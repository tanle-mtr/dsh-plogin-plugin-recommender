...
- **标签：** `web-ui`, `plugin-ecosystem`, `visualization`
- **推荐理由：** DSH插件Web可视化聚合平台，统一管理插件。
...
- **标签：** `pet`, `ui-decoration`, `mascot`, `terminal`
- **推荐理由：** 动画宠物画廊，为编码Agent终端增添趣味。
...
- **标签：** `desktop`, `agent-runtime`, `computer-use`
...
- **推荐理由：** 本地优先的AI代理桌面应用，支持多模型和自我进化技能。
...
- **标签：** `canvas`, `workspace`, `visualization`, `conversation`
- **推荐理由：** 可视化非线性画布工作区，支持分支对话管理。
...
- **标签：** `desktop`, `electron`, `windows`, `gui`
- **推荐理由：** Windows桌面客户端，内置SSH和移动��程访问功能。
...
- **标签：** `desktop`, `electron`, `cross-platform`, `gui`
- **推荐理由：** 跨平台CodePilot风格桌面客户端，支持插件和技能。
...
- **标签：** `mcp`, `skills`, `ui`, `webui`
- **推荐理由：** Web界面Skill与MCP管理工具面板
...
- **标签：** `marketplace`, `ui`, `web`, `plugin-market`
- **推荐理由：** 深度集成到DSH Web GUI的社区插件市场
...
- **标签：** `desktop-app`, `deepseek-harness`, `electron`
- **推荐理由：** Electron桌面控制台，管理插件和MCP服务
...
- **推荐理由：** 集成数据库/SSH/Docker/AI的一站式桌面工具

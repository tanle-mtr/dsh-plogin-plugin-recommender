...
- **标签：** `desktop`, `electron`, `windows`, `ssh`
...
- **标签：** `desktop-app`, `privacy`, `agent`
- **推荐理由：** 本地优先的AI代理桌面应用，支持多模型和自进化技能
...
- **推荐理由：** 原生iOS客户端，支持工作区会话和Agent执行追踪
...
- **推荐理由：** 一站式DevOps桌面，整合数据库、SSH、Docker和AI

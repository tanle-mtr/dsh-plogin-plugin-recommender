...
- **推荐理由：** 可扩展侧边栏，内置文件编辑器、终端、Git和子代理页面。
...
- **标签：** `taskboard`, `ui`, `embed`, `productivity`
- **推荐理由：** 现代化可嵌入任务面板，灵活集成Codex和DSH。
...
- **标签：** `widget`, `balance`, `ui-extension`
- **推荐理由：** 萌系悬浮小鲸鱼，实时提醒账户余额
...
- **推荐理由：** 零配置Windows桌面端，集成Codex、SSH和插件系统。
...
- **标签：** `desktop`, `mcp`, `ui`
- **推荐理由：** 本地优先的AI桌面工作台，支持会话、项目和MCP集成。
...
- **推荐理由：** 在Harness中集成表格、文档、幻灯片等办公功能
...
- **推荐理由：** 原生iOS客户端，支持WebSocket连接与工作区管理
...
- **推荐理由：** DeepSeek Harness桌面管理控制台，双击即用
...
- **标签：** `workbench`, `plugin-system`, `typescript`, `deepseek-harness`
...
- **推荐理由：** 集成数据库、SSH、Docker的DevOps桌面端。

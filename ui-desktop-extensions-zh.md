...
- **标签：** `ui`, `mascot`, `pixel-art`, `gallery`
- **推荐理由：** 多AI编码Agent的动画宠物画廊，提升使用体验
...
- **推荐理由：** 可扩展侧边栏，内置文件/终端/对话/Git/子代理页面。
...
- **标签：** `taskboard`, `ui`, `codex`, `dsh-plugin`
- **推荐理由：** 现代化嵌入式任务面板，支持Codex和DSH灵活集成。
...
- **标签：** `widget`, `ui`, `floating`, `dsh-plugin`
- **推荐理由：** 可拖拽小鲸鱼挂件，监控DeepSeek账户余额并带动画。
...
- **标签：** `electron`, `desktop-app`, `mcp`, `local-first`
...
- **推荐理由：** Windows桌面GUI客户端，集成Codex、SSH与移动端远程访问
...
- **推荐理由：** 本地优先的Tauri桌面应用，支持多模型AI工作流
...
- **标签：** `ios`, `mobile`, `desktop-client`
- **推荐理由：** 原生iOS客户端，WebSocket连接DSH工作台和会话
...
- **推荐理由：** 桌面多Tab控制台管理Harness/插件/MCP。
...
- **标签：** `ui`, `status-bar`, `web`
- **推荐理由：** 持久状态栏显示模型提供商、余额和实时价格信息
...
- **推荐理由：** 面向科研人员生物信息学桌面Agent，支持离线和技能库
...
- **标签：** `ui`, `skill-picker`, `workflow`
- **推荐理由：** 类WorkBuddy技能选择器，在Composer中快速插入技能
...
- **标签：** `ui`, `mcp`, `manager`
- **推荐理由：** 为DSH Web GUI设置页新增技能和MCP管理卡片。
...
- **推荐理由：** 集成数据库、SSH、Docker和AI助手的DevOps桌面端。
...
- **推荐理由：** Electron封装桌面版DSH，集成侧边栏与ModLens。

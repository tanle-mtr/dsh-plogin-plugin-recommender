...
- **标签：** `deepseek-harness`, `dsh`, `sidebar`
...
- **标签：** `cli`, `dsh-plugin`, `skills`, `taskboard`
...
- **标签：** `deepseek-harness`, `tui`, `terminal`, `dsh-plugin`
- **推荐理由：** Claude Code风格TUI，鲸鱼顶栏/流式思考/回滚功能
...
- **⭐ 星标：** 2,765
- **语言：** JavaScript
- **描述：** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你��dsh安装
- **标签：** `widget`, `balance`, `ui`
- **推荐理由：** 可爱鲸鱼浮动组件，实时监控DeepSeek余额并支持拖拽吸附
...
- **标签：** `desktop-app`, `electron`, `codex`, `ssh-client`
- **推荐理由：** 零配置Electron桌面客户端，集成Codex、SSH和插件系统
...
- **标签：** `desktop-app`, `mcp`, `local-first`, `office-automation`
- **推荐理由：** 本地优先AI桌面工作区，支持会话、MCP和Office集成
...
- **标签：** `canvas`, `conversation-ui`, `non-linear`, `workspace`
- **推荐理由：** 可视化非线性对话画布，支持分支会话和工作流探索
...
- **推荐理由：** 原生iOS/Android客户端，WebSocket连接DSH
...
- **推荐理由：** Electron 桌面管理控制台，多 Tab 管理插件与 MCP
...
- **标签：** `workbench`, `agent-platform`, `skills`
- **推荐理由：** 基于 DSH 的插件化 Web 工作台，全局技能管理
...
- **推荐理由：** 生物信息学桌面代理，支持离线模式和技能商店，适合临床和实验室科学家。
...
- **推荐理由：** 实时显示模型信息、余额和峰谷定价，DSH必备的底部状态栏。
...
- **推荐理由：** WorkBuddy风格技能选择器，在DSH编辑器中直接选择插入技能。
...
- **推荐理由：** Electron桌面版DSH，集成侧边栏与插件市场。
...
- **标签：** `knowledge-cards`, `ui`, `share`
- **推荐理由：** Transforms chat history into shareable knowledge cards

...
- **标签：** `desktop`, `ui`, `dsh-plugin-desktop`
- **推荐理由：** DeepSeek Harness原生桌面客户端
...
- **标签：** `taskboard`, `ui`
- **推荐理由：** 现代化灵活任务面板，可嵌入Codex和DeepSeek Harness。
...
- **⭐ 星标：** 2,743
- **语言：** JavaScript
- **描述：** DeepSeek Harness（DSH）一只��在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
...
- **推荐理由：** 零配置Windows桌面客户端，内置Codex、SSH及移动端远程访问
...
- **标签：** `desktop-app`, `mcp`, `local-first`
- **推荐理由：** 本地优先桌面工作台，支持MCP、网页研究和Office组件
...
- **标签：** `conversation`, `canvas`, `workspace`
- **推荐理由：** 基于Canvas的非线性对话画布，支持会话分支探索
...
- **推荐理由：** 本地优先Tauri桌面应用，自进化技能、多模型、隐私优先
...
- **标签：** `ios`, `mobile`, `native`
- **推荐理由：** 原生iOS客户端，WebSocket同步Harness工作区。
...
- **推荐理由：** 端到端加密P2P远程接入，PC/Android/Web多端随时操作Harness，安全低延迟。
...
- **推荐理由：** 应用内技能管理器+调用审计，监控和管理DSH技能调用的必备面板。
...
- **⭐ 星标：** 165
- **语言：** TypeScript
- **描述：** 开源版锤子便签，复刻锤科美��，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **标签：** `notes`, `productivity`, `dsh-plugin`
- **推荐理由：** 开源锤子便签复刻，Docker私有化部署，支持微信/QQ/飞书推送，DSH插件兼容。
...
- **标签：** `workbench`, `typescript`, `plugin-system`
...
- **标签：** `bioinformatics`, `desktop-app`, `offline-mode`
- **推荐理由：** 桌面生物信息学代理，支持离线模式和技能商店
...
- **推荐理由：** WorkBuddy 风格技能选择器，快速插入技能指令

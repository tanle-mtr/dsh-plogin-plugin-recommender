...
- **推荐理由：** DeepSeek Harness现代化桌面端解决方案
...
- **标签：** `web-ui`, `plugin-ecosystem`, `dsh`
- **推荐理由：** DSH插件浏览器Web UI聚合生态
...
- **标签：** `agent-sandbox`, `agent-tools`, `virtual-terminal`, `vfs`
- **推荐理由：** 首个AI代理虚拟终端，支持沙盒化多会话操作环境
...
- **⭐ 星标：** 3,213
- **语言：** TypeScript
- **描述：** 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/���代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
- **标签：** `deepseek-harness`, `sidebar`, `dsh-plugin`
- **推荐理由：** 开放侧边栏底座，集成文件编辑/终端/Git/对话等多功能面板
...
- **标签：** `dsh-plugin`, `skills`, `cli`, `codex`
- **推荐理由：** 现代化灵活任务面板，完美嵌入Codex和DeepSeek Harness工作流
...
- **推荐理由：** Claude Code风格TUI，含鲸鱼顶栏/流式思考/双击回滚/上下文进度显示
...
- **标签：** `widget`, `floating`, `deepseek`
- **推荐理由：** 萌系浮窗小鲸鱼监控账户余额，支持拖拽和动画效果
...
- **推荐理由：** 本地优先Electron桌面工作区，支持MCP与办公集成
...
- **标签：** `marketplace`, `webui`, `plugin-market`, `ui`
...
- **推荐理由：** 一站式DevOps桌面：数据库/SSH/Docker/AI沙箱集成

...
- **标签：** `dsh-web`, `dsh-web-ui`, `creative-workshop`
- **推荐理由：** 插件的Web聚合生态系统。
...
- **推荐理由：** 可拓展侧边栏，内置文件编辑/终端/对话/Git等页面
...
- **推荐理由：** 轻量Tauri桌面应用，零配置预装插件，跨平台支持。
...
- **推荐理由：** 开源Electron桌面客户端，内置SSH与技能系统。
...
- **推荐理由：** 开源锤子便签，一键Docker部署，支持Skill调用。
...
- **标签：** `mcp`, `skills`, `ui`
- **推荐理由：** Web界面统一管理skill和MCP工具，操作便捷
...
- **标签：** `market`, `ui`, `plugins`
- **推荐理由：** 社区插件市场，一键安装卸载，方便扩展
...
- **推荐理由：** Electron桌面控制台，多Tab管理DSH插件与MCP
...
- **标签：** `dsh-plugin`, `plugin`, `usage-tracking`
- **推荐理由：** 底部状态栏显示模型、余额及峰谷价格
...
- **标签：** `desktop-app`, `devops`, `ssh`, `docker`
- **推荐理由：** DevOps一体化桌面，集成SSH/Docker/DB/AI沙箱

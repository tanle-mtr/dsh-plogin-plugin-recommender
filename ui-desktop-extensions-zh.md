...
- **推荐理由：** Privacy-focused open-source resume builder, fully customizable
...
- **推荐理由：** Browser extension suite enhancing Gemini, Claude, ChatGPT UIs
...
- **推荐理由：** Modern desktop client built as a DSH plugin ecosystem
...
- **推荐理由：** Cross-device agent workspaces and task boards
...
- **标签：** `web-ui`, `skin`, `desktop`
- **推荐理由：** Web GUI, task boards, wallpapers, and skins
...
- **推荐理由：** Fun web-simulated traditional toy, mobile-first
...
- **推荐理由：** Extensible sidebar with file editor, terminal, Git, and sub-agents
...
- **⭐ 星标：** 2,327
- **语言：** TypeScript
- **描述：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，���鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **标签：** `deepseek-harness`, `dsh-plugin`, `tui`
- **推荐理由：** Claude Code-style TUI with whale header and streaming status
...
- **推荐理由：** Animated desktop companion pets
...
- **推荐理由：** Lightweight 5mb cross-platform desktop
...
- **标签：** `dsh-plugin`, `desktop`, `local`
- **推荐理由：** Local-first AI desktop workspace
...
- **推荐理由：** Cute whale widget tracking balance
...
- **标签：** `desktop-app`, `tauri`, `privacy`
- **推荐理由：** Local-first multi-model AI desktop app with self-evolving skills
...
- **推荐理由：** CodePilot-style desktop client and plugin suite for DSH
...
- **推荐理由：** Native Windows desktop GUI with SSH & mobile access
...
- **推荐理由：** Visual non-linear canvas workspace for sessions
...
- **标签：** `mcp`, `skills`, `ui`
- **推荐理由：** Web UI panel for managing skills and MCP tools
...
- **标签：** `dsh-plugin`, `ui`
- **推荐理由：** Live info bar: provider, balance, pricing, countdown at bottom
...
- **标签：** `hud`, `status`, `panel`
- **推荐理由：** Floating HUD showing git status, MCP, skills, model info
...
- **标签：** `desktop`, `tauri`, `database`, `ssh`
- **推荐理由：** Tauri desktop app integrating DB, SSH, Docker + AI
...
- **标签：** `desktop-app`, `electron`, `modlens`
- **推荐理由：** Electron desktop wrapper with ModLens and sidebar integration

...
- **标签：** `mascot`, `ui`, `dsh-plugin`
- **推荐理由：** 为各类Agent提供可爱动效宠物UI装饰。
...
- **推荐理由：** 本地AI桌面工作区，集成DSH会话、项目、文件及MCP工具。
...
- **推荐理由：** 零配置Windows桌面客户端，集成Codex、SSH和远程访问。
...
- **推荐理由：** 在对话回复中直接渲染图表、表单、测验等交互UI组件。
...
- **推荐理由：** 原生SQLite任务面板，无iframe的清晰Web UI
...
- **推荐理由：** 跨平台桌面客户端，类CodePilot体验的DSH集成
...
- **推荐理由：** 原生iOS客户端，WebSocket同步工作区与Agent轨迹
...
- **推荐理由：** 开源锤子便签，Docker私有化部署支持DSH插件
...
- **推荐理由：** Electron多Tab桌面控制台，统一管理Harness/MCP/Skill
...
- **标签：** `bioinformatics`, `desktop`
- **推荐理由：** 生物信息学桌面应用，离线可用，技能商店丰富。
...
- **推荐理由：** 一站式 DevOps 桌面：数据库、SSH、SFTP、Docker 与 AI 沙箱。

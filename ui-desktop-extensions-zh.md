...
- **标签：** `ai-design`, `dsh-plugin`, `figma-alternative`
- **推荐理由：** DSH最佳设计插件，本地优先的AI设计工具。
...
- **推荐理由：** DSH 可视化插件市场，一键浏览安装插件，必备���具
...
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/Git等核心功能
...
- **推荐理由：** 现代化灵活任务面板，无缝嵌入 DSH 和 Codex 工作流
...
- **标签：** `tui`, `ui`, `interface`
- **推荐理由：** 鲸鱼主题 TUI，支持流式思考与双击 Esc 回滚
...
- **标签：** `agentic-runtime`, `desktop`, `vibe-coding`
- **推荐理由：** Rust编写的高性能Agent运行时，附带精美桌面应用
...
- **标签：** `novel-writing`, `desktop`, `creative`
- **推荐理由：** 本地优先的桌面小说创作软件，支持角色和世界管理
...
- **标签：** `desktop`, `mcp`, `office-automation`
- **推荐理由：** 本地AI桌面工作区含MCP和Office支持
...
- **标签：** `visual`, `canvas`, `session-explorer`
- **推荐理由：** 可视化画布会话浏览器含分支功能
...
- **标签：** `desktop-app`, `privacy`, `multi-model`, `local-first`
- **推荐理由：** 本地优先的Claude Cowork替代品，隐私安全且支持多模型
...
- **推荐理由：** 将电子表格、文档、幻灯片等办公套件引入Harness
...
- **标签：** `ios`, `mobile`, `native-client`, `websocket`
- **推荐理由：** 原生iOS客户端，将工作区和Agent轨迹延伸至iPhone
...
- **推荐理由：** 跨平台桌面客户端，CodePilot风格优雅插件套件
...
- **推荐理由：** Web界面管理skills和MCP服务器，可视化操作
...
- **标签：** `ui`, `info-bar`, `deepseek-harness`
- **推荐理由：** 底部信息栏显示模型、余额、实时定价信息
...
- **标签：** `work-platform`, `web`, `skills`
- **推荐理由：** 基于DSH的插件化Web工作平台，集成技能管理
...
- **推荐理由：** 全栈运维桌面，数据库/SSH/Docker/AI 一体化
...
- **标签：** `ui`, `dsh-plugin`, `web`
- **推荐理由：** 为DSH面板添加一键折叠上下文按钮。

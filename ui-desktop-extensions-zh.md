...
- **推荐理由：** 增强Gemini/Claude/ChatGPT界面，带提示词管理功能
...
- **推荐理由：** Claude Code风格TUI，含鲸鱼顶栏与流式思考。
...
- **推荐理由：** 可爱的桌面浮窗，实时查看DeepSeek余额，支持拖拽吸附和动画。
...
- **推荐理由：** 轻量Tauri桌面版DSH，跨平台支持，预装插件，零环境配置。
...
- **标签：** `desktop-app`, `electron`, `windows-desktop`
- **推荐理由：** 零配置Windows桌面客户端，内置插件、SSH与Codex
...
- **推荐理由：** 本地优先的AI桌面工作区，支持DSH会话与MCP工具
...
- **标签：** `office`, `productivity`, `document`
- **推荐理由：** 完整办公套件，表格文档幻灯片无缝集成
...
- **标签：** `task-management`, `native`, `productivity`
- **推荐理由：** 原生SQLite任务管理，支持Agent认领审核
...
- **推荐理由：** 复刻锤子便签，支持Docker私有化与skill调用，一键导出公众号格式。
...
- **推荐理由：** Web界面技能与MCP管理工具，直接在浏览器中操作。
...
- **推荐理由：** Web GUI社区插件市场，一键安装卸载，浏览便捷。
...
- **标签：** `bioinformatics`, `desktop-app`, `dsh-plugin`, `tauri`
- **推荐理由：** 一键安装生信桌面应用，支持离线模式，适合临床与实验室用户
...
- **推荐理由：** 融合八字风水等传统智慧的AI技能包，带可视化仪表盘
...
- **推荐理由：** 一体化运维桌面：数据库/SSH/Docker/AI沙箱
...
- **推荐理由：** Electron桌面版，集成DSH Web/ModLens等

...
- **标签：** `cordis`, `desktop`, `dsh-plugin-desktop`
...
- **标签：** `web-ui`, `plugin-store`, `dsh-web`
- **推荐理由：** 基于Web的DSH插件聚合生态，可视化插件分发平台。
...
- **推荐理由：** 现代化灵活任务面板，无缝嵌入Codex和DSH工作流
...
- **推荐理由：** Claude Code风格TUI，含鲸鱼顶栏/流式思考/上下文进度
...
- **标签：** `dsh-plugin`, `gen-ui`, `interactive`, `ui-components`
- **推荐理由：** 在DSH对话中内联渲染图表、表单等交互UI组件。
...
- **推荐理由：** 开源Electron桌面客户端，支持SSH、移动远程访问和插件系统。
...
- **推荐理由：** 本地优先Tauri桌面AI助手，支持多模型、自进化技能和隐私优先。
...
- **标签：** `canvas`, `conversation`, `session-explorer`, `ui-extension`
...
- **标签：** `ios`, `mobile`, `websocket`, `client`
- **推荐理由：** 原生iOS客户端，将DeepSeek Harness功能延伸到iPhone
...
- **标签：** `mcp`, `skills`, `ui`
- **推荐理由：** DSH Web界面中管理skill和MCP的实用工具
...
- **推荐理由：** 生物信息学桌面应用，支持离线和插件市场，面向科研人员
...
- **推荐理由：** Electron桌面版DeepSeek Harness，集成侧边栏与ModLens。
...
- **标签：** `ui-enhancement`, `dsh-plugin`, `webui`
- **推荐理由：** DSH Web上下文面板一键紧凑模式按钮。
...
- **推荐理由：** DeepSeek Harness的插件市场，类似CodeX浏览体验

...
- **Why use it:** Web UI panel for skill and MCP management in DSH.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp-server`
- **Why use it:** Hot-reload MCP config and skill management via UI.
...
- **Why use it:** OAuth integration for ChatGPT models inside DSH.

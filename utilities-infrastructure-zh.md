...
- **推荐理由：** Ultimate image uploader supporting 60+ hosting services
...
- **推荐理由：** Curated plugin discovery list for DSH ecosystem
...
- **标签：** `vfs`, `agent-tools`, `sandbox`
- **推荐理由：** Unified virtual filesystem for all AI agents
...
- **推荐理由：** Built-in plugin marketplace for browsing and one-click installs
...
- **标签：** `dsh-plugin`, `plugin-registry`, `awesome-list`
- **推荐理由：** Plugin radar with curated top 50 and auto-updated index
...
- **推荐理由：** Curated plugin finder with daily updates and verification
...
- **推荐理由：** Bilingual curated list of DSH plugins, tools, and integrations
...
- **推荐理由：** OAuth login to use ChatGPT/Claude/Grok subscriptions as LLM backends
...
- **标签：** `web-search`, `free`, `universal`
- **推荐理由：** Free web search bridge plugin for all DSH models, no API key needed
...
- **⭐ 星标：** 207
- **语言：** TypeScript
- **描述：** DSH (DeepSeek Harness) 原理学习、插件市场���最佳实践 · Learn DSH principles, plugin marketplace & best practices
- **标签：** `documentation`, `learning`, `guide`
- **推荐理由：** Learn DSH principles, plugin marketplace tips, and best practices
...
- **标签：** `awesome-list`, `guide`, `starter`
- **推荐理由：** Ultimate DSH guide with quickstart, plugins, and toolkits
...
- **标签：** `cost-tracking`, `utilities`
- **推荐理由：** Track session/daily costs and API quota usage
...
- **推荐理由：** Run Pi Agent extensions as native DSH plugins
...
- **推荐理由：** Crash recovery, snapshots, and one-click SAFE MODE
...
- **推荐理由：** Cross-preset session migration with state preservation
...
- **标签：** `plugin`, `management`, `ui`, `registry`
- **推荐理由：** 插件控制台+开发引导，生态基建
...
- **标签：** `container`, `management`, `multi-version`
- **推荐理由：** 隔离容器运行多版本DSH，一键导入
...
- **标签：** `context`, `audit`, `ui`, `utility`
- **推荐理由：** Context audit tool with token cost analysis and Web UI
...
- **标签：** `manager`, `mcp`, `skills`, `webui`
- **推荐理由：** Web GUI plugin for managing skills and MCP servers
...
- **推荐理由：** Awesome list and plugin directory for DSH ecosystem discovery
...
- **标签：** `config-manager`, `mcp`
- **推荐理由：** Full DSH config backup/restore with sync via WebDAV
...
- **标签：** `awesome-list`, `dsh-plugin`
- **推荐理由：** Curated DSH plugin list — quick ecosystem overview
...
- **推荐理由：** Real-time token usage, cost estimates, and balance charts
...
- **推荐理由：** Diagnoses and resolves plugin conflicts and version issues

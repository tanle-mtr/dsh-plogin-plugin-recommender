...
- **Tags:** `ai-guide`, `tutorials`, `resource-list`
- **Why use it:** Comprehensive AI resource library and tutorial collection
...
- **Why use it:** Beginner-friendly harness engineering from zero to one
...
- **Tags:** `curated-list`, `awesome-list`, `reference`
- **Why use it:** Essential curated reference for discovering all DSH plugins, tools, and integrations
...
- **Tags:** `encyclopedia`, `knowledge-base`, `learning`, `mcp`
- **Why use it:** Comprehensive AI encyclopedia covering MCP, RAG, multimodal, and learning roadmaps
...
- **Tags:** `academic-search`, `mcp`, `arxiv`, `research-workflow`
- **Why use it:** Academic paper search across CrossRef, PubMed, arXiv with citation verification and graphs.
...
- **Why use it:** Domain pack for industry research with chain mapping and news tracking
...
- **Tags:** `evaluation`, `rag-evaluation`, `prompt-testing`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `guide`, `plugin-directory`

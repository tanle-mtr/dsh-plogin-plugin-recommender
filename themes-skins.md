...
- **Why use it:** Highly customizable frosted glass theme with adjustable blur and background.
...
- **Why use it:** Upload custom backgrounds or switch preset atmospheres in DSH web UI

...
- **Tags:** `skin`, `whale`, `theme`
- **Why use it:** Whale Girl cute skin series for DeepSeek Harness UI customization
...
- **Tags:** `theme`, `desktop-ui`, `glassmorphism`
...
- **Tags:** `theme`, `webgpu`, `threejs`, `ocean-skin`
- **Why use it:** WebGPU ocean-themed visual skin with Three.js for an immersive Harness experience
...
- **Tags:** `theme`, `skins`, `opencode`, `dsh-plugin`
- **Why use it:** 34 opencode classic themes with one-click switch, persist across restarts

...
- **Why use it:** Cute whale girl skin series for DeepSeek Harness visual customization
...
- **Why use it:** Customizable frosted glass theme without touching source code.
...
- **Why use it:** Stunning WebGPU ocean-themed visual skin for DeepSeek Harness interface
...
- **Tags:** `theme`, `skin`, `color-scheme`, `dsh-plugin`
- **Why use it:** 34 opencode classic color themes with one-click apply, no restart needed

...
- **Why use it:** Animated pet gallery to personalize your coding agent
...
- **Why use it:** Highly customizable glass-morphism theme for DSH web UI.
...
- **Why use it:** 34 opencode classic themes one-click switch, persist across restarts.

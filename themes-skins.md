...
- **Why use it:** Public gallery of animated pets that personalize your coding agent experience.
...
- **Why use it:** Whale Girl theme series for DSH interface
...
- **Why use it:** Frosted-glass transparent theme with fully customizable blur,磨砂 and wallpaper.
...
- **Tags:** `dsh-plugin`, `theme`, `animation`, `threejs`
- **Why use it:** Real-time animated ocean theme with adjustable waves and glassmorphism effects

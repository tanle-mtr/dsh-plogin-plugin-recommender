...
- **Tags:** `mascot`, `pixel-art`, `ui-customization`, `themes`
- **Why use it:** Public gallery of animated pet mascots that customize the UI of major AI coding agents.
...
- **Why use it:** Whale girl skin series for DSH with beautiful designs
...
- **Why use it:** Frosted glass theme with fully customizable blur,磨砂度和壁纸 for DSH web UI.
...
- **Tags:** `dsh-plugin`, `theme`, `webgpu`
- **Why use it:** WebGPU ocean-themed skin with Three.js for immersive DSH web interface experience.

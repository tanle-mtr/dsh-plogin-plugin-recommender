...
- **Tags:** `mascot`, `pixel-art`, `cli`, `themes`
- **Why use it:** Public gallery of animated mascot pets for coding agents and CLI tools
...
- **Tags:** `theme`, `ocean`, `webgpu`, `chrome-extension`
- **Why use it:** WebGPU ocean-themed skin with Three.js and WebGPU rendering effects.
...
- **Why use it:** 34 opencode themes for DSH, one-click switch, persists restarts
...
- **Why use it:** Customizable backgrounds with real-time preview and theme presets

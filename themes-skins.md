...
- **Tags:** `mascot`, `pixel-art`, `animated`, `themes`
- **Why use it:** Animated pet mascots gallery for coding agents
...
- **Why use it:** Whale Girl skin series for DeepSeek Harness with cute aesthetic customization.
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`, `theme`
- **Why use it:** Glass morphism theme with fully customizable frosted effects and wallpapers.
...
- **Tags:** `theme`, `color-scheme`, `opencode`
- **Why use it:** 34 opencode classic color themes, one-click swap, survives restarts
...
- **Why use it:** Customizable background themes with presets and live preview.

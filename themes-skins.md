...
- **Why use it:** 34 opencode classic color themes, one-click switch with persistence across restarts.
...
- **Why use it:** Web background customization with presets and upload

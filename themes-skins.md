...
- **⭐ Stars:** 1,997
- **Language:** TypeScript
- **Description:** Whale Girl skin series for DeepSeek Harness. 适用于 DeepSeek Harness 的，鲸鱼娘系列��肤。
- **Tags:** `skin`, `theme`
- **Why use it:** Popular whale-girl themed skin series for DSH.
...
- **Why use it:** WebGPU-accelerated ocean-themed skin for DSH with Three.js and native Chrome/Edge integration.
...
- **Why use it:** Custom backgrounds with presets, blur, and focus controls.

...
- **Tags:** `mascot`, `pixel-art`, `theme`, `animation`, `pet`, `terminal`
- **Why use it:** Community gallery of animated mascot pets personalizing your coding agent terminal experience.
...
- **Why use it:** Popular whale girl skin series for visual customization.
...
- **Tags:** `theme`, `glass-morphism`, `ui-customization`, `desktop`
- **Why use it:** High-freedom frosted glass theme with fully customizable blur and backgrounds
...
- **Why use it:** Customizable web background with image upload, presets, and real-time preview.

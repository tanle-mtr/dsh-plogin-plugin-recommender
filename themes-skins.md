...
- **Tags:** `skin`, `theme`, `ui`
- **Why use it:** Whale Girl skin series for DeepSeek Harness with charming visual design
...
- **Why use it:** WebGPU-powered ocean-themed visual skin for DSH.
...
- **Tags:** `themes`, `skins`, `dark-mode`, `ui`
- **Why use it:** 34 opencode themes (Dracula, TokyoNight, Gruvbox) for one-click DSH skin swaps.
...
- **Tags:** `dsh-plugin`, `webui`
- **Why use it:** Custom web background with preset atmospheres and fine-tuning controls.

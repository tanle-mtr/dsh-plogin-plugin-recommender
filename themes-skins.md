...
- **Why use it:** Animated pet mascot gallery adding personality to CLI coding agents.
...
- **Why use it:** WebGPU ocean-themed visual skin for DeepSeek Harness interface.
...
- **Tags:** `themes`, `skins`, `color-scheme`, `customization`
- **Why use it:** 34 opencode classic color themes with one-click swap and persistence across restarts
...
- **Why use it:** Customizable DSH Web background with presets

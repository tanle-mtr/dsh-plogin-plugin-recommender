...
- **Why use it:** Public animated pet mascot gallery that personalizes your coding agent experience.
...
- **Why use it:** Whale girl themed skins for DeepSeek Harness with cute visual customization.
...
- **Tags:** `theme`, `ui`
- **Why use it:** Glass-effect theme with highly customizable frosted glass UI.
...
- **⭐ Stars:** 14
- **Language:** JavaScript
- **Description:** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一键���上——tokyonight、dracula、gruvbox、matrix、rose-pine……即点即换，重启不丢。34 opencode themes for DeepSeek Harness, one click, persisted. More by @FeatherHunter: ⚡ dsh-prompt · 🧠 dsh-mattpocock-skills-deck
- **Tags:** `theme`, `skins`, `dark-mode`
- **Why use it:** 34 opencode classic themes one-click apply, persists after restart

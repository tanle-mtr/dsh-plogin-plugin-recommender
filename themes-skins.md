...
- **Why use it:** Public gallery of animated pet mascots for various AI agent platforms
...
- **Why use it:** Whale Girl skin series for DeepSeek Harness. Customizes the visual appearance of the interface.
...
- **Why use it:** Frosted glass theme with full customization options.
...
- **Tags:** `theme`, `skins`, `opencode`
- **Why use it:** 34 opencode classic color themes, one-click switch, no fade on restart.
...
- **Tags:** `webui`, `theme`, `background`, `visual`
- **Why use it:** Customizable backgrounds and themes for DSH Web UI.

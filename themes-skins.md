...
- **Why use it:** Gallery of animated pet mascots for coding agents to personalize your IDE
...
- **Why use it:** Stunning WebGPU ocean-themed skin for DSH with threejs
...
- **Tags:** `theme`, `skin`, `dark-mode`, `opencode`
- **Why use it:** 34 opencode themes for DSH with one-click switching

...
- **标签：** `agent-skills`, `dsh-plugin`, `skill-md`
- **推荐理由：** 最大技能商店，涵盖多领域开箱即用的技能包。
...
- **标签：** `agent-os`, `loop-engineering`, `llm-orchestration`, `mcp`
- **推荐理由：** 自我进化的Agent OS，通过评测门禁迭代升级。
...
- **标签：** `skills`, `workflow`, `dsh-plugin`, `vibe-coding`
...
- **标签：** `cognitive-enhancement`, `skills`, `dsh-plugin`, `j-space`
...
- **标签：** `novel-writing`, `creative-writing`, `long-form`
- **推荐理由：** 完整小说创作工作流：世界观构建到审稿修稿
...
- **标签：** `creative-writing`, `agent-skills`, `workflow`
- **推荐理由：** 小说/短剧/游戏写作工作流，一站式创作平台
...
- **标签：** `task-management`, `native-ui`, `agent-workflow`
- **推荐理由：** 原生任务看板，SQLite存储，Agent协作管理
...
- **推荐理由：** 全栈自动数学建模竞赛Skill，GitOps流水线+代码自证
...
- **标签：** `agent-review`, `prompt-engineering`, `plan-mode`
- **推荐理由：** Agent可组合可审查，持续自我进化
...
- **标签：** `agent`, `ai-coding`, `code-review`
- **推荐理由：** AI导师技能，扫描架构、生成章节、自动判题
...
- **标签：** `patent`, `legal-tech`, `multi-agent`
- **推荐理由：** 专利侵权分析技能，输入专利号产出竞品报告
...
- **推荐理由：** 八字/风水/中医融合AI技能包，本地确定性引擎+可视化
...
- **标签：** `quality-gate`, `engineering`, `guard`, `skill`
- **推荐理由：** 工程纪律保障：检验需求、测试、验证交付质量
...
- **标签：** `qa`, `testing`, `skill`, `playwright`
- **推荐理由：** 11个QA技能框架+共享知识库，助力AI测试工程
...
- **推荐理由：** 多Agent数学建模，含33模型库+论文模板+审稿脚本
...
- **推荐理由：** 指导AI从零开发、构建、测试DSH插件的Skill
...
- **推荐理由：** Godot 4.x全栈游戏开发Skill，面向DSH Agent
...
- **推荐理由：** 电影感视频Agent，含152张镜头配方卡和Remotion模板
...
- **标签：** `plugin-dev`, `skill`, `cross-platform`
- **推荐理由：** DSH插件开发Agent Skill，兼容Claude Code和Codex

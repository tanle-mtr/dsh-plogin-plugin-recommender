...
- **标签：** `agent-orchestration`, `mcp`, `workflow`
- **推荐理由：** 统一Agent工作空间，多端任务管理。
...
- **标签：** `cognition`, `reasoning`, `verification`
- **推荐理由：** 推理时控制套件，增强深度推理和纠错恢复能力
...
- **推荐理由：** 赋予AI视听能力，视频音频屏幕分析并输出可验证证据。
...
- **推荐理由：** 原生SQLite任务看板，支持Agent认领和审核功能
...
- **标签：** `deepseek-harness`, `agent-review`
- **推荐理由：** 支持Agent自我进化与可组合审查模式。
...
- **推荐理由：** TDD、调试、规划与协作技能，源自superpowers
...
- **标签：** `agent-plugins`, `agent-skills`, `mcp`
- **推荐理由：** 多平台通用技能，支持网页搜索、研究与内容提取。
...
- **标签：** `agent-skills`, `spec-driven`, `dsh-plugin`
- **推荐理由：** 便携版规格驱动开发技能，基于DSH工程模式。
...
- **标签：** `ai-agent`, `chinese-traditional-wisdom`, `fengshui`, `tcm`
- **推荐理由：** 八字/风水/中医融合，本地引擎+可视化面板，一键安装
...
- **推荐理由：** 11个测试工程Skill+知识库，AI辅助质量保证

...
- **标签：** `agent-orchestration`, `no-code`, `workspaces`
- **推荐理由：** 统一Agent工作台，支持任务看板和多设备访问。
...
- **标签：** `skill-store`, `agent-skills`, `marketplace`
- **推荐理由：** 最大技能商店，自动收录开发、文档、金融等技能包。
...
- **推荐理由：** 智能技能路由与工作流编排，SkillsBench奖励+21.12pp，效率显著提升
...
- **⭐ 星标：** 3,013
- **语言：** Python
- **描述：** J-Space Cognition Suite V3.7 - AI cognitive-enhancement Skills based on Anthropic's J-space global workspace research. | 哔哩���哩：Tiger380 (UID 3494375382321675) — https://space.bilibili.com/3494375382321675
- **标签：** `cognition`, `agent-skills`, `research`
...
- **标签：** `creative-writing`, `drama`, `plugin`
- **推荐理由：** AI驱动的小说与短剧创作工作流
...
- **推荐理由：** 可组合、可审查的Agent自演进模式，支持可持续改进工作流。
...
- **⭐ 星标：** 170
- **语言：** Python
- **描述：** 为 Claude Code 赋能多模态视觉能力，适配 纯文本 LLM 底座，用于截图 / UI / 图表分��；搭配 browser-harness 可做前端布局自动化检查。
...
- **标签：** `research-skills`, `marketing`, `deep-research`
- **推荐理由：** 88个开箱即用技能，覆盖研究、营销与商业工作流。
...
- **推荐理由：** 适配TDD调试和规划的Superpowers技能集
...
- **推荐理由：** 融合八字/风水/易经的本地确定性AI技能包，一键安装
...
- **推荐理由：** 多Agent协作框架，支持独立模型/技能/共享工作区
...
- **标签：** `ai-video`, `directorx`, `multimodal`
- **推荐理由：** DirectorX插件，集成AI视频/图像/音频技能和工具
...
- **推荐理由：** 11个测试工程技能+共享知识库，让AI像资深测试工程师
...
- **标签：** `roleplay`, `narrative`, `agent-skill`
- **推荐理由：** 交互式叙事RPG技能，NPC有记忆/立场，数百素材库
...
- **推荐理由：** 跨平台Agent交接技能，保持会话连续性和上下文记忆
...
- **推荐理由：** Godot 4.x全栈游戏开发技能，赋能DSH智能体
...
- **标签：** `plugin-dev`, `agent-skill`, `skills`
- **推荐理由：** 开发DSH插件的智能体技能，覆盖服务/事件/工具
...
- **标签：** `agent-tools`, `awesome-dsh-plugin`, `llm-agents`
- **推荐理由：** 任务预检自动注入Top-K插件，让Agent能力可预期。

...
- **标签：** `ai-writing`, `webnovel`, `chinese-novel`
- **推荐理由：** 专注长篇网文创作的专用工作流
...
- **推荐理由：** 本地优先的多Agent控制中心，跨会话保持目标与决策持续运行。
...
- **推荐理由：** 智能���能路由与工作流编排，显著降低Token消耗并提升奖励。
...
- **标签：** `agent-skills`, `cognition`, `workflow`
- **推荐理由：** 模型无关的推理时控制套件，支持深度推理、验证与恢复的全流程能力。
...
- **推荐理由：** 在DSH生态中实现多Agent团队协作的工作流编排与调度能力。
...
- **标签：** `novel-writing`, `workflow`, `desktop`
- **推荐理由：** 桌面小说创作助手，将灵感、角色、世界观与章节写作组织成端到端可控工作流。
...
- **标签：** `ai-writing`, `agent-skills`, `novel-writing`
- **推荐理由：** 内置小说、短剧、游戏、视频四大写作工作台，一站式AI创作流程
...
- **标签：** `multimodal`, `agent-skills`, `computer-vision`
- **推荐理由：** 赋予AI代理视听感知能力，视频音频分析转可验证证据
...
- **推荐理由：** 全流程数学建模技能，支持国赛美赛，GitOps流水线。
...
- **标签：** `cordis`, `skill-management`, `audit`
...
- **标签：** `agent-skills`, `research`, `marketing`, `business`
...
- **标签：** `agent-skills`, `cross-platform`, `workflow`
- **推荐理由：** 将经验转化为跨平台可重复执行的技能。
...
- **推荐理由：** 多Agent金融分析系统，支持skill扩展和IM盯盘。
...
- **标签：** `plugin-discovery`, `verification`, `automation`
- **推荐理由：** 自动搜索安装并验证DSH插件的技能工具。
...
- **标签：** `security`, `pentest`, `reverse-engineering`, `ctf`
...
- **推荐理由：** 内置25个工程技能，开发效率提升10倍，专注GitHub
...
- **标签：** `agent-skills`, `dsh-plugin`, `deepseek-harness`
- **推荐理由：** AI编程导师，扫描架构、生成阶梯教程、代码审查
...
- **标签：** `spec-programming`, `agent-skill`, `development`
- **推荐理由：** 便携式规格驱动开发技能，适用于DSH等代理。
...
- **⭐ 星标：** 31
- **语言：** TypeScript
- **描述：** 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、���码组件和音频资产。
- **标签：** `agent-skills`, `video`, `remotion`
- **推荐理由：** 152张电影感镜头配方卡，搭配Remotion模板与音频资产
...
- **推荐理由：** 跨平台会话连续性技能，支持Codex和Claude Code
...
- **标签：** `agent-skill`, `plugin-dev`, `workflow`
- **推荐理由：** 开发DSH插件的Agent Skill，提供标准流程与最佳实践。
...
- **推荐理由：** 工程工作流：任务阶段、验证记录、提交检查与技能管理。

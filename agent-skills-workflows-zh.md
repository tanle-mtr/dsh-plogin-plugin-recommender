...
- **标签：** `dsh-plugin`, `meta-skill`, `knowledge-distillation`
- **推荐理由：** 将思维方式提炼为可复用智能体技能的工具。
...
- **标签：** `skills`, `marketplace`, `skill-md`, `automation`
- **推荐理由：** 最大技能市场，自动抓取整理，覆盖8大类别可直接安装
...
- **标签：** `preset`, `agent-bootstrap`
- **推荐理由：** 两阶段预设实现稳定可靠的Agent引导启动。
...
- **推荐理由：** 智能技能路由，SkillsBench上节省29.6%Token。
...
- **标签：** `dsh-plugin`, `skill`, `research`
- **推荐理由：** 自动搜索中国8大平台，生成有据可查研究报告
...
- **推荐理由：** AI小说创作：灵感、角色、世界观、章节写作、审稿全流程
...
- **推荐理由：** 88个开源Agent技能，覆盖调研营销与商业自动化
...
- **推荐理由：** AI基础设施开发专用技能集合，支持编写、优化和调试
...
- **标签：** `ctf`, `security`, `pentest`, `reverse-engineering`
- **推荐理由：** 完整的逆向工程和渗透测试技能集，适用于安全研究
...
- **推荐理由：** Superpowers的TDD、调试、规划和协作技能
...
- **标签：** `skills-deck`, `productivity`, `engineering`
- **推荐理由：** 内置25个工程与效率技能，侧边栏直接调用
...
- **标签：** `gongwen`, `docx`, `document`
- **推荐理由：** 完整公文全流程处理技能，含格式检查与模板生成
...
- **标签：** `workbench`, `skills`, `dsh-plugin`
...
- **标签：** `multi-agent`, `dsh-plugin`, `collaboration`
- **推荐理由：** 多Agent团队协作，支持独立模型、技能和共享工作区。
...
- **标签：** `quality-gate`, `engineering-discipline`, `dsh-plugin`
- **推荐理由：** 工程纪律质量门禁：验证需求、测试实现、确保交付。
...
- **推荐理由：** 面向AI Agent的11项测试工程技能框架，支持测试自动化。
...
- **标签：** `code-simplification`, `dsh-plugin`, `codex`
- **推荐理由：** 从DSH官方模式改编的代码简化技能，适用于Codex。
...
- **标签：** `skillhub`, `dsh-plugin`
- **推荐理由：** 腾讯SkillHub官方文档与DSH集成
...
- **标签：** `math`, `agent`, `dsh-plugin`
- **推荐理由：** 多Agent数学建模，5角色+33模型+自动论文
...
- **标签：** `math-modeling`, `skill`
- **推荐理由：** 全流程数学建模技能：数据/编程/写作
...
- **标签：** `skill`, `agent-skills`
- **推荐理由：** 开发DSH插件的Agent技能。

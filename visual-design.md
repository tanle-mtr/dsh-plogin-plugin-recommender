...
- **Why use it:** Self-contained HTML diagrams with motion and crisp explanations
...
- **Why use it:** 530+ image prompts with industrial templates and skill reuse
...
- **Tags:** `design`, `visual`, `dsh-plugin`, `ppt`
...
- **Why use it:** Transform legal case materials into publication-ready timeline diagrams
...
- **Tags:** `ai-video`, `ai-image`, `storyboard`, `text-to-video`
- **Why use it:** AI video/image/audio generation and editing skills with knowledge corpus
...
- **Why use it:** 6 design style presets (dark-saas, apple-minimal, neo-neu...) to avoid generic AI look.

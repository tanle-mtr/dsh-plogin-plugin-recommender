...
- **Tags:** `architecture-as-code`, `diagrams-as-code`, `dsh-plugin`
- **Why use it:** Generate beautiful self-contained architecture diagrams.
...
- **Why use it:** 530+ image prompts and 20+ reusable design skills.
...
- **Tags:** `design`, `agent`, `ui`
- **Why use it:** AI-native vector design with Agent Teams and Design-as-Code workflow
...
- **⭐ Stars:** 63
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把���乱的诉讼图重画成能进材料的图，直接读案件材料画准一张时间轴，并提供庭前三大法宝（大事记表、庭审对抗图、法律关系图）。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `visualization`, `legal`, `timeline`
- **Why use it:** Litigation timeline, event charts & legal relationship diagrams for lawyers.
...
- **Tags:** `ai-video`, `ai-image`, `directorx`, `deepseek-harness`
...
- **Why use it:** Real-time token usage and cost charts for DeepSeek API

...
- **标签：** `mascot`, `pets`, `skins`
- **推荐理由：** 多平台 AI 代理的动画宠物吉祥物画廊。
...
- **标签：** `theme`, `ui`, `deepseek-harness-plugin`
- **推荐理由：** 可定制磨砂玻璃主题，视觉效果出色且不修改源码。
...
- **标签：** `theme`, `dsh-plugin`, `skins`
- **推荐理由：** 34款opencode经典配色一键切换，重启后主题持久保存。

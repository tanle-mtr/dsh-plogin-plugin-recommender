...
- **标签：** `theme`, `skin`, `whale`
- **推荐理由：** 鲸鱼娘系列皮肤美化DSH界面，提供可爱动漫风格主题定制体验。
...
- **标签：** `theme`, `glass-effect`, `customization`
- **推荐理由：** 高自由度毛玻璃主题，可自定义模糊度和背景效果。
...
- **推荐理由：** 动态海洋主题，支持波浪动画与玻璃拟态效果，视觉惊艳

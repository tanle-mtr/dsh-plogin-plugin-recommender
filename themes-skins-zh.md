...
- **标签：** `skin`, `theme`, `whale`
- **推荐理由：** 鲸鱼娘主题皮肤系列，美化DeepSeek Harness界面
...
- **标签：** `theme`, `glass-ux`, `customizable`
- **推荐理由：** 高度可定制的磨砂玻璃主题，不改原DSH源码
...
- **标签：** `theme`, `webgpu`, `visual`
- **推荐理由：** 基于WebGPU的海洋主题视觉皮肤，沉浸式界面体验。
...
- **标签：** `background`, `webui`, `themes`, `dsh-plugin`
- **推荐理由：** 可自定义Web背景，支持预设与实时预览

...
- **标签：** `mascot`, `pixel-art`, `theme`, `animation`, `pet`, `terminal`
- **推荐理由：** 社区动画宠物画廊，为你的编码Agent终端增添个性化萌趣体验。
...
- **标签：** `dsh-plugin`, `skin`, `themes`
- **推荐理由：** 鲸鱼娘主题皮肤，高人气美化插件。
...
- **标签：** `theme`, `glass-morphism`, `ui-customization`, `desktop`
- **推荐理由：** 高自由度磨砂玻璃主题，支持自定义模糊度与壁纸
...
- **推荐理由：** 基于WebGPU的海洋主题皮肤，含Three.js视觉特效

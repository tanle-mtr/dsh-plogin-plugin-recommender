...
- **标签：** `mascot`, `pixel-art`, `sprites`, `dsh-plugin`
- **推荐理由：** CLI编码Agent的动画吉祥物宠物公开画廊
...
- **标签：** `skin`, `animated`, `threejs`
- **推荐理由：** 实时动画海洋主题，可调波浪、日落和玻璃效果
...
- **标签：** `background`, `customization`
- **推荐理由：** 可自定义DSH网页背景，支持预设和自动压缩

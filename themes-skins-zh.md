...
- **标签：** `theme`, `ui`, `glassmorphism`, `customizable`
- **推荐理由：** 磨砂玻璃质感主题，顶栏侧边栏壁纸等均可自由调节。
...
- **标签：** `theme`, `ocean`, `webgpu`, `threejs`
- **推荐理由：** WebGPU海洋主题皮肤，为DSH网页端提供动态沉浸式背景。

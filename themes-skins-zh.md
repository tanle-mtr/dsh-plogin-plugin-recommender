...
- **标签：** `theme`, `desktop-ui`, `glassmorphism`
- **推荐理由：** 高自由度磨砂玻璃主题，支持自定义壁纸和模糊度
...
- **标签：** `theme`, `webgpu`, `threejs`, `ocean-skin`
- **推荐理由：** 基于WebGPU和Three.js的海洋主题沉浸式视觉皮肤
...
- **标签：** `theme`, `skins`, `opencode`, `dsh-plugin`

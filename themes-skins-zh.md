...
- **标签：** `skin`, `theme`, `whale`, `dsh-plugin`
- **推荐理由：** 鲸鱼娘系列皮肤，为DeepSeek Harness提供可爱视觉定制。
...
- **推荐理由：** 上传自定义图片或使用预设切换Web背景，实时预览自动保存

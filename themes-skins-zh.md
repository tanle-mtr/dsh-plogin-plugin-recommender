...
- **标签：** `mascot`, `pixel-art`, `animated-pets`, `ui-theme`
- **推荐理由：** 多平台编码Agent卡通宠物展示画廊
...
- **标签：** `skin`, `animated`, `ocean`, `chrome-extension`
- **推荐理由：** 动态海洋主题，支持波浪、日落和磨砂效果调节。

...
- **标签：** `dsh`, `dsh-plugin`
- **推荐理由：** 鲸鱼娘系列皮肤，专为DeepSeek Harness提供视觉美化。
...
- **推荐理由：** 高度可定制的磨砂玻璃主题，可调模糊度、磨砂度和背景。
...
- **推荐理由：** 实时海洋动态主题，含波浪、日落效果及可调磨砂玻璃透明度。
...
- **标签：** `themes`, `customization`
- **推荐理由：** 支持自定义图片、预设氛围和实时预览的背景主题插件。

...
- **标签：** `pixel-art`, `developer-tools`, `dsh-plugin`
- **推荐理由：** 动画宠物画廊，为编码Agent增添个性
...
- **标签：** `deepseek-harness-plugin`, `theme`
- **推荐理由：** 高自由度磨砂玻璃主题，支持自定义壁纸与模糊度。
...
- **标签：** `webui`, `dsh-plugin-market`, `personalization`
- **推荐理由：** 支持自定义图片与预设氛围，实时预览所见即所得

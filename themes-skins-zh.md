...
- **标签：** `mascot`, `pixel-art`, `skins`
- **推荐理由：** Animated pixel-art pet mascots for agents
...
- **标签：** `dsh-plugin`, `theme`
- **推荐理由：** Whale girl themed skin series for DSH
...
- **推荐理由：** Glassmorphism theme with full visual customization controls
...
- **推荐理由：** WebGPU ocean theme with Three.js visuals for DSH
...
- **标签：** `theme`, `ui`
- **推荐理由：** 34 opencode color themes, one-click apply, persists restarts
...
- **推荐理由：** Custom backgrounds with presets and real-time preview

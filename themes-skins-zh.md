...
- **标签：** `mascot`, `pixel-art`, `cute`
- **推荐理由：** 动画宠物画廊，为Agent增添趣味视觉
...
- **推荐理由：** 鲸鱼娘系列皮肤，为DeepSeek Harness提供可爱视觉主题定制。
...
- **⭐ 星标：** 396
- **语言：** JavaScript
- **描述：** 是���层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。

...
- **标签：** `ocean-skin`, `glassmorphism`, `animated-background`
- **推荐理由：** 动态海洋主题，支持玻璃态和实时波浪效果
...
- **标签：** `themes`, `webui`, `customization`
- **推荐理由：** 支持上传自定义图片或切换预设氛围背景

...
- **标签：** `pixel-art`, `mascot`, `customization`
- **推荐理由：** 多款AI编程工具的动态宠物画廊自定义主题
...
- **推荐理由：** 磨砂玻璃主题，可自定义模糊度和磨砂效果，零源码修改
...
- **标签：** `background`, `theming`, `ui-customization`
- **推荐理由：** 支持自定义背景图和预设主题，实时预览效果佳。

...
- **标签：** `chrome-extension`, `deepseek-harness`, `theme`, `threejs`, `webgpu`
- **推荐理由：** WebGPU海洋主题，Three.js驱动视觉效果出色
...
- **标签：** `webui`, `customization`
- **推荐理由：** 支持自定义背景和预设氛围，实时预览自动保存

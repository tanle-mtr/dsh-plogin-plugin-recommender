...
- **标签：** `theme`, `dsh-plugin`, `desktop-app`
- **推荐理由：** 高自由度磨砂玻璃主题，支持全面自定义
...
- **标签：** `theme`, `chrome-extension`, `threejs`, `webgpu`
- **推荐理由：** WebGPU海洋主题皮肤，Three.js视觉特效

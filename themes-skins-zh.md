...
- **⭐ 星标：** 371
- **语言：** JavaScript
- **描述：** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任��一行源码。
- **标签：** `theme`, `dsh-plugin`, `ui`
- **推荐理由：** 高度可定制的磨砂玻璃质感主题，无需修改源码
...
- **标签：** `theme`, `ocean`, `webgpu`, `chrome-extension`
...
- **标签：** `color-scheme`, `customization`, `dark-mode`, `opencode`, `skins`, `theme`, `ui`
- **推荐理由：** 一键切换 34 款 opencode 经典配色，持久保存。

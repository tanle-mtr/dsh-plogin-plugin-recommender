...
- **标签：** `mascot`, `pixel-art`, `ui-customization`, `themes`
- **推荐理由：** 公共动态宠物画廊，为各大AI编码工具提供UI美化。
...
- **标签：** `dsh-plugin`, `theme`, `webgpu`
- **推荐理由：** WebGPU海洋主题皮肤，沉浸式DSH界面体验。

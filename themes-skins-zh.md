...
- **标签：** `color-scheme`, `dark-mode`, `theme-engine`, `ui`
- **推荐理由：** 34款经典配色一键应用，重启不丢失，支持tokyonight、dracula等。
...
- **标签：** `dsh-plugin`, `webui`, `deepseek-harness`
- **推荐理由：** 支持自定义壁纸与预设氛围，实时预览所见即所得。

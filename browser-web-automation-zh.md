...
- **标签：** `browser-extension`, `dsh-plugin`, `chat-management`, `chrome-extension`
- **推荐理由：** AI聊天平台增强套件，含提示词管理。
...
- **标签：** `web-search`, `dsh-plugin`, `free`
- **推荐理由：** 免费无需注册的Web搜索插件，适用于所有模型
...
- **推荐理由：** 基于Playwright的强大浏览器自动化，深度集成DSH

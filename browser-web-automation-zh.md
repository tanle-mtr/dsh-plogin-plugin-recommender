...
- **标签：** `browser-extension`, `chrome-extension`, `prompt-manager`
- **推荐理由：** 浏览器扩展，增强主流AI聊天平台体验
...
- **推荐理由：** 本地私有跨平台AI内容发现Agent，支持多平台自动抓取。
...
- **标签：** `dsh-plugin`, `browser-use`, `automation`
- **推荐理由：** AI Agent控制真实已登录浏览器，不中断用户工作流。
...
- **推荐理由：** 无需视觉API即可直接操控浏览器的Chrome侧边栏插件
...
- **推荐理由：** Tabbit浏览器插件，通过Playwright自动化浏览任务。

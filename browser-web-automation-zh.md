...
- **推荐理由：** Gemini/Claude/ChatGPT增强套件与提示词管理
...
- **标签：** `web-ui`, `marketplace`, `plugin-aggregator`
- **推荐理由：** Web插件聚合生态包，一切皆插件，创意工坊分发。
...
- **推荐理由：** 跨平台内容发现Agent，支持B站、小红书等8个平台。
...
- **标签：** `search`, `web`
- **推荐理由：** 最强的免费网页搜索插件，无需注册即可为所有模型提供搜索。

...
- **推荐理由：** 跨平台内容发现Agent，支持B站/YouTube/小红书等多平台
...
- **标签：** `mobile-automation`, `ios-simulator`, `mcp`
- **推荐理由：** 22个Agent工具控制iOS模拟器及真机

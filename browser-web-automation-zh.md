...
- **推荐理由：** 跨浏览器AI增强套件，统一Prompt管理与提升体验。
...
- **标签：** `ai-agent`, `content-discovery`, `dsh-plugin`, `privacy-first`
- **推荐理由：** 跨平台内容发现代理，覆盖B站、抖音、YouTube等。
...
- **标签：** `web-search`, `free`, `browser`, `no-api-key`
- **推荐理由：** 免费网络搜索桥接插件，无需注册即可使用

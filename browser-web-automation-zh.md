...
- **标签：** `anti-detect-browser`, `browser-automation`, `playwright`, `mcp-server`
- **推荐理由：** 反检测浏览器，指纹伪装和无限本地配置文件
...
- **标签：** `mobile-automation`, `ios-simulator`, `ui-automation`
- **推荐理由：** 22种Agent工具实现iOS模拟器和真机自动化。

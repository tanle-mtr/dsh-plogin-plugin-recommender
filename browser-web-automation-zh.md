...
- **标签：** `browser-extension`, `prompt-manager`, `chrome-extension`
...
- **标签：** `content-discovery`, `cross-platform`, `browser-automation`, `privacy-first`
- **推荐理由：** 跨平台内容发现代��，支持B站/小红书/抖音/YouTube等多平台抓取。
...
- **标签：** `ios`, `automation`, `simulator`, `mobile-testing`
- **推荐理由：** 对话内运行iOS模拟器与真机，22个Agent工具实现自动化控制
...
- **标签：** `browser-automation`, `mcp-server`, `fingerprint`
- **推荐理由：** 持久浏览器身份与指纹伪装，支持安卓模拟

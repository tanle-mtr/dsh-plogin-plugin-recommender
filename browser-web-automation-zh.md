...
- **标签：** `browser-use`, `automation`, `extension`
- **推荐理由：** 非侵入式浏览器自动化，保持登录状态
...
- **标签：** `content-discovery`, `browser`, `multi-platform`, `privacy`
...
- **推荐理由：** 基于Playwright的Tabbit浏览器自动化插件套件。

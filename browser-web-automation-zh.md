...
- **标签：** `browser`, `web-automation`, `content-discovery`, `bilibili`
- **推荐理由：** 跨平台内容发现Agent，本地爬取B站/YouTube/Reddit等平台。
...
- **标签：** `ios`, `automation`, `mcp`, `mobile`
- **推荐理由：** iOS模拟器及USB iPhone自动化，22个智能体控制工具

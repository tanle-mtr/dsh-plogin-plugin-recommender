...
- **Why use it:** Portable, user-owned memory layer with Markdown-native RAG.
...
- **Tags:** `long-term-memory`, `rag`, `mcp`, `skills`
...
- **Why use it:** Persistent memory layer backed by Milvus with hybrid semantic search for agents
...
- **Why use it:** Shared persistent memory hub connecting all AI agents with full user control
...
- **Tags:** `context`, `dsh-plugin`, `management`, `ui`
- **Why use it:** Best context management plugin with dashboard, sidebar, and command interface

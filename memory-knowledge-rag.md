...
- **Tags:** `knowledge`, `ai-encyclopedia`, `rag`
- **Why use it:** Comprehensive AI encyclopedia covering skills, RAG, MLOps, and learning paths
...
- **Why use it:** Turns SKILL.md files into retrieval-ready agent skill corpora with search

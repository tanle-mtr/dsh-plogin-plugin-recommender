...
- **Tags:** `agent-memory`, `rag`, `local-first`
- **Why use it:** Local-first portable memory layer, user-owned and cross-app
...
- **Tags:** `agent-memory`, `stateful`, `context-engineering`
- **Why use it:** Dedicated memory library for building stateful agents
...
- **Why use it:** Memory management kit for agents: remember context and refine knowledge across sessions
...
- **Why use it:** Persistent unified memory layer for all AI agents backed by Markdown and Milvus vector search
...
- **Tags:** `memory`, `agent`, `RAG`, `long-term-memory`
...
- **Tags:** `agent-memory`, `semantic-search`, `vector-search`, `skill-corpus`
- **Why use it:** Turns scattered SKILL.md files into searchable agent-skill corpora

...
- **Why use it:** Portable, user-owned memory layer enabling cross-app persistent agent memory
...
- **Why use it:** Self-evolving memory OS with hybrid retrieval achieving 35% token savings
...
- **Why use it:** Context dashboard and insight management tool
...
- **Why use it:** Comprehensive AI encyclopedia covering skills, RAG, MCP, and learning paths.
...
- **Tags:** `skill-md`, `semantic-search`, `embeddings`
- **Why use it:** Turns SKILL.md files into curated retrieval-ready corpora with semantic search.
...
- **Tags:** `memory`, `powercontext`, `skills`
- **Why use it:** Centralized memory, skills, and experience sharing via PowerContext

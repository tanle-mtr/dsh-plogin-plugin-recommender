...
- **标签：** `fimga`, `flutter`, `react`, `vibedesign`, `mcp`
...
- **标签：** `design`, `ppt`, `visual`, `dsh-plugin`
- **推荐理由：** AI设计工作室，支持模板、PPT编辑和原型设计
...
- **推荐理由：** 将诉讼材料可视化生成时间轴与案件图，支持直接导入法律材料。
...
- **标签：** `ai-video`, `image`, `audio`, `storyboard`
- **推荐理由：** AI视频/图像/音频创作，含剧本板和知识库工具

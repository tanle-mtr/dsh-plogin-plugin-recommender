...
- **推荐理由：** Open-source Claude Design alternative with local-first desktop
...
- **标签：** `diagrams-as-code`, `agent-skills`, `dsh-plugin`
- **推荐理由：** Agent skill generating beautiful architecture and sequence diagrams
...
- **推荐理由：** AI-native vector design with Agent Teams
...
- **推荐理由：** AI-powered design studio with templates, PPT, and prototyping
...
- **标签：** `genui`, `interactive`, `charts`
- **推荐理由：** Generates interactive UI components inline in chat responses
...
- **推荐理由：** Preview and edit OpenPencil .op docs in-chat
...
- **推荐理由：** Generate AI images directly in DSH chats
...
- **标签：** `design`, `ui`, `styles`, `aesthetics`
- **推荐理由：** 6 design style presets to avoid generic AI-looking sites
...
- **标签：** `ai-image`, `ai-video`
- **推荐理由：** AI video/image/audio skills with configurable model tools

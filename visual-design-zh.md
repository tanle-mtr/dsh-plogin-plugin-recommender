...
- **标签：** `diagrams-as-code`, `mermaid-alternative`, `architecture`
- **推荐理由：** 代码生成架构与序列图，所见即所得
...
- **标签：** `design`, `agent-team`, `vibedesign`, `flutter`
- **推荐理由：** 首款开源AI原生矢量设计工具，支持Agent协作
...
- **标签：** `vision`, `ocr`, `image-to-text`, `agent-skills`
- **推荐理由：** 为纯文本编码代理添加视觉/OCR能力，输出结构化JSON。
...
- **标签：** `design`, `ui`, `openpencil`, `visual`
...
- **标签：** `deepseek-harness`, `design`, `ui`, `vibe-coding`, `web-design`
- **推荐理由：** 6种视觉风格包，避免AI生成的千篇一律，提升设计质感。

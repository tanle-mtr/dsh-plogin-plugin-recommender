...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 841,089 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 23:27:44 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,895 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,736 | Local-first design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,059 | Deploy multi-agent swarms with coordinated autonom |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 23 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (23)
...
- **Why use it:** Comprehensive DSH plugin development tutorial for beginners
...
- **Why use it:** Multi-engine enterprise workspace for Codex, DSH, and OpenCode agents
...
- **Tags:** `harness-tools`, `preset`, `standard`
- **Why use it:** Minimal-aligned bootstrap to full Standard tools preset (98/99)
...
- **Why use it:** Vision bridge enabling image input for any text-only coding agent
...
- **Why use it:** One-click model switching between major AI coding agents
...
- **Tags:** `agentic-runtime`, `ai-coding`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop AI coding application
...
- **Tags:** `agent`, `coding`, `collaboration`, `dsh-plugin`
- **Why use it:** Unifies Claude Code, Codex, Grok and other agents into a collaborative team.
...
- **Why use it:** Superpowers skill port for Reasonix harness
...
- **Tags:** `ctf`, `security`, `reverse-engineering`, `pentest`
...
- **Tags:** `agent-skill`, `dsh-plugin`, `plugin-development`
- **Why use it:** Agent skill for building DSH plugins: slots, tools, and packaging
...
- **Tags:** `dsh-plugin`, `ocr`, `vision`, `image-reading`
- **Why use it:** OCR and pixel-to-text for text-only DSH models
...
- **Why use it:** Agent skill for building and packaging DSH plugins from scratch
...
- **Why use it:** Multi-agent collaboration framework
...
- **Tags:** `plugin-dev`, `development`, `cordis`
...
- **Why use it:** Practical DSH plugin dev guide covering common pitfalls and solutions.
...
- **Tags:** `plugin-dev`, `testing`, `skills`
...
- **Tags:** `discovery`, `registry`, `plugin-manager`
- **Why use it:** Unified plugin discovery merging multiple sources with deduplication.
...
- **Why use it:** CLI tool for discovering, installing, and managing DSH plugins.
...
- **Tags:** `publisher`, `plugin-manager`
- **Why use it:** One-click plugin publishing assistant with validation and PR generation.
...
- **Why use it:** Modern desktop client designed natively for the DSH plugin ecosystem.
...
- **Tags:** `dsh-web-ui`, `desktop-extension`, `wallpaper`
- **Why use it:** Web GUI + Wallpaper Engine support with mobile/SSH remote access
...
- **Tags:** `tui`, `dsh-plugin`, `ui-extension`
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, and context progress
...
- **Tags:** `desktop`, `mcp`, `electron`
- **Why use it:** Local-first desktop companion with animated pets and SDK
...
- **Why use it:** Lightweight Tauri desktop app with zero environment setup
...
- **Why use it:** Local AI desktop workspace integrating DSH sessions and files
...
- **Tags:** `desktop-app`, `agent`, `multi-model`, `dsh-plugin`
- **Why use it:** Local-first multi-model agent desktop app with privacy focus.
...
- **Why use it:** Generates interactive UI components inline within DSH assistant replies.
...
- **Tags:** `desktop-app`, `electron`, `cross-platform`, `dsh-plugin`
- **Why use it:** CodePilot-inspired cross-platform desktop client with rich plugin suite.
...
- **Why use it:** Native Windows desktop GUI with SSH, skills, mobile remote access
...
- **Tags:** `taskboard`, `ui`, `management`
- **Why use it:** Native taskboard with SQLite projects and review
...
- **Why use it:** Real-time token usage charts and API cost tracking
...
- **Why use it:** Floating HUD panel showing git, MCP, skills, and token stats
...
- **Why use it:** All-in-one Tauri desktop with DB, SSH, Docker, and AI
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI with sidebar and ModLens
...
- **Why use it:** Turn raw docs into queryable RAG, reasoning agent, and Wiki.
...
- **Why use it:** Local-first portable memory layer across all AI agents and apps
...
- **Why use it:** Hybrid-retrieval memory OS with 35% token savings and skill reuse
...
- **Why use it:** Provides unlimited persistent memory for AI agents
...
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, and learning paths.
...
- **Why use it:** Open-source smartisan-style notes with Docker deploy, skill support
...
- **Tags:** `rag`, `embedding`, `semantic-search`
- **Why use it:** Turn SKILL.md files into retrieval-ready corpus
...
- **Tags:** `memory`, `long-term`, `mcp`
- **Why use it:** Durable long-term agent memory with recall
...
- **Tags:** `agent-skill`, `knowledge-base`, `plugin-development`, `cordis`
- **Why use it:** On-demand agent skill with official DSH plugin dev docs (EN/ZH)
...
- **Tags:** `agent-handoff`, `session-memory`, `continuity`
- **Why use it:** Session continuity memory across agents
...
- **Why use it:** Centralized memory, recall, and handoff via PowerContext server
...
- **Why use it:** Bridges Claude Code memory and skills into DSH
...
- **Why use it:** Deploy multi-agent swarms with coordinated autonomous workflows.
...
- **Why use it:** Self-evolving agent with memory, skills, and multi-channel support.
...
- **Tags:** `agent-skills`, `prompt-engineering`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `routing`, `cordis`
- **Why use it:** Task-aware reasoning-mode router with measured performance gains
...
- **Why use it:** Self-improving agent OS with continuous LLM evaluation loop
...
- **Why use it:** Intelligently routes and orchestrates local skills and harness workflows
...
- **Tags:** `agent-skills`, `architecture`, `spec-driven`
...
- **Why use it:** Enables text-only LLMs to understand images and automate GUI
...
- **Why use it:** Human-in-the-loop task manager with mobile and web control
...
- **Tags:** `agent-teams`, `multi-agent`, `workflows`
...
- **Why use it:** Native DSH vision toolkit for image Q&A and OCR automation
...
- **Why use it:** Turn coding experience into repeatable, shareable skills
...
- **Why use it:** Skill that auto-searches, installs, and verifies DSH plugins
...
- **Why use it:** Novel writing and short-drama production skill powered by Oh Story
...
- **Why use it:** AI infra agent skills for coding & debugging
...
- **⭐ Stars:** 65
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI ��程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `dsh-plugin`, `agent-skill`, `mentor`
- **Why use it:** AI mentor that teaches coding via project analysis and code review
...
- **Why use it:** 88 agent skills for research, marketing, and business workflows
...
- **Why use it:** WorkBuddy-style skill selection
...
- **Why use it:** Adapted code simplification skill
...
- **Why use it:** Centralized skill management
...
- **Tags:** `image`, `vision`, `generation`
- **Why use it:** Image generation and reading
...
- **Tags:** `skills`, `mcp`, `web-gui`, `manager`
- **Why use it:** Web GUI for skills/MCP management
...
- **Why use it:** Governance skill with version pinning and offline verification.
...
- **Tags:** `gongwen`, `docx`, `office`
- **Why use it:** Full Chinese official document pipeline: format, review, and generation.
...
- **Tags:** `practices`, `engineering`, `skill`
- **Why use it:** Engineering discipline distilled into a portable agent skill.
...
- **Tags:** `canvas`, `agent`, `creative`
- **Why use it:** Infinite canvas with creative agent skills for generative workflows.
...
- **Why use it:** Dedicated Godot 4.x game dev skill with GDScript support
...
- **Why use it:** Records macOS workflows and converts them to reusable agent skills
...
- **Why use it:** Math modeling enhancement with 17 manual skill cards
...
- **Why use it:** Virtual product team agent preset for collaborative PM-to-engineering workflows
...
- **Why use it:** Manage skills and MCP tools via Web UI
...
- **Why use it:** Paste JSON to connect MCP servers instantly with hot-load
...
- **Tags:** `chatgpt`, `oauth`, `codex`
- **Why use it:** OAuth binds ChatGPT account to DSH for direct ChatGPT model access
...
- **Why use it:** Generate beautiful architecture and sequence diagrams as code.
...
- **Why use it:** 20+ industrial prompt templates with 470+ reverse-engineered cases
...
- **Tags:** `design-tool`, `vibedesign`, `agent-team`
...
- **Tags:** `video-generation`, `agent-skill`, `dsh-plugin`
...
- **Why use it:** AI-powered design studio with template marketplace and PPT generation.
...
- **Why use it:** Generate images directly within DeepSeek Harness conversations
...
- **Why use it:** Edit OpenPencil docs directly in conversation
...
- **Tags:** `agent-skills`, `visualization`, `legal-tech`, `svg`
- **Why use it:** Generate litigation timelines and legal diagrams in SVG
...
- **Tags:** `design`, `aesthetics`, `ui`, `styles`
- **Why use it:** 6 design aesthetics style packs
...
- **Tags:** `ai-video`, `directorx`, `visual`
- **Why use it:** AI video/image/audio creation skills with configurable model tools.
...
- **Why use it:** Local-first cross-platform AI content discovery across 8 major platforms
...
- **Why use it:** Let AI agents use your real logged-in browser without interrupting your work via CLI extension
...
- **Why use it:** Controls your browser directly via Chrome sidebar without vision capabilities.
...
- **Why use it:** Live iOS Simulator and USB iPhone control inside DSH conversation.
...
- **Why use it:** Search 65,600+ API docs across 20 major Chinese platforms
...
- **Why use it:** First unified virtual filesystem abstraction for all AI agents
...
- **Why use it:** Plugin radar and curated top-50 list with real installation path testing and auto-updating index
...
- **Why use it:** Best context insight dashboard and management for DSH
...
- **Tags:** `oauth`, `subscription`, `infrastructure`, `dsh-plugin`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as free LLM backends via OAuth.
...
- **Tags:** `cost-tracking`, `tokens`, `utility`
- **Why use it:** Tracks session/daily token costs and API balance in real-time
...
- **Why use it:** Runs Pi agent extensions as native DSH plugins via compatibility layer
...
- **Why use it:** One-click browse and install all DSH plugins
...
- **Why use it:** Crash rescue with undo and SAFE MODE recovery
...
- **Tags:** `market`, `webui`, `community`
- **Why use it:** Web GUI community plugin market with one-click install
...
- **Why use it:** Core DSH infra: plugin console + official dev skill generator
...
- **Tags:** `dsh-plugin`, `dsh-plugins`, `deepseek-harness`
...
- **Tags:** `sync`, `bridge`, `mcp`, `codex`
- **Why use it:** Bidirectional bridge for Codex/DSH
...
- **Tags:** `audit`, `context`, `ui`, `tool`
- **Why use it:** Context audit and conflict detection
...
- **Tags:** `backup`, `config`, `migration`, `webdav`
- **Why use it:** Full config backup and migration
...
- **Tags:** `package-manager`, `assets`, `skills`, `kit`
- **Why use it:** 42-skill package manager for agents
...
- **Tags:** `awesome-dsh`, `dsh-plugin`, `utilities`
- **Why use it:** Detects and resolves plugin-to-plugin and version conflicts in DSH
...
- **⭐ Stars:** 2
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件���示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
...
- **Why use it:** Public animated pet gallery with pixel art for multiple coding agents
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness desktop
...
- **Why use it:** Fully customizable frosted glass theme for DSH web UI with live preview.
...
- **Why use it:** Beautiful WebGPU ocean-themed visual skin for DSH
...
- **Why use it:** One-click apply 34 opencode classic themes, survives restarts.
...
- **Why use it:** Customizable web backgrounds with presets and auto-save
...
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days and generates cited research reports
...
- **Tags:** `awesome-list`, `curated`, `bilingual`, `dsh-plugin`
- **Why use it:** Curated bilingual resource list of DSH plugins, tools, and integrations.
...
- **Tags:** `awesome-list`, `curated`, `verified`, `dsh-plugin`
- **Why use it:** Daily-verified plugin directory with clear suitability guidance for each.
...
- **Tags:** `web-search`, `free`, `bridge`, `dsh-plugin`
...
- **Tags:** `learning`, `marketplace`, `best-practices`, `dsh-plugin`
- **Why use it:** Learn DSH internals, discover plugins, and find best practices easily.
...
- **Tags:** `awesome-list`, `guide`, `bilingual`, `dsh-plugin`
- **Why use it:** Ultimate bilingual DSH guide covering quickstart, tools, and curated plugins.
...
- **Why use it:** Curated plugin list covering productivity tools
...
- **Why use it:** 24 curated stock/finance/quant DSH plugins
...
- **Why use it:** Curated quality-checked plugin list for 2026 DSH ecosystem discovery
...
- **Why use it:** Community-curated collection of useful DSH plugins for quick discovery
...
- **Why use it:** Plugin manual and navigation with scenario-based selection and risk info
...
- **Tags:** `awesome-list`, `plugin-directory`, `ai-agents`
...
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for DSH ecosystem insights
...
- **Tags:** `plugin-portal`, `static-site`, `awesome-dsh-plugin`
...
- **Why use it:** Original awesome list now migrated to github.com/awesome-dsh-plugin
...
- **Why use it:** In-agent plugin search across npm and curated lists for DSH discovery
...
- **Tags:** `ai-agents`, `awesome-list`, `coding-agents`
- **Why use it:** AI-curated hourly-updated plugin list with 190+ plugins across 12 categories
...
- **Tags:** `dsh-bundle`, `dsh-plugin-verify`, `dsh-plugins`
- **Why use it:** Plugin bundle and verification tools for the DSH ecosystem
...
- **Why use it:** Privacy-focused, self-hosted resume builder with MCP support.
...
- **Tags:** `low-code`, `ai-agent`, `dsh-plugin`
...
- **Why use it:** Curated meta-list of all DSH plugins — essential discovery resource
...
- **Why use it:** Web simulation of a traditional Chinese spinning toy, zero dependency
...
- **Why use it:** Comprehensive curated directory of DSH tools and plugins
...
- **Why use it:** Curated DSH ecosystem resource list covering plugins, skills, MCPs
...
- **Why use it:** Plugin marketplace with 3100+ entries, search, rankings, and free API
...
- **Tags:** `marketplace`, `plugins`, `hub`
- **Why use it:** DSH plugin marketplace and hub for plugin discovery and management
...
- **Why use it:** Auto-maintained DSH plugin catalog updated every 4 hours
...
- **Tags:** `awesome-list`, `directory`, `plugin-catalog`
- **Why use it:** Comprehensive curated plugin directory
...
- **Tags:** `bazi`, `fengshui`, `niche`, `traditional`
- **Why use it:** Niche Bazi/Fengshui AI integration
...
- **Tags:** `photo`, `commemoration`, `community`
- **Why use it:** Beta test commemoration photo wall
...
- **Why use it:** Public plugin directory for ecosystem discovery and install commands.
...
- **Why use it:** Curated list of DSH plugins for community discovery.
...
- **Why use it:** Unofficial community plugin catalog for DSH
...
- **Why use it:** Curated verified DSH plugin directory with install guidance
...
- **Why use it:** Curated bilingual DSH plugin directory, ideal starting point.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Community-curated DSH plugin catalog.
...
- **Why use it:** Evidence-aware curated shortlist for DSH plugins.
...
- **Tags:** `awesome`, `curated-list`, `plugin-directory`, `registry`
- **Why use it:** Broad curated list covering models, tools, sandboxes, and UI plugins.
...
- **Why use it:** Industry-specific plugin directory (finance, law, HR, medical, etc.).
...
- **Why use it:** Full 1000+ DSH tool catalog sorted by GitHub stars.

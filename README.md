...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 854,636 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-24 18:48:25 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 191,589 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,041 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,276 | Deploy multi-agent swarms with autonomous workflow |
...
- [MCP Servers & Tools](#mcp-servers-&-tools) — 13 plugins
...
- [Research & Analysis](#research-&-analysis) — 6 plugins
...
- [MCP Servers & Tools](mcp-servers-tools) (13)
...
- [Research & Analysis](research-analysis) (6)
- [Other](other) (42)
---
...
- **Tags:** `coding-agent`, `cli`, `tui`, `deepseek`
- **Why use it:** Terminal-native AI coding agent with prefix-cache stability for long sessions
...
- **Why use it:** Unified agent orchestration platform with board-based task tracking across all devices.
...
- **Tags:** `dsh-plugin`, `agent`, `routing`
- **Why use it:** Task-aware reasoning-mode router with measured performance optimization.
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-orchestration`
- **Why use it:** Self-improving agent OS that gets smarter autonomously through loop engineering.
...
- **Tags:** `multi-agent-workspace`, `enterprise`, `visual-editor`
- **Why use it:** Enterprise-grade multi-engine agent workbench with visual editor and team support.
...
- **Tags:** `code-review`, `agent-skills`, `clean-architecture`
- **Why use it:** AI code review based on 12 classic engineering books with citations.
...
- **Why use it:** Architecture-aware coding agent with baseline-first, drift-checked workflows
...
- **Tags:** `vision`, `ocr`
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, screenshot-to-UI
...
- **Tags:** `security`, `audit`, `redteam`
- **Why use it:** Audits AI-generated code for hallucinated packages, missing safeguards and security vulnerabilities
...
- **Why use it:** Unifies multiple coding agents into a collaborative team with session dispatch capabilities
...
- **Tags:** `coding-agent`, `multimodal`, `orchestration`, `subagent`
...
- **Why use it:** Plugin infrastructure with browser console and official dev skills guide
...
- **Why use it:** Learn DSH plugin development with standard patterns and skill scaffolding
...
- **Why use it:** Manage plugin slots, Typert remotes, and credentials via agent skill
...
- **Tags:** `dsh-plugin`, `skill-picker`, `ui`
- **Why use it:** WorkBuddy-style skill picker for fast skill insertion in composer
...
- **Tags:** `capability-menu`, `mcp`, `control`
- **Why use it:** Unified control panel for MCP tool exposure level and execution mode
...
- **Tags:** `plugin-dev`, `audit`, `development`
- **Why use it:** Portable skill for developing and auditing DeepSeek Harness plugins
...
- **Tags:** `plugin-dev`, `docs`, `tutorial`
- **Why use it:** Practical DSH plugin dev docs covering cordis, tsconfig, zstd tips
...
- **Why use it:** Connect ChatGPT Plus via OAuth to use GPT models inside DSH.
...
- **Tags:** `dsh-web`, `dsh-web-ui`, `marketplace`
- **Why use it:** Web UI aggregation package for DSH ecosystem with marketplace distribution.
...
- **Why use it:** Animated pet gallery to personalize and decorate your AI coding assistant interface.
...
- **Why use it:** Extensible sidebar with built-in file editor, terminal, and Git.
...
- **Tags:** `desktop-companion`, `mcp`
- **Why use it:** Desktop companion platform with animated pets and rich plugin SDK
...
- **Tags:** `widget`, `desktop`
- **Why use it:** Cute floating whale widget tracking your DeepSeek account balance
...
- **Why use it:** Local-first desktop workspace for DSH sessions, files, web research and MCP
...
- **Tags:** `desktop`, `agent`, `tauri`
- **Why use it:** Local-first multi-model desktop AI agent with self-evolving skills and privacy focus
...
- **Tags:** `ui`, `interactive`, `gen-ui`
- **Why use it:** Generates interactive UI components like charts and forms inline in assistant replies
...
- **Tags:** `canvas`, `ui`, `workspace`
- **Why use it:** Canvas-based visual non-linear conversation workspace with session branching exploration
...
- **Why use it:** Full-featured Windows desktop client with GUI, SSH, mobile remote access, and plugin support.
...
- **Tags:** `task-management`, `taskboard`, `ui`, `web`
- **Why use it:** SQLite-backed taskboard with native Web UI for project management
...
- **Why use it:** GUI panel for managing skills and MCP servers in DeepSeek Harness
...
- **Why use it:** Persistent bottom bar showing model info, live balance, and pricing
...
- **Why use it:** Electron-based desktop wrapper integrating multiple DSH plugins and services.
...
- **Tags:** `rag`, `knowledge-base`, `wiki`, `vector-search`
- **Why use it:** Enterprise-grade LLM knowledge platform with RAG and self-maintaining wiki
...
- **Why use it:** Essential memory management kit for AI agents with RAG support.
...
- **Tags:** `memory`, `rag`
- **Why use it:** Provides unlimited persistent memory for AI agents across sessions
...
- **Tags:** `skill-md`, `embeddings`, `vector-search`, `information-retrieval`
...
- **Tags:** `long-term-memory`, `mcp`, `typescript`
...
- **Why use it:** Official plugin dev knowledge base and docs archive as on-demand skill
...
- **Tags:** `ai-agent`, `multi-model`, `skills`, `mcp`
- **Why use it:** Self-evolving agent with memory, knowledge, and multi-model support
...
- **Tags:** `no-code`, `low-code`, `business-systems`, `crm`
...
- **Why use it:** 20+ industrial prompt templates with 530+ reverse-engineered cases as skills
...
- **Tags:** `agent-skills`, `workflow`, `automation`
...
- **Why use it:** Transform AI conversations into organized, reusable cross-platform workflows
...
- **Tags:** `agent-teams`, `workflows`
- **Why use it:** Enables multi-agent team collaboration within the DSH ecosystem
...
- **Why use it:** Specialized skill for novel writing and short-drama production with Oh Story engine.
...
- **Why use it:** Turn experience into repeatable AI agent execution patterns across multiple platforms.
...
- **Tags:** `vision`, `multimodal`, `claude-code`, `browser-harness`
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot/UI/chart analysis automation.
...
- **Tags:** `plugin-discovery`, `agent-skills`, `github`
- **Why use it:** Auto-discovers, installs, and verifies GitHub plugins directly within DSH conversation.
...
- **Why use it:** Specialized skills for AI infra development and optimization
...
- **Tags:** `agent`, `workflow`
- **Why use it:** Agent workflow plugin for DeepSeek Harness
...
- **Why use it:** AI coding mentor that generates structured learning paths and code reviews
...
- **Tags:** `agent-skills`, `deep-research`
...
- **Why use it:** Portable spec-driven development skill for repository-native workflows
...
- **Why use it:** Cross-platform agent handoff with repository-local continuity memory
...
- **Why use it:** Chinese traditional wisdom AI agent: Bazi, Fengshui, I Ching, TCM fusion
...
- **Why use it:** Codex-compatible skill adapted from DSH code simplification workflow
...
- **Why use it:** 6 design aesthetic styles to avoid generic AI-generated website looks
...
- **Why use it:** Image reading, generation, and vision transcription via paste-and-run skills
...
- **Tags:** `skills`, `package`, `agents`
- **Why use it:** Comprehensive package with 42 skills and CLIs for AI agent engineering
...
- **Why use it:** Swift Cycle governance skill for structured, verifiable project workflows
...
- **Why use it:** Full Chinese official document workflow following GB/T 9704 national standard
...
- **Tags:** `skills`, `gamification`, `missions`
- **Why use it:** Game-like mission system with fog-of-war map and task-bar progression
...
- **Tags:** `video`, `image`, `directorx`
- **Why use it:** AI video/image/audio generation with storyboard and vision tools integrated
...
- **Why use it:** Engineering discipline skill emphasizing evidence-based development practices
...
- **Why use it:** Virtual product team agent preset simulating PM-Engineer-QA workflows.
...
- **Tags:** `agent-tools`, `pre-flight`, `plugin-matching`
- **Why use it:** Pre-flight plugin check that auto-injects relevant plugins for tasks.
...
- **Why use it:** First vision plugin for DSH — converts images to structured JSON evidence via OCR.
...
- **Tags:** `mcp`, `skills`, `plugin`
- **Why use it:** Web UI skill and MCP management interface
...
- **Why use it:** Plugin registry with verification and analytics support.
...
- **Why use it:** Auto-updated bilingual plugin catalog via GitHub Actions.
...
- **Why use it:** Simple bilingual DSH plugin collection.
...
- **Tags:** `awesome-list`, `curated`, `review`
- **Why use it:** Evidence-led curated directory with immutable commit reviews.
...
- **Tags:** `awesome-list`, `registry`, `models`, `ui`
- **Why use it:** Comprehensive registry covering models, tools, sandboxes, UI.
...
- **Tags:** `awesome-list`, `industry`, `curated`
- **Why use it:** Industry-focused plugin directory: finance, law, HR, healthcare.
...
- **Tags:** `registry`, `discovery`, `dedupe`
- **Why use it:** Merges multiple sources into a deduped plugin registry.
...
- **Why use it:** Official auto-generated Cordis plugin directory by cordis.run.
...
- **Tags:** `awesome-list`, `comprehensive`, `directory`
- **Why use it:** Full 1000+ repo DSH tool清单 sorted by stars.
...
- **Why use it:** Open-source design system with local-first desktop app and Figma alternative
...
- **Tags:** `agent-skills`, `mermaid-alternative`, `diagrams-as-code`
- **Why use it:** Generates verifiable architecture and sequence diagrams from text via self-contained HTML.
...
- **Tags:** `vibedesign`, `ui`, `design-as-code`
- **Why use it:** AI-native vector design tool with concurrent Agent Teams turning prompts into UI.
...
- **Why use it:** End-to-end Vox-style explainer video generation from a single topic.
...
- **Why use it:** Generate AI images directly in chat using Seedream, Gemini, and OpenAI models.
...
- **Tags:** `design`, `openpencil`, `ui-design`, `ppt`
- **Why use it:** Preview, inspect, and edit real OpenPencil .op design files inside DSH conversations.
...
- **Why use it:** Generate professional legal timelines and litigation diagrams from case files
...
- **Tags:** `browser-extension`, `chat-enhancement`, `prompt-manager`
- **Why use it:** Cross-browser AI chat enhancement suite with prompt management
...
- **Tags:** `bilibili`, `content-discovery`, `privacy-first`
- **Why use it:** Cross-platform content discovery agent with privacy-first design.
...
- **Why use it:** AI agents use your logged-in browser seamlessly without interrupting work
...
- **Why use it:** Strongest free web search plugin for DSH, works for all models without API keys or signup
...
- **Why use it:** Brings live iOS Simulator and USB-connected iPhone into DSH conversations with 22 agent tools
...
- **Why use it:** Tabbit Browser automation plugin for DeepSeek Harness via Playwright
...
- **Why use it:** Universal image uploader supporting 60+ hosting services and major editors
...
- **Tags:** `dsh-plugin`, `preset`, `harness`
- **Why use it:** Two-phase minimal bootstrap preset achieving Project2 98/99 tooling standard.
...
- **Why use it:** Unified virtual filesystem abstraction layer enabling cross-engine file access for agents.
...
- **Tags:** `deepseek-harness`, `model-switch`, `cli`
- **Why use it:** One-click model switch across major CLI coding tools.
...
- **Tags:** `marketplace`, `plugin`, `utilities`
- **Why use it:** Visual plugin marketplace with one-click install for DSH.
...
- **Why use it:** Best context insight and management tool with dashboard and browser views
...
- **Tags:** `awesome-list`, `resource`, `curated`
- **Why use it:** Bilingual curated list of DSH plugins, extensions, tools, skills, and integrations
...
- **Why use it:** Daily-scraped plugin discovery tool with scenario classification and quality filtering
...
- **Why use it:** Uses ChatGPT Codex, Claude, and Grok subscriptions as DSH LLM providers via OAuth
...
- **Tags:** `knowledge-base`, `encyclopedia`, `resource`
- **Why use it:** Comprehensive AI encyclopedia covering agents, MCP, RAG, multimodal tools and learning paths
...
- **Tags:** `awesome-list`, `guide`, `resource`
- **Why use it:** Ultimate DSH guide covering quickstart, curated plugins, resources and practical toolkits
...
- **Why use it:** Track session/daily costs, budgets, and token usage across multiple providers.
...
- **Tags:** `anime`, `bangumi`, `torrent`, `magnet`
- **Why use it:** Anime search plugin with Bangumi ratings, details, and magnet link support.
...
- **Why use it:** Bridge Pi ecosystem extensions to run natively as DSH plugins via shared ABI.
...
- **Tags:** `backup`, `rollback`, `crash-recovery`, `windows`
...
- **Tags:** `ocr`, `vision`
- **Why use it:** OCR and pixel-to-text image reading tools for text-only LLM models
...
- **Tags:** `context-audit`, `utility`, `ui`
- **Why use it:** Audit context injection: token costs, duplicate detection, conflict analysis
...
- **Tags:** `utility`, `troubleshooting`, `compatibility`
...
- **Tags:** `cli`, `plugin-manager`, `tooling`
...
- **Why use it:** Adorable whale girl skin series for DeepSeek Harness.
...
- **Tags:** `theme`, `ui`, `glass`
- **Why use it:** Frosted glass theme fully customizable without modifying DSH source code
...
- **Why use it:** Stunning WebGPU ocean-themed skin with Three.js visuals for DSH UI.
...
- **Tags:** `theme`, `skin`, `palette`
- **Why use it:** 34 opencode classic color themes with one-click switching, persistent across restarts
...
- **Why use it:** Customizable background plugin with preset atmospheres and real-time preview.
...
- **Tags:** `ai-guide`, `tutorial`, `vibe-coding`, `resources`
- **Why use it:** Comprehensive AI resource library and Vibe Coding beginner tutorials
...
- **Why use it:** Curated plugin showcase with MCP servers, skills, and UIs for DSH discovery.
...
- **Tags:** `ai-agents`, `chinese-api`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in coding agents
...
- **Why use it:** Interactive K-line analysis with technical indicators for market research
...
- **Why use it:** Privacy-focused open-source resume builder, completely free and customizable
...
- **Why use it:** Curated list of all notable DSH plugins — essential discovery resource.
...
- **Why use it:** Curated plugin radar with 9000+ candidates and top-50 human-edited selections
...
- **Why use it:** Curated ecosystem list covering DSH plugins, tools, and infrastructure
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Comprehensive curated list of DSH plugins from official hub and community
...
- **Why use it:** Official-style plugin marketplace with 3100+ plugins, search, and free API access.
...
- **Tags:** `plugin-marketplace`, `deepseek-v4-pro`
- **Why use it:** Plugin marketplace collection featuring DeepSeek v4 Pro support.
...
- **Why use it:** Open-source smart notes app with social features, WeChat export, and multi-tenant support.
...
- **Why use it:** Curated awesome list of all DSH plugins
...
- **Tags:** `awesome-list`, `deepseek`, `dsh-plugin`
- **Why use it:** Essential curated resource list for DSH ecosystem discovery
...
- **Tags:** `awesome-deepseek-harness`, `plugin-marketplace`
- **Why use it:** Community-maintained auto-syncing plugin catalog with curated listings
...
- **Tags:** `photo`, `community`, `oauth`
- **Why use it:** DSH beta testing group photo wall with GitHub OAuth and Polaroid style
...
- **Why use it:** Curated GitHub list of notable DeepSeek Harness community plugins
...
- **Why use it:** Public GitHub directory with plugin install commands and ecosystem discovery
...
- **Why use it:** Agent skills for building and testing DeepSeek Harness plugins — from scaffoldin
...
- **Why use it:** Native WeShop Cordis plugin for DeepSeek Harness. Allow you to use infinite canv
...
- **Why use it:** 改配置+重启才能加 MCP？DeepSeek Harness (DSH) 插件「技能配置」解决：设置页粘贴 JSON 即连 MCP 服务器、热加载免重启；上传 
...
- **Why use it:** DeepSeek Harness record macOS desktop workflows by demonstration and turn them i
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** DeepSeek Harness plugin that connects to a PowerContext Server over HTTP for rec
...
- **Tags:** `dsh-plugin`
- **Why use it:** DSH 插件管理器:在 DeepSeek Harness 设置面板内嵌 GUI,管理 MCP 服务 / Skills / 内置插件包,改动热生效无需重启
...
- **Why use it:** Curated 2026 plugin list with quality checks for DSH users.
...
- **Tags:** `directory`, `verified`, `community`
- **Why use it:** Star-ranked verified community plugin directory for DeepSeek Harness.
...
- **Tags:** `guide`, `directory`, `documentation`
...
- **Tags:** `archived`, `moved`
- **Why use it:** Archived; migrated to awesome-dsh-plugin repository.
...
- **Tags:** `recommender`, `ai-curated`, `comprehensive`

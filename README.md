...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,065,499 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-20 14:41:37 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 230,949 | Core plugin ecosystem enabling everything-as-plugi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,234 | Open-source design tool for coding agents with loc |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,904 | Multi-agent swarm system for autonomous workflow c |
...
- **Why use it:** Core plugin ecosystem enabling everything-as-plugin architecture
...
- **Why use it:** Terminal-native AI coding agent with prompt caching for stability
...
- **Why use it:** Two-phase preset for minimal bootstrap to full standard tools.
...
- **Tags:** `account`, `quota`, `routing`
- **Why use it:** Unified account and quota management with smart model routing.
...
- **Tags:** `cognition`, `inference`, `control`
...
- **Why use it:** Comprehensive context management dashboard, browser sidebar, and CLI commands.
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, screenshot UI restore.
...
- **Why use it:** Local-first AI agent desktop with multi-model support and privacy focus
...
- **Tags:** `provider`, `oauth`, `integration`
- **Why use it:** Bridge ChatGPT/Claude/Grok subscriptions as LLM providers via OAuth
...
- **Tags:** `provider`, `model`, `integration`
- **Why use it:** Command Code model provider with plan-aware selection and reasoning
...
- **Tags:** `desktop-app`, `codepilot`, `multi-platform`
- **Why use it:** CodePilot-inspired desktop client spanning macOS/Windows/Linux
...
- **Tags:** `chatgpt`, `dsh-plugin`, `oauth`, `coding-agents`
- **Why use it:** Integrates ChatGPT models into DSH via OAuth subscription access.
...
- **Why use it:** Enhances Gemini, Claude, ChatGPT UIs with prompt management
...
- **Why use it:** Official DSH desktop app for local-first enhanced experience
...
- **Why use it:** Open sidebar foundation with file render, terminal, Git pages.
...
- **Why use it:** Modern flexible task panel embedding into Codex/DSH.
...
- **Why use it:** Claude Code style TUI with whale header and streaming thoughts.
...
- **Why use it:** Cute floating widget tracking DeepSeek account balance with drag and animations.
...
- **Why use it:** Lightweight Tauri desktop app for DSH, cross-platform with pre-installed plugins.
...
- **Tags:** `desktop-app`, `electron`, `windows-desktop`
- **Why use it:** Zero-setup Windows desktop GUI with plugins, SSH, and Codex integration
...
- **Why use it:** Local-first AI desktop workspace for DSH sessions and MCP tools
...
- **Tags:** `office`, `productivity`, `document`
- **Why use it:** Full office suite: spreadsheets, docs, slides integrated into Harness
...
- **Tags:** `task-management`, `native`, `productivity`
...
- **Why use it:** Native iOS/Android client with WebSocket connection to Harness workspace
...
- **Why use it:** Live iOS Simulator and USB iPhone control with 22 automation tools
...
- **Why use it:** Smartisan-style notes with Docker privacy, skill integration, and WeChat export.
...
- **Why use it:** One-click bioinformatics desktop app with offline mode for clinicians
...
- **Why use it:** Unique traditional Chinese wisdom agent with visualization dashboard
...
- **Why use it:** Persistent bottom bar showing model, balance and pricing at a glance
...
- **Why use it:** Electron desktop with self-hosted DSH web and integrations
...
- **Tags:** `ui`, `webui`, `ux`
- **Why use it:** Adds one-click compact context button to DSH Web UI.
...
- **Why use it:** Self-evolving multi-agent system with memory and skill management
...
- **Why use it:** Distills thinking patterns into reusable cross-agent skills
...
- **Tags:** `agent-orchestration`, `mcp`, `agent-skills`
...
- **Why use it:** Largest skills marketplace with auto-crawled GitHub skill projects
...
- **Why use it:** Enterprise multi-agent workbench supporting Codex, DSH, OpenCode
...
- **Why use it:** Self-improving agent OS with evaluation loops and MCP support
...
- **Why use it:** Vision bridge turning images into structured JSON evidence.
...
- **Why use it:** Enables multi-agent team collaboration workflows within DSH ecosystem.
...
- **Why use it:** Organized long-form fiction writing pipeline with character/worldbuilding management.
...
- **Tags:** `canvas`, `session-explorer`, `non-linear`
...
- **Tags:** `creative-writing`, `novel`, `screenwriting`, `workflows`
- **Why use it:** Novel and short-drama writing workflow with dedicated workbench modes
...
- **Tags:** `video-analysis`, `agent-observability`, `multimodal`
- **Why use it:** Video/audio/screen observation with verifiable evidence and timestamps
...
- **Tags:** `skill-panel`, `audit`, `skill-management`
- **Why use it:** Skill invocation audit and in-app skill manager for DSH workflow control
...
- **Why use it:** Enables composable, human-reviewed agent self-evolution with plan modes and acceptance controls
...
- **Tags:** `agent-skills`, `experience-reuse`, `multi-agent`
- **Why use it:** Turns experience into repeatable execution across Claude, Codex, and DSH agents
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshots, UI and chart analysis
...
- **Why use it:** Specialized agent skills for AI infrastructure dev, write, optimize, and debug.
...
- **Why use it:** Auto-converts successful DSH sessions into reusable agent skills locally.
...
- **Why use it:** Superpowers skill port for Reasonix coding harness — powerful dev workflows.
...
- **Why use it:** Dynamic skill exposure control reduces context bloat
...
- **Why use it:** Web search and research skills across multiple agent platforms
...
- **Tags:** `skills`, `deck`, `github-issues`
- **Why use it:** 25 ready-to-use engineering skills with GitHub issue support
...
- **Why use it:** Complete GB/T 9704 official document processing skill set
...
- **Why use it:** Generate litigation timelines,对抗图和法律关系图 in SVG
...
- **Why use it:** Repository-native spec-driven development agent skill bundle
...
- **Tags:** `engineering-discipline`, `skill`, `dsh-plugin`
- **Why use it:** Engineering discipline skill: verify requirements before shipping code
...
- **Why use it:** Durable multi-agent system with persistent memory across sessions
...
- **Why use it:** Comprehensive QA testing skill framework with 11 skills and shared KB
...
- **Tags:** `dsh-plugin`, `skills`, `workflow`
- **Why use it:** Lets you pick skills in the DSH composer instantly
...
- **Why use it:** Multi-agent math modeling with 5 roles and 33 model templates
...
- **Tags:** `math-modeling`, `research`, `cn-skills`
- **Why use it:** End-to-end CN math modeling skill: data, code, papers, figures
...
- **Why use it:** Search 65k+ Chinese API docs from 20 platforms, zero config
...
- **Why use it:** Official Huawei Cloud skills, MCP tools and sandbox for agents
...
- **Why use it:** One-click local MCP, Skills, and rules setup across platforms
...
- **Why use it:** Open-source design tool for coding agents with local-first desktop
...
- **Tags:** `diagrams`, `agent-skills`, `dsh-plugin`
...
- **Why use it:** 530+ image generation prompts and industrial templates library
...
- **Why use it:** Public animated pet gallery for multiple coding agents.
...
- **Why use it:** AI-powered design studio for editable systems, templates, PPT, and prototyping.
...
- **Why use it:** Interactive inline UI components — charts, layouts, forms rendered in replies
...
- **Why use it:** Image-to-text OCR for text-only models with trained methodology
...
- **Tags:** `visualization`, `finance`, `dsh-plugin`
- **Why use it:** Interactive K-line charts with indicators and fundamental data
...
- **Why use it:** 152 shot recipes and Remotion templates for cinematic product videos
...
- **Why use it:** CLI+extension for real browser automation without login interruption
...
- **Tags:** `content-discovery`, `browser`, `web`
- **Why use it:** Cross-platform content discovery agent for B站, YouTube, etc.
...
- **Why use it:** Agent browser with fingerprint spoofing, anti-detect, and unlimited profiles
...
- **Why use it:** Tabbit Browser plugin with Playwright-powered browser automation for DSH.
...
- **Why use it:** Ecosystem radar discovering and continuously validating 21k+ DSH plugins via k8s.
...
- **Why use it:** Daily-refreshed comprehensive DSH plugin marketplace sourced and reviewed globally.
...
- **Why use it:** CLI and resolver for DSH Plugin Hub with schemas and agent tooling
...
- **Why use it:** Token usage tracking, budget alerts, and cost history across providers
...
- **Why use it:** Comprehensive agent-first DSH handbook covering runtime, plugins, MCP, sandbox and more
...
- **Why use it:** Secure P2P multi-device remote access to DSH with end-to-end encryption
...
- **Tags:** `compatibility-layer`, `migration`, `ecosystem-bridge`
- **Why use it:** Bridges Pi and DSH ecosystems by running unmodified Pi extensions as native plugins
...
- **Why use it:** DSH skill that searches, installs, and verifies GitHub plugins automatically
...
- **Tags:** `backup`, `config-manager`, `migration`, `webdav`
- **Why use it:** Full DSH config backup, restore, migrate via WebDAV — comprehensive and reliable.
...
- **Why use it:** Community-curated plugin catalog with auto-sync every 4h
...
- **Tags:** `infrastructure`, `plugin-management`, `registry`
- **Why use it:** Infrastructure for plugin ecosystem with dev guide skill included
...
- **Tags:** `context`, `tool`, `dsh-plugin`
- **Why use it:** Context injection auditing tool with Web UI and token cost analysis
...
- **Why use it:** Official skill hub API docs and examples for DeepSeek Harness plugins
...
- **Tags:** `dsh-plugin`, `containers`, `infrastructure`
- **Why use it:** Manages multiple DSH versions in isolated containers seamlessly
...
- **Why use it:** Unifies Runtime, Provider, Plugin and MCP orchestration natively
...
- **Tags:** `ai-cost`, `token-usage`, `data-visualization`
...
- **Why use it:** Free Xiaomi MiMo TTS API for text-to-speech in DSH
...
- **Tags:** `dsh-plugin`, `skin`, `themes`
- **Why use it:** Whale girl themed skin series visually customizing the DSH interface.
...
- **Tags:** `theme`, `glass-UI`, `customizable`
- **Why use it:** High-customization frosted glass theme for DSH web interface with adjustable blur
...
- **Tags:** `theme`, `animated-background`, `customization`
- **Why use it:** Animated ocean-themed UI with adjustable waves and glassmorphism effects
...
- **Why use it:** Customizable web background with presets and upload support.
...
- **Tags:** `ai-guide`, `vibe-coding`, `dsh-plugin`
...
- **Why use it:** One-stop academic research workbench with LaTeX, arXiv, and GPU management
...
- **Why use it:** Comprehensive cross-database academic search with citation graph for Chinese researchers
...
- **Why use it:** Tushare-based financial database with multi-agent analysis and MCP/HTTP auto-generation
...
- **Why use it:** Industry chain mapping, policy/news tracking, and company research methodology.
...
- **Why use it:** Patent infringement analysis with agent-callable skill output
...
- **Why use it:** Curated stock/finance/quant plugins for trading research
...
- **Why use it:** Bilingual curated resource list of all DSH plugins and extensions
...
- **Why use it:** Curated plugin discovery tool with auto-filtering and categorized listings
...
- **Why use it:** Comprehensive plugin, skill, MCP server curated directory with visualization
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, plugins and tools
...
- **Why use it:** Learn DSH internals, plugin marketplace browsing and best practices
...
- **Why use it:** Massive plugin marketplace with 11,000+ plugins and search, rankings, and free API
...
- **Why use it:** Chinese-English DSH plugin catalog with 1,958 repos, smart search and STAR ranking
...
- **Why use it:** Curated awesome list of all notable DSH plugins and extensions.
...
- **Why use it:** Official auto-generated curated list of all DSH Cordis plugins by cordis.run.
...
- **Why use it:** Curated list of DSH plugins, extensions, tools, and productivity resources.
...
- **Tags:** `migration`, `tools`, `cross-platform`
- **Why use it:** Four-source migration wizard between Claude, Codex, and DSH ecosystems
...
- **Why use it:** Community-curated unofficial catalog of DSH plugins and extensions
...
- **Tags:** `registry`, `plugin-registry`, `open-data`
...
- **Why use it:** Comprehensive 1000+ repo awesome list ranked by stars.
...
- **Tags:** `awesome-list`, `collection`
- **Why use it:** Hand-picked DSHA plugin collection.
...
- **Why use it:** Zero-dependency static portal to discover and install DSH plugins.
...
- **Tags:** `awesome-dsh-plugins`, `dsh-ecosystem`, `plugin-directory`
- **Why use it:** DSH plugin repository and ecosystem listing resource.
...
- **Why use it:** Plugin listing — now moved to awesome-dsh-plugin org.
...
- **Why use it:** Curated plugin registry covering models, tools, sandboxes, and UI.

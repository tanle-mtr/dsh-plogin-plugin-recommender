...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 864,142 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 15:50:12 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 194,726 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,385 | Open-source Claude-style design tool with local-fi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,374 | Meta-harness for deploying multi-agent swarms and  |
...
- **Why use it:** Super AI assistant with multi-model support and self-evolving memory
...
- **Tags:** `coding-agent`, `cli`, `tui`, `deepseek`, `dsh-plugin`
- **Why use it:** Native terminal coding agent with prefix-cache stability
...
- **Tags:** `cordis`, `routing`, `dsh-plugin`, `reasoning`
- **Why use it:** Task-aware reasoning-mode router for DSH
...
- **Tags:** `deepseek-harness`, `preset`, `standard-tools`, `bootstrap`
- **Why use it:** Two-phase bootstrap preset with full standard tools
...
- **Why use it:** Vision plugin enabling image-to-JSON for text-only agents
...
- **Tags:** `coding-agent`, `architecture`, `drift-check`
- **Why use it:** Makes AI coding agents architecture-aware with baseline-first drift checking
...
- **Tags:** `security`, `code-review`, `dsh-plugin`
...
- **Why use it:** Specialized skills for AI infra dev, writing, optimizing, and debugging systems
...
- **Why use it:** Build, run and interact with live Android emulators or USB devices inside chat
...
- **Why use it:** Agent skill for developing DSH plugins with standards and guides
...
- **Why use it:** Agent skill covering slots, Typert remotes, and credentials setup
...
- **Tags:** `codex`, `mcp`, `sync`, `cordis`
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live skill and MCP sync
...
- **Tags:** `plugin-development`, `agent-skills`, `tooling`
- **Why use it:** Portable skill for developing and auditing DSH plugins with optional profile bundle adapter.
...
- **Why use it:** Practical DSH plugin dev archive covering cordis, tsconfig, junctions, and zstd multi-frame tips.
...
- **Why use it:** Essential skills for building, scaffolding, and testing DSH plugins inside the harness
...
- **Tags:** `agent-tools`, `capability`, `automation`
- **Why use it:** Pre-flight plugin check for DSH agents to boost utility
...
- **Why use it:** Search and discover DSH plugins from inside agents.
...
- **Why use it:** Modern desktop client for DSH ecosystem with plugin-first design
...
- **Tags:** `dsh-web-ui`, `plugin-ecosystem`, `web`
- **Why use it:** Web plugin ecosystem package for DeepSeek Harness
...
- **Why use it:** Extensible sidebar with built-in files, terminal, chat and Git
...
- **Why use it:** Claude Code-style TUI with whale theme and real-time status
...
- **Why use it:** Lightweight Tauri desktop app with only 5MB installer, zero setup required
...
- **Why use it:** Local AI desktop workspace for sessions, projects, files and Office artifacts
...
- **Why use it:** Local-first Claude Cowork alternative with multi-model and self-evolving skills.
...
- **Why use it:** CodePilot-inspired desktop client and plugin suite for all platforms.
...
- **Tags:** `workspace`, `canvas`, `visualization`
- **Why use it:** Visual canvas-based non-linear conversation workspace and session explorer.
...
- **Why use it:** Open-source Windows desktop GUI with SSH and mobile access
...
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin marketplace entries
...
- **Tags:** `task-management`, `web-ui`, `sqlite`
- **Why use it:** SQLite-backed native taskboard with agent claim/review and no iframe runtime
...
- **Why use it:** Web UI panel for managing skills and MCP configurations at a glance
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer UI for quick skill insertion
...
- **Tags:** `dsh-plugin`, `mcp`, `ui`, `capability-management`
- **Why use it:** Unified menu to control MCP tool exposure level and execution mode with progress tracking
...
- **Tags:** `ui-extension`, `info-bar`, `usage-tracking`
- **Why use it:** Persistent bottom info bar showing provider, model, balance, and live pricing with countdown.
...
- **Tags:** `canvas`, `creative`, `wes hop`
- **Why use it:** Native WeShop infinite canvas with creative AI skills integration
...
- **Tags:** `visualization`, `cost`, `token-tracking`
...
- **Why use it:** Cross-platform desktop app integrating DB, SSH, Docker panels with AI assistant
...
- **Why use it:** Knowledge platform turning documents into RAG with self-maintaining wiki
...
- **Tags:** `agent-memory`, `long-term-memory`, `rag`, `memory-management`
- **Why use it:** Portable memory layer for AI agents with local-first approach
...
- **Tags:** `long-term-memory`, `rag`, `memory-management`, `self-evolving`
- **Why use it:** Self-evolving memory OS with hybrid retrieval for agents
...
- **Why use it:** Comprehensive AI encyclopedia covering skills, RAG, tools, and learning paths.
...
- **Tags:** `vector-search`, `embeddings`, `skill-md`
...
- **Why use it:** Official DSH docs archive with EN/ZH multilingual support for plugin development
...
- **Why use it:** Distills agent thinking patterns into reusable skills for any bot
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `coding-agent`, `no-code`
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-orchestration`, `self-improving`
- **Why use it:** Self-improving agent OS with continuous grading
...
- **Tags:** `enterprise-agent-workspace`, `multi-agent-workspace`, `visual-editor`
...
- **Tags:** `skills`, `cognitive`, `agent-skills`
...
- **Why use it:** Intelligent workflow orchestrator routing local Skills
...
- **Tags:** `agent-teams`, `workflow`, `coordination`
- **Why use it:** Enable multi-agent teamwork coordination for DSH
...
- **Tags:** `workflow`, `conversation`, `productivity`
...
- **Why use it:** Vision toolkit for text-only models: OCR, image Q&A, screenshot restore
...
- **Tags:** `agent`, `collaboration`, `skill`
...
- **Why use it:** Adds multimodal vision to Claude Code for UI/screenshot analysis
...
- **Why use it:** Turns experience into repeatable execution workflows
...
- **Tags:** `migration`, `session`, `agent-memory`
- **Why use it:** Cross-preset session migration with fixed-schema handoffs preserving agent state
...
- **Tags:** `skills`, `reasoning`, `coding`
- **Why use it:** Superpowers skill port enabling advanced reasoning workflows in Reasonix
...
- **Tags:** `agent-skill`, `chinese-traditional-wisdom`, `dashboard`
- **Why use it:** Unique Bazi/Fengshui/IChing skill pack with local deterministic engine and dashboard
...
- **Why use it:** Cross-platform agent continuity memory — seamless handoff between Codex and Claude Code
...
- **Why use it:** Adapted code simplification skill from DSH for Codex — clean and refactoring-focused
...
- **Tags:** `multi-agent`, `team-collaboration`, `dsh-plugins`
- **Why use it:** Multi-agent collaboration with independent models, skills, and shared workspace in DSH
...
- **Tags:** `skills-manager`, `dsh-plugin`, `organization`
...
- **⭐ Stars:** 16
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位���料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `workflow`
- **Why use it:** Complete Chinese official document workflow: formatting, optimization, template generation per GB/T 9704.
...
- **Tags:** `agent-framework`, `package-manager`, `skills`
- **Why use it:** Package manager with 42 skills covering AI engineering, databases, Docker, Kubernetes and more.
...
- **Why use it:** Game-like mission system with fog-of-war map and progress-driven task bar.
...
- **Why use it:** Portable agent skill distilling engineering discipline and evidence-based decision making
...
- **Tags:** `agent`, `workflow`, `product-management`
- **Why use it:** Simulates a virtual product team for collaborative workflows
...
- **Tags:** `mcp-manager`, `skill-management`, `web-gui`
- **Why use it:** Web GUI plugin to manage skills and MCP servers directly from settings page.
...
- **Why use it:** Paste JSON to connect MCP servers with hot-reload; auto-detect .skill ZIPs for instant creation.
...
- **Why use it:** OAuth-based ChatGPT integration within DSH
...
- **Why use it:** Open-source Claude-style design tool with local-first approach
...
- **Why use it:** Industrial-grade image generation prompts with 530+ reverse-engineered cases
...
- **Tags:** `agent-skills`, `architecture-diagram`, `diagrams-as-code`, `deepseek-harness`
- **Why use it:** Creates beautiful architecture and workflow diagrams from code
...
- **Tags:** `vector-design`, `ui`, `design-as-code`, `agent-team`
...
- **Why use it:** Preview and edit real .op design documents directly within conversations
...
- **Why use it:** Turn messy litigation diagrams into court-ready timelines
...
- **Why use it:** Free image reading and generation skills with auto vision transcription support.
...
- **Tags:** `video`, `image-generation`, `audio`
- **Why use it:** AI video/image/audio skills with storyboard and configurable multimodal model tools.
...
- **Why use it:** Enhancement suite for major AI chat platforms as browser extension
...
- **Tags:** `content-discovery`, `browser`, `privacy`
- **Why use it:** Privacy-first cross-platform content discovery agent
...
- **Why use it:** AI agents can use your real logged-in browser without interrupting your work
...
- **Why use it:** Playwright-powered Tabbit browser automation integrated into DeepSeek Harness
...
- **Tags:** `electron-app`, `image-uploader`, `s3`, `dsh-plugin`
- **Why use it:** Ultimate image uploader with 60+ hosting services support
...
- **Tags:** `virtual-filesystem`, `vfs`, `agent-sandbox`, `unified-storage`
- **Why use it:** Unified virtual filesystem for AI agents across platforms
...
- **Tags:** `model-switch`, `utils`, `dsh-plugin`
- **Why use it:** One-click model switch between multiple coding agents
...
- **Tags:** `marketplace`, `utils`, `plugin`
- **Why use it:** Official plugin marketplace with one-click install
...
- **Why use it:** Best context insight and management with dashboard and statistics
...
- **Why use it:** One-click Docker deployment with SMS-style aesthetics, export to images
...
- **Why use it:** Crash rescue with config rollback, secret-safe snapshots, and offline SAFE MODE
...
- **⭐ Stars:** 57
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill ���方插件开发引导
- **Tags:** `console`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-repository-plugin`, `plugin-management`, `ui`
- **Why use it:** Plugin management console and official dev skill guidance
...
- **Why use it:** Image-to-text OCR for text-only models with pixel art support
...
- **Why use it:** Full DSH config backup/restore with WebDAV sync — essential for migration and safety
...
- **Why use it:** Audit and optimize DSH context tokens — detects duplicates and conflicts via Web UI
...
- **Tags:** `migration`, `import`, `cross-platform`
- **Why use it:** Seamlessly migrates Claude Code/Codex/OpenCode setups into DeepSeek Harness
...
- **Tags:** `diagnostic`, `plugin-management`, `utility`
...
- **Tags:** `mascot`, `pixel-art`, `animated-pets`, `dev-tools`
- **Why use it:** Gallery of animated pets for various AI coding assistants
...
- **Why use it:** Cute whale girl themed skins for DSH customization
...
- **Why use it:** 6 UI design styles to keep vibe-coded sites away from generic AI aesthetics.
...
- **Tags:** `theme`, `color-scheme`, `skins`
- **Why use it:** 34 opencode classic color themes with one-click switch and persistence across restarts.
...
- **Why use it:** Customizable web background with presets and image uploads
...
- **Tags:** `ai-guide`, `rag`, `vibe-coding`, `mcp`
...
- **Tags:** `research`, `china`, `skill`
- **Why use it:** Auto-searches 8 major Chinese platforms for recent reports
...
- **Tags:** `plugin-registry`, `awesome-list`, `curation`
- **Why use it:** Comprehensive plugin registry with 9000+ candidates and top 50 curated selection
...
- **Tags:** `web-search`, `free`, `research`
- **Why use it:** Strongest free web search plugin bridging models without native web access.
...
- **Tags:** `kline`, `financial-analysis`, `interactive-chart`
- **Why use it:** Interactive K-line analysis with multi-market data, technical indicators, and news integration
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, and agents across multiple platforms.
...
- **Tags:** `mcp`, `search`, `zhihu`
- **Why use it:** Search Zhihu via Skill, CLI, and MCP with official open-platform API support.
...
- **Why use it:** Curated stock/finance/quant plugin directory for DSH
...
- **Why use it:** Beginner tutorial for DeepSeek Harness engineering
...
- **Tags:** `toy`, `entertainment`, `web`
- **Why use it:** Fun zero-dependency web toy simulation for mobile
...
- **Why use it:** End-to-end Vox-style explainer video generation via agent
...
- **Tags:** `awesome-list`, `bilingual`, `reference`
...
- **⭐ Stars:** 274
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub ���的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
...
- **⭐ Stars:** 249
- **Language:** PowerShell
- **Description:** DeepSeek 专用破甲插���「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐
- **Tags:** `prompt`, `armor-breaking`, `deepseek`
- **Why use it:** Armor-breaking prompt stabilization plugin specifically for DeepSeek.
...
- **Why use it:** Curated list of DSH plugins, skills, MCP servers and UIs
...
- **Why use it:** Plugin marketplace with 3100+ plugins and search functionality
...
- **Why use it:** DSH plugin marketplace for DeepSeek-V4-Pro
...
- **Tags:** `awesome-list`, `community`, `reference`
- **Why use it:** Curated awesome list of DSH plugins — essential discovery and reference resource
...
- **Why use it:** Curated plugin list, great starting point for DSH exploration
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories — best discovery resource
...
- **Why use it:** Curated community list of DSH plugins with bilingual descriptions
...
- **Tags:** `awesome-list`, `catalog`, `unofficial`
...
- **Why use it:** 2026 curated list of DSH plugins with quality verification
...
- **Why use it:** Spam-filtered open-data plugin registry with bundles and skills
...
- **Tags:** `awesome-list`, `verified`, `evidence-led`
...
- **Why use it:** Star-ranked verified community plugin collection
...
- **Tags:** `radar`, `plugin-registry`, `awesome-list`
...
- **Why use it:** Static portal for discovering and installing 227+ DSH plugins
...
- **Tags:** `repository`, `plugins`
- **Why use it:** General-purpose DSH plugins repository
...
- **Why use it:** Original awesome-dsh-plugins repo (now relocated)
...
- **Tags:** `awesome-list`, `directory`, `automation`
- **Why use it:** Automatically crawled bilingual DSH plugin directory
...
- **Tags:** `awesome-list`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** 1000+ DSH tools catalog sorted by stars.
...
- **Why use it:** CodeX-like plugin marketplace for DSH.
...
- **Why use it:** AI-curated plugin list updated hourly.
...
- **Why use it:** Simple DSH plugin directory listing.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Curated plugins covering models, tools, sandboxes, UI.
...
- **Why use it:** Industry-specific DSH plugins for finance, legal, etc.

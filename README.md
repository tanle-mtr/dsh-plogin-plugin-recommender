...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,031,586 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-16 00:11:41 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225,313 | Core DSH ecosystem hub enabling everything-as-plug |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,381 | Open-source design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,549 | Original multi-agent swarm harness with autonomous |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 34 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (34)
...
- **Why use it:** Core DSH ecosystem hub enabling everything-as-plugin architecture
...
- **Tags:** `ai-agent`, `multi-agent`, `dsh-plugin`
- **Why use it:** Super AI assistant with memory, self-evolution, and multi-model support
...
- **Tags:** `harness`, `tutorial`, `agent`
- **Why use it:** Beginner-friendly harness engineering tutorial from 0 to 1
...
- **Why use it:** Self-improving Agent OS with evaluation loops and MCP server
...
- **Tags:** `agent-runtime`, `ai-coding`, `desktop`
- **Why use it:** High-performance Rust agent runtime with polished desktop app and code agent depth.
...
- **Tags:** `agent-teams`, `coding-agent`, `dsh`
- **Why use it:** Enables multi-agent team collaboration within DeepSeek Harness for complex tasks.
...
- **Why use it:** Open-source CLI and resolver for managing DSH Plugin Hub projects efficiently.
...
- **Tags:** `modeling`, `competition`, `gitops`
- **Why use it:** Full-stack auto math modeling agent with GitOps pipeline and code verification
...
- **Tags:** `evolution`, `review`, `agent`
- **Why use it:** Enables composable, reviewable and self-improving agent workflows in DSH
...
- **Tags:** `infra`, `development`, `skills`
- **Why use it:** Specialized skills for AI infrastructure development, optimization and debugging
...
- **Tags:** `plugin-creator`, `validation`, `harness`
- **Why use it:** Essential toolkit for creating and validating DSH plugins reliably.
...
- **Why use it:** Enables vision capabilities for text-only models with OCR and pixel analysis.
...
- **Why use it:** Audits context token costs and detects conflicts in instructions and tools.
...
- **Tags:** `code-simplification`, `skill`, `refactoring`
- **Why use it:** Refines code with simplification patterns adapted from official DSH skills.
...
- **Tags:** `skill-picker`, `ui`, `workflow`
- **Why use it:** WorkBuddy-style skill picker that streamlines skill selection in composer.
...
- **Tags:** `codex`, `sync`, `integration`
- **Why use it:** Bidirectional bridge between Codex and DSH with sync, skill mounting and MCP mirroring.
...
- **Tags:** `migration`, `import`, `tool`
- **Why use it:** Migration wizard moving Claude Code, Codex, OpenCode sessions and memories to DSH.
...
- **Tags:** `plugin-dev`, `skill`, `developer-tools`
- **Why use it:** Agent skill for developing DSH plugins: standards for plugins, services, events, tools and MCP adapters.
...
- **Tags:** `marketplace`, `plugin-market`
- **Why use it:** CodeX-style plugin marketplace for DSH, streamlined plugin discovery
...
- **Tags:** `agent-tools`, `plugin-check`
- **Why use it:** Pre-flight plugin check for agents to boost plugin library usage
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** Bind ChatGPT account via OAuth to use models inside DSH
...
- **Why use it:** Web-based DSH plugin aggregation ecosystem and distribution platform
...
- **Tags:** `desktop`, `tauri`, `dsh`
- **Why use it:** Lightweight Tauri desktop with zero env setup and preset plugins cross-platform.
...
- **Why use it:** Brings full office suite — spreadsheets, docs, slides — directly into Harness.
...
- **Tags:** `task-management`, `ui-extension`, `native`
- **Why use it:** Native local taskboard with SQLite, agent claim/review and a clean Web UI.
...
- **Tags:** `ios`, `mobile`, `ui-extension`
- **Why use it:** Native iOS client bringing Harness workspaces, sessions and agent traces to iPhone.
...
- **Tags:** `desktop-app`, `ui-extension`, `electron`
- **Why use it:** CodePilot-inspired cross-platform desktop client and plugin suite for macOS/Win/Linux.
...
- **Tags:** `notes`, `ui`, `smartisan`
- **Why use it:** Smartisan-style note app with Docker deployment and WeChat export
...
- **Tags:** `mcp`, `skills`, `webui`, `plugin`
- **Why use it:** Web UI panel for managing skills and MCP servers.
...
- **Tags:** `plugin-market`, `webui`, `ui`
- **Why use it:** Browse and install community plugins directly in Web GUI.
...
- **Tags:** `mcp`, `capabilities`, `menu`, `ui`
- **Why use it:** Unified menu to manage MCP tool and skill exposure levels.
...
- **Why use it:** Desktop management console with multi-tab Harness/Plugin/MCP/Skill control
...
- **Tags:** `ui`, `info-bar`, `balance`, `pricing`
- **Why use it:** Clean info bar with real-time balance, pricing, and model status.
...
- **Tags:** `bioinformatics`, `desktop-app`, `tauri`, `agent`
- **Why use it:** Purpose-built bioinformatics desktop agent for clinical and wet-lab use.
...
- **Tags:** `desktop`, `devops`, `ssh`, `docker`, `database`
- **Why use it:** All-in-one DevOps desktop: DB, SSH, SFTP, Docker, AI in one window.
...
- **Why use it:** Electron desktop shell integrating DSH web services and tools.
...
- **Why use it:** One-click compact context button for DSH Web context meter.
...
- **Tags:** `web-portal`, `plugin-browser`
- **Why use it:** Static web portal for browsing and filtering 227+ plugins
...
- **Why use it:** Turn documents into queryable RAG, reasoning agents, and self-maintaining wiki
...
- **Tags:** `ai`, `rag`, `prompt`
- **Why use it:** Comprehensive AI resource hub with LLM tutorials and prompt大全
...
- **Why use it:** Local-first portable memory layer for AI agents with RAG support
...
- **Why use it:** Memory library for building stateful, continual-learning agents
...
- **Why use it:** Local-first memory hub giving all AI agents shared persistent context and control.
...
- **Why use it:** Zero-prompt auto memory with three-layer consolidation and skill crystallization
...
- **Why use it:** Original multi-agent swarm harness with autonomous workflow coordination
...
- **Why use it:** Distill expert thinking patterns into reusable skills for any AI agent
...
- **Tags:** `agent-orchestration`, `skills`, `workspaces`
...
- **Why use it:** Most comprehensive skill marketplace with auto-crawled GitHub skills
...
- **Why use it:** Enterprise multi-agent workspace with visual editor and team collab
...
- **Tags:** `control-plane`, `long-horizon`, `workflow`
- **Why use it:** Long-horizon agent control plane for durable governed cross-harness work
...
- **Why use it:** Organized AI novel writing with worldbuilding, chapters, and revision in local-first app.
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, OCR, and UI restoration.
...
- **Why use it:** Gives agents verifiable multimodal perception — video, audio, screen as evidence.
...
- **Tags:** `agent-skills`, `creative-writing`, `drama-skills`
- **Why use it:** End-to-end creative writing workflows for novels, short dramas, and game scripts.
...
- **Tags:** `skills`, `framework`, `reusable`
- **Why use it:** Reusable skill framework turning experience into repeatable AI executions
...
- **Why use it:** 88 ready-to-install skills for research, marketing and business automation
...
- **Tags:** `plugin`, `discovery`, `installation`
- **Why use it:** Dedicated skill for discovering, installing and verifying DSH plugins
...
- **Tags:** `vision`, `multimodal`, `coding`
- **Why use it:** Adds multimodal vision capability to text-only LLM-based coding agents
...
- **Why use it:** 87 reverse-engineering skills for security and CTF research.
...
- **Tags:** `agent-skills`, `skill-generator`, `automation`
...
- **Tags:** `skills`, `reasonix`, `superpowers`
...
- **Why use it:** TDD, debugging, planning skills from obra/superpowers.
...
- **Why use it:** Transforms AI coding assistant into a mentor with guided hands-on learning
...
- **Tags:** `skills`, `agent`, `dsh-plugin`
- **Why use it:** 25 ready-to-use engineering skills in right panel, one-click install
...
- **Why use it:** Full GB/T 9704 official document processing: format, review, templates
...
- **Tags:** `spec-driven`, `agent-skills`, `dsh-plugin`
- **Why use it:** Repository-native spec-driven development skill for AI coding agents
...
- **Tags:** `chinese-traditional-wisdom`, `dashboard`, `dsh-plugin`
- **Why use it:** Bazi/Fengshui/IChing skill pack with local deterministic engine and dashboard
...
- **Why use it:** Enables powerful multi-agent collaboration with shared workspaces and contexts.
...
- **Tags:** `quality-gate`, `requirements`, `engineering`
- **Why use it:** Quality gate ensuring requirements are grilled before delivery ships.
...
- **Tags:** `qa`, `testing`, `agent-skills`, `playwright`
- **Why use it:** Professional QA agent skills framework with 11 skills and knowledge base.
...
- **Why use it:** Maintains session continuity memory for smooth cross-agent handoffs.
...
- **Tags:** `skillhub`, `official`, `api`, `tencent`
- **Why use it:** Official Tencent SkillHub plugin with Open API docs and skill examples.
...
- **Tags:** `video`, `remotion`, `agent-skill`
...
- **Tags:** `math`, `modeling`, `multi-agent`
- **Why use it:** Multi-agent math modeling solver with 5 role presets, 33 models, and paper templates for competitions.
...
- **⭐ Stars:** 25
- **Language:** TypeScript
- **Description:** Give DeepSeek Harness a persistent agent team: durable Member identities with private memory, notes and skills across sessions. You set the direction — agents coordinate through Channels and Tasks, and manage their own context.
- **Tags:** `agent-team`, `memory`, `multi-agent`
- **Why use it:** Persistent agent team with private memory, notes and skills across sessions.
...
- **Tags:** `finance`, `mcp`, `stock`
- **Why use it:** Financial data MCP server with multi-agent analysis and IM alert support
...
- **Tags:** `huaweicloud`, `mcp`, `dsh-plugin`
- **Why use it:** Official Huawei Cloud plugin: MCP tools, skills, safety guardrails, cloud sandbox
...
- **Tags:** `mcp`, `config-sync`, `multi-agent`, `cross-platform`
- **Why use it:** One-click MCP, skills, and rules sync across 7+ major AI agent platforms.
...
- **Why use it:** Web UI card for managing skills and MCP servers directly in DSH browser settings.
...
- **Why use it:** Open-source design tool turning coding agents into designers
...
- **Tags:** `diagram-as-code`, `architecture-diagram`, `dsh-plugin`
- **Why use it:** Beautiful architecture and sequence diagrams from code, self-contained HTML output
...
- **Why use it:** 530+ image prompt templates and case library for GPT Image generation
...
- **Why use it:** Native design studio with AI generation, visual editing, templates, and PPT support.
...
- **Tags:** `visualization`, `legal`, `dsh-plugin`
- **Why use it:** Legal timeline generation and litigation diagrams from case materials
...
- **Why use it:** Full AI creative suite for video, image, and audio generation via DirectorX.
...
- **Tags:** `design`, `ui`, `styles`
- **Why use it:** 6 design style packs (dark-saas, apple-minimal, neo-neu) to eliminate AI-generated aesthetics.
...
- **Why use it:** Transform chat history into shareable knowledge cards
...
- **⭐ Stars:** 20,075
- **Language:** TypeScript
- **Description:** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any websites, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；其中的提示词管理器可用于��意网站，如 DeepSeek Harness。
- **Tags:** `browser-extension`, `chat-management`, `dsh-plugin`
- **Why use it:** Enhancement suite for AI chat platforms with cross-browser extension support
...
- **Why use it:** Use your real logged-in browser with AI agents without interrupting workflow.
...
- **Why use it:** Persistent-identity browser with fingerprint spoofing and Android emulation built in.
...
- **Why use it:** Live iOS Simulator and USB iPhone control with 22 agent tools inside the conversation.
...
- **Why use it:** Tabbit Playwright browser automation plugins for DSH.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with plugin ecosystem
...
- **Tags:** `no-code`, `low-code`, `dsh-plugin`
- **Why use it:** Open-source AI + no-code platform for rapid business system development
...
- **Tags:** `routing`, `injector`, `infrastructure`
- **Why use it:** Runtime injector and task-aware reasoning-mode router kit
...
- **Tags:** `plugin-registry`, `ecosystem`, `infrastructure`
- **Why use it:** Self-hostable ecosystem radar auto-discovering and validating 15900+ plugin candidates.
...
- **Why use it:** Best context insight and management plugin with dashboard, browser, and sidebar.
...
- **Why use it:** Leverage ChatGPT/Claude/Grok subscriptions as LLM providers — no API keys needed.
...
- **Why use it:** Track session/daily costs, budgets and token usage across multiple LLM providers.
...
- **Tags:** `provider`, `llm-provider`, `utility`
- **Why use it:** Adds Command Code LLM provider with live catalog, plan-aware selection and reasoning.
...
- **Tags:** `remote`, `p2p`, `access`
- **Why use it:** Secure P2P multi-device remote access for DSH with end-to-end encryption
...
- **Tags:** `upgrade`, `automation`, `plugin`
- **Why use it:** Auto-updates plugins with DSH version upgrades.
...
- **Tags:** `backup`, `config-manager`, `webdav`, `migration`
- **Why use it:** Backup, restore, sync and migrate DSH config via WebDAV.
...
- **Why use it:** Plugin ecosystem infrastructure: console + make-dsh-plugin dev guide
...
- **Tags:** `skills`, `management`, `dsh-plugin`
- **Why use it:** Centralized load and safe management of local Agent Skills in DSH
...
- **Tags:** `awesome-list`, `plugins`, `dsh-plugin`
...
- **Tags:** `containers`, `management`, `utility`, `infrastructure`
- **Why use it:** Isolated container-based DSH management with embedded WebView UI.
...
- **⭐ Stars:** 23
- **Language:** Rust
- **Description:** 释放 DeepSeek Harness 插件化内核能力，将 Runtime、Provider、Plugin、Skill、MCP 等能力统一编排，让 Harness 真正成为可扩展、可组合、可管理的本地 AI 运行平台。
- **Tags:** `launcher`, `infrastructure`, `orchestration`
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill, MCP into a unified extensible AI platform.
...
- **Why use it:** Fast, simple Neovim plugin manager written in pure Lua.
...
- **Tags:** `token-usage`, `cost-tracking`, `visualization`
...
- **Tags:** `tts`, `xiaomi`, `voice`
- **Why use it:** Free Xiaomi MiMo TTS API integration with custom/builtin voices.
...
- **Tags:** `doctor`, `conflict-resolution`, `compatibility`
...
- **Why use it:** In-agent plugin search combining npm and curated lists
...
- **Tags:** `pet`, `mascot`, `theme`, `sprites`
- **Why use it:** Public animated pet gallery for multiple AI coding agents and CLIs
...
- **Tags:** `skin`, `theme`, `ui`
- **Why use it:** Cute whale girl themed skin series that personalizes your DeepSeek Harness UI.
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或���键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `background`, `customization`
- **Why use it:** Custom background images with presets and real-time preview.
...
- **Tags:** `research`, `web-search`, `skill`
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day content and generates cited reports.
...
- **Why use it:** Curated comprehensive list of DSH ecosystem plugins, tools, and infrastructure.
...
- **Why use it:** Curated plugin ecosystem list covering CLI, web UI, and agent harness tools.
...
- **Why use it:** Multi-source academic search with citation verification and graph for Chinese researchers
...
- **Why use it:** Curated DSH plugin directory for discovery and reference.
...
- **Tags:** `industry-research`, `report`, `company-research`
- **Why use it:** Industry research skills with chain mapping and news tracking.
...
- **Tags:** `awesome-list`, `cordis`, `plugin`
...
- **Tags:** `awesome-list`, `agents`, `plugins`
- **Why use it:** Curated list of DSH tools covering productivity and features.
...
- **⭐ Stars:** 87
- **Language:** Python
- **Description:** 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自���维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic
- **Tags:** `plugin-marketplace`, `awesome-list`, `ecosystem`
- **Why use it:** Community-maintained auto-syncing DSH plugin catalog.
...
- **Why use it:** Searches 65,600+ API docs across 20 Chinese platforms, zero-config Skill support
...
- **Tags:** `patent`, `legal-tech`, `dsh-plugin`
- **Why use it:** Patent infringement analysis producing competitive reports, callable as skill
...
- **Why use it:** Interactive K-line charts with multi-market support and built-in technical indicators for DSH sidebar.
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, skills, and agents with native DSH support.
...
- **Tags:** `stock`, `finance`, `quant`, `trading`
- **Why use it:** 24 verified stock/finance/quant plugins, bilingual listing.
...
- **Why use it:** Curated star-ranked plugin directory for DSH ecosystem discovery
...
- **Tags:** `awesome-list`, `ai-curated`
- **Why use it:** AI-curated comprehensive plugin list with 190+ entries across 12 categories
...
- **Why use it:** Officially selected DSHA plugin collection
...
- **Why use it:** Auto-crawled daily plugin directory via GitHub Actions
...
- **Tags:** `plugin-bundle`, `analytics`
- **Why use it:** Plugin bundle with analytics and verification capabilities
...
- **Why use it:** Moved to new repo, archived list
...
- **Why use it:** Auto-updating curated plugin list with bilingual support
...
- **Tags:** `awesome-list`, `deepseek-harness`, `ai-agents`
- **Why use it:** Evidence-led bilingual directory with immutable review commits
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Simple Chinese plugin directory for DSH ecosystem discovery
...
- **Why use it:** Privacy-first resume builder with secure, customizable, portable design
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated DSH plugin directory — essential discovery resource
...
- **Why use it:** The plugin market inside DeepSeek Harness — browse, search, one-click install · 
...
- **Why use it:** The first vision plugin for DeepSeek Harness, and the vision bridge for every te
...
- **Why use it:** Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard
...
- **Tags:** `agent-sandbox`, `agent-tools`, `ai-agents`, `bash`, `claude-code`, `dsh`, `dsh-plugin`, `fuse`, `llm-agents`, `openai-agents`, `python`, `typescript`, `vfs`, `virtual-filesystem`, `virtual-terminal`
- **Why use it:** The World's First Virtual Terminal for AI Agents
...
- **Why use it:** 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, su
...
- **Tags:** `agent`, `ai-agents`, `dsh-plugin`, `memory`, `memoryscope`, `openclaw`, `openclaw-plugin`, `qwenpaw`, `rag`, `reme`
- **Why use it:** ReMe: Memory Management Kit for Agents - Remember Me, Refine Me.
...
- **Why use it:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 We
...
- **Why use it:** Intelligent Skill routing and workflow orchestration for AI agents — +21.12 pp r
...
- **Why use it:** One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI
...
- **Tags:** `claude-code`, `cli`, `codex`, `codex-app`, `codex-desktop`, `codex-plugin`, `dsh`, `dsh-plugin`, `skills`
- **Why use it:** 现代化可灵活嵌入的任务面板，支持 Codex、DeepSeek Harness
...
- **Why use it:** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。 
...
- **Tags:** `deepseek`, `deepwiki`, `dsh-plugin`, `grok`, `okf-format`, `openwiki`
- **Why use it:** Turn code into clarity. Generate accurate technical docs and AI-ready context in
...
- **Why use it:** A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Cod
...
- **Tags:** `cordis`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `dsh-plugins`, `floating-widget`, `plugin`
- **Why use it:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动
...
- **Tags:** `agent`, `deepseek`, `deepseek-harness`, `deepseek-harness-plugin`, `dsh`, `dsh-plugin`, `harness`
- **Why use it:** The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced
...
- **Why use it:** Open-source infrastructure that turns scattered SKILL.md files into curated, ret
...
- **Tags:** `agentic-workflows`, `ai-agent`, `ai-workbench`, `data-analysis`, `deepseek-harness`, `desktop-app`, `dsh`, `dsh-plugin`, `electron`, `local-first`, `mcp`, `model-context-protocol`, `office-automation`, `react`, `typescript`
- **Why use it:** DeepSeek Harness Desktop App: a local AI desktop workspace for DSH Sessions, pro
...
- **Why use it:** Curated DeepSeek Harness (DSH) plugins, extensions, tools, skills, clients, runt
...
- **Why use it:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bri
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** GenUI for DeepSeek Harness: interactive UI components rendered inline in assista
...
- **Tags:** `agent`, `ai`, `ai-agents`, `aisecurity`, `cybersecurity`, `dsh`, `dsh-bundle`, `dsh-plugin`, `dsh-plugin-desktop`, `dsh-plugin-market`, `dsh-plugin-verify`, `dsh-plugins`, `dsh-skill`, `hacker`, `plugin`, `redteam`, `security`, `vscode`, `vulnerabilities`, `vulnerability`
- **Why use it:** DeepSec — AI Security Offense & Defense Platform. Shield audits AI-generated cod
...
- **Tags:** `arxiv`, `bibtex`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `experiment-tracking`, `gpu-cluster`, `latex`, `paper-writing`, `research`, `research-tools`, `ssh`
- **Why use it:** Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。A
...
- **Tags:** `ai`, `ai-agent`, `claude`, `claude-code`, `cli`, `codex`, `codex-cli`, `coding-agent`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `go`, `oh-my-pi`, `omp`, `openai`, `pi`, `terminal`, `tui`
- **Why use it:** a coding agent, rpc plugin, sub-agents, hashline edits, and mcp
...
- **Tags:** `animated-background`, `chrome-extension`, `customization`, `deepseek`, `deepseek-harness`, `deepseek-theme`, `dsh`, `dsh-plugin`, `edge-extension`, `glassmorphism`, `ocean`, `ocean-skin`, `skin`, `theme`, `threejs`, `webgpu`
- **Why use it:** 🌊 DeepSeek Harness 海洋皮肤与动态主题 | Real-time ocean theme with adjustable waves, sun
...
- **Why use it:** AI skills大全 mcp ai知识库 Agent 全维度 AI 资源百科，DSH插件 收录大模型、智能 Agent、RAG 检索增强、多模态、MLOps、
...
- **Why use it:** Open-source alternative to Claude Cowork — a local-first AI agent desktop app · 
...
- **Tags:** `awesome-list`, `discovery`, `plugin-manager`
- **Why use it:** Curated plugin discovery tool with daily GitHub sweeps and scene-based categorization.
...
- **Why use it:** Comprehensive curated list of plugins, skills, MCPs, patches and orchestrators.
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, plugins and practical toolkits.
...
- **Why use it:** Large plugin marketplace with 11,000+ plugins and public API
...
- **Why use it:** Comprehensive plugin catalog with search, filter and ranking features
...
- **Why use it:** Unofficial community-curated catalog of DeepSeek Harness plugins.
...
- **Why use it:** Curated list of DSH plugins with categorized discovery and ratings.
...
- **Why use it:** Comprehensive awesome list covering DSH plugins, tools, skills and resources.
...
- **Why use it:** Curated open-data registry of DSH plugins, bundles, and skills.
...
- **Why use it:** Public GitHub directory for DSH plugin ecosystem discovery.
...
- **Tags:** `awesome-list`, `curated`, `permissions`
- **Why use it:** Evidence-led curated directory with permission-aware installation guidance.
...
- **Tags:** `awesome-list`, `inventory`, `catalog`
- **Why use it:** Complete DSH tool inventory with 1000+ repos sorted by stars.
...
- **Tags:** `awesome-list`, `collection`
- **Why use it:** Useful DSH plugin collection for quick reference.

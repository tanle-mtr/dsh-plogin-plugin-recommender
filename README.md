...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,028,661 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-15 09:56:00 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 224,756 | The core DSH platform enabling plugin-based agent  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,277 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,495 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** The core DSH platform enabling plugin-based agent extensibility
...
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability optimization
...
- **Tags:** `agent-collaboration`, `dsh-plugin`, `multi-agent-workspace`
- **Why use it:** Enterprise-grade multi-engine agent workbench for teams
...
- **Tags:** `agent-os`, `mcp`, `llm-orchestration`, `dsh-plugin`
...
- **Why use it:** Enables vision capabilities for text-only agents via OCR and image analysis
...
- **Why use it:** Two-phase preset that bootstraps agents with minimal config then full tools
...
- **Why use it:** Virtual terminal and filesystem sandbox enabling safe isolated agent execution
...
- **Why use it:** High-performance Rust agent runtime with polished desktop IDE integration
...
- **Why use it:** Multi-agent team orchestration plugin for complex coding workflows
...
- **⭐ Stars:** 880
- **Language:** TypeScript
- **Description:** [dsh]为纯文本��型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **Tags:** `vision`, `ocr`, `gui-automation`
- **Why use it:** Powerful vision toolkit for text-only LLMs: OCR, screenshot UI restoration, multi-image QA
...
- **Tags:** `plugin-market`, `curation`, `daily-update`
- **Why use it:** Comprehensive curated plugin marketplace refreshed daily with quality reviews.
...
- **Why use it:** CLI schemas resolver and agent tools for the official DSH Plugin Hub
...
- **Why use it:** Adds plan-aware model selection and live catalog for DSH agents.
...
- **Tags:** `agent-review`, `prompt-engineering`, `self-evolve`
- **Why use it:** Composable agent modes with human review for continuous self-evolution.
...
- **Tags:** `vision`, `multimodal`, `frontend`
- **Why use it:** Adds multimodal vision to LLMs for screenshot and UI analysis.
...
- **Why use it:** Foundation plugin for DSH ecosystem: registry console and official dev skill.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Centralized loader and manager for local Agent Skills in DSH with safety checks.
...
- **Why use it:** Audit context injection, detect token cost, duplicates and conflicts
...
- **Tags:** `codex`, `sync`, `integration`, `mcp`
...
- **Why use it:** Web GUI plugin to manage skills and MCP servers directly in settings
...
- **Tags:** `godot`, `game`, `gdscript`, `development`
- **Why use it:** Full-stack Godot 4.x game development skill for DSH agent
...
- **Why use it:** Unleashes DSH plugin kernel: orchestrates Runtime, Provider, Plugin, Skill, MCP
...
- **⭐ Stars:** 22
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的��计：模型适配器、工具注册表、Agent 循环、网页界面都是插件
- **Tags:** `developer`, `plugin-dev`, `skill`
- **Why use it:** Guides AI agent through 0-to-1 DSH plugin development workflow
...
- **Tags:** `plugin-dev`, `skill`, `adapter`
- **Why use it:** Agent skill for DSH plugin development: plugins, services, events, tools, MCP adapters
...
- **Why use it:** Pre-flight plugin library checker for DSH agents.
...
- **Why use it:** Bind ChatGPT via OAuth to use ChatGPT models in DSH.
...
- **Why use it:** Unified agent workspace board accessible across all devices
...
- **Why use it:** Extensible sidebar foundation with built-in file editor, terminal, Git and sub-agent views
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status and streaming thought display
...
- **Why use it:** Lightweight 5MB desktop app with preset plugins, cross-platform support
...
- **Why use it:** Local-first desktop workspace with sessions, files, web research, and Office integration.
...
- **Why use it:** Local-first multi-model desktop agent with self-evolving skills and privacy focus.
...
- **Why use it:** Brings spreadsheets docs slides canvases into the harness as a real office
...
- **⭐ Stars:** 297
- **Language:** Kotlin
- **Description:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将工作区、会话、实时回复和 Agent 执行轨迹带到 iPhone，同时延�� DeepSeek WebUI 克制、清晰的视觉语言
- **Tags:** `ios`, `mobile`, `kmp`
- **Why use it:** Native iOS app connecting via WebSocket for workspace sessions and agent traces
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with full plugin suite
...
- **Why use it:** Smartisan-style open-source notes app with Docker and IM integration.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Electron desktop console managing Harness, Plugins, MCP and Skills in tabs.
...
- **Why use it:** Electron-based desktop wrapper integrating DSH web UI and tools
...
- **Why use it:** Open-source LLM knowledge platform with RAG, autonomous reasoning and self-maintaining wiki
...
- **Tags:** `long-term-memory`, `agent-memory`, `rag`, `mcp`
...
- **Tags:** `agent-memory`, `agentic-rag`, `memory`, `mcp`
...
- **Tags:** `memory`, `milvus`, `rag`, `persistent-memory`
...
- **Tags:** `memory`, `local-first`, `persistent-context`
- **Why use it:** Shared persistent memory hub enabling all AI agents to retain context
...
- **Tags:** `skill-retrieval`, `vector-search`, `embeddings`
- **Why use it:** Transforms SKILL.md files into retrieval-ready corpora with vector search and evaluation.
...
- **Why use it:** AI-enhanced no-code platform for rapidly building business systems and dashboards
...
- **Tags:** `agent-skills`, `dsh-plugin`, `skills`
- **Why use it:** Largest skill store with auto-collected GitHub skills by category
...
- **Why use it:** Long-horizon agent control plane for governed cross-harness workflows
...
- **Why use it:** Intelligent skill routing and workflow orchestration with significant reward gains
...
- **Why use it:** End-to-end automated video generation from topic to finished Vox-style explainer
...
- **Why use it:** Organized novel writing workflow with RAG, worldbuilding, and revision management
...
- **Tags:** `agent-observability`, `multimodal`, `video-understanding`
- **Why use it:** Gives AI agents vision, audio, and verifiable evidence from multimodal inputs
...
- **Why use it:** Four creative workflows: novels, short dramas, games, video recaps built-in
...
- **Tags:** `math-modeling`, `gitops`, `agent-skill`
...
- **Why use it:** Complete reverse engineering and pentest skill pack for DSH
...
- **Why use it:** Turn successful sessions into reusable agent skills automatically
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** AI mentor skill for coding: architecture scan, tiered chapters, code review.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** 25 ready-to-use engineering skills panel including triage and wayfinder.
...
- **⭐ Stars:** 62
- **Language:** Python
- **Description:** 专利侵权分析系统 —— 输入专利公开号，产出竞品侵权���析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 调用。
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Patent infringement analysis skill generating competitive reports from patent numbers.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** GB/T 9704-compliant Chinese official document formatting, review and generation.
...
- **⭐ Stars:** 39
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融���，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Bazi, Fengshui, I Ching and TCM AI skill with local engine and visualization dashboard.
...
- **Tags:** `plugin-development`, `codex`, `validation`
...
- **Why use it:** AI video/image/audio generation skills with knowledge corpus
...
- **Why use it:** 11 QA agent skills with shared knowledge base and decision matrix
...
- **Tags:** `official`, `documentation`, `api`
- **Why use it:** Official API docs and examples for DSH plugin development
...
- **Tags:** `math`, `competition`, `agent`, `modeling`
- **Why use it:** 5-role multi-agent math modeling with 33 model library and paper templates
...
- **Why use it:** One-click local setup for MCP, Skills, and rules across 8+ AI agents
...
- **Why use it:** Open-source design system with local-first desktop app and AI generation
...
- **Why use it:** Self-contained HTML diagrams with motion for architecture and workflow viz
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** SVG-based litigation timeline and diagram tool for legal professionals.
...
- **Why use it:** 6 aesthetic style packs to avoid generic AI-generated design look
...
- **Why use it:** Enhancement suite for major AI chat platforms with cross-browser prompt management
...
- **Why use it:** Cross-platform content discovery agent scraping B站、抖音、YouTube等 8+ platforms
...
- **Why use it:** Leverages real logged-in browser for AI agent web automation seamlessly
...
- **Why use it:** Free no-signup web search plugin bridging all models to web access.
...
- **Why use it:** Persistent identity browser with fingerprint spoofing Android emulation and proxies
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 dedicated agent tools
...
- **Why use it:** Centralized plugin marketplace with one-click install and search
...
- **Why use it:** One-click switch between 9+ coding agent platforms including Claude Code and Codex
...
- **Why use it:** Auto-discovers and validates 15900+ candidate plugins with production-grade pipeline
...
- **Why use it:** Dashboard and sidebar for context insight, status monitoring, and management
...
- **Tags:** `security`, `vulnerability`, `redteam`
...
- **Why use it:** Auto-upgrades plugins to match new DSH versions
...
- **Tags:** `config-manager`, `backup`, `migration`, `sync`
- **Why use it:** Backup, restore and sync full DSH config, plugins, MCPs and skills
...
- **Tags:** `container`, `management`, `infra`
...
- **Tags:** `cost-tracking`, `visualization`
- **Why use it:** Real-time token usage and cost estimation for DeepSeek API
...
- **Tags:** `mascot`, `dsh-plugin`, `sprites`, `claude-code`
- **Why use it:** Public gallery of animated pet mascots for agent harnesses
...
- **Tags:** `skin`, `desktop`, `theme`
- **Why use it:** Beautiful whale girl skin series to personalize your DeepSeek Harness UI
...
- **Tags:** `ai`, `vibe-coding`, `deepseek`, `rag`
...
- **Why use it:** Beginner-friendly tutorial for mastering harness engineering
...
- **Tags:** `documentation`, `analysis`, `code-research`
- **Why use it:** Generates accurate technical docs and AI-ready context from codebases efficiently
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates evidence-based research reports
...
- **⭐ Stars:** 338
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合��，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `plugin-discovery`, `curation`
- **Why use it:** Daily automated GitHub scan with curated classification and real plugin filtering
...
- **Why use it:** Comprehensive curated list of plugins skills MCP servers patches and UIs
...
- **Why use it:** Ultimate DSH guide with quickstart resources curated plugins and toolkit
...
- **Tags:** `finance`, `stock`, `tushare`
- **Why use it:** Financial multi-agent system with Tushare DB, IM alerts, and MCP.
...
- **Tags:** `fintech`, `backtesting`, `investment-research`, `llm-agents`
...
- **Why use it:** Industry chain mapping and company research methodology skills
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Search 65,600+ Chinese platform API docs directly inside your AI agent.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Curated catalog of 280+ DSH plugins across 14 categories with direct repo links.
...
- **Why use it:** Curated stock, finance, and quant plugins for DSH ecosystem
...
- **Why use it:** Privacy-focused open-source resume builder, customizable and free forever
...
- **Why use it:** Community-curated directory covering plugins across CLI, web UI, and agent ecosystems
...
- **Why use it:** Bilingual curated list of DSH plugins, skills, tools, and verified references.
...
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, multimodal tools, and learning paths.
...
- **Why use it:** Plugin marketplace and hub with 11,000+ plugins and API access.
...
- **Why use it:** Comprehensive handbook covering runtime, plugins, MCP, and sandbox.
...
- **Why use it:** Curated list of DSH plugins covering productivity and extensions
...
- **Why use it:** Curated plugin discovery directory for DSH ecosystem
...
- **Why use it:** Evidence-led curated list with verified plugin installations
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** 2026 curated DSH plugins list with quality checks
...
- **Why use it:** Comprehensive catalog of 1000+ DSH tools sorted by stars
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated community plugin list with star rankings.
...
- **Why use it:** Plugin navigator with installation and compatibility guide.
...
- **⭐ Stars:** 3
- **Language:** TypeScript
- **Description:** DeepSeek Harness ��本的类 CodeX 插件市场
...
- **Why use it:** Auto-crawled daily plugin directory, bilingual.
...
- **Tags:** `repository`, `dsh-plugins-net`
...
- **Tags:** `awesome-list`
- **Why use it:** Original awesome-dsh-plugin repo, now moved.
...
- **Why use it:** Curated bilingual directory of DSH plugins with immutable commit reviews.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Auto-updating plugin list with bilingual README and Vercel deployment.

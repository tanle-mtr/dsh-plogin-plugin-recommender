...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,006,944 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-11 18:19:47 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 220,414 | Core DSH runtime enabling everything-as-plugin age |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,590 | Open-source Claude-style design agent with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,105 | Deploy multi-agent swarms and autonomous coordinat |
...
- **Why use it:** Core DSH runtime enabling everything-as-plugin agent orchestration
...
- **Why use it:** Task-aware router kit for intelligent routing.
...
- **Why use it:** Self-improving agent OS with evaluation loops.
...
- **Tags:** `control-plane`, `long-horizon`, `governance`
- **Why use it:** Long-horizon agent control plane for governance.
...
- **Why use it:** Virtual terminal enabling isolated agent environments with VFS support
...
- **Tags:** `agent-teams`, `orchestration`, `dsh-plugin`
...
- **Tags:** `context`, `dashboard`, `dsh-plugin`, `tools`
- **Why use it:** Deep context insight dashboard, sidebar and command for DSH management.
...
- **Tags:** `vision`, `ocr`, `computer-vision`, `agent-tools`
- **Why use it:** Enhanced vision toolkit for text-only LLMs with OCR and screenshot analysis.
...
- **Why use it:** CLI and resolver for managing DSH plugins and Hub schemas.
...
- **Tags:** `infrastructure`, `coding`, `skills`
...
- **Tags:** `superpowers`, `coding`, `reasonix`
...
- **Tags:** `superpowers`, `coding`, `tdd`, `debugging`
...
- **Tags:** `documentation`, `skillhub`, `dsh-plugin`
- **Why use it:** Official skill hub docs and examples for DSH plugin development
...
- **Why use it:** Fast Neovim plugin manager in Lua for DSH coding workflow
...
- **Tags:** `desktop`, `dsh`, `dsh-plugin`, `cordis`
- **Why use it:** Modern desktop client built around the DSH plugin ecosystem
...
- **Why use it:** Web-based plugin ecosystem aggregator for DSH.
...
- **Why use it:** Extensible sidebar with built-in file editor, terminal, chat, Git panels
...
- **Tags:** `taskboard`, `ui-extension`, `coding-agents`
- **Why use it:** Modern flexible task panel integrating with Codex and DSH interfaces
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status and rollback features
...
- **Tags:** `widget`, `ui-extension`, `floating`
- **Why use it:** Floating whale widget monitoring DeepSeek account balance with animations
...
- **Tags:** `desktop`, `tauri`, `dsh-plugin`, `native-app`
- **Why use it:** Zero-setup Tauri desktop with preset plugins for all platforms.
...
- **Why use it:** Local-first desktop workspace with files, research, and Office support
...
- **Why use it:** Windows desktop GUI with Codex, SSH, and mobile remote access
...
- **Tags:** `ui`, `dsh-ui`, `interactive`
- **Why use it:** Generates inline UI components — charts, forms, quizzes via dsh-ui fence
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite for macOS/Linux/Windows.
...
- **Tags:** `mobile`, `ios`, `client`
- **Why use it:** Native iOS client with WebSocket — workspace, sessions, agent traces on phone.
...
- **Why use it:** Open-source Smartisan Notes clone with DSH plugin and Docker support
...
- **Why use it:** One-click install community plugins from Web GUI
...
- **Why use it:** Desktop console for multi-tab DSH/Harness management
...
- **Why use it:** Persistent bottom bar showing balance, pricing and model info
...
- **Why use it:** WorkBuddy-style skill picker for easier skill selection
...
- **Why use it:** Bioinformatics desktop agent for clinicians and scientists
...
- **Tags:** `mcp`, `ui`, `skills`, `dsh-plugin`
- **Why use it:** Web GUI panel for managing skills and MCP servers in browser
...
- **Why use it:** All-in-one DevOps desktop: SSH, DB client, Docker, SFTP and AI assistant
...
- **Why use it:** Electron desktop wrapper for DSH with sidebar and web UI integration
...
- **Tags:** `theming`, `webui`, `customization`
- **Why use it:** Custom web background themes with presets and real-time preview
...
- **Why use it:** One-click compact mode for the DSH Web context meter panel.
...
- **Why use it:** Transforms recent chat history into beautifully shareable knowledge cards.
...
- **Tags:** `rag`, `dsh-plugin`, `knowledge-base`, `vector-search`
- **Why use it:** Open-source RAG platform turning documents into queryable knowledge and wiki
...
- **Why use it:** Lightweight memory library for stateful agents.
...
- **Why use it:** Dedicated memory management kit helping agents remember and refine
...
- **Tags:** `memory`, `agent`, `rag`, `personal-ai`
...
- **Tags:** `skills`, `rag`, `retrieval`, `infrastructure`
...
- **Why use it:** Visual non-linear canvas workspace for exploring and branching conversations
...
- **Why use it:** Comprehensive AI knowledge encyclopedia covering LLMs, agents, RAG, and MLOps
...
- **Tags:** `knowledge`, `api`, `documentation`
- **Why use it:** 65,600+ Chinese API docs searchable in DSH/Cursor
...
- **Tags:** `agent-skills`, `dsh-plugin`, `llm-agent`, `meta-skill`
...
- **Tags:** `workspaces`, `multi-device`, `agents`
...
- **Why use it:** Largest curated skills marketplace for DSH.
...
- **Tags:** `preset`, `bootstrap`, `agent-skills`
- **Why use it:** Two-phase preset streamlining DSH bootstrap with Standard tools
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `research`
...
- **Tags:** `video`, `agent-skill`, `ffmpeg`, `automation`
...
- **Why use it:** Organized novel writing workflow with character/worldbuilding management.
...
- **Tags:** `skill`, `multimodal`, `ocr`
- **Why use it:** Turns video/audio/screen into timestamped searchable evidence with OCR and CV
...
- **Why use it:** Complete creative writing and short-drama production skill for DSH.
...
- **Why use it:** Native taskboard with SQLite, agent claim/review, no iframe needed.
...
- **Tags:** `ios`, `mobile-automation`, `agent-tools`
- **Why use it:** 22 agent tools for iOS Simulator — boot, build, drive from conversation.
...
- **Tags:** `agent-skills`, `self-evolve`, `workflow`
...
- **Why use it:** Turns experience into repeatable execution patterns for agents
...
- **Tags:** `skill-learning`, `automation`, `reusable`
...
- **Tags:** `patent`, `legal`, `skill`
- **Why use it:** Patent infringement analysis system with skill packaging
...
- **Why use it:** 25 ready-to-use engineering skills in right panel
...
- **Why use it:** Legal litigation timeline and case visualization
...
- **Tags:** `gongwen`, `document`, `office`
- **Why use it:** Official document processing following GB/T 9704
...
- **Tags:** `spec`, `programming`, `agent`
- **Why use it:** Repository-native spec programming portable agent skill
...
- **Why use it:** Fusion of Bazi, Fengshui, I Ching and TCM in one skill
...
- **Why use it:** 11 QA skills with shared knowledge base for testing
...
- **Why use it:** Interactive narrative RPG with NPC memory and YAML存档
...
- **Tags:** `quality-gate`, `engineering-discipline`, `skills`
- **Why use it:** Quality gate workflow to grill requirements and prove delivery
...
- **Why use it:** Godot Engine 4.x full-stack game dev skill pack for DSH agents
...
- **Why use it:** Guides AI agents to build DSH plugins from scratch
...
- **Tags:** `video`, `remotion`, `agent-skills`, `motion-design`
...
- **Why use it:** Pre-flight plugin library check ensures agents use optimal tools reliably.
...
- **Why use it:** One-click MCP/Skills config sync across 8+ AI agents
...
- **Why use it:** Open-source Claude-style design agent with local-first desktop support
...
- **Tags:** `agent-skills`, `diagrams-as-code`, `dsh-plugin`, `mermaid-alternative`
- **Why use it:** Generate verifiable architecture, sequence, and data-flow diagrams as code
...
- **Tags:** `ai-image-generation`, `dsh-plugin`, `skills`, `workflow-automation`
- **Why use it:** 530+ prompt templates and skills library for GPT image generation
...
- **Why use it:** Open-source AI-native vector design tool.
...
- **Why use it:** First vision plugin for DSH, enables image analysis for text-only agents
...
- **Why use it:** Enables image-to-text for text-only LLMs via OCR
...
- **Why use it:** 6 design style presets to give AI-generated sites a polished look
...
- **Why use it:** Cross-platform content discovery agent for Bilibili, YouTube, Reddit etc.
...
- **Why use it:** AI agents leverage your real logged-in browser for seamless automation.
...
- **Why use it:** Tabbit browser automation plugin suite for DSH
...
- **Why use it:** OAuth-based ChatGPT binding lets you chat with ChatGPT models inside DSH.
...
- **Why use it:** DingTalk IM channel turns each chat into a tool-capable agent with read receipts.
...
- **Tags:** `dsh-plugin`, `electron`, `image`, `upyun`
- **Why use it:** Universal image uploader supporting 60+ hosting services and editors
...
- **Tags:** `ai-agent`, `dsh-plugin`, `low-code`, `self-hosted`
...
- **Tags:** `plugin-registry`, `ecosystem`, `tooling`
- **Why use it:** Self-hosted radar auto-discovers and validates 15900+ plugin candidates.
...
- **Tags:** `cost-tracking`, `token-usage`, `api-cost`
- **Why use it:** Track session and daily API costs, budgets, and usage history.
...
- **Why use it:** Complete DSH plugin catalog with 1958 repos, Chinese/English search
...
- **Why use it:** Bridges Pi and DSH ecosystems via one Host ABI for plugin migration
...
- **Why use it:** Agent-first DSH handbook covering runtime, plugins, MCP, and 74 resources
...
- **Why use it:** P2P encrypted multi-device remote access to DSH from PC/Android/Web
...
- **⭐ Stars:** 123
- **Language:** TypeScript
- **Description:** 帮���插件自动随着dsh版本升级的skill
...
- **Why use it:** Unified local Agent Skills loading and safety management
...
- **Tags:** `evaluation`, `llm-judge`, `rag-evaluation`, `dsh-plugin`
...
- **Tags:** `migration`, `claude-code`, `dsh-plugin`
- **Why use it:** Migration wizard to move sessions and data from Claude Code/Codex/Hermes
...
- **Tags:** `cost-tracking`, `visualization`, `api-monitoring`
...
- **Tags:** `diagnostics`, `conflict-resolution`, `compatibility`
...
- **Tags:** `mascot`, `pets`, `ui`
- **Why use it:** Gallery of animated pet mascots for coding agents.
...
- **Why use it:** Whale girl themed skins for DeepSeek Harness desktop experience.
...
- **Why use it:** Animated ocean theme with Three.js/WebGPU; also works as Chrome/Edge extension
...
- **Tags:** `research`, `web-search`, `china`, `agent-skill`
- **Why use it:** Searches 8 major Chinese platforms for recent 30 days content research.
...
- **Why use it:** Strongest free web search plugin; bridges models without native access
...
- **Why use it:** Curated plugin discovery tool with ranking, categorization, and auto-updates.
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, GPU tracking, experiment logs.
...
- **Why use it:** Learn DSH principles, browse plugin marketplace, and explore best practices.
...
- **Why use it:** Curated list of plugins, skills, MCPs, patches, orchestrators, and UIs.
...
- **Tags:** `marketplace`, `store`, `catalog`
- **Why use it:** Plugin store with 11K+ entries, search, rankings, install commands, and API.
...
- **Why use it:** Local financial DB with multi-agent stock analysis and IM monitoring
...
- **Tags:** `community`, `marketplace`, `awesome-list`
...
- **Tags:** `awesome-list`, `directory`, `research`
...
- **Tags:** `guide`, `knowledge`, `development`
- **Why use it:** Plugin development knowledge base as on-demand skill
...
- **Tags:** `kline`, `finance`, `chart`
- **Why use it:** Interactive K-line chart with indicators and news analysis
...
- **Why use it:** Vertical curated list of 24 stock/finance/quant DSH plugins
...
- **Why use it:** Curated plugin list — great discovery starting point.
...
- **Tags:** `awesome-list`, `ecosystem`, `curation`
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `curation`
- **Why use it:** Curated community-maintained plugin ecosystem listing for dsh.
...
- **Why use it:** Curated bilingual resource list covering DSH ecosystem tools
...
- **Tags:** `awesome-list`, `registry`, `resources`
- **Why use it:** Curated awesome list covering plugins, tools, skills & MCPs
...
- **Tags:** `verified`, `directory`, `curated`
...
- **Tags:** `awesome-list`, `2026`, `quality-checked`
...
- **Why use it:** Collection of useful DSH plugins for general use
...
- **Tags:** `directory`, `comprehensive`, `star-ranked`
- **Why use it:** Complete star-ranked directory of 1000+ DSH ecosystem plugins
...
- **Tags:** `verified`, `community`, `directory`
...
- **Tags:** `documentation`, `navigation`, `guidance`
- **Why use it:** Plugin product manuals and navigation by use case with risk info
...
- **Why use it:** Zero-dependency static portal for browsing and installing DSH plugins easily.
...
- **Tags:** `dsh-plugin-bundle`, `dsh-plugin-market`, `skills`
- **Why use it:** CodeX-style plugin marketplace for DSH, centralized skill discovery.
...
- **Why use it:** Curated DSHA plugin collection for quick reference and discovery.
...
- **Why use it:** Evidence-backed DSH plugin radar with 2Origin lab integration.
...
- **Why use it:** Search npm and awesome-lists directly from inside DSH agents for plugin discovery.
...
- **Why use it:** Community-curated DeepSeek Harness plugins repository and verification hub.
...
- **Why use it:** 80+ verified DSH plugins organized by functionality for easy browsing.
...
- **Why use it:** Archived original repo, now migrated to awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Why use it:** General DSH plugin collection with limited details
...
- **Tags:** `plugin-list`, `awesome`, `dsh`
- **Why use it:** Curated evidence-aware DSH plugin shortlist

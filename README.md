...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,018,520 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-13 18:40:36 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 222,419 | Core DSH framework — all plugins run here |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,907 | Open-source design agent alternative to Claude Des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,304 | Multi-agent swarm orchestration with autonomous wo |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 24 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (24)
...
- **Why use it:** Core DSH framework — all plugins run here
...
- **Why use it:** Terminal-based DeepSeek-native AI coding agent
...
- **Tags:** `routing`, `injector`, `workflow`
- **Why use it:** Runtime injector and task-aware routing kit for enhanced DSH workflows.
...
- **Why use it:** Self-improving agent OS with interview-gated staged evaluation and budget.
...
- **Why use it:** Two-phase preset bootstrap with Standard tools (Project2 98/99).
...
- **Tags:** `terminal`, `sandbox`, `virtual-filesystem`
- **Why use it:** Virtual terminal with sandboxed execution for AI agents.
...
- **Tags:** `installer`, `model-switch`, `multi-agent`
- **Why use it:** One-click install and model switching across Claude Code, Codex, DeepSeek, etc.
...
- **Tags:** `documentation`, `generation`, `code-analysis`
...
- **Tags:** `agent-teams`, `collaboration`, `orchestration`
- **Why use it:** Enable multi-agent collaboration and team orchestration in DSH
...
- **Why use it:** Best context dashboard and management tool for DSH workflows
...
- **Why use it:** Powerful vision toolkit for text-only LLMs with OCR and UI restoration
...
- **Tags:** `plugin-marketplace`, `deepseek-harness`
- **Why use it:** Comprehensive daily-updated plugin marketplace with review quality control.
...
- **Tags:** `coding-agent`, `rpc`, `mcp`, `terminal`
- **Why use it:** Coding agent with RPC sub-agents, hashline edits, and MCP support for terminal workflows.
...
- **Tags:** `ios`, `mobile-automation`, `coding-agent`
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools inside DSH
...
- **Why use it:** TDD, debugging, planning skills from Superpowers for DSH
...
- **Why use it:** Essential tool for creating and validating DSH plugins
...
- **Why use it:** Fast Neovim plugin manager in Lua, ideal for efficient workflow setup.
...
- **Tags:** `agent-tools`, `ai-agents`
- **Why use it:** Pre-flight plugin check for DSH agents
...
- **Tags:** `web-ui`, `plugin-aggregation`, `ecosystem`
...
- **Why use it:** Enterprise multi-agent workbench with visual editor and team collaboration.
...
- **Tags:** `sidebar`, `ui`, `extensions`
- **Why use it:** Open sidebar with file editor, terminal, chat, Git, and sub-agent pages.
...
- **Tags:** `task-panel`, `ui`, `embedded`
- **Why use it:** Modern flexible task panel embeddable in Codex and DSH interfaces.
...
- **Tags:** `tui`, `interface`, `theme`
- **Why use it:** Claude Code-style TUI with whale header, streaming thoughts, and rollback.
...
- **Tags:** `widget`, `ui`, `balance-tracker`
- **Why use it:** Cute floating whale widget tracking DeepSeek account balance in DSH.
...
- **Tags:** `agent-runtime`, `desktop`, `ai-coding`
- **Why use it:** High-performance Rust runtime with polished desktop UX for AI coding
...
- **Why use it:** Local-first Electron desktop workspace integrating DSH sessions, plugins, and Office tools.
...
- **Tags:** `desktop-app`, `multi-model`, `privacy`, `local-first`
- **Why use it:** Local-first multi-model desktop app with self-evolving skills and privacy-first design.
...
- **Tags:** `office`, `spreadsheet`, `desktop-extension`
- **Why use it:** Brings full office suite (spreadsheets, docs, slides) into DeepSeek Harness
...
- **Tags:** `mobile`, `ios`, `native-client`
- **Why use it:** Native iOS client syncing workspace, sessions and agent execution traces
...
- **Tags:** `desktop`, `electron`, `ui-extension`
- **Why use it:** CodePilot-inspired Electron desktop client for DSH on all major platforms
...
- **Why use it:** Smartisan-style notes app with Docker deploy, skill calls and WeChat export
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI panel for managing skills and MCP tools
...
- **Why use it:** Clean bottom bar with live usage stats and pricing info
...
- **Why use it:** Bioinformatics desktop app with offline mode and skill store
...
- **Why use it:** WorkBuddy-style skill picker for easy skill selection
...
- **Why use it:** All-in-one DevOps desktop: SSH, SFTP, Docker, DB client, and AI assistant in one window.
...
- **Why use it:** Electron-based desktop wrapper integrating multiple DSH tools and extensions.
...
- **Tags:** `ui`, `button`, `webui`, `dsh-plugin`
- **Why use it:** One-click compact button for DSH Web context meter, improves UI ergonomics.
...
- **Why use it:** Self-evolving context DB unifying memory, RAG, and skills
...
- **Why use it:** Self-maintaining RAG knowledge base with semantic search
...
- **Why use it:** Portable local-first memory layer with Markdown-native agent memory.
...
- **Tags:** `memory-os`, `hybrid-retrieval`, `token-optimization`
...
- **Tags:** `memory-library`, `stateful-agents`, `continual-learning`
...
- **Why use it:** Memory management kit enabling agents to remember and refine context.
...
- **Tags:** `memory`, `agent`, `personal-ai`
- **Why use it:** Shared persistent memory hub giving all AI agents unified context
...
- **Tags:** `agent-memory`, `skill-corpus`, `embeddings`, `vector-search`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready agent corpora with eval tooling.
...
- **Tags:** `knowledge-base`, `ai-pedia`, `rag`, `multi-model`
- **Why use it:** Comprehensive AI encyclopedia covering LLMs, agents, RAG, multimodal, and MLOps resources.
...
- **Tags:** `multi-agent`, `agentic-workflow`, `skills`
...
- **Why use it:** Distill expertise into reusable AI agent skills
...
- **Tags:** `agent-workspace`, `task-tracking`, `multi-device`
- **Why use it:** Unified agent workspace with cross-device task tracking and MCP support.
...
- **Tags:** `skills-store`, `marketplace`, `agent-skills`
- **Why use it:** Most comprehensive skills store with auto-updated curated agent skill packs.
...
- **Tags:** `long-horizon`, `control-plane`, `workflow-automation`
- **Why use it:** Long-horizon agent control plane with durable governed cross-harness workflows.
...
- **Tags:** `cognition`, `skills`, `research-based`
...
- **Tags:** `video`, `agent-skill`, `automation`
- **Why use it:** End-to-end automated Vox-style video generation from a single topic
...
- **⭐ Stars:** 840
- **Language:** TypeScript
- **Description:** AI 小说创作软件：把灵感、角色、世界观、大纲、章节写作、审稿和修稿组织成可控流程；提供 Windows/macOS 桌面版、Ollama 与 DSH 插件预览。AI Novel Writing Software: Organizes inspirations, characters, worldbuilding, outlines, chapter drafting, review, and revision into a controllable workflow. Features desktop apps for Windows/macOS, Ollama integration, and a DeepSeek Harness (DSH) plugin preview.
- **Tags:** `writing`, `novel`, `creative`
- **Why use it:** Complete AI novel writing workflow with worldbuilding and revision tools
...
- **Tags:** `canvas`, `branching`, `workspace`, `conversation`
- **Why use it:** Visual non-linear conversation canvas enabling branching sessions and workspace exploration.
...
- **Tags:** `computer-vision`, `multimodal`, `ocr`, `agent-skill`
- **Why use it:** Gives agents vision and hearing — turns video, audio, screen into searchable timestamped evidence.
...
- **⭐ Stars:** 343
- **Language:** Python
- **Description:** DeepSeek 写网文/小说的工作流插件：DeepSeek Harness 社区插件，内置小说、短剧、游戏、视频解说四个工作台 | Community DeepSeek Harness plugin with novel, short-drama, game and video-recap workbenches. Not affiliated with DeepSeek.
- **Tags:** `novel-writing`, `creative-writing`, `agent-skills`
- **Why use it:** Specialized creative writing workflows for novels, short dramas, games and video
...
- **Tags:** `task-management`, `agent-workflow`, `sqlite`
- **Why use it:** Native taskboard with SQLite projects and agent claim/review workflow
...
- **Tags:** `plan-mode`, `agent-review`, `self-evolving`
- **Why use it:** Composable, human-reviewed agent modes enabling self-evolution
...
- **Why use it:** Turn experience into repeatable execution across coding agents
...
- **⭐ Stars:** 170
- **Language:** Python
- **Description:** 为 Claude Code 赋能多模态视觉能力，适配 纯文本 LLM 底座，用于截图 / UI / 图表分析；搭配 browser-harness 可做前端布局自动化��查。
...
- **Tags:** `skills`, `research`, `marketing-automation`
...
- **Why use it:** 87 reverse engineering skills for security research and CTF
...
- **Tags:** `skill-generation`, `agent-learning`
- **Why use it:** Converts successful sessions into reusable agent skills
...
- **Tags:** `fintech`, `backtesting`, `mcp`
- **Why use it:** AI investment desk with multi-strategy backtesting skills
...
- **Tags:** `bazi`, `fengshui`, `wisdom`
- **Why use it:** Unique Chinese wisdom AI skill with local deterministic engine
...
- **Why use it:** Enables OCR and image reading for text-only models
...
- **Why use it:** Multi-agent collaboration with shared workspace

---

### [daha1216/dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension)

- **⭐ Stars:** 33
- **Language:** Python
- **Description:** DeepSeek自带破甲18+互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。
- **Tags:** `roleplay`, `narrative`, `interactive`
- **Why use it:** Rich interactive narrative skill with memory and YAML存档
...
- **Why use it:** Code simplification Codex skill adapted for DSH workflows
...
- **Tags:** `video`, `image`, `audio`, `directorx`
- **Why use it:** AI video/image/audio generation skills with DirectorX integration
...
- **Why use it:** 11 testing skills with shared knowledge base for AI agents
...
- **Why use it:** Enables cross-session agent continuity with repository-local memory.
...
- **Tags:** `math-modeling`, `multi-agent`, `skill`
...
- **Tags:** `skillhub`, `api`, `open-api`
- **Why use it:** Official SkillHub Open API docs with DSH plugin integration.
...
- **⭐ Stars:** 24
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent �� 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型适配器、工具注册表、Agent 循环、网页界面都是插件
- **Tags:** `plugin-dev`, `skill`, `tutorial`
- **Why use it:** Guides AI to build DSH plugins from scratch with step-by-step instructions.
...
- **Why use it:** Cinematic video agent skill with 152 shot recipes and Remotion templates.
...
- **Tags:** `plugin-dev`, `agent-skill`, `standards`
- **Why use it:** Agent skill for developing DSH plugins per official standards.
...
- **⭐ Stars:** 474
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的��型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `free`, `mcp`, `harness-tool`
- **Why use it:** Strongest free web search bridge for models without native web access, no signup needed.
...
- **Tags:** `provider`, `llm`, `command-code`
...
- **Tags:** `mcp`, `config-sync`, `multi-tool`
- **Why use it:** One-click MCP/Skills config sync across multiple AI tools
...
- **Why use it:** Web GUI plugin manager for skills and MCP servers in DSH settings.
...
- **Why use it:** Open-source design agent alternative to Claude Design
...
- **Why use it:** 530+ image prompts and reusable skill templates
...
- **Tags:** `design-tool`, `vector`, `agentic-design`
...
- **Why use it:** First vision plugin enabling OCR for text-only coding agents in DSH.
...
- **Why use it:** Native design studio with AI generation, template market, and PPT
...
- **Tags:** `genui`, `ui-components`, `charts`, `interactive`
- **Why use it:** Generates interactive inline UI components — charts, forms, quizzes — in assistant replies.
...
- **Tags:** `kline`, `visualization`, `financial-analysis`
- **Why use it:** Interactive K-line analysis with sidebar visualization and market data.
...
- **Why use it:** 6 design style presets to avoid generic AI-looking websites.
...
- **Why use it:** Real-time token usage charts and cost estimates, great for budget monitoring.
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任���服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `visual`, `theme`, `background`, `webui`
- **Why use it:** Personalize DSH Web background with custom images and preset atmospheres.
...
- **Tags:** `knowledge-cards`, `awesome-dsh-plugin`
...
- **Why use it:** Cross-browser AI assistant enhancement suite with prompt manager
...
- **Tags:** `content-discovery`, `automation`, `cross-platform`
- **Why use it:** Cross-platform AI content discovery agent for Bilibili, YouTube, Reddit etc.
...
- **Why use it:** Connect AI agents to your real logged-in browser seamlessly
...
- **Tags:** `electron`, `image-uploader`, `s3`
...
- **Tags:** `marketplace`, `installation`, `discovery`
- **Why use it:** Built-in marketplace for browsing and one-click installing DSH plugins.
...
- **Tags:** `plugin`, `ecosystem`, `infrastructure`
- **Why use it:** Self-hosted plugin radar with k8s-grade validation and auto-indexing
...
- **Why use it:** AI security platform auditing code for hallucinated packages, vulnerabilities and safety gaps.
...
- **Tags:** `subscriptions`, `oauth`, `llm-provider`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as LLM providers without API keys
...
- **Why use it:** Open-source CLI and plugin manager for DSH Plugin Hub
...
- **Why use it:** Tracks session/daily costs, budgets, and token usage across providers
...
- **Tags:** `catalog`, `marketplace`, `plugin-directory`
...
- **Why use it:** Bridges Pi ecosystem to DSH — run Pi extensions as native plugins
...
- **Why use it:** Full config backup/restore with webdav sync support
...
- **Tags:** `context`, `audit`, `tooling`
- **Why use it:** Audits context tokens, detects duplicates and conflicts
...
- **Tags:** `container`, `management`, `versioning`
- **Why use it:** Isolated multi-version DSH management in containers
...
- **Tags:** `launcher`, `infrastructure`, `cordis`
...
- **Tags:** `utility`, `plugin-conflict`, `deepseek-harness`
- **Why use it:** Diagnoses plugin conflicts and provides solutions, essential for stable DSH setup.
...
- **Tags:** `mascot`, `animated`, `cli-theme`
- **Why use it:** Public animated pet gallery to personalize and liven up your agent CLI interface.
...
- **Tags:** `skin`, `theme`, `customization`
- **Why use it:** Beautiful whale-themed skins to personalize your DSH desktop
...
- **Tags:** `theme`, `glassmorphism`, `customization`, `ui`
- **Why use it:** High-freedom frosted glass theme for DSH web UI with adjustable blur,磨砂 and custom wallpapers.
...
- **Tags:** `animated`, `ocean`, `theme`, `threejs`
- **Why use it:** Real-time animated ocean theme with adjustable waves, sunset and glass opacity effects.
...
- **Why use it:** Comprehensive AI resource hub with tutorials and prompt guides.
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day research reports
...
- **Tags:** `math-modeling`, `competition`, `agent-skill`
...
- **Why use it:** Cross-database academic search with citation graphs and MeSH support
...
- **Tags:** `finance`, `stock`, `mcp`
- **Why use it:** Local financial DB via Tushare with multi-agent stock analysis and IM alerts
...
- **Tags:** `research`, `industry-analysis`
...
- **Why use it:** Unofficial community-curated catalog of all DSH plugins.
...
- **Why use it:** Curated list of essential DeepSeek Harness plugins.
...
- **Why use it:** Comprehensive awesome list covering plugins, skills, tools, and resources.
...
- **Why use it:** Curated star-ranked DSH plugin directory
...
- **Why use it:** Plugin guide with installation and risk info
...
- **Why use it:** Static web portal for plugin discovery
...
- **Tags:** `dsh-plugin-market`, `awesome-dsh-plugin`
...
- **Tags:** `ai-agents`, `awesome-list`
- **Why use it:** AI-curated 190+ plugins across 12 categories
...
- **Tags:** `ai-agent`, `plugin-registry`
- **Why use it:** Evidence-backed plugin radar and registry
...
- **Why use it:** Search npm + awesome list from inside DSH
...
- **Why use it:** DSH plugin repository and verification list
...
- **Tags:** `awesome-list`, `dsh-plugins`
- **Why use it:** Original awesome-dsh-plugin repo
...
- **Why use it:** Curated plugin directory for discovering DSH ecosystem plugins.
...
- **Tags:** `awesome-list`, `plugin`, `community`
- **Why use it:** Another excellent curated plugin list for the DSH ecosystem
...
- **Why use it:** Curated plugin discovery list with daily GitHub scans and classification
...
- **Why use it:** Ultimate DSH guide with quickstart, resources, plugins and toolkit curation
...
- **Tags:** `awesome-list`, `mcp`, `orchestrator`
- **Why use it:** Curated list of plugins, skills, MCP servers, patches and orchestrators
...
- **Why use it:** Comprehensive handbook covering runtime, plugins, MCP and troubleshooting
...
- **Why use it:** Plugin catalog with 1819 verified plugins, bilingual search and filtering
...
- **Why use it:** Official auto-generated plugin directory by cordis.run
...
- **⭐ Stars:** 51
- **Language:** Python
- **Description:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内��优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `ai-docs`, `deepseek-harness`, `deepseek-harness-plugin`, `docx`, `dsh-plugin`, `gongwen`, `wps-office`
- **Why use it:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内��优化（Word 
...
- **Why use it:** Public GitHub directory for DSH plugin discovery and ecosystem browsing.
...
- **Why use it:** Spam-filtered open-data registry, a trusted source for DSH plugin discovery.
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** 2026 curated list with quality checks, keeping plugin discovery up to date.
...
- **Why use it:** Niche stock/finance/quant plugin list for vertical DSH use cases.
...
- **Tags:** `tts`, `xiaomi`, `audio`, `plugin`
- **Why use it:** Free Xiaomi MiMo TTS integration, supports custom and built-in browser voices.
...
- **Why use it:** Hand-picked collection of useful DSH plugins for quick reference.
...
- **Tags:** `awesome-list`, `plugin-registry`, `deepseek-harness`
- **Why use it:** Complete 1000+ repo DSH plugin inventory sorted by stars, comprehensive resource.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `deepseek-harness`, `bilingual`
- **Why use it:** Curated evidence-led bilingual directory of DSH plugins with immutable commit reviews
...
- **Why use it:** Minimal DSH plugin listing repository for community reference
...
- **Tags:** `awesome-list`, `dsh-plugin`, `auto-updating`, `bilingual`
- **Why use it:** Auto-updating curated plugin list with YAML-driven bilingual README generation

...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 838,919 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 14:30:18 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,068 | Core plugin ecosystem framework for DSH |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,625 | Open-source Claude Design alternative for DSH |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,944 | Deploy multi-agent swarms and autonomous workflows |
...
- [Themes & Skins](#themes-&-skins) — 7 plugins
...
- **Why use it:** Core plugin ecosystem framework for DSH
...
- **Tags:** `ai-agent`, `mcp`, `multi-agent`, `dsh-plugin`
- **Why use it:** Super AI assistant with memory and multi-model support
...
- **Tags:** `agent-orchestration`, `workspace`, `multi-device`, `mcp`
...
- **Tags:** `agent-os`, `loop-engineering`, `evaluation`, `mcp`
- **Why use it:** Self-improving agent OS with loop engineering and LLM evaluation
...
- **Tags:** `enterprise`, `multi-agent`, `workspace`, `editor`
...
- **Why use it:** Vision bridge enabling text-only agents to process images as JSON
...
- **Why use it:** One-click switch between 9+ coding agents including Claude Code, Codex, DeepSeek Harness
...
- **Tags:** `tui`, `coding-agent`, `dsh-plugin`
...
- **Why use it:** High-performance Rust agent runtime paired with polished desktop coding agent application
...
- **Tags:** `code-review`, `developer-tools`, `dsh-plugin`
...
- **Why use it:** Architecture-aware coding with drift detection
...
- **Why use it:** Official Swift-native macOS coding agent
...
- **Tags:** `coding-agents`, `multi-agent`, `collaboration`, `skill`
- **Why use it:** Unifies multiple coding agents into one collaborative team workflow
...
- **Why use it:** Agent skill that teaches DSH plugin development standards
...
- **Why use it:** One-tap import from Codex with two-way Skills/MCP sync.
...
- **Tags:** `agent-framework`, `mcp`, `skills`, `cli`, `kit`
- **Why use it:** All-in-one package: 42 skills, CLIs, and plugins for agent engineering.
...
- **Why use it:** Portable skill for developing and auditing DSH plugins with bundle adapter
...
- **Tags:** `plugin-dev`, `documentation`, `skill`
- **Why use it:** Practical DSH plugin dev guides with real-world troubleshooting notes
...
- **Why use it:** Build and test DSH plugins entirely inside the platform with scaffolding
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp`, `skills`
- **Why use it:** Unified menu to manage MCP tools and skills exposure and execution mode.
...
- **Tags:** `dsh-plugin`, `plugin-manager`, `mcp`, `skills`
- **Why use it:** Built-in GUI plugin manager for MCP, Skills, and bundles with hot-reload.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp`, `skill-management`, `hot-reload`
- **Why use it:** Configures MCP servers and manages skills via JSON paste without restart.
...
- **Tags:** `desktop`, `cordis-plugin`, `dsh-plugin`
...
- **Tags:** `desktop-companion`, `electron`, `plugin-sdk`
- **Why use it:** Desktop pet companion with plugin SDK
...
- **Why use it:** Lightweight Tauri desktop app, zero setup needed
...
- **Why use it:** Cute whale widget showing account balance at desktop
...
- **Why use it:** Local-first desktop workspace integrating DSH features
...
- **Tags:** `agent`, `desktop-app`, `local-first`, `multi-model`
...
- **Tags:** `ui-components`, `interactive`, `charts`, `forms`
- **Why use it:** Interactive UI components rendered inline in DSH assistant replies
...
- **Tags:** `ios`, `mobile-automation`, `webdriveragent`, `simulator`
- **Why use it:** Live iOS Simulator inside DSH with 22 mobile automation tools
...
- **Tags:** `conversation`, `canvas`, `workspace`
- **Why use it:** Canvas-based non-linear conversation workspace for deep exploration
...
- **Tags:** `electron`, `desktop`, `gui`, `ssh`
- **Why use it:** Full-featured Electron desktop client with SSH, skills and remote access
...
- **Why use it:** Smartisan-style notes app with Docker deployment and DSH integration
...
- **Why use it:** Live provider model info, balance, and pricing countdown in status bar
...
- **Why use it:** Floating HUD panel showing git status, MCP, skills, model, and tokens.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `desktop`, `docker`, `ssh`, `database`
- **Why use it:** Cross-platform desktop app integrating DB, SSH, Docker, and AI assistant.
...
- **⭐ Stars:** 4
- **Language:** JavaScript
- **Description:** 桌面版 DeepSeek Harness：Electron 壳 + 自托�� dsh web 服务，集成 dsh-better-sidebar / dsh-web-ui / ModLens / awesome-dsh-plugin / dshmarket
...
- **Tags:** `multi-agent`, `swarm`, `skills`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `digital-human`, `dsh-plugin`
- **Why use it:** Transform memories into warm reusable AI skills
...
- **Tags:** `tutorial`, `agent`, `harness-engineering`, `skills`
- **Why use it:** Comprehensive beginner guide for mastering DSH plugin development
...
- **Tags:** `routing`, `workflow`, `automation`, `cordis`
- **Why use it:** Task-aware reasoning-mode router for adaptive agent workflows
...
- **Tags:** `preset`, `bootstrap`, `standards`, `workflow`
- **Why use it:** Two-phase bootstrap preset achieving Project2 98/99 tool coverage
...
- **Why use it:** General-purpose skill that auto-routes and orchestrates harness workflows intelligently
...
- **Why use it:** Vision toolkit for text-only LLM agents
...
- **Tags:** `task-manager`, `agentic-workflow`, `mcp`
- **Why use it:** Human-in-loop task manager with mobile/web UI
...
- **Tags:** `skills`, `agent`, `coding`, `workflow`
- **Why use it:** Turn experiences into repeatable agent skills across major coding tools
...
- **Tags:** `vision`, `multimodal`, `skill`, `claude`
...
- **Why use it:** AI-powered novel writing and short-drama production with structured skills
...
- **Why use it:** Specialized skills for AI infra dev: write, optimize, debug high-performance systems
...
- **Why use it:** Native SQLite-backed taskboard with Agent claim/review, no iframe needed
...
- **Why use it:** AI coding mentor that guides through projects step by step
...
- **Tags:** `spec-driven-development`, `ai-coding`, `dsh-plugin`
...
- **Why use it:** Agent skill for managing installed DSH plugin slots and credentials
...
- **Tags:** `agent-skills`, `session-memory`, `handoff`
- **Why use it:** Enables seamless agent handoff with persistent session memory.
...
- **Tags:** `agent-skills`, `code-simplification`, `codex`
- **Why use it:** Applies DSH simplification patterns as reusable Codex skills.
...
- **Tags:** `dsh-plugin`, `skill-picker`, `ux`
- **Why use it:** Quickly pick and insert skills in the DSH composer UI.
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `agent-skills`
...
- **Why use it:** Multi-agent team with independent models, skills, and shared workspace.
...
- **Why use it:** Centralized management interface for DSH skills.
...
- **Tags:** `media`, `image`, `vision`, `agent-skills`
- **Why use it:** Image reading and generation skills via multi-model vision support.
...
- **Why use it:** Version-pinned Swift Cycle governance skill for DSH projects.
...
- **Tags:** `docx`, `gongwen`, `office`
- **Why use it:** Full pipeline Chinese official document creation per GB/T 9704 standard
...
- **Tags:** `engineering`, `skill`, `practices`
- **Why use it:** Engineering discipline distilled from DSH fact-finding and decision practices
...
- **Tags:** `canvas`, `creative`, `mcp`
- **Why use it:** Infinite creative canvas with agentic workflow and MCP tool integration
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `godot`, `game-development`, `gdscript`
- **Why use it:** Registers Godot Engine 4.x full-stack game dev skill at runtime.
...
- **Why use it:** Virtual product team preset for guided agent workflows
...
- **Tags:** `agent-tools`, `pre-flight`, `utility`
- **Why use it:** Pre-flight checklist that injects top-K relevant plugins per task
...
- **Tags:** `web-search`, `free`, `mcp`, `agents`
- **Why use it:** Strongest free web search plugin, works as search bridge for all models
...
- **Tags:** `mcp`, `skills`
- **Why use it:** Web UI panel for managing skills and MCP servers in DSH
...
- **Why use it:** Image OCR and pixel-to-text tools for text-only LLMs
...
- **Tags:** `design-systems`, `ui-generator`, `vibe-coding`, `dsh-plugin`
...
- **Why use it:** Generate beautiful architecture and workflow diagrams as code
...
- **Tags:** `image-generation`, `prompt-engineering`, `skills`, `visual`
- **Why use it:** 470+ reverse-engineered image prompts with reusable skills
...
- **Why use it:** Turns one topic into finished Vox-style paper-collage explainer video automatically end-to-end
...
- **Why use it:** AI-powered design studio with PPT, prototyping and template marketplace
...
- **Tags:** `image-generation`, `seedream`, `design`
- **Why use it:** Generate images directly in-chat with Seedream and other models
...
- **Tags:** `design`, `ui`, `ppt`
- **Why use it:** Preview and edit OpenPencil UI documents directly in DSH conversation
...
- **Why use it:** Transform legal case materials into courtroom-ready timelines
...
- **Why use it:** Prevents AI-generic look with 6 curated design system styles.
...
- **Tags:** `ai-video`, `image`, `directorx`
- **Why use it:** AI video/image/audio generation with storyboard and vision tools
...
- **Why use it:** Chrome sidebar to control browser directly without vision capabilities
...
- **Why use it:** Tabbit Browser plugins for DSH using Playwright for browser automation
...
- **Tags:** `electron`, `image`, `dsh-plugin`
...
- **Tags:** `low-code`, `crm`, `erp`, `dsh-plugin`
- **Why use it:** AI + no-code platform for building business systems fast
...
- **Tags:** `vfs`, `virtual-filesystem`, `sandbox`, `utilities`
- **Why use it:** First unified virtual filesystem abstracting storage for all agents
...
- **Why use it:** Visual plugin marketplace inside DSH with browse, search and one-click install
...
- **Why use it:** Plugin radar with 9000+ candidates, runtime-tested top 50 curated across 11 categories
...
- **Tags:** `context-management`, `dashboard`, `utilities`
...
- **Tags:** `oauth`, `subscriptions`, `llm-providers`
- **Why use it:** OAuth integration to use ChatGPT/Claude/Grok subscriptions as LLM providers
...
- **Why use it:** Run Pi Agent extensions as native DSH plugins via compatibility layer
...
- **Why use it:** Crash rescue plugin with undo config/plugin changes, snapshot rollback and SAFE MODE
...
- **Why use it:** Cross-preset session migration preserving state and source-model intent with fixed schema
...
- **Why use it:** Zero-patch console for managing DSH plugin repositories
...
- **Tags:** `context`, `audit`, `ui`, `token-optimization`
- **Why use it:** Audits context token costs, detects duplicates and conflicts.
...
- **Why use it:** Complete DSH config backup, restore, sync via WebDAV for all settings
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `token-usage`, `ai-cost`, `data-visualization`
- **Why use it:** Real-time token usage, cost estimates, and API balance charts.
...
- **Tags:** `utility`, `conflict-resolution`, `diagnostic`
...
- **Tags:** `dsh-plugin`, `registry`, `plugin-manager`, `deepseek-harness`
- **Why use it:** Plugin discovery registry merging multiple sources with deduplication
...
- **Tags:** `dsh-plugin`, `cli`, `plugin-manager`, `deepseek-harness`
...
- **Tags:** `dsh-plugin`, `publisher`, `cli`
- **Why use it:** One-click plugin publisher: validates, generates docs, creates PRs automatically
...
- **Tags:** `web-ui`, `skins`, `theme`, `wallpaper`
- **Why use it:** Web GUI with WebGL-optimized skins, wallpapers and creative workshop
...
- **Tags:** `pets`, `mascot`, `sprites`, `theme`
- **Why use it:** Public gallery of animated mascot pets across multiple agent platforms
...
- **Why use it:** Highly customizable glassmorphism theme with full UI control
...
- **Tags:** `chrome-extension`, `theme`, `threejs`, `webgpu`
- **Why use it:** Stunning WebGPU ocean-themed skin for DeepSeek Harness
...
- **Tags:** `theme`, `skin`, `opencode`
- **Why use it:** 34 opencode classic themes one-click apply with persistence across restarts
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `theme`, `background`, `ui`
- **Why use it:** Customizable Web background plugin with presets and upload support.
...
- **Tags:** `rag`, `vibe-coding`, `prompt-engineering`, `dsh-plugin`
...
- **Why use it:** Cross-platform AI content discovery agent from Bilibili, Reddit, YouTube and more
...
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days content, generates cited research reports
...
- **Tags:** `market`, `web`, `ui`
- **Why use it:** Community plugin market for DSH web GUI: browse and one-click install/uninstall
...
- **Tags:** `awesome-list`, `plugins`
- **Why use it:** Meticulously curated list of DSH plugins, tools and development resources
...
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms instantly
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `stock`, `finance`, `quant`
...
- **Why use it:** Community-curated good DSH plugin collection
...
- **Tags:** `awesome-list`, `navigation`, `documentation`
- **Why use it:** Plugin manual and navigation by use case for DSH
...
- **Tags:** `awesome-list`, `registry`, `plugin-radar`
...
- **Why use it:** Zero-dependency static portal for DSH plugin discovery
...
- **Why use it:** Redirect — moved to new repo (not actionable)
...
- **Why use it:** Bilingual evidence-led plugin directory at immutable commits
...
- **Why use it:** Auto-crawled bilingual plugin directory via daily GitHub Actions
...
- **Why use it:** Search DSH plugins from within agents via npm and curated lists
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `awesome-list`
...
- **Tags:** `awesome-list`, `curated`, `dsh`, `resources`
- **Why use it:** Curated meta-list of all notable DSH plugins and resources
...
- **Why use it:** Web simulation of traditional Chinese buzzbug toy, zero-dependency single file
...
- **Tags:** `awesome-list`, `ecosystem`, `curated`
- **Why use it:** Curated plugin ecosystem directory for DSH
...
- **Why use it:** Curated bilingual plugin & tool reference for DeepSeek Harness ecosystem
...
- **Why use it:** Daily-verified plugin discovery with blacklisting and recommendation engine
...
- **Tags:** `documentation`, `learning`, `marketplace`
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins and developer toolkit
...
- **Tags:** `awesome-list`, `plugins`, `mcp`, `agent`
- **Why use it:** Essential curated directory of DSH plugins, skills, and MCPs
...
- **Why use it:** Plugin marketplace with 3100+ entries, search, rankings and public API
...
- **Tags:** `marketplace`, `plugin`, `harness`
- **Why use it:** Plugin marketplace and hub for DeepSeek Harness ecosystem
...
- **Tags:** `awesome-list`, `dsh-plugins`, `curated`
- **Why use it:** Best starting point to discover all DSH plugins across categories.
...
- **Why use it:** Community photo wall with OAuth auth for DSH beta event.
...
- **Why use it:** Curated essential DSH plugins list for quick ecosystem discovery
...
- **Why use it:** Fast elegant Neovim plugin manager written in Lua — not DSH native
...
- **Tags:** `deepseek-harness`, `math`, `modeling`, `skills`
- **Why use it:** Math modeling enhancement suite with presets and manual skill cards.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `registry`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `registry`
- **Why use it:** Curated directory of verified DSH plugins with installation guidance.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `registry`, `skills`
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `dsh-ecosystem`
- **Why use it:** Curated directory of DeepSeek Harness plugins
...
- **Why use it:** Simple Chinese DSH plugin listing
...
- **Why use it:** Curated DSH plugins covering models, tools, sandboxes, UI
...
- **Tags:** `dsh-plugin`, `industry`, `deepseek-harness`
- **Why use it:** Industry-specific DSH plugins for finance, law, healthcare etc.
...
- **Tags:** `cordis`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Official auto-generated list of Cordis plugins curated by cordis.run
...
- **Why use it:** 1000+ DSH tools sorted by GitHub stars with comprehensive coverage

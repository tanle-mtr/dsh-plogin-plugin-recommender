...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,077,017 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-21 20:55:38 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 232,258 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,452 | Open-source design system plugin with local-first  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,999 | Deploy multi-agent swarms and autonomous workflows |
...
- **Tags:** `agent-orchestration`, `multi-device`, `mcp`, `no-code`
- **Why use it:** Unified multi-device agent orchestration with task boards
...
- **Why use it:** Task-aware reasoning-mode router with measured performance
...
- **Why use it:** Enterprise multi-engine agent workspace, local-first design
...
- **Why use it:** Self-evolving agent OS with MCP server and evaluation loops
...
- **Tags:** `coding-agent`, `ai-ide`, `agentic-runtime`
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: OCR, image Q&A, GUI
...
- **⭐ Stars:** 86
- **Language:** TypeScript
- **Description:** 一个面向 DeepSeek Harness 的统一能力管理插件，为 Tools/Skills 提���常驻、按需、禁用三档暴露策略，以减少上下文占用并支持运行时动态发现与执行。
- **Tags:** `dsh-plugin`, `skills`, `mcp`
- **Why use it:** Reduces context overhead with tiered tool/skill exposure strategies
...
- **Why use it:** Unified and secure management of local Agent Skills in DSH
...
- **Tags:** `plugin-system`, `workbench`, `skills`
- **Why use it:** Plugin-based web workbench with global skill and workspace management
...
- **Tags:** `plugin-creator`, `harness-tools`, `codex`
...
- **Why use it:** Enable ChatGPT OAuth integration and model access within DSH agents.
...
- **Tags:** `dsh-plugin`, `ui-generator`
- **Why use it:** Open-source design system plugin with local-first desktop app.
...
- **Why use it:** Modern desktop wrapper for DSH ecosystem, plugin-first design.
...
- **Why use it:** Universal AI enhancement browser extension for multiple platforms
...
- **Why use it:** Native desktop client for DeepSeek Harness, offline-first
...
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thoughts, and rollback.
...
- **Why use it:** Lightweight Tauri desktop app with preset plugins, cross-platform
...
- **Why use it:** Official-style desktop GUI with SSH, plugins, skills, and mobile remote access.
...
- **Tags:** `ui`, `charts`, `interactive`, `genui`
- **Why use it:** Interactive UI components (charts, forms, quizzes) rendered inline via dsh-ui fence.
...
- **Tags:** `canvas`, `workspace`, `branching`, `ui`
- **Why use it:** Visual canvas-based branching workspace for exploring and navigating DSH conversations.
...
- **Tags:** `desktop-app`, `agent-framework`, `desktop-automation`
...
- **Tags:** `office`, `office-harness`, `deepseek-harness-plugin`
...
- **Tags:** `ios`, `mobile`, `coding-agent`, `kmp`
- **Why use it:** Native iOS client bringing workspace sessions and agent tracks to iPhone
...
- **Tags:** `desktop-app`, `electron`, `codepilot`, `multi-platform`
- **Why use it:** CodePilot-inspired cross-platform desktop client for macOS Windows and Linux
...
- **Why use it:** In-app skill manager with DSH skill call auditing for better control.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI plugin for convenient skill and MCP management
...
- **Why use it:** Electron desktop console managing Plugins/MCP/Skills via multi-tab UI
...
- **Tags:** `bioinformatics`, `desktop-app`, `dsh-plugin`, `tauri`
...
- **Tags:** `ui-extension`, `info-bar`, `dsh-plugin`
...
- **Why use it:** Electron desktop app bundling DSH web services and plugins.
...
- **Tags:** `ui`, `dsh-plugin`
- **Why use it:** One-click compact button for the context meter panel
...
- **Why use it:** Local-first persistent memory layer, user-owned across workflows
...
- **Why use it:** Hybrid-retrieval memory OS with 35% token savings
...
- **Why use it:** Purpose-built memory library for stateful agentic systems
...
- **Why use it:** Memory management kit helping agents remember and refine knowledge over time.
...
- **Tags:** `rag`, `memory`, `milvus`, `embeddings`
...
- **Tags:** `rag`, `embeddings`, `vector-search`, `skill-retrieval`
...
- **Tags:** `knowledge-base`, `awesome`, `encyclopedia`, `learning`
- **Why use it:** Comprehensive AI knowledge base covering LLMs, agents, RAG, multimodal tools and learning paths.
...
- **Why use it:** Three-layer auto memory with zero-prompt recall and skill crystallization
...
- **⭐ Stars:** 31
- **Language:** TypeScript
- **Description:** DSH 上下文注入审���插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context-audit`, `ui-tool`, `dsh-plugin`
- **Why use it:** Context audit tool with Web UI for token cost analysis and conflict detection
...
- **Why use it:** Cross-platform agent session continuity and state recovery.
...
- **Why use it:** Distill reasoning patterns into reusable cross-agent skills.
...
- **Tags:** `dsh-plugin`, `no-code`
- **Why use it:** AI-enhanced no-code platform for rapid business system build.
...
- **Why use it:** Long-form web novel writing assistant, handles 2M+ characters
...
- **Tags:** `agent-skills`, `skills-store`, `dsh-plugin`
- **Why use it:** Largest skills marketplace with auto-collected GitHub skills
...
- **Tags:** `agent`, `workflow`, `long-horizon`
- **Why use it:** Long-horizon agent control plane for durable governed workflows across harnesses.
...
- **Why use it:** Virtual terminal enabling sandboxed bash and VFS for AI agents.
...
- **Why use it:** Intelligent skill routing and workflow orchestration boosting agent efficiency.
...
- **Why use it:** End-to-end Vox-style explainer video generation via agent skill
...
- **Tags:** `agent-teams`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `ai-writing`, `novel`, `rag`, `creative`
- **Why use it:** Structured AI novel writing assistant with worldbuilding and revision
...
- **Why use it:** Built-in workflow workstations for novel, short-drama, game and video-recap writing.
...
- **Tags:** `agent-observability`, `computer-vision`, `video-analysis`, `agent-skills`
- **Why use it:** Gives agents visual and audio perception with verifiable timestamped evidence
...
- **Why use it:** Implements Epistemic Loop methodology for scientific discovery workflows
...
- **Why use it:** Native SQLite-backed task management with agent claim and review workflows
...
- **Why use it:** Live iOS Simulator with 22 tools for mobile app booting building and driving
...
- **Why use it:** Turns experience into repeatable execution across Claude, Codex, Grok, GPT and more.
...
- **Why use it:** One-click Docker deployment with skill integration and multi-tenant support
...
- **Why use it:** 87 reverse-engineering skills for CTF and authorized pentesting
...
- **Why use it:** Industry research methodology with chain mapping and news tracking skills
...
- **Why use it:** Turns AI into a coding mentor with scaffolding, reviewing, and chapter-based learning
...
- **Why use it:** 25 production-grade skills pre-installed, 10x dev efficiency
...
- **Why use it:** Web search, research, and integration discovery skills for AI agents
...
- **Tags:** `agent-skills`, `patent`, `rag`
- **Why use it:** Patent infringement analysis skill generating competitive reports
...
- **Tags:** `skills`, `docx`, `dsh-plugin`
- **Why use it:** GB/T 9704 standard official document processing with full workflow
...
- **Tags:** `chinese-traditional-wisdom`, `agent-skill`, `dsh-plugin`
- **Why use it:** Comprehensive Bazi/Fengshui/Tcm AI skill pack with local deterministic engine
...
- **Why use it:** Official DSH plugin dev knowledge base as on-demand agent skill bundle
...
- **Tags:** `spec-programming`, `agent-skills`, `dsh-plugin`
...
- **Why use it:** Engineering discipline bundle with requirements grill and delivery quality gate
...
- **Tags:** `math-modeling`, `skill-package`, `research`
- **Why use it:** Complete math modeling skill suite: preprocessing, coding, writing, plotting
...
- **Why use it:** Pixel-to-text OCR skill enabling image reading for text-only DSH models
...
- **Tags:** `multi-agent`, `agent-orchestration`, `dsh-plugin`
- **Why use it:** Durable multi-agent orchestration with persistent memory across sessions
...
- **Why use it:** 11 QA agent skills with shared knowledge base for test automation workflows
...
- **Why use it:** Separation-of-plan-and-execution skill for disciplined AI collaboration
...
- **Why use it:** Multi-agent math modeling with 5 roles and 33 models.
...
- **Why use it:** Official agent skill for developing DSH plugins with standards.
...
- **Why use it:** In-agent plugin search for enhanced discoverability
...
- **Tags:** `dsh-plugin`, `diagram-as-code`
- **Why use it:** Self-contained agent skill generating beautiful architecture diagrams.
...
- **Tags:** `dsh-plugin`, `image-generation`
- **Why use it:** 530+ image prompts and 20+ reusable skills for GPT Image 2.
...
- **Why use it:** AI-native vector design with concurrent Agent Teams for Design-as-Code.
...
- **Why use it:** Native design & PPT studio with AI generation and visual editing
...
- **Why use it:** AI video/image/audio skills with storyboard and model tools.
...
- **Why use it:** Cinematic product video agent with 152 shot recipe cards.
...
- **Why use it:** Real-time token usage charts, cost estimates, API balance.
...
- **Why use it:** CLI+extension for seamless real-browser AI automation
...
- **Why use it:** Self-evolving cross-platform content discovery agent from B站, YouTube, X, etc.
...
- **Tags:** `browser-automation`, `fingerprint`, `anti-detect`, `playwright`
...
- **Why use it:** Tabbit browser automation plugins with Playwright support for DSH
...
- **Tags:** `dsh-plugin`, `self-hosted`
- **Why use it:** Privacy-first open-source resume builder, MCP-compatible.
...
- **Tags:** `account`, `routing`, `management`
- **Why use it:** Multi-model account management with smart routing and auto failover.
...
- **Why use it:** Comprehensive context insight dashboard with sidebar and commands
...
- **Why use it:** AI security platform auditing code for hallucinated packages, missing safeguards & vulnerabilities.
...
- **Why use it:** CLI and plugin manager for DSH Plugin Hub with resolver and agent tooling.
...
- **Why use it:** Connects ChatGPT Claude and Grok subscriptions as LLM providers via OAuth
...
- **Tags:** `awesome-list`, `dsh-plugin`, `plugin-discovery`
- **Why use it:** Daily curated plugin directory with smart filtering and scenario-based discovery
...
- **Tags:** `awesome-list`, `coding-agent`, `mcp`, `plugins`
- **Why use it:** Comprehensive curated list covering plugins MCP servers and coding agents
...
- **Why use it:** Multi-device remote access via secure P2P network with end-to-end encryption.
...
- **Why use it:** Skill that finds, installs and verifies DSH GitHub plugins automatically.
...
- **Why use it:** Complete backup/restore for DSH config, plugins, MCP and skills via WebDAV
...
- **Tags:** `plugin-marketplace`, `awesome-list`, `dsh-plugin`
- **Why use it:** Auto-synced community plugin catalog maintained every 4 hours
...
- **Why use it:** Zero-patch browser console for DSH plugin repository management
...
- **Why use it:** Unify Runtime, Provider, Plugin, Skill and MCP orchestration.
...
- **Why use it:** Migration wizard for Claude Code, Codex sessions to DSH.
...
- **Why use it:** Curated collection: notifications, trace, keybindings, terminal.
...
- **Why use it:** Free Xiaomi MiMo TTS API integration for DSH text-to-speech.
...
- **Tags:** `pet`, `theme`, `mascot`
- **Why use it:** Public gallery of animated pets adding personality to coding agent terminals.
...
- **Why use it:** Frosted glass theme with full customization for blur,磨砂, and background on DSH web UI.
...
- **Tags:** `ocean-skin`, `glassmorphism`, `animated-background`
- **Why use it:** Beautiful animated ocean theme with glassmorphism and real-time wave effects
...
- **Tags:** `themes`, `webui`, `customization`
- **Why use it:** Customize DSH Web background with images or presets
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools, skills and integrations in EN/ZH.
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiments, GPU SSH, metrics and charts.
...
- **Why use it:** Powerful academic search with cross-database support and citation graph for Chinese researchers.
...
- **Tags:** `agent-skills`, `marketplace`, `research-tools`
- **Why use it:** 88 open-source agent skills for deep research, social intelligence and marketing workflows.
...
- **Tags:** `mcp`, `deepseek-harness`
- **Why use it:** Local financial database with multi-agent analysis and IM channel market monitoring.
...
- **Why use it:** Curated list of DSH plugins covering productivity and functionality tools
...
- **Why use it:** Interactive K-line analysis with multi-market and indicator support.
...
- **Why use it:** Plugin product guide with installation and compatibility info
...
- **Tags:** `ai-recommendation`, `awesome-list`
- **Why use it:** AI-curated hourly-updated list across 12 categories
...
- **Why use it:** Evidence-backed plugin radar for informed selection
...
- **Why use it:** Official beginner tutorial, zero-to-one DSH development guide
...
- **Why use it:** Plugin aggregation ecosystem with workshop distribution
...
- **Tags:** `dsh-plugin`, `deepseek-harness`
- **Why use it:** Official DSH learning resource with plugin marketplace and best practices.
...
- **Tags:** `catalog`, `plugin-directory`, `dsh-plugin`
- **Why use it:** Massive plugin catalog with 11,000+ entries, search, rankings and public API.
...
- **Why use it:** Comprehensive agent-first handbook covering runtime, plugins, MCP, sandbox and troubleshooting.
...
- **Tags:** `catalog`, `plugin-marketplace`, `dsh-plugin`
- **Why use it:** Comprehensive DSH plugin catalog with 1,958 repos, bilingual search and classification.
...
- **Why use it:** Curated awesome list of DSH plugins, skills and resources.
...
- **Tags:** `awesome-list`, `plugin-registry`, `skills`
- **Why use it:** Spam-filtered open-data registry with quality assurance.
...
- **Why use it:** Public GitHub directory with install commands and discovery.
...
- **Why use it:** Verified stock/finance/quant plugin directory, bilingual.
...
- **Why use it:** 2026 curated list with quality checks included.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Comprehensive star-sorted catalog of 1000+ DSH tools
...
- **Why use it:** Daily automated plugin directory via GitHub Actions
...
- **Why use it:** Community-curated DSH plugin list with verification support.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `redirect`
- **Why use it:** Repository has moved; redirect to new location for updated list.
...
- **Why use it:** Auto-updating bilingual plugin directory with data-driven YAML entries.
...
- **Tags:** `plugin-directory`, `deepseek-harness`, `curated-list`
- **Why use it:** Comprehensive curated plugin registry covering models, tools, UI, and sandboxes.

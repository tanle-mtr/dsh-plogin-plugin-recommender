...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 872,697 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 10:09:37 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 196,699 | Core DSH platform enabling all plugins. Essential  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,612 | Local-first design tool, Figma alternative for AI  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,436 | Multi-agent swarm orchestration for complex workfl |
...
- **Why use it:** Core DSH platform enabling all plugins. Essential foundation.
...
- **Tags:** `ai-agents`, `memory`, `multi-model`
...
- **Tags:** `agent-os`, `loop-engineering`, `dsh-plugin`
...
- **Tags:** `vision`, `multimodal`, `dsh-plugin`
- **Why use it:** Vision plugin enabling image-to-JSON for text-only coding agents
...
- **Tags:** `agent-runtime`, `ai-ide`, `dsh-plugin`
...
- **Tags:** `agent`, `agent-skill`, `deepseek-harness`, `dsh-plugin`, `skill`
- **Why use it:** Agent skill that teaches you how to build DSH plugins from scratch
...
- **Tags:** `plugin-dev`, `harness-tools`, `credentials`
- **Why use it:** Essential tool for building and managing DSH plugins, slots, and credentials
...
- **Why use it:** Audits context token cost and detects conflicts in AGENTS.md and tools.
...
- **Tags:** `agent-framework`, `mcp`, `dsh-plugin`, `database`
...
- **Why use it:** Practical plugin dev playbook covering cordis, tsconfig, Windows junctions.
...
- **Why use it:** Scaffold, test, and iterate DSH plugins entirely within agent-driven workflows.
...
- **Why use it:** Fast and elegant Neovim plugin manager, integrates well with DSH dev workflows.
...
- **Tags:** `desktop`, `dsh-plugin`, `desktop-app`
...
- **Tags:** `dsh-web`, `plugin-aggregation`, `dsh-plugin`
- **Why use it:** Web-based plugin aggregation platform for the DSH ecosystem
...
- **Why use it:** Open sidebar with file editor, terminal, Git, and sub-agent pages.
...
- **Tags:** `tui`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with whale theme, streaming thought display.
...
- **Tags:** `desktop`, `pets`, `gui`
- **Why use it:** Animated desktop pets with coding integration
...
- **Tags:** `electron`, `desktop`, `ssh-client`
- **Why use it:** Full-featured Electron desktop client with SSH and mobile remote access.
...
- **Why use it:** Open-source Smartisan notes with one-click Docker deployment and WeChat export.
...
- **⭐ Stars:** 58
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管理官�� repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **Tags:** `console`, `deepseek-harness`, `dsh`, `dsh-plugin`, `plugin-management`, `ui`
- **Why use it:** Browser console plugin registry manager — essential DSH infrastructure
...
- **Tags:** `deepseek-harness`, `desktop-app`, `dsh`, `dsh-plugin`, `electron`, `typescript`
- **Why use it:** Electron desktop console for multi-tab management of DSH/Plugins/MCP/Skills
...
- **Tags:** `ui`, `mcp`, `capability-management`
...
- **Tags:** `usage-tracking`, `ui`, `dsh-plugin`
- **Why use it:** Shows provider, model, live balance, and pricing countdown persistently.
...
- **Why use it:** Tauri 2 desktop app integrating databases, SSH, Docker, and AI in one window.
...
- **Why use it:** Electron desktop shell wrapping DSH web with sidebar, ModLens, and plugin integration.
...
- **Tags:** `ui`, `theme`, `customization`, `webui`
- **Why use it:** Custom web background with image upload and preset themes
...
- **Tags:** `agent-memory`, `long-term-memory`, `dsh-plugin`
- **Why use it:** Portable, user-owned memory layer with long-term retention across agents
...
- **Tags:** `memory-management`, `self-evolving`, `dsh-plugin`
- **Why use it:** Self-evolving memory with 35% token savings via hybrid retrieval
...
- **Why use it:** Specialized memory management kit for agents with RAG support.
...
- **Tags:** `agent-memory`, `milvus`, `rag`, `dsh-plugin`
...
- **Why use it:** Unlimited memory system for AI agents
...
- **Tags:** `embeddings`, `vector-search`, `skill-md`
- **Why use it:** Builds retrieval-ready skill corpora from SKILL.md files with semantic search.
...
- **Why use it:** Official plugin dev docs archive with multi-language support
...
- **Tags:** `evaluation`, `rag-evaluation`, `dsh-plugin`, `agent-evaluation`
...
- **Why use it:** Multi-agent swarm orchestration for complex workflows.
...
- **Tags:** `agent-skills`, `ai-agent`, `deepseek-harness`, `dsh-plugin`
...
- **Why use it:** Intelligently routes and orchestrates harness workflows automatically.
...
- **Tags:** `coding`, `agent-skills`, `architecture`
- **Why use it:** Architecture-aware coding with evidence verification
...
- **Tags:** `agent`, `teams`, `coordination`
- **Why use it:** Multi-agent team coordination plugin
...
- **Tags:** `workflow`, `conversations`, `productivity`
...
- **Why use it:** Visual toolkit for text-only LLMs
...
- **Why use it:** Powerful creative writing skill for novels and short-drama production.
...
- **Tags:** `skills`, `infrastructure`, `agent`
- **Why use it:** Collection of agent skills for AI infrastructure development and debugging.
...
- **Tags:** `workflow`, `agent`, `orchestration`
- **Why use it:** Streamlined agent workflow orchestration for DSH ecosystem.
...
- **Why use it:** Port of Pro Agent superpowers skills — TDD, debugging, planning for DSH
...
- **Why use it:** Superpowers skill port to Reasonix — enables structured coding workflows
...
- **Why use it:** AI mentor that scans architecture, generates learning paths and code reviews
...
- **Tags:** `agent-plugins`, `agent-skills`, `deep-research`, `research-tools`, `skill-md`
- **Why use it:** 88 agent skills for research, marketing and business workflows across platforms
...
- **Tags:** `agent-skills`, `ai-coding`, `deepseek-harness`, `spec-driven-development`, `vibe-coding`
- **Why use it:** Repository-native spec-driven development skill for structured coding
...
- **Tags:** `agent-handoff`, `session-memory`, `workflow`
...
- **Why use it:** Multi-agent team with independent models, skills, MCPs, and shared workspace
...
- **Why use it:** Adapted code simplification skill for Codex workflows
...
- **Why use it:** Version-pinned offline-verifiable governance skill for Swift Cycle
...
- **Tags:** `agent`, `skills`, `dsh-plugin`, `wayfinder`
- **Why use it:** Game-like mission system that tracks progress via task bar automation.
...
- **Why use it:** Full Chinese official document workflow with format check and optimization.
...
- **Why use it:** Infinite canvas with creative skills enhances agentic workflow productivity.
...
- **Tags:** `agent-skill`, `engineering`, `fact-finding`
- **Why use it:** Portable agent skill encoding engineering discipline and decision-making frameworks.
...
- **Why use it:** Full-stack Godot 4.x development skill, great for game dev workflows.
...
- **Tags:** `agent-preset`, `product-management`, `workflows`
- **Why use it:** Virtual PM-to-Engineer role-play agent for product workflows
...
- **Why use it:** Web UI for skill and MCP management directly in DSH interface.
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge syncing chat, skills, and MCPs between Codex and DSH
...
- **Why use it:** Web UI card to manage skills and MCP servers directly in browser.
...
- **Tags:** `mcp`, `zhihu`, `dsh-plugin`
- **Why use it:** Zhihu search and Zhida ask via MCP, Skill, and CLI interfaces.
...
- **Why use it:** Hot-reload MCP connections without restarts, JSON paste to connect instantly.
...
- **Why use it:** Local-first design tool, Figma alternative for AI agents.
...
- **Why use it:** 530+ image prompts and industrial templates with skills.
...
- **Why use it:** Generates beautiful architecture and workflow diagrams from text input
...
- **Tags:** `design-as-code`, `vector-design`, `dsh-plugin`
...
- **Tags:** `widget`, `visual`, `balance`
- **Why use it:** Cute whale widget showing account balance
...
- **Why use it:** Generate images directly in chat via multiple AI providers.
...
- **Tags:** `design`, `ppt`, `openpencil`
- **Why use it:** Preview, inspect and edit .op presentation documents directly in conversation.
...
- **Tags:** `agent-skills`, `claude-code`, `diagram`, `dsh-plugin`, `legal`, `svg`, `timeline`
- **Why use it:** Visual litigation timelines and diagrams — unique tool for legal professionals
...
- **Tags:** `kline`, `visualization`, `finance`
...
- **Tags:** `design-skills`, `ui`, `vibe-coding`, `dsh-plugin`
- **Why use it:** 6 design styles keep vibe-coded sites away from generic AI looks.
...
- **Tags:** `agent-skills`, `image-generation`, `vision`, `dsh-plugin`
- **Why use it:** Free image reading and generation capabilities for DSH workflows.
...
- **Tags:** `ai-director`, `ai-video`, `dsh-plugin`, `storyboard`
- **Why use it:** AI video/image/audio skills with configurable model tools and storyboard.
...
- **Why use it:** Extension suite for Gemini, Claude & ChatGPT with prompt manager.
...
- **Tags:** `bilibili`, `xiaohongshu`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent from 8+ major platforms.
...
- **Why use it:** Real browser automation without interruption
...
- **Why use it:** Privacy-focused resume builder, free and open-source.
...
- **Why use it:** AI + low-code platform for building business systems fast.
...
- **Why use it:** Task-aware routing and injector kit for optimized agent reasoning
...
- **Tags:** `preset`, `harness-engineering`, `dsh-plugin`
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tool coverage
...
- **Tags:** `vfs`, `virtual-filesystem`, `dsh-plugin`
- **Why use it:** Unified virtual filesystem providing consistent agent file operations
...
- **Why use it:** Built-in visual marketplace for browsing and installing DSH plugins.
...
- **Tags:** `desktop`, `tauri`, `deepseek`
- **Why use it:** Lightweight 5MB desktop app with zero setup
...
- **Why use it:** Tracks session and daily costs with budget alerts and history.
...
- **Why use it:** Bridges Pi ecosystem — runs unmodified Pi extensions as native DSH plugins.
...
- **Why use it:** Crash-recovery plugin with undo config changes and secret-safe snapshots.
...
- **Why use it:** Build, run and interact with live Android emulator or USB device in conversation.
...
- **Tags:** `agents`, `awesome`, `awesome-list`, `deepseek`, `dsh-plugin`
- **Why use it:** Curated plugin resource list — great starting point for DSH exploration
...
- **Tags:** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `awesome-list`, `deepseek-harness`, `dsh`
...
- **Tags:** `ai-agents`, `alipay`, `api-documentation`, `chinese-api`, `deepseek-harness`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in DSH/Claude/Cursor
...
- **Why use it:** OCR and pixel-to-text tool — enables image reading for text-only models
...
- **Tags:** `containers`, `ui`, `deployment`
- **Why use it:** Run multiple isolated DSH versions via containers with embedded WebView
...
- **Why use it:** Complete backup/restore/sync for all DSH configs, plugins, MCPs, and skills
...
- **Tags:** `plugin-conflict`, `utilities`, `infrastructure`
...
- **⭐ Stars:** 3
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件提示，让插件库���用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `plugin-check`, `utility`, `agent-tools`
- **Why use it:** Pre-flight plugin check ensures expected library utilization
...
- **Why use it:** Search and discover DSH plugins directly inside agents
...
- **Why use it:** Animated pet mascot gallery enhancing coding agent desktop experience
...
- **Why use it:** Whale girl themed visual skins for DeepSeek Harness UI.
...
- **Tags:** `theme`, `skins`, `color-scheme`, `dsh-plugin`
...
- **Why use it:** Beginner-friendly tutorial for mastering DeepSeek Harness engineering
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates citable reports.
...
- **Why use it:** Curated top 50 plugins from 9000+ candidates
...
- **Tags:** `awesome-list`, `ecosystem`, `plugins`
- **Why use it:** Plugin ecosystem curated list for DSH
...
- **Why use it:** Ecosystem overview and tool catalog
...
- **Why use it:** Real-time token usage, cost tracking, and per-round API balance visualization.
...
- **Why use it:** 24 verified stock/finance/quant plugins vertical list
...
- **Tags:** `awesome-list`, `dsh-plugin`, `2origin`
- **Why use it:** Plugin radar with 2Origin lab — great for ecosystem overview
...
- **Tags:** `recommender`, `mcp`, `dsh-plugin`
- **Why use it:** AI-curated hourly-updated plugin recommender with 12 categories
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Original awesome list — redirect to canonical repo
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Community-curated DSH plugin listings
...
- **Tags:** `curated-list`, `dsh-plugin`, `ui`
- **Why use it:** Curated install guide covering models, tools, UI, and agent loops
...
- **Why use it:** Industry-specific plugin directory for finance, legal, medical etc.
...
- **Why use it:** Web simulation of a traditional Chinese bamboo dragonfly toy.
...
- **Why use it:** DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 
...
- **⭐ Stars:** 277
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，��你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
...
- **Why use it:** Essential starting guide and resource hub for new DSH users.
...
- **Why use it:** Comprehensive curated list covering plugins, skills, MCP servers, and UIs.
...
- **Why use it:** Largest DSH plugin marketplace with 3100+ plugins and free API.
...
- **Tags:** `plugin-marketplace`, `plugins`
- **Why use it:** Plugin marketplace and collection hub for DeepSeek Harness.
...
- **Tags:** `marketplace`, `plugin`, `browser`
- **Why use it:** One-click browse, install and update all DSH plugins from GitHub marketplace.
...
- **Why use it:** Community plugin market integrated into DSH web GUI for easy browse and install.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Community photo wall with OAuth login for DSH内测收官纪念。
...
- **Why use it:** Seamlessly migrates Claude Code/Codex/OpenCode setups into DSH ecosystem.
...
- **Why use it:** Curated discovery list for exploring the DSH plugin ecosystem effectively.
...
- **Why use it:** Public directory for plugin discovery, install commands, and ecosystem mapping.
...
- **Why use it:** Unofficial community catalog for broad DSH plugin discovery and reference.
...
- **Why use it:** Quality-checked curated plugin list for 2026 DSH ecosystem exploration.
...
- **Tags:** `registry`, `awesome-list`, `discovery`
...
- **Tags:** `registry`, `awesome-list`, `verified`
- **Why use it:** Curated verified plugin directory with permission guidance
...
- **Tags:** `registry`, `awesome-list`, `community`
...
- **Tags:** `registry`, `awesome-list`, `collection`
- **Why use it:** Good-quality DSH plugin collection directory
...
- **Why use it:** Plugin product manual with installation and risk guidance
...
- **Tags:** `portal`, `static-site`, `discovery`, `web`
...
- **Tags:** `registry`, `awesome-list`, `resources`
- **Why use it:** Curated plugins, tools, skills and resources overview
...
- **Tags:** `registry`, `bundle`, `plugins`
- **Why use it:** Diverse DSH plugin and bundle listing
...
- **Tags:** `registry`, `automation`, `awesome-list`, `bilingual`
...
- **Tags:** `marketplace`, `dsh-plugin`, `dsh-plugin-market`
- **Why use it:** CodeX-style marketplace for DSH plugin browsing and installs

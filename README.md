...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,068,190 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 231,461 | Core framework for plugin-based AI agent developme |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,331 | Open-source design tool with AI-powered UI generat |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,953 | Multi-agent swarm framework with autonomous workfl |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 47 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (47)
...
- **Why use it:** Core framework for plugin-based AI agent development
...
- **Why use it:** Multi-agent swarm framework with autonomous workflows
...
- **Tags:** `orchestration`, `workspace`
- **Why use it:** Unified workspace for all agents and devices, self-tracking tasks.
...
- **Tags:** `routing`, `injector`
- **Why use it:** Runtime injector and task-aware reasoning mode router preset.
...
- **Tags:** `preset`, `deepseek-harness`
- **Why use it:** Two-phase preset providing minimal bootstrap then full Standard tools coverage
...
- **Tags:** `virtual-terminal`, `agent-sandbox`
- **Why use it:** World's first virtual terminal giving AI agents isolated execution environments
...
### [VDERR/echocat-skill-panel](https://github.com/VDERR/echocat-skill-panel)
...
- **Why use it:** Official docs archive and plugin dev knowledge base as installable skill
...
- **Tags:** `context-audit`, `debugging`, `tool`
- **Why use it:** Audit instruction chain, skills, tools for token cost and conflict detection
...
- **Tags:** `dsh-plugin`, `agent-tools`, `capability`
- **Why use it:** Pre-flight plugin check for agents to boost library usage.
...
- **Tags:** `chatgpt`, `oauth`, `ai-agents`, `deepseek-harness`
- **Why use it:** Extends DSH with ChatGPT model access via official OAuth
...
- **Why use it:** Modern desktop app built for the DSH plugin ecosystem
...
- **Why use it:** AI-enhanced no-code platform for building business systems
...
- **Tags:** `browser-extension`, `prompt-manager`
- **Why use it:** Enhances AI platforms with unified prompt manager across browsers.
...
- **Why use it:** DeepSeek Harness desktop client with cross-platform support.
...
- **Tags:** `enterprise`, `workbench`
- **Why use it:** Enterprise local-first agent workbench for Codex and DSH teams.
...
- **Tags:** `sidebar`, `dsh-plugin`
- **Why use it:** Open sidebar foundation with file editing, terminal, chat and sub-agent pages
...
- **Tags:** `task-board`, `ui`
- **Why use it:** Modern flexible task board with seamless embedding for Codex and DeepSeek Harness
...
- **⭐ Stars:** 3,124
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼��栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `terminal`
- **Why use it:** Claude Code-style TUI with whale status bar, streaming thoughts and rollback
...
- **⭐ Stars:** 2,821
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮��盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `floating-widget`, `dsh-plugin`, `ui`
- **Why use it:** Cute floating whale widget tracking DeepSeek balance with drag/snap features.
...
- **Why use it:** Lightweight Tauri desktop version of DSH with zero environment setup.
...
- **Tags:** `desktop`, `gui`, `windows`
- **Why use it:** Zero-setup Windows desktop GUI for DSH with SSH, plugins, and remote access
...
- **Why use it:** Local-first AI desktop workspace with projects, files, web research, and MCP
...
- **Why use it:** Interactive inline UI components: charts, plots, forms, quizzes rendered in replies
...
- **Tags:** `canvas`, `conversation`, `visualization`
...
- **Tags:** `desktop-app`, `agent`, `multi-model`, `privacy`
- **Why use it:** Local-first desktop AI agent with multi-model support and evolving skills
...
- **Tags:** `ios`, `mobile`, `kmp`, `native-client`
- **Why use it:** Native iOS client bringing workspaces sessions and agent execution to iPhone
...
- **Tags:** `desktop-app`, `electron`, `codepilot`, `cross-platform`
- **Why use it:** CodePilot-inspired multi-platform desktop client and plugin suite for DSH
...
- **Why use it:** Smartisan-style notes with Docker deployment and WeChat MP export
...
- **Tags:** `mcp`, `skills`, `dsh-plugin`, `ui`
- **Why use it:** Web UI panel for managing DSH skills and MCP servers
...
- **Tags:** `plugin-market`, `ui`, `dsh-plugin`
...
- **Why use it:** Electron desktop console for multi-tab plugin management
...
- **Why use it:** Desktop bioinformatics agent with offline mode and skill store for scientists
...
- **Why use it:** Live balance/price countdown info bar for DSH desktop experience
...
- **Tags:** `desktop`, `electron`, `integration`, `dsh-web`
- **Why use it:** Electron desktop shell integrating DSH web with sidebar, ModLens and market
...
- **Tags:** `dsh-plugin`, `ui`, `knowledge-cards`
...
- **Why use it:** Portable local-first memory layer owned by users, self-evolving.
...
- **Why use it:** Memory library for building stateful persistent agents.
...
- **Why use it:** Memory management kit enabling agents to remember and refine past interactions
...
- **Why use it:** Persistent unified memory layer with Milvus embeddings and hybrid search.
...
- **Why use it:** Local memory hub giving all AI agents shared persistent context control.
...
- **Tags:** `skill-management`, `rag`, `evaluation`
- **Why use it:** Turns SKILL.md files into retrieval-ready corpora with evaluation tooling
...
- **Why use it:** Distills expert thinking into reusable AI agent skills
...
- **Tags:** `skills`, `store`
- **Why use it:** Most comprehensive skills store with auto-organized GitHub projects.
...
- **Why use it:** Intelligent skill routing with 21pp reward boost and 30% token reduction
...
- **Why use it:** Model-agnostic inference control for deep reasoning, verification and recovery
...
- **Why use it:** Automated end-to-end Vox-style paper-collage explainer video generation.
...
- **Why use it:** Enables multi-agent collaboration and team workflows within DSH.
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, screenshot restoration.
...
- **Tags:** `writing`, `novel`, `creative-workflow`
- **Why use it:** Novel and short-drama writing workflows with built-in workbenches for fiction creation
...
- **Tags:** `computer-vision`, `audio-understanding`, `agent-skills`, `multimodal`
- **Why use it:** Gives agents vision and audio capabilities with verifiable timestamped evidence
...
- **Why use it:** Native SQLite-backed taskboard with agent claim review workflow and Web UI
...
- **Tags:** `ios-simulator`, `mobile-automation`, `ui-automation`, `mcp`
- **Why use it:** Embed live iOS Simulator and USB iPhone inside conversation with 22 agent tools
...
- **⭐ Stars:** 251
- **Language:** Python
- **Description:** 全栈式自动数学建模竞赛Skill，支持 Claude Code / Codex / opencode / DeepSeek Harness。AI 担任 Autopilot，人类担任 Copilot；国赛/美赛通用，GitOps ���水线 + 强制代码自证，可选 addons 模块。
- **Tags:** `agent-skills`, `math-modeling`, `workflow`
...
- **⭐ Stars:** 199
- **Language:** TypeScript
- **Description:** 让 Agent 的工作方��可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **Tags:** `agent-review`, `self-evolving`, `prompt-engineering`
- **Why use it:** Composable self-evolving agent modes with human review capability
...
- **Tags:** `agent`, `skills`, `cross-platform`
...
- **Tags:** `plugin-discovery`, `agent-skills`, `installation`
...
- **Why use it:** 87 reverse-engineering and pentesting skills for DSH agents
...
- **Tags:** `industry-research`, `cordis`, `dsh-plugin`
- **Why use it:** Industry research skills with chain mapping and policy tracking
...
- **Why use it:** Auto-upgrades plugins as DSH version evolves
...
- **Why use it:** Unified skill exposure management with on-demand strategies
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** AI coding mentor with project architecture analysis
...
- **Tags:** `skills`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** 25 ready-to-use engineering and efficiency skills
...
- **Tags:** `patent`, `agent-skills`, `legal-tech`
...
- **Tags:** `skills`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Unified local skill loading and security management
...
- **Tags:** `ai-docs`, `deepseek-harness`, `gongwen`
- **Why use it:** Full workflow official document processing and formatting
...
- **Tags:** `agent-platform`, `skills`, `deepseek-harness`
- **Why use it:** Plugin-based web platform with global skill management
...
- **Why use it:** Unique Bazi/Fengshui/TCM skill pack with local deterministic engine
...
- **Why use it:** Engineering discipline skill: grill requirements, test impl, prove delivery
...
- **Why use it:** Pixel-to-text OCR skill for text-only models, 34-image trained methodology
...
- **Why use it:** Durable multi-agent team with persistent memory across sessions and rollovers
...
- **⭐ Stars:** 33
- **Language:** HTML
- **Description:** 让 AI 像资深测试工程���一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **Tags:** `qa`, `testing`, `test-automation`
- **Why use it:** 11 QA skills framework with shared KB for AI-driven test engineering
...
- **Why use it:** Math modeling competition skill set: data, coding, writing, plotting
...
- **Tags:** `planning`, `collaboration`, `workflow`
- **Why use it:** Discuss-then-act separation mechanism for collaborative AI task planning
...
- **Why use it:** WorkBuddy-style skill picker, streamlines skill selection
...
- **Why use it:** Cross-platform session handoff preserves context across agents
...
- **Tags:** `code-simplification`, `codex-skill`, `dsh`
- **Why use it:** Adapted code simplification skill, clean and readable output
...
- **Tags:** `agent-skill`, `plugin-dev`, `dsh`
- **Why use it:** Standardized agent skill template for building DSH plugins
...
- **Why use it:** First vision plugin bridging image input to structured JSON for text-only agents
...
- **Tags:** `finance`, `mcp`, `database`, `multi-agent`
- **Why use it:** Local financial database with Tushare, auto-generates HTTP and MCP interfaces
...
- **Tags:** `agent-plugins`, `mcp`, `web-search`
- **Why use it:** Web search and research skills for AI agents
...
- **Why use it:** Search 65000+ Chinese platform API docs natively
...
- **Tags:** `cloud`, `mcp`, `deepseek-harness`
- **Why use it:** Official Huawei Cloud MCP tools with sandbox support
...
- **Why use it:** Generates beautiful architecture and workflow diagrams
...
- **Tags:** `image-generation`, `prompts`, `templates`
- **Why use it:** GPT Image prompt library with 530+ cases and templates
...
- **⭐ Stars:** 1,406
- **Language:** JavaScript
- **Description:** DeepSeek Harness 可编辑设��系统：AI 生成、可视化编辑、模板市场与 PPT｜Native Design & PPT Studio for DeepSeek Harness.
- **Tags:** `design`, `ppt`, `visual-editor`
- **Why use it:** Native design and PPT studio with AI generation, templates and visual editor.
...
- **Why use it:** Legal litigation diagrams and timeline visualization
...
- **Why use it:** AI video/image/audio generation pipeline for creative workflows
...
- **Why use it:** 152 cinematic shot recipes with Remotion templates for product videos
...
- **Why use it:** Let AI agents use real logged-in browser without interrupting work.
...
- **Why use it:** Self-evolving cross-platform content discovery agent from Bilibili, YouTube, X etc
...
- **Why use it:** Anti-detect browser with fingerprint spoofing and unlimited local profiles
...
- **Why use it:** Tabbit Browser + Playwright automation plugins for DSH
...
- **Tags:** `resume`, `self-hosted`, `mcp-server`
...
- **Why use it:** Official plugin marketplace for browsing, searching and one-click installation
...
- **Tags:** `multi-model`, `quota-management`
- **Why use it:** Unified account management and smart multi-model routing with failover for agents
...
- **Why use it:** Ecosystem radar discovering 21k+ plugins with k8s runtime validation.
...
- **Tags:** `marketplace`, `plugin-shop`, `ecosystem`
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-publish review.
...
- **Why use it:** AI security platform that audits generated code for hallucinated packages and vulnerabilities
...
- **Why use it:** CLI tool and plugin manager for the DSH Plugin Hub with schema validation
...
- **Why use it:** Full office suite with spreadsheets, docs, slides, and canvases for DSH
...
- **Tags:** `oauth`, `subscription`, `llm-provider`, `codex`
...
- **Tags:** `cost-tracking`, `budget`, `token-usage`, `analytics`
- **Why use it:** Track session and daily costs with budget alerts and multi-provider balance
...
- **Tags:** `compatibility-layer`, `migration`, `ecosystem`
- **Why use it:** Compatibility layer to run Pi extensions as native DSH plugins
...
- **Why use it:** Backup, restore, migrate and sync complete DSH configurations
...
- **Why use it:** Plugin ecosystem infrastructure with dev guidance
...
- **Why use it:** Manage multiple DSH versions in isolated containers with one-click plugin import
...
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill and MCP for extensible DSH
...
- **Why use it:** Migration wizard for sessions and skills across 4 AI coding tools
...
- **Tags:** `terminal`, `keybindings`, `trace`, `enhancement`
- **Why use it:** Task notifications, trace inspection, keybindings and built-in terminal
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset/custom/browser voices
...
- **Tags:** `diagnostic`, `plugin-conflict`, `dsh-plugin`
...
- **Why use it:** Animated pet gallery adding personality and fun to your coding agent
...
- **Why use it:** Whale girl skin series adding aesthetic customization to DSH interface.
...
- **Why use it:** Frosted glass theme with full customization for DSH web interface, no source changes
...
- **Tags:** `animated-background`, `glassmorphism`, `ocean`, `theme`
...
- **Why use it:** Curated plugin list for DSH ecosystem discovery and comparison.
...
- **⭐ Stars:** 7,873
- **Language:** TypeScript
- **Description:** DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创��工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
- **Tags:** `web`, `aggregation`
- **Why use it:** Web plugin aggregation ecosystem for DSH plugin discovery.
...
- **Why use it:** Generates accurate technical docs and AI-ready context from your codebase
...
- **Why use it:** Curated bilingual list of DSH plugins, tools, skills, and verified integrations
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU task orchestration, experiment tracking
...
- **Tags:** `encyclopedia`, `resource`, `awesome-list`
...
- **Tags:** `epistemic-loop`, `scientific-discovery`, `agent-preset`
- **Why use it:** Brings Epistemic Loop methodology for scientific discovery and agent presets
...
- **Tags:** `academic-search`, `research-workflow`, `mcp`, `citation-management`
...
- **Tags:** `agent-skills`, `research`, `workflow`, `marketplace`
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories for discovery
...
- **⭐ Stars:** 29
- **Language:** HTML
- **Description:** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持��市场行情、技术指标、支撑压力位、新闻与基本面分析，并在原生侧栏中直接展示。
- **Tags:** `kline`, `financial`, `technical-analysis`
- **Why use it:** Interactive K-line charts with technical indicators in DSH sidebar
...
- **Why use it:** Curated DSH plugin discovery list for ecosystem exploration
...
- **Why use it:** Spam-filtered plugin registry with open-data quality assurance
...
- **Why use it:** Public plugin directory with install commands and ecosystem discovery
...
- **Why use it:** Vertical curated list for stock/finance/quant DSH plugins (24 verified)
...
- **⭐ Stars:** 8
- **Language:** Unknown
- **Description:** 好用的DeepSeek Harness插件集���
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated collection of useful DSH plugins with community selection
...
- **Why use it:** 2026 updated curated plugin list with quality checks
...
- **Why use it:** Comprehensive star-ranked directory of 1000+ DSH plugins.
...
- **Why use it:** Verified star-ranked community plugins catalog.
...
- **Why use it:** Plugin guide with installation and compatibility info.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `ai-curated`
- **Why use it:** AI-curated 190+ plugins across 12 categories, updated hourly.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `radar`
- **Why use it:** Evidence-backed plugin radar with risk assessment.
...
- **Why use it:** Curated selection of DSHA plugins.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `automated`
- **Why use it:** Auto-crawled daily bilingual plugin directory.
...
- **Tags:** `novel`, `writing`, `rag`, `creative`
- **Why use it:** Full-featured AI novel writing software with worldbuilding and chapter management.
...
- **Why use it:** Curated DSH plugin directory with daily GitHub updates and real classification
...
- **Why use it:** Comprehensive curated list covering plugins skills MCP servers and patches
...
- **⭐ Stars:** 270
- **Language:** Unknown
- **Description:** DeepSeek Harness 终极指���：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **Tags:** `awesome-list`, `quickstart`, `resources`, `guide`
- **Why use it:** Ultimate DSH guide with quickstart resources curated plugins and toolkits
...
- **Why use it:** Comprehensive DSH learning resource with marketplace guide
...
- **Tags:** `awesome-list`, `plugin-marketplace`, `catalog`
...
- **Tags:** `handbook`, `agent-runtime`, `mcp`, `documentation`
- **Why use it:** 173 source-backed agent handbook covering runtime, plugins, MCP and more
...
- **Tags:** `awesome-list`, `plugin-catalog`, `marketplace`
- **Why use it:** Plugin catalog with 1958 repos, search, filter and STAR ranking
...
- **Tags:** `awesome`, `agents`, `dsh-plugin`
...
- **Tags:** `plugins`, `dsh-plugins`, `dsh-ecosystem`
- **Why use it:** Plugin repository listing for the DSH ecosystem
...
- **Why use it:** Repo moved; redirect to updated plugin listing
...
- **Tags:** `awesome-list`, `plugins`, `dsh-plugins`
- **Why use it:** Auto-updating plugin list with bilingual README
...
- **Tags:** `plugins`, `registry`, `dsh-plugin`, `skills`

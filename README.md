...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,030,034 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-15 14:47:01 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225,076 | Core DSH ecosystem framework for plugin-based AI d |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,324 | Open-source Claude Design alternative for AI agent |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,518 | Multi-agent swarm orchestration with autonomous wo |
...
- **Tags:** `harness`, `framework`, `core`
- **Why use it:** Core DSH ecosystem framework for plugin-based AI development
...
- **Tags:** `agents`, `harness`, `skills`
- **Why use it:** Self-evolving multi-agent harness with memory and skills
...
- **Tags:** `desktop`, `dsh`, `ecosystem`
- **Why use it:** Modern desktop solution for DeepSeek Harness plugin ecosystem
...
- **Tags:** `agent-harness`, `workspace`, `no-code`, `mcp`
- **Why use it:** Unified agent workspace manager with cross-device task boards and API access.
...
- **Tags:** `routing`, `injector`, `agent-workflow`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for agent workflows.
...
- **Why use it:** Enterprise multi-engine agent workbench for team collaboration across harnesses.
...
- **Tags:** `agent-os`, `llm-evaluation`, `mcp`, `loop-engineering`
- **Why use it:** Self-improving agent OS with interview-gated evaluation and MCP server.
...
- **Why use it:** Long-horizon agent control plane for durable cross-harness orchestration.
...
- **Tags:** `bootstrap`, `preset`, `standard`
- **Why use it:** Two-phase bootstrap preset aligning agent behavior with standards
...
- **Tags:** `virtual-terminal`, `sandbox`, `agent-tools`
- **Why use it:** Virtual terminal for AI agents, first-of-its-kind sandbox
...
- **Tags:** `agent-teams`, `multi-agent`, `harness`
...
- **Why use it:** Dashboard and sidebar for deep context insight and management
...
- **Why use it:** OCR, image Q&A and screenshot-to-UI for text-only LLM agents
...
- **Why use it:** CLI, schemas, resolver and agent tools for the DSH Plugin Hub — essential for plugin development and management.
...
- **Tags:** `plugin-discovery`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Skill that searches, installs and verifies DSH plugins from GitHub
...
- **Tags:** `ai-infra`, `skills`, `deepseek-harness`
- **Why use it:** Specialized skills for AI infra development, code write and debug
...
- **Tags:** `superpowers`, `skills`, `coding`
...
- **Why use it:** Centralized control for MCP tools and skills exposure level and execution mode
...
- **Tags:** `skills`, `manager`, `harness`
- **Why use it:** Unified local Agent Skills loading and safe management in DSH
...
- **Tags:** `plugin-creator`, `deepseek-harness`, `coding`
...
- **Tags:** `troubleshooting`, `plugin-manager`
...
- **Why use it:** Search-enhanced plugin discoverability integrated directly inside DSH agents.
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `coding-agents`
- **Why use it:** Binds ChatGPT account via OAuth to use paid models directly inside DSH.
...
- **Why use it:** Open sidebar foundation with built-in file editor and terminal
...
- **Why use it:** Modern flexible task panel embeddable in DSH/Codex
...
- **Tags:** `tui`, `ui`, `whale`
- **Why use it:** TUI plugin with whale theme, real-time status and flow control
...
- **⭐ Stars:** 2,447
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh���装
- **Tags:** `widget`, `balance`, `whale`
- **Why use it:** Cute whale widget monitoring DeepSeek account balance in DSH
...
- **Why use it:** Zero-setup 5MB desktop client for Windows/macOS/Linux
...
- **Why use it:** Native iOS companion app via WebSocket — brings workspace, sessions, real-time replies and agent traces to your phone.
...
- **Why use it:** CodePilot-inspired native desktop client for macOS, Windows and Linux — a polished alternative UI for DSH.
...
- **Tags:** `vision`, `multimodal`, `claude-code`, `deepseek-harness`
...
- **Why use it:** Community plugin marketplace integrated into Web GUI
...
- **Why use it:** Live provider/model info, balance, pricing countdown in bottom bar
...
- **Tags:** `context`, `ui`, `audit`
- **Why use it:** Context injection auditor: stats token costs, detects duplicates and conflicts
...
- **Why use it:** All-in-one DevOps desktop with DB, SSH, SFTP, Docker and AI tools
...
- **Why use it:** Electron-based desktop wrapper integrating DSH web services and sidebar
...
- **Tags:** `knowledge`, `rag`, `wiki`
- **Why use it:** Open-source LLM knowledge platform with RAG and wiki
...
- **Why use it:** Portable, user-owned memory layer for all AI agents with self-evolving RAG.
...
- **Tags:** `agent-memory`, `rag`, `token-savings`, `skill-reuse`
...
- **Why use it:** Memory library for building stateful, agentic-RAG capable AI agents.
...
- **Tags:** `memory`, `rag`, `knowledge`
- **Why use it:** Persistent memory layer for agents, remember and refine
...
- **Tags:** `memory`, `milvus`, `search`
- **Why use it:** Unified memory layer backed by Markdown and Milvus for agents
...
- **Why use it:** Shared persistent memory hub giving all AI agents long-term recall
...
- **Why use it:** Zero-prompt associative memory with three-layer auto-consolidation
...
- **Tags:** `knowledge-base`, `agent-skill`, `plugin-development`
- **Why use it:** Official DSH docs archive in EN/ZH as on-demand agent skill
...
- **Tags:** `skills`, `distill`, `agents`
- **Why use it:** Distill agent thinking into reusable skills for any bot
...
- **Tags:** `skills`, `marketplace`, `automation`, `coding`
- **Why use it:** Largest skills marketplace with auto-scraped GitHub skills organized by category.
...
- **Why use it:** Intelligent skill routing and workflow orchestration engine
...
- **Tags:** `cognition`, `inference`, `reasoning`
- **Why use it:** Model-agnostic inference control for reasoning and verification
...
- **Why use it:** End-to-end automated Vox-style video generation from one topic
...
- **Why use it:** Full novel writing workflow with character, worldbuilding and editing
...
- **Tags:** `agent-observability`, `computer-vision`, `video-analysis`
- **Why use it:** Gives AI agents computer vision, audio, and screen monitoring with verifiable timestamped evidence.
...
- **Tags:** `creative-writing`, `novel-writing`, `fiction-writing`
- **Why use it:** Full novel, short-drama, game and video-recap writing workflow built for creative storytelling.
...
- **Why use it:** Live iOS Simulator and USB iPhone inside DSH conversation with 22 agent tools for full device automation.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `math-modeling`
- **Why use it:** Full-stack auto math modeling skill with GitOps pipeline and self-validation
...
- **Tags:** `agent-review`, `prompt-engineering`, `deepseek-harness`
- **Why use it:** Enables composable, reviewable agent modes for self-evolving workflows
...
- **Why use it:** Turn experience into repeatable execution across multiple AI platforms
...
- **Why use it:** 87 SKILL.md files for reverse engineering and pentesting
...
- **Why use it:** AI-powered investment desk with multi-strategy backtesting
...
- **Tags:** `agent-skill`, `ai-coding`, `mentor`
- **Why use it:** AI coding mentor that guides users through architecture scanning and code review
...
- **Tags:** `skills`, `agent`, `deck`
- **Why use it:** 25 ready-to-use engineering and productivity skills in sidebar panel
...
- **Why use it:** Full workflow GB/T 9704 compliant official document processing skill
...
- **Tags:** `spec`, `development`, `agent-skill`
...
- **Why use it:** Multi-agent team collaboration with shared workspace and independent tools
...
- **Why use it:** 11 QA skills with shared KB and type-decision matrix for test automation
...
- **Why use it:** Codex-style skill that finds and simplifies complex code patterns automatically
...
- **Tags:** `quality-gate`, `engineering`, `skill`
- **Why use it:** Engineering discipline bundle: grill requirements, test impl, prove delivery
...
- **Why use it:** Cross-platform session memory handoff: resume objective and status seamlessly
...
- **Why use it:** Multi-agent math modeling for competitions with 33 models and templates
...
- **Tags:** `recommender`, `ai-agents`, `mcp`
- **Why use it:** AI-curated plugin recommender with 190+ plugins across 12 categories updated hourly.
...
- **Tags:** `agent-tools`, `llm-agents`, `awesome-dsh-plugin`
- **Why use it:** Pre-flight plugin library check that auto-injects top-K relevant plugin hints for tasks.
...
- **Tags:** `finance`, `mcp`, `agent`, `deepseek-harness`
- **Why use it:** Local financial DB via Tushare with MCP and multi-agent trading alerts
...
- **Tags:** `cloud`, `mcp`, `huaweicloud`, `sdk`
...
- **Why use it:** One-click MCP/skills/rules config sync across 7+ AI agent tools
...
- **Why use it:** Open-source Claude Design alternative for AI agents
...
- **Tags:** `diagrams`, `architecture`, `visual`
- **Why use it:** Beautiful architecture and sequence diagram generator
...
- **Tags:** `design`, `vector`, `vibedesign`, `agent-team`
...
- **Why use it:** First vision/OCR plugin for DSH, enables image understanding
...
- **Why use it:** AI-generated design studio with templates, PPT and visual editor
...
- **Why use it:** Legal timeline and diagram visualization for litigation materials
...
- **Tags:** `ai-video`, `ai-image`, `director`
- **Why use it:** Full AI video/image/audio generation suite with storyboard and knowledge corpus
...
- **Why use it:** Cinematic video production with 152 shot recipe cards and Remotion
...
- **Why use it:** 6 design aesthetics styles to avoid AI-generated look in vibe coding
...
- **Why use it:** Transforms recent chat history into beautifully designed downloadable knowledge cards.
...
- **Tags:** `browser`, `extension`, `prompts`
...
- **Why use it:** Use real logged-in browser for AI agent automation seamlessly
...
- **Why use it:** Persistent fingerprint-spoofed browser with unlimited local profiles, Android emulation and residential proxies.
...
- **Tags:** `low-code`, `no-code`, `business`
...
- **Tags:** `model-switch`, `utility`
- **Why use it:** One-click model switch across Claude Code, Codex, DeepSeek, etc.
...
- **Why use it:** Turn code into structured technical docs for humans and agents
...
- **Why use it:** Auto-discovers and validates 15900+ plugins via k8s pipeline
...
- **Why use it:** Use ChatGPT, Claude, Grok subscriptions as DSH LLM providers — no API keys needed, OAuth in web UI.
...
- **Why use it:** Brings spreadsheets, docs, slides, canvases and relational tables directly into the DSH workspace.
...
- **Why use it:** Daily curated plugin discovery: filters real plugins from spam, ranks by heat, and categorizes by use-case.
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review workflow and a pure Web UI — no iframes.
...
- **Why use it:** Curated guide covering plugins, skills, MCP servers, patches and UIs for DeepSeek Harness ecosystem.
...
- **Why use it:** Track per-session and daily LLM costs, budgets, token usage history, and provider balance at a glance.
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, resources and practical toolkit recommendations.
...
- **Why use it:** Adds Command Code model access with live catalog, plan-aware selection and reasoning efficiency in DSH.
...
- **Why use it:** 11,000+ plugin catalog with search, rankings and public API
...
- **Tags:** `plugin-catalog`, `deepseek-harness`, `awesome-list`
- **Why use it:** Plugin catalog with 1958 repos, Chinese/English search and classification
...
- **Tags:** `remote-access`, `encryption`, `deepseek-harness`
...
- **Why use it:** Auto-upgrades plugins when DSH version updates
...
- **Why use it:** Backup, restore, migrate and sync all DSH configurations
...
- **Why use it:** Plugin ecosystem foundation: registry console and official dev guide
...
- **Tags:** `containers`, `management`, `infrastructure`
...
- **Why use it:** Web GUI plugin to manage skills and MCP servers in DSH settings
...
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill and MCP into unified platform
...
- **Tags:** `migration`, `import`, `claude-code`, `codex`
- **Why use it:** Migration wizard for Claude Code, Codex, OpenCode and Hermes data
...
- **Why use it:** Real-time token usage and cost tracking with visualization charts
...
- **Tags:** `mascot`, `pixel-art`, `ui`, `animation`
- **Why use it:** Public animated pet gallery to customize and personalize your coding agent UI.
...
- **Tags:** `theme`, `skin`, `desktop`
- **Why use it:** Cute whale girl visual theme series for DSH desktop
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一���切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `background`, `customization`
- **Why use it:** Customizable web background with presets and real-time preview
...
- **Tags:** `content-discovery`, `research`, `cross-platform`
- **Why use it:** Cross-platform AI content discovery from Bilibili, YouTube, etc.
...
- **Why use it:** Auto-scans 8 major Chinese platforms for 30-day research reports
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `documentation`
- **Why use it:** Essential learning resource and best practices guide for DSH ecosystem
...
- **Tags:** `academic-search`, `mcp`, `research`, `deepseek-harness`
- **Why use it:** Multi-source academic search with citation graph and verification via MCP
...
- **Why use it:** Comprehensive handbook covering runtime, plugins, MCP and sandbox concepts
...
- **Why use it:** Industry research pack with chain mapping and news tracking
...
- **Why use it:** Patent infringement analysis system with report generation
...
- **Tags:** `documentation`, `examples`, `skillhub`
- **Why use it:** Official SkillHub docs and examples for DSH ecosystem
...
- **Tags:** `kline`, `trading`, `technical-analysis`
...
- **Why use it:** Unofficial community catalog browsing all DSH plugins
...
- **Why use it:** Curated list of DSH plugins with descriptions and links
...
- **Why use it:** Curated stock/finance/quant DSH plugins with 24 verified entries
...
- **Tags:** `awesome-list`, `deepseek-harness`, `auto-update`, `bilingual`
- **Why use it:** Auto-updating bilingual plugin list with data-driven approach
...
- **Tags:** `prompts`, `image`, `gpt`
- **Why use it:** GPT Image 2 prompt library with 530+ industrial cases
...
- **Why use it:** Web-based plugin aggregation ecosystem for DSH with Creative Workshop distribution.
...
- **Why use it:** Curated directory of DSH plugins across CLI, web UI and agents
...
- **Why use it:** Official auto-generated plugin catalog by cordis.run
...
- **Tags:** `traditional-wisdom`, `bazi`, `fengshui`, `dashboard`
- **Why use it:** Bazi, Fengshui, I Ching and TCM traditional wisdom dashboard skill
...
- **Why use it:** Centralized DSH plugin directory for ecosystem discovery
...
- **Why use it:** Spam-filtered open-data DSH plugin registry and skills index
...
- **Why use it:** Evidence-led curated plugin directory with permission-aware guidance
...
- **Why use it:** Collection of useful DSH plugins for practical use
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Verified star-ranked community plugin curated list for DSH discovery.
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品���明书与导航：按场景选插件，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `dsh-plugin-directory`
- **Why use it:** Plugin manual and navigation guide covering install, permissions, compatibility.
...
- **Tags:** `marketplace`, `dsh-plugin-bundle`
- **Why use it:** DSH version of CodeX-style plugin marketplace for streamlined discovery.
...
- **Why use it:** DSHA official curated plugin collection for DeepSeek Harness users.
...
- **Tags:** `catalog`, `awesome-list`, `dsh-plugin-directory`
...
- **Tags:** `plugin-registry`, `awesome-list`, `2origin`
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for community experimentation.
...
- **Tags:** `static-site`, `web`, `plugin-portal`
- **Why use it:** Zero-dependency static web portal for discovering and filtering 227+ DSH plugins.
...
- **Why use it:** Organized DSH plugins directory with 80+ verified plugins grouped by functionality.
...
- **Tags:** `dsh-bundle`, `dsh-plugin-verify`, `dsh-plugins-net`
- **Why use it:** DSH plugins repository with verification, bundling, and analytics support.
...
- **Why use it:** Moved repository, original awesome-dsh plugin list now hosted elsewhere.
...
- **Why use it:** Simple DSH plugin listing, basic reference only

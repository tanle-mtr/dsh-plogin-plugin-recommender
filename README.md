...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 858,348 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 05:41:27 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 192,895 | The foundational harness platform for the entire D |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,171 | Open-source design plugin turning coding agents in |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,316 | Deploy multi-agent swarms with autonomous coordina |
...
- **Why use it:** The foundational harness platform for the entire DSH plugin ecosystem
...
- **Why use it:** Self-evolving super assistant with multi-model and memory support
...
- **Why use it:** Best beginner tutorial from 0 to harness engineering
...
- **Tags:** `vision`, `ocr`, `multimodal`, `bridge`
- **Why use it:** Vision bridge enabling image understanding for text-only agents
...
- **Why use it:** Makes AI coding agents architecture-aware with drift checking and evidence verification
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: OCR, image Q&A, screenshot
...
- **Tags:** `coding-agent`, `orchestration`, `mcp`, `dsh-plugin`
- **Why use it:** Dispatch work to DSH agents from Claude Code/Codex with subagent orchestration
...
- **Why use it:** Superpowers skill port adapted for Reasonix coding harness environment
...
- **Why use it:** Standard guide for building DSH plugins and adapters.
...
- **Tags:** `package-manager`, `skills`, `agent-framework`
- **Why use it:** Package manager with 42 skills, 5 CLIs for AI agent engineering and eval-driven dev
...
- **Tags:** `plugin-development`, `agent-skill`, `cordis`
- **Why use it:** Portable skill for developing and auditing DSH plugins with profile bundle adapter
...
- **Tags:** `plugin-development`, `documentation`, `best-practices`
- **Why use it:** Plugin dev experience archive: cordis dual-copy, tsconfig, Windows junction tips
...
- **Why use it:** Portable skill distilling engineering discipline: fact-finding, durable decisions, honest reporting
...
- **Tags:** `plugin-development`, `scaffolding`, `testing`
- **Why use it:** Plugin scaffolding & testing toolkit
...
- **Why use it:** Fast Neovim plugin manager
...
- **Why use it:** Modern desktop client tailored for the DeepSeek Harness plugin ecosystem
...
- **Tags:** `web-ui`, `plugin-hub`, `ecosystem`
- **Why use it:** Web UI aggregation for the DSH plugin ecosystem
...
- **Tags:** `pets`, `mascot`, `pixel-art`, `fun`
- **Why use it:** Fun animated pet gallery across multiple AI coders
...
- **Why use it:** Lightweight Tauri desktop wrapper with zero environment setup
...
- **Why use it:** Animated desktop companion with plugin SDK and coding-agent integrations
...
- **Why use it:** Cute whale widget tracking DeepSeek account balance in DSH
...
- **Why use it:** Full-featured Electron desktop workspace for DSH sessions and projects
...
- **Tags:** `dsh-plugin`, `desktop-app`, `agent`, `mcp`, `privacy`
...
- **Why use it:** Generates interactive UI components inline within assistant replies
...
- **Tags:** `dsh-plugin`, `desktop-app`, `electron`, `typescript`
- **Why use it:** CodePilot-inspired desktop client with full plugin suite for DSH
...
- **Tags:** `dsh-plugin`, `ui`, `canvas`, `workspace`
- **Why use it:** Visual non-linear canvas-based conversation workspace for DSH sessions
...
- **Tags:** `desktop`, `electron`, `gui`, `ssh`, `windows`
- **Why use it:** Full-featured Windows desktop client with SSH, skills & mobile access
...
- **Why use it:** Electron desktop console for managing DSH plugins.
...
- **Tags:** `desktop-app`, `devops`, `ssh`, `docker`
- **Why use it:** All-in-one DevOps desktop app
...
- **Tags:** `electron`, `desktop-app`, `integration`
- **Why use it:** Electron-based desktop integration
...
- **Why use it:** Self-evolving context database unifying agent memory and knowledge
...
- **Why use it:** Turn raw documents into RAG, reasoning agents, and self-maintaining wiki
...
- **Tags:** `memory`, `local-first`, `rag`, `markdown`
- **Why use it:** Local-first portable memory layer across all AI tools
...
- **Tags:** `memory`, `self-evolving`, `token-optimization`
...
- **Why use it:** Provides unlimited memory capabilities for AI agents
...
- **Why use it:** Comprehensive context management with dashboard and statistics
...
- **Tags:** `dsh-plugin`, `knowledge-base`, `rag`, `ai-pedia`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering agents RAG and MLOps
...
- **Tags:** `memory`, `rag`, `skills`, `embeddings`, `retrieval`
- **Why use it:** Transforms SKILL.md files into searchable retrieval-ready corpora
...
- **Tags:** `memory`, `recall`, `http-server`
- **Why use it:** PowerContext memory & recall
...
- **Why use it:** Deploy multi-agent swarms with autonomous coordination and workflows
...
- **Tags:** `workspace`, `multi-device`, `orchestration`
- **Why use it:** Unified agent workspace across all your devices
...
- **Why use it:** Self-improving agent OS that gets smarter over time
...
- **Tags:** `enterprise`, `multi-agent`, `workspace`
- **Why use it:** Enterprise multi-agent workspace with unified editor
...
- **Tags:** `workflow`, `productivity`, `ai-assistant`
...
- **Why use it:** Enables multi-agent team collaboration within DSH
...
- **Tags:** `dsh-plugin`, `agent`, `skill`, `automation`
- **Why use it:** Orchestrates multiple coding agents into a collaborative team workflow
...
- **Tags:** `creative-writing`, `screenwriting`, `fiction`, `novel`
- **Why use it:** Dedicated plugin for novel writing and short-drama production workflows
...
- **Tags:** `skills`, `agent`, `workflow`, `architecture`, `docs`
...
- **Tags:** `vision`, `multimodal`, `skill`, `claude-code`
- **Why use it:** Adds multimodal vision capability to text-only LLM agents
...
- **Tags:** `plugin-discovery`, `skill`, `automation`, `installation`
- **Why use it:** Auto-discovers, installs and verifies GitHub plugins via skill
...
- **Tags:** `context-migration`, `session`, `dsh-plugin`
...
- **Tags:** `task-management`, `agent`, `dsh-plugin`
...
- **Tags:** `workflow`, `agent`, `dsh-plugin`
- **Why use it:** Agent workflow plugin for structuring multi-step DSH operations
...
- **Why use it:** TDD, debugging, planning and collaboration skills from Superpowers for DSH
...
- **Why use it:** 85 specialized skills for reverse engineering and CTF.
...
- **Why use it:** AI coding mentor with project scanning and code review.
...
- **Tags:** `research-tools`, `marketing-automation`
- **Why use it:** 88 cross-platform agent skills for research and marketing.
...
- **Tags:** `legal-tech`, `visualization`
- **Why use it:** Legal case timeline and diagram generation skill.
...
- **Why use it:** Repository-native spec-driven development skill.
...
- **Tags:** `agent-skill`, `plugin-management`
- **Why use it:** Agent skill for managing slots and credentials.
...
- **Why use it:** Official DSH plugin dev knowledge base as on-demand skill
...
- **Why use it:** Enables cross-platform agent handoff with session continuity memory
...
- **Tags:** `chinese-traditional-wisdom`, `bazi`, `fengshui`, `iching`
- **Why use it:** Fusion Bazi/Fengshui/I-Ching skill with local deterministic engine
...
- **Why use it:** WorkBuddy-style skill picker for quick skill insertion in DSH
...
- **Why use it:** Codex-adapted skill for code simplification and refactoring
...
- **Why use it:** Centralized skill management plugin for DSH ecosystem
...
- **Tags:** `dsh-plugin`, `skill`, `oauth`
- **Why use it:** DSH event group photo wall with GitHub OAuth and polaroid-style photos
...
- **⭐ Stars:** 15
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文���作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `docx`, `gongwen`, `wps-office`
- **Why use it:** Full Chinese official document processing: format check, optimization, template generation
...
- **Tags:** `skills`, `gamification`, `task-bar`
- **Why use it:** Game-like mission system with fog-of-war map and task-bar progression for DSH
...
- **Tags:** `canvas`, `creative-skills`, `agent-skills`
- **Why use it:** Infinite canvas with creative skills
...
- **Tags:** `record-replay`, `desktop-workflow`, `macos`
- **Why use it:** Record desktop workflows as skills
...
- **Why use it:** Godot 4.x game dev skill

---

### [Classicoke/cleverer-dsh](https://github.com/Classicoke/cleverer-dsh)
...
- **Tags:** `agent-skills`, `intelligence`, `cordis`
- **Why use it:** DSH intelligence plugin suite
...
- **Why use it:** Virtual product team agent preset for collaborative workflows
...
- **Tags:** `agent-tools`, `capability-index`, `plugin-check`
- **Why use it:** Pre-flight plugin check that auto-injects Top-K relevant tools
...
- **Tags:** `dsh-plugin`, `web-search`, `mcp`, `agent-skills`
- **Why use it:** Best free web search plugin with no signup or API key required
...
- **Tags:** `ocr`, `vision`
- **Why use it:** Image-to-text OCR tools for text-only AI models.
...
- **Tags:** `mcp`, `skill-management`, `ui`
- **Why use it:** Web GUI plugin to manage skills and MCP servers via browser settings
...
- **Why use it:** Zhihu search and ask via Skill, CLI and MCP with official open-platform APIs
...
- **Why use it:** Paste JSON to connect MCP servers with hot reload; zip upload auto-creates skills
...
- **Why use it:** OAuth integration to use ChatGPT Plus models inside DSH
...
- **Why use it:** Open-source design plugin turning coding agents into powerful designers
...
- **Why use it:** 530+ reverse-engineered image prompts with 20 industrial-grade templates
...
- **Tags:** `diagrams`, `architecture`, `mermaid-alternative`
- **Why use it:** Beautiful self-contained architecture diagrams with motion
...
- **Why use it:** Open-source AI-native vector design with Agent Teams
...
- **Why use it:** AI-generated visual design system with PPT and template marketplace
...
- **Why use it:** Generate images directly inside DSH chats via multiple AI models
...
- **Tags:** `design`, `ui`, `ppt`, `openpencil`, `visual`
- **Why use it:** Preview, inspect and edit OpenPencil .op design docs inside chat
...
- **Tags:** `kline`, `financial`, `visualization`, `analysis`
- **Why use it:** Interactive K-line chart with technical indicators in native sidebar
...
- **Why use it:** 6 design aesthetic styles to avoid generic AI-generated website look
...
- **Tags:** `image-generation`, `vision`, `agent-skills`
...
- **Why use it:** AI video/image/audio skills with knowledge corpus and configurable multimodal tools
...
- **⭐ Stars:** 19,830
- **Language:** TypeScript
- **Description:** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；提示词管理器可用于任�� Web UI，含 DeepSeek Harness。
...
- **Tags:** `chat-bot`, `dingtalk`, `dsh-plugin`
- **Why use it:** DingTalk channel with agent capabilities.
...
- **Tags:** `routing`, `infrastructure`, `injection`
- **Why use it:** Professional routing injector for task-aware reasoning
...
- **Why use it:** Minimal two-phase preset achieving near-perfect scores
...
- **Tags:** `vfs`, `virtual-filesystem`, `abstraction`
...
- **Tags:** `dsh-plugin`, `security`, `cybersecurity`, `redteam`
...
- **Tags:** `dsh-plugin`, `mcp`, `oauth`, `provider`
- **Why use it:** Uses ChatGPT Claude Grok subscriptions as free LLM providers via OAuth
...
- **Tags:** `cost-tracking`, `token`, `budget`, `utility`
...
- **Why use it:** Run Pi ecosystem extensions natively in DSH via compatibility layer
...
- **Why use it:** One-click browse, install and update all dsh-plugin marketplace plugins
...
- **Tags:** `backup`, `crash-recovery`, `dsh-plugin`
- **Why use it:** Crash rescue with undo config changes and SAFE MODE one-click recovery
...
- **Why use it:** Web UI management panel for skills and MCP tools configuration
...
- **Tags:** `marketplace`, `webui`, `dsh-plugin`
...
- **Why use it:** Plugin management console and dev scaffolding tool.
...
- **Why use it:** Isolated container runtime manager for multiple DSH.
...
- **Why use it:** Backup, restore, and sync your full DSH config and plugins
...
- **Tags:** `capability-menu`, `mcp`, `skill-management`
...
- **Tags:** `context-audit`, `token`, `ui`
- **Why use it:** Audits context token costs, detects duplicates and conflicts via Web UI
...
- **Tags:** `token-usage`, `data-visualization`, `monitoring`
- **Why use it:** Real-time token usage charts
...
- **⭐ Stars:** 6
- **Language:** TypeScript
- **Description:** 致力于解决各插件之间也与版��之间可能存在的冲突问题并提供解决方案
- **Tags:** `dsh-plugin`, `deepseek-harness`, `utility`
- **Why use it:** Resolves plugin conflicts and compatibility issues
...
- **Why use it:** Search and browse DSH plugins directly.
...
- **Why use it:** Plugin marketplace for DSH ecosystem.
...
- **Tags:** `dsh-plugin`, `theme`, `ui`
- **Why use it:** Highly customizable glassmorphism theme without modifying DSH source code
...
- **Why use it:** Stunning WebGPU ocean-themed UI skin for DSH
...
- **Tags:** `theme`, `skin`, `dark-mode`
- **Why use it:** 34 opencode classic color themes for DSH, one-click switch, survives restarts
...
- **Tags:** `webui`, `theme`, `background`, `customization`
- **Why use it:** Web UI background customization with preset atmospheres and effects
...
- **Why use it:** Comprehensive bilingual curated list of DSH plugins and integrations
...
- **Tags:** `dsh-plugin`, `awesome-list`, `discovery`
- **Why use it:** Daily automated curation filtering fake plugins by scenario and popularity
...
- **Tags:** `dsh-plugin`, `documentation`, `learning`
- **Why use it:** Learn DSH principles plugin marketplace and best practices comprehensively
...
- **Tags:** `dsh-plugin`, `guide`, `awesome-list`, `bilingual`
- **Why use it:** Ultimate bilingual guide covering quickstart resources and plugin toolkit
...
- **Tags:** `chinese-api`, `api-documentation`
...
- **Tags:** `awesome-list`, `registry`, `plugin-directory`
- **Why use it:** Spam-filtered open-data plugin registry and catalog
...
- **Why use it:** Curated finance/quant plugin directory with 24 verified entries
...
- **Tags:** `awesome-list`, `documentation`, `plugin-guide`
- **Why use it:** Plugin product manual with scenario-based selection guide
...
- **Tags:** `plugin-radar`, `evidence-backed`, `2origin`
...
- **Tags:** `awesome-list`, `plugin-repo`, `catalog`
- **Why use it:** Community-curated DSH plugin repository and catalog
...
- **Tags:** `awesome-list`, `archived`, `moved`
- **Why use it:** Archived list, migrated to separate repository
...
- **Tags:** `awesome-list`, `automated`, `bilingual`, `directory`
...
- **Why use it:** Curated plugin directory for DSH discovery.
...
- **Why use it:** AI-updated plugin recommendation list.
...
- **Why use it:** Curated resources for DSH ecosystem.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Basic DSH plugin directory.
...
- **Why use it:** Evidence-aware plugin shortlist.
...
- **Why use it:** Verified plugins categorized by function.
...
- **Why use it:** Industry-specific DSH plugin directory.
...
- **Tags:** `mcp-server`, `resume-builder`, `self-hosted`
- **Why use it:** Privacy-focused open-source resume builder with MCP integration
...
- **Why use it:** Comprehensive AI resource hub and Vibe Coding beginner tutorials
...
- **Why use it:** Curated plugin ecosystem directory for DSH community
...
- **Why use it:** Curated plugin radar with real installation testing and top 50 selection
...
- **Why use it:** Curated plugin list covering the full DSH ecosystem
...
- **Why use it:** Curated collection of DSH ecosystem plugins and tools
...
- **Tags:** `awesome-list`, `plugin-directory`, `meta`
- **Why use it:** Essential curated index of the entire DSH plugin ecosystem
...
- **Tags:** `marketplace`, `plugin-store`, `catalog`, `directory`
- **Why use it:** Plugin marketplace with 3100+ plugins, search and free API
...
- **Tags:** `plugin-collection`, `harness`, `ecosystem`
...
- **Tags:** `anime`, `search`, `bangumi`, `torrent`, `entertainment`
- **Why use it:** Anime search plugin with Bangumi scores, magnet links and card display
...
- **Why use it:** Smartisan-style notes with Docker deploy, skill calls, WeChat export
...
- **Why use it:** Curated DSH ecosystem resource list for discovery.
...
- **Why use it:** Community-maintained auto-sync plugin catalog.
...
- **Why use it:** Auto-generated official plugin listing from cordis.run.
...
- **Why use it:** Curated plugin discovery list
...
- **Why use it:** Public plugin directory
...
- **Why use it:** Community plugin catalog
...
- **Tags:** `awesome-list`, `evidence-led`, `curation`
- **Why use it:** Evidence-led plugin directory
...
- **Why use it:** 2026 curated plugin list
...
- **Tags:** `portal`, `webui`, `plugin-directory`, `static-site`
- **Why use it:** Static web portal for browsing and installing 227+ curated plugins
...
- **Why use it:** Broad plugin collection for DSH customization.

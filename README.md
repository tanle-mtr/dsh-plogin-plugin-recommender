...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 877,611 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 22:56:32 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 197,882 | Core DSH ecosystem hub with plugin-first architect |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,781 | Open-source design system generator with Figma-alt |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,484 | Meta-harness for deploying multi-agent swarms and  |
...
- **Why use it:** Core DSH ecosystem hub with plugin-first architecture enabling full extensibility.
...
- **Tags:** `coding-agent`, `tui`, `tool-use`, `prompt-caching`
...
- **Tags:** `routing`, `dsh-plugin`, `agent-orchestration`
- **Why use it:** Task-aware reasoning router that boosts coding agent accuracy and efficiency.
...
- **Tags:** `preset`, `standards`, `dsh-plugin`
- **Why use it:** Production-grade preset aligning DSH with full Standard tools for reliable coding.
...
- **Why use it:** Vision bridge plugin turning images into structured JSON evidence for text-only agents.
...
- **Tags:** `claude-code`, `deepseek-harness`, `coding-agent`
- **Why use it:** One-click model switching across major coding agents and harnesses.
...
- **Tags:** `agent-runtime`, `rust`, `vibe-coding`
- **Why use it:** High-performance Rust agent runtime with polished desktop AI coding app.
...
- **Why use it:** Stabilizes DeepSeek prompting via armor-breaking tech
...
- **Tags:** `agent`, `desktop`, `multi-model`, `dsh-plugin`
...
- **Why use it:** Security platform auditing AI-generated code for vulnerabilities
...
- **Why use it:** Official DSH plugin dev knowledge base with EN/ZH docs.
...
- **Tags:** `deepseek-harness`, `plugin-development`, `codex`
- **Why use it:** Build and validate DSH/Cordis plugins with reusable Codex skills.
...
- **Tags:** `agent`, `package-manager`, `skills`, `cli`
- **Why use it:** 42 skills + 5 CLIs + 1 plugin package manager for AI agent engineering.
...
- **Tags:** `plugin-development`, `audit`, `portable`
...
- **Tags:** `best-practices`, `documentation`, `dsh-plugin`, `skill`
- **Why use it:** Practical DSH plugin dev guide with proven fixes and patterns
...
- **Tags:** `dsh-plugin`, `scaffolding`, `testing`, `skills`
- **Why use it:** Complete skill suite for scaffolding and testing DSH plugins
...
- **Why use it:** Pre-flight plugin check for agents — automatically injects top-K relevant plugins
...
- **Why use it:** Privacy-first resume builder with customizable open-source templates.
...
- **Tags:** `dsh-web`, `dsh-plugin`, `community`
- **Why use it:** Web-based DSH plugin aggregator; expands ecosystem with creative community plugins.
...
- **Why use it:** Adorable animated pet gallery that personalizes your coding agent experience.
...
- **Why use it:** Open sidebar foundation with file editor, terminal, chat, Git and sub-agents.
...
- **Why use it:** Claude Code-inspired TUI with whale theme, streaming thinking, and rollback.
...
- **Why use it:** Local-first desktop workspace integrating sessions and plugins
...
- **Tags:** `desktop`, `electron`, `multi-platform`
- **Why use it:** Cross-platform Electron desktop client for DeepSeek Harness
...
- **Why use it:** Open-source Windows GUI client with SSH, Codex, and mobile access
...
- **Tags:** `design`, `ui`, `vibe-coding`, `theme`
...
- **Tags:** `data-visualization`, `token-usage`, `ai-cost`, `web-plugin`
- **Why use it:** Real-time token usage dashboard with cost charts and API balance
...
- **Tags:** `desktop`, `tauri`, `docker`, `ssh`, `database`
...
- **Why use it:** Electron desktop wrapper integrating DSH web with useful plugins
...
- **Tags:** `webui`, `dsh-plugin`, `background`
- **Why use it:** Personalizes DSH Web background with custom images and preset themes
...
- **Why use it:** Knowledge platform turning documents into queryable RAG, agents, and Wiki.
...
- **Why use it:** Portable local-first memory layer enabling persistent, cross-agent memory.
...
- **Why use it:** Solid memory management kit for AI agents with RAG capabilities.
...
- **Tags:** `knowledge-base`, `mcp`, `rag`, `skills`
...
- **Tags:** `evaluation`, `rag`, `prompt-testing`, `benchmark`
- **Why use it:** Evidence-backed evaluation for prompts, RAG, agents, and workflows.
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `ai-persona`
- **Why use it:** Distills expert thinking into reusable AI agent skills and personas.
...
- **Why use it:** Self-improving agent OS that learns and evolves through evaluation feedback loops.
...
- **Why use it:** Transforms AI conversations into reusable workflows
...
- **Tags:** `agent-skills`, `skill-md`, `vector-search`
- **Why use it:** Curate and retrieve agent skills from scattered SKILL.md files
...
- **Tags:** `creative-writing`, `novel-writing`, `dsh-plugin`
- **Why use it:** AI-powered novel writing and short-drama production skill
...
- **Tags:** `agent-skills`, `math-modeling`, `coding`
...
- **Why use it:** Add multimodal vision to text-only LLMs for UI and chart analysis
...
- **Why use it:** Discover, install, and verify DSH plugins via GitHub seamlessly
...
- **Why use it:** AI mentor skill: scans arch, generates chapters, code reviews
...
- **Why use it:** Legal visualization tools: timelines and litigation diagrams
...
- **Why use it:** Bazi/Fengshui/TCM AI agent with local deterministic engine.
...
- **Tags:** `agent-handoff`, `context-memory`
...
- **Tags:** `skill-picker`, `ux`
- **Why use it:** One-gesture skill picker for DSH composer, like WorkBuddy.
...
- **Why use it:** Version-pinned Swift Cycle governance skill with offline verification.
...
- **Tags:** `agent`, `skills`, `gamification`, `mission`
...
- **⭐ Stars:** 18
- **Language:** Python
- **Description:** 中文公文全流程处理工具——��于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `template`, `china`
- **Why use it:** Full Chinese official document workflow: format, optimization, templates.
...
- **Tags:** `agent-skills`, `canvas`, `mcp`, `skills`
- **Why use it:** Enables infinite canvas with rich creative agent skills
...
- **Why use it:** Portable agent skill encoding proven engineering discipline
...
- **Why use it:** Full-stack Godot 4.x dev skill registered at runtime
...
- **Why use it:** Virtual product team preset guiding users through PM to QA workflows
...
- **Why use it:** Open-source design system generator with Figma-alternative capabilities.
...
- **Why use it:** Beautiful architecture and sequence diagrams via code; ideal for visual thinking and docs.
...
- **Tags:** `design`, `vibedesign`, `dsh-plugin`
- **Why use it:** AI-native vector design tool with concurrent Agent Teams for design-as-code workflow.
...
- **Tags:** `vision`, `ocr`
- **Why use it:** Powerful vision toolkit for text-only LLMs with OCR support
...
- **Why use it:** AI-powered editable design system with PPT and prototyping
...
- **Tags:** `image-generation`, `dsh-plugin`, `ai-agent`
...
- **Why use it:** Interactive K-line chart analysis with multi-market and technical indicators.
...
- **Why use it:** Free image reading & generation with auto vision transcription support.
...
- **Tags:** `video`, `image`, `ai-director`, `multimodal`
...
- **Tags:** `bilibili`, `xiaohongshu`, `content-discovery`, `local-first`
...
- **Why use it:** Integrates iOS Simulator and USB iPhone into agent workflows
...
- **Tags:** `zhihu`, `search`, `mcp`, `knowledge`
- **Why use it:** Zhihu search, Zhida Q&A, and official open-platform API integration.
...
- **Why use it:** Frosted glass theme with fully customizable blur and backgrounds
...
- **Why use it:** Stunning WebGPU ocean-themed skin extension for DSH
...
- **Tags:** `theme`, `skin`, `color-scheme`, `customization`
- **Why use it:** 34 opencode themes one-click switch, persists across restarts.
...
- **Tags:** `ai-resources`, `prompt-engineering`, `vibe-coding`, `rag`
- **Why use it:** Comprehensive AI resource compilation covering models, prompts, and skill tutorials.
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day content research reports.
...
- **Why use it:** Public plugin registry with install commands and ecosystem discovery
...
- **Why use it:** Community-maintained unofficial plugin catalog for DSH
...
- **Why use it:** 2026 curated plugin list with quality checks included
...
- **Why use it:** Spam-filtered open plugin registry with bundles and skills index
...
- **Why use it:** Automated curated plugin directory for DSH ecosystem
...
- **Why use it:** Search and browse DSH plugins directly inside agents
...
- **Why use it:** CodeX-style marketplace for browsing DSH plugin skills
...
- **Why use it:** Curated plugins covering models, tools, sandboxes and UI
...
- **Why use it:** Basic DSH plugin directory resource
...
- **Why use it:** Industry-specific DSH plugins for IT, finance, legal and more
...
- **Why use it:** Curated plugin directory — best starting point for discovering DSH ecosystem tools.
...
- **Tags:** `toy`, `web-simulation`, `single-file`
- **Why use it:** Web simulation of a traditional Chinese children's toy, zero dependency.
...
- **Why use it:** Curated plugin radar with automated discovery and real-world testing
...
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Curated plugin list for the DeepSeek Harness ecosystem
...
- **Why use it:** Curated bilingual plugin and extension discovery list
...
- **Why use it:** Daily curated plugin discovery with ratings and guides
...
- **Tags:** `learning`, `documentation`, `dsh-plugin`
- **Why use it:** Learning resource for DSH principles and plugin best practices
...
- **Why use it:** Ultimate DSH guide with resources, plugins, and toolkit
...
- **Why use it:** Curated list of DSH plugins, MCP servers, skills, and tools
...
- **Why use it:** Plugin marketplace and hub with 11,000+ searchable DSH plugins
...
- **Tags:** `plugin-marketplace`, `dsh-plugin`, `plugins`
- **Why use it:** DeepSeek Harness plugin marketplace and collection hub
...
- **Why use it:** Star-ranked community plugin directory for DSH ecosystem discovery
...
- **Why use it:** Comprehensive curated resource hub for all DSH plugins, tools, and skills
...
- **Why use it:** Practical DSH plugin collection covering useful community extensions
...
- **Why use it:** Plugin product manual and navigation with scene-based selection guidance
...
- **Why use it:** DSH plugins bundle and ecosystem repository directory
...
- **Why use it:** Evidence-backed plugin radar and 2Origin plugin lab for DSH ecosystem

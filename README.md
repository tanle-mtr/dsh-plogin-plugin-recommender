...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,084,931 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 233,986 | Core DSH platform — everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,742 | Open-source Figma alternative with AI design gener |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,112 | Deploy multi-agent swarms with autonomous workflow |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 29 plugins
...
- [Research & Analysis](#research-&-analysis) — 15 plugins
...
- [Coding Agents & Harness Tools](coding-agents-harness-tools) (29)
...
- **Why use it:** Open-source multi-agent assistant with self-evolving memory
...
- **Tags:** `agent-orchestration`, `workspace`, `no-code`, `mcp`
- **Why use it:** Unified agent workspace with board-based task tracking across desktop, mobile, browser, and API.
...
- **Tags:** `enterprise`, `multi-agent`, `workbench`, `coding-agent`
- **Why use it:** Enterprise multi-engine agent workbench with unified workspace for Codex, DeepSeek, and OpenCode.
...
- **Tags:** `agent-os`, `mcp`, `llm-orchestration`, `evaluation`
- **Why use it:** Self-evolving agent OS with interview-gated evaluation, budgeted loops, and 14 runtime MCP support.
...
- **Tags:** `vision`, `ocr`, `multimodal`, `image-to-text`, `agent-skills`
- **Why use it:** First vision plugin bridging image inputs to structured JSON for text-only agents.
...
- **Why use it:** Virtual terminal and filesystem enabling isolated agent environments.
...
- **Tags:** `agentic-runtime`, `rust`, `code-agent`, `desktop`
- **Why use it:** High-performance Rust agent runtime with polished desktop app and multi-agent support.
...
- **Why use it:** Comprehensive context insight dashboard, sidebar, and browser management tools.
...
- **Tags:** `vision-tools`, `ocr`, `gui-automation`, `computer-vision`
- **Why use it:** Vision toolkit for text-only LLMs: image Q&A, OCR, and screenshot UI restoration.
...
- **Tags:** `security`, `cybersecurity`, `vulnerability`, `audit`
...
- **Tags:** `deepseek-harness`, `office`, `dsh-plugin`
- **Why use it:** Adds full office suite (docs, sheets, slides) directly into DSH
...
- **Tags:** `llm-provider`, `oauth`, `dsh-plugin`
...
- **Tags:** `task-management`, `dsh-plugin`, `sqlite`
...
- **Tags:** `ios-simulator`, `mcp`, `mobile-automation`
- **Why use it:** Embed live iOS Simulator in DSH with 22 agent automation tools
...
- **Why use it:** Bridge Pi ecosystem to DSH — run Pi extensions natively as DSH plugins.
...
- **Why use it:** Audit DSH skill calls and manage skills within the app seamlessly.
...
- **Tags:** `plugin-discovery`, `installation`, `skill`
- **Why use it:** Skill to search, install, and verify DSH GitHub plugins automatically.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `agent`
- **Why use it:** AI coding mentor that guides you through project architecture step by step
...
- **Tags:** `plugin-creator`, `scaffold`, `development-tool`
- **Why use it:** Reusable skill scaffold for building and validating DSH plugins
...
- **Tags:** `context`, `deepseek-harness`, `ui`, `tool`
- **Why use it:** Audits context token costs and detects conflicts in DSH instruction chains
...
- **Tags:** `cordis`, `orchestration`, `launcher`
- **Why use it:** Unifies runtime, providers, plugins and MCP orchestration in DSH
...
- **Tags:** `plugin-doctor`, `conflict-resolution`, `deepseek-harness`
...
- **Tags:** `chatgpt`, `dsh-plugin`, `oauth`, `ai-agents`
- **Why use it:** Enables ChatGPT model access via OAuth directly in DSH.
...
- **Tags:** `desktop`, `dsh-desktop`, `native-app`
- **Why use it:** Official desktop client for DSH — brings native app experience to DeepSeek Harness.
...
- **Tags:** `dsh-web`, `plugin-ecosystem`, `marketplace`
- **Why use it:** Web-based plugin aggregation hub — discovers and distributes DSH plugins through creative workshop.
...
- **Tags:** `sidebar`, `ui-extension`, `dsh-plugin`, `terminal`
...
- **Tags:** `taskboard`, `ui-extension`, `skills`, `codex`
...
- **Why use it:** TUI plugin with whale bar, streaming thoughts, and real-time context progress.
...
- **Tags:** `floating-widget`, `dsh-plugin`, `cordis`
- **Why use it:** Cute floating whale widget monitors your DeepSeek account balance.
...
- **Tags:** `desktop`, `tauri`, `dsh-desktop`
- **Why use it:** Lightweight Tauri desktop client with zero setup and preset plugins.
...
- **Tags:** `desktop`, `gui`, `ssh-client`, `electron`
- **Why use it:** Zero-setup Windows GUI for DSH with SSH, Codex, plugins, and mobile remote access
...
- **Tags:** `desktop`, `local-first`, `react`, `typescript`
- **Why use it:** Local-first AI desktop workspace for DSH sessions, projects, files, and Office artifacts
...
- **Why use it:** Interactive UI components rendered inline in replies — charts, forms, quizzes
...
- **Tags:** `canvas`, `workspace`, `conversation`, `visual`
- **Why use it:** Canvas-based non-linear conversation workspace with visual session branching
...
- **Tags:** `mobile`, `ios`, `websocket`
- **Why use it:** Native iOS client for DSH with workspace, sessions, and agent tracks
...
- **Tags:** `desktop-app`, `electron`, `multi-os`
- **Why use it:** CodePilot-inspired desktop client with plugin suite for all OSes
...
- **Tags:** `vision`, `multimodal`, `ui`
- **Why use it:** Add multimodal vision to text-only LLMs for screenshot/UI/chart analysis.
...
- **Why use it:** Open-source Smartisan Notes with Docker deployment, skill calls, and export.
...
- **Tags:** `mcp`, `skills`, `ui`, `web`
- **Why use it:** Web UI plugin for managing skills and MCP servers directly in the browser
...
- **Why use it:** Electron-based DSH desktop console for multi-tab plugin/MCP/skill management
...
- **Tags:** `web-platform`, `skills`, `typescript`
- **Why use it:** Plugin-based web work platform with global skill and workspace integration
...
- **Tags:** `bioinformatics`, `desktop-app`, `single-cell`
- **Why use it:** Bioinformatics agent desktop with skill store and offline mode for scientists
...
- **Tags:** `ui-extension`, `info-bar`, `desktop`
- **Why use it:** Replaces composer stats row with provider/model/quota info bar
...
- **Why use it:** All-in-one DevOps desktop: DB, SSH, SFTP, Docker, AI assistant in one window.
...
- **Why use it:** Electron desktop shell integrating dsh-web-ui, ModLens, and awesome-dsh plugins.
...
- **Why use it:** Adds one-click compact mode button to the context meter panel
...
- **Why use it:** Portable local-first memory layer with Markdown-native storage and cross-app RAG support.
...
- **Tags:** `agent-memory`, `rag`, `token-savings`, `skills`
- **Why use it:** Self-evolving memory OS with hybrid retrieval achieving 35% token savings across tasks.
...
- **Why use it:** Dedicated memory library enabling stateful agents with continual learning capabilities.
...
- **Tags:** `memory`, `rag`, `agent`, `knowledge-management`
- **Why use it:** Dedicated memory management kit with RAG for persistent agent context.
...
- **Tags:** `agent-memory`, `rag`, `milvus`, `semantic-search`
- **Why use it:** Unified persistent memory layer for all AI agents using Milvus + Markdown.
...
- **Tags:** `rag`, `embeddings`, `vector-search`, `skill-corpus`
...
- **Why use it:** Official docs archive as on-demand agent skill knowledge base
...
- **Tags:** `skillhub`, `documentation`, `open-api`
- **Why use it:** Open API skill documentation hub with examples for DSH plugins
...
- **Why use it:** Deploy multi-agent swarms with autonomous workflows
...
- **Tags:** `agent-skills`, `knowledge-distillation`
...
- **Why use it:** Long-form web novel writing assistant solving AI forgetting and hallucination at 2M word scale.
...
- **Tags:** `skills`, `skill-store`, `multi-platform`
- **Why use it:** Most comprehensive skill store with auto-aggregated GitHub skills across multiple AI platforms.
...
- **Tags:** `agent-control-plane`, `workflow-automation`, `long-horizon`
...
- **Tags:** `agent-skills`, `workflow-automation`, `context-engineering`, `multi-agent`
- **Why use it:** Intelligent skill routing and workflow orchestration with proven performance gains.
...
- **Tags:** `agent-skills`, `inference-time-control`, `cognitive-enhancement`
- **Why use it:** Model-agnostic inference control for deep reasoning and recovery workflows.
...
- **Why use it:** Enables multi-agent team collaboration and coordinated workflows in DSH.
...
- **Tags:** `writing`, `novel`, `workflow`, `creative`
- **Why use it:** Workflow plugin for novel, short drama, game video scripting, and creative writing
...
- **Tags:** `agent-skills`, `multimodal`, `mcp`
- **Why use it:** Gives agents ears and eyes via video/audio/screen monitoring
...
- **Tags:** `agent-preset`, `scientific-discovery`
- **Why use it:** Brings epistemic loop workflow for scientific discovery into DSH
...
- **Tags:** `evolution`, `self-improvement`, `agent`
- **Why use it:** Enable composable, reviewable, self-evolving agent workflows via Web plugin.
...
- **Tags:** `skills`, `workflow`, `cross-platform`
- **Why use it:** Turn AI experience into repeatable cross-platform execution workflows.
...
- **Tags:** `ctf`, `reverse-engineering`, `security`, `pentest`
- **Why use it:** 87 specialized SKILL.md files for reverse engineering and authorized pentesting
...
- **Why use it:** Specialized agent skills for AI infrastructure development and optimization
...
- **Tags:** `agent-learning`, `skill-generator`, `automatic`
...
- **Why use it:** Ports popular Superpowers skills to the Reasonix coding harness
...
- **Why use it:** 25 ready-to-use engineering skills from 30B tokens, 10x dev efficiency
...
- **Tags:** `gongwen`, `ai-docs`, `skill`
- **Why use it:** Full workflow tool for official documents per GB/T 9704 national standard
...
- **Why use it:** Unified local agent skills loading and secure management in DSH
...
- **Tags:** `agent-skill`, `chinese-traditional-wisdom`, `bazi`, `fengshui`
- **Why use it:** Unique Bazi/Fengshui skill with local deterministic engine
...
- **Why use it:** Engineering discipline guard: verify requirements before shipping
...
- **Tags:** `math-modeling`, `competition`, `research`
- **Why use it:** Complete math modeling skill: preprocessing to paper writing
...
- **Tags:** `spec-driven`, `agent-skill`, `coding`
- **Why use it:** Repository-native spec-driven development with DSH engineering patterns
...
- **Tags:** `multi-agent`, `durable`, `memory`
- **Why use it:** Durable multi-agent with persistent memory across sessions and rollovers
...
- **Why use it:** Pixel-to-text OCR bridge enabling text-only models to read images
...
- **Tags:** `qa`, `testing`, `agent-skill`
- **Why use it:** 11 specialized QA skills with shared knowledge base for AI testing
...
- **Why use it:** 5-role math modeling agent with 33 model templates and visual progress
...
- **Tags:** `planning`, `agent-skill`, `collaboration`
- **Why use it:** Separates discussion from action for AI collaborative change tasks
...
- **Tags:** `ai-director`, `ai-video`, `deepseek-harness`
- **Why use it:** Integrates AI video/image/audio skills and configurable model tools
...
- **Why use it:** Maintains cross-session continuity memory between agents
...
- **Tags:** `code-simplification`, `codex`, `dsh-plugin`
- **Why use it:** Simplifies and refactors code via Codex-compatible skill
...
- **Why use it:** 152 shot recipe cards and Remotion templates for cinematic videos
...
- **Why use it:** Agent skill for developing DSH plugins; standard guidance for Claude Code and Codex.
...
- **Tags:** `agent-tools`, `workflow`, `capability-check`
- **Why use it:** Pre-flight plugin check for agents — auto-injects Top-K relevant plugins
...
- **Why use it:** Engineering workflow plugin with task stages, verification, commits and skills management
...
- **Why use it:** Open-source Figma alternative with AI design generation
...
- **Tags:** `diagrams`, `mermaid-alternative`
- **Why use it:** Generate beautiful architecture and sequence diagrams from text
...
- **Tags:** `design`, `vibecoding`, `agent-team`, `flutter`, `react`
- **Why use it:** AI-native vector design with concurrent agent teams and Design-as-Code.
...
- **Why use it:** AI-powered visual editor and PPT studio with template marketplace for design work.
...
- **Why use it:** Legal litigation visualization: timelines, case diagrams, court prep tools
...
- **Tags:** `data-visualization`, `token-usage`, `deepseek-api`
- **Why use it:** Web plugin showing real-time token usage, cost estimates, and API balance charts.
...
- **Tags:** `visual`, `cards`, `ui`, `design`
- **Why use it:** Transforms recent chat history into beautifully designed downloadable cards
...
- **Why use it:** Multi-browser extension enhancing all major AI chat platforms with unified prompt management.
...
- **Why use it:** Let AI agents control your logged-in browser seamlessly via CLI — powerful real-world automation.
...
- **Tags:** `content-discovery`, `ai-agent`, `bilibili`, `privacy-first`, `cross-platform`
- **Why use it:** Local-first cross-platform content discovery agent from Bilibili, YouTube, Xiaohongshu and more.
...
- **Why use it:** Free no-signup web search bridge for every model without native web access
...
- **Tags:** `browser-automation`, `anti-detect`, `fingerprint`, `playwright`
- **Why use it:** Persistent identity browser with fingerprint spoofing, unlimited local profiles
...
- **Why use it:** Tabbit Browser Playwright-based automation plugins for DeepSeek Harness
...
- **⭐ Stars:** 7
- **Language:** TypeScript
- **Description:** 给DSH接入���费的 Xiaomi MiMo TTS API，支持使用预置/自定义/浏览器内置声音朗读正文
- **Tags:** `tts`, `xiaomi-mimo`, `voice`
- **Why use it:** Free Xiaomi MiMo TTS API integration with custom and browser voices support.
...
- **Tags:** `mcp-server`, `resume-builder`
- **Why use it:** Privacy-first resume builder with MCP server integration
...
- **Why use it:** AI + low-code platform for fast business system development
...
- **Tags:** `routing`, `infrastructure`, `reasoning-mode`
- **Why use it:** Runtime injector with task-aware reasoning-mode router — optimizes agent decision routing.
...
- **Tags:** `preset`, `configuration`, `deepseek-harness`, `llm-agent`
...
- **Tags:** `multi-model`, `account-management`, `cli`, `routing`
- **Why use it:** Multi-model account manager with smart routing, quota tracking, and failover.
...
- **Tags:** `mcp`, `proxy`, `api-keys`, `registry`
- **Why use it:** OpenRouter-like registry for agent tools, MCP proxy, and credential management.
...
- **Tags:** `cli`, `plugin-manager`, `schemas`, `utility`
- **Why use it:** CLI and resolver for DSH Plugin Hub with open schemas and agent tooling
...
- **Why use it:** Auto-upgrades plugin skills as DSH version evolves
...
- **Tags:** `backup`, `config`, `restore`, `migration`, `mcp`
- **Why use it:** Full backup/restore for DSH config, plugins, MCP servers and skills via WebDAV
...
- **Tags:** `cordis`, `mcp`, `skills`, `utility`
- **Why use it:** Unified tool/skill exposure management reducing context usage with dynamic strategies
...
- **Why use it:** Plugin ecosystem infrastructure: browser console + official skill scaffolder
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories
...
- **Tags:** `deepseek-harness`, `container`, `utility`
- **Why use it:** Manages multiple isolated DSH instances with containerized setup
...
- **Why use it:** One-click MCP/skills/config sync across 8+ AI coding tools
...
- **Tags:** `migration`, `session-import`, `claude-code`
- **Why use it:** Four-source migration wizard for sessions, memories and skills
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `claude-code`, `codex`
- **Why use it:** Animated pet gallery adding personality to coding agents and terminals.
...
- **Tags:** `theme`, `glass-morphism`, `customizable`, `skin`
- **Why use it:** Glass-morphism theme with adjustable blur, frosted glass, and custom wallpapers
...
- **Why use it:** Dynamic ocean-themed UI with adjustable waves and glass effects
...
- **Tags:** `ui`, `theme`, `background`, `visual`
- **Why use it:** Customizable backgrounds with preset themes and fine-tuned visual controls
...
- **Tags:** `ai-guide`, `rag`, `prompt-library`
...
- **Tags:** `documentation`, `deepwiki`, `analysis`, `code-understanding`
...
- **Tags:** `plugin-registry`, `ecosystem-radar`, `validation`
- **Why use it:** Ecosystem radar scanning 21k+ plugins with k8s runtime validation.
...
- **Tags:** `awesome-list`, `curated`, `dsh-plugins`
...
- **Why use it:** All-in-one academic workbench: LaTeX, arXiv, experiment tracking, GPU SSH orchestration
...
- **Why use it:** Cross-database academic search with citation verification and graph tools
...
- **Tags:** `dsh-plugin`, `learning`
- **Why use it:** Great starting point for learning DSH principles and exploring plugins.
...
- **Tags:** `marketplace`, `catalog`, `plugins`
- **Why use it:** Massive 11,000+ plugin marketplace with search, rankings, and free API.
...
- **Tags:** `handbook`, `documentation`, `mcp`
- **Why use it:** Comprehensive handbook with 173 source-backed entries on runtime, plugins, MCP.
...
- **Why use it:** 1958-repo plugin catalog with bilingual search, filtering, and STAR sorting.
...
- **Tags:** `finance`, `data-source`, `mult-agent`
- **Why use it:** Local financial data source with multi-agent analysis and IM channel alerts.
...
- **Why use it:** Methodology skills for industry chain mapping and company research reports
...
- **Why use it:** Web search, content extraction, and research skills for AI agents
...
- **Why use it:** Patent infringement analysis system producing competitive reports
...
- **Tags:** `kline`, `deepseek-harness`, `sidebar`
- **Why use it:** Interactive K-line analysis with multi-market support and sidebar display
...
- **Why use it:** Curated plugin directory — essential starting point for discovering the DSH ecosystem.
...
- **Why use it:** Beginner-friendly tutorial from scratch — ideal for new DSH plugin developers.
...
- **Why use it:** Official DSH plugin marketplace with one-click install and browsing.
...
- **Tags:** `ai-writing`, `novel`, `worldbuilding`, `long-form-fiction`
- **Why use it:** Feature-rich AI novel writing software with worldbuilding and chapter management.
...
- **Why use it:** Daily-refreshed plugin marketplace with community sourcing and pre-publish review.
...
- **Why use it:** Curated bilingual plugin, extension, and tool awesome list for DeepSeek Harness
...
- **Tags:** `encyclopedia`, `ai-resources`, `knowledge-base`, `awesome-list`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, MLOps, and skill libraries
...
- **Why use it:** Daily-curated DSH plugin directory with real reviews and scene-based filtering
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCPs, and patches
...
- **Tags:** `awesome`, `awesome-list`, `official`
- **Why use it:** Official auto-generated awesome list curated by cordis.run
...
- **Why use it:** Curated list of DSH plugins covering productivity and functional tools
...
- **Tags:** `awesome-list`, `catalog`, `plugin`
...
- **Why use it:** Spam-filtered open-data registry and curated list of DSH plugins.
...
- **Why use it:** Public GitHub directory for discovering DSH plugins and ecosystem.
...
- **Tags:** `stock`, `quant`, `finance`, `awesome-list`
...
- **Why use it:** Curated DSH plugins: notifications, LLM traces, keybindings with built-in terminal.
...
- **Tags:** `awesome-list`, `plugin-registry`, `verified`
...
- **Tags:** `awesome-list`, `curated`, `plugin-list`
...
- **Why use it:** Curated DSH plugin ecosystem list covering CLI, web UI, and autonomous agents.
...
- **Why use it:** Comprehensive curated list of 1000+ DSH plugins ranked by stars
...
- **Why use it:** Plugin guide covering installation, permissions, compatibility and risks
...
- **Tags:** `marketplace`, `skills`, `plugin-store`
...
- **Tags:** `recommendation`, `ai-curated`, `awesome-list`
...
- **Tags:** `radar`, `awesome-list`, `evidence-backed`
...
- **Tags:** `curated`, `collection`, `official`
- **Why use it:** DSHA curated plugin collection for DeepSeek Harness users
...
- **Why use it:** Auto-generated bilingual plugin directory updated daily via GitHub Actions
...
- **Why use it:** In-agent plugin search across npm and awesome-dsh-plugin curated lists
...
- **Tags:** `dsh-plugins`, `repository`, `dsh-ecosystem`
- **Why use it:** DSH plugin repository and verification hub.
...
- **Tags:** `migrated`, `awesome-dsh-plugin`
- **Why use it:** Repository migrated — redirect to new URL.
...
- **Why use it:** Auto-updating bilingual plugin directory with YAML data.

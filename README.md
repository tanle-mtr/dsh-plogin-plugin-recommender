...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 839,780 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 16:33:06 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,384 | Core harness framework. Everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,661 | Open-source Claude-like design tool, local-first. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,982 | Multi-agent swarm orchestration with MCP. |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 25 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 19 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 12 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 38 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 4 plugins
- [Visual & Design](#visual-&-design) — 13 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 4 plugins
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 19 plugins
- [Themes & Skins](#themes-&-skins) — 5 plugins
- [Research & Analysis](#research-&-analysis) — 16 plugins
- [Other](#other) — 36 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (25)
- [UI & Desktop Extensions](ui-desktop-extensions) (19)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (12)
- [Agent Skills & Workflows](agent-skills-workflows) (38)
...
- [Research & Analysis](research-analysis) (16)
- [Other](other) (36)
---
...
- **Why use it:** Core harness framework. Everything is a plugin.
...
- **Tags:** `ai-agent`, `mcp`, `multi-agent`
- **Why use it:** Super AI assistant with memory, skills, self-evolve.
...
- **Tags:** `coding-agent`, `deepseek`, `tui`
...
- **Tags:** `harness-engineering`, `tutorial`, `beginner`
- **Why use it:** Best beginner tutorial from 0 to 1 for harness engineering.
...
- **Why use it:** Task-aware reasoning-mode router with injector for optimal agent routing.
...
- **Why use it:** Agent OS that gets smarter autonomously with loop-based self-improvement.
...
- **Tags:** `preset`, `bootstrap`, `standards`
- **Why use it:** Two-phase bootstrap preset aligning minimal init to full Standard toolset.
...
- **⭐ Stars:** 3,550
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本模型外挂视觉能力，粘贴图���即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `multimodal`
- **Why use it:** First vision plugin for text-only coding agents with structured JSON output.
...
- **Tags:** `deepseek-harness`, `claude-code`, `model-switch`
- **Why use it:** One-click model switch across major AI coding agents
...
- **Why use it:** Claude Code style TUI with whale bar and streaming status
...
- **Tags:** `agent-runtime`, `rust`, `desktop`
- **Why use it:** High-performance Rust agent runtime with polished desktop UI
...
- **Why use it:** AI code reviews based on 12 classic engineering books with citations
...
- **Tags:** `coding-agent`, `macos`, `swift`, `deepseek`
- **Why use it:** Official Swift-native macOS coding agent built by DeepSeek.
...
- **Tags:** `agent`, `skill`, `deepseek-harness`, `claude-code`
- **Why use it:** Orchestrates multiple coding agents into one collaborative team — powerful multi-agent setup.
...
- **Tags:** `ios`, `mobile-automation`, `mcp`, `ui-automation`
- **Why use it:** 22 agent tools for iOS Simulator and physical iPhone automation within DSH conversations.
...
- **Tags:** `coding`, `tdd`, `skills`
- **Why use it:** TDD, debugging, planning and collaboration coding skills
...
- **Tags:** `agent-skills`, `dsh-plugin`, `plugin-development`, `llm-agent`
- **Why use it:** Agent skill to develop DSH plugins following official standards
...
- **Tags:** `agent-skills`, `spec-programming`, `ai-coding`, `developer-tools`
- **Why use it:** Portable spec-driven development skill following DSH engineering patterns
...
- **Tags:** `agent-skill`, `plugin-development`, `knowledge-base`, `cli`
- **Why use it:** Official DSH plugin dev docs archive as on-demand agent skill (EN/ZH)
...
- **Tags:** `agent-framework`, `package-manager`, `cli`
- **Why use it:** Package manager with 42 skills, 5 CLIs and agent engineering tools
...
- **Tags:** `agent-skills`, `dsh-plugin`, `plugin-development`
- **Why use it:** Portable Agent Skill for building, auditing and testing DSH plugins with profile-installable adapter.
...
- **Tags:** `documentation`, `dsh-plugin`, `skill`
- **Why use it:** Practical DSH plugin dev knowledge base covering cordis, tsconfig, Windows junctions and zstd tricks.
...
- **Why use it:** Agent skills for scaffolding, building and testing DSH plugins entirely within the harness environment.
...
- **Tags:** `godot`, `game-development`, `dsh-plugin`
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH — GDScript support with runtime skill registration.
...
- **Tags:** `agent-tools`, `pre-flight`, `plugin-recommendation`
- **Why use it:** Pre-flight plugin check that injects top-K relevant plugins for tasks.
...
- **Tags:** `cordis-plugin`, `desktop`, `dsh-plugin`
- **Why use it:** Modern desktop client for DSH ecosystem.
...
- **Tags:** `web-ui`, `desktop`, `skins`
- **Why use it:** Web GUI with task boards, remote SSH, WebGL skins, and Wallpaper support.
...
- **Why use it:** Open sidebar foundation with file/terminal/Git/sub-agent pages
...
- **Tags:** `desktop`, `pet`, `mcp`, `typescript`
- **Why use it:** Local-first desktop companion with animated pets and plugin SDK.
...
- **Tags:** `desktop`, `tauri`, `cross-platform`, `ui`
- **Why use it:** Lightweight 5MB Tauri desktop app with preset plugins, cross-platform.
...
- **Tags:** `widget`, `ui`, `balloon`, `fun`
- **Why use it:** Cute floating whale widget tracking DeepSeek balance with animations.
...
- **Tags:** `desktop`, `electron`, `mcp`, `local-first`
- **Why use it:** Local AI desktop workspace integrating sessions, MCP, research, and plugins.
...
- **Tags:** `dsh-plugin`, `ui`, `interactive`
- **Why use it:** Interactive UI components rendered inline in assistant replies via dsh-ui fence.
...
- **Tags:** `desktop-app`, `electron`, `plugin-suite`
- **Why use it:** CodePilot-inspired desktop client with plugin suite, cross-platform support.
...
- **Why use it:** Canvas-based non-linear conversation workspace with branching.
...
- **Tags:** `desktop`, `electron`, `ssh`
- **Why use it:** Open-source Electron desktop app with SSH, skills, mobile remote access.
...
- **Tags:** `marketplace`, `ui`, `plugin`
- **Why use it:** One-click browse, install, update all DSH plugins in Web GUI
...
- **Tags:** `desktop-app`, `electron`, `typescript`, `dsh-plugin`
- **Why use it:** Electron desktop hub managing Harness/plugins/MCP/skills with multi-tab UI
...
- **Tags:** `ui`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Persistent bottom bar showing provider, model, live balance and peak/off-peak pricing with countdown.
...
- **Tags:** `agent`, `dsh-plugin`, `mcp`
- **Why use it:** Native WeShop Cordis plugin enabling infinite creative canvas with agentic skills and MCP tools.
...
- **Why use it:** Floating HUD panel showing git status, MCP servers, skills, and usage
...
- **⭐ Stars:** 9
- **Language:** Rust
- **Description:** StarHub 是一款跨平台桌面应用（Tauri 2 + Rust 主进�� + DeepSeek Harness React 工作台 + Go Sidecar），把开发运维日常高频工具整合到同一个窗口 —— 数据库、SSH/SFTP、Docker 面板与 AI 助手。目标是减少在 Navicat、Xshell、Portainer、文件管理器和 AI 对话窗口之间来回切换的成本。  前端架构：基于 DeepSeek Harness 原生 React 工作台（/starhub-react 路由）。资产、设置、SSH 终端、SFTP、数据库
- **Tags:** `desktop`, `tauri`, `docker`, `ssh`
- **Why use it:** Cross-platform Tauri desktop integrating DB, SSH, Docker and AI assistant
...
- **Why use it:** Self-evolving context database for agents.
...
- **Why use it:** LLM knowledge base with RAG and self-maintaining wiki.
...
- **Tags:** `dsh-bundle`, `ai-knowledge`, `rag`, `skills`
- **Why use it:** Comprehensive AI knowledge base covering agents, RAG, MLOps, and learning roadmaps.
...
- **Tags:** `notes`, `knowledge`, `smartisan`
- **Why use it:** Open-source smart notes app with Docker, multi-tenant and export.
...
- **Tags:** `memory`, `mcp`, `long-term`
- **Why use it:** Durable inspectable agent memory with recall tools
...
- **Tags:** `memory`, `skills`, `rag`
- **Why use it:** Turns SKILL.md files into retrieval-ready skill corpora
...
- **Tags:** `context-audit`, `ui`, `optimization`
- **Why use it:** Audits AGENTS.md token cost and detects context conflicts
...
- **Why use it:** Connects to PowerContext for persistent memory, recall, and skill handoff
...
- **Why use it:** Bridges Claude Code memory and skills into the DeepSeek Harness ecosystem
...
- **Tags:** `agentic-ai`, `multi-agent`, `mcp-server`
- **Why use it:** Multi-agent swarm orchestration with MCP.
...
- **Why use it:** Digital persona skill for personalized AI agents.
...
- **Tags:** `agent-orchestration`, `workspaces`, `multi-device`
- **Why use it:** Unify all agents and workspaces across devices with task tracking boards.
...
- **Why use it:** Enterprise multi-engine agent workspace with visual editor and team collab.
...
- **Why use it:** Cognitive enhancement skills based on J-space research
...
- **Tags:** `agent-framework`, `workflow-automation`, `multi-agent`
- **Why use it:** Intelligent workflow orchestration for local skills
...
- **Why use it:** Architecture-aware agent with drift checking and evidence verification.
...
- **Tags:** `vision`, `agent-skills`, `computer-use`, `multimodal`
...
- **Tags:** `task-manager`, `workflow`, `mcp`, `agent-rq`
- **Why use it:** Self-hosted human-in-the-loop task manager with mobile and web UIs.
...
- **Tags:** `browser-extension`, `workflow`, `productivity`, `prompt`
...
- **Tags:** `agent-teams`, `collaboration`, `workflow`, `multi-agent`
- **Why use it:** Enable multi-agent collaboration and coordinated task workflows.
...
- **Tags:** `vision`, `ocr`, `ui-restoration`, `agent-skills`
- **Why use it:** Native DSH vision toolkit for image Q&A, OCR, and UI restoration — free to use.
...
- **Tags:** `agent`, `mcp`, `desktop-app`, `tauri`
- **Why use it:** Local-first multi-model agent with self-evolving skills and privacy focus.
...
- **Why use it:** Turn AI coding experience into reusable repeatable execution skills.
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot/UI analysis.
...
- **Why use it:** Auto-search, install and verify GitHub DSH plugins via AI skill.
...
- **Tags:** `creative-writing`, `drama`, `skill`
- **Why use it:** Novel and short-drama writing toolkit powered by Oh Story skills.
...
- **Tags:** `skills`, `infra`
- **Why use it:** Specialized infra dev skills for high-performance systems
...
- **Tags:** `workflow`, `migration`, `session`
- **Why use it:** Cross-preset session migration with state preservation
...
- **Tags:** `skills`, `mcp`, `panel`
- **Why use it:** Skill and MCP management tool in Web UI panel
...
- **Why use it:** Superpowers skill port adapted for Reasonix coding harness
...
- **Why use it:** 85 skill files for reverse engineering and authorized pentesting
...
- **Why use it:** AI mentor that scans architecture, generates chapters, and does code review
...
- **Tags:** `image-reading`, `ocr`, `vision`, `pixel-art`, `dsh-plugin`
- **Why use it:** Pixel-to-text image reading and OCR tools for text-only LLM models
...
- **Tags:** `agent-handoff`, `session-memory`, `codex`
- **Why use it:** Enables cross-platform agent continuity and session recovery
...
- **Tags:** `code-simplification`, `agent-skill`, `codex`
- **Why use it:** Finds and simplifies redundant code patterns in projects
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer
...
- **⭐ Stars:** 21
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包�� DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `tcm`
- **Why use it:** Comprehensive Bazi/Fengshui/TCM agent skill with dashboard
...
- **Tags:** `skills-manager`, `dsh-plugin`
- **Why use it:** Centralized skills management plugin for DSH
...
- **Tags:** `vision`, `image-generation`, `media`
- **Why use it:** Free image reading and generation via multiple vision models
...
- **Tags:** `swift-cycle`, `governance`, `agent-skill`
- **Why use it:** Swift Cycle governance skill with offline verification
...
- **Tags:** `ai-docs`, `deepseek-harness-plugin`, `gongwen`
- **Why use it:** Full Chinese official document workflow: format check, content optimization, template generation per GB/T 9704.
...
- **Tags:** `agent-skill`, `dsh`
- **Why use it:** Distilled engineering discipline from DSH: fact-finding, durable decisions, evidence by surface principles.
...
- **Why use it:** Record macOS workflows and convert them into reusable agent skills
...
- **Why use it:** Paste JSON to connect MCP servers and manage skills with hot reload
...
- **Why use it:** Math modeling enhancement with 17 pre-built skill cards and presets
...
- **Why use it:** Virtual product team preset for guided AI conversations across roles.
...
- **Why use it:** Open-source Claude-like design tool, local-first.
...
- **Tags:** `agent-skills`, `architecture-diagram`, `mermaid`
- **Why use it:** Architecture diagramming skill with motion effects.
...
- **Why use it:** Industrial-grade image prompt templates with 470+ reverse-engineered cases.
...
- **Tags:** `design`, `vector`, `ui-generation`
...
- **Tags:** `video`, `generative-ai`, `ffmpeg`
- **Why use it:** Turns one topic into finished Vox-style paper-collage video
...
- **Tags:** `ai-design`, `ppt`, `prototyping`, `visual-editor`
- **Why use it:** AI-generated designs, PPT, and prototyping — powerful creative toolkit for DSH.
...
- **Tags:** `image-generation`, `seedream`, `visual`
- **Why use it:** Generate images directly in DeepSeek Harness chat via Seedream.
...
- **Tags:** `design`, `ppt`, `ui`
- **Why use it:** Edit .op documents directly in conversation UI
...
- **Tags:** `legal-tech`, `visualization`, `diagram`, `svg`, `agent-skills`
- **Why use it:** Legal litigation timeline and diagram visualization for lawyers
...
- **Why use it:** 6 design style presets to avoid generic AI-generated UI
...
- **Tags:** `kline`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Rich K-line charts with multi-market support and technical indicators directly in DSH sidebar.
...
- **Tags:** `ai-director`, `dsh-plugin`, `video-editing`
- **Why use it:** DirectorX AI video/image/audio generation skills with knowledge corpus and configurable model tools.
...
- **Tags:** `background`, `theme`, `webui`, `personalization`
- **Why use it:** Web UI background personalization with image upload and preset themes
...
- **Why use it:** Browser extension for AI chat enhancement + prompt mgmt.
...
- **Why use it:** Let AI agents use your real logged-in browser without interruption
...
- **Why use it:** Direct browser control without vision; Chrome sidebar is practical and versatile.
...
- **Why use it:** Playwright-based browser automation plugins for DSH
...
- **Tags:** `image`, `electron`, `cloud-storage`
- **Why use it:** Ultimate image uploader with 60+ cloud services.
...
- **Why use it:** Built-in plugin marketplace for browsing and one-click install
...
- **Why use it:** Plugin radar with 9000+ candidates and curated Top 50 list
...
- **Tags:** `context`, `utility`, `dashboard`, `insights`
- **Why use it:** Context dashboard and management with statistics and browser integration.
...
- **Why use it:** OAuth integration for ChatGPT/Claude/Grok subscriptions as DSH LLM providers.
...
- **Tags:** `cost-tracking`, `token`, `utility`
- **Why use it:** Track session/daily costs, budget limits, and token usage in DSH.
...
- **Tags:** `backup`, `utility`, `windows`
- **Why use it:** Crash-rescue with undo, snapshots, SAFE MODE, offline CLI
...
- **Tags:** `taskboard`, `utility`, `sqlite`
- **Why use it:** SQLite-backed taskboard with native Web UI, no iframe
...
- **Tags:** `console`, `plugin-management`, `ui`, `dsh-repository-plugin`
- **Why use it:** Plugin management console + official dev skill scaffold for DSH ecosystem
...
- **Tags:** `agent-skill`, `plugin-development`, `cli`, `dsh-plugin`
- **Why use it:** Manage installed DSH plugins, slots, Typert remotes and credentials
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `container`, `desktop-app`
...
- **Tags:** `backup`, `config-manager`, `dsh-plugin`
- **Why use it:** Essential backup/restore tool for complete DSH config, plugins, MCPs and skills with WebDAV sync.
...
- **Why use it:** Fast, simple Neovim plugin manager written in Lua — ideal for lightweight plugin lifecycle management.
...
- **Tags:** `capability`, `mcp`, `management`
- **Why use it:** Centralized menu to manage MCP tool exposure and execution modes
...
- **Why use it:** Built-in GUI plugin manager with hot-reload, no restart needed
...
- **Why use it:** Real-time token usage tracking, cost estimation, and API balance charts
...
- **Tags:** `utility`, `conflict-resolution`, `health`
- **Why use it:** Detects and resolves plugin version conflicts in DSH.
...
- **Why use it:** Search npm and curated lists directly inside DSH agents.
...
- **Tags:** `mascot`, `pets`, `skins`
- **Why use it:** Public animated pet mascot gallery for multiple AI agent platforms.
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** Whale Girl themed skins for DeepSeek Harness UI
...
- **Tags:** `theme`, `ui`, `deepseek-harness-plugin`
- **Why use it:** Fully customizable frosted glass theme, highly aesthetic and source-preserving.
...
- **Tags:** `theme`, `webgpu`, `dsh-plugin`
- **Why use it:** WebGPU-powered ocean-themed visual skin for DeepSeek Harness UI.
...
- **Tags:** `theme`, `dsh-plugin`, `skins`
- **Why use it:** One-click swap to 34 opencode themes (tokyonight, dracula, gruvbox) with persistence across restarts.
...
- **Tags:** `ai-agent`, `content-discovery`, `cross-platform`
- **Why use it:** Cross-platform AI content discovery from 8+ Chinese platforms
...
- **Why use it:** Auto-searches 8 major Chinese platforms, generates cited reports
...
- **Why use it:** Strongest free web search bridge for models lacking native web access, no signup needed.
...
- **Tags:** `research`, `awesome-list`
- **Why use it:** Awesome curated list of DSH plugins and resources
...
- **Tags:** `research`, `awesome-list`
- **Why use it:** Curated list of DSH plugins, extensions and dev resources
...
- **Tags:** `api-documentation`, `chinese-api`, `ai-agents`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `deep-research`, `marketing-automation`, `social-listening`
- **Why use it:** 88 open-source agent skills for research, social intelligence and marketing
...
- **Tags:** `awesome-list`, `curated-list`, `plugin`
- **Why use it:** Curated 2026 plugin list with quality checks for DSH.
...
- **Tags:** `awesome-list`, `directory`, `guide`
- **Why use it:** Plugin guide with scenario-based discovery and risk info.
...
- **Tags:** `awesome-list`, `plugin-registry`, `evidence`
...
- **Tags:** `portal`, `static-site`, `plugin-discovery`
- **Why use it:** Zero-dependency static portal for discovering and installing DSH plugins.
...
- **Why use it:** Original awesome-dsh-plugins list, now moved elsewhere.
...
- **Tags:** `awesome-list`, `bilingual`, `evidence`
- **Why use it:** Bilingual evidence-led plugin directory with immutable reviews.
...
- **Tags:** `awesome-list`, `automated`, `directory`
- **Why use it:** Auto-crawled daily bilingual DSH plugin directory via GitHub Actions.
...
- **Tags:** `agent-skills`, `resume-builder`, `self-hosted`
- **Why use it:** Privacy-first, free resume builder.
...
- **Tags:** `low-code`, `no-code`, `crm`
- **Why use it:** AI-powered no-code platform for business systems.
...
- **Why use it:** Comprehensive AI resource hub and vibe coding tutorial.
...
- **Why use it:** Curated master list of all DSH plugins — essential discovery resource.
...
- **Tags:** `toy`, `simulation`, `lightweight`
- **Why use it:** Traditional Chinese toy simulation, zero dependencies
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `curated`
- **Why use it:** Curated plugin ecosystem list for DeepSeek Harness community.
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools, and infrastructure.
...
- **Tags:** `awesome-list`, `bilingual`, `plugins`
- **Why use it:** Curated bilingual plugin list and resource hub — essential reference for DSH users.
...
- **⭐ Stars:** 268
- **Language:** JavaScript
- **Description:** 用 30 秒为你的 DeepSeek Harness找到合适的插件。 仓库由脚本每天自动抓取，再经人���逐个核实——真插件进目录，蹭热度的进黑名单，每条剔除理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **Tags:** `awesome-list`, `plugin-discovery`, `verified`
- **Why use it:** Daily auto-scraped, human-verified plugin discovery with blacklist for fake entries.
...
- **Tags:** `dsh-plugin`, `documentation`, `best-practices`
- **Why use it:** Learning resource covering DSH internals, plugin marketplace, and best practices.
...
- **Tags:** `awesome-list`, `guide`, `plugins`
- **Why use it:** Ultimate guide with quickstart, curated plugins, and toolkit for DSH newcomers.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `catalog`
- **Why use it:** Curated directory of DSH plugins, skills, MCP servers and patches.
...
- **Tags:** `marketplace`, `catalog`, `registry`
- **Why use it:** 3100+ plugin marketplace with search, rankings and public API.
...
- **Tags:** `plugins`, `marketplace`, `bundle`
- **Why use it:** Plugin bundle and marketplace collection for DeepSeek Harness.
...
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet links.
...
- **Why use it:** Community-curated DSH plugin catalog auto-synced every 4 hours
...
- **⭐ Stars:** 42
- **Language:** JavaScript
- **Description:** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选维��的 DeepSeek Harness Cordis 插件官方自动生成列表。
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness`, `plugin-marketplace`
...
- **Tags:** `awesome-list`, `dsh-plugins`, `plugin-catalog`
...
- **Tags:** `community`, `oauth`, `photo`
- **Why use it:** Community polaroid photo wall with GitHub OAuth auth
...
- **Why use it:** Public GitHub directory and curated list for DSH plugin discovery with install commands.
...
- **⭐ Stars:** 12
- **Language:** Shell
- **Description:** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness 插件���表
- **Tags:** `awesome`, `dsh-plugin`
- **Why use it:** Curated collection of DSH plugins with selection descriptions for ecosystem exploration.
...
- **Why use it:** Unofficial community catalog for discovering DSH plugins
...
- **Why use it:** Curated, evidence-led directory with verified and permission-aware plugins
...
- **Tags:** `registry`, `open-data`, `curated`
...
- **Tags:** `stock`, `finance`, `quant`, `catalog`
- **Why use it:** Curated stock/finance/quant vertical plugin catalog with 24 verified entries
...
- **Why use it:** AI-curated plugin list updated hourly with 190+ entries
...
- **Why use it:** DSH plugin repository and verification listing
...
- **Why use it:** Simple DSH plugin collection resource
...
- **Tags:** `awesome-list`, `curated`, `registry`
- **Why use it:** Curated directory covering models, tools, sandboxes, UI, and agent loops
...
- **Tags:** `awesome-list`, `industry`, `directory`
- **Why use it:** Industry-specific plugin directory for computing, finance, law, healthcare etc.
...
- **Why use it:** Merges multiple sources into one deduplicated plugin registry
...
- **Why use it:** Official auto-generated Cordis plugins listing curated by cordis.run
...
- **Why use it:** CLI tool to discover, install, update and audit DSH plugins
...
- **Why use it:** Full catalog of 1000+ DSH tools sorted by stars from GitHub topic
...
- **Tags:** `publisher`, `plugin-tool`
- **Why use it:** One-click publish tool for validating, documenting and listing plugins

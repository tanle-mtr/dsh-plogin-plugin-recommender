...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,077,298 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-21 23:58:42 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 232,297 | Core plugin framework powering the entire DSH ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,471 | Local-first design system tool powered by AI agent |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,003 | Deploy multi-agent swarms with autonomous coordina |
...
- **Why use it:** Local-first design system tool powered by AI agents.
...
- **Tags:** `browser-extension`, `chat-enhancement`, `multi-platform`
- **Why use it:** All-in-one browser extension enhancing major AI chat platforms
...
- **Why use it:** Official desktop client bringing DSH to your local machine
...
- **Tags:** `sidebar`, `ui`, `terminal`, `git`, `file-editor`
...
- **Tags:** `taskboard`, `ui`, `codex-plugin`, `workflow`, `productivity`
- **Why use it:** Modern flexible task board that embeds into Codex and DeepSeek Harness workspaces
...
- **Tags:** `tui`, `terminal`, `status`, `dsh-plugin`, `ui`
- **Why use it:** TUI companion with whale bar, live status, streaming thoughts, and context progress
...
- **Tags:** `floating-widget`, `ui`, `balance-monitor`
...
- **Why use it:** Lightweight Tauri desktop version with preset plugins, zero setup
...
- **Why use it:** Interactive UI components rendered inline in assistant replies
...
- **Tags:** `conversation`, `canvas`, `workspace`, `non-linear`
...
- **Tags:** `desktop-app`, `desktop-automation`, `multi-model`, `privacy`
...
- **Tags:** `ios`, `android`, `mobile-app`, `kmp`
- **Why use it:** Native iOS/Android client with WebSocket sync for workspaces, sessions and agent trails
...
- **Why use it:** Embed live iOS Simulator and USB iPhone directly in conversation with 22 agent automation tools
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI panel for managing skills and MCP servers directly in the browser
...
- **Why use it:** Desktop console with multi-tab management for Harness/Plugin/MCP/Skills.
...
- **Tags:** `dsh-plugin`, `workbench`, `plugin-system`, `skills`
...
- **Tags:** `ui-extension`, `status-bar`, `info-display`
- **Why use it:** Persistent bottom bar showing provider/model, live balance, pricing with countdown.
...
- **Tags:** `context`, `ui-tool`, `audit`
- **Why use it:** Context audit tool: visualize token cost, detect duplicates/conflicts via web UI ring panel.
...
- **Why use it:** WorkBuddy-style skill picker that inserts slash commands into composer
...
- **Why use it:** Electron desktop with integrated DSH web services
...
- **Tags:** `dsh-plugin`, `ui`
- **Why use it:** One-click compact toggle for DSH context meter panel
...
- **Tags:** `memory`, `rag`, `long-term-memory`, `local-first`
- **Why use it:** Portable, user-owned memory layer with Markdown-native RAG support
...
- **Why use it:** Specialized memory library for building persistent stateful agents
...
- **Tags:** `memory`, `rag`, `knowledge`, `agent-skills`, `scope`
- **Why use it:** Memory management kit enabling agents to remember, refine, and retrieve knowledge
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus embeddings
...
- **Tags:** `agent-memory`, `skill-md`, `embeddings`, `vector-search`
...
- **Why use it:** Proactive associative memory with auto-consolidation before model speaks.
...
- **Why use it:** Deploy multi-agent swarms with autonomous coordination.
...
- **Tags:** `agent-workspace`, `orchestration`, `multi-device`
...
- **Why use it:** Long-form web novel writing assistant solving AI forgetfulness
...
- **Why use it:** Largest skills marketplace with auto-crawled GitHub skill repositories
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `multimodal`, `agent-skills`
- **Why use it:** First vision plugin bridging text-only agents with image understanding via OCR
...
- **Tags:** `skills`, `routing`, `workflow`, `orchestration`, `vibe-coding`
- **Why use it:** Intelligent skill routing and workflow orchestration with 21pp reward improvement
...
- **Tags:** `agent-skills`, `deep-reasoning`, `cognitive-enhancement`
- **Why use it:** Inference-time control for deep reasoning and long-horizon agent tasks
...
- **Why use it:** Enables multi-agent team coordination and collaborative workflows
...
- **Tags:** `novel-writing`, `creative`, `rag`
- **Why use it:** Organized long-form fiction pipeline with worldbuilding and local Ollama support
...
- **Tags:** `novel-writing`, `creative-writing`, `workflows`, `screenwriting`
- **Why use it:** Novel, short-drama, game, and video-writing workflow workbench plugin
...
- **Tags:** `agent-observability`, `multimodal`, `video-analysis`, `ocr`
- **Why use it:** Gives AI agents visual and audio sensing with verified, timestamped evidence
...
- **Why use it:** Introduces the Epistemic Loop framework for automated scientific discovery in agents
...
- **Tags:** `dsh-plugin`, `agent-review`
- **Why use it:** Composable, reviewable agent modes enabling self-evolution
...
- **Why use it:** Turn experience into repeatable execution across AI tools
...
- **Why use it:** 87 specialized reverse-engineering and pentesting skills for CTF and security research
...
- **Why use it:** Specialized skills for AI infrastructure development and high-performance system debugging
...
- **Tags:** `upgrade`, `dsh-plugin`
- **Why use it:** Automates plugin upgrades alongside DSH version updates
...
- **Why use it:** Converts successful agent sessions into reusable reviewable skills automatically
...
- **Why use it:** Port of popular Superpowers skills to the Reasonix coding harness
...
- **Why use it:** Adapted Superpowers skills for DSH: TDD, debugging, planning, collaboration
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `agent`
...
- **Why use it:** 25 pre-built engineering skills with 10x dev efficiency boost.
...
- **Tags:** `agent-skills`, `mcp`, `web-search`, `dsh-plugin`
- **Why use it:** Web search, research and finance skills for cross-agent platforms.
...
- **Tags:** `dsh-plugin`, `gongwen`, `docx`, `ai-docs`
- **Why use it:** Complete Chinese official document workflow: format check, optimization, templates.
...
- **Tags:** `agent-skill`, `tradition-wisdom`, `dashboard`
- **Why use it:** Unique Bazi/Fengshui/TCM agent skill with local deterministic engine and visual dashboard.
...
- **Why use it:** Official DSH plugin dev knowledge base as an on-demand agent skill with EN/ZH docs.
...
- **Why use it:** Repository-native spec-driven development agent skill, inspired by DeepSeek Harness patterns.
...
- **Why use it:** Engineering discipline guard: grill requirements, test implementation, prove delivery before ship.
...
- **Why use it:** Comprehensive math modeling skill suite: data preprocessing, programming, paper writing, visualization.
...
- **Why use it:** Durable multi-agent teams with persistent memory, notes, and skills across sessions and roll overs.
...
- **Why use it:** 11 QA agent skills with shared knowledge base for AI-driven test automation and case writing.
...
- **Why use it:** Separates discussion from execution: structured plan-first mechanism for AI collaborative tasks.
...
- **Tags:** `skillhub`, `official`
- **Why use it:** Official SkillHub documentation and examples for DeepSeek Harness
...
- **Why use it:** Multi-agent math modeling solver with 33 models and thesis templates
...
- **Why use it:** Agent skill for building DSH plugins with standards
...
- **Why use it:** Adds Command Code model provider with live catalog, plan-aware selection and reasoning
...
- **Why use it:** Local finance DB with Tushare, auto-generates HTTP and MCP interfaces
...
- **Why use it:** One-click MCP/Skills/rules config sync across 7+ AI coding tools
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `deepseek-harness`
- **Why use it:** Access ChatGPT models via OAuth directly in DSH
...
- **Why use it:** 530+ image generation prompts with reusable skills and templates.
...
- **Tags:** `design`, `vector`, `agent-teams`, `flutter`, `react`
- **Why use it:** AI-native vector design with concurrent Agent Teams for Design-as-Code workflow
...
- **Why use it:** AI-powered design studio with template marketplace and native PPT support
...
- **Why use it:** Legal visualization toolkit: timelines, court battle diagrams, relationship maps.
...
- **Why use it:** Pixel-to-text OCR skill enabling text-only models to read images, with 34-image trained method.
...
- **Tags:** `ai-video`, `ai-image`, `media`
- **Why use it:** AI video/image/audio creation toolkit with vision and media model support
...
- **Why use it:** Seamless real-browser automation for AI agents without interruption
...
- **Tags:** `browser`, `content-discovery`, `bilibili`, `youtube`, `privacy`
- **Why use it:** Cross-platform AI content discovery agent for Bilibili, YouTube, Reddit, Zhihu and more
...
- **Why use it:** Strongest free web search bridge for any model without API or signup
...
- **Tags:** `browser-automation`, `playwright`, `anti-detect`, `mcp-server`
- **Why use it:** Persistent browser identity with fingerprint spoofing and Playwright automation
...
- **Why use it:** Tabbit Browser integration with Playwright for DSH web automation
...
- **Tags:** `web`, `plugin-marketplace`, `ecosystem`
- **Why use it:** Web-based plugin marketplace ecosystem for DSH distribution
...
- **Tags:** `marketplace`, `dsh-plugin`, `installer`
...
- **Tags:** `routing`, `quota`, `failover`, `multi-model`, `utility`
- **Why use it:** Multi-model smart routing with quota tracking, priority management and auto failover
...
- **Why use it:** Comprehensive context insight dashboard, browser and sidebar management
...
- **Tags:** `cybersecurity`, `ai-security`, `redteam`, `vulnerabilities`
- **Why use it:** AI code audit platform detecting hallucinated packages and security flaws
...
- **Tags:** `cli`, `plugin-manager`, `typescript`, `hub`
- **Why use it:** Open-source CLI for DSH Plugin Hub management and resolver
...
- **Tags:** `office`, `spreadsheet`, `document`, `productivity`
...
- **Tags:** `llm-provider`, `oauth`, `subscription`, `multi-model`
- **Why use it:** Use ChatGPT, Claude, and Grok subscriptions as LLM providers without API keys via OAuth
...
- **Why use it:** Native local task management with SQLite projects, agent claim/review and clean Web UI
...
- **Why use it:** Track session and daily costs, budgets, and token usage across multiple LLM providers
...
- **Why use it:** Massive plugin marketplace with 11,000+ plugins and search API
...
- **Tags:** `directory`, `marketplace`, `dsh-plugin`
- **Why use it:** Extensive DSH plugin catalog with 1958 repos and bilingual search
...
- **Why use it:** Open-source Smartisan notes clone with Docker deploy, skill support, and multi-tenant
...
- **Tags:** `dsh-plugin`, `mcp`, `skills`, `cordis`
- **Why use it:** Unified tool/skill management with dynamic exposure strategies.
...
- **Tags:** `container`, `multi-version`, `tooling`
...
- **Tags:** `utility`, `conflict-resolution`, `plugin`
...
- **Tags:** `mascot`, `pixel-art`, `animated`, `cli`, `theme`
- **Why use it:** Public gallery of animated pet mascots for coding agents and CLI tools
...
- **Tags:** `theme`, `glassmorphism`, `desktop`, `customizable`
- **Why use it:** Glassmorphism desktop theme with fully customizable blur and wallpaper
...
- **Tags:** `animated-background`, `theme`, `glassmorphism`, `ocean`
- **Why use it:** Beautiful animated ocean theme with adjustable waves, sunset effects and glassmorphism
...
- **Why use it:** Customize DSH Web UI background with images or presets
...
- **Why use it:** Comprehensive AI resource hub and vibe coding tutorial guide.
...
- **Tags:** `documentation`, `wiki`, `code-analysis`, `ai-context`, `research`
- **Why use it:** Turns codebases into structured technical docs and AI-ready context for agents and teams
...
- **Why use it:** Curated bilingual DSH plugin and tool reference list
...
- **⭐ Stars:** 536
- **Language:** TypeScript
- **Description:** Mimir — 一站式科研工作台插件：LaTeX 论���边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the whole research cycle.
- **Tags:** `research-tools`, `latex`, `arxiv`, `gpu-cluster`
- **Why use it:** All-in-one Chinese research workbench: LaTeX, arXiv, SSH, GPU tracking
...
- **Why use it:** Comprehensive Chinese AI resource encyclopedia and one-stop dev navigation
...
- **Why use it:** Daily-curated plugin discovery list with real verification, categorized by scenario
...
- **Why use it:** Ultimate DeepSeek Harness guide with quickstart, curated plugins and practical toolkit
...
- **Why use it:** Powerful academic search with cross-source dedup and citation graph
...
- **Why use it:** Industry research methodology, chain mapping, and company analysis skill pack
...
- **Why use it:** Comprehensive curated list of DSH plugins covering productivity and tools
...
- **Tags:** `dsh-plugin`, `patent`, `rag`, `legal-tech`
- **Why use it:** Patent infringement analysis generating competitor reports from patent IDs.
...
- **Why use it:** Interactive K-line analysis with technical indicators and market data in sidebar
...
- **Why use it:** Open-data registry with spam filtering for plugins
...
- **Tags:** `awesome-list`, `enhancement`, `terminal`
- **Why use it:** Curated plugins with notifications and trace inspection
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** Evidence-led curated directory with quality guidance
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** 2026 curated list with quality checks
...
- **Why use it:** Ecosystem radar discovering and validating 21k+ DSH plugins continuously
...
- **Why use it:** Comprehensive DSH plugin marketplace with daily refresh and pre-review
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories, a must-have discovery hub.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Comprehensive DSH plugin catalog sorted by stars
...
- **Tags:** `dsh-plugin`
- **Why use it:** DSHA精选插件合集，适合DASHA用户参考
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Daily automated GitHub Actions crawled plugin directory
...
- **Why use it:** Search and browse DSH plugins directly from inside agents
...
- **Why use it:** DSH plugin collection with ecosystem resources
...
- **Tags:** `awesome-list`, `repository`, `deepseek-harness`
- **Why use it:** Moved — redirected to new repo location
...
- **Tags:** `awesome-list`, `bilingual`, `auto-updating`, `dsh-plugins`
...
- **Tags:** `awesome-list`, `curated`, `dsh-plugins`, `ui`, `skills`
- **Why use it:** Curated DSH plugins covering models, tools, UI and agent loops

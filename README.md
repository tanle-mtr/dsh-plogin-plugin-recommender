...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 873,525 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 11:40:13 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 196,918 | Core DSH platform; everything is a plugin architec |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,639 | Local-first AI design tool with coding agent integ |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,439 | Multi-agent swarm harness with autonomous workflow |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 50 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (50)
...
- **Why use it:** Open-source super assistant with self-evolving memory.
...
- **Why use it:** Terminal-native AI coding agent with R1 prefix-cache stability.
...
- **Tags:** `code-review`, `code-quality`, `architecture`
...
- **Tags:** `coding-agent`, `architecture`, `baseline`
- **Why use it:** Architecture-aware coding with baseline-first safety checks
...
- **Why use it:** Build, run, and interact with live Android emulator or USB device from conversation
...
- **Tags:** `plugin-dev`, `skills`, `tools`, `developer`
...
- **Tags:** `plugin-dev`, `harness`
- **Why use it:** Build custom DSH plugins with slots and credentials support.
...
- **Tags:** `skills`, `manager`
- **Why use it:** Manage and organize DSH skills efficiently.
...
- **Why use it:** Seamlessly migrate Claude Code configs to DSH
...
- **Why use it:** Lightweight 5MB desktop app, zero setup required
...
- **Tags:** `desktop`, `companion`, `pet`, `electron`
...
- **Tags:** `electron`, `desktop`, `ui`, `plugin-management`
- **Why use it:** Electron desktop console managing Harness/Plugin/MCP/Skills in multi-tab UI
...
- **Tags:** `visualization`, `token-usage`, `dashboard`
- **Why use it:** Real-time token cost dashboard via web plugin
...
- **Why use it:** Electron desktop shell wrapping DSH web + sidebar
...
- **Why use it:** Open-source LLM knowledge platform with RAG and wiki features.
...
- **Tags:** `memory`, `rag`, `local-first`, `portable`, `agent-memory`
...
- **Tags:** `memory`, `self-evolving`, `token-savings`, `hybrid-retrieval`
...
- **Why use it:** Unlimited memory solution for long-running agent sessions
...
- **Why use it:** Turns SKILL.md files into curated retrieval-ready skill corpora
...
- **Why use it:** Durable long-term agent memory with inspectable storage, recall tools, and settings page
...
- **Tags:** `knowledge`, `docs`
- **Why use it:** Official DSH docs knowledge base as on-demand agent skill.
...
- **Why use it:** All-in-one agent workspace with task tracking across devices
...
- **Tags:** `agent-os`, `self-improving`, `loop-engineering`, `grading`
- **Why use it:** Self-improving agent OS with grading command and loop engineering
...
- **Tags:** `enterprise`, `multi-agent`, `workbench`, `collaboration`
- **Why use it:** Enterprise multi-engine agent workbench with unified workspace
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `multimodal`, `first`
- **Why use it:** First vision plugin: OCR image-to-JSON evidence for text-only agents
...
- **Why use it:** Intelligently orchestrates harness workflows and routes local skills
...
- **Why use it:** Automated Vox-style video generation from a single topic using ffmpeg and TTS
...
- **Tags:** `creative-writing`, `fiction`, `drama-skills`
...
- **Tags:** `agent-skills`, `multi-agent`, `framework`
- **Why use it:** Framework to turn experience into repeatable agent executions
...
- **Tags:** `task-management`, `agent`, `webui`
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and pure Web UI — no iframe
...
- **Why use it:** Structured agent workflow orchestration for complex multi-step DSH tasks
...
- **Why use it:** TDD/debugging/planning skills adapted from obra superpowers for DSH
...
- **Why use it:** Superpowers skill port to Reasonix coding harness for AI agents
...
- **Tags:** `skills`, `pentest`, `reverse-engineering`, `security`
...
- **Tags:** `skills`, `mentor`, `education`, `coding`
...
- **Tags:** `skills`, `research`, `marketing`, `multi-agent`
- **Why use it:** 88 cross-platform agent skills for research, marketing and business
...
- **Tags:** `spec-driven`, `skills`, `development`, `workflow`
...
- **Why use it:** Chinese metaphysics AI skill with Bazi, Fengshui, I Ching analysis.
...
- **Why use it:** Multi-agent team collaboration with shared workspace and independent configs.
...
- **Why use it:** Codex skill for automatic code simplification adapted from DSH.
...
- **Why use it:** Swift Cycle governance skill for structured project management.
...
- **⭐ Stars:** 18
- **Language:** JavaScript
- **Description:** 拨开迷雾看见终点，剩下的交给��务栏。Part the fog, see the end — the task bar handles the rest. 🎮 mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A game-like mission system for Matt Pocock skills in DeepSeek Harness. More by @FeatherHunter: 🎨 dsh-opencode-palette · ⚡ dsh-prompt
- **Tags:** `skills`, `mission`, `gamification`
- **Why use it:** Game-like mission system makes DSH task workflow engaging.
...
- **⭐ Stars:** 18
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生���持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese`
...
- **Why use it:** Image reading and generation skills with vision transcription.
...
- **Why use it:** AI video/image/audio creation skills via DirectorX integration.
...
- **Why use it:** Infinite canvas with agentic creative workflow skills
...
- **Why use it:** Portable skill encoding proven engineering discipline
...
- **Why use it:** Skills for building and testing DSH plugins internally
...
- **Why use it:** Virtual product team agent preset for end-to-end workflows
...
- **Tags:** `agent-tools`, `checklist`, `capabilities`
- **Why use it:** Pre-flight plugin check for predictable agent capabilities
...
- **Why use it:** Web UI panel for managing skills and MCP servers — unified configuration dashboard
...
- **Why use it:** Hot-reload MCP config via UI, no restart needed
...
- **Why use it:** OAuth integration to use ChatGPT models within DSH
...
- **Why use it:** Cross-browser enhancement suite for Gemini, Claude & ChatGPT.
...
- **Why use it:** Real browser automation for AI agents with login persistence
...
- **Why use it:** Browser extension turning AI conversations into reusable workflows
...
- **Why use it:** Playwright-based browser automation plugins for web interaction and scraping workflows
...
- **Tags:** `router`, `injector`, `infrastructure`, `preset`
- **Why use it:** Runtime injector and task-aware reasoning-mode router preset kit
...
- **Tags:** `bootstrap`, `preset`, `standard-tools`, `infrastructure`
- **Why use it:** Two-phase minimal-aligned bootstrap preset with standard tools
...
- **Tags:** `vfs`, `virtual-filesystem`, `fuse`, `infrastructure`, `unified`
- **Why use it:** Unified virtual filesystem for AI agents across languages and platforms
...
- **Tags:** `dsh-plugin`, `model-switch`, `multi-agent`
...
- **Why use it:** Built-in plugin marketplace for browsing, searching, and one-click installing
...
- **Why use it:** Plugin marketplace with 3,100+ plugins, search and install
...
- **Why use it:** Search, install and verify GitHub plugins directly in DSH
...
- **Why use it:** Smartisan-style notes with Docker deployment, skill calling, and image export
...
- **⭐ Stars:** 146
- **Language:** JavaScript
- **Description:** DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与���新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI
...
- **Why use it:** Cross-preset session migration with fixed-schema handoffs preserving state and intent
...
- **Why use it:** Crash-rescue with undo config/plugin changes, secret-safe snapshots, and SAFE MODE
...
- **Why use it:** Community plugin market integrated into DSH Web GUI with one-click install/uninstall
...
- **Why use it:** Auto-syncing plugin catalog maintained every 4 hours by community
...
- **Tags:** `awesome-list`, `official`, `plugins`
...
- **Why use it:** Browser console for plugin management + official dev skill guide
...
- **Tags:** `ocr`, `image`, `vision`, `tools`
- **Why use it:** Pixel-to-text image reading with OCR for text-only LLM models
...
- **Tags:** `package`, `skills`, `database`
- **Why use it:** Package manager with 42 skills, 5 CLIs, and database tools.
...
- **Why use it:** Spam-filtered plugin registry with open data verification
...
- **Why use it:** Curated plugin directory with permission-aware installation guide
...
- **Why use it:** Community-curated useful plugin collection
...
- **Why use it:** Static web portal for plugin discovery and installation
...
- **Why use it:** Comprehensive curated resource for plugins, tools & skills
...
- **Tags:** `repository`, `verification`, `plugins`
...
- **Tags:** `awesome-list`, `2origin`, `plugin-registry`
- **Why use it:** Plugin radar with 2Origin lab integrations
...
- **Why use it:** Built-in plugin search for DSH agents
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ tools catalog sorted by popularity
...
- **Why use it:** AI-curated hourly-updated plugin recommendations
...
- **Why use it:** Redirect to official awesome-dsh-plugin registry
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Simple DSH plugin collection list
...
- **Why use it:** Evidence-aware curated plugin shortlist
...
- **Tags:** `registry`, `curated-list`, `ui`
- **Why use it:** Install, extend models, tools, sandboxes and UI
...
- **Tags:** `pixel-art`, `mascot`, `gallery`, `themes`, `skins`
- **Why use it:** Public gallery of animated pixel-art pets as agent companion themes
...
- **Tags:** `theme`, `skin`, `color`
- **Why use it:** 34 opencode themes with one-click switch, no config loss.
...
- **Tags:** `webui`, `themes`, `personalization`
- **Why use it:** Web background personalization with preset atmospheres
...
- **Tags:** `ai-guide`, `prompt-library`, `tutorials`
- **Why use it:** Comprehensive AI resource guide with tutorials and prompt collections.
...
- **Why use it:** Searches 8 major Chinese platforms for last 30 days and generates citable reports
...
- **Tags:** `api`, `documentation`, `chinese-platforms`, `search`
- **Why use it:** Search 65,600+ Chinese platform API docs across multiple coding tools
...
- **Tags:** `finance`, `kline`
- **Why use it:** Interactive K-line stock analysis with multi-market and technical indicators.
...
- **Why use it:** Zhihu search and Zhida ask via MCP for Chinese knowledge retrieval.
...
- **Why use it:** Curated stock/finance/quant plugins for financial research
...
- **Tags:** `industry`, `curated-list`
- **Why use it:** Industry-specific plugins for finance, legal, healthcare
...
- **Tags:** `tutorial`, `harness-engineering`, `beginner`, `learning`
...
- **Tags:** `awesome-list`, `curated`, `directory`, `ecosystem`
...
- **Tags:** `web`, `aggregation`, `ecosystem`, `creative-workshop`
- **Why use it:** Web plugin aggregation ecosystem for DeepSeek Harness creative workshop
...
- **Tags:** `toy`, `web`, `zero-dependency`
- **Why use it:** Web simulation of traditional Chinese bamboo cricket toy, zero dependencies
...
- **Why use it:** Comprehensive curated plugin radar and registry
...
- **Why use it:** Well-curated comprehensive DSH plugin ecosystem list
...
- **Why use it:** Curated plugin list covering DSH ecosystem tools and infrastructure
...
- **Why use it:** Curated awesome list of DSH plugins — best starting point for exploring the ecosystem
...
- **Tags:** `documentation`, `best-practices`, `dsh-plugin`
- **Why use it:** Practical DSH plugin dev notes covering pitfalls
...
- **Why use it:** Curated community plugin directory for DSH
...
- **Why use it:** Public GitHub directory with install commands
...
- **Why use it:** Community-cataloged DSH plugins reference list

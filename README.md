...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,022,483 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-14 10:30:22 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 223,333 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,064 | Local-first design tool with Figma-alternative cap |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,381 | Multi-agent swarm orchestration with autonomous wo |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 38 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (38)
...
- **Tags:** `agent-framework`, `coding-agent`, `prompt-caching`, `tui`
...
- **Why use it:** Runtime injector + task-aware reasoning router for improved agent performance.
...
- **Tags:** `agent-workspace`, `multi-agent`
...
- **Why use it:** First vision plugin for DSH, enables text-only agents to process images via OCR.
...
- **Tags:** `preset`, `standard-tools`, `dsh-plugin`, `llm-agent`
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for optimal agent performance.
...
- **Why use it:** Virtual terminal enabling isolated, reproducible agent environments with VFS support.
...
- **Tags:** `cognition`, `inference-control`, `agent-skills`, `dsh-plugin`
- **Why use it:** Model-agnostic inference control suite for deep reasoning, long-horizon tasks, and recovery.
...
- **Tags:** `agent-teams`, `agentic-runtime`, `ai-coding`, `computer-use-agent`
...
- **Why use it:** CLI and schemas for DSH plugin management and hub operations
...
- **Tags:** `command-code`, `provider`, `dsh-plugin`
...
- **Why use it:** Code simplification skill adapted from official DeepSeek Harness repo
...
- **Why use it:** Godot Engine game dev skill with GDScript support at runtime.
...
- **Tags:** `dsh-plugin`
- **Why use it:** Guides agents to develop, build, install and test DSH plugins.
...
- **Tags:** `agent-skill`, `llm-agent`, `skill`
- **Why use it:** Agent skill for DSH plugin/service/tool development standards.
...
- **Tags:** `agent-skills`, `ai-design`, `desktop-app`, `ui-generator`
- **Why use it:** Local-first design tool with Figma-alternative capabilities
...
- **Tags:** `desktop`, `dsh-plugin`, `cordis-plugin`, `dsh`
- **Why use it:** Modern desktop wrapper with plugin-native architecture
...
- **Why use it:** Web-based plugin ecosystem aggregation for DeepSeek Harness.
...
- **Tags:** `pet`, `ui`, `developer-tools`
- **Why use it:** Public animated pet gallery adding personality to your AI coding agents.
...
- **Tags:** `taskboard`, `ui`, `dsh-plugin`, `skills`
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status, streaming thoughts, and TPS display.
...
- **Tags:** `widget`, `ui`, `balance-monitor`, `dsh-plugin`
...
- **Why use it:** Local-first AI desktop workspace with projects, files, web research, and MCP support.
...
- **Why use it:** Zero-setup Windows desktop GUI with Codex, SSH, mobile remote access, and plugins.
...
- **Why use it:** Full office suite with spreadsheets, docs, and slides in Harness
...
- **Why use it:** Native SQLite-backed task management with Agent workflow support
...
- **Why use it:** Native iOS/Android client with WebSocket real-time sync
...
- **Why use it:** CodePilot-style desktop client across macOS, Windows, Linux
...
- **Why use it:** Open-source Smartisan-style notes app with Docker deployment, skill calls and image export.
...
- **Why use it:** Electron desktop console for managing Harness/Plugin/MCP/Skills with multi-tab UI.
...
- **Why use it:** Live model info, balance, peak/off-peak pricing with countdown
...
- **Why use it:** Bioinformatics desktop agent with skill store, offline mode for clinicians
...
- **Why use it:** WorkBuddy-style skill picker: insert skill name via slash command
...
- **Why use it:** Electron desktop wrapper integrating DSH ecosystem.
...
- **Tags:** `agentic-ai`, `multi-agent`, `skills`, `mcp-server`
...
- **Tags:** `ai-image-generation`, `skills`, `workflow-automation`, `prompt-engineering`
- **Why use it:** 530+ production-ready image prompt templates and skills
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `meta-skill`, `llm-agent`
...
- **Tags:** `ai-agent`, `no-code`, `internal-tools`, `workflows`
- **Why use it:** AI-powered no-code platform for internal business tools
...
- **Tags:** `skills`, `dsh-plugin`
- **Why use it:** Largest skills marketplace covering docs, coding, ML, automation workflows.
...
- **Tags:** `workflow-automation`, `long-horizon`
...
- **Why use it:** Intelligent skill routing and workflow orchestration boosting reward by 21pp, cutting tokens 30%.
...
- **Why use it:** Organized workflow for AI novel writing with worldbuilding and editing
...
- **Why use it:** Turns SKILL.md files into retrieval-ready skill corpora with semantic search.
...
- **Tags:** `canvas`, `conversation`, `workflow`
- **Why use it:** Visual non-linear conversation canvas with branching workspace and session explorer.
...
- **Why use it:** Gives agents eyes and ears — turns video, audio, and screen activity into timestamped evidence.
...
- **Tags:** `creative-writing`, `novel`, `workflows`
- **Why use it:** Specialized workflow for novel and short-drama writing with AI
...
- **Why use it:** Enables composable, reviewable agent modes for self-evolving and continuously improvable workflows.
...
- **Why use it:** Turns experience into repeatable execution skills across multiple AI coding tools.
...
- **Tags:** `agent-skills`, `research-automation`, `market-research`
- **Why use it:** 88 open-source agent skills for research, marketing automation and social intelligence workflows.
...
- **Why use it:** Specialized agent skills for AI infrastructure: writing, optimizing and debugging high-performance systems.
...
- **Why use it:** 87 security RE skills for authorized pentesting
...
- **Why use it:** Auto-generates reusable skills from successful sessions
...
- **Why use it:** AI coding mentor that generates step-by-step chapters and auto-reviews your code.
...
- **Tags:** `skills`, `agent`, `deepseek-harness`
- **Why use it:** 25 ready-to-use engineering skills via sidebar panel, including triage and wayfinder.
...
- **Tags:** `gongwen`, `docx`, `deepseek-harness`
- **Why use it:** Full workflow gov-doc tool: format check, optimization, template generation per GB/T 9704 standard.
...
- **Tags:** `ai-agent`, `bazi`, `fengshui`, `iching`, `tcm`
- **Why use it:** Fusion of Bazi, Fengshui, TCM, I Ching with local deterministic engine
...
- **Why use it:** QA skill framework: 11 skills, shared KB, type decision matrix for testing
...
- **Tags:** `guard`, `quality-gate`, `engineering`
...
- **Tags:** `agent`, `mcm`, `cumcm`, `skill`
- **Why use it:** 5-role multi-agent math modeling system for competitions.
...
- **Tags:** `agent-orchestration`, `multi-agent-systems`
...
- **Tags:** `agent-skills`, `architecture-diagram`, `diagram-as-code`, `mermaid-alternative`
- **Why use it:** Self-contained architecture diagrams with animations
...
- **Why use it:** Open-source AI vector design tool with concurrent Agent Teams support.
...
- **Tags:** `ui-components`, `charts`, `visualization`
- **Why use it:** Generates interactive inline UI — charts, plots, forms, quizzes rendered via dsh-ui fence.
...
- **Why use it:** Visualize legal litigation timelines and case diagrams directly from case materials.
...
- **Tags:** `directorx`, `video`, `image`, `audio`
- **Why use it:** AI video/image/audio skills with configurable vision model tools
...
- **Why use it:** 6 design style packs to avoid generic AI-generated aesthetics.
...
- **Tags:** `browser-extension`, `chat-management`, `chrome-extension`, `prompt-manager`
- **Why use it:** Multi-browser extension suite for AI chat platforms
...
- **Why use it:** Cross-platform content discovery agent scraping B站、YouTube、小红书等10+ platforms locally.
...
- **Why use it:** Live iOS Simulator control directly within AI conversations
...
- **Tags:** `browser-automation`, `mcp-server`, `anti-detect`
- **Why use it:** Persistent identity browser with fingerprint spoofing and Android emulation for automation.
...
- **Tags:** `electron-app`, `image-uploader`, `s3`, `cloudflare-r2`
...
- **Tags:** `utility`, `model-switch`, `multi-agent`, `dsh-plugin`
- **Why use it:** One-click install and model switching across Claude Code, Codex, DSH, Kimi, and other agents.
...
- **Why use it:** Self-hosted plugin radar discovering 15900+ candidates with k8s testing
...
- **Why use it:** Best context insight tool with dashboard, browser, and sidebar views
...
- **Why use it:** AI security platform auditing code for hallucinated packages, missing safeguards & errors.
...
- **Tags:** `authentication`, `providers`, `oauth`
- **Why use it:** OAuth login for ChatGPT/Claude/Grok subscriptions without API keys
...
- **Tags:** `cost-tracking`, `budget`, `analytics`
- **Why use it:** Track session and daily costs across all LLM providers
...
- **Why use it:** Learn DSH principles, marketplace navigation, and best practices
...
- **⭐ Stars:** 233
- **Language:** JavaScript
- **Description:** DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与��式校验，免费搜索 API。deepseek1024.com
- **Tags:** `awesome-list`, `plugin-store`, `marketplace`
- **Why use it:** Plugin marketplace with 11,000+ plugins, search, rankings and free API for discovery.
...
- **Tags:** `handbook`, `awesome-list`, `developer-tools`
- **Why use it:** Comprehensive handbook covering runtime, plugins, MCP and sandbox with 173 source-backed resources.
...
- **Why use it:** Plugin directory with 1958 repos, search, filtering and STAR ranking in both Chinese and English.
...
- **Why use it:** Secure P2P remote access solution for DSH across PC, Android and Web with end-to-end encryption.
...
- **Why use it:** DSH skill that automatically finds, installs and verifies GitHub plugins for easy discovery.
...
- **Why use it:** Curated awesome list for DSH plugin discovery
...
- **Why use it:** Auto-upgrades plugins with DSH version changes
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Official auto-generated plugin directory
...
- **Why use it:** Complete DSH config backup, restore and migration
...
- **Why use it:** Curated list of productivity and dev resources
...
- **Tags:** `dsh-plugin`, `plugin-marketplace`, `awesome-list`
- **Why use it:** Community-maintained auto-synced plugin catalog updated every 4 hours.
...
- **Why use it:** Infrastructure for DSH plugin ecosystem: browser-based registry console and dev guide skill.
...
- **Why use it:** Unified loader and manager for safely handling local Agent Skills in DSH environment.
...
- **Why use it:** Official DSH plugin dev knowledge base bundled as installable on-demand agent skill.
...
- **Why use it:** Audit instruction chains, detect duplicates/conflicts with web UI panel
...
- **Tags:** `container`, `management`, `isolation`
...
- **Tags:** `config`, `mcp`, `multi-agent`, `setup`
- **Why use it:** One-click MCP/Skills/Rule setup for Claude Code, Codex, DSH, Cursor, Qwen
...
- **Tags:** `cordis`, `cordis-plugin`
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill and MCP capabilities.
...
- **Why use it:** Curated list of essential DSH plugins for quick discovery.
...
- **Tags:** `awesome`, `awesome-list`, `mcp`
- **Why use it:** Comprehensive awesome list of DSH plugins, skills and resources.
...
- **Tags:** `cost`, `data-visualization`, `deepseek-api`
- **Why use it:** Real-time token usage and cost tracking via charts.
...
- **Tags:** `utilities`, `plugin-management`
- **Why use it:** Diagnoses and resolves DSH plugin version conflicts.
...
- **Tags:** `tts`, `utility`
- **Why use it:** Free Xiaomi MiMo TTS integration for DSH text reading.
...
- **Why use it:** Bilingual curated plugin directory with immutable review commits.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Auto-updating data-driven plugin list with Vercel deployment.
...
- **Why use it:** Highly customizable frosted glass theme with adjustable blur, opacity, and animated backgrounds.
...
- **Tags:** `theme`, `animated`, `ocean`
- **Why use it:** Animated ocean theme with adjustable waves, sunset effects, and glassmorphism — DSH+extension.
...
- **Tags:** `themes`, `webui`, `background`
- **Why use it:** Customizable DSH web UI background themes.
...
- **Tags:** `documentation`, `wiki`, `code-analysis`, `dsh-plugin`
...
- **Why use it:** All-in-one research workbench: LaTeX writing, arXiv management, GPU SSH, and experiment tracking.
...
- **Tags:** `discovery`, `curation`, `directory`
- **Why use it:** Daily auto-scanned plugin directory with quality verification
...
- **Why use it:** Curated plugin/skill/MCP list with visualization and PPT support
...
- **Tags:** `guide`, `quickstart`, `beginner`
- **Why use it:** Ultimate beginner guide with quickstart and plugin toolkit
...
- **Why use it:** Cross-database academic search with citation graph and verification, ideal for Chinese researchers.
...
- **Why use it:** Financial database with multi-agent analysis, auto-generated HTTP/MCP interfaces and IM alerts.
...
- **Why use it:** Industry research methodology with news tracking
...
- **Why use it:** Input a patent number and generate a competitor infringement analysis report automatically.
...
- **Tags:** `awesome-deepseek-harness`, `dsh-better-sidebar`, `dsh-plugin-market`
- **Why use it:** Interactive K-line charts with technical and fundamental analysis.
...
- **Why use it:** Curated plugin directory — best starting point for DSH discovery.
...
- **Why use it:** Step-by-step harness engineering tutorial from scratch to expert.
...
- **Tags:** `plugin-market`, `community`
- **Why use it:** Daily refreshed plugin marketplace with community-sourced, reviewed DSH plugins.
...
- **Why use it:** Curated bilingual awesome list of DSH plugins, extensions, tools, and integrations.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Evidence-led verified DSH plugin directory.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Practical DSH plugin collection list.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ DSH tools sorted by stars on GitHub.
...
- **Why use it:** A plugin of Deepseek Harness(DSH),transf
...
- **Why use it:** DSH plugins directory: 80+ verified Deep

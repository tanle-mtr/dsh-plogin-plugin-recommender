...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,031,274 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225,304 | Core DSH platform — everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,372 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,545 | Multi-agent swarms with autonomous workflow coordi |
...
- **Tags:** `agent-orchestration`, `mcp`, `workspace`, `no-code`
...
- **Tags:** `routing`, `injector`, `harness-tools`
- **Why use it:** Runtime injector and task-aware router for reasoning modes
...
- **Tags:** `multi-agent`, `enterprise`, `workspace`, `coding-agent`
...
- **Tags:** `agent-os`, `evaluation`, `mcp`, `skills`
...
- **Why use it:** Long-horizon agent control plane for governed multi-harness work
...
- **Tags:** `preset`, `deepseek-harness`, `llm-agent`
- **Why use it:** Two-phase preset providing minimal bootstrap then full Standard tools configuration
...
- **Why use it:** Virtual terminal with VFS for sandboxed agent execution environments
...
- **Tags:** `installer`, `model-switch`, `coding-agent`
- **Why use it:** Universal agent installer with one-click setup and model switching across 8+ platforms
...
- **Why use it:** Turns codebases into structured technical docs and AI-ready context in minutes
...
- **Why use it:** Best context insight and management tool with dashboard, browser sidebar, and CLI commands.
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, screenshot UI restoration in one line.
...
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits, and MCP integration via CLI/TUI
...
- **Why use it:** Enables composable, reviewable agent workflows for self-evolving capabilities
...
- **Why use it:** Official Huawei Cloud SDK with MCP tools and sandbox
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional sync bridge between OpenAI Codex and DSH with live skills.
...
- **Why use it:** Real-time token usage tracking, cost estimates, and API balance.
...
- **Tags:** `dsh-web`, `ui`, `plugin-ecosystem`
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thoughts, and context progress tracking
...
- **Why use it:** Lightweight Tauri desktop app with zero-env setup and preset plugins for DSH.
...
- **Why use it:** Local-first AI desktop workspace for DSH sessions, files, web research, and Office artifacts
...
- **Why use it:** Zero-setup Windows GUI client with Codex, plugins, SSH, and mobile remote access
...
- **Tags:** `canvas`, `conversation`, `non-linear`
- **Why use it:** Visual non-linear conversation canvas for session exploration and branching workflows
...
- **Why use it:** Local-first multi-model AI agent desktop with self-evolving skills and privacy focus
...
- **Tags:** `ios`, `mobile`, `kmp`
- **Why use it:** Native iOS client connecting to DSH via WebSocket, bringing workspace to your phone
...
- **Why use it:** Live iOS Simulator and USB-connected iPhone control directly inside DSH conversations
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI tool for skill and MCP management
...
- **Why use it:** Electron desktop console for multi-tab Harness management
...
- **Tags:** `ui`, `info-bar`
- **Why use it:** Persistent bottom bar showing model, balance, pricing info
...
- **Why use it:** All-in-One DevOps desktop: SSH, DB, Docker, AI assistant unified.
...
- **Tags:** `memory`, `rag`, `token-optimization`, `skills`
...
- **Why use it:** Dedicated memory management kit with RAG support for agent context retention
...
- **Why use it:** Persistent unified memory layer backed by Milvus for cross-agent semantic search
...
- **Tags:** `memory`, `rag`, `mcp`, `personal-ai`
- **Why use it:** Shared long-term memory hub for all AI agents with full user control and persistence.
...
- **Why use it:** Turns SKILL.md files into vector-searchable corpora with retrieval and evaluation tooling
...
- **Why use it:** Multi-agent swarms with autonomous workflow coordination.
...
- **Why use it:** Self-evolving multi-agent with memory and knowledge.
...
- **Tags:** `skills`, `marketplace`, `automation`, `workflow`
- **Why use it:** Fastest-updating skills store with auto-scraped GitHub skills
...
- **Why use it:** First vision plugin enabling OCR and image-to-JSON for text-only coding agents
...
- **Tags:** `skills`, `workflow`, `agent-skills`
...
- **Tags:** `cognition`, `agent-skills`, `reasoning`
- **Why use it:** Model-agnostic inference control suite for deep reasoning, verification and recovery
...
- **Tags:** `skill`, `research`, `web-search`
- **Why use it:** Searches 8 major Chinese platforms for last 30 days and generates well-sourced research reports.
...
- **Why use it:** Organized novel writing workflow with worldbuilding, characters, chapters, and revision tools.
...
- **Tags:** `agent-observability`, `video-analysis`, `multimodal`
- **Why use it:** Gives AI agents real-time video/audio/screen monitoring with timestamped evidence
...
- **Tags:** `creative-writing`, `novel-writing`, `agent-skills`
- **Why use it:** All-in-one creative writing suite: novels, short dramas, games, video recaps
...
- **Tags:** `math-modeling`, `agent-skill`, `gitops`
- **Why use it:** Full-stack math modeling autopilot with GitOps pipeline and code self-verification
...
- **Why use it:** Cross-database academic search with citation verification and graph for Chinese researchers
...
- **Tags:** `skills`, `cross-agent`, `architecture`
...
- **Why use it:** Multi-agent financial analysis system with adaptive HTTP/MCP and IM alerts
...
- **Why use it:** Specialized agent skills for AI infrastructure development and high-performance debugging
...
- **Tags:** `ctf`, `security`, `pentest`
- **Why use it:** 87 reverse engineering & pentest skills
...
- **⭐ Stars:** 52
- **Language:** Python
- **Description:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生���持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `skill`
- **Why use it:** GB/T 9704 standard official document processing suite
...
- **Tags:** `spec-programming`, `agent-skill`
...
- **Why use it:** Bazi, Fengshui, I Ching and TCM wisdom agent skill
...
- **Why use it:** Bioinformatics agent desktop for clinicians and researchers
...
- **Tags:** `quality`, `guard`
- **Why use it:** Engineering discipline quality gate before shipping
...
- **Tags:** `qa`, `testing`
- **Why use it:** Test engineer agent skills framework with decision matrix
...
- **Tags:** `skillhub`, `api`
- **Why use it:** SkillHub API docs and plugin integration
...
- **Tags:** `multi-agent`, `memory`, `deepseek-harness`
...
- **Tags:** `math-modeling`, `multi-agent`, `mcm`
...
- **Why use it:** 6 design style presets to keep vibe-coded sites from generic AI look.
...
- **⭐ Stars:** 22
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型��配器、工具注册表、Agent 循环、网页界面都是插件
- **Tags:** `plugin-dev`, `skill`, `dsh`
- **Why use it:** Guides AI agents to develop, build, test and install DSH plugins from scratch.
...
- **Tags:** `plugin-dev`, `skill`, `agent`
- **Why use it:** Agent skill for developing DSH plugins: services, events, tools and adapters.
...
- **Tags:** `agent-tools`, `plugin-optimization`, `workflow`
...
- **Tags:** `mcp`, `config`
- **Why use it:** One-click MCP and skills setup for multiple AI agents
...
- **Why use it:** Web GUI card for managing skills and MCP servers in browser settings.
...
- **Why use it:** Open-source design system with local-first desktop.
...
- **Why use it:** Beautiful architecture and sequence diagram generation.
...
- **Tags:** `design`, `ui`, `vector`, `agent-team`
...
- **Tags:** `pet`, `pixel-art`, `mascot`, `ui`
- **Why use it:** Public gallery of animated pixel pets for coding agents
...
- **Why use it:** Native design & PPT studio for DSH with AI generation, visual editing, and template marketplace.
...
- **Why use it:** Generates interactive inline UI — charts, plots, forms, quizzes via dsh-ui fence
...
- **Why use it:** Litigation timeline and case diagram visualization
...
- **Why use it:** AI video/image/audio creation and editing skills
...
- **Why use it:** Let AI agents control your real logged-in browser without interrupting workflow.
...
- **Why use it:** Persistent fingerprint-spoofing browser with Android emulation for agent web automation
...
- **Tags:** `content-discovery`, `cross-platform`, `ai-agent`
...
- **Why use it:** Privacy-first open-source resume builder, self-hosted.
...
- **Tags:** `no-code`, `low-code`, `ai-agent`, `internal-tools`
- **Why use it:** Open-source AI no-code platform for building business apps.
...
- **Why use it:** Essential marketplace for discovering and installing DSH plugins with one-click setup
...
- **⭐ Stars:** 1,466
- **Language:** Python
- **Description:** DSH Plugin Radar — 开源可自部署的 DSH 插件生��雷达：自动发现 15900+ 候选、k8s 运行级实测管线；自动索引可用Plugin List
- **Tags:** `plugin-registry`, `infrastructure`, `discovery`
- **Why use it:** Self-hostable plugin radar with k8s-grade validation pipeline indexing 15900+ candidates.
...
- **Why use it:** AI security offense & defense platform auditing generated code for hallucinations and vulnerabilities
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as LLM providers without API keys via OAuth
...
- **Why use it:** CLI, schemas, and resolver for managing and publishing DSH plugins via Plugin Hub
...
- **Tags:** `remote-access`, `security`, `p2p`
...
- **Why use it:** DSH skill for automatic plugin discovery, installation and GitHub verification
...
- **Why use it:** Smartisan-style open-source notes with Docker deployment and WeChat/QQ integration
...
- **Why use it:** Auto-upgrades plugins on DSH updates
...
- **Why use it:** Backup, restore and sync DSH config and skills
...
- **Why use it:** Plugin ecosystem backbone with dev scaffolding
...
- **Why use it:** Plugin development knowledge base and official docs
...
- **Tags:** `context`, `audit`
- **Why use it:** Context injection audit with token cost tracking
...
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill and MCP into extensible platform.
...
- **Tags:** `migration`, `claude-code`, `utility`
- **Why use it:** Migration wizard for Claude Code, Codex, OpenCode sessions to DSH.
...
- **Why use it:** Fast, simple Neovim plugin manager for streamlined workflows.
...
- **Tags:** `troubleshooting`, `plugin-health`, `conflict-resolution`
...
- **Tags:** `skin`, `theme`, `ui`
- **Why use it:** Cute whale-themed skin series for DeepSeek Harness desktop interface.
...
- **Why use it:** Frosted glass theme with fully adjustable opacity, blur, and custom wallpaper support
...
- **Why use it:** Custom background images with presets: aurora, ember, rice paper.
...
- **Tags:** `ai-guide`, `tutorials`, `rag`, `mcp`
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiment tracking, GPU cluster SSH orchestration
...
- **Why use it:** Comprehensive DSH learning resource with plugin marketplace and best practices
...
- **Tags:** `catalog`, `marketplace`, `registry`
- **Why use it:** Massive plugin catalog with 11,000+ entries, search and install commands
...
- **Tags:** `handbook`, `reference`, `multilingual`
- **Why use it:** Comprehensive 173-resource handbook covering runtime, plugins, MCP and troubleshooting
...
- **Why use it:** Curated plugin directory with 1958 repos, bilingual search and STAR ranking
...
- **Why use it:** Industry research methodology and tracking skills
...
- **Why use it:** Search 65K+ Chinese platform API docs with zero config
...
- **Why use it:** Patent infringement analysis with competitor reports
...
- **Why use it:** Interactive K-line analysis with technical indicators and fundamental data.
...
- **Why use it:** 24 verified stock/finance/quant plugins for trading research.
...
- **Why use it:** Curated awesome list of DSH plugins, tools, and infrastructure from the community ecosystem.
...
- **Tags:** `awesome-list`, `curated`, `ecosystem`
- **Why use it:** Comprehensive curated plugin list covering the full DeepSeek Harness ecosystem landscape.
...
- **Why use it:** Comprehensive DSH plugin marketplace with daily updates and pre-reviewed listings
...
- **Why use it:** Curated bilingual awesome list of DSH plugins, skills, clients, and integrations
...
- **Tags:** `encyclopedia`, `ai-resources`, `awesome-list`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, multimodal, MLOps, and learning routes
...
- **Why use it:** Curated plugin discovery: auto-syncs GitHub, filters fake listings, ranked by popularity
...
- **Tags:** `awesome-list`, `resource`, `guide`
- **Why use it:** Comprehensive curated list of plugins, MCP servers, patches, and UIs for DSH
...
- **Why use it:** Ultimate DSH guide: quickstart, resource recommendations, and plugin/tool showcases
...
- **Why use it:** Curated list of DSH tools and resources
...
- **Why use it:** Community-maintained DSH plugin catalog with auto-sync
...
- **Why use it:** Curated registry of verified DSH plugins, bundles, and skills.
...
- **Why use it:** Evidence-led curated list with permission-aware installation guide.
...
- **Tags:** `awesome-list`, `catalog`, `community`
- **Why use it:** Comprehensive catalog of 1000+ DSH plugins sorted by stars.
...
- **Why use it:** Curated star-ranked community plugin list for DSH discovery
...
- **Why use it:** Plugin guide with scenario-based recommendations and risk info
...
- **Why use it:** DSH plugin marketplace analogous to CodeX for plugin bundling
...
- **Why use it:** Official DSHA plugin collection with verified selections
...
- **Tags:** `awesome-list`, `auto-crawl`, `bilingual`
- **Why use it:** Auto-crawled daily GitHub directory with bilingual support
...
- **Tags:** `oauth`, `chatgpt`, `subscription`
...
- **Tags:** `plugin-repository`, `verify`, `analytics`
...
- **Why use it:** Moved to awesome-dsh-plugin repo, redirect reference
...
- **Tags:** `awesome-list`, `dsh-plugin`, `meta`
- **Why use it:** Auto-updating curated plugin list with bilingual README generation
...
- **Tags:** `awesome-list`, `ai-agents`, `deepseek-harness`, `meta`
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `dsh-plugin`, `awesome-list`, `meta`
- **Why use it:** Simple DSH plugin list, lightweight entry for plugin discovery

...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 964,680 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-04 13:21:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 211,877 | Core DSH platform — everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,000 | Open-source Claude Design alternative for DSH |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,432 | Multi-agent swarm orchestrator with MCP support |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 14 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (14)
...
- **Why use it:** Super AI assistant with memory, skills, multi-model
...
- **Why use it:** Terminal-native DeepSeek coding agent with prompt caching
...
- **Tags:** `low-code`, `crm`, `workflows`, `ai-agent`
- **Why use it:** AI-powered no-code platform for fast business systems
...
- **Tags:** `dsh-plugin`, `ai-agents`, `cordis`
- **Why use it:** Task-aware router injector for optimized reasoning mode selection
...
- **Tags:** `agent-os`, `loop-engineering`, `mcp`, `skills`
- **Why use it:** Self-improving agent OS with evaluation-gated evolution loops and MCP
...
- **Why use it:** Enables vision for text-only coding agents via OCR and structured JSON output
...
- **Tags:** `preset`, `bootstrap`, `dsh-plugin`
- **Why use it:** Provides a two-phase preset config with minimal bootstrap and full standard tools
...
- **Why use it:** First virtual terminal with VFS for isolated agent execution environments
...
- **Tags:** `installer`, `multi-agent`, `dsh-plugin`
- **Why use it:** One-click cross-platform agent installer supporting Claude Code, Codex, DeepSeek, Kimi and more
...
- **Tags:** `code-review`, `lint`, `agent-skills`
...
- **Why use it:** Vision toolkit enabling image Q&A, OCR and UI restoration for text-only models
...
- **Why use it:** Full-featured coding agent with RPC, sub-agents, hashline edits and MCP support.
...
- **Tags:** `dsh-plugin`, `plugin-discovery`, `agent-skills`
- **Why use it:** Essential skill for discovering and managing DSH plugins efficiently.
...
- **Why use it:** Run multiple DSH versions in isolated containers with easy plugin management
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional sync bridge between OpenAI Codex and DSH with auto MCP mirroring
...
- **Why use it:** Package manager with 42 skills and 5 CLIs for AI agent engineering workflows
...
- **Why use it:** Pre-flight plugin check ensures optimal plugin selection
...
- **Why use it:** ChatGPT OAuth integration for DSH agents
...
- **Why use it:** Modern desktop wrapper for the DSH plugin ecosystem
...
- **Why use it:** Extensible sidebar foundation with built-in file editor, terminal, chat, Git and sub-agent pages
...
- **Tags:** `taskboard`, `ui`, `coding-agent`, `dsh-plugin`
- **Why use it:** Modern flexible task panel embeddable in Codex and DeepSeek Harness
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thoughts, and rollback support
...
- **Tags:** `desktop`, `runtime`, `ui`, `dsh-plugin`
- **Why use it:** Rust-based high-performance agent runtime paired with a polished desktop application
...
- **Why use it:** Lightweight Tauri desktop client for DSH with zero env setup needed
...
- **Why use it:** Local-first desktop workspace for DSH sessions, projects and Office artifacts
...
- **Tags:** `dsh-ui`, `interactive`, `charts`
- **Why use it:** Inline interactive UI components—charts, forms, quizzes—in assistant replies
...
- **Tags:** `desktop`, `local-first`, `multi-model`
...
- **Why use it:** Feature-rich Windows desktop client with SSH, mobile remote access, and plugin system
...
- **Why use it:** Adds full office suite (spreadsheets, docs, slides) directly into Harness desktop.
...
- **Why use it:** CodePilot-style desktop client for DSH, cross-platform with rich UI features.
...
- **⭐ Stars:** 115
- **Language:** JavaScript
- **Description:** DSH Web UI plugin: skill and MCP management（Web界面的skill/MCP管��工具）
- **Tags:** `mcp`, `dsh-plugin`, `ui`
- **Why use it:** Web UI panel for managing DSH skills and MCP tools visually and conveniently.
...
- **Tags:** `plugin-market`, `webui`, `plugin-management`
- **Why use it:** Web GUI plugin marketplace with one-click install/uninstall
...
- **Tags:** `plugin-registry`, `ui`, `infrastructure`
- **Why use it:** Lightweight browser console for plugin management and dev guide
...
- **Tags:** `desktop`, `electron`, `management`
- **Why use it:** Electron desktop hub for multi-tab Harness/MCP/Skill management
...
- **Why use it:** WorkBuddy-style skill picker in composer with /skill-name shortcut support
...
- **Tags:** `desktop-app`, `electron`, `webui`
- **Why use it:** Electron desktop wrapper for DSH with ModLens and sidebar integration
...
- **Tags:** `ui`, `background`, `webui`, `customization`
- **Why use it:** Web background customization with image upload and preset themes
...
- **Why use it:** LLM knowledge platform with RAG, Wiki and semantic search
...
- **Tags:** `agent-memory`, `agentic-rag`, `continual-learning`
- **Why use it:** Dedicated memory library for building stateful, continual-learning agents
...
- **Tags:** `memory`, `rag`, `agent-memory`, `dsh-plugin`
- **Why use it:** Dedicated memory management kit enabling agents to remember and refine knowledge
...
- **Why use it:** Context dashboard and management for deeper DSH session insights
...
- **Tags:** `skill-md`, `vector-search`, `embeddings`
- **Why use it:** Transforms scattered SKILL.md files into retrieval-ready corpora with vector search
...
- **Why use it:** Multi-agent swarm orchestrator with MCP support
...
- **Tags:** `agent-workspaces`, `agent-skills`, `mcp`, `no-code`
...
- **⭐ Stars:** 6,185
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内���创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **Tags:** `agent-skills`, `skill`, `dsh-plugin`
- **Why use it:** Largest skills marketplace with auto-sorted categories and update tracking
...
- **Tags:** `agent-ops`, `loop-engineering`, `workflow-automation`
- **Why use it:** Long-horizon agent control plane for durable cross-harness workflow automation
...
- **Tags:** `agent-collaboration`, `multi-agent-workspace`, `skills`
- **Why use it:** Enterprise multi-agent workspace with visual editor and cross-harness support
...
- **Tags:** `cognitive`, `skills`, `research`, `dsh-plugin`
...
- **Tags:** `agent-teams`, `workflow`, `multi-agent`
...
- **Why use it:** Native SQLite-backed task management with agent claim/review and clean Web UI
...
- **Why use it:** Specialized plugin for novel writing and short-drama production with dedicated skills
...
- **Tags:** `skill`, `competition`, `math-modeling`
- **Why use it:** End-to-end auto math modeling competition skill with GitOps pipeline and code verification.
...
- **Tags:** `agent`, `self-evolution`, `workflow`
- **Why use it:** Enable composable, reviewable agent workflows for continuous self-evolution.
...
- **Tags:** `agent-skills`, `skills`, `coding`
- **Why use it:** Turn expertise into reusable agent skills across multiple coding platforms.
...
- **Why use it:** Adds multimodal vision analysis to text-only LLMs, great for UI inspection.
...
- **Tags:** `ai-infra`, `skills`, `agent-skills`
...
- **Why use it:** 87 reverse-engineering skills for CTF, pentesting, and security research.
...
- **Tags:** `superpowers`, `skills`, `agent-skills`
- **Why use it:** Brings TDD, debugging and planning superpowers skills to DSH
...
- **Why use it:** Ports Superpowers skills to the Reasonix coding harness
...
- **Tags:** `mentor`, `coding-agent`, `skill`
- **Why use it:** AI coding mentor that guides through architecture and code review
...
- **Tags:** `patent`, `rag`, `multi-agent`, `legal-tech`
- **Why use it:** Patent infringement analysis agent with reusable skill packaging
...
- **⭐ Stars:** 53
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：���凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `legal`, `visualization`, `svg`, `timeline`
- **Why use it:** Transforms chaotic case data into professional legal timelines and diagrams.
...
- **Tags:** `skills`, `deck`, `engineering`, `github-issues`
- **Why use it:** Pre-loaded 25 engineering skills ready to use directly from the sidebar panel.
...
- **Tags:** `plugin-dev`, `agent-skill`, `dsl`
- **Why use it:** Standards-compliant skill for developing DSH plugins, services, and tools.
...
- **Why use it:** Agent skill for managing installed plugin slots, remotes, and credentials.
...
- **Tags:** `spec-driven`, `vibe-coding`, `developer-tools`
...
- **⭐ Stars:** 37
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修���+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `wps`, `formatting`
- **Why use it:** Full workflow Chinese official document tool with format validation and optimization.
...
- **Why use it:** Reusable skill for building and validating DSH and Cordis plugins efficiently.
...
- **Tags:** `guide`, `knowledge-base`, `plugin-dev`
- **Why use it:** On-demand plugin development knowledge base with official docs archive.
...
- **Tags:** `fengshui`, `bazi`, `iching`, `traditional-wisdom`
- **Why use it:** Integrated Chinese metaphysics skill pack with local deterministic engine and dashboard.
...
- **Tags:** `skills-manager`, `management`, `safety`
- **Why use it:** Centralized manager for loading and safely managing local Agent Skills in DSH.
...
- **Tags:** `deepseek-harness`, `multi-agent`, `collaboration`
- **Why use it:** Multi-agent collaboration with shared workspace and independent contexts
...
- **Why use it:** Adapted code simplification skill for cleaner, more efficient code generation
...
- **Tags:** `agent-handoff`, `session-memory`, `skill`
- **Why use it:** Cross-platform skill preserving session memory for agent handoff continuity
...
- **Why use it:** 10 QA skills framework with shared knowledge base for AI testing workflows
...
- **Why use it:** Full-stack Godot 4.x game dev skill for building GDScript projects with AI
...
- **Why use it:** Virtual product team preset: PM→Engineer→QA→Release workflow
...
- **Why use it:** Open-source Claude Design alternative for DSH
...
- **Why use it:** Beautiful mermaid-alternative architecture diagrams
...
- **Why use it:** 530+ GPT-Image2 prompt templates as reusable skills
...
- **Tags:** `video-generation`, `ffmpeg`, `ai-video`
...
- **Why use it:** AI-powered design studio with PPT generation, templates and visual editing
...
- **Why use it:** Preview, inspect, and edit OpenPencil .op documents directly in conversations.
...
- **Tags:** `design`, `aesthetics`, `vibe-coding`
- **Why use it:** 6 design style presets keeping vibe-coded sites away from generic AI aesthetics
...
- **Why use it:** Converts chat history into downloadable knowledge cards
...
- **Why use it:** Enhancement suite for Gemini, Claude & ChatGPT web UIs
...
- **Why use it:** Local-first cross-platform content discovery agent spanning Bilibili, YouTube, Reddit and more
...
- **Why use it:** Embed a live iOS Simulator or connected iPhone directly in DSH conversations for mobile automation
...
- **Why use it:** Browser automation via Tabbit + Playwright for DSH agents
...
- **Why use it:** Privacy-focused, self-hosted resume builder
...
- **Tags:** `image`, `electron-app`, `s3-uploader`
...
- **Why use it:** In-app plugin marketplace with browse, search, and one-click install functionality
...
- **Why use it:** AI security audit tool: detects hallucinated packages and missing safeguards in generated code
...
- **Tags:** `oauth`, `subscription`, `providers`
- **Why use it:** Reuse ChatGPT/Claude/Grok subscriptions as DSH providers via OAuth; skip API key hassle
...
- **Why use it:** Track API costs, budgets, and token usage per session with open-code quota support.
...
- **Why use it:** CLI tool with schemas and resolver for managing DSH Plugin Hub effectively.
...
- **Tags:** `deepseek-harness`, `pi-agent`, `migration`
- **Why use it:** Seamlessly migrate Pi extensions to DSH without code changes.
...
- **Tags:** `dsh-plugin`, `context-migration`, `session-migration`
- **Why use it:** Enables cross-preset session migration while preserving state and intent.
...
- **Why use it:** Secure P2P multi-device remote access for your DeepSeek Harness instance.
...
- **Tags:** `capability-management`, `mcp`, `configuration`
...
- **Why use it:** Full DSH config backup/restore via WebDAV with export and import
...
- **Why use it:** Audit context tokens, detect duplicates and conflicts in instruction chains
...
- **Tags:** `utility`, `conflict-resolution`, `version-management`
...
- **Tags:** `mascot`, `pixel-art`, `dsh-plugin`, `cli`
- **Why use it:** Animated pet mascot gallery enhancing developer tool UIs across harnesses
...
- **Tags:** `theme`, `skin`, `customization`, `dsh-plugin`
...
- **Tags:** `theme`, `glass`, `desktop`
- **Why use it:** Frosted glass theme with full customization; zero source modification needed
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates cited research reports
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiments, GPU SSH orchestration.
...
- **Tags:** `academic-search`, `research-workflow`, `mcp`
- **Why use it:** Powerful academic search across PubMed, arXiv, Crossref with citation graphs.
...
- **Tags:** `research`, `marketing-automation`, `deep-research`
...
- **Why use it:** Official curated plugin list kept updated by cordis.run
...
- **Tags:** `awesome-list`, `plugin-directory`, `resources`
...
- **Why use it:** Community-maintained auto-syncing DSH plugin catalog every 4h
...
- **Tags:** `api-search`, `chinese-api`, `research`
- **Why use it:** Searches 65,600+ Chinese API docs across 20 platforms zero-config
...
- **Why use it:** Comprehensive industry research toolkit with methodology skills and policy tracking.
...
- **Why use it:** Interactive K-line chart with technical indicators and market analysis sidebar
...
- **Why use it:** DSH plugin directory with verification support
...
- **Why use it:** Evidence-led bilingual curated plugin directory
...
- **Tags:** `awesome-list`, `plugin-registry`
- **Why use it:** Plugin radar with 2Origin lab integration
...
- **Why use it:** In-agent npm + awesome-list plugin search tool
...
- **Tags:** `awesome-list`, `mcp`, `recommender`
...
- **Tags:** `awesome-list`
- **Why use it:** Moved to awesome-dsh-plugin repository
...
- **Why use it:** Auto-updating YAML-based plugin registry with Vercel
...
- **Tags:** `awesome-list`, `evidence`
- **Why use it:** Evidence-aware shortlisted useful plugins
...
- **Why use it:** Comprehensive AI resource collection with tutorials and prompt guides
...
- **Tags:** `dsh-plugin`, `harness-engineering`, `agent`
...
- **Why use it:** Curated collection of top DSH plugins for discovery and reference
...
- **⭐ Stars:** 1,446
- **Language:** Python
- **Description:** DSH Plugin Radar — 开源 DSH 插件生态���达：自动发现 15900+ 候选、k8s 运行级实测 10000+、15 分钟快照管线；插件目录是其自动生成的 artifact
- **Tags:** `plugin-registry`, `ecosystem`, `meta`
- **Why use it:** Auto-discovers 15900+ DSH plugins with k8s-verified testing pipeline
...
- **Why use it:** Curated list of DSH plugins — best starting point for ecosystem exploration
...
- **Tags:** `armor-breaking`, `utility`, `deepseek`
- **Why use it:** Armor-breaking plugin unlocking enhanced capabilities for DeepSeek
...
- **Why use it:** Curated bilingual plugin directory; essential starting point for DSH exploration
...
- **Tags:** `knowledge-base`, `awesome-list`, `ai-pedia`
- **Why use it:** Comprehensive AI knowledge base and resource encyclopedia covering agents, RAG, MLOps and more
...
- **Why use it:** Canvas-based non-linear conversation workspace for branching and visual session exploration
...
- **Why use it:** Daily auto-curated plugin discovery with scene-based filtering and community reviews
...
- **Tags:** `guide`, `resource`, `awesome-list`
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, and useful tool recommendations.
...
- **Tags:** `awesome-list`, `catalog`, `resource`
...
- **Tags:** `marketplace`, `catalog`, `store`
- **Why use it:** Plugin store with 11,000+ entries, search, rankings, and free public API.
...
- **Tags:** `anime`, `entertainment`, `deepseek-harness`
- **Why use it:** Fun anime search plugin with Bangumi ratings and magnet link support.
...
- **Why use it:** Smartisan-style note app with Docker deployment, skill integration, and export.
...
- **Why use it:** Curated list of top DSH plugins, great starting point for exploring the ecosystem.
...
- **Tags:** `agent-skills`, `ai-hedge-fund`, `backtesting`, `deepseek`, `deepseek-harness`, `dsh`, `fintech`, `investment-research`, `llm-agents`, `mcp`
- **Why use it:** Alpha Desk — a deepseek-harness (dsh) skill pack that turns an agent session int
...
- **Why use it:** The bioinformatics agent desktop for clinicians and wet-lab scientists — built o
...
- **Why use it:** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness 插件列表h
...
- **Why use it:** Awesome DSH Plugins: a public GitHub directory for DeepSeek Harness plugins, DSH
...
- **Why use it:** StarHub — All-in-One DevOps Desktop Command Center。把开发运维每天要用到的工具收进同一个窗口:数据库客户端 ·
...
- **Why use it:** A fast, simple, and elegant Neovim plugin manager written in Lua!
...
- **Why use it:** A DeepSeek Harness Web plugin for real-time Token usage, cost estimates, per-rou
...
- **Why use it:** Official spam-filtered registry with open-data plugin directory
...
- **Tags:** `stock`, `finance`, `quant`, `trading`, `curated-list`
- **Why use it:** Vertical curated list of 24 verified stock/finance DSH plugins
...
- **Why use it:** Evidence-led verified plugin directory with permission-aware guidance
...
- **Why use it:** Handpicked collection of useful DSH plugins
...
- **Tags:** `awesome-list`, `verified`, `star-ranked`
- **Why use it:** Star-ranked verified community plugin listing for DSH
...
- **Why use it:** Full catalog of 1000+ DSH tools sorted by stars from GitHub topics
...
- **Why use it:** Plugin product manual and navigation with scenario-based recommendations
...
- **Tags:** `awesome-list`, `catalog`, `automated`, `directory`
- **Why use it:** Auto-crawled daily plugin directory via GitHub Actions, bilingual
...
- **Why use it:** Zero-dependency static web portal to discover and install DSH plugins
...
- **Why use it:** Plugin marketplace for DSH similar to CodeX ecosystem

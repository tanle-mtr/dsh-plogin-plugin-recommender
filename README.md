...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,012,244 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-13 00:44:40 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 221,601 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,792 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,237 | Multi-agent swarm orchestration with autonomous wo |
...
- [Research & Analysis](#research-&-analysis) — 35 plugins
...
- [Research & Analysis](research-analysis) (35)
- [Other](other) (28)
---
...
- **Why use it:** Super AI assistant with memory, multi-agent, and self-evolving skills.
...
- **Why use it:** Native terminal coding agent with prefix-cache stability for long runs.
...
- **Tags:** `agent-orchestration`, `mcp`, `skills`
...
- **Tags:** `agent-collaboration`, `workspace`
- **Why use it:** Enterprise-grade local-first multi-agent workbench across harnesses
...
- **Tags:** `agent-ops`, `workflow-automation`
...
- **Tags:** `preset`, `dsh-plugin`, `agent-skills`
- **Why use it:** Two-phase preset with minimal bootstrap and full Standard tools for reliable agent setup
...
- **Why use it:** High-performance Rust-based agent runtime paired with polished desktop application
...
- **Tags:** `security`, `cybersecurity`, `audit`
- **Why use it:** AI security platform that audits code for hallucinated packages, missing safeguards & vulnerabilities
...
- **Why use it:** Coding agent with RPC plugin, sub-agents, hashline edits & MCP support for terminal workflows
...
- **Why use it:** CLI and agent tools for managing and installing DSH plugins from the hub.
...
- **Why use it:** Pixel-to-text OCR tools enabling text-only models to read and analyze images effectively.
...
- **Why use it:** WorkBuddy-style skill picker UI integrated into DSH composer for quick skill insertion.
...
- **Why use it:** Open-source design tool with local-first desktop and AI generation.
...
- **Why use it:** Modern flexible task panel embedding into Codex and DSH with clean interface
...
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thinking, and rollback features
...
- **Why use it:** Cute floating whale widget displaying DeepSeek account balance with drag and snap features
...
- **Tags:** `deepseek`, `desktop`, `dsh-desktop`, `dsh-plugin`, `tauri`
- **Why use it:** Lightweight Tauri desktop version with preset plugins, zero setup needed.
...
- **Tags:** `desktop-app`, `electron`, `local-first`
- **Why use it:** Local-first AI desktop workspace integrating sessions, files, web research & plugins
...
- **Tags:** `desktop-app`, `windows`, `ssh-client`
- **Why use it:** Windows desktop GUI with zero-setup installer, SSH client & mobile remote access
...
- **Tags:** `gui`, `charts`, `interactive`
- **Why use it:** Generates interactive inline UI components — charts, forms, quizzes directly in replies
...
- **Tags:** `canvas`, `visualization`, `conversation`
- **Why use it:** Canvas-based non-linear conversation workspace with visual session branching & exploration
...
- **Why use it:** Local-first multi-model desktop agent with self-evolving skills and privacy-first design
...
- **Tags:** `office`, `ui-extension`
- **Why use it:** Brings spreadsheets, docs, slides and canvases into DeepSeek Harness.
...
- **Tags:** `mobile`, `ui-extension`
- **Why use it:** Native iOS client connecting to DSH via WebSocket for on-the-go use.
...
- **Why use it:** Open-source Smartisan notes clone with Docker deployment and DSH plugin support
...
- **Why use it:** Browse and install community plugins directly from Web GUI
...
- **Tags:** `desktop`, `ui`, `electron`, `management`
...
- **Tags:** `ui`, `information-bar`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Essential info bar showing provider, model, live balance and peak/off-peak pricing in real-time.
...
- **Tags:** `bioinformatics`, `desktop-app`, `llm-agent`, `dsh-plugin`
- **Why use it:** Bioinformatics agent desktop with one-click installers and skill store for researchers.
...
- **Why use it:** Electron desktop shell integrating DSH web UI with sidebar and ModLens.
...
- **Why use it:** Converts chat history into beautiful shareable knowledge cards
...
- **Why use it:** Self-evolving context database unifying memory and RAG for agents.
...
- **Why use it:** Open-source RAG knowledge platform with self-maintaining wiki support.
...
- **Tags:** `memory`, `rag`, `mcp`
- **Why use it:** Local-first portable memory layer with self-evolving agent memory
...
- **Why use it:** Dedicated memory library for building stateful AI agents
...
- **Why use it:** Professional memory management kit for agents with recall and refinement capabilities
...
- **Tags:** `agent`, `memory`, `mcp`, `dsh-plugin`
- **Why use it:** Persistent memory hub giving all AI agents shared long-term context and control.
...
- **Tags:** `skill-rag`, `embeddings`, `reranking`
- **Why use it:** Turns scattered skills into retrievable corpora with embedding & reranking tools
...
- **Tags:** `knowledge-base`, `awesome-list`, `ai-encyclopedia`
- **Why use it:** Comprehensive AI encyclopedia covering LLMs, agents, RAG, multimodal tools & learning roadmaps
...
- **Why use it:** Three-layer proactive memory with zero-prompt recall and skill crystallization
...
- **Tags:** `multi-agent`, `agentic-workflow`, `mcp-server`
- **Why use it:** Multi-agent swarm orchestration with autonomous workflow support.
...
- **Tags:** `skills`, `workflow`, `marketplace`
- **Why use it:** Largest skill marketplace with auto-collected GitHub skill projects
...
- **Why use it:** Intelligent skill routing and workflow orchestration with proven token efficiency gains
...
- **Tags:** `cognitive`, `agent-skills`, `research`
...
- **Tags:** `ai-video`, `ffmpeg`, `dsh-plugin`, `tts`
...
- **Why use it:** Enables multi-agent team coordination and collaborative task execution in DSH.
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, long screenshot OCR, UI restoration.
...
- **Tags:** `ai-writing`, `novel`, `rag`, `dsh-plugin`
- **Why use it:** Complete novel writing workflow from inspiration to editing with RAG-backed organization.
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`
- **Why use it:** Gives agents eyes & ears — converts video, audio, screenshots into searchable timestamped evidence
...
- **Why use it:** One-stop research workbench: LaTeX editing, arXiv management, experiment tracking & GPU SSH
...
- **Tags:** `creative-writing`, `agent-skills`
- **Why use it:** Full creative writing workbenches for novels, dramas, and video recaps.
...
- **Tags:** `task-management`, `agent-workflow`
- **Why use it:** SQLite-backed local taskboard with agent claim review and native Web UI.
...
- **Tags:** `math-modeling`, `agent-skill`
- **Why use it:** Full-stack math modeling competition skill with GitOps pipeline and self-proof.
...
- **Tags:** `skills`, `agent`, `codex`, `claude`
...
- **Why use it:** Adds multimodal vision to Claude Code for screenshot and UI layout automation
...
- **Tags:** `infra`, `ai-infra`, `debugging`
- **Why use it:** Specialized skills for AI infrastructure development, code optimization and debugging
...
- **Why use it:** Comprehensive reverse engineering skill pack for DSH agents
...
- **Tags:** `agent-skill`, `coding-agent`, `code-review`
- **Why use it:** AI coding mentor with project analysis, auto grading and code review
...
- **Why use it:** 25 ready-to-use engineering skills in sidebar, no manual install needed
...
- **Tags:** `document`, `gongwen`, `workflow`, `skill`
- **Why use it:** Full government document pipeline: format check, optimization, template generation
...
- **Tags:** `spec-driven`, `skill`, `coding`
- **Why use it:** Repository-native spec-driven development skill for DSH/Codex/Claude Code
...
- **Tags:** `ai-agent`, `chinese-traditional-wisdom`, `fengshui`, `dsh-plugin`
- **Why use it:** Unique AI agent skill covering Bazi, Fengshui, IChing and TCM with local deterministic engine.
...
- **Tags:** `ai-roleplay`, `interactive-narrative`, `agent-skills`, `dsh-plugin`
- **Why use it:** Immersive interactive narrative skill with NPC memory, YAML save system and random starts.
...
- **Tags:** `code-simplification`, `skill`, `dsh-plugin`
- **Why use it:** Adapted Codex skill for code simplification, directly applicable in DSH agent workflows.
...
- **Tags:** `qa`, `testing`, `agent-skills`, `dsh-plugin`
- **Why use it:** Professional QA testing framework with 11 skills and knowledge base for AI agent test automation.
...
- **Tags:** `agent-handoff`, `session-memory`, `cross-platform`, `dsh-plugin`
- **Why use it:** Cross-platform session memory skill enabling continuity handoff between Codex and DSH agents.
...
- **Why use it:** Generates beautiful, verifiable architecture and workflow diagrams.
...
- **Why use it:** 530+ image prompt templates and skills for GPT Image generation.
...
- **Why use it:** AI-powered design studio with editable systems, template marketplace, and PPT.
...
- **Tags:** `visualization`, `legal`, `svg`, `diagram`
- **Why use it:** Draw litigation timelines and case diagrams as SVG, input-ready for materials
...
- **Why use it:** AI video/image/audio creation suite with DirectorX integration and configurable vision tools.
...
- **Why use it:** First virtual terminal for AI agents with VFS, bash, and virtual filesystem support
...
- **Why use it:** Self-evolving cross-platform content discovery agent covering B站, YouTube, Reddit, and more
...
- **Why use it:** Seamlessly let AI agents control your logged-in browser for real-world tasks.
...
- **Why use it:** Free no-signup web search bridge for all DSH models without native browser access
...
- **Tags:** `ios`, `automation`
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools in chat.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services globally.
...
- **Tags:** `routing`, `agent`, `infrastructure`
- **Why use it:** Runtime injector and task-aware reasoning-mode router for agents
...
- **Tags:** `marketplace`, `dsh-plugin`, `ui`
- **Why use it:** Built-in plugin marketplace with browse, search, and one-click install for DSH
...
- **Why use it:** One-click install and model switcher supporting Claude Code, Codex, Grok, Kimi, and more
...
- **Why use it:** Self-hostable ecosystem radar discovering and validating 15900+ candidate plugins.
...
- **Tags:** `dsh-plugin`, `dsh-external`
- **Why use it:** Comprehensive context insight dashboard with sidebar, browser, and command tools.
...
- **Why use it:** Curated list of DSH ecosystem plugins, tools, and infrastructure from multiple sources.
...
- **Why use it:** Community-curated plugin ecosystem list covering agents, CLI, and web UI tools.
...
- **Tags:** `dsh-plugin`, `plugin-market`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with pre-published review filtering.
...
- **Why use it:** Tracks session daily costs budget and token usage across multiple providers.
...
- **Why use it:** Bridge Pi ecosystem to DSH via ABI compatibility layer for seamless migration
...
- **Why use it:** P2P encrypted remote access to DSH from PC, Android and Web across devices
...
- **Why use it:** Full backup and restore for DSH config, MCPs, and skills
...
- **Tags:** `api-docs`, `chinese-api`, `utility`
- **Why use it:** Search 65,600+ Chinese API docs across 20 platforms, zero config
...
- **Tags:** `plugin`, `registry`, `infrastructure`
- **Why use it:** Plugin registry console and official development guide for DSH ecosystem
...
- **Why use it:** Unified local Agent Skills loader and manager with safety controls in DSH
...
- **Tags:** `directory`, `awesome-list`, `plugin`
- **Why use it:** Curated directory of 280+ plugins across 14 categories for DSH ecosystem
...
- **Why use it:** On-demand plugin development knowledge base with official EN/ZH docs archive
...
- **Why use it:** Reusable Codex skill to scaffold, build and validate DSH and Cordis plugins
...
- **Tags:** `context`, `audit`, `tool`, `ui`, `dsh-plugin`
- **Why use it:** Audit tool for AGENTS.md instruction chains, detects duplicate and conflicting tokens efficiently.
...
- **Tags:** `container`, `management`, `dsh-plugin`
- **Why use it:** Container-based DSH version management with isolated environments and embedded WebView UI.
...
- **Tags:** `dsh-plugin`, `troubleshooting`, `utilities`
...
- **Why use it:** Public gallery of animated mascot pets for multiple AI harnesses
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** Whale girl skin series for DeepSeek Harness UI customization.
...
- **Why use it:** Highly customizable glassmorphism theme with adjustable blur, opacity & animated backgrounds
...
- **Tags:** `theme`, `animated`, `threejs`
- **Why use it:** Animated ocean theme with adjustable waves, sunset effects & glass opacity via DSH plugin
...
- **Tags:** `theme`, `background`, `webui`
- **Why use it:** Web background customization: upload images or switch preset atmospheres.
...
- **Why use it:** Curated plugin list for discovering DSH ecosystem tools
...
- **Tags:** `awesome-list`, `research`
- **Why use it:** Daily auto-crawls GitHub to filter and classify real DSH plugins for you.
...
- **Tags:** `guide`, `awesome-list`
- **Why use it:** Ultimate guide with quickstart resources curated plugins and toolkits.
...
- **Why use it:** Curated list of plugins skills MCP servers patches and UIs for DSH.
...
- **Why use it:** Plugin store with 11000+ entries search rankings install commands and API.
...
- **Why use it:** Multi-source academic search with citation verification and MeSH support for Chinese researchers
...
- **⭐ Stars:** 186
- **Language:** Python
- **Description:** 基于tushare构建本地财经数据库。AI原生的多Agent金融分析系统，支��skill拓展Agent能力并自适应生成http接口与mcp调用。支持本地数据库访问的skill对接deepseek-harness/openclaw等通用智能体与微信/QQ/飞书等IM通道盯盘
- **Tags:** `finance`, `stock`, `mcp`
- **Why use it:** Local financial database with Tushare, supports multi-agent analysis and IM alerts
...
- **Tags:** `fintech`, `backtesting`, `research`
...
- **Why use it:** Industry and company research skill pack with methodology tools
...
- **Why use it:** Patent infringement analysis with competitor reports and prior-art search
...
- **Tags:** `finance`, `kline`, `analysis`, `dsh-plugin`
- **Why use it:** Interactive K-line financial analysis plugin with multi-market data, indicators and news feed.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `coding-agent`
...
- **Tags:** `awesome-list`, `dsh-plugins`, `registry`
...
- **Why use it:** Real-time token usage, cost charts, and API balance tracking dashboard.
...
- **Tags:** `awesome-list`, `curated-list`, `dsh`
- **Why use it:** 2026 DSH plugins curated list with quality checks.
...
- **Why use it:** Curated stock/finance/quant plugins for DSH — 24 verified bilingual entries.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Collection of useful DeepSeek Harness plugins for community reference.
...
- **Tags:** `awesome-list`, `registry`, `dsh-plugin`
- **Why use it:** Complete 1000+ repo DSH tool list sorted by stars from dsh-plugin topic.
...
- **Why use it:** Curated star-ranked plugin list for DSH discovery
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin navigation guide covering install, permissions and risks
...
- **Tags:** `awesome-dsh-plugin`, `static-site`
- **Why use it:** Static web portal to browse and install 227+ curated DSH plugins
...
- **Why use it:** CodeX-like plugin marketplace for DSH ecosystem exploration
...
- **Why use it:** Curated DSHA plugin collection for quick reference
...
- **Tags:** `plugin-registry`, `plugin-radar`
...
- **Tags:** `plugin-verify`, `repository`
- **Why use it:** DSH plugin repository and verification directory
...
- **Why use it:** Redirect to the canonical awesome-dsh-plugin repository
...
- **Tags:** `no-code`, `low-code`, `crm`, `erp`
- **Why use it:** AI-enhanced no-code platform for building CRM, ERP, and business apps.
...
- **Why use it:** Curated bilingual awesome list of all DSH plugins, tools, skills, and integrations
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, search and filtering support
...
- **Why use it:** Skill that discovers, installs and verifies GitHub plugins for DSH automatically
...
- **Why use it:** Official curated list of DSH plugins, auto-maintained
...
- **Why use it:** Curated plugin list with productivity tools and resources
...
- **Why use it:** UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预
...
- **Why use it:** Double-check before you ship: grill the 
...
- **Why use it:** The ultimate 2-way bridge between OpenAI
...
- **Tags:** `dsh`, `dsh-plugin`, `dsh-plugins`, `skill`, `skills`
- **Why use it:** dsh-plugin-developer — DeepSeek Harness 
...
- **⭐ Stars:** 22
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness 的电���感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。
- **Tags:** `agent-skills`, `deepseek-harness`, `motion-design`, `remotion`, `typescript`, `video`
- **Why use it:** 面向 DeepSeek Harness 的电���感产品视频 Agent Ski
...
- **Why use it:** 释放 DeepSeek Harness 插件化内核能力，将 Runtime、Pr
...
- **Why use it:** An Agent Skills skill for developing Dee
...
- **Why use it:** Curated bilingual plugin directory with immutable reviews
...
- **Tags:** `awesome-list`, `deepseek-harness`, `automation`
- **Why use it:** Auto-updating plugin list with YAML and Vercel deployment

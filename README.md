...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 915,724 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-30 19:12:34 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 204,565 | Core DSH platform — everything is a plugin archite |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,808 | Open-source design system tool with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,809 | Original multi-agent meta-harness enabling swarm i |
...
- **Tags:** `coding-agent`, `dsh-plugin`, `r1`
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for extended use
...
- **Why use it:** Task-aware reasoning-mode router injector for optimized DSH routing.
...
- **Tags:** `preset`, `standard`, `dsh-plugin`
- **Why use it:** Two-phase standard preset ensuring minimal bootstrap then full tool coverage.
...
- **Tags:** `runtime`, `ide`, `agent`
- **Why use it:** Rust-based high-performance agent runtime paired with polished desktop IDE
...
- **Why use it:** Powerful vision toolkit with OCR and screenshot analysis
...
- **Tags:** `plugin-dev`, `agent-skill`, `dsh-plugin`
- **Why use it:** Agent skill for developing and packaging DSH plugins standard
...
- **Tags:** `plugin-creator`, `scaffold`, `validator`
...
- **Why use it:** Two-way Codex-DSH sync with MCP mirroring
...
- **Why use it:** Context audit tool with token cost analysis and conflict detection
...
- **Tags:** `plugin-development`, `audit`, `harness-tools`
...
- **Tags:** `web-ui`, `plugin-aggregator`, `dsh-web`
...
- **Why use it:** Open sidebar foundation with built-in file, terminal, chat, Git and sub-agent pages
...
- **Tags:** `task`, `ui`, `panel`
- **Why use it:** Modern task panel flexibly embeds into Codex and DeepSeek Harness workflows
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought and Esc rollback
...
- **Why use it:** Lightweight 5MB Tauri desktop with preset plugins, no setup
...
- **Tags:** `floating-widget`, `developer-tools`, `dsh-plugin`
- **Why use it:** Cute floating whale widget monitors your DeepSeek balance
...
- **Why use it:** Runs live iOS Simulator or connected iPhone directly within DSH conversations
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with full plugin ecosystem
...
- **Why use it:** Feature-rich open-source Windows desktop client with SSH and mobile remote access
...
- **Tags:** `office`, `ui`
- **Why use it:** Brings full office suite (docs, sheets, slides) into DSH
...
- **Why use it:** Web UI panel for managing skills and MCP tools directly in DSH.
...
- **Tags:** `desktop-app`, `electron`, `dsh-plugin`
- **Why use it:** Electron-based desktop hub for multi-tab DSH plugin management
...
- **Why use it:** WorkBuddy-style skill picker for quick command insertion in DSH
...
- **Why use it:** Persistent bottom bar showing model, balance and live pricing info
...
- **Tags:** `canvas`, `cordis`, `creative`
- **Why use it:** Infinite canvas with creative skills for DSH workflow
...
- **Why use it:** Tauri desktop integrating DB, SSH, Docker with AI
...
- **Tags:** `dsh-plugin`, `ui`, `customization`, `theme`
- **Why use it:** Customize DSH web UI background with images and preset atmospheres.
...
- **Why use it:** Enterprise-grade open-source RAG platform with semantic search, Wiki and agent reasoning
...
- **Tags:** `memory`, `rag`, `agent-memory`, `long-term-memory`
...
- **Why use it:** Essential memory kit for persistent agent recall and refinement
...
- **Why use it:** Provides unlimited memory capabilities for OpenClaw agents
...
- **Why use it:** Converts SKILL.md files into searchable, retrieval-ready agent skill corpora
...
- **Tags:** `multi-agent`, `mcp-server`, `dsh-plugin`
- **Why use it:** Original multi-agent meta-harness enabling swarm intelligence and autonomous workflows
...
- **Why use it:** Super AI assistant harness with self-evolving memory, knowledge and multi-model support
...
- **Why use it:** Solid beginner tutorial from 0 to 1 for harness engineering.
...
- **Tags:** `agent-orchestration`, `multi-device`, `no-code`
- **Why use it:** Unified agent workspace across all devices with task board and self-hosting.
...
- **Why use it:** Self-improving agent OS with built-in LLM evaluation and loop engineering.
...
- **Why use it:** Enterprise multi-agent workspace supporting Codex, DSH, and OpenClaw engines.
...
- **Why use it:** First vision plugin enabling OCR and image-to-JSON for text-only agents.
...
- **Why use it:** Intelligent skill routing cuts tokens 29.6% while boosting reward +21pp
...
- **Why use it:** End-to-end Vox-style paper-collage video generation agent skill
...
- **Why use it:** Enables multi-agent team coordination for DSH
...
- **Tags:** `ai-workflow`, `browser-extension`, `dsh-plugin`
...
- **Tags:** `task`, `agent`
- **Why use it:** Native task management with SQLite and clean Web UI
...
- **Why use it:** Specialized skill for creative novel and drama writing
...
- **Tags:** `math`, `modeling`
- **Why use it:** Full-stack automated math modeling with GitOps pipeline
...
- **Why use it:** Turns experience into repeatable execution across agents
...
- **Why use it:** Comprehensive reverse-engineering and pentest skill with 87 modules
...
- **Why use it:** Superpowers skill ported for Reasonix coding harness
...
- **Tags:** `agent-skills`, `research`, `deepseek-harness`
- **Why use it:** 88 open-source skills for research, marketing, and social workflows
...
- **Why use it:** AI coding mentor skill with architecture analysis and code review
...
- **Tags:** `agent-skills`, `credentials`, `slots`
- **Why use it:** Manages installed DSH plugins, slots, and credentials seamlessly
...
- **Tags:** `skills`, `task-board`, `agent`
- **Why use it:** Visual task board for MattSkillsDeck within DSH environment
...
- **Tags:** `fengshui`, `iching`, `bazi`, `tcm`
- **Why use it:** Bazi, Fengshui, IChing and TCM all-in-one wisdom agent skill
...
- **Why use it:** Full pipeline Chinese official document writing and formatting tool
...
- **Tags:** `agent-handoff`, `context-engineering`, `memory`
- **Why use it:** Preserves context and objectives for seamless multi-agent handoffs
...
- **⭐ Stars:** 25
- **Language:** JavaScript
- **Description:** DSH Skills Manager — 在 DeepSeek Harness ���统一加载并安全管理本机 Agent Skills · Load and safely manage local Agent Skills in DSH
- **Tags:** `dsh-plugin`, `agent-skills`
- **Why use it:** Unified skill loading and management in DSH
...
- **Tags:** `code-simplification`, `skills`
- **Why use it:** Adapted Codex skill for code simplification workflows
...
- **Why use it:** All-in-one agent asset package: 42 skills, 5 CLIs, database tools
...
- **Tags:** `skill-generator`, `agent-learning`, `dsh`
...
- **Tags:** `swift-cycle`, `agent-skills`, `governance`
...
- **Why use it:** Fun photo wall with OAuth and DSH Skill packaging
...
- **Why use it:** Godot 4.x game dev skill integrated into DSH
...
- **Why use it:** Virtual product team agent preset simulating PM to QA workflows.
...
- **Why use it:** Hot-reload MCP config UI for DSH, no restart needed
...
- **Tags:** `agent-tools`, `plugin-discovery`, `capability-index`
- **Why use it:** Pre-flight check injects top-K relevant plugins for task requests.
...
- **Tags:** `chatgpt`, `oauth`, `mcp`, `integration`
- **Why use it:** OAuth integration to chat with ChatGPT models inside DSH directly.
...
- **Why use it:** Open-source design system tool with local-first desktop and AI agent integration
...
- **Why use it:** AI-powered architecture diagram generator with mermaid alternative and motion effects
...
- **Why use it:** 530+ industrial-grade image generation prompts with reusable skills and templates
...
- **Tags:** `design`, `vector`, `agent-team`, `ui`
...
- **Why use it:** Renders interactive UI components—charts, layouts, forms, quizzes—inline
...
- **Tags:** `image-generation`, `stable-diffusion`, `genai`
- **Why use it:** Generate images directly inside DSH conversations via multiple AI models
...
- **Tags:** `canvas`, `workspace`, `non-linear`
...
- **Why use it:** Preview and edit .op documents directly within DSH conversations.
...
- **Why use it:** Legal timeline and litigation diagram visualization for lawyers
...
- **Why use it:** Enables text-only models to read images via OCR and pixel scanning
...
- **Why use it:** AI video/image/audio skills with configurable vision tools
...
- **Why use it:** Enhancement suite for major AI chat platforms plus cross-platform prompt management
...
- **Why use it:** Best free web search bridge for all models without native web access
...
- **Why use it:** Playwright-based browser automation plugin for DeepSeek Harness
...
- **Why use it:** Ultimate image uploader supporting 60+ services, integrates with Obsidian and VS Code
...
- **Tags:** `vfs`, `virtual-filesystem`, `tools`
- **Why use it:** Unified virtual filesystem abstracting storage for AI agents across languages.
...
- **Why use it:** One-click model switch across Claude, Codex, Grok, DeepSeek and more
...
- **Why use it:** Built-in visual plugin marketplace for browse, search and one-click install
...
- **Why use it:** Dashboard and commands for context insight and management
...
- **Why use it:** AI security platform auditing code for hallucinations, vulnerabilities and safeguards
...
- **Tags:** `cost`, `utility`
- **Why use it:** Essential token and budget tracking for DSH sessions
...
- **Tags:** `migration`, `bridge`
- **Why use it:** Bridges Pi ecosystem plugins as native DSH extensions
...
- **Why use it:** Enables cross-preset session migration while preserving context and state.
...
- **Why use it:** Private note-taking app with One-click Docker deployment and DSH integration.
...
- **Why use it:** Browse and install all dsh-plugin GitHub plugins from the Web GUI.
...
- **Why use it:** Crash rescue plugin with snapshot rollback and SAFE MODE recovery.
...
- **Why use it:** Secure P2P multi-device remote access to your DeepSeek Harness.
...
- **Why use it:** Unified menu to manage MCP tools and skill exposure levels
...
- **Why use it:** Official plugin registry console and dev skill scaffolding tool
...
- **Tags:** `container`, `infrastructure`, `multi-version`
- **Why use it:** Run multiple isolated DSH instances via containers with embedded UI
...
- **Tags:** `migration`, `mcp`, `configuration`
- **Why use it:** One-click migration from Claude Code to DSH
...
- **Why use it:** Real-time token usage and cost monitoring dashboard
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** ���面版 DeepSeek Harness：Electron 壳 + 自托管 dsh web 服务，集成 dsh-better-sidebar / dsh-web-ui / ModLens / awesome-dsh-plugin / dshmarket
- **Tags:** `deepseek-harness`, `dsh`, `electron`, `integration`
- **Why use it:** Electron wrapper with integrated DSH web services and plugins.
...
- **Why use it:** Detects and resolves plugin conflicts for smoother DSH operation.
...
- **Why use it:** Public gallery of animated mascot pets across major coding agent platforms.
...
- **Why use it:** Adorable whale girl skin series for DeepSeek Harness visual customization
...
- **Why use it:** 34 opencode themes with one-click DSH skin switching
...
- **Tags:** `ai`, `llm`, `rag`, `vibecoding`
- **Why use it:** Comprehensive AI resource hub covering LLMs, prompts, and vibe-coding tutorials.
...
- **Why use it:** Essential curated plugin list for discovering DSH ecosystem tools.
...
- **Tags:** `content-discovery`, `research`, `privacy-first`
- **Why use it:** Local-first AI agent auto-discovers content from Bilibili, Douyin, YouTube and more
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day trend research reports
...
- **Why use it:** Auto-discovers and validates 15900+ plugins with k8s testing
...
- **Why use it:** Curated ecosystem list for discovering DSH plugins
...
- **Tags:** `guide`, `dsh`
- **Why use it:** Excellent intro to DSH principles and best practices
...
- **Tags:** `awesome`, `guide`
- **Why use it:** Comprehensive DSH guide with curated resources and tools
...
- **Why use it:** Largest plugin marketplace with 11K+ plugins and search
...
- **Tags:** `awesome`, `mcp`
- **Why use it:** Curated list covering plugins, MCP servers, and orchestrators
...
- **Tags:** `academic-search`, `arxiv`, `mcp`
- **Why use it:** Comprehensive academic search with citation graphs across multiple databases.
...
- **Why use it:** Search 65k+ API docs from 20 Chinese platforms directly in agents
...
- **Why use it:** Patent infringement analysis system producing competition reports
...
- **Tags:** `industry-research`, `report`, `dsh`
- **Why use it:** Industry research methodology and policy tracking pack
...
- **Why use it:** Unofficial community catalog for plugin discovery
...
- **Tags:** `awesome-list`, `dsh-plugin`, `curated`
- **Why use it:** Curated evidence-led directory with verified plugin recommendations.
...
- **Tags:** `awesome-list`, `dsh`, `deepseek-harness`
...
- **Why use it:** Star-ranked verified community plugins for DSH ecosystem.
...
- **Tags:** `awesome-list`, `plugin-guide`, `dsh-plugin`
...
- **Tags:** `plugin-portal`, `awesome-list`, `web`
- **Why use it:** Static web portal for browsing and installing 227+ curated DSH plugins.
...
- **Why use it:** Complete 1000+ repository list sorted by stars for DSH ecosystem.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `curated`
- **Why use it:** Curated plugin directory with verification and ecosystem resources.
...
- **Why use it:** Plugin radar with evidence-backed curation and lab
...
- **Tags:** `discoverability`, `dsh-plugin`, `search`
...
- **Tags:** `deepseek-harness-plugins`, `curated-list`, `ui`
...
- **Tags:** `industry`, `awesome-list`, `plugin-directory`
- **Why use it:** Industry-specific plugins for CS, finance, law, HR, manufacturing
...
- **Why use it:** Privacy-focused open-source resume builder with full customization and MCP support
...
- **Why use it:** Open-source no-code platform for rapid AI-powered business system development
...
- **Tags:** `toy`, `web`, `culture`
- **Why use it:** Zero-dependency web simulation of traditional Chinese buzzing toy with real audio
...
- **Tags:** `armor-breaking`, `dsh-plugin`
- **Why use it:** Armor-breaking plugin for DeepSeek prompt stabilization
...
- **Why use it:** Comprehensive curated list of DSH plugins, extensions and integrations
...
- **Why use it:** Daily-curated DSH plugin directory with ratings, categories and usage guides
...
- **Tags:** `encyclopedia`, `resource`, `ai-nav`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, MLOps and more
...
- **Why use it:** Plugin collection for DeepSeek Harness ecosystem
...
- **Why use it:** Fun anime search plugin with Bangumi ratings and magnet links.

...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,007,512 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-12 00:01:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 220,529 | Core DSH platform powering the entire plugin ecosy |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,621 | Open-source design system and UI generator for cod |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,136 | Multi-agent swarm framework for autonomous workflo |
...
- **Tags:** `dsh-plugin`, `cordis`, `routing`, `ai-agents`
- **Why use it:** Injector + router-standard kit enabling task-aware reasoning mode selection.
...
- **Tags:** `agent-collaboration`, `multi-agent`, `dsh-plugin`, `visual-editor`
- **Why use it:** Enterprise multi-agent workbench unified across Codex, DSH, and OpenCode.
...
- **Tags:** `agent-os`, `mcp`, `llm-orchestration`, `loop-engineering`, `skill`
- **Why use it:** Self-improving Agent OS with interview-gated evaluation and budgeted loops.
...
- **Why use it:** First vision plugin bridging images to text-only coding agents via structured JSON
...
- **Tags:** `preset`, `deepseek-harness`, `dsh-plugin`, `llm-agent`
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for reliable setup
...
- **Tags:** `multi-agent`, `switch`, `dsh-plugin`, `coding-agent`
...
- **Tags:** `agent-runtime`, `rust`, `dsh-plugin`, `coding-agent`
...
- **Tags:** `agent`, `dsh-plugin`, `agent-teams`
...
- **⭐ Stars:** 874
- **Language:** TypeScript
- **Description:** [dsh]为纯��本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
...
- **Why use it:** Coding agent with sub-agents, RPC, hashline edits, and MCP integration for terminal use
...
- **Why use it:** CLI and agent tools for managing and discovering DSH plugins from the hub
...
- **Tags:** `provider`, `model-access`, `plan-mode`
...
- **Tags:** `ai-infra`, `coding`, `skills`, `optimization`
...
- **Why use it:** Adapted TDD, debugging, and planning skills from obra/superpowers
...
- **Tags:** `claude-code`, `migration`, `deepseek-harness`
- **Why use it:** Migration wizard moving sessions and skills from Claude Code, Codex, etc.
...
- **Tags:** `diagnostics`, `plugin-management`, `dsh-plugin`
...
- **Why use it:** OAuth-based ChatGPT subscription binding inside DSH
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `dsh-plugin`, `cli`
- **Why use it:** Animated pet gallery enhancing Codex, Claude Code, DSH and other CLI tools.
...
- **Tags:** `sidebar`, `deepseek-harness`, `dsh-plugin`, `ui`
...
- **Tags:** `taskboard`, `ui`, `dsh-plugin`, `cli`
...
- **Tags:** `tui`, `terminal`, `dsh-plugin`, `ui`
- **Why use it:** Claude Code-style TUI with whale theme, real-time status and streaming thinking
...
- **Why use it:** Cute floating whale widget tracking DeepSeek account balance with animations
...
- **Why use it:** Lightweight 5MB desktop app with zero setup required.
...
- **Tags:** `desktop`, `electron`, `local-first`, `ai-workbench`
- **Why use it:** Local-first desktop workspace with projects, files, web research and plugins
...
- **Tags:** `desktop`, `windows`, `gui`, `ssh`, `codex`
- **Why use it:** Windows desktop GUI with Codex, SSH, mobile remote access and zero-setup install
...
- **Tags:** `canvas`, `conversation`, `workspace`, `visual`
- **Why use it:** Visual canvas-based non-linear conversation workspace with session branching
...
- **Tags:** `desktop`, `tauri`, `multi-model`, `local-first`
- **Why use it:** Local-first Tauri desktop app with multi-model support and self-evolving skills
...
- **Tags:** `office`, `univer`, `productivity`
...
- **Why use it:** Native iOS mobile client bringing DSH workspaces and agent tracks to iPhone
...
- **Why use it:** Secure P2P encrypted remote access to Harness from PC, Android and Web.
...
- **Why use it:** Smartisan-style notes app with one-click Docker, skill calls and WeChat/QQ/Qidian integration.
...
- **Tags:** `marketplace`, `ui`, `plugins`, `webui`
- **Why use it:** One-click install community plugins directly from DSH Web GUI
...
- **Tags:** `deepseek-harness`, `mcp`, `ui`
- **Why use it:** Web UI plugin to manage skills and MCP servers via browser settings.
...
- **Tags:** `electron`, `desktop-app`, `modlens`
- **Why use it:** Electron-based desktop wrapper integrating DSH web services and ModLens
...
- **Why use it:** One-click compact button to simplify the DSH Web context meter panel
...
- **Tags:** `agent-memory`, `rag`, `mcp`, `skills`, `long-term-memory`
- **Why use it:** Portable, local-first memory layer with user-owned Markdown-native storage.
...
- **Tags:** `memory`, `rag`, `skills`, `mcp`, `token-savings`
...
- **Tags:** `agent-memory`, `agentic-rag`, `memory`, `context-engineering`
- **Why use it:** Memory library for stateful agents with agent-driven RAG capabilities.
...
- **Why use it:** Dedicated memory management kit with RAG support for persistent agent knowledge
...
- **Tags:** `memory`, `milvus`, `rag`, `dsh-plugin`
...
- **Why use it:** Personal AI agent with shared persistent memory for all tools.
...
- **Tags:** `evaluation`, `rag`, `knowledge-engineering`
...
- **Tags:** `agent-orchestration`, `skills`, `mcp`, `no-code`, `local-first`
...
- **⭐ Stars:** 6,558
- **Language:** Python
- **Description:** ���录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **Tags:** `skills`, `agent-skills`, `dsh-plugin`, `finance-skill`, `office-skill`
- **Why use it:** Most comprehensive skill store with auto-collected GitHub skills by category.
...
- **Tags:** `agent-control-plane`, `workflow-automation`, `long-horizon`, `dsh-plugin`
- **Why use it:** Long-horizon control plane for durable, governed multi-agent work orchestration.
...
- **Tags:** `skills`, `workflow`, `dsh-plugin`, `agent-framework`
- **Why use it:** Intelligent skill routing and workflow orchestration boosting rewards and efficiency
...
- **Tags:** `cognitive`, `skills`, `dsh-plugin`, `ai-agent`
...
- **Tags:** `ai-video`, `skill`, `dsh-plugin`
- **Why use it:** End-to-end AI video generation with automated workflow.
...
- **Tags:** `ai-writing`, `dsh-plugin`, `novel`
- **Why use it:** Organized AI novel writing software with controllable creative workflow.
...
- **Tags:** `skill`, `computer-vision`, `ocr`, `multimodal`
- **Why use it:** Gives agents eyes and ears by converting video, audio, and screen activity into evidence
...
- **Tags:** `math-modeling`, `competition`, `automation`
...
- **Why use it:** Enables composable, reviewable, self-improving agent workflows with isolated task controls.
...
- **Tags:** `skills`, `agent`, `codex`, `claude-code`
- **Why use it:** Turns experience into repeatable execution across Codex, Claude Code, and DSH.
...
- **Why use it:** Local financial DB with multi-agent stock analysis, auto-generates MCP and HTTP APIs.
...
- **Tags:** `skills`, `research`, `marketing`, `social-intelligence`
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill pack for security research
...
- **Why use it:** AI investment desk with multi-strategy backtesting and compliance checks
...
- **Tags:** `agent`, `skill`, `mentor`
- **Why use it:** AI coding mentor that guides learners through project architecture and code review.
...
- **Why use it:** 25 ready-to-use engineering skills including triage, grilling, wayfinder in sidebar.
...
- **Tags:** `document`, `gongwen`, `office`
- **Why use it:** GB/T 9704 compliant official document processor with format check, optimization and template generation.
...
- **Why use it:** Portable spec-driven development skill informed by public DSH engineering patterns.
...
- **Why use it:** Unique fusion of Bazi, Fengshui, TCM into a deterministic AI agent skill.
...
- **Tags:** `ocr`, `vision`, `image-reading`, `skill`
- **Why use it:** Enables text-only models to process images via pixel-level OCR skill.
...
- **Tags:** `multi-agent`, `collaboration`, `skill`
...
- **Why use it:** Adapted Codex skill for automated code simplification in DSH agents.
...
- **Tags:** `video`, `ai-creation`, `skill`
- **Why use it:** Full AI video/image/audio production pipeline with storyboard support.
...
- **Why use it:** WorkBuddy-style skill picker speeds up skill selection in composer.
...
- **Tags:** `roleplay`, `narrative`, `skill`
- **Why use it:** Rich interactive narrative RPG skill with memory, YAML存档 and random plots.
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-assisted test automation.
...
- **Why use it:** Cross-platform agent handoff skill with repo-local continuity memory.
...
- **Tags:** `deepseek-harness`, `engineering-discipline`, `quality-gate`
...
- **Why use it:** Godot 4.x full-stack game dev skill for DSH AI agents.
...
- **Why use it:** Skill guiding AI to build, test, and install DSH plugins from scratch.
...
- **Tags:** `agent-skills`, `remotion`, `video`
...
- **Why use it:** Agent Skill for developing DSH plugins: services, events, tools, adapters.
...
- **Why use it:** Auto-preflights and injects Top-K relevant plugins per task
...
- **Why use it:** Search npm + curated list for plugin discoverability from agents
...
- **Tags:** `api-docs`, `chinese-platforms`, `mcp`
- **Why use it:** Searches 65,600+ Chinese platform API docs directly in coding agents, zero config.
...
- **Tags:** `codex`, `deepseek-harness`, `mcp`
...
- **Why use it:** Open-source design system and UI generator for coding agents
...
- **Tags:** `design`, `vibedesign`, `ui`, `mcp`, `flutter`, `react`
...
- **Tags:** `design`, `dsh-plugin`, `visual`
- **Why use it:** AI-native design studio with editable templates and PPT support.
...
- **Why use it:** Interactive UI components like charts, plots, forms rendered inline in assistant replies
...
- **Why use it:** Litigation visualization toolkit that transforms case materials into clear timeline diagrams.
...
- **Why use it:** 6 design aesthetic styles to prevent AI-looking websites.
...
- **Tags:** `content-discovery`, `bilibili`, `dsh-plugin`, `ai-agent`
- **Why use it:** Cross-platform content discovery agent covering B站, YouTube, Reddit and more
...
- **Why use it:** DingTalk IM channel with stream-mode agent chat support
...
- **Why use it:** Privacy-first self-hosted resume builder for professionals
...
- **⭐ Stars:** 1,462
- **Language:** Python
- **Description:** DSH Plugin Radar — 开源可自部署的 DSH 插件生态雷达：��动发现 15900+ 候选、k8s 运行级实测管线；自动索引可用Plugin List
- **Tags:** `plugin`, `ecosystem`, `dsh-plugin`
- **Why use it:** Self-hosted plugin radar discovering 15900+ candidates automatically.
...
- **Tags:** `context`, `dsh-plugin`, `utility`
- **Why use it:** Comprehensive context insight dashboard and management tool.
...
- **Tags:** `security`, `redteam`, `audit`, `cybersecurity`
...
- **Tags:** `provider`, `oauth`, `subscription`, `utility`
...
- **Tags:** `task-management`, `project-board`, `sqlite`
- **Why use it:** Native taskboard with SQLite backend and clean Web UI for project management
...
- **Why use it:** Track session/daily costs, budgets, and multi-provider token usage
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, search and filter by category.
...
- **Tags:** `handbook`, `documentation`, `runtime`, `sandbox`
- **Why use it:** Comprehensive 173-resource handbook covering runtime, plugins, MCP, sandbox and troubleshooting.
...
- **Why use it:** Skill that searches, installs and verifies GitHub DSH plugins automatically.
...
- **Why use it:** Curated awesome list of DeepSeek Harness plugins for quick discovery.
...
- **Why use it:** Automates plugin upgrades synced with DSH version updates
...
- **Why use it:** Full backup and restore for DSH config, plugins, MCPs, and skills via WebDAV
...
- **Tags:** `mcp`, `tools`, `configuration`, `menu`
...
- **Why use it:** DSH ecosystem infrastructure: plugin registry console and official plugin dev guide.
...
- **Tags:** `context`, `utility`, `ui`, `audit`
- **Why use it:** Audits context token costs, detects duplicates and conflicts in skills.
...
- **Tags:** `infra`, `container`, `management`
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `awesome-list`, `plugin-catalog`, `dsh`
- **Why use it:** Curated DSH plugin collection for quick discovery
...
- **Tags:** `ai`, `llm`, `mcp`, `rag`, `vibe-coding`
...
- **Why use it:** Searches top 8 Chinese platforms for comprehensive 30-day reports.
...
- **Tags:** `web-search`, `free`, `no-api-key`, `research`
- **Why use it:** Free web search plugin with no signup required, bridges models lacking native search
...
- **Why use it:** Auto-curated plugin directory with ratings and categorized recommendations
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, and resource collection
...
- **Why use it:** Learn DSH principles, browse plugin marketplace and best practices
...
- **Why use it:** Plugin marketplace with 11,000+ entries, search, rankings, and public API
...
- **Tags:** `academic-search`, `mcp`, `skills`, `citation-management`
- **Why use it:** Cross-database academic search with citation graph and verification for Chinese researchers.
...
- **Why use it:** Industry research domain pack with company analysis and news tracking
...
- **Why use it:** Patent infringement analysis tool that generates competitive reports from patent numbers.
...
- **Why use it:** Installable DSH plugin development knowledge base with official docs archive EN/ZH.
...
- **Why use it:** Interactive K-line analysis with multi-market support in native sidebar.
...
- **Why use it:** Curated awesome list of DSH ecosystem plugins and tools.
...
- **Tags:** `marketplace`, `plugin-curator`, `deepseek-harness`
- **Why use it:** Comprehensive daily-updated plugin marketplace with reviewed listings
...
- **Why use it:** Curated bilingual awesome list covering plugins, skills, clients and integrations
...
- **Tags:** `encyclopedia`, `resources`, `learning`, `ai-pedia`
- **Why use it:** Comprehensive AI resource encyclopedia covering LLMs, agents, RAG, skills and learning paths
...
- **Tags:** `registry`, `awesome-list`, `plugin-registry`
...
- **Why use it:** Complete 1000+ plugin inventory sorted by stars from dsh-plugin topic
...
- **Why use it:** Curated plugin navigation guide for DSH users
...
- **Why use it:** Plugin radar and 2Origin plugin lab with evidence backing
...
- **Why use it:** Deekseek Harness plugins repository and ecosystem listing
...
- **Why use it:** Redirect to original awesome-dsh-plugin repo

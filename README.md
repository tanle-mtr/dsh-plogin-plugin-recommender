...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 1,001,518 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-11 01:05:33 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 219,171 | Core DSH ecosystem foundation with full plugin sup |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,422 | Local-first design tool, Claude Design alternative |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,992 | Multi-agent swarm orchestration with MCP server su |
...
- **Why use it:** Core DSH ecosystem foundation with full plugin support
...
- **Tags:** `multi-agent`, `self-evolving`, `dsh-plugin`
- **Why use it:** Self-evolving multi-agent assistant with memory and skills
...
- **Why use it:** Self-improving Agent OS with interview-gated evaluation, staged deployment, and MCP support.
...
- **⭐ Stars:** 3,939
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等���文本模型外挂视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `dsh-plugin`
- **Why use it:** First vision plugin for DSH, turns images into structured JSON for coding agents.
...
- **Why use it:** Solid two-phase preset combining minimal bootstrap with full standard tools.
...
- **Tags:** `virtual-terminal`, `sandbox`, `dsh-plugin`
- **Why use it:** Virtual terminal environment isolating AI agent operations safely.
...
- **Why use it:** Unified one-click installer and model switcher across multiple coding agent platforms.
...
- **Tags:** `runtime`, `desktop`, `dsh-plugin`
...
- **Tags:** `coding-agent`, `cli`, `mcp`, `dsh-plugin`
- **Why use it:** Coding agent with RPC plugin system, sub-agents and hashline edits for DSH
...
- **Tags:** `task-management`, `agent`, `taskboard`
- **Why use it:** Native local task management with SQLite and Web UI — no iframe needed.
...
- **Tags:** `plugin-creator`, `validator`, `utility`
...
- **Tags:** `ai-agents`, `awesome-dsh-plugin`, `chatgpt`, `codex`, `dsh`
- **Why use it:** Connect ChatGPT via OAuth to use their models in DSH.
...
- **Why use it:** Web-based plugin aggregation ecosystem bringing DSH to browsers via Creative Workshop.
...
- **Why use it:** Extensible sidebar with built-in file editor, terminal, chat, Git and sub-agents.
...
- **Why use it:** Modern flexible task panel compatible with Codex and DSH.
...
- **Why use it:** Claude Code-style TUI with whale navbar, streaming thoughts, and rollback support.
...
- **Why use it:** 5MB zero-setup Tauri desktop, cross-platform with preset plugins
...
- **Tags:** `context`, `dashboard`, `UI`
- **Why use it:** Context dashboard + sidebar + browser integration for DSH plugins
...
- **Tags:** `desktop-app`, `electron`, `dsh-plugin`, `mcp`
- **Why use it:** Full local desktop workspace with file, session and plugin management
...
- **Why use it:** Open-source Windows GUI client with SSH, Codex and mobile remote access
...
- **Tags:** `dsh-plugin`, `visual`, `workspace`
...
- **Tags:** `desktop-app`, `tauri`, `mcp`, `privacy`
...
- **Why use it:** Brings full office suite (spreadsheets, docs, slides) into DSH natively.
...
- **Tags:** `ios`, `mobile`, `swift`, `websocket`
- **Why use it:** Native iOS client for DSH with workspace, sessions, and Agent execution tracking.
...
- **Why use it:** Adds multimodal vision to Claude Code for screenshot/UI/chart analysis with browser automation
...
- **Why use it:** Open-source Smartisan-style notes with Docker deploy, DSH plugin support and WeChat export
...
- **Why use it:** 底部状态栏实时显示provider/model/余额/定价信息
...
- **Why use it:** WorkBuddy风格技能选择器，快捷插入Skill命令
...
- **Why use it:** 生物信息学桌面应用，Tauri构建，支持离线和技能商店
...
- **Why use it:** Electron desktop wrapper with integrated DSH web services and tools.
...
- **Why use it:** Enhances DSH context meter panel with compact view toggle.
...
- **Tags:** `knowledge-base`, `rag`, `dsh-plugin`
...
- **Why use it:** Portable, local-first memory layer with Markdown-native storage and cross-app self-evolution.
...
- **Tags:** `agent-memory`, `token-savings`, `rag`
- **Why use it:** Self-evolving memory OS with hybrid retrieval and cross-task skill reuse, saving tokens.
...
- **Why use it:** Dedicated memory library enabling stateful, context-aware agents with continual learning.
...
- **Why use it:** Dedicated memory management kit enabling agents to remember and refine context.
...
- **Why use it:** Persistent unified memory layer backed by Milvus for semantic search across agents.
...
- **Why use it:** Shared persistent memory hub giving every AI agent full context recall
...
- **Tags:** `skill-corpus`, `RAG`, `evaluation`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready corpora with eval tools
...
- **Tags:** `knowledge-base`, `rag`, `dsh-plugin`, `ai-pedia`
...
- **Why use it:** Proactive memory with zero-prompt recall and auto-consolidation
...
- **Tags:** `handoff`, `memory`, `continuity`
- **Why use it:** 跨平台会话记忆延续，让未来Agent恢复目标和上下文
...
- **Tags:** `multi-agent`, `agentic-workflow`, `dsh-plugin`
...
- **Tags:** `agent-orchestration`, `workflow`, `multi-device`
- **Why use it:** Unified multi-device agent workspace with task boards and API access across desktop and mobile.
...
- **Why use it:** Largest skills marketplace with auto-collected GitHub skills across docs, code, and automation.
...
- **Tags:** `long-horizon`, `control-plane`, `workflow`
- **Why use it:** Long-horizon control plane for durable, governed agent workflows across Codex and Claude.
...
- **Why use it:** Enterprise multi-agent workbench with visual editor supporting Codex, DSH, and OpenCode.
...
- **Tags:** `cognition`, `skills`, `dsh-plugin`
- **Why use it:** AI cognitive enhancement skills based on Anthropic's J-space global workspace research.
...
- **Why use it:** One-click topic-to-video pipeline via Atlas Cloud + ffmpeg
...
- **Why use it:** Multi-agent team coordination plugin for DSH workspaces
...
- **Why use it:** One-line vision toolkit: image paste recognition, OCR, screenshot-to-UI
...
- **Why use it:** End-to-end novel writing: characters, worldbuilding, chapters, revision
...
- **Tags:** `agent-skills`, `multimodal`, `ocr`, `mcp`
- **Why use it:** Multimodal skill turning video/audio/screen into timestamped searchable evidence
...
- **Why use it:** Creative writing workflow for novels and short dramas with specialized skills.
...
- **Tags:** `agent-skills`, `skills-marketplace`
- **Why use it:** Turn experience into repeatable execution skills compatible with major AI agents
...
- **Why use it:** 88 open-source agent skills for research, social intelligence, marketing and business workflows
...
- **Why use it:** Specialized skills for AI infrastructure development, write/optimize/debug high-performance systems
...
- **Why use it:** 87 reverse engineering skills for authorized pentesting and security research in DSH
...
- **Why use it:** 25 ready-to-use engineering skills in a sidebar panel
...
- **Tags:** `gongwen`, `document`, `skill`
- **Why use it:** Full workflow for official Chinese document formatting and generation
...
- **Tags:** `agent-skills`, `chinese-wisdom`, `traditional`
- **Why use it:** Unique融合八字/风水/中医的AI技能包，本地确定性引擎
...
- **Why use it:** Multi-agent协作框架，支持独立模型和共享工作区
...
- **Tags:** `code-simplification`, `skill`, `clean-code`
- **Why use it:** 代码简化Skill，帮助AI生成更简洁优雅的实现
...
- **Tags:** `video`, `image`, `multimodal`
- **Why use it:** AI视频/图像/音频创作技能，含知识库和视觉工具
...
- **Why use it:** 测试工程师Skill框架，11 Skills+共享知识库+决策矩阵
...
- **Tags:** `roleplay`, `narrative`, `character-ai`
- **Why use it:** AI互动叙事角色Skill，有记忆立场，数百素材库
...
- **Why use it:** 工程纪律Bundle：审查需求、测试实现、验证交付
...
- **Why use it:** 6 design style presets to avoid generic AI-generated looks
...
- **⭐ Stars:** 22
- **Language:** TypeScript
- **Description:** ��向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。
- **Tags:** `video`, `remotion`, `agent-skills`
- **Why use it:** 152 cinematic shot cards with Remotion templates for video agents
...
- **⭐ Stars:** 21
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型适配器、工具注���表、Agent 循环、网页界面都是插件
- **Tags:** `plugin`, `development`, `skill`
- **Why use it:** Guides AI agents through zero-to-one DSH plugin development
...
- **Why use it:** Free image reading & generation with auto vision transcod
...
- **Why use it:** Plugins marketplace for DSH, inspired by CodeX style.
...
- **Why use it:** Auto-preloads relevant plugins before agent tasks.
...
- **Tags:** `routing`, `injector`, `mcp`
- **Why use it:** Runtime injector and task-aware reasoning router for intelligent MCP-style request routing.
...
- **Tags:** `web-search`, `agent-skills`, `dsh-plugin`, `mcp`
- **Why use it:** Best free web search bridge for models without native web access
...
- **Tags:** `llm-provider`, `typescript`, `model-picker`
- **Why use it:** DeepSeek LLM provider for Command Code with plan-aware model picker and image input
...
- **Tags:** `codex`, `mcp`, `sync`, `deepseek-harness`
- **Why use it:** Seamless 2-way sync between Codex and DSH with live MCP mirroring
...
- **Why use it:** Local-first design tool, Claude Design alternative for agents
...
- **Why use it:** Self-contained architecture diagrams with motion and clarity
...
- **Why use it:** 530+ GPT Image prompt templates with case library
...
- **Tags:** `design-tool`, `vector`, `agent-teams`
...
- **Why use it:** Editable design system with AI-generated templates and PPT studio
...
- **Why use it:** Generate litigation timelines and legal diagrams as SVG visuals
...
- **Why use it:** Cross-platform local-first AI content discovery from B站, YouTube, Reddit etc.
...
- **Tags:** `web-search`, `China`, `research`
- **Why use it:** Crawls 8 major Chinese platforms, generates well-sourced research reports
...
- **Tags:** `ios`, `mobile-automation`, `mcp`, `xcode`
- **Why use it:** 22 agent tools for live iOS Simulator and USB iPhone automation inside DSH.
...
- **Tags:** `ai-agent`, `awesome-dsh-plugin`, `chat-bot`, `dingtalk`
- **Why use it:** DingTalk IM channel with stream-mode agent support.
...
- **Why use it:** Privacy-first open-source resume builder, fully self-hostable
...
- **Tags:** `security`, `cybersecurity`, `dsh-plugin`, `redteam`
...
- **Tags:** `dsh-plugin`, `oauth`, `llm`, `utilities`
...
- **Why use it:** Track session/daily costs, budget, and token usage across multiple providers.
...
- **Why use it:** CLI, schemas, resolver and agent tools for the DSH Plugin Hub ecosystem.
...
- **Tags:** `migration`, `compatibility-layer`, `abi`
- **Why use it:** Bridges Pi ecosystem to DSH, runs Pi extensions as native plugins without modification
...
- **Why use it:** Auto-discovers, installs and verifies GitHub plugins within DSH ecosystem
...
- **Why use it:** Plugin ecosystem infrastructure with registry console and dev guide
...
- **Tags:** `awesome-list`, `plugin-directory`, `utility`
...
- **Why use it:** Plugin dev knowledge base bundled as an on-demand agent skill
...
- **Why use it:** 审计AGENTS.md指令链和工具schema的token成本
...
- **Tags:** `container`, `multi-version`, `devtools`
- **Why use it:** 容器化隔离多版本DSH管理，嵌入式WebView界面
...
- **Tags:** `config-sync`, `mcp`, `multi-tool`
- **Why use it:** 一键配置Claude Code/Cursor/Gemini等多工具MCP和Skills
...
- **Why use it:** Diagnoses and resolves plugin conflicts between versions.
...
- **Why use it:** Popular whale-girl themed visual skins for DSH desktop
...
- **Tags:** `theme`, `dsh-plugin`, `desktop-app`
- **Why use it:** Frosted glass theme with full customization for DSH web interface
...
- **Tags:** `theme`, `chrome-extension`, `threejs`, `webgpu`
- **Why use it:** WebGPU-powered ocean-themed skin for DSH with Three.js visual effects
...
- **Why use it:** Customizable web background with presets and fine-tuning options.
...
- **Why use it:** Beginner-friendly harness engineering tutorial from zero to one, ideal for new DSH users.
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, GPU SSH, and experiment tracking.
...
- **Why use it:** Local financial DB via Tushare with multi-agent analysis, MCP integration and IM alerts
...
- **Why use it:** Comprehensive DSH handbook covering runtime, plugins, MCP, sandbox and 74 resources
...
- **Why use it:** Search 65,600+ Chinese platform API docs directly in DSH
...
- **Why use it:** Patent infringement analysis with RAG, portable as agent skill
...
- **Why use it:** 交互式K线分析，多市场行情+技术指标+支撑压力位
...
- **Why use it:** Spam-filtered curated registry for discovering DSH plugins.
...
- **Why use it:** Comprehensive curated awesome list covering all DSH ecosystem resources.
...
- **Why use it:** 24 verified stock/finance/quant plugins — bilingual resource.
...
- **Tags:** `plugin-directory`, `documentation`, `guide`
- **Why use it:** Plugin documentation and navigation guide by use case.
...
- **Tags:** `plugin-portal`, `static-site`, `awesome-list`
...
- **Tags:** `awesome-list`, `tool-inventory`, `dsh-plugin`
- **Why use it:** Full tool inventory of 1000+ DSH repos ranked by stars.
...
- **Why use it:** Curated meta-list of DSH plugins; essential starting point for exploring the ecosystem.
...
- **Tags:** `mascot`, `pets`, `community`
- **Why use it:** Community-driven animated pet gallery adding personality to your coding harness experience.
...
- **Why use it:** Self-hostable ecosystem radar discovering 15k+ candidate plugins
...
- **Why use it:** Curated plugin/tool list serving as DSH ecosystem handbook
...
- **Tags:** `awesome-list`, `discovery`, `onboarding`
- **Why use it:** Curated DSH plugin list for discoverability and onboarding
...
- **Tags:** `awesome-list`, `curated-list`, `bilingual`, `dsh-plugin`
- **Why use it:** Curated bilingual plugin and tool resource list for DSH ecosystem
...
- **Tags:** `dsh-plugin-market`, `plugin`, `harness`
- **Why use it:** Daily-updated plugin marketplace with community-sourced and reviewed plugins
...
- **Why use it:** Daily-curated plugin directory with scenario-based categorization and rankings.
...
- **Why use it:** Ultimate DSH guide with quickstart, plugin recommendations, and toolkit resources.
...
- **Tags:** `dsh-principles`, `marketplace`, `best-practices`
...
- **Why use it:** Curated list of plugins, skills, MCP servers, patches, orchestrators, and UIs.
...
- **Tags:** `marketplace`, `catalog`, `plugin-store`, `api`
- **Why use it:** Massive plugin marketplace: 11,000+ plugins with search, rankings, and free API.
...
- **Why use it:** Complete DSH plugin catalog with 1958 repos, Chinese/English search and filtering
...
- **Why use it:** Curated list of DSH plugins with community highlights
...
- **Why use it:** Curated collection of DSHA精选 plugins.
...
- **Why use it:** Evidence-backed DSH plugin radar and 2Origin lab.
...
- **Why use it:** Automated daily crawl directory of DSH plugins.
...
- **Why use it:** DSH plugin repository with verification features.
...
- **Why use it:** Archived — moved to another repo.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** General DSH plugin list collection.
...
- **Tags:** `curated-list`, `discovery`, `awesome-list`

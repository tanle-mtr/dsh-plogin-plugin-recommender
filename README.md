...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 984,179 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-08 05:49:26 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215,408 | Core DSH framework — everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,745 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,479 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** AI + low-code platform for fast business system building.
...
- **Why use it:** Comprehensive AI resource hub with vibe coding tutorials and prompt collections.
...
- **Why use it:** Beginner-friendly tutorial从零到一掌握Harness工程。
...
- **Tags:** `routing`, `injector`, `harness`
- **Why use it:** Task-aware router kit enabling intelligent mode switching for agents.
...
- **Why use it:** Two-phase bootstrap preset providing minimal-aligned setup with full Standard tools.
...
- **Why use it:** AI code reviews based on 12 classic engineering books with severity labels and auto-fix
...
- **Tags:** `agent-vision-toolkit`, `computer-vision`
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, screenshot UI restoration
...
- **Why use it:** Feature-rich coding agent with RPC, sub-agents, hashline edits and MCP support
...
- **Why use it:** CLI and schemas for DSH Plugin Hub—manage and discover plugins efficiently
...
- **Why use it:** Superpowers skill ported to the Reasonix coding harness.
...
- **Why use it:** Agent skill to develop DSH plugins with standard patterns and packaging
...
- **Tags:** `build`, `plugin-management`
- **Why use it:** Build and manage installed DSH plugins, slots and credentials
...
- **Why use it:** OCR and pixel-to-text image reading tools for text-only models
...
- **Why use it:** Audit AGENTS.md instruction chains, detect duplicates/conflicts with token stats
...
- **Tags:** `quality`, `guard`, `engineering`, `delivery`
- **Why use it:** Quality gate skill that validates requirements before shipping code
...
- **Why use it:** Modern desktop solution for DSH where desktop itself is a plugin.
...
- **Why use it:** Browser extension enhancement suite for Gemini, Claude & ChatGPT.
...
- **Why use it:** Web-based plugin aggregation ecosystem with Creative Workshop delivery.
...
- **Why use it:** Virtual terminal giving AI agents a sandboxed terminal environment.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight Tauri desktop app with zero setup and preset plugins for all platforms
...
- **Why use it:** Browse and install community plugins via one-click web UI.
...
- **Tags:** `mcp`, `menu`, `control`
- **Why use it:** Unified menu to control MCP/skills exposure and execution.
...
- **Why use it:** Electron desktop console for managing DSH plugins and MCPs
...
- **Tags:** `ui`, `pricing`, `info-bar`, `usage-tracking`
- **Why use it:** Bottom info bar showing provider/model, live balance, peak/off-peak pricing
...
- **Tags:** `bioinformatics`, `desktop`, `tauri`, `agent`
...
- **Why use it:** Electron桌面壳集成DSH Web，离线可用，体验更接近原生应用。
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `dsh-plugins`
- **Why use it:** Adds compact view button for DSH context meter panel.
...
- **Why use it:** Turn documents into queryable RAG with self-maintaining wiki.
...
- **Why use it:** Portable, local-first memory layer for persistent AI agent state.
...
- **Tags:** `memory`, `rag`, `token-efficient`
...
- **Why use it:** Memory library enabling stateful agents with continual learning.
...
- **Why use it:** Dedicated memory management kit helping agents remember and refine context.
...
- **Why use it:** Best context management plugin with dashboard, browser view, and statistics
...
- **Why use it:** Proactive associative memory with auto-consolidation for agents
...
- **Tags:** `evaluation`, `rag`, `prompt-testing`, `observability`
...
- **Why use it:** Unified agent workspace and task board across all devices.
...
- **Why use it:** Most comprehensive skill store with auto-sync from GitHub.
...
- **Why use it:** End-to-end Vox-style explainer video generation from a single topic via agent skill
...
- **Tags:** `workflow`, `competition`, `agent-skill`
- **Why use it:** Full-stack math modeling competition autopilot with GitOps and code verification
...
- **Why use it:** Adds multimodal vision capabilities to text-only LLM backends.
...
- **Tags:** `security`, `ctf`, `pentest`, `reverse-engineering`
...
- **⭐ Stars:** 71
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项���架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `mentor`, `skill`, `code-review`
- **Why use it:** Turns your AI agent into a coding mentor with code review.
...
- **Why use it:** 25 ready-to-use engineering and efficiency skills bundled together
...
- **Why use it:** Chinese official document processing following national format standards
...
- **Why use it:** Fusion of Bazi, Fengshui, I Ching, TCM etc. with local deterministic engine
...
- **Why use it:** Codex skill for finding and simplifying code patterns in projects
...
- **Why use it:** Cross-platform session memory for agent handoff continuity across sessions
...
- **Why use it:** 11 QA skills + shared KB with type decision matrix for AI testing engineers
...
- **⭐ Stars:** 22
- **Language:** JavaScript
- **Description:** Godot Engine 4.x 全栈游戏开发���能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime
- **Tags:** `godot`, `game-dev`, `gdscript`, `skill`
- **Why use it:** Full-stack Godot 4.x game dev skill pack for DSH agents
...
- **Tags:** `video`, `motion-design`, `remotion`, `skill`
- **Why use it:** Cinematic video production skill with 152 shot recipe cards and templates
...
- **Why use it:** 虚拟产品团队预设，模拟PM到工程到QA的协作流程。
...
- **⭐ Stars:** 3
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前检查单"——任务���请求时自动预检插件库并注入 Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `agent-tools`, `ai-agents`, `cordis`, `dsh`, `llm-agents`
...
- **Why use it:** Search npm + awesome-lists for DSH plugins from inside agents.
...
- **Why use it:** Local financial database with auto-generated MCP and HTTP interfaces for multi-agent analysis.
...
- **Tags:** `llm-provider`, `provider`, `typescript`
- **Why use it:** LLM provider plugin with live model catalog and plan-aware picker for Command Code.
...
- **Tags:** `codex`, `sync`, `mcp`, `bridge`, `cordis`
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live sync and auto MCP mirroring
...
- **Why use it:** Official SkillHub Open API docs and examples for DSH ecosystem
...
- **Why use it:** Self-contained HTML diagrams with motion and explanations.
...
- **Why use it:** 530+ image prompts and 20+ industrial templates with skills.
...
- **Why use it:** Legal visualization tool for generating litigation timelines and diagrams
...
- **Tags:** `design`, `ui`, `styles`, `vibe-coding`
- **Why use it:** 6 design style presets to avoid generic AI-generated website looks
...
- **Tags:** `content-discovery`, `web-automation`, `multi-platform`
- **Why use it:** Cross-platform AI content discovery agent scraping Bilibili, YouTube, Reddit, and more.
...
- **Why use it:** CLI+extension lets AI agents use real logged-in browser without interruption
...
- **Why use it:** Live iOS Simulator + physical device automation via 22 agent tools
...
- **Why use it:** One-click install and model switcher supporting multiple coding agents including DSH.
...
- **Why use it:** Floating whale widget monitors DeepSeek account balance with cute animations
...
- **Why use it:** Curated awesome list of DSH plugins, tools, and ecosystem infrastructure
...
- **Why use it:** Comprehensive curated plugin list covering agents, CLI, web UI and more
...
- **Tags:** `cost`, `token-tracking`, `utility`
...
- **Why use it:** Bridges Pi and DSH ecosystems with seamless extension compatibility.
...
- **Why use it:** Secure P2P multi-device remote access for Harness and CodeX.
...
- **Why use it:** Backup, restore, sync and migrate full DSH configurations.
...
- **Why use it:** Plugin management console and dev skill scaffolding for DSH
...
- **Tags:** `skills-manager`, `utility`, `security`
...
- **Why use it:** Real-time token usage tracking and cost visualization for DSH users.
...
- **Why use it:** 免费接入小米MiMo TTS，支持自定义和浏览器内置声音朗读正文。
...
- **Why use it:** ���断并解决插件间冲突和版本兼容问题，维护插件生态健康。
...
- **Tags:** `pets`, `theme`, `ui-cosmetic`
- **Why use it:** Animated pet gallery adding personality to any agent harness.
...
- **Why use it:** Whale girl themed skin series for customizing DeepSeek Harness appearance.
...
- **Why use it:** 支持自定义背景图片和多种预设氛围，所见即所得。
...
- **Why use it:** Searches 8 major Chinese platforms for 30-day content and generates cited research reports
...
- **Why use it:** Full-cycle research workbench: LaTeX editing, arXiv management, GPU orchestration
...
- **Why use it:** Cross-database academic search with citation verification, graphs, and MeSH support
...
- **Why use it:** Industry research toolkit with chain mapping and news tracking.
...
- **Why use it:** Patent infringement analysis with RAG-powered competitor reports
...
- **Tags:** `kline`, `financial`, `analysis`, `visualization`
- **Why use it:** Interactive K-line analysis with multi-market data, indicators, and fundamentals
...
- **Why use it:** Curated plugin list for DeepSeek Harness ecosystem exploration
...
- **Why use it:** Comprehensive curated awesome list of DSH plugins, tools, and skills
...
- **Tags:** `registry`, `open-data`, `plugins`, `curated`
...
- **Tags:** `awesome-list`, `discovery`, `dsh`
...
- **Tags:** `deepseek`, `armor-breaking`
- **Why use it:** Armor-breaking plugin for DeepSeek with stable enhancement capabilities
...
- **Tags:** `agent-observability`, `agent-skills`, `agentic-ai`, `ai-agents`, `audio-understanding`, `computer-vision`, `deepseek`, `deepseek-harness`, `deepwatch`, `ffmpeg`, `local-first`, `mcp`, `multimodal`, `ocr`, `python`, `speech-to-text`, `typescript`, `verification`, `video-analysis`, `video-understanding`
...
- **Why use it:** A DSH plugin for novel writing and short
...
- **Why use it:** Curated daily-updated plugin discovery tool for DSH ecosystem
...
- **Why use it:** Comprehensive DSH plugin catalog with 1819 plugins, search and filter support.
...
- **Why use it:** 2026年精选插件合集，经质量审核，便于快速发现优质插件。
...
- **Why use it:** 24个经过验证的金融/量化插件合集，双语说明。
...
- **Why use it:** 证据驱动的插件目录，提供权限感知安装指导。
...
- **Why use it:** 实用的DeepSeek Harness插件集合，持续更新。
...
- **Why use it:** 按星标排序的社区插件清单，帮助快速筛选高质量插件。
...
- **Tags:** `catalog`, `awesome-list`, `comprehensive`
- **Why use it:** 1000+插件全量清单，按star排序，覆盖面最广。
...
- **Tags:** `directory`, `navigation`, `manual`
- **Why use it:** 面向用户的插件产品说明书，帮助按场景选择和了解风险。
...
- **Why use it:** GitHub Actions自动爬取的插件目录，每日更新，双语支持。
...
- **Why use it:** 零依赖静态插件门户，支持筛选和浏览227+插件。
...
- **Why use it:** DeepSeek Harness plugin marketplace inspired by CodeX.
...
- **Why use it:** Curated collection of DeepSeek Harness plugins.
...
- **Why use it:** DSHA curated plugin directory.
...
- **Why use it:** Curated plugin registry with auto-updating bilingual listings for DSH discovery.

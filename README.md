...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 865,439 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 19:37:23 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,031 | Core framework enabling everything-as-plugin archi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,441 | Open-source design alternative to Claude Design wi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,386 | Multi-agent swarm framework for autonomous workflo |
...
- **Why use it:** Versatile agent harness with multi-model, multi-channel and self-evolving memory.
...
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for continuous use.
...
- **Why use it:** Self-improving agent OS with continuous learning
...
- **Why use it:** Coordinates multiple coding agents into one collaborative team.
...
- **Why use it:** Helps discover, install, and verify GitHub plugins directly within DSH.
...
- **Tags:** `compatibility-layer`, `migration`, `deepseek-harness`
...
- **Tags:** `marketplace`, `plugin-market`, `agent`
- **Why use it:** One-click browse, install, and update all DSH plugins from GitHub in the Web GUI.
...
- **Why use it:** Web UI plugin for managing skills and MCP tools at a glance.
...
- **Why use it:** Community plugin marketplace browsed from awesome-dsh-plugin.com directly in Web GUI.
...
- **Tags:** `agent`, `agent-skill`, `ai-agent`, `deepseek-harness`, `dsh-plugin`, `llm-agent`, `skill`
- **Why use it:** Agent Skill to develop DSH plugins with standards for slots and adapters.
...
- **Why use it:** Manage installed DSH plugins, slots, credentials and Typert remotes.
...
- **Tags:** `agent-framework`, `mcp`, `database`
- **Why use it:** Package manager for AI agents: 42 skills, 5 CLIs, eval-driven and spec-driven dev
...
- **Why use it:** Practical DSH plugin dev notes covering cordis, tsconfig, Windows junctions & more
...
- **Tags:** `agent-tools`, `checklist`, `utility`
- **Why use it:** Pre-flight check auto-injects top-K relevant plugins for tasks
...
- **Why use it:** Modern desktop client for DSH ecosystem, treating the desktop itself as a plugin.
...
- **Why use it:** Lightweight Tauri desktop app, 5MB installer, zero env setup
...
- **Tags:** `desktop-companion`, `plugin-sdk`, `dsh-plugin`
- **Why use it:** Desktop companion with animated pets and plugin SDK for agents
...
- **Why use it:** Local-first desktop workspace for DSH sessions, projects and files
...
- **Why use it:** Local-first desktop AI agent with multi-model support.
...
- **Why use it:** Renders interactive UI components inline within chat replies.
...
- **Why use it:** Cross-platform desktop client for DeepSeek Harness with plugin suite.
...
- **Why use it:** Feature-rich Windows desktop GUI with SSH, skills, and mobile remote access.
...
- **Why use it:** Preview and edit OpenPencil .op documents directly inside conversations.
...
- **Why use it:** Build and interact with live Android emulators or USB devices inside conversations.
...
- **⭐ Stars:** 57
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄��制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **Tags:** `console`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-repository-plugin`, `plugin-management`, `ui`
- **Why use it:** Lightweight console for managing DSH repository plugins, zero patch.
...
- **Why use it:** Desktop Electron app integrating multiple DSH tools
...
- **Why use it:** Open-source LLM knowledge platform with RAG, semantic search and self-maintaining wiki.
...
- **Why use it:** Portable local-first memory layer for every AI agent
...
- **Why use it:** Essential memory management kit for long-term agent persistence.
...
- **Why use it:** Persistent unified memory layer backed by Milvus and Markdown for all agents.
...
- **Why use it:** Comprehensive AI knowledge encyclopedia covering MCP, RAG, and more.
...
- **Why use it:** Turns scattered SKILL.md files into searchable agent-skill corpora with retrieval tooling.
...
- **Why use it:** Official docs archive with on-demand agent skill for plugin development
...
- **Why use it:** Multi-agent swarm framework for autonomous workflows and conversational AI.
...
- **Why use it:** 530+ industrial-grade image generation prompts distilled into reusable agent skills.
...
- **Tags:** `agent-orchestration`, `workspaces`, `mcp`
- **Why use it:** Unified agent workspaces accessible across all devices
...
- **Why use it:** Enterprise-grade multi-agent workspace with unified toolkit
...
- **Why use it:** First vision plugin: paste image, get structured JSON evidence
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `inference-time-control`
...
- **Why use it:** Intelligently routes and orchestrates harness workflows with auto-context engineering.
...
- **Why use it:** Powerful plugin for novel writing and short-drama production with specialized skills.
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot and UI analysis tasks.
...
- **Why use it:** Transform experience into repeatable, shareable execution workflows across agents.
...
- **Tags:** `anime`, `bangumi`, `torrent`, `plugin`
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet support in conversation.
...
- **Tags:** `notes`, `smartisan`, `private-deploy`
- **Why use it:** Smartisan-style notes with Docker deploy, WeChat export, and skill integration.
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and pure Web UI.
...
- **Why use it:** Port of Superpowers skill suite to Reasonix coding harness.
...
- **Why use it:** 85-step reverse engineering & pentest skill for security research.
...
- **Why use it:** AI coding mentor: scans architecture, guides step-by-step learning.
...
- **Tags:** `agent-plugins`, `agent-skills`, `ai-agents`, `claude-code`, `codex-skills`, `deep-research`, `fact-checking`, `market-research`
- **Why use it:** 88 open-source skills for research, social intelligence & marketing.
...
- **Tags:** `agent-skills`, `ai-coding`, `deepseek-harness`, `developer-tools`, `dsh-plugin`, `spec-driven-development`
- **Why use it:** Portable spec-driven development skill based on DSH engineering patterns.
...
- **Tags:** `chinese-traditional-wisdom`, `bazi`, `fengshui`, `agent-skill`
- **Why use it:** Bazi/Fengshui/TCM multi-domain agent skill with local deterministic engine
...
- **Why use it:** Adapted code simplification skill from DSH for Codex workflow
...
- **Tags:** `skills-manager`, `organization`, `plugin`
...
- **Why use it:** Native image reading & generation with vision transcription
...
- **Why use it:** Full workflow for Chinese official documents: format check, templates & revision
...
- **Why use it:** Game-like mission system with fog-of-war map and task-bar automation
...
- **Why use it:** Portable agent skill for engineering best practices and disciplined workflows
...
- **Why use it:** Native WeShop plugin with infinite canvas and creative agentic skills
...
- **Why use it:** Simulates product team roles for collaborative workflows
...
- **Why use it:** Zhihu search MCP + skill + CLI with official open-platform API support
...
- **Why use it:** Enhancement suite and prompt manager for Gemini, Claude, ChatGPT and DeepSeek web UIs.
...
- **Why use it:** Privacy-first cross-platform content discovery agent for Chinese & global platforms.
...
- **Why use it:** AI agents control your real logged-in browser without interruption
...
- **Why use it:** Strongest free web search plugin; no API key or signup needed.
...
- **Why use it:** Live iOS Simulator integration with 22 agent automation tools.
...
- **Why use it:** Privacy-focused resume builder with MCP server support and full customization.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with multi-platform integration.
...
- **Why use it:** First unified virtual filesystem for all AI agents
...
- **Why use it:** Official DSH plugin marketplace — browse, search, one-click install.
...
- **Why use it:** Context dashboard and management tool with statistics and browser
...
- **Tags:** `utility`, `oauth`, `subscription`
- **Why use it:** Uses ChatGPT/Claude/Grok subscriptions as free DSH LLM providers.
...
- **Why use it:** Track session and daily costs, budget limits, and token usage seamlessly.
...
- **Why use it:** Cross-preset session migration preserving state, model intent, and unresolved images.
...
- **Tags:** `backup`, `undo`, `crash-recovery`, `rollback`
- **Why use it:** Crash rescue with undo, secret-safe snapshots, and one-click SAFE MODE recovery.
...
- **Why use it:** Pixel-to-text OCR & image reading tools for text-only models.
...
- **Tags:** `dsh-plugins`, `container`, `infrastructure`
...
- **Tags:** `capability-menu`, `mcp`, `tools-management`
...
- **Tags:** `context-audit`, `ui`, `tools`
- **Why use it:** Audit context injection, detect duplicates/conflicts with visual dashboard
...
- **Why use it:** In-browser skills & MCP manager with zero-config setup
...
- **Why use it:** Paste JSON to connect MCP, hot-reload, auto-scan skills — no restart needed
...
- **Why use it:** Streamlines migration from Claude Code/Codex/OpenCode to DSH with full config import
...
- **Tags:** `monitoring`, `cost-tracking`, `dashboard`
...
- **Why use it:** Enables in-agent plugin search across npm and awesome lists
...
- **Why use it:** Cute whale-girl themed skin series for DeepSeek Harness UI customization.
...
- **Tags:** `theme`, `ui`, `glass`
- **Why use it:** Beautiful frosted glass theme with full customization control.
...
- **Why use it:** Stunning WebGPU ocean-themed skin for a visually immersive DSH experience.
...
- **Tags:** `theme`, `dark-mode`, `opencode`
- **Why use it:** 34 classic opencode themes with one-click apply, persists across restarts
...
- **Why use it:** Comprehensive AI resource hub with tutorials for DeepSeek, GPT, Gemini and prompt engineering.
...
- **Why use it:** Auto-searches top 8 Chinese platforms for 30-day content and generates citable reports.
...
- **Why use it:** Audits AI code for hallucinations, vulnerabilities, and safety gaps.
...
- **Tags:** `prompt`, `research`, `breaking`
- **Why use it:** Stabilized prompt-breaking plugin for DeepSeek research.
...
- **Tags:** `ai-agents`, `alipay`, `api-documentation`, `chinese-api`, `claude-code`, `cursor`, `deepseek-harness`, `dingtalk`, `douyin`, `dsh-plugin`
...
- **Why use it:** Interactive K-line financial analysis with multi-market support and technical indicators
...
- **Tags:** `evaluation-framework`, `rag-evaluation`, `agent-evaluation`
...
- **Tags:** `stock`, `finance`, `research`
- **Why use it:** Curated stock/finance plugin list for vertical research
...
- **Why use it:** Curated plugins, tools, skills & resources overview
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Evidence-aware curated shortlist of useful plugins
...
- **Tags:** `awesome-list`, `dsh-plugin`, `ui`
...
- **⭐ Stars:** 1
- **Language:** Python
- **Description:** 计算���｜金融｜法律｜HR｜制造｜医疗｜电商等行业精选 dsh 插件目录
- **Tags:** `industry`, `dsh-plugin`
- **Why use it:** Industry-specific plugins for finance, law, healthcare, e-commerce
...
- **Why use it:** AI-powered no-code platform for building CRM, ERP and internal business tools fast.
...
- **Tags:** `dsh-plugin`, `toy`
- **Why use it:** Novelty web toy — no practical DSH utility; entertainment only.
...
- **Why use it:** Plugin discovery radar with 9000+ candidates and top 50 curated picks
...
- **Why use it:** Curated bilingual resource listing all DSH plugins and tools.
...
- **Tags:** `awesome-list`, `curated`, `discover`
- **Why use it:** Daily-scanned curated plugin directory with real reviews.
...
- **Tags:** `learning`, `marketplace`, `docs`
- **Why use it:** Learn DSH principles, browse the plugin marketplace efficiently.
...
- **Why use it:** Ultimate starter guide with curated plugins and resources for DSH.
...
- **Tags:** `plugin-marketplace`, `catalog`, `dsh-store`
- **Why use it:** Massive plugin marketplace with 3,100+ plugins, search, rankings, and free API.
...
- **Why use it:** Plugin marketplace hub for DeepSeek Harness with curated listings.
...
- **Why use it:** Curated awesome list of all notable DSH ecosystem plugins.
...
- **Why use it:** Curated plugin awesome-list for productivity and tools.
...
- **Tags:** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `awesome-list`, `deepseek-harness`, `dsh`, `dsh-ecosystem`, `dsh-plugin`
...
- **Tags:** `group-photo`, `oauth`, `community`
- **Why use it:** GitHub OAuth group photo wall with instant polaroid-style sharing
...
- **Why use it:** Spam-filtered plugin registry and open-data directory
...
- **Tags:** `docs`, `guide`, `navigation`
- **Why use it:** Plugin documentation and scenario-based navigation guide
...
- **Tags:** `collection`, `community`
- **Why use it:** Community-maintained DSH plugin collection
...
- **Tags:** `awesome-list`, `auto`, `directory`

...
|--------|-------|
| **Plugins tracked** | 202 |
| **Total community stars** | 1,094,936 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 235,902 | Core plugin ecosystem enabling everything-as-plugi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,076 | Open-source design system generator with local-fir |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,261 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Core plugin ecosystem enabling everything-as-plugin architecture for AI agents.
...
- **Why use it:** Self-evolving multi-agent harness with memory, task planning, and multi-model support.
...
- **Tags:** `coding-agent`, `terminal`, `deepseek`
- **Why use it:** Terminal-based DeepSeek-native coding agent with prefix-cache stability for long sessions.
...
- **Tags:** `agent`, `dsh-plugin`, `harness-engineering`, `tutorial`
- **Why use it:** Comprehensive zero-to-one tutorial for mastering DSH plugin development
...
- **Why use it:** Runtime injector and task-aware reasoning-mode router for advanced DSH harness control
...
- **Tags:** `agent-os`, `llm-orchestration`, `mcp`, `loop-engineering`
- **Why use it:** Self-improving Agent OS with evaluation-gated evolution loop and MCP server integration
...
- **Why use it:** First virtual terminal for AI agents with VFS and sandboxed execution environment.
...
- **Tags:** `deepwiki`, `dsh-plugin`, `developer-tools`
- **Why use it:** Generates accurate technical docs and AI-ready context for codebases.
...
- **Why use it:** High-performance Rust agent runtime paired with polished desktop IDE.
...
- **Tags:** `jailbreak`, `dsh-plugin`, `deepseek`
- **Why use it:** Jailbreak plugin enabling all models to bypass restrictions flexibly.
...
- **Tags:** `context`, `dsh-plugin`, `developer-tools`
- **Why use it:** Best context dashboard and management tool for DeepSeek Harness.
...
- **Tags:** `coding-agent`, `cli`, `mcp`
- **Why use it:** Coding agent with RPC plugins, sub-agents, hashline edits, and MCP integration.
...
- **Why use it:** CLI and resolver tools for managing DSH Plugin Hub — essential for plugin developers.
...
- **Why use it:** Local-first multi-model desktop agent with self-evolving skills
...
- **Why use it:** Bridges Pi and DSH ecosystems with compatibility layer
...
- **Tags:** `migration`, `import`, `sessions`
- **Why use it:** Import conversations from 25+ AI coding agents as resumable sessions
...
- **Why use it:** CTF and reverse engineering skill with 87 SKILL.md entries
...
- **Tags:** `agent-skills`, `vision`, `claude-code`
- **Why use it:** Adds multimodal vision to Claude Code, enabling screenshot/UI analysis
...
- **Why use it:** Pre-flight plugin matching boosts DSH agent reliability and usability.
...
- **Why use it:** Open-source design system generator with local-first desktop app integration.
...
- **Tags:** `desktop`, `dsh`, `plugin-first`
- **Why use it:** Modern desktop client for DSH ecosystem with plugin-first architecture and local-first design.
...
- **Why use it:** Brings DeepSeek Harness to desktop with native app experience across platforms
...
- **Tags:** `taskboard`, `skills`, `ui-extension`
- **Why use it:** Modern flexible task board embeddable into Codex and DeepSeek Harness interfaces.
...
- **Why use it:** Feature-rich TUI companion: whale bar, streaming thoughts, rollback, and context progress.
...
- **Tags:** `floating-widget`, `dsh-plugin`, `deepseek`
...
- **Why use it:** Lightweight 5MB Tauri desktop app with preset plugins for DSH.
...
- **Tags:** `desktop-app`, `gui`, `ssh-client`
- **Why use it:** Full-featured desktop GUI with SSH, mobile remote access, and plugin system for DSH.
...
- **Why use it:** Local-first AI desktop workspace with project management, web research, and MCP support.
...
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes in assistant replies.
...
- **Tags:** `office`, `productivity`, `deepseek-harness-plugin`
...
- **Tags:** `mobile`, `ios`, `desktop-app`
- **Why use it:** Native iOS client with real-time agent tracking and WebSocket connectivity
...
- **Why use it:** Live iOS Simulator + physical device control with 22 agent automation tools
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI plugin for managing skills and MCP servers in DSH dashboard
...
- **Tags:** `market`, `ui`, `plugin`
- **Why use it:** Community plugin market integrated into DSH Web GUI for one-click install
...
- **Tags:** `platform`, `workspace`, `plugins`
...
- **Tags:** `ui`, `skills`, `menu`, `context-management`
- **Why use it:** Unified capability menu with three-tier exposure strategy to reduce context overhead
...
- **Tags:** `desktop`, `electron`, `ui`, `hub`
- **Why use it:** Electron-based desktop hub with multi-tab management for DSH, plugins, and MCP
...
- **Why use it:** Visual context audit with token cost tracking and conflict detection via web UI
...
- **Why use it:** One-click compact toggle for the context meter panel
...
- **Why use it:** Multi-agent swarm orchestration with autonomous workflow coordination and MCP support.
...
- **Tags:** `skills`, `knowledge-distillation`, `meta-skill`
- **Why use it:** Distill human thinking patterns into reusable agent skills for any AI assistant or bot.
...
- **Tags:** `agent-workspaces`, `coding-agent`, `no-code`, `self-hosted`
- **Why use it:** Unified multi-device workspace for agents with task tracking and API access
...
- **Tags:** `agent-skills`, `skill-marketplace`, `coding`, `automation`
- **Why use it:** Comprehensive skills marketplace covering documents, coding, automation and ML workflows
...
- **Why use it:** Long-form web novel writing assistant solving AI forgetting and hallucination problems
...
- **Why use it:** Enterprise-grade multi-agent workbench with visual editor supporting Codex and DSH
...
- **Why use it:** Durable state kernel for long-horizon multi-agent teams with minimal human intervention.
...
- **Tags:** `skills`, `workflow-automation`, `context-engineering`
...
- **Tags:** `agent-skills`, `dsh-plugin`, `cognitive-enhancement`
...
- **Tags:** `vision-toolkit`, `ocr`, `dsh-plugin`, `agent-skills`
- **Why use it:** Vision toolkit with OCR, image Q&A, and UI restoration for agents.
...
- **Tags:** `agent-preset`, `scientific-discovery`, `epistemic-loop`
- **Why use it:** Brings Epistemic Loop methodology to DSH for structured scientific discovery workflows.
...
- **Why use it:** Creative writing workflow for novels, short dramas, games, and video recaps with built-in templates.
...
- **Tags:** `agent-skills`, `computer-vision`, `multimodal`
- **Why use it:** Gives agents verifiable vision/audio skills with timestamped evidence
...
- **Why use it:** Native SQLite-backed task management with Agent claim/review workflow
...
- **Tags:** `evolution`, `self-improvement`, `review`
- **Why use it:** Composable agent self-evolution with human review capabilities
...
- **Why use it:** 88 open-source agent skills for research and business workflows
...
- **Why use it:** Skill audit and in-app skill manager for DSH Cordis
...
- **Tags:** `skills`, `experience`, `reusable`
...
- **Why use it:** Financial analysis system with Tushare data and MCP support
...
- **Tags:** `skill-generator`, `automation`, `agent`
...
- **Why use it:** TDD, debugging, planning skills adapted from proven superpowers framework
...
- **Tags:** `skills`, `engineering`, `productivity`, `github-issues`
- **Why use it:** 25 pre-loaded engineering skills trained on 300B tokens, ready to use instantly
...
- **Tags:** `web-search`, `research`, `agent-skills`, `integration`
- **Why use it:** Web search and research skills from You.com for AI agents
...
- **Tags:** `mentor`, `coding`, `education`, `review`
...
- **Tags:** `docx`, `gongwen`, `templates`, `word`
- **Why use it:** Complete GB/T 9704 official document processing: format check, optimization, templates
...
- **Tags:** `agent`, `skill`, `math-modeling`, `cumcm`
- **Why use it:** Comprehensive multi-agent math modeling toolkit with model library and paper templates
...
- **Why use it:** Separates discussion from execution for better AI collaboration outcomes
...
- **Tags:** `skill`, `api`, `deepseek-harness`
...
- **Tags:** `agent-handoff`, `skill`, `session-memory`
- **Why use it:** Preserves session memory across agent handoffs for continuity
...
- **Why use it:** Adapts DSH code simplification patterns for Codex workflow
...
- **Tags:** `skill`, `godot`, `game-development`
...
- **Why use it:** Essential agent skill for building DSH plugins with standards and templates
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset and custom voice support
...
- **Tags:** `workflow`, `task-management`, `dsh-plugin`
- **Why use it:** Structured task stages and verification records for engineering workflows.
...
- **Why use it:** Vision bridge for text-only agents — paste images and get structured JSON evidence via OCR.
...
- **Tags:** `api-docs`, `mcp`, `chinese-platforms`, `search`
...
- **Tags:** `cloud`, `mcp`, `huawei`, `terraform`, `sdk`
- **Why use it:** Official Huawei Cloud toolkit with MCP tools, skills, and cloud sandbox support
...
- **Tags:** `mcp`, `config`, `skills`, `deepseek-harness`
- **Why use it:** One-click MCP/Skills setup across 7+ AI agent platforms
...
- **Tags:** `diagrams`, `architecture`, `code-visualization`
- **Why use it:** Generate beautiful architecture, sequence, and data-flow diagrams as self-contained code.
...
- **Why use it:** 530+ GPT Image prompt templates and cases with industrial-grade reusable skill collections.
...
- **Tags:** `agent`, `vibecoding`, `ui`, `vibedesign`
...
- **Why use it:** Legal litigation visualization: timelines, case relationship diagrams, SVG output
...
- **Tags:** `blender`, `3d`, `automation`, `bpy`
- **Why use it:** Direct TCP control of Blender viewport and renders by AI model in real time
...
- **Tags:** `kline`, `visual`, `sidebar`, `finance`
- **Why use it:** Interactive K-line chart with multi-market tech indicators in native sidebar
...
- **Tags:** `ai-video`, `ai-image`, `skill`, `directorx`
...
- **Why use it:** Real-time token usage charts and cost estimates, essential for budget tracking
...
- **Tags:** `browser-extension`, `chatgpt`, `deepseek`, `chrome-extension`
- **Why use it:** Powerful browser extension enhancing multiple AI chat platforms with prompt management
...
- **Tags:** `browser-use`, `agent`, `cli`
- **Why use it:** CLI+extension enabling agents to use real logged-in browsers without workflow interruption
...
- **Why use it:** Free web search plugin for any model without native web access — no signup needed.
...
- **Why use it:** Persistent fingerprint-spoofed browser for agents with unlimited local profiles.
...
- **Tags:** `content-discovery`, `personal-ai`, `cross-platform`
- **Why use it:** Cross-platform content discovery agent spanning B站, YouTube, 小红书 and more platforms.
...
- **Why use it:** OAuth-powered ChatGPT integration directly inside DSH agents.
...
- **Tags:** `resume-builder`, `privacy`, `self-hosted`
- **Why use it:** Privacy-first open-source resume builder with full customization and self-hosting support.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with Obsidian and VS Code integration.
...
- **Why use it:** Two-phase preset config: minimal bootstrap then full Standard tools for stable DSH setup.
...
- **Tags:** `mcp`, `registry`, `secrets`
- **Why use it:** OpenRouter-style registry for agent tools with MCP support and secret management.
...
- **Tags:** `cli`, `multi-model`, `credentials`
- **Why use it:** Unified multi-model account manager with smart routing, priority, and auto failover.
...
- **Why use it:** Ecosystem radar scanning 21k+ DSH plugins with k8s validation.
...
- **Why use it:** Curated community list of DSH plugins, tools, and infrastructure.
...
- **Why use it:** Daily-updated comprehensive plugin marketplace with pre-review.
...
- **Tags:** `cybersecurity`, `vulnerability`, `redteam`
...
- **Why use it:** Secure P2P multi-device remote access solution for DSH
...
- **Why use it:** One-click Docker private note app with Smartisan aesthetics and skill support
...
- **Why use it:** Auto-upgrades DSH plugins when the platform version updates
...
- **Why use it:** Complete DSH backup/restore with export, import and WebDAV sync support
...
- **Why use it:** Unified local agent skills loading and safety management in DSH
...
- **Tags:** `utility`, `container`, `dsh-plugin`, `management`
- **Why use it:** Isolated multi-DSH container management with embedded WebView UI
...
- **Why use it:** Migration wizard transferring sessions and skills from Claude Code/Codex/OpenCode
...
- **Why use it:** Fast and elegant Neovim plugin manager, lightweight and well-designed
...
- **Tags:** `utilities`, `keybindings`, `terminal`
- **Why use it:** Practical plugin bundle: task notifications, LLM trace, keybindings, terminal
...
- **⭐ Stars:** 7
- **Language:** TypeScript
- **Description:** 致力于解决各插件之间也与版本之间可能存在的��突问题并提供解决方案
- **Tags:** `conflict-resolution`, `utility`, `debugging`
...
- **Why use it:** Animated pet gallery that personalizes your coding agent with cute mascot visuals.
...
- **⭐ Stars:** 405
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH ���何一行源码。
- **Tags:** `theme`, `glassmorphism`, `deepseek-harness-plugin`
- **Why use it:** Frosted glass theme with full customization; no source code changes needed
...
- **Tags:** `theme`, `animated`, `glassmorphism`
- **Why use it:** Animated ocean theme with adjustable waves and glassmorphism effects
...
- **Why use it:** Customizable web background with preset themes and image upload
...
- **Tags:** `ai-resources`, `tutorials`, `prompt-engineering`
- **Why use it:** Comprehensive AI resource library with tutorials covering DeepSeek, GPT, Claude, and RAG.
...
- **Tags:** `latex`, `arxiv`, `research`
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU SSH, experiment tracking for academics.
...
- **Why use it:** Daily-curated plugin discovery with real filtering and scene-based classification
...
- **Tags:** `awesome-list`, `resources`, `curation`
...
- **⭐ Stars:** 274
- **Language:** Unknown
- **Description:** DeepSeek Harness 终极指南：快速入门、资源推荐、精选插��与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **Tags:** `awesome-list`, `guide`, `resources`
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins and practical toolkit
...
- **Why use it:** Cross-source academic search with citation graph, MeSH and trial verification
...
- **Tags:** `research`, `company-research`, `industry`
- **Why use it:** Comprehensive industry/company research pack with methodology and news tracking
...
- **Tags:** `patent`, `analysis`, `legal-tech`, `rag`
- **Why use it:** Patent infringement analysis system generating competitor comparison reports
...
- **Tags:** `stock-analysis`, `quantitative`, `backtesting`, `research`
- **Why use it:** 39 tools and 20 strategy skills for multi-market stock analysis and backtesting
...
- **Why use it:** Curated stock/finance/quant plugins with 24 verified bilingual entries
...
- **Tags:** `no-code`, `crm`, `erp`
- **Why use it:** AI-powered no-code platform for building CRM, ERP, and business systems without coding.
...
- **Why use it:** Curated plugin list for DSH — essential discovery resource for exploring available tools
...
- **Tags:** `dsh-web`, `dsh-plugin`, `plugin-aggregation`
- **Why use it:** Web plugin aggregation ecosystem distributing DSH plugins through a creative workshop
...
- **Tags:** `ai-writing`, `novel-writing`, `dsh-plugin`
- **Why use it:** Full AI novel writing pipeline with characters, worldbuilding, and editing.
...
- **Why use it:** Curated bilingual plugin list — essential navigation for discovering DSH ecosystem tools.
...
- **Tags:** `knowledge-base`, `mcp`, `mlops`
- **Why use it:** Comprehensive AI knowledge base and directory covering RAG, agents, MLOps, and learning paths.
...
- **Why use it:** Massive plugin marketplace with 11000+ plugins and search API
...
- **Why use it:** Comprehensive agent-first DSH handbook with 173 source-backed resources
...
- **Why use it:** Plugin catalog with 1958 repos and bilingual search/filter
...
- **Tags:** `discovery`, `plugin-manager`, `verification`
- **Why use it:** Skill that discovers, installs and verifies DSH GitHub plugins
...
- **Why use it:** Curated awesome list of useful DSH plugins and extensions
...
- **Why use it:** Official auto-generated curated list of Cordis DSH plugins by cordis.run
...
- **⭐ Stars:** 44
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇���/风水/五运六气/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `ai-agent`, `bazi`, `chinese-traditional-wisdom`, `dashboard`, `deepseek-harness`, `dsh-plugin`, `fengshui`, `iching`, `tcm`, `ziwei-doushu`
- **Why use it:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇���/风水/五运六气/
...
- **Why use it:** Double-check before you ship: grill the requirements, test the implementation, p
...
- **⭐ Stars:** 41
- **Language:** Python
- **Description:** 数学建模资源，包含辅助建模、数据��处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harness v4.1 pro，但并非仅有dsh适配，skill内涵skill.md文件、README.md文件，reference文件夹及所需依赖，可以利用各种大模型agent进行安装，此外，库内还上传了数学建模workbench的自定义agent，涵盖着数学建模建模手，编程手，论文手三者分工流程及其他要点，使用该agent便于减少数学建模相关提示词的输入，配合各类skill能完成较为高质量的数学建模论文
- **Why use it:** 数学建模资源，包含辅助建模、数据��处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harne
...
- **Why use it:** Reusable Codex skill for building and validating DeepSeek Harness and Cordis plu
...
- **Tags:** `agent-orchestration`, `agent-team`, `ai-agents`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `multi-agent`, `multi-agent-systems`
- **Why use it:** dsh-agent-team gives DeepSeek Harness agents that don't reset: durable Members w
...
- **Why use it:** DeepSeek Harness (DSH) plugin: replaces the stats row under the composer with pr
...
- **Tags:** `catalog`, `community`, `reference`
- **Why use it:** Community-curated catalog of DSH plugins for discovery and reference
...
- **Why use it:** Comprehensive curated list of all DSH plugins, tools, and skills in one place
...
- **Tags:** `registry`, `curated-list`
- **Why use it:** Spam-filtered open-data registry, reliable plugin discovery source
...
- **Why use it:** Curated DSH plugin list with bilingual descriptions for easy browsing
...
- **Tags:** `plugin-directory`, `discovery`
...
- **Why use it:** Handy curated collection of useful DSH plugins for quick reference
...
- **Why use it:** Comprehensive plugin ecosystem directory covering CLI, web UI, and agents
...
- **Why use it:** Updated 2026 plugin list with quality checks, current and reliable
...
- **Tags:** `documentation`, `guide`, `awesome-list`
...
- **Tags:** `marketplace`, `skills`, `directory`
...
- **Why use it:** Evidence-backed plugin radar and 2Origin lab integration
...
- **Why use it:** Curated selected DSH plugin collection

...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 840,935 ⭐ |
| **Categories** | 10 |
| **Last updated** | 2026-08-23 22:27:58 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,838 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,730 | Local-first AI design tool with Figma-like capabil |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,052 | Meta-harness for multi-agent swarms and autonomous |
...
- **Why use it:** Core DSH framework enabling everything-as-plugin architecture
...
- **Tags:** `multi-agent`, `mcp`, `dsh-plugin`
- **Why use it:** Self-evolving multi-model agent harness with memory
...
- **Tags:** `coding-agent`, `tui`, `dsh-plugin`
- **Why use it:** Terminal-native AI coding agent with prompt caching
...
- **Why use it:** Beginner-friendly tutorial from 0 to 1 for DSH plugin development.
...
- **Why use it:** Unified multi-device agent orchestration with task boards and API.
...
- **Why use it:** Self-improving Agent OS that gets smarter through loop engineering.
...
- **Why use it:** One-click switch between major AI coding agents
...
- **Tags:** `agent-teams`, `dsh-plugin`, `vibe-coding`
...
- **Tags:** `agent-skills`, `code-review`, `dsh-plugin`
- **Why use it:** AI code review grounded in 12 classic engineering books
...
- **Tags:** `deepseek-harness`, `macos`, `swift`, `coding-agent`
...
- **Tags:** `coding-agent`, `team`, `dsh-plugin`
...
- **Tags:** `skills`, `mcp`, `webui`
- **Why use it:** Skill and MCP management panel for DSH Web UI.
...
- **Why use it:** Agent skill for building DSH plugins with standard patterns and templates
...
- **Tags:** `dsh-plugin`, `plugin-development`, `agent-skill`
- **Why use it:** Agent skill for managing plugin slots, remotes and credentials
...
- **Why use it:** Official DSH plugin dev knowledge base as an on-demand agent skill
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional sync bridge between Codex and DSH with live skills and MCP mirroring
...
- **Why use it:** Audits AGENTS.md token costs, detects duplicates and conflicts via Web UI
...
- **Tags:** `skills`, `manager`
- **Why use it:** Centralized skills management plugin for DSH ecosystem
...
- **Why use it:** Backup, restore, migrate and sync complete DSH config via WebDAV
...
- **Why use it:** Web GUI plugin card for managing skills and MCP servers in browser
...
- **Why use it:** Portable agent skill for developing and auditing DSH plugins with optional bundle adapter
...
- **Why use it:** Practical DSH plugin dev guide covering cordis, tsconfig, Windows junctions, and zstd compression
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins entirely within the harness environment
...
- **Why use it:** Built-in GUI plugin manager with hot-reload support
...
- **Why use it:** Hot-reload MCP and skill config via DSH settings page
...
- **Tags:** `publisher`, `dsh-plugin`, `automation`
- **Why use it:** One-click plugin publishing tool with validation, docs generation, and PR automation.
...
- **Why use it:** Local-first AI design tool with Figma-like capabilities
...
- **Tags:** `web-ui`, `gui`, `skins`
- **Why use it:** Full DSH web GUI with task boards, mobile SSH, and WebGL-optimized skins.
...
- **Why use it:** Extensible sidebar with file editor, terminal, Git and more
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `tui`
- **Why use it:** Claude Code-style TUI with real-time status and streaming
...
- **Tags:** `desktop-pet`, `electron`, `mcp`, `plugin-sdk`
...
- **Why use it:** Lightweight Tauri desktop with zero setup required
...
- **Tags:** `desktop`, `electron`, `local-first`, `office-automation`
...
- **Why use it:** Local-first multi-model AI agent desktop app alternative
...
- **Why use it:** Renders interactive UI components inline in chat responses
...
- **Why use it:** CodePilot-inspired desktop client for DSH on all platforms
...
- **Why use it:** Canvas-based branching conversation workspace for DSH
...
- **Why use it:** Open-source Electron desktop GUI with SSH and Codex support
...
- **Why use it:** Persistent bottom info bar showing provider, model, live balance, and peak/off-peak pricing
...
- **Why use it:** Electron desktop shell for DSH with integrated plugins and sidebar support
...
- **Why use it:** LLM knowledge platform with RAG and self-maintaining wiki
...
- **Why use it:** Portable, local-first memory layer enabling cross-agent persistent recall.
...
- **Why use it:** Self-evolving hybrid-retrieval memory with 35% token savings.
...
- **Tags:** `skill`, `retrieval`, `rag`
- **Why use it:** Curate SKILL.md files into searchable agent-skill corpora.
...
- **Tags:** `memory`, `powercontext`, `handoff`
- **Why use it:** Connects to PowerContext for memory and experience recall
...
- **Why use it:** Meta-harness for multi-agent swarms and autonomous workflows
...
- **Tags:** `image-generation`, `skills`, `prompt-engineering`
- **Why use it:** 470+ reverse-engineered image prompts with reusable skills and templates.
...
- **Why use it:** Vision bridge converting images to structured JSON evidence for text agents.
...
- **Tags:** `agent-skills`, `ai-agent`, `dsh-plugin`
...
- **Why use it:** Intelligently routes and orchestrates harness workflows
...
- **Tags:** `dsh-plugin`, `video-generation`, `agent`
- **Why use it:** End-to-end Vox-style video generation from a single topic
...
- **Tags:** `agent-skills`, `coding-agents`, `architecture`
- **Why use it:** Architecture-aware coding with baseline-first approach
...
- **⭐ Stars:** 1,097
- **Language:** Python
- **Description:** 为纯文本模型"看图“设计更好的视觉工具箱和���能，支持多图理解，图片问答，前端UI还原、GUI 自动化等，并可选无缝接入多个主流agent，直接识别粘贴图片｜ A vision toolkit and skill designed for text-only llms — image Q&A, long-screenshot OCR, frontend UI restoration, and GUI automation, with optional seamless integration for Codex, Claude Code, Pi, Oh My Pi, and OpenCode
- **Tags:** `agent-skills`, `vision`, `multimodal`, `computer-use`
...
- **Why use it:** Human-in-loop task manager with mobile and web control
...
- **Tags:** `browser-extension`, `ai-workflow`, `productivity`
- **Why use it:** Transform AI conversations into reusable workflows
...
- **Tags:** `agent-teams`, `multi-agent`, `dsh`
...
- **Why use it:** Native DSH vision plugin with OCR and UI restoration
...
- **Why use it:** Turn experience into repeatable execution across AI agents
...
- **Why use it:** Auto-discovers, installs and verifies GitHub plugins for DSH
...
- **Why use it:** Novel writing and short-drama production workflow plugin
...
- **Why use it:** Smartisan-style notes with Docker deployment and WeChat export
...
- **Why use it:** Specialized skills for AI infra dev workflows.
...
- **Tags:** `task-management`, `ui`
- **Why use it:** Native local taskboard with SQLite-backed project management.
...
- **Why use it:** TDD, debugging and planning skills for DSH agents.
...
- **Why use it:** 85 SKILL.md for reverse engineering and authorized pentesting
...
- **Why use it:** AI coding mentor that guides through project architecture and code review
...
- **Why use it:** 88 agent skills for research, social intelligence and marketing workflows
...
- **Why use it:** Spec-driven development skill informed by DSH engineering patterns
...
- **Why use it:** Enables cross-agent session continuity with repository-local memory
...
- **Why use it:** WorkBuddy-style skill picker for quick skill selection via composer
...
- **Why use it:** Adapted Codex skill for automatic code simplification and cleanup
...
- **Tags:** `chinese-wisdom`, `dashboard`, `bazi`
- **Why use it:** Fusion of Bazi, Fengshui, IChing etc. with local deterministic engine and dashboard
...
- **Why use it:** Free image reading & generation supporting multiple vision models
...
- **Why use it:** Version-pinned Swift Cycle governance skill, offline-verifiable
...
- **Tags:** `agent-framework`, `agent-skills`, `dsh-plugin`
- **Why use it:** Comprehensive agent asset package with 42 skills and multiple CLIs for AI engineering workflows
...
- **Why use it:** Complete Chinese official document processing tool following GB/T 9704 national standard
...
- **Tags:** `agent-skills`, `deepseek-harness`, `engineering`
- **Why use it:** Distilled engineering discipline: fact-finding, durable decisions, and honest reporting patterns
...
- **Why use it:** Godot 4.x full-stack game dev skill for DSH
...
- **Why use it:** Record macOS workflows and convert to agent skills
...
- **Why use it:** Math modeling enhancement suite with 17 skill cards
...
- **Why use it:** Virtual PM-to-QA team preset for guided product development conversations
...
- **Tags:** `agent-tools`, `plugin-injection`
- **Why use it:** Pre-flight plugin check injection that boosts agent plugin utilization predictably
...
- **Why use it:** Official OAuth integration to use ChatGPT Plus models directly inside DSH
...
- **Tags:** `architecture-diagram`, `agent-skills`, `dsh-plugin`
- **Why use it:** Agent skill for generating beautiful architecture diagrams
...
- **Why use it:** Open-source vector design tool with concurrent AI agent teams.
...
- **Why use it:** AI-powered design studio with PPT and visual editing
...
- **Tags:** `image-generation`, `visual`, `ai`
- **Why use it:** Generate images directly in DSH chats via multiple AI providers
...
- **Tags:** `design`, `ui`, `ppt`
- **Why use it:** Preview and edit OpenPencil docs directly in chat.
...
- **⭐ Stars:** 40
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或��接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `legal-tech`, `visualization`, `diagram`, `svg`
- **Why use it:** Generate litigation timeline diagrams and SVG visualizations for legal cases
...
- **Why use it:** 6 design aesthetic styles to keep vibe-coded sites away from generic AI look
...
- **Tags:** `directorx`, `ai-video`, `ai-image`, `dsh-plugin`
- **Why use it:** AI video/image/audio generation with storyboard support and configurable model tools in DSH
...
- **Tags:** `canvas`, `agent-skills`, `mcp`, `weshop`
- **Why use it:** Native WeShop canvas plugin with infinite creative skills and Cordis integration for DSH
...
- **Why use it:** Real-time token usage charts and cost estimates dashboard
...
- **Why use it:** Floating HUD panel showing git, MCP, skills and usage stats
...
- **Why use it:** Cross-browser enhancement suite for AI chat platforms
...
- **Tags:** `ai-agent`, `bilibili`, `dsh-plugin`
- **Why use it:** Local-first cross-platform AI content discovery agent
...
- **Why use it:** Use your real logged-in browser for AI agent automation
...
- **Why use it:** Chrome sidebar to control browser directly without vision
...
- **Tags:** `mobile`, `ios`, `automation`, `dsh-plugin`
- **Why use it:** Live iOS Simulator and USB iPhone automation inside DSH
...
- **Why use it:** Playwright-powered browser automation for DSH.
...
- **Tags:** `self-hosted`, `mcp-server`, `dsh-plugin`
- **Why use it:** Privacy-focused open-source resume builder
...
- **Tags:** `image`, `electron`, `dsh-plugin`
...
- **Why use it:** Task-aware router and injector for optimized reasoning mode selection.
...
- **Why use it:** Minimal-aligned two-phase preset bootstrap for DSH Standard tools.
...
- **Tags:** `vfs`, `virtual-filesystem`, `sandbox`
- **Why use it:** Unified virtual filesystem giving agents shared persistent file access.
...
- **Tags:** `dsh-plugin`, `awesome-list`, `plugin-registry`
- **Why use it:** Plugin radar with auto-discovery and curated top 50 picks
...
- **Tags:** `deepseek-harness`, `context`, `dashboard`
- **Why use it:** Context dashboard and management with browser stats
...
- **Tags:** `utility`, `oauth`, `provider`, `dsh-plugin`
...
- **Tags:** `web-search`, `utility`, `dsh-plugin`
- **Why use it:** Free no-signup web search bridge for all DSH models
...
- **Why use it:** Track session cost, budget, and token usage across providers
...
- **Why use it:** Bridge Pi ecosystem to DSH, run Pi extensions as native plugins
...
- **Why use it:** One-click browse, install and update all DSH plugins.
...
- **Why use it:** Crash-rescue with snapshots and one-click SAFE MODE.
...
- **Tags:** `context-migration`, `session`
...
- **Why use it:** Plugin registry console and official dev skill scaffold
...
- **Why use it:** Pixel-to-text OCR and image reading tools for text-only LLMs
...
- **Why use it:** Unified menu to manage MCP tool exposure levels and execution modes in DSH
...
- **Why use it:** Fast, simple, and elegant Neovim plugin manager written in Lua for lightweight setup
...
- **Tags:** `desktop`, `ssh`, `docker`, `database`
- **Why use it:** All-in-one desktop: SSH, DB, Docker + AI assistant in one window
...
- **Tags:** `utility`, `plugin-verify`
- **Why use it:** Detects and resolves plugin conflicts between versions and plugins
...
- **Why use it:** In-DSH plugin search tool combining npm and curated list discovery
...
- **Tags:** `registry`, `plugin-manager`, `dsh-plugin`
- **Why use it:** Centralized plugin registry merging multiple discovery sources with dedup.
...
- **Why use it:** Full CLI tool for discovering, installing, updating, and auditing DSH plugins.
...
- **Tags:** `pet`, `pixel-art`, `mascot`
- **Why use it:** Gallery of animated pixel-art pets for multiple agent platforms.
...
- **Tags:** `theme`, `chrome-extension`, `webgpu`
- **Why use it:** Beautiful WebGPU ocean-themed skin for DSH with Three.js visuals
...
- **Tags:** `theme`, `skins`, `dark-mode`, `opencode`
- **Why use it:** 34 opencode classic themes available with one-click application, no data loss on restart
...
- **Tags:** `theme`, `background`, `ui-customization`
- **Why use it:** Customize DSH web background with images and preset themes
...
- **Tags:** `ai`, `rag`, `mcp`
- **Why use it:** Comprehensive AI resource hub and vibe coding tutorials
...
- **⭐ Stars:** 1,605
- **Language:** Python
- **Description:** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 ��的内容，综合分析后生成有据可查的研究报告。
- **Tags:** `dsh-plugin`, `research`, `web-search`
- **Why use it:** Auto-searches 8 major Chinese platforms for research reports
...
- **Tags:** `awesome-list`, `plugin`, `dsh-plugin`
- **Why use it:** Curated bilingual plugin and tool reference directory
...
- **Tags:** `awesome-list`, `discovery`, `dsh-plugin`
- **Why use it:** Auto-scraped, human-verified plugin discovery with filtering
...
- **Tags:** `knowledge-base`, `skills`, `dsh-plugin`
- **Why use it:** Comprehensive AI resource encyclopedia and skill knowledge base
...
- **Tags:** `guide`, `dsh-plugin`, `learning`
- **Why use it:** DSH principles, marketplace guide and best practices resource
...
- **Tags:** `guide`, `awesome-list`, `dsh-plugin`
- **Why use it:** Ultimate bilingual starter guide with curated plugin recommendations
...
- **Why use it:** Curated list of DSH plugins, skills, and MCP servers
...
- **Why use it:** Plugin marketplace with 3100+ entries, search and ranking
...
- **Tags:** `dsh-plugin`, `kline`, `financial-analysis`
- **Why use it:** Interactive K-line analysis with technical indicators, support/resistance levels, and news integration
...
- **Why use it:** Bilingual curated evidence-led directory of DSH plugins with immutable reviews.
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Community-maintained DSH plugin directory listing.
...
- **Why use it:** Auto-updated daily via GitHub Actions; bilingual awesome list.
...
- **Tags:** `plugin-directory`, `registry`, `dsh-plugin`
...
- **Tags:** `industry`, `dsh-plugin`, `directory`
- **Why use it:** Industry-specific plugin curation across computing, finance, legal, and more.
...
- **Tags:** `cordis`, `awesome-list`, `dsh-plugin`
- **Why use it:** Official auto-generated curated list of DeepSeek Harness Cordis plugins.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `catalog`
- **Why use it:** 1000+ DSH tools sorted by stars — the most comprehensive community listing.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated directory of all DSH plugins; essential browsing resource.
...
- **Why use it:** Web simulation of a traditional Chinese toy, zero dependency
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `dsh`
- **Why use it:** Curated plugin ecosystem list for DSH community
...
- **Tags:** `awesome-list`, `deepseek-harness`, `tools`
- **Why use it:** Curated DSH tools and infrastructure resource list
...
- **Why use it:** DeepSeek Harness plugin collection marketplace
...
- **Tags:** `awesome-list`, `resources`
- **Why use it:** Curated list of DSH plugins covering productivity tools.
...
- **Why use it:** Community-curated plugin catalog with auto-sync every 4 hours
...
- **Tags:** `awesome-list`, `deepseek-harness`, `plugin-marketplace`
...
- **Why use it:** Curated catalog of 280+ DSH plugins across 14 categories
...
- **Why use it:** Curated list of DeepSeek Harness plugins — a community-maintained discovery resource
...
- **Why use it:** Curated DSH plugins directory with verified entries
...
- **Why use it:** Spam-filtered open-data plugin registry and skill catalog
...
- **Why use it:** Curated vertical list of 24 stock/finance/quant DSH plugins
...
- **Why use it:** Curated 2026 DSH plugin list with quality checks for discovery
...
- **Why use it:** Community-curated collection of useful DSH plugins for quick reference
...
- **Why use it:** Plugin product manual and navigation guide covering install, permissions and risks
...
- **Why use it:** Evidence-backed DSH plugin radar with 2Origin lab for plugin exploration
...
- **Tags:** `moved`, `redirect`
- **Why use it:** Redirect notice — use github.com/awesome-dsh-plugin/awesome-dsh-plugin instead
...
- **Tags:** `ai-recommender`, `awesome-list`
- **Why use it:** AI-curated hourly-updated plugin catalog across 12 categories with 190+ plugins
...
- **Tags:** `plugin-repository`, `dsh-ecosystem`
- **Why use it:** DSH plugin repository listing for ecosystem reference

...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 916,848 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-31 01:17:46 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 204,747 | Core DSH framework, everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,839 | Local-first design tool with UI generation. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,853 | Multi-agent swarm orchestration with MCP support. |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 32 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (32)
...
- **Why use it:** Super AI assistant with self-evolving memory.
...
- **Tags:** `harness`, `agent`, `tutorial`, `dsh`
...
- **Tags:** `preset`, `harness`, `standard`, `tools`
- **Why use it:** Two-phase harness preset: minimal bootstrap leading to full Standard tools (98/99 score)
...
- **Tags:** `runtime`, `desktop`, `agent`
- **Why use it:** High-performance agent runtime paired with desktop application
...
- **Why use it:** AI code review grounded in 12 classic engineering books with citations
...
- **Tags:** `agent-vision-toolkit`, `computer-vision`, `dsh-plugin`
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, screenshot
...
- **Why use it:** Turn experience into repeatable execution across multiple agents.
...
- **Why use it:** Specialized skills for writing, optimizing, and debugging AI infra systems.
...
- **Why use it:** TDD, debugging and planning superpowers adapted for DSH agents.
...
- **Why use it:** Lightweight plugin registry console with zero-patch browser panel management
...
- **Why use it:** Official DSH plugin dev knowledge base as an on-demand skill.
...
- **Tags:** `plugin-creator`, `dsh-plugin`, `development`
...
- **Why use it:** One-click MCP/Skills/rules config for multiple AI agent platforms.
...
- **Tags:** `codex`, `mcp`, `sync`
- **Why use it:** 2-way sync bridge between Codex and DSH with live skills and MCP mirroring.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web GUI plugin to manage skills and MCP servers directly in DSH settings.
...
- **Why use it:** Fast, simple, elegant Neovim plugin manager written in pure Lua.
...
- **Tags:** `agent-tool`, `plugin-discovery`, `pre-flight`
- **Why use it:** Pre-flight plugin library check that auto-injects top-K relevant plugin hints for agents
...
- **Tags:** `agent-skills`, `design-systems`, `desktop-app`
- **Why use it:** Local-first design tool with UI generation.
...
- **Why use it:** Modern desktop client for DSH plugin ecosystem.
...
- **Tags:** `web-ui`, `dsh`, `plugin-ecosystem`, `ui`
...
- **Why use it:** Extensible sidebar with built-in file editor, terminal, and chat
...
- **Tags:** `tui`, `terminal`, `theme`
- **Why use it:** Terminal-based UI with whale theme and real-time status display
...
- **Why use it:** Lightweight Tauri desktop with zero setup and preset plugins included
...
- **Tags:** `floating-widget`, `dsh-plugins`, `developer-tools`
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions and projects
...
- **Tags:** `office`, `univer`, `deepseek-harness-plugin`
- **Why use it:** Brings spreadsheets, docs, slides into DSH as a real office suite.
...
- **Why use it:** Electron desktop console for multi-tab DSH, plugin, MCP, and skill management
...
- **Tags:** `canvas`, `agentic-workflow`, `skills`
- **Why use it:** Infinite canvas with agentic creative skills, native WeShop integration.
...
- **Tags:** `desktop`, `ssh`, `docker`, `tauri`
- **Why use it:** Cross-platform Tauri desktop integrating DB, SSH, Docker panels with AI.
...
- **Why use it:** Electron desktop shell integrating DSH web with multiple plugins for a full app experience
...
- **Tags:** `ui`, `theme`, `background`, `customization`
- **Why use it:** Customizable Web UI backgrounds with presets and real-time preview for personalization
...
- **Why use it:** Self-evolving context database unifying RAG and memory.
...
- **Why use it:** LLM knowledge platform with RAG, wiki and self-maintenance.
...
- **Tags:** `memory`, `rag`, `long-term-memory`, `self-evolving`
...
- **Why use it:** Dedicated memory kit for agents with RAG capabilities
...
- **Tags:** `memory`, `vector`, `persistent`
- **Why use it:** Persistent memory layer using Markdown and Milvus vector database
...
- **Why use it:** Unlimited memory system for OpenClaw with RAG capabilities
...
- **Tags:** `workspace`, `agents`, `no-code`, `orchestration`
...
- **Tags:** `routing`, `agent`, `harness`, `cordis`
- **Why use it:** Task-aware reasoning-mode router with injector kit for adaptive routing
...
- **Tags:** `agent-os`, `loop-engineering`, `skills`, `evaluation`
- **Why use it:** Self-improving Agent OS with loop engineering and independent grading evaluation
...
- **Tags:** `enterprise`, `multi-agent`, `visual-editor`, `workspace`
- **Why use it:** Enterprise-grade local-first agent workbench with visual editor for multi-engine teams
...
- **Tags:** `skills`, `workflows`, `orchestration`
...
- **Tags:** `agentteams`, `dsh`, `dsh-plugin`
- **Why use it:** Enable multi-agent team collaboration within DSH ecosystem
...
- **Tags:** `ai-workflow`, `browser-extension`, `productivity`
...
- **Tags:** `task-management`, `agent`, `deepseek-harness`
- **Why use it:** Native task management with SQLite and Web UI — no iframe needed.
...
- **Why use it:** Specialized plugin for novel writing and short-drama production.
...
- **Tags:** `math-modeling`, `gitops`, `ai-agents`
- **Why use it:** Full-stack auto math modeling with GitOps pipeline and self-verification.
...
- **Why use it:** Automates DSH plugin discovery and installation from GitHub.
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill set with 87 SKILL.md entries
...
- **Why use it:** Brings popular Superpowers skills to Reasonix-based coding harness
...
- **Tags:** `agent-skills`, `research-automation`, `marketing-automation`
- **Why use it:** 88 cross-platform agent skills covering research, marketing, and business workflows
...
- **Why use it:** AI coding mentor that guides through architecture review and step-by-step coding
...
- **⭐ Stars:** 57
- **Language:** Python
- **Description:** 专利侵权分��系统 —— 输入专利公开号，产出竞品侵权分析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 调用。
- **Tags:** `patent-analysis`, `rag`, `multi-agent`, `legal-tech`
- **Why use it:** Patent infringement analysis engine producing competitive patent reports via skill
...
- **Tags:** `agent-skill`, `dsh-plugin`, `skill-development`
- **Why use it:** Meta skill for developing DSH plugins: slots, events, tools, and packaging standards
...
- **Tags:** `dsh-plugin`, `agent-skill`, `plugin-dev`
- **Why use it:** Agent skill to build and manage installed DSH plugins, slots, and credentials
...
- **Why use it:** Portable spec-driven development skill for repo-native workflows.
...
- **Why use it:** Adds OCR and vision tools to text-only models via skill.
...
- **Tags:** `skills`, `task-board`, `dsh-plugin`
- **Why use it:** Visual task board that manages MattSkillsDeck skills in DSH.
...
- **Tags:** `chinese-wisdom`, `dashboard`, `dsh-plugin`
- **Why use it:** Integrated Bazi, Fengshui, IChing and TCM skill with dashboard.
...
- **Why use it:** Full workflow Chinese official document processing per GB/T 9704.
...
- **Why use it:** Cross-platform session memory for agent handoff continuity.
...
- **Why use it:** Unified and safe local Agent Skills management in DSH.
...
- **Why use it:** Adapted code simplification skill inspired by DSH for cleaner codebases.
...
- **Tags:** `agent`, `skills`, `package-manager`
- **Why use it:** Package manager for AI agent assets with 42 skills, 5 CLIs, and plugins.
...
- **Tags:** `skill`, `automation`, `agent-learning`
...
- **Tags:** `design`, `skill`, `ui`
- **Why use it:** 6 design style presets to avoid the typical AI-generated look in websites.
...
- **Tags:** `skill`, `governance`, `swift-cycle`
- **Why use it:** Swift Cycle governance skill adapter with version pinning and offline verification.
...
- **Why use it:** 10 QA skills with knowledge base for AI agents, like a senior test engineer.
...
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH, registers at runtime.
...
- **Why use it:** Virtual product team agent preset simulating PM-to-engineer-to-QA workflow conversations
...
- **Tags:** `chatgpt`, `oauth`, `integration`, `skill`
- **Why use it:** Bind ChatGPT accounts via OAuth to chat with ChatGPT models directly inside DSH
...
- **Tags:** `diagram-as-code`, `mermaid-alternative`, `agent-skills`
- **Why use it:** Self-contained HTML architecture diagrams with motion.
...
- **Tags:** `design`, `vector`, `agent-team`, `vibedesign`
...
- **Tags:** `video`, `automation`, `vox`
- **Why use it:** End-to-end automated generation of Vox-style paper-collage videos
...
- **Tags:** `ai-design`, `design`, `dsh-plugin`
- **Why use it:** Native design and PPT studio with AI generation and visual editing
...
- **Why use it:** Preview and edit .op documents directly within conversation.
...
- **⭐ Stars:** 49
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把��乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `visualization`, `legal`, `timeline`, `diagram`
- **Why use it:** Legal litigation timeline and diagram generation tool for case material visualization
...
- **Tags:** `video`, `image`, `director`
- **Why use it:** AI video/image/audio skills with configurable vision and model tools.
...
- **Why use it:** Real-time token usage, cost charts, and API balance visualization in web UI.
...
- **Tags:** `browser-extension`, `chrome-extension`, `chat-management`
- **Why use it:** Multi-browser extension suite enhancing Gemini, Claude, ChatGPT.
...
- **Tags:** `content-discovery`, `automation`, `privacy`
- **Why use it:** Local-first agent that discovers content from multiple platforms
...
- **Why use it:** Tabbit Browser Playwright integration for automated web interaction.
...
- **Why use it:** Turns DingTalk chats into tool-capable agent conversations.
...
- **Tags:** `mcp-server`, `self-hosted`, `typescript`
- **Why use it:** Privacy-focused resume builder with MCP server.
...
- **Tags:** `electron`, `imageuploader`, `cloudflare-r2`
...
- **Tags:** `vfs`, `virtual-filesystem`, `tools`, `infrastructure`
- **Why use it:** Unified virtual filesystem for AI agents, abstracting storage across multiple backends
...
- **Tags:** `installation`, `model-switch`, `multi-tool`
- **Why use it:** One-click install and model switcher for multiple AI coding tools
...
- **Tags:** `marketplace`, `plugins`, `installation`
...
- **Why use it:** Ecosystem radar discovering 15900+ plugins with k8s-level validation
...
- **Tags:** `cordis-plugin`, `dsh-external`, `dsh-plugin`
- **Why use it:** Best context insight and management tool with dashboard and browser
...
- **Tags:** `cost-tracking`, `token-usage`, `deepseek-api`
...
- **Tags:** `context-migration`, `session-migration`, `cordis`
- **Why use it:** Enables seamless cross-preset session migration with preserved state.
...
- **Why use it:** Smartisan-style notes with Docker deploy, WeChat export, and skill support.
...
- **Tags:** `plugin-marketplace`, `dsh-plugin`, `cordis`
- **Why use it:** Web GUI one-click browse, install and update all dsh-plugin GitHub repos.
...
- **Why use it:** Crash-recovery snapshots with SAFE MODE for config and plugin restoration.
...
- **Why use it:** Curated awesome list of all known DSH plugins for quick discovery.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Official auto-generated curated list of Cordis DSH plugins.
...
- **Why use it:** Curated plugin and tool catalog for DSH ecosystem discovery
...
- **Tags:** `config-manager`, `backup`, `sync`, `webdav`
- **Why use it:** Complete DSH config backup, restore, migration, and WebDAV sync in one plugin
...
- **Tags:** `container`, `dsh-plugin`, `utilities`
...
- **Why use it:** Audit tool for DSH context, detecting token costs, duplicates, and conflicts.
...
- **Tags:** `migration`, `agent-migration`, `mcp`
- **Why use it:** Migrate Claude Code/Codex/OpenCode configs to DSH seamlessly.
...
- **Why use it:** Diagnoses and resolves plugin version conflicts, ensuring stable DSH environments
...
- **Why use it:** Curated plugin directory with verified loadable extensions and permission-aware guidance
...
- **Tags:** `awesome-list`, `resources`, `comprehensive`
...
- **⭐ Stars:** 4
- **Language:** Unknown
- **Description:** 好用的DeepSeek Harness插件��合
- **Tags:** `awesome-list`, `community`, `plugins`
...
- **Why use it:** Star-ranked verified community plugins for DSH with curated quality assurance
...
- **Tags:** `documentation`, `navigation`, `plugin-guide`
- **Why use it:** Plugin product manual and navigation helping users choose by scenario with compatibility info
...
- **Why use it:** Complete DSH tool catalog with 1000+ repos sorted by stars for comprehensive reference
...
- **Why use it:** CodeX-style plugin marketplace for DSH enabling easy browsing and installation of skills
...
- **Tags:** `awesome-list`, `repository`, `ecosystem`
- **Why use it:** DSH plugins repository and ecosystem reference for plugin exploration
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `ui`
- **Why use it:** Public animated pet gallery adding cute mascots to coding agents and CLI tools
...
- **Why use it:** Whale girl themed visual skin for DeepSeek Harness interface
...
- **Tags:** `theme`, `threejs`, `webgpu`, `chrome-extension`
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** 34 opencode classic color themes, one-click apply with persistence across restarts.
...
- **Tags:** `ai`, `llm`, `rag`, `vibe-coding`
- **Why use it:** Comprehensive AI resource library with tutorials and prompt大全
...
- **Tags:** `research`, `china`, `auto-report`
- **Why use it:** Auto-searches Chinese platforms and generates cited research reports
...
- **Tags:** `academic-search`, `citation-graph`, `mcp`
...
- **Why use it:** Domain pack with research methodology, chain mapping, and news tracking skills.
...
- **Why use it:** Interactive K-line analysis with multi-market data, indicators, and news.
...
- **Why use it:** Curated plugin radar with evidence-backed listings.
...
- **Why use it:** Bilingual directory reviewed at immutable commits.
...
- **Why use it:** Auto-crawled daily directory with bilingual README.
...
- **Why use it:** Hourly AI-curated list covering 190+ plugins in 12 categories.
...
- **Why use it:** Redirects to updated plugin registry repository.
...
- **Why use it:** Auto-updating data-driven curated plugin list with Vercel hosting.
...
- **Why use it:** Curated list covering models, tools, sandboxes, UI, and agent loops.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Concise Chinese-language DSH plugin collection.
...
- **Why use it:** Industry-specific DSH plugins for computing, finance, law, HR, etc.
...
- **Why use it:** 20+ industrial prompt templates with 530+ reverse-engineered cases.
...
- **Why use it:** Open-source AI + no-code platform for business systems.
...
- **Why use it:** Curated plugin index for DSH ecosystem discovery and browsing
...
- **Tags:** `toy`, `simulation`, `web`
- **Why use it:** Web simulation of a traditional Chinese toy with real recordings
...
- **Why use it:** Comprehensive curated list of DSH ecosystem plugins, tools, and infra
...
- **Why use it:** Armor-breaking prompt plugin to stabilize DeepSeek generation output
...
- **Why use it:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭
...
- **Why use it:** Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harn
...
- **Why use it:** Essential guide for DSH learning and plugin marketplace exploration.
...
- **Why use it:** Ultimate quick-start guide with curated resources and tools.
...
- **Tags:** `plugin-directory`, `marketplace`, `awesome-list`
- **Why use it:** Massive plugin registry with 11K+ entries and search API.
...
- **Tags:** `awesome-list`, `mcp`, `coding-agent`
- **Why use it:** Curated list covering plugins, skills, MCP servers and UIs.
...
- **Why use it:** Community photo wall for DSH beta with GitHub OAuth and whitelisted check-in.
...
- **Tags:** `awesome-list`, `curated-list`, `directory`
- **Why use it:** Curated plugin directory for DSH ecosystem discovery and reference.
...
- **Why use it:** Public GitHub directory for DSH plugins with install commands and discovery.
...
- **Tags:** `awesome-list`, `curated-list`, `catalog`
- **Why use it:** Unofficial community catalog for comprehensive DSH plugin discovery.
...
- **Tags:** `registry`, `open-data`, `plugin-registry`
...
- **Why use it:** Quality-checked curated plugin list for DSH in 2026.
...
- **Why use it:** Vertical curated list of 24 verified stock/finance/quant DSH plugins.

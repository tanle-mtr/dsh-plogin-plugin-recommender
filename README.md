...
|--------|-------|
| **Plugins tracked** | 195 |
| **Total community stars** | 959,681 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-03 17:42:46 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 210,869 | The foundational platform powering the entire DSH  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,841 | Local-first open-source design tool with agent-dri |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,329 | Deploy multi-agent swarms and autonomous coordinat |
...
- **Why use it:** The foundational platform powering the entire DSH plugin ecosystem
...
- **Tags:** `ai-agents`, `multi-agent`, `mcp`, `dsh-plugin`
- **Why use it:** Multi-model AI assistant with self-evolving memory and knowledge
...
- **Tags:** `ecosystem`, `plugin`, `tooling`
- **Why use it:** Ecosystem radar discovering and validating 15900+ DSH plugins
...
- **Why use it:** AI code review grounded in 12 classic software engineering books
...
- **Tags:** `armor-breaking`, `enhancement`, `plugin`
- **Why use it:** DeepSeek armor-breaking plugin for enhanced model capabilities
...
- **Tags:** `ios`, `mobile-automation`, `coding-agent`, `mcp`
- **Why use it:** 22 tools for live iOS Simulator and USB iPhone automation inside DSH conversations.
...
- **Why use it:** Official standard skill for building DSH plugins and adapters.
...
- **Why use it:** Essential skill for installing and managing DSH plugin slots.
...
- **Why use it:** Official DSH plugin dev docs as an on-demand agent skill.
...
- **Tags:** `plugin-creator`, `codex`, `dsh-plugin`
...
- **Why use it:** Plugin discoverability search within DSH agents
...
- **Tags:** `agent-skills`, `ai-design`, `desktop-app`, `dsh-plugin`
- **Why use it:** Local-first open-source design tool with agent-driven prototyping
...
- **Tags:** `desktop`, `dsh-plugin`, `deepseek-harness`, `dsh`
...
- **Why use it:** Web UI plugin aggregation ecosystem for DSH community
...
- **Why use it:** Lightweight Tauri desktop app with preset plugins and zero setup
...
- **Why use it:** Local-first Electron desktop workspace integrating DSH sessions and files
...
- **Tags:** `ui`, `interactive`, `components`, `genui`
- **Why use it:** Interactive UI components rendered inline via dsh-ui fence
...
- **Why use it:** Local-first Tauri desktop app with multi-model and self-evolving skills
...
- **Why use it:** Open-source Electron desktop client with SSH and mobile remote access
...
- **Why use it:** Canvas-based visual non-linear conversation workspace
...
- **Tags:** `desktop-app`, `electron`, `ui-extension`
...
- **Tags:** `office`, `ui-extension`, `collaboration`
- **Why use it:** Integrates spreadsheets, docs, slides and relational tables into DSH workspace.
...
- **Why use it:** Adds multimodal vision to Claude Code for screenshot/UI/chart analysis
...
- **Why use it:** Web UI management panel for skills and MCP servers with visual configuration
...
- **Why use it:** Web GUI plugin marketplace for browsing and one-click installing DSH plugins.
...
- **Tags:** `dsh-plugin`, `mcp`, `capability-menu`
- **Why use it:** Unified menu to manage MCP tools and skills exposure level and execution mode.
...
- **Why use it:** Lightweight console for managing official DSH repository plugins with zero patch.
...
- **Why use it:** Electron desktop hub with multi-tab management for Harness, plugins, MCP and skills.
...
- **Tags:** `ui`, `info`, `web`
- **Why use it:** Clean bottom bar with live balance and pricing countdown
...
- **Tags:** `bioinformatics`, `desktop-app`, `llm-agent`
...
- **Why use it:** Electron desktop shell for DSH with sidebar integration
...
- **Tags:** `ui`, `webui`, `compact`
- **Why use it:** One-click compact context button for Web UI
...
- **Why use it:** Transform raw documents into queryable RAG knowledge base and wiki
...
- **Why use it:** Portable local-first Markdown memory layer for AI agents
...
- **Tags:** `agent-skills`, `vector-search`, `embeddings`, `reranking`
- **Why use it:** Turns SKILL.md files into retrieval-ready vector corpora
...
- **Tags:** `knowledge-base`, `mcp`, `rag`, `learning-roadmap`
- **Why use it:** AI knowledge encyclopedia with MCP, RAG, skills, and learning roadmap
...
- **Tags:** `agentic-workflow`, `multi-agent`, `swarm`, `dsh-plugin`
- **Why use it:** Deploy multi-agent swarms and autonomous coordinated workflows
...
- **Tags:** `agent-orchestration`, `mcp`, `workflows`
- **Why use it:** Unified agent workspace with cross-device task boards and MCP
...
- **Tags:** `skills`, `agent-skills`, `workflow`
- **Why use it:** Comprehensive skill store covering docs, coding, finance and automation
...
- **Tags:** `agent-control-plane`, `workflow`, `loop-engineering`
- **Why use it:** Long-horizon agent control plane for durable multi-engine workflows
...
- **Tags:** `agent-collaboration`, `workspace`, `skills`
- **Why use it:** Enterprise local-first agent workbench with multi-engine support
...
- **⭐ Stars:** 1,740
- **Language:** Python
- **Description:** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天��内容，综合分析后生成有据可查的研究报告。
- **Tags:** `research`, `web-search`, `agent-skills`
- **Why use it:** Auto-searches Chinese platforms for 30-day trending research reports
...
- **Tags:** `task-management`, `sqlite`, `workflow`, `native`
...
- **Tags:** `creative-writing`, `novel`, `screenwriting`, `fiction`
...
- **Tags:** `agent-skill`, `workflow`, `math-modeling`
- **Why use it:** Full-stack math modeling competition skill with GitOps pipeline and code verification.
...
- **Tags:** `agent-skill`, `self-evolution`, `prompt-engineering`
- **Why use it:** Composable task controls with human-reviewed self-evolution for DSH agents.
...
- **Why use it:** Discovers, installs, and verifies DSH plugins automatically via skills
...
- **Why use it:** Turns reusable experience into repeatable agent skills across multiple AI tools
...
- **Tags:** `skills`, `superpowers`, `tdd`, `collaboration`
- **Why use it:** Adapts TDD, debugging, planning and collaboration skills from obra/superpowers
...
- **Why use it:** 88 open-source agent skills covering research, marketing and business workflows.
...
- **Why use it:** Superpowers skill ported to Reasonix harness — powerful coding skills.
...
- **⭐ Stars:** 69
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带��手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `dsh-plugin`, `agent-skills`, `mentor`
- **Why use it:** AI coding mentor skill: scans architecture, generates chapters and does code review.
...
- **⭐ Stars:** 44
- **Language:** JavaScript
- **Description:** 非官方 DeepSeek Harness 插件：Matt Pocock 技能套件（mattpocock/skills）的 DSH 控制面板（Deck）——将 wayfinder 地图/票务/进度、triage / grilling / handoff 动���注入带进 DSH；配套 25 个工程与效率技能。打开形式仅右侧 details 列（无 PiP/悬浮）。安装：dsh plugin --profile <name> add 一条命令即装好，无需手动注册（DSH Desktop 桌面应用用 --profile desktop，自启 web 服务用 --profile web；profile 装错不生效，多个入口需分别安装）。
- **Tags:** `agent`, `skills`, `wayfinder`
- **Why use it:** Brings Matt Pocock's battle-tested agent skills into DSH deck.
...
- **Why use it:** Portable spec-driven development skill for coding agents.
...
- **Why use it:** Multi-agent team collaboration with shared workspace and contexts.
...
- **Tags:** `skill`, `simplification`
- **Why use it:** Adapted Codex skill for cleaner, simpler code generation
...
- **Tags:** `skill`, `session`, `memory`
- **Why use it:** Maintains cross-session continuity for multi-agent workflows
...
- **Why use it:** 10+ testing skills with shared knowledge base for QA
...
- **Tags:** `kit`, `skills`, `mcp`
- **Why use it:** Comprehensive asset pack: 42 skills, 5 CLIs for agent engineering
...
- **Tags:** `godot`, `game`, `skill`
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH workflows
...
- **Why use it:** Free image reading and generation skills for DSH with vision support.
...
- **Why use it:** AI video/image/audio director skills with storyboard and knowledge corpus support.
...
- **Why use it:** Official SkillHub API docs and examples for DSH plugin development.
...
- **Why use it:** Swift Cycle governance skill for version-pinned, offline-verifiable projects.
...
- **Tags:** `dsh-plugin`, `skill`, `development`
...
- **Why use it:** Virtual PM-to-Eng team preset for product workflows
...
- **Why use it:** 530+ industrial-grade image generation prompts distilled into skills
...
- **Tags:** `video`, `generative-ai`, `design`
- **Why use it:** End-to-end voxel explainer video generation from a single topic
...
- **Why use it:** AI-generated editable design system with PPT and prototyping studio
...
- **Why use it:** Generate images directly in-chat via Gemini/OpenAI/Seedream APIs
...
- **Why use it:** Preview, inspect, and edit .op documents directly inside conversations
...
- **⭐ Stars:** 52
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律���的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `legal-tech`, `visualization`, `timeline`
- **Why use it:** Legal litigation visualization tool: redraw case timelines into courtroom-ready diagrams.
...
- **Why use it:** Enables pixel-level image reading for text-only models via OCR.
...
- **Tags:** `design`, `ui`, `skills`
- **Why use it:** 6 design style presets prevent generic AI-looking websites
...
- **Why use it:** Cross-browser enhancement suite for Gemini, Claude and ChatGPT UIs
...
- **Why use it:** Seamless browser automation with logged-in sessions for AI agents
...
- **⭐ Stars:** 346
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索���件，免费免注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `browser`, `free`, `no-signup`
...
- **Why use it:** Tabbit Browser plugins enabling automated browser interactions in DSH.
...
- **Why use it:** OAuth integration to chat ChatGPT models in DSH
...
- **Why use it:** DingTalk IM channel with agent capabilities
...
- **Why use it:** Privacy-first self-hosted resume builder with zero data harvesting
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services natively
...
- **Tags:** `low-code`, `ai-agent`, `internal-tools`, `dsh-plugin`
...
- **Tags:** `security`, `cybersecurity`, `vulnerabilities`, `redteam`
- **Why use it:** AI security offense/defense auditing for hallucinated code
...
- **Tags:** `oauth`, `subscriptions`, `chatgpt`, `claude`, `grok`
- **Why use it:** OAuth-login to use ChatGPT/Claude/Grok subscriptions as DSH providers
...
- **Why use it:** Track session/daily costs, budgets, token usage across official and custom providers.
...
- **Why use it:** Bridges Pi and DSH ecosystems: runs unmodified Pi extensions as native DSH plugins.
...
- **Why use it:** Enables previewable cross-preset session migration preserving state and context
...
- **Why use it:** Secure P2P remote access to DSH from PC, Android, and Web with end-to-end encryption
...
- **Why use it:** Open-source Smartisan-style notes with Docker deploy, skill call, and export
...
- **Why use it:** Backup, restore and sync your complete DSH configuration via WebDAV.
...
- **Tags:** `dsh-plugin`, `container`, `management`
...
- **Tags:** `skills-manager`, `plugin-management`, `dsh-plugins`
- **Why use it:** Unified local loading and secure management of Agent Skills.
...
- **Why use it:** Audits context tokens, detects conflicts efficiently
...
- **Tags:** `config`, `mcp`, `multi-agent`
- **Why use it:** One-click MCP/skills config across 7+ AI agent tools
...
- **Tags:** `sync`, `codex`, `mcp`
- **Why use it:** Bidirectional sync bridge between Codex and DSH ecosystems
...
- **Tags:** `token-usage`, `data-visualization`, `ai-cost`
- **Why use it:** Real-time token usage, cost charts, and API balance tracking for DSH.
...
- **⭐ Stars:** 4
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注�� Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `agent-tools`, `utility`
- **Why use it:** Pre-flight plugin checklist for agent tasks
...
- **Tags:** `mascot`, `themes`, `cli`
- **Why use it:** Animated pet gallery adding personality to CLI agent interfaces
...
- **Tags:** `theme`, `ui`, `glass-effect`, `customizable`
- **Why use it:** Highly customizable frosted glass theme for DSH web UI
...
- **Why use it:** Stunning WebGPU ocean-themed visual skin for DSH via Chrome/Edge extension.
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** 34 classic opencode themes, one-click switch, persists after restart
...
- **Why use it:** Customizable web background with preset atmospheres
...
- **Why use it:** Curated DSH plugin discovery list for finding useful tools
...
- **Why use it:** Academic search skill + MCP across CrossRef, PubMed, arXiv, OpenAlex with citation graphs.
...
- **Why use it:** All-in-one academic research workbench with LaTeX, arXiv, GPU cluster support
...
- **Tags:** `chinese-api`, `api-documentation`, `deepseek-harness`
- **Why use it:** Search 65,600+ API docs across 20 Chinese open platforms directly in your agent.
...
- **Why use it:** Patent infringement analysis system producing competitive reports from patent numbers.
...
- **Tags:** `industry-research`, `research`, `cordis`
- **Why use it:** Full industry research toolkit with chain mapping and policy tracking.
...
- **Why use it:** Interactive K-line charts with technical indicators and news
...
- **Tags:** `evaluation-framework`, `rag-evaluation`, `skill-evaluation`
...
- **Why use it:** Curated quality-checked plugin list for 2026
...
- **Why use it:** Focused stock/finance plugin collection
...
- **Why use it:** Star-ranked verified community plugin list
...
- **Tags:** `awesome-list`, `index`
- **Why use it:** 1000+ repo sorted by stars, full ecosystem index
...
- **Why use it:** Plugin guide with scenario-based selection
...
- **Why use it:** Static web portal to discover and filter 227+ plugins
...
- **Why use it:** Comprehensive curated list of DSH plugins in bilingual format
...
- **Tags:** `awesome-list`, `curated`, `plugin-discovery`
- **Why use it:** Daily auto-scraped curated plugin directory with scenario-based filtering
...
- **Why use it:** Ultimate DSH guide: quickstart, resources, curated plugins and toolkit.
...
- **Why use it:** Plugin store with 11,000+ DSH plugins, search, rankings and public API.
...
- **Why use it:** Comprehensive DSH plugin catalog: 1958 repos, 1819 real plugins with search and filtering.
...
- **Why use it:** Anime search plugin with Bangumi ratings and magnet link support
...
- **Tags:** `plugin-marketplace`, `awesome-deepseek-harness`, `dsh-ecosystem`
- **Why use it:** Community-maintained auto-syncing DSH plugin catalog with curated selections.
...
- **Why use it:** Complete Chinese official document processor following GB/T standard.
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `iching`
- **Why use it:** Fusion of Bazi, Fengshui, I Ching with local deterministic engine.
...
- **Tags:** `awesome-list`, `curated`, `plugin`
- **Why use it:** Curated list of精选 DeepSeek Harness plugins and resources.
...
- **Why use it:** Plugin marketplace for DSH, similar to CodeX
...
- **Tags:** `awesome-list`, `dsh-plugin-verify`
- **Why use it:** Curated DSH plugins directory
...
- **Why use it:** Plugin radar with 2Origin plugin lab
...
- **Why use it:** 80+ verified DSH plugins by function
...
- **Tags:** `awesome-list`
- **Why use it:** Original awesome-dsh-plugins (moved elsewhere)
...
- **Tags:** `awesome-list`, `curated-list`
- **Why use it:** Auto-updating curated plugin list with bilingual README
...
- **Tags:** `coding-agents`, `curated-list`, `ui`
- **Why use it:** Curated plugins covering models, tools, UI, and agents

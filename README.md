...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,010,505 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-12 13:31:26 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 221,244 | Core harness framework powering the entire DSH plu |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,715 | Local-first AI design plugin; coding agents become |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,202 | Deploy multi-agent swarms and coordinate autonomou |
...
- **Why use it:** Self-contained HTML architecture and sequence diagrams for agents.
...
- **Tags:** `coding-agent`, `terminal`, `prefix-cache`
...
- **Tags:** `agent-os`, `evaluation`, `self-evolving`, `mcp`
- **Why use it:** Self-evolving Agent OS with interview-gated staged evaluation loop
...
- **Tags:** `vision`, `ocr`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** First vision plugin for DSH, bridges image-to-JSON for text-only agents
...
- **Why use it:** World's first virtual terminal and filesystem for AI agent sandboxes
...
- **Tags:** `agent-runtime`, `coding-agent`, `dsh-plugin`, `desktop`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop coding application
...
- **Tags:** `agent-teams`, `dsh-plugin`, `agent`
- **Why use it:** Enables multi-agent team coordination within the DSH ecosystem.
...
- **Tags:** `vision`, `computer-vision`, `ocr`, `dsh-plugin`
- **Why use it:** One-line vision toolkit: image Q&A, OCR, and UI restoration for text-only models.
...
- **Why use it:** Coding agent with sub-agents, hashline edits, and MCP support in a TUI terminal
...
- **Tags:** `huawei-cloud`, `mcp`, `devops`
- **Why use it:** Official Huawei Cloud MCP tools and sandbox for agents
...
- **Tags:** `plugin-dev`, `guide`, `scaffold`
- **Why use it:** Plugin dev knowledge base and scaffold as on-demand skill
...
- **Tags:** `plugin-creator`, `sdk`, `tooling`
...
- **Tags:** `coding`, `simplification`, `codex`, `skill`
- **Why use it:** Adapts Codex code-simplification patterns for DeepSeek Harness agent workflows.
...
- **Tags:** `chatgpt`, `oauth`, `coding-agent`
- **Why use it:** Connect ChatGPT via OAuth to use paid models inside DSH.
...
- **Why use it:** Local-first AI design plugin; coding agents become designers.
...
- **Why use it:** Modern desktop shell for DSH where even the desktop is a plugin.
...
- **Tags:** `workbench`, `enterprise`, `local-first`
- **Why use it:** Enterprise multi-engine agent workbench with visual editor, local-first
...
- **Why use it:** Extensible sidebar foundation with file editor, terminal, Git, and sub-agent pages
...
- **Tags:** `task-panel`, `ui`, `dsh-plugin`, `codex`
...
- **Tags:** `widget`, `ui`, `dsh-plugin`, `floating`
- **Why use it:** Adorable floating whale widget monitoring your DeepSeek account balance in DSH
...
- **Why use it:** Lightweight 5MB desktop app with zero setup, pre-installed plugins.
...
- **Why use it:** Windows desktop GUI client with Codex, SSH, plugins, and mobile remote access
...
- **Tags:** `notes`, `ui-extension`
- **Why use it:** Smartisan-style note-taking app with Docker deployment and WeChat/QQ alerts
...
- **Tags:** `mcp`, `ui`, `skill-management`, `web`
- **Why use it:** Web UI tool for centralized skill and MCP server management
...
- **Tags:** `marketplace`, `ui`, `plugin-install`, `web`
...
- **Why use it:** Electron-based multi-tab DSH desktop management console
...
- **Why use it:** Clean bottom bar showing model, balance, and peak/off-peak pricing in real time.
...
- **Tags:** `desktop`, `electron`, `ui`
- **Why use it:** Electron-based desktop DSH with sidebar, UI and ModLens integration
...
- **Why use it:** LLM knowledge platform turning documents into RAG and self-maintaining wiki.
...
- **Why use it:** Portable, user-owned memory layer for all AI agents — local-first Markdown-native
...
- **Tags:** `memory`, `stateful`, `continual-learning`
- **Why use it:** Stateful memory library for building agents with continual learning
...
- **Why use it:** Memory management kit for agents with refine and recall capabilities
...
- **Tags:** `memory`, `rag`, `milvus`, `dsh-plugin`, `semantic-search`
...
- **Tags:** `memory`, `agent`, `mcp`, `dsh-plugin`
...
- **Tags:** `agent-memory`, `semantic-search`, `vector-search`
- **Why use it:** Curates SKILL.md files into retrieval-ready corpora with semantic search and evaluation
...
- **Why use it:** Proactive auto-memory with three-layer consolidation
...
- **Tags:** `multi-agent`, `self-evolving`, `skills`
...
- **Tags:** `image-prompts`, `skills`, `prompt-engineering`
- **Why use it:** 530+ GPT Image prompts and reusable skills for creative agents.
...
- **Tags:** `knowledge-distillation`, `skills`, `meta-skill`
- **Why use it:** Distill expert reasoning into reusable skills for any agent.
...
- **Tags:** `skills`, `store`, `automation`
- **Why use it:** Largest skills store with auto-updated curated skill packs across domains
...
- **Tags:** `agent-skills`, `workflow-automation`, `dsh-plugin`, `vibe-coding`
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `dsh-plugin`
...
- **Tags:** `video-generation`, `agent-skill`, `ffmpeg`, `dsh-plugin`
- **Why use it:** Automated end-to-end Vox-style video generation from a single topic.
...
- **Tags:** `novel-writing`, `rag`, `creative`, `dsh-plugin`
- **Why use it:** End-to-end novel writing workflow: characters, worldbuilding, drafting, and editing.
...
- **Why use it:** AI security platform auditing code for hallucinated packages, missing safeguards, and vulnerabilities
...
- **Why use it:** Multimodal skill turning video, audio, and screen activity into searchable timestamped evidence
...
- **Why use it:** Creative writing workbenches for novels, short-dramas, games, and video recaps
...
- **Tags:** `agent-skills`, `prompt-engineering`
- **Why use it:** Enables composable, self-evolving agents with human-reviewed workflow control
...
- **Why use it:** Reusable skill templates for Claude Code, Codex, and other coding agents
...
- **Why use it:** Automatically searches, installs, and verifies DSH plugins via GitHub
...
- **Why use it:** Adds multimodal vision to text-only LLMs for UI/screenshot/analysis tasks
...
- **Tags:** `agent-skills`, `research-automation`
- **Why use it:** 88 open-source agent skills for research, marketing automation, and intelligence
...
- **Tags:** `skill-learning`, `automation`, `agent-skills`
...
- **Tags:** `fintech`, `backtesting`, `investment`, `skills`
...
- **Tags:** `superpowers`, `tdd`, `debugging`, `skills`
- **Why use it:** TDD, debugging, planning skills from obra/superpowers for DSH
...
- **Why use it:** Full GB/T 9704 standard official document processing suite
...
- **Why use it:** Spec-driven development portable agent skill
...
- **Why use it:** All-in-one traditional wisdom agent with Bazi, Fengshui, TCM and visualization.
...
- **Tags:** `roleplay`, `narrative`, `ai-roleplay`, `interactive`
- **Why use it:** Immersive 18+ interactive narrative skill with NPC memory, YAML存档 and random starts.
...
- **Why use it:** Cross-platform session memory skill enabling seamless agent handoff and objective recovery.
...
- **Why use it:** Multi-agent math modeling with 5 roles, 33 models, paper templates
...
- **Tags:** `quality-gate`, `guard`, `skill`
- **Why use it:** Engineering discipline bundle: validate requirements before shipping
...
- **Why use it:** Godot 4.x full-stack game dev skill with GDScript expertise
...
- **Why use it:** Guide AI agents to build DSH plugins from scratch end-to-end
...
- **Tags:** `plugin`, `developer`, `agent-skill`
- **Why use it:** Agent Skill for developing DSH plugins with standardized conventions
...
- **Tags:** `agent-tools`, `workflow`, `llm-agents`
- **Why use it:** Pre-flight plugin check to match top-K relevant plugins to tasks.
...
- **Tags:** `ai-curated`, `recommender`, `mcp`
- **Why use it:** Hourly AI-curated 190+ plugin recommendations by category.
...
- **Why use it:** One-click MCP/skill/config sync across Claude Code, Codex, DSH, Cursor and more.
...
- **Tags:** `skillhub`, `mcp`, `api`
- **Why use it:** Official Tencent SkillHub API docs and DSH integration guide
...
- **Why use it:** Web GUI card for managing skills and MCP servers in DSH settings
...
- **Tags:** `design`, `vector`, `agent-teams`, `ui`
...
- **Why use it:** Legal timeline and diagram visualization tool
...
- **Tags:** `image-reading`, `ocr`, `vision`, `pixel-art`
- **Why use it:** Enables text-only models to read images via OCR and pixel-level scanning tools.
...
- **Tags:** `ai-video`, `ai-image`, `storyboard`, `directorx`
- **Why use it:** AI video/image/audio creation suite with storyboard and configurable vision tools.
...
- **Why use it:** 6 design aesthetic styles to avoid generic AI-generated looks
...
- **Why use it:** Browser extension suite enhancing AI chat tools across platforms.
...
- **Tags:** `content-discovery`, `bilibili`, `browser-automation`, `dsh-plugin`
- **Why use it:** Local-first cross-platform AI content discovery agent across major Chinese platforms
...
- **Why use it:** AI agents automate real logged-in browser sessions seamlessly.
...
- **Why use it:** Free no-signup web search bridge for all models without native web access
...
- **Why use it:** Tabbit browser automation integration for DSH tasks
...
- **Tags:** `image-uploader`, `s3`, `electron`
...
- **Why use it:** Runtime injector + task-aware router kit — measured P1 performance gains
...
- **Tags:** `model-switch`, `installer`, `dsh-plugin`, `utility`
- **Why use it:** One-click install and model switch across Claude Code, Codex, DSH, and more
...
- **Why use it:** Best context dashboard, browser sidebar, and management commands.
...
- **Tags:** `plugin-marketplace`, `dsh-plugin`, `ecosystem`
- **Why use it:** Daily-refreshed plugin marketplace with pre-published reviews.
...
- **Tags:** `model-provider`, `dsh-plugin`
...
- **Why use it:** Local financial database with Tushare, MCP exposure, and multi-channel alerts
...
- **Tags:** `upgrade`, `plugin-management`, `infrastructure`
- **Why use it:** Helps plugins auto-adapt to DSH version upgrades seamlessly
...
- **Tags:** `config`, `backup`, `restore`, `sync`, `migration`
- **Why use it:** Full DSH config backup, restore, sync and migration toolkit
...
- **Tags:** `capability`, `mcp`, `utils`, `management`
- **Why use it:** Manage MCP/skill exposure levels and execution modes centrally
...
- **Why use it:** Official plugin registry console with zero patch needed
...
- **Why use it:** Audits context token costs, detects duplicates and conflicts with a Web UI panel.
...
- **Why use it:** WorkBuddy-style skill picker shortcut for quick skill insertion in the composer.
...
- **Tags:** `container`, `management`, `import`
- **Why use it:** Run multiple isolated DSH versions in containers with embedded WebView and one-click import.
...
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill, MCP into extensible platform
...
- **Tags:** `cost`, `usage`, `visualization`, `api`
- **Why use it:** Real-time token usage, cost tracking and API balance visualization
...
- **Why use it:** Minimal DSH plugin list for quick discovery
...
- **Tags:** `awesome-list`, `dsh`, `auto-update`, `bilingual`
- **Why use it:** Auto-updating curated plugin directory with bilingual README
...
- **Tags:** `pet`, `mascot`, `ui`, `theme`
- **Why use it:** Public animated pet gallery for multiple AI coding tools — delightful UX touch
...
- **Why use it:** Cute whale girl skin series to personalize your DSH interface.
...
- **Why use it:** Highly customizable frosted glass theme with adjustable blur, opacity, and wallpaper
...
- **Tags:** `theme`, `background`, `visual`, `customization`
- **Why use it:** Customizable DSH web backgrounds with presets and real-time preview
...
- **Tags:** `research`, `web-search`, `agent-skill`, `dsh-plugin`
- **Why use it:** Auto-searches top 8 Chinese platforms for 30-day content reports.
...
- **Why use it:** Curated ecosystem list covering plugins across the DSH landscape.
...
- **Why use it:** Cross-source academic search with citation graph and verification for researchers
...
- **Tags:** `research`, `industry`, `company-analysis`
- **Why use it:** Industry chain mapping and company research methodology pack
...
- **Why use it:** Search 65,600+ Chinese API docs without config
...
- **Why use it:** Patent infringement analysis with visual claim charts
...
- **Why use it:** Interactive K-line chart analysis with multi-market support, indicators, and news integration.
...
- **Why use it:** Curated awesome list of all DSH plugins, skills & resources
...
- **Why use it:** Evidence-led curated directory with verified plugins and skills
...
- **Why use it:** Curated stock/finance/quant plugin list, 24 verified bilingual entries
...
- **Tags:** `awesome-list`, `catalog`, `registry`
...
- **Tags:** `radar`, `research`, `plugin-registry`
- **Why use it:** Evidence-backed plugin radar and 2Origin lab catalog.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `directory`
- **Why use it:** Curated list of DSH plugins — essential directory for discovery
...
- **Tags:** `awesome-list`, `knowledge-base`, `encyclopedia`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, MCPs, RAG, MLOps, and learning paths
...
- **Tags:** `catalog`, `plugin-marketplace`
...
- **Why use it:** Curated awesome list of top DSH plugins for discovery and reference
...
- **Why use it:** Official curated plugin directory maintained by cordis.run
...
- **Why use it:** Specialized bioinformatics desktop agent for clinicians with offline mode and skill store.
...
- **Why use it:** Plugin guide covering install, permissions, and compatibility.
...
- **Why use it:** DSH-style plugin marketplace for browsing and installing.
...
- **Why use it:** DSHA selected curated plugin collection.
...
- **Why use it:** Search npm and curated lists for plugin discovery inside DSH.
...
- **Why use it:** DSH plugin repository with bundle and ecosystem focus.
...
- **Tags:** `redirect`, `meta`
- **Why use it:** Redirects to the main awesome-dsh-plugin repository.

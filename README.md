...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,079,630 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-22 09:20:49 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 232,861 | Core plugin framework powering the entire DSH ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,550 | Local-first design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,034 | Deploy multi-agent swarms with autonomous workflow |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 49 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (49)
...
- **Tags:** `multi-agent`, `mcp`, `agent-skills`
- **Why use it:** Self-evolving multi-agent harness with memory and task planning.
...
- **Tags:** `coding-agent`, `agent-runtime`, `vibe-coding`
...
- **Tags:** `coding-agent`, `cli`, `tui`, `rpc`, `mcp`, `go`
- **Why use it:** Terminal coding agent with RPC plugin support, sub-agents, and MCP integration.
...
- **Tags:** `cli`, `plugin-manager`, `typescript`, `hub`, `schemas`
- **Why use it:** CLI, schema parser, and resolver toolkit for building and managing DSH plugins.
...
- **Why use it:** Ports Superpowers skills to Reasonix coding harness for enhanced coding
...
- **Why use it:** Official DSH plugin development knowledge base as installable skill
...
- **Tags:** `code`, `simplification`, `refactor`
- **Why use it:** Adapted code simplification skill from official DSH find-simplifications
...
- **Why use it:** Godot Engine 4.x full-stack game development skill registered at runtime
...
- **Tags:** `agent-tools`, `plugin-management`, `cordis`
- **Why use it:** Pre-flight plugin check for DSH agents, boosts library usage.
...
- **Why use it:** Brings ChatGPT models into DSH via OAuth, expanding AI options.
...
- **Why use it:** Enhancement suite for major AI platforms with prompt manager.
...
- **Why use it:** Official desktop wrapper for DeepSeek Harness experience.
...
- **Why use it:** Open sidebar foundation supporting third-party page extensions and built-in panels.
...
- **⭐ Stars:** 3,179
- **Language:** JavaScript
- **Description:** 现���化可灵活嵌入的任务面板，支持 Codex、DeepSeek Harness
- **Tags:** `taskboard`, `ui`, `codex-plugin`
...
- **Why use it:** Featured TUI plugin with whale bar, streaming thoughts, live status, and rollback support.
...
- **Tags:** `floating-widget`, `ui-extension`, `dsh-plugin`
...
- **Why use it:** Lightweight Tauri desktop version with preset plugins, cross-platform
...
- **Why use it:** Zero-setup Windows desktop GUI with SSH, plugins, and remote access built in.
...
- **Tags:** `desktop`, `local-first`, `mcp`, `react`, `typescript`
...
- **Why use it:** Canvas-based visual workspace with non-linear branching conversations and session explorer.
...
- **Tags:** `desktop-app`, `electron`, `codepilot`
- **Why use it:** CodePilot-inspired desktop client and plugin suite across all platforms
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI panel for managing skills and MCP servers in one place
...
- **Why use it:** Desktop app tailored for bioinformatics workflows with offline mode
...
- **Why use it:** Turn documents into queryable RAG with reasoning agents and wiki.
...
- **Why use it:** Dedicated memory management kit enabling agents to remember and refine over time.
...
- **Tags:** `agent-memory`, `rag`, `embeddings`, `milvus`
...
- **Tags:** `skill-corpus`, `rag`, `embeddings`, `vector-search`, `reranking`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready vector corpora with evaluation tooling.
...
- **Why use it:** Private notes with Docker deploy, Skill support, and easy export
...
- **Tags:** `agent-workspaces`, `mcp`, `coding-agent`
...
- **Why use it:** Long-form web novel writing assistant solving AI amnesia.
...
- **Why use it:** Largest skill marketplace with auto-sourced GitHub skills.
...
- **Tags:** `agent-skill`, `video-generation`, `ffmpeg`
- **Why use it:** End-to-end automated Vox-style explainer video generation agent skill
...
- **Why use it:** Organized AI novel writing workflow with character and world management
...
- **Tags:** `agent-vision-toolkit`, `ocr`, `computer-vision`
...
- **Tags:** `novel-writing`, `creative-writing`, `screenwriting`, `workflows`
- **Why use it:** Dedicated novel, short-drama, and game script writing workflows with built-in templates.
...
- **Why use it:** Gives AI agents verifiable video/audio/screen evidence with timestamps
...
- **Why use it:** Implements Epistemic Loop for scientific discovery within DSH agents
...
- **Why use it:** Full-stack auto math modeling competition agent with GitOps pipeline and code self-verification
...
- **Why use it:** Composable and reviewable agent workflows enabling continuous self-improvement
...
- **Why use it:** Turn AI experience into repeatable execution across multiple agent platforms
...
- **Why use it:** 87 reverse-engineering & pentest skills for authorized security research
...
- **Why use it:** Specialized skills for AI infra dev, optimize and debug high-performance systems
...
- **Why use it:** Turns successful DSH sessions into reusable, reviewable agent skills
...
- **Why use it:** TDD, debugging, planning and collaboration skills from Superpowers adapted for DSH
...
- **Why use it:** Dynamic skill exposure with 3-tier strategy to reduce context overhead
...
- **Why use it:** AI coding mentor with step-by-step chapters and auto code review
...
- **Why use it:** 25 pre-built engineering skills from 30B token foundation
...
- **Tags:** `agent-skills`, `mcp`, `web-search`, `cordis`
- **Why use it:** Web search, research and content extraction skills for AI agents
...
- **Tags:** `deepseek`, `dsh-plugin`, `skills`
...
- **Tags:** `ai-docs`, `docx`, `gongwen`, `wps-office`
- **Why use it:** Full Chinese official document processing with format validation and templates
...
- **Tags:** `legal-tech`, `diagram`, `svg`, `timeline`
- **Why use it:** Legal visualization tool: timelines, case diagrams, courtroom battle maps
...
- **Tags:** `agent-platform`, `workbench`, `skills`, `typescript`
...
- **Tags:** `bazi`, `fengshui`, `tcm`, `agent-skill`
- **Why use it:** Unique Bazi/Fengshui/TCM agent skill with local deterministic engine
...
- **Why use it:** Repository-native spec-driven development skill for AI agents
...
- **Why use it:** Engineering quality gate: requirements grill, test, and delivery proof
...
- **⭐ Stars:** 39
- **Language:** Python
- **Description:** 数学建模资源，包含辅��建模、数据预处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harness v4.1 pro，但并非仅有dsh适配，skill内涵skill.md文件、README.md文件，reference文件夹及所需依赖，可以利用各种大模型agent进行安装，此外，库内还上传了数学建模workbench的自定义agent，涵盖着数学建模建模手，编程手，论文手三者分工流程及其他要点，使用该agent便于减少数学建模相关提示词的输入，配合各类skill能完成较为高质量的数学建模论文
- **Tags:** `math-modeling`, `skill`, `research`
- **Why use it:** Comprehensive Chinese mathematical modeling skill framework
...
- **Why use it:** Multi-agent team with independent skills, contexts, and shared workspace
...
- **Why use it:** Durable multi-agent team with persistent memory across sessions
...
- **Why use it:** Complete QA testing skill framework with 11 skills and decision matrix
...
- **Tags:** `planning`, `workflow`, `agent-skill`
- **Why use it:** Discussion-before-action workflow for AI-collaborative task changes
...
- **Tags:** `math-modeling`, `agent`, `cmcm`
- **Why use it:** Complete math modeling solution with 33 models, agent roles, thesis templates
...
- **Tags:** `skill`, `official`, `tencent`
- **Why use it:** Official Tencent skill catalog with API docs and plugin examples
...
- **Why use it:** WorkBuddy-style skill picker, insert skill names directly in composer
...
- **Tags:** `agent-skill`, `deepseek-harness`, `plugin-dev`
...
- **Why use it:** 530+ GPT Image prompts and industrial-grade design templates.
...
- **Tags:** `agent`, `design`, `ui`, `vibedesign`, `mcp`
...
- **Why use it:** AI-powered design studio with visual editor and template marketplace
...
- **Tags:** `ui-components`, `charts`, `forms`, `visual`, `dsh-ui`
- **Why use it:** Renders interactive UI components—charts, forms, quizzes—inline inside assistant replies.
...
- **Why use it:** OCR and image analysis tools for text-only models via vision pipeline
...
- **Why use it:** AI video/image/audio director with configurable model tools and storyboard support
...
- **Tags:** `video`, `shotcraft`, `cinematic`
- **Why use it:** Cinematic product video skill with 152 shot cards, Remotion templates
...
- **Why use it:** Real-time token usage charts and cost estimates
...
- **Why use it:** Free no-signup web search bridge for any model without native search access.
...
- **Tags:** `browser-automation`, `anti-detect`, `fingerprint`, `playwright`, `mcp`
- **Why use it:** Engine-level fingerprint spoofing with persistent browser identities and Playwright automation.
...
- **Why use it:** Official plugin marketplace with one-click install and visual browser.
...
- **Tags:** `preset`, `deepseek-harness`, `configuration`
- **Why use it:** Two-phase preset bootstrap with minimal config then full Standard tools setup.
...
- **Why use it:** Unified account management with smart routing and auto failover across multiple LLM providers.
...
- **Tags:** `context-management`, `dsh-external`, `plugin`
- **Why use it:** Best context insight and management plugin with dashboard and sidebar
...
- **Tags:** `ecosystem-radar`, `plugin-registry`, `continuous-validation`
...
- **Tags:** `security`, `cybersecurity`, `vulnerability`, `redteam`, `code-audit`
- **Why use it:** AI code security scanner: detects hallucinated packages, missing safeguards, and vulnerability patterns.
...
- **Why use it:** Adds Command Code model access with plan-aware selection and live catalog
...
- **Why use it:** Secure multi-device remote access to DSH via P2P encrypted network
...
- **Why use it:** Bridge Pi ecosystem extensions to run as native DSH plugins via ABI compatibility
...
- **Why use it:** Browser-based plugin console with zero-patch repository management
...
- **Why use it:** Context injection auditing tool with token cost stats and conflict detection
...
- **Tags:** `management`, `container`, `ui`
- **Why use it:** Local DSH management with isolated containers and embedded WebView UI
...
- **Tags:** `mcp`, `setup`, `multi-agent`
- **Why use it:** One-click MCP/Skills setup across 7+ AI agent platforms locally
...
- **Tags:** `migration`, `wizard`, `utility`
- **Why use it:** Four-source migration wizard moving sessions, memories, skills between platforms
...
- **Tags:** `launcher`, `runtime`, `plugin`
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill orchestration for extensible DSH
...
- **Why use it:** Curated DSH utilities: notifications, trace, keybindings, terminal
...
- **Tags:** `doctor`, `plugin-management`, `deepseek-harness`
...
- **Tags:** `mascot`, `pixel-art`, `cli`, `developer-tools`
- **Why use it:** Public gallery of animated pets to personalize your coding agent interface.
...
- **Why use it:** Whale girl skin series for DeepSeek Harness with cute aesthetics
...
- **Tags:** `theme`, `glassmorphism`, `ui-customization`, `css`
- **Why use it:** Fully customizable glassmorphism theme for DSH web UI with adjustable blur and opacity.
...
- **Tags:** `theme`, `animated-background`, `glassmorphism`
- **Why use it:** Beautiful real-time ocean animated theme with glassmorphism effects
...
- **Why use it:** Customize DSH Web background with presets and uploads.
...
- **Why use it:** Local-first cross-platform content discovery agent covering Bilibili, YouTube, Reddit, etc.
...
- **Tags:** `documentation`, `code-analysis`, `deepwiki`
- **Why use it:** Turns codebases into accurate technical docs and AI-ready context instantly.
...
- **Tags:** `awesome-list`, `curated`, `bilingual`, `plugin-index`
- **Why use it:** Bilingual curated catalog of DSH plugins, skills, runtimes, and verified integrations.
...
- **Tags:** `academic`, `latex`, `arxiv`, `research`, `gpu-cluster`
- **Why use it:** All-in-one research workbench: LaTeX writing, arXiv management, GPU orchestration, and experiment tracking.
...
- **Tags:** `knowledge-base`, `resource-catalog`, `ai-encyclopedia`, `learning`
- **Why use it:** Comprehensive AI resource encyclopedia covering LLMs, agents, RAG, multimodal tools, and learning paths.
...
- **Why use it:** Curated daily-filtered plugin directory with scenario-based recommendations
...
- **Why use it:** Comprehensive curated list of DSH plugins, MCP servers, patches and guides
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins and practical tools
...
- **Tags:** `mcp`, `finance`, `agent`
- **Why use it:** Local financial database with Tushare integration for multi-agent stock analysis
...
- **Why use it:** Domain pack for industry/company research with methodology and tracking
...
- **Tags:** `plugin-registry`, `curated-list`, `deepseek-harness`
...
- **Why use it:** Public GitHub directory for plugin discovery
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** Evidence-led curated plugin directory with quality checks
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** 2026 curated DSH plugins with quality verification
...
- **Tags:** `awesome-list`, `curated-list`, `dsh-plugins`
...
- **Why use it:** Comprehensive daily-updated plugin marketplace reviewed before publishing
...
- **Tags:** `awesome-list`, `plugin-directory`, `marketplace`
- **Why use it:** Massive plugin catalog with 11000+ DSH plugins, search and API support
...
- **Tags:** `deepseek-harness`, `awesome-list`, `mcp`
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, search and classification
...
- **Why use it:** Curated list of DSH plugins, extensions, tools and dev resources
...
- **Why use it:** Essential curated index of 280+ community plugins across 14 categories
...
- **Tags:** `catalog`, `community`, `plugin`
- **Why use it:** Unofficial community catalog for DSH plugins, comprehensive listing
...
- **Why use it:** 1000+ DSH repos sorted by stars, comprehensive overview.
...
- **Tags:** `guide`, `awesome-list`, `documentation`
...
- **Tags:** `recommender`, `awesome-list`, `ai-curated`
...
- **Tags:** `directory`, `awesome-list`, `automation`
...
- **Tags:** `curated`, `dsha`, `plugins`
- **Why use it:** DSHA精选插件合集，官方精选推荐。
...
- **Why use it:** Curated directory of 80+ verified DSH plugins by category.
...
- **Why use it:** Plugin list with bundle and verify ecosystem support.
...
- **Why use it:** Plugin list, now migrated to newer repository.
...
- **Why use it:** Auto-updating bilingual plugin directory with Vercel deployment.
...
- **Tags:** `registry`, `curated`, `coding-agents`, `ui`, `skills`
- **Why use it:** Comprehensive curated registry covering models, tools, and UI.

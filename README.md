...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 939,807 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-01 17:45:33 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 207,868 | Core DSH framework - everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,302 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,113 | Deploy intelligent multi-agent swarms and autonomo |
...
- [Research & Analysis](#research-&-analysis) — 32 plugins
...
- [Research & Analysis](research-analysis) (32)
- [Other](other) (25)
---
...
- **Tags:** `harness`, `agent`, `tutorial`
- **Why use it:** Beginner-friendly harness engineering tutorial
...
- **Why use it:** Two-phase preset bootstraps DSH with minimal then full Standard tools for reliable setup
...
- **Tags:** `bitfun`, `agent-runtime`, `ai-ide`, `vibe-coding`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for deep coding assistance
...
- **Why use it:** Book-grounded AI code review with decay risk diagnostics and citations
...
- **Tags:** `security`, `cybersecurity`, `code-audit`
- **Why use it:** Shields AI-generated code against hallucinated packages, missing safeguards, and AI pattern errors. Essential for secure dev.
...
- **Tags:** `office`, `harness-tool`, `dsh-plugin`
- **Why use it:** Brings spreadsheets, docs, and office tools directly into DSH.
...
- **Tags:** `coding-agent`, `mcp`, `harness-tool`
- **Why use it:** Coding agent with NPC sub-agents, hashline edits and MCP support.
...
- **Tags:** `migration`, `compatibility`, `harness-tool`
...
- **Why use it:** Adds vision capabilities to Claude Code for screenshot/UI/chart analysis
...
- **Why use it:** TDD, debugging, planning and collaboration skills for developers
...
- **Why use it:** Provides OCR and image-to-text tools for text-only AI models.
...
- **Tags:** `agent-migration`, `configuration-migration`, `import`
- **Why use it:** Seamlessly migrate Claude Code, Codex, and OpenCode setups into DSH
...
- **Why use it:** Real-time token usage tracking, cost estimates, and API balance visualization
...
- **Why use it:** Pre-flight plugin check for DSH agent tasks
...
- **Why use it:** Plugin marketplace like CodeX for DSH
...
- **Why use it:** Modern desktop solution for the DeepSeek Harness ecosystem
...
- **Tags:** `web-ui`, `plugin-ecosystem`, `dsh`
- **Why use it:** Web UI aggregation ecosystem for browsing DSH plugins
...
- **Tags:** `agent-sandbox`, `agent-tools`, `virtual-terminal`, `vfs`
- **Why use it:** First virtual terminal for AI agents, enabling sandboxed multi-session workflows
...
- **⭐ Stars:** 3,213
- **Language:** TypeScript
- **Description:** 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/���代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
- **Tags:** `deepseek-harness`, `sidebar`, `dsh-plugin`
- **Why use it:** Open sidebar foundation with file editor, terminal, chat, Git, and agent panels
...
- **Tags:** `dsh-plugin`, `skills`, `cli`, `codex`
- **Why use it:** Modern flexible task panel with seamless Codex and DeepSeek Harness integration
...
- **Tags:** `deepseek-harness`, `tui`, `terminal`, `dsh-plugin`
- **Why use it:** Claude Code-inspired TUI with whale header, streaming thoughts, rollback, and real-time context progress
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero env setup needed
...
- **Why use it:** Local-first Electron desktop workspace with MCP and office integration
...
- **Why use it:** Renders interactive UI components (charts, forms, layouts) inline within DSH assistant replies via dsh-ui fence.
...
- **Why use it:** Local-first AI agent desktop app with multi-model support, self-evolving skills, and privacy-first architecture.
...
- **Why use it:** Zero-setup Windows desktop client with Codex, plugins, skills, SSH, and mobile remote access built in.
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite across macOS, Windows, and Linux.
...
- **Why use it:** Smartisan-style notes app with Docker deployment and article export
...
- **Tags:** `marketplace`, `webui`, `plugin-market`, `ui`
- **Why use it:** Community plugin marketplace with one-click install/uninstall in web GUI
...
- **Why use it:** Electron desktop hub managing Harness, plugins, MCPs, and skills
...
- **Tags:** `balance`, `usage-tracking`, `ui`
- **Why use it:** Live balance, peak pricing and model info at a glance in the bottom bar.
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI
...
- **Why use it:** One-click compact button for DSH Web context meter panel UI.
...
- **Tags:** `multi-agent`, `swarm-intelligence`, `agentic-workflow`
- **Why use it:** Deploy intelligent multi-agent swarms and autonomous workflows
...
- **Tags:** `prompt-engineering`, `image-generation`, `skills`
- **Why use it:** 530+ industrial prompt templates and skills for image generation
...
- **Why use it:** Distill how experts think into reusable agent skills
...
- **Why use it:** Unified agent orchestration and workspace management platform
...
- **Why use it:** Task-aware reasoning-mode router with injector for DSH
...
- **⭐ Stars:** 6,030
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：416个精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分���、更新时间、Star数量整理。
- **Tags:** `skills`, `marketplace`, `automation`
- **Why use it:** Largest skills marketplace with 416+ ready-to-install skill packs
...
- **Why use it:** Self-improving Agent OS with loop engineering at its core
...
- **Tags:** `agent-control`, `long-horizon`, `workflow`
- **Why use it:** Long-horizon agent control plane for durable cross-harness work
...
- **Why use it:** Enterprise-grade local-first multi-agent workbench with visual editor
...
- **Tags:** `agent-skills`, `workflow-automation`, `vibecoding`, `multi-agent`
- **Why use it:** Intelligent skill routing and workflow orchestration boosting rewards and cutting token usage significantly
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `j-space`, `deepseek-harness`
- **Why use it:** Cognitive-enhancement skills based on Anthropic J-space global workspace research for deeper agent reasoning
...
- **Why use it:** Enable multi-agent team coordination within DSH
...
- **Why use it:** Native SQLite-backed task management with agent claim/review workflow. No iframe or second runtime needed.
...
- **Tags:** `creative-writing`, `skill`, `dsh-plugin`
- **Why use it:** Creative writing agent for novels and short-drama production.
...
- **Tags:** `skill`, `math-modeling`, `competition`
...
- **Tags:** `skill`, `self-evolution`, `review`
- **Why use it:** Composable task controls enabling human-reviewed agent self-evolution.
...
- **Why use it:** Auto-searches, installs and verifies GitHub DSH plugins.
...
- **Why use it:** Turn coding experience into repeatable agent execution workflows.
...
- **Why use it:** Specialized skills for AI infrastructure code writing, optimization and debugging
...
- **Why use it:** 87 reverse engineering and pentesting SKILL.md plugins for security research
...
- **Why use it:** AI coding mentor skill: scans projects, generates chapters, does code review
...
- **Why use it:** Agent skill that scaffolds and develops DSH plugins from scratch
...
- **Tags:** `spec-programming`, `agent-skill`, `ai-coding`
- **Why use it:** Enables spec-driven development workflows directly in repositories.
...
- **Tags:** `skills-deck`, `agent-skills`, `task-delegation`
- **Why use it:** Game-like task delegation system using MattSkillsDeck in DSH.
...
- **⭐ Stars:** 31
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、���容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `workflow`, `chinese-docs`
- **Why use it:** Full Chinese official document pipeline per GB/T 9704 national standard.
...
- **Tags:** `multi-agent`, `team`, `collaboration`, `workspace`
...
- **Why use it:** Cross-platform skill for repository-local continuity memory between agents.
...
- **Tags:** `code-simplification`, `codex`, `refactoring`
- **Why use it:** Codex skill adapted from DSH to find and simplify code automatically.
...
- **Tags:** `package-manager`, `skills`, `multi-agent`
- **Why use it:** Package manager with 42 skills, 5 CLIs and plugin for AI agent engineering.
...
- **Why use it:** 10 QA skills with shared knowledge base for AI-powered test engineering.
...
- **Why use it:** User-invoked governance skill with version pinning and offline verification
...
- **Why use it:** Infinite canvas with agentic creative skills for enhanced workflow
...
- **Why use it:** Virtual product team agent preset (PM/QA/Eng)
...
- **Why use it:** OAuth integration to use ChatGPT models in DSH
...
- **Tags:** `vision`, `mcp`, `multimodal`, `ocr`
- **Why use it:** First vision plugin bridging image input to structured JSON for agents
...
- **⭐ Stars:** 333
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免���免注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `free`, `mcp`
- **Why use it:** Free web search bridge for models without native web access. No signup or API key required.
...
- **Tags:** `mcp`, `capability-management`
...
- **⭐ Stars:** 14
- **Language:** JavaScript
- **Description:** 改配置+重启才能加 MCP？DeepSeek Harness (DSH) 插件「技能配置」解决：设置页粘贴 JSON 即连 MCP 服务器、热加载免重启；上传 zip/.skill 自动识别 SKILL.md，创建/编���/启停技能，即点即用
- **Tags:** `mcp`, `skill-management`, `hot-reload`
- **Why use it:** Hot-reload MCP config from UI without restart; auto-detects .skill uploads
...
- **Tags:** `ai-design`, `figma-alternative`, `prototyping`
- **Why use it:** Open-source Claude Design alternative with local-first UI
...
- **Tags:** `design`, `ui`, `agent-team`, `vibe-design`
...
- **Tags:** `video-generation`, `ai-video`, `ffmpeg`, `tts`
- **Why use it:** Auto-generates Vox-style collage explainer videos end-to-end
...
- **Tags:** `computer-vision`, `ocr`, `vision`
- **Why use it:** Vision toolkit for text-only models: OCR, image Q&A, screenshot analysis
...
- **Why use it:** AI-powered design system with visual editor and PPT generation
...
- **Why use it:** Generate images directly in DSH chats using multiple models including Gemini, Seedream, and OpenAI.
...
- **Why use it:** Preview, inspect and edit .op documents directly in conversation
...
- **Tags:** `visualization`, `legal-tech`
- **Why use it:** Visualizes litigation timelines and diagrams in SVG
...
- **Tags:** `design`, `vibe-coding`, `ui-styles`
...
- **Why use it:** Free image reading and generation with auto vision transclusion support.
...
- **Tags:** `video`, `image-generation`, `ai-director`
- **Why use it:** AI video/image/audio creation with storyboard and configurable model tools.
...
- **Tags:** `browser-extension`, `prompt-management`, `chat`
...
- **Tags:** `bilibili`, `content-discovery`, `ai-agent`, `cross-platform`, `local-first`
- **Why use it:** Local-first self-evolving cross-platform content discovery agent for Bilibili, Douyin, Xiaohongshu and more
...
- **Why use it:** Let AI agents operate your real logged-in browser seamlessly
...
- **Why use it:** Live iOS Simulator and USB iPhone control inside DSH conversations. 22 agent tools for mobile automation.
...
- **Tags:** `ai-agent`, `dingtalk`, `chat-bot`, `dsh-plugin`
- **Why use it:** DingTalk IM channel enabling tool-capable agent chat bots.
...
- **Tags:** `image-uploader`, `electron-app`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `claude-code`, `openclaw`
- **Why use it:** One-click multi-model switcher across Claude Code, Codex, Grok, DSH, Kimi, Qwen and more
...
- **Why use it:** Built-in DSH plugin marketplace with browse, search, and one-click install functionality
...
- **Tags:** `context-migration`, `session-migration`, `preset`
- **Why use it:** Enables previewable cross-preset session migration with state preservation
...
- **Tags:** `marketplace`, `plugin-market`, `browser`
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin community plugins
...
- **Tags:** `config-manager`, `backup`
- **Why use it:** Backup, restore, migrate and sync DSH config via WebDAV
...
- **Why use it:** Plugin registry console with official dev guide skill
...
- **Tags:** `plugin-management`, `credentials`, `slots`
- **Why use it:** Manages slots, credentials, and remote connections for DSH plugins.
...
- **Why use it:** Auto-upgrades plugins to match the latest DSH version seamlessly.
...
- **Tags:** `knowledge-base`, `plugin-dev`, `docs`
...
- **Tags:** `container`, `multi-version`, `isolation`
...
- **Tags:** `config-sync`, `mcp`, `multi-agent`, `universal`
- **Why use it:** One-click MCP/Skills/config sync for Claude, Codex, Cursor, Qwen, etc.
...
- **Tags:** `skills-manager`, `security`, `local-skills`
...
- **Tags:** `codex`, `sync`, `mcp`, `interoperability`
- **Why use it:** 2-way bridge syncing chat, skills and MCP between Codex and DSH.
...
- **Tags:** `mcp-manager`, `skills`, `web-ui`
- **Why use it:** Web GUI plugin for managing skills and MCP servers directly in settings.
...
- **Why use it:** Fast, elegant Neovim plugin manager for streamlined editor setup
...
- **Tags:** `mascot`, `pets`, `cli`, `visual`
- **Why use it:** Animated pet gallery for enhancing CLI coding agent aesthetics
...
- **Tags:** `dsh-plugin`, `themes`, `skins`, `deepseek-harness`
- **Why use it:** Whale Girl themed skin series adding anime-style visual customization to DeepSeek Harness
...
- **Tags:** `theme`, `ui-customization`, `glassmorphism`
- **Why use it:** Glassmorphism theme with adjustable blur,磨砂 effects, and custom wallpapers. Zero source modification needed.
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** WebGPU ocean-themed skin for DeepSeek Harness UI.
...
- **Why use it:** 34 classic opencode themes, one-click install, persists across restarts
...
- **Why use it:** Customizable web background with preset themes
...
- **Tags:** `research`, `web-search`, `skills`, `chinese-platforms`, `dsh-plugin`
- **Why use it:** Automated research skill scraping 8 major Chinese platforms for the last 30 days into cited reports
...
- **Why use it:** Auto-discovers and validates 10000+ plugins via k8s test pipeline
...
- **Why use it:** Curated list of DSH plugins serving as an ecosystem discovery guide
...
- **Why use it:** Curated ecosystem collection of DSH plugins, tools, and integrations
...
- **Why use it:** Bilingual curated list of DSH plugins, tools, and verified references
...
- **Tags:** `knowledge-base`, `ai-resources`, `nav`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, MLOps, and more. Continuously updated navigation library.
...
- **Why use it:** Auto-curated DSH plugin discovery with daily GitHub scraping, real filtering, and categorized rankings.
...
- **Tags:** `research`, `dsh-plugin`, `guide`
...
- **Tags:** `awesome-list`, `guide`, `research`
...
- **Why use it:** Curated list of DSH plugins, MCP servers, skills and orchestrators.
...
- **Tags:** `marketplace`, `catalog`, `research`
- **Why use it:** Plugin marketplace with 11K+ entries, search and install commands.
...
- **Tags:** `catalog`, `directory`, `research`
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos and multi-language search.
...
- **Tags:** `academic-search`, `arxiv`, `mcp`, `research`
- **Why use it:** Cross-platform academic paper search with citation verification and MeSH support
...
- **Tags:** `research`, `latex`, `arxiv`, `gpu-cluster`, `paper-writing`
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiment tracking, GPU SSH
...
- **Tags:** `industry-research`, `report`, `analysis`
- **Why use it:** Industry research skill pack with methodology, mapping, and tracking.
...
- **Why use it:** 24 verified stock/finance plugins, bilingual
...
- **Why use it:** Evidence-backed plugin radar and curated list for DSH ecosystem discovery.
...
- **Why use it:** Bilingual curated directory with immutable commit reviews for reliability.
...
- **Why use it:** Auto-updating daily crawl directory with bilingual support.
...
- **Why use it:** In-agent npm+awesome-list search tool for plugin discoverability.
...
- **Tags:** `awesome-list`, `coding-agents`, `deepseek-harness`, `mcp`
- **Why use it:** AI-curated 190+ plugin list across 12 categories, hourly updated.
...
- **Why use it:** 80+ verified plugins organized by functionality for quick lookup.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** DSH plugin directory with curated selections.
...
- **Why use it:** Auto-updating data-driven bilingual directory with Vercel deployment.
...
- **Tags:** `coding-agents`, `curated-list`, `deepseek-harness`, `ui`
...
- **Why use it:** Industry-specific plugin directory across computing, finance, law, HR, and more.
...
- **Why use it:** Privacy-first resume builder, completely secure and free
...
- **Tags:** `armor-breaking`, `deepseek`
- **Why use it:** Armor-breaking plugin for bypassing DeepSeek limitations
...
- **Tags:** `awesome-list`, `dsh-plugin`, `resource`
...
- **Why use it:** Curated list of DSH plugins, extensions, and tools
...
- **Tags:** `tradition`, `wisdom`, `dashboard`, `bazi`
- **Why use it:** Unique Bazi/fengshui/IChing wisdom engine with visualization dashboard.
...
- **Why use it:** Unofficial community catalog for DSH plugins exploration
...
- **Why use it:** Spam-filtered registry of DSH plugins, bundles, and skills with open data
...
- **Tags:** `awesome-list`, `coding-agent`, `skills`
- **Why use it:** Comprehensive curated list covering plugins, tools, skills, and resources
...
- **Why use it:** Community curated useful DSH plugins collection
...
- **Why use it:** 1000+ DSH plugins sorted by stars, comprehensive
...
- **Why use it:** Plugin guide with install, permissions, risks
...
- **Tags:** `awesome-list`, `repository`
- **Why use it:** DSH plugin repository collection
...
- **Why use it:** Moved repository — redirect to new location.

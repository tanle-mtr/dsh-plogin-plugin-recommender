...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 996,937 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-10 08:52:45 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 218,239 | Core plugin ecosystem framework powering DSH agent |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,269 | Open-source design plugin with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,881 | Multi-agent swarm orchestrator with autonomous wor |
...
- **Why use it:** Core plugin ecosystem framework powering DSH agents
...
- **Why use it:** AI-powered low-code platform for rapid internal tool and system building
...
- **Why use it:** Two-phase preset bootstrap; brings full Standard tools to DSH agents efficiently.
...
- **Why use it:** Virtual terminal sandbox for AI agents; isolates and manages agent environments.
...
- **Why use it:** One-click model switcher across Claude Code, Codex, DSH, Kimi Code, and other agents.
...
- **Tags:** `radar`, `plugin`, `discovery`
- **Why use it:** Auto-discovers 15000+ plugins with production validation
...
- **Why use it:** Coding agent with sub-agents, RPC, hashline edits and MCP support.
...
- **Why use it:** SQLite-backed task management with native UI. No iframe needed.
...
- **Why use it:** Session/daily cost tracking with budget alerts and balance monitoring.
...
- **Tags:** `cli`, `plugin-manager`, `schema`
- **Why use it:** Open-source CLI with schema resolver for DSH Plugin Hub management.
...
- **Why use it:** Unofficial Command Code LLM provider with plan-aware model picker
...
- **Tags:** `ai-infra`, `skills`, `system-optimization`
- **Why use it:** Specialized skills for AI infra development and high-performance systems
...
- **Tags:** `api-docs`, `chinese-platforms`, `zero-config`
- **Why use it:** Search 20 Chinese platforms' 65k+ API docs directly in your coding agent
...
- **Tags:** `plugin-builder`, `validator`, `coding-agent`
- **Why use it:** Build and validate DSH/Cordis plugins with auto slot and credential mgmt
...
- **Tags:** `plugin-creator`, `codex`, `validator`
...
- **Tags:** `codex`, `mcp`, `deepseek-harness`
- **Why use it:** Bidirectional sync bridge between Codex and DSH with MCP mirroring
...
- **Why use it:** OAuth-based ChatGPT integration inside DSH.
...
- **Why use it:** Modern flexible task panel; integrates seamlessly with Codex and DeepSeek Harness.
...
- **Why use it:** Claude Code-style TUI for DSH with whale navbar, streaming thoughts, and rollback support.
...
- **Why use it:** Cute floating whale widget in DSH that tracks your DeepSeek account balance in real time.
...
- **Tags:** `desktop`, `workspace`, `office`
- **Why use it:** Local AI desktop workspace with office automation
...
- **Tags:** `gui`, `interactive`, `inline-ui`
- **Why use it:** Inline interactive UI components — charts, forms, quizzes in replies.
...
- **Tags:** `desktop`, `tauri`, `local-first`
- **Why use it:** Local-first Tauri desktop agent — privacy-focused, multi-model.
...
- **Tags:** `office`, `spreadsheet`, `documents`
- **Why use it:** Full office suite: spreadsheets, docs, slides in Harness workspace.
...
- **Tags:** `ios`, `simulator`, `automation`
- **Why use it:** Live iOS Simulator + USB iPhone inside conversation. 22 agent tools.
...
- **Why use it:** CodePilot-inspired desktop client with Electron plugin suite for DSH.
...
- **Tags:** `ios`, `mobile`, `native`, `websocket`
- **Why use it:** Native iOS client with WebSocket connection to DSH workspace & sessions.
...
- **Why use it:** Open-source Smartisan notes with Docker deployment and skill support
...
- **Tags:** `desktop`, `electron`, `ts`, `ui`
- **Why use it:** Electron desktop console for multi-tab DSH/Harness/MCP management
...
- **Why use it:** Adds one-click compact view to DSH context meter panel.
...
- **Why use it:** Converts recent chat history into shareable knowledge cards.
...
- **Tags:** `multi-agent`, `mcp`, `agent-memory`
- **Why use it:** Self-evolving agent harness with unified memory and knowledge system
...
- **Why use it:** Open-source RAG knowledge platform with self-maintaining wiki and agent
...
- **Why use it:** Dedicated memory management kit for agents; remembers and refines agent knowledge.
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Markdown and Milvus vector store.
...
- **Why use it:** Best context insight and management dashboard for DSH
...
- **Tags:** `skill`, `corpus`, `retrieval`
- **Why use it:** Turns scattered SKILL.md into retrieval-ready corpora
...
- **Tags:** `academic-search`, `citation`, `crossref`, `arxiv`
- **Why use it:** Cross-platform academic search: CrossRef, PubMed, arXiv dedup with citations.
...
- **Tags:** `memory`, `rag`, `auto-consolidation`
- **Why use it:** Three-layer auto memory with zero-prompt recall before model speaks
...
- **Why use it:** Distill thinking patterns into reusable agent skills for any bot
...
- **Why use it:** Intelligent skill routing and workflow orchestration; boosts agent reward significantly.
...
- **Tags:** `cognitive-enhancement`, `skills`, `research`
...
- **Tags:** `video`, `skill`, `workflow`
- **Why use it:** End-to-end video generation skill for AI agents
...
- **Tags:** `agent`, `teams`, `collaboration`
- **Why use it:** Enable multi-agent collaboration in DeepSeek Harness
...
- **Why use it:** Vision toolkit: OCR, screenshot recognition, Q&A
...
- **Tags:** `multimodal`, `ocr`, `skill`
- **Why use it:** Multimodal sensor skill — video, audio, screen into timestamped evidence.
...
- **Tags:** `creative`, `writing`, `skill`
- **Why use it:** Dedicated novel and short-drama writing skill — creative workflow.
...
- **Why use it:** Auto math modeling competition skill with GitOps pipeline & self-proof.
...
- **⭐ Stars:** 206
- **Language:** TypeScript
- **Description:** 让 Agent 的工作方式可组合、可审查、可持��改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **Tags:** `agent-review`, `plan-mode`, `prompt-engineering`
- **Why use it:** Enables composable, self-evolving agent workflows with human review
...
- **Why use it:** Turns experience into repeatable agent execution skills
...
- **⭐ Stars:** 173
- **Language:** JavaScript
- **Description:** 帮 DSH 搜索、安装并��证插件的 Skill｜A DSH skill that finds, installs, and verifies GitHub plugins
- **Tags:** `plugin-discovery`, `agent-skills`, `automation`
- **Why use it:** Discovers, installs, and verifies GitHub plugins via skill
...
- **Why use it:** Auto-upgrades DSH plugins across versions seamlessly
...
- **Why use it:** Ports proven Superpowers skills to Reasonix/DSH
...
- **Why use it:** TDD, debugging and planning skills from Superpowers adapted
...
- **Why use it:** Patent infringement skill callable by any agent with RAG analysis
...
- **Tags:** `skills`, `matt-pocock`, `workflow`
- **Why use it:** 25 ready-made Matt Pocock skills panel for triage/workflow automation
...
- **Tags:** `gongwen`, `gb-t-9704`, `doc-processing`
- **Why use it:** National GB/T 9704 standard doc processing with format check and fix
...
- **Tags:** `spec-driven`, `development`, `agent-skill`
...
- **Why use it:** Official SkillHub API docs and examples for DSH ecosystem
...
- **Why use it:** Full-stack Godot 4.x game dev skill for AI-assisted development
...
- **Tags:** `quality-gate`, `engineering`, `delivery`
- **Why use it:** Engineering discipline quality gate to validate before shipping
...
- **Why use it:** Cinematic product video skill with 152 shot recipe cards and Remotion
...
- **⭐ Stars:** 21
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）��件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型适配器、工具注册表、Agent 循环、网页界面都是插件
...
- **Tags:** `plugin-dev`, `agent-skills`, `standard`
- **Why use it:** Agent skill for standard DSH plugin/service/tool development workflows
...
- **Why use it:** Adds free Xiaomi MiMo TTS with preset/custom/browser voices.
...
- **Why use it:** Auto-injects top-K relevant plugins for agent tasks.
...
- **Why use it:** Open-source design plugin with local-first desktop and UI generation
...
- **Tags:** `diagrams-as-code`, `mermaid-alternative`, `code-visualization`
- **Why use it:** Beautiful architecture and sequence diagrams as self-contained HTML
...
- **Why use it:** 530+ GPT Image prompt templates and case library for visual generation
...
- **Why use it:** First vision plugin for DSH; adds OCR and image understanding to text-only agents.
...
- **Tags:** `design`, `template`, `visual`
- **Why use it:** Editable design system with template marketplace
...
- **Why use it:** Transform messy case materials into precise timeline diagrams (SVG)
...
- **Why use it:** Pixel-to-text OCR for vision-enabled models via image_scan/image_ocr
...
- **Why use it:** 6 design styles to elevate vibe-coded websites beyond AI aesthetics
...
- **Tags:** `ai-agent`, `chat-bot`, `dingtalk`
...
- **Why use it:** Built-in plugin marketplace for DSH; browse, search, and one-click install plugins.
...
- **Why use it:** AI code security audit — catches hallucinated packages and vulnerabilities.
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH LLM providers — no API keys.
...
- **Tags:** `discovery`, `verification`, `ranking`
- **Why use it:** Daily GitHub scraper with real plugin verification and rankings.
...
- **Tags:** `guide`, `quickstart`, `resources`
- **Why use it:** Ultimate DSH guide: quickstart, resource recommendations & plugin catalog.
...
- **Tags:** `learning`, `best-practices`, `exploration`
- **Why use it:** DSH principle learning, plugin marketplace exploration & best practices.
...
- **Tags:** `catalog`, `mcp`, `visualization`
- **Why use it:** Curated list of plugins, skills, MCP servers with visualization & PPT.
...
- **Tags:** `marketplace`, `11k-plugins`, `api`
- **Why use it:** 11,000+ plugin marketplace with search, rankings & free public API.
...
- **Why use it:** Bridges Pi and DSH ecosystems, runs Pi extensions natively
...
- **Why use it:** Secure P2P remote access to Harness from any device
...
- **Why use it:** Comprehensive backup, restore and sync for all DSH configs
...
- **Tags:** `plugin-registry`, `infrastructure`, `cli`
- **Why use it:** Official plugin registry console + plugin scaffolding guidance
...
- **⭐ Stars:** 42
- **Language:** JavaScript
- **Description:** DSH Skills Manager — 在 DeepSeek Harness 中统一加载并安全管理���机 Agent Skills · Load and safely manage local Agent Skills in DSH
- **Tags:** `skills-manager`, `security`, `utility`
- **Why use it:** Unified secure loader for local agent skills with access control
...
- **Tags:** `awesome-list`, `plugin-index`, `community`
- **Why use it:** Curated 280+ plugin directory across 14 categories with direct links
...
- **Why use it:** Real-time token usage tracking with cost estimates and API balance.
...
- **Tags:** `conflict-resolution`, `debugging`, `utility`
...
- **Why use it:** Cute whale girl skin series for DeepSeek Harness desktop
...
- **⭐ Stars:** 406
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一��源码。
- **Tags:** `theme`, `glass`, `visual`
...
- **Why use it:** WebGPU ocean-themed skin with Three.js — immersive visual experience.
...
- **Tags:** `webui`, `background`, `customization`
- **Why use it:** Custom background images with real-time preview and preset themes.
...
- **Why use it:** Cross-platform content discovery agent for B站, YouTube, Reddit and more; privacy-first.
...
- **Tags:** `research`, `search`, `china`
- **Why use it:** Searches 8 major Chinese platforms for 30-day research reports
...
- **Why use it:** Curated bilingual DSH plugin index — great starting point.
...
- **Why use it:** Daily-refreshed comprehensive plugin marketplace.
...
- **Why use it:** Free web search bridge — no signup, works with any model.
...
- **Tags:** `encyclopedia`, `knowledge`, `resource`
- **Why use it:** One-stop AI encyclopedia — skills, MCP, RAG, tutorials all in one.
...
- **Why use it:** All-in-one research workbench: LaTeX editing, arXiv, GPU SSH orchestration.
...
- **Why use it:** Domain pack with industry mapping and policy tracking skills
...
- **Why use it:** Multi-strategy fund backtesting and investment research desk
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, agents and skills
...
- **Why use it:** Curated open-data registry for discovering and evaluating DSH plugins.
...
- **Tags:** `awesome-list`, `curated-directory`, `verified`
- **Why use it:** Evidence-led plugin directory with verified extensions and guidance.
...
- **Why use it:** 2026 curated DSH plugins with quality checks for reliable discovery.
...
- **Why use it:** Vertical stock/finance/quant plugin list with 24 verified entries.
...
- **Why use it:** Practical collection of useful DSH plugins for quick reference.
...
- **Tags:** `guide`, `documentation`, `plugin-directory`
- **Why use it:** Plugin product manuals with scenario-based selection and risk info.
...
- **Why use it:** Star-ranked verified community plugins for easy discovery.
...
- **Why use it:** Full 1000+ tool inventory sorted by stars from GitHub dsh-plugin topic.
...
- **Why use it:** Evidence-backed plugin radar and curated directory.
...
- **Why use it:** In-agent npm + curated list plugin search tool.
...
- **Tags:** `ai-agents`, `coding-agents`, `deepseek-harness`, `mcp`
- **Why use it:** Hourly AI-curated list of 190+ DSH plugins across 12 categories.
...
- **Why use it:** General-purpose DeepSeek Harness plugin registry.
...
- **Tags:** `dsh-plugins`
- **Why use it:** Moved repository; refers to active awesome-dsh-plugin listing.
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** DSH plugin collection listing.
...
- **Tags:** `ai`, `ai-agent`, `artificial-intelligence`, `chatgpt`, `claude`, `claude-code`, `codex`, `cursor`, `deep-learning`, `deepseek`, `gemini`, `generative-ai`, `gpt`, `llm`, `mcp`, `openai`, `rag`, `vibe-coding`, `vibecoding`, `vuepress`
...
- **Tags:** `agent`, `agentic-ai`, `ai`, `ai-agents`, `chatgpt`, `claude`, `deepseek-harness`, `dsh-plugin`, `hermes`, `llm`, `long-term-memory`, `mcp`, `memory`, `memory-management`, `openclaw`, `rag`, `self-evolving`, `skills`, `token-savings`
...
- **Why use it:** DeepSeek Harness (DSH) Web Plugin Aggreg
...
- **Tags:** `agent-memory`, `agentic-rag`, `ai`, `ai-agents`, `ai-memory`, `context-engineering`, `continual-learning`, `dsh-plugin`, `llm`, `memory`
- **Why use it:**  Memory library for building stateful ag
...
- **Tags:** `agent-skills`, `claude-skills`, `codex`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh-plugin`, `finance-skill`, `gemini-skills`, `hermes-skill`, `office-skill`, `openclaw-skills`, `opencode`, `skill`, `skill-md`, `skills`
- **Why use it:** 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作
...
- **Tags:** `agent-os`, `agentic-ai`, `ai-agent`, `ai-coding-agent`, `claude-code`, `cli`, `codex`, `coding-agent`, `deepseek`, `developer-tools`, `dsh`, `dsh-plugin`, `llm-evaluation`, `llm-orchestration`, `loop-engineering`, `mcp`, `opencode`, `skill`, `skills`
...
- **Tags:** `agent-control-plane`, `agent-harness`, `agent-ops`, `ai-agents`, `codex`, `dsh-plugin`, `long-horizon`, `long-horizon-agents`, `loop-engineering`, `loopx`, `workflow-automation`
- **Why use it:** Long-horizon agent control plane for dur
...
- **Tags:** `awesome`, `catalog`, `ds`
- **Why use it:** Comprehensive plugin catalog for DSH ecosystem
...
- **Why use it:** Official curated plugin catalog maintained by cordis.run
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Curated plugin and resource collection for DSH ecosystem
...
- **Why use it:** Community plugin marketplace with 4-hour auto-sync catalog
...
- **Why use it:** 一键配置各类 AI Agent 工具的 MCP、Skills 和规则；支持 Cl
...
- **Why use it:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skil
...
- **Tags:** `agent-skills`, `ai-agent`, `ai-roleplay`, `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** DeepSeek自带破甲18+互动叙事 Skill：NPC 活人感（有记忆/立场
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated list of DSH plugins with community recommendations
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin-bundle`, `dsh-plugin-desktop`
- **Why use it:** CodeX-style plugin marketplace bundled for DSH.

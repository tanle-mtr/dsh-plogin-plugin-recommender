...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,035,506 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 226,156 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,473 | Best open-source design plugin, local-first deskto |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,588 | Original multi-agent swarm harness with autonomous |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 35 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (35)
...
- **Why use it:** Two-phase preset aligning minimal bootstrap with full Standard tools.
...
- **Tags:** `agent-teams`, `collaboration`, `harness`
...
- **Tags:** `coding-agent`, `rpc`, `sub-agents`
...
- **Tags:** `agent`, `desktop`, `local-first`, `privacy`
- **Why use it:** Local-first AI agent desktop app with self-evolving skills and multi-model support
...
- **Why use it:** Automatically discovers, installs and verifies DSH GitHub plugins
...
- **Why use it:** Build and validate DSH plugins efficiently with reusable Codex skills
...
- **⭐ Stars:** 23
- **Language:** Rust
- **Description:** 释放 DeepSeek Harness 插件化内核能力，将 Runtime、Provider、Plugin、Skill、MCP 等能力统一编排，让 Harness 真正成为可扩展、可组合、可管理的��地 AI 运行平台。
- **Tags:** `launcher`, `orchestration`, `runtime`
- **Why use it:** Orchestrates Runtime, Skills, MCP as extensible platform
...
- **Why use it:** Agent Skill for developing DSH plugins with full spec
...
- **Why use it:** Fast, elegant Neovim plugin manager for development workflows.
...
- **Why use it:** Pre-flight plugin check for agents — injects Top-K relevant plugins automatically.
...
- **Why use it:** Bind ChatGPT via OAuth and use ChatGPT models inside DSH with your subscription.
...
- **Why use it:** Modern desktop solution for DSH ecosystem where desktop itself is a plugin
...
- **Why use it:** Animated pet mascot gallery for multiple coding agent platforms.
...
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thoughts, and context progress.
...
- **Why use it:** Cute floating whale widget monitoring DeepSeek account balance in DSH corner.
...
- **Why use it:** Lightweight 5MB Tauri desktop with preset plugins for DSH.
...
- **Why use it:** Local-first Electron desktop for DSH sessions, projects, MCP, and Office.
...
- **Tags:** `desktop`, `windows`, `ssh-client`
- **Why use it:** Zero-setup Windows desktop client with SSH, Codex, plugins and mobile access.
...
- **Tags:** `genui`, `charts`, `interactive`
- **Why use it:** Generates interactive inline UI — charts, forms, quizzes rendered directly in replies.
...
- **Tags:** `canvas`, `nonlinear`, `workspace`
...
- **Tags:** `mobile`, `ios`, `kotlin`
- **Why use it:** Native iOS client with WebSocket sync for workspaces, sessions, and agent traces
...
- **Tags:** `notes`, `dsh-plugin`, `docker`, `ui`
...
- **Why use it:** Community plugin market with one-click install for web GUI
...
- **Why use it:** Shows provider, balance, pricing and usage at a glance in DSH UI
...
- **Tags:** `platform`, `workbench`, `workspace`
- **Why use it:** Plugin-based web workbench with skill management
...
- **Why use it:** Electron desktop shell for DSH with integrated sidebar and AI tools.
...
- **Why use it:** Self-evolving AI assistant with unified memory, knowledge and multi-model support
...
- **Why use it:** Open-source LLM knowledge platform transforming documents into RAG and wiki
...
- **Why use it:** Ultra-persistent memory with hybrid retrieval and 35% token savings.
...
- **Why use it:** Dedicated memory management kit for persistent agent recall and refinement.
...
- **Tags:** `memory`, `rag`, `milvus`, `vector-search`
- **Why use it:** Persistent unified memory layer for AI agents backed by Milvus vector search.
...
- **Tags:** `memory`, `persistent-context`, `agent`
...
- **Tags:** `skill-rag`, `vector-search`, `reranking`
- **Why use it:** Turns SKILL.md files into retrieval-ready agent skill corpora with RAG evaluation.
...
- **Tags:** `finance`, `database`, `mcp`, `multi-agent`
- **Why use it:** Local financial DB with multi-agent analysis and MCP/HTTP auto-generation
...
- **Why use it:** Distill expertise into reusable skills for any AI agent or bot
...
- **Why use it:** Most comprehensive skills marketplace with auto-sync from GitHub.
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `inference`
...
- **Tags:** `video`, `ffmpeg`, `generative-ai`
- **Why use it:** End-to-end AI-generated Vox-style explainer video automation.
...
- **Why use it:** Organized novel-writing pipeline with worldbuilding, drafting and editing.
...
- **Why use it:** Gives agents eyes and ears — turns video/audio/screen into timestamped searchable evidence.
...
- **Tags:** `creative-writing`, `novel`, `workflow`
- **Why use it:** Integrated workflows for novel, short-drama, game, and video-recap creative writing
...
- **Tags:** `task-management`, `productivity`, `sqlite`
...
- **Why use it:** Live iOS Simulator automation with 22 agent tools for building and driving devices
...
- **Why use it:** Full-stack auto math modeling with GitOps pipeline and self-proof
...
- **Why use it:** Composable agent modes with human review and self-evolution
...
- **Tags:** `agent-skills`, `multi-platform`, `claude`, `codex`
- **Why use it:** Turn experience into repeatable, cross-platform agent skills
...
- **Tags:** `ai-infra`, `skills`, `development`, `debugging`
...
- **Tags:** `bioinformatics`, `desktop-app`, `tall`
- **Why use it:** Bioinformatics agent desktop for clinicians with skill store and offline mode
...
- **Tags:** `quality-gate`, `guard`, `engineering`
...
- **Why use it:** 11 QA skills with shared knowledge base for AI testing automation
...
- **Why use it:** Simplifies code with proven DSH simplification methodology
...
- **Why use it:** Persistent agent team with durable identities, private memory and skills
...
- **Why use it:** 152-shot recipe cards for cinematic product videos
...
- **Why use it:** 5-role math modeling agent with 33 model templates
...
- **Why use it:** Godot Engine 4.x full-stack game dev skill
...
- **Why use it:** Strongest free web search plugin, works as search bridge for any model without native access.
...
- **Why use it:** Web UI for managing skills and MCP servers centrally
...
- **Why use it:** One-click MCP/Skills config sync across Claude Code, Codex, DSH, Cursor etc.
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional Codex↔DSH bridge with MCP mirroring
...
- **Tags:** `mcp`, `manager`, `gui`
- **Why use it:** GUI plugin to manage skills and MCP servers in browser
...
- **Why use it:** Best open-source design plugin, local-first desktop app for AI designers
...
- **Tags:** `diagrams-as-code`, `architecture`, `mermaid-alternative`
- **Why use it:** Generates beautiful architecture and sequence diagrams as self-contained HTML
...
- **Why use it:** 530+ GPT Image prompt cases with industrial templates and reusable skills
...
- **Why use it:** First vision plugin enabling image-to-JSON OCR for text-only agents.
...
- **Tags:** `vision`, `multimodal`, `ui`, `screenshot`
- **Why use it:** Adds multimodal vision for screenshots and UI analysis to text-only LLMs
...
- **Why use it:** Enables text-only LLMs to read images via OCR and pixel scanning
...
- **Tags:** `video`, `ai-image`, `directorx`
- **Why use it:** AI video/image/audio generation with DirectorX skill orchestration
...
- **Why use it:** 6 design style packs to avoid generic AI aesthetics
...
- **Tags:** `background`, `ui-customization`, `visual`
- **Why use it:** Customizable web backgrounds with presets and real-time preview.
...
- **Why use it:** Transforms chat history into beautiful shareable knowledge cards with design.
...
- **Why use it:** Self-evolving cross-platform content discovery agent across major social channels.
...
- **Why use it:** AI-enhanced no-code platform for rapidly building business systems
...
- **Tags:** `dsh-web`, `plugin-ecosystem`, `infrastructure`
- **Why use it:** Web-based plugin aggregation ecosystem for DSH distribution.
...
- **Why use it:** Self-improving agent OS with interview-gated staged evaluation.
...
- **Why use it:** Virtual terminal and filesystem layer enabling safe AI agent sandboxing.
...
- **Tags:** `model-switch`, `utility`, `multi-agent`
- **Why use it:** One-click model switcher across Claude Code, Codex, Grok, DSH, Kimi, and more.
...
- **Tags:** `documentation`, `code`, `ai-context`
...
- **Tags:** `ecosystem`, `registry`, `plugin-discovery`
...
- **Why use it:** Context dashboard and management with sidebar/browser integration.
...
- **Tags:** `marketplace`, `curated`, `plugin-store`
- **Why use it:** Daily refreshed curated plugin marketplace with quality review.
...
- **Tags:** `security`, `redteam`, `vulnerability-audit`
- **Why use it:** AI security offense-defense platform auditing hallucinated packages and vulnerability patterns.
...
- **Why use it:** CLI and resolver tools for managing and discovering DSH plugins from the hub
...
- **Tags:** `cost-tracking`, `tokens`, `utilities`
...
- **Why use it:** 11,000+ plugin marketplace with search and public API
...
- **Tags:** `remote-access`, `p2p`, `encryption`, `cross-platform`
...
- **Why use it:** Largest DSH plugin catalog with 1,958 repos and multilingual search
...
- **Why use it:** Backup, restore, export and sync full DSH configuration
...
- **Why use it:** Audits AGENTS.md instruction chains and detects token cost, conflicts
...
- **Tags:** `api`, `documentation`, `plugin`
- **Why use it:** Official SkillHub API docs and plugin reference
...
- **Why use it:** Curated Chinese-language DSH plugin list
...
- **Why use it:** Comprehensive curated list of plugins, skills & resources
...
- **Why use it:** Real-time token usage and cost tracking with per-round charts.
...
- **Why use it:** Free Xiaomi MiMo TTS integration for DSH with customizable voices.
...
- **Tags:** `doctor`, `debugging`, `plugin-conflict`
...
- **Tags:** `research`, `web-search`, `chinese-platforms`
- **Why use it:** Auto-researches 8 major Chinese platforms for 30-day trend reports.
...
- **Why use it:** Bilingual curated awesome list of DSH plugins, skills, clients, and integrations.
...
- **Tags:** `encyclopedia`, `awesome-list`, `ai-resources`
- **Why use it:** Comprehensive AI encyclopedia covering models, agents, RAG, multimodal, MLOps, and learning paths.
...
- **Why use it:** Comprehensive guide to DSH principles and best practices
...
- **Tags:** `academic-search`, `mcp`, `agent-skills`, `arxiv`, `pubmed`
- **Why use it:** Powerful cross-database academic search with citation graph
...
- **Why use it:** Authoritative handbook covering runtime, plugins, MCP and sandbox
...
- **Why use it:** Domain pack with methodology for industry and company research
...
- **Why use it:** Interactive K-line analysis with indicators and news
...
- **Why use it:** Curated stock/finance/quant plugins for deep market analysis.
...
- **Why use it:** AI-curated, hourly-updated comprehensive plugin recommender with 190+ plugins.
...
- **Why use it:** Search npm and awesome lists directly inside DSH agents for plugin discovery.
...
- **Why use it:** Curated plugin list — essential reference for DSH ecosystem discovery.
...
- **Why use it:** Centralized plugin marketplace with one-click install for DSH.
...
- **Why use it:** Daily-curated plugin discovery list with verified real plugins and scene-based categorization
...
- **Why use it:** Curated compendium of plugins, skills, MCP servers, patches and orchestrators for DSH
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, selected plugins and practical tools
...
- **Tags:** `awesome-list`, `resources`
- **Why use it:** Curated list of DSH tools, extensions and resources
...
- **Why use it:** Curated directory with quality checks and permission-aware install guidance.
...
- **Why use it:** 2026 curated DSH plugin list with quality verification.
...
- **Why use it:** Comprehensive 1000+ DSH plugin catalog sorted by stars.
...
- **Why use it:** Curated awesome-list of verified DSH plugins ranked by community stars.
...
- **Tags:** `guide`, `plugin-directory`
- **Why use it:** Plugin guide with install, permission and compatibility info for DSH.
...
- **Why use it:** DSH plugin marketplace similar to CodeX, discover and install plugins easily.
...
- **Why use it:** DSHA curated plugin collection for extended DSH capabilities.
...
- **Why use it:** Auto-crawled daily GitHub list covering all topic:dsh-plugin repositories.
...
- **Why use it:** Evidence-backed plugin radar from 2Origin plugin lab with verification.
...
- **Tags:** `portal`, `web`
- **Why use it:** Static web portal for browsing, filtering and installing 227+ DSH plugins.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** 80+ verified DSH plugins organized by functionality for easy lookup.
...
- **Tags:** `bundle`, `ecosystem`
- **Why use it:** Community-driven DSH plugin bundle and analytics platform directory.
...
- **Why use it:** Redirects to the canonical awesome-dsh-plugin repository — follow the link.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `dsh`, `awesome-list`, `plugin-directory`
- **Why use it:** Simple Chinese-language DSH plugin listing resource.

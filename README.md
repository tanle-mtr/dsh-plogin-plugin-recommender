...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 855,239 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 22:34:07 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 191,829 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,079 | Best open-source design plugin with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,291 | Original multi-agent swarm harness with autonomous |
...
- **Why use it:** Terminal AI coding agent with prefix-cache stability for long sessions
...
- **Why use it:** Runtime injector + task-aware router kit for advanced reasoning-mode orchestration.
...
- **Tags:** `preset`, `tool-config`, `anchored-standard`
- **Why use it:** Proven two-phase preset (98/99 project score) for robust standard tool configuration.
...
- **Tags:** `model-switch`, `claude-code`, `dsh-plugin`
- **Why use it:** One-click multi-model switch across major coding agents.
...
- **Why use it:** Architecture-aware coding agent with drift checking and evidence verification
...
- **Why use it:** Powerful vision toolkit for text-only LLMs with OCR and screenshot
...
- **Tags:** `security`, `agent`
- **Why use it:** AI security audit tool that catches hallucinated packages and missing safeguards in generated code.
...
- **Tags:** `migration`, `session`, `dsh-plugin`
- **Why use it:** Cross-preset session migration with fixed-schema handoffs
...
- **Tags:** `subagent`, `orchestration`, `mcp`
- **Why use it:** Dispatch work to DSH agents from Claude Code and Codex
...
- **Tags:** `agent-skills`, `plugin-development`, `scaffold`
- **Why use it:** Skill for developing DSH plugins following official patterns.
...
- **Tags:** `spec-driven-development`, `developer-tools`
...
- **Why use it:** Installable plugin dev knowledge base with official docs (EN/ZH).
...
- **Tags:** `codex`, `mcp`, `sync`
- **Why use it:** Bidirectional bridge syncing chats, skills and MCPs between Codex and DSH.
...
- **Tags:** `agent-team`, `deepseek-harness`
...
- **Why use it:** Portable skill for DSH plugin development
...
- **Why use it:** Plugin dev notes: pitfalls & solutions
...
- **Tags:** `ui-generator`, `figma-alternative`, `design-systems`
...
- **Why use it:** Modern desktop solution for DSH ecosystem with plugin-first architecture
...
- **Why use it:** Open sidebar foundation with third-party extension support and built-in panels.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking, and rollback.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight Tauri desktop with preset plugins, zero setup required
...
- **Why use it:** Local-first desktop workspace integrating sessions, files and research
...
- **Tags:** `ui`, `plugin`
- **Why use it:** Generates interactive UI components—charts, forms, quizzes—inline in DSH assistant replies.
...
- **Tags:** `desktop-app`, `typescript`
- **Why use it:** CodePilot-inspired cross-platform desktop client with a full plugin suite for DSH.
...
- **Tags:** `ui`, `canvas`
- **Why use it:** Visual non-linear canvas workspace for branching conversations in DSH.
...
- **Why use it:** Full-featured Windows desktop GUI client with SSH, Codex, and remote access.
...
- **Why use it:** Electron-based desktop hub for multi-tab Harness/Plugin/MCP management.
...
- **Why use it:** Live balance & pricing info bar for DSH
...
- **Why use it:** Portable local-first memory layer enabling self-evolving cross-app agent memory.
...
- **Tags:** `agent-memory`, `self-evolving`, `token-savings`
- **Why use it:** Ultra-persistent memory OS with hybrid retrieval, 35% token savings for agents.
...
- **Why use it:** AI encyclopedia covering skills, MCP, RAG, multimodal tools, and learning roadmaps.
...
- **Tags:** `embeddings`, `vector-search`, `reranking`
...
- **Tags:** `session-memory`, `agent-skills`
- **Why use it:** Maintains cross-session continuity so future agents can recover status.
...
- **Why use it:** Original multi-agent swarm harness with autonomous workflows
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `cross-device`
- **Why use it:** Unify agents, workspaces, and tasks across all devices with board-based tracking.
...
- **Why use it:** Self-improving agent OS: agents get smarter autonomously through loop engineering.
...
- **Why use it:** Enterprise-grade multi-agent workspace with unified cross-engine orchestration.
...
- **Tags:** `video-generation`, `ffmpeg`, `ai-skill`
...
- **Why use it:** Enable multi-agent collaboration through AgentTeams for DSH
...
- **Tags:** `agent`, `skill`
- **Why use it:** Orchestrates multiple coding agents into a collaborative team for cross-session task dispatch.
...
- **Why use it:** Dedicated plugin for novel writing and short-drama script production workflows.
...
- **Tags:** `skills`, `agent-framework`, `experience`
...
- **Why use it:** Auto-discovers, installs, and verifies DSH plugins via a built-in skill.
...
- **Tags:** `skills`, `ai-infra`, `dsh-plugin`
- **Why use it:** AI infra agent skills for coding, optimizing, debugging
...
- **Tags:** `task-management`, `sqlite`, `dsh-plugin`
- **Why use it:** Native local taskboard with SQLite projects and agent workflow
...
- **Why use it:** Agent workflow orchestration for DSH
...
- **Why use it:** Complete reverse engineering skill for CTF and security research.
...
- **Why use it:** AI coding mentor that teaches architecture, generates chapters, reviews code.
...
- **Tags:** `agent-skills`, `deep-research`, `marketing`
...
- **Tags:** `legal`, `diagram`, `visualization`
- **Why use it:** Legal visualization tool: draw litigation timelines and diagrams.
...
- **Why use it:** Agent skill for managing slots, remotes, and credentials of DSH plugins.
...
- **Why use it:** WorkBuddy-style skill picker for easy skill selection in composer.
...
- **Tags:** `chinese-traditional-wisdom`, `dsh-plugin`
- **Why use it:** Fusion of Bazi, Fengshui, I Ching into one local deterministic AI engine.
...
- **Tags:** `codex`, `dsh-plugin`
- **Why use it:** Adapted from DSH to simplify code structure efficiently.
...
- **Why use it:** Dedicated plugin for managing DSH skills lifecycle efficiently.
...
- **Tags:** `agent-skills`, `package-manager`, `database`
- **Why use it:** 42 skills & 5 CLIs package for AI agents
...
- **Why use it:** Swift Cycle governance skill for DSH
...
- **⭐ Stars:** 14
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公��写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese-documents`
- **Why use it:** GB/T compliant Chinese document processor
...
- **Tags:** `agent-skills`, `gamification`, `mission-system`
- **Why use it:** Gamified mission system with fog-of-war
...
- **Tags:** `agent-skills`, `engineering`, `best-practices`
- **Why use it:** Fact-finding & evidence-based agent skill
...
- **Why use it:** Virtual product team agent preset for product workflows.
...
- **Why use it:** Pre-flight plugin check to boost agent task success rate.
...
- **Why use it:** First vision bridge for text-only agents — paste images, get structured JSON evidence.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** In-browser skills & MCP server manager
...
- **Tags:** `web-ui`, `marketplace`, `plugin-aggregator`
- **Why use it:** Web plugin aggregator and marketplace hub — all plugins via dsh-market.com.
...
- **Why use it:** Cross-platform content discovery agent from 8+ Chinese and global platforms.
...
- **Tags:** `search`, `web`
- **Why use it:** Strongest free web search bridge plugin for models without native browsing access.
...
- **Why use it:** Tabbit Browser automation plugin for DSH via Playwright
...
- **Why use it:** Anime search plugin with Bangumi ratings and magnet link support in chat.
...
- **Tags:** `deepseek-harness`, `social`
- **Why use it:** DSH内测合影墙，GitHub OAuth零权限登录拍立得风格合影。
...
- **Why use it:** Privacy-first resume builder, completely free and self-hostable
...
- **Tags:** `low-code`, `no-code`, `internal-tool`
...
- **Tags:** `virtual-filesystem`, `vfs`, `infrastructure`
- **Why use it:** Unified virtual filesystem abstraction giving all AI agents shared persistent storage.
...
- **Why use it:** Context dashboard and browser for insight and management
...
- **Tags:** `utility`, `oauth`
- **Why use it:** Bridges ChatGPT/Claude/Grok OAuth subscriptions as DSH LLM providers without API keys.
...
- **Why use it:** Tracks session and daily costs with budget alerts and token usage history.
...
- **Why use it:** Compatibility layer bridging Pi extensions to run natively as DSH plugins.
...
- **Tags:** `backup`, `undo`, `crash-recovery`
- **Why use it:** Crash-rescue plugin with undo config and snapshot recovery
...
- **Why use it:** Community plugin market with one-click install/uninstall
...
- **Why use it:** Lightweight console for managing official DSH repository plugins.
...
- **Why use it:** Pixel-to-text image reading skill for text-only LLM models.
...
- **Why use it:** Unified menu to manage MCP tools and skills exposure and execution modes.
...
- **Why use it:** Search and discover plugins directly inside DSH agents.
...
- **Tags:** `theme`, `ui`
- **Why use it:** Glassmorphism theme with fully customizable blur and background settings for DSH.
...
- **Tags:** `themes`, `skins`, `dark-mode`, `color-scheme`
- **Why use it:** 34 opencode themes, one-click switch
...
- **Why use it:** Custom web UI backgrounds with presets and fine-tuning.
...
- **Why use it:** Curated index of DSH plugins, skills, and MCP servers for ecosystem discovery.
...
- **Tags:** `ai-agents`, `chinese-api`, `specification`
- **Why use it:** Search 65K+ Chinese platform API docs across multiple AI agents.
...
- **Tags:** `evaluation`, `llm-evaluation`, `rag-evaluation`, `benchmark`
- **Why use it:** Evidence-backed evaluation for LLMs & RAG
...
- **Tags:** `research`, `analysis`, `plugin-radar`
...
- **Tags:** `ai-curated`, `recommendation`, `comprehensive`
- **Why use it:** AI-curated 190+ plugin list with 12 categories, hourly updates.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `dsh-ecosystem`
- **Why use it:** General DSH plugin repository for ecosystem exploration
...
- **Tags:** `awesome-list`, `catalog`, `bilingual`
...
- **Tags:** `ai-agents`, `awesome-list`, `evidence-led`
...
- **Tags:** `verified`, `organized`, `dsh-plugins`
...
- **Tags:** `models`, `tools`, `sandboxes`, `ui`, `agent-loops`
...
- **Tags:** `industry`, `finance`, `legal`, `healthcare`
- **Why use it:** Industry-specific plugins for finance, legal, healthcare, and more
...
- **Tags:** `registry`, `discovery`, `dedupe`, `cli`
- **Why use it:** Unified registry merging multiple sources with deduplication
...
- **Tags:** `cordis`, `official`, `auto-generated`
...
- **Tags:** `cli`, `plugin-manager`, `discovery`, `audit`
...
- **Tags:** `awesome-list`, `comprehensive`, `star-sorted`
- **Why use it:** Comprehensive 1000+ DSH tool repository list sorted by stars
...
- **Why use it:** Curated plugin directory — essential discovery hub for the entire DSH ecosystem.
...
- **Tags:** `toy`, `web-sim`, `zero-dependency`
- **Why use it:** Web simulation of a traditional Chinese toy, zero-dependency single file.
...
- **⭐ Stars:** 1,374
- **Language:** Python
- **Description:** DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器真实安装路���运行级实测（四档判定），精选 Top 50 · 11 类人工策展，全量索引 PLUGINS-ALL.md，自动更新。
- **Tags:** `awesome-list`, `plugin-registry`
- **Why use it:** Curated plugin radar with auto-discovery and real installation testing
...
- **Why use it:** Curated list covering DSH plugin ecosystem comprehensively
...
- **Why use it:** Curated plugins, tools and infrastructure from dsh-external/hub
...
- **Why use it:** Bilingual curated index of DSH plugins, tools, skills, and integrations.
...
- **Why use it:** Auto-scraped daily plugin discovery with real categorization and hot rankings.
...
- **Why use it:** Ultimate Chinese-English guide covering quickstart, resources, and curated plugins.
...
- **Why use it:** Plugin marketplace bundle for DeepSeek Harness ecosystem expansion.
...
- **Why use it:** Private note app with Docker deploy, skill call support
...
- **Why use it:** Curated meta-list of DSH plugins and resources.
...
- **Why use it:** Community-maintained auto-synced DSH plugin catalog.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Official auto-generated curated list by cordis.run.
...
- **Why use it:** Curated list of awesome DSH plugins
...
- **Why use it:** Public directory for DSH plugin discovery
...
- **Why use it:** Plugin documentation and navigation guide for DSH users.
...
- **Why use it:** Static portal to discover and browse 227+ DSH plugins.
...
- **Tags:** `redirect`, `meta`
- **Why use it:** Redirect notice - moved to awesome-dsh-plugin org.

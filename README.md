...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 835,727 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 06:50:09 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 185,867 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,524 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,880 | Multi-agent swarm orchestrator for autonomous work |
...
- [Visual & Design](#visual-&-design) — 7 plugins
...
- **Tags:** `dsh-plugin`, `multi-agent`, `skills`
- **Why use it:** Super AI assistant with memory, multi-model, and multi-channel support
...
- **Tags:** `dsh-plugin`, `coding-agent`, `cli`
...
- **Why use it:** Comprehensive beginner tutorial for harness engineering
...
- **Tags:** `preset`, `standard-tools`, `dsh-plugin`
- **Why use it:** Two-phase preset with minimal bootstrap and full standard tools
...
- **Tags:** `vfs`, `agent-tools`, `typescript`
- **Why use it:** Unified virtual filesystem abstraction for AI agents
...
- **Why use it:** One-click model/agent switching across 9+ coding tools
...
- **Tags:** `coding-agent`, `agent-runtime`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime with polished desktop IDE
...
- **Tags:** `code-review`, `dsh-plugin`, `developer-tools`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with citations
...
- **Tags:** `architecture`, `coding-agent`, `drift-check`
- **Why use it:** Makes coding agents architecture-aware with drift checking
...
- **Tags:** `agent`, `teamwork`
- **Why use it:** Unifies multiple coding agents (Claude, Codex, Grok) into one team
...
- **Tags:** `ios`, `mobile-automation`
- **Why use it:** 22 agent tools for iOS Simulator and physical iPhone automation
...
- **Why use it:** Auto-searches, installs, and verifies GitHub plugins for DSH
...
- **Tags:** `plugin-development`, `agent-skills`, `cordis`
...
- **Why use it:** Practical DSH plugin dev docs covering cordis, tsconfig, Windows tricks
...
- **Tags:** `engineering`, `practices`, `agent-skill`
- **Why use it:** Engineering discipline skill distilled from DSH development experience
...
- **Tags:** `plugin-development`, `skills`, `testing`
...
- **Why use it:** Pre-flight plugin check for task-based DSH agent requests
...
- **Tags:** `dsh-plugin`, `ui-generator`, `figma-alternative`
...
- **Tags:** `dsh-plugin`, `desktop`, `cordis`
- **Why use it:** Modern desktop client for DSH where even the desktop is a plugin
...
- **Tags:** `dsh-web-ui`, `desktop-extension`, `themes`
- **Why use it:** Web GUI with task board, mobile remote, and WebGL skins
...
- **Why use it:** Open sidebar with file editor, terminal, Git, sub-agent pages
...
- **⭐ Stars:** 2,331
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录的 TUI 补位插件：Claude Code ��，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `dsh-plugin`, `terminal`
- **Why use it:** TUI with whale topbar, streaming thinking, progress & TPS display
...
- **Why use it:** Lightweight Tauri desktop app with zero setup required
...
- **Why use it:** Cute floating whale widget monitoring DeepSeek balance
...
- **Why use it:** Local-first Tauri desktop app, open-source Claude Cowork alternative
...
- **Why use it:** Interactive UI components (charts, forms, quizzes) rendered inline
...
- **Why use it:** CodePilot-inspired Electron desktop client across all platforms
...
- **Why use it:** Full-featured Electron desktop GUI with SSH, plugins, and mobile access
...
- **Why use it:** Visual non-linear canvas workspace for branching conversations
...
- **Why use it:** Smartisan-style notes app with Docker deploy, export and skill support
...
- **Tags:** `marketplace`, `dsh-plugin`, `plugin-marketplace`
- **Why use it:** One-click browse, install and update all DSH plugins via GUI
...
- **Tags:** `task-management`, `taskboard`, `dsh-plugin`
- **Why use it:** Native SQLite-backed taskboard with Web UI, no iframe needed
...
- **Why use it:** Electron desktop console for managing DSH plugins and MCP
...
- **Why use it:** Shows provider, model, balance and pricing in a persistent bottom bar
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `hud`, `ui`
- **Why use it:** Floating HUD panel showing git, MCP, skills, model and token status
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `desktop`, `docker`, `ssh`
- **Why use it:** Cross-platform desktop app unifying DB, SSH, Docker and AI in one window
...
- **⭐ Stars:** 4
- **Language:** JavaScript
- **Description:** 桌面版 DeepSeek Harness：Electron 壳 + 自��管 dsh web 服务，集成 dsh-better-sidebar / dsh-web-ui / ModLens / awesome-dsh-plugin / dshmarket
- **Tags:** `desktop-app`, `electron`
- **Why use it:** Electron-based desktop wrapper for DSH web service
...
- **Tags:** `dsh-plugin`, `agent-memory`, `agentic-rag`
- **Why use it:** Self-evolving context database unifying agent memory and RAG skills
...
- **Tags:** `dsh-plugin`, `rag`, `knowledge-base`
- **Why use it:** LLM knowledge platform turning documents into queryable RAG and wiki
...
- **Tags:** `memory`, `rag`, `self-evolving`, `mcp`
...
- **Tags:** `memory`, `rag`, `openclaw`
- **Why use it:** Provides unlimited persistent memory for OpenClaw agents
...
- **Why use it:** Comprehensive AI knowledge base with MCP integration and RAG support
...
- **Why use it:** Durable long-term memory with recall tools and inspectability
...
- **Why use it:** Connects PowerContext server for recall and memory handoff
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `claude-code`, `memory`
- **Why use it:** Bridges Claude Code memory and skills into DeepSeek Harness

---

### [biedongbin/dsh-claude-compat](https://github.com/biedongbin/dsh-claude-compat)

- **⭐ Stars:** 9
- **Language:** JavaScript
- **Description:** DSH plugin: bridge Claude Code's .claude/ directory (skills, commands, rules) into DeepSeek Harness natively
- **Tags:** `deepseek-harness`, `dsh-plugin`, `claude-code`, `compat`
- **Why use it:** Native bridge for Claude Code .claude/ directory into DSH
...
- **Tags:** `dsh-plugin`, `multi-agent`, `swarm-intelligence`
- **Why use it:** Multi-agent swarm orchestrator for autonomous workflows and coordination
...
- **Tags:** `dsh-plugin`, `agent-skills`, `ai-persona`
- **Why use it:** Digital human skill that transforms memories into reusable AI personas
...
- **Why use it:** Unified multi-device agent workspace with task boards
...
- **Why use it:** Runtime injector with task-aware reasoning mode router
...
- **Why use it:** Self-improving Agent OS with continuous grading loop
...
- **Tags:** `multi-agent`, `workspace`, `dsh-plugin`
- **Why use it:** Enterprise-grade multi-engine agent workbench
...
- **Why use it:** Cognitive-enhancement skills based on Anthropic J-space research
...
- **Why use it:** Intelligently routes and orchestrates local DSH agent workflows
...
- **Tags:** `video-generation`, `skill`, `dsh-plugin`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation
...
- **Why use it:** Vision toolkit enabling text-only LLMs to understand images
...
- **Tags:** `task-manager`, `workflow`, `mcp`
- **Why use it:** Human-in-loop task manager for AI agents with cross-platform control
...
- **Why use it:** DSH-native vision toolkit with OCR and UI restoration
...
- **Why use it:** Turn experience into repeatable execution skills across AI agents
...
- **Tags:** `vision`, `multimodal`, `agent-skill`
...
- **Why use it:** Specialized skills for writing, optimizing, and debugging AI infrastructure
...
- **Tags:** `creative-writing`, `drama-skills`, `dsh-plugin`
- **Why use it:** AI-powered novel writing and short-drama production workflow
...
- **Tags:** `agent-skills`, `embeddings`, `vector-search`
- **Why use it:** Curate SKILL.md files into retrievable agent-skill corpora
...
- **Why use it:** Comprehensive reverse engineering skill for security research
...
- **Why use it:** AI mentor that guides learning with structured chapters
...
- **Why use it:** 88 skills for research, marketing, and social intelligence
...
- **Why use it:** Visual litigation timeline tool for legal professionals
...
- **⭐ Stars:** 39
- **Language:** Unknown
- **Description:** An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插件/���务/事件/工具/LLM 适配器/打包安装的标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any compatible agent.
- **Tags:** `agent-skills`, `plugin-development`
- **Why use it:** Skill for developing DSH plugins following official standards
...
- **Why use it:** Spec-driven development skill for repository-native workflows
...
- **Tags:** `agent-skills`, `plugin-development`
- **Why use it:** Build and configure DSH plugins with slots and credentials
...
- **Why use it:** On-demand plugin dev knowledge base as installable skill
...
- **Tags:** `gongwen`, `docx`, `chinese-docs`
- **Why use it:** Full pipeline Chinese official document processing per GB/T 9704 standard
...
- **Tags:** `canvas`, `agent-skills`, `cordis`
- **Why use it:** Infinite canvas with creative skills via native WeShop Cordis integration
...
- **Tags:** `record-replay`, `computer-use`, `workflow`
- **Why use it:** Record macOS desktop workflows and convert to reusable agent skills
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `skill-management`, `mcp`
- **Why use it:** Hot-reload MCP and skills via web UI — paste JSON to connect instantly
...
- **Tags:** `deepseek-harness`, `math`, `skills`
- **Why use it:** 17 math modeling skill cards with presets and portable Windows scripts
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `godot`, `game-development`
- **Why use it:** Godot 4.x full-stack game dev skill plugin for DSH
...
- **Why use it:** Simulates a full product team for guided AI conversations
...
- **Tags:** `web-search`, `mcp`
- **Why use it:** Strongest free web search bridge for models without native access
...
- **Why use it:** Web UI panel for managing skills and MCP tools in DSH
...
- **Why use it:** OCR and pixel-to-text tools for text-only AI models
...
- **Tags:** `dsh-plugin`, `agent-skills`, `diagrams`
- **Why use it:** Agent skill generating beautiful verifiable architecture and sequence diagrams
...
- **Why use it:** 20+ industrial prompt templates for GPT-Image2 generation
...
- **Tags:** `design`, `vibecoding`, `mcp`, `flutter`
...
- **Why use it:** AI-powered design studio with PPT, prototyping and template market
...
- **Tags:** `image-generation`, `ai-agent`, `dsh-plugin`
- **Why use it:** Generate images directly in DSH chats via multiple AI models
...
- **Tags:** `ai-image`, `ai-video`, `directorx`
- **Why use it:** AI video/image/audio generation with storyboard and knowledge corpus
...
- **Tags:** `dsh-plugin`, `browser-extension`, `chat-management`
- **Why use it:** Enhancement suite for Gemini, Claude, ChatGPT across all browsers
...
- **Why use it:** Auto-discovers content from B站/Xiaohongshu/YouTube etc.
...
- **Tags:** `browser-extension`, `chrome`, `workflow`
- **Why use it:** Chrome extension turning AI chats into reusable workflows
...
- **Why use it:** Chrome sidebar for direct DSH browser control without vision
...
- **Tags:** `dsh-plugin`, `self-hosted`, `mcp-server`
- **Why use it:** Privacy-first resume builder, completely self-hosted and free
...
- **Tags:** `dsh-plugin`, `electron-app`, `image`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and editors
...
- **Tags:** `dsh-plugin`, `low-code`, `ai-agents`
- **Why use it:** Open-source AI+no-code platform for building business systems fast
...
- **⭐ Stars:** 3,533
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本模型外���视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `multimodal`, `dsh-plugin`
- **Why use it:** Vision bridge converting images to structured JSON for text agents
...
- **Why use it:** In-harness plugin marketplace with search and one-click install
...
- **⭐ Stars:** 1,340
- **Language:** Python
- **Description:** DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器真实安装路径运行级实测（��档判定），精选 Top 50 · 11 类人工策展，全量索引 PLUGINS-ALL.md，自动更新。
- **Tags:** `plugin-registry`, `awesome-list`, `dsh-plugin`
- **Why use it:** Plugin radar scanning 9000+ candidates with real installation verification
...
- **Tags:** `context`, `dashboard`, `utilities`
- **Why use it:** Context dashboard and management tool with statistics
...
- **Why use it:** Curated plugin discovery with daily automated verification
...
- **Why use it:** Bilingual curated list of DSH plugins, tools and integrations
...
- **Why use it:** Ultimate DSH quickstart guide with curated plugins and resources
...
- **Tags:** `cost`, `token-usage`, `tracking`
- **Why use it:** Tracks session/daily costs, budget, and token usage across providers
...
- **Why use it:** Runs Pi extensions as native DSH plugins via compatibility layer
...
- **Why use it:** Crash rescue with undo, snapshots, and SAFE MODE recovery
...
- **Why use it:** Previewable cross-preset session migration with state preservation
...
- **Why use it:** Essential plugin management console for DSH ecosystem
...
- **Tags:** `desktop`, `plugin-management`
- **Why use it:** Run multiple DSH versions in isolated containers
...
- **Why use it:** Backup, restore, sync and migrate complete DSH config and plugins
...
- **Tags:** `dsh-plugin`, `plugin-manager`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `token-usage`, `data-visualization`
...
- **Why use it:** Resolves plugin conflicts and version incompatibilities
...
- **Why use it:** Multi-source deduped plugin registry merging awesome list, GitHub, and npm
...
- **Tags:** `dsh-plugin`, `cli`, `plugin-manager`
...
- **Tags:** `dsh-plugin`, `publisher`
- **Why use it:** One-click publish tool for skills/plugins with validation and PR generation
...
- **Tags:** `dsh-plugin`, `market`
- **Why use it:** Dynamic marketplace plugin with search, categorization, and one-click install
...
- **Tags:** `pet`, `mascot`, `pixel-art`, `dsh-plugin`
- **Why use it:** Public gallery of animated pet mascots for AI coding tools
...
- **Why use it:** Whale girl themed visual skins for the DSH interface
...
- **Tags:** `theme`, `ui`
- **Why use it:** Glass-morphism theme with full customization for DSH UI
...
- **Tags:** `theme`, `threejs`, `webgpu`
- **Why use it:** Beautiful WebGPU ocean-themed skin with Three.js visuals for DSH
...
- **Why use it:** One-click apply 34 opencode themes including dracula, tokyonight, gruvbox
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `themes`, `webui`
- **Why use it:** Custom background plugin with presets and browser-side compression
...
- **Tags:** `research`, `skill`, `dsh-plugin`
- **Why use it:** Auto-searches 8 major CN platforms, generates cited research reports
...
- **Why use it:** Curated list of DSH ecosystem plugins and tools
...
- **Why use it:** Curated DSH ecosystem plugins and infrastructure directory
...
- **⭐ Stars:** 54
- **Language:** TypeScript
- **Description:** 在 DeepSeek Harness / Claude Code / Cursor / Codex / Gemini CLI 里直接搜索 20 个中国开放平台的 65,600+ 篇 API 文���；零配置，支持 Skill 与 DSH 原生插件。
- **Tags:** `api-documentation`, `chinese-api`, `research`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in IDE
...
- **Why use it:** Interactive K-line analysis with technical indicators and market data
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Curated plugin directory with verified loadable extensions and guidance
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugins`, `registry`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `stock`, `finance`
- **Why use it:** Curated stock/finance/quant plugin vertical list for DSH
...
- **Tags:** `awesome-list`
- **Why use it:** Curated collection of useful DSH plugins
...
- **Why use it:** Plugin directory with installation and compatibility guides
...
- **Why use it:** Static portal for browsing and installing 227+ plugins
...
- **Tags:** `awesome-list`
- **Why use it:** Original awesome-dsh-plugins repository (redirected)
...
- **Why use it:** Search npm and awesome list directly from inside DSH agents
...
- **Why use it:** Curated plugin discovery list for the DSH ecosystem
...
- **Tags:** `dsh-plugin`, `entertainment`
- **Why use it:** Web sim of a traditional Chinese children's toy with real audio
...
- **Why use it:** Essential curated list of DSH plugins, skills, MCP servers and more
...
- **Why use it:** Plugin marketplace with 3100+ plugins, search, rankings and public API
...
- **Tags:** `marketplace`, `plugin-hub`, `v4-pro`
- **Why use it:** DSH plugin marketplace hub for DeepSeek v4 Pro integration
...
- **Why use it:** Curated awesome list of all DSH plugins and resources
...
- **Tags:** `awesome-list`, `dsh-plugin`, `agents`
...
- **Why use it:** Community-curated auto-syncing plugin catalog
...
- **Why use it:** Use this cross-platform skill in Codex or Claude Code to establish repository-lo
...
- **Why use it:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质
...
- **Why use it:** One-tap Codex move-in to DSH: auto-import project chats, two-way Skills & MCP sy
...
- **Why use it:** DSH Skills Manager 基于 DeepSeek Harness 的Skills管理插件
...
- **Why use it:** Multi-agent team collaboration for DeepSeek Harness, with independent models, sk
...
- **Why use it:** DSH 内测收官合影墙：GitHub OAuth 零权限登录 + 冻结白名单校验的拍立得合影站（含 DSH Skill 包装）
...
- **Why use it:** Free image reading & generation for DeepSeek Harness (rc.7/rc.8/v0.1.1-rc.1) — p
...
- **Why use it:** Design aesthetics skill pack for DeepSeek Harness (DSH) - keeps vibe-coded websi
...
- **⭐ Stars:** 15
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏���器里管理技能（skills）与 MCP 服务器。
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏���器里管
...
- **Why use it:** Swift Cycle governance skill adapter for DeepSeek Harness; user-invoked, version
...
- **Why use it:** Package manager for AI agent assets — 42 skills, 5 CLIs, 1 plugin. Skills for AI
...
- **Tags:** `awesome-list`, `directory`, `ecosystem`
- **Why use it:** Public GitHub directory and discovery resource for DSH plugins
...
- **Why use it:** Curated list of精选 DSH plugins as a discovery resource
...
- **Why use it:** Fast Neovim plugin manager in Lua — not a DSH plugin
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Comprehensive hourly-updated AI-curated list of 190+ DSH plugins
...
- **Why use it:** DSH plugin curated list with ecosystem and analytics support
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple DSH plugin list for quick reference
...
- **Tags:** `dsh-plugin`, `awesome-list`
- **Why use it:** Broad coverage of DSH plugins including models, tools, sandboxes, and UI
...
- **Why use it:** Official auto-generated list of DSH Cordis plugins
...
- **Tags:** `dsh-plugin`, `awesome-list`
- **Why use it:** Full 1000+ DSH tool list sorted by stars from GitHub topic

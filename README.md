...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 940,575 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-01 23:11:35 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 208,040 | Core harness platform; everything is a plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,352 | Open-source design tool with local-first desktop,  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,138 | Multi-agent swarm orchestrator for autonomous work |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 33 plugins
- [Themes & Skins](#themes-&-skins) — 5 plugins
- [Research & Analysis](#research-&-analysis) — 37 plugins
- [Other](#other) — 9 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (33)
- [Themes & Skins](themes-skins) (5)
- [Research & Analysis](research-analysis) (37)
- [Other](other) (9)
---
...
- **Why use it:** Core harness platform; everything is a plugin ecosystem.
...
- **Why use it:** Super agent harness with planning, tools, skills and self-evolving memory.
...
- **Tags:** `agent`, `cordis`, `dsh-plugin`
- **Why use it:** Task-aware reasoning-mode router for intelligent agent request routing
...
- **Tags:** `agent-os`, `mcp`, `skills`
- **Why use it:** Self-improving agent OS with loop engineering for autonomous skill growth
...
- **Tags:** `vision`, `mcp`, `dsh-plugin`
- **Why use it:** First vision plugin for text-only agents with OCR and structured JSON output
...
- **Tags:** `deepseek`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Minimal-aligned bootstrap then full Standard tools for DSH. Great starter preset.
...
- **Tags:** `code-review`, `static-analysis`, `code-quality`
- **Why use it:** AI code reviews grounded in 12 classic engineering books
...
- **Tags:** `context-management`, `dashboard`, `statistics`
- **Why use it:** Context dashboard and management for DSH sessions and stats
...
- **Why use it:** Vision toolkit for text-only LLMs: OCR, image Q&A, screenshot analysis
...
- **Tags:** `security`, `cybersecurity`, `redteam`, `vulnerabilities`
- **Why use it:** AI security platform that audits AI-generated code for hallucinated packages and vulnerabilities
...
- **Tags:** `coding-agent`, `mcp`, `sub-agents`, `tui`
- **Why use it:** Feature-rich coding agent with sub-agents, hashline edits, and MCP.
...
- **Tags:** `reasonix`, `skills`, `deepseek`
- **Why use it:** Superpowers skill ported to Reasonix coding harness for enhanced dev.
...
- **Why use it:** Build and validate DSH plugins via reusable Codex skill
...
- **Tags:** `agent-tools`, `llm-agents`, `dsh-plugin`
- **Why use it:** Pre-flight plugin check boosts agent tool usage
...
- **Why use it:** OAuth bind ChatGPT account, chat via DSH
...
- **Why use it:** Modern desktop client for DeepSeek Harness plugin ecosystem.
...
- **Tags:** `dsh-web`, `cordis`, `dsh-plugin`
...
- **Tags:** `agent-sandbox`, `agent-tools`, `virtual-terminal`
- **Why use it:** First virtual terminal for AI agents. Sandbox-style isolated execution.
...
- **⭐ Stars:** 3,214
- **Language:** TypeScript
- **Description:** 开放的侧边��底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
- **Tags:** `sidebar`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, chat, Git pages.
...
- **Tags:** `cli`, `skills`, `taskboard`
- **Why use it:** Modern flexible task panel embedding into Codex and DSH workflows.
...
- **Tags:** `tui`, `terminal`, `deepseek-harness`
- **Why use it:** Claude Code style TUI with whale bar, streaming thoughts, and progress tracking.
...
- **Why use it:** Rust agent runtime paired with polished desktop app for agentic coding.
...
- **Tags:** `floating-widget`, `dsh-plugin`, `ui`
- **Why use it:** Cute floating whale widget tracking your DeepSeek balance
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions and files
...
- **Why use it:** Generates interactive UI components inline — charts, layouts, forms, and quizzes via dsh-ui fence
...
- **Tags:** `desktop-app`, `tauri`, `local-first`, `privacy`
- **Why use it:** Local-first open-source desktop AI agent app with multi-model support and self-evolving skills
...
- **Tags:** `canvas`, `workspace`, `non-linear`, `session`
...
- **Why use it:** Open-source Windows desktop GUI for DSH with Codex, plugins, skills, SSH, and mobile remote access
...
- **Tags:** `desktop-app`, `electron`, `cross-platform`, `macos`, `linux`
- **Why use it:** CodePilot-inspired cross-platform desktop client and plugin suite for DSH on macOS, Windows, Linux
...
- **Why use it:** Electron desktop console for managing Harness, plugins, MCP and skills.
...
- **Tags:** `ui`, `balance`, `pricing`
- **Why use it:** Clean bottom bar with live balance, provider info, and peak pricing countdown.
...
- **Why use it:** Electron desktop shell wrapping DSH web service
...
- **Tags:** `plugin-portal`, `web`, `github-pages`
- **Why use it:** Zero-dependency static portal to browse 227+ plugins
...
- **Tags:** `dsh-plugin`, `ui`, `dsh-plugin-market`
...
- **Why use it:** LLM knowledge platform turning docs into RAG, agents, and Wiki.
...
- **Why use it:** Local-first portable memory layer with Markdown-native user-owned data
...
- **Why use it:** Memory management kit with refine capability. Keeps agent context alive.
...
- **Why use it:** Persistent unified memory layer backed by Milvus for all AI agents.
...
- **Tags:** `skill-md`, `vector-search`, `reranking`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready skill corpora with search and evaluation
...
- **Why use it:** Multi-agent swarm orchestrator for autonomous workflows.
...
- **Tags:** `architecture-as-code`, `agent-skills`, `dsh-plugin`
- **Why use it:** Generates beautiful architecture and workflow diagrams as code.
...
- **Why use it:** Distill expert thinking into reusable skills for any agent or bot.
...
- **Tags:** `agent-harness`, `no-code`, `mcp`
...
- **⭐ Stars:** 6,033
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：416个精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工���流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。
- **Tags:** `skills`, `agent-skills`, `dsh-plugin`
- **Why use it:** Largest skills store with 416+ curated packs covering code, docs, and automation
...
- **Tags:** `loop-engineering`, `dsh-plugin`, `agent-harness`
- **Why use it:** Long-horizon agent control plane for durable, governed multi-tool workflows
...
- **Tags:** `agent-skills`, `multi-agent`, `dsh-plugin`
- **Why use it:** Enterprise-grade multi-engine agent workbench with unified task management
...
- **Tags:** `agent-skills`, `workflow`, `vibe-coding`
...
- **⭐ Stars:** 3,007
- **Language:** Python
- **Description:** J-Space Cognition Suite V3.7 - AI cognitive-enhancement Skills based on Anthropic's J-space global workspace research. | ���哩哔哩：Tiger380 (UID 3494375382321675) — https://space.bilibili.com/3494375382321675
...
- **Tags:** `ai-video`, `ffmpeg`, `text-to-video`, `agent-skill`
- **Why use it:** Automated end-to-end Vox-style explainer video generation
...
- **Why use it:** Enable multi-agent collaboration within DeepSeek Harness
...
- **Tags:** `task-management`, `sqlite`, `taskboard`, `native-ui`
- **Why use it:** Native SQLite-backed task board with agent claim/review, pure local Web UI without iframes
...
- **Tags:** `creative-writing`, `fiction-writing`, `drama-skills`
- **Why use it:** AI-powered creative writing for novels and short dramas.
...
- **Why use it:** Enable composable, reviewable agent workflows for self-evolution.
...
- **Why use it:** Automate plugin discovery, installation, and verification for DSH.
...
- **Tags:** `skills`, `agent-skills`, `multi-platform`
- **Why use it:** Turn experience into repeatable execution skills across agents.
...
- **Tags:** `agent-skills`, `multimodal`, `vision`
- **Why use it:** Adds multimodal vision to text-only Claude Code for UI/chart analysis
...
- **Why use it:** Specialized skills for AI infra development: write, optimize, debug high-performance systems
...
- **Tags:** `superpowers`, `skills`, `tdd`, `debugging`
...
- **Tags:** `agent-skills`, `education`, `code-review`
- **Why use it:** AI coding mentor skill that generates steps, reviews code, auto-grades.
...
- **Tags:** `agent-skills`, `skill-generator`, `local-first`
...
- **Tags:** `agent-skills`, `plugin-dev`, `development`
- **Why use it:** Agent skill that guides you through standard DSH plugin development.
...
- **Tags:** `plugin-management`, `slots`, `credentials`
- **Why use it:** Manages DSH plugin slots, credentials and remotes
...
- **Why use it:** Spec-driven development skill inspired by DSH patterns
...
- **Tags:** `skills`, `task-management`, `game-like`
- **Why use it:** Game-like one-click skill claim and dispatch system
...
- **Why use it:** On-demand plugin dev knowledge base as agent skill
...
- **Tags:** `gongwen`, `document`, `chinese`
- **Why use it:** Full workflow Chinese official document creation and formatting
...
- **Tags:** `skills-manager`, `safety`, `local`
- **Why use it:** Unified safe loading and management of local Agent Skills
...
- **Why use it:** Multi-agent team with shared workspace and independent skills
...
- **Why use it:** Quick skill selection in composer with official /skill-name gesture support.
...
- **Tags:** `agent-skills`, `handoff`, `session-memory`
- **Why use it:** Cross-platform agent handoff skill with repository-local session memory continuity.
...
- **Why use it:** Adapted DSH code simplification skill for cleaner, more readable output.
...
- **Tags:** `agent-kit`, `skills`, `cli`
- **Why use it:** 42 skills + 5 CLIs package for eval-driven and spec-driven agent engineering.
...
- **Why use it:** 10 QA skills with decision matrices for professional test engineering workflows.
...
- **Why use it:** Full-stack Godot 4.x game dev skill with GDScript at runtime.
...
- **Tags:** `agent-skills`, `project-governance`
- **Why use it:** Governance skill adapter, user-invoked and offline-verifiable
...
- **Why use it:** Native WeShop canvas with infinite creative skills support
...
- **Why use it:** Virtual PM-to-QA product team agent preset
...
- **Tags:** `web-search`, `free`, `no-api-key`, `bridge`
- **Why use it:** Strongest free web search plugin — no signup, no API key, works as a bridge for any model
...
- **Why use it:** One-click MCP, skills and rules setup across multiple AI tools
...
- **Why use it:** Hot-reload MCP config and skill management without restart
...
- **Why use it:** Open-source design tool with local-first desktop, Figmа alternative.
...
- **Why use it:** Industrial-grade GPT image prompt engine with 530+ reverse-engineered cases.
...
- **Tags:** `design`, `ppt`, `visual-editor`, `prototyping`
...
- **Why use it:** Generate images directly in DSH chats using multiple AI image generation models
...
- **Why use it:** Preview, inspect and edit .op documents directly inside DSH conversations
...
- **Why use it:** 6 design styles prevent AI-generic look in vibe-coded websites.
...
- **Why use it:** Free image reading and generation with auto vision model transcoding support.
...
- **Tags:** `video`, `image`, `ai-director`
- **Why use it:** AI video/image/audio creation suite with configurable model tools and knowledge corpus.
...
- **Tags:** `webui`, `dsh-plugin-market`, `plugin`
- **Why use it:** Custom web UI backgrounds with presets and uploads
...
- **Tags:** `bilibili`, `douyin`, `cross-platform`
- **Why use it:** Local-first cross-platform content discovery agent from 8+ Chinese platforms.
...
- **Why use it:** Let AI agents seamlessly use your real logged-in browser
...
- **Tags:** `ios`, `simulator`, `webdriveragent`, `mobile-automation`
- **Why use it:** Live iOS Simulator and connected iPhone inside conversations with 22 agent automation tools
...
- **Why use it:** Playwright-based browser automation for DeepSeek Harness workflows.
...
- **Tags:** `dingtalk`, `ai-agent`, `chat-bot`
- **Why use it:** DingTalk IM channel turning chats into tool-capable agents
...
- **Tags:** `mcp-server`, `self-hosted`, `dsh-plugin`
- **Why use it:** Privacy-focused, customizable open-source resume builder.
...
- **Tags:** `no-code`, `ai-agent`, `dsh-plugin`
- **Why use it:** AI-powered no-code platform for fast business system development.
...
- **Why use it:** One-click install + model switch across 10+ popular CLI coding agents.
...
- **Tags:** `marketplace`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `oauth`, `subscription`, `llm-provider`, `chatgpt`
- **Why use it:** Use ChatGPT, Claude, and Grok subscriptions as DSH LLM providers via OAuth — no API keys needed
...
- **Tags:** `cost-tracking`, `deepseek-api`, `token-usage`
- **Why use it:** Track DSH session costs, budgets, and token usage in one place.
...
- **Why use it:** Bridge Pi ecosystem to DSH—run unmodified Pi extensions natively.
...
- **Tags:** `context-migration`, `cordis`, `session-migration`
...
- **Why use it:** Open-source Smartisan Notes clone with Docker deployment and DSH integration
...
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin collection in Web GUI
...
- **Tags:** `awesome-list`, `plugin-list`, `dsh-plugin`
- **Why use it:** Curated awesome list of all known DeepSeek Harness plugins
...
- **Why use it:** Official auto-generated curated list of Cordis plugins by cordis.run
...
- **Why use it:** Web UI panel for managing DSH skills and MCP configurations
...
- **Why use it:** Community plugin market integrated into DSH Web GUI for easy install/uninstall
...
- **Why use it:** Community-maintained auto-syncing plugin marketplace catalog.
...
- **Why use it:** Backup, restore and sync your full DSH config, plugins and MCP servers.
...
- **Tags:** `plugin-management`, `ui`, `development`
- **Why use it:** Lightweight plugin management console with official dev guidance skill.
...
- **Tags:** `container`, `isolation`, `management`
- **Why use it:** Run multiple isolated DSH versions with embedded WebView UI
...
- **Why use it:** Audits context tokens and detects duplicates/conflicts in AGENTS.md chains.
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge syncing Codex and DSH chats, skills, and MCP servers live.
...
- **Why use it:** Web UI plugin to manage skills and MCP servers directly from the browser settings.
...
- **Tags:** `migration`, `configuration-migration`, `import`
- **Why use it:** Migrate Claude Code/Codex/OpenCode setups into DSH seamlessly
...
- **Tags:** `awesome-dsh`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Resolves plugin conflicts and version issues
...
- **Tags:** `dsh-plugin`, `plugins`
- **Why use it:** Handpicked useful DSH plugin collection
...
- **Why use it:** 1000+ DSH tools sorted by stars from GitHub
...
- **Why use it:** DSH plugin marketplace similar to CodeX
...
- **Tags:** `dsh-plugin`, `dsh-plugins`, `dsh-ecosystem`
- **Why use it:** General DSH plugin ecosystem collection
...
- **Tags:** `mascot`, `dsh-plugin`, `claude-code`
- **Why use it:** Animated pet mascot gallery that personalizes your coding agent experience
...
- **Why use it:** Cute whale girl skin series for DeepSeek Harness UI personalization.
...
- **Why use it:** Highly customizable frosted glass theme for DSH web UI with adjustable blur and background
...
- **Tags:** `theme`, `ocean-skin`, `webgpu`, `threejs`
- **Why use it:** Stunning WebGPU ocean-themed skin with Three.js and WebGPU effects.
...
- **Why use it:** 34 opencode themes, one-click install, survives restarts
...
- **Why use it:** Curated plugin collection listing all essential DSH ecosystem tools
...
- **Tags:** `research`, `web-search`, `skill-cn`
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days and generates reports.
...
- **Tags:** `ecosystem-radar`, `plugin-registry`, `validation`
- **Why use it:** Ecosystem radar discovering 15900+ candidates with k8s validation
...
- **Why use it:** Curated comprehensive list of DSH plugins and ecosystem tools
...
- **Why use it:** Curated DSH ecosystem: plugins, tools, and infrastructure links
...
- **Tags:** `awesome-list`, `bilingual`, `curated`, `references`
- **Why use it:** Bilingual curated list of DSH plugins, extensions, and verified references
...
- **Tags:** `knowledge-base`, `ai-resources`, `encyclopedia`, `mcp`
- **Why use it:** Comprehensive AI resource encyclopedia covering LLMs, agents, RAG, and MLOps open-source projects
...
- **⭐ Stars:** 305
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插���分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `plugin-directory`, `curation`
- **Why use it:** Curated DSH plugin directory with daily GitHub scraping, categorized by real usage scenarios
...
- **Tags:** `academic`, `mcp`, `arxiv`, `citation-graph`
- **Why use it:** Cross-platform academic search with citation graph and MeSH support for Chinese researchers
...
- **⭐ Stars:** 155
- **Language:** TypeScript
- **Description:** Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献��理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the whole research cycle.
...
- **Tags:** `awesome-list`, `plugins`, `deepseek`
- **Why use it:** Curated catalog of DSH plugins, tools and development resources.
...
- **Why use it:** Patent infringement analysis system producing competitor reports via RAG.
...
- **Why use it:** Industry research skill pack with chain mapping and news tracking
...
- **Why use it:** Multi-market K-line analysis with technical indicators and fundamental data in sidebar.
...
- **Why use it:** Curated community list of DSH plugins and extensions
...
- **Why use it:** Public GitHub directory for plugin discovery and installs
...
- **Why use it:** Real-time token usage charts and cost estimation dashboard
...
- **Tags:** `awesome-list`, `registry`, `plugin-registry`
...
- **Tags:** `awesome-list`, `curated-list`, `resources`
...
- **Tags:** `awesome-list`, `verified`, `curated-list`
- **Why use it:** Evidence-led directory with verified and permission-aware installs
...
- **Tags:** `awesome-list`, `dsh-plugin-directory`, `plugin`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `plugin-registry`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Bilingual reviewed plugin directory at immutable commits
...
- **Tags:** `awesome-list`, `catalog`, `deepseek-harness`
- **Why use it:** Daily auto-crawled bilingual plugin directory via GitHub Actions
...
- **Tags:** `awesome-list`, `moved`
- **Why use it:** Redirect to main awesome-dsh-plugin repo
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** DSH plugin collection directory
...
- **Tags:** `awesome-list`, `auto-updating`, `vercel`
- **Why use it:** Auto-updating YAML-driven bilingual plugin list with Vercel static site
...
- **Tags:** `curated-list`, `coding-agents`, `mcp`
...
- **Tags:** `industry`, `awesome-list`, `curated`
- **Why use it:** Industry-specific DSH plugins for computing, finance, law, healthcare and more
...
- **Tags:** `armor-breaking`, `bypass`, `experimental`
- **Why use it:** Armor-breaking plugin for DeepSeek, stable bypass functionality
...
- **Tags:** `deepseek-harness`, `plugin-marketplace`
- **Why use it:** Learn DSH principles, browse plugins, and discover best practices.
...
- **Why use it:** Curated list of DSH plugins, skills, MCP servers, and patch layers.
...
- **Tags:** `plugin-store`, `marketplace`, `awesome-list`
- **Why use it:** Plugin marketplace with 11,000+ entries, search, and free API.
...
- **Why use it:** Comprehensive plugin catalog with 1,958 repos, search, and ranking.
...
- **Why use it:** Conversational anime search with Bangumi ratings and magnet support
...
- **Why use it:** Curated directory of 280+ community DSH plugins
...
- **⭐ Stars:** 31
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融合，本地��定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`
- **Why use it:** Integrates Bazi, Fengshui, IChing and TCM into AI agent skills

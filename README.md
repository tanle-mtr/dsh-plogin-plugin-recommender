...
|--------|-------|
| **Plugins tracked** | 195 |
| **Total community stars** | 899,406 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-28 23:59:13 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 202,016 | Core platform for the entire DSH plugin ecosystem. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,389 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,648 | Meta-harness for deploying multi-agent swarms and  |
...
- **Tags:** `ai-agent`, `multi-model`, `self-evolving`
- **Why use it:** Versatile multi-model agent harness with memory and self-evolution.
...
- **Tags:** `agent-orchestration`, `workspace`, `mcp`, `no-code`
...
- **Tags:** `runtime`, `rust`, `desktop`
- **Why use it:** High-performance Rust agent runtime with desktop app
...
- **Tags:** `code-review`, `static-analysis`, `auto-fix`
...
- **Why use it:** One-line vision toolkit for text-only models: image Q&A, OCR, and UI restoration.
...
- **Tags:** `security`, `dsh-plugin`, `audit`
- **Why use it:** Audits AI-generated code for hallucinated packages and security gaps.
...
- **Why use it:** Bridges Pi ecosystem to DSH — runs unmodified Pi extensions as native DSH plugins.
...
- **Tags:** `plugin-discovery`, `agent-skills`, `verification`
- **Why use it:** Skill that discovers, installs and verifies GitHub plugins directly within DSH.
...
- **Tags:** `reasonix`, `superpowers`, `coding-agent`
- **Why use it:** Superpowers skills ported to Reasonix coding harness for devs.
...
- **Why use it:** Agent skill to scaffold and build DSH plugins from scratch
...
- **Why use it:** Pre-flight plugin check for DSH agents to auto-inject relevant tools
...
- **Tags:** `desktop`, `dsh-plugin`, `ui-extension`
...
- **Tags:** `dsh-web`, `web-ui`, `marketplace`, `plugin-aggregator`
- **Why use it:** Web-based plugin aggregator with creative marketplace distribution.
...
- **Why use it:** Open sidebar foundation with third-party support
...
- **Why use it:** Claude Code style TUI with real-time status display
...
- **Why use it:** 5MB Tauri desktop with zero environment setup and preset plugins across platforms.
...
- **Tags:** `widget`, `balance-monitor`, `ui`
...
- **Why use it:** Local-first Electron desktop workspace combining sessions, projects, and Office artifacts.
...
- **Tags:** `ui`, `dsh-plugin`, `charts`
- **Why use it:** Interactive UI components rendered inline in chat replies.
...
- **Why use it:** CodePilot-inspired Electron desktop client for macOS, Windows, Linux.
...
- **Why use it:** Official Windows desktop GUI for DSH with SSH, mobile remote access and full plugin support.
...
- **Why use it:** Electron desktop hub for multi-tab DSH/MCP/plugin management
...
- **Tags:** `dsh-plugin`, `mcp`, `ui`
- **Why use it:** Unified menu to control MCP tool exposure and execution modes
...
- **Why use it:** Persistent status bar showing model, balance, and live pricing info
...
- **Why use it:** Context audit with Web UI panel and token cost analysis
...
- **Why use it:** Infinite canvas with agentic creative skills for WeShop Cordis
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** 桌��版 DeepSeek Harness：Electron 壳 + 自托管 dsh web 服务，集成 dsh-better-sidebar / dsh-web-ui / ModLens / awesome-dsh-plugin / dshmarket
- **Tags:** `desktop`, `electron`, `integration`, `plugin`
- **Why use it:** Electron desktop wrapper for DSH with integrated plugins and tools
...
- **Why use it:** Custom DSH Web UI backgrounds with real-time preview and multiple presets
...
- **Tags:** `multi-agent`, `workbench`, `enterprise`, `skills`
- **Why use it:** Enterprise multi-engine workbench with visual editor and agent collaboration.
...
- **Why use it:** Intelligent skill routing and workflow orchestration
...
- **Why use it:** Multi-agent collaboration plugin enabling team-style workflows in DSH.
...
- **Why use it:** Local-first AI agent with self-evolving skills and privacy focus.
...
- **Tags:** `web-search`, `dsh-plugin`, `agent-skill`
- **Why use it:** Strongest free web search bridge with no signup required.
...
- **Tags:** `creative-writing`, `drama-skills`, `fiction-writing`
- **Why use it:** AI-powered novel writing and short-drama production skill for creative workflows.
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot/UI/chart analysis in DSH.
...
- **Why use it:** Turns experience into repeatable agent execution workflows across multiple coding tools.
...
- **⭐ Stars:** 163
- **Language:** TypeScript
- **Description:** 让 Agent 的工作方式可组��、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
...
- **Why use it:** Preserves cross-preset session state and context during migration.
...
- **Why use it:** Comprehensive reverse engineering & pentesting skill with 87 guides
...
- **Why use it:** 88 cross-platform agent skills for research & marketing workflows
...
- **Why use it:** AI coding mentor that teaches architecture and reviews code
...
- **Tags:** `plugins`, `slots`, `credentials`
- **Why use it:** Manage slots, credentials and remote Typert connections easily
...
- **Why use it:** Repository-native spec-driven development skill with DSH patterns
...
- **Why use it:** Bazi, Fengshui, IChing and TCM all-in-one traditional wisdom agent
...
- **Tags:** `skills`, `task-board`, `visualization`
- **Why use it:** Visual task board that makes MattSkillsDeck skills actionable in DSH
...
- **Tags:** `skill-picker`, `ux`, `shortcut`
- **Why use it:** WorkBuddy-style skill picker with /skill-name shortcut insertion
...
- **⭐ Stars:** 23
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政��关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `ai-docs`
- **Why use it:** Full Chinese official document processing with format compliance
...
- **Why use it:** Multi-agent collaboration with independent models and tools
...
- **Why use it:** Swift Cycle governance skill adapter for DSH
...
- **Tags:** `agent-skills`, `qa`, `test-automation`
- **Why use it:** Full-lifecycle QA agent framework with 10 skills and reproducible benchmarks
...
- **Why use it:** Hot-reload MCP and skill management via settings page—no restart needed
...
- **Why use it:** Full-stack GDScript game dev skill for Godot Engine 4.x
...
- **Why use it:** Engineering discipline distilled into portable agent skill
...
- **Why use it:** Virtual product team preset simulating PM, Engineer, QA, Release roles
...
- **Why use it:** Manages skills and MCP servers via Web UI plugin card
...
- **Tags:** `figma-alternative`, `ui-generator`, `design-systems`
...
- **Tags:** `diagram-as-code`, `architecture`, `mermaid-alternative`
- **Why use it:** AI-powered architecture and workflow diagram generation as code.
...
- **Tags:** `design`, `flutter`, `react`, `vibedesign`, `agent-team`
...
- **Tags:** `video`, `generation`, `vox`
- **Why use it:** One topic to Vox-style paper-collage video generation
...
- **Why use it:** Native design studio with AI generation, visual editor, template marketplace and PPT.
...
- **Tags:** `image-generation`, `dsh-plugin`, `visual`
- **Why use it:** Generate images directly inside DSH conversations.
...
- **Why use it:** Preview and edit OpenPencil UI design docs directly in conversation.
...
- **Tags:** `photo-editing`, `image-processing`, `editorial-design`
- **Why use it:** Photo-to-editorial AI skill with creative composition control
...
- **Tags:** `visualization`, `legal-tech`, `litigation`, `svg`
...
- **Why use it:** Adds OCR and pixel-to-text vision to text-only LLM agents
...
- **Tags:** `design`, `styles`, `vibe-coding`
- **Why use it:** 6 design styles to avoid AI-generated look in websites
...
- **Why use it:** Free image reading and generation with vision transcription
...
- **Why use it:** AI video/image/audio skills with configurable model tools
...
- **Why use it:** Universal enhancement suite and prompt manager for all major AI web UIs.
...
- **Why use it:** CLI extension for browser automation across agents
...
- **Tags:** `browser-extension`, `workflow`, `multi-platform`
- **Why use it:** Chrome extension turning AI conversations into organized, reusable cross-platform workflows.
...
- **Why use it:** Live iOS Simulator and USB iPhone control with 22 agent tools.
...
- **Why use it:** Tabbit Browser plugins enabling Playwright-based web automation.
...
- **Tags:** `portal`, `web`, `static-site`, `discovery`
...
- **Tags:** `marketplace`, `skills`, `installation`
- **Why use it:** CodeX-style marketplace for browsing and installing DSH skills
...
- **Tags:** `photo`, `social`, `oauth`
- **Why use it:** Group photo wall with GitHub OAuth and whitelist validation
...
- **Why use it:** Privacy-first open-source resume builder, fully self-hosted and free.
...
- **Tags:** `routing`, `injector`, `cordis`, `dsh-plugin`
...
- **Tags:** `preset`, `standard-tools`, `dsh-plugin`, `bootstrap`
- **Why use it:** Two-phase preset for reliable DSH bootstrap with full Standard tools.
...
- **Why use it:** First vision plugin converting images to structured JSON for text-only agents.
...
- **Tags:** `vfs`, `virtual-filesystem`, `agent-tools`, `bash`
- **Why use it:** Unified virtual filesystem for AI agents — abstracts local and remote storage.
...
- **Tags:** `model-switch`, `cli`, `infrastructure`
- **Why use it:** One-click multi-model switch for DSH ecosystem
...
- **Why use it:** Context dashboard and browser for real-time stats, management, and inspection.
...
- **Tags:** `oauth`, `llm-provider`, `dsh-plugin`
...
- **Why use it:** Tracks session/daily token costs, budgets, and quota history for DSH API usage.
...
- **Tags:** `task-management`, `native-web-ui`, `sqlite`
- **Why use it:** Native SQLite-backed taskboard for DSH with agent claim/review and clean Web UI.
...
- **Why use it:** Brings full office suite—spreadsheets, docs, slides—into the DSH environment.
...
- **Why use it:** Smartisan-style notes app with Docker deploy and DSH skill integration.
...
- **Tags:** `marketplace`, `plugin-management`, `nodejs`
...
- **Why use it:** Crash rescue with undo, snapshots and SAFE MODE for config safety.
...
- **Why use it:** Plugin registry console + dev skill for DSH ecosystem infrastructure
...
- **Tags:** `config-manager`, `backup`, `mcp`, `sync`
...
- **Tags:** `containers`, `ui`, `multi-version`
...
- **Why use it:** One-click MCP/Skills/config setup for 7+ AI coding agent tools
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional sync bridge between OpenAI Codex and DSH ecosystems
...
- **Tags:** `package`, `manager`, `assets`
- **Why use it:** Package manager with 42 skills, 5 CLIs, and 1 plugin
...
- **Why use it:** Seamlessly migrate Claude Code configs, skills, and MCP settings into DSH
...
- **Tags:** `conflict`, `utility`, `plugin-manager`, `fix`
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `theme`
- **Why use it:** Animated pet gallery — fun visual theme for coding agents across platforms.
...
- **Why use it:** Whale girl skin series for DeepSeek Harness
...
- **Why use it:** Frosted glass theme with full visual customization.
...
- **Why use it:** Stunning WebGPU ocean-themed visual skin extension for DeepSeek Harness UI.
...
- **⭐ Stars:** 18
- **Language:** JavaScript
- **Description:** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一��换上——tokyonight、dracula、gruvbox、matrix、rose-pine……即点即换，重启不丢。34 opencode themes for DeepSeek Harness, one click, persisted. More by @FeatherHunter: ⚡ dsh-prompt · 🧠 dsh-mattpocock-skills-deck
- **Tags:** `themes`, `skins`, `color-scheme`
- **Why use it:** 34 opencode themes with one-click switching, persistence
...
- **Tags:** `ai`, `rag`, `vibecoding`, `prompt`
- **Why use it:** Comprehensive AI resource hub and prompt collection for beginners.
...
- **Why use it:** Auto-searches top 8 Chinese platforms for research
...
- **Tags:** `knowledge-base`, `dsh-plugin`, `ai-encyclopedia`
- **Why use it:** Comprehensive AI knowledge hub covering agents, RAG, MLOps and more.
...
- **Tags:** `awesome-list`, `agent-harness`, `developer-tools`
- **Why use it:** Comprehensive DSH quickstart guide with curated plugins and resource recommendations.
...
- **Why use it:** Curated directory of DSH plugins, MCP servers, patches and UI orchestrators.
...
- **⭐ Stars:** 199
- **Language:** JavaScript
- **Description:** DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动���集与格式校验，免费搜索 API。deepseek1024.com
- **Tags:** `plugin-marketplace`, `catalog`, `registry`
- **Why use it:** Plugin marketplace hub with 11,000+ DSH plugins, search and free public API.
...
- **Tags:** `api-documentation`, `chinese-api`, `deep-research`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in agents
...
- **Tags:** `patent-analysis`, `rag`, `legal-tech`, `intellectual-property`
- **Why use it:** Patent infringement analysis with RAG-powered claim charts
...
- **Tags:** `kline`, `trading`, `analysis`
- **Why use it:** Interactive K-line chart with tech indicators and market news analysis
...
- **Why use it:** Industry research methodology with policy and news tracking
...
- **Tags:** `plugin-registry`, `open-data`, `curated-list`
...
- **Why use it:** Curated finance/stock/quant plugins for DSH with bilingual support
...
- **Tags:** `awesome-list`, `verified`, `guide`
- **Why use it:** Evidence-led curated directory with verified plugins and installation guidance
...
- **Tags:** `awesome-list`, `comprehensive`, `resource`
...
- **Tags:** `awesome-list`, `star-ranked`, `verified`
...
- **Tags:** `awesome-list`, `collection`, `useful`
...
- **Tags:** `awesome-list`, `navigation`, `guide`
- **Why use it:** Plugin navigation with scenario-based selection and risk awareness
...
- **Why use it:** Full inventory of 1000+ DSH tools sorted by stars from GitHub topics
...
- **Tags:** `deepseek-harness`, `dsh-repository-plugin`, `dsh-plugin-verify`
- **Why use it:** Curated DSH plugin repository with verify and analytics topics
...
- **Tags:** `awesome-list`, `ai-agent`, `plugin-registry`
...
- **Why use it:** Bilingual curated directory with immutable commit reviews
...
- **Why use it:** Auto-updating bilingual directory via daily GitHub Actions crawl
...
- **Why use it:** Plugin search and discoverability tool inside DSH agents
...
- **Why use it:** Auto-updating curated list with YAML data and Vercel deployment
...
- **Tags:** `coding-agents`, `plugin-directory`, `ui`, `skills`
- **Why use it:** Comprehensive curated plugins for models, tools, sandboxes and UI
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** DSH plugin curated list
...
- **Why use it:** Industry-specific plugins for computing, finance, legal and more
...
- **Why use it:** Curated plugin list — essential discovery resource for DSH ecosystem.
...
- **Why use it:** Traditional toy web simulation, lightweight single file
...
- **Why use it:** Ecosystem radar auto-discovering 15900+ plugins with k8s-based live validation.
...
- **Why use it:** Curated plugin ecosystem list — essential reference for discovering DSH tools.
...
- **Why use it:** Curated plugin, tool and infrastructure list from the DSH ecosystem.
...
- **Tags:** `prompt`, `deepseek-specific`, `utility`
- **Why use it:** Specialized prompt plugin for DeepSeek; use responsibly per your platform guidelines.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `bilingual`
- **Why use it:** Curated bilingual DSH plugin directory with verified entries.
...
- **Why use it:** Daily-scraped plugin discovery with scenario-based classification.
...
- **Tags:** `documentation`, `dsh-plugin`, `guide`
- **Why use it:** DSH principles, plugin marketplace guide, and best practices.
...
- **Why use it:** DSH plugin marketplace collection page for discovering and browsing plugins.
...
- **Tags:** `awesome-list`, `plugin-directory`, `reference`
- **Why use it:** Curated awesome list of all DSH plugins for discovery and reference.
...
- **⭐ Stars:** 84
- **Language:** JavaScript
- **Description:** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选维护的 DeepSeek Harness Cordis 插件官方自动生成��表。
- **Tags:** `awesome-list`, `plugin-marketplace`, `dsh`
...
- **Why use it:** Community-maintained DSH plugin catalog with 4-hour auto-sync

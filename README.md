...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 836,891 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 09:35:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 186,288 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,562 | Open-source AI design tool with local-first deskto |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,893 | Multi-agent swarm harness with autonomous workflow |
...
- **Why use it:** Multi-agent swarm harness with autonomous workflow coordination
...
- **Why use it:** Self-evolving multi-model agent with memory and knowledge
...
- **Why use it:** Best beginner guide to learn harness engineering from scratch
...
- **Tags:** `cordis`, `dsh-plugin`, `mcp`
- **Why use it:** Task-aware reasoning-mode router injector for DSH runtime
...
- **Tags:** `agent-collaboration`, `multi-agent`, `mcp`
...
- **Why use it:** One-click install and model switch across major AI coding tools
...
- **Tags:** `code-review`, `agent-skills`, `dsh-plugin`, `clean-architecture`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with severity labels and auto-fix
...
- **Tags:** `architecture`, `coding-agents`, `spec-driven`
- **Why use it:** Makes AI coding agents architecture-aware with evidence verification
...
- **Why use it:** Official Swift-native macOS coding agent by DeepSeek team
...
- **Why use it:** Context dashboard and management for DSH with statistics
...
- **Why use it:** Runs unmodified Pi extensions as native DSH plugins via ABI bridge
...
- **Tags:** `plugin-development`, `agent-skills`, `tools`
- **Why use it:** Agent skill covering all DSH plugin standards: slots, tools, adapters, packaging
...
- **Tags:** `plugin-development`, `agent-skills`
- **Why use it:** Agent skill for building DSH plugins: handles slots, Typert remotes, credentials
...
- **Why use it:** Plugin dev knowledge base and scaffold as on-demand agent skill with EN/ZH docs
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** One-tap project migration and two-way sync between Codex and DSH
...
- **Why use it:** Audits context injection, detects duplicates and conflicts via Web UI
...
- **Why use it:** Centralized skill management plugin for DeepSeek Harness
...
- **Tags:** `package-manager`, `agent-assets`, `cli`
- **Why use it:** Package manager for AI agent assets with 42 skills, 5 CLIs, and plugin
...
- **Tags:** `plugin-dev`, `agent-skill`, `scaffolding`, `cordis`
- **Why use it:** Portable agent skill for building and auditing DSH plugins with bundle adapter
...
- **Tags:** `documentation`, `best-practices`, `tsconfig`, `zstd`
- **Why use it:** Practical dev pitfalls doc covering cordis, tsconfig, Windows junction, zstd
...
- **Tags:** `plugin-dev`, `scaffolding`, `testing`, `skills`
- **Why use it:** Agent skills for scaffolding DSH plugins and choosing test tiers from inside DSH
...
- **Why use it:** Web GUI, task board, Wallpaper Engine skin, and mobile SSH support
...
- **Why use it:** Open sidebar foundation with file editor, terminal, chat, Git and sub-agent pages
...
- **⭐ Stars:** 2,341
- **Language:** TypeScript
- **Description:** DSH ��方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `terminal`, `dsh-plugin`, `claude-code`
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thought, rollback and progress display
...
- **Tags:** `agent-runtime`, `desktop`, `dsh-plugin`, `vibe-coding`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop AI coding app
...
- **⭐ Stars:** 628
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随���面自动启用，建议直接喊来你的dsh安装
- **Tags:** `widget`, `desktop`, `cute`
- **Why use it:** Cute floating whale widget tracking DSH account balance
...
- **Why use it:** Local-first desktop workspace with DSH sessions and Office
...
- **Why use it:** Canvas-based branching conversation workspace for complex sessions
...
- **Tags:** `electron`, `desktop`, `ssh`
- **Why use it:** Zero-setup Electron desktop client with SSH, skills, and mobile access
...
- **Why use it:** Electron desktop hub for multi-tab DSH plugin, MCP, and skill management
...
- **Tags:** `ui`, `status-bar`, `balance`, `pricing`
...
- **Why use it:** Cross-platform desktop integrating DB, SSH, Docker panels with AI.
...
- **Why use it:** Open-source LLM knowledge platform with RAG and semantic search
...
- **Tags:** `agent-memory`, `long-term-memory`, `rag`
- **Why use it:** Portable local-first memory layer with self-evolving RAG
...
- **Tags:** `memory-management`, `rag`, `token-savings`
...
- **Why use it:** Unified virtual filesystem enabling persistent agent file abstraction
...
- **Why use it:** Unlimited memory storage for OpenClaw agents
...
- **Why use it:** Comprehensive AI knowledge base covering MLOps, RAG, agents and more
...
- **Tags:** `memory`, `handoff`, `deepseek-harness`
- **Why use it:** Connects to PowerContext for recall and memory handoff between sessions.
...
- **Why use it:** Bridges Claude Code memory and skills into DSH for cross-platform recall.
...
- **Why use it:** Transform memories into living AI skills and personas
...
- **Tags:** `agent-skills`, `diagrams`, `code-visualization`
- **Why use it:** Agent skill for generating beautiful architecture and sequence diagrams
...
- **Tags:** `agent-workspaces`, `coding-agent`, `mcp`
...
- **Why use it:** Self-improving agent OS with loop-engineering and evaluation
...
- **Why use it:** First vision bridge for text-only coding agents with OCR and JSON output
...
- **Tags:** `video-generation`, `agent-skill`, `dsh-plugin`, `ffmpeg`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation from a single topic
...
- **Tags:** `task-manager`, `workflow`, `human-loop`
...
- **Tags:** `multi-agent`, `teams`, `collaboration`
- **Why use it:** Multi-agent team collaboration plugin for DSH
...
- **Tags:** `agent`, `skill`
- **Why use it:** Unifies multiple coding agents into a collaborative team
...
- **Why use it:** Turn experience into repeatable agent execution patterns
...
- **Tags:** `infra`, `skills`, `system`
- **Why use it:** Specialized skills for AI infra: write, optimize, and debug systems
...
- **Why use it:** 85 SKILL.md reverse-engineering skill for CTF and authorized pentesting
...
- **Tags:** `agent-skills`, `coding-agent`
...
- **Tags:** `agent-skills`, `research-tools`, `marketing`
...
- **Tags:** `spec-driven-development`, `agent-skills`, `coding`
...
- **Why use it:** Codex skill for finding and applying code simplifications
...
- **Why use it:** Unique Bazi/Fengshui/I Ching agent skill with local deterministic engine
...
- **Why use it:** Multi-agent team with independent models, skills, MCP and shared workspace
...
- **Why use it:** Swift Cycle governance skill, user-invoked with version pinning and offline verification
...
- **Tags:** `skill`, `engineering`, `discipline`, `portable`
- **Why use it:** Engineering discipline portable skill: fact-finding, evidence by surface, honest reporting
...
- **Tags:** `gongwen`, `document`, `word`, `templates`
- **Why use it:** Full Chinese official document pipeline per GB/T 9704 — format check, template, revision
...
- **Tags:** `record-replay`, `macos`, `workflows`, `computer-use`
- **Why use it:** Record macOS desktop workflows as demonstrations and turn them into reusable agent skills
...
- **Tags:** `agent`, `agent-preset`, `ai-agents`
- **Why use it:** Virtual product team preset for guided agent conversations
...
- **Why use it:** Pre-flight plugin check that auto-injects relevant plugins
...
- **Why use it:** Web GUI plugin to manage skills and MCP servers in DSH settings page
...
- **Why use it:** Paste JSON to connect MCP servers instantly; auto-parses .skill files.
...
- **Why use it:** OAuth-based ChatGPT integration for DSH agent conversations
...
- **Tags:** `ai-design`, `design-systems`, `prototyping`
- **Why use it:** Open-source AI design tool with local-first desktop app
...
- **Why use it:** AI-generated visual editor with PPT and template marketplace
...
- **Why use it:** Preview and edit OpenPencil .op documents directly in DSH chat
...
- **Tags:** `visualization`, `legal-tech`, `diagram`
- **Why use it:** Turn messy litigation cases into court-ready SVG timelines and diagrams
...
- **Why use it:** Free image reading and generation with vision models (GLM-4V, DeepSeek-V4)
...
- **Why use it:** 6 design style presets to keep AI-generated websites aesthetically polished
...
- **Tags:** `ai-video`, `ai-image`, `storyboard`, `vision`
- **Why use it:** AI video/image/audio generation pipeline with configurable models and storyboard tools
...
- **Tags:** `canvas`, `creative`, `infinite`, `cordis`
- **Why use it:** Infinite creative canvas with agentic skills, native WeShop Cordis integration
...
- **Why use it:** Local-first AI content discovery agent across Bilibili, Xiaohongshu, YouTube and more
...
- **Why use it:** Let AI agents use your real logged-in browser seamlessly via CLI plus extension
...
- **Why use it:** Chrome sidebar extension enabling direct browser control via DSH
...
- **Why use it:** Live iOS Simulator and USB iPhone automation via 22 agent tools
...
- **Tags:** `community`, `social`, `oauth`
- **Why use it:** DSH beta member group photo wall with GitHub OAuth zero-permission login
...
- **Tags:** `self-hosted`, `mcp-server`, `agent-skills`
...
- **Why use it:** Two-phase minimal bootstrap preset with full Standard tools
...
- **Why use it:** Visual plugin marketplace inside DSH for browsing, searching and one-click installing
...
- **Why use it:** Plugin radar with 9000+ candidates, runtime testing, top 50 curation and auto-updating index
...
- **⭐ Stars:** 266
- **Language:** JavaScript
- **Description:** 用 30 秒为你的 DeepSeek Harness找到合适的插件。 ���库由脚本每天自动抓取，再经人工逐个核实——真插件进目录，蹭热度的进黑名单，每条剔除理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **Tags:** `awesome-list`, `discovery`
- **Why use it:** Curated plugin discovery tool with manual verification and blacklist
...
- **Why use it:** Uses ChatGPT/Claude/Grok subscriptions as LLM providers via OAuth
...
- **Tags:** `cost`, `token-tracking`, `billing`
- **Why use it:** Track per-session and daily token costs across multiple providers
...
- **Why use it:** Open-source smart pen-style notes with Docker deployment and export
...
- **Why use it:** DSH ecosystem infrastructure: console for plugin management + dev guide
...
- **Tags:** `container`, `desktop`, `management`
...
- **Tags:** `config`, `backup`, `restore`, `mcp`, `webdav`
- **Why use it:** Full DSH config backup/restore with MCP server sync, export/import, WebDAV support
...
- **Tags:** `plugin-manager`, `ui`, `hot-reload`
- **Why use it:** GUI plugin manager in settings; hot-reload without restart.
...
- **Tags:** `capabilities`, `security`, `mcp`
- **Why use it:** Unified menu to manage exposure level and execution mode of tools.
...
- **Tags:** `analytics`, `cost`, `visualization`
- **Why use it:** Real-time token usage, cost charts, and API balance dashboard.
...
- **⭐ Stars:** 3
- **Language:** TypeScript
- **Description:** 致力于解��各插件之间也与版本之间可能存在的冲突问题并提供解决方案
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness`
- **Why use it:** Detects and resolves plugin conflicts and version issues
...
- **Tags:** `plugin-manager`, `registry`
- **Why use it:** Merges multi-source plugin lists with deduplication.
...
- **Tags:** `plugin-manager`, `cli`
- **Why use it:** CLI tool for discovering, installing, managing DSH plugins.
...
- **Tags:** `publisher`, `plugin-tools`
- **Why use it:** One-click plugin publisher: validates, generates docs and PRs.
...
- **Why use it:** Public animated pet gallery for mascots and themes across CLIs
...
- **Why use it:** Whale Girl character skin series for DeepSeek Harness visual customization
...
- **⭐ Stars:** 368
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自���义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`
- **Why use it:** Frosted glass theme with fully customizable visual effects
...
- **Why use it:** WebGPU-accelerated ocean theme with native DSH integration
...
- **Tags:** `theme`, `skin`, `opencode`, `palette`, `dark-mode`
- **Why use it:** 34 opencode classic color schemes one-click swap — tokyonight, dracula, gruvbox, matrix
...
- **Why use it:** Web background customization with presets, blur, masking, and preview.
...
- **Tags:** `rag`, `ai-guide`, `vibe-coding`
- **Why use it:** Comprehensive AI resource hub with tutorials and knowledge base
...
- **Tags:** `research`, `web-search`, `dsh-plugin`, `china`
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days and generates citable research reports
...
- **Tags:** `api-documentation`, `research`, `chinese-api`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in your AI coding agent
...
- **Tags:** `finance`, `technical-analysis`, `kline`, `sidebar`
- **Why use it:** Interactive K-line chart with multi-market support and technical indicators in sidebar
...
- **Why use it:** Math modeling toolkit with 17 skill cards and preset configurations.
...
- **Why use it:** Curated stock/finance/quant plugin vertical list with 24 entries.
...
- **Why use it:** Plugin manual and navigation by use case with risk info
...
- **Why use it:** Evidence-backed plugin radar and lab for DSH
...
- **Tags:** `plugin-portal`, `web`, `awesome-dsh-plugin`
- **Why use it:** Static web portal for browsing and installing 227+ plugins
...
- **Why use it:** Curated awesome list to discover all DSH ecosystem plugins
...
- **Tags:** `dsh-plugin`, `toy`, `single-file`
- **Why use it:** Zero-dependency web toy simulating the traditional zhuzhiliao whistle with real audio
...
- **Tags:** `awesome-list`, `ecosystem`, `directory`
...
- **Why use it:** Curated list of DSH plugins, tools and infrastructure
...
- **Why use it:** Bilingual curated reference list of DSH plugins and integrations
...
- **Why use it:** Curated DSH plugin ecosystem map covering MCP, skills, and patches
...
- **Why use it:** Plugin marketplace hub with 3100+ listings and public API
...
- **Why use it:** DeepSeek Harness plugin marketplace extension hub
...
- **Why use it:** Search anime across Bangumi and mikan with magnet link support
...
- **Why use it:** A DSH plugin for novel writing and short-drama production, powered by Oh Story a
...
- **Why use it:** Generate images directly in DeepSeek Harness chats
...
- **Why use it:** DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub 
...
- **Why use it:** Noema long-term memory plugin for DSH: durable, inspectable agent memory with re
...
- **Why use it:** DSH crash-rescue plugin: undo config & plugin-code changes, secret-safe snapshot
...
- **Why use it:** DeepSeek Harness plugin for previewable cross-preset session migration. Fixed-sc
...
- **Why use it:** Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collabora
...
- **Why use it:** A meticulously curated list of useful plugins, extensions, tools and development
...
- **Tags:** `awesome-list`, `directory`, `discovery`, `nextjs`
- **Why use it:** Public GitHub directory for DSH plugin discovery, install commands, and ecosystem map
...
- **Why use it:** Curated list of DSH plugins — hand-picked highlights for ecosystem discovery
...
- **Why use it:** Fast, simple, elegant Neovim plugin manager in Lua — not DSH-specific but useful
...
- **Why use it:** Unofficial community-curated plugin catalog for DSH.
...
- **Tags:** `catalog`, `curated`, `awesome-list`
- **Why use it:** Evidence-led curated directory with verified plugin entries.
...
- **Tags:** `registry`, `open-data`, `plugin-catalog`
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Moved to new repo — no longer actively maintained here
...
- **Tags:** `awesome-list`, `dsh-ecosystem`
- **Why use it:** DSH plugin ecosystem listing and repository.
...
- **Tags:** `awesome-list`
- **Why use it:** Auto-generated Cordis plugin listing by cordis.run.
...
- **Why use it:** 1000+ DSH tools sorted by stars from GitHub topics.
...
- **Tags:** `marketplace`, `plugin-directory`
- **Why use it:** Dynamic plugin marketplace: browse, search, install plugins.

...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 927,176 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-31 21:50:51 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 206,394 | Core harness framework powering the entire DSH eco |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,057 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,999 | Deploy multi-agent swarms and autonomous workflows |
...
- [Research & Analysis](#research-&-analysis) — 44 plugins
- [Other](#other) — 12 plugins
...
- [Research & Analysis](research-analysis) (44)
- [Other](other) (12)
---
...
- **Why use it:** Core harness framework powering the entire DSH ecosystem.
...
- **Why use it:** Terminal AI coding agent with prompt caching for stability.
...
- **Tags:** `agent-sandbox`, `vfs`, `virtual-filesystem`
- **Why use it:** Unified virtual filesystem powering AI agents with sandbox isolation.
...
- **Tags:** `claude-code`, `model-switch`, `coding-agent`
- **Why use it:** One-click switch between 10+ major AI coding agents and models.
...
- **Tags:** `agent-runtime`, `rust`, `ai-coding`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop IDE.
...
- **Tags:** `agent-skills`, `ai-code-review`, `code-quality`, `dsh-plugin`
...
- **Tags:** `agent-vision-toolkit`, `computer-vision`, `ocr`, `dsh-plugin`
- **Why use it:** Powerful vision toolkit with OCR and screenshot-to-UI for text-only models
...
- **Why use it:** Audits AI code for hallucinated packages, missing safeguards & errors.
...
- **Tags:** `agent-review`, `prompt-engineering`
- **Why use it:** Enables composable, reviewable, self-evolving agent workflows
...
- **Why use it:** Manage skills and MCP tools directly from the DSH Web UI panel.
...
- **Tags:** `marketplace`, `webui`, `plugin`, `community`
...
- **Why use it:** Installable plugin dev knowledge base with official docs archive.
...
- **Tags:** `dsh-plugin`, `plugin-creator`, `cordis`
...
- **Tags:** `codex`, `sync`, `mcp`, `dsh-plugin`
...
- **Tags:** `package`, `skills`, `mcp`, `database`
- **Why use it:** All-in-one asset package: 42 skills, 5 CLIs, database integrations.
...
- **Tags:** `agent-tools`, `capability-check`, `plugin-library`
- **Why use it:** Pre-flight plugin library check for agents, boosts plugin utilization predictability
...
- **Tags:** `deepseek-harness`, `sidebar`, `ui-extension`
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, chat, and Git views.
...
- **Tags:** `taskboard`, `skills`, `deepseek-harness`
- **Why use it:** Modern flexible task panel embedding into Codex and DeepSeek Harness.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, and real-time stats.
...
- **Tags:** `deepseek-harness`, `desktop`, `dsh`, `tauri`
...
- **Tags:** `deepseek-harness`, `floating-widget`, `plugin`
...
- **Tags:** `desktop-app`, `dsh-plugin`, `electron`, `local-first`
...
- **Tags:** `ui`, `components`
- **Why use it:** Renders interactive UI components inline in assistant replies.
...
- **Tags:** `desktop`, `multi-model`
- **Why use it:** Local-first multi-model desktop app with self-evolving skills & privacy focus.
...
- **Why use it:** Live iOS Simulator and USB iPhone integration with 22 agent automation tools.
...
- **Tags:** `desktop`, `ssh`
- **Why use it:** Windows desktop GUI with SSH, skills, plugins and remote mobile access.
...
- **Why use it:** Brings full office suite into DSH environment seamlessly
...
- **Why use it:** Desktop Electron app to manage Harness, plugins, MCP and skills via multi-tab UI
...
- **Why use it:** Persistent bottom bar showing provider, model, balance, and pricing.
...
- **Tags:** `skills`, `mcp`, `manager`, `ui`
- **Why use it:** Web UI card for managing skills and MCP servers in DSH settings.
...
- **⭐ Stars:** 17
- **Language:** HTML
- **Description:** DSH 内测收官合影墙：GitHub OAuth 零权限��录 + 冻结白名单校验的拍立得合影站（含 DSH Skill 包装）
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Fun community photo wall with OAuth login
...
- **Tags:** `desktop`, `docker`
- **Why use it:** All-in-one DevOps desktop: SSH, Docker, DB client
...
- **Why use it:** Customizable DSH Web background with preset themes and auto-save
...
- **Why use it:** Turn documents into queryable RAG knowledge base with wiki.
...
- **Tags:** `memory`, `rag`, `mcp`, `local-first`
- **Why use it:** Local-first portable memory layer, user-owned and cross-app persistent
...
- **Why use it:** Dedicated memory management kit for persistent agent recall.
...
- **Why use it:** Persistent memory layer backed by Markdown and Milvus hybrid search.
...
- **Tags:** `long-term-memory`, `mcp`, `dsh-plugin`, `personal-ai`
- **Why use it:** Local memory hub giving all AI agents shared persistent context
...
- **Tags:** `agent-memory`, `rag`, `embeddings`
- **Why use it:** Transforms SKILL.md files into curated, retrieval-ready agent corpora.
...
- **Why use it:** Evidence-backed evaluation for prompts, RAG, skills, and agents.
...
- **Why use it:** Self-improving agent OS with loop engineering and continuous evaluation
...
- **Tags:** `agent`, `workflow`, `loop-engineering`
- **Why use it:** Long-horizon agent control plane for durable, governed cross-tool workflows
...
- **Tags:** `agent`, `workspace`, `multi-agent`, `skills`
...
- **Why use it:** Intelligent skill routing and workflow orchestration with measurable gains.
...
- **Tags:** `creative-writing`, `ai-agents`
- **Why use it:** Powerful creative writing and short-drama production skill
...
- **Tags:** `agent-skills`, `multimodal`
- **Why use it:** Adds multimodal vision to text-only LLM backends for UI automation
...
- **Tags:** `anime-search`, `bangumi`, `magnet`, `deepseek-harness`
- **Why use it:** Search anime across multiple sources with Bangumi ratings directly in chat.
...
- **Tags:** `ai-infra`, `skills`, `agent`, `debugging`
...
- **Why use it:** TDD, debugging, and planning skills adapted from obra/superpowers for DSH.
...
- **Tags:** `pentest`, `reverse-engineering`, `security`, `ctf`
...
- **Why use it:** Ports powerful coding skills from Superpowers into Reasonix harness
...
- **Tags:** `skills`, `coding`, `mentor`
- **Why use it:** AI mentor skill that generates guided coding chapters and reviews your code
...
- **Tags:** `plugin-dev`, `skills`, `agent`
- **Why use it:** Skill that generates DSH plugins following official conventions and packaging
...
- **Tags:** `plugin-dev`, `management`
- **Why use it:** Manage installed DSH plugins — slots, typert remotes, and credentials easily
...
- **Why use it:** Portable spec-driven dev skill with DSH patterns built in.
...
- **Tags:** `skills`, `agent`, `dsh-better-sidebar`, `dsh-plugin`
- **Why use it:** Game-like skill assignment and delegation system for DSH agents.
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `tcm`, `dsh-plugin`
- **Why use it:** Bazi/fengshui/TCM agent skill with local deterministic engine.
...
- **Tags:** `gongwen`, `docx`, `wps-office`, `dsh-plugin`
- **Why use it:** Full workflow Chinese official doc tool compliant with GB/T 9704.
...
- **Tags:** `dsh-plugins`, `skills-manager`, `agent-skills`
...
- **Tags:** `dsh-plugin`, `skill-picker`, `composer`
- **Why use it:** WorkBuddy-style skill picker for quick DSH composer integration.
...
- **Tags:** `dsh-plugins`, `multi-agent`, `team-collaboration`
- **Why use it:** Multi-agent collaboration with shared workspace and independent tools.
...
- **Why use it:** Adapts DSH simplification patterns as reusable Codex agent skills.
...
- **⭐ Stars:** 19
- **Language:** Python
- **Description:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决���矩阵（Claude Code / dsh 等 Agent 可用）
- **Tags:** `qa`, `testing`, `skills`, `playwright`
- **Why use it:** 10 QA skills with shared knowledge base for AI testing workflows.
...
- **Why use it:** Swift Cycle governance skill, offline-verifiable
...
- **Tags:** `game-development`, `dsh-plugin`
- **Why use it:** Godot 4.x full-stack game dev skill plugin
...
- **Why use it:** Engineering discipline skill from DSH best practices
...
- **Why use it:** Virtual product team agent preset: PM→Engineer→QA→Release workflow
...
- **Why use it:** Vision bridge plugin enabling image analysis for text-only coding agents
...
- **Tags:** `mcp`, `skills`
- **Why use it:** Hot-reload MCP config + skill management UI
...
- **Why use it:** Industrial-grade prompt engine with 530+ image generation templates.
...
- **Tags:** `video-generation`, `ffmpeg`, `generative-ai`
- **Why use it:** End-to-end automated generation of Vox-style paper-collage explainer videos.
...
- **Tags:** `ai-design`, `design-studio`, `ppt`, `dsh-plugin`
- **Why use it:** Native AI design system with visual editor and PPT studio integration
...
- **Why use it:** Generates images directly within DeepSeek Harness chat conversations.
...
- **Why use it:** Preview and edit .op documents directly inside DeepSeek Harness conversations.
...
- **Why use it:** Visualize litigation timelines and case diagrams into court-ready SVG output
...
- **Why use it:** Enables pixel-level image reading and OCR for text-only models.
...
- **Why use it:** 6 design styles to avoid AI-generated look in vibe-coded sites.
...
- **Tags:** `media`, `image`, `vision`, `generation`
- **Why use it:** Image reading with vision transcription and DeepSeek generation.
...
- **Why use it:** Infinite canvas with creative agentic skills
...
- **Why use it:** Enhancement suite and prompt manager for AI chat browsers.
...
- **Why use it:** Seamless browser automation with real logged-in sessions for AI agents
...
- **Tags:** `search`, `web`
- **Why use it:** Free, no-signup web search bridge for all models without native access.
...
- **Why use it:** Playwright-based browser automation plugins for DeepSeek Harness
...
- **Why use it:** Local-first AI agent discovering content across Chinese social platforms.
...
- **Tags:** `ai-agents`, `chatgpt`, `oauth`, `dsh-plugin`
- **Why use it:** OAuth integration for ChatGPT within DSH
...
- **Tags:** `mcp-server`, `resume-builder`, `dsh-plugin`
...
- **Tags:** `routing`, `dsh-plugin`, `cordis`
- **Why use it:** Task-aware routing kit, essential for directing agent workflows
...
- **Why use it:** Web-based plugin aggregation ecosystem, everything as plugin
...
- **Tags:** `preset`, `dsh-plugin`, `standard`
- **Why use it:** Two-phase preset achieving Project2 98/99 standard tool alignment
...
- **Tags:** `deepseek-harness-plugin`, `dsh-plugin`, `context`
...
- **Tags:** `cost-tracking`, `deepseek-api`
- **Why use it:** Track session and daily costs with budget management
...
- **Why use it:** Bridges Pi and DSH ecosystems with one ABI compatibility layer
...
- **Why use it:** Preserve session state across preset migrations with fixed-schema handoffs.
...
- **Why use it:** Smartisan-style notes app with Docker deployment, export, and plugin support.
...
- **Tags:** `marketplace`, `plugin`, `web-gui`, `nodejs`
...
- **Tags:** `backup`, `crash-recovery`, `undo`, `snapshot`
- **Why use it:** Crash-rescue with undo, snapshots, and SAFE MODE for DSH config safety.
...
- **Tags:** `utility`, `mcp`, `management`
- **Why use it:** Centralized menu to manage MCP tools and skills exposure level in DSH
...
- **Why use it:** Backup, import, sync and migrate all DSH configs via WebDAV
...
- **Tags:** `registry`, `plugin-dev`, `infrastructure`
- **Why use it:** Official plugin registry console + skill guide for DSH plugin development
...
- **Tags:** `dsh-plugins`, `containers`, `infrastructure`
...
- **Tags:** `mcp`, `config-sync`, `dsh-skill`, `agent-config`
...
- **⭐ Stars:** 25
- **Language:** TypeScript
- **Description:** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token ��本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context`, `audit`, `dsh-plugin`
- **Why use it:** Audits context injection tokens; detects duplicates and conflicts.
...
- **Why use it:** Auto-upgrades DSH plugins to match new DSH versions seamlessly.
...
- **Tags:** `agent-migration`, `dsh-plugin`
- **Why use it:** Migrate Claude Code setups into DSH seamlessly
...
- **Why use it:** Real-time token usage and cost tracking dashboard
...
- **Tags:** `utility`, `plugin-management`, `compatibility`
- **Why use it:** Plugin conflict resolver, diagnoses and fixes version compatibility issues
...
- **Tags:** `mascot`, `ui`, `pixel-art`, `themes`
- **Why use it:** Community gallery of animated mascots enhancing the coding agent experience
...
- **Why use it:** Whale Girl themed skins series for DeepSeek Harness UI customization.
...
- **Tags:** `theme`, `ui`
- **Why use it:** Frosted glass theme with full customization, no source changes needed.
...
- **Tags:** `theme`, `chrome-extension`
- **Why use it:** Stunning WebGPU ocean-themed skin with Three.js visuals
...
- **Tags:** `theme`, `skin`, `palette`, `opencode`
- **Why use it:** 34 classic opencode themes (TokyoNight, Dracula, etc.) one-click swap.
...
- **Why use it:** Beginner-friendly harness engineering guide from scratch
...
- **Why use it:** Curated plugin directory, essential starting point for DSH exploration
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day content and generates citable reports.
...
- **Tags:** `deepseek-harness`, `ecosystem-radar`, `plugin-registry`, `dsh-plugin`
- **Why use it:** Auto-discovers 15900+ plugins with k8s-level validated measurements
...
- **Tags:** `awesome-list`, `deepseek-harness`, `plugin-ecosystem`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `mcp`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `bilingual`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `knowledge-base`, `directory`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, MLOps & more.
...
- **Why use it:** Daily-curated plugin directory with rankings, tags, and usage guides.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Essential guide for learning DSH principles and plugin ecosystem
...
- **Why use it:** Ultimate DSH guide with curated resources and plugins
...
- **Why use it:** Comprehensive curated list covering plugins, MCP servers and UIs
...
- **Tags:** `plugin-directory`, `marketplace`
- **Why use it:** Massive plugin marketplace with 11,000+ searchable entries
...
- **Why use it:** Automates plugin search, installation and verification in DSH
...
- **⭐ Stars:** 159
- **Language:** Python
- **Description:** Academic Paper Search：���文科研用户的 Codex / Claude Code / DeepSeek Harness Skill + MCP；跨 CrossRef、PubMed、arXiv、OpenAlex、Europe PMC 检索去重，支持 MeSH、引用核验、引文图谱、试验检索与审计导出。
- **Tags:** `academic-search`, `arxiv`, `pubmed`, `mcp`, `citation`
- **Why use it:** Cross-database academic search with citation verification and graph analysis.
...
- **Tags:** `research`, `latex`, `arxiv`, `gpu-cluster`, `experiment-tracking`
- **Why use it:** All-in-one research workbench: LaTeX editing, arXiv management, GPU SSH orchestration.
...
- **Tags:** `research`, `agent-skills`, `marketing`
- **Why use it:** 88 agent skills covering deep research, social intel, and marketing workflows
...
- **Tags:** `api`, `research`, `chinese-api`
- **Why use it:** Search 65,600+ Chinese API docs across 20 platforms directly in your agent
...
- **Why use it:** Patent infringement analysis agent skill producing competitive analysis reports
...
- **Why use it:** Industry research skill pack with policy tracking and chain mapping.
...
- **Tags:** `kline`, `finance`, `analysis`, `dsh-plugin`
...
- **Why use it:** Comprehensive curated plugin directory for DSH ecosystem discovery
...
- **Why use it:** Evidence-led curated list with permission-aware installation guidance
...
- **Why use it:** 2026 updated curated list with quality checks for plugin selection
...
- **Tags:** `awesome-list`, `stock`, `finance`, `quant`
- **Why use it:** Bilingual curated stock/finance plugin directory, 24 verified entries
...
- **Why use it:** Star-ranked verified community plugins directory for DSH
...
- **Why use it:** Plugin product manual and navigation: scene-based selection with risk info
...
- **Tags:** `plugin-portal`, `static-site`, `discovery`
- **Why use it:** Zero-dependency static portal for discovering and filtering 227+ DSH plugins
...
- **Why use it:** Full inventory of 1000+ DSH tools ranked by stars from GitHub topic
...
- **Tags:** `dsh-plugins`, `dsh-bundle`, `dsh-ecosystem`
- **Why use it:** Curated plugin directory for DSH ecosystem
...
- **Why use it:** Plugin radar with 2Origin lab evidence tracking
...
- **Why use it:** Bilingual curated plugin directory with reviews
...
- **Why use it:** Plugin search and discoverability from inside DSH agents
...
- **Tags:** `ai-agents`, `coding-agents`, `mcp`, `awesome-list`
- **Why use it:** AI-curated hourly updated 190+ plugin list across 12 categories
...
- **Why use it:** Moved to new repository — legacy plugin directory
...
- **Tags:** `awesome-dsh-plugin`, `curated-list`
- **Why use it:** Auto-updating YAML-based bilingual plugin list with Vercel deployment
...
- **Tags:** `agent-harness`, `coding-agents`, `curated-list`, `ui`, `skills`
- **Why use it:** Curated DSH plugins covering models, tools, sandboxes, UI, and skills
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`, `plugins`
- **Why use it:** DSH plugin collection and directory
...
- **Why use it:** Curated industry plugin directory for DSH ecosystem discovery
...
- **Tags:** `armor-breaking`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Specialized armor-breaking plugin for DeepSeek content generation
...
- **Why use it:** Plugin marketplace resource for DeepSeek Harness ecosystem
...
- **Why use it:** Official auto-generated list of DeepSeek Harness Cordis plugins by cordis.run.
...
- **Why use it:** Curated plugin ecosystem list for DSH — essential discovery resource
...
- **Why use it:** Community-maintained auto-synced plugin catalog with 4-hour refresh
...
- **Tags:** `awesome-list`, `dsh-plugins`, `deepseek-harness`
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Community-cataloged DSH plugins directory
...
- **Why use it:** Spam-filtered open-data DSH plugin registry
...
- **Tags:** `marketplace`, `plugin-market`, `dsh-plugin-bundle`

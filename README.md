...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 840,064 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 17:26:14 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,478 | Core plugin framework enabling everything-is-a-plu |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,676 | Local-first design plugin turning coding agents in |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,994 | Original agent meta-harness for deploying multi-pl |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 21 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 13 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 30 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 1 plugins
- [Visual & Design](#visual-&-design) — 10 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 9 plugins
- [Communication & Social](#communication-&-social) — 1 plugins
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 26 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 24 plugins
- [Other](#other) — 28 plugins
...
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (13)
- [Agent Skills & Workflows](agent-skills-workflows) (30)
...
- [Utilities & Infrastructure](utilities-infrastructure) (26)
- [Themes & Skins](themes-skins) (6)
- [Research & Analysis](research-analysis) (24)
- [Other](other) (28)
---
...
- **Why use it:** Core plugin framework enabling everything-is-a-plugin architecture for AI agents.
...
- **Tags:** `multi-agent`, `skills`, `mcp`
- **Why use it:** Super AI assistant with multi-model, multi-channel support and self-evolving memory.
...
- **Why use it:** DeepSeek-native terminal coding agent optimized for prefix-cache stability.
...
- **Why use it:** Best beginner tutorial for harness engineering from scratch
...
- **Why use it:** One-click model switch across major AI coding tools including DeepSeek Harness.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking, rollback, and real-time TPS.
...
- **Tags:** `coding-agent`, `rust`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop app for coding agents.
...
- **Tags:** `code-review`, `static-analysis`, `dsh-plugin`
- **Why use it:** AI code review grounded in 12 classic engineering books with severity labels and 6 modes.
...
- **Why use it:** Curated plugin radar scanning 9000+ candidates with real installation path testing.
...
- **Why use it:** Architecture-aware coding agent with drift checking.
...
- **Why use it:** Native macOS coding agent built by DeepSeek team.
...
- **Tags:** `agent`, `coding-agent`, `dsh-plugin`
- **Why use it:** Teams up Claude Code, Codex, Grok, Kimi and DSH into one collaborative workflow
...
- **Tags:** `compatibility`, `migration`, `pi-agent`, `bridge`
- **Why use it:** Runs Pi extensions as native DSH plugins via compatibility layer bridge.
...
- **Tags:** `codex`, `sync`, `mcp`, `deepseek-harness`
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with auto MCP mirroring
...
- **Why use it:** Portable agent skill for DSH plugin development and auditing.
...
- **Tags:** `plugin-dev`, `best-practices`, `documentation`
- **Why use it:** Essential dev practices archive covering cordis, tsconfig, and testing.
...
- **Why use it:** Scaffold and test DSH plugins entirely within the harness.
...
- **Tags:** `agent-tools`, `pre-flight-check`
...
- **Tags:** `design`, `desktop-app`, `figma-alternative`
- **Why use it:** Local-first design plugin turning coding agents into design tools.
...
- **Tags:** `workspace`, `orchestration`, `multi-device`
- **Why use it:** Unified agent workspace with board tracking across all devices
...
- **Tags:** `web-ui`, `themes`, `skin`
- **Why use it:** Web GUI, skins, WebGL-optimized themes, and marketplace integration
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight 5MB Tauri desktop app, zero setup required.
...
- **Tags:** `widget`, `floating-widget`
- **Why use it:** Cute whale widget monitoring DeepSeek account balance.
...
- **Tags:** `desktop`, `electron`
- **Why use it:** Local-first desktop workspace for DSH with multi-feature support.
...
- **Tags:** `desktop-app`, `agent`, `privacy`, `dsh-plugin`
- **Why use it:** Local-first multi-model desktop agent app, privacy-focused alternative
...
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with plugin suite
...
- **Tags:** `ui`, `canvas`, `workspace`, `conversation`
- **Why use it:** Canvas-based non-linear conversation workspace with branching support.
...
- **Why use it:** Full-featured Windows desktop GUI with SSH, skills, and remote access.
...
- **Tags:** `marketplace`, `plugin-market`, `javascript`
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin marketplace in DSH Web GUI
...
- **Tags:** `task-management`, `taskboard`, `agent`
- **Why use it:** Native SQLite-backed taskboard with Agent claim/review, no iframe or second runtime
...
- **Why use it:** Community plugin market for DSH Web GUI: browse awesome-dsh-plugin.com and one-click install
...
- **Why use it:** Persistent status bar showing provider, model, balance, and pricing.
...
- **Tags:** `hud`, `status`, `ui`
- **Why use it:** Floating HUD panel showing git status, MCP servers, and token usage
...
- **Why use it:** Tauri 2 desktop app unifying DB, SSH, Docker panels with AI assistant
...
- **Why use it:** Electron desktop shell integrating DSH web service with plugins
...
- **Why use it:** LLM knowledge platform turning documents into queryable RAG and self-maintaining wiki.
...
- **Why use it:** Portable local-first memory layer with RAG across all apps
...
- **Why use it:** Extends AI memory capacity for long-running sessions.
...
- **Tags:** `context`, `dsh-plugin`
- **Why use it:** Context dashboard and management for DeepSeek Harness.
...
- **Why use it:** Comprehensive AI knowledge base covering agents, MCP, RAG and learning paths
...
- **Tags:** `notes`, `smartisan`, `docker`, `private`
- **Why use it:** Smartisan-style notes app with Docker deployment and WeChat export support.
...
- **Why use it:** Durable, inspectable long-term agent memory with recall tools and settings page
...
- **Tags:** `embeddings`, `semantic-search`, `reranking`, `vector-search`
- **Why use it:** Transform scattered SKILL.md files into curated retrieval-ready corpora with evaluation
...
- **Why use it:** Cross-platform session memory for agent continuity and handoff
...
- **Tags:** `memory`, `powercontext`, `recall`
- **Why use it:** Connects to PowerContext server for persistent memory and skill recall
...
- **Why use it:** Bridges Claude Code memory and skills into DeepSeek Harness seamlessly
...
- **Why use it:** Original agent meta-harness for deploying multi-player swarms and workflows.
...
- **⭐ Stars:** 23,854
- **Language:** Python
- **Description:** Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill / colleague-skill（原同事 Skill）.
- **Tags:** `agent-skills`, `skill-generator`, `knowledge-distillation`
...
- **⭐ Stars:** 12,594
- **Language:** JavaScript
- **Description:** Prompt as Code | GPT-Image2 工业级提示词引擎与模板库，470+ 个案例逆向工程，20+ 套工业级模板，并���炼出Skills，持续更新中
- **Tags:** `image-generation`, `skills`, `prompts`
- **Why use it:** 470+ image prompts with ready-to-use Skills and workflows
...
- **Tags:** `agent-os`, `evaluation`, `loop-engineering`
- **Why use it:** Self-improving Agent OS with automated grading and loop engineering
...
- **Why use it:** Enterprise multi-engine workbench with visual editor for agent teams
...
- **Why use it:** Vision bridge plugin — converts images to structured JSON for text-only agents
...
- **Why use it:** Intelligently routes and orchestrates harness workflows and skills automatically.
...
- **Tags:** `task-manager`, `agentic-workflow`
- **Why use it:** Self-hosted task manager with human-in-the-loop control.
...
- **Tags:** `skills`, `agent`, `workflow`, `reusable`
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot and UI analysis.
...
- **Why use it:** Automatically finds, installs, and verifies GitHub plugins for DSH.
...
- **Tags:** `creative-writing`, `novel`, `drama`, `skill`
- **Why use it:** Novel writing and short-drama production powered by Oh Story skills.
...
- **Why use it:** Specialized agent skills for AI infra: write, optimize, and debug high-performance systems
...
- **Why use it:** Superpowers skill port to Reasonix coding harness for enhanced agent capabilities
...
- **Tags:** `superpowers`, `skills`, `tdd`
- **Why use it:** Superpowers skills adapted for DSH: TDD, debugging, planning and collaboration
...
- **Tags:** `code-simplification`, `dsh-inspired`, `codex-skill`
- **Why use it:** Code simplification skill adapted from DSH for Codex workflows
...
- **Tags:** `skill-picker`, `dsh-plugin`, `workflow`
- **Why use it:** WorkBuddy-style skill picker for quick DSH skill insertion
...
- **Tags:** `chinese-traditional-wisdom`, `bazi`, `fengshui`, `dashboard`
- **Why use it:** Unique Bazi/Fengshui/IChing traditional wisdom skill with dashboard
...
- **Tags:** `multi-agent`, `team-collaboration`, `shared-workspace`
...
- **Tags:** `swift-cycle`, `governance`, `version-pinned`
- **Why use it:** Swift Cycle governance skill, user-invoked with version pinning
...
- **Tags:** `gongwen`, `docx`, `agent-skills`
- **Why use it:** Complete Chinese official document workflow following national GB standards.
...
- **Tags:** `engineering`, `skill`, `best-practices`
- **Why use it:** Portable skill distilling engineering discipline and fact-finding practices.
...
- **Tags:** `canvas`, `agent-skills`, `agentic-workflow`
- **Why use it:** Infinite canvas with creative skills for agentic workflows.
...
- **Tags:** `record-replay`, `skills`, `macos`
- **Why use it:** Record macOS workflows and auto-convert into reusable agent skills
...
- **Why use it:** Math modeling toolkit with 17 handcrafted skill cards for DSH
...
- **Why use it:** Virtual product team preset for end-to-end product workflow simulation
...
- **Tags:** `diagram`, `architecture`, `mermaid-alternative`
- **Why use it:** Agent skill generating beautiful architecture, sequence, and data-flow diagrams.
...
- **Why use it:** AI-native vector design tool with concurrent Agent Teams, design-as-code
...
- **Why use it:** End-to-end automated generation of Vox-style paper-collage explainer and ad videos.
...
- **Why use it:** Vision toolkit enabling text-only LLMs to see and interact.
...
- **Tags:** `vision`, `dsh-plugin`
- **Why use it:** Native DSH vision toolkit with OCR and UI restoration.
...
- **Why use it:** AI-powered design system with templates, PPT and visual editor built-in
...
- **Tags:** `image-generation`, `visual`, `seedream`, `gemini`
- **Why use it:** Generate AI images directly within DeepSeek Harness chat conversations.
...
- **Tags:** `deepseek-harness`, `design`, `ui-design`, `ppt`
- **Why use it:** Preview, inspect, and edit real OpenPencil design documents directly in conversation
...
- **Tags:** `design`, `vibe-coding`, `ui-styles`, `web-design`
- **Why use it:** 6 design style presets to keep vibe-coded sites away from generic AI look
...
- **⭐ Stars:** 2,997
- **Language:** Python
- **Description:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（���持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `bilibili`, `ai-agent`, `dsh-plugin`
- **Why use it:** Local-first AI agent auto-discovers content from Bilibili, YouTube, Reddit and more.
...
- **Tags:** `browser-automation`, `cli`, `dsh-plugin`
- **Why use it:** Let AI agents use your real logged-in browser for cross-platform web automation.
...
- **Why use it:** Browser extension turning AI conversations into workflows.
...
- **Why use it:** Chrome sidebar lets DSH control your browser directly without vision
...
- **Tags:** `web-search`, `agent-skills`, `dsh-plugin`
- **Why use it:** Strongest free web search bridge — no signup, works with all models
...
- **Tags:** `ios`, `automation`, `mcp`, `dsh-plugin`
- **Why use it:** Live iOS Simulator and USB iPhone control inside DSH with 22 agent tools
...
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet link support.
...
- **Why use it:** Tabbit Browser integration for DSH: Playwright-powered browser automation and use
...
- **Why use it:** Privacy-first resume builder with full customization and self-hosting support.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with obsidian integration.
...
- **Tags:** `low-code`, `crm`, `workflows`
- **Why use it:** AI-powered low-code platform for building CRM, ERP, and business systems fast.
...
- **Tags:** `routing`, `infrastructure`, `cordis`
- **Why use it:** Task-aware reasoning-mode router — essential routing infrastructure
...
- **Tags:** `vfs`, `sandbox`, `infrastructure`
- **Why use it:** Unified virtual filesystem enabling cross-platform agent file access
...
- **Tags:** `dsh-plugin`, `web-sim`
- **Why use it:** Zero-dependency web toy simulation with real audio sampling, mobile-first design.
...
- **Tags:** `oauth`, `llm`, `dsh-plugin`, `utility`
- **Why use it:** Use ChatGPT/Claude/Grok sub accounts as DSH LLM providers via OAuth
...
- **Tags:** `cost-tracking`, `utility`, `tokens`, `budget`
- **Why use it:** Track session and daily costs, budget management, token usage history.
...
- **Why use it:** Crash-rescue with undo config/plugin changes, secret-safe snapshots, and one-click SAFE MODE
...
- **Tags:** `context-migration`, `preset-migration`, `session-migration`
- **Why use it:** Cross-preset session migration preserving state, source-model intent, and unresolved images
...
- **Tags:** `context-audit`, `token-optimization`, `ui`
- **Why use it:** Audits context injection token costs and detects duplicates/conflicts
...
- **Tags:** `skills-manager`, `dsh-plugin`, `management`
- **Why use it:** Dedicated skills management plugin for DSH ecosystem
...
- **Tags:** `mcp-manager`, `skills-manager`, `web-gui`
...
- **Tags:** `package-manager`, `agent-assets`, `multi-tool`
- **Why use it:** Package manager for AI agent assets: 42 skills, 5 CLIs, 1 plugin bundled
...
- **Tags:** `config`, `backup`, `migration`, `mcp`
- **Why use it:** Backup, restore, and sync your entire DSH configuration ecosystem.
...
- **Why use it:** Public plugin directory and ecosystem discovery resource.
...
- **Why use it:** Curated plugin list for DSH ecosystem navigation.
...
- **Tags:** `mcp`, `skill`, `hot-reload`
- **Why use it:** Paste JSON to connect MCP, auto-import .skill files, zero-config hot reload
...
- **Tags:** `token`, `cost`, `visualization`
- **Why use it:** Real-time token usage charts and cost estimates directly in browser
...
- **Tags:** `plugin-doctor`, `conflict-resolution`
- **Why use it:** Detects and resolves plugin and version conflicts automatically
...
- **Why use it:** Search npm and curated lists directly from within DSH agents
...
- **Tags:** `oauth`, `chatgpt`
- **Why use it:** OAuth binding for ChatGPT subscription models inside DSH
...
- **Tags:** `registry`, `plugin-manager`, `discovery`
- **Why use it:** Unified registry merging multiple sources for deduplicated plugin discovery.
...
- **Tags:** `publisher`, `plugin`, `cli`
- **Why use it:** One-click plugin publisher validating completeness and generating PRs.
...
- **Tags:** `pets`, `mascot`, `skins`
- **Why use it:** Public animated pet gallery — cute skins for all major agent CLIs
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness desktop customization.
...
- **Why use it:** Frosted glass theme with full customization, zero source code changes
...
- **Tags:** `theme`, `ocean-skin`, `threejs`, `webgpu`
- **Why use it:** Beautiful WebGPU ocean-themed skin for DeepSeek Harness UI.
...
- **Why use it:** One-click apply 34 opencode themes — persists across restarts.
...
- **Why use it:** Personalize DSH Web background with custom images or preset atmospheres
...
- **Tags:** `ai-guide`, `tutorial`, `vibe-coding`
- **Why use it:** Comprehensive AI resource hub with tutorials covering DeepSeek, GPT, Gemini, and more.
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates evidence-backed research reports.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `reference`
- **Why use it:** Curated bilingual plugin & tool encyclopedia, essential DSH reference
...
- **Why use it:** Daily verified plugin directory with fake-fixer blacklist and match advice
...
- **Tags:** `learning`, `dsh-plugin`, `marketplace`
- **Why use it:** Learn DSH internals, browse plugin marketplace and discover best practices
...
- **Tags:** `awesome-list`, `quickstart`, `dsh-plugin`
- **Why use it:** Ultimate DSH quickstart guide with curated plugins and practical toolkits
...
- **Why use it:** Multi-market K-line analysis with technical indicators and fundamentals.
...
- **Tags:** `stock`, `finance`, `quant`, `research`
- **Why use it:** 24 verified stock/finance/quant plugins for DeepSeek Harness
...
- **Why use it:** Curated 2026 plugin list with quality checks
...
- **Why use it:** Plugin manual and navigation guide with installation and risk info
...
- **Why use it:** Star-ranked verified community plugins for DSH
...
- **Why use it:** Evidence-backed plugin radar with 2Origin plugin lab
...
- **Why use it:** Zero-dependency static portal for discovering and filtering plugins
...
- **Why use it:** Comprehensive AI-curated DSH plugin list with 190+ entries updated hourly.
...
- **Why use it:** Curated DSH plugin directory covering ecosystem and analytics.
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Simple DSH plugin collection for quick reference.
...
- **Tags:** `awesome-list`, `coding-agents`, `ui`
- **Why use it:** Broad curated list covering models, tools, UI, and agent loops.
...
- **Why use it:** Industry-specific DSH plugins for computing, finance, legal and more.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Full inventory of 1000+ DSH tools sorted by stars on GitHub.
...
- **Why use it:** Curated plugin list — essential directory for DSH ecosystem
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, and MCP servers.
...
- **Why use it:** Plugin marketplace with 3,100+ plugins, search, and free public API.
...
- **Tags:** `marketplace`, `bundle`, `plugin`
- **Why use it:** Plugin marketplace bundle for DeepSeek Harness ecosystem.
...
- **Why use it:** Curated awesome list of useful DSH plugins and extensions for community discovery
...
- **Tags:** `awesome`, `awesome-list`, `agents`
- **Why use it:** Meticulously curated list of DSH plugins covering productivity and functionality tools
...
- **Why use it:** Community-curated catalog covering all DeepSeek Harness plugin categories
...
- **Why use it:** Evidence-led curated directory with verified plugin loading guidance
...
- **Tags:** `registry`, `open-data`, `spam-filtered`
...
- **Why use it:** Redirect to new repo location; no longer actively maintained

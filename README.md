...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 849,495 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 09:04:15 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 190,019 | The foundational DSH platform enabling all plugin- |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,903 | Open-source design system generator with local-fir |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,200 | Multi-agent swarm orchestrator with autonomous wor |
...
- **Why use it:** The foundational DSH platform enabling all plugin-based AI agent workflows.
...
- **Why use it:** Self-evolving multi-model agent harness with memory and tool ecosystem.
...
- **Tags:** `harness-engineering`, `dsh-plugin`, `llm`
- **Why use it:** Best beginner guide to learn DSH harness engineering from scratch
...
- **Why use it:** Self-improving agent OS with automatic grading and feedback loop
...
- **Tags:** `multi-agent-workspace`, `agent-skills`, `mcp`
...
- **Why use it:** First vision plugin for DeepSeek Harness with OCR and multimodal support
...
- **Tags:** `architecture`, `coding-agents`
- **Why use it:** Architecture-aware coding with drift detection and verification
...
- **Why use it:** Unifies multiple coding agents into a collaborative team for task dispatch
...
- **Tags:** `mcp`, `oauth`, `llm-provider`
- **Why use it:** Use existing ChatGPT/Claude/Grok subscriptions as DSH LLM providers via OAuth
...
- **Tags:** `orchestration`, `subagent`
- **Why use it:** Dispatch work to DSH agents from Claude Code/Codex as subagents
...
- **Tags:** `agent-skill`, `dsh-plugin`, `developer-tools`, `skill`
- **Why use it:** Meta skill for developing DSH plugins following official standards
...
- **Tags:** `agent-skills`, `spec-programming`, `developer-tools`, `vibe-coding`
- **Why use it:** Repository-native spec-driven development skill with DSH engineering patterns
...
- **Tags:** `deepseek-harness`, `ocr`, `image-reading`, `vision`
- **Why use it:** Pixel-to-text OCR for text-only models with 34-image trained methodology
...
- **Tags:** `plugin-dev`, `cordis`, `tools`
- **Why use it:** Portable skill for developing and auditing DSH plugins with Cordis support.
...
- **Why use it:** Curated dev practices and pitfalls archive for DSH plugin development.
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins entirely inside the harness.
...
- **Why use it:** Built-in GUI to manage MCP services, skills, and plugins with hot reload
...
- **Why use it:** OAuth integration to use ChatGPT Plus models inside DSH directly.
...
- **Tags:** `deepseek-harness-plugins`, `ui`, `skills`
- **Why use it:** Curated installable plugins for models, tools, sandboxes, UI, and agent loops.
...
- **Why use it:** Official auto-generated directory of DeepSeek Harness Cordis plugins.
...
- **Why use it:** Modern desktop client built exclusively for the DSH plugin ecosystem.
...
- **Tags:** `agent-orchestration`, `agent-skills`, `no-code`
...
- **Why use it:** Claude Code style TUI with whale toolbar and streaming thinking
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight Tauri desktop with zero env setup required
...
- **Tags:** `widget`, `ui`
- **Why use it:** Cute floating whale widget showing account balance
...
- **Tags:** `desktop`, `electron`
- **Why use it:** Local-first desktop workspace with Office integration
...
- **Why use it:** Renders interactive UI components like charts and forms inline in responses
...
- **Tags:** `task-management`, `web-ui`
- **Why use it:** SQLite-backed native taskboard with agent claim/review in Web UI
...
- **Tags:** `marketplace`, `web-gui`
- **Why use it:** Browse and one-click install community plugins from awesome-dsh-plugin.com
...
- **Tags:** `console`, `dsh-plugin`, `ui`, `plugin-management`
- **Why use it:** Plugin management console via browser panel with dev skill guide
...
- **Tags:** `deepseek-harness`, `desktop-app`, `electron`, `typescript`
...
- **Why use it:** Cross-platform desktop app integrating DB, SSH, Docker with AI
...
- **Why use it:** Electron desktop wrapper integrating multiple DSH plugins natively.
...
- **Why use it:** Turn documents into queryable RAG knowledge base with autonomous maintenance.
...
- **Why use it:** Portable, user-owned memory layer with Markdown-native persistence
...
- **Tags:** `long-term-memory`, `rag`, `skills`
...
- **Why use it:** Agent memory management kit with refine capabilities
...
- **Why use it:** Turns scattered SKILL.md into retrieval-ready corpora with evaluation
...
- **Tags:** `knowledge-base`, `plugin-development`, `agent-skill`
- **Why use it:** Official DSH docs archive as on-demand agent knowledge base
...
- **Why use it:** Distill expert thinking patterns into reusable cross-agent skills.
...
- **Tags:** `agent-skills`, `workflow`, `multi-agent`
- **Why use it:** Intelligent workflow orchestration for agent skills routing
...
- **Tags:** `workflow`, `browser-extension`
- **Why use it:** Turns AI conversations into organized reusable workflows
...
- **Why use it:** Enables multi-agent teamwork and collaboration
...
- **Tags:** `vision`, `plugin`
- **Why use it:** DSH-native vision toolkit with one-line install
...
- **Why use it:** Turn AI experience into repeatable execution workflows
...
- **Why use it:** Adds multimodal vision to text-only LLM agents for UI analysis
...
- **Why use it:** Creative writing skills for novels and short drama production
...
- **Why use it:** Skill to auto-search, install and verify GitHub DSH plugins
...
- **Why use it:** Specialized skills for AI infra dev with optimization and debugging
...
- **Tags:** `session-migration`, `context`
- **Why use it:** Cross-preset session migration preserving state and source-model intent
...
- **Why use it:** 85 SKILL.md for reverse engineering, pentesting, and security research
...
- **Why use it:** AI coding mentor that generates chapters, reviews code, and auto-grades
...
- **Tags:** `agent-skills`, `deep-research`, `social-listening`, `market-research`
- **Why use it:** 88 agent skills for research, social intelligence, marketing, business
...
- **Tags:** `ai-agent`, `chinese-wisdom`, `bazi`, `fengshui`
- **Why use it:** Chinese traditional wisdom AI agent covering Bazi, Fengshui, IChing and more
...
- **Tags:** `multi-agent`, `team-collaboration`, `workflow`
...
- **Why use it:** Free image reading and generation skills for DSH vision workflows
...
- **Tags:** `agent-framework`, `package-manager`, `skills`, `cli`
- **Why use it:** Package manager bundling 42 skills, 5 CLIs for AI agent engineering
...
- **Why use it:** Version-pinned Swift Cycle governance skill for structured project management.
...
- **Why use it:** Full Chinese official document processing pipeline following GB/T 9704 standard.
...
- **Why use it:** Portable agent skill distilling engineering discipline and decision practices.
...
- **Why use it:** Provides Godot 4.x full-stack game dev skills at runtime
...
- **Tags:** `skills`, `gamification`, `workflow`
- **Why use it:** Game-like mission system to organize and track skill progress
...
- **Why use it:** Virtual PM/Eng/QA team preset for user-led product workflows.
...
- **Tags:** `agent-tool`, `workflow`, `plugin-recommendation`
- **Why use it:** Pre-flight plugin check injects Top-K relevant plugins per task.
...
- **Why use it:** Bidirectional bridge syncing Codex and DSH chat with MCP mirroring
...
- **Tags:** `mcp`, `skills`, `gui`
- **Why use it:** Centralized skills and MCP server management directly in the DSH web UI.
...
- **Tags:** `mcp`, `skills`, `menu`
- **Why use it:** Unified menu to control MCP tool exposure level and execution mode.
...
- **Why use it:** Hot-reload MCP config without restart; auto-recognizes skill files
...
- **Tags:** `ai-design`, `design-systems`, `ui-generator`
- **Why use it:** Open-source design system generator with local-first desktop experience.
...
- **Why use it:** Generate beautiful architecture, workflow, and sequence diagrams via code.
...
- **Why use it:** 530+ reverse-engineered image prompts with industrial templates
...
- **Tags:** `ui-design`, `openpencil`, `preview`
- **Why use it:** Preview and edit OpenPencil UI designs directly in chat
...
- **Why use it:** 6 design style presets to prevent generic AI-generated website aesthetics
...
- **Why use it:** AI video/image/audio generation via DirectorX with configurable model tools.
...
- **Tags:** `canvas`, `creative`, `visual`
- **Why use it:** Infinite canvas with creative skills for visual brainstorming and design.
...
- **Why use it:** Cross-browser AI enhancement suite with universal prompt management.
...
- **Tags:** `dsh-web`, `dsh-plugin`
- **Why use it:** Web-based plugin marketplace aggregator for DSH ecosystem
...
- **Tags:** `bilibili`, `cross-platform`, `privacy-first`
- **Why use it:** Cross-platform content discovery agent with privacy-first approach
...
- **Why use it:** Enables agents to use real logged-in browsers safely
...
- **Tags:** `ios`, `mobile`, `ui-automation`
- **Why use it:** Integrate live iOS Simulator and real iPhone directly into DSH conversations
...
- **Why use it:** Build and interact with Android emulators/devices inside conversations
...
- **Why use it:** Runtime injector + task-aware router for optimized agent routing
...
- **Tags:** `vfs`, `virtual-filesystem`, `mcp`
- **Why use it:** Unified virtual filesystem abstraction for cross-agent file access
...
- **Tags:** `claude-code`, `deepseek`, `model-switch`
- **Why use it:** One-click model switch across multiple coding agents
...
- **Tags:** `marketplace`, `plugins`, `utility`
...
- **Tags:** `awesome-list`, `registry`, `discovery`
- **Why use it:** Plugin radar with auto-discovery and curated top 50 rankings
...
- **Why use it:** Context dashboard and statistics management tool
...
- **Tags:** `discovery`, `curation`, `utility`
- **Why use it:** Daily-verified plugin discovery tool with transparent curation criteria
...
- **Why use it:** Free no-signup web search bridge for any model without native web access
...
- **Why use it:** Track session and daily costs with budget and quota management
...
- **Why use it:** Open-source Smartisan-style notes with Docker and plugin support
...
- **Tags:** `crash-recovery`, `rollback`
- **Why use it:** Crash-rescue with undo, rollback, snapshots and one-click safe mode
...
- **Tags:** `dsh-plugin`, `agent-skill`, `plugin-management`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `container`, `desktop`
...
- **Tags:** `dsh-plugin`, `skill-picker`, `ui-tool`
- **Why use it:** WorkBuddy-style skill picker for quick DSH skill selection
...
- **Tags:** `context`, `tool`, `ui`, `audit`
- **Why use it:** Audits context token costs, detects duplicates and conflicts with Web UI
...
- **Why use it:** Centralized DSH skills management plugin for easy organization
...
- **Tags:** `config-manager`, `backup`, `migration`, `webdav`
- **Why use it:** Full DSH config backup, restore, migration via WebDAV sync
...
- **Tags:** `directory`, `curated`, `verified`
- **Why use it:** Curated plugin directory with verified loads and permission guidance
...
- **Why use it:** Open-data registry with spam filtering for plugins and skills
...
- **Why use it:** Curated vertical list of 24 verified stock/finance/quant plugins
...
- **Tags:** `utility`, `debugging`, `compatibility`
...
- **Why use it:** Search npm + awesome lists for plugin discovery inside DSH agents.
...
- **Tags:** `dsh-plugin`, `dsh-plugin-verify`, `dsh-repository-plugin`
- **Why use it:** DSH plugin bundle with verification tools for ecosystem management.
...
- **Why use it:** Automated daily-crawled plugin directory via GitHub Actions, bilingual.
...
- **Why use it:** Merges multiple plugin sources into one deduplicated registry for efficient discovery.
...
- **Why use it:** CLI tool for discovering, installing, updating plugins with multi-source search and audit.
...
- **Why use it:** Gallery of animated pet mascots to personalize your agent UI
...
- **Why use it:** Whale girl themed skins for DeepSeek Harness
...
- **Why use it:** Highly customizable glass-morphism theme without modifying source code
...
- **Why use it:** 34 opencode classic themes one-click applied, persistence across restarts.
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH ��置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `background`, `ui`
- **Why use it:** Custom backgrounds with presets, fine-tuning controls, auto-save.
...
- **Tags:** `ai-tutorial`, `vibe-coding`, `prompt-collection`
- **Why use it:** Comprehensive AI resource library with tutorials and prompt collections.
...
- **Why use it:** Searches 8 major Chinese platforms for recent 30-day content research
...
- **Tags:** `knowledge-base`, `ai-pedia`, `resources`
...
- **Why use it:** Learn DSH internals, explore plugin marketplace and discover best practices
...
- **Why use it:** Ultimate bilingual DSH guide with quickstart, plugins and toolkit recommendations
...
- **Tags:** `ai-agents`, `api-documentation`, `chinese-api`, `dsh-plugin`
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms directly
...
- **Tags:** `agent-skills`, `legal-tech`, `visualization`, `diagram`
- **Why use it:** Visualize legal case timelines and litigation diagrams from documents
...
- **Why use it:** Math modeling enhancement suite with 17 skill cards for DSH
...
- **Tags:** `recommendation`, `awesome-list`, `ai-curated`
- **Why use it:** AI-curated hourly-updated plugin list across 12 categories, 190+.
...
- **Why use it:** Evidence-led bilingual curated directory of DSH plugins, reviewed at commits.
...
- **Why use it:** Curated evidence-aware shortlist of useful DSH plugins for targeted exploration.
...
- **Why use it:** 70+ verified DSH plugins organized by function for structured discovery.
...
- **Tags:** `industry`, `dsh-plugins`
- **Why use it:** Industry-specific DSH plugins across finance, law, HR, medical, and e-commerce.
...
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Comprehensive 1000+ plugin list sorted by stars for ecosystem overview.
...
- **Why use it:** Privacy-first open-source resume builder with full customization control.
...
- **Why use it:** Essential curated plugin directory for discovering DSH ecosystem
...
- **Tags:** `toy`, `simulation`, `no-dependency`
- **Why use it:** Web-based traditional toy simulation with real audio sampling
...
- **Tags:** `awesome-list`, `reference`, `bilingual`
- **Why use it:** Curated bilingual plugin and extension reference list for DSH ecosystem
...
- **Why use it:** Curated directory of DSH plugins, skills, and MCP servers
...
- **Why use it:** Large marketplace with 3,100+ searchable plugins and free API
...
- **Why use it:** Plugin marketplace hub for DeepSeek Harness ecosystem
...
- **Why use it:** Curated plugin directory and resource list for DSH ecosystem
...
- **Why use it:** Hand-picked collection of practical DSH plugins.
...
- **Tags:** `guide`, `navigation`, `awesome-list`
- **Why use it:** Plugin navigation guide with scene-based selection and risk info.
...
- **Tags:** `radar`, `awesome-list`, `research`
- **Why use it:** Evidence-backed plugin radar and 2Origin lab for DSH.
...
- **Why use it:** Original awesome list (now moved to new repo).
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple DSH plugin directory for basic discovery.

...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 876,136 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 16:24:44 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 197,535 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,710 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,455 | Multi-agent swarm meta-harness for autonomous work |
...
- **Why use it:** Multi-agent swarm meta-harness for autonomous workflow orchestration
...
- **Why use it:** Super AI assistant harness with memory, self-evolution, multi-model support
...
- **Tags:** `multi-agent-workspace`, `dsh-plugin`, `agent-collaboration`
- **Why use it:** Enterprise-grade local-first multi-agent workbench supporting multiple coding harnesses
...
- **Tags:** `coding-agent`, `agent-runtime`, `desktop`
...
- **Why use it:** Vision toolkit for text-only models: image Q&A, OCR, screenshot.
...
- **Why use it:** Dedicated armor-breaking plugin stabilizing DeepSeek prompts
...
- **Why use it:** Bridge Pi extensions to run as native DSH plugins seamlessly
...
- **Why use it:** Bidirectional bridge syncing chat, skills and MCP tools between OpenAI Codex and DSH.
...
- **Why use it:** Creates and validates DSH plugins easily
...
- **Why use it:** Manages skills and MCP in DSH Web UI
...
- **Tags:** `agent-skills`, `cordis`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Develops and audits DSH plugins
...
- **Why use it:** Essential plugin dev guide covering real-world pitfalls and solutions
...
- **Tags:** `migration`, `import`, `multi-agent`
- **Why use it:** Seamlessly migrate skills and config from Claude Code/Codex/OpenCode
...
- **Why use it:** Build and test DSH plugins entirely within the harness
...
- **Why use it:** Pre-flight plugin check for DSH agents — auto-injects top-K relevant plugins per task
...
- **Why use it:** Enables dsh agents to search and discover plugins directly
...
- **Why use it:** Modern desktop shell for DSH ecosystem where even the desktop is a plugin
...
- **Why use it:** Web UI plugin aggregator ecosystem for DeepSeek Harness with creative marketplace
...
- **Why use it:** Extensible sidebar with built-in file, terminal, and chat.
...
- **Why use it:** Claude Code-style TUI with whale theme and streaming UX.
...
- **Why use it:** Desktop companion with animated pets and coding-agent integrations.
...
- **Tags:** `ui`, `dsh-plugin`
- **Why use it:** Renders interactive UI components inline within assistant replies
...
- **Why use it:** Electron desktop console for multi-tab DSH and plugin management
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer with slash command insertion.
...
- **Tags:** `dsh-plugin`, `usage-tracking`, `web`
- **Why use it:** Shows model info and pricing in DSH
...
- **Tags:** `visualization`, `cost`, `dashboard`
- **Why use it:** Real-time token usage charts and cost estimates via web UI
...
- **Why use it:** All-in-one desktop with DB, SSH, Docker and AI assistant built in
...
- **Why use it:** Electron desktop wrapping DSH web with integrated sidebar and tools
...
- **Why use it:** Portable local-first memory layer with Markdown-native, cross-app agent memory
...
- **Tags:** `long-term-memory`, `rag`, `memory-management`, `dsh-plugin`
...
- **Why use it:** Essential memory management kit for agent RAG workflows.
...
- **Why use it:** Strongest free web search plugin bridging models without native access
...
- **Tags:** `knowledge`, `ai-pedia`, `resources`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, RAG, and more
...
- **Tags:** `agent-memory`, `skill-corpus`, `vector-search`, `rag`
...
- **Tags:** `knowledge-base`, `docs`, `plugin-dev`
- **Why use it:** On-demand plugin dev knowledge base with official docs archive and Cordis primer.
...
- **Tags:** `agent-evaluation`, `rag`, `llm`, `evaluation-framework`
- **Why use it:** Evidence-backed evaluation for AI workflows
...
- **Why use it:** Intelligent workflow orchestration and skill routing.
...
- **Why use it:** Transform AI conversations into reusable organized workflows.
...
- **Tags:** `agent`, `desktop`, `automation`
- **Why use it:** Local-first multi-model AI agent desktop with self-evolving skills
...
- **Why use it:** Powerful skill for novel writing and short-drama production
...
- **Tags:** `skill`, `math-modeling`, `automation`, `competition`
...
- **Why use it:** Turn experience into repeatable execution across agents
...
- **Why use it:** Add multimodal vision to text-only LLMs for UI analysis
...
- **Why use it:** Skill that finds, installs and verifies GitHub plugins
...
- **Tags:** `agent-skills`, `mentor`
- **Why use it:** AI coding agent transforms into mentor with step-by-step guidance
...
- **Tags:** `capability-manage`, `mcp`, `ui`
- **Why use it:** Centralized menu to control MCP tool exposure levels and execution modes in DSH.
...
- **Tags:** `chinese-wisdom`, `skill`, `domain-specific`
- **Why use it:** Comprehensive Bazi/Fengshui/IChing agent skill with local deterministic engine and dashboard.
...
- **Why use it:** Cross-platform agent continuity memory enabling Codex/Claude Code context recovery.
...
- **Tags:** `code-simplify`, `refactor`, `skill`
- **Why use it:** Adapted code simplification skill from DSH for Codex, automates refactoring suggestions.
...
- **Why use it:** Version-pinned Swift Cycle governance skill adapter with offline verification for DSH.
...
- **Tags:** `agent`, `ai`, `deepseek-harness`, `dsh`, `skills`
- **Why use it:** Game-like task progression system for agents
...
- **Tags:** `ai-docs`, `deepseek-harness`, `docx`, `gongwen`
- **Why use it:** Full workflow for Chinese government documents
...
- **Why use it:** Enables infinite canvas with creative AI skills in DSH
...
- **Tags:** `engineering`, `skills`, `methodology`
- **Why use it:** Portable agent skill encoding engineering discipline principles
...
- **Why use it:** First vision plugin enabling OCR and image-to-structured-JSON for text-only agents
...
- **Why use it:** Search 65,600+ Chinese platform API docs directly in DSH/Cursor
...
- **Why use it:** Hot-reload MCP config without restart, seamless skill management
...
- **Why use it:** Generates beautiful, verifiable architecture and sequence diagrams as self-contained HTML
...
- **Tags:** `vibedesign`, `ui`, `dsh-plugin`, `mcp`
...
- **Tags:** `video`, `generative-ai`, `motion-graphics`
- **Why use it:** End-to-end Vox-style paper-collage video generation skill.
...
- **Tags:** `design`, `visual`
- **Why use it:** AI design studio with editable templates, PPT generation and prototyping.
...
- **Why use it:** Generate images directly in DSH chats with AI models
...
- **Why use it:** Interactive K-line chart analysis with multi-market support and sidebar visualization.
...
- **Tags:** `deepseek-harness`, `design-skills`, `ui`, `vibe-coding`
- **Why use it:** Keeps AI sites away from generic look
...
- **Tags:** `agent-skills`, `deepseek-harness`, `image-generation`, `vision`
- **Why use it:** Free image reading and generation tools
...
- **Why use it:** AI video and image generation tools
...
- **Tags:** `browser-extension`, `chat-management`, `multi-browser`
- **Why use it:** Cross-browser AI enhancement suite with prompt management for any web UI
...
- **Why use it:** Cross-platform content discovery agent with privacy focus.
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** Group photo archive for DSH community
...
- **Why use it:** DingTalk IM integration turning chats into agent tools
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and major editors
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `cordis`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for DSH agents
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `llm-agent`
- **Why use it:** Two-phase preset providing minimal bootstrap then full standard tool alignment
...
- **Why use it:** Unified virtual filesystem abstraction for AI agents across multiple languages
...
- **Why use it:** One-click model switch across major AI coding tools.
...
- **Why use it:** Powerful context insight dashboard with statistics and management.
...
- **Tags:** `cost-tracking`, `token-usage`, `utils`
- **Why use it:** Track session and daily costs, budget and token usage
...
- **Why use it:** Plugin ecosystem console with browser panel and dev guide
...
- **Why use it:** Pixel-to-text OCR tool for text-only language models
...
- **Tags:** `plugin-dev`, `build-tool`
- **Why use it:** Essential scaffolding tool for building and packaging DSH plugins with slots and credential support.
...
- **Why use it:** Complete backup/restore/sync for DSH config, plugins, MCP servers and skills via WebDAV.
...
- **Tags:** `sandbox`, `containers`, `management`
- **Why use it:** Run multiple isolated DSH instances with embedded WebView UI and one-click plugin import.
...
- **Why use it:** Audits context injection and token costs in DSH
...
- **Tags:** `agent-framework`, `agent-skills`, `ai-agents`, `dsh`
- **Why use it:** Package manager for 42 skills and tools
...
- **Why use it:** Fast and elegant Neovim plugin manager for DevOps workflows
...
- **Why use it:** Animated pet gallery adding personality to Codex, Claude Code, and DSH terminals
...
- **Why use it:** Cute Whale Girl skin series for DSH customization.
...
- **⭐ Stars:** 386
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流���或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `deepseek-harness`
- **Why use it:** Glassmorphism theme with fully customizable frosted effects
...
- **Tags:** `color-scheme`, `dark-mode`, `theme`, `ui`
- **Why use it:** 34 opencode themes for DSH, one click
...
- **Tags:** `ui`, `theme`, `webui`
- **Why use it:** Customize DSH Web UI background with uploaded images or preset themes
...
- **Why use it:** Comprehensive AI resource compilation with vibe coding tutorials and knowledge encyclopedia
...
- **Why use it:** Ultimate guide with resources, plugins and toolkit for DSH
...
- **Tags:** `awesome-list`, `mcp`, `plugins`, `dsh`
- **Why use it:** Curated list of plugins, MCP servers, orchestrators and UIs
...
- **Why use it:** Plugin marketplace with 11000+ plugins, search and API
...
- **Why use it:** Search Zhihu via DSH platform
...
- **Why use it:** Verified, evidence-led directory with permission-aware installation guidance
...
- **Why use it:** Curated plugins, tools, skills & resources — everything is a plugin
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：���场景选插件，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin product manual and navigation: scenario-based plugin selection guide
...
- **Tags:** `portal`, `plugin-directory`, `web`
...
- **Tags:** `awesome-list`, `plugin-registry`
- **Why use it:** DSH plugin ecosystem overview and curated plugin list
...
- **Why use it:** Evidence-led bilingual curated DSH plugin directory
...
- **Why use it:** Auto-crawled daily DSH plugin catalog with bilingual support
...
- **Why use it:** Comprehensive 1000+ DSH plugin list sorted by stars
...
- **Tags:** `ai-agents`, `plugin-recommender`, `mcp`
...
- **Tags:** `curated-list`, `dsh-plugin`, `registry`
...
- **Why use it:** Evidence-aware short curated DSH plugin list
...
- **Tags:** `industry`, `awesome-list`, `vertical`
- **Why use it:** Industry-specific DSH plugins across 6 verticals
...
- **Why use it:** Beginner-friendly tutorial for learning DSH harness engineering from scratch
...
- **Why use it:** Curated collection of DSH plugins, ideal for discovering quality tools
...
- **Why use it:** Web-simulated traditional Chinese toy, zero-dependency.
...
- **Tags:** `awesome-list`, `plugin-registry`
- **Why use it:** Curated plugin radar with real installation path testing and auto-updating index.
...
- **Why use it:** Curated plugin and infrastructure ecosystem index for DSH.
...
- **Why use it:** Curated bilingual DSH plugin and resource reference list
...
- **Why use it:** Daily automated plugin discovery with real verification and categorized browsing
...
- **Tags:** `tutorial`, `dsh`, `guide`
- **Why use it:** Learn DSH principles, plugin marketplace guides, and best practices
...
- **Tags:** `marketplace`, `plugin-hub`, `dsh`
...
- **Why use it:** DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Ban
...
- **Why use it:** The DeepSeek Harness plugin for OpenPenc
...
- **Why use it:** DSH插件市场 / DSH Plugin Marketplace: 在 Deep
...
- **Why use it:** Native local Taskboard plugin for DeepSe
...
- **Why use it:** DeepSeek Harness plugin for previewable 
...
- **Why use it:** DSH crash-rescue plugin: undo config & p
...
- **Why use it:** Noema long-term memory plugin for DSH: d
...
- **Why use it:** DeepSeek Harness Agent Workflow
...
- **Tags:** `marketplace`, `awesome-list`
- **Why use it:** Community-maintained DSH plugin marketplace with auto-sync
...
- **Why use it:** Public GitHub directory for DSH plugins with install commands
...
- **Why use it:** DSH-style plugin marketplace similar to CodeX
...
- **Why use it:** Redirected repo — migration notice only

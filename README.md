...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 866,091 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 23:30:29 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,183 | DeepSeek Harness: Everything is a Plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,470 | 🎨 Best DeepSeek Harness Design Plugin.  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,402 | 🌊 The original agent meta-harness. Depl |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 21 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 20 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 9 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 35 plugins
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 16 plugins
- [Themes & Skins](#themes-&-skins) — 5 plugins
- [Research & Analysis](#research-&-analysis) — 14 plugins
- [Other](#other) — 52 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (21)
- [UI & Desktop Extensions](ui-desktop-extensions) (20)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (9)
- [Agent Skills & Workflows](agent-skills-workflows) (35)
...
- [Utilities & Infrastructure](utilities-infrastructure) (16)
- [Themes & Skins](themes-skins) (5)
- [Research & Analysis](research-analysis) (14)
- [Other](other) (52)
---
...
- **Tags:** `agent-routing`, `cordis`, `dsh-plugin`, `injector`
- **Why use it:** Task-aware reasoning-mode router with runtime injector for DSH agent routing
...
- **Tags:** `agent-collaboration`, `multi-agent`, `enterprise`, `visual-editor`
- **Why use it:** Enterprise-grade multi-engine agent workbench with visual editor and collaboration
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `multimodal`
- **Why use it:** Vision bridge plugin enabling image-to-structured-JSON for text-only coding agents
...
- **Why use it:** One-click model switch across multiple coding agent platforms.
...
- **Tags:** `agent-runtime`, `desktop`, `vibe-coding`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop IDE-like application.
...
- **Tags:** `code-review`, `architecture-review`, `auto-fix`
...
- **Why use it:** Architecture-aware coding agents with drift detection
...
- **Tags:** `vision`, `ocr`
- **Why use it:** Vision toolkit for text-only LLMs: OCR, screenshot analysis
...
- **Tags:** `jailbreak`, `armor-breaking`, `deepseek`
- **Why use it:** Armor-breaking plugin with stabilized jailbreak prompts for DeepSeek
...
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin marketplace plugins.
...
- **Why use it:** Meta-skill for developing DSH plugins covering slots, events, tools and adapters.
...
- **Tags:** `code-simplification`, `coding-agent`, `codex`
...
- **Why use it:** Plugin dev pitfall archive with cordis/tscconfig/junction records
...
- **Why use it:** Build and validate DSH plugins with reusable Codex skills
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins
...
- **Why use it:** Diagnoses and resolves plugin version conflicts in DSH
...
- **Tags:** `dsh-web`, `web-ui`, `plugin-hub`, `distribution`
- **Why use it:** Web-based DSH plugin hub and creative workshop distribution platform
...
- **Why use it:** Extensible sidebar with file editor, terminal, chat, Git, and sub-agent pages built in.
...
- **Tags:** `desktop`, `pet`
- **Why use it:** Animated desktop companion with plugin SDK integration
...
- **Tags:** `widget`, `desktop`
- **Why use it:** Floating whale widget tracks DeepSeek balance in DSH
...
- **Tags:** `desktop`, `agent`, `multi-model`, `privacy`
...
- **Tags:** `ui`, `genui`, `interactive`
- **Why use it:** Renders interactive UI components like charts, forms, and quizzes inline in responses
...
- **Tags:** `desktop`, `electron`, `client`, `cross-platform`
- **Why use it:** CodePilot-inspired cross-platform desktop client with plugin suite for macOS/Linux/Windows
...
- **Tags:** `canvas`, `ui`, `conversation`, `branching`
- **Why use it:** Visual non-linear canvas workspace enabling branching conversations and session exploration
...
- **Tags:** `desktop`, `gui`, `electron`, `ssh`
- **Why use it:** Full-featured Windows desktop GUI with SSH, skills, and mobile remote access
...
- **Tags:** `android`, `emulator`, `mobile`
- **Why use it:** Build and interact with live Android emulators directly inside conversations.
...
- **Tags:** `mcp`, `capability-menu`, `ui`
- **Why use it:** Unified menu to control MCP tool/skill exposure level and execution mode
...
- **Tags:** `skill-picker`, `ui`, `composer`
- **Why use it:** WorkBuddy-style skill picker with composer integration for DSH
...
- **Why use it:** Infinite canvas with creative skills in native DSH plugin
...
- **Why use it:** Real-time token usage and cost charts via web plugin
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** All-in-one Tauri desktop with DB, SSH, Docker and AI assistant
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI and tools
...
- **Tags:** `agent-memory`, `rag`, `long-term-memory`, `markdown`
- **Why use it:** Portable local-first memory layer with Markdown-native persistence across agents
...
- **Why use it:** Self-evolving hybrid-retrieval memory OS with significant token savings
...
- **Why use it:** Dedicated memory management kit tailored for AI agents with RAG capabilities.
...
- **Tags:** `memory`, `milvus`, `rag`, `semantic-search`
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus vector database.
...
- **Tags:** `memory`, `rag`
- **Why use it:** Unlimited persistent memory system for AI agents
...
- **Tags:** `knowledge`, `rag`, `ai-wiki`, `skills`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering skills, RAG, MCP, and learning paths
...
- **Tags:** `skill-management`, `semantic-search`, `embeddings`
- **Why use it:** Turn scattered SKILL.md files into searchable, retrieval-ready agent skill corpus
...
- **Why use it:** Durable long-term agent memory with recall tools and inspectable storage.
...
- **Why use it:** Official DSH docs archive with EN/ZH support and Cordis primer
...
- **Tags:** `harness-engineering`, `tutorial`, `dsh-plugin`
- **Why use it:** Beginner-friendly tutorial covering harness engineering from zero to production
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `no-code`, `local-first`
- **Why use it:** Unified multi-device agent workspace with task boards and cross-platform access
...
- **Tags:** `agent-os`, `llm-orchestration`, `loop-engineering`, `evaluation`
- **Why use it:** Self-improving agent OS with LLM evaluation and loop engineering capabilities
...
- **Tags:** `preset`, `dsh-plugin`, `bootstrap`, `standard-tools`
- **Why use it:** Two-phase DSH preset combining minimal bootstrap with full Standard tool suite
...
- **Why use it:** End-to-end automated Vox-style paper-collage explainer video generation skill.
...
- **Why use it:** Multi-agent team orchestration for complex DSH tasks
...
- **Tags:** `workflow`, `prompt-management`
- **Why use it:** Transform AI conversations into organized reusable workflows
...
- **Tags:** `agent`, `team`, `workflow`, `multi-agent`
- **Why use it:** Unifies multiple coding agents into one collaborative team with session dispatch
...
- **Tags:** `creative-writing`, `novel`, `screenwriting`
- **Why use it:** Creative writing skill for novels and short dramas with Oh Story framework
...
- **Tags:** `skills`, `framework`, `multi-agent`
- **Why use it:** Universal skill framework turning experience into repeatable execution across agents
...
- **Why use it:** Auto-discovers, installs, and verifies GitHub plugins directly within DSH
...
- **Why use it:** Specialized agent skills for AI infrastructure code writing and debugging.
...
- **Why use it:** Superpowers skill ported to Reasonix coding harness for enhanced workflows.
...
- **Why use it:** TDD, debugging, planning and collaboration skills adapted from proven superpowers framework.
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill with 85 SKILL.md entries.
...
- **Why use it:** AI coding mentor skill: scans architecture, generates chapters, reviews code.
...
- **Why use it:** 88 open-source agent skills for research, marketing, social intelligence workflows.
...
- **Why use it:** Legal visualization skill: draw litigation timelines and diagrams from case materials.
...
- **Why use it:** Portable spec-driven development skill inspired by DeepSeek Harness engineering patterns.
...
- **Tags:** `bazi`, `fengshui`, `tcm`, `dashboard`
- **Why use it:** Fusion of Bazi/Fengshui/TCM into a deterministic local agent skill with dashboard
...
- **Why use it:** Cross-platform session memory for agent continuity in Codex/Claude Code
...
- **Why use it:** Multi-agent collaboration with independent models, skills, MCP and shared workspace
...
- **Tags:** `skills-manager`, `plugin`, `management`
- **Why use it:** Centralized skills management plugin for DeepSeek Harness ecosystem
...
- **Tags:** `swift-cycle`, `governance`, `agent-skills`
- **Why use it:** Version-pinned Swift Cycle governance skill with offline verifiability
...
- **Tags:** `document`, `workflow`, `chinese`
- **Why use it:** Full Chinese official document workflow based on national GB/T standard
...
- **Tags:** `agent`, `package`, `manager`
- **Why use it:** Package manager for 42 AI agent skills across multiple frameworks
...
- **⭐ Stars:** 15
- **Language:** JavaScript
- **Description:** 拨开迷雾看见终点，剩下的交给任���栏。Part the fog, see the end — the task bar handles the rest. 🎮 mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A game-like mission system for Matt Pocock skills in DeepSeek Harness. More by @FeatherHunter: 🎨 dsh-opencode-palette · ⚡ dsh-prompt
- **Tags:** `skills`, `game`, `task`
- **Why use it:** Game-like mission system with fog-piercing task guidance mechanic
...
- **Why use it:** Encapsulates engineering discipline as portable agent skills
...
- **Tags:** `godot`, `game-dev`
- **Why use it:** Full-stack Godot 4.x development skill for DSH agents
...
- **Why use it:** Virtual product team agent preset for guided workflows
...
- **Why use it:** Pre-flight plugin recommendation for DSH agents
...
- **Tags:** `subscription`, `oauth`, `llm-provider`
- **Why use it:** Route ChatGPT Codex, Claude, Grok subscriptions as LLM providers via OAuth
...
- **Why use it:** Strongest free web search bridge for models without native web access, no signup
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms across multiple agents.
...
- **Why use it:** Add Skills & MCP card to DSH Web GUI settings for browser management
...
- **Tags:** `search`, `mcp`, `zhihu`
- **Why use it:** Zhihu search CLI skill with official open-platform API integration
...
- **Tags:** `mcp`, `hot-reload`, `config`
- **Why use it:** Hot-reload MCP server via JSON config, auto-recognizes SKILL.md
...
- **Why use it:** Generates beautiful architecture and sequence diagrams from text descriptions
...
- **Tags:** `design`, `ui`, `agent-team`, `vector`, `fimga`
...
- **Tags:** `design`, `ppt`
- **Why use it:** AI-powered design system with PPT generation and prototyping
...
- **Why use it:** Generate images directly in DSH chats via Gemini and OpenAI models
...
- **Tags:** `design`, `openpencil`, `ui`
- **Why use it:** Preview and edit OpenPencil design docs directly inside conversations.
...
- **Why use it:** Pixel-to-text OCR plugin enabling text-only models to read and understand images.
...
- **Why use it:** 6 curated design styles prevent generic AI-looking websites
...
- **Why use it:** Free image reading and generation with auto vision transcription
...
- **Tags:** `video`, `ai`, `media`
- **Why use it:** AI video/image/audio creation with configurable skill corpus
...
- **Tags:** `content-discovery`, `cross-platform`, `bilibili`
- **Why use it:** Cross-platform content discovery agent covering major Chinese and global platforms.
...
- **Why use it:** AI agents control your real logged-in browser seamlessly
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools inside conversations
...
- **Why use it:** Tabbit Browser automation plugin for DeepSeek Harness with Playwright.
...
- **Tags:** `ai-agent`, `awesome-dsh-plugin`, `chat-bot`, `deepseek-harness`, `dingtalk`, `dsh`, `dsh-plugin`
- **Why use it:** Connects DSH agents to DingTalk IM with streaming mode and emotion features.
...
- **Why use it:** Curated plugin discovery list for the entire DSH ecosystem
...
- **Tags:** `virtual-filesystem`, `vfs`, `agent-sandbox`, `utilities`
- **Why use it:** Unified virtual filesystem abstraction enabling cross-environment file operations
...
- **Why use it:** Context dashboard and management for DSH operations
...
- **Tags:** `cost-tracking`, `billing`, `token-usage`
...
- **Why use it:** Runs Pi extensions as native DSH plugins via a compatibility bridge layer
...
- **Why use it:** Cross-preset session migration preserving state and agent intent.
...
- **Tags:** `backup`, `crash-recovery`, `safety`
- **Why use it:** Crash rescue with config rollback, secret-safe snapshots and SAFE MODE.
...
- **Why use it:** Infrastructure plugin: browser-based plugin registry console + dev guide skill.
...
- **Why use it:** Skill for managing installed DSH plugins including slots, remote config and credentials.
...
- **Tags:** `deepseek-harness`, `containers`, `ui`
...
- **Why use it:** Backup/restore/sync full DSH config via WebDAV with one-click import
...
- **Why use it:** Audit context injection tokens, detect duplicates/conflicts via web UI panel
...
- **Tags:** `utility`, `info`, `tracking`
- **Why use it:** Real-time provider/model balance and peak pricing countdown display
...
- **Why use it:** Migrate Claude Code/Codex configs seamlessly into DSH
...
- **Why use it:** Bind ChatGPT account via OAuth into DSH
...
- **Tags:** `mascot`, `pixel-art`, `animated`, `community`
- **Why use it:** Community gallery of animated mascot pets for various AI coding agent tools
...
- **Why use it:** Whale Girl series skins for DeepSeek Harness, visually appealing customization.
...
- **⭐ Stars:** 384
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊���、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glass`
- **Why use it:** Beautiful frosted glass theme with full customization, no source modification needed
...
- **Why use it:** Beautiful WebGPU ocean-themed skin for DSH, Chrome/Edge extension
...
- **Tags:** `webui`, `theme`, `background`
- **Why use it:** DSH Web background personalization with presets
...
- **⭐ Stars:** 1,633
- **Language:** Python
- **Description:** last30days-cn 是一个 AI Agent 技能（Skill），能够自���搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析后生成有据可查的研究报告。
- **Tags:** `research`, `web-search`, `tiktok`, `rednotebook`
- **Why use it:** Searches top 8 Chinese platforms for recent 30 days and generates citable research reports.
...
- **Why use it:** Learn DSH principles, explore plugin marketplace, and follow best practices
...
- **Tags:** `kline`, `finance`, `analysis`, `technical`
- **Why use it:** Interactive K-line analysis with multi-market, indicators, and fundamental data
...
- **Why use it:** Evidence-backed benchmarking for prompts, RAG, and agent evaluation
...
- **Why use it:** Helps agents discover and search DSH plugins from npm and curated lists.
...
- **⭐ Stars:** 1
- **Language:** JavaScript
- **Description:** Awesome DeepSeek Harness (dsh) — curated plugins, tools, skills & resources. Everything is a plugin.
- **Why use it:** Curated collection of DSH plugins, tools, skills, and resources.
...
- **Why use it:** 70+ verified DSH plugins organized by functionality.
...
- **Why use it:** Redirected awesome list — check github.com/awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** DSH plugin awesome list.
...
- **Why use it:** Industry-specific DSH plugins for computing, finance, legal, healthcare, etc.
...
- **Tags:** `ai`, `artificial-intelligence`, `chatgpt`, `claude`, `codex`, `cursor`, `deep-learning`, `deepseek`, `gemini`, `generative-ai`, `gpt`, `llm`, `mcp`, `openai`, `python`, `rag`, `vibe-coding`, `vibecoding`, `vue`, `vuepress`
- **Why use it:** 程序员鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 Op
...
- **Tags:** `toy`, `web-app`, `mobile-first`
- **Why use it:** Web-simulated traditional Chinese toy with real audio samples, mobile-friendly.
...
- **Tags:** `marketplace`, `dsh-plugin`, `plugin-manager`
- **Why use it:** Official plugin marketplace with browse, search, and one-click install inside DSH.
...
- **Why use it:** Curated plugin radar with real installation verification
...
- **Why use it:** Curated DSH plugin ecosystem catalog and discovery list
...
- **Why use it:** Comprehensive DSH plugin and tool ecosystem catalog
...
- **Why use it:** Curated bilingual awesome list covering DSH plugins, skills, tools, and integrations
...
- **⭐ Stars:** 274
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮���快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `discovery`, `plugin-market`
- **Why use it:** Daily GitHub-scanned plugin discovery with scenario-based classification and rankings
...
- **Tags:** `awesome-list`, `guide`, `deepseek-harness`
- **Why use it:** Essential DSH quickstart guide with curated plugins and resources
...
- **Why use it:** Comprehensive curated list covering plugins, MCP servers, skills and patches
...
- **Why use it:** Plugin marketplace hub with 3,100+ plugins, search, rankings and public API
...
- **Tags:** `marketplace`, `plugin-collection`, `harness`
- **Why use it:** DSH plugin marketplace and collection hub for DeepSeek Harness ecosystem
...
- **Tags:** `notes`, `smartisan`, `productivity`
- **Why use it:** Smartisan-style notes with Docker deployment, skill calls, and export.
...
- **Why use it:** Native local Taskboard plugin for DeepSeek Harness. SQLite-backed projects, Agen
...
- **Tags:** `awesome-list`, `collection`, `discovery`
- **Why use it:** Curated awesome-list of best DeepSeek Harness plugins.
...
- **Why use it:** Curated awesome-list of DSH plugins, extensions and dev resources.
...
- **Tags:** `photo`, `internal`, `test`
- **Why use it:** Internal test completion photo wall with OAuth zero-permission login
...
- **Why use it:** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一键换上——tokyonight、dracula、gruvbox、matrix、rose-p
...
- **Why use it:** Curated list of DSH plugins — good starting discovery tool
...
- **Why use it:** 2026 curated DSH plugin list with quality checks
...
- **Tags:** `awesome-list`, `plugin-registry`
- **Why use it:** Open-data spam-filtered plugin registry
...
- **Why use it:** Evidence-led curated plugin directory
...
- **Why use it:** Curated finance/quant plugin vertical list
...
- **Why use it:** Chinese-language useful DSH plugin collection
...
- **Tags:** `awesome-list`, `guide`, `directory`
- **Why use it:** Plugin product guide with scenario-based navigation
...
- **Why use it:** Zero-dependency static portal for 227+ plugins
...
- **Tags:** `dsh-plugins`, `catalog`
- **Why use it:** DSH plugin ecosystem collection
...
- **Tags:** `awesome-list`, `automated`, `bilingual`
...
- **Tags:** `awesome-list`, `reviewed`
- **Why use it:** Evidence-led immutable commit-reviewed plugins
...
- **Tags:** `plugin-registry`, `radar`, `awesome-list`
- **Why use it:** Plugin radar and 2Origin lab resource
...
- **Why use it:** Plugin marketplace for DSH similar to CodeX, enabling browsing and installation.

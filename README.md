...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 869,206 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 04:50:51 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,868 | Core DSH framework; everything is a plugin archite |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,534 | Open-source design plugin with Figma alternative a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,420 | Meta-harness for multi-agent swarms and autonomous |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 14 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (14)
...
- **Tags:** `ai-agent`, `multi-agent`, `mcp`, `dsh-plugin`, `skills`
- **Why use it:** Super AI assistant harness with self-evolving memory and multi-model support
...
- **Tags:** `coding-agent`, `deepseek`, `dsh-plugin`, `tui`, `tool-use`
- **Why use it:** Terminal-native AI coding agent optimized for prefix-cache stability
...
- **Tags:** `agent-skills`, `diagrams`, `architecture`
- **Why use it:** Beautiful architecture diagrams with motion effects
...
- **Why use it:** Task-aware reasoning-mode router preset
...
- **Tags:** `enterprise`, `agent-workspace`, `multi-agent`
- **Why use it:** Enterprise multi-engine agent workbench
...
- **Tags:** `preset`, `harness`, `bootstrap`
- **Why use it:** Two-phase bootstrap preset for DSH projects
...
- **Why use it:** First vision plugin for text-only coding agents
...
- **Tags:** `coding-agent`, `ai-ide`, `dsh-plugin`
- **Why use it:** High-performance Rust-based agent runtime paired with a polished desktop coding IDE.
...
- **Tags:** `agent-skills`, `coding-agents`, `architecture-driven`
- **Why use it:** Makes AI coding agents architecture-aware with evidence verification and drift checking.
...
- **Why use it:** Powerful vision toolkit for text-only models with OCR and screenshot support.
...
- **Why use it:** Unifies multiple coding agents into one coordinated team with session dispatch.
...
- **Tags:** `vision`, `multimodal`, `browser-harness`
- **Why use it:** Adds multimodal vision for screenshots, UI, and chart analysis.
...
- **Tags:** `android`, `emulator`, `mobile-dev`
- **Why use it:** Build and interact with Android emulator/device inside chat
...
- **Tags:** `agent`, `agent-skill`, `agent-skills`, `deepseek-harness`, `dsh-plugin`, `llm-agent`
- **Why use it:** Agent skill for developing DSH plugins covering services, events, tools, and adapters
...
- **Tags:** `deepseek-harness`, `plugin-dev`
- **Why use it:** Builds DSH plugins with slot/credential management out of the box.
...
- **Why use it:** Bidirectional chat sync, live skills mount and auto MCP mirroring with Codex.
...
- **Why use it:** Package manager with 42 skills, 5 CLIs, and 1 plugin for AI agent engineering
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `plugin-development`
...
- **Tags:** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `plugin-development`
- **Why use it:** Portable skill for developing and auditing DSH plugins with optional bundle adapter
...
- **Tags:** `migration`, `mcp`, `skills`
- **Why use it:** Seamlessly migrate skills, agents and MCP configs from Claude Code/Codex
...
- **Tags:** `chatgpt`, `oauth`, `integration`, `agent-tool`
- **Why use it:** OAuth binding for ChatGPT accounts to chat models directly inside DSH
...
- **Tags:** `dsh-plugin`, `desktop`, `cordis-plugin`, `deepseek-harness`
- **Why use it:** Modern desktop client for DSH where even the desktop itself is a plugin
...
- **Tags:** `dsh-web`, `ui`, `plugin-marketplace`
- **Why use it:** Web UI plugin aggregation ecosystem
...
- **Tags:** `deepseek-harness`, `sidebar`, `dsh-plugin`
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, and rollback features.
...
- **Tags:** `desktop-app`, `electron`, `office-automation`
- **Why use it:** Local-first desktop workspace integrating sessions, files, and office artifacts.
...
- **Tags:** `agent`, `desktop-app`, `dsh-plugin`
- **Why use it:** Local-first AI agent desktop app with multi-model support and privacy focus.
...
- **Why use it:** CodePilot-inspired desktop client for DSH with cross-platform support (macOS/Win/Linux).
...
- **Tags:** `desktop-app`, `electron`, `gui`
- **Why use it:** Open-source Windows desktop GUI with SSH and remote access built in.
...
- **Why use it:** Electron desktop console for managing Harness, plugins, MCP, and skills in tabs
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `usage-tracking`, `web`
- **Why use it:** Persistent bottom bar showing provider, model, live balance and pricing info
...
- **Tags:** `desktop`, `tauri`, `devops`, `ssh`
- **Why use it:** All-in-one Tauri desktop combining DB, SSH, Docker and AI assistant
...
- **Why use it:** Electron desktop wrapper for DSH with sidebar and UI integrations
...
- **Tags:** `rag`, `vector-search`, `knowledge-base`, `dsh-plugin`, `multi-tenant`
- **Why use it:** Open-source LLM knowledge platform with RAG, semantic search, and wiki capabilities
...
- **Why use it:** Self-evolving memory with 35% token savings
...
- **Why use it:** Dedicated memory management for agents with refinement capabilities.
...
- **Tags:** `memory`, `dsh-plugin`, `rag`
- **Why use it:** Provides unlimited memory storage for AI agents on OpenClaw.
...
- **Tags:** `skill-retrieval`, `embeddings`, `agent-memory`
- **Why use it:** Transform SKILL.md files into searchable, retrieval-ready corpora.
...
- **Tags:** `memory`, `long-term`, `mcp`, `agent`
- **Why use it:** Durable long-term agent memory with recall tools and settings
...
- **Tags:** `context`, `deepseek-harness`, `dsh-plugin`, `ui`
- **Why use it:** Audits token costs and detects conflicts in context injection chains
...
- **Tags:** `agentic-ai`, `agentic-workflow`, `multi-agent`, `mcp-server`, `dsh-plugin`
- **Why use it:** Meta-harness for multi-agent swarms and autonomous workflow orchestration
...
- **Tags:** `agent-skills`, `ai-persona`, `dsh-plugin`, `meta-skill`, `knowledge-distillation`
- **Why use it:** Distills AI thinking patterns into reusable meta-skills for any agent
...
- **Tags:** `ai-agent`, `low-code`, `workflows`, `dsh-plugin`, `internal-tools`
...
- **Why use it:** Beginner tutorial from zero to one
...
- **Why use it:** All-in-one agent workspace across all devices
...
- **Why use it:** Self-improving agent OS with loop engineering
...
- **Why use it:** Intelligent workflow orchestrator that auto-routes and manages agent skills.
...
- **Tags:** `workflow`, `productivity`, `plugin`
- **Why use it:** Transforms AI conversations into organized reusable workflows.
...
- **Tags:** `math-modeling`, `gitops`, `competition`
- **Why use it:** Full-stack automated math modeling competition skill with GitOps pipeline.
...
- **Tags:** `skills`, `execution`, `agent`
- **Why use it:** Turn experience into repeatable, cross-platform execution skills.
...
- **Why use it:** Agent skills for AI infra dev, optimization and debugging
...
- **Why use it:** SQLite-backed task management with Agent claim/review
...
- **Why use it:** Structured agent workflow orchestration plugin
...
- **Why use it:** Port of Superpowers skills to Reasonix coding harness for enhanced productivity
...
- **Why use it:** TDD, debugging, planning skills adapted for DeepSeek Harness workflows
...
- **Why use it:** Complete reverse engineering and pentesting skill set with 85 SKILL.md files
...
- **Why use it:** AI coding mentor that scans projects, generates chapters, and performs code review
...
- **Tags:** `agent-plugins`, `agent-skills`, `ai-agents`, `deepseek`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `ai-coding`, `deepseek-harness`, `dsh-plugin`, `spec-driven-development`
- **Why use it:** Portable spec-driven development skill for repository-native programming workflows
...
- **Why use it:** Official DSH plugin dev docs as an on-demand agent skill (EN/ZH).
...
- **Tags:** `agent-skill`, `chinese-culture`, `dashboard`
- **Why use it:** Unique Bazi/Fengshui/I Ching AI agent skill with local deterministic engine.
...
- **Why use it:** Cross-platform session continuity memory for agent handoff between sessions.
...
- **Tags:** `ux`, `agent-skill`, `composer`
- **Why use it:** WorkBuddy-style skill picker to insert /skill-name commands in composer.
...
- **Tags:** `codex`, `code-quality`, `simplification`
- **Why use it:** Adapted Codex skill for automatic code simplification from DSH originals.
...
- **Tags:** `governance`, `swift-cycle`, `agent-skill`
- **Why use it:** Version-pinned Swift Cycle governance skill adapter with offline verification.
...
- **⭐ Stars:** 18
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查��修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `ai-docs`, `deepseek-harness`, `dsh-plugin`, `gongwen`
- **Why use it:** Full pipeline Chinese official document processing compliant with GB/T 9704
...
- **Tags:** `agent`, `dsh-plugin`, `skills`, `wayfinder`
- **Why use it:** Game-like mission system with fog-of-war map to guide task progression in DSH
...
- **Tags:** `documentation`, `best-practices`, `skill`
- **Why use it:** Practical DSH plugin dev guide covering pitfalls and solutions
...
- **Why use it:** Enables infinite creative canvas with agentic workflow skills
...
- **Tags:** `engineering`, `agent-skill`, `practices`
- **Why use it:** Portable engineering discipline skill for evidence-based agent work
...
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH agents
...
- **Why use it:** Build and test DSH plugins entirely inside the harness
...
- **Why use it:** Virtual PM-Engineer-QA product team preset for guided conversations
...
- **⭐ Stars:** 3
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件提示，让插件��利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `agent-tools`, `capability-index`, `workflow`, `preflight`
- **Why use it:** Pre-flight plugin library check — auto-injects Top-K plugins per task
...
- **Why use it:** Web UI tool for managing skills and MCP connections
...
- **Tags:** `mcp`, `configuration`, `ui`
- **Why use it:** Unified menu to control MCP tool exposure and execution mode.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp`
- **Why use it:** Manages skills and MCP servers directly in the DSH Web GUI settings page
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp`, `zhihu`
- **Why use it:** Search Zhihu, Zhida, and use official APIs via DSH plugin with MCP support
...
- **Why use it:** Hot-reload MCP servers via UI config, no restart needed
...
- **Tags:** `agent-skills`, `ai-design`, `dsh-plugin`, `figma-alternative`, `ui-generator`
- **Why use it:** Open-source design plugin with Figma alternative and local-first desktop app
...
- **Tags:** `ai-image-generation`, `dsh-plugin`, `skills`, `workflow-automation`, `prompt-engineering`
- **Why use it:** 20+ industrial-grade GPT-Image2 prompt templates distilled as reusable skills
...
- **Why use it:** AI-powered design studio with template marketplace and PPT creation.
...
- **Tags:** `ui`, `dsh-plugin`, `design`
- **Why use it:** Interactive UI components like charts, forms, and quizzes rendered inline in chat.
...
- **Tags:** `workspace`, `dsh-plugin`, `canvas`
- **Why use it:** Visual non-linear canvas workspace for branching conversations and session exploration.
...
- **Tags:** `image-generation`, `ai-agent`, `plugin`
...
- **Why use it:** Preview and edit OpenPencil documents inside conversation
...
- **Tags:** `agent-skills`, `claude-code`, `deepseek-harness`, `diagram`, `dsh-plugin`, `legal`, `timeline`, `visualization`
- **Why use it:** Legal litigation visualization tool for creating court-ready timeline diagrams
...
- **Tags:** `design-skills`, `dsh-plugin`, `ui`, `web-design`
- **Why use it:** Keeps vibe-coded sites away from generic AI aesthetics with 6 curated styles
...
- **Tags:** `agent-skills`, `dsh-plugin`, `image-generation`, `vision`
- **Why use it:** Enables free image reading and generation with auto vision transcription in DSH
...
- **Tags:** `ai-director`, `dsh-plugin`, `text-to-video`, `storyboard`
- **Why use it:** AI video/image/audio generation skills with configurable vision and storyboard tools
...
- **Tags:** `background`, `theming`, `webui`, `visual`
- **Why use it:** Upload custom backgrounds or switch presets; browser-side compression
...
- **Tags:** `mcp-server`, `self-hosted`, `dsh-plugin`, `react`
- **Why use it:** Privacy-first resume builder, self-hosted and fully customizable
...
- **Tags:** `dsh-plugin`, `electron`, `image-uploader`, `s3`, `github`
...
- **Tags:** `vfs`, `infrastructure`, `tools`
- **Why use it:** Unified virtual filesystem for all AI agents
...
- **Why use it:** One-click multi-model switch between major AI coding tools.
...
- **Tags:** `context`, `dsh-external`, `utility`
- **Why use it:** Context dashboard and management tool with statistics and browser view.
...
- **Tags:** `widget`, `floating`, `dsh-plugin`
- **Why use it:** Cute floating whale widget to monitor DeepSeek account balance.
...
- **Why use it:** Use ChatGPT, Claude, Grok subscriptions as LLM providers via OAuth in DSH.
...
- **Tags:** `cost-tracking`, `token-usage`, `harness`
- **Why use it:** Track session costs, budgets, and token usage in real time.
...
- **Why use it:** Plugin marketplace with 3,100+ entries, search, and a public API.
...
- **Why use it:** Curated collection of DeepSeek Harness community plugins.
...
- **Tags:** `compatibility-layer`, `migration`, `abi`
...
- **Why use it:** One-click browse and install all GitHub dsh plugins
...
- **Tags:** `backup`, `rollback`, `windows`, `safety`
- **Why use it:** Crash recovery, undo config/plugin changes safely offline
...
- **Why use it:** Essential plugin management console for DSH ecosystem with zero patch required
...
- **Why use it:** Dedicated skills management plugin for organizing and controlling DSH skills.
...
- **Tags:** `cost-tracking`, `data-visualization`, `api`
...
- **Tags:** `conflict-resolution`, `compatibility`, `utilities`
- **Why use it:** Resolves plugin conflicts and version compatibility issues automatically
...
- **Why use it:** In-agent plugin search via npm + curated list lookup
...
- **Tags:** `marketplace`, `skills`, `extensions`
- **Why use it:** Plugin marketplace for DSH enabling skill-based extensions
...
- **Tags:** `verified`, `directory`, `organized`
- **Why use it:** 70+ verified plugins organized by functional categories
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness customization.
...
- **Why use it:** Beautiful frosted glass theme with fully customizable blur and background options.
...
- **Why use it:** Stunning WebGPU ocean-themed visual skin for DeepSeek Harness.
...
- **Tags:** `color-scheme`, `dark-mode`, `dsh-plugin`, `theme`
- **Why use it:** One-click switch between 34 opencode classic themes without losing on restart
...
- **Tags:** `ai-guide`, `rag`, `vibe-coding`, `dsh-plugin`, `llm`
- **Why use it:** Comprehensive AI resource library and zero-to-hero tutorials for multiple LLMs
...
- **Why use it:** Automatically searches 8 major Chinese platforms for 30-day content and generates citable reports.
...
- **Why use it:** Curated plugin radar with 9000+ candidates and top 50 selection for DSH ecosystem.
...
- **Tags:** `awesome-list`, `hub`, `curated`
- **Why use it:** Comprehensive curated list from dsh-external/hub and public plugins.
...
- **Why use it:** Daily auto-scraped and verified DSH plugin discovery with categorized recommendations.
...
- **Tags:** `ai-pedia`, `dsh-plugin`, `resource`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MLOps, and learning roadmaps.
...
- **Tags:** `ai-agents`, `alipay`, `api-documentation`, `chinese-api`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `finance`, `kline`, `analysis`, `dashboard`
...
- **Tags:** `evaluation`, `rag-evaluation`, `dsh-plugin`, `prompt-testing`
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, and agents with observability
...
- **Tags:** `finance`, `quant`, `stock`, `research`
- **Why use it:** Curated stock/finance/quant plugin vertical list, 24 verified entries
...
- **Tags:** `plugin-radar`, `discovery`, `awesome-list`
- **Why use it:** Plugin radar and evidence-backed discovery for DSH ecosystem
...
- **Why use it:** Complete 1000+ plugin inventory sorted by star rating
...
- **Tags:** `ai-recommender`, `curated`, `hourly-update`
- **Why use it:** AI-curated 190+ plugin recommendations updated hourly
...
- **Tags:** `awesome-list`, `resources`, `curated`
- **Why use it:** Curated collection of plugins, tools, skills and resources
...
- **Tags:** `curated`, `evidence-aware`, `shortlist`
...
- **Tags:** `installable`, `curated`, `typescript`
- **Why use it:** Installable curated plugins for models, tools, sandboxes and UI
...
- **Tags:** `industry`, `sector-specific`, `finance`, `legal`, `medical`
- **Why use it:** Industry-specific plugins for finance, legal, medical and more
...
- **Why use it:** Curated list of DSH plugins
...
- **Why use it:** Zero-dependency web sim of a traditional Chinese toy with real audio samples.
...
- **Tags:** `security`, `agent`, `dsh-plugin`
- **Why use it:** AI security platform for auditing code vulnerabilities and hallucinated packages.
...
- **Tags:** `armor-breaking`, `dsh-plugin`, `prompt`
- **Why use it:** Armor-breaking prompt plugin specifically for DeepSeek, stabilizes jailbreak prompts.
...
- **Why use it:** Comprehensive guide and curated resource list for DeepSeek Harness users.
...
- **Why use it:** Curated catalog of DSH plugins, MCP servers, skills, and UIs.
...
- **Tags:** `anime`, `bangumi`, `search`, `torrent`
- **Why use it:** Multi-source anime search with Bangumi ratings in chat
...
- **Why use it:** Smartisan-style notes with Docker deploy, skill support
...
- **Why use it:** Curated list of DSH plugins, extensions, tools and development resources
...
- **⭐ Stars:** 27
- **Language:** JavaScript
- **Description:** DeepSeek Harness (DSH) 插件精选目录 — 14 类 280+ 个社区插件，覆盖 MCP / Skill / TUI / 多 Agent / 上下���记忆 / UI 皮肤，点链接直达仓库。Curated directory of dsh plugins for DeepSeek Harness.
- **Tags:** `awesome-list`, `discovery`, `community`
...
- **Why use it:** Curated Chinese-language DSH plugin showcase list
...
- **Why use it:** Fast Neovim plugin manager — not a DSH plugin but excellent tooling
...
- **Why use it:** Unofficial community-curated DSH plugin catalog for exploration
...
- **Why use it:** 2026 quality-checked curated DSH plugin list with ratings
...
- **Tags:** `awesome-list`, `curated`, `permission-aware`
- **Why use it:** Evidence-led curated directory with permission-aware install guidance
...
- **Tags:** `awesome-list`, `community`, `verified`
- **Why use it:** Verified star-ranked community plugins list for DSH ecosystem
...
- **Why use it:** General plugin collection — easy-to-use DeepSeek Harness plugins
...
- **Tags:** `awesome-list`, `guide`, `navigation`, `manual`
- **Why use it:** Plugin product manual and navigation by use-case with risk guidance
...
- **Tags:** `portal`, `static-site`, `discovery`, `awesome-list`
- **Why use it:** Zero-dependency static portal to discover and install 227+ DSH plugins
...
- **Tags:** `awesome-list`, `plugin-collection`
- **Why use it:** General DeepSeek Harness plugins collection and ecosystem directory
...
- **Tags:** `awesome-list`, `catalog`, `automation`, `directory`
- **Why use it:** Auto-crawled daily plugin directory with GitHub Actions, bilingual listing
...
- **Tags:** `awesome-list`, `evidence-led`, `bilingual`, `reviewed`
...
- **Tags:** `moved`, `redirect`
- **Why use it:** Repository moved to github.com/awesome-dsh-plugin
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugins`, `collection`
- **Why use it:** Generic DSH plugin collection

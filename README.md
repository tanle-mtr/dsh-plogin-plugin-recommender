...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 862,381 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 13:00:05 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 194,314 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,328 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,358 | Meta-harness for multi-agent swarms and autonomous |
...
- **Why use it:** Terminal-native DeepSeek coding agent with prompt caching stability
...
- **Why use it:** Unified agent workspace across all devices with task tracking and self-hosting.
...
- **Tags:** `agent-orchestration`, `dsh-plugin`, `cordis`
- **Why use it:** Task-aware routing injector with measurable reasoning-mode presets for agents.
...
- **Why use it:** Self-improving Agent OS with loop engineering and graded evaluation on success.
...
- **Tags:** `enterprise-agent-workspace`, `multi-agent`, `agent-skills`
- **Why use it:** Enterprise-grade local-first multi-agent workbench for Codex, DSH, and Hermes.
...
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop IDE application.
...
- **Tags:** `code-review`, `static-analysis`, `developer-tools`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with severity labels and citations.
...
- **Why use it:** Makes AI coding agents architecture-aware with drift detection
...
- **Why use it:** Vision toolkit for text-only models: OCR, image Q&A, UI restoration
...
- **Why use it:** Audits AI-generated code for hallucinated packages and missing security safeguards.
...
- **Tags:** `mobile-automation`, `mcp`, `dsh-plugin`
- **Why use it:** Integrates live iOS Simulator and USB iPhone control directly inside DSH conversations.
...
- **Why use it:** AI infra skills for system dev and debugging
...
- **Why use it:** Search 65,600+ Chinese platform API docs across multiple CLI agents.
...
- **Why use it:** Agent skill guiding standard DSH plugin development workflows.
...
- **Why use it:** Pixel-to-text OCR and image reading for text-only LLM models.
...
- **Tags:** `codex`, `mcp`, `sync`, `developer-tools`
...
- **Tags:** `plugin-development`, `cordis`, `skill`
- **Why use it:** Portable skill for developing and auditing DSH plugins with profile adapter.
...
- **Why use it:** Open-source Figma alternative with local-first desktop app
...
- **Why use it:** Web UI aggregation pack for DSH — all plugins in one creative workshop distribution.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** 5MB Tauri desktop with zero setup and preset plugins
...
- **Tags:** `widget`, `ui`
- **Why use it:** Cute floating whale widget monitoring account balance
...
- **Why use it:** Full-featured Electron desktop GUI with SSH and mobile access
...
- **Why use it:** Smartisan-style notes with one-click deploy
...
- **Why use it:** Electron desktop console for managing DSH, plugins, MCP and skills.
...
- **Why use it:** Multi-version DSH container manager with embedded WebView UI.
...
- **Why use it:** Live model info, balance, and pricing countdown bar for DSH web UI.
...
- **Why use it:** Cross-platform desktop with DB, SSH, Docker, and AI assistant.
...
- **Tags:** `desktop`, `electron`
- **Why use it:** Electron desktop shell integrating DSH web and ecosystem plugins.
...
- **Why use it:** Self-evolving memory with hybrid retrieval and significant token savings for agents.
...
- **Why use it:** Essential memory management kit for persistent agent recall and RAG workflows.
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus for hybrid semantic search.
...
- **Tags:** `memory`, `rag`
- **Why use it:** Provides unlimited memory capability for AI agents
...
- **Why use it:** Comprehensive AI knowledge encyclopedia covering MCP, RAG, agents, and learning paths.
...
- **Why use it:** Connects to PowerContext server for memory and recall.
...
- **Why use it:** Enables multi-agent team collaboration for DSH
...
- **Why use it:** Unifies Claude Code, Codex, Grok, and DSH into one collaborative agent team.
...
- **Tags:** `creative-writing`, `drama-skills`, `skill`
...
- **Why use it:** Framework to turn experience into repeatable agent execution
...
- **Why use it:** Skill that finds, installs and verifies GitHub plugins automatically
...
- **Why use it:** Comprehensive 85-skill reverse engineering and pentesting workflow.
...
- **Why use it:** AI coding mentor that guides project architecture and code review.
...
- **Tags:** `agent-skill`, `knowledge-base`, `scaffold`
- **Why use it:** Official DSH docs as an on-demand agent skill with EN/ZH support.
...
- **Why use it:** Fusion of Bazi, Fengshui, I Ching into a local deterministic AI skill.
...
- **Tags:** `dsh-plugin`, `agent-skills`, `ui`
- **Why use it:** WorkBuddy-style skill picker integrated directly into DSH composer.
...
- **Tags:** `multi-agent`, `dsh-plugins`, `team-collaboration`
...
- **Tags:** `skills-manager`, `dsh-plugins`, `utility`
- **Why use it:** Centralized skills management plugin for DSH with install and organize.
...
- **Why use it:** Adds free image reading and generation capabilities via vision transcriptions.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `oauth`
- **Why use it:** Zero-permission OAuth group photo wall with DSH skill packaging.
...
- **Why use it:** Full Chinese official document pipeline: format check, templates, and editing.
...
- **Tags:** `agent-framework`, `skills`, `mcp`
- **Why use it:** Package manager with 42 skills and CLIs for agent engineering workflows.
...
- **Tags:** `ai-director`, `video-editing`, `skill`
...
- **Tags:** `skills`, `gamification`, `agent`
...
- **Why use it:** Godot 4.x full-stack game dev skill at runtime.
...
- **Why use it:** Agent skills for building, scaffolding, and testing DSH plugins.
...
- **Tags:** `canvas`, `mcp-tools`, `skills`
- **Why use it:** Infinite canvas with creative skills and MCP tools.
...
- **Tags:** `record-replay`, `computer-use`
...
- **Why use it:** First vision plugin turning images into structured JSON evidence for text-only agents.
...
- **Why use it:** Unified virtual filesystem abstraction enabling portable agent file operations.
...
- **Why use it:** MCP server and skill for Zhihu search and Q&A via official APIs.
...
- **Why use it:** Hot-reload MCP manager: paste JSON to connect, auto-recognizes .skill files.
...
- **Why use it:** Self-contained HTML diagrams with motion and crisp visuals for architecture and workflows.
...
- **Tags:** `design-tool`, `ui`, `vibecoding`
- **Why use it:** Open-source AI-native vector design tool with concurrent Agent Teams and design-as-code.
...
- **Why use it:** Native design studio for AI-generated visual editing and PPT
...
- **Tags:** `ui`, `dsh-plugin`, `visualization`
- **Why use it:** Generates interactive UI components — charts, forms, quizzes — inline in chat replies.
...
- **Tags:** `canvas`, `workspace`, `dsh-plugin`
...
- **Why use it:** Edit OpenPencil designs directly in-chat
...
- **Why use it:** 6 aesthetic style packs to keep vibe-coded websites away from generic AI look.
...
- **Why use it:** Cross-platform local-first content discovery agent spanning Bilibili, YouTube, X, and more.
...
- **Why use it:** AI agents control real logged-in browser seamlessly via CLI+extension
...
- **Why use it:** Strongest free web search bridge for models without native web access, no API needed.
...
- **Why use it:** Build and test Android apps via emulator or USB
...
- **Why use it:** Tabbit Browser automation via Playwright for DSH
...
- **Why use it:** DingTalk IM channel enabling tool-capable agents via chat.
...
- **Why use it:** Public gallery of animated pixel-art mascots for your AI coding agent desktop.
...
- **Why use it:** Whale Girl series aesthetic skins specifically designed for DeepSeek Harness.
...
- **Why use it:** Stunning WebGPU ocean-themed visual customization for DSH
...
- **Why use it:** 34 opencode themes one-click applied, persists across restarts.
...
- **Why use it:** Curated plugin list — essential reference for discovering DSH ecosystem tools.
...
- **Why use it:** Auto-searches top 8 Chinese platforms for recent 30-day content and generates citable reports.
...
- **⭐ Stars:** 206
- **Language:** Unknown
- **Description:** DeepSeek Harness 终极���南：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **Tags:** `awesome-list`, `deepseek-harness`, `plugins`
- **Why use it:** Comprehensive DSH guide with curated plugins and resources
...
- **Tags:** `awesome-list`, `mcp`, `dsh-plugins`
- **Why use it:** Curated list covering plugins, MCP servers, patches and orchestrators
...
- **Why use it:** Plugin marketplace with 3100+ entries, search and public API
...
- **⭐ Stars:** 162
- **Language:** TypeScript
- **Description:** DeepSeek Harness 搜番插件：对话内多源搜索番剧，��片展示 Bangumi 评分与详情，支持复制磁力。
...
- **Why use it:** Interactive multi-market K-line analysis with technical indicators and news.
...
- **Why use it:** Evidence-led curated plugin directory for DSH ecosystem discovery.
...
- **Why use it:** Comprehensive 1000+ plugin directory sorted by stars.
...
- **Why use it:** AI-curated hourly-updated plugin list with 12 categories.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `resources`
- **Why use it:** Broad curated resource hub covering plugins, tools, skills.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `verified`
...
- **Tags:** `registry`, `dsh-plugin`, `curated`
- **Why use it:** Curated registry covering models, tools, sandboxes, UI.
...
- **Tags:** `industry`, `awesome-list`, `dsh-plugin`
- **Why use it:** Industry-specific plugin directory for computing, finance, legal, HR.
...
- **Why use it:** NocoBase is an open-source AI + no-code platform for building business systems f
...
- **Why use it:** Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an 
...
- **Why use it:** 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
...
- **Why use it:** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manage
...
- **Why use it:** 程��员鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 OpenClaw 保姆级教程、大模型玩法（DeepSeek / GPT / Gem
...
- **Why use it:** Prompt as Code | GPT-Image2 工业级提示词引擎与模板库，530+ 个案例逆向工程，20+ 套工业级模板，并提炼出Skills，持续更新
...
- **Why use it:** Curated plugin radar with 9000+ candidates and top 50 selection
...
- **Why use it:** Curated bilingual resource list covering DSH plugins, skills, clients, and integrations.
...
- **Why use it:** Auto-scraper that curates real DSH plugins by category,热度排行 and practical guides.
...
- **Why use it:** Specialized jailbreak prompt stabilization plugin for DeepSeek models.
...
- **Tags:** `documentation`, `learning`, `dsh-plugin`
- **Why use it:** Learn DSH principles, plugin marketplace exploration, and best practice documentation.
...
- **Tags:** `agents`, `awesome-list`, `deepseek`, `dsh-plugin`, `plugins`
- **Why use it:** Curated awesome-list for DSH ecosystem discovery and learning.
...
- **Why use it:** Official auto-generated curated list by cordis.run plugin marketplace.
...
- **⭐ Stars:** 13
- **Language:** Unknown
- **Description:** DSH 插件开发踩坑与做法档案（skill + 文档）：cordis 双副本、tsconfig 三���套、Windows junction、多帧 zstd 等实测记录
- **Tags:** `documentation`, `plugin-development`
- **Why use it:** Plugin dev handbook covering cordis, tsconfig, Windows junctions, and zstd.
...
- **Tags:** `skill`, `engineering`, `practices`
- **Why use it:** Portable skill distilling engineering discipline for DSH development.
...
- **Why use it:** Evidence-led verified DSH plugin directory with installation guidance.
...
- **Why use it:** Spam-filtered, open-data registry of Dee

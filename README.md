...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,096,381 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-26 07:20:23 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 236,288 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,122 | Local-first design agent with Figma-like prototypi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,295 | Multi-agent swarm orchestration with autonomous wo |
...
- **Tags:** `routing`, `injector`, `performance`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for optimized DSH performance
...
- **Why use it:** Self-improving agent OS with staged evaluation loop and MCP server support
...
- **Tags:** `deepwiki`, `docs`, `dsh-plugin`
- **Why use it:** Generate structured technical docs and AI-ready context quickly.
...
- **Why use it:** Dashboard, browser, and sidebar for context insight and management.
...
- **Why use it:** Coding agent with RPC sub-agents, hashline edits and MCP support via TUI.
...
- **Tags:** `cli`, `plugin-manager`, `hub`, `typescript`
- **Why use it:** CLI and schemas for managing DSH plugins and agent tools via the Plugin Hub.
...
- **Why use it:** Integrates live iOS Simulator and USB iPhone with 22 agent automation tools
...
- **Why use it:** Official plugin dev docs + scaffold as on-demand agent skill
...
- **Why use it:** Bind ChatGPT account via OAuth and chat with ChatGPT models inside DSH directly
...
- **Tags:** `dsh-plugin-desktop`, `cordis`, `desktop`
...
- **Tags:** `desktop`, `official`, `ui`
- **Why use it:** Official DeepSeek Harness desktop application for native experience
...
- **Why use it:** Open sidebar foundation supporting third-party pages with built-in file/terminal/Git views
...
- **Tags:** `tui`, `terminal`, `deepseek-harness`, `react`
- **Why use it:** Featured TUI plugin with whale bar, live streaming thought and context progress
...
- **Tags:** `deepseek`, `dsh-plugin`, `floating-widget`
- **Why use it:** Cute floating widget tracking DeepSeek balance with drag & snap.
...
- **Why use it:** Zero-setup Windows desktop client with full DSH integration and remote access.
...
- **Tags:** `desktop`, `mcp`, `electron`, `office-automation`
- **Why use it:** Local-first AI desktop workspace with MCP, projects, files and Office automation.
...
- **Why use it:** Interactive UI components rendered inline in replies — layouts, charts, forms, quizzes.
...
- **Why use it:** Adds full office suite (spreadsheets, docs, slides) directly into DSH
...
- **Tags:** `ios-app`, `mobile`, `dsh-plugin`
...
- **Why use it:** CodePilot-inspired multi-platform desktop client with rich plugin ecosystem
...
- **Tags:** `workbench`, `desktop`, `typescript`
...
- **Why use it:** Direct TCP control of Blender for AI-driven 3D modeling and rendering
...
- **Why use it:** Bioinformatics desktop app for clinicians, offline mode supported
...
- **Why use it:** Replaces composer stats bar with model, balance, and pricing info
...
- **Why use it:** All-in-one DevOps desktop hub: DB client, SSH, SFTP, Docker, AI assistant in one window
...
- **Tags:** `enhancement`, `terminal`, `keybindings`, `notifications`
...
- **Tags:** `desktop`, `electron`, `integration`, `ui`
- **Why use it:** Electron desktop wrapper bundling DSH web, ModLens, sidebar and plugin marketplace
...
- **Why use it:** Customize DSH Web UI backgrounds with presets and personal images.
...
- **Tags:** `knowledge-distillation`, `meta-skill`, `llm-agent`
...
- **Tags:** `workspace`, `agent-orchestration`, `no-code`
- **Why use it:** Unified agent workspace with cross-device task tracking and no-code support
...
- **Why use it:** Most comprehensive skills store with auto-crawled GitHub projects organized by category
...
- **Why use it:** Specialized novel writing agent solving AI forgetfulness for 2M+ word serials
...
- **Why use it:** Enterprise multi-engine agent workspace with unified visual editor and team collaboration
...
- **Tags:** `agent-control-plane`, `multi-agent`, `workflow-automation`, `long-horizon`
- **Why use it:** Durable control plane for long-horizon agents and persistent state across sessions
...
- **Why use it:** First vision plugin for DSH — paste images to get structured JSON evidence via OCR
...
- **Tags:** `skills`, `workflow-automation`, `context-engineering`, `multi-agent`
...
- **Tags:** `agent-skills`, `deep-reasoning`, `dsh-plugin`
...
- **Why use it:** Enables multi-agent team workflows within DSH.
...
- **Why use it:** Vision toolkit for text-only models: OCR, screenshot, image Q&A.
...
- **Why use it:** Built-in creative writing workflows for novels, short dramas, and game scripts
...
- **Why use it:** Gives agents eyes and ears — video/audio analysis with timestamped evidence
...
- **Tags:** `task-management`, `dsh-plugin`
- **Why use it:** SQLite-backed native taskboard with agent claim/review and clean Web UI
...
- **Tags:** `math-modeling`, `workflow`, `automation`
...
- **Why use it:** Enables composable, reviewable and self-evolving agent workflows with task controls
...
- **Why use it:** Turn experience into repeatable execution across major AI coding platforms
...
- **Why use it:** 87 SKILL.md reverse engineering skill for CTF, pentesting and security research
...
- **Tags:** `multimodal`, `claude-code`, `agent-skills`
- **Why use it:** Adds vision analysis to Claude Code for screenshots and UIs.
...
- **Why use it:** Web UI for managing skills and MCP servers directly in DSH.
...
- **Why use it:** Ports the popular Superpowers skill to Reasonix coding harness.
...
- **Tags:** `mcp`, `skills`, `capability`
- **Why use it:** Unified capability management with dynamic exposure strategies for skills/tools
...
- **Why use it:** 25 ready-to-use engineering skills, 10x dev efficiency boost
...
- **Tags:** `agent`, `mentor`, `code-review`
- **Why use it:** AI coding mentor that guides architecture, generates chapters and reviews code
...
- **Why use it:** Full workflow government document processing with format validation and optimization
...
- **Tags:** `bazi`, `fengshui`, `iching`, `agent-skill`
- **Why use it:** Fusion of Bazi, Fengshui, IChing with visual dashboard
...
- **Why use it:** Engineering discipline bundle: grill requirements, test delivery
...
- **⭐ Stars:** 42
- **Language:** Python
- **Description:** 数学建模资源，包含辅助建模、数据预处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。��建者使用skill的大模型为deepseek harness v4.1 pro，但并非仅有dsh适配，skill内涵skill.md文件、README.md文件，reference文件夹及所需依赖，可以利用各种大模型agent进行安装，此外，库内还上传了数学建模workbench的自定义agent，涵盖着数学建模建模手，编程手，论文手三者分工流程及其他要点，使用该agent便于减少数学建模相关提示词的输入，配合各类skill能完成较为高质量的数学建模论文
- **Tags:** `math-modeling`, `paper-writing`, `skill`
- **Why use it:** Math modeling suite: preprocessing, plotting, paper writing, anti-AIGC
...
- **Why use it:** Spec-driven development skill inspired by DSH engineering patterns
...
- **Why use it:** Multi-agent team with durable members and cross-session memory
...
- **Why use it:** 5-role multi-agent math modeling with 33 models and paper templates
...
- **Why use it:** Pixel-to-text OCR skill for text-only LLMs, 34-image trained
...
- **Why use it:** Comprehensive QA testing skill framework for AI agents
...
- **Why use it:** Separates discussion from execution in AI collaboration
...
- **Tags:** `directorx`, `video`, `skills`
- **Why use it:** AI video/image/audio generation skills with configurable models
...
- **Tags:** `godot`, `game-dev`, `skills`
- **Why use it:** Full-stack Godot 4.x game dev skills registered at runtime
...
- **Tags:** `agent-skill`, `plugin-dev`, `development`
- **Why use it:** Essential skill kit for DSH plugin development, compatible with Claude Code and Codex
...
- **⭐ Stars:** 2
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起飞前��查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `agent-tools`, `dsh-plugin`, `automation`
- **Why use it:** Auto-prechecks and injects relevant plugins for DSH agents before tasks
...
- **Tags:** `skillhub`, `api`, `mcp`
- **Why use it:** Official SkillHub API with documentation and examples
...
- **Why use it:** One-click MCP, Skills and config setup for multiple AI agents
...
- **Why use it:** Local-first design agent with Figma-like prototyping.
...
- **Why use it:** 530+ image prompts and 20+ industrial templates for GPT Image.
...
- **Tags:** `agent`, `ui`, `vibedesign`, `flutter`, `react`
...
- **Why use it:** Legal case visualization toolkit generating timelines and court diagrams
...
- **Why use it:** Cinematic product video skill: 152 shot cards, Remotion templates, assets
...
- **Why use it:** Real logged-in browser automation for AI agents without workflow interruption
...
- **Tags:** `bilibili`, `content-discovery`, `self-hosted`, `privacy-first`
- **Why use it:** Local-first cross-platform content discovery agent for B站, YouTube, Reddit and more
...
- **Why use it:** Strongest free web search bridge for all models — no signup, no API key needed.
...
- **Why use it:** Persistent fingerprint-spoofed browser with unlimited profiles and Android emulation.
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset/custom/browser voices for DSH audio output
...
- **Tags:** `api-keys`, `secrets`, `proxy`, `mcp`
- **Why use it:** OpenRouter for agent tools — unified API key, credential and proxy registry
...
- **Tags:** `cli`, `credentials`, `multi-agent`, `deepseek-harness`
- **Why use it:** Multi-model account manager with smart routing, priority and auto failover across Codex/Claude
...
- **Tags:** `jailbreak`, `utilities`, `dsh-plugin`
- **Why use it:** Jailbreak all models with swappable per-model prompts.
...
- **Why use it:** Ecosystem radar scanning 21k+ candidates with k8s validation.
...
- **Tags:** `dsh-plugin`, `oauth`, `llm-provider`
...
- **Why use it:** Secure P2P remote access solution across PC, Android and web for Harness
...
- **Why use it:** Imports conversation history from 25+ AI coding agents as resumable sessions
...
- **Why use it:** Skill call auditing and in-app skill manager for DSH Cordis
...
- **Why use it:** Auto-upgrades DSH plugins along with the DSH framework version.
...
- **Why use it:** Backup, import, export, and sync all DSH configs and skills.
...
- **⭐ Stars:** 58
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管��官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **Tags:** `plugin-management`, `ui`, `console`
- **Why use it:** Official plugin registry console with zero patch required
...
- **Why use it:** Audits context token costs and detects conflicts in DSH
...
- **Tags:** `migration`, `utility`, `cli-tools`
- **Why use it:** Migration wizard for sessions and skills from Claude Code, Codex, etc.
...
- **Why use it:** Fast and elegant Neovim plugin manager written in pure Lua for DSH extension management
...
- **Why use it:** Complete engineering workflow: task stages, verification records, and commit checks
...
- **Why use it:** Comprehensive AI resource hub with tutorials and prompt大全.
...
- **Why use it:** Native Epistemic Loop plugin enabling systematic scientific discovery workflows.
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiments, and GPU SSH orchestration.
...
- **Why use it:** Cross-platform academic search across PubMed, arXiv, OpenAlex with citation graph
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `education`
...
- **Why use it:** Local financial database with multi-agent analysis and IM alert channels
...
- **Why use it:** Industry research domain pack with methodology and chain mapping.
...
- **Why use it:** Interactive multi-market K-line analysis with native sidebar
...
- **Tags:** `stock`, `analysis`, `quantitative`
- **Why use it:** Multi-market stock analysis with 39 tools and 20 strategy skills
...
- **Why use it:** Bilingual curated list of 24 verified stock/finance/quant plugins for financial research
...
- **Why use it:** Real-time token usage visualization, cost tracking, and API balance monitoring dashboard
...
- **Why use it:** Curated directory of DSH plugins, ideal for discovering top community tools
...
- **Why use it:** Beginner-friendly DSH tutorial from zero to production-ready skills
...
- **Tags:** `marketplace`, `web`, `ecosystem`
- **Why use it:** DSH Web plugin marketplace ecosystem with creative workshop distribution
...
- **Tags:** `novel-writing`, `ai-writing`, `dsh-plugin`
- **Why use it:** Organized workflow for AI novel writing with local & online models.
...
- **Tags:** `plugin-marketplace`, `dsh-plugin`
- **Why use it:** Comprehensive plugin marketplace refreshed daily with review.
...
- **Why use it:** Bilingual curated directory of DSH plugins, extensions, tools and verified references.
...
- **Tags:** `security`, `cybersecurity`, `vulnerability`, `redteam`
...
- **Tags:** `encyclopedia`, `ai-resources`, `mcp`, `learning`
- **Why use it:** Comprehensive AI encyclopedia: skills, MCP, RAG, multimodal tools and learning routes.
...
- **Why use it:** Curated plugin directory with daily GitHub scraping and scenario-based classification
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCP servers, and UIs
...
- **Tags:** `awesome`, `awesome-list`, `cordis`
...
- **Why use it:** Meticulously curated list of DSH plugins, extensions, and tools.
...
- **Tags:** `awesome-list`, `marketplace`, `ecosystem`
- **Why use it:** Community plugin marketplace catalog with auto-sync every 4 hours
...
- **Tags:** `awesome-list`, `directory`, `meta`
...
- **Why use it:** Comprehensive curated list and resource hub for the entire DSH plugin ecosystem
...
- **Why use it:** Curated plugin list with bilingual descriptions for DSH ecosystem discovery
...
- **Tags:** `awesome-list`, `plugin-directory`, `discoverability`
- **Why use it:** Public GitHub directory with install commands and ecosystem discovery features
...
- **Tags:** `awesome-list`, `curated`, `practical`
- **Why use it:** Curated collection of useful DSH plugins for practical daily development scenarios
...
- **Tags:** `verified`, `evidence-led`, `installation-guide`
...
- **Tags:** `awesome-list`, `ecosystem`, `categorized`
- **Why use it:** Curated DSH plugin ecosystem list covering CLI, web UI, and autonomous agent categories
...
- **Tags:** `curated-list`, `quality-check`, `2026`
- **Why use it:** 2026 quality-checked curated DSH plugin list for up-to-date ecosystem discovery
...
- **Why use it:** Comprehensive 1000+ plugin catalog sorted by stars for DSH ecosystem.
...
- **Why use it:** Verified and star-ranked community plugins for DeepSeek Harness.
...
- **Tags:** `directory`, `ai-curated`
- **Why use it:** 190+ AI-curated plugins across 12 categories, updated hourly.
...
- **Why use it:** Curated directory for installing and customizing DSH models and tools.
...
- **Tags:** `directory`, `curated`
- **Why use it:** Curated plugin collection for DSHA users.
...
- **Why use it:** Search DSH plugins directly inside agents via npm and curated lists.
...
- **Why use it:** Plugins directory with 80+ verified DSH plugins organized by function
...
- **Tags:** `dsh-plugins`, `repository`
- **Why use it:** DeepSeek Harness plugins repository for ecosystem exploration
...
- **Tags:** `archived`, `moved`
- **Why use it:** Moved to github.com/awesome-dsh-plugin — archived, redirect to new location

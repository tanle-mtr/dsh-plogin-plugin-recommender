...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 836,097 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 07:39:35 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 185,995 | Core harness enabling everything as a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,539 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,883 | Multi-agent swarm framework for autonomous workflo |
...
- **Why use it:** Core harness enabling everything as a plugin
...
- **Tags:** `routing`, `injector`, `reasoning-mode`, `agent-tools`
- **Why use it:** Runtime injector + task-aware reasoning mode router for DSH agents
...
- **Tags:** `agent-os`, `loop-engineering`, `self-improving`, `orchestration`
- **Why use it:** Self-improving Agent OS with loop engineering and LLM orchestration
...
- **Why use it:** Enterprise local-first agent workbench for multi-engine teams and visual editing
...
- **Tags:** `preset`, `bootstrap`, `standard-tools`, `configuration`
...
- **Tags:** `coding-agent`, `deepseek-harness`, `dsh-plugin`, `tui`
- **Why use it:** Claude Code-style TUI with streaming thought and status display.
...
- **Tags:** `agent-runtime`, `ai-coding`, `dsh-plugin`, `vibe-coding`
...
- **Tags:** `dsh-plugin`, `code-review`, `static-analysis`, `agent-skills`
- **Why use it:** AI code review based on 12 classic engineering books.
...
- **Why use it:** Makes AI coding agents architecture-aware with drift checking
...
- **Why use it:** Turns multiple coding agents into a coordinated team with dispatch capability
...
- **Why use it:** Agent skill for developing DSH plugins covering slots, tools, adapters, and packaging standards
...
- **Tags:** `dsh-plugin`, `agent-skill`, `plugin-development`
- **Why use it:** Agent skill for managing installed DSH plugin slots, Typert remotes, and credentials
...
- **Why use it:** One-tap Codex sync: import chats, skills & MCP bidirectionally.
...
- **Why use it:** Package manager for AI agent assets: 42 skills, 5 CLIs, 1 plugin.
...
- **Why use it:** Practical plugin dev documentation and troubleshooting archive
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins inside the harness
...
- **Why use it:** Pre-flight plugin check-in for DSH agents, auto-injects top-K relevant plugins
...
- **Tags:** `workspace`, `task-tracking`, `multi-device`, `no-code`
- **Why use it:** Unified agent workspace board with multi-device access and task tracking
...
- **Tags:** `web-ui`, `skin`, `gui`, `wallpaper-engine`
- **Why use it:** Web GUI skin ecosystem with WebGL optimization and Wallpaper Engine support
...
- **Why use it:** Open sidebar with third-party extension support and built-in tools.
...
- **Why use it:** Lightweight Tauri desktop client with preset plugins
...
- **Why use it:** Local-first desktop workspace with DSH integrations
...
- **Tags:** `floating-widget`, `cordis`, `dsh-plugin`
...
- **Tags:** `desktop-app`, `agent`, `tauri`, `dsh-plugin`
...
- **Why use it:** Live iOS Simulator with 22 agent tools for mobile app development inside DSH
...
- **Tags:** `ui`, `info-bar`, `pricing`, `tracking`
...
- **Tags:** `deepseek-harness`, `desktop`, `tauri`, `docker`, `ssh`
...
- **Tags:** `marketplace`, `plugin-discovery`
- **Why use it:** Dynamic plugin marketplace for browsing, searching, and installing DSH plugins.
...
- **Why use it:** LLM knowledge platform with RAG, agent reasoning, and self-maintaining wiki
...
- **Tags:** `memory`, `markdown`, `local-first`, `long-term-memory`
- **Why use it:** Portable local-first Markdown memory layer for cross-app AI agents
...
- **Tags:** `memory`, `token-savings`, `self-evolving`, `rag`
...
- **Tags:** `dsh-plugin`
- **Why use it:** Provides unlimited memory storage for OpenClaw agents
...
- **Tags:** `dsh-external`, `context-management`
- **Why use it:** Context insight dashboard for statistics and management
...
- **Tags:** `dsh-plugin`, `knowledge-base`, `plugin-development`
- **Why use it:** Installable plugin dev knowledge base as on-demand agent skill with official EN/ZH docs
...
- **Why use it:** Audits context injection costs, detects duplicates and conflicts.
...
- **Why use it:** Enables recall, memory handoff and skills integration via PowerContext server
...
- **Tags:** `deepseek-harness`, `claude-code`, `memory`, `bridge`
...
- **Tags:** `agent-skills`, `ai-persona`, `knowledge-distillation`
- **Why use it:** Digital life skill with knowledge distillation and AI persona
...
- **Tags:** `agent-skills`, `ai-agents`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `ai-workflow`, `automation`, `dsh-plugin`
- **Why use it:** General-purpose skill routing and workflow orchestration.
...
- **Tags:** `dsh-plugin`, `video-generation`, `ai-video`, `ffmpeg`
...
- **Tags:** `vision`, `agent-skills`, `computer-use`
- **Why use it:** Vision toolkit enabling text-only LLMs to see images
...
- **Tags:** `task-manager`, `mcp`, `agentic-workflow`
- **Why use it:** Human-in-loop task manager with mobile and web access
...
- **Tags:** `vision-tools`, `ocr`, `dsh-plugin`
...
- **Why use it:** Creative writing and short-drama production workflow plugin
...
- **Tags:** `agent-skills`, `skill-routing`, `semantic-search`
- **Why use it:** Curates SKILL.md files into retrieval-ready agent-skill corpora
...
- **Why use it:** 85 SKILL.md reverse engineering skill for authorized pentesting and security research
...
- **Tags:** `dsh-plugin`, `ai-coding`, `mentor`
- **Why use it:** AI coding mentor that scans projects, generates chapters, and provides code review
...
- **Tags:** `dsh-plugin`
- **Why use it:** WorkBuddy-style skill picker for DSH composer integration.
...
- **Why use it:** AI agent skill pack integrating Chinese traditional wisdom systems.
...
- **Why use it:** Multi-agent team collaboration with shared workspace and tools.
...
- **Why use it:** Manages DSH skills via web interface.
...
- **Why use it:** Swift Cycle governance skill adapter for DSH projects.
...
- **Tags:** `engineering`, `workflows`, `agent-skills`
...
- **⭐ Stars:** 12
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自���含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese-docs`
- **Why use it:** Complete Chinese official document processing with format checking and optimization
...
- **Tags:** `canvas`, `creative-skills`, `agentic`
- **Why use it:** Infinite canvas with creative skills for agentic AI workflows
...
- **Why use it:** Math modeling enhancement with 17 skill cards and preset system
...
- **Why use it:** Virtual product team preset guiding users through PM-to-engineer-to-QA workflow
...
- **Tags:** `agent-skills`, `ai-design`, `ui-generator`
...
- **Why use it:** 20+ industrial GPT-Image2 prompt templates with 470+ reverse-engineered cases
...
- **Tags:** `design`, `vector`, `agent-team`, `flutter`, `react`
...
- **Why use it:** AI-powered design system with visual editor, templates and PPT studio
...
- **Tags:** `ui`, `visual-editor`, `dsh-plugin`
...
- **Tags:** `image-generation`, `deepseek-harness`
...
- **Tags:** `legal-tech`, `visualization`, `diagram`, `timeline`
- **Why use it:** Legal litigation visualization tool: redraw case diagrams and generate accurate timelines
...
- **Why use it:** Design aesthetics skill pack to avoid AI-looking websites.
...
- **Tags:** `ai-video`, `ai-image`, `multimodal`
- **Why use it:** AI video/image/audio creation tools with configurable model support
...
- **Why use it:** Group photo wall for DSH内测 with OAuth login and whitelist.
...
- **Why use it:** OAuth binding to ChatGPT, enabling ChatGPT model chat inside DSH
...
- **Tags:** `image`, `electron-app`, `cloud-storage`
...
- **Tags:** `vfs`, `virtual-filesystem`, `python`, `typescript`
- **Why use it:** Unified virtual filesystem for AI agents enabling cross-tool file management
...
- **Why use it:** Fun web-based toy simulation, zero dependency single file.
...
- **Why use it:** Visual plugin marketplace for DSH with one-click install.
...
- **Why use it:** Plugin radar with 9000+ auto-discovered and curated entries.
...
- **Why use it:** Crash-rescue with undo, snapshots and one-click SAFE MODE
...
- **Why use it:** Community web GUI plugin market for browsing and installing plugins
...
- **Why use it:** Infrastructure plugin: thin console for DSH repository plugin management with development guide
...
- **Why use it:** Pixel-to-text image reading plugin with OCR and vision tools for text-only LLMs
...
- **Why use it:** Local DSH container manager: run multiple versions in isolated containers with one-click import
...
- **Why use it:** In-app GUI plugin manager with hot-reload, no restart needed
...
- **Tags:** `dsh-plugin`, `mcp`, `hot-reload`, `skill-management`
- **Why use it:** Hot-reload MCP server config and skill management via settings page
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `mcp`, `tools`
- **Why use it:** Unified control panel for MCP tool exposure and execution modes
...
- **Tags:** `deepseek-harness`, `token-usage`, `data-visualization`
...
- **Tags:** `pet`, `pixel-art`, `mascot`, `sprites`, `themes`
- **Why use it:** Public animated pet gallery with pixel art sprites for coding agents
...
- **Tags:** `themes`, `skins`, `dark-mode`, `customization`
- **Why use it:** 34 opencode classic themes with one-click switching, no restart needed
...
- **Tags:** `deepseek-harness`, `theme`, `background`, `ui`
- **Why use it:** Web background personalization with presets and image upload support
...
- **Tags:** `ai-guide`, `vibe-coding`, `llm-resources`
...
- **Why use it:** Beginner-friendly DSH tutorial covering harness engineering from scratch
...
- **Why use it:** Curated comprehensive plugin list for DeepSeek Harness ecosystem
...
- **Why use it:** Curated plugin discovery with daily auto-scan, fake plugin blacklist
...
- **Why use it:** Strongest free web search bridge for all DSH models without native access
...
- **Tags:** `knowledge-base`, `awesome-list`, `dsh-plugin`
...
- **Why use it:** Learn DSH principles, plugin marketplace browsing and best practices guide
...
- **Tags:** `awesome-list`, `guide`, `dsh-plugin`
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms across multiple agent frameworks
...
- **Tags:** `kline`, `technical-analysis`, `multi-market`
...
- **Why use it:** Curated 24-entry stock/finance/quant plugin list for DSH
...
- **Why use it:** Handpicked collection of useful DeepSeek Harness plugins
...
- **Why use it:** Plugin product manual and navigation guide by use case with risk info
...
- **Why use it:** Legacy plugin directory, migrated to awesome-dsh-plugin org
...
- **Why use it:** Bilingual evidence-led plugin directory reviewed at immutable commits

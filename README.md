...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 862,880 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 14:01:44 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 194,459 | Core DSH framework powering everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,351 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,365 | Deploy multi-agent swarms and coordinate autonomou |
...
- **Why use it:** Core DSH framework powering everything is a plugin
...
- **Why use it:** Best beginner tutorial for DSH from zero to one.
...
- **Why use it:** Enterprise multi-engine agent workbench; unified local-first workspace.
...
- **Why use it:** First vision plugin for DSH; turns images into structured JSON evidence.
...
- **Tags:** `agent-runtime`, `ide`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime with polished desktop IDE experience.
...
- **Tags:** `code-review`, `agent-skill`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `ai-coding`, `dsh-plugin`, `spec-programming`
- **Why use it:** Repository-native spec-driven development for coding agents
...
- **Tags:** `plugin-development`, `cordis`, `audit`
...
- **Why use it:** Plugin development best practices and known issues archive.
...
- **Why use it:** Build and test DSH plugins entirely within the agent
...
- **Tags:** `skills`, `prompt-engineering`, `workflow-automation`
- **Why use it:** 530+ prompt templates distilled into reusable skills for image generation
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `no-code`, `multi-device`
- **Why use it:** Unified agent workspace across all devices; task boards and multi-access.
...
- **Why use it:** Agent OS that self-improves; grading loop without leaking answers.
...
- **Why use it:** Intelligent skill routing and workflow orchestration for harness.
...
- **Why use it:** Multi-agent team collaboration for complex DSH tasks
...
- **Tags:** `workflow`, `organization`, `chat`
...
- **Why use it:** Vision toolkit for text-only models: OCR, image Q&A, screenshots
...
- **Why use it:** Specialized workflow for novel writing and short drama creation
...
- **Why use it:** Turns experience into repeatable execution across AI agents
...
- **Why use it:** Auto-searches, installs and verifies DSH GitHub plugins
...
- **Why use it:** Superpowers TDD and debugging skills ported to Reasonix
...
- **Tags:** `agent-skills`, `deep-research`, `market-research`, `social-listening`
- **Why use it:** 88 open-source skills for research, social intel, and marketing
...
- **Tags:** `agent-skills`, `dsh-plugin`, `llm-agent`, `skill`
- **Why use it:** Standard workflow and guidance for developing DSH plugins
...
- **Why use it:** Manage plugin slots, credentials, and remote services via agent
...
- **Tags:** `dsh-plugin`, `chinese-traditional-wisdom`
- **Why use it:** Unique Chinese wisdom skill: Bazi, Fengshui, TCM and IChing integration
...
- **Tags:** `dsh-plugin`
- **Why use it:** Adapted DSH code simplification skill for Codex workflow improvement
...
- **Why use it:** Free image reading & generation with auto vision transcription for DSH.
...
- **Why use it:** Full Chinese official document processing with format check and optimization.
...
- **Why use it:** Game-like mission system with fog-of-war map and task bar推进.
...
- **Why use it:** Adds full-stack Godot 4.x game dev skills to DSH agents
...
- **Why use it:** Infinite canvas with creative AI skills for WeShop
...
- **Why use it:** Simulates product team workflow from PM to QA for project management
...
- **Why use it:** Binds ChatGPT account via OAuth to use ChatGPT models in DSH
...
- **Why use it:** Plugin marketplace for DSH
...
- **Why use it:** Manage skills and MCP servers directly from the DSH Web GUI settings.
...
- **Why use it:** MCP server and skill for Zhihu search and Zhida API integration.
...
- **Why use it:** Paste JSON to connect MCP servers with hot-reload, no restart needed.
...
- **Tags:** `architecture-diagram`, `mermaid-alternative`, `text-to-diagram`
...
- **Why use it:** Generate AI images directly within DSH chats
...
- **⭐ Stars:** 43
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，���直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `agent-skills`, `diagram`, `legal`, `svg`, `visualization`
- **Why use it:** Convert litigation materials into clear timeline and case diagrams
...
- **Tags:** `dsh-plugin`, `design-skills`
- **Why use it:** 6 design style presets to make vibe-coded sites stand out from generic AI look
...
- **Why use it:** Privacy-first cross-platform content discovery agent for Chinese platforms.
...
- **Why use it:** Build, run and interact with Android emulators inside conversation
...
- **Why use it:** Tabbit Browser automation with Playwright for web tasks
...
- **Why use it:** OCR and image-to-text tools for vision-capable text-only models
...
- **⭐ Stars:** 17
- **Language:** HTML
- **Description:** DSH 内测收官合影墙：GitHub OAuth 零权限登录 + 冻结白名单校���的拍立得合影站（含 DSH Skill 包装）
- **Tags:** `community`, `social`, `dsh-plugin`
- **Why use it:** Community group photo wall with GitHub OAuth and Polaroid style.
...
- **Why use it:** DingTalk IM integration for DSH
...
- **Tags:** `router`, `injector`, `agent-tooling`
- **Why use it:** Runtime injector + task-aware router for optimized reasoning modes.
...
- **Why use it:** Unified virtual filesystem for AI agents; abstracts local/remote storage.
...
- **Tags:** `dsh-plugin`, `multi-model`
- **Why use it:** Multi-model one-click switch hub covering major AI coding tools.
...
- **Why use it:** Context dashboard and management with visualization browser
...
- **Why use it:** Track session and daily API costs with budget alerts
...
- **Tags:** `marketplace`, `plugin`, `nodejs`
...
- **Why use it:** Crash recovery, undo config changes, one-click safe mode
...
- **Why use it:** Web UI tool for managing skills and MCP configurations
...
- **Tags:** `console`, `dsh-plugin`, `plugin-management`, `ui`
- **Why use it:** Plugin management console and development guide for DSH
...
- **Tags:** `dsh-plugin`, `config-manager`
...
- **Tags:** `migration`, `agent-migration`, `utilities`
- **Why use it:** Migrate Claude Code/Codex/OpenCode configs into DSH
...
- **Tags:** `utilities`, `conflict-resolution`, `maintenance`
...
- **Tags:** `utilities`, `checklist`, `agent-tools`
- **Why use it:** Pre-flight plugin check for agents to ensure optimal tool selection
...
- **Why use it:** Search and discover DSH plugins
...
- **Why use it:** Gallery of animated mascot pets for multiple coding agent platforms.
...
- **Why use it:** Cute whale girl visual skin series for DeepSeek Harness.
...
- **Tags:** `theme`, `ocean-skin`, `webgpu`, `chrome-extension`
- **Why use it:** Stunning WebGPU ocean-themed skin for DSH
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** 34 opencode themes with one-click apply and no reset on restart.
...
- **Tags:** `dsh-plugin`, `awesome-deepseek-harness`
- **Why use it:** Interactive K-line financial analysis with multi-market and technical indicators
...
- **Tags:** `engineering`, `practices`, `evidence`
- **Why use it:** Engineering discipline distilled from DSH development experience.
...
- **Why use it:** Public directory with install commands and ecosystem guides
...
- **Tags:** `awesome-list`, `verified`, `permissions`
...
- **Why use it:** Curated stock/finance/quant plugin list for investment research
...
- **Why use it:** Verified star-ranked community plugin directory for discovery
...
- **Why use it:** Plugin documentation and navigation guide by use case scenarios
...
- **Why use it:** Comprehensive DSH plugin repository and ecosystem overview
...
- **Tags:** `awesome-list`, `official`, `directory`
- **Why use it:** Official awesome-dsh plugin directory (redirect to new location)
...
- **Why use it:** Automated daily-crawled bilingual plugin catalog via GitHub Actions
...
- **Why use it:** Curated DSH plugin directory
...
- **Why use it:** Comprehensive DSH plugin listing
...
- **Why use it:** Curated DSH resources and plugins
...
- **Tags:** `curated`, `ui`, `agents`
- **Why use it:** Extend DSH with curated plugins
...
- **Tags:** `industry`, `curated`
- **Why use it:** Industry-specific DSH plugins
...
- **Why use it:** AI + no-code platform for rapid business system development
...
- **Why use it:** Comprehensive AI resource library and Vibe Coding tutorial
...
- **Why use it:** Curated plugin list — essential discovery hub for DSH ecosystem.
...
- **Tags:** `game`, `toy`, `dsh-plugin`
- **Why use it:** Fun traditional toy simulation — web-based, zero-dependency single file.
...
- **Tags:** `awesome-list`, `ecossystem`, `curated`
...
- **Why use it:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊��、磨砂度、背景
...
- **Why use it:** ccteam turns the coding agents you already run (Claude Code, Codex, Grok, Kimi, 
...
- **Why use it:** DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破
...
- **Tags:** `awesome-list`, `dsh-plugin`, `mcp`, `plugins`
- **Why use it:** Large curated catalog of DSH plugins, skills, MCP servers and UIs
...
- **Why use it:** 3,100+ plugin marketplace with search, rankings and public API
...
- **Why use it:** DSH plugin marketplace and catalog browser

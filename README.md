...
|--------|-------|
| **Plugins tracked** | 199 |
| **Total community stars** | 1,041,627 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-17 07:27:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 227,136 | The foundational DSH framework enabling plugin-bas |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,633 | Local-first design plugin turning coding agents in |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,656 | Deploy multi-agent swarms with autonomous workflow |
...
- **Why use it:** The foundational DSH framework enabling plugin-based AI agent orchestration.
...
- **Why use it:** Self-improving agent OS with gated evaluation loops
...
- **Why use it:** One-click install and model switch across 8+ coding agent frameworks
...
- **Why use it:** CLI tool for DSH Plugin Hub management and schemas
...
- **Why use it:** Auto-discovers, installs and verifies DSH plugins via GitHub skill integration
...
- **Tags:** `migration`, `import`, `claude-code`
- **Why use it:** Migration wizard from Claude Code, Codex, OpenCode and Hermes to DSH.
...
- **Why use it:** Modern desktop solution where the desktop itself is a plugin for DSH ecosystem.
...
- **Tags:** `taskboard`, `cli`, `dsh-plugin`, `skills`
- **Why use it:** Modern flexible task board embeddable in Codex and DSH workflows
...
- **Why use it:** Claude Code-inspired TUI with whale bar, streaming thoughts and rollback
...
- **Tags:** `floating-widget`, `dsh-plugin`, `balance-monitor`
- **Why use it:** Cute floating whale widget monitoring DeepSeek balance with drag-and-drop and animations.
...
- **Tags:** `agent-runtime`, `desktop-app`, `ai-coding`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for AI coding.
...
- **Why use it:** Lightweight Tauri desktop client for DSH — only 5MB installer, zero setup required.
...
- **Why use it:** Desktop AI novel writing app organizing inspiration, characters, worldbuilding, and drafting.
...
- **Why use it:** Windows desktop client with GUI, SSH, Codex and plugin support.
...
- **Why use it:** Local-first desktop workspace for sessions, projects and Office artifacts.
...
- **Tags:** `canvas`, `conversation`, `non-linear`, `workspace`
- **Why use it:** Visual non-linear canvas for branching conversation exploration and sessions.
...
- **Tags:** `agent`, `desktop`, `privacy`, `local-first`
- **Why use it:** Local-first AI agent desktop with self-evolving skills
...
- **Why use it:** Native mobile client for DeepSeek Harness on iOS/Android
...
- **Why use it:** Cross-platform desktop client inspired by CodePilot
...
- **Why use it:** Community plugin marketplace in DSH web GUI with one-click install
...
- **Tags:** `plugin-mgmt`, `ui`, `infrastructure`
...
- **Tags:** `skills`, `manager`, `ui`
- **Why use it:** Unified local agent skill loader with安全管理 in DSH
...
- **Tags:** `desktop`, `devops`, `ssh`, `docker`, `ai-assistant`
- **Why use it:** All-in-one DevOps desktop: DB, SSH, SFTP, Docker, AI tools
...
- **Why use it:** Electron desktop shell integrating multiple DSH web tools
...
- **Why use it:** Adds a compact one-click button to the DSH Web context meter panel
...
- **Why use it:** Open-source RAG platform with semantic search, reasoning agents, and self-maintaining wiki.
...
- **Tags:** `agent-memory`, `rag`, `markdown`, `local-first`
...
- **Tags:** `memory-library`, `stateful-agents`, `context-engineering`
...
- **Why use it:** Dedicated memory management kit with RAG-backed agent recall
...
- **Why use it:** Persistent unified memory layer for agents backed by Milvus vector DB
...
- **Tags:** `memory`, `RAG`, `personal-agent`
- **Why use it:** Personal AI memory hub giving every agent shared persistent context and long-term memory.
...
- **Why use it:** Best context insight and management tool with dashboard, browser, and sidebar for DSH.
...
- **Why use it:** Transforms SKILL.md files into searchable corpora with retrieval and evaluation.
...
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, MCP, RAG and more.
...
- **Why use it:** Deploy multi-agent swarms with autonomous workflows and conversational AI.
...
- **Why use it:** Self-evolving multi-agent harness with memory, skills, and multi-model support.
...
- **Tags:** `knowledge-distillation`, `skills`, `agent-persona`
- **Why use it:** Distill expert knowledge into reusable AI agent skills and personas.
...
- **Tags:** `low-code`, `internal-tools`, `workflow`
- **Why use it:** AI-powered no-code platform for rapidly building custom business systems and dashboards.
...
- **Tags:** `agent-orchestration`, `task-tracking`, `cross-device`
- **Why use it:** Cross-device agent orchestration with task tracking boards
...
- **Tags:** `skills-marketplace`, `curation`, `auto-update`
- **Why use it:** Largest curated skills marketplace with auto-updating catalog
...
- **Tags:** `agent-skills`, `workflow-automation`, `prompt-engineering`, `dsh-plugin`
...
- **Why use it:** End-to-end automated video generation skill turning topics into polished Vox-style explainers.
...
- **Why use it:** Auto-searches China's top 8 platforms for recent 30-day content and generates cited research reports.
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, OCR, and UI restoration in one line.
...
- **Why use it:** Gives agents eyes and ears — video, audio and screen analysis with verifiable evidence.
...
- **Tags:** `writing`, `creative`, `novel`, `workflow`
- **Why use it:** Built-in workflows for novel, drama, game and video writing
...
- **Tags:** `taskboard`, `sqlite`, `local`
- **Why use it:** Native local task management with SQLite backend
...
- **Why use it:** Complete math modeling competition workflow with GitOps pipeline and code self-verification
...
- **Why use it:** Enable composable task controls and human-reviewed self-evolving agent loops
...
- **Tags:** `agent-skills`, `deepseek-harness`, `claude-code`
- **Why use it:** Turn experience into repeatable execution across Claude, Codex and DSH
...
- **Why use it:** 88 production-ready agent skills for research, marketing and business workflows
...
- **Tags:** `dsh-plugin`, `skills`, `ai-infra`
- **Why use it:** Specialized skills for AI infra: write, optimize and debug high-performance systems
...
- **Why use it:** AI coding mentor with step-by-step chapters and auto-grading
...
- **Tags:** `web-search`, `research`, `multi-agent`
- **Why use it:** Comprehensive web search and research skills for multi-agent platforms
...
- **Tags:** `skills`, `deck`, `engineering`
- **Why use it:** 25 ready-to-use engineering skills in a right-panel deck, zero config
...
- **Why use it:** Full GB/T 9704 compliant government document processing with format check
...
- **Tags:** `spec`, `development`, `workflow`
- **Why use it:** Portable spec-driven development skill aligned with DSH engineering patterns
...
- **Tags:** `skill-picker`, `ui-enhancement`
...
- **Why use it:** Official SkillHub open API with documentation and examples for DSH.
...
- **Why use it:** Math modeling competition multi-agent with 5 roles, 33 models and templates.
...
- **Why use it:** Full-stack Godot 4.x game development skill with GDScript support.
...
- **Why use it:** Standard guide for building DSH plugins, skills, and tools
...
- **Why use it:** Free web search bridge for models without native web access, no signup.
...
- **Why use it:** Official Huawei Cloud MCP tools, skills and cloud sandbox for agents
...
- **Why use it:** Local-first design plugin turning coding agents into creative designers.
...
- **Why use it:** 530+ prompt templates and cases for GPT Image generation with workflow automation.
...
- **Tags:** `design-tool`, `vector`, `agent-team`
...
- **⭐ Stars:** 3,975
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本��型外挂视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `multimodal`, `dsh-plugin`
- **Why use it:** First vision/OCR plugin bridging text-only agents to image input
...
- **Why use it:** AI-powered design studio with editable systems, templates, and native PPT creation for DSH.
...
- **Tags:** `gui`, `charts`, `interactive`, `ui-components`
...
- **Why use it:** Generate litigation timelines, relationship diagrams and court prep visuals
...
- **Why use it:** Multi-AI chat management extension with prompt manager
...
- **Why use it:** Use your real logged-in browser for AI agent web automation tasks
...
- **Tags:** `browser`, `automation`, `fingerprint`, `proxy`
...
- **Why use it:** Live iOS Simulator and USB iPhone automation in conversation
...
- **Tags:** `bilibili`, `content-discovery`, `privacy-first`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent covering B站,小红书,抖音,YouTube等
...
- **Why use it:** Privacy-focused resume builder with MCP server integration and customization.
...
- **Why use it:** Universal image uploader supporting 60+ hosting services including S3 and GitHub.
...
- **Why use it:** Essential marketplace for discovering and installing DSH plugins
...
- **Tags:** `agent-sandbox`, `virtual-terminal`, `vfs`, `dsh-plugin`
...
- **Tags:** `security`, `redteam`, `audit`, `vulnerability`
...
- **Tags:** `oauth`, `subscriptions`, `providers`
- **Why use it:** Use subscription accounts as LLM providers without API keys
...
- **Tags:** `cost`, `tracking`, `budget`
- **Why use it:** Track session costs, budgets and provider usage history
...
- **Tags:** `provider`, `command-code`, `models`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `remote`
- **Why use it:** Secure P2P multi-device remote access with end-to-end encryption for DSH
...
- **Why use it:** Automatically upgrades plugins when DSH version updates
...
- **Why use it:** Backup and restore full DSH configuration via WebDAV sync
...
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill and MCP orchestration for extensibility.
...
- **Why use it:** Free Xiaomi MiMo TTS API with custom and browser voices
...
- **Tags:** `troubleshooting`, `conflict-resolution`, `utilities`
- **Why use it:** Resolves plugin and version conflicts with solutions
...
- **Tags:** `mascot`, `pixel-art`, `animated-pets`, `ui-theme`
- **Why use it:** Public animated pet gallery for diverse coding agent harnesses
...
- **Why use it:** Adorable whale girl skin series to customize and beautify your DSH interface.
...
- **Why use it:** Frosted glass theme with fully customizable blur,磨砂度和动态壁纸支持。
...
- **Tags:** `skin`, `animated`, `ocean`, `chrome-extension`
...
- **Why use it:** Custom backgrounds with presets, WYSIWYG preview and save
...
- **Tags:** `ai-tutorial`, `prompt-engineering`, `research`
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and multi-model coverage.
...
- **Tags:** `deepwiki`, `documentation`, `dsh-plugin`
- **Why use it:** Turn codebases into accurate technical docs and AI-ready context quickly
...
- **Tags:** `awesome-list`, `discovery`, `tutorials`
- **Why use it:** Auto-curated plugin discovery with ratings and tutorials
...
- **Tags:** `awesome-list`, `visualization`, `reference`
- **Why use it:** Curated list visualization for DSH plugins and tools
...
- **Tags:** `guide`, `reference`, `quickstart`
- **Why use it:** Ultimate guide with quickstart resources and toolkit reference
...
- **Why use it:** Essential beginner guide for DSH principles and plugin marketplace exploration
...
- **Why use it:** Cross-source academic search with MeSH, citation verification and graph support
...
- **Tags:** `plugin-catalog`, `marketplace`, `awesome-list`
- **Why use it:** Massive 11,000+ plugin catalog with search, rankings and free public API
...
- **Why use it:** Comprehensive 173-source handbook covering runtime, plugins, MCP and sandbox
...
- **Tags:** `plugin-catalog`, `awesome-list`, `dsh-plugins`
- **Why use it:** 1958-repo plugin catalog with bilingual search, filtering and STAR rankings
...
- **Tags:** `agent-skills`, `mcp`, `deepseek-harness`
- **Why use it:** Tushare-based financial database with multi-agent analysis and IM alert integration
...
- **Why use it:** Industry research methodology with chain mapping and policy tracking
...
- **Why use it:** Search 65,600+ API docs across 20 Chinese open platforms instantly
...
- **Why use it:** Patent infringement analysis system with competitor report generation
...
- **Why use it:** Spam-filtered open-data registry of verified DSH plugins
...
- **Why use it:** Evidence-led curated directory with permission-aware installation
...
- **Tags:** `awesome-list`, `inventory`, `discovery`
- **Why use it:** Complete DSH tool inventory sorted by stars from 1000+ repos
...
- **Why use it:** Curated DSH plugin ecosystem discovery list
...
- **Why use it:** Beginner-friendly DSH framework tutorial from zero
...
- **Tags:** `plugin-aggregator`, `web-ecosystem`, `distribution`
- **Why use it:** Web-based plugin aggregation ecosystem hub
...
- **Tags:** `ecosystem`, `plugin-discovery`, `validation`
- **Why use it:** Ecosystem radar discovering and continuously validating 21k+ DSH plugin candidates.
...
- **Why use it:** Curated collection of DSH plugins, tools, and infrastructure from community and hub.
...
- **Why use it:** Comprehensive curated plugin list covering CLI, web UI, and coding agent ecosystems.
...
- **Tags:** `marketplace`, `plugin-curation`, `deepseek-harness`
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-reviewed listings.
...
- **Why use it:** Brings office documents, spreadsheets and tables into Harness
...
- **Tags:** `awesome-list`, `ecsystem`
- **Why use it:** Meticulously curated DSH plugin and tool ecosystem list
...
- **Tags:** `docs`, `knowledge-base`, `scaffold`
- **Why use it:** Installable plugin development knowledge base with official docs archive
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated list of精选 DeepSeek Harness plugins with descriptions.
...
- **Why use it:** Comprehensive curated awesome list of plugins, tools, skills and resources.
...
- **Why use it:** Star-ranked community-curated plugin directory for DSH
...
- **Why use it:** Bilingual plugin guide with installation and compatibility info
...
- **Tags:** `dsh-plugins`
- **Why use it:** Curated collection of DSHA精选插件合集
...
- **Tags:** `plugin-portal`, `github-pages`, `web`
- **Why use it:** Zero-dependency static web portal to browse and install 227+ DSH plugins
...
- **Why use it:** Redirect notice; refers to primary awesome-dsh-plugin repository.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `bilingual`
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Minimal DSH plugin listing repository.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `bilingual`, `ai-agents`

...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,061,151 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 229,989 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,090 | Open-source Claude Design alternative; local-first |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,865 | Deploy multi-player agent swarms with autonomous w |
...
- **Why use it:** Core DSH platform enabling everything-as-plugin architecture for AI agent development.
...
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for continuous operation.
...
- **Tags:** `workspace`, `task-tracking`, `multi-device`
...
- **Tags:** `enterprise`, `multi-engine`, `workbench`
- **Why use it:** Enterprise multi-engine workspace for Codex/DeepSeek
...
- **Why use it:** First vision plugin for DSH—paste images, get structured JSON.
...
- **Tags:** `agent-sandbox`, `virtual-terminal`, `dsh-plugin`
- **Why use it:** World's first virtual terminal giving agents isolated workspaces.
...
- **Tags:** `agent-skills`, `inference-control`, `dsh-plugin`
...
- **Tags:** `agent-teams`, `collaboration`, `plugin`
- **Why use it:** Enables multi-agent collaboration within DeepSeek Harness seamlessly
...
- **Tags:** `skill-audit`, `skill-manager`, `dsh-plugin`
- **Why use it:** Skill invocation audit and in-app skill manager for DSH
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms directly in your AI agent
...
- **Tags:** `plugin-creator`, `harness-tools`, `coding-agent`
...
- **Why use it:** Engineering discipline bundle: grill requirements, test, and prove delivery before shipping.
...
- **Tags:** `ui-generator`, `desktop-app`, `design-systems`
- **Why use it:** Open-source Claude Design alternative; local-first desktop app for AI-powered UI design.
...
- **Why use it:** Modern desktop solution for DSH ecosystem; treats the desktop itself as a plugin.
...
- **Tags:** `desktop`, `client`, `official`
- **Why use it:** Official DSH desktop client application
...
- **Why use it:** Open sidebar foundation with built-in file, terminal, Git pages.
...
- **⭐ Stars:** 2,742
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你��dsh安装
- **Tags:** `widget`, `ui`, `balance`
- **Why use it:** Cute floating whale widget tracking DeepSeek balance with smooth animations
...
- **Why use it:** Lightweight Tauri desktop app with zero setup and preset plugins included
...
- **Why use it:** Zero-setup Windows desktop GUI for DSH with SSH and remote access.
...
- **Why use it:** Local-first desktop workspace for DSH sessions, projects and Office.
...
- **Tags:** `desktop-app`, `local-first`, `mcp`
- **Why use it:** Local-first AI agent desktop app with multi-model and self-evolving skills.
...
- **Why use it:** CodePilot-inspired desktop client and plugin suite for DSH on all platforms
...
- **Why use it:** Adds multimodal vision to text-only LLMs for UI and screenshot analysis
...
- **Tags:** `notes`, `desktop-app`, `docker`
- **Why use it:** Open-source Smartisan-style notes app with DSH plugin and Docker support
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI tool for managing skills and MCP servers
...
- **Why use it:** Community plugin market browser with one-click install for Web GUI
...
- **Tags:** `desktop-app`, `electron`, `ui`, `dsh-plugin`
- **Why use it:** Electron desktop console for multi-tab DSH/Plugin/MCP/Skill management
...
- **Tags:** `workbench`, `typescript`, `agent-platform`
- **Why use it:** Plugin-based web workbench on DSH with global skill management and workspace integration
...
- **Why use it:** Desktop bioinformatics agent built on Tauri with offline mode and skill store.
...
- **Tags:** `ui`, `information-bar`, `usage-tracking`
...
- **Tags:** `context`, `auditing`, `ui`
- **Why use it:** Context injection auditor with token cost stats, duplicate detection and Web UI panel.
...
- **Why use it:** Electron desktop shell integrating DSH web, sidebar, ModLens, and awesome plugin ecosystem
...
- **Why use it:** One-click compact context toggle for improved readability.
...
- **Why use it:** Self-evolving context database unifying agent memory, knowledge RAG, and skill storage.
...
- **Why use it:** Open-source LLM knowledge platform turning documents into RAG, agents, and self-maintaining Wiki.
...
- **Tags:** `memory`, `rag`, `markdown`
- **Why use it:** Portable Markdown-native memory layer for AI agents
...
- **Tags:** `memory`, `token-optimization`, `self-evolving`
...
- **Tags:** `memory`, `stateful`, `library`
- **Why use it:** Stateful agent memory library for persistent context
...
- **Why use it:** Memory management kit enabling agents to remember and refine.
...
- **Why use it:** Persistent unified memory layer backed by Milvus with semantic search
...
- **Why use it:** Personal AI agent hub providing shared persistent memory across all agents
...
- **Tags:** `agent-memory`, `embeddings`, `skill-routing`
- **Why use it:** Builds retrieval-ready skill corpora with semantic search and reranking.
...
- **Tags:** `knowledge-base`, `mcp`, `skills`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering skills, MCP and RAG.
...
- **Why use it:** Zero-prompt proactive memory with three-layer auto-consolidation for DSH
...
- **Why use it:** Official DSH docs archive with EN/ZH knowledge base for plugin development.
...
- **Tags:** `skillhub`, `documentation`, `api`
- **Why use it:** Official SkillHub open API docs and examples for DeepSeek Harness plugin integration.
...
- **Why use it:** Deploy multi-player agent swarms with autonomous workflows and conversational AI coordination.
...
- **Why use it:** Self-evolving multi-agent harness with memory, task planning, and cross-platform model support.
...
- **Why use it:** Distill expert thinking patterns into reusable skills for any agent or bot.
...
- **Why use it:** Injector + router kit for task-aware agent reasoning
...
- **Tags:** `skills`, `marketplace`, `categorization`
- **Why use it:** Most comprehensive skills marketplace with auto-classification
...
- **Tags:** `agent-os`, `evaluation`, `self-evolving`
- **Why use it:** Self-evolving agent OS with evaluation loop and MCP
...
- **Why use it:** Long-horizon control plane for durable governed workflows
...
- **Why use it:** Organized novel writing pipeline with worldbuilding and chapter management
...
- **Why use it:** Gives AI agents visual/audio perception with timestamped evidence
...
- **Why use it:** Complete creative writing workflow for novels and short dramas
...
- **Why use it:** Native local taskboard with SQLite, agent claim/review and web UI
...
- **Why use it:** Full-stack auto math modeling skill for national/international competitions
...
- **Why use it:** Composable self-evolving agent modes with human review and isolation
...
- **Why use it:** Reusable agent skill architecture across Claude Code, Codex, and DSH
...
- **Tags:** `agent-learning`, `skill-generator`, `automation`
...
- **Tags:** `agent-skills`, `web-search`, `mcp`, `integration-discovery`
- **Why use it:** You.com web search and research skills for AI agents across multiple platforms
...
- **Why use it:** AI coding mentor that guides you through architecture review and code writing
...
- **Tags:** `skills`, `agent`, `dsh-plugin`, `wayfinder`
- **Why use it:** 25 ready-to-use engineering skills bundled in a convenient DSH side panel
...
- **Tags:** `patent`, `rag`, `legal-tech`, `multi-agent`
- **Why use it:** Patent infringement analysis skill generating competitor reports from publication numbers
...
- **Tags:** `skills`, `dsh-plugin`, `plugin-management`
- **Why use it:** Unified loader and manager for local Agent Skills within DSH safely
...
- **Why use it:** Full workflow tool for Chinese official document creation and formatting compliance
...
- **Tags:** `agent-skills`, `spec-programming`, `workflow`
- **Why use it:** Portable agent skill for spec-driven development with DSH engineering patterns.
...
- **⭐ Stars:** 39
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六��/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `chinese-wisdom`, `agent-skill`, `dashboard`
- **Why use it:** Fusion AI Agent skill covering Bazi, Fengshui, IChing and TCM with local engine.
...
- **Why use it:** Professional QA skill framework with 11 skills, shared KB, and type decision matrix.
...
- **Why use it:** Durable multi-agent system where members retain memory, notes and skills across sessions.
...
- **Why use it:** WorkBuddy-style skill picker for DSH composer with /skill-name shortcut insertion.
...
- **Why use it:** Agent Skill for building DSH plugins with standardized workflows for services, tools, and adapters
...
- **Tags:** `finance`, `mcp`, `stock-analysis`
- **Why use it:** Tushare-based financial database with MCP and multi-channel alerting
...
- **Why use it:** OAuth-binding plugin to chat with ChatGPT models inside DSH.
...
- **Why use it:** Generate beautiful architecture, sequence, and data-flow diagrams as self-contained HTML.
...
- **Tags:** `image-prompts`, `skills`, `workflow-automation`
- **Why use it:** 530+ GPT Image prompt cases with 20+ industrial templates and reusable skills for image generation.
...
- **Why use it:** First open-source AI vector design tool with Agent Teams
...
- **Why use it:** Native design studio with AI-generated visuals, templates, and PPT creation
...
- **Why use it:** Interactive UI components — charts, plots, forms rendered inline.
...
- **Why use it:** Visual litigation toolkit: timelines, case diagrams, and relationship maps for lawyers
...
- **Why use it:** Pixel-to-text OCR and vision tools designed for text-only LLMs.
...
- **Why use it:** AI video/image/audio generation plugin with storyboard and configurable model tools.
...
- **Why use it:** Transforms chat history into beautiful downloadable cards.
...
- **Why use it:** Two-phase preset ensuring minimal bootstrap then full tools.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `multi-agent`
...
- **Why use it:** Ecosystem radar with continuous discovery and k8s-validated plugin quality
...
- **Why use it:** Comprehensive context dashboard and management toolkit for DSH
...
- **Tags:** `cybersecurity`, `redteam`, `ai-security`
- **Why use it:** Shields AI code against hallucinated packages and security flaws.
...
- **Why use it:** CLI and schema resolver for managing DSH plugin hub ecosystems.
...
- **Tags:** `remote-access`, `encryption`, `infrastructure`
- **Why use it:** P2P encrypted remote access for DSH across PC, Android, and Web
...
- **Why use it:** Runs unmodified Pi extensions as native DSH plugins via compatibility layer
...
- **Tags:** `plugin-discovery`, `automation`, `utilities`
- **Why use it:** Discovers, installs, and verifies DSH plugins from GitHub automatically
...
- **Why use it:** Backup, restore, sync and migrate complete DSH configurations
...
- **Tags:** `capability`, `management`, `utilities`
- **Why use it:** Unified capability management with tiered exposure strategies
...
- **Why use it:** Lightweight browser console for plugin management and official development guide
...
- **Why use it:** Fast and elegant Neovim plugin manager written in Lua, essential for Vim users
...
- **Why use it:** Curated DSH plugin collection with task notifications, LLM traces, keybindings, and terminal
...
- **Why use it:** Free Xiaomi MiMo TTS API integration supporting preset, custom, and browser内置 voices
...
- **Tags:** `debug`, `conflict-resolution`, `utility`
- **Why use it:** Diagnoses and resolves plugin conflicts and version incompatibilities in DSH ecosystem
...
- **Tags:** `pre-flight`, `checklist`, `utility`
...
- **Why use it:** Adorable animated pets that personalize your coding agent.
...
- **Why use it:** Adorable whale girl skin series enhancing DSH visual experience
...
- **Tags:** `theme`, `glass-morphism`, `ui`
- **Why use it:** Glass-morphism theme with fully adjustable frosted blur and wallpaper.
...
- **Tags:** `animated-background`, `glassmorphism`, `ocean-skin`
- **Why use it:** Stunning animated ocean theme with glassmorphism effects
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语���面。
- **Tags:** `background`, `theme`, `webui`
- **Why use it:** Customizable backgrounds with preset themes and real-time preview.
...
- **Tags:** `content-discovery`, `cross-platform`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery from B站, YouTube, Reddit etc.
...
- **Why use it:** Generate accurate technical docs and AI-ready context from code.
...
- **Tags:** `arxiv`, `latex`, `experiment-tracking`
- **Why use it:** Full-cycle research workbench: LaTeX, arXiv, experiments, GPU SSH.
...
- **Tags:** `awesome-list`, `plugin-marketplace`, `curation`
- **Why use it:** Curated plugin marketplace with daily GitHub scanning and reviews
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCPs and tools
...
- **Why use it:** Learn DSH principles, explore plugin marketplace and best practices
...
- **Why use it:** Comprehensive academic search across PubMed, arXiv, CrossRef with citation verification
...
- **Why use it:** Industry research methodology with company mapping and news tracking
...
- **Why use it:** Real-time token usage tracking, cost estimation, and API balance visualization via web plugin
...
- **Why use it:** Privacy-first open-source resume builder, customizable and self-hostable forever free.
...
- **Tags:** `low-code`, `ai-agent`, `internal-tools`
- **Why use it:** AI + no-code platform for rapidly building business systems like CRM, ERP, and internal tools.
...
- **Why use it:** Comprehensive AI resource library with tutorials for DeepSeek, GPT, Claude, and vibe coding.
...
- **Why use it:** Curated plugin directory, not a functional plugin
...
- **Why use it:** Educational tutorial, not a distributable plugin
...
- **Tags:** `aggregation`, `ecosystem`
- **Why use it:** Plugin aggregation hub, not a single functional plugin
...
- **Why use it:** Curated collection of DSH plugins, tools, and ecosystem resources
...
- **Tags:** `marketplace`, `shop`, `plugin`
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-publication review
...
- **Why use it:** Curated bilingual plugin and tool directory for the DSH ecosystem.
...
- **Why use it:** 11,000+ plugin catalog with search and API access for DSH ecosystem
...
- **Why use it:** Comprehensive 173-entry handbook covering runtime, plugins, MCP, and troubleshooting
...
- **Why use it:** Plugin directory with 1958 repos, classification, filtering, and STAR ranking
...
- **Tags:** `awesome`, `awesome-list`, `plugin`
...
- **Tags:** `awesome-list`, `plugins`, `dsh-ecosystem`
...
- **⭐ Stars:** 28
- **Language:** Python
- **Description:** 数学建模资源，包含辅助建模、数据预处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harness v4.1 pro，但并非仅有dsh适配，skill内涵skill.md文件、README.md文件，reference文件夹及所需依赖，可以利用各种大模型agent进行安装，此外，库内还上传了数学建模workbench的自定义agent，涵盖着数学建模建模手，编程手，论文���三者分工流程及其他要点，使用该agent便于减少数学建模相关提示词的输入，配合各类skill能完成较为高质量的数学建模论文
...
- **Why use it:** Comprehensive open-data registry for discovering DSH plugins, bundles, and skills
...
- **Why use it:** Public GitHub directory with install commands and ecosystem discovery for DSH
...
- **Why use it:** Bilingual curated list of 24 verified stock/finance/quant plugins for DSH
...
- **Why use it:** Evidence-led curated directory with verified extensions and permission-aware installation guidance
...
- **Why use it:** 2026 curated DSH plugin list with quality checks for reliable ecosystem discovery
...
- **Why use it:** Curated collection of useful DeepSeek Harness plugins in Chinese
...
- **⭐ Stars:** 6
- **Language:** Unknown
- **Description:** 🐳 DeepSeek Harness（DSH）工具��量清单——GitHub topic:dsh-plugin 生态 1000+ 仓库按 star 排序。Awesome list for DeepSeek Harness tools.
- **Tags:** `awesome-list`, `quantitative`, `directory`
- **Why use it:** Quantitative directory of 1000+ DSH tools sorted by GitHub stars for ecosystem overview
...
- **Tags:** `radar`, `evidence-backed`
- **Why use it:** Evidence-backed plugin radar with community lab.
...
- **Tags:** `collection`, `chinese`
- **Why use it:** DSHA精选插件合集，中文社区推荐。
...
- **Tags:** `auto-crawl`, `directory`
- **Why use it:** Auto-crawled daily directory via GitHub Actions.
...
- **Why use it:** Zero-dependency static portal for 227+ plugin discovery.
...
- **Why use it:** Search npm and awesome list directly from DSH agents.
...
- **Tags:** `dsh-plugins`, `awesome-list`, `plugin-directory`
...
- **Tags:** `dsh-repository`, `dsh-ecosystem`, `plugin-verify`
- **Why use it:** DSH plugin repository covering analytics, verification, and ecosystem tools.
...
- **Tags:** `awesome-list`, `moved`, `archived`
- **Why use it:** Redirects to a dedicated awesome-dsh-plugin repository — archived listing.
...
- **Tags:** `auto-updating`, `awesome-list`, `bilingual`
- **Why use it:** Auto-updating curated list with bilingual README generated via YAML + scripts.
...
- **Tags:** `registry`, `curated-list`, `dsh-plugin`
- **Why use it:** Curated registry for DSH plugins — covers models, tools, sandboxes, and UI.

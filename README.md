...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 207,072 | Core DSH framework; everything is a plugin archite |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,154 | Open-source Claude-style design tool with local-fi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,055 | Original meta-harness for multi-agent swarms and a |
...
- **Why use it:** Super AI assistant harness with multi-model, multi-channel support
...
- **Tags:** `coding-agent`, `dsh-plugin`, `terminal`
...
- **Tags:** `vfs`, `agent-tools`, `dsh-plugin`
- **Why use it:** Unified virtual filesystem empowering AI agents with cross-session persistent storage.
...
- **Why use it:** High-performance Rust-based agent runtime paired with a polished desktop application for agentic coding.
...
- **Why use it:** AI code reviews grounded in classic engineering books
...
- **Why use it:** Vision toolkit for text-only LLMs: OCR, screenshots, UI restoration
...
- **Why use it:** Scans AI-generated code for hallucinated packages and security vulnerabilities.
...
- **Why use it:** Build and validate DSH/Cordis plugins via reusable Codex skill
...
- **Why use it:** On-demand plugin development knowledge base with official docs
...
- **Tags:** `web-ui`, `aggregation`, `dsh-web`
...
- **Why use it:** Extensible sidebar framework with built-in file editor, terminal, chat, Git, and sub-agent pages.
...
- **Why use it:** Modern embeddable task board with flexible integration support for Codex and DeepSeek Harness.
...
- **Why use it:** Claude Code-style TUI plugin with whale bar, real-time status, streaming thought, and context progress tracking.
...
- **Why use it:** Lightweight Tauri desktop app, zero setup required
...
- **Tags:** `widget`, `floating-widget`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracks account balance
...
- **Tags:** `desktop-app`, `electron`, `agentic-workflows`
...
- **Why use it:** Inline UI components—charts, forms, quizzes—directly in chat replies.
...
- **Tags:** `desktop`, `multi-model`, `privacy`
...
- **Why use it:** Visual non-linear canvas workspace for branching conversation sessions.
...
- **Why use it:** Open-source Windows desktop client with plugins, SSH, and mobile remote access.
...
- **Tags:** `desktop`, `cross-platform`, `electron`
- **Why use it:** Cross-platform desktop client inspired by CodePilot for macOS, Windows, Linux.
...
- **Why use it:** Adds full office suite (spreadsheets, docs, slides) into DeepSeek Harness.
...
- **Why use it:** Audits context injection costs with Web UI ring panel and conflict detection
...
- **Tags:** `info-bar`, `usage-tracking`
- **Why use it:** Essential status bar showing model, balance, and live pricing info
...
- **Why use it:** Open-source LLM knowledge platform with RAG, reasoning, and Wiki
...
- **Why use it:** Purpose-built memory management kit enabling agents to remember and refine context over time.
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus, enabling semantic search across all AI agents.
...
- **Tags:** `cordis-plugin`, `context-management`
- **Why use it:** Powerful context dashboard and management tool
...
- **Tags:** `agent-memory`, `skill-corpus`, `semantic-search`
- **Why use it:** Turn SKILL.md files into searchable agent-skill corpora
...
- **Tags:** `knowledge-base`, `ai-catalog`, `rag`
- **Why use it:** Comprehensive AI knowledge base covering agents, RAG, multimodal tools and more.
...
- **Tags:** `agent-orchestration`, `workspace`, `workflow`
- **Why use it:** Unified agent workspace with board-based task tracking
...
- **Why use it:** Intelligent skill routing and workflow orchestration delivering significant token savings and performance gains.
...
- **Tags:** `cognitive-enhancement`, `skills`, `dsh-plugin`
- **Why use it:** Cognitive-enhancement skills based on Anthropic J-space global workspace research for improved agent reasoning.
...
- **Why use it:** SQLite-backed task management with agent claim/review in a native Web UI.
...
- **Why use it:** Powerful plugin for novel writing and short-drama production with AI co-pilot.
...
- **Tags:** `agent-skills`, `gitops`, `math-modeling`
...
- **Tags:** `agent-review`, `prompt-engineering`, `self-evolving`
- **Why use it:** Enables composable, reviewable, and self-improving agent workflow modes.
...
- **Why use it:** Turns experience into repeatable execution skills across multiple AI agents.
...
- **Why use it:** Adds multimodal vision capability to Claude Code for UI and diagram analysis.
...
- **Why use it:** Ports Superpowers skill to Reasonix coding harness for DSH
...
- **Tags:** `agent-skills`, `deepseek`, `research`, `marketing`
...
- **Why use it:** AI coding mentor skill that scans projects and guides step-by-step learning
...
- **Tags:** `dsh-plugin`, `agent-skills`, `deepseek-harness`, `skills`
- **Why use it:** Agent skill for developing DSH plugins following standard patterns and specs
...
- **Why use it:** Agent skill to build and configure installed DSH plugins, slots, and credentials
...
- **Tags:** `agent-skills`, `deepseek-harness`, `spec-driven-development`, `dsh-plugin`
...
- **Why use it:** Game-like skill task management for DSH agents
...
- **Tags:** `traditional-wisdom`, `fengshui`, `dashboard`
- **Why use it:** Chinese metaphysics tools: Bazi, Fengshui, I Ching with visual dashboard
...
- **Tags:** `skills-manager`, `security`, `local-first`
...
- **Why use it:** WorkBuddy-style skill picker, quick insert skills into composer
...
- **Why use it:** Cross-platform skill enabling repo-local session memory continuity
...
- **Tags:** `skills-manager`, `mcp-manager`
...
- **Tags:** `agent-framework`, `package-manager`
...
- **Tags:** `qa`, `testing`
- **Why use it:** 10 testing skills with shared knowledge base for QA automation
...
- **Tags:** `ai-video`, `image-generation`
...
- **Tags:** `agent-skills`, `governance`
- **Why use it:** Governance skill adapter with version-pinning and offline verification.
...
- **Why use it:** Native WeShop Cordis plugin with infinite creative canvas.
...
- **Tags:** `codex`, `mcp`, `sync`
- **Why use it:** Bidirectional Codex-DSH bridge with live MCP mirroring
...
- **Why use it:** Hot-reload MCP config via UI; paste JSON to connect instantly.
...
- **Why use it:** Open-source Claude-style design tool with local-first desktop app
...
- **Tags:** `architecture-diagram`, `dsh-plugin`, `diagrams`
- **Why use it:** Agent skill for beautiful architecture and sequence diagrams
...
- **Tags:** `video`, `generative-ai`, `dsh-plugin`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation powered by LLM agents and ffmpeg automation.
...
- **Why use it:** Native design studio: AI generation, visual editing, PPT
...
- **Tags:** `visualization`, `legal`, `timeline`, `dsh-plugin`
- **Why use it:** Legal litigation visualization tool: redraw case diagrams and generate timelines
...
- **Tags:** `vision`, `ocr`, `image-reading`
- **Why use it:** Enables text-only models to read and understand images via OCR
...
- **Why use it:** Real-time token usage charts and API cost estimates in browser.
...
- **Why use it:** Enhancement suite for Gemini, Claude and ChatGPT browser UIs
...
- **Tags:** `content-discovery`, `web-automation`, `dsh-plugin`
- **Why use it:** Self-evolving cross-platform content discovery agent covering Bilibili, YouTube, Xiaohongshu and more.
...
- **Why use it:** Let AI use your logged-in browser seamlessly
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools inside chat.
...
- **Tags:** `dingtalk`, `chat-bot`, `communication`, `stream-mode`
- **Why use it:** DingTalk IM channel turning chats into tool-capable agent sessions.
...
- **Why use it:** Privacy-first open-source resume builder, secure and self-hosted
...
- **Tags:** `image-uploader`, `dsh-plugin`, `electron`
...
- **Tags:** `installer`, `model-switch`, `dsh-plugin`
- **Why use it:** One-click multi-agent tool installer with seamless model switching across Claude, Codex, DeepSeek, etc.
...
- **Why use it:** Built-in plugin marketplace for DSH enabling browse, search, and one-click installation of community plugins.
...
- **Why use it:** Tracks session and daily cost, budget history, and OpenCode quota usage.
...
- **Tags:** `compatibility-layer`, `migration`, `mcp`
- **Why use it:** Bridges Pi ecosystem to DSH via ABI compatibility layer for plugin migration.
...
- **Tags:** `config-manager`, `deepseek-harness`, `mcp`, `skills`
- **Why use it:** Backup, restore, export/import and sync complete DSH configuration via WebDAV
...
- **⭐ Stars:** 59
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository ��件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **Tags:** `deepseek-harness`, `dsh-plugin`, `plugin-management`, `ui`
- **Why use it:** Browser-based plugin management console and official dev guide skill
...
- **⭐ Stars:** 28
- **Language:** TypeScript
- **Description:** 一键配置各类 AI Agent 工具的 MCP、Skills 和��则；支持 Claude Code、Codex、DeepSeek Harness、OpenCode、Cursor、Gemini CLI、Qwen Code 等。 One-click local setup for MCP servers, skills, and rules across AI coding agents.
- **Tags:** `config-sync`, `mcp`, `multi-agent`
- **Why use it:** One-click MCP/skill/config setup across multiple AI agent frameworks
...
- **Tags:** `mascot`, `pixel-art`, `cute`
- **Why use it:** Animated pet gallery — fun visual customization for agents
...
- **Why use it:** Adorable Whale Girl themed skin series for DeepSeek Harness, enhancing visual customization.
...
- **⭐ Stars:** 396
- **Language:** JavaScript
- **Description:** 是���层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
...
- **Why use it:** Stunning WebGPU ocean skin theme for DeepSeek Harness UI.
...
- **Why use it:** 34 opencode classic color themes one-click switch, persist after restart
...
- **Why use it:** Comprehensive AI resource hub with tutorials and prompt collection
...
- **Why use it:** Curated plugin list - best starting point for DSH discovery
...
- **Why use it:** Automated research skill scanning China's top 8 platforms for the last 30 days, generating citable reports.
...
- **Tags:** `ecosystem-radar`, `plugin-registry`
- **Why use it:** Auto-discovers and rates 15900+ DSH candidate plugins
...
- **Tags:** `learning`, `marketplace`, `documentation`
- **Why use it:** Learn DSH principles, browse the plugin marketplace, and explore best practices.
...
- **Why use it:** Ultimate guide to DSH covering quickstart, resources, plugins and toolkits.
...
- **Tags:** `awesome-list`, `coding-agent`, `mcp`
- **Why use it:** Curated list of DSH plugins, skills, MCP servers, patches and orchestration tools.
...
- **Why use it:** Plugin marketplace and hub with 11,000+ DSH plugins and public API.
...
- **Why use it:** Comprehensive DSH plugin catalog with 1,958 repos and multilingual search.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `api-documentation`, `chinese-api`
...
- **Tags:** `patent-analysis`, `rag`, `legal-tech`, `dsh-plugin`
- **Why use it:** Patent infringement analysis with RAG; outputs competitor infringement reports
...
- **Why use it:** Comprehensive industry/company research methodology and tracking skills
...
- **Tags:** `evaluation`, `llm-evaluation`
- **Why use it:** Evidence-backed evaluation and observability for prompts, RAG, agents
...
- **Tags:** `awesome-list`, `curated-list`
- **Why use it:** Curated community list of DSH plugins for discovery.
...
- **Why use it:** Public GitHub directory for plugin installation and discovery.
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools, skills & resources.
...
- **Why use it:** Armor-breaking plugin optimized for DeepSeek
...
- **Tags:** `directory`, `awesome-list`, `curation`
- **Why use it:** Daily-curated plugin directory with scene-based classification and popularity ranking.
...
- **⭐ Stars:** 144
- **Language:** TypeScript
- **Description:** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操���远程 Harness。 (A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling PC, Android, and Web clients to securely access and operate a remote Harness over a low-latency, end-to-end encrypted, P2P-first network.)
...
- **Why use it:** Curated awesome list of DSH plugins, tools, and dev resources
...
- **Why use it:** Evidence-led bilingual plugin directory with immutable commits for trust.
...
- **Tags:** `awesome-list`, `auto-updated`, `directory`
- **Why use it:** Auto-updated daily via GitHub Actions crawling dsh-plugin topics.
...
- **Why use it:** Search npm and awesome-lists directly from inside DSH agents.
...
- **Tags:** `recommender`, `curated-list`, `ai-curated`
- **Why use it:** AI-curated hourly-updated list covering 190+ plugins in 12 categories.
...
- **Why use it:** 80+ verified plugins organized by functional category.
...
- **Tags:** `awesome-list`, `archived`, `migrated`
- **Why use it:** Original awesome-list; now migrated to another repo.
...
- **Tags:** `awesome-list`, `auto-generated`, `bilingual`
- **Why use it:** YAML-driven auto-generated bilingual README with Vercel deployment.
...
- **Tags:** `curated-list`, `comprehensive`, `directory`
- **Why use it:** Comprehensive curated plugins covering models, tools, sandboxes, UI.
...
- **Tags:** `curated-list`, `evidence-aware`, `shortlist`
- **Why use it:** Short evidence-aware curated list of useful DSH plugins.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `directory`, `catalog`, `dsh-plugin`
- **Why use it:** DSH plugin catalog — compact and practical.
...
- **Tags:** `industry`, `curated-list`, `specialized`
- **Why use it:** Industry-focused plugin directory covering computing, finance, law, HR.

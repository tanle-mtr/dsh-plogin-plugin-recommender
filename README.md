...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,066,846 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-21 00:02:59 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 231,183 | Core DSH framework; everything is a plugin foundat |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,297 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,932 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Core DSH framework; everything is a plugin foundation
...
- **Tags:** `cli`, `plugin-manager`, `schema`, `hub`
- **Why use it:** CLI, schemas, and resolver for DSH Plugin Hub — manage plugins via command line
...
- **Why use it:** Local-first Claude Cowork alternative with multi-model support and privacy focus
...
- **Why use it:** P2P encrypted multi-device remote access for DSH and CodeX.
...
- **Tags:** `skill-manager`, `audit`, `utility`
...
- **Why use it:** Ports Superpowers coding skills to Reasonix for enhanced agent capabilities.
...
- **Why use it:** Adapts Superpowers skills for DSH: TDD, debugging, planning and collaboration.
...
- **Why use it:** Manages tools/skills exposure with dynamic discoverability to reduce context usage
...
- **Tags:** `plugin-creator`, `scaffold`, `validation`
...
- **Tags:** `agent-tools`, `plugin`, `utility`
- **Why use it:** Pre-flight plugin library check for DSH agents before tasks
...
- **Why use it:** Modern desktop client built exclusively for DSH plugin ecosystem
...
- **⭐ Stars:** 20,111
- **Language:** TypeScript
- **Description:** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any websites, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；其中的提示词管理器可用��任意网站，如 DeepSeek Harness。
- **Tags:** `dsh-plugin`, `browser-extension`
- **Why use it:** Versatile enhancement suite with prompt management across all major AI platforms
...
- **Why use it:** Official desktop version bringing DSH capabilities to native macOS/Windows/Linux
...
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, chat and Git panels.
...
- **Why use it:** Modern flexible task panel with Codex and DeepSeek Harness integration.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking and rollback features.
...
- **Tags:** `floating-widget`, `balance-monitor`, `dsh-plugin`
- **Why use it:** Floating whale widget monitors account balance with animations
...
- **Why use it:** Zero-setup native desktop app for Windows/macOS/Linux
...
- **Tags:** `desktop-app`, `electron`, `windows`, `gui`
- **Why use it:** Zero-setup Windows desktop GUI with Codex, SSH, plugins, and mobile remote access
...
- **Why use it:** Local-first AI desktop workspace with MCP, projects, web research, and Office support
...
- **Tags:** `genui`, `ui-components`, `charts`, `forms`
...
- **Tags:** `canvas`, `non-linear`, `session-explorer`, `branching`
- **Why use it:** Canvas-based non-linear session explorer with branching conversation workspace
...
- **Tags:** `office`, `dsh-plugin`, `productivity`
- **Why use it:** Brings spreadsheets, docs, slides and canvases into DSH for a real office environment
...
- **Tags:** `mobile`, `ios`, `kotlin-multiplatform`, `ui-design`
- **Why use it:** Native iOS client for DSH via WebSocket with workspace and agent tracking
...
- **Why use it:** Privately deployable notes app with Smartisan aesthetics and WeChat MP export.
...
- **Tags:** `dsh`, `mcp`, `plugin`, `skills`
- **Why use it:** Web UI plugin for managing DSH skills and MCP servers via browser interface.
...
- **Tags:** `agent-harness`, `plugin-market`, `ui`, `web`
...
- **Tags:** `web-platform`, `workbench`, `skills`
...
- **Why use it:** Desktop bioinformatics agent app with skill store and offline mode
...
- **Why use it:** Shows provider, model, balance, pricing info and peak/off-peak countdown
...
- **Why use it:** Curated DSH plugins with notifications, tracing, keybindings and terminal
...
- **Why use it:** Web plugin for real-time token usage, cost charts, and API balance tracking
...
- **Why use it:** Electron desktop wrapper integrating DSH web with sidebar, ModLens, and market
...
- **Tags:** `multi-agent`, `agent-memory`, `skills`
- **Why use it:** Self-evolving agent with built-in memory and knowledge systems
...
- **Why use it:** Full RAG platform with semantic search, QA, and self-maintaining wiki
...
- **Why use it:** Portable local-first Markdown memory layer with self-evolving cross-app persistence
...
- **Tags:** `long-term-memory`, `token-savings`, `rag`
- **Why use it:** Hybrid-retrieval memory with 35% token savings and proven cross-task reuse
...
- **Why use it:** Purpose-built memory library enabling truly stateful persistent agent behavior
...
- **Tags:** `memory`, `rag`, `persistence`
- **Why use it:** Dedicated memory management kit for persistent context across agent sessions.
...
- **Why use it:** Unified persistent memory layer for all AI agents backed by Milvus
...
- **Why use it:** Personal AI agent with shared persistent context across tools
...
- **Tags:** `ai-knowledge`, `encyclopedia`, `rag`, `learning-path`
- **Why use it:** Comprehensive AI encyclopedia covering LLMs, Agents, RAG, multimodal, MLOps, and learning paths
...
- **Why use it:** Cross-platform skill preserving context across agent sessions
...
- **Why use it:** Unified multi-device agent orchestration with board-style task tracking and API access
...
- **Tags:** `skill-marketplace`, `skills`
- **Why use it:** Most comprehensive skills marketplace with automated GitHub scraping and curation
...
- **Tags:** `agent-collaboration`, `enterprise`
- **Why use it:** Enterprise-grade local-first workbench supporting multi-agent team collaboration
...
- **Why use it:** Robust long-horizon agent orchestration with governance control plane.
...
- **Tags:** `skills`, `routing`, `optimization`
- **Why use it:** Intelligent skill routing with 21pp reward improvement and 30% token reduction.
...
- **Tags:** `video`, `ffmpeg`, `automation`
- **Why use it:** Auto-generates Vox-style explainer videos end-to-end
...
- **Tags:** `teamwork`, `collaboration`, `agents`
...
- **Why use it:** AI-assisted novel writing with full creative workflow
...
- **Why use it:** One-line vision toolkit with OCR and image recognition
...
- **Tags:** `creative-writing`, `novel`, `screenwriting`, `workflow`
- **Why use it:** Four specialized workbenches for novel, short-drama, game, and video-recap creative writing
...
- **Tags:** `agent-skills`, `multimodal`, `computer-vision`, `mcp`
- **Why use it:** Gives agents eyes and ears via video/audio/screen observation with verifiable results
...
- **Tags:** `task-management`, `agent`, `native-ui`
...
- **Why use it:** Brings Epistemic Loop framework for scientific discovery to DSH agents
...
- **Tags:** `agent-evolution`, `workflows`, `review`
- **Why use it:** Self-evolving agent modes with composable task controls and human review.
...
- **Why use it:** Turn experience into repeatable AI execution skills across Codex, Claude, DSH.
...
- **Why use it:** Skill that auto-discovers, installs, and verifies DSH GitHub plugins.
...
- **Why use it:** Multimodal vision skill for screenshots/UI analysis on text-only LLM backends.
...
- **Why use it:** Auto-upgrades plugins when DSH version changes, keeping everything current.
...
- **Tags:** `agent-learning`, `automatic-skill-learning`, `skill-generator`
...
- **Tags:** `dsh-plugin`, `agent-skill`, `coding-mentor`
...
- **Tags:** `skills-deck`, `agent-skill`, `mattpocock`
- **Why use it:** 25 pre-built engineering skills including triage, wayfinder, and handoff
...
- **Tags:** `document`, `gongwen`, `wps-office`
- **Why use it:** Full-process official document processing following GB/T 9704 national standard
...
- **Why use it:** Chinese traditional wisdom AI skill pack covering Bazi, Fengshui, TCM and more
...
- **Why use it:** Repository-native Spec-driven development agent skill for coding projects
...
- **Why use it:** Engineering discipline skill: verify requirements, test, and prove delivery
...
- **Why use it:** Image-to-text OCR skill enabling text-only LLMs to read images
...
- **Why use it:** Multi-agent team with independent models, skills, contexts and shared workspace
...
- **Tags:** `multi-agent`, `memory`, `durable`
...
- **Why use it:** 11 QA skills + shared KB for AI-driven test engineering and automation
...
- **Tags:** `code-simplification`, `dsh-plugin`
- **Why use it:** Codex skill adapted for code simplification workflows
...
- **Why use it:** Plan-before-execute collaboration skill for AI-assisted tasks
...
- **Why use it:** Multi-agent math modeling suite with 33 models and paper templates
...
- **Why use it:** Chinese math modeling resources with data processing and writing skills
...
- **Why use it:** Cinematic product video agent skill with 152 shot recipes
...
- **Why use it:** Agent skill for building DSH plugins with standardized workflows
...
- **Why use it:** First vision bridge plugin enabling text-only agents to process images as JSON evidence.
...
- **Tags:** `mcp`, `academic-search`, `citation`
- **Why use it:** MCP-based academic search across PubMed, arXiv, OpenAlex with citation graph.
...
- **Why use it:** Local financial data source with Tushare, auto-generates HTTP/MCP interfaces.
...
- **Tags:** `skillhub`, `api`, `openapi`
- **Why use it:** Open API documentation and plugin for Tencent SkillHub ecosystem
...
- **Why use it:** One-click MCP/server/skill config sync for all major AI agents
...
- **Tags:** `chatgpt`, `oauth`, `ai-agents`, `dsh-plugin`
- **Why use it:** Binds ChatGPT via OAuth for model access inside DSH.
...
- **Why use it:** 530+ GPT Image prompts with industrial-grade templates
...
- **Tags:** `design`, `flutter`, `vibedesign`
- **Why use it:** First open-source AI-native vector design tool with concurrent multi-agent teams
...
- **Why use it:** Creative animated pet gallery with pixel-art style for coding agents.
...
- **Why use it:** AI-powered design studio with visual editing and PPT
...
- **Why use it:** Legal litigation visualization: timelines, case diagrams, and relationship charts
...
- **Why use it:** AI video/image/audio generation skill with storyboard and text-to-video tools
...
- **Tags:** `ui`, `visual`, `knowledge`
- **Why use it:** Transform chat history into shareable beautifully designed cards
...
- **Why use it:** CLI + extension for seamless logged-in browser automation across any AI agent
...
- **Tags:** `web-search`, `free`, `no-signup`, `plugin`
- **Why use it:** Strongest free web search plugin — no signup, no API key, works with any model
...
- **Tags:** `browser-automation`, `anti-detect`, `playwright`, `android`
- **Why use it:** Persistent-identity browser with engine-level fingerprint spoofing and Android emulation
...
- **Why use it:** Live iOS simulator and USB iPhone automation with 22 agent tools inside conversation
...
- **Tags:** `browser-automation`, `browser-use`, `playwright`
- **Why use it:** Tabbit Browser automation plugins using Playwright for DSH.
...
- **Tags:** `router`, `infrastructure`, `injector`
- **Why use it:** Runtime injector with task-aware reasoning router, measured P1 performance gains
...
- **Why use it:** Centralized marketplace for browsing, searching and one-click installing DSH plugins.
...
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tools configuration.
...
- **Tags:** `account-management`, `routing`, `failover`
- **Why use it:** Unified account manager with multi-model smart routing and auto failover for Codex.
...
- **Tags:** `discovery`, `radar`, `registry`
- **Why use it:** Discover DSH plugins through continuous ecosystem radar
...
- **Why use it:** Smart context dashboard for insight and management
...
- **Why use it:** Daily refreshed plugin marketplace with quality review
...
- **Tags:** `security`, `redteam`, `vulnerability`, `auditing`
- **Why use it:** AI security platform auditing hallucinated packages, missing safeguards, and pattern errors
...
- **Why use it:** Use ChatGPT Claude and Grok subscriptions as LLM providers without API keys
...
- **Tags:** `cost-tracking`, `token-usage`, `llm-provider`
...
- **Tags:** `llm-provider`, `commandcode`, `plugin`
...
- **Why use it:** Compatibility layer bridging Pi ecosystem to native DSH plugins.
...
- **Tags:** `backup`, `config-manager`, `mcp`, `migration`, `sync`
- **Why use it:** Backup, restore, migrate and sync your complete DSH configuration via WebDAV.
...
- **Why use it:** Browser console for plugin repository management plus dev scaffolding
...
- **Why use it:** Context injection audit tool: checks token cost, detects duplicates and conflicts
...
- **Tags:** `dsh-box`, `container`
- **Why use it:** Isolated multi-version DSH container manager with WebView UI
...
- **Why use it:** Search npm + awesome list for plugin discoverability inside DSH
...
- **Why use it:** Whale Girl skin series for personalized DSH interface
...
- **Tags:** `theme`, `glass-UI`, `frosted`, `wallpaper`
- **Why use it:** Highly customizable frosted glass theme with adjustable blur,磨砂, and custom wallpapers
...
- **Tags:** `animated-background`, `theme`, `glassmorphism`, `threejs`
...
- **Tags:** `theme`, `ui`, `webui`
- **Why use it:** Web background personalization with presets and custom uploads
...
- **Tags:** `ai-guide`, `prompt-engineering`, `vibe-coding`
...
- **Why use it:** AI-ready documentation generator that transforms code into structured technical context.
...
- **Why use it:** Curated collection of DSH plugins and ecosystem tools
...
- **Why use it:** Bilingual curated list of all DSH plugins, extensions, skills, and integrations
...
- **Tags:** `arxiv`, `latex`, `gpu-cluster`, `ssh`, `research`
- **Why use it:** Full-cycle research workbench: LaTeX live compile, arXiv management, GPU SSH orchestration
...
- **⭐ Stars:** 348
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目��除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `dsh-plugin`, `discovery`
- **Why use it:** Curated DSH plugin directory with daily GitHub scraping and scenario-based classification
...
- **Tags:** `awesome-list`, `agent-framework`, `mcp`
...
- **Tags:** `company-research`, `industry-research`, `report`, `research`
- **Why use it:** Industry research domain pack with methodology skills and company analysis.
...
- **Tags:** `web-search`, `agent-skills`, `research`
- **Why use it:** Web search and research skills for AI agents with up-to-date content
...
- **Why use it:** Interactive K-line chart analysis with indicators and fundamentals
...
- **Why use it:** Curated plugin discovery list for DSH ecosystem exploration
...
- **Tags:** `plugin-registry`, `skills`, `open-data`
- **Why use it:** Open-data registry with spam filtering for plugin discovery
...
- **Why use it:** Evidence-led curated directory with verified extensions and guided installation
...
- **Why use it:** 2026 curated plugin list with quality checks for reliable discovery
...
- **Why use it:** Concise collection of useful DSH plugins for quick reference
...
- **Why use it:** Curated awesome list for DSH plugin ecosystem discovery
...
- **Why use it:** 1000+ DSH plugins sorted by stars, comprehensive catalog
...
- **Why use it:** Verified star-ranked community plugins directory
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选插件，了解安��、权限、兼容性和风险
- **Tags:** `guide`, `awesome-list`, `directory`
- **Why use it:** Plugin guide with security, permissions and compatibility info
...
- **Why use it:** 190+ plugins across 12 categories, hourly AI-updated list
...
- **Why use it:** Automated daily GitHub Actions crawled plugin directory
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Essential curated directory for discovering quality DSH ecosystem plugins
...
- **Why use it:** Complete beginner tutorial from scratch to build your first harness skill
...
- **Why use it:** Web-based plugin aggregation ecosystem with workshop-style distribution model
...
- **Why use it:** DSH learning hub with principles and marketplace guide.
...
- **Why use it:** Largest DSH plugin catalog with 11000+ plugins and free API.
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, bilingual search and filtering.
...
- **Tags:** `agents`, `awesome`, `awesome-list`
...
- **Why use it:** Curated directory listing 80+ verified DSH plugins.
...
- **Tags:** `dsh-plugins`, `plugin-directory`, `awesome-dsh-plugins`
- **Why use it:** Community-curated DSH plugins directory and ecosystem list.
...
- **Tags:** `redirect`, `awesome-dsh-plugins`
- **Why use it:** Redirect notice; original moved to another repo.
...
- **Tags:** `awesome-list`, `auto-update`, `dsh-plugins`
...
- **Tags:** `plugin-directory`, `curated-list`, `deepseek-harness`

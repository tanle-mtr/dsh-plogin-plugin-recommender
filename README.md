...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 874,237 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 13:03:42 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 197,086 | Core plugin harness for DSH ecosystem. All-in-one  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,655 | Open-source design alternative for coding agents. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,442 | Original agent meta-harness for multi-agent swarms |
...
- **Why use it:** Core plugin harness for DSH ecosystem. All-in-one plugin framework.
...
- **Tags:** `terminal`, `coding`, `agent`, `cli`
...
- **Why use it:** Minimal bootstrap to full Standard tools preset, Project2 98/99 aligned
...
- **Tags:** `claude-code`, `deepseek-harness`, `dsh-plugin`, `model-switch`
- **Why use it:** One-click model switching across Claude, Codex, Grok, and more.
...
- **Tags:** `code-review`, `architecture-review`, `code-quality`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with citations and severity labels.
...
- **Tags:** `coding-agents`, `architecture`, `dsh-plugin`
- **Why use it:** Architecture-aware coding agents with baseline-first and drift-checked workflows
...
- **Why use it:** Specialized armor-breaking prompts to stabilize DeepSeek output quality.
...
- **Tags:** `android`, `emulator`, `development`
- **Why use it:** Build and interact with Android emulators or USB devices inside conversation
...
- **Tags:** `plugin-dev`, `scaffolding`, `credentials`
- **Why use it:** Builds DSH plugin scaffolding with slots and credentials management.
...
- **Why use it:** Centralized control panel for MCP tools and skills exposure management.
...
- **Tags:** `containers`, `ui`, `isolated`
- **Why use it:** Run isolated DSH instances via containers with embedded WebView UI.
...
- **Why use it:** Bidirectional bridge syncing Codex chats, skills, and MCP tools with DSH.
...
- **Why use it:** Dedicated skills management interface for organizing DSH skills.
...
- **Tags:** `plugin-development`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `plugin-development`, `agent-skills`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `design`, `ui`, `desktop`, `figma`
- **Why use it:** Open-source design alternative for coding agents.
...
- **Why use it:** Open sidebar foundation with built-in file, terminal, Git, and sub-agent pages.
...
- **Why use it:** Zero-setup 5MB Tauri desktop with preset plugins for Windows/macOS/Linux
...
- **Why use it:** Cute whale widget floats on DSH UI to monitor DeepSeek account balance
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, files, and MCP
...
- **Why use it:** Local-first desktop AI agent with multi-model support and privacy focus.
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** Renders interactive UI components like charts and forms inline in chat replies.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with bundled plugin suite.
...
- **Why use it:** Full-featured Windows desktop GUI with SSH and Codex integration
...
- **Tags:** `ui`, `usage-tracking`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Shows provider/model, live balance, pricing info with peak/off-peak countdown.
...
- **Tags:** `canvas`, `creative`, `native`
- **Why use it:** Native infinite canvas with creative skills
...
- **Why use it:** Electron desktop wrapping DSH web with sidebar
...
- **Tags:** `memory`, `rag`, `context`, `database`
...
- **Tags:** `rag`, `knowledge`, `wiki`, `vector`
...
- **Tags:** `long-term-memory`, `rag`, `local-first`
...
- **Tags:** `memory-management`, `token-savings`, `rag`
...
- **Why use it:** Dedicated memory management kit designed specifically for AI agents.
...
- **Why use it:** Unlimited memory storage for AI agents via OpenClaw integration
...
- **⭐ Stars:** 267
- **Language:** TypeScript
- **Description:** AI skills大全 mcp ai知识库 Agent 全维度 AI 资源百科，DSH插件 收录大模型、智能 Agent、RAG 检索增强、多模态、MLOps、AI 应用工具、AI面试集、Vibe coding 大全、零基础学习路线，持续更��前沿 AI 开源项目，开发者一站式 AI 导航库
- **Tags:** `rag`, `mcp`, `dsh-plugin`
- **Why use it:** Comprehensive AI skills encyclopedia covering RAG, MCP, multimodal, and learning paths.
...
- **Why use it:** Builds curated skill corpora with semantic retrieval and evaluation
...
- **Why use it:** Long-term durable agent memory with recall tools and inspectable storage
...
- **Tags:** `context`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Audits AGENTS.md tokens, detects conflicts; essential context hygiene tool.
...
- **Tags:** `evaluation`, `rag-evaluation`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `agentic`, `swarm`, `multi-agent`, `workflow`
- **Why use it:** Original agent meta-harness for multi-agent swarms.
...
- **Tags:** `ai-agent`, `skills`, `memory`, `self-evolving`
- **Why use it:** Super AI assistant with memory, skills, self-evolving.
...
- **Tags:** `skills`, `distill`, `agent`, `workflow`
...
- **Tags:** `routing`, `agent-skills`, `cordis`
- **Why use it:** Task-aware routing injector for intelligent agent mode switching
...
- **Why use it:** Self-improving agent OS with loop-engineering and self-evaluation
...
- **Tags:** `agent`, `skill`, `deepseek-harness`
- **Why use it:** Unifies multiple coding agents into one coordinated team with dispatch capabilities.
...
- **Tags:** `skill`, `math-modeling`, `automation`, `gitops`
- **Why use it:** Full-stack automated math modeling competition workflow skill
...
- **Tags:** `skills`, `agent`, `workflow`, `coding`
...
- **Tags:** `vision`, `multimodal`, `agent-skills`, `ui-testing`
...
- **Why use it:** Discovers, installs, and verifies DSH GitHub plugins via skill
...
- **Why use it:** Native SQLite taskboard with agent claim/review and no iframe needed
...
- **Why use it:** Specialized agent skills for AI infra development, write and debug systems
...
- **Why use it:** 85 reverse-engineering and pentesting SKILL.md for security research.
...
- **Why use it:** AI coding mentor that generates structured learning paths with auto-review.
...
- **Tags:** `spec-programming`, `agent-skills`
- **Why use it:** Repository-native spec-driven development skill for DSH patterns.
...
- **Why use it:** Official DSH plugin dev docs bundled as an on-demand agent skill.
...
- **Tags:** `bazi`, `fengshui`, `dashboard`, `chinese`
- **Why use it:** Chinese metaphysics AI skill: Bazi, Fengshui, I Ching with dashboard.
...
- **Why use it:** Cross-platform session continuity for Codex and Claude Code agents.
...
- **Why use it:** Swift Cycle governance skill: user-invoked, version-pinned, offline-safe.
...
- **Why use it:** Game-like mission system with fog-of-war map and progress tracking.
...
- **Tags:** `gongwen`, `docx`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Full pipeline for Chinese official documents with format checking and optimization.
...
- **Tags:** `agent-skills`, `database`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Package manager with 42 skills covering databases, evals, and agent dev.
...
- **Why use it:** Solves MCP+skill hot-reload pain without restart
...
- **Tags:** `skill`, `engineering`, `portable`
- **Why use it:** Portable engineering discipline skill for agents
...
- **Why use it:** Full-stack Godot 4.x game dev skill
...
- **Tags:** `plugin-dev`, `skills`, `testing`
- **Why use it:** Skills for scaffolding and testing DSH plugins
...
- **Tags:** `agent`, `workflow`
- **Why use it:** Virtual product team agent preset workflow
...
- **Why use it:** Pre-flight plugin check for agent tasks
...
- **Why use it:** First vision bridge for text-only agents, OCR with structured JSON output
...
- **Tags:** `mcp`, `zhihu`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Zhihu search, Zhida Q&A, and open-platform API via Skill and MCP.
...
- **Tags:** `browser`, `extension`, `automation`, `gemini`
- **Why use it:** Enhancement suite for Gemini, AI Studio, Claude, ChatGPT.
...
- **Tags:** `dsh-web`, `plugin-marketplace`, `web-ui`
- **Why use it:** Web plugin aggregation ecosystem for creative workshop distribution
...
- **Tags:** `bilibili`, `content-discovery`, `cross-platform`, `web-automation`
...
- **Why use it:** Let AI agents control your real logged-in browser without interruption
...
- **Tags:** `browser-extension`, `workflow`, `plugin`
- **Why use it:** Browser extension turning AI conversations into reusable organized workflows
...
- **Tags:** `web-search`, `deepseek-harness`, `dsh-plugin`
...
- **Why use it:** 22 agent tools for live iOS Simulator and USB iPhone control inside DSH conversations.
...
- **Why use it:** Tabbit Browser Playwright-based automation plugin for DSH
...
- **Tags:** `resume`, `privacy`, `mcp`, `server`
- **Why use it:** Privacy-first open-source resume builder, free forever.
...
- **Tags:** `no-code`, `crm`, `erp`, `business`
- **Why use it:** Open-source AI no-code platform for rapid business systems.
...
- **Why use it:** Unified virtual filesystem abstraction for seamless agent file operations
...
- **Why use it:** Context dashboard and statistics for DeepSeek Harness with browser integration
...
- **Tags:** `oauth`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Leverages ChatGPT/Claude/Grok subscriptions as free DSH LLM providers via OAuth.
...
- **Why use it:** Track session costs, budgets, and token usage with ease
...
- **Tags:** `migration`, `compatibility`, `pi-agent`, `abi`
- **Why use it:** Compatibility layer bridging Pi ecosystem plugins to DSH
...
- **Why use it:** One-click browse, install and update all dsh-plugin GitHub plugins
...
- **Why use it:** Crash-rescue plugin with undo, snapshots and SAFE MODE for DSH recovery
...
- **Why use it:** Web UI management panel for skills and MCP tools in DSH
...
- **Why use it:** Community plugin market browser with one-click install/uninstall
...
- **Why use it:** Plugin management console and official dev skill scaffolding.
...
- **Tags:** `documentation`, `best-practices`, `dev`
- **Why use it:** Practical DSH dev pitfalls and best practices archive
...
- **Why use it:** One-click migrate Claude Code setup to DSH
...
- **Tags:** `utils`, `compatibility`
- **Why use it:** Solves plugin conflicts and version issues
...
- **Tags:** `mascot`, `pixel-art`, `customization`
- **Why use it:** Public gallery of animated mascots to personalize your agent experience
...
- **Tags:** `theme`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `themes`, `dark-mode`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** 34 opencode classic color themes, one-click switch, persists across restarts.
...
- **Tags:** `ui`, `theme`
- **Why use it:** Customizable Web background with presets
...
- **Tags:** `ai`, `resources`, `guide`, `tutorial`
- **Why use it:** Comprehensive AI resource library and vibe coding tutorials.
...
- **Why use it:** Searches 8 major Chinese platforms for last 30 days and generates evidence-based reports.
...
- **Why use it:** Curated plugin radar with automated discovery and real-world testing across 9000+ candidates
...
- **Why use it:** Curated plugin ecosystem list covering DSH tools and infrastructure
...
- **Tags:** `finance`, `quant`
- **Why use it:** Curated stock/finance/quant plugins
...
- **Why use it:** Evidence-led curated directory of verified DSH plugins
...
- **Why use it:** Plugin radar with 2Origin lab integration for discovery
...
- **Why use it:** Comprehensive 1000+ repo listing sorted by popularity
...
- **Why use it:** Archived — redirect to main awesome-dsh-plugin repo
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** Simple DSH plugin directory entry
...
- **Why use it:** Web-simulated traditional Chinese toy with real audio sampling, zero dependencies.
...
- **Tags:** `awesome-list`, `bilingual`, `deepseek-harness`
- **Why use it:** Curated bilingual catalog of DSH plugins, tools, and verified integrations.
...
- **Why use it:** Daily-auto-curated plugin discovery with scenario-based classification and rankings.
...
- **Why use it:** Educational resource covering DSH principles, plugin marketplace navigation, and best practices.
...
- **Why use it:** Comprehensive starter guide and resource hub for DSH ecosystem
...
- **Tags:** `awesome-list`, `plugin-directory`, `mcp`, `patch`
- **Why use it:** Curated catalog of plugins, MCP servers, skills, patches and UIs
...
- **Tags:** `plugin-marketplace`, `registry`, `catalog`
...
- **Why use it:** Plugin marketplace and hub listing for DSH
...
- **Why use it:** Curated plugin list and ecosystem resources for DSH.
...
- **Why use it:** Curated catalog of 280+ community DSH plugins across 14 categories.
...
- **Why use it:** Public directory for plugin discovery and install
...
- **Tags:** `awesome-list`, `catalog`, `community`
- **Why use it:** Community-cataloged DSH plugin reference
...
- **Why use it:** Quality-checked curated plugin list for 2026
...
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Verified plugins with permission-aware installation
...
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Star-ranked community plugin directory
...
- **Why use it:** Curated plugins, tools, skills & resources list
...
- **Why use it:** Collection of useful DSH plugins
...
- **Why use it:** Plugin navigation by scenario with risk guidance
...
- **Tags:** `portal`, `web`
- **Why use it:** Static portal to discover and install plugins
...
- **Tags:** `awesome-list`, `collection`
- **Why use it:** DSH plugins ecosystem collection
...
- **Why use it:** Auto-crawled daily plugin directory

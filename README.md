...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,046,741 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-18 05:44:11 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 228,279 | Core DSH framework, the foundational plugin ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,808 | Open-source Claude Design alternative, local-first |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,741 | Multi-agent swarm coordination with autonomous wor |
...
- **Why use it:** Core DSH framework, the foundational plugin ecosystem
...
- **Tags:** `routing`, `harness-tool`, `reasoning-mode`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for DSH harnesses.
...
- **Tags:** `multi-agent`, `enterprise`, `agent-workbench`
- **Why use it:** Enterprise-grade unified multi-agent workbench for Codex, DSH, and OpenCode.
...
- **Why use it:** First vision plugin turning images into structured JSON for agents
...
- **Tags:** `vfs`, `virtual-terminal`, `agent-sandbox`
- **Why use it:** Virtual terminal with VFS for isolated agent sandboxing
...
- **Why use it:** AI security offensive & defensive platform auditing AI-generated code
...
- **Why use it:** Bridge Pi extensions to DSH via unified ABI compatibility layer.
...
- **Why use it:** Build and validate DSH plugins with a reusable skill.
...
- **Tags:** `mcp`, `agent-config`, `dsh`
- **Why use it:** One-click MCP and skills setup for multiple AI coding agents
...
- **Tags:** `migration`, `claude-code`, `dsh`
...
- **Tags:** `launcher`, `orchestration`, `dsh`
...
- **Tags:** `agent-skill`, `development`
- **Why use it:** Agent skill standardizing DSH plugin dev workflow
...
- **Why use it:** Pre-flight plugin check to boost agent library utilization.
...
- **Tags:** `sidebar`, `ui`
- **Why use it:** Open sidebar foundation with file editor, terminal, chat and Git
...
- **Tags:** `taskboard`, `ui`
- **Why use it:** Modern embedded task panel supporting Codex and DSH
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thought and rollback
...
- **Tags:** `desktop`, `agent-runtime`, `ai-ide`
...
- **Why use it:** Zero-setup Tauri desktop app, 5MB installer, cross-platform.
...
- **Why use it:** Zero-setup Windows desktop GUI client with SSH and mobile remote access
...
- **Why use it:** Visual non-linear canvas-based conversation workspace with session branching
...
- **Why use it:** Local-first multi-model desktop app alternative to Claude Cowork with self-evolving skills
...
- **Why use it:** CodePilot-inspired cross-platform desktop app with plugin suite for DSH
...
- **Tags:** `ui`, `market`, `deepseek-harness`
- **Why use it:** Community plugin market with one-click install in web GUI
...
- **Tags:** `ui`, `capability`, `dsh`
- **Why use it:** Unified capability menu with tiered exposure control for tools
...
- **Tags:** `workbench`, `typescript`, `agent-platform`, `plugin-system`
- **Why use it:** Plugin-based web workbench on DSH with global Skill management and native workspace integration.
...
- **Tags:** `desktop`, `devops`
- **Why use it:** All-in-one DevOps desktop: SSH, Docker, AI
...
- **Why use it:** Electron desktop wrapping DSH web + sidebar + ModLens
...
- **Why use it:** Self-evolving multi-agent system with memory and skill capabilities
...
- **Why use it:** Cross-device agent workspace with board-based task tracking and API access.
...
- **Why use it:** Largest skills marketplace covering code, finance, office, and ML workflows.
...
- **Why use it:** Two-phase preset for clean bootstrap and full Standard tools
...
- **Why use it:** Intelligent skill routing cuts tokens by 29% on SkillsBench
...
- **Tags:** `cognitive-enhancement`, `reasoning`, `inference-control`
...
- **Tags:** `video`, `skill`, `ai-generation`
...
- **Why use it:** Organized workflow for AI novel writing with local-first and cloud support.
...
- **Tags:** `agent-observability`, `video-analysis`, `OCR`
- **Why use it:** Gives agents vision and audio with timestamped evidence verification
...
- **Why use it:** Live iOS simulator and USB phone automation with 22 agent tools inside DSH
...
- **Tags:** `agent-skills`, `workflow`, `gitops`
...
- **Why use it:** Auto-upgrades plugins to match DSH version
...
- **Tags:** `skills`, `agent-learning`, `dsh`
...
- **Tags:** `skills`, `superpowers`, `deepseek-harness`
- **Why use it:** TDD, debugging, planning and collaboration skills adapted
...
- **Why use it:** AI coding mentor that scans projects and guides step-by-step learning with auto-grading and code review.
...
- **Tags:** `agent-skills`, `mcp`, `web-search`, `multi-agent`
- **Why use it:** Comprehensive web search, research, finance and integration discovery skills for AI agents.
...
- **Tags:** `dsh-plugin`, `skills`, `github-issues`, `wayfinder`
- **Why use it:** Pre-loaded with 25 engineering & productivity skills, right-panel access without manual installation.
...
- **Tags:** `legal`, `visualization`, `svg`, `timeline`, `agent-skill`
- **Why use it:** Legal litigation visualization: timelines, case diagrams, and courtroom battle charts for lawyers.
...
- **Tags:** `gongwen`, `docx`, `dsh-plugin`, `skill`
- **Why use it:** Complete GB/T 9704 official document processing: format check, optimization, templates, and conversion.
...
- **Why use it:** On-demand plugin dev knowledge base as a skill bundle; official docs archive with Cordis primer.
...
- **Why use it:** Portable spec-driven development skill for DSH agents.
...
- **Tags:** `fengshui`, `iching`, `dsh-plugin`
- **Why use it:** Fuses Chinese metaphysics into a local deterministic engine with dashboard.
...
- **Why use it:** Enables text-only models to read and interpret images via OCR.
...
- **Tags:** `deepseek-harness`, `guard`, `quality-gate`
...
- **Tags:** `qa`, `test-automation`, `dsh-plugin`
- **Why use it:** 11 QA skills framework for AI agents acting as senior test engineers.
...
- **Why use it:** Persistent agent team with private memory and cross-session skills.
...
- **Why use it:** Cross-platform handoff skill for repository-local continuity memory.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Simplifies code using a skill adapted from DSH patterns.
...
- **Why use it:** Chinese math modeling suite: preprocessing, writing, AIGC reduction
...
- **Why use it:** Local finance DB with Tushare, auto-generates MCP endpoints for agents.
...
- **Tags:** `mcp`, `api-documentation`, `chinese-api`, `dsh-plugin`
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms; zero-config MCP + Skill support.
...
- **Tags:** `mcp`, `cloud`, `huaweicloud`, `sdk`, `terraform`
- **Why use it:** Official Huawei Cloud toolkit with skills, MCP tools, guardrails and cloud sandbox for AI agents.
...
- **Why use it:** Official SkillHub API plugin for DSH ecosystem
...
- **Why use it:** Open-source Claude Design alternative, local-first UI prototyping
...
- **Why use it:** 530+ GPT Image prompts and 20+ industrial-grade reusable templates
...
- **Tags:** `ai-video`, `directorx`, `dsh-plugin`
- **Why use it:** AI video/image/audio skills with storyboard and configurable model tools.
...
- **Why use it:** Cinematic video agent with 152 camera recipes and Remotion templates
...
- **Why use it:** All-in-one enhancement suite for major AI chat platforms with prompt manager.
...
- **Why use it:** Real browser automation for AI agents without interrupting your live sessions.
...
- **Why use it:** Cross-platform content discovery agent from 8+ platforms
...
- **Why use it:** Persistent identity browser with fingerprint spoofing and Playwright automation
...
- **Why use it:** Bind ChatGPT account via OAuth to chat inside DSH.
...
- **Tags:** `mcp-server`, `dsh-plugin`, `resume-builder`
- **Why use it:** Privacy-first open-source resume builder, MCP server integration
...
- **Tags:** `image`, `dsh-plugin`, `electron`
...
- **Why use it:** Official plugin marketplace with one-click install and search
...
- **Tags:** `model-switch`, `install`
- **Why use it:** One-click install + model switch across 9+ coding agent platforms
...
- **Tags:** `utilities`, `ecosystem`, `plugin`
- **Why use it:** Open-source ecosystem radar discovering and validating 21k+ DSH plugins.
...
- **Tags:** `context`, `utilities`, `dsh`
- **Why use it:** Context insight dashboard, browser sidebar, and management commands.
...
- **Why use it:** Comprehensive daily-refreshed plugin marketplace sourced across the internet.
...
- **Why use it:** Open-source CLI and schemas for managing and discovering DSH plugins
...
- **Why use it:** Tracks session and daily costs budget history across all DSH providers
...
- **Why use it:** Plugin marketplace with 11K+ plugins, search and API.
...
- **Why use it:** P2P encrypted remote access across PC, Android, and Web devices.
...
- **Why use it:** Skill that discovers, installs, and verifies DSH plugins automatically.
...
- **Tags:** `config`, `backup`, `dsh`
- **Why use it:** Backup and restore DSH configs, plugins, and MCPs
...
- **Tags:** `plugin-management`, `ui`, `console`, `dsh-plugin`
- **Why use it:** Lightweight plugin management console with zero-patch official repo integration and dev guide.
...
- **Why use it:** Centralized loading and secure management of local Agent Skills within DSH.
...
- **Tags:** `enhancement`, `terminal`
- **Why use it:** Task notifications, LLM trace, keybindings
...
- **Tags:** `cost`, `visualization`
- **Why use it:** Real-time token usage, cost charts, API balance
...
- **Tags:** `tts`, `voice`
- **Why use it:** Free Xiaomi MiMo TTS with custom/browser voices
...
- **⭐ Stars:** 7
- **Language:** TypeScript
- **Description:** 致力于解决各插件之间也与版本之间可能存在的冲突问题并提���解决方案
- **Tags:** `debug`, `conflict-resolution`
...
- **Why use it:** Animated pet gallery for coding agents, adds fun pixel-art companions
...
- **Tags:** `theme`, `animation`, `ocean`
- **Why use it:** Real-time animated ocean theme with Three.js and adjustable glass effects
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗��遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `dsh-plugin`, `webui`, `theme`
- **Why use it:** Personalize DSH Web UI with custom backgrounds and preset themes.
...
- **Tags:** `documentation`, `deepwiki`, `analysis`
...
- **Tags:** `research`, `skill`, `web-search`
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days content and generates reports.
...
- **Why use it:** Curated bilingual DSH plugins awesome list with verified references
...
- **Why use it:** All-in-one academic research workbench: LaTeX, arXiv, GPU SSH orchestration
...
- **Tags:** `awesome-list`, `encyclopedia`, `ai-resources`
...
- **Tags:** `academic-search`, `mcp`, `agent-skills`, `research-workflow`
...
- **Why use it:** 88 agent skills for deep research, marketing, and social intelligence.
...
- **Tags:** `research`, `industry`, `deepseek-harness`
- **Why use it:** Industry/company research with methodology and tracking
...
- **Tags:** `patent`, `research`, `rag`, `multi-agent`
- **Why use it:** Patent infringement analysis with competitive reports; packaged as reusable skill for any agent.
...
- **Tags:** `finance`, `quant`
- **Why use it:** Curated stock/finance/quant plugins (24 entries)
...
- **Why use it:** Curated plugin showcase list, great starting point for exploring DSH ecosystem.
...
- **Why use it:** Curated awesome list of DSH ecosystem plugins, tools, and resources.
...
- **Why use it:** Curated daily-scraped plugin discovery with real verification and rankings
...
- **Why use it:** Comprehensive curated list of DSH plugins skills MCP servers and patches
...
- **Why use it:** Ultimate guide covering quickstart resources curated plugins and toolkits
...
- **Tags:** `awesome-list`, `documentation`, `handbook`
- **Why use it:** Comprehensive agent-first handbook covering runtime, MCP, and sandbox.
...
- **Why use it:** Catalog of 1958 repos and 1819 real DSH plugins with search/filter.
...
- **Tags:** `marketplace`, `community`, `deepseek-harness`
- **Why use it:** Community-maintained auto-synced plugin marketplace
...
- **Tags:** `awesome`, `catalog`, `community`
...
- **Why use it:** Curated list of DeepSeek Harness plugins and resources
...
- **Why use it:** Curated open-data registry filtering spam
...
- **Why use it:** Public GitHub directory for ecosystem discovery
...
- **Why use it:** Evidence-led verified plugin directory
...
- **Why use it:** 2026 curated list with quality check
...
- **Why use it:** Simple curated plugin collection
...
- **Why use it:** Complete 1000+ plugin list sorted by stars
...
- **Why use it:** Plugin guide with scenario-based navigation and risk info.
...
- **Tags:** `plugin-radar`, `awesome-list`
...
- **Why use it:** Zero-dependency static portal for 227+ DSH plugins.
...
- **Tags:** `dsh-plugins`, `repository`, `plugin-verify`
...
- **Tags:** `awesome-list`, `archived`, `redirect`
- **Why use it:** Archived — redirected to new repo location
...
- **Tags:** `plugin-directory`, `curated-list`, `typescript`
- **Why use it:** Broad curated registry covering models, tools, UI, and agent loops

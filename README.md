...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 836,501 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 08:37:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 186,140 | Core platform enabling plugin-based AI agent devel |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,547 | Local-first design tool with Figma-like UI generat |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,885 | Multi-agent swarm orchestration with autonomous wo |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 15 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (15)
...
- **Why use it:** Core platform enabling plugin-based AI agent development
...
- **Why use it:** Self-evolving multi-model agent with memory and skills
...
- **Why use it:** Native DeepSeek terminal coding agent with prompt caching
...
- **Why use it:** Best beginner guide to mastering DSH plugin development from scratch.
...
- **Why use it:** Two-phase preset combining minimal bootstrap with full standard tooling.
...
- **Why use it:** Keeps coding agents architecture-aware and drift-free
...
- **Tags:** `coding-agent`, `swift`, `macos`, `deepseek`
...
- **Tags:** `dsh-plugin`, `plugin-management`, `ui`, `console`
- **Why use it:** Plugin registry console with browser management and dev scaffolding guide
...
- **Why use it:** Agent skill covering plugin/service/tool/adapter development standards
...
- **Why use it:** Agent skill for managing plugin slots, Typert remotes and credentials
...
- **Tags:** `kline`, `analysis`, `deepseek-harness-plugin`
...
- **Why use it:** Practical plugin dev guide covering cordis, tsconfig, Windows junctions.
...
- **Why use it:** Engineering discipline distilled for robust DSH plugin development.
...
- **Tags:** `ai-director`, `ai-video`, `dsh-plugin`
- **Why use it:** AI video/image/audio skills with configurable model tools in DSH.
...
- **Why use it:** Dynamic plugin marketplace with search, categories, bookmarks and install features
...
- **Tags:** `ui-generator`, `design-systems`, `figma-alternative`
- **Why use it:** Local-first design tool with Figma-like UI generation
...
- **Tags:** `desktop-app`, `dsh-plugin`, `cordis`
...
- **Tags:** `dsh-web-ui`, `dsh-plugin`, `cordis`
- **Why use it:** Web GUI with WebGL-optimized skins, task boards, and mobile/SSH support.
...
- **Why use it:** Open sidebar foundation with file editor, terminal, chat, Git support.
...
- **Tags:** `desktop`, `electron`, `pets`, `mcp`
...
- **Why use it:** Lightweight Tauri desktop app, 5MB installer, zero setup
...
- **Tags:** `widget`, `desktop`, `utility`, `fun`
...
- **Why use it:** Full-featured Electron desktop client with SSH, skills, and mobile remote access.
...
- **Tags:** `ui`, `web`, `usage-tracking`
- **Why use it:** Displays provider/model info, live balance, and peak/off-peak pricing.
...
- **Tags:** `desktop`, `tauri`, `deepseek-harness`, `dsh-plugin`
...
- **Why use it:** Enterprise-grade RAG platform with semantic search and wiki
...
- **Tags:** `long-term-memory`, `rag`, `self-evolving`
...
- **Tags:** `agent-memory`, `long-term-memory`, `mcp`, `noema`
...
- **Tags:** `agent-skills`, `embeddings`, `semantic-search`, `reranking`
...
- **Tags:** `memory`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Connects to PowerContext for memory recall, handoff, and experience storage
...
- **Tags:** `memory`, `claude-code`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Bridges Claude Code memory, skills, and config into DeepSeek Harness
...
- **Why use it:** AI persona skill for conversational digital human interaction
...
- **Why use it:** 20+ industrial prompt templates for GPT-Image2 with Skill integration.
...
- **Why use it:** Self-improving agent OS with evaluation-driven autonomous skill evolution.
...
- **Tags:** `agent-collaboration`, `multi-agent-workspace`, `visual-editor`
- **Why use it:** Enterprise multi-engine workbench with agent collaboration and visual editor.
...
- **Why use it:** Enables text-only LLMs to see and understand images
...
- **Why use it:** Self-hosted human-in-the-loop task manager for agents
...
- **Why use it:** Turns AI chats into organized reusable workflows across platforms
...
- **Tags:** `vision`, `agent-skills`, `ocr`
- **Why use it:** Native DSH vision toolkit with image Q&A and OCR
...
- **Tags:** `ai-agents`, `creative-writing`, `drama-skills`, `novel-writing`
- **Why use it:** Powerful creative writing and drama skills for DSH agents
...
- **Tags:** `context-migration`, `preset-migration`, `session-migration`, `cordis`
...
- **Tags:** `task-management`, `taskboard`, `sqlite`, `agent`
...
- **Tags:** `skills`, `superpowers`, `reasonix`, `coding-agent`
...
- **Why use it:** 85 comprehensive reverse engineering SKILL.md for CTF and pentesting
...
- **Why use it:** OCR and pixel-art image reading tools for text-only AI models
...
- **Tags:** `agent-skills`, `session-memory`, `agent-handoff`
...
- **Tags:** `agent-skills`, `chinese-wisdom`, `bazi`, `fengshui`
- **Why use it:** Unique Bazi/Fengshui/IChing agent skill with local deterministic engine
...
- **Tags:** `multi-agent`, `team-collaboration`, `dsh-plugin`
...
- **Why use it:** User-invoked Swift Cycle governance skill with offline verifiability
...
- **Tags:** `package-manager`, `agent-skills`, `mcp`, `cli`
...
- **Tags:** `skills`, `mcp`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Configure MCP and skills via Web UI with hot reload, upload .skill files easily
...
- **Tags:** `godot`, `game-dev`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Godot 4.x game development skill for DSH, registers at runtime
...
- **Tags:** `mcp`, `skills`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Unified menu to control MCP tool and skill exposure level and execution mode
...
- **Tags:** `ui`, `vibedesign`, `design-as-code`
...
- **Why use it:** Automated Vox-style paper-collage explainer video generation end-to-end.
...
- **Why use it:** Preview, inspect, and edit OpenPencil .op design files in conversation.
...
- **Tags:** `design-skills`, `vibe-coding`, `web-design`
- **Why use it:** 6 design style presets to avoid generic AI-generated website aesthetics
...
- **Why use it:** OAuth ChatGPT binding for in-app model access
...
- **Why use it:** Privacy-focused, fully customizable open-source resume builder
...
- **Why use it:** Unified virtual filesystem abstraction layer for cross-platform AI agents.
...
- **Why use it:** Plugin radar with 9000+ candidates, real-world tested top 50 rankings.
...
- **Tags:** `awesome-list`, `ecosystem`, `reference`
...
- **Why use it:** Best context insight and management with dashboard and browser
...
- **Tags:** `awesome-list`, `ecosystem`, `reference`
- **Why use it:** Curated DSH ecosystem plugins, tools, and infrastructure list
...
- **Why use it:** Track session/daily costs, budgets, and quota usage in real time.
...
- **Why use it:** Bridge Pi extensions into DSH via shared ABI compatibility layer.
...
- **Why use it:** Generate images directly in DSH chats via multiple AI backends
...
- **Why use it:** Crash-rescue with undo config, snapshots, and SAFE MODE recovery
...
- **Tags:** `plugin-market`, `webui`, `ui`, `awesome-dsh-plugin`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `plugin-management`
...
- **Tags:** `dsh-plugin`, `skill-picker`, `ui-ux`
...
- **Why use it:** Audits context injection token costs, detects duplicates and conflicts
...
- **Tags:** `plugin-manager`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Built-in GUI plugin manager with hot-reload, manages MCP/skills without restart
...
- **Tags:** `monitoring`, `cost`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Real-time token usage, cost estimates, and API balance visualization charts
...
- **Tags:** `hud`, `monitoring`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Floating HUD panel showing git status, MCP servers, skills, model and token info
...
- **Tags:** `utility`, `conflict-resolution`, `doctor`
...
- **Tags:** `search`, `discoverability`, `plugin-search`
...
- **Tags:** `agent-tools`, `capability-check`, `pre-flight`
- **Why use it:** Pre-flight plugin library check for agent task requests
...
- **Why use it:** Multi-source plugin registry merging awesome lists and GitHub/npm searches
...
- **Tags:** `publisher`, `utility`, `automation`
- **Why use it:** One-click publish tool with validation, description generation, and PR commands
...
- **Why use it:** WebGPU ocean-themed visual skin for a beautiful DSH experience.
...
- **Why use it:** One-click switch between 34 opencode themes — no restart needed.
...
- **Tags:** `theme`, `ui`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Custom background plugin for DSH Web with preset themes and image upload support
...
- **Why use it:** Curated awesome list covering plugins, skills, MCP servers and more.
...
- **Why use it:** Plugin marketplace hub with 3,100+ plugins, search, rankings and API.
...
- **Tags:** `marketplace`, `plugin-marketplace`, `plugins`
- **Why use it:** Plugin hub and marketplace for DeepSeek Harness v4 Pro ecosystem.
...
- **Why use it:** Search 65,600+ API docs from 20 major Chinese platforms with zero config
...
- **Tags:** `math`, `skills`, `deepseek-harness`
- **Why use it:** Math modeling toolkit with 17 skill cards and presets for DeepSeek Harness
...
- **Tags:** `finance`, `stock`, `awesome-list`, `deepseek-harness`

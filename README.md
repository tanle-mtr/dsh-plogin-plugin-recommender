...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 865,919 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 22:33:15 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,155 | Core harness framework powering the entire DSH plu |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,464 | Open-source design tool empowering coding agents t |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,399 | Multi-agent swarm orchestrator for autonomous work |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 28 plugins
...
- [Coding Agents & Harness Tools](coding-agents-harness-tools) (28)
...
- **Tags:** `ai-agent`, `dsh-plugin`, `mcp`
- **Why use it:** Self-evolving multi-model agent with memory and skill capabilities.
...
- **Tags:** `dsh-plugin`, `coding-agent`, `tui`
...
- **Tags:** `dsh-plugin`, `no-code`, `internal-tools`
- **Why use it:** AI + no-code platform for rapidly building business systems.
...
- **Why use it:** Router-standard kit for task-aware reasoning mode in DSH
...
- **Why use it:** Self-improving agent OS that gets smarter with usage
...
- **Tags:** `multi-agent`, `enterprise`, `visual-editor`
...
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tools
...
- **Tags:** `model-switch`, `coding-agent`, `dsh-plugin`
- **Why use it:** One-click model switching across Claude, Codex, Grok, DSH and more.
...
- **Tags:** `code-review`, `lint`, `code-quality`
...
- **Why use it:** Makes coding agents architecture-aware with baseline-first and drift-checking
...
- **Why use it:** Vision toolkit for text-only models: OCR, image Q&A, and UI restoration
...
- **Tags:** `security`, `agent`
- **Why use it:** AI security audit tool detecting hallucinated packages and vulnerable code patterns.
...
- **Tags:** `armor-breaking`, `prompt`
- **Why use it:** DeepSeek-specific armor-breaking plugin with stabilized prompt injection technique.
...
- **Tags:** `android`, `mobile`, `coding`
- **Why use it:** Build and test Android apps via emulator or USB in conversation
...
- **Why use it:** Superpowers skill port bringing advanced coding capabilities to Reasonix
...
- **Why use it:** Pixel-to-text OCR skill enabling text-only models to read images — practical vision enhancement.
...
- **Tags:** `mcp`, `skill-management`, `web-gui`
- **Why use it:** Web GUI plugin to manage skills and MCP servers directly from browser settings.
...
- **Why use it:** Package manager for AI agents: 42 skills, 5 CLIs for eval-driven and spec-driven development.
...
- **Tags:** `plugin-development`, `agent-skills`, `development`
...
- **Why use it:** Hot-load MCP and skill management via Web GUI — paste JSON to connect, no restart needed.
...
- **Tags:** `documentation`, `plugin-development`, `best-practices`
- **Why use it:** Practical plugin development guide covering cordis, tsconfig, Windows junctions, and zstd tips.
...
- **Tags:** `plugin-creator`, `validation`, `skill`
...
- **Why use it:** Complete toolkit for building and testing DSH plugins
...
- **Why use it:** OAuth ChatGPT integration to use subscription models in DSH
...
- **Tags:** `agent-tools`, `plugin-check`, `utility`
...
- **Why use it:** Open-source design tool empowering coding agents to generate UIs.
...
- **Why use it:** Modern desktop client built specifically for the DeepSeek Harness ecosystem.
...
- **Tags:** `dsh-web`, `dsh-plugin`, `marketplace`
- **Why use it:** Web-based DSH plugin marketplace and ecosystem aggregator
...
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, Git, and agent pages.
...
- **Tags:** `desktop-pet`, `electron`, `plugin-sdk`
...
- **Tags:** `widget`, `desktop`, `balance-monitor`
...
- **Why use it:** Local-first desktop workspace for DSH sessions, files, web research and plugins
...
- **Tags:** `ui`, `interactive`
- **Why use it:** Interactive inline UI components: layouts, charts, forms, and quizzes in replies.
...
- **Tags:** `ui`, `workspace`
- **Why use it:** Visual non-linear canvas workspace for branching conversation exploration.
...
- **Why use it:** Open-source Windows desktop GUI with SSH, plugins and remote access.
...
- **Why use it:** Electron desktop console for multi-tab DSH/Plugin/MCP/Skill management — ready-to-use GUI.
...
- **Why use it:** Status bar showing provider, model, live balance, and peak/off-peak pricing with countdown.
...
- **Why use it:** Infinite canvas with powerful creative skills integration
...
- **Why use it:** All-in-one Tauri desktop with DB, SSH, Docker and AI tools
...
- **Tags:** `electron`, `desktop`, `web-ui`
- **Why use it:** Electron desktop wrapping DSH web with sidebar and plugins
...
- **Tags:** `dsh-plugin`, `rag`, `vector-search`
...
- **Why use it:** Powerful memory management kit specifically designed for AI agents.
...
- **Why use it:** Provides unlimited memory capabilities for OpenClaw/DSh agents
...
- **Tags:** `knowledge`, `rag`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering agents, RAG, multimodal, and learning paths.
...
- **Tags:** `agent-memory`, `embeddings`, `skill-md`
- **Why use it:** Turn scattered SKILL.md files into retrieval-ready agent skill corpora.
...
- **Tags:** `multi-agent`, `dsh-plugin`, `mcp-server`
- **Why use it:** Multi-agent swarm orchestrator for autonomous workflow coordination.
...
- **Why use it:** Distill agent thinking patterns into reusable skills for any bot.
...
- **Why use it:** Intelligently orchestrates local skills and automates harness workflows.
...
- **Why use it:** Enables multi-agent teamwork and coordination within the DSH ecosystem
...
- **Tags:** `workflow`, `prompt-management`, `productivity`
- **Why use it:** Organizes AI conversations into reusable workflows across major AI platforms
...
- **Tags:** `agent`, `workflow`
- **Why use it:** Coordinates multiple coding agents into one collaborative team for dispatching tasks.
...
- **Tags:** `ai-agent`, `math-modeling`, `dsh-plugin`
...
- **Tags:** `skills`, `tdd`, `deepseek-harness`
- **Why use it:** Brings Proven TDD, debugging, and planning skills to DSH from Superpowers framework.
...
- **Why use it:** Comprehensive reverse-engineering and pentesting skill (85 SKILL.md) for security research.
...
- **Why use it:** Turns AI coding assistant into a mentor — project scanning, chapter-based learning, and code review.
...
- **Why use it:** 88 open-source agent skills covering research, social intelligence, marketing, and business workflows.
...
- **⭐ Stars:** 43
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工��集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `legal`, `visualization`, `diagram`
- **Why use it:** Legal visualization skill: transforms messy litigation diagrams into presentation-ready timelines.
...
- **Tags:** `plugin-dev`, `skills`, `agent-skills`
- **Why use it:** Agent Skill for developing DSH plugins — covers slots, services, events, tools, and packaging standards.
...
- **Why use it:** Portable spec-driven development skill following DeepSeek Harness engineering patterns.
...
- **Why use it:** Official docs knowledge base as on-demand agent skill
...
- **Why use it:** Integrates Bazi, Fengshui, IChing into one local deterministic engine
...
- **Why use it:** Adapted skill for automated code simplification from DSH
...
- **Why use it:** Dedicated skills management plugin for DSH
...
- **Why use it:** Version-pinned Swift Cycle governance skill adapter
...
- **Why use it:** Image reading and generation capabilities with auto vision transcription for DSH.
...
- **Why use it:** Full Chinese official document processing: format check, optimization, template generation per GB/T 9704.
...
- **Tags:** `skills`, `gamification`, `task-management`
- **Why use it:** Game-like mission system with fog-of-war map and task bar progress tracking.
...
- **Why use it:** Essential engineering discipline guide for DSH agent workflows
...
- **Why use it:** Virtual product team preset for guided PM-to-engineering workflows
...
- **Why use it:** Vision bridge plugin enabling OCR for text-only coding agents
...
- **Tags:** `dsh-plugin`, `image-prompts`, `skills`
- **Why use it:** 530+ reverse-engineered image prompts distilled into reusable skills.
...
- **Why use it:** Beautiful verifiable architecture diagrams with motion and crisp rendering
...
- **Why use it:** AI-generated design studio with visual editor, templates and PPT creation
...
- **Why use it:** Generate AI images directly within DeepSeek Harness chat sessions.
...
- **Why use it:** Preview and edit OpenPencil designs directly in conversation
...
- **Tags:** `ai-video`, `image-generation`, `directorx`
- **Why use it:** AI video/image/audio creation and editing with configurable vision and generation model tools.
...
- **Why use it:** Enhancement suite and prompt manager for major AI web platforms.
...
- **Tags:** `content-discovery`, `browser`, `privacy-first`
- **Why use it:** Local-first AI agent that discovers content across Bilibili, YouTube, and more.
...
- **Tags:** `agent`, `browser-use`, `deepseek-harness`
- **Why use it:** Enables AI agents to control your real logged-in browser via CLI and extension
...
- **Tags:** `search`, `browser`
- **Why use it:** Free web search bridge plugin for all models without native internet access.
...
- **Tags:** `ios`, `automation`
- **Why use it:** Live iOS Simulator and USB iPhone control with 22 agent tools inside DSH conversations.
...
- **Why use it:** Playwright-powered browser automation plugin for DSH
...
- **Tags:** `zhihu`, `mcp`, `search`
- **Why use it:** Zhihu search, Zhida Q&A, and official open-platform API via Skill, CLI, and MCP.
...
- **Why use it:** Privacy-first resume builder with full customization and portability.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with DSH integration.
...
- **Why use it:** Official visual plugin marketplace inside DeepSeek Harness for browsing and installing.
...
- **Why use it:** Context dashboard and management tool with statistics and browser integration
...
- **Why use it:** Track session and daily costs, budgets, and API quotas in real time.
...
- **Why use it:** Bridge Pi ecosystem extensions to run as native DSH plugins.
...
- **Tags:** `marketplace`, `plugin-manager`, `web`
- **Why use it:** One-click browse, install and update all DSH plugins in Web GUI
...
- **Why use it:** Crash-rescue with undo, snapshots and SAFE MODE for DSH
...
- **Tags:** `awesome-list`, `directory`, `reference`
...
- **Why use it:** Manage skills and MCP tools directly from the DSH Web UI
...
- **Tags:** `marketplace`, `community`, `webui`
- **Why use it:** Community plugin market for browsing and one-click install/uninstall
...
- **Why use it:** Infrastructure for DSH plugin ecosystem — browser console for plugin management + dev guidance skill.
...
- **Tags:** `dsh-plugins`, `configuration`
...
- **Tags:** `config-manager`, `mcp`, `skills`
...
- **Why use it:** Audit AGENTS.md token costs and detect conflicts
...
- **Tags:** `migration`, `claude-code`, `mcp`
- **Why use it:** Seamlessly migrate Claude Code setup into DeepSeek Harness
...
- **Tags:** `diagnostics`, `conflicts`, `utility`
- **Why use it:** Detects and resolves DSH plugin version conflicts automatically
...
- **Why use it:** Search and discover DSH plugins directly from agents.
...
- **Why use it:** Plugin marketplace for DSH, similar to CodeX experience.
...
- **Why use it:** WebGPU-powered ocean-themed Chrome/Edge extension for DSH.
...
- **Tags:** `design-skills`, `vibe-coding`, `ui`
- **Why use it:** 6 design styles to make AI-generated sites look polished and human-designed.
...
- **Tags:** `theme`, `color-scheme`, `customization`
- **Why use it:** 34 opencode classic color themes, one-click apply, persists after restart.
...
- **Why use it:** Upload custom backgrounds or switch presets with live preview
...
- **Tags:** `dsh-plugin`, `ai-resources`, `vibecoding`
...
- **Why use it:** Auto-searches top 8 Chinese platforms for last 30 days and generates cited reports.
...
- **Why use it:** Daily-curated plugin marketplace with scenario classification and popularity rankings.
...
- **Why use it:** Learn DSH principles, browse plugin marketplace and best practices collection.
...
- **Why use it:** Curated DSH plugin & tool list — ideal starting point for ecosystem exploration.
...
- **Tags:** `awesome-list`, `plugin-marketplace`, `ecosystem`
- **Why use it:** Community-maintained auto-syncing DSH plugin catalog with curated directory every 4 hours.
...
- **Tags:** `api-documentation`, `chinese-api`, `research-tools`
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms directly inside coding agents — zero config.
...
- **Tags:** `awesome-list`, `plugin`, `official`
- **Why use it:** Official auto-generated plugin catalog curated by cordis.run — reliable ecosystem reference.
...
- **Tags:** `dsh-plugin`, `finance`, `analysis`
...
- **Tags:** `evaluation`, `rag-evaluation`, `agent-evaluation`
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, skills, and agents across multiple platforms.
...
- **Why use it:** Curated list of essential DSH plugins, great discovery resource
...
- **Tags:** `toy`, `fun`, `mobile`
- **Why use it:** A fun zero-dependency traditional toy simulator for mobile browsers.
...
- **Why use it:** Curated plugin radar with real installation testing and auto-updating index
...
- **Tags:** `awesome-list`, `curated`, `plugin-ecosystem`
- **Why use it:** Comprehensive curated plugin list covering the entire DSH plugin ecosystem
...
- **Why use it:** Ecosystem catalog of curated plugins, tools, and infrastructure from DSH hub
...
- **Why use it:** Comprehensive guide with resources, plugins and tools for quick DSH onboarding.
...
- **Why use it:** Curated list covering plugins, MCP servers, patches and UIs for DSH.
...
- **Why use it:** Convenient anime search with Bangumi ratings and magnet support
...
- **Tags:** `dsh`, `community`, `photo-wall`
- **Why use it:** DSH beta closing photo wall with OAuth login and Polaroid-style group photos.
...
- **Why use it:** Curated list of quality DSH plugins for ecosystem discovery
...
- **Tags:** `registry`, `awesome-list`, `plugins`
...
- **Why use it:** Evidence-led curated directory with installation guidance
...
- **Why use it:** Plugin product manual with scenario-based selection guidance
...
- **Tags:** `repository`, `plugins`, `verify`
- **Why use it:** DSH plugin repository with verification capabilities
...
- **Tags:** `awesome-list`, `bilingual`, `registry`
- **Why use it:** Evidence-led bilingual directory reviewed at immutable commits
...
- **Tags:** `awesome-list`, `radar`, `registry`
- **Why use it:** Plugin radar with 2Origin lab for community curation
...
- **Why use it:** Comprehensive 1000+ DSH plugin directory sorted by stars.
...
- **Why use it:** Curated collection of DSH plugins, tools, skills & resources.
...
- **Why use it:** Moved to new repo; legacy reference for DSH plugin list.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Curated DSH plugin collection for quick reference.
...
- **Why use it:** Comprehensive curated DSH plugins covering models, tools, UI.
...
- **Why use it:** Industry-specific DSH plugins: IT, finance, legal, healthcare.

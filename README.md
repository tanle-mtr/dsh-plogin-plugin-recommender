...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 840,652 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 20:29:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,726 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,714 | Open-source design system and prototyping tool for |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,024 | Multi-agent swarm orchestrator with autonomous wor |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 23 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 8 plugins
...
- [Research & Analysis](#research-&-analysis) — 8 plugins
- [Other](#other) — 55 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (23)
- [MCP Servers & Tools](mcp-servers-tools) (8)
...
- [Research & Analysis](research-analysis) (8)
- [Other](other) (55)
---
...
- **Tags:** `ai-agents`, `cordis`, `dsh-plugin`
...
- **Tags:** `agent-os`, `coding-agent`, `loop-engineering`, `mcp`
- **Why use it:** Self-improving agent OS with built-in evaluation loop
...
- **Tags:** `agent-collaboration`, `enterprise-agent-workspace`, `multi-agent-workspace`
- **Why use it:** Enterprise multi-agent workspace unifying Codex, DSH, and Opencode
...
- **Why use it:** Multi-model one-click switch for DSH ecosystem across platforms
...
- **Tags:** `dsh-plugin`, `agent-runtime`, `ai-coding`
- **Why use it:** Rust agent runtime paired with polished desktop AI coding IDE
...
- **Tags:** `dsh-plugin`, `code-review`, `developer-tools`
- **Why use it:** AI code review grounded in 12 classic engineering architecture books
...
- **Tags:** `coding-agent`, `architecture`, `spec-driven`
- **Why use it:** Architecture-aware AI coding with baseline-first and drift checks.
...
- **Why use it:** Unifies multiple coding agents into one coordinated team workflow
...
- **Why use it:** Multi-agent team collaboration with shared workspace and独立模型
...
- **Tags:** `agent-framework`, `dsh-plugin`, `claude-code`, `python`
- **Why use it:** Comprehensive AI agent asset package manager with 42 skills and multiple CLIs
...
- **Tags:** `plugin-development`, `cordis`, `dsh-plugin`
...
- **Why use it:** Practical DSH plugin development best practices and troubleshooting archive
...
- **Tags:** `agent-skills`, `best-practices`, `dsh-plugin`
- **Why use it:** Engineering discipline distilled from DSH — fact-finding and evidence-based reporting
...
- **Tags:** `dsh-plugin`, `agent-skills`, `development`
- **Why use it:** Scaffold, build and test DSH plugins entirely within the harness
...
- **Why use it:** Godot 4.x full-stack game dev skill with GDScript support
...
- **Why use it:** All-in-one desktop: DB, SSH, Docker panels with AI assistant
...
- **Tags:** `agent-tools`, `plugin-checklist`
- **Why use it:** Pre-flight plugin check that auto-injects top-K relevant plugins for task-type requests.
...
- **Tags:** `agent-orchestration`, `coding-agent`, `mcp`, `no-code`
- **Why use it:** Unified agent workspace across all devices with task tracking
...
- **Tags:** `dsh-plugin`, `ui-extension`
- **Why use it:** Zero-dependency web simulation of traditional bamboo dragon toy
...
- **Tags:** `dsh-plugin`, `sidebar`
- **Why use it:** Open sidebar foundation with file editor, terminal, Git, and sub-agents
...
- **Tags:** `dsh-plugin`, `tui`, `terminal`
- **Why use it:** Claude Code-style TUI with whale header, real-time status and flow
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero environment setup.
...
- **Why use it:** Local-first desktop workspace for DSH sessions, files, and research.
...
- **Tags:** `desktop-app`, `multi-model`, `privacy`
...
- **Tags:** `ui-components`, `charts`, `interactive`
...
- **Why use it:** Native SQLite taskboard with agent claim and review UI
...
- **Why use it:** Persistent bottom info bar showing provider, model, balance and pricing
...
- **Why use it:** Floating HUD panel showing git status, MCP, skills and usage
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI, ModLens, and sidebar plugins.
...
- **Tags:** `long-term-memory`, `mcp`, `rag`, `self-evolving`, `skills`
...
- **Tags:** `memory`, `r ag`, `deepseek-harness`
...
- **Why use it:** Context dashboard and management with statistics and insights.
...
- **Why use it:** Comprehensive AI knowledge base covering RAG, MCP, agents, and resources
...
- **Why use it:** Durable long-term memory with recall tools for agents
...
- **Tags:** `memory`, `rag`, `skills`, `retrieval`
- **Why use it:** Curate and retrieve agent skills from SKILL.md files
...
- **Why use it:** Connects PowerContext for memory recall and skill handoff
...
- **Why use it:** Bridge Claude Code memory and skills into DeepSeek Harness
...
- **Why use it:** Multi-agent swarm orchestrator with autonomous workflow coordination
...
- **Why use it:** Versatile multi-model agent harness with self-evolving memory and skills
...
- **Why use it:** Anthropic J-space inspired cognitive enhancement skills for agents
...
- **Tags:** `agent-skills`, `dsh-plugin`, `workflow-automation`
- **Why use it:** Intelligent workflow orchestrator routing local skills automatically
...
- **Tags:** `dsh-plugin`, `video-generation`, `agent-skills`
- **Why use it:** End-to-end Vox-style video generation from topic to finished video
...
- **Tags:** `task-manager`, `human-in-loop`, `agent-workflow`
- **Why use it:** Self-hosted human-in-loop task manager with mobile and web control.
...
- **Why use it:** Enables multi-agent team coordination for complex tasks.
...
- **Tags:** `vision`, `ocr`, `native-integration`
- **Why use it:** DeepSeek Harness native vision toolkit: image Q&A, OCR, UI restore.
...
- **Tags:** `skills`, `infra`, `coding`
- **Why use it:** Specialized skills for AI infrastructure dev workflows
...
- **Why use it:** Port of Superpowers skills to Reasonix coding harness
...
- **Why use it:** TDD, debugging, and planning skills adapted for DSH
...
- **Why use it:** Enables cross-platform agent continuity with session memory
...
- **Why use it:** Adapts DSH code simplification skill for Codex users
...
- **Tags:** `ai-agent`, `chinese-traditional-wisdom`, `dashboard`
- **Why use it:** Unique skill pack: Bazi, Fengshui, IChing with local engine
...
- **Why use it:** Swift Cycle governance skill for DSH with version pinning
...
- **Tags:** `gongwen`, `docx`, `ai-docs`, `deepseek-harness`
...
- **Tags:** `record-replay`, `agent-skills`, `macos`
- **Why use it:** Record desktop workflows and auto-generate agent skills
...
- **Why use it:** Math modeling enhancement with 17 pre-built skill cards
...
- **Why use it:** Agent preset simulating a full product team (PM to QA) for guided project workflows.
...
- **Tags:** `agent-skills`, `multimodal`, `ocr`, `vision`
- **Why use it:** Vision bridge plugin: paste images get structured JSON evidence
...
- **Why use it:** Free web search bridge plugin for all models without native web access
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Manage skills and MCP tools directly from the Web UI
...
- **Why use it:** Paste JSON to connect MCP servers; upload skills for instant setup
...
- **Why use it:** Built-in DSH agent plugin search via npm and curated lists for better discoverability.
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** OAuth-bound ChatGPT plugin to chat with ChatGPT/Codex models inside DSH using subscription.
...
- **Why use it:** Open-source design system and prototyping tool for AI agents
...
- **Tags:** `diagrams-as-code`, `architecture`, `mermaid`
...
- **Tags:** `image-prompts`, `prompt-engineering`, `skills`, `workflow-automation`
- **Why use it:** 470+ professional image prompts with industrial templates
...
- **Tags:** `agent-team`, `flutter`, `react`, `skill`, `vibecoding`
...
- **Why use it:** Full AI design studio with PPT, prototyping, and visual editor
...
- **Tags:** `design`, `ui`, `ppt`
- **Why use it:** Edit and preview OpenPencil designs directly in conversation
...
- **Why use it:** Image reading & generation skills for DSH with multiple vision models
...
- **Tags:** `design`, `vibe-coding`, `ui`
- **Why use it:** 6 design aesthetics styles to avoid generic AI-generated looks
...
- **Tags:** `ai-video`, `ai-image`, `directorx`, `visual`
- **Why use it:** AI video/image/audio skills with DirectorX integration and storyboard support
...
- **Tags:** `canvas`, `agentic-workflow`, `mcp`, `creative`
- **Why use it:** Native infinite canvas with creative skills for WeShop AI workflows
...
- **Why use it:** Community photo wall with GitHub OAuth for DSH内测收官纪念
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and platforms
...
- **Tags:** `agent-sandbox`, `agent-tools`, `vfs`, `virtual-filesystem`
- **Why use it:** Unified virtual filesystem for all AI agents across environments
...
- **Why use it:** Built-in plugin marketplace for browsing and one-click installation
...
- **Why use it:** Curated top 50 plugins from 9000+ candidates with live verification
...
- **Tags:** `oauth`, `llm-provider`, `utility`
...
- **Tags:** `backup`, `crash-recovery`, `utility`
- **Why use it:** Crash-rescue with snapshot rollback for configs and plugins
...
- **Tags:** `migration`, `context`, `utility`
- **Why use it:** Cross-preset session migration preserving full context
...
- **Why use it:** Audit AGENTS.md token costs, detect conflicts with Web UI panel
...
- **Why use it:** Complete DSH config backup/restore via WebDAV with migration support
...
- **Tags:** `token-usage`, `visualization`, `cost`
- **Why use it:** Real-time token usage charts and API balance tracking
...
- **Why use it:** Curated evidence-led bilingual DSH plugin directory
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Concise DSH plugin collection
...
- **Why use it:** Evidence-aware curated shortlist of DSH plugins
...
- **Tags:** `dsh-plugin`, `plugin-directory`, `registry`
- **Why use it:** Comprehensive curated DSH plugins covering models, tools, UI, and agent loops
...
- **Why use it:** Industry-specific DSH plugins for finance, legal, HR, healthcare, and more
...
- **Why use it:** Unified plugin registry merging multiple sources with deduplication
...
- **Why use it:** Official auto-generated Cordis plugins list curated by cordis.run
...
- **Why use it:** One-click plugin publisher that validates, generates docs, and creates PRs
...
- **Tags:** `cordis`, `dsh-web-ui`, `dsh-plugin`
- **Why use it:** Web GUI, mobile SSH, and WebGL-optimized skin ecosystem
...
- **Tags:** `cli`, `developer-tools`, `mascot`, `pixel-art`
- **Why use it:** Animated pet gallery for multiple AI coding agents
...
- **Why use it:** Whale Girl themed cosmetic skins for DeepSeek Harness UI
...
- **Tags:** `color-scheme`, `theme`, `dark-mode`, `ui`
- **Why use it:** 34 classic opencode themes for DSH, one-click switch with persistent recall
...
- **Why use it:** Custom web background with presets and real-time preview
...
- **Tags:** `agent`, `agentic-ai`, `harness`, `llm`
- **Why use it:** Comprehensive DSH tutorial from beginner to advanced
...
- **Why use it:** Auto-searches 8 major CN platforms for 30-day research reports
...
- **Why use it:** Curated bilingual plugin and tool catalog for DSH ecosystem
...
- **⭐ Stars:** 269
- **Language:** JavaScript
- **Description:** 用 30 秒为你的 DeepSeek Harness找到合适的插件。 仓库由脚本每天自动抓取，再经人工逐个核实——真插件进目录，蹭热度的进黑名单，每条剔���理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **Tags:** `awesome-list`, `verified`, `curated`
- **Why use it:** Auto-verified plugin directory with daily scraping and blacklist
...
- **Tags:** `documentation`, `guides`, `best-practices`
...
- **Why use it:** Ultimate bilingual guide with quickstart, resources, and curated plugins
...
- **Tags:** `kline`, `analysis`, `market`, `deepseek-harness-plugin`
...
- **Why use it:** Curated stock/finance/quant plugin list for DSH
...
- **Why use it:** Privacy-first open-source resume builder with customizable templates
...
- **Why use it:** AI-powered no-code platform for building custom business systems fast
...
- **Tags:** `ai-resources`, `tutorial`, `prompt-engineering`
- **Why use it:** Comprehensive AI resource library and vibe coding tutorials for developers
...
- **Tags:** `awesome-list`, `community`, `directory`
- **Why use it:** Curated ecosystem plugin list for DeepSeek Harness community.
...
- **Tags:** `awesome-list`, `resources`, `directory`
- **Why use it:** Comprehensive curated list of DSH plugins, tools, and resources.
...
- **Why use it:** Public GitHub directory for DSH plugin discovery and installation commands
...
- **Why use it:** Curated list of DSH plugins — 精选插件目录
...
- **Why use it:** Curated 2026 DSH plugin list with quality checks for community reference.
...
- **Tags:** `plugin-directory`, `awesome-list`
- **Why use it:** Plugin directory with scenario-based selection, installation and compatibility guide.
...
- **Why use it:** Verified star-ranked community DSH plugin catalog.
...
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for DSH ecosystem analytics.
...
- **Why use it:** Zero-dependency static portal for discovering, filtering and installing 227+ DSH plugins.
...
- **Why use it:** Archived; redirect to github.com/awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Tags:** `plugin-repository`, `dsh-bundle`
- **Why use it:** DSH plugin repository and bundle collection for the ecosystem.

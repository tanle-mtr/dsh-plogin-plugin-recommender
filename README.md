...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 858,017 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 04:48:13 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 192,786 | Core harness platform enabling all DSH plugins and |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,164 | Open-source design tool and UI generator for AI ag |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,310 | Meta-harness for deploying multi-agent swarms and  |
...
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 23 plugins
...
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (23)
...
- **Why use it:** Core harness platform enabling all DSH plugins and agents.
...
- **Tags:** `cli`, `coding-agent`, `deepseek`
...
- **Why use it:** Makes coding agents architecture-aware with drift-checking and evidence verification
...
- **Why use it:** AI security platform — audits generated code for hallucinations and vulnerabilities.
...
- **Tags:** `agent`, `orchestration`, `coding`
- **Why use it:** Orchestrates multiple coding agents into a collaborative team — spawn, dispatch, coordinate.
...
- **Why use it:** Dedicated skill for building DSH plugins following standard patterns.
...
- **Tags:** `dsh-plugin`, `image-reading`, `ocr`
...
- **Why use it:** Official DSH plugin dev knowledge base with agent skill integration.
...
- **Why use it:** Audits AGENTS.md instruction chains and token costs with Web UI.
...
- **Why use it:** DSH plugin dev notes covering cordis, tsconfig, Windows junction and zstd
...
- **Tags:** `agent-skills`, `best-practices`, `engineering`
- **Why use it:** Engineering discipline distilled from DSH: evidence-based dev practices
...
- **Why use it:** Agent skills to scaffold and test DSH plugins from within.
...
- **Tags:** `dsh-web`, `web-ui`, `plugin-hub`
- **Why use it:** Web-based plugin aggregation hub offering creative workshop distribution for DSH.
...
- **Tags:** `sidebar`, `ui-extension`, `dsh`
- **Why use it:** Extensible sidebar foundation with file editor, terminal, chat, Git, and sub-agent pages.
...
- **Why use it:** Claude Code-style TUI with real-time status, streaming thought, and context progress.
...
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop app experience.
...
- **Why use it:** Local-first desktop agent app with multi-model support and privacy focus.
...
- **Tags:** `ui`, `interactive`, `genui`
- **Why use it:** Inline interactive UI components — charts, forms, quizzes rendered in-chat.
...
- **Why use it:** CodePilot-inspired desktop client suite for DSH across macOS, Windows, and Linux.
...
- **Why use it:** Windows GUI client with SSH and mobile remote access
...
- **Why use it:** Smartisan-style notes with Docker deploy and image export.
...
- **Why use it:** Desktop Electron console for managing Harness, plugins, MCPs, and skills.
...
- **Tags:** `deepseek-harness`, `dsh-plugins`, `desktop-app`
- **Why use it:** Multi-version DSH manager with isolated containers and embedded WebView UI.
...
- **Tags:** `capability-menu`, `mcp`, `ui`, `dsh-plugin`
...
- **Why use it:** All-in-one Tauri desktop integrating DB, SSH, Docker & AI.
...
- **Why use it:** Electron-based desktop wrapper integrating DSH web UI with popular plugins
...
- **Why use it:** Self-evolving AI assistant with memory and knowledge storage.
...
- **Why use it:** Open-source LLM knowledge platform with RAG, agent, and Wiki.
...
- **Tags:** `agent-memory`, `long-term-memory`, `rag`, `markdown`
- **Why use it:** Portable, user-owned memory layer with Markdown-native storage and self-evolution.
...
- **Tags:** `long-term-memory`, `hybrid-retrieval`, `token-savings`
- **Why use it:** Self-evolving memory OS with hybrid retrieval, token savings up to 35%.
...
- **Why use it:** Powerful memory management kit tailored for AI agents with RAG support.
...
- **Tags:** `agent-memory`, `embeddings`, `vector-search`
- **Why use it:** RAG infrastructure for agent skill retrieval
...
- **Tags:** `agent-memory`, `long-term-memory`, `mcp`, `dsh-plugin`
...
- **Why use it:** Connects DSH to PowerContext for memory and skill recall.
...
- **Why use it:** Plugin discovery tool for searching and browsing DSH plugins directly from agents.
...
- **Why use it:** Comprehensive DSH plugin catalog with 1000+ repos sorted by stars.
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `market`
...
- **Tags:** `ai-agents`, `awesome-list`, `coding-agents`, `deepseek-harness`
- **Why use it:** AI-curated comprehensive plugin list with 190+ plugins updated hourly.
...
- **Why use it:** Automated bilingual plugin directory crawled daily via GitHub Actions.
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple DSH plugin directory.
...
- **Tags:** `ai-agents`, `awesome`, `dsh-plugins`, `plugins`
...
- **Tags:** `agent-harness`, `coding-agents`, `deepseek-harness-plugin`, `registry`
...
- **Tags:** `industry`, `dsh-plugin`, `awesome-list`
- **Why use it:** Industry-specific DSH plugin directory for computing, finance, legal, etc.
...
- **Why use it:** Meta-harness for deploying multi-agent swarms and workflows.
...
- **Why use it:** Industrial-grade GPT-Image2 prompt engine with 530+ case studies.
...
- **Why use it:** Beginner-friendly tutorial covering harness engineering from scratch to advanced.
...
- **Tags:** `agent-orchestration`, `workspaces`, `task-tracking`
- **Why use it:** Centralizes all agents and workspaces with board-based task tracking across devices.
...
- **Tags:** `agent-os`, `self-evolving`, `llm-orchestration`
- **Why use it:** Self-improving Agent OS where agents get smarter through continuous self-evaluation loops.
...
- **Why use it:** Enterprise-grade multi-engine workspace with visual editor for agent team collaboration.
...
- **Tags:** `agent-skills`, `workflow-automation`, `skill-orchestration`
- **Why use it:** Intelligent skill router that orchestrates harness workflows automatically.
...
- **Why use it:** Transforms AI conversations into reusable organized workflows
...
- **Tags:** `search`, `web-fetch`, `skill`
- **Why use it:** Best free web search bridge — works for any model without native web access, no signup.
...
- **Why use it:** Novel writing and short-drama production skills
...
- **Why use it:** Turn experience into repeatable agent execution
...
- **Why use it:** Auto-search, install and verify DSH plugins
...
- **Why use it:** Specialized skills for AI infra coding, optimization and debugging.
...
- **Why use it:** Agent workflow plugin for orchestrating DSH tasks.
...
- **Tags:** `orchestration`, `subagent`, `mcp`, `dsh-plugin`
...
- **Why use it:** Transforms AI coding assistant into a mentor with guided chapter-based learning.
...
- **Why use it:** 88 versatile skills for research, social intelligence, marketing automation.
...
- **Why use it:** Specialized legal visualization skill for timelines and case diagrams.
...
- **Tags:** `agent-skills`, `spec-programming`, `developer-tools`
- **Why use it:** Repository-native spec-driven development skill for structured coding workflows.
...
- **Tags:** `agent-skills`, `dsh-plugin`, `developer-tools`
- **Why use it:** Agent skill covering plugin build lifecycle including slots and credentials.
...
- **Why use it:** Enables cross-agent session memory continuity across platforms.
...
- **Tags:** `chinese-traditional-wisdom`, `agent-skill`, `fengshui`
- **Why use it:** Fusion AI agent skill combining Bazi, Fengshui, IChing and TCM.
...
- **Tags:** `dsh-plugin`, `agent-skills`, `skill-picker`
- **Why use it:** WorkBuddy-style skill picker streamlining skill selection in DSH.
...
- **Why use it:** Adapted Codex skill for code simplification and refactoring.
...
- **Tags:** `agent-team`, `multi-agent`, `dsh-plugin`
...
- **Tags:** `skills-manager`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Centralized plugin-based skills management for DeepSeek Harness.
...
- **Tags:** `agent-skills`, `swift-cycle`, `project-governance`
...
- **Why use it:** Image reading & generation skill with auto vision transcription
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `skill`
- **Why use it:** OAuth-powered group photo station with DSH skill wrapper
...
- **Tags:** `agent-skills`, `cli`, `database`
...
- **⭐ Stars:** 14
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增�� 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `ai-docs`
- **Why use it:** Chinese official document processing with GB/T 9704 standard compliance
...
- **Why use it:** AI video/image/audio generation skills via DirectorX integration
...
- **Tags:** `skills`, `gamification`, `wayfinder`
- **Why use it:** Game-like mission system with fog-of-war map and task bar progression

---

### [mudden2380078550-creator/write-chinese-long-screenplay](https://github.com/mudden2380078550-creator/write-chinese-long-screenplay)

- **⭐ Stars:** 13
- **Language:** Python
- **Description:** 中文电影与剧集长剧本写作 skill
- **Tags:** `screenwriting`, `ai-writing`, `chinese`
- **Why use it:** Chinese feature film and TV series long screenplay writing skill
...
- **Tags:** `canvas`, `creative`, `agentic`
- **Why use it:** Enables infinite canvas with creative agentic skills.
...
- **Tags:** `record-replay`, `computer-use`, `skills`
- **Why use it:** Record desktop workflows and convert them into agent skills.
...
- **Tags:** `agent-skills`, `execution`, `discipline`
- **Why use it:** 11 plugins + 6 skills to improve DSH execution discipline.
...
- **Tags:** `agent`, `workflow`, `product-team`
...
- **Tags:** `agent-tools`, `pre-flight`, `automation`
- **Why use it:** Pre-flight plugin library check for predictable agent performance
...
- **Why use it:** Vision bridge enabling text-only agents to process images with structured OCR output.
...
- **Why use it:** Web GUI plugin for managing skills and MCP servers in browser
...
- **Tags:** `mcp`, `zhihu`, `skill`
- **Why use it:** Zhihu search, Zhida Q&A and open-platform APIs via Skill + MCP + CLI
...
- **Why use it:** Hot-reload MCP connections and skill management without restarts.
...
- **Why use it:** Bind ChatGPT via OAuth to chat with models inside DSH
...
- **Tags:** `agent-skills`, `ui-generator`, `figma-alternative`
- **Why use it:** Open-source design tool and UI generator for AI agents.
...
- **Why use it:** Produces beautiful, verifiable architecture and sequence diagrams via agent skill.
...
- **Tags:** `vector-design`, `agent-team`, `design-as-code`
- **Why use it:** AI-native vector design tool with concurrent Agent Teams, turning prompts into UI directly.
...
- **Tags:** `video-generation`, `ffmpeg`, `explainer-video`
...
- **Why use it:** Preview and edit OpenPencil designs in chat
...
- **Why use it:** 6 design style presets to give AI-generated websites a polished look.
...
- **Why use it:** Multi-browser extension enhancement suite for AI platforms.
...
- **Why use it:** Cross-platform local-first content discovery agent across major Chinese and global platforms.
...
- **Why use it:** Live iOS Simulator and real device control directly from DSH conversations — 22 automation tools.
...
- **Why use it:** Tabbit Browser plugin for DSH enabling Playwright-based automation.
...
- **Why use it:** Multi-source anime search within DSH chat
...
- **Tags:** `ai-agent`, `dingtalk`, `chat-bot`, `deepseek-harness`
- **Why use it:** DingTalk IM channel enabling tool-capable agent interactions via chat.
...
- **Why use it:** Secure, private, and portable open-source resume builder.
...
- **Tags:** `no-code`, `low-code`, `ai-agent`
...
- **Why use it:** Provides runtime injector and task-aware reasoning-mode router for improved agent routing.
...
- **Why use it:** Two-phase preset for minimal bootstrap followed by full standard tool configuration.
...
- **Tags:** `virtual-filesystem`, `vfs`, `abstraction`
- **Why use it:** Unified virtual filesystem abstraction that works across all major AI agent frameworks.
...
- **Tags:** `claude-code`, `deepseek-harness`, `tool-switch`
- **Why use it:** One-click multi-model CLI switcher covering major AI coding tools.
...
- **Why use it:** Essential context management dashboard with statistics and browser
...
- **Why use it:** Track token usage and costs per session
...
- **Why use it:** Bridge Pi ecosystem plugins to run on DSH
...
- **Tags:** `marketplace`, `plugin-marketplace`, `dsh-plugin`
...
- **Tags:** `context-migration`, `session-migration`, `dsh-plugin`
...
- **Tags:** `backup`, `crash-recovery`, `undo`, `dsh-plugin`
...
- **Tags:** `plugin-market`, `ui`, `web`, `dsh-plugin`
...
- **⭐ Stars:** 57
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官��插件开发引导
- **Tags:** `console`, `plugin-management`, `ui`
- **Why use it:** Essential plugin management console with browser panel and dev skill guidance.
...
- **Why use it:** Complete DSH config backup, restore, migrate and sync via WebDAV.
...
- **Tags:** `token-tracking`, `cost`, `visualization`
- **Why use it:** Real-time token usage charts and cost estimates for DSH.
...
- **Tags:** `diagnostic`, `utility`, `conflict`
- **Why use it:** Diagnoses and resolves conflicts between DSH plugins
...
- **Tags:** `mascot`, `pixel-art`, `animation`
- **Why use it:** Public gallery of animated pixel-art pets that customize your coding agent's personality.
...
- **Why use it:** Cute whale girl skin series for DeepSeek Harness with aesthetic customization.
...
- **Why use it:** 34 opencode classic themes with one-click switching, no loss after restart
...
- **Why use it:** Custom background plugin with presets and fine-tuning controls
...
- **Tags:** `research`, `web-search`, `report-generation`
- **Why use it:** Auto-searches 8 major Chinese platforms for the past 30 days and generates citable reports.
...
- **Why use it:** Curated bilingual plugin and tool reference for the DSH ecosystem.
...
- **Tags:** `awesome-list`, `curation`, `discovery`
- **Why use it:** Daily curated plugin discovery with scene-based classification and ranking.
...
- **Tags:** `encyclopedia`, `learning`, `resource`
...
- **Tags:** `education`, `reference`, `marketplace`
- **Why use it:** DSH principle learning, plugin marketplace guide, and best practices reference.
...
- **Tags:** `guide`, `awesome-list`, `bilingual`
- **Why use it:** Ultimate bilingual DSH guide with quickstart, resources, plugins, and toolkit.
...
- **⭐ Stars:** 55
- **Language:** TypeScript
- **Description:** 在 DeepSeek Harness / Claude Code / Cursor / Codex / Gemini CLI 里直接���索 20 个中国开放平台的 65,600+ 篇 API 文档；零配置，支持 Skill 与 DSH 原生插件。
- **Tags:** `ai-agents`, `api-documentation`, `chinese-api`
- **Why use it:** Searches 65,600+ Chinese platform API docs directly inside coding agents.
...
- **Tags:** `evaluation-framework`, `rag-evaluation`, `prompt-testing`
...
- **Why use it:** Curated plugin list for easy DSH ecosystem discovery.
...
- **Why use it:** Public directory for discovering and installing DSH plugins.
...
- **Why use it:** Community catalog for discovering DSH plugins.
...
- **Why use it:** Curated stock/finance/quant plugins for vertical analysis
...
- **Why use it:** Evidence-backed DSH plugin radar and lab platform
...
- **Why use it:** Comprehensive AI resource library and zero-basis Vibe Coding tutorial.
...
- **Why use it:** Curated plugin directory serving as an excellent discovery resource for the ecosystem.
...
- **Tags:** `toy`, `web-simulation`, `mobile-friendly`
- **Why use it:** Single-file web simulation of the traditional Chinese bamboo dragonfly toy.
...
- **Why use it:** Curated plugin registry with real-world testing and auto-updating index
...
- **Why use it:** Curated comprehensive plugin ecosystem list for DSH
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated plugins, tools, and infrastructure from DSH ecosystem
...
- **Why use it:** Curated plugin list for DSH ecosystem
...
- **Why use it:** Plugin marketplace with 3100+ plugins and search
...
- **Tags:** `plugin-marketplace`, `dsh-plugins`
- **Why use it:** Plugin marketplace and catalog for DSH
...
- **Why use it:** Curated plugin catalog, great starting point for DSH explorers.
...
- **Why use it:** Auto-synced community catalog, keeps DSH plugin ecosystem organized.
...
- **Tags:** `awesome-list`, `plugin-marketplace`
- **Why use it:** Official auto-generated plugin catalog curated by cordis.run community.
...
- **Why use it:** Curated spam-filtered registry of DSH plugins and skills
...
- **Tags:** `registry`, `awesome-list`
- **Why use it:** Verified star-ranked community DSH plugin collection
...
- **Why use it:** Plugin docs and navigation guide organized by use case
...
- **Tags:** `portal`, `web`, `discovery`
- **Why use it:** Static web portal to discover and install DSH plugins
...
- **Why use it:** D SH plugins repository and verification platform
...
- **Tags:** `registry`, `archived`
- **Why use it:** Archived registry, moved to github.com/awesome-dsh-plugin

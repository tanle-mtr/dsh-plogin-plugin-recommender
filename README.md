...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,044,779 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-18 00:09:17 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 227,924 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,772 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,723 | Deploy multi-agent swarms and autonomous collabora |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 29 plugins
- [Visual & Design](#visual-&-design) — 7 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 5 plugins
- [Communication & Social](#communication-&-social) — 3 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (29)
...
- **Tags:** `agent-orchestration`, `workspace`, `multi-platform`
- **Why use it:** All-in-one agent orchestration platform across desktop, mobile, browser
...
- **Tags:** `routing`, `agent-toolkit`, `performance`
...
- **Tags:** `multi-agent`, `enterprise`, `collaboration`
- **Why use it:** Enterprise multi-agent workspace for Codex, DSH, and OpenClaw teams
...
- **Tags:** `agent-os`, `self-evolving`, `evaluation`
- **Why use it:** Self-improving Agent OS with evaluation-gated evolution loops
...
- **Tags:** `control-plane`, `long-horizon`, `orchestration`
...
- **Tags:** `vision`, `ocr`, `coding-agent`
- **Why use it:** First vision plugin for DSH — OCR and image-to-JSON for text-only agents
...
- **Tags:** `cognition`, `reasoning`, `agent-tools`
...
- **Why use it:** Powerful coding agent with RPC plugin support, sub-agents, hashline edits, and full MCP integration.
...
- **Why use it:** Open-source CLI and resolver for managing DSH plugins from the Plugin Hub
...
- **Tags:** `plugin-creator`, `meta`, `codex`
- **Why use it:** Meta-skill for building and validating DSH/Cordis plugins efficiently
...
- **Tags:** `workbench`, `web`, `skills`, `workspace`
- **Why use it:** Web workbench with global skill management and native workspace integration
...
- **Why use it:** Agent skill for standard DSH plugin development with Claude Code/Codex support.
...
- **Tags:** `agent-tools`, `pre-flight`, `plugin-index`
- **Why use it:** Pre-flight plugin check that injects top-K relevant plugin hints to agents.
...
- **Tags:** `dsh-plugin`, `plugin-directory`
- **Why use it:** Plugin directory for DSH ecosystem
...
- **Why use it:** Curated plugin list (redirected)
...
- **Tags:** `auto-update`, `bilingual`
- **Why use it:** Auto-updating bilingual plugin list
...
- **Tags:** `plugin-directory`, `registry`, `skills`
- **Why use it:** Curated DSH plugins with install guide
...
- **Why use it:** DSH plugin repository
...
- **Why use it:** Modern desktop client for the DSH plugin ecosystem with plugin-first design
...
- **Tags:** `mascot`, `ui-extension`, `pixel-art`
- **Why use it:** Animated pet gallery for multiple coding agents - adds personality to workflows
...
- **Why use it:** Open sidebar foundation with built-in files, terminal, chat, Git, and sub-agent pages
...
- **Tags:** `taskboard`, `ui`, `coding`
- **Why use it:** Modern flexible task board panel embeddable in Codex and DSH environments
...
- **Tags:** `tui`, `ui`, `terminal`
- **Why use it:** Claude Code-style TUI with whale header, real-time status and streaming thinking
...
- **Tags:** `deepseek`, `deepseek-harness`, `desktop`, `dsh`, `dsh-desktop`, `dsh-plugin`, `tauri`
- **Why use it:** Lightweight Tauri desktop app with zero setup and preset plugins for Windows/macOS/Linux.
...
- **Tags:** `ai-writing`, `creative-writing`, `deepseek-harness`, `dsh-plugin`, `electron`, `fiction-writing`, `local-first`, `long-form-fiction`, `novel-writing`, `ollama`, `rag`, `web-novel`, `worldbuilding`, `writing-assistant`
- **Why use it:** Desktop novel writing software organizing inspiration, characters, worldbuilding, and editing workflows.
...
- **Tags:** `desktop-app`, `windows`, `gui`, `ssh-client`
- **Why use it:** Zero-setup Windows desktop GUI for DSH with built-in Codex, plugins, SSH, and mobile remote access.
...
- **Tags:** `desktop-app`, `local-first`, `mcp`
- **Why use it:** Local-first AI desktop workspace integrating sessions, projects, files, web research, and MCP tools.
...
- **Tags:** `gui`, `interactive`, `visualization`
- **Why use it:** Generates rich interactive UI components—charts, forms, quizzes—rendered inline within DSH replies.
...
- **Tags:** `visual-workspace`, `canvas`, `session-management`
- **Why use it:** Canvas-based non-linear conversation workspace enabling visual session exploration and branching workflows.
...
- **Why use it:** Local-first multi-model desktop app alternative to Claude Cowork with self-evolving skills and privacy focus.
...
- **Tags:** `office`, `productivity`, `univer`
- **Why use it:** Bridges spreadsheets, docs, slides and relational tables into DSH natively
...
- **Why use it:** Native iOS/Android client bringing workspaces, chats and agent traces to mobile
...
- **Why use it:** Run live iOS Simulator and USB iPhone automation directly inside DSH conversations
...
- **Why use it:** CodePilot-inspired cross-platform desktop client plugin suite for DSH
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI plugin for managing skills and MCP servers
...
- **Why use it:** Community plugin market browser with one-click install in DSH Web GUI
...
- **Tags:** `tools`, `skills`, `management`
- **Why use it:** Unified tool/skill management with persistent, on-demand, and disabled modes
...
- **Tags:** `ui`, `info-bar`, `pricing`, `balance`
- **Why use it:** Essential bottom bar showing model, balance, pricing and peak/off-peak countdown
...
- **Tags:** `bioinformatics`, `desktop`, `tauri`, `clinical`
...
- **Tags:** `desktop`, `devops`, `docker`
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker, AI assistant.
...
- **Why use it:** Electron shell wrapping DSH web with sidebar, UI and ModLens integration.
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `ui`
- **Why use it:** Compact one-click button for DSH context meter panel, improves UI usability.
...
- **Why use it:** Transforms chat history into downloadable shareable knowledge cards.
...
- **Why use it:** Deploy multi-agent swarms and autonomous collaborative workflows
...
- **Why use it:** Distill thinking patterns into reusable agent skills and meta-skills
...
- **Why use it:** Most comprehensive skills marketplace with auto-crawled GitHub projects
...
- **Tags:** `preset`, `workflow`, `deepseek`
- **Why use it:** Two-phase preset configuration for standardized DeepSeek Harness workflows
...
- **Why use it:** Intelligent skill routing and workflow orchestration with measurable performance gains
...
- **Why use it:** End-to-end automated video generation from topics using Atlas Cloud and ffmpeg.
...
- **Why use it:** Automatically searches and analyzes 8 major Chinese internet platforms for the last 30 days to generate cited research reports.
...
- **Why use it:** Enables collaborative multi-agent teams within DeepSeek Harness ecosystem.
...
- **Tags:** `agent-skills`, `agent-vision-toolkit`, `computer-vision`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `gui-automation`, `ocr`, `plugin`, `python`, `screenshot-testing`, `text-only-llm`, `typescript`, `ui-restoration`, `vision-language-model`, `vision-tools`
- **Why use it:** Powerful vision toolkit for text-only LLMs with image Q&A, OCR, and UI restoration capabilities.
...
- **Tags:** `agent-observability`, `agent-skills`, `multimodal`
- **Why use it:** Gives AI agents vision and audio capabilities with verifiable timestamped output
...
- **Tags:** `creative-writing`, `novel-writing`, `workflow`
- **Why use it:** Built-in workflow workbench for novels, short dramas, games and video recaps
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and clean Web UI
...
- **Tags:** `agent-skills`, `deepseek-harness`, `automation`
- **Why use it:** Full-stack math modeling competition automation with GitOps pipeline.
...
- **Why use it:** Composable agent modes with human review for self-evolving workflows.
...
- **Why use it:** Turn experience into repeatable agent skills across multiple platforms.
...
- **Why use it:** 88 open-source agent skills for research, marketing and social intel.
...
- **Why use it:** Adds multimodal vision to text-only LLMs for UI and chart analysis.
...
- **Why use it:** Reverse engineering and pentesting skill pack with 87 SKILL.md files
...
- **Why use it:** Converts successful DSH sessions into reusable agent skills automatically
...
- **Why use it:** TDD, debugging, planning and collaboration skills adapted from Superpowers
...
- **Tags:** `bazi`, `fengshui`, `iching`, `skill`
- **Why use it:** Unique Chinese metaphysics agent with I Ching, Bazi, Fengshui融合本地引擎
...
- **Tags:** `multi-agent`, `collaboration`, `mcp`, `workspace`
- **Why use it:** Multi-agent collaboration with independent models, MCP tools and shared workspace
...
- **Tags:** `quality-gate`, `engineering`, `requirements`, `delivery`
- **Why use it:** Engineering discipline bundle: grill requirements, test implementation, prove delivery
...
- **Tags:** `qa`, `testing`, `playwright`, `pytest`
- **Why use it:** 11 QA skills with shared knowledge base and type decision matrix for AI agents
...
- **Tags:** `multi-agent`, `memory`, `persistent`, `team`
- **Why use it:** Persistent agent team with private memory, notes and cross-session skill sharing
...
- **Tags:** `handoff`, `session-memory`, `cross-platform`, `context`
- **Why use it:** Cross-platform session handoff skill preserving context and objectives across agents
...
- **Tags:** `code-simplification`, `codex`, `skill`
- **Why use it:** Codex-adapted skill for code simplification inspired by DSH find-simplifications
...
- **Tags:** `design-systems`, `figma-alternative`, `ui-generator`
- **Why use it:** Open-source Figma alternative with local-first desktop and AI design generation
...
- **Tags:** `diagrams-as-code`, `architecture-diagram`, `mermaid-alternative`
- **Why use it:** Generate beautiful verifiable architecture and sequence diagrams as code
...
- **⭐ Stars:** 32,478
- **Language:** JavaScript
- **Description:** Prompt as Code | GPT Image 2 / 2.5 提示词与案例库，530+ 个案例、20+ 套工业级模板与可复用 Skills，���增 2.5 同提示词对比专区，附完整提示词与生成记录，持续更新。
- **Tags:** `image-generation`, `prompt-engineering`, `skills`
- **Why use it:** 530+ GPT Image prompt templates and case library for image generation
...
- **Why use it:** Editable design system with AI generation, visual editing, template marketplace, and PPT studio.
...
- **Tags:** `ocr`, `image-reading`, `vision`, `pixel-art`
- **Why use it:** Pixel-to-text OCR skill enabling image reading for text-only LLM models
...
- **Tags:** `video`, `image`, `audio`, `directorx`, `storyboard`
- **Why use it:** AI video/image/audio creation with storyboard, knowledge corpus and multi-model support
...
- **Tags:** `browser-extension`, `prompt-management`, `ai-platforms`
- **Why use it:** Enhances Gemini, Claude, ChatGPT with prompt management across browsers
...
- **Why use it:** Strongest free web search plugin with no signup required, bridging models lacking native web access.
...
- **Tags:** `browser-automation`, `anti-detect`, `fingerprint`
- **Why use it:** Agent browser with persistent identity, engine-level fingerprint spoofing, and unlimited local profiles.
...
- **Tags:** `content`, `social`, `discovery`
- **Why use it:** Cross-platform content discovery agent from Bilibili, YouTube, Reddit and more
...
- **Tags:** `tts`, `communication`
- **Why use it:** Free Xiaomi MiMo TTS integration with custom and browser voices.
...
- **Why use it:** OAuth integration to chat with ChatGPT models inside DSH using your subscription.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services including S3 and OSS
...
- **Why use it:** AI-powered no-code platform for building business systems and internal tools fast
...
- **Tags:** `terminal`, `vfs`, `sandbox`
- **Why use it:** Virtual terminal and VFS for AI agents — sandboxed execution environment
...
- **Tags:** `installer`, `multi-agent`, `utility`
- **Why use it:** One-click multi-agent framework installer with seamless model switching
...
- **Tags:** `agent-plugins`, `continuous-validation`, `deepseek-harness`, `dsh`, `dsh-plugin`, `ecosystem-radar`, `plugin-registry`
- **Why use it:** Continuous discovery and k8s runtime validation for DSH plugin ecosystem (21k+ candidates).
...
- **Tags:** `cordis-plugin`, `deepseek-harness`, `deepseek-harness-plugin`, `dsh-external`, `dsh-plugin`, `dsh-plugins`
- **Why use it:** Comprehensive context insight and management with dashboard, browser, sidebar, and commands.
...
- **Why use it:** Comprehensive daily-updated plugin marketplace with internet sourcing and pre-publishing review.
...
- **Why use it:** Curated bilingual plugin directory covering extensions, skills, clients, and verified DSH references.
...
- **Tags:** `security`, `code-audit`, `vulnerability`
- **Why use it:** Audits AI-generated code for hallucinated packages, missing safeguards, and AI-specific vulnerability patterns.
...
- **Tags:** `llm-provider`, `oauth`, `subscriptions`
...
- **Why use it:** Track session and daily costs, budgets and token usage across multiple providers
...
- **Tags:** `catalog`, `marketplace`, `plugin-hub`
- **Why use it:** Massive plugin marketplace with search, rankings and public API.
...
- **Tags:** `awesome-list`, `agent-runtime`, `handbook`
- **Why use it:** Comprehensive agent-first handbook covering runtime, plugins and MCP.
...
- **Why use it:** P2P encrypted remote access to Harness from any device securely.
...
- **Why use it:** Curated plugin catalog with bilingual search and STAR ranking.
...
- **Why use it:** Search, install and verify DSH plugins directly within your workflow.
...
- **Tags:** `upgrade`, `utility`
- **Why use it:** Auto-upgrades plugins as DSH version updates
...
- **Why use it:** Backup, restore, and sync DSH config, plugins, MCPs and skills via WebDAV
...
- **⭐ Stars:** 29
- **Language:** TypeScript
- **Description:** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/��具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context`, `audit`, `ui`, `optimization`
- **Why use it:** Context injection auditor: token cost stats, duplicate detection, Web UI ring panel
...
- **Tags:** `management`, `containers`, `installer`, `local`
- **Why use it:** Local DSH manager: run multiple versions in containers, embedded WebView, one-click import
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** Whale Girl skin series for DeepSeek Harness visual customization.
...
- **Why use it:** Highly customizable frosted-glass theme for DSH web with adjustable blur,磨砂度, and background options.
...
- **Tags:** `theme`, `animated`, `ocean`, `threejs`
- **Why use it:** Animated ocean theme with real-time waves, sunset effects, and adjustable glass opacity via Three.js.
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜��不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `themes`, `customization`
- **Why use it:** Custom background images with presets, blur, masking and real-time preview.
...
- **Tags:** `ai-guide`, `vibe-coding`, `rag`
- **Why use it:** Comprehensive AI resource library and vibe coding tutorial for developers
...
- **Tags:** `documentation`, `analysis`, `rust`
- **Why use it:** Generate accurate technical docs and AI-ready context from codebases quickly
...
- **Tags:** `agent`, `ai`, `ai-agents`, `ai-tools`, `awesome`, `awesome-list`, `coding-assistant`, `curated-list`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `dsh-plugins`, `harness`, `llm`, `mcp`, `plugins`
- **Why use it:** Curated comprehensive list of DSH ecosystem plugins, tools, and infrastructure resources.
...
- **Tags:** `academic`, `latex`, `research`, `arxiv`
- **Why use it:** Full-cycle research workbench: LaTeX editing with live compilation, arXiv management, and GPU task orchestration.
...
- **Tags:** `awesome-list`, `plugin-curation`, `discovery`
- **Why use it:** Daily-curated plugin directory with scenario-based classification and rankings
...
- **Tags:** `awesome-list`, `reference`, `plugins`
- **Why use it:** Comprehensive curated list covering plugins, skills, MCPs, patches and UIs
...
- **Tags:** `guide`, `awesome-list`, `beginner-friendly`
...
- **Tags:** `education`, `plugin-marketplace`, `best-practices`
- **Why use it:** Learn DSH internals, browse the plugin marketplace and discover best practices
...
- **Tags:** `academic-search`, `citation-graph`, `mcp`, `research-workflow`
- **Why use it:** Cross-source academic search with citation graphs and verification.
...
- **Why use it:** Industry research domain pack with methodology skills and tracking
...
- **Why use it:** Curated spam-filtered registry for discovering DSH plugins and skills.
...
- **Tags:** `finance`, `quant`, `awesome-list`
- **Why use it:** Curated 24-entry stock/finance/quant plugin list for DSH ecosystem.
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** 2026 curated DSH plugin list with quality checks for AI agents.
...
- **Why use it:** Full 1000+ DSH tool list sorted by stars from GitHub topic ecosystem.
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Hand-picked collection of useful DSH plugins.
...
- **Why use it:** Privacy-first open-source resume builder with self-hosted deployment
...
- **Why use it:** Curated collection of DSH plugins - essential discovery resource
...
- **Tags:** `tutorial`, `harness-engineering`, `beginner`
- **Why use it:** Beginner tutorial for harness engineering from scratch
...
- **Tags:** `dsh-web`, `plugin-ecosystem`, `aggregation`
- **Why use it:** DSH Web plugin ecosystem aggregator for creative workshop distribution
...
- **Why use it:** Smartisan-style notes app with Docker deployment and WeChat/QQ alerts.
...
- **Why use it:** Official auto-generated curated plugin catalog by cordis.run
...
- **Tags:** `plugin-marketplace`, `community`
- **Why use it:** Community plugin marketplace auto-synced every 4 hours
...
- **Why use it:** ProMentor 是一个 AI Coding Agent Skill。装上它，
...
- **Why use it:** You.com skills and plugins for web searc
...
- **Why use it:** Matt Pocock 技能面板（DSH Deck）：安装即自带 25 个工程与
...
- **Why use it:** Proactive associative memory for DSH: ze
...
- **Why use it:** 在 DeepSeek Harness / Claude Code / Curso
...
- **Why use it:** 专利侵权分析系统 —— 输入专利公开号，产出竞品侵权分析报告；同时打包成 ski
...
- **Why use it:** DSH Desktop Hub — DeepSeek Harness 桌面管理控
...
- **Why use it:** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，
...
- **Why use it:** DSH Skills Manager — 在 DeepSeek Harness 
...
- **Why use it:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼
...
- **Why use it:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面
...
- **Why use it:**  Official Huawei Cloud plugin for AI age
...
- **Why use it:** Installable DSH bundle: the dsh-plugin-g
...
- **Why use it:** Portable Agent Skill for repository-nati
...
- **Tags:** `agent-skills`, `deepseek-harness`, `motion-design`, `remotion`, `typescript`, `video`
- **Why use it:** 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。
...
- **Why use it:** The ultimate 2-way bridge between OpenAI Codex and DSH: bidirectional chat sync,
...
- **Tags:** `cordis`, `cordis-plugin`, `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** Unlock DeepSeek Harness plugin-native core capabilities, unifying Runtime, Provi
...
- **Why use it:** 数学建模资源，包含辅助建模、数据预处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harnes
...
- **Tags:** `agent-evaluation`, `ai`, `benchmark`, `bootstrap-ci`, `claude`, `claude-code`, `deepseek-harness`, `dsh-plugin`, `evaluation-as-code`, `evaluation-framework`, `knowledge-engineering`, `krippendorff-alpha`, `llm`, `llm-evaluation`, `llm-judge`, `multi-judge-ensemble`, `prompt-engineering`, `prompt-testing`, `rag-evaluation`, `skill-evaluation`
- **Why use it:** OMK ��� Evidence-backed evaluation and observability for prompts, RAG, skills, a
...
- **Why use it:** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness 插件列表
...
- **Tags:** `agent-harness`, `ai-agent`, `ai-tools`, `awesome`, `awesome-list`, `coding-agent`, `cordis`, `deepseek`, `deepseek-ai`, `deepseek-harness`, `dsh`, `dsh-plugin`, `mcp`, `plugin`, `skills`
- **Why use it:** Awesome DeepSeek Harness (dsh) — curated awesome list of plugins, tools, skills 
...
- **Why use it:** Verified, star-ranked community plugin directory for DSH ecosystem.
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用���的插件产品说明书与导航：按场景选插件，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `dsh-plugin`, `guide`
- **Why use it:** Plugin guide and navigation with install, permissions, compatibility info.
...
- **Why use it:** Curated plugin ecosystem list covering agents, CLI, and web UI tools.
...
- **Why use it:** CodeX-style plugin marketplace for DSH, centralize plugin discovery.
...
- **Tags:** `awesome-list`, `plugin-recommender`, `mcp`
- **Why use it:** 190+ plugins across 12 categories, hourly AI-updated curated list.
...
- **Why use it:** DSHA selected plugin collection for DeepSeek Harness users.
...
- **Why use it:** In-agent plugin search across npm and curated lists for DSH discoverability.
...
- **Tags:** `awesome-list`, `directory`, `verified`
- **Why use it:** 80+ verified DSH plugins organized by functionality for quick lookup.

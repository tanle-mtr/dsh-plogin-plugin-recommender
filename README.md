...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,043,867 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-17 13:16:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 227,540 | Core DSH platform powering the entire plugin ecosy |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,690 | Open-source design tool with Figma-like capabiliti |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,687 | Original multi-agent swarm framework for autonomou |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 35 plugins
...
- [Other](#other) — 41 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (35)
...
- **Why use it:** Core DSH platform powering the entire plugin ecosystem.
...
- **Tags:** `dsh-plugin`, `mcp`, `multi-agent`, `skills`
...
- **Tags:** `dsh-plugin`, `coding-agent`, `tui`, `terminal`
- **Why use it:** Terminal-native DeepSeek coding agent optimized for prefix-cache stability.
...
- **Tags:** `routing`, `injector`, `harness-tools`, `dsh`
- **Why use it:** Injector + reasoning-mode router kit for task-aware DSH agent pipelines
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-orchestration`, `mcp`
- **Why use it:** Self-improving agent OS with interview-gated staged evaluation and budgeted loops
...
- **Tags:** `control-plane`, `long-horizon`, `agent-ops`, `workflow`
- **Why use it:** Long-horizon control plane for durable governed work across multiple harnesses
...
- **Why use it:** First vision plugin enabling image-to-JSON for text-only agents.
...
- **Tags:** `virtual-terminal`, `vfs`
- **Why use it:** First virtual terminal for AI agents with sandboxed filesystem.
...
- **Tags:** `cognitive-enhancement`, `inference-control`
- **Why use it:** Model-agnostic inference-time control for deep reasoning agents.
...
- **Why use it:** Generates AI-ready structured technical docs from code fast.
...
- **Tags:** `dsh-plugin`, `agent-runtime`, `coding`
- **Why use it:** High-perf Rust agent runtime with polished desktop app
...
- **Tags:** `dsh-plugin`, `agent-teams`, `coding`
- **Why use it:** Multi-agent team coordination plugin for DeepSeek Harness
...
- **Tags:** `dsh-plugin`, `context`, `harness`
- **Why use it:** Context dashboard, sidebar, browser and command management
...
- **Tags:** `dsh-plugin`, `vision`, `computer-vision`
- **Why use it:** One-line install vision toolkit: OCR, image Q&A, screenshot-to-UI
...
- **Tags:** `provider`, `subscription`, `oauth`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH LLM providers without API keys
...
- **Tags:** `cli`, `developer-tools`, `plugin-mgr`
- **Why use it:** CLI and resolver tools for managing and building DSH plugins from the hub
...
- **Tags:** `migration`, `compatibility-layer`, `plugin-migration`
- **Why use it:** Bridges Pi ecosystem to DSH with zero-migration compatibility layer
...
- **Why use it:** Adds multimodal vision to Claude Code for UI and screenshot analysis
...
- **Tags:** `mcp`, `dsh-plugin`, `capability`
- **Why use it:** Unified menu to manage MCP tools and skills exposure levels directly in DSH
...
- **Why use it:** Unified loader and manager for local Agent Skills within DSH
...
- **Tags:** `plugin-creator`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Build and validate DSH/Cordis plugins with reusable Codex skill.
...
- **Tags:** `context`, `ui`, `dsh-plugin`
- **Why use it:** Audit context tokens in AGENTS.md, detect duplicates and conflicts with Web UI panel.
...
- **Tags:** `container`, `dsh-plugin`, `utility`
...
- **Tags:** `mcp`, `config-sync`, `dsh`
- **Why use it:** One-click MCP/skills config across multiple AI agents
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge syncing Codex and DSH sessions and skills
...
- **Tags:** `cordis`, `orchestration`, `dsh-plugin`
- **Why use it:** Unifies runtime, provider, plugin, skill and MCP orchestration
...
- **Why use it:** Pre-flight plugin check for DSH agents before tasks
...
- **Tags:** `coding-agents`, `dsh-plugin`
- **Why use it:** Bind ChatGPT account via OAuth and use models in DSH
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `plugin-verify`
- **Why use it:** DSH plugin bundle with verify & registry support
...
- **Tags:** `deepseek-harness`, `moved`
- **Why use it:** Archived, moved to new repository
...
- **Tags:** `deepseek-harness`, `curated-list`, `auto-update`
- **Why use it:** Auto-updating curated list with bilingual README generation
...
- **Tags:** `deepseek-harness`, `plugin-directory`, `registry`, `skills`
- **Why use it:** Comprehensive curated plugins for install, extend, customize
...
- **Tags:** `browser-extension`, `chatgpt`, `claude-ai`, `prompt-manager`
- **Why use it:** Universal AI enhancement suite with prompt management across all major platforms
...
- **Tags:** `agent-workspace`, `board`, `multi-device`, `local-first`
- **Why use it:** Unified agent workspace across all devices with board-based task tracking
...
- **Why use it:** Essential one-click plugin marketplace with visual browsing.
...
- **Why use it:** Extensible sidebar with built-in files/terminal/chat/Git pages.
...
- **Tags:** `task-panel`, `ui`
- **Why use it:** Modern flexible task panel embedded in DSH and Codex workflows.
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thought, rollback.
...
- **Tags:** `dsh-plugin`, `floating-widget`, `ui`
- **Why use it:** Cute whale widget tracks balance with drag & roll animations
...
- **Why use it:** Only 5MB installer, zero setup, cross-platform Tauri desktop
...
- **Tags:** `office`, `productivity`, `ui`
- **Why use it:** Full office suite—spreadsheets, docs, slides and canvases integrated into DSH
...
- **Tags:** `mobile`, `ios`, `ui`
- **Why use it:** Native iOS client for DSH with workspace, chat and agent trace via WebSocket
...
- **Tags:** `desktop`, `ui`, `client`
- **Why use it:** CodePilot-inspired cross-platform desktop client with plugin suite for DSH
...
- **Why use it:** Secure P2P multi-device remote access for DSH across PC and mobile
...
- **Why use it:** Open-source Smartisan-style notes with Docker, skills, and social export
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI plugin for managing skills and MCP servers visually
...
- **Why use it:** Community plugin marketplace with one-click install for DSH web GUI
...
- **Why use it:** Electron-based desktop control panel for multi-tab management of Harness and plugins
...
- **Tags:** `ui`, `dsh-plugin`, `usage-tracking`
- **Why use it:** Persistent bottom bar showing provider, model, balance and pricing info.
...
- **Tags:** `bioinformatics`, `desktop-app`, `dsh-plugin`
- **Why use it:** Bioinformatics desktop agent with skill store and offline mode for clinicians.
...
- **Tags:** `desktop`, `devops`
- **Why use it:** All-in-one DevOps desktop command center.
...
- **Why use it:** Electron-based DSH desktop app with web UI.
...
- **Tags:** `ui`, `dsh-plugin`
- **Why use it:** Adds one-click compact context button to DSH Web panel
...
- **Tags:** `web`, `dsh-plugin`
- **Why use it:** Zero-dependency static web portal for plugin discovery
...
- **Tags:** `dsh-plugin`, `agent-memory`, `rag`
...
- **Tags:** `dsh-plugin`, `rag`, `vector-search`, `wiki`
- **Why use it:** Open-source LLM knowledge platform turning documents into RAG and self-maintaining wiki.
...
- **Why use it:** Portable local-first memory layer with Markdown-native storage and cross-app evolution
...
- **Tags:** `memory-management`, `rag`, `token-savings`, `self-evolving`
- **Why use it:** Self-evolving memory OS with hybrid retrieval and 35% token savings for agents
...
- **Tags:** `agent-memory`, `context-engineering`, `stateful`
- **Why use it:** Memory library for building persistent stateful agents with context engineering
...
- **Why use it:** Dedicated memory management kit with refinement for agents.
...
- **Why use it:** Persistent unified memory layer backed by Milvus for all agents.
...
- **Tags:** `dsh-plugin`, `memory`, `agent`
- **Why use it:** Personal AI agent with shared persistent local memory hub
...
- **Tags:** `dsh-plugin`, `multi-agent`, `swarm`
- **Why use it:** Original multi-agent swarm framework for autonomous workflow coordination.
...
- **Tags:** `dsh-plugin`, `meta-skill`, `knowledge-distillation`
...
- **Tags:** `skills`, `marketplace`, `skill-md`, `automation`
- **Why use it:** Largest skills marketplace with auto-curated packages across 8 categories
...
- **Tags:** `preset`, `agent-bootstrap`
- **Why use it:** Two-phase preset for reliable minimal-aligned agent bootstrap.
...
- **Tags:** `skills`, `workflow-automation`
- **Why use it:** Intelligent skill routing cuts tokens by 29.6% on SkillsBench.
...
- **Tags:** `dsh-plugin`, `skill`, `research`
- **Why use it:** Auto-searches CN platforms, generates evidence-based research reports
...
- **Tags:** `dsh-plugin`, `writing`, `creative`
- **Why use it:** AI novel writing: organizes inspiration, characters, worldbuilding, review
...
- **Tags:** `writing`, `workflow`, `creative`
- **Why use it:** Built-in workflows for novel writing, short drama, gaming and video recap creation
...
- **Why use it:** Enables composable, reviewable agent workflows with self-evolution
...
- **Why use it:** Turns experience into repeatable execution across multiple agent platforms
...
- **Why use it:** 88 open-source skills for research, marketing, and business automation
...
- **Tags:** `ctf`, `security`, `pentest`, `reverse-engineering`
- **Why use it:** Comprehensive reverse engineering and pentesting skill set for security research
...
- **Why use it:** Auto-upgrade plugin skills with DSH version updates
...
- **Why use it:** Convert successful sessions into reusable agent skills automatically
...
- **Tags:** `agent-skill`, `coding`, `mentor`
- **Why use it:** Transforms AI coding assistant into a mentor with chapter-based guided coding and review
...
- **Tags:** `skills-deck`, `productivity`, `engineering`
- **Why use it:** Bundled 25 engineering and productivity skills directly available via side panel
...
- **Tags:** `gongwen`, `docx`, `document`
- **Why use it:** Complete official Chinese document processing skill with format check and template generation
...
- **Why use it:** Plugin development knowledge base installable as on-demand agent skill with official docs
...
- **Tags:** `agent-skills`, `spec-driven-development`, `dsh-plugin`
- **Why use it:** Repository-native spec-driven development skill for DSH agents.
...
- **Tags:** `ocr`, `vision`, `dsh-plugin`
- **Why use it:** Enables text-only models to read images via pixel-to-text OCR skill.
...
- **Tags:** `workbench`, `skills`, `dsh-plugin`
- **Why use it:** Plugin-based web work platform with global skill management and workspace integration.
...
- **Tags:** `multi-agent`, `dsh-plugin`, `collaboration`
...
- **Tags:** `quality-gate`, `engineering-discipline`, `dsh-plugin`
- **Why use it:** Engineering discipline bundle: validate requirements, test implementation, prove delivery.
...
- **Tags:** `qa`, `testing`, `dsh-plugin`
- **Why use it:** 11 QA skills framework for AI agents with shared knowledge base and test automation.
...
- **Tags:** `agent-handoff`, `session-memory`, `dsh-plugin`
- **Why use it:** Cross-platform skill for repository-local continuity memory across agent sessions.
...
- **Tags:** `code-simplification`, `dsh-plugin`, `codex`
- **Why use it:** Code simplification skill adapted from official DSH patterns for Codex agents.
...
- **Tags:** `multi-agent`, `dsh-plugin`
- **Why use it:** Persistent multi-agent team with private memory across sessions
...
- **Why use it:** WorkBuddy-style quick skill picker in DSH composer
...
- **Tags:** `skillhub`, `dsh-plugin`
- **Why use it:** Official Tencent SkillHub docs and DSH integration
...
- **Tags:** `video`, `agent-skills`
- **Why use it:** Cinematic product video generation skill with 152 shot templates
...
- **Tags:** `math`, `agent`, `dsh-plugin`
- **Why use it:** Multi-agent math modeling with 5 roles, 33 models, and auto-paper
...
- **Tags:** `godot`, `game-dev`, `dsh-plugin`
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH
...
- **Tags:** `math-modeling`, `skill`
- **Why use it:** Comprehensive math modeling skill with data prep, coding, and paper writing
...
- **Why use it:** Agent skill for developing DSH plugins.
...
- **Tags:** `dsh-plugin`, `ui-generator`, `design-systems`
- **Why use it:** Open-source design tool with Figma-like capabilities and local-first architecture.
...
- **Tags:** `dsh-plugin`, `diagrams-as-code`, `mermaid-alternative`
- **Why use it:** Generates beautiful architecture diagrams and sequence charts from code.
...
- **Tags:** `dsh-plugin`, `gpt-image-2`, `prompt-engineering`
- **Why use it:** Massive GPT Image prompt library with 530+ cases and reusable industry templates.
...
- **Tags:** `design`, `vector`, `vibedesign`, `agent-teams`, `flutter`
...
- **Tags:** `dsh-plugin`, `video`, `generative-ai`
- **Why use it:** End-to-end Vox-style paper-collage explainer video automation
...
- **Tags:** `dsh-plugin`, `design`, `visual`
- **Why use it:** Editable design system with AI generation, template marketplace & PPT
...
- **Why use it:** Legal litigation visualization toolkit generating timelines, charts and relationship diagrams
...
- **Tags:** `video`, `ai-image`, `dsh-plugin`
- **Why use it:** AI video/image/audio generation skills with configurable model tools and storyboarding.
...
- **Why use it:** Web background personalization with preset themes.
...
- **Why use it:** Seamless browser automation with logged-in sessions across shells.
...
- **Tags:** `content-discovery`, `cross-platform`
- **Why use it:** Cross-platform content discovery across 8 major platforms locally.
...
- **Tags:** `browser`, `anti-detect`, `automation`
- **Why use it:** Browser automation with persistent fingerprint spoofing and unlimited local profiles
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent control tools
...
- **Why use it:** Tabbit browser automation plugin with Playwright integration
...
- **Tags:** `dsh-plugin`, `electron`, `image-uploader`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with VS Code integration.
...
- **Tags:** `plugin-ecosystem`, `aggregation`, `dsh-web`, `marketplace`
- **Why use it:** Plugin aggregation hub distributed via creative workshop — everything is a plugin
...
- **Tags:** `tool-switch`, `utility`
- **Why use it:** One-click install and model switching across 8+ AI coding tools.
...
- **⭐ Stars:** 1,470
- **Language:** Python
- **Description:** DSH Plugin Radar — open-source ecosystem radar for DeepSeek Harness plugins: continuous discovery (21k+ candidates), k8s runtime validation (13k+ tests), 15-min snapshots; the catalog is a generated artifact — 开源 DSH 插件���态雷达：持续发现 2.1 万+ 候选、k8s 运行级实测 1.3 万+、15 分钟快照；插件目录为自动生成的产物
- **Tags:** `dsh-plugin`, `infrastructure`, `registry`
- **Why use it:** Ecosystem radar: continuous discovery of 21k+ plugin candidates
...
- **Tags:** `cost`, `utility`, `monitoring`
- **Why use it:** Track session and daily LLM costs with budget alerts and usage history
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `marketplace`
- **Why use it:** Essential DSH learning hub with plugin marketplace guidance
...
- **Tags:** `plugin-catalog`, `marketplace`, `registry`
- **Why use it:** Largest DSH plugin catalog with 11K+ plugins and public API
...
- **Tags:** `plugin-catalog`, `directory`, `marketplace`
- **Why use it:** Comprehensive bilingual DSH plugin catalog with advanced filtering
...
- **Why use it:** Automates DSH plugin discovery, installation, and verification
...
- **Why use it:** Backup, restore, and sync complete DSH configuration including plugins and MCPs
...
- **Tags:** `infrastructure`, `plugin-mgmt`, `registry`
- **Why use it:** Infrastructure for DSH plugin ecosystem with browser console and development scaffolding
...
- **Tags:** `migration`, `dsh-plugin`
- **Why use it:** Four-source migration wizard for Claude Code, Codex, OpenCode sessions
...
- **Why use it:** Fast, elegant Neovim plugin manager.
...
- **Tags:** `chart`, `cost`
- **Why use it:** Real-time token usage and cost visualization.
...
- **Tags:** `tts`, `xiaomi`
- **Why use it:** Free Xiaomi MiMo TTS API integration for DSH.
...
- **Tags:** `conflict`, `doctor`
- **Why use it:** Resolves plugin version conflicts automatically.
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `themes`, `developer-tools`
- **Why use it:** Public gallery of animated mascot pets for Codex, Claude, Hermes and more
...
- **Tags:** `dsh-plugin`, `skin`, `theme`
- **Why use it:** Whale girl skin series for DSH — customizes interface aesthetics
...
- **Tags:** `dsh-plugin`, `ai-guide`, `vibe-coding`, `rag`
- **Why use it:** Comprehensive AI resource hub with tutorials for DeepSeek, Claude, GPT, and more.
...
- **Tags:** `academic-search`, `mcp`, `citation-graph`, `research-workflow`
- **Why use it:** Comprehensive academic search with citation graph and cross-platform MCP support
...
- **Tags:** `handbook`, `agent-runtime`, `mcp`, `sandbox`
- **Why use it:** Authoritative agent-first handbook covering runtime, MCP, and troubleshooting
...
- **Tags:** `stock`, `finance`, `mcp`, `multi-agent`
- **Why use it:** Local financial database with multi-agent stock analysis and IM alerts
...
- **Why use it:** Industry research methodology with chain mapping and news tracking
...
- **Why use it:** Provides web search, content extraction and research capabilities for AI agents
...
- **Why use it:** Searches 65,600+ Chinese platform API docs directly within DSH without config
...
- **Tags:** `patent`, `legal-tech`, `rag`
- **Why use it:** Patent infringement analysis tool generating competitive reports from patent numbers
...
- **Tags:** `kline`, `analysis`, `dsh-plugin`
- **Why use it:** Interactive K-line analysis with multi-market and technical indicators
...
- **Why use it:** Spam-filtered plugin registry with open data.
...
- **Why use it:** Public directory for DSH ecosystem discovery.
...
- **Tags:** `stock`, `finance`
- **Why use it:** Curated stock/finance plugin vertical list.
...
- **Tags:** `directory`, `guidance`
- **Why use it:** Evidence-led plugin directory with install guidance.
...
- **Tags:** `list`, `quality-check`
- **Why use it:** Quality-checked DSH plugin list for 2026.
...
- **Tags:** `list`, `inventory`
- **Why use it:** Complete DSH tool inventory sorted by stars.
...
- **Tags:** `dsh-plugin`, `self-hosted`, `resume-builder`
- **Why use it:** Privacy-first resume builder with full customization and open-source freedom.
...
- **Tags:** `dsh-plugin`, `no-code`, `low-code`, `crm`
- **Why use it:** AI-powered no-code platform for rapidly building CRM, ERP, and internal tools.
...
- **Tags:** `awesome-list`, `dsh`, `plugin-index`
- **Why use it:** Curated index of all DSH plugins — essential starting point for discovering tools
...
- **Why use it:** Beginner-friendly tutorial to master harness engineering from zero
...
- **Tags:** `dsh-plugin`, `awesome-list`, `curated`
...
- **Tags:** `dsh-plugin`, `awesome-list`, `curated`
- **Why use it:** Curated DeepSeek Harness plugin ecosystem list
...
- **Why use it:** The most comprehensive DeepSeek Harness 
...
- **⭐ Stars:** 494
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的模型补上���索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
...
- **⭐ Stars:** 405
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背���（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
...
- **Why use it:** 🌊 DeepSeek Harness 海洋皮肤与动态主题 | Real-tim
...
- **Tags:** `agent-observability`, `agent-skills`, `agentic-ai`, `ai-agents`, `audio-understanding`, `computer-vision`, `deepseek`, `deepseek-harness`, `deepwatch`, `llm`, `local-first`, `mcp`, `multimodal`, `ocr`, `python`, `speech-to-text`, `typescript`, `verification`, `video-analysis`, `video-understanding`
- **Why use it:** Give AI agents eyes, ears, and verifiabl
...
- **Tags:** `resource`, `awesome-list`, `discovery`
- **Why use it:** Curated daily-scraped plugin list with scenario-based filtering and rankings
...
- **Tags:** `resource`, `awesome-list`, `reference`
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCP servers and UIs with visualization
...
- **Tags:** `resource`, `guide`, `reference`
- **Why use it:** Ultimate DSH guide with quickstart, resource picks and practical toolkit index
...
- **Why use it:** Curated collection of DSH plugins covering productivity and functionality
...
- **Why use it:** Community-maintained plugin marketplace with auto-sync every 4 hours
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `dsh-plugin`
- **Why use it:** Fusion of Bazi, Fengshui, IChing and TCM into an AI agent skill with dashboard.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated list of DeepSeek Harness plugins for discovery
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated collection of useful DeepSeek Harness plugins
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Plugin product guide with scenario-based recommendations
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Evidence-backed plugin radar from 2Origin plugin lab
...
- **Tags:** `search`, `dsh-plugin`
- **Why use it:** Search npm and curated list directly from DSH agents

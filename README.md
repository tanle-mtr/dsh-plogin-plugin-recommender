...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,037,495 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-16 16:31:31 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 226,485 | Core harness platform for DSH ecosystem plugin orc |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,536 | Open-source design tool for coding agents, local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,608 | Multi-agent swarm orchestrator with MCP server int |
...
- [Research & Analysis](#research-&-analysis) — 31 plugins
...
- [Research & Analysis](research-analysis) (31)
- [Other](other) (17)
---
...
- **Why use it:** Core harness platform for DSH ecosystem plugin orchestration.
...
- **Tags:** `multi-agent`, `mcp-server`, `swarm`
- **Why use it:** Multi-agent swarm orchestrator with MCP server integration.
...
- **Why use it:** Multi-model AI assistant with memory, skills, and self-evolution.
...
- **Why use it:** Terminal AI coding agent with prompt caching and R1 optimization.
...
- **Why use it:** Task-aware routing kit with injector for DSH runtime
...
- **Tags:** `agent-os`, `mcp`, `skill`
- **Why use it:** Self-improving agent OS with staged evaluation loops
...
- **Why use it:** Long-horizon agent control plane for durable workflow
...
- **Tags:** `agent`, `rust`, `coding`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for AI coding workflows.
...
- **Tags:** `coding-agent`, `tui`, `rpc`, `mcp`
- **Why use it:** TUI coding agent with sub-agents, RPC, hashline edits, and MCP support
...
- **Why use it:** TDD, debugging, planning skills for DSH coding workflow
...
- **Tags:** `plugin-creator`, `dsh`, `codex`
- **Why use it:** Build and validate DSH plugins with reusable Codex skill templates
...
- **Why use it:** Codex-style skill for automated code simplification and refactoring
...
- **Tags:** `agent-orchestration`, `multi-agent`, `dsh-plugin`
...
- **Why use it:** Bidirectional bridge syncing Codex and DSH chat, skills, MCPs
...
- **Tags:** `cordis`, `launcher`, `orchestration`, `dsh-plugin`
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill, MCP orchestration
...
- **Tags:** `evaluation`, `benchmark`, `rag`, `dsh-plugin`
- **Why use it:** Evidence-backed eval framework for prompts, RAG, skills, agents
...
- **Why use it:** Agent Skill for building DSH plugins with standards and tooling
...
- **Why use it:** Fast elegant Lua Neovim plugin manager for harness workflows
...
- **Why use it:** Pre-flight plugin check injects Top-K relevant plugins for task requests
...
- **Tags:** `design`, `ui-generator`, `desktop-app`
...
- **Why use it:** Extensible sidebar with files, terminal, chat, Git, and sub-agents
...
- **Why use it:** Modern embedded task panel with flexible Codex and DSH integration
...
- **Why use it:** Claude Code-style TUI with whale banner, streaming thought, and rollback
...
- **Tags:** `widget`, `balance`, `desktop`
- **Why use it:** Cute floating whale widget tracks your DeepSeek balance with drag support and animations.
...
- **Why use it:** Lightweight 5MB Tauri desktop app with preset plugins for Windows/macOS/Linux.
...
- **Why use it:** Zero-setup Windows GUI client with SSH, plugins, and mobile access
...
- **Tags:** `canvas`, `visual`, `conversation`
...
- **Tags:** `agent`, `desktop-app`, `tauri`, `typescript`
- **Why use it:** Local-first desktop AI agent with Tauri, multi-model support and privacy focus
...
- **Why use it:** Brings spreadsheets, docs, slides, canvases into DeepSeek Harness
...
- **Tags:** `task-management`, `ui-design`, `typescript`
- **Why use it:** Native local taskboard with SQLite, agent claim/review and native Web UI
...
- **⭐ Stars:** 302
- **Language:** Kotlin
- **Description:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将工作���、会话、实时回复和 Agent 执行轨迹带到 iPhone，同时延续 DeepSeek WebUI 克制、清晰的视觉语言
- **Tags:** `ios`, `mobile-automation`, `typescript`
- **Why use it:** Native iOS client for DeepSeek Harness with WebSocket-based agent control
...
- **Tags:** `ios-simulator`, `mcp`, `ui-automation`
- **Why use it:** Live iOS Simulator with 22 agent tools for booting, building and driving
...
- **Why use it:** Smartisan-style open notes app with Docker deployment and WeChat/QQ/Feishu support.
...
- **Tags:** `webui`, `plugin-market`
- **Why use it:** One-click install community plugins via Web GUI
...
- **Tags:** `bioinformatics`, `desktop-app`, `turan`
- **Why use it:** Desktop bioinformatics agent for clinicians with offline mode
...
- **Why use it:** Live balance, pricing, model info bar always visible
...
- **Tags:** `web`, `workbench`, `plugin-system`
...
- **Why use it:** All-in-one DevOps desktop: SSH, SFTP, Docker, DB client and AI assistant
...
- **Why use it:** Real-time token usage charts and API cost estimates dashboard
...
- **Why use it:** Electron desktop shell integrating DSH web UI, ModLens and sidebar
...
- **Tags:** `theming`, `background`, `ui-customization`
- **Why use it:** Customizable Web UI backgrounds with presets and image uploads
...
- **Tags:** `ui-enhancement`, `button`, `compact`
...
- **Why use it:** Binds ChatGPT account via OAuth to use ChatGPT models inside DSH
...
- **Tags:** `agent-memory`, `rag`, `knowledge`
...
- **Why use it:** Portable Markdown-native local-first memory layer
...
- **Tags:** `memory`, `rag`, `management`
- **Why use it:** Dedicated agent memory management with recall and refinement
...
- **Tags:** `memory`, `milvus`, `vector-db`, `rag`
...
- **Why use it:** Personal AI agent with shared local memory hub for persistent context across all AI tools.
...
- **Why use it:** Best context management plugin with dashboard, browser, and sidebar for DSH.
...
- **Tags:** `skill-retrieval`, `rag`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready skill corpora
...
- **Tags:** `context`, `memory`, `dsh-plugins`
...
- **Why use it:** Audit context injection costs, detect duplicates and conflicts
...
- **Tags:** `agent-orchestration`, `agent-skills`, `mcp`
...
- **Tags:** `agent-skills`, `skill`
- **Why use it:** Largest skills store with auto-collected GitHub projects
...
- **Tags:** `agent-skills`, `agent-collaboration`
...
- **Why use it:** Vision-to-JSON pipeline for image-aware coding agents
...
- **Why use it:** Intelligent skill routing cuts tokens 29.6% while boosting rewards
...
- **Why use it:** End-to-end AI video generation from topic to Vox-style explainer with ffmpeg automation.
...
- **Why use it:** Enable multi-agent teamwork capabilities directly within DeepSeek Harness.
...
- **Why use it:** Complete AI novel writing software with workflow for characters, worldbuilding, and editing.
...
- **Why use it:** Gives agents eyes and ears — video, audio, screen analysis with verifiable proof
...
- **Why use it:** Built-in workflows for novel, short-drama, game and video-recap writing
...
- **Tags:** `agent-skills`, `workflow`, `experience-automation`
...
- **Why use it:** Local financial database with multi-agent analysis and IM notification support.
...
- **Why use it:** Skill that discovers, installs, and verifies DSH GitHub plugins automatically.
...
- **Why use it:** Specialized skills for AI infra development, optimizing and debugging high-performance systems.
...
- **Why use it:** 87 reverse engineering and pentesting skills
...
- **Why use it:** Turn successful sessions into reusable agent skills
...
- **Why use it:** AI coding mentor with auto code review and step-by-step guidance
...
- **Tags:** `agent`, `skills`, `dsh-better-sidebar`, `github-issues`
- **Why use it:** 25 ready-to-use engineering skills, one-click install
...
- **Why use it:** Patent infringement analysis with multi-agent support
...
- **Tags:** `ai-docs`, `gongwen`, `docx`
- **Why use it:** Complete official document formatting tool per GB/T 9704
...
- **Tags:** `spec-driven-development`, `vibe-coding`, `agent-skills`
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `dashboard`
- **Why use it:** Bazi, Fengshui, I Ching fused skill with local deterministic engine
...
- **Tags:** `quality`, `guard`, `engineering`
- **Why use it:** Engineering discipline bundle for quality-gating before delivery
...
- **Why use it:** 11 QA skills framework for AI testing automation workflows
...
- **Why use it:** Cross-platform agent session handoff with repository-local memory
...
- **Why use it:** Interactive K-line chart with multi-market and technical analysis
...
- **Tags:** `video`, `remotion`, `agent-skill`, `dsh-plugin`
...
- **Tags:** `math-modeling`, `agent`, `competition`, `dsh-plugin`
- **Why use it:** 5-role math modeling agent with 33 models and paper templates
...
- **Why use it:** Search 65,600+ Chinese open platform API docs directly
...
- **Why use it:** One-click MCP/Skills config sync for Claude Code, DSH, Cursor, etc.
...
- **Tags:** `mcp`, `skills`, `manager`, `dsh-plugin`
...
- **Tags:** `visual`, `design`, `agent-team`
- **Why use it:** Open-source AI vector design tool with concurrent agents
...
- **Why use it:** Adds multimodal vision capabilities for screenshot and UI analysis to text-only LLMs.
...
- **Why use it:** Legal case timeline and diagram visualization toolkit
...
- **Why use it:** OCR and image reading tools for text-only LLM models
...
- **Why use it:** AI video/image/audio creation with DirectorX toolkit integration
...
- **Why use it:** 6 design style presets keeping vibe-coded sites away from AI look
...
- **Tags:** `content-discovery`, `social`, `bilibili`
- **Why use it:** Cross-platform content discovery agent for Bilibili, YouTube, X, etc.
...
- **Why use it:** Two-phase preset for minimal bootstrap then full tooling
...
- **Why use it:** Virtual filesystem and terminal layer for isolated agent execution
...
- **Tags:** `installer`, `switcher`, `multi-agent`
- **Why use it:** Unified one-click installer for Claude Code, Codex, Grok, DSH, and more
...
- **Tags:** `radar`, `validation`, `ecosystem`
- **Why use it:** Ecosystem radar with 21k+ plugin discovery and k8s runtime validation for DSH.
...
- **Tags:** `llm-provider`, `oauth`, `typescript`
...
- **Why use it:** Open-source CLI and resolver tools for DSH Plugin Hub management
...
- **Tags:** `cost-tracking`, `token-usage`, `typescript`
- **Why use it:** Track session/daily costs, budget, history and multi-provider balance
...
- **Tags:** `llm-provider`, `commandcode`, `typescript`
...
- **Why use it:** Secure multi-device P2P remote access solution for DSH across PC, Android, Web.
...
- **Why use it:** Backup, restore, migrate and sync DSH configs
...
- **Why use it:** Official plugin ecosystem infrastructure and dev guide
...
- **Why use it:** Free Xiaomi MiMo TTS API integration with customizable voices
...
- **Why use it:** Diagnoses and resolves plugin and version conflicts in DSH
...
- **Tags:** `ai`, `deepseek`, `mcp`, `rag`
- **Why use it:** Comprehensive AI resources and tutorials for developers
...
- **Tags:** `research`, `china`, `analysis`
- **Why use it:** Auto-searches 8 major Chinese platforms for recent 30-day content analysis and reports.
...
- **Tags:** `awesome-list`, `plugin-manager`
- **Why use it:** Curated plugin directory with daily GitHub scraping and scenario classification
...
- **Tags:** `awesome-list`, `developer-tools`, `typescript`
- **Why use it:** Ultimate guide covering quickstart, resources, curated plugins and tools
...
- **Why use it:** Great DSH learning resource with plugin marketplace and best practices.
...
- **Why use it:** Cross-platform academic search with citation verification and graph features.
...
- **Tags:** `plugin-directory`, `catalog`, `marketplace`
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, bilingual search and ranking.
...
- **Why use it:** Curated DSH plugin directory for discovery
...
- **Why use it:** Industry research with methodology and tracking
...
- **Why use it:** Curated DSH tools covering productivity and features
...
- **Why use it:** Verified star-ranked community plugin catalog for DSH discovery
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin navigation with scenario-based selection and compatibility guidance
...
- **Why use it:** CodeX-style plugin marketplace for DSH with curated bundles
...
- **Why use it:** Official DSHA selected plugin collection from the core team
...
- **Why use it:** Auto-crawled daily via GitHub Actions, bilingual plugin registry
...
- **Tags:** `web-portal`, `static-site`
- **Why use it:** Zero-dependency static portal for discovering and installing 227+ plugins
...
- **Tags:** `repository`, `analytics`
- **Why use it:** Community plugin repository with verification and analytics features
...
- **Why use it:** Legacy awesome-list, migrated to awesome-dsh-plugin repo
...
- **Why use it:** Auto-updating curated DSH plugin directory.
...
- **Why use it:** Evidence-led bilingual DSH plugin list.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Simple Chinese DSH plugin list.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated plugin directory for DeepSeek Harness ecosystem
...
- **Why use it:** Centralized marketplace for browsing and installing DSH plugins
...
- **Why use it:** Another well-curated plugin list covering DSH ecosystem breadth and depth.
...
- **Why use it:** Daily-updated plugin marketplace with pre-reviewed submissions
...
- **Why use it:** Comprehensive AI resource encyclopedia covering models, agents, RAG, MCP
...
- **Why use it:** Curated list of DeepSeek Harness plugins with descriptions
...
- **Why use it:** Comprehensive awesome list: plugins, tools, skills & resources
...
- **Why use it:** Spam-filtered curated registry for discovering DSH plugins and skills
...
- **Why use it:** Hand-picked collection of useful DSH plugins and extensions

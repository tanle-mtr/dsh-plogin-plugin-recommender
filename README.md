...
|--------|-------|
| **Plugins tracked** | 190 |
| **Total community stars** | 833,728 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 01:53:03 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 185,159 | Core DSH framework; the foundation for all plugins |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,449 | Open-source design system; Figma alternative for a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,864 | Meta-harness for multi-agent swarms and autonomous |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 37 plugins
...
- **Why use it:** Core DSH framework; the foundation for all plugins
...
- **Why use it:** Unified agent workspace with cross-device access
...
- **Why use it:** Self-improving agent OS with loop evaluation
...
- **Why use it:** Two-phase harness preset for Project2 alignment
...
- **Why use it:** Vision plugin bringing OCR to text-only coding agents
...
- **Why use it:** Native macOS coding agent for DeepSeek
...
- **Why use it:** Unifies Claude Code, Codex, Grok into one coordinated team
...
- **Why use it:** Dispatch work to DSH agents from Claude Code/Codex
...
- **Why use it:** AI编程导师，扫描架构生成阶梯教程并Code Review
...
- **Why use it:** 开发DSH插件的Agent技能，插件/服务/工具标准流程
...
- **Why use it:** 仓库原生Spec驱动开发技能，DSH工程模式
...
- **Why use it:** 像素转文本图像识别，OCR与视觉工具技能
...
- **Why use it:** 构建DSH插件的Agent技能，slots与凭证管理
...
- **Why use it:** Plugin dev & audit agent skill with bundle adapter
...
- **Why use it:** Practical DSH plugin dev pitfall docs & skill
...
- **Why use it:** Scaffold & test DSH plugins inside agent
...
- **Why use it:** Essential plugin manager with hot-reload, no restart needed
...
- **Why use it:** Hot-reload MCP & skills config directly from settings page
...
- **Why use it:** Floating HUD panel for git, MCP, skills, token status
...
- **Why use it:** Native bridge for Claude Code .claude/ directory
...
- **Why use it:** OAuth bind ChatGPT account for use inside DSH.
...
- **Why use it:** Extensive curated DSH plugins for agents, UI, and tools
...
- **Why use it:** Unified plugin registry merging multiple sources
...
- **Why use it:** One-click publish tool for DSH skills and plugins
...
- **Why use it:** Dynamic marketplace for browsing and installing DSH plugins
...
- **Why use it:** Modern desktop app built as a DSH plugin ecosystem
...
- **Why use it:** Web UI skins with task board, pet, and live stats
...
- **Tags:** `pet`, `mascot`, `ui`
- **Why use it:** Public animated pet gallery for agent harnesses
...
- **Why use it:** Desktop companion with animated pets
...
- **Why use it:** Lightweight Tauri desktop app (5MB)
...
- **Why use it:** Full local AI desktop workspace app
...
- **Why use it:** Floating whale widget for account balance
...
- **Why use it:** Local-first multi-model AI desktop app, privacy-focused
...
- **Why use it:** Generates interactive inline UI: charts, forms, quizzes
...
- **Why use it:** Zero-setup Windows GUI for DSH
...
- **Why use it:** Visual canvas for branching conversations
...
- **Why use it:** Electron桌面管理控制台，多Tab管理Harness/MCP/Plugins
...
- **Why use it:** 法律诉讼可视化，生成时间轴与案件图SVG
...
- **Why use it:** Live provider/model info & pricing bar
...
- **Why use it:** Unlimited memory storage for AI agents
...
- **Why use it:** Context insight and dashboard management
...
- **Why use it:** AI encyclopedia covering MCP, RAG, agents, skills, and more
...
- **Why use it:** Smartisan-style notes with Docker deploy
...
- **Why use it:** Curated skill corpora with retrieval & evaluation
...
- **Why use it:** 跨平台Agent会话连续性记忆，状态恢复技能
...
- **Why use it:** Audits context injection, detects duplicates and conflicts
...
- **Why use it:** HTTP server for memory, recall & experience handoff
...
- **Why use it:** 470+ image prompts as skills for workflow automation
...
- **Why use it:** Human-in-loop task manager for agents
...
- **Why use it:** Multi-agent team collaboration plugin
...
- **Why use it:** OCR, screenshots, vision automation
...
- **Why use it:** Adds multimodal vision to DSH agents
...
- **Why use it:** Specialized infra dev skills for agents
...
- **Why use it:** Novel writing & short-drama production skills
...
- **Why use it:** TDD, debugging, planning superpowers skills
...
- **Why use it:** Code simplification skill adapted from DSH original
...
- **Why use it:** Unique Bazi/Fengshui/I-Ching AI agent skill pack
...
- **Why use it:** Free image reading & generation via Vision models
...
- **Why use it:** Swift Cycle governance skill with version pinning
...
- **Why use it:** Engineering discipline portable agent skill
...
- **Why use it:** Chinese official doc format check & generation
...
- **Why use it:** Infinite canvas with creative agent skills
...
- **Why use it:** Record macOS workflows into reusable agent skills
...
- **Why use it:** Virtual product team preset: PM to QA walkthrough
...
- **Why use it:** Pre-flight plugin check for DSH agents at runtime.
...
- **Why use it:** One-tap Codex migration with Skills & MCP sync
...
- **Why use it:** Web GUI card to manage skills and MCP servers
...
- **Why use it:** Open-source design system; Figma alternative for agents
...
- **Why use it:** Preview & edit OpenPencil .op docs in chat
...
- **Why use it:** 6 design styles to avoid generic AI look in websites
...
- **Why use it:** AI video/image/audio creative tools suite
...
- **Why use it:** Enhancement suite and prompt manager for AI web UIs
...
- **Why use it:** Turn conversations into reusable workflows
...
- **Why use it:** Chrome sidebar extension for direct browser control via DSH
...
- **Why use it:** Live iOS Simulator inside DSH with 22 automation tools
...
- **Why use it:** Tabbit Browser automation for DSH via Playwright
...
- **Why use it:** Community group photo wall with GitHub OAuth
...
- **Why use it:** Use ChatGPT/Claude/Grok subs as DSH LLM providers via OAuth
...
- **Why use it:** Auto-searches, installs & verifies DSH plugins
...
- **Why use it:** 3100+ plugin marketplace with API
...
- **Why use it:** DeepSeek Harness plugin bundle & store
...
- **Why use it:** Track session & daily LLM costs
...
- **Why use it:** Crash-rescue undo config & plugin-code changes
...
- **Why use it:** Awesome curated list of DSH plugins
...
- **Why use it:** Web UI community plugin marketplace integration
...
- **Why use it:** Web UI skill and MCP management dashboard
...
- **Why use it:** Curated DSH plugins, extensions, tools catalog
...
- **Why use it:** Auto-syncing DSH plugin community catalog
...
- **Why use it:** 插件生态基建，控制台管理官方repository插件
...
- **Why use it:** 20个中国开放平台65,600+API文档一键搜索
...
- **Why use it:** 官方精选DSH插件自动列表，cordis.run维护
...
- **Why use it:** 本地容器化运行多DSH版本，导入插件技能一键
...
- **Why use it:** Package manager with 42 skills, 5 CLIs, 1 plugin
...
- **Why use it:** Backup, restore & sync DSH config via WebDAV
...
- **Why use it:** Auto-crawled daily Bilingual DSH plugin directory.
...
- **Why use it:** Search npm + curated lists from inside DSH agents.
...
- **Why use it:** WebGPU ocean-themed dynamic skin for DeepSeek Harness
...
- **Why use it:** 34 opencode themes one-click for DSH
...
- **Why use it:** Curated plugin ecosystem directory
...
- **Why use it:** DSH ecosystem curated resources list
...
- **Why use it:** Ultimate DSH guide and resource hub
...
- **Why use it:** Curated DSH plugins, skills & MCP list
...
- **Why use it:** 逆向工程与授权渗透测试技能库，85篇SKILL.md
...
- **Why use it:** 88个开源Agent技能，研究社交情报与营销自动化
...
- **Why use it:** Interactive K-line chart with multi-market technical analysis
...
- **Why use it:** Curated plugin discovery directory & install commands
...
- **Why use it:** Curated DSH plugin discovery list
...
- **Why use it:** Math modeling suite with 17 skill cards for DSH
...
- **Why use it:** Evidence-backed plugin radar with quality reviews.
...
- **Why use it:** Curated plugin list — not a functional plugin
...
- **Why use it:** VibeSkills is a general-purpose Skill th
...
- **Why use it:** 竹知了 —— 一转就哇哇叫的传统玩具，Web 模拟版。零依赖单文件，真实录音采样
...
- **Why use it:** AI code reviews grounded in 12 classic e
...
- **Why use it:** DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器真实安装路径运行级
...
- **Why use it:** Let AI agents use your real, logged-in b
...
- **Why use it:** Curated plugin directory with daily verification and reviews
...
- **Why use it:** Bilingual curated list of DSH plugins, tools, and skills
...
- **Why use it:** DSH principles guide with plugin marketplace and best practices
...
- **Why use it:** In-chat anime search via Bangumi
...
- **Why use it:** Curated meta-directory of 280+ DSH plugins across 14 categories
...
- **Why use it:** Curated evidence-led plugin directory with verification
...
- **Why use it:** Open-data plugin registry with spam filtering
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Curated 2026 DSH plugin collection with quality checks.
...
- **Tags:** `redirect`
- **Why use it:** Redirects to primary awesome-dsh-plugin repo.
...
- **Why use it:** Verified star-ranked community DSH plugin listings.
...
- **Why use it:** Bilingual evidence-led DSH plugin directory.
...
- **Why use it:** AI-powered auto-categorized DSH plugin recommender.
...
- **Why use it:** Curated DSH plugin repository listing
...
- **Description:** DSH插件
- **Tags:** `dsh`, `plugins`
- **Why use it:** Community DSH plugin list
...
- **Why use it:** Complete sorted directory of 1000+ DSH ecosystem plugins

...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 841,716 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-24 01:31:26 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 188,144 | Core harness framework enabling everything-as-plug |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,751 | Open-source design plugin turning coding agents in |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,087 | Multi-agent swarm framework for autonomous workflo |
...
- [Research & Analysis](#research-&-analysis) — 9 plugins
...
- [Research & Analysis](research-analysis) (9)
- [Other](other) (50)
---
...
- **Why use it:** Core harness framework enabling everything-as-plugin architecture for AI agents
...
- **Tags:** `ai-agents`, `mcp`, `multi-agent`
- **Why use it:** Self-evolving multi-model agent harness with memory, skills, and cross-platform support
...
- **Tags:** `coding-agent`, `terminal`, `prompt-caching`
...
- **Tags:** `low-code`, `ai-agent`, `workflows`
- **Why use it:** Open-source AI-powered no-code platform for rapid business system development
...
- **Why use it:** Comprehensive beginner tutorial for harness engineering from scratch.
...
- **Why use it:** Enterprise-grade local workbench supporting Codex, DSH, and OpenCode.
...
- **Why use it:** One-click install and model switch across major AI coding agents
...
- **Tags:** `agent-runtime`, `coding-agent`, `dsh-plugin`
...
- **Tags:** `code-review`, `lint`, `dsh-plugin`
- **Why use it:** AI code review with 12 classic engineering book citations and severity labels
...
- **Tags:** `dsh-plugin`, `coding-agents`, `architecture`
- **Why use it:** Makes AI coding agents architecture-aware with baseline-first and drift-checking.
...
- **Tags:** `dsh-plugin`, `coding-agent`, `swift`
- **Why use it:** Official Swift-native macOS coding agent built by DeepSeek for DeepSeek.
...
- **Tags:** `agent`, `desktop-app`, `multi-model`, `privacy`
- **Why use it:** Local-first multi-model agent desktop with self-evolving skills and privacy focus.
...
- **Why use it:** Practical DSH plugin dev knowledge base with real-world solutions
...
- **Tags:** `dsh-plugin`, `agent-skills`, `plugin-development`
- **Why use it:** Agent skills for scaffolding and testing DSH plugins end-to-end
...
- **Tags:** `dsh-plugin`, `desktop`, `cordis-plugin`
- **Why use it:** Modern desktop solution for DSH where even the desktop itself is a plugin
...
- **Tags:** `web-ui`, `theme`, `desktop`
- **Why use it:** Full web GUI with task boards, mobile access, and WebGL-optimized skins.
...
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, Git
...
- **Why use it:** Claude Code-style TUI with whale header and real-time status
...
- **Tags:** `dsh-plugin`, `desktop`, `electron`
...
- **Why use it:** Lightweight Tauri desktop client for DSH with zero setup, cross-platform.
...
- **Tags:** `dsh-plugin`, `widget`, `desktop`
- **Why use it:** Cute floating whale widget displaying DeepSeek account balance in DSH.
...
- **Tags:** `dsh-plugin`, `desktop`, `electron`
- **Why use it:** Local AI desktop workspace for DSH sessions, files, research, and plugins.
...
- **Tags:** `dsh-ui`, `interactive`, `components`
- **Why use it:** Renders interactive UI components like charts, forms, and quizzes inline.
...
- **Why use it:** Cross-platform CodePilot-inspired desktop client for macOS, Windows, and Linux.
...
- **Why use it:** Visual branching conversation workspace with canvas UI
...
- **Why use it:** Open-source Electron desktop GUI for DeepSeek Harness
...
- **Why use it:** Smartisan-style notes app with Docker deploy and plugin support
...
- **Tags:** `dsh-plugin`, `ui`, `usage-tracking`
- **Why use it:** Persistent bottom bar showing model, balance, and pricing info
...
- **Why use it:** Real-time token usage charts and API balance visualization
...
- **Why use it:** Floating HUD panel showing git status, MCP, skills, model & tokens
...
- **Why use it:** Cross-platform desktop app integrating DB, SSH, Docker with AI assistant
...
- **Why use it:** Electron desktop wrapper integrating multiple DSH plugins
...
- **Why use it:** Turn raw documents into queryable RAG, autonomous reasoning agent, and self-maintaining wiki
...
- **Why use it:** Portable, local-first Markdown memory layer across all AI apps.
...
- **Why use it:** Provides unlimited persistent memory for AI agents in OpenClaw.
...
- **Why use it:** Best context insight and management plugin with dashboard and statistics.
...
- **Tags:** `knowledge-base`, `rag`, `ai-encyclopedia`
- **Why use it:** Comprehensive AI encyclopedia covering skills, RAG, multimodal tools, and learning paths.
...
- **Tags:** `skill-corpus`, `rag`, `retrieval`
...
- **Why use it:** Durable, inspectable long-term memory with recall tools.
...
- **Why use it:** Connects PowerContext server for recall, memory, and skill handoff
...
- **Why use it:** Bridges Claude Code memory and skills into DSH ecosystem
...
- **Tags:** `agentic-ai`, `multi-agent`, `swarm`
- **Why use it:** Multi-agent swarm framework for autonomous workflows and conversational AI systems
...
- **Tags:** `agent-skills`, `skill-generator`, `meta-skill`
- **Why use it:** Distill thinking patterns into reusable skills for any agent or bot
...
- **Tags:** `agent-workspace`, `multi-platform`, `no-code`
- **Why use it:** Unified workspace for agents across desktop, mobile, and browser.
...
- **Tags:** `agent-os`, `self-improving`, `loop-engineering`
- **Why use it:** Self-improving Agent OS that learns and evolves over time.
...
- **Why use it:** Cognitive-enhancement skills based on global workspace research
...
- **Why use it:** Intelligently orchestrates and routes local skills and workflows
...
- **Tags:** `dsh-plugin`, `vision`, `agent-skills`
- **Why use it:** Empowers text-only LLMs with image Q&A, vision skills, and GUI automation.
...
- **Tags:** `dsh-plugin`, `task-manager`, `workflow`
- **Why use it:** Self-hosted human-in-the-loop task manager with mobile and web control.
...
- **Tags:** `dsh-plugin`, `agent-teams`, `collaboration`
...
- **⭐ Stars:** 818
- **Language:** TypeScript
- **Description:** [dsh]为纯文本模型设计更强大的视觉工具箱：安装免费使用、粘贴图片直���识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **Tags:** `dsh-plugin`, `vision`, `ocr`
- **Why use it:** Native DSH vision toolkit: OCR, UI restoration, and multi-image Q&A.
...
- **Tags:** `agent`, `workflow`, `coding-agents`
- **Why use it:** Unifies multiple coding agents (Claude, Codex, Grok) into one coordinated team.
...
- **Why use it:** Turn experience into repeatable AI agent execution skills
...
- **Tags:** `skill`, `vision`, `multimodal`, `claude-code`
- **Why use it:** Adds multimodal vision to text-only LLMs for UI analysis
...
- **Why use it:** Novel writing and short-drama production with Oh Story
...
- **Tags:** `ai-infra`, `skills`, `debugging`
- **Why use it:** Specialized agent skills for AI infra dev, optimization and debugging.
...
- **Tags:** `task-management`, `workflow`, `ui`
- **Why use it:** SQLite-backed taskboard with agent claim/review workflow.
...
- **Why use it:** Superpowers skills ported to Reasonix coding harness.
...
- **Tags:** `agent-handoff`, `session-memory`
- **Why use it:** Enables cross-session agent continuity with repo-local memory
...
- **Tags:** `skill-picker`, `ui`
- **Why use it:** WorkBuddy-style skill picker integrates into DSH composer
...
- **Why use it:** Adapted code simplification skill from DSH for Codex
...
- **Tags:** `chinese-wisdom`, `skill`
- **Why use it:** Bazi/Fengshui/I-Ching AI agent skill with local deterministic engine
...
- **Tags:** `agent-framework`, `database`, `cli`
- **Why use it:** 42 skills, 5 CLIs, 1 plugin for AI agent engineering
...
- **Tags:** `agent-skills`, `dsh-plugin`, `project-governance`
- **Why use it:** Version-pinned governance skill for reliable agent workflows
...
- **Tags:** `agent-skills`, `docx`, `gongwen`, `wps-office`
- **Why use it:** Complete Chinese official document processing workflow per national standard
...
- **Tags:** `agent-skills`, `cordis`, `best-practices`
- **Why use it:** Engineering discipline distilled from DeepSeek Harness experience
...
- **Tags:** `agent-skills`, `dsh-plugin`, `canvas`, `mcp-tools`
- **Why use it:** Native WeShop Cordis plugin with infinite canvas and creative skills
...
- **Why use it:** Godot 4.x full-stack dev skill for DSH agent workflows
...
- **Tags:** `agent-preset`, `ai-agents`, `product-management`
- **Why use it:** Virtual product team agent preset for guided product workflows
...
- **Tags:** `agent-tools`, `llm-agents`, `plugin-matching`
- **Why use it:** Pre-flight plugin matching for predictable agent capabilities
...
- **Tags:** `agent-skills`, `design-systems`, `ui-generator`
- **Why use it:** Open-source design plugin turning coding agents into creative designers with local-first approach
...
- **Tags:** `agent-skills`, `diagram-as-code`, `mermaid-alternative`
...
- **Why use it:** 470+ reverse-engineered image prompts with industrial templates.
...
- **Why use it:** AI-powered design studio with templates, PPT creation, and prototyping.
...
- **Why use it:** Generate images directly within DeepSeek Harness chat
...
- **Why use it:** 6 aesthetic styles to avoid generic AI-generated web looks
...
- **Tags:** `dsh-plugin`, `ai-director`, `video-editing`, `ai-image`
- **Why use it:** AI video/image/audio skills via DirectorX with configurable models
...
- **Why use it:** Enhancement suite for Gemini, Claude, ChatGPT with cross-browser and prompt management
...
- **Why use it:** Local-first cross-platform AI content discovery from major platforms
...
- **Tags:** `dsh-plugin`, `browser-extension`, `workflow`
- **Why use it:** Chrome extension turning AI conversations into organized reusable workflows.
...
- **Why use it:** Control your browser directly from DSH conversations without vision capabilities.
...
- **Tags:** `ios`, `mobile-automation`, `simulator`, `ui-automation`
- **Why use it:** Live iOS Simulator and USB iPhone control directly inside DSH conversations with 22 agent tools.
...
- **Why use it:** Tabbit Browser integration for automated web workflows.
...
- **Why use it:** Privacy-focused open-source resume builder, completely free and self-hostable
...
- **Tags:** `router`, `infra`, `cordis`
- **Why use it:** Runtime injector + task-aware router for optimized agent reasoning.
...
- **Tags:** `marketplace`, `utility`, `dsh-plugin`
- **Why use it:** Visual plugin marketplace with browse, search, and one-click install
...
- **Why use it:** Plugin radar discovering 9000+ candidates with curated Top 50
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH LLM providers via OAuth login.
...
- **Tags:** `cost-tracking`, `token`, `budget`
- **Why use it:** Track session/daily costs, budget limits, and token usage
...
- **Why use it:** Runs Pi Agent extensions as native DSH plugins via ABI bridge
...
- **Why use it:** Crash rescue with config snapshots, rollback and SAFE MODE.
...
- **Tags:** `migration`, `preset`, `session`
- **Why use it:** Cross-preset session migration with fixed-schema state handoff.
...
- **Why use it:** Audits context tokens, detects conflicts in AGENTS.md instructions
...
- **Why use it:** Full DSH config backup, restore, migrate via WebDAV sync
...
- **Tags:** `mcp`, `manager`, `webgui`
- **Why use it:** Web GUI plugin for managing skills and MCP servers in DSH
...
- **Tags:** `utilities`, `plugin-conflict`, `debugging`
- **Why use it:** Detects and resolves plugin and version conflicts
...
- **Tags:** `search`, `discoverability`, `plugin`
...
- **Why use it:** Merges multiple sources into one deduped plugin registry for discovery
...
- **Why use it:** CLI tool for discovering, installing and managing DSH plugins with multi-source search
...
- **Tags:** `dsh`
- **Why use it:** One-click publish planner: validates, generates docs and PR commands
...
- **Tags:** `pet`, `skin`, `pixel-art`
- **Why use it:** Public animated pet gallery — cute customization for coding agents.
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness UI
...
- **Tags:** `theme`, `deepseek-harness-plugin`, `ui`
- **Why use it:** Frosted glass theme with full customization for DSH UI elements.
...
- **Why use it:** WebGPU ocean-themed skin with native DSH integration
...
- **Tags:** `dsh-plugin`, `theme`, `skins`, `ui`
- **Why use it:** 34 opencode color themes for DSH, one-click switch with persistence
...
- **Why use it:** Upload custom backgrounds or switch presets; auto-saves to DSH settings
...
- **Tags:** `rag`, `vibe-coding`, `prompt-engineering`
...
- **Why use it:** Auto-searches top 8 Chinese platforms for 30-day research reports
...
- **Tags:** `web-search`, `free`, `agent-skills`
...
- **Tags:** `awesome-list`, `plugin-directory`, `agent-framework`
- **Why use it:** Curated list of DSH plugins, skills, MCP servers & tools
...
- **Why use it:** Plugin marketplace with 3100+ plugins and public API
...
- **Tags:** `dsh-plugin`, `ftshare`, `finance`
...
- **Why use it:** Unofficial community catalog for browsing and discovering DSH plugins
...
- **Why use it:** Curated directory with verified loads and permission-aware install guidance
...
- **Why use it:** Curated plugin list — essential directory for the DSH ecosystem.
...
- **Tags:** `dsh-plugin`, `web-toy`
- **Why use it:** Fun zero-dependency web simulation of traditional Chinese toy
...
- **Why use it:** Curated plugin ecosystem list for the DeepSeek Harness community.
...
- **Why use it:** Curated bilingual collection of DSH plugins, extensions, tools, and integrations.
...
- **Why use it:** Auto-scraped plugin directory with human verification and personalized recommendations.
...
- **⭐ Stars:** 212
- **Language:** TypeScript
- **Description:** DSH (DeepSeek Harness) 原理学习、插件市场与���佳实践 · Learn DSH principles, plugin marketplace & best practices
- **Tags:** `learning`, `plugin-marketplace`, `best-practices`
- **Why use it:** Learn DSH principles, browse the plugin marketplace, and discover best practices.
...
- **Tags:** `guide`, `awesome-list`, `quickstart`
- **Why use it:** Ultimate DSH guide with quickstart, resource recommendations, and curated plugins.
...
- **Why use it:** DeepSeek Harness plugin marketplace and collection
...
- **Tags:** `awesome-list`, `reference`, `resources`
...
- **Why use it:** Curated index of 280+ DSH plugins across 14 categories
...
- **Tags:** `community`, `oauth`
- **Why use it:** DSH beta closing group photo wall with GitHub OAuth
...
- **Why use it:** Public GitHub directory for discovering DSH plugins and installation commands
...
- **Why use it:** Curated collection of DSH plugins with community selections
...
- **Why use it:** Community curated DSH plugin collection in Chinese
...
- **Why use it:** Plugin guide with installation, permissions and risk info
...
- **Why use it:** Zero-dependency static portal to discover and install plugins
...
- **Why use it:** Redirect notice - see awesome-dsh-plugin repo instead
...
- **Why use it:** AI-curated hourly-updated plugin list across 12 categories
...
- **Tags:** `plugin-collection`, `dsh-ecosystem`
- **Why use it:** DSH plugin repository and verification collection
...
- **Why use it:** Curated evidence-led bilingual plugin directory for DSH ecosystem
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Simple Chinese DSH plugin listing resource
...
- **Why use it:** Auto-generated daily crawled bilingual DSH plugin directory
...
- **Tags:** `agent-harness`, `awesome`, `coding-agents`, `deepseek-harness-plugin`, `dsh-plugin`, `skills`, `ui`
...
- **Why use it:** Industry-specific plugin directory covering finance, legal, medical etc
...
- **Why use it:** Complete DSH tool清单 sorted by stars from 1000+ GitHub repos

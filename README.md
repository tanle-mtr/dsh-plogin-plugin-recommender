...
> The most comprehensive AI-curated collection of DeepSeek Harness plugins — updated hourly, categorized by intelligence.

[🇨🇳 中文版](README-zh.md)

[![GitHub stars](https://img.shields.io/github/stars/tanle-mtr/dsh-plogin-plugin-recommender?style=social)](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/tanle-mtr/dsh-plogin-plugin-recommender/network/members)](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/network/members)
[![GitHub last commit](https://img.shields.io/github/last-commit/tanle-mtr/dsh-plogin-plugin-recommender)](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/commits/main)
[![License: MIT](https://img.shields.io/github/license/tanle-mtr/dsh-plogin-plugin-recommender)](LICENSE)
...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 837,258 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 10:31:07 UTC |
| **AI Model** | agnes-2.5-flash |

---

## Top Plugins Right Now

| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 186,436 | Core DSH platform: everything is a plugin architec |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,571 | Best open-source design plugin for local-first UI  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,895 | Original multi-agent swarm meta-harness with MCP s |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 18 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 8 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 25 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 3 plugins
- [Visual & Design](#visual-&-design) — 12 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 8 plugins
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 18 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 17 plugins
- [Other](#other) — 50 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (18)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (8)
- [Agent Skills & Workflows](agent-skills-workflows) (25)
- [MCP Servers & Tools](mcp-servers-tools) (3)
- [Visual & Design](visual-design) (12)
- [Browser & Web Automation](browser-web-automation) (8)
- [Utilities & Infrastructure](utilities-infrastructure) (18)
...
- **Why use it:** Original multi-agent swarm meta-harness with MCP support.
...
- **Why use it:** Super agent harness with self-evolving memory across models.
...
- **Tags:** `coding-agent`, `deepseek`, `cli`, `tui`
- **Why use it:** Native terminal coding agent optimized for DeepSeek prefix cache.
...
- **Tags:** `low-code`, `ai-agent`, `internal-tools`, `workflows`
- **Why use it:** AI-powered no-code platform for building internal business tools.
...
- **Why use it:** Best beginner tutorial for DSH harness engineering fundamentals
...
- **Tags:** `claude-code`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Switch between Claude Code, Codex, Grok, DeepSeek and other coding agents in one click.
...
- **Tags:** `agent-runtime`, `coding-agent`, `rust`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop app for agentic coding.
...
- **Tags:** `code-review`, `code-quality`, `clean-architecture`, `dsh-plugin`
- **Why use it:** AI code review grounded in 12 classic engineering books with severity labels and decay diagnostics.
...
- **Tags:** `architecture`, `coding-agents`, `drift-check`
- **Why use it:** Architecture-aware coding with drift detection and evidence verification

---

### [paean-ai/deeptide](https://github.com/paean-ai/deeptide)

- **⭐ Stars:** 1,094
- **Language:** Rust
- **Description:** Built by DeepSeek, for DeepSeek — a Swift-native macOS coding agent
- **Tags:** `swift`, `macos`, `coding-agent`
- **Why use it:** Official Swift-native macOS coding agent by DeepSeek
...
- **Tags:** `coding-agent`, `team-automation`
- **Why use it:** Unifies multiple coding agents into one collaborative team
...
- **Why use it:** Superpowers skill ported to Reasonix coding harness.
...
- **Tags:** `skills`, `superpowers`, `coding-agent`
- **Why use it:** TDD, debugging, planning and collaboration skills for DSH.
...
- **⭐ Stars:** 39
- **Language:** Unknown
- **Description:** An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插件/服��/事件/工具/LLM 适配器/打包安装的标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any compatible agent.
- **Tags:** `dsh-plugin`, `plugin-development`, `agent-skills`
- **Why use it:** Agent skill for building DSH plugins following official patterns and standards
...
- **Tags:** `dsh-plugin`, `plugin-development`
- **Why use it:** Agent skill guiding plugin slot assignment, Typert remotes, and credential setup
...
- **Why use it:** On-demand plugin dev knowledge base with official EN/ZH docs and Cordis primer

---

### [w2112515/dsh-plugin-development](https://github.com/w2112515/dsh-plugin-development)
...
- **Tags:** `plugin-development`, `agent-skills`, `dsh-plugin`
- **Why use it:** Portable Agent Skill for developing and auditing DSH plugins

---

### [omdsh-dev/dsh-plugin-dev](https://github.com/omdsh-dev/dsh-plugin-dev)

- **⭐ Stars:** 13
- **Language:** Unknown
- **Description:** DSH 插件开发踩坑与做法档案（skill + 文档）：cordis 双副本、tsconfig 三件套、Windows junction、多帧 zstd 等实测记录
- **Tags:** `plugin-dev`, `documentation`, `best-practices`
- **Why use it:** Practical DSH plugin dev notes covering cordis, tsconfig, Windows junctions

---

### [czm15053/dsh-development-practices](https://github.com/czm15053/dsh-development-practices)
...
- **Tags:** `engineering`, `best-practices`, `agent-skill`
- **Why use it:** Engineering discipline and best practices distilled from DSH development

---

### [omdsh-dev/dsh-plugin-skills](https://github.com/omdsh-dev/dsh-plugin-skills)
...
- **Tags:** `plugin-development`, `testing`, `skills`
- **Why use it:** Agent skills for scaffolding and testing DSH plugins inside DSH
...
- **Why use it:** Full-stack Godot 4.x game development skill plugin registered at runtime
...
- **Why use it:** Multi-source plugin discovery with deduplication from GitHub and npm
...
- **Tags:** `cli`, `plugin-manager`
- **Why use it:** Full-featured CLI for discovering, installing, updating and auditing DSH plugins

---

### [SongYuhui14/dsh-publisher](https://github.com/SongYuhui14/dsh-publisher)
...
- **Tags:** `publisher`, `automation`
- **Why use it:** One-click plugin publishing with validation, description generation, and PR automation

---

### [joeyefengying/dsh-plugin-market](https://github.com/joeyefengying/dsh-plugin-market)

- **⭐ Stars:** 1
- **Language:** JavaScript
- **Description:** DSH 插件市场动态插件：浏览 awesome-dsh-plugin 社区精选（227），搜索/分类/星标排名/一键安装/已装检测/收藏
- **Tags:** `marketplace`, `ui`
- **Why use it:** Interactive plugin marketplace with search, categorization, favorites, and one-click install
...
- **Tags:** `desktop`, `dsh-plugin`, `cordis`, `deepseek-harness`
...
- **Tags:** `agent-workspace`, `no-code`, `multi-platform`
...
- **Why use it:** Open sidebar foundation with file editor, terminal, side chat, Git, and sub-agent page support.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking, real-time status, and rollback.
...
- **Why use it:** Desktop companion with animated pets and plugin SDK support
...
- **Tags:** `tauri`, `desktop`, `zero-setup`
- **Why use it:** Lightweight Tauri desktop with preset plugins, zero environment setup
...
- **⭐ Stars:** 635
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼���，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `widget`, `floating`, `balance`
- **Why use it:** Cute floating whale widget showing DeepSeek account balance with animations
...
- **Why use it:** Local-first AI desktop workspace with projects, research and office automation
...
- **Tags:** `desktop-app`, `agent`, `tauri`
- **Why use it:** Local-first desktop AI agent with self-evolving skills
...
- **Why use it:** Interactive UI components rendered inline in replies
...
- **Tags:** `desktop-app`, `electron`, `multi-platform`
- **Why use it:** CodePilot-inspired desktop client for DSH across platforms
...
- **Tags:** `canvas`, `workspace`, `plugin`
- **Why use it:** Visual non-linear canvas workspace, enables branching conversations
...
- **Tags:** `electron`, `desktop`, `gui`
- **Why use it:** Open-source Electron desktop client with SSH, mobile remote access
...
- **Why use it:** Open-source Smartisan-style notes with Docker deployment and skill support
...
- **Why use it:** Electron desktop console managing Harness/plugins/MCP/skills with multi-tab UI
...
- **Tags:** `ui`, `status-bar`, `info-display`
- **Why use it:** Status bar showing provider, model, live balance and pricing info

---

### [a903067276-rgb/dsh-hud](https://github.com/a903067276-rgb/dsh-hud)
...
- **Tags:** `hud`, `ui`, `status-panel`
- **Why use it:** Floating HUD panel showing git status, MCP servers, skills, model and token usage at a glance
...
- **Tags:** `rag`, `knowledge-base`, `semantic-search`, `llm`
- **Why use it:** Open-source RAG knowledge platform with semantic search and wiki.
...
- **Why use it:** Portable local-first memory layer with self-evolving cross-app RAG support
...
- **Why use it:** Unlimited memory storage for persistent agent sessions
...
- **Tags:** `knowledge-base`, `rag`, `ai-resources`
...
- **Tags:** `long-term-memory`, `agent-memory`, `mcp`
- **Why use it:** Durable long-term agent memory with inspectable recall tools.

---

### [knqiufan/powercontext-dsh](https://github.com/knqiufan/powercontext-dsh)
...
- **Tags:** `memory`, `skills`, `deepseek-harness`
- **Why use it:** Enables recall, memory, handoff and skills via PowerContext server integration
...
- **Tags:** `agent-skills`, `ai-persona`, `digital-human`, `skill-generator`
- **Why use it:** Digital persona skill that preserves memories as AI agents.
...
- **Tags:** `routing`, `cordis`, `reasoning`
- **Why use it:** Task-aware router kit that optimizes reasoning mode per scenario
...
- **Tags:** `agent-os`, `loop-engineering`, `self-improving`
- **Why use it:** Self-improving agent OS that gets smarter through loop engineering over time
...
- **Tags:** `enterprise`, `multi-agent`, `visual-editor`
- **Why use it:** Enterprise multi-engine agent workspace with visual editor and team collaboration
...
- **Tags:** `preset`, `bootstrap`, `standard`
- **Why use it:** Two-phase preset bootstrapping projects with minimal alignment then full standard tools
...
- **Tags:** `agent-skills`, `workflow-automation`, `vibe-coding`, `dsh-plugin`
- **Why use it:** General-purpose skill that intelligently routes and orchestrates harness workflows and skills.
...
- **Why use it:** Vision toolkit enabling text-only LLMs to understand images and automate GUIs
...
- **Tags:** `task-manager`, `human-in-loop`, `workflow`
- **Why use it:** Human-in-the-loop task manager with real-time agent control across platforms
...
- **Tags:** `agent-teams`, `collaboration`, `multi-agent`
- **Why use it:** Enable multi-agent team collaboration within DSH
...
- **Why use it:** Turn experience into repeatable execution, cross-agent skill system
...
- **Tags:** `vision`, `multimodal`, `skill`
- **Why use it:** Adds multimodal vision to Claude Code, supports screenshot/UI analysis
...
- **Tags:** `ai-infra`, `skills`, `infrastructure`
- **Why use it:** Specialized agent skills for AI infrastructure development and debugging

---

### [worldwonderer/oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh)

- **⭐ Stars:** 144
- **Language:** Python
- **Description:** A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills.
- **Tags:** `creative-writing`, `novel-writing`, `drama-skills`
- **Why use it:** Creative writing and drama production powered by Oh Story.
...
- **Tags:** `agent-skills`, `skill-routing`, `embeddings`
- **Why use it:** Turn SKILL.md files into curated, retrieval-ready skill corpora.
...
- **Tags:** `task-management`, `taskboard`, `cordis`
- **Why use it:** SQLite-backed native taskboard with agent claim and review.
...
- **Why use it:** 85 SKILL.md covering reverse engineering and authorized pentesting workflows
...
- **Tags:** `dsh-plugin`, `agent-skills`
- **Why use it:** AI coding mentor that scans architecture, generates steps, and reviews code
...
- **Why use it:** 88 cross-platform agent skills for research, marketing, and social intelligence
...
- **Tags:** `spec-driven-development`, `ai-coding`, `agent-skills`
- **Why use it:** Portable spec-driven development skill inspired by DSH engineering patterns
...
- **Why use it:** Complete Chinese official document workflow tool following GB/T 9704 standard
...
- **Tags:** `canvas`, `agent-skills`, `mcp`
- **Why use it:** Infinite canvas with creative agent skills and MCP tools integration
...
- **Tags:** `record-replay`, `macos`, `agent-skills`
- **Why use it:** Record macOS desktop workflows and convert them into agent skills
...
- **Tags:** `mcp-server`, `skills`, `hot-reload`
- **Why use it:** Paste JSON to connect MCP servers, auto-recognizes .skill files, hot-reloads without restart

---

### [LKQ667/metamath-harness](https://github.com/LKQ667/metamath-harness)

- **⭐ Stars:** 10
- **Language:** Python
- **Description:** DeepSeek Harness 0.1.0-rc.6 数学建模增强套件：外置插件 + Preset + 17 个手动 Skill 卡片 + Windows 便携版脚本
- **Tags:** `math`, `skills`, `modeling`
- **Why use it:** Math modeling enhancement toolkit with 17 manual skill cards and preset configurations
...
- **Tags:** `agent-skills`, `ai-design`, `design-systems`, `ui-generator`
- **Why use it:** Best open-source design plugin for local-first UI prototyping.
...
- **Tags:** `agent-skills`, `architecture-diagram`, `diagrams-as-code`, `mermaid`
- **Why use it:** Agent skill for generating beautiful architecture and flow diagrams.
...
- **Why use it:** 470+ GPT-Image2 prompts and industrial-grade templates for image generation
...
- **Why use it:** First vision plugin converting images to structured JSON evidence for text-only agents
...
- **Tags:** `video-generation`, `ffmpeg`, `vox`, `dsh-plugin`
- **Why use it:** Turns one topic into a finished Vox-style paper-collage explainer video end-to-end via ffmpeg.
...
- **Why use it:** DeepSeek Harness-native vision toolkit with free image OCR and UI restoration
...
- **Why use it:** AI-powered design studio with PPT and prototyping tools
...
- **Why use it:** Preview, inspect and edit OpenPencil .op documents inside conversations
...
- **Tags:** `image-generation`, `ai-agent`, `deepseek-harness`
- **Why use it:** Generate images directly in DeepSeek Harness chats with AI models.
...
- **Tags:** `legal-tech`, `visualization`, `diagram`, `svg`
- **Why use it:** Visualize legal cases into courtroom-ready timelines and diagrams as SVG
...
- **Why use it:** AI video/image/audio skills with storyboard and vision tools for creators
...
- **Tags:** `browser-extension`, `chat-management`, `prompt-manager`, `multi-platform`
- **Why use it:** Enhancement suite for Gemini, Claude and ChatGPT web UIs.
...
- **Tags:** `ai-agent`, `bilibili`, `content-discovery`, `dsh-plugin`
- **Why use it:** Local-first cross-platform content discovery agent covering B站, YouTube, Reddit, X and more.
...
- **Tags:** `browser-automation`, `browser-use`, `tencent`, `dsh-plugin`
- **Why use it:** Let AI agents leverage your real logged-in browser seamlessly without interrupting your workflow.
...
- **Why use it:** Turn AI conversations into organized reusable workflows across platforms
...
- **Why use it:** Controls Chrome browser directly via sidebar extension
...
- **Why use it:** Strongest free web search bridge for all models without native access
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools
...
- **Tags:** `image-uploader`, `electron`, `s3`, `cloudflare-r2`
...
- **Tags:** `vfs`, `virtual-filesystem`, `unified`
- **Why use it:** First unified virtual filesystem bridging all major AI agent platforms seamlessly
...
- **⭐ Stars:** 1,938
- **Language:** TypeScript
- **Description:** The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH ���视化插件市场
- **Tags:** `marketplace`, `plugin-discovery`, `dsh-plugin`
...
- **Tags:** `plugin-registry`, `awesome-list`, `discovery`, `dsh-plugin`
- **Why use it:** Plugin radar and curated top-50 list with real installation-path testing across 9000+ candidates.
...
- **Tags:** `context`, `dashboard`, `utility`
- **Why use it:** Deep context insight dashboard and management with statistics
...
- **Tags:** `cost-tracking`, `token-usage`, `utility`
- **Why use it:** Track session/daily costs, budget limits, OpenCode Go quota monitoring
...
- **Why use it:** Bridge Pi Agent ecosystem to DSH, run Pi extensions natively as DSH plugins
...
- **Why use it:** Crash recovery with undo snapshots and safe mode support.
...
- **Tags:** `context-migration`, `session-migration`, `preset-migration`
- **Why use it:** Cross-preset session migration preserving state and intent.
...
- **Tags:** `dsh-repository-plugin`, `plugin-management`, `ui`
- **Why use it:** Zero-patch plugin console + official dev skill guide for DSH ecosystem
...
- **Why use it:** Pixel-to-text OCR and vision tools enabling image understanding for text-only LLMs
...
- **Tags:** `dsh-plugins`, `plugin-management`
- **Why use it:** Run multiple isolated DSH containers with embedded WebView UI and one-click import
...
- **Tags:** `config`, `backup`, `migration`, `utility`
...
- **Why use it:** Fast Neovim plugin manager written in Lua for developer workflows

---

### [liqichen/dsh-plugin-manager](https://github.com/liqichen/dsh-plugin-manager)

- **⭐ Stars:** 11
- **Language:** JavaScript
- **Description:** DSH 插件管理器:在 DeepSeek Harness 设置面板内嵌 GUI,管理 MCP 服务 / Skills / 内置插件包,改动热生效无需重启
- **Tags:** `plugin-manager`, `mcp`, `hot-reload`
- **Why use it:** Built-in GUI for managing MCP services, skills, and plugins with hot-reload support
...
- **Tags:** `monitoring`, `cost`, `visualization`
- **Why use it:** Real-time token usage tracking, cost estimation, and API balance visualization dashboard

---

### [dabaicai001/star-deepseek-harness-desktop](https://github.com/dabaicai001/star-deepseek-harness-desktop)
...
- **Why use it:** Cross-platform Tauri desktop integrating database, SSH, Docker panels with AI assistant
...
- **Tags:** `pet`, `mascot`, `pixel-art`
- **Why use it:** Animated mascot pets gallery personalizing your coding agent interfaces
...
- **Tags:** `skin`, `theme`, `whale`, `dsh-plugin`
- **Why use it:** Whale Girl skin series providing cute visual customization for DeepSeek Harness.
...
- **Why use it:** Glassmorphism theme with full customization controls
...
- **Tags:** `chrome-extension`, `theme`, `threejs`
- **Why use it:** Beautiful WebGPU ocean-themed skin for DSH, enhances visual experience
...
- **Tags:** `theme`, `skin`, `color-scheme`
- **Why use it:** 34 opencode themes like tokyonight and dracula, one-click apply
...
- **Tags:** `background`, `theme`, `customization`
- **Why use it:** Upload custom images or switch presets for Web background with real-time preview and auto-save
...
- **⭐ Stars:** 1,546
- **Language:** Python
- **Description:** last30days-cn ��一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析后生成有据可查的研究报告。
- **Tags:** `research`, `web-search`, `chinese-platforms`, `dsh-plugin`
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days content and generates cited research reports.
...
- **Why use it:** Curated plugin/skill/MCP resource list, essential DSH discovery guide
...
- **Why use it:** Multi-source anime search plugin with Bangumi ratings and magnet links
...
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms with zero config
...
- **Tags:** `kline`, `analysis`, `deepseek-harness`
- **Why use it:** Interactive K-line analysis with multi-market support and technical indicators
...
- **Why use it:** Unofficial community catalog serving as a comprehensive DSH plugin discovery resource
...
- **Tags:** `curated`, `awesome-list`, `verified`
- **Why use it:** Curated evidence-led directory with verified loadable extensions and permission guidance
...
- **Tags:** `registry`, `open-data`, `awesome-list`
- **Why use it:** Spam-filtered open-data registry cataloging DSH plugins, bundles, and skills comprehensively
...
- **Why use it:** Vertical curated list of 24 verified stock/finance/quant plugins for DeepSeek Harness
...
- **Why use it:** Comprehensive AI-curated plugin directory with 190+ entries updated hourly
...
- **Why use it:** Curated DSH plugin collection with multi-topic coverage
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** DSH plugin resource list for ecosystem exploration
...
- **Why use it:** Curated registry covering models, tools, sandboxes, and UI extensions

---

### [web-casa/awesome-cordis-plugins](https://github.com/web-casa/awesome-cordis-plugins)
...
- **Why use it:** Complete sorted catalog of 1000+ DSH ecosystem repositories by stars
...
- **Tags:** `agent-skills`, `mcp-server`, `resume-builder`, `self-hosted`
- **Why use it:** Privacy-first open-source resume builder with MCP integration.
...
- **⭐ Stars:** 19,066
- **Language:** JavaScript
- **Description:** 程序��鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 OpenClaw 保姆级教程、大模型玩法（DeepSeek / GPT / Gemini / Claude / GLM）、最新 AI 资讯、Prompt 提示词大全、AI 知识百科（Agent Skills / RAG / MCP / A2A）、AI 编程教程（Harness Engineering）、AI 工具用法（Cursor / Claude Code / TRAE / Codex / Copilot）、AI 开发框架教程（Spring AI / LangChain）、AI 产品变现指南，帮你快速掌握 AI 技术，走在时代前沿。本项目为开源文档 aiguide，已升级为鱼皮 AI 导航网站
- **Tags:** `ai`, `llm`, `vibe-coding`, `prompt-engineering`
- **Why use it:** Comprehensive AI resource hub and vibe coding tutorial collection.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Essential curated plugin directory for discovering quality DSH extensions
...
- **Tags:** `toy`, `mobile-first`, `single-file`, `dsh-plugin`
- **Why use it:** Web simulation of a traditional Chinese cicala toy with real audio sampling, zero dependencies.
...
- **Why use it:** Curated awesome list of DSH plugins for ecosystem discovery
...
- **Tags:** `awesome-list`, `curated`, `infrastructure`
- **Why use it:** Comprehensive curated list of DSH plugins and infrastructure tools
...
- **⭐ Stars:** 266
- **Language:** JavaScript
- **Description:** 用 30 秒为你的 DeepSeek Harness找到合适的��件。 仓库由脚本每天自动抓取，再经人工逐个核实——真插件进目录，蹭热度的进黑名单，每条剔除理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **Tags:** `awesome-list`, `plugin-discovery`
- **Why use it:** Curated plugin directory with automated verification
...
- **Why use it:** Bilingual curated list of DSH plugins and integrations
...
- **⭐ Stars:** 163
- **Language:** TypeScript
- **Description:** DeepSeek Harness plugin store, marketplace and hub — 3,100+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：���动收集与格式校验，免费搜索 API。deepseek1024.com
- **Tags:** `marketplace`, `catalog`, `plugin-store`
- **Why use it:** Plugin marketplace with 3100+ entries, search and install commands
...
- **Tags:** `plugin-marketplace`, `collection`
- **Why use it:** DeepSeek Harness plugin collection and marketplace integration
...
- **Tags:** `marketplace`, `plugin-marketplace`, `deepseek-harness`
- **Why use it:** Browse and install all GitHub dsh-plugins with one click.
...
- **Tags:** `webui`, `plugin-market`, `deepseek-harness`
- **Why use it:** Web GUI plugin marketplace with one-click install and uninstall.
...
- **Tags:** `awesome-list`, `plugins`, `deepseek-harness`
- **Why use it:** Meticulously curated DSH plugin and tool resource list.
...
- **Why use it:** Community-curated auto-syncing DSH plugin catalog updated every 4 hours
...
- **Tags:** `awesome-dsh-plugin`, `plugin-marketplace`
- **Why use it:** Official auto-generated curated plugin list maintained by cordis.run
...
- **Why use it:** DeepSeek Harness (DSH) 插件精选目录 — 14 类 280
...
- **Why use it:** Use this cross-platform skill in Codex o
...
- **Why use it:** This Codex skill is adapted from DeepSee
...
- **Tags:** `dsh-plugin`
- **Why use it:** DSH 实现 workbuddy 同款选择 skill 功能 | WorkBud
...
- **Why use it:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness
...
- **Tags:** `codex`, `cordis`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `import`, `mcp`, `model-context-protocol`, `openai-codex`, `sync`
- **Why use it:** One-tap Codex move-in to DSH: auto-impor
...
- **Why use it:** Multi-agent team collaboration for DeepS
...
- **Why use it:** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 s
...
- **Why use it:** DSH Skills Manager 基于 DeepSeek Harness 的
...
- **Why use it:** DSH 内测收官合影墙：GitHub OAuth 零权限登录 + 冻结白名单校验
...
- **Why use it:** Free image reading & generation for Deep
...
- **Why use it:** Design aesthetics skill pack for DeepSee
...
- **⭐ Stars:** 15
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏览���里管理技能（skills）与 MCP 服务器。
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的
...
- **Why use it:** Swift Cycle governance skill adapter for
...
- **Why use it:** Package manager for AI agent assets — 42
...
- **Why use it:** Curated public directory for discovering and installing DSH plugins
...
- **Why use it:** Curated list of selected DSH plugins for ecosystem discovery
...
- **Why use it:** Bridges Claude Code memory, skills and config into DeepSeek Harness ecosystem

---

### [songoao25/dsh-virtual-product-team](https://github.com/songoao25/dsh-virtual-product-team)
...
- **Why use it:** Product Team Mode - a DeepSeek Harness a
...
- **Why use it:** Curated list of DeepSeek Harness (DSH) p
...
- **Why use it:** 桌面版 DeepSeek Harness：Electron 壳 + 自托管 ds
...
- **Why use it:** 好用的DeepSeek Harness插件集合
...
- **Why use it:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选插件
...
- **Why use it:** Verified, star-ranked community plugins 
...
- **Why use it:** Evidence-backed DeepSeek Harness plugin 
...
- **Why use it:** DSH Plugin Portal — a zero-dependency st
...
- **Why use it:** 致力于解决各插件之间也与版本之间可能存在的冲突问题并提供解决方案
...
- **Why use it:** Moved → github.com/awesome-dsh-plugin/aw
...
- **Why use it:** Evidence-led bilingual directory of Deep
...
- **Why use it:** Awesome dsh plugin list — automated Deep
...
- **Why use it:** Plugin discoverability for DeepSeek Harn
...
- **Why use it:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并
...
- **Why use it:** ChatGPT Subscription - a DeepSeek Harnes

---

## How It Works

1. **Discovery** — Searches GitHub for repos matching `dsh-plugin`, `deepseek-harness`, `awesome-dsh-plugin`, etc.
2. **AI Categorization** — Each plugin is analyzed by AI and assigned to the best-fitting category
3. **Manual Curation** — A correction table fixes known misclassifications (awesome lists, etc.)
4. **Hourly Updates** — GitHub Actions runs every hour to fetch new plugins and regenerate this list

---

## Contribute

Found a great DSH plugin that's missing? Want to improve categorization?

- **[Open an Issue](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/issues)** — report a bug or suggest a plugin
- **[Fork & PR](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/fork)** — fix miscategorized plugins in `scripts/fix-categories.js`
...
If this list helped you find a great plugin, please share it:

- **Twitter/X**: [Share](https://twitter.com/intent/tweet?text=Check%20out%20this%20amazing%20AI-curated%20DeepSeek%20Harness%20plugin%20list!&url=https://github.com/tanle-mtr/dsh-plogin-plugin-recommender)
- **Reddit**: r/deepseek, r/localllama, r/Cline
- **Discord**: DeepSeek community servers
...
*Generated by AI · Updated hourly via GitHub Actions*

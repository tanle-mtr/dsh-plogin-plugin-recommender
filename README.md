...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 854,034 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 14:50:25 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 191,087 | Core DSH platform; everything is a plugin. Essenti |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,995 | Open-source design system & UI generator with loca |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,252 | Deploy multi-agent swarms with autonomous workflow |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 31 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 12 plugins
- [Other](#other) — 31 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (31)
...
- **Why use it:** Core DSH platform; everything is a plugin. Essential starting point.
...
- **Why use it:** Super AI assistant harness with memory, skills, and multi-model support.
...
- **Why use it:** Terminal-native AI coding agent with prompt caching for stable sessions.
...
- **Tags:** `tutorial`, `harness-engineering`, `dsh`
- **Why use it:** Essential beginner tutorial from zero to harness engineering mastery
...
- **Tags:** `preset`, `harness`, `dsh`
- **Why use it:** Minimal bootstrap then full Standard tools preset for Project2 quality
...
- **Tags:** `agent-runtime`, `coding`, `dsh-plugin`
- **Why use it:** Rust-based high-performance agent runtime with polished desktop UI.
...
- **Why use it:** Architecture-aware coding agents with baseline-first approach
...
- **Why use it:** Multi-agent team coordination plugin for DSH
...
- **Tags:** `agent`, `desktop-app`, `local-first`
...
- **Why use it:** Unifies multiple coding agents into one coordinated team
...
- **Tags:** `desktop-app`, `electron`, `client`
- **Why use it:** CodePilot-inspired desktop client and plugin suite for DSH
...
- **Why use it:** Dispatch Claude Code/Codex work to DSH subagents
...
- **Why use it:** WorkBuddy-style skill picker for DSH composer
...
- **Tags:** `skills-manager`, `management`, `ui`
- **Why use it:** Centralized skills management for DSH ecosystem
...
- **Tags:** `skills`, `mcp`, `manager`, `web-gui`
- **Why use it:** Web GUI plugin manager for skills and MCP servers
...
- **Tags:** `documentation`, `plugin-development`, `skill`
- **Why use it:** Plugin dev troubleshooting archive — cordis, tsconfig, Windows junction tips.
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins from scratch with test tiers.
...
- **Why use it:** Plugin discovery via multi-source merge
...
- **Why use it:** CLI tool for discover/install/manage DSH plugins
...
- **Why use it:** Modern desktop client for DSH plugin ecosystem. Everything is a plugin.
...
- **Tags:** `agent-workspaces`, `no-code`, `mcp`
- **Why use it:** Unified agent workspace accessible across desktop, mobile, browser, API
...
- **Why use it:** Web-based DSH plugin aggregator with marketplace distribution support
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thought, and TPS.
...
- **Why use it:** Floating whale widget monitoring DeepSeek account balance
...
- **Tags:** `desktop`, `workspace`, `electron`
- **Why use it:** Local AI desktop workspace with projects, files, research
...
- **Tags:** `electron`, `desktop-app`, `gui`, `ssh-client`, `windows`
- **Why use it:** Full-featured Electron desktop GUI with SSH and mobile remote access
...
- **Why use it:** Desktop electron hub for multi-tab DSH management
...
- **Tags:** `deepseek-harness`, `ui`, `capability`
...
- **Tags:** `ui`, `info-bar`, `status`
- **Why use it:** Bottom status bar showing provider/model, live balance, and pricing info.
...
- **Why use it:** Cross-platform desktop integrating DB, SSH, Docker, AI
...
- **Why use it:** Electron desktop shell integrating multiple DSH plugins and ModLens
...
- **Why use it:** Local-first portable memory layer with Markdown-native long-term memory
...
- **Why use it:** Self-evolving memory OS with 35.24% token savings and hybrid retrieval
...
- **Tags:** `agent`, `memory`, `rag`, `dsh-plugin`
- **Why use it:** Persistent memory management kit for AI agents with RAG support.
...
- **Why use it:** Unified persistent memory layer backed by Milvus semantic search.
...
- **Tags:** `memory`, `rag`
- **Why use it:** Unlimited memory solution for OpenClaw AI agents
...
- **Tags:** `knowledge`, `rag`, `mcp`
- **Why use it:** Comprehensive AI knowledge base with skills and MCP resources
...
- **Why use it:** Curated skill corpora with semantic search and evaluation tooling
...
- **Tags:** `long-term-memory`, `mcp`, `durable`
- **Why use it:** Durable long-term memory with recall tools and settings
...
- **Why use it:** Cross-platform session memory for agent continuity
...
- **Tags:** `memory`, `rag`, `handoff`
- **Why use it:** Connects to PowerContext for memory, recall and handoff
...
- **Why use it:** Deploy multi-agent swarms with autonomous workflows and coordination.
...
- **Why use it:** Distill AI behaviors into reusable skills. Reusable meta-skill framework.
...
- **Why use it:** AI-powered no-code platform to build business systems fast with workflows.
...
- **Why use it:** 530+ reverse-engineered image prompts with reusable skills and templates
...
- **Tags:** `agent-skills`, `mcp`, `enterprise`
- **Why use it:** Enterprise multi-engine agent workbench with visual editor for teams
...
- **Why use it:** Intelligent skill routing and workflow orchestration for DSH.
...
- **Tags:** `video`, `skill`, `dsh-plugin`
- **Why use it:** End-to-end automated Vox-style paper-collage video from one topic.
...
- **Tags:** `code-review`, `skill`, `dsh-plugin`
- **Why use it:** Book-grounded AI code reviews with severity labels and auto-fix.
...
- **Why use it:** Turn AI conversations into reusable workflows across platforms
...
- **Tags:** `creative-writing`, `fiction-writing`, `drama-skills`, `oh-story`
- **Why use it:** Powerful novel and short-drama writing assistant with drama skills
...
- **Tags:** `agent`, `skills`, `architecture`, `coding`, `docs`
- **Why use it:** Turn experience into repeatable execution workflows across AI agents
...
- **Tags:** `agent-skills`, `multimodal`, `vision`, `claude-code`, `python`
- **Why use it:** Add multimodal vision to text-only LLMs for screenshot/UI analysis
...
- **Tags:** `agent-skills`, `plugin-discovery`, `deepseek-harness`
- **Why use it:** Skill that automates plugin discovery, installation and verification
...
- **Tags:** `taskboard`, `sqlite`, `task-management`
- **Why use it:** Native task management with SQLite backend and Agent review
...
- **Why use it:** Native agent workflow orchestration for DSH
...
- **Why use it:** Superpowers skill port adapted for Reasonix harness
...
- **Why use it:** TDD, debugging, planning skills for DSH from Superpowers
...
- **Why use it:** Complete reverse engineering pentest skill
...
- **Why use it:** AI coding mentor with auto code review
...
- **Tags:** `agent-skills`, `research-tools`
- **Why use it:** 88 open-source agent skills for research and marketing
...
- **Tags:** `agent-skills`, `spec-programming`
...
- **Why use it:** OCR and pixel art image reading for text models
...
- **Tags:** `agent-skills`, `plugin-dev`
- **Why use it:** Agent skill for plugin slots and credentials
...
- **Why use it:** Official plugin dev knowledge base as on-demand skill
...
- **Why use it:** Traditional Chinese wisdom: Bazi, Fengshui, IChing skills
...
- **Tags:** `code-simplification`, `refactoring`, `codex`
- **Why use it:** Codex skill for code simplification and refactoring
...
- **Tags:** `agent-skills`, `vision`, `image-generation`
- **Why use it:** Enables image reading and generation via vision transcribing and media skills.
...
- **Tags:** `agent-framework`, `skills`, `package-manager`
- **Why use it:** Package manager with 42 skills, 5 CLIs for AI agent engineering and dev.
...
- **⭐ Stars:** 14
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、���格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `skill`
- **Why use it:** Chinese official document processing — formatting, optimization, template generation.
...
- **Tags:** `engineering`, `practices`, `skill`
- **Why use it:** Engineering discipline skill: fact-finding, durable decisions, evidence-based reporting.
...
- **Tags:** `canvas`, `skills`, `dsh-plugin`
- **Why use it:** Infinite canvas with creative agent skills for DSH
...
- **Why use it:** Hot-reload MCP config, paste JSON to connect instantly
...
- **Tags:** `record-replay`, `workflow`, `skill`
- **Why use it:** Record macOS workflows as agent skills on the fly
...
- **Tags:** `skills`, `game`, `mission`
- **Why use it:** Game-like mission system with fog-of-war map for DSH
...
- **Why use it:** Virtual product team agent preset simulating PM to QA workflow
...
- **Tags:** `mcp`, `vision`, `ocr`, `multimodal`
- **Why use it:** Vision bridge for text-only agents, converting images to structured JSON
...
- **Tags:** `mcp`, `vfs`, `agent-tools`, `python`
- **Why use it:** Unified virtual filesystem giving AI agents persistent cross-session storage
...
- **Why use it:** Bidirectional bridge between Codex and DSH with MCP sync
...
- **Tags:** `oauth`, `chatgpt`
- **Why use it:** Official OAuth integration to use ChatGPT Plus models inside DSH
...
- **Why use it:** Open-source design system & UI generator with local-first desktop.
...
- **Tags:** `agent-skills`, `diagram-as-code`, `dsh-plugin`
- **Why use it:** Agent skill for generating beautiful architecture, sequence, and flow diagrams.
...
- **Tags:** `design`, `ui`, `mcp`, `vibecoding`
- **Why use it:** AI-native vector design tool with concurrent agent teams, prompt-to-UI
...
- **Tags:** `design`, `ai-design`, `ppt`
- **Why use it:** AI-powered design studio with templates and PPT support
...
- **Tags:** `image-generation`, `ai-agent`, `gemini`, `openai`, `seedream`
- **Why use it:** Generate AI images directly inside DSH chat conversations
...
- **Tags:** `design`, `ui-design`, `openpencil`, `ppt`, `ui`
- **Why use it:** Preview, inspect and edit OpenPencil .op documents in-chat
...
- **Why use it:** Legal timeline and litigation diagram generator
...
- **Tags:** `design`, `visual`, `vibe-coding`, `ui`
- **Why use it:** 6 design style presets to avoid AI-generated look
...
- **Tags:** `directorx`, `video`, `ai-image`
- **Why use it:** DirectorX plugin with AI video/image/audio skills and configurable vision tools.
...
- **Why use it:** Browser extension enhancement suite for major AI web UIs including DSH.
...
- **Why use it:** AI agents control real logged-in browser without interruption
...
- **Why use it:** Free web search plugin bridging any model to internet access
...
- **Why use it:** Live iOS Simulator inside DSH with 22 automated testing tools
...
- **Why use it:** Tabbit Playwright-based browser automation for DSH
...
- **Tags:** `community`, `social`, `oauth`, `photo`
- **Why use it:** Community group photo wall with GitHub OAuth login
...
- **Why use it:** Privacy-first open-source resume builder. Secure, customizable, free.
...
- **Why use it:** Ultimate image uploader supporting 60+ services. Essential for creators.
...
- **Tags:** `dsh-plugin`, `utils`, `multi-agent`
- **Why use it:** One-click install and model switch across 10+ coding agent frameworks.
...
- **Tags:** `marketplace`, `utils`, `dsh-plugin`
- **Why use it:** Visual plugin marketplace inside DSH with one-click install.
...
- **Tags:** `context`, `dashboard`, `monitoring`
...
- **Tags:** `cost-tracking`, `token-usage`, `llm`, `deepseek-api`
- **Why use it:** Track API costs and token usage with budget alerts
...
- **Tags:** `anime-search`, `bangumi`, `magnet`, `torrent`
...
- **Tags:** `compatibility-layer`, `migration`, `pi-agent`, `plugin-migration`
...
- **Tags:** `session-migration`, `preset`, `state`
...
- **Why use it:** Crash-rescue with rollback, snapshot, and SAFE MODE
...
- **Why use it:** Plugin registry console and dev guide
...
- **Tags:** `desktop-app`, `plugin-management`
- **Why use it:** Containerized DSH version manager with WebView UI
...
- **Why use it:** Audit context injection, detect token waste and conflicts
...
- **Why use it:** Fast, elegant Neovim plugin manager in pure Lua
...
- **Why use it:** Built-in GUI plugin/MCP/skill manager, hot applies
...
- **Why use it:** Diagnoses and resolves plugin conflicts across versions and plugins
...
- **Why use it:** Search npm and awesome-dsh-plugin lists directly from inside DSH agents
...
- **Tags:** `awesome-list`, `dsh-plugin`, `dsh-repository`
- **Why use it:** Plugin catalog tracking DSH ecosystem tools
...
- **Why use it:** Curated DSH plugin collection
...
- **Why use it:** Auto-crawled daily DSH plugin directory
...
- **Tags:** `awesome-list`, `dsh-plugin`, `llm`, `ui`
- **Why use it:** Curated DSH plugins covering models, tools, UI
...
- **Why use it:** 70+ verified DSH plugins by function
...
- **Tags:** `awesome-list`, `dsh-plugin`, `industry`
...
- **Tags:** `awesome-list`, `cordis-plugin`, `dsh`
- **Why use it:** Auto-generated Cordis plugin list
...
- **Why use it:** 1000+ DSH tools sorted by stars
...
- **Tags:** `mascot`, `cli`, `pixel-art`
- **Why use it:** Public animated pet gallery enhancing CLI assistant interface personality
...
- **Tags:** `chrome-extension`, `deepseek-harness`, `theme`, `threejs`, `webgpu`
- **Why use it:** Beautiful WebGPU ocean theme with three.js visuals
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** 34 opencode classic color themes for DSH, one-click switch, persistent across restarts.
...
- **Tags:** `webui`, `customization`
- **Why use it:** Customizable web background with presets, real-time preview and auto-save
...
- **Tags:** `research`, `content-discovery`, `dsh-plugin`
- **Why use it:** Auto-discovers content across 8+ Chinese platforms with AI analysis.
...
- **Tags:** `api-documentation`, `research-tools`
- **Why use it:** Search 65,600+ Chinese platform API docs
...
- **Tags:** `evaluation`, `benchmark`, `rag`, `prompt-testing`
...
- **Why use it:** Interactive K-line chart analysis with multi-market data and technical indicators.
...
- **Why use it:** Math modeling toolkit with 17 manual skill cards
...
- **Why use it:** Curated, verified DSH plugins with permission guidance
...
- **Why use it:** Spam-filtered plugin registry with open data insights
...
- **Tags:** `radar`, `plugin-registry`
- **Why use it:** Evidence-backed plugin radar and 2Origin lab for DSH ecosystem analysis
...
- **Why use it:** Curated plugin directory for discovering quality DSH ecosystem tools
...
- **Tags:** `novelty`, `web`, `dsh-plugin`
- **Why use it:** Fun web-based simulation of a traditional Chinese buzzing toy.
...
- **Why use it:** Plugin registry with 9000+ candidates and top 50 curated picks
...
- **Why use it:** Curated list of DSH plugins across ecosystem
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Comprehensive curated list of DSH ecosystem plugins and tools
...
- **Why use it:** Native DSH vision toolkit, paste image for instant recognition
...
- **Why use it:** Curated bilingual plugin and tool reference list for DSH
...
- **Tags:** `awesome-list`, `discovery`, `plugin`
- **Why use it:** Auto-scraped plugin discovery with scenario-based classification
...
- **Why use it:** Learn DSH principles and discover best plugins via marketplace
...
- **Why use it:** Ultimate DSH guide with quickstart and curated plugin recommendations
...
- **Tags:** `awesome-list`, `agent-framework`, `mcp`, `dsh-plugin`
...
- **Tags:** `marketplace`, `plugin-store`, `registry`, `dsh-plugin-market`
- **Why use it:** Plugin marketplace hub with 3100+ entries and search API
...
- **Tags:** `plugin-marketplace`, `deepseek-harness`, `harness-ai`
- **Why use it:** Plugin marketplace and directory for DSH ecosystem
...
- **Why use it:** Smartisan-style open-source notes with Docker deployment and WeChat export
...
- **Tags:** `marketplace`, `plugin-market`, `gui`
- **Why use it:** One-click browse/install all DSH plugins via Web GUI
...
- **Why use it:** Curated plugin ecosystem resource list
...
- **Tags:** `awesome-list`, `plugins`
- **Why use it:** Official auto-generated plugin list by cordis.run
...
- **Tags:** `awesome-list`, `plugins`, `community`
...
- **Why use it:** Curated list of DeepSeek Harness plugins — good for ecosystem discovery.
...
- **Why use it:** Public GitHub directory for DSH plugins with install commands and discovery tools.
...
- **Why use it:** Curated 2026 DSH plugin list with quality checks for safe selection
...
- **Why use it:** Verified, star-ranked community plugins directory for DSH
...
- **Tags:** `plugin-directory`, `documentation`
- **Why use it:** Plugin product manual and navigation: scenario-based selection guide
...
- **Tags:** `deprecated`
- **Why use it:** Deprecated — moved to github.com/awesome-dsh-plugin/awesome-dsh-plugin

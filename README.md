...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,090,572 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-24 14:47:07 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 234,932 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,921 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,195 | Deploy multi-agent swarms with autonomous workflow |
...
- **Tags:** `agent-orchestration`, `agent-skills`, `coding-agent`, `mcp`
- **Why use it:** Unified agent orchestration platform with task boards, multi-device access and skills.
...
- **Tags:** `agent-collaboration`, `coding-agent`, `mcp`, `dsh-plugin`
- **Why use it:** Enterprise-grade multi-agent workspace with visual editor and cross-engine support.
...
- **Tags:** `agent-os`, `coding-agent`, `mcp`, `llm-evaluation`
- **Why use it:** Self-improving agent OS with staged evaluation loops, budgeted evolution, and MCP server.
...
- **Why use it:** Powerful coding agent with sub-agents, hashline edits, and MCP integration
...
- **Why use it:** Bridge Pi extensions to DSH via unified ABI — zero modification needed
...
- **Tags:** `agent-platform`, `typescript`, `skills`
...
- **Why use it:** Official cloud plugin with MCP tools and sandbox
...
- **Tags:** `bioinformatics`, `llm-agent`, `desktop-app`
- **Why use it:** Bioinformatics agent desktop with one-click install, skill store, and offline mode.
...
- **Tags:** `plugin-creator`, `cordis`
- **Why use it:** Build and validate DSH/Cordis plugins with this reusable Codex skill.
...
- **Why use it:** Audits context injection and optimizes token efficiency
...
- **Tags:** `docker`, `management`, `container`
- **Why use it:** Containerized multi-DSH instance management with embedded UI
...
- **Tags:** `migration`, `import`, `session`
- **Why use it:** Migration wizard moving sessions from Claude Code and Codex
...
- **Why use it:** Standardized agent skill for building DSH plugins
...
- **Why use it:** Real-time token usage, cost charts, and API balance monitor
...
- **Why use it:** Pre-flight plugin check that auto-injects relevant plugin hints for tasks.
...
- **Why use it:** Privacy-first resume builder with self-hosted MCP integration
...
- **Tags:** `desktop`, `dsh-plugin`, `electron`
- **Why use it:** Modern desktop client for DSH ecosystem where desktop itself is a plugin
...
- **Why use it:** Native desktop application version of DeepSeek Harness for enhanced UX.
...
- **Why use it:** Extensible sidebar with file editor and terminal
...
- **Why use it:** Modern task panel embeddable in DSH/Codex
...
- **Why use it:** TUI enhancement with whale bar and streaming status
...
- **⭐ Stars:** 3,068
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账���余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `widget`, `ui`, `dsh`
- **Why use it:** Cute whale mascot tracks your DeepSeek balance in DSH
...
- **Why use it:** Zero-setup Windows desktop GUI with SSH, Codex, and mobile remote access
...
- **Tags:** `desktop`, `mcp`, `office`, `typescript`
...
- **Tags:** `gui`, `charts`, `forms`, `interactive`
...
- **Tags:** `canvas`, `session`, `branching`, `workspace`
- **Why use it:** Canvas-based non-linear session explorer with branching conversation support
...
- **Why use it:** Open-source local-first multi-model AI agent desktop app
...
- **Why use it:** Native iOS client via WebSocket with sessions and agents
...
- **Why use it:** Privately hosted notes app with Smartisan aesthetics
...
- **Tags:** `plugin-market`, `webui`
- **Why use it:** One-click install/uninstall plugins from community market
...
- **Tags:** `desktop`, `devops`
- **Why use it:** All-in-one DevOps desktop: DB, SSH, SFTP, Docker
...
- **Why use it:** Electron desktop shell integrating DSH web with multiple plugins
...
- **Why use it:** One-click compact toggle for context meter panel, improves UI density.
...
- **Why use it:** LLM knowledge platform with RAG, autonomous reasoning and wiki
...
- **Why use it:** Portable, local-first memory layer with Markdown-native cross-platform memory management.
...
- **Why use it:** Self-evolving memory OS with hybrid retrieval achieving significant token savings.
...
- **Why use it:** Dedicated memory library for building persistent, stateful AI agents with continual learning.
...
- **Why use it:** Dedicated memory management kit for AI agents
...
- **Tags:** `skill-corpus`, `rag`, `semantic-search`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into curated, semantically searchable corpora
...
- **Why use it:** Three-layer auto-consolidation memory system
...
- **Why use it:** Deploy multi-agent swarms with autonomous workflows and conversation
...
- **Tags:** `ai-writing`, `webnovel`, `dsh-plugin`, `skills`
- **Why use it:** Specialized skill for web novel writing at 2M+ word scale, solves AI forgetting and hallucinations.
...
- **Tags:** `agent-skills`, `skills`, `dsh-plugin`, `marketplace`
- **Why use it:** Largest skills marketplace covering coding, content creation, automation, and ML workflows.
...
- **Tags:** `multi-agent`, `workflow-automation`, `control-plane`
- **Why use it:** Control plane for long-horizon multi-agent teams
...
- **Why use it:** Vision bridge for text-only coding agents via OCR
...
- **Why use it:** Virtual terminal and filesystem for agent sandboxes
...
- **Why use it:** Intelligent skill routing with workflow orchestration
...
- **Tags:** `agents`, `teams`, `workflow`
- **Why use it:** AgentTeams plugin for coordinating multi-agent collaboration
...
- **Why use it:** Organizes inspiration-to-published novel workflow with local/online models
...
- **Why use it:** Vision toolkit for text-only models: paste image for OCR and Q&A
...
- **Tags:** `epistemic-loop`, `workflow`, `scientific-discovery`
- **Why use it:** Brings epistemic loop framework for systematic scientific discovery workflows
...
- **Tags:** `creative-writing`, `novel-writing`, `short-drama`
- **Why use it:** Built-in workflows for novel, drama, game and video scripts
...
- **Tags:** `computer-vision`, `video-analysis`, `ocr`
- **Why use it:** Video/audio analysis with verifiable timestamped evidence
...
- **Why use it:** SQLite-backed project taskboard with Agent claim/review
...
- **Tags:** `skill-management`, `audit`, `cordis`
- **Why use it:** In-app skill audit panel for DSH with call tracing and management
...
- **Why use it:** Enables composable, reviewable agent modes for continuous self-evolution
...
- **Tags:** `skills`, `research`, `business-workflow`
...
- **Why use it:** Turn recurring experience into repeatable agent execution patterns
...
- **Why use it:** 87 reverse engineering and security research skills
...
- **Why use it:** AI infra dev skills for writing and debugging systems
...
- **Tags:** `skills`, `mcp`, `deepseek-harness`
- **Why use it:** Manages tool exposure strategies to reduce context usage
...
- **Why use it:** 25 pre-installed engineering skills for 10x dev efficiency
...
- **Tags:** `agent-skills`, `web-search`, `integration`
...
- **Tags:** `agent`, `deepseek-harness`, `skills`
- **Why use it:** AI coding mentor with project scanning and review
...
- **Tags:** `skills`, `deepseek-harness`, `dsh-plugins`
...
- **Why use it:** Official document processing with format checking and optimization
...
- **Tags:** `chinese-traditional-wisdom`, `agent-skill`
- **Why use it:** Integrates Bazi, Fengshui, IChing and TCM into a local deterministic engine with dashboard.
...
- **Why use it:** Plugin dev knowledge base as on-demand skill, covers official docs in EN/ZH.
...
- **Why use it:** Engineering-quality guard: grill requirements, test implementation, prove delivery.
...
- **Tags:** `spec-programming`, `ai-coding`
- **Why use it:** Repository-native spec-driven development skill for AI coding workflows.
...
- **Tags:** `multi-agent`, `agent-orchestration`
...
- **Tags:** `qa`, `testing`
- **Why use it:** QA engineer agent skill framework with 11 skills, shared KB, and type decision matrix.
...
- **Why use it:** Separation-of-deliberation-and-action skill for structured AI task collaboration.
...
- **Tags:** `skill`, `official`, `api`
- **Why use it:** Official skill hub with API docs and practical examples
...
- **Tags:** `video`, `skill`, `motion-design`
- **Why use it:** Cinematic video production skill with 152 shot recipes
...
- **Why use it:** Full-stack Godot 4.x game development skill plugin
...
- **Why use it:** Free TTS integration via Xiaomi MiMo with custom voices
...
- **Why use it:** Structures engineering workflows with task stages and commit checks.
...
- **Why use it:** Plugin aggregation ecosystem with creative workshop distribution for DSH Web.
...
- **Why use it:** Local financial database via Tushare with MCP and HTTP auto-generation
...
- **Why use it:** One-click MCP and skill setup across all major AI tools
...
- **Why use it:** ChatGPT OAuth integration to use ChatGPT models inside DSH.
...
- **Why use it:** Open-source design system with local-first desktop app for agents
...
- **Why use it:** 530+ image prompts with industrial templates and reusable skills
...
- **Tags:** `vibedesign`, `agent-team`, `mcp`
...
- **Why use it:** AI-generated visual editor with template marketplace and PPT
...
- **Why use it:** AI video and image generation toolkit with configurable models
...
- **Why use it:** Enhances multiple AI chat platforms with prompt management for any website.
...
- **Why use it:** Enables AI agents to control your real logged-in browser seamlessly across any shell.
...
- **Why use it:** Free web search plugin with no signup, bridges any model to web access
...
- **Why use it:** Agent browser with persistent identity, fingerprint spoofing, and Playwright
...
- **Why use it:** Live iOS Simulator and device automation with 22 agent tools
...
- **Tags:** `dsh-plugin`, `routing`, `cordis`, `dsh`
- **Why use it:** Router-standard kit with runtime injector for task-aware reasoning mode switching.
...
- **Tags:** `marketplace`, `dsh-plugin`, `infrastructure`
- **Why use it:** Official DSH plugin marketplace for discovery
...
- **Why use it:** Two-phase preset for streamlined DSH bootstrapping
...
- **Tags:** `account-management`, `quota`, `multi-model`
- **Why use it:** Unified account and quota management for AI tools
...
- **Tags:** `api-keys`, `mcp`, `proxy`
- **Why use it:** OpenRouter for agent tools with API key management and MCP proxy
...
- **Tags:** `context`, `dashboard`, `utils`
- **Why use it:** Context insight and management with dashboard and sidebar views
...
- **Why use it:** Curated list of DSH plugins, tools, and ecosystem infrastructure
...
- **Why use it:** CLI, schemas, and resolver for managing the DSH Plugin Hub ecosystem
...
- **Why use it:** Shields AI code from hallucinated packages, missing safeguards, and pattern errors
...
- **Why use it:** OAuth login for ChatGPT, Claude, Grok subscriptions
...
- **Why use it:** Import conversation history from 25+ AI agents as resumable DSH sessions
...
- **Why use it:** Full DSH config backup, restore, sync via WebDAV
...
- **Tags:** `plugin-marketplace`, `dsh-ecosystem`, `awesome-list`
...
- **Why use it:** Plugin ecosystem infrastructure with console and dev guide
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories — essential discovery resource.
...
- **Why use it:** Utility plugins: task notifications, trace, keybindings, terminal
...
- **Tags:** `pixel-art`, `mascot`, `customization`
- **Why use it:** Animated pet gallery for multiple AI coding tools
...
- **Tags:** `themes`, `skins`, `whale`
- **Why use it:** Whale Girl skin series for DeepSeek Harness desktop customization
...
- **Why use it:** Frosted glass theme with fully customizable blur and磨砂 effects, zero source changes
...
- **Why use it:** Animated ocean theme with waves and glassmorphism effects
...
- **Tags:** `background`, `theming`, `ui-customization`
- **Why use it:** Customizable web backgrounds with preset themes and real-time preview.
...
- **Tags:** `ai-guide`, `prompt-engineering`, `rag`
...
- **⭐ Stars:** 3,348
- **Language:** Python
- **Description:** 本地私有、开源��自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `recommendation`, `multi-platform`
- **Why use it:** Cross-platform AI content discovery from multiple sources
...
- **Tags:** `documentation`, `code-analysis`, `technical-writes`
- **Why use it:** Generate accurate technical docs from codebases
...
- **⭐ Stars:** 1,465
- **Language:** Python
- **Description:** DSH Plugin Radar — open-source ecosystem radar for DeepSeek Harness plugins: continuous discovery (21k+ candidates), k8s runtime validation (13k+ tests), 15-min snapshots; the catalog is a generated artifact — 开源 DSH 插件生态雷达：持续发现 2.1 万+ 候选、k8s 运行级实测 1.3 万+、15 分钟快照；插件目录为���动生成的产物
- **Tags:** `research`, `analysis`, `radar`
- **Why use it:** Ecosystem radar discovering 21k+ plugin candidates with k8s validation
...
- **Tags:** `research`, `latex`, `arxiv`, `gpu-tracking`
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU tracking, and SSH orchestration
...
- **Why use it:** Curated daily-scraper plugin discovery guide with rankings
...
- **Why use it:** Curated list of plugins, skills, MCPs, patches and UIs
...
- **Why use it:** Ultimate DSH guide with quickstart, resources and plugin toolkit
...
- **Why use it:** Cross-database academic search with citation graph and verification
...
- **Why use it:** Largest DSH plugin catalog with 11,000+ plugins, search API and rankings
...
- **Tags:** `handbook`, `runtime`, `documentation`
- **Why use it:** Definitive DSH handbook covering 173 runtime sources across 7 major topics
...
- **Why use it:** Curated DSH plugin catalog with 1958 repos and bilingual search/filtering
...
- **Why use it:** Skill that searches, installs and verifies DSH GitHub plugins automatically
...
- **Why use it:** Industry chain mapping and company research toolkit
...
- **⭐ Stars:** 39
- **Language:** Python
- **Description:** 数学建模资源，包含辅助建模、数据预处理、编程、论文写作、降aigc、查重、科研绘图等关键skill。创建者使用skill的大模型为deepseek harness v4.1 pro，但并非仅有dsh适配，skill内涵skill.md文���、README.md文件，reference文件夹及所需依赖，可以利用各种大模型agent进行安装，此外，库内还上传了数学建模workbench的自定义agent，涵盖着数学建模建模手，编程手，论文手三者分工流程及其他要点，使用该agent便于减少数学建模相关提示词的输入，配合各类skill能完成较为高质量的数学建模论文
- **Tags:** `math-modeling`, `research`
- **Why use it:** Complete math modeling toolkit: preprocessing, coding, paper writing, visualization skills.
...
- **Why use it:** Math modeling competition agent: 5 roles, 33 models, thesis templates and grading scripts.
...
- **Why use it:** Curated collection of DSH plugins — essential starting point for discovering tools.
...
- **Why use it:** Beginner-friendly tutorial covering DSH plugin development from scratch.
...
- **Tags:** `shop`, `marketplace`, `plugin`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with review curation
...
- **Why use it:** Curated bilingual repository of DSH plugins, skills, runtimes, and integrations
...
- **Why use it:** Curated awesome list of all DSH plugins, tools, skills & resources
...
- **Why use it:** Curated plugin registry for DSH ecosystem discovery
...
- **Why use it:** Spam-filtered plugin registry with open data for DSH
...
- **Tags:** `stock`, `quant`
- **Why use it:** Curated stock/finance/quant plugin list (24 entries)
...
- **Why use it:** Evidence-led verified plugin directory with safety guidance
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选插件，了解安装、权���、兼容性和风险
- **Tags:** `navigation`, `manual`, `guide`
- **Why use it:** Plugin manual and navigation with scenario-based recommendations.
...
- **Why use it:** Plugin radar with evidence-backed categorization and lab.
...
- **Tags:** `curated`, `collection`, `selection`
- **Why use it:** Curated collection of selected DSH plugins.
...
- **Tags:** `automated`, `bilingual`, `directory`
...
- **Why use it:** Search and discover DSH plugins directly from within agents.
...
- **Why use it:** Curated DSH plugins directory with 80+ verified plugins.
...
- **Why use it:** Community plugins directory for DeepSeek Harness ecosystem.
...
- **Why use it:** Redirected repo, see awesome-dsh-plugin organization instead.
...
- **Why use it:** Auto-updating curated plugin list with YAML-driven README.

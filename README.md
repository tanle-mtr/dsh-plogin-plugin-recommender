...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,097,458 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 236,547 | Core DSH framework — everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,147 | Open-source design plugin with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,309 | Deploy multi-agent swarms with autonomous workflow |
...
- **Tags:** `agents`, `multi-agent`, `mcp`
- **Why use it:** Super AI assistant with self-evolving multi-agent system
...
- **Tags:** `router`, `injection`, `harness-tool`
...
- **Why use it:** Self-evolving Agent OS with evaluation loop and MCP support
...
- **Why use it:** Built-in plugin marketplace for browsing, searching, and one-click install
...
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for harness setup
...
- **Tags:** `accounts`, `routing`, `multi-model`
- **Why use it:** Multi-account and multi-model management with smart routing and failover
...
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits and MCP support in TUI
...
- **Why use it:** CLI, schemas and resolver for managing DSH plugins from the Plugin Hub
...
- **Tags:** `ai-agent`, `deepseek-harness`, `oauth`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions via OAuth, no API keys needed.
...
- **Tags:** `command-code`, `llm-provider`, `dsh-plugin`
...
- **Tags:** `ai-agents`, `compatibility-layer`, `migration`, `pi-agent`
- **Why use it:** Bridge Pi and DSH ecosystems via one Pi Host ABI
...
- **Tags:** `ai-agents`, `automation`, `chatgpt`, `claude-code`, `import`
- **Why use it:** Import conversation history from 25+ AI coding agents
...
- **Tags:** `agent-skills`, `discovery`, `plugin-discovery`
...
- **Why use it:** Essential DSH plugin infrastructure with official repo management and dev guide.
...
- **Why use it:** Official DSH plugin dev knowledge base and scaffold as on-demand agent skill.
...
- **Tags:** `plugin-creator`, `cordis`, `validation`
...
- **Why use it:** CodeX-style plugin marketplace for discovering and installing DSH skills
...
- **Tags:** `agent-tools`, `dsh-plugin`, `awesome-dsh-plugin`
- **Why use it:** Auto-selects relevant plugins per task, boosting agent efficiency
...
- **Why use it:** Versatile browser extension suite across multiple AI platforms
...
- **Tags:** `desktop`, `ui`, `dsh-client`
- **Why use it:** Native desktop client for DeepSeek Harness with full features
...
- **Why use it:** Modern embeddable task board supporting Codex and DeepSeek Harness
...
- **Why use it:** TUI enhancement with whale bar, live status, streaming thoughts, and rollback
...
- **Why use it:** Full desktop GUI client with SSH, mobile access and zero-setup installer
...
- **Tags:** `desktop-app`, `mcp`, `office-automation`, `local-first`
...
- **Tags:** `canvas`, `non-linear`, `session-explorer`
...
- **Why use it:** Local-first privacy desktop agent with self-evolving skills and multi-model.
...
- **Why use it:** Native iOS client bringing workspace and real-time agent tracking to mobile.
...
- **Why use it:** All-in-one DevOps desktop with SSH/Docker/AI
...
- **Why use it:** Electron desktop shell wrapping DSH web with sidebar
...
- **Tags:** `ui`, `button`
- **Why use it:** One-click compact button for context meter panel, clean UI improvement
...
- **Tags:** `skills`, `agent`, `knowledge-distillation`
...
- **Tags:** `agent-workspaces`, `skills`, `orchestration`
- **Why use it:** Unified workspace managing agents, tasks and skills across devices
...
- **Tags:** `skill-store`, `agent-skills`, `curation`
- **Why use it:** Comprehensive skill store with auto-curation from GitHub
...
- **Tags:** `ai-writing`, `novel`, `chinese-content`
- **Why use it:** Solves AI forgetting and hallucination for 2M-word novel writing
...
- **Tags:** `agent-control-plane`, `multi-agent`, `workflow`
- **Why use it:** Control plane with durable state for long-horizon multi-agent teams
...
- **Why use it:** First vision plugin enabling text-only agents to process images via OCR
...
- **Why use it:** Virtual terminal with VFS for isolated AI agent execution environments
...
- **Why use it:** Intelligent skill routing and workflow orchestration improving agent reward
...
- **Tags:** `agent`, `inference`, `reasoning`
...
- **Why use it:** Complete novel writing workflow with character, worldbuilding, and revision tools.
...
- **Why use it:** Creative writing workflows for novels, short drama, games and video recaps
...
- **Tags:** `agent-observability`, `agent-skills`, `video-analysis`
- **Why use it:** Gives AI agents eyes, ears and verifiable multimodal results.
...
- **Tags:** `agent-skills`, `automation`, `competition`, `math-modeling`
- **Why use it:** Full-stack auto math modeling competition skill with AI autopilot
...
- **Tags:** `agent-skills`, `research`, `marketing-automation`, `codex`
...
- **Tags:** `agent-review`, `plan-mode`, `prompt-engineering`, `self-evolving`
- **Why use it:** Composable, reviewable task controls for agent self-evolution
...
- **Tags:** `cordis`, `deepseek-harness`, `skill-manager`
- **Why use it:** DSH skill call audit and in-app skill manager
...
- **Tags:** `agent`, `ai`, `architecture`, `skills`
...
- **Why use it:** Reverse-engineering and authorized pentesting Cordis plugin
...
- **Why use it:** Smartisan-style notes with DSH skill integration and Docker support
...
- **Tags:** `skills`, `dsh-plugin`, `superpowers`
- **Why use it:** Great TDD, debugging, and planning skills for DSH agent workflows.
...
- **Why use it:** Smart three-tier skill exposure strategy reduces context overhead.
...
- **Why use it:** 25 pre-loaded high-quality engineering skills, 10x dev efficiency boost.
...
- **Tags:** `skills`, `dsh-plugin`, `agent`
- **Why use it:** AI coding mentor that guides step-by-step with code review and tests.
...
- **Why use it:** Centralized skill loading and management for DSH local agent skills.
...
- **Why use it:** Bioinformatics desktop agent with skill store and offline mode for scientists.
...
- **Why use it:** Unique Chinese traditional wisdom skill covering Bazi, Fengshui, TCM and more.
...
- **Tags:** `quality-gate`, `requirements`, `engineering-discipline`
- **Why use it:** Engineering quality gate bundle for requirement validation before shipping.
...
- **Tags:** `math-modeling`, `data-preprocessing`, `research`
- **Why use it:** Comprehensive math modeling skill suite with data preprocessing and paper writing.
...
- **Why use it:** Durable multi-agent teams with persistent memory, notes, and cross-session skills.
...
- **Why use it:** 5-role multi-agent math modeling suite with 33 models and thesis template.
...
- **Why use it:** Full QA skill framework with 11 skills and shared knowledge base for AI agents.
...
- **Why use it:** Separates discussion from execution for reliable AI collaboration on change tasks.
...
- **Why use it:** Adapted code simplification skill from DSH for Codex-compatible workflows.
...
- **Why use it:** Standard agent skill for developing DSH plugins
...
- **Why use it:** Manages task stages, verification, and commit checks for engineering workflows
...
- **Why use it:** Official SkillHub open API docs and examples as a DSH plugin.
...
- **Why use it:** One-click local setup for MCP, Skills and rules across 7+ AI agent tools.
...
- **Why use it:** Local-first cross-platform AI content discovery agent from Bilibili, YouTube, and more
...
- **Why use it:** Strongest free web search plugin bridging all models without native web access
...
- **Tags:** `anti-detect-browser`, `browser-automation`, `playwright`, `mcp-server`
- **Why use it:** Anti-detect browser with fingerprint spoofing, unlimited local profiles and Playwright
...
- **Tags:** `mobile-automation`, `ios-simulator`, `ui-automation`
...
- **Why use it:** Tabbit Browser plugins for DSH browser automation workflows
...
- **Tags:** `resume`, `mcp-server`, `react`
- **Why use it:** Privacy-focused open-source resume builder with MCP
...
- **Tags:** `registry`, `credentials`, `mcp`
- **Why use it:** OpenRouter-style registry for agent tools, credentials, and API key management
...
- **Tags:** `jailbreak`, `utility`, `prompts`
- **Why use it:** Jailbreak plugin enabling all models to break restrictions with custom prompts.
...
- **Why use it:** Continuous plugin discovery and k8s-validated ecosystem radar with 21k+ candidates.
...
- **Tags:** `cybersecurity`, `vulnerabilities`, `redteam`, `aisecurity`
...
- **Tags:** `deepseek-harness-plugin`, `dsh-plugin`, `office`
...
- **Why use it:** Daily curated plugin discovery with classification and popularity ranking.
...
- **Tags:** `awesome`, `deepseek-harness`, `plugins`
...
- **Tags:** `task-management`, `deepseek-harness`, `agent`
...
- **Why use it:** Multi-device remote access via secure P2P encrypted network
...
- **Tags:** `finance`, `database`, `multi-agent`, `mcp`
- **Why use it:** Local financial database with multi-AI analysis and IM support
...
- **Tags:** `backup`, `config-manager`, `mcp`
- **Why use it:** Backup, restore, and sync entire DSH config including MCPs and skills
...
- **Why use it:** Essential community plugin marketplace with auto-sync catalog.
...
- **Why use it:** Audits AGENTS.md tokens, detects duplicates/conflicts with a Web UI panel.
...
- **Tags:** `migration`, `utility`
- **Why use it:** Four-source migration wizard for sessions, memories and skills into DSH.
...
- **Why use it:** Practical plugins: notifications, tracing, keybindings
...
- **Why use it:** Solves plugin version conflicts automatically with practical solutions
...
- **Tags:** `mascot`, `pixel-art`, `community`
- **Why use it:** Public gallery of animated pets to personalize your coding agent experience
...
- **Tags:** `deepseek-harness-plugin`, `dsh-plugin`, `theme`
- **Why use it:** Frosted glass theme with full customization, no source code changes.
...
- **Tags:** `animated-background`, `ocean-skin`, `glassmorphism`
- **Why use it:** Real-time ocean animated theme with adjustable waves and glass effects.
...
- **Tags:** `prompts`, `image-generation`, `reference`
- **Why use it:** 530+ GPT image prompt cases and industrial template library
...
- **Why use it:** Comprehensive AI resource library with vibe coding tutorials
...
- **Why use it:** Curated comprehensive list of DSH plugins, tools, and infrastructure resources.
...
- **Why use it:** Brings Epistemic Loop methodology for structured scientific discovery in DSH
...
- **Why use it:** One-stop research workbench with LaTeX editing, arXiv, GPU tracking and SSH
...
- **Tags:** `ai-knowledge-base`, `resources`, `learning`
...
- **Tags:** `academic-search`, `agent-skills`, `mcp`
- **Why use it:** Academic search skill+MCP across arXiv, PubMed, CrossRef with citation graphs.
...
- **Why use it:** Comprehensive industry/company research toolkit with policy tracking
...
- **Why use it:** Search 65,600+ Chinese platform API docs directly in AI coding tools.
...
- **Why use it:** Patent infringement analysis agent producing competitor infringement reports.
...
- **Tags:** `awesome-list`, `plugin-discovery`, `dsh-plugins`
...
- **Why use it:** Interactive K-line analysis with technical indicators and multi-market support.
...
- **Why use it:** 39 tools + 20 strategy skills for A/HK/US/JP/KR/TW market analysis and backtesting.
...
- **Why use it:** Curated stock/finance/quant vertical plugin list
...
- **Why use it:** Plugin selection guide with install, permission, and compatibility info
...
- **Why use it:** Verified star-ranked community plugins curated list for DSH
...
- **Why use it:** Curated guide covering models, tools, sandboxes, UI, and agent loops
...
- **Why use it:** Hand-picked DSHA curated plugin collection for essential tools
...
- **Why use it:** Daily automated crawl of dsh-plugin repos with bilingual directory
...
- **Why use it:** Zero-dependency static portal for filtering and discovering 227+ plugins
...
- **Why use it:** Curated directory to discover quality DSH plugins
...
- **Tags:** `plugin-ecosystem`, `web-ui`, `distribution`
- **Why use it:** Plugin aggregation ecosystem distributed via workshop
...
- **Why use it:** Daily-updated plugin marketplace with reviewed and sourced listings.
...
- **Why use it:** Curated bilingual list of all DSH plugins, extensions and verified references
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`, `learning`
...
- **Tags:** `awesome-list`, `catalog`, `marketplace`, `plugin-directory`
- **Why use it:** Plugin store with 11,000+ DSH plugins and public API
...
- **Tags:** `agent-runtime`, `handbook`, `mcp`, `sandbox`
- **Why use it:** Agent-first handbook covering runtime, plugin, MCP, sandbox
...
- **Tags:** `awesome-list`, `catalog`, `directory`, `skills`
- **Why use it:** Catalog of 1,958 DSH repos with STAR ranking and search
...
- **Why use it:** Curated awesome-list of useful DSH plugins
...
- **Tags:** `awesome-list`, `plugins`
- **Why use it:** Curated list of DSH plugins for productivity and functionality
...
- **Why use it:** AI-driven Blender integration via TCP for real-time 3D viewport control.
...
- **Why use it:** Full GB/T 9704 standard official document creation and formatting tool.
...
- **Why use it:** Legal visualization toolkit: timelines, courtroom battle diagrams, relation maps.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Evidence-led directory with permission-aware guidance
...
- **Why use it:** Broad plugin ecosystem list covering CLI to web UI
...
- **Tags:** `dsh-repository-plugin`, `awesome-dsh-plugin`
- **Why use it:** DSH plugin repository with verification and ecosystem features

...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,088,087 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-24 03:55:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 234,465 | Core plugin harness powering the entire DSH ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,854 | Local-first desktop design tool powered by AI agen |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,163 | Multi-agent swarm framework for autonomous workflo |
...
- **Why use it:** Core plugin harness powering the entire DSH ecosystem.
...
- **Why use it:** Unified agent workspace with cross-device access, task boards, and MCP tool support.
...
- **Why use it:** Enterprise-grade multi-engine agent workspace with visual editor and local-first design.
...
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools suite.
...
- **Why use it:** High-performance Rust agent runtime paired with polished desktop for deep coding tasks.
...
- **Tags:** `cybersecurity`, `vulnerability`, `redteam`, `vscode`
- **Why use it:** Security auditing for AI-generated code vulnerabilities
...
- **Why use it:** Skill audit and in-app management panel for DSH
...
- **Why use it:** AI coding mentor that generates step-by-step chapters and auto-grades your code.
...
- **Tags:** `agent-platform`, `workbench`, `dsh-plugin`
...
- **Why use it:** On-demand plugin dev knowledge base and docs archive for DSH/Cordis developers
...
- **Tags:** `plugin-creator`, `codex-skill`, `dsh-plugin`
- **Why use it:** Reusable Codex skill scaffold for building and validating DSH/Cordis plugins
...
- **Why use it:** Pre-flight plugin check — auto-injects top-K relevant plugins per task.
...
- **Tags:** `agent-skills`, `desktop-app`
- **Why use it:** Local-first desktop design tool powered by AI agents.
...
- **Tags:** `desktop`, `dsh-desktop`, `ui`
- **Why use it:** Official DeepSeek Harness desktop client — run DSH as a native desktop application.
...
- **Why use it:** Open sidebar with built-in pages for files, terminal, Git, and sub-agents.
...
- **Tags:** `task`, `ui`, `dashboard`
- **Why use it:** Modern flexible task board that integrates into DSH/Codex workflows.
...
- **Why use it:** TUI enhancement with whale bar, live stats, streaming thought display.
...
- **Tags:** `widget`, `balance`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracking your DeepSeek account balance with fun animations.
...
- **Why use it:** Lightweight Tauri desktop app with preset plugins, zero setup needed across all platforms.
...
- **Why use it:** Native Windows GUI with SSH and mobile remote access
...
- **Tags:** `desktop-app`, `electron`, `mcp`, `office-automation`
...
- **Tags:** `visual`, `canvas`, `conversation-workspace`
- **Why use it:** Canvas-based non-linear session explorer for DSH
...
- **Why use it:** Brings spreadsheets, docs, slides and relational tables directly into DSH
...
- **Why use it:** Local-first multi-model desktop AI agent app with self-evolving skills
...
- **Why use it:** Native SQLite-backed taskboard with Agent claim/review and no iframe dependency
...
- **Why use it:** Native iOS/Android client with WebSocket sync for workspaces, chats and agent trails
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with full plugin suite support
...
- **Why use it:** Community plugin marketplace with one-click install for Web GUI
...
- **Why use it:** Desktop bioinformatics agent with skill store and offline mode for scientists
...
- **Why use it:** Replaces composer stats bar with model info, balance, and pricing at a glance
...
- **Why use it:** WorkBuddy-style skill picker for easy skill selection in DSH composer.
...
- **Why use it:** All-in-One DevOps desktop: DB, SSH, Docker, AI tools
...
- **Why use it:** Electron desktop wrapper integrating DSH web plugins
...
- **Tags:** `ui`, `knowledge-card`, `sharing`
...
- **Tags:** `agentic-workflow`, `mcp-server`
- **Why use it:** Multi-agent swarm framework for autonomous workflows.
...
- **Tags:** `knowledge-distillation`, `meta-skill`
...
- **Tags:** `low-code`, `workflows`
- **Why use it:** AI-powered no-code platform for building custom business systems.
...
- **Tags:** `ai-writing`, `chinese-novel`, `writing-assistant`
- **Why use it:** AI-assisted long-form Chinese web novel writing — handles 2M+ word serial创作 with memory.
...
- **Why use it:** Comprehensive skills marketplace with auto-crawled GitHub skills — broadest selection available.
...
- **Why use it:** Self-improving Agent OS with interview-gated evaluation and budgeted evolution loops.
...
- **Tags:** `agent-harness`, `multi-agent`, `workflow`
- **Why use it:** Local-first control plane for persistent multi-agent workflows across sessions.
...
- **Why use it:** Intelligent skill routing and workflow orchestration with token efficiency.
...
- **Tags:** `agent-skills`, `inference-control`, `reasoning`
- **Why use it:** Model-agnostic inference control for deep reasoning, verification and recovery workflows.
...
- **Why use it:** Enable multi-agent team collaboration workflows directly within DeepSeek Harness.
...
- **Why use it:** Comprehensive context management dashboard, browser, sidebar and commands for DSH.
...
- **Why use it:** Organized novel writing workflow with characters, worldbuilding, drafting and editing.
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, and UI restoration.
...
- **Tags:** `agent-skills`, `skill-md`, `embeddings`, `semantic-search`
- **Why use it:** Curates skills from SKILL.md with retrieval tooling
...
- **Why use it:** Implements epistemic loop for scientific discovery
...
- **Tags:** `agent-skills`, `creative-writing`, `dsh-plugin`
- **Why use it:** Full workflow workbench for novel, short-drama, game and video content creation
...
- **Why use it:** Gives AI agents vision and audio understanding with verifiable timestamped evidence
...
- **Why use it:** Live iOS Simulator and USB iPhone control inside DSH with 22 automation tools
...
- **Tags:** `mcm`, `competition`, `gitops`, `agent-skills`
- **Why use it:** Full-stack math modeling autopilot with GitOps pipeline
...
- **Tags:** `self-evolving`, `prompt-engineering`, `review`
- **Why use it:** Enables agent self-evolution with composable and reviewable modes
...
- **Tags:** `agent-skills`, `research`, `business`
...
- **⭐ Stars:** 187
- **Language:** Python
- **Description:** 基于tushare构建本地财经数据库。AI原生的多Agent金融分��系统，支持skill拓展Agent能力并自适应生成http接口与mcp调用。支持本地数据库访问的skill对接deepseek-harness/openclaw等通用智能体与微信/QQ/飞书等IM通道盯盘
- **Tags:** `finance`, `agent`, `mcp`
- **Why use it:** Local financial DB with multi-agent and IM channel monitoring
...
- **Why use it:** Auto-finds, installs and verifies DSH plugins as a skill
...
- **Why use it:** 87 SKILL.md for reverse engineering and authorized pentesting
...
- **Why use it:** Unified capability management with three exposure tiers reduces context overhead.
...
- **Why use it:** 25 pre-installed engineering skills built on 30B tokens, boosts dev efficiency 10x.
...
- **Tags:** `agent-skills`, `mcp`, `web-search`
- **Why use it:** Web search, content extraction, finance and research skills for AI agents.
...
- **Why use it:** Full-process Chinese government document tool following GB/T 9704 national standard.
...
- **Tags:** `chinese-traditional-wisdom`, `bazi`, `fengshui`, `dsh-plugin`
- **Why use it:** Integrates Bazi, Fengshui, I Ching into one deterministic local agent skill
...
- **Why use it:** Portable spec-driven development skill inspired by DeepSeek Harness patterns
...
- **Why use it:** Engineering discipline quality gate: grill requirements, test, prove delivery
...
- **Tags:** `math-modeling`, `skill`, `cn`
- **Why use it:** Comprehensive math modeling skill suite: preprocessing, writing, plotting, AIGC reduction
...
- **Why use it:** Senior-tester-style QA skill framework with 11 skills and decision matrix for agents
...
- **Tags:** `math-modeling`, `multi-agent`, `dsh-plugin`
- **Why use it:** 5-role multi-agent math modeling solver with 33 models, templates, and progress viz
...
- **Tags:** `agent-skill`, `planning`, `workflow`
- **Why use it:** Separates discussion from execution for AI-assisted task changes, cross-platform skill
...
- **Why use it:** Film-quality video production skill with 152 shot recipe cards and Remotion templates.
...
- **Why use it:** AI video/image/audio creation skills with configurable model tools for DSH.
...
- **Why use it:** Cross-platform skill preserving session memory for seamless agent handoffs.
...
- **Why use it:** Adapted code simplification skill inspired by DSH find-simplifications.
...
- **Why use it:** Full-stack Godot 4.x game dev skill registering at runtime for DSH.
...
- **Why use it:** Task notifications, LLM trace, keybindings, terminal
...
- **Tags:** `dsh-plugin`, `workflow`, `task-management`
...
- **Why use it:** Vision bridge for text-only agents: paste image, get structured JSON.
...
- **Tags:** `mcp`, `api-keys`, `registry`
- **Why use it:** Centralized API key registry for agent tools, like an OpenRouter for credentials management.
...
- **Why use it:** Search 65,600+ Chinese platform API docs directly in your agent workspace.
...
- **Tags:** `ocr`, `image-reading`, `dsh-plugin`
- **Why use it:** Pixel-to-text OCR tools enabling text-only models to read images via trained methodology
...
- **Why use it:** One-click config sync for MCP, skills, and rules across 7+ AI agent platforms.
...
- **Why use it:** Bind ChatGPT via OAuth to chat inside DSH directly.
...
- **Why use it:** Generates beautiful, verifiable architecture diagrams as code.
...
- **Why use it:** 530+ prompt templates and case library for GPT image generation.
...
- **Tags:** `design`, `ai-agent`, `ui`, `vibedesign`
...
- **Why use it:** AI-powered design studio with visual editing, templates, and PPT creation built in.
...
- **Tags:** `dsh-ui`, `interactive`, `layouts`
- **Why use it:** Inline UI components with charts, forms, and quizzes
...
- **⭐ Stars:** 64
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，��接读案件材料画准一张时间轴，并提供庭前三大法宝（大事记表、庭审对抗图、法律关系图）。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `visualization`, `legal`, `agent-skills`
- **Why use it:** Legal litigation visualization: timelines, case diagrams, and courtroom battle maps.
...
- **Tags:** `browser-extension`, `ai-studio`, `chat-management`
- **Why use it:** All-in-one browser extension enhancing multiple AI platforms with prompt management.
...
- **Why use it:** Let AI agents control your logged-in browser seamlessly — non-disruptive automation.
...
- **Why use it:** Cross-platform content discovery agent across 8+ major social media platforms.
...
- **Tags:** `web-fetch`, `web-search`, `coding-agent`
- **Why use it:** Free web search bridge for models without native access
...
- **Tags:** `browser-automation`, `anti-detect-browser`, `android-emulation`
...
- **Tags:** `vision`, `multimodal`, `browser`
- **Why use it:** Adds vision/multimodal capability for UI and screenshot analysis
...
- **Tags:** `image-uploader`, `cloud-storage`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and apps.
...
- **Why use it:** Beginner-friendly DSH tutorial from zero to one — essential learning resource.
...
- **Why use it:** Runtime injector + task-aware reasoning router — improves agent routing efficiency.
...
- **Why use it:** Official DSH plugin marketplace for one-click browsing and installation.
...
- **Tags:** `account`, `routing`, `utility`
- **Why use it:** Unified account management and smart multi-model routing with failover.
...
- **Why use it:** CLI and resolver for DSH plugin management
...
- **Why use it:** Use ChatGPT Codex, Claude and Grok subscriptions as DSH LLM providers via OAuth
...
- **Why use it:** Essential DSH guide for learning principles and best practices
...
- **Tags:** `handbook`, `agent-runtime`, `awesome-list`
- **Why use it:** Comprehensive handbook covering runtime, plugins, MCP and more
...
- **Why use it:** P2P encrypted remote access from PC, Android, Web to Harness
...
- **Why use it:** Bridges Pi ecosystem to DSH as native plugins
...
- **Tags:** `migration`, `chat-import`, `sessions`
- **Why use it:** Imports chat history from 25+ AI agents as resumable sessions
...
- **Tags:** `backup`, `config-manager`, `restore`, `webdav`
...
- **Why use it:** Community-maintained plugin catalog auto-synced every 4 hours for discovery.
...
- **Why use it:** Zero-patch plugin registry console with official plugin development guidance skill.
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories, essential discovery tool
...
- **Why use it:** Migration wizard for moving sessions, skills, and configs from Claude Code/Codex.
...
- **Tags:** `dsh-plugin`, `conflict-resolution`, `utility`
...
- **Why use it:** Public gallery of animated pixel-art pets for coding agent terminals.
...
- **Why use it:** Whale Girl skin series for DSH, adding cute visual customization to your harness.
...
- **Why use it:** Animated ocean-themed dynamic skin with adjustable waves and glassmorphism effects
...
- **Why use it:** Custom web background with presets, compression, and real-time preview.
...
- **Tags:** `ai-resources`, `vibe-coding`
- **Why use it:** Comprehensive AI resource collection and vibe-coding tutorials.
...
- **Tags:** `documentation`, `analysis`, `code`
- **Why use it:** Auto-generates accurate technical docs and AI-ready context from codebase.
...
- **Why use it:** All-in-one academic research platform with LaTeX and arXiv
...
- **⭐ Stars:** 270
- **Language:** Python
- **Description:** Academic Paper Search：中文科研用户的 Codex / Claude Code / DeepSeek Harness Skill + MCP；跨 CrossRef、PubMed、arXiv、OpenAlex、Europe PMC 检索去重，支持 MeSH、引用核验、引文图谱、试验检���与审计导出。
...
- **Why use it:** Comprehensive industry research with methodology and chain mapping skills
...
- **Why use it:** Patent infringement analysis: input patent number, get competitive infringement report.
...
- **Tags:** `kline`, `finance`, `analysis`, `sidebar`
...
- **Why use it:** Real-time token usage, cost charts, API balance tracking
...
- **Why use it:** Comprehensive 1000+ plugin catalog sorted by stars for discovery.
...
- **Why use it:** Plugin manual and navigation guide covering install, permissions, risks.
...
- **Tags:** `ai-curate`, `recommendation`, `awesome-list`
...
- **Tags:** `radar`, `evidence-backed`, `directory`
- **Why use it:** Evidence-backed plugin radar and 2Origin plugin lab directory.
...
- **Tags:** `curated`, `collection`, `dsha`
- **Why use it:** DSHA精选插件合集，整理精选优质插件。
...
- **Why use it:** Auto-crawled daily catalog of DSH plugins via GitHub Actions.
...
- **Why use it:** Privacy-focused, open-source resume builder with AI skills.
...
- **Why use it:** Curated plugin directory — great starting point for discovering DSH ecosystem plugins.
...
- **⭐ Stars:** 7,971
- **Language:** TypeScript
- **Description:** DeepSeek Harness (DSH) Web 插件���合生态 · 万物皆插件，通过创意工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
...
- **Tags:** `ecosystem`, `radar`, `discovery`
- **Why use it:** Ecosystem radar discovering 21k+ plugins with k8s-based continuous validation.
...
- **Why use it:** Curated awesome list of DSH plugins, tools, and infrastructure from the community.
...
- **Why use it:** Daily-refreshed plugin marketplace with community sourcing and review moderation.
...
- **Why use it:** Auto-curated plugin discovery with daily GitHub updates and scene-based categorization
...
- **Why use it:** Comprehensive curated list of plugins, skills, MCP servers and UIs for DeepSeek Harness
...
- **Why use it:** Ultimate Chinese-language guide covering quickstart, resources and plugin toolkit
...
- **Tags:** `marketplace`, `awesome-list`, `catalog`
- **Why use it:** Massive 11K+ plugin marketplace with API and search
...
- **Tags:** `catalog`, `directory`, `awesome`
- **Why use it:** Complete DSH plugin catalog with search and category filters
...
- **Tags:** `awesome`, `plugin-market`, `curated`
...
- **Why use it:** Curated list of DSH plugins covering productivity and utilities
...
- **Tags:** `catalog`, `community`, `resources`
...
- **Why use it:** Curated DSH plugin list for ecosystem discovery
...
- **Tags:** `registry`, `plugin-registry`, `skills`
- **Why use it:** Spam-filtered open-data plugin registry with skills
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `ai-agent`
...
- **Tags:** `dsh-plugins`, `dsh-repository`, `plugin-verify`
- **Why use it:** Curated DSH plugin repository with analytics.
...
- **Tags:** `awesome-dsh`, `deprecated`
- **Why use it:** Moved to new repo; outdated reference page.
...
- **Why use it:** Auto-updating bilingual plugin list with scripts.

...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,078,272 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-22 04:04:22 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 232,527 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,502 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,017 | Deploy multi-agent swarms with autonomous workflow |
...
- **Why use it:** Modern desktop solution for DSH — the desktop itself is a plugin
...
- **⭐ Stars:** 3,143
- **Language:** TypeScript
- **Description:** DSH 官方公众��收录的 TUI 补位插件：鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `terminal`, `ui`
- **Why use it:** TUI companion with whale bar, live status, streaming thought display.
...
- **⭐ Stars:** 2,906
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的���鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `floating-widget`, `dsh-plugin`, `ui`
- **Why use it:** Cute floating whale widget displaying account balance
...
- **Why use it:** Full-featured Windows desktop GUI with SSH, Codex, and mobile remote access.
...
- **Why use it:** Local-first AI desktop workspace with project management and Office artifacts support.
...
- **Why use it:** Generates interactive UI components, charts, plots, and quizzes inline.
...
- **Why use it:** Local-first desktop app alternative to Claude Cowork with multi-model support
...
- **Tags:** `ios`, `mobile`, `kmp`
- **Why use it:** Native iOS client connecting to Harness via WebSocket for on-the-go use
...
- **Why use it:** Web UI plugin for centralized skill and MCP management
...
- **Why use it:** Community plugin marketplace integrated into the DSH web GUI
...
- **Why use it:** Bioinformatics desktop agent with offline mode and skill store for clinicians.
...
- **Tags:** `desktop`, `docker`, `ssh`, `ai-agent`
...
- **Why use it:** Electron desktop wrapper integrating DSH web ecosystem
...
- **Why use it:** One-click compact button for DSH context meter panel, improves UI efficiency.
...
- **Why use it:** Open-source RAG knowledge platform with autonomous reasoning agent
...
- **Tags:** `documentation`, `knowledge`, `rag`
...
- **Tags:** `agent-memory`, `vector-search`, `skill-md`
- **Why use it:** Curates skill files into retrieval-ready corpora with semantic search and evaluation.
...
- **Tags:** `knowledge`, `mcp`, `encyclopedia`
- **Why use it:** Comprehensive AI encyclopedia covering agents, MCP, RAG, and learning paths.
...
- **Tags:** `ui`, `knowledge-cards`, `memory`
...
- **Why use it:** Long-form web novel writing assistant for AI
...
- **Tags:** `agent-skills`, `skill-store`, `community`
- **Why use it:** Comprehensive skills marketplace with GitHub integration
...
- **Why use it:** Self-evolving agent OS with evaluation loop
...
- **Tags:** `agent-control`, `workflow`, `harness`
...
- **Why use it:** Vision plugin bridging images to structured JSON for text-only agents.
...
- **Why use it:** Inference-time control for deep reasoning and recovery workflows
...
- **Why use it:** Full workflow AI novel writing with RAG and local model support
...
- **Why use it:** Novel writing workflow with templates for fiction, drama, games, and video scripts.
...
- **Tags:** `agent-observability`, `multimodal`, `ocr`
- **Why use it:** Adds multimodal observation skills with verifiable timestamps for agents
...
- **Why use it:** Integrates full office suite—spreadsheets, docs, slides—into Harness
...
- **Why use it:** Implements Epistemic Loop for scientific discovery workflows natively
...
- **Tags:** `self-evolving`, `agent-review`
- **Why use it:** Enable agent self-evolution with composable, human-reviewed modes
...
- **Why use it:** Turn AI experience into repeatable execution across multiple agents
...
- **Why use it:** 87 reverse engineering and pentest skills for authorized security research
...
- **Why use it:** Industry research skills with methodology and public-source tracking
...
- **Why use it:** Specialized AI infra skills for writing and optimizing high-performance systems
...
- **Tags:** `agent-learning`, `skill-generator`, `local-first`
...
- **Why use it:** Superpowers skill suite ported to Reasonix coding harness
...
- **Tags:** `skills`, `dsh-plugin`, `capability`
- **Why use it:** Dynamic skill exposure control reduces context overhead
...
- **Tags:** `skill`, `coding-agent`, `mentor`
- **Why use it:** AI coding mentor that guides through architecture review and code writing
...
- **Why use it:** 25 pre-installed skills for 10x development efficiency boost
...
- **Tags:** `skill`, `document`, `gongwen`
- **Why use it:** Full GB/T 9704 compliant official document generation and editing
...
- **Tags:** `workbench`, `skills`, `typescript`
...
- **Why use it:** Bazi, Fengshui, I Ching and TCM wisdom agent with local deterministic engine.
...
- **Why use it:** Math modeling skill suite with data preprocessing, coding, and paper writing.
...
- **Why use it:** Separate discussion from execution for AI-assisted change tasks across agents.
...
- **Why use it:** Comprehensive AI media toolkit for video, image, and audio generation.
...
- **Tags:** `skillhub`, `dsh-plugin`, `tencent`
- **Why use it:** Official Tencent SkillHub plugin with API docs and examples.
...
- **Why use it:** Adapted Codex skill for code simplification from DSH inspiration.
...
- **Tags:** `math-modeling`, `competition`, `dsh-plugin`
- **Why use it:** Multi-agent math modeling tool with 33 models and paper templates.
...
- **Tags:** `video`, `remotion`, `dsh-plugin`
- **Why use it:** Cinematic video agent with 152 shot cards and Remotion templates.
...
- **Tags:** `agent-skill`, `dsh-plugin`, `skill`
...
- **Why use it:** 530+ image prompts and industrial-grade template skills library
...
- **Why use it:** AI-powered design studio with PPT and visual editor
...
- **Tags:** `visualization`, `svg`, `legal`
- **Why use it:** Legal timeline and case diagrams generation for litigation prep
...
- **Tags:** `browser-extension`, `chat-management`, `deepseek`
- **Why use it:** Multi-platform AI enhancement suite with prompt manager
...
- **Why use it:** Browser automation for AI agents with real login
...
- **Why use it:** Vision toolkit for text-only models: OCR, screenshot analysis
...
- **Why use it:** Strongest free web search bridge for all models without native web access.
...
- **Why use it:** Persistent identity browser with fingerprint spoofing and unlimited local profiles.
...
- **Why use it:** Brings live iOS Simulator automation with 22 agent tools directly into chat
...
- **Why use it:** Two-phase preset: minimal bootstrap then full standard tooling.
...
- **Why use it:** Tracks session/daily costs and balances across multiple LLM providers
...
- **Tags:** `compatibility`, `bridge`
- **Why use it:** Bridge Pi extensions to DSH via single ABI compatibility layer
...
- **Why use it:** Auto-upgrades plugins in sync with DSH version updates
...
- **Why use it:** Backup, restore and migrate complete DSH configuration via WebDAV
...
- **Tags:** `containers`, `dsh-plugin`, `devops`
...
- **Why use it:** One-click MCP/Skills/config setup for 8+ AI coding tools.
...
- **Why use it:** Migration wizard for sessions, memories, and skills from 4 tools.
...
- **Tags:** `launcher`, `orchestration`, `dsh-plugin`
- **Why use it:** Plugin-native orchestration for Runtime, Provider, Plugin, Skill, MCP.
...
- **Why use it:** Enhanced DSH with task notifications, traces, keybindings
...
- **Why use it:** Free Xiaomi MiMo TTS integration for DSH plugins
...
- **Tags:** `diagnostic`, `dsh-plugin`, `conflict-resolution`
...
- **Why use it:** Public animated pet gallery to customize your agent terminal.
...
- **Why use it:** Glassmorphism theme with fully customizable frosted glass effects.
...
- **Tags:** `animated-background`, `theme`, `glassmorphism`
- **Why use it:** Stunning ocean-themed animated background with adjustable wave effects
...
- **Tags:** `webui`, `themes`, `background`
- **Why use it:** Custom background images and presets for DSH Web UI with real-time preview.
...
- **Tags:** `ai-tutorials`, `resource`, `rag`
...
- **Tags:** `content-discovery`, `research`, `agent`
- **Why use it:** Cross-platform AI content discovery agent for Bilibili, YouTube, X, etc.
...
- **Why use it:** One-stop academic research workbench: LaTeX, arXiv, experiments, GPU SSH.
...
- **Why use it:** Patent infringement analysis with competitive reports via skill
...
- **Tags:** `kline`, `technical-analysis`, `dsh-plugin`
...
- **Why use it:** DSH web plugin aggregation ecosystem hub
...
- **Tags:** `marketplace`, `plugin`, `dsb`
- **Why use it:** DSH built-in marketplace for browsing and one-click plugin install.
...
- **Why use it:** Curated daily-scraped plugin directory with filtered fake-tagged projects
...
- **Why use it:** Comprehensive curated list covering plugins, skills, MCPs, and orchestrators
...
- **Why use it:** Privately deployable notes app with Smartisan aesthetic and multi-tenant support
...
- **Tags:** `plugin-marketplace`, `ecosystem`
...
- **Why use it:** Plugin infrastructure with browser-based repository management console
...
- **Tags:** `catalog`, `community`, `dsh-plugin`
...
- **Why use it:** Curated awesome list of DSH plugins, skills, MCPs and resources.
...
- **Tags:** `registry`, `plugin-registry`, `dsh-plugins`
...
- **Why use it:** Curated finance/quant plugin list for DSH ecosystem
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Practical curated collection of useful DSH plugins
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated awesome list for DSH plugins, helps discover ecosystem tools quickly.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ GitHub-sorted plugin directory for DSH ecosystem discovery.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Verified, star-ranked community plugin directory for DSH users.
...
- **Why use it:** Plugin navigation guide with installation, permissions, and compatibility info.
...
- **Why use it:** Automated daily crawler catalog of DSH plugins via GitHub Actions.
...
- **Why use it:** Zero-dependency static portal to browse, filter, and install 227+ plugins.
...
- **Why use it:** In-agent plugin discoverability by searching npm and curated awesome lists.
...
- **Tags:** `dsh-ecosystem`, `plugin-directory`, `awesome-dsh`
- **Why use it:** DSH plugins ecosystem collection and discovery resource
...
- **Tags:** `awesome-list`, `deepseek-harness`, `redirect`
- **Why use it:** Redirects to main awesome-dsh-plugin repository (archived)
...
- **Why use it:** Auto-updating bilingual plugin list with data-driven YAML entries
...
- **Tags:** `registry`, `plugin-directory`, `skills`, `ui`
- **Why use it:** Curated registry covering models, tools, sandboxes, UI, and agent skills

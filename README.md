...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,013,217 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-13 06:04:53 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 221,808 | Core harness platform enabling everything-as-plugi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,820 | Open-source design system alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,250 | Deploy multi-player agent swarms with autonomous w |
...
- [Research & Analysis](#research-&-analysis) — 39 plugins
- [Other](#other) — 13 plugins
...
- [Research & Analysis](research-analysis) (39)
- [Other](other) (13)
---
...
- **Why use it:** Core harness platform enabling everything-as-plugin architecture
...
- **Why use it:** Self-evolving multi-agent assistant with memory and knowledge
...
- **Tags:** `dsh-plugin`, `cordis`, `ai-agents`, `routing`
- **Why use it:** Injector + router-standard kit for task-aware reasoning-mode agents
...
- **Why use it:** Self-improving Agent OS with evaluation-gated loop and MCP server
...
- **Tags:** `preset`, `standard-tools`, `workflow`
...
- **Why use it:** Virtual terminal and filesystem for AI agents, enabling sandboxed coding workflows
...
- **Tags:** `runtime`, `agent`, `desktop`, `rust`
...
- **Tags:** `agent-teams`, `multi-agent`, `dsh-plugin`
- **Why use it:** Enable multi-agent team workflows in DeepSeek Harness
...
- **Tags:** `security`, `audit`, `vulnerability`, `redteam`
...
- **Tags:** `commandcode`, `llm-provider`, `typescript`
- **Why use it:** Adds Command Code model access with plan-aware selection and reasoning efficiency
...
- **Why use it:** Adds multimodal vision to Claude Code for screenshot, UI and chart analysis
...
- **Why use it:** Ports popular Superpowers coding skills to the Reasonix harness.
...
- **Tags:** `coding`, `tdd`, `debugging`
- **Why use it:** TDD, debugging and planning skills from Superpowers adapted for DSH.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `coding-agent`
- **Why use it:** Transforms your AI coding assistant into a mentor with step-by-step guidance and auto-grading.
...
- **Tags:** `plugin-creator`, `tooling`, `validation`
...
- **Why use it:** Adapted Codex skill for code simplification in DSH workflows
...
- **Tags:** `plugin`, `development`, `skill`
- **Why use it:** Guides AI Agent from 0 to 1 developing, building, and testing DSH plugins.
...
- **Tags:** `plugin`, `agent`, `development`
- **Why use it:** Agent Skill standard for developing DSH plugins with Claude Code, Codex support.
...
- **Why use it:** Real-time token usage charts and API cost estimates for DSH.
...
- **Why use it:** Pre-flight plugin library check, boosts agent utilization
...
- **Why use it:** OAuth ChatGPT integration for DSH agent conversations
...
- **Why use it:** Modern desktop solution tailored for the DSH plugin ecosystem
...
- **Tags:** `petdex`, `mascot`, `dsh-plugin`, `ui`
- **Why use it:** Animated pet gallery enhancing coding CLI tool UX across harnesses
...
- **Tags:** `taskboard`, `ui`, `panel`
- **Why use it:** Modern flexible task panel embedding into Codex and DeepSeek Harness interfaces
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thought, rollback and TPS display
...
- **⭐ Stars:** 2,266
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小��鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `widget`, `ui`, `balance-monitor`
- **Why use it:** Cute floating whale widget monitoring your DeepSeek account balance in DSH
...
- **Why use it:** Lightweight Tauri desktop with zero setup, cross-platform support
...
- **Tags:** `desktop`, `electron`, `local-first`, `workspace`
- **Why use it:** Local-first Electron desktop workspace integrating DSH sessions, files, web research and plugins
...
- **Tags:** `desktop`, `windows`, `gui`, `ssh`
- **Why use it:** Windows desktop GUI for DSH with Codex integration, SSH client and mobile remote access
...
- **Why use it:** Generates interactive inline UI components — charts, forms, quizzes rendered in assistant replies
...
- **Tags:** `canvas`, `branching`, `workspace`, `visualization`
- **Why use it:** Canvas-based non-linear conversation workspace enabling branching sessions and visual exploration
...
- **Tags:** `desktop`, `tauri`, `local-first`, `privacy`
- **Why use it:** Local-first Tauri desktop app with multi-model support, self-evolving skills and privacy focus
...
- **Why use it:** Brings spreadsheets, docs, slides into Harness office environment
...
- **Tags:** `ios`, `mobile`, `native-app`
- **Why use it:** Native iOS client with WebSocket sync for workspaces and agent traces
...
- **Why use it:** Smartisan-style notes with Docker private deployment and multi-tenant support
...
- **Tags:** `marketplace`, `ui`, `plugins`
- **Why use it:** Community plugin marketplace for DSH web GUI with one-click install.
...
- **Why use it:** Electron-based desktop console for multi-tab management of Harness, Plugins, MCP, and Skills.
...
- **Tags:** `balance`, `pricing`, `tracking`, `web`
- **Why use it:** Live balance/pricing info bar with countdown, enhances DSH UX
...
- **Tags:** `bioinformatics`, `desktop`, `single-cell`, `tauri`
...
- **Why use it:** All-in-one DevOps desktop hub with DB client, SSH, SFTP, Docker, and AI.
...
- **Why use it:** Electron desktop wrapper for DSH with integrated sidebar and ModLens.
...
- **Tags:** `knowledge-cards`, `dsh-plugin`, `ui`
...
- **Why use it:** LLM knowledge platform turning docs into queryable RAG and wiki
...
- **Why use it:** Portable local-first memory layer with Markdown-native cross-app memory
...
- **Why use it:** Lightweight memory library for building stateful agentic applications
...
- **Tags:** `memory`, `rag`, `memory-management`
...
- **Tags:** `memory`, `agent`, `local-first`, `dsh-plugin`
...
- **Why use it:** Curates scattered SKILL.md files into retrieval-ready corpora with vector search and reranking
...
- **Tags:** `knowledge-base`, `encyclopedia`, `learning`, `mcp`
...
- **Tags:** `awesome-list`, `agent-runtime`, `mcp`
- **Why use it:** 74-resource awesome list covering DSH runtime, plugins, MCP, sandbox and more
...
- **Why use it:** Proactive associative memory with three-layer auto-consolidation injected before model speaks.
...
- **Tags:** `handoff`, `memory`, `session`, `context-engineering`
- **Why use it:** Cross-platform session continuity memory for agent handoff scenarios
...
- **Tags:** `agentic-framework`, `multi-agent`, `swarm`
- **Why use it:** Deploy multi-player agent swarms with autonomous workflows
...
- **Tags:** `agent-skills`, `skill`, `dsh-plugin`, `skills`
- **Why use it:** Largest skill marketplace with auto-categorized agent skill packs
...
- **Tags:** `skills`, `workflow`, `routing`, `orchestration`
- **Why use it:** Intelligent skill routing and workflow orchestration, improving reward and reducing tokens
...
- **Tags:** `cognitive-enhancement`, `skills`, `j-space`
...
- **Tags:** `video`, `agent-skill`, `ffmpeg`, `dsh-plugin`
- **Why use it:** End-to-end Vox-style video generation from one topic
...
- **Tags:** `vision`, `ocr`, `agent-skill`, `dsh-plugin`
- **Why use it:** Vision toolkit for text-only LLMs: OCR, multi-image QA, screenshot analysis
...
- **Tags:** `writing`, `novel`, `creative`, `dsh-plugin`
- **Why use it:** Full novel writing workflow with character, worldbuilding, and chapter management
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `screen-recording`
- **Why use it:** Gives agents eyes and ears — converts video, audio and screen activity into timestamped evidence
...
- **⭐ Stars:** 342
- **Language:** Python
- **Description:** Community plugin for DeepSeek Harness with novel, short-drama, game and video-recap workbenches. Not affiliated with DeepSeek.
- **Tags:** `creative-writing`, `ai-agents`, `drama-skills`
- **Why use it:** Novel/drama/game writing workbenches for AI agents
...
- **Why use it:** Native SQLite taskboard with agent claim/review, no iframe runtime
...
- **Tags:** `ios`, `ui-automation`, `webdriveragent`
- **Why use it:** 22 agent tools for live iOS Simulator and USB iPhone automation
...
- **Tags:** `math-modeling`, `automation`, `competition`
- **Why use it:** Full-stack math modeling competition autopilot with GitOps and code proof
...
- **Tags:** `agent-review`, `plan-mode`, `prompt-engineering`
- **Why use it:** Enables composable, human-reviewed agent self-evolution workflows
...
- **Why use it:** Turn experience into repeatable execution across Claude Code, Codex and other agents
...
- **Tags:** `agent-skills`, `research-tools`, `workflow`
- **Why use it:** 88 installable skills for research, social intelligence, marketing and business workflows
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill pack with 87 SKILL.md entries.
...
- **Why use it:** Turns successful DSH sessions into reusable agent skills automatically.
...
- **Why use it:** AI investment desk skill pack with multi-strategy fund backtesting.
...
- **Why use it:** 25 ready-to-use engineering and productivity skills bundled in a sidebar deck panel.
...
- **⭐ Stars:** 51
- **Language:** Python
- **Description:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对���版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `workflow`
- **Why use it:** Complete official document processing workflow based on GB/T 9704 standard with format checking and templates.
...
- **Tags:** `spec-driven`, `development`, `workflow`
- **Why use it:** Portable spec-driven development skill adapted from DeepSeek Harness engineering patterns.
...
- **⭐ Stars:** 36
- **Language:** TypeScript
- **Description:** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/��爻/梅花/奇门/风水/五运六气/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **Tags:** `ai-agent`, `bazi`, `fengshui`, `iching`
- **Why use it:** Comprehensive Bazi/Fengshui/TCM skill with local engine and dashboard
...
- **Why use it:** Enables text-only models to read images via pixel-to-text method
...
- **Tags:** `multi-agent`, `collaboration`, `skills`
...
- **Tags:** `ai-roleplay`, `narrative`, `agent-skills`
- **Why use it:** Adult interactive narrative skill with NPC memory and YAML存档
...
- **Tags:** `skill-picker`, `composer`, `utility`
- **Why use it:** WorkBuddy-style skill picker, quick /skill-name insertion in composer
...
- **Why use it:** QA testing framework with 11 skills and type decision matrix
...
- **Tags:** `math`, `modeling`, `competition`, `agent`
- **Why use it:** Math modeling competition agent with 5 roles, 33 models, thesis templates
...
- **Why use it:** Official SkillHub Open API docs and examples for DeepSeek Harness.
...
- **Why use it:** Godot Engine 4.x full-stack game dev skill registered at runtime.
...
- **Tags:** `huaweicloud`, `mcp`, `cloud-sdk`
- **Why use it:** Official Huawei Cloud AI agent SDK with MCP tools, skills, cloud sandbox, and safety guardrails.
...
- **Tags:** `mcp`, `config`, `multi-agent`, `claude-code`
...
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live sync and MCP mirroring.
...
- **Tags:** `mcp`, `manager`, `settings`
- **Why use it:** Manages skills and MCP servers via Web UI plugin card in settings page.
...
- **Tags:** `agent-skills`, `ai-design`, `design-systems`
- **Why use it:** Open-source design system alternative with local-first desktop support
...
- **Why use it:** Generate beautiful architecture and sequence diagrams from code
...
- **Why use it:** 530+ image prompts with 20+ industrial-grade reusable skills
...
- **Tags:** `fimga`, `flutter`, `react`, `vibedesign`, `mcp`
...
- **Why use it:** First vision plugin for DSH, enables OCR and image-to-text for text-only agents
...
- **Tags:** `design`, `ppt`, `visual`, `dsh-plugin`
- **Why use it:** AI-powered design studio with templates, PPT editing and prototyping
...
- **Why use it:** Legal case visualization toolkit generating litigation diagrams and timelines directly from case materials.
...
- **Tags:** `ai-video`, `image`, `audio`, `storyboard`
- **Why use it:** AI video/image/audio creation with storyboard and corpus tools
...
- **Tags:** `video`, `remotion`, `design`
- **Why use it:** Cinematic product video Agent Skill with 152 shot recipes and Remotion templates.
...
- **Why use it:** 6 design style presets to keep vibe-coded websites away from generic AI look.
...
- **Tags:** `content-discovery`, `web-scraper`, `cross-platform`
- **Why use it:** Cross-platform content discovery agent for B站, YouTube, X, Reddit and more
...
- **Tags:** `browser`, `agent`, `automation`, `dsh-plugin`
- **Why use it:** Official browser automation for AI agents with real sessions
...
- **Tags:** `resume-builder`, `self-hosted`, `open-source`
- **Why use it:** Privacy-first open-source resume builder, self-hosted and free
...
- **Tags:** `electron-app`, `image-uploader`, `cloud-storage`
...
- **Tags:** `low-code`, `ai-agent`, `self-hosted`
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `no-code`, `mcp`
- **Why use it:** Unified agent and workspace management across all devices and APIs
...
- **Tags:** `agent-skills`, `multi-agent-workspace`, `dsh-plugin`
- **Why use it:** Enterprise multi-engine agent workbench for Codex, DSH, and Opencode
...
- **Tags:** `agent-control-plane`, `loop-engineering`, `workflow-automation`
...
- **Why use it:** One-click install and model switch across Claude Code, Codex, DSH, Kimi Code and more
...
- **Tags:** `context`, `dashboard`, `utility`, `dsh-plugin`
- **Why use it:** Comprehensive context dashboard with sidebar and command management
...
- **Tags:** `web-search`, `free`, `bridge`, `no-api-key`
- **Why use it:** Free web search bridge plugin enabling any model without native browsing capability
...
- **Tags:** `oauth`, `llm-providers`, `subscriptions`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH providers via OAuth
...
- **Why use it:** Session/daily cost tracking, budget alerts, and quota monitoring
...
- **Why use it:** Comprehensive plugin catalog with 1958 repos and 1819 verified plugins, bilingual search
...
- **Why use it:** Bridge Pi and DSH ecosystems with ABI compatibility layer for seamless migration
...
- **Why use it:** P2P encrypted remote access to DSH from PC, Android and Web anytime anywhere
...
- **Why use it:** Discovers, installs and verifies GitHub plugins directly within DSH
...
- **Why use it:** Auto-upgrades plugins to stay compatible with DSH version updates.
...
- **Why use it:** Backup, restore, sync and migrate all DSH configs, plugins, MCPs and skills.
...
- **Tags:** `plugin-management`, `infrastructure`, `console`
- **Why use it:** Infrastructure plugin for DSH ecosystem: browser-based plugin registry console and dev guide.
...
- **Why use it:** Unified loader and manager for local Agent Skills within DeepSeek Harness with safety controls.
...
- **⭐ Stars:** 42
- **Language:** JavaScript
- **Description:** DeepSeek Harness (DSH) 插件精选目录 — 14 类 280+ 个社区插件，覆��� MCP / Skill / TUI / 多 Agent / 上下文记忆 / UI 皮肤，点链接直达仓库。Curated directory of dsh plugins for DeepSeek Harness.
...
- **Why use it:** Audits instruction chain token costs and detects conflicts in context
...
- **Tags:** `container`, `management`, `local-first`
- **Why use it:** Runs multiple isolated DSH containers with embedded WebView UI
...
- **Tags:** `launcher`, `infrastructure`, `runtime`
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill, MCP orchestration into extensible platform.
...
- **Why use it:** Resolves conflicts between DSH plugins and version incompatibilities.
...
- **Tags:** `dsh`, `dsh-plugin`, `skin`, `theme`
- **Why use it:** Whale girl themed skins with high community popularity
...
- **Tags:** `theme`, `glassmorphism`, `customizable`, `ui`
- **Why use it:** Frosted-glass theme with fully customizable blur, opacity and background for DSH web UI
...
- **Why use it:** Real-time animated ocean theme with adjustable waves, sunset and glass effects for DSH
...
- **Why use it:** Customizable DSH Web background with preset atmospheres and image uploads.
...
- **Tags:** `ai-guide`, `ai-agent`, `vibe-coding`, `mcp`, `rag`
...
- **Why use it:** Curated DSH plugin list, ideal starting point for discovering quality plugins
...
- **Tags:** `harness-engineering`, `dsh-plugin`, `tutorial`
...
- **⭐ Stars:** 1,782
- **Language:** Python
- **Description:** last30days-cn 是一个 AI Agent 技能（Skill），能���自动搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析后生成有据可查的研究报告。
- **Tags:** `research`, `agent-skill`, `cn`, `dsh-plugin`
- **Why use it:** Auto-searches 8 major Chinese platforms for recent content research
...
- **Tags:** `research`, `latex`, `arxiv`, `experiment-tracking`
- **Why use it:** One-stop research workbench: LaTeX live compilation, arXiv management, experiment tracking and GPU SSH
...
- **Why use it:** Daily-curated plugin discovery with real-plugin filtering and rankings
...
- **Why use it:** Ultimate DSH guide covering quickstart, plugins, resources and toolkits
...
- **Why use it:** DSH principles learning, plugin marketplace exploration and best practices
...
- **Why use it:** Curated lists of plugins, skills, MCP servers, patches, orchestrators and UIs
...
- **Tags:** `marketplace`, `plugin-directory`, `api`
- **Why use it:** 11000+ plugin marketplace with search, rankings, install commands and API
...
- **Why use it:** Cross-source academic search with citation verification and MeSH support
...
- **Tags:** `finance`, `multi-agent`, `skill`
- **Why use it:** Tushare-based financial database with multi-agent analysis and MCP integration
...
- **Why use it:** Industry research skill pack with methodology and chain mapping.
...
- **Why use it:** Searches 65,600+ API docs across 20 Chinese platforms directly within your AI coding tool.
...
- **Why use it:** Patent infringement analysis system generating competitive reports from patent numbers.
...
- **Tags:** `quality-gate`, `engineering`, `testing`
- **Why use it:** Quality gate for engineering discipline, double-checks requirements before shipping.
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, and agent workflows.
...
- **Why use it:** Evidence-led curated directory with verified plugins and permission guidance.
...
- **Why use it:** Complete DSH tool registry with 1000+ repos sorted by stars.
...
- **Why use it:** Curated star-ranked DSH plugin catalog for discovery
...
- **Why use it:** Plugin navigation guide with install, permissions, risks
...
- **Tags:** `plugin-portal`, `awesome-dsh-plugin`, `web`
- **Why use it:** Static web portal for discovering and filtering plugins
...
- **Tags:** `dsh-plugin-market`, `awesome-dsh-plugin`, `plugins`
...
- **Tags:** `awesome-list`, `coding-agents`, `ai-agents`
- **Why use it:** AI-curated 190+ plugin list across 12 categories hourly
...
- **Why use it:** Automated daily-crawled bilingual DSH plugin directory
...
- **Why use it:** DSHA curated plugin collection for reference
...
- **Why use it:** Search npm and curated list from inside DSH agents
...
- **Why use it:** 80+ verified plugins organized by function
...
- **Tags:** `dsh-plugin-verify`, `dsh-plugins`, `dsh-ecosystem`
- **Why use it:** General DSH plugin directory and verification platform
...
- **Tags:** `awesome-list`, `dsh-plugin`, `ai-agents`
- **Why use it:** Evidence-led curated plugin directory with immutable reviews
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Minimal DSH plugin collection listing
...
- **Tags:** `awesome-list`, `dsh-plugin`, `automation`
- **Why use it:** Auto-updating plugin directory with Vercel deployment
...
- **Why use it:** Self-hosted plugin discovery radar with k8s-level testing pipeline
...
- **Tags:** `awesome-list`, `curated`, `dsh-plugin`
- **Why use it:** Community-curated list of all DSH plugin ecosystem resources
...
- **Tags:** `marketplace`, `plugin-store`, `dsh-plugin`
- **Why use it:** Comprehensive plugin marketplace refreshed daily with pre-review quality control
...
- **Why use it:** Bilingual curated list of DSH plugins, extensions, skills and verified integrations
...
- **Tags:** `community`, `catalog`, `marketplace`
...
- **Tags:** `knowledge-base`, `plugin-dev`, `documentation`
- **Why use it:** Installable plugin-development knowledge base bundled as an on-demand agent skill with EN/ZH docs.
...
- **Why use it:** Unofficial community catalog listing all DeepSeek Harness plugins.
...
- **Why use it:** Curated list of精选DeepSeek Harness plugins with badges and descriptions.
...
- **Why use it:** Official awesome list of plugins, tools, skills & resources for DSH ecosystem.

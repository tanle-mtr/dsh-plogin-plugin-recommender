...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 955,350 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-03 03:42:20 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 209,855 | Core DSH platform; everything is a plugin architec |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,663 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,271 | Multi-agent swarm orchestrator with autonomous wor |
...
- **Why use it:** Super AI assistant with memory, skills and multi-model/multi-channel support.
...
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for long sessions.
...
- **Tags:** `low-code`, `internal-tools`, `ai-agent`, `dsh-plugin`
- **Why use it:** AI + no-code platform for rapid internal tool and business system development.
...
- **Tags:** `agent-harness`, `routing`, `mcp`, `injection`
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-evaluation`, `coding-agent`
...
- **Why use it:** First vision plugin for text-only coding agents, enables image-to-JSON.
...
- **Why use it:** Virtual terminal and filesystem for isolated AI agent workflows.
...
- **Why use it:** AI security offense & defense platform for auditing generated code
...
- **Why use it:** Full coding agent with RPC plugin, sub-agents, hashline edits and MCP
...
- **Why use it:** Adds multimodal vision to text-only LLM code agents
...
- **Tags:** `security`, `reverse`, `pentest`
- **Why use it:** 87 reverse engineering and authorized pentesting agent skills
...
- **Why use it:** Port of Superpowers skill to Reasonix coding harness, expanding AI coding capabilities.
...
- **Why use it:** Standardized plugin development skill for DSH ecosystem
...
- **Why use it:** Official DSH plugin development knowledge base with EN/ZH docs
...
- **Tags:** `plugin-creator`, `validation`, `codex`
...
- **Tags:** `context`, `deepseek-harness`, `dsh`, `ui`
- **Why use it:** Audits token cost, detects duplicates and conflicts in DSH context injection
...
- **Tags:** `mcp`, `agent-config`, `deepseek-harness`, `cross-platform`
- **Why use it:** One-click cross-platform MCP/Skills/config sync for multiple AI agents
...
- **Tags:** `agent-framework`, `skills`, `cli`, `mcp`
...
- **Tags:** `agent-tools`, `ai-agents`, `dsh`
...
- **Why use it:** Web-based plugin ecosystem aggregation for the DSH platform
...
- **Tags:** `mascot`, `pixel-art`, `ui`, `coding-agent`
- **Why use it:** Animated pet gallery that personalizes your coding agent experience
...
- **Why use it:** Open sidebar foundation with file editor, terminal, and Git pages.
...
- **Why use it:** Modern flexible task panel embeddable in Codex and DSH.
...
- **Why use it:** Open-source Electron desktop client with SSH, mobile access, and plugins
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite across platforms
...
- **Tags:** `notes`, `desktop`, `smartisan`
- **Why use it:** Smartisan-style notes app with Docker deploy and skill integration
...
- **Why use it:** Browse and manage DSH plugins directly from the web GUI marketplace with one-click install/uninstall.
...
- **Why use it:** DSH plugin ecosystem infrastructure: thin console for repository plugin management and dev guide.
...
- **Why use it:** Electron-based desktop hub for multi-tab management of Harness, plugins, MCP and skills.
...
- **Tags:** `ui`, `web`, `deepseek-harness`, `usage-tracking`
- **Why use it:** Persistent bottom bar showing provider, model, live balance and pricing
...
- **Tags:** `kline`, `ui`, `finance`, `deepseek-harness`
- **Why use it:** Interactive K-line analysis with market data and indicators in sidebar
...
- **Tags:** `mcp`, `skills`, `ui`, `deepseek-harness`
- **Why use it:** Web GUI card for managing skills and MCP servers in browser
...
- **Tags:** `desktop`, `ssh`, `docker`, `sftp`, `devops`
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker, AI assistant and sandboxes in one window.
...
- **Why use it:** Electron desktop wrapper with ModLens and sidebar integration.
...
- **Tags:** `ui`, `dsh-plugin`, `compact`
- **Why use it:** One-click compact context button for DSH web interface
...
- **Why use it:** Open-source LLM knowledge platform turning documents into queryable RAG and wiki.
...
- **Why use it:** Portable Markdown-native memory layer with cross-app persistence
...
- **Tags:** `agent-memory`, `rag`, `token-savings`, `hybrid-retrieval`
...
- **Why use it:** Memory management kit with memory refinement for agents.
...
- **Why use it:** Persistent memory layer backed by Milvus for unified agent memory.
...
- **Why use it:** Best context insight and management plugin with dashboard and browser
...
- **Why use it:** Transforms SKILL.md files into retrieval-ready vector corpora with evaluation
...
- **Tags:** `multi-agent`, `swarm`, `agentic-workflow`, `dsh-plugin`
...
- **Why use it:** Distill expert thinking patterns into reusable agent skills for any AI bot or persona.
...
- **Tags:** `agent-orchestration`, `workspace`, `multi-platform`, `no-code`
...
- **Tags:** `agent-skills`, `marketplace`, `automation`
- **Why use it:** Largest skills marketplace across Claude, Codex, DeepSeek, and more
...
- **Tags:** `agent-control-plane`, `loop-engineering`, `long-horizon`, `workflow-automation`
...
- **Tags:** `agent-workspace`, `multi-agent`, `enterprise`, `visual-editor`
...
- **Why use it:** Intelligent skill routing with 21pp reward gain and token reduction.
...
- **Tags:** `agent`, `teams`
- **Why use it:** Enables multi-agent teamwork within the DeepSeek Harness ecosystem
...
- **Why use it:** Dedicated plugin for creative fiction and short-drama writing workflows
...
- **Why use it:** Composable task controls with human-reviewed self-evolving agent modes
...
- **Tags:** `plugin-discovery`, `installer`, `skill`
- **Why use it:** Auto-finds, installs and verifies GitHub plugins as a DSH skill
...
- **Why use it:** Turns experience into repeatable agent execution workflows
...
- **Why use it:** 88 installable agent skills for research, marketing, and business workflows across multiple coding harnesses.
...
- **Tags:** `dsh-plugin`, `agent-skills`, `coding-mentor`
- **Why use it:** AI coding mentor skill: scans project architecture, generates learning chapters, auto-reviews code.
...
- **Tags:** `agent-skills`, `skill-generator`, `automatic-learning`
- **Why use it:** Automatically converts successful DSH sessions into reusable, reviewable agent skills.
...
- **Tags:** `patent`, `legal-tech`, `multi-agent`, `rag`
- **Why use it:** Patent infringement analysis system producing competitor reports; packagable as cross-agent skill.
...
- **Tags:** `skills-deck`, `agent-skills`, `wayfinder`
- **Why use it:** Brings Matt Pocock skill deck with wayfinder and triage actions
...
- **Tags:** `plugin-management`, `agent-skill`, `credentials`
- **Why use it:** Manage slots, Typert remotes, and credentials for installed plugins
...
- **Tags:** `spec-programming`, `agent-skills`, `development`
- **Why use it:** Portable spec-driven development skill with DSH engineering patterns
...
- **Why use it:** Bazi, Fengshui, I Ching and TCM wisdom integrated AI agent skill
...
- **Tags:** `gongwen`, `docx`, `document-processing`
...
- **Why use it:** Cross-platform skill for session continuity memory between agents
...
- **Tags:** `codex`, `skill`, `code-simplification`
- **Why use it:** Code simplification skill adapted from DeepSeek Harness for Codex
...
- **Why use it:** QA engineering skill framework with 10 skills and shared knowledge base
...
- **Tags:** `design`, `skills`, `ui`, `web-design`
- **Why use it:** 6 design style presets to avoid generic AI-generated look in websites
...
- **Tags:** `media`, `vision`, `skills`, `image-generation`
- **Why use it:** Free image reading and generation with auto vision transcribing support
...
- **Tags:** `video`, `image`, `skills`, `directorx`
- **Why use it:** AI video/image/audio skills with configurable model tools for DSH
...
- **⭐ Stars:** 19
- **Language:** JavaScript
- **Description:** Godot Engine 4.x ���栈游戏开发技能插件 for DeepSeek Harness (DSH) — registers the godot-4-development skill at runtime
- **Tags:** `godot`, `game-development`, `gdscript`, `skills`
- **Why use it:** Godot Engine 4.x game dev skill registered at runtime in DSH
...
- **Why use it:** Swift Cycle governance skill for DSH — version-pinned, offline-verifiable, user-invoked.
...
- **Tags:** `skill`, `dsh-plugins`, `developer-tools`
- **Why use it:** Teaches AI agents to develop, build, test and install DSH plugins from scratch.
...
- **Why use it:** Migrates Claude Code/Codex/OpenCode configs — skills, hooks, permissions, MCP into DSH.
...
- **Tags:** `agent-preset`, `product-management`, `dsh`
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms directly within DSH, Claude Code, Cursor and more.
...
- **Why use it:** Open-source design system with local-first desktop, UI generator and Figma alternative.
...
- **Why use it:** Agent skill for beautiful architecture, sequence and data-flow diagrams as code.
...
- **Tags:** `image-generation`, `prompt-engineering`, `skills`, `dsh-plugin`
- **Why use it:** Industrial-grade image generation prompt engine with 530+ reverse-engineered cases.
...
- **Tags:** `design`, `ui`, `agent-team`, `vibedesign`, `figma`
...
- **Why use it:** End-to-end AI-generated Vox-style paper-collage explainer videos
...
- **Tags:** `design`, `ppt`
- **Why use it:** Native design studio with AI generation, visual editing and PPT support
...
- **Why use it:** Generate images directly within DeepSeek Harness chat conversations
...
- **Why use it:** Preview and edit .op design documents directly in conversations
...
- **Tags:** `legal`, `visualization`, `timeline`, `svg`
- **Why use it:** Legal litigation visualization toolkit: redraw messy cases into court-ready diagrams and timelines.
...
- **Why use it:** Enables pixel-to-text image reading for text-only models with OCR
...
- **Why use it:** Browser extension enhancing Gemini, Claude, ChatGPT with unified prompt management.
...
- **Tags:** `browser`, `agent`
- **Why use it:** Enables AI agents to use your real logged-in browser seamlessly
...
- **Why use it:** Powerful browser automation plugins leveraging Playwright for DeepSeek Harness integration.
...
- **Tags:** `dingtalk`, `ai-agent`, `communication`
...
- **Why use it:** Privacy-first open-source resume builder, customizable and self-hosted forever free.
...
- **Tags:** `image-uploader`, `electron`, `cloud-storage`, `dsh-plugin`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services, works with Obsidian and VS Code.
...
- **Why use it:** Ecosystem radar discovering and testing 15900+ candidate plugins
...
- **Why use it:** Tracks session and daily costs, budgets, and token usage history
...
- **Why use it:** Bridge Pi ecosystem to DSH with one ABI running unmodified extensions
...
- **Tags:** `migration`, `context`, `utilities`
- **Why use it:** Enables cross-preset session migration with state preservation
...
- **Why use it:** P2P encrypted multi-device remote access to Harness instances
...
- **Why use it:** Backup, restore, migrate and sync complete DSH configuration including plugins, MCP servers and skills.
...
- **Why use it:** Auto-upgrades plugins as DSH version advances
...
- **Why use it:** Local DSH manager with isolated containers and embedded WebView UI
...
- **Tags:** `skills-manager`, `utility`, `management`
...
- **Tags:** `mcp-server`, `skill-management`, `hot-reload`, `mcp`
- **Why use it:** Paste JSON to connect MCP servers with hot reload; auto-detects .skill files — no restart needed.
...
- **Tags:** `data-visualization`, `ai-cost`, `token-usage`, `deepseek-api`
- **Why use it:** Real-time token usage tracking, cost estimation, per-round charts and API balance monitoring.
...
- **Tags:** `plugin`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Diagnoses and resolves plugin conflicts and version issues.
...
- **Why use it:** Whale girl themed skin series for DeepSeek Harness.
...
- **Tags:** `theme`, `ui`, `deepseek-harness`
...
- **Tags:** `color-scheme`, `dark-mode`, `theme-engine`, `ui`
- **Why use it:** 34 classic opencode color schemes one-click applied, persist across restarts.
...
- **Tags:** `dsh-plugin`, `webui`, `deepseek-harness`
- **Why use it:** Custom wallpaper support with preset themes and real-time preview.
...
- **Tags:** `ai-agent`, `deepseek`, `prompt`, `vibecoding`
...
- **Why use it:** Curated comprehensive list of all DSH plugins and ecosystem tools
...
- **Why use it:** Curated ecosystem directory of plugins, tools, and infrastructure
...
- **Why use it:** Comprehensive curated DSH plugin directory with bilingual resources
...
- **Why use it:** Comprehensive AI knowledge encyclopedia and resource navigation hub
...
- **Why use it:** Daily-curated DSH plugin discovery with filtering and recommendations
...
- **Why use it:** Cross-source academic search with citation verification and graph
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiments, GPU
...
- **Why use it:** Comprehensive industry research methodology and policy tracking tools
...
- **Tags:** `agent-evaluation`, `rag-evaluation`, `llm-evaluation`, `prompt-testing`
...
- **Why use it:** Curated quality-checked plugin list for DSH 2026 discovery.
...
- **Why use it:** 24 verified stock/finance/quant plugins for DSH users.
...
- **Why use it:** Complete 1000+ plugin catalog sorted by stars on GitHub.
...
- **Why use it:** Plugin documentation and navigation by scenario with risk info.
...
- **Why use it:** Auto-crawled daily updated bilingual plugin directory.
...
- **Tags:** `dsh-plugin`, `plugin-portal`, `web`
- **Why use it:** Static web portal for filtering and installing 227+ plugins.
...
- **Why use it:** Curated plugin repository for DSH ecosystem discovery
...
- **Why use it:** Search npm and awesome-lists directly inside DSH agents
...
- **Why use it:** Community-curated DSH plugin directory
...
- **Tags:** `awesome-list`, `auto-updating`, `bilingual`
...
- **Tags:** `coding-agents`, `plugin-directory`, `curated-list`
...
- **Why use it:** Armor-breaking plugin for DeepSeek, enables unlimited generation
...
- **Why use it:** Learn DSH principles, plugin marketplace and best practices guide
...
- **Why use it:** Curated list of plugins, skills, MCP servers and UIs for DSH
...
- **Why use it:** Plugin marketplace with 11,000+ plugins, search and free public API
...
- **Tags:** `catalog`, `directory`, `plugin-catalog`
- **Why use it:** Plugin catalog with 1958 repos, bilingual search and classification
...
- **Why use it:** Conversational anime search with Bangumi ratings and magnet links
...
- **Tags:** `awesome-list`, `meta`, `community`
...
- **Why use it:** Community-maintained auto-sync catalog of DSH plugins with curated selections every 4 hours.
...
- **Tags:** `awesome-list`, `community`, `plugin-directory`
- **Why use it:** Unofficial community-curated catalog of DeepSeek Harness plugins and resources.
...
- **Why use it:** Curated list of DeepSeek Harness plugins — well-organized and community-driven.
...
- **Why use it:** Public GitHub directory with install commands and ecosystem discovery for DSH plugins.
...
- **Tags:** `awesome-list`, `mcp`, `skills`, `ai-agents`
- **Why use it:** Comprehensive curated list: plugins, tools, skills, MCP resources for the DSH ecosystem.
...
- **Tags:** `awesome-list`, `verified-plugins`, `dsh-plugin`
- **Why use it:** Evidence-led verified plugin directory with permission-aware installation guidance.
...
- **Why use it:** Repository moved to new URL, see redirect notice

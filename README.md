...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,098,344 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 236,722 | Core DSH framework — everything is a plugin. Essen |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,174 | Open-source design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,319 | Multi-agent swarm orchestrator with autonomous wor |
...
- **Why use it:** Core DSH framework — everything is a plugin. Essential starting point.
...
- **Why use it:** Self-evolving multi-agent harness with memory, tool use, and multi-model support.
...
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for long runs.
...
- **Why use it:** Unified agent workspace with cross-device task boards and API access
...
- **Why use it:** Runtime injector and task-aware reasoning router for DSH agent orchestration
...
- **Why use it:** Enterprise multi-agent workbench supporting Codex, DeepSeek and OpenClaw
...
- **Why use it:** Self-improving agent OS with evaluation-gated evolution and MCP support
...
- **Tags:** `agent-control-plane`, `multi-agent`, `long-horizon`
- **Why use it:** Control plane with durable state for long-horizon multi-agent orchestration
...
- **Why use it:** Two-phase preset: minimal bootstrap then full standard tooling setup
...
- **Why use it:** World's first virtual terminal and filesystem sandbox for AI agents
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `security`
...
- **⭐ Stars:** 78
- **Language:** TypeScript
- **Description:** ProMentor ��一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `mentor`, `coding`, `education`
- **Why use it:** AI coding mentor: project scanning, step-by-step guidance, code review
...
- **Why use it:** Integrates ChatGPT models via OAuth for seamless DSH usage.
...
- **Why use it:** Open-source design tool turning coding agents into designers. Local-first desktop.
...
- **Why use it:** Modern desktop client for DSH — treats the desktop itself as a plugin.
...
- **Tags:** `desktop`, `ui`
- **Why use it:** Official desktop client providing native DSH experience across platforms
...
- **Tags:** `web-ui`, `plugin-marketplace`
...
- **Why use it:** Open sidebar framework with built-in files, terminal, Git, and agent pages
...
- **Tags:** `tui`, `ui`, `status-bar`
- **Why use it:** TUI overlay with whale bar, streaming thoughts, and context progress display
...
- **Tags:** `floating-widget`, `deepseek-harness`
- **Why use it:** Cute whale widget tracks account balance with drag-able animations
...
- **Tags:** `desktop`, `agent-runtime`
- **Why use it:** Rust-powered agent runtime with polished desktop app interface
...
- **Tags:** `desktop`, `gui`, `ssh`, `codex`
- **Why use it:** Zero-setup desktop GUI for DSH with SSH, Codex, skills, and mobile access.
...
- **Tags:** `desktop`, `local-first`, `mcp`, `ui`
- **Why use it:** Local-first AI desktop workspace for DSH sessions, projects, and web research.
...
- **Tags:** `ui-components`, `charts`, `interactive`, `genui`
- **Why use it:** Generates interactive inline UI—charts, forms, quizzes—directly in replies.
...
- **Why use it:** Visual canvas-based session explorer with non-linear branching conversation.
...
- **Why use it:** Native iOS client bringing DSH workspaces and agent tracks to your iPhone
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review in pure Web UI
...
- **Why use it:** Smartisan-style notes app with Docker deployment and skill support.
...
- **Tags:** `desktop`, `workspace`, `plugin-system`
...
- **Tags:** `desktop`, `electron`, `hub`
- **Why use it:** Electron-based desktop hub for managing Harness/Plugins/MCP/Skills
...
- **Why use it:** Tauri-based bioinformatics desktop app for clinicians and scientists.
...
- **Why use it:** Replaces composer stats row with provider, model, and pricing info.
...
- **Why use it:** Customize DSH web background with presets
...
- **Why use it:** One-click compact context button for panel
...
- **Why use it:** Portable, local-first memory layer with Markdown-native cross-agent persistence
...
- **Why use it:** Lightweight memory library for building stateful, context-aware agents
...
- **Why use it:** Memory management kit enabling agents to remember and refine over time
...
- **Tags:** `docs`, `rag`, `deepwiki`
- **Why use it:** Generates accurate technical docs and AI-ready context instantly
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Milvus RAG
...
- **Tags:** `embedding`, `vector-search`, `skill-md`, `retrieval`
...
- **Tags:** `deepseek-harness`, `agent`
- **Why use it:** Local finance DB with multi-agent analysis and IM alerts
...
- **Tags:** `skill-distillation`, `meta-skill`, `agent-skills`
- **Why use it:** Distill agent thinking patterns into reusable skills for any bot or agent.
...
- **Why use it:** Best beginner tutorial for learning DSH plugin development from scratch
...
- **Why use it:** Largest skill marketplace with auto-categorized ready-to-install agent skills
...
- **Why use it:** Specialized long-form novel writing assistant solving AI hallucination issues
...
- **Why use it:** Vision bridge enabling text-only agents to process images via OCR to JSON
...
- **Why use it:** Modern flexible task board that embeds into Codex and DeepSeek Harness
...
- **Why use it:** Enables multi-agent team collaboration within DSH natively
...
- **Tags:** `ai-writing`, `novel`
- **Why use it:** Organized AI novel writing workflow with local and online model support
...
- **Tags:** `novel-writing`, `creative`, `workflows`, `drama`
- **Why use it:** Built-in workspaces for novel, short-drama, game script, and video recap writing.
...
- **Tags:** `deepseek-harness-plugin`, `office`, `dsh`
- **Why use it:** Adds full office suite capabilities to DSH with spreadsheets, docs, and slides
...
- **Why use it:** Gives agents vision and hearing with timestamped, verifiable evidence
...
- **Why use it:** 22 tools for live iOS Simulator control and USB iPhone automation inside chat
...
- **Tags:** `agent-skills`, `deepseek-harness`, `marketplace`
...
- **Why use it:** Turn experience into repeatable AI agent execution flows
...
- **Why use it:** Adds vision capability to Claude Code for screenshot and UI analysis.
...
- **Why use it:** AI infrastructure agent skills for writing, optimizing and debugging systems.
...
- **Why use it:** TDD, debugging, planning skills adapted from proven superpowers
...
- **Tags:** `skills`, `github-issues`, `productivity`
- **Why use it:** 25 pre-installed skills for 10x dev efficiency, GitHub issue support
...
- **Tags:** `document`, `government`, `workflow`
- **Why use it:** GB/T 9704 compliant government document processing suite
...
- **Why use it:** Unique Bazi/Fengshui/TCM knowledge agent with local deterministic engine.
...
- **Why use it:** Engineering discipline skill: grill requirements, test implementation.
...
- **Tags:** `math-modeling`, `datascience`, `skill`
- **Why use it:** Comprehensive math modeling skill pack: data preprocessing, plotting, paper writing.
...
- **Why use it:** Official DSH plugin development knowledge base as an on-demand agent skill.
...
- **Tags:** `spec-driven`, `ai-coding`, `skill`
...
- **Why use it:** Multi-agent orchestration with durable memory and skills across sessions.
...
- **⭐ Stars:** 36
- **Language:** Python
- **Description:** UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预设 + 33 篇模型库 + 论文模板/审稿脚��随包 + 进度可视化
- **Tags:** `math-modeling`, `multi-agent`, `competition`
- **Why use it:** 5-role multi-agent math modeling with 33 model templates and paper writing.
...
- **Why use it:** 11 QA skills with shared knowledge base for AI agents
...
- **Tags:** `skill`, `workflow`, `ai-collaboration`
- **Why use it:** Separates planning from execution for better AI collaboration
...
- **Why use it:** Official SkillHub Open API with DSH plugin integration
...
- **Tags:** `ai-video`, `ai-image`, `skills`
- **Why use it:** AI video/image/audio generation skills with vision tools
...
- **Tags:** `engineering-workflow`, `task-management`, `workflow`
- **Why use it:** Structured engineering workflow with task stages, verification and commit checks.
...
- **Why use it:** Web UI management tool for skills and MCP servers in DSH.
...
- **Why use it:** All-in-one browser extension for major AI platforms with cross-site prompt management
...
- **Why use it:** Seamless browser automation for agents with preserved logged-in sessions
...
- **Tags:** `content-discovery`, `browser`, `multi-platform`
- **Why use it:** Cross-platform content discovery agent covering Bilibili, YouTube, Reddit etc.
...
- **Why use it:** Vision toolkit for text-only models: image Q&A, OCR, UI restoration
...
- **Tags:** `web-search`, `free`, `browser`, `bridge`
...
- **Tags:** `anti-detect`, `playwright`, `browser-automation`, `mcp`
...
- **Why use it:** Privacy-first open-source resume builder. Self-hosted, customizable, free forever.
...
- **Why use it:** Ultimate image uploader supporting 60+ services, works with Obsidian and VS Code.
...
- **Tags:** `no-code`, `ai-agent`, `low-code`
- **Why use it:** AI-powered no-code platform for rapid business system building. Highly extensible.
...
- **Tags:** `proxy`, `api-keys`, `mcp`, `registry`
- **Why use it:** OpenRouter-style proxy registry for统一管理MCP工具和API密钥
...
- **Why use it:** Unified account management and smart routing across ChatGPT, Codex, Claude
...
- **Tags:** `cordis-plugin`, `context`
- **Why use it:** Context insight dashboard, browser and sidebar for DSH management
...
- **Why use it:** CLI and resolver for managing DSH Plugin Hub with open-source schemas.
...
- **Tags:** `security`, `vulnerability`, `redteam`, `code-audit`
- **Why use it:** Audits AI-generated code for hallucinated packages, vulnerabilities, and missing safeguards.
...
- **Tags:** `dsh-plugin`, `llm-provider`, `oauth`
- **Why use it:** Use ChatGPT, Claude, and Grok subscriptions as DSH LLM providers via OAuth
...
- **Tags:** `llm-provider`, `command-code`
...
- **Why use it:** Secure P2P remote access for multi-device Harness control
...
- **Tags:** `ai-agents`, `dsh-plugin`, `free-model`
- **Why use it:** Free unlimited access to frontier models without API keys
...
- **Tags:** `migration`, `automation`, `dsh-plugin`
- **Why use it:** Import conversations from 25+ AI agents as resumable sessions
...
- **Why use it:** Automatically upgrades plugins along with DSH version updates.
...
- **Why use it:** Full DSH config backup, restore, import/export and sync via WebDAV.
...
- **Why use it:** Unified tool/skill management with dynamic exposure control
...
- **Tags:** `skills`, `management`, `safety`
- **Why use it:** Unified local skill loading and safe management in DSH
...
- **Why use it:** Essential plugin management infrastructure with official repository support.
...
- **Why use it:** Audits token costs and detects conflicts in DSH context
...
- **Why use it:** One-click MCP/Skills/config sync for 7+ AI agent tools
...
- **Tags:** `containers`, `management`, `ui`
- **Why use it:** Container-based DSH management with embedded WebView UI
...
- **Tags:** `migration`, `tool`, `session-import`
- **Why use it:** Migration wizard for sessions/skills from 4 AI coding tools
...
- **Why use it:** Resolves plugin conflicts automatically
...
- **Why use it:** Animated pixel-art pet mascots that bring personality to your coding agent
...
- **Tags:** `theme`, `deepseek-harness-plugin`, `glassmorphism`
- **Why use it:** Beautiful glassmorphism theme with fully customizable frosted glass effects
...
- **Why use it:** Stunning real-time ocean-themed animated background with adjustable waves
...
- **Why use it:** Comprehensive AI resource hub with tutorials on agents, RAG, prompts, and Vibe Coding.
...
- **Why use it:** Curated open-source list of DSH plugins, tools, and infrastructure
...
- **Why use it:** Brings Epistemic Loop methodology for rigorous scientific discovery to DSH.
...
- **Tags:** `academic`, `latex`, `arxiv`, `gpu-cluster`
...
- **Why use it:** Curated daily-updated plugin discovery tool filtering out fake tags
...
- **Why use it:** Comprehensive curated list covering plugins, skills, MCPs, and more for DSH
...
- **Why use it:** Cross-database academic search with citation graph and MeSH support for researchers
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Learn DSH principles, marketplace & best practices
...
- **Why use it:** 11000+ plugins marketplace with search and rankings
...
- **Tags:** `awesome-list`, `deepseek-harness`, `agent-runtime`
...
- **⭐ Stars:** 198
- **Language:** HTML
- **Description:** 🐋 DeepSeek Harness 插件总目�� · The catalog of DSH plugins：1958 个仓库 / 1819 个真插件（Skills · MCP · Tools · UI · Orchestration），中英文搜索、分类筛选、STAR 排序 → leenkcool.github.io
- **Tags:** `awesome-list`, `catalog`, `dsh-plugin`
- **Why use it:** Catalog of 1958 repos / 1819 real plugins with search & filters
...
- **Why use it:** DSH skill that searches, installs and verifies GitHub plugins
...
- **Why use it:** Complete industry research toolkit with company analysis and policy tracking.
...
- **Why use it:** Web search, content extraction, and integration discovery for agents
...
- **Why use it:** Search 65,600+ Chinese platform APIs across 20 major platforms
...
- **Why use it:** Patent infringement analysis with competitive reporting output
...
- **Tags:** `stock`, `quantitative`, `analysis`
- **Why use it:** 39 tools + 20 strategy skills for multi-market stock analysis
...
- **Why use it:** Comprehensive 1000+ plugin star-ranked catalog
...
- **Why use it:** Plugin guide with install and compatibility tips
...
- **Why use it:** Verified star-ranked community plugins list
...
- **Why use it:** AI-curated 190+ plugins in 12 categories hourly
...
- **Tags:** `curated`, `registry`
- **Why use it:** Curated registry for models, tools, sandboxes
...
- **Tags:** `automated`, `directory`
- **Why use it:** Daily automated GitHub Actions plugin directory
...
- **Why use it:** Search npm + curated list from inside agents
...
- **Why use it:** Curated meta-list of DSH plugins — essential discovery and reference resource
...
- **Why use it:** Daily-updated comprehensive plugin marketplace with pre-reviewed submissions
...
- **Tags:** `awesome-list`, `curated`, `bilingual`, `extensions`
- **Why use it:** Curated bilingual awesome list of DSH plugins, extensions, and integrations.
...
- **Tags:** `encyclopedia`, `knowledge-base`, `awesome-list`, `ai`
- **Why use it:** Comprehensive AI encyclopedia covering LLMs, agents, RAG, MLOps, and learning paths.
...
- **Why use it:** Bridge Pi extensions as native DSH plugins via ABI compat
...
- **Tags:** `awesome-list`, `official`, `cordis`
...
- **Why use it:** Curated collection of DSH plugins, extensions, tools and resources.
...
- **Tags:** `marketplace`, `ecosystem`, `community`
...
- **Tags:** `awesome-dsh-plugin`, `dsh`, `dsh-plugin`, `dsh-plugin-market`, `xiaomi-mimo`, `xiaomi-mimo-tts`
- **Why use it:** 给DSH接入免费的 Xiaomi MiMo TTS API，支持使用预置/自定义
...
- **Tags:** `deepseek`, `deepseek-harness`, `dsh-plugin`, `dsh-plugins`, `dsh-web`, `enhancement`, `keybindings`, `terminal`, `trace`
- **Why use it:** A curated collection of awesome plugins 
...
- **Tags:** `dsh-plugins`, `dsh-ecosystem`, `dsh-bundle`
- **Why use it:** DSH plugin repository with bundle and analytics support.
...
- **Why use it:** Redirected — moved to github.com/awesome-dsh-plugin/awesome-dsh-plugin.

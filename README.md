...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 927,812 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-01 01:10:14 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 206,479 | Core harness framework enabling all DSH plugin eco |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,073 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,018 | Deploy intelligent multi-agent swarms with autonom |
...
- **Why use it:** Core harness framework enabling all DSH plugin ecosystem functionality
...
- **Tags:** `ai-agent`, `deepseek`, `dsh-plugin`, `skills`
- **Why use it:** Multi-model, multi-channel super AI assistant with self-evolving memory
...
- **Tags:** `coding-agent`, `deepseek`, `dsh-plugin`, `tui`
...
- **Why use it:** Beginner-friendly DSH plugin development tutorial from scratch
...
- **Tags:** `loop-engineering`, `agent-control`, `codex`
- **Why use it:** Long-horizon control plane for durable multi-agent workflows
...
- **Why use it:** Enterprise local-first agent workbench with visual editor
...
- **Tags:** `code-review`, `static-analysis`, `agent-skills`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with severity labels
...
- **Why use it:** AI security offense & defense: audits AI-generated code for hallucinated packages and vulnerabilities.
...
- **Tags:** `ai-infra`, `skills`, `agent`
- **Why use it:** Specialized agent skills for AI infra development, optimization, and debugging.
...
- **Why use it:** Web UI tool for managing skills and MCP configurations in DSH.
...
- **Tags:** `ctf`, `reverse-engineering`, `pentest`, `security`
...
- **Tags:** `plugin-dev`, `agent-skills`, `tools`
- **Why use it:** Agent skill for developing DSH plugins: standards for services, events, tools and packaging
...
- **Tags:** `plugin-dev`, `agent-skills`, `utilities`
- **Why use it:** Agent skill to manage installed DSH plugins, slots, Typert remotes and credentials
...
- **Tags:** `agent-tools`, `plugin-selection`
- **Why use it:** Pre-flight plugin library check for agents, ensures predictable selection
...
- **Why use it:** OAuth integration to use ChatGPT Plus models directly inside DSH
...
- **Why use it:** In-agent plugin search tool bridging npm and curated awesome-lists.
...
- **Tags:** `dsh-plugin`, `desktop`, `deepseek-harness`
- **Why use it:** Modern desktop client purpose-built for the DeepSeek Harness ecosystem
...
- **Tags:** `web-ui`, `plugin-aggregation`, `dsh`
- **Why use it:** Web UI for DSH plugin ecosystem, everything-as-plugin model
...
- **Why use it:** Extensible sidebar with built-in terminal, file editor, and git views
...
- **Tags:** `taskboard`, `ui-extension`, `codex`
- **Why use it:** Modern embeddable task panel with flexible integration for Codex and DSH
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status, and streaming thought display
...
- **Tags:** `desktop`, `tauri`, `gui`
- **Why use it:** Lightweight 5MB Tauri desktop app with preset plugins, zero setup required
...
- **Tags:** `desktop-app`, `tauri`, `multi-model`, `mcp`
- **Why use it:** Local-first multi-model AI agent desktop app with self-evolving skills, open-source Claude Cowork alternative.
...
- **Why use it:** Visual non-linear conversation canvas with branching workspace for exploring multi-path dialogues.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client and plugin suite for DeepSeek Harness.
...
- **Why use it:** Zero-setup Windows desktop GUI with Codex, plugins, skills, SSH, and mobile remote access built in.
...
- **Tags:** `office`, `dsh-plugin`, `desktop`
- **Why use it:** Brings full office suite into DSH — spreadsheets, docs, slides
...
- **Why use it:** Electron desktop console for multi-tab management of Harness, plugins, and MCP
...
- **Why use it:** WorkBuddy-style skill picker UI for DSH composer integration
...
- **Why use it:** All-in-one DevOps desktop with DB, SSH, Docker, and AI tools.
...
- **Why use it:** Real-time token usage, cost charts, and API balance viewer.
...
- **Why use it:** Electron desktop wrapper for DSH with ModLens integration
...
- **Tags:** `ui`, `desktop-extension`
- **Why use it:** One-click compact context button enhancing DSH Web context meter UX.
...
- **Tags:** `agent-memory`, `dsh-plugin`, `self-evolving`, `agentic-rag`
...
- **Tags:** `dsh-plugin`, `rag`, `vector-search`, `knowledge-base`
- **Why use it:** Turn raw documents into queryable RAG, reasoning agent, and self-maintaining wiki
...
- **Tags:** `agent-memory`, `rag`, `markdown-native`
- **Why use it:** Portable local-first memory layer with cross-app evolution
...
- **Why use it:** Self-evolving memory with hybrid retrieval and token savings
...
- **Why use it:** Dedicated memory management kit with refinement capabilities for agents
...
- **Why use it:** Persistent memory layer backed by Milvus with hybrid semantic search
...
- **Why use it:** Personal AI agent and local memory hub for persistent cross-agent context
...
- **Tags:** `agent-memory`, `skill-md`, `vector-search`, `reranking`
...
- **Tags:** `notes`, `smartisan`, `docker`, `plugin`
- **Why use it:** Smartisan-style notes with Docker deployment, skill calls, and exports.
...
- **Tags:** `agentic-ai`, `multi-agent`, `dsh-plugin`, `mcp-server`
- **Why use it:** Deploy intelligent multi-agent swarms with autonomous workflow coordination
...
- **Tags:** `agent-skills`, `dsh-plugin`, `knowledge-distillation`
- **Why use it:** Distills expert thinking patterns into reusable skills for any agent
...
- **Tags:** `agent-workspace`, `multi-device`, `orchestration`
...
- **Tags:** `routing`, `agent-ops`, `cordis`
- **Why use it:** Task-aware reasoning router with proven P1 accuracy gains
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-evaluation`
- **Why use it:** Self-improving agent OS with grading loop for continuous growth
...
- **Tags:** `preset`, `dsh-plugin`, `llm-agent`
- **Why use it:** Two-phase DSH preset with Standard tools, 98/99 Project2 score
...
- **Tags:** `agent-skills`, `workflow`, `skill-routing`
- **Why use it:** Intelligent skill routing and workflow orchestration with proven benchmark gains
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `j-space`
...
- **Tags:** `video-generation`, `tts`, `agent-skill`
- **Why use it:** End-to-end Vox-style video generation from topic via TTS and automated editing
...
- **Tags:** `agent-teams`, `workflows`, `multi-agent`
- **Why use it:** Enables multi-agent team coordination within DeepSeek Harness
...
- **Tags:** `task-management`, `sqlite`, `workflow`
- **Why use it:** Native SQLite-backed taskboard with agent claim/review workflow and clean Web UI — no iframe needed.
...
- **Tags:** `creative-writing`, `dsh-plugin`, `skills`
- **Why use it:** Powerful creative writing skill for novels and short dramas
...
- **Tags:** `agent-review`, `self-evolution`, `dsh-plugin`
- **Why use it:** Enables composable, reviewable agent self-evolution modes
...
- **Tags:** `skills`, `multi-agent`, `cross-framework`
- **Why use it:** Cross-framework agent skills platform for repeatable execution
...
- **Why use it:** TDD, debugging, planning and collaboration skills adapted from obra/superpowers.
...
- **Why use it:** Superpowers skill port to Reasonix coding harness, extends agent capabilities
...
- **Tags:** `agent-skills`, `coding-agent`, `education`
...
- **Tags:** `agent-skills`, `spec-programming`, `dsh-plugin`
- **Why use it:** Portable spec-driven programming skill for DSH workflows
...
- **Why use it:** Enables text-only models to read images via OCR and vision skills
...
- **Why use it:** Plugin dev knowledge base as on-demand agent skill with EN/ZH docs
...
- **Why use it:** Reusable Codex skill to build and validate DSH/Cordis plugins
...
- **Tags:** `chinese-traditional-wisdom`, `skill`, `dsh-plugin`
- **Why use it:** Integrates Bazi, Fengshui, IChing and TCM into one AI agent skill
...
- **Why use it:** Full workflow Chinese official document tool per GB/T 9704 standard
...
- **Tags:** `multi-agent`, `team`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `deepseek-harness`, `swift-cycle`
- **Why use it:** Governance skill adapter for DSH with offline verification support.
...
- **Why use it:** Full-stack Godot 4.x development skill for DSH at runtime.
...
- **Tags:** `agent-preset`, `workflow`, `product-management`
- **Why use it:** Simulates a virtual product team (PM→Eng→QA) conversation flow
...
- **Why use it:** First vision plugin for text-only agents via structured OCR JSON
...
- **Why use it:** Bridges Pi extensions to DSH via ABI compatibility layer
...
- **Why use it:** MCP server with 65,600+ API docs from 20 Chinese open platforms, zero config
...
- **Why use it:** Hot-reload MCP server config with UI — no restart needed.
...
- **Tags:** `agent-skills`, `architecture-diagram`, `dsh-plugin`, `diagrams-as-code`
- **Why use it:** Generates beautiful architecture, sequence, and data-flow diagrams as code
...
- **Tags:** `ai-image-generation`, `dsh-plugin`, `prompt-engineering`, `skills`
- **Why use it:** Industrial-grade GPT-Image2 prompt engine with 530+ reverse-engineered cases
...
- **Tags:** `design`, `vector`, `fimga`, `vibedesign`
...
- **Why use it:** Vision toolkit for text-only models: image Q&A, OCR, and screenshot analysis
...
- **Why use it:** Native design studio for AI-generated visuals, templates, and PPT creation
...
- **Tags:** `image-generation`, `multi-model`, `seedream`
- **Why use it:** Generate images directly within DeepSeek Harness chats using multiple AI model backends.
...
- **Tags:** `design`, `ui-design`, `openpencil`, `ppt`
...
- **Why use it:** Legal litigation visualization: auto-generate timeline and case material diagrams
...
- **Why use it:** Enhancement suite for Gemini, Claude, ChatGPT browsers with prompt management
...
- **Tags:** `web-automation`, `content-discovery`, `bilibili`
- **Why use it:** Cross-platform content discovery agent across B站、抖音、YouTube等
...
- **Why use it:** Seamless logged-in browser control for AI agents without work interruption
...
- **Why use it:** Strongest free web search bridge for all models without native web access. No signup, no API needed.
...
- **Why use it:** 22 agent tools for live iOS Simulator and USB-connected iPhone automation directly inside DSH chats.
...
- **Why use it:** Official Tabbit browser automation plugin for DeepSeek Harness with Playwright support
...
- **Tags:** `communication`, `dingtalk`
- **Why use it:** DingTalk IM integration turning chats into tool-capable agent conversations.
...
- **Tags:** `dsh-plugin`, `mcp-server`, `self-hosted`, `typescript`
- **Why use it:** Privacy-focused, self-hosted resume builder with full customization
...
- **Tags:** `dsh-plugin`, `low-code`, `self-hosted`, `workflows`
...
- **Tags:** `virtual-filesystem`, `agent-tools`, `vfs`
- **Why use it:** Unified virtual filesystem enables seamless file operations across AI agents
...
- **Why use it:** One-click install and seamless model switching across major AI coding tools
...
- **Tags:** `marketplace`, `plugin-store`, `dsh`
- **Why use it:** Official plugin marketplace for browsing, searching, and one-click installing DSH plugins
...
- **Why use it:** Auto-discovers 15900+ candidate plugins with k8s-level validation pipeline
...
- **Why use it:** Context dashboard and browser for DSH insights, statistics, and management
...
- **Tags:** `armor-breaking`, `jailbreak`, `utility`
- **Why use it:** Armor-breaking plugin for DeepSeek with stable jailbreak capabilities
...
- **Tags:** `cost-tracking`, `dsh-plugin`, `utility`
- **Why use it:** Essential cost tracking with session/daily budget and history
...
- **Why use it:** Seamless cross-preset session migration preserving state and intent.
...
- **Tags:** `marketplace`, `plugin-marketplace`, `javascript`, `nodejs`
- **Why use it:** One-click browse, install, and update all DSH plugins from Web GUI.
...
- **Tags:** `backup`, `rollback`, `snapshot`, `windows`, `crash-recovery`
- **Why use it:** Crash rescue with undo, snapshots, and SAFE MODE for config recovery.
...
- **Tags:** `awesome`, `cordis`, `dsh-plugin`
...
- **Why use it:** Community plugin marketplace integrated into DSH Web GUI for easy install.
...
- **Why use it:** Backup and restore DSH config, plugins, MCP servers and skills via WebDAV sync
...
- **Why use it:** Plugin ecosystem infrastructure: browser panel for repo management, no patch needed
...
- **Tags:** `dsh-plugins`, `container`, `management`
...
- **Why use it:** Centralized safe loading and management of local agent skills
...
- **Why use it:** One-click MCP/Skills config sync across Claude, Codex, DSH and more
...
- **Tags:** `migration`, `configuration-migration`, `mcp`
- **Why use it:** Migrates Claude Code/Codex/OpenCode configs into DSH seamlessly.
...
- **Why use it:** Detects and resolves plugin conflicts between versions
...
- **Tags:** `marketplace`, `distribution`
- **Why use it:** DSH version of CodeX-style plugin marketplace for distribution
...
- **Why use it:** Public animated pet gallery for harness mascot customization
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness aesthetic customization
...
- **⭐ Stars:** 396
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂���、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `dsh-plugin`
- **Why use it:** Frosted glass theme with full customization for DSH web UI.
...
- **Tags:** `theme`, `skin`, `chrome-extension`
- **Why use it:** Stunning WebGPU ocean animated theme for DSH interface
...
- **Tags:** `theme`, `ui-customization`, `webui`
- **Why use it:** Web UI background personalization with presets and custom uploads
...
- **Tags:** `ai-resources`, `tutorials`, `prompt-library`
...
- **Tags:** `research`, `web-search`, `china-platforms`
...
- **Why use it:** Curated plugin catalog for navigating the DeepSeek Harness ecosystem
...
- **Tags:** `awesome-list`, `resources`, `research`
- **Why use it:** Curated list of DSH plugins, tools, MCP servers, and integrations
...
- **Tags:** `awesome-list`, `bilingual`, `research`
- **Why use it:** Bilingual curated list of DSH plugins, extensions, tools, and verified refs
...
- **Tags:** `knowledge-base`, `ai-resources`, `learning`
- **Why use it:** Comprehensive AI skills and resources encyclopedia covering agents, RAG, MLOps, and learning paths.
...
- **Why use it:** Daily-curated DSH plugin discovery with real plugin filtering, rankings, and scenario-based categorization.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `learning`
- **Why use it:** Great DSH learning guide and best practices resource
...
- **Why use it:** Comprehensive DSH guide with curated plugins and tools
...
- **Why use it:** Curated plugin catalog with visualization, coding and MCP resources
...
- **Tags:** `marketplace`, `dsh-plugin`, `directory`
- **Why use it:** Massive plugin marketplace with 11K+ plugins and search API
...
- **Tags:** `catalog`, `awesome-list`, `directory`
- **Why use it:** Large plugin catalog with multi-language search and ranking
...
- **Tags:** `academic-search`, `mcp`, `arxiv`, `pubmed`, `citation`
- **Why use it:** Cross-database academic search with citation verification and graphs.
...
- **Tags:** `arxiv`, `latex`, `paper-writing`, `gpu-cluster`, `ssh`
- **Why use it:** One-stop research workbench: LaTeX, arXiv, experiments, GPU SSH orchestration.
...
- **Tags:** `patent`, `rag`, `legal-tech`, `research`
- **Why use it:** Patent infringement analysis: input patent number, generate competitive reports
...
- **Tags:** `industry-research`, `research`, `dsh-plugin`
- **Why use it:** Domain pack for industry/company research with methodology skills
...
- **Why use it:** Curated list of DSH plugins for ecosystem discovery.
...
- **Why use it:** Curated awesome list of DSH plugins, tools, skills, and resources.
...
- **Why use it:** Evidence-led verified plugin directory with install guidance.
...
- **Tags:** `awesome-list`, `plugin-discovery`, `dsh`
- **Why use it:** Curated plugin list — best discovery resource for DSH
...
- **Tags:** `anime`, `bangumi`, `magnet`, `typescript`
...
- **Why use it:** Curated DSH plugin and tool resource list, essential ecosystem discovery hub
...
- **Why use it:** Bottom Info Bar — an information bar plugin for DeepSeek Harness: provider/model
...
- **Why use it:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏览器里管理技
...
- **Why use it:** Free image reading & generation for DeepSeek Harness (rc.7 / rc.8 / v0.1.1-rc.1 
...
- **Why use it:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决策矩阵（Claude 
...
- **Why use it:** OMK — Evidence-backed evaluation and observability for prompts, RAG, skills, age
...
- **Why use it:** Curated quality-checked DSH plugin list for 2026
...
- **Why use it:** Finance/quant plugin vertical curated list, bilingual
...
- **Why use it:** Star-ranked verified community DSH plugin directory
...
- **Why use it:** Plugin product manual and navigation by scenario with risk info
...
- **Why use it:** Zero-dependency static portal to discover, filter and install plugins
...
- **Why use it:** Full 1000+ plugin directory sorted by stars from GitHub topic dsh-plugin
...
- **Tags:** `awesome-list`, `collection`
- **Why use it:** General curated DSH plugins resource list
...
- **Why use it:** Curated plugin radar with evidence-backed listings for DSH ecosystem discovery.
...
- **Why use it:** Bilingual reviewed plugin directory with immutable commit verification.
...
- **Why use it:** Auto-updating daily crawler for DSH plugin discovery via GitHub Actions.
...
- **Why use it:** AI-curated 190+ plugin directory with 12 categories updated hourly.
...
- **Tags:** `awesome-list`, `verified`
- **Why use it:** 80+ verified plugins organized by functionality for quick reference.
...
- **Why use it:** Redirect to canonical awesome-dsh-plugin repository.
...
- **Tags:** `awesome-list`, `auto-update`
- **Why use it:** Data-driven auto-updating plugin list with bilingual README and Vercel deployment.
...
- **Why use it:** Comprehensive curated guide covering models, tools, sandboxes, and UI plugins.
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Evidence-aware shortlist of useful DSH plugins for practical use.
...
- **Description:** DSH插件
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Simple DSH plugin directory for basic plugin discovery.

...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 1,001,173 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-10 23:04:05 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 219,094 | Core framework enabling everything is a plugin arc |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,410 | Open-source Claude Design alternative for local-fi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,978 | Deploy multi-agent swarms with autonomous coordina |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 27 plugins
- [Themes & Skins](#themes-&-skins) — 3 plugins
- [Research & Analysis](#research-&-analysis) — 27 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (27)
- [Themes & Skins](themes-skins) (3)
- [Research & Analysis](research-analysis) (27)
- [Other](other) (21)
---
...
- **Why use it:** Core framework enabling everything is a plugin architecture
...
- **Tags:** `multi-agent`, `mcp`, `skills`, `self-evolving`
...
- **Tags:** `coding-agent`, `terminal`, `tui`, `tool-use`, `prompt-caching`
...
- **Why use it:** Unified multi-device agent workspace with task boards, accessible anywhere via desktop or API
...
- **Tags:** `agent-os`, `evaluation`
- **Why use it:** Self-improving agent OS with interview-gated evaluation, staged upgrades, and budgeted loops
...
- **Why use it:** Enterprise multi-engine agent workbench with unified workspace for Codex, DSH, and Hermes
...
- **Why use it:** Vision bridge enabling text-only agents to process images via structured JSON OCR output.
...
- **Why use it:** Virtual terminal with VFS gives agents isolated, replayable command environments.
...
- **Tags:** `runtime`, `desktop`, `agent`, `dsh-plugin`
- **Why use it:** Rust-based high-performance agent runtime paired with polished desktop AI coding environment.
...
- **Why use it:** Coding agent with RPC plugin architecture, sub-agents, hashline edits, and MCP integration for development.
...
- **Why use it:** Native SQLite-backed task management with Agent claim/review and pure Web UI.
...
- **Tags:** `ai-infra`, `coding`, `optimization`, `debugging`, `skills`
- **Why use it:** Specialized skills for writing, optimizing and debugging high-performance AI infrastructure
...
- **Tags:** `codex`, `deepseek-harness`, `mcp`, `sync`
- **Why use it:** Two-way Codex-DSH sync with auto MCP mirroring
...
- **Tags:** `dsh-plugin`, `development`, `skill`
- **Why use it:** Guide agents to build, test, and install DSH plugins
...
- **Tags:** `plugin-dev`, `agent-skill`, `adapter`
- **Why use it:** Agent skill for developing DSH plugins and adapters
...
- **Why use it:** Modern desktop client for DSH where the desktop itself is a plugin
...
- **Tags:** `web-ui`, `plugin-aggregator`
- **Why use it:** Web-based plugin aggregation ecosystem — browse and discover plugins through an intuitive UI
...
- **Tags:** `ui`, `pets`, `aesthetic`
- **Why use it:** Adorable animated pet gallery that adds personality and charm to any AI coding harness UI
...
- **Why use it:** Open sidebar framework with built-in file editor, terminal, chat, Git, and sub-agent pages.
...
- **Tags:** `taskboard`, `ui`, `skills`, `dsh-plugin`
- **Why use it:** Modern flexible task board embeddable in Codex and DSH with rich agent task management.
...
- **Tags:** `tui`, `ui`, `terminal`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with whale header, streaming thoughts, rollback, and TPS monitoring.
...
- **Tags:** `widget`, `ui`, `utility`, `dsh-plugin`
...
- **Why use it:** Zero-setup Tauri desktop with preset plugins for DSH
...
- **Tags:** `desktop-app`, `electron`, `mcp`, `agentic-workflows`
- **Why use it:** Local-first desktop workspace integrating DSH sessions, projects, and Office automation seamlessly.
...
- **Tags:** `desktop-app`, `windows`, `ssh-client`, `gui`
- **Why use it:** Zero-setup Windows desktop GUI with Codex, SSH, mobile remote access, and plugin system built in.
...
- **Tags:** `canvas`, `workspace`, `non-linear`, `conversation`
...
- **Why use it:** Local-first open-source desktop AI agent with multi-model support, self-evolving skills, and privacy focus.
...
- **Why use it:** Brings full office suite — spreadsheets, docs, slides, canvases into Harness.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with integrated plugin suite.
...
- **Why use it:** Native iOS client with WebSocket connection bringing Harness workspace to iPhone.
...
- **Tags:** `notes`, `desktop`, `docker`, `smartisan`, `ui`
- **Why use it:** Open-source Smartisan-style notes with Docker deploy, WeChat export and skill support
...
- **Why use it:** Clean web UI for managing skills and MCP servers
...
- **Tags:** `mcp`, `ui`, `control`
- **Why use it:** Unified menu to control MCP/skill exposure levels
...
- **Why use it:** Persistent info bar showing provider, balance, and pricing at a glance
...
- **Tags:** `dsh-plugin`, `ui`
- **Why use it:** WorkBuddy-style skill picker improves composer UX significantly
...
- **Why use it:** Desktop bioinformatics agent for clinicians with offline mode and skill store
...
- **Why use it:** All-in-one DevOps desktop: DB, SSH, Docker, AI sandbox
...
- **Tags:** `tts`, `voice`, `xiaomi`
- **Why use it:** Free Xiaomi MiMo TTS integration with custom voice support
...
- **Tags:** `webui`, `theme`, `customization`
- **Why use it:** Web UI background personalization with preset atmospheres
...
- **Why use it:** Adds a compact mode button to improve context meter panel usability.
...
- **Tags:** `rag`, `knowledge-base`, `semantic-search`, `vector-search`
- **Why use it:** Open-source LLM knowledge platform turning documents into RAG and wiki
...
- **Why use it:** Portable, local-first memory layer enabling cross-app persistence and user-owned data
...
- **Why use it:** Self-evolving memory OS with hybrid retrieval and 35% token savings for persistent agents
...
- **Why use it:** Essential memory library for building persistent, stateful AI agents with context continuity
...
- **Why use it:** Dedicated memory management kit with refine-and-remember loops for persistent agent context.
...
- **Why use it:** Persistent unified memory layer for all agents backed by Markdown and Milvus hybrid search.
...
- **Why use it:** Shared persistent memory hub for all AI agents
...
- **Why use it:** Best context management with dashboard and sidebar UI
...
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready corpora
...
- **Why use it:** Deploy multi-agent swarms with autonomous coordination workflows
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `meta-skill`, `digital-human`
...
- **Why use it:** Largest skill marketplace with auto-scraped GitHub skills, organized by category and popularity
...
- **Tags:** `agent-control`, `workflow`
- **Why use it:** Long-horizon agent control plane enabling durable, governed workflows across multiple harnesses
...
- **Tags:** `preset`, `workflow`, `dsh-plugin`, `agent`
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for reliable agent onboarding.
...
- **Tags:** `cognitive`, `skills`, `agent`, `dsh-plugin`
- **Why use it:** Cognitive-enhancement skills based on J-space global workspace research for smarter agents.
...
- **Tags:** `skill`, `chinese-web`, `research`
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day insights
...
- **Tags:** `agent-teams`, `multi-agent`, `plugin`
- **Why use it:** Enables multi-agent team coordination within DSH
...
- **Why use it:** Vision toolkit for text-only models — OCR and image Q&A
...
- **Why use it:** Complete novel writing workflow — characters, worldbuilding, review
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `agent-skill`
- **Why use it:** Grants agents visual and auditory perception — video, audio, screen analysis with timestamped verifiable output.
...
- **Why use it:** Creative writing AI skill for novels and short dramas with integrated Oh Story engine.
...
- **Tags:** `agent-skills`, `plan-mode`, `prompt-engineering`, `agent-review`
- **Why use it:** Enables composable, reviewable agent workflows supporting self-evolution goals
...
- **Tags:** `agent-skills`, `coding`, `architecture`, `multi-platform`
- **Why use it:** Turns experience into repeatable agent execution across multiple AI platforms
...
- **Tags:** `vision`, `multimodal`, `claude-code`, `frontend-analysis`
...
- **Tags:** `reverse-engineering`, `ctf`, `pentest`, `security`, `agent-skills`
- **Why use it:** Complete reverse engineering skill set (87 SKILL.md) for CTF, pentesting and security research
...
- **Why use it:** Turns successful sessions into reusable agent skills
...
- **Tags:** `skill`, `superpowers`, `coding`
- **Why use it:** Brings proven superpowers skills to DSH agents
...
- **Tags:** `skill`, `tdd`, `debugging`
- **Why use it:** TDD, debugging, planning skills for DSH agents
...
- **Tags:** `finance`, `backtesting`, `agent`
- **Why use it:** Compliance-first AI investment desk with backtesting
...
- **Tags:** `skill`, `mentor`, `coding`
- **Why use it:** AI coding mentor that guides you through architecture
...
- **Tags:** `skills`, `productivity`, `deck`
- **Why use it:** 25 pre-installed engineering skills with right-panel quick access
...
- **Why use it:** Full workflow for Chinese official document formatting and validation
...
- **Tags:** `skills`, `management`, `utility`
- **Why use it:** Centralized loading and safe management of local Agent Skills
...
- **Why use it:** Official plugin dev knowledge base as installable on-demand skill
...
- **Tags:** `plugin-dev`, `tooling`, `validator`
...
- **Tags:** `ai-agent`, `chinese-traditional-wisdom`, `dsh-plugin`
- **Why use it:** Unique fusion of bazi/fengshui/TCM into a local deterministic engine
...
- **Why use it:** Enables multi-agent collaboration with shared workspace and independent contexts
...
- **Tags:** `ai-agents`, `dsh-plugin`, `code-simplification`
- **Why use it:** Adapts DSH code simplification skill for broader agent use
...
- **Tags:** `ai-video`, `dsh-plugin`, `directorx`
- **Why use it:** AI video/image/audio skills with configurable vision and corpus tools
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-driven test automation
...
- **Why use it:** Cross-platform session memory enables smooth agent handoff continuity
...
- **Tags:** `ai-roleplay`, `agent-skills`, `dsh-plugin`
- **Why use it:** Advanced NPC roleplay skill with memory, YAML save, and rich素材库
...
- **Tags:** `engineering-discipline`, `quality-gate`, `dsh-plugin`
- **Why use it:** Engineering discipline quality gate: grill requirements before shipping
...
- **Why use it:** Official SkillHub Open API docs and DSH plugin
...
- **Why use it:** Full-stack Godot 4.x dev skill for DSH agents
...
- **Tags:** `video`, `remotion`, `motion-design`, `agent-skills`
- **Why use it:** Cinematic video agent skill with 152 shot templates
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin-bundle`
- **Why use it:** Plugin marketplace similar to CodeX, expands DSH agent capabilities.
...
- **Why use it:** Pre-flight plugin check boosts agent tool discoverability and reliability.
...
- **Why use it:** Browser-based skills and MCP server management UI
...
- **Tags:** `design-systems`, `ui-generator`, `vibe-coding`, `figma-alternative`
- **Why use it:** Open-source Claude Design alternative for local-first UI prototyping
...
- **Tags:** `architecture-diagram`, `diagrams-as-code`, `mermaid-alternative`, `sequence-diagram`
...
- **Tags:** `image-generation`, `prompt-engineering`, `skills`, `workflow-automation`
...
- **Why use it:** Open-source AI-native vector design tool with concurrent agent teams turning prompts into UI
...
- **Tags:** `design`, `ppt`, `template`
- **Why use it:** Editable design system with template marketplace for PPT
...
- **Tags:** `gui`, `visualization`, `forms`, `charts`
- **Why use it:** Generates interactive inline UI components — charts, plots, forms, quizzes — rendered directly in replies.
...
- **Why use it:** Transforms legal documents into court-ready diagrams and timelines
...
- **Tags:** `design`, `ui`, `vibe-coding`, `design-system`
...
- **Why use it:** Image reading and generation with auto vision transcoding
...
- **⭐ Stars:** 3,278
- **Language:** Python
- **Description:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动�� B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `automation`, `cross-platform`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent covering Bilibili, YouTube, Xiaohongshu and more.
...
- **Why use it:** Real browser automation for AI agents without interruption
...
- **Tags:** `web-search`, `free`, `no-api-key`, `universal`
- **Why use it:** Free no-signup web search bridge enabling any model without native web access to search the internet.
...
- **Tags:** `ios`, `mobile-automation`, `webdriveragent`, `xcode`
- **Why use it:** 22 tools for iOS Simulator and USB iPhone control directly from Harness conversations.
...
- **Why use it:** Connect ChatGPT accounts via OAuth to use their models inside DSH.
...
- **Why use it:** DingTalk IM channel turns chats into tool-capable agent conversations.
...
- **Why use it:** Privacy-first open-source resume builder with MCP server integration
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services for creators
...
- **Tags:** `low-code`, `no-code`, `internal-tools`, `crm`, `erp`
- **Why use it:** AI-powered no-code platform for building business systems and internal tools
...
- **Why use it:** Runtime injector with task-aware reasoning-mode routing for optimal DSH agent performance
...
- **Tags:** `marketplace`, `plugin-management`, `dsh-plugin`
- **Why use it:** In-app marketplace for browsing, searching, and one-click installing DSH plugins.
...
- **Tags:** `tool-switcher`, `installer`, `multi-agent`, `dsh-plugin`
- **Why use it:** One-click manager to install and switch between Claude Code, Codex, DSH, and other agents.
...
- **Tags:** `radar`, `ecosystem`, `discovery`
- **Why use it:** Open-source plugin radar discovering 15K+ candidates
...
- **Why use it:** Curated plugin list — essential DSH ecosystem index
...
- **Why use it:** Plugin ecosystem curated list — good entry point for DSH
...
- **Tags:** `security`, `redteam`, `vulnerability`, `code-audit`
- **Why use it:** Audits AI-generated code for hallucinated packages, missing safeguards, and vulnerability patterns.
...
- **Tags:** `subscription`, `oauth`, `llm-provider`, `cost-saving`
- **Why use it:** Leverages ChatGPT/Claude/Grok subscription OAuth as LLM providers — no API keys needed for DSH access.
...
- **Why use it:** Open-source CLI and schemas for DSH Plugin Hub management and resolver tooling.
...
- **⭐ Stars:** 194
- **Language:** HTML
- **Description:** 🐋 DeepSeek Harness 插件总目录 · The catalog of DSH plugins：1958 个仓库 / 1819 个真插件（Skills · MCP · Tools · UI · Orchestration），中英��搜索、分类筛选、STAR 排序 → leenkcool.github.io
- **Tags:** `catalog`, `plugin-marketplace`, `directory`, `awesome-list`
- **Why use it:** Complete DSH plugin catalog with 1819 verified plugins and smart filtering
...
- **Tags:** `llm-provider`, `typescript`, `model-picker`, `image-input`
- **Why use it:** LLM provider plugin with live model catalog, plan-aware picker and image input
...
- **Tags:** `compatibility-layer`, `migration`, `plugin-migration`, `ecosystem`
- **Why use it:** Bridges Pi and DSH ecosystems running Pi extensions as native DSH plugins
...
- **Tags:** `plugin-discovery`, `automation`, `install`, `verify`
- **Why use it:** Discovers, installs and verifies GitHub plugins automatically for DSH users
...
- **Tags:** `awesome-list`, `catalog`, `plugin-discovery`, `reference`
- **Why use it:** Curated awesome-list of DeepSeek Harness plugins for quick discovery and reference
...
- **Tags:** `plugin`, `upgrade`, `utility`
- **Why use it:** Essential for keeping DSH plugins updated automatically
...
- **Tags:** `plugin-management`, `infrastructure`, `utilities`
- **Why use it:** Official plugin management console + scaffold for DSH ecosystem
...
- **Tags:** `ocr`, `vision`, `utility`
- **Why use it:** Pixel-to-text OCR tools enabling vision for text-only LLMs
...
- **Tags:** `context`, `dsh-plugin`, `tool`, `ui`
- **Why use it:** Audits context tokens, detects duplicates and conflicts in AGENTS.md
...
- **Why use it:** Run multiple DSH versions in isolated containers with WebView UI
...
- **⭐ Stars:** 29
- **Language:** TypeScript
- **Description:** 一键配置各类 AI Agent 工具的 MCP、Skills 和规���；支持 Claude Code、Codex、DeepSeek Harness、OpenCode、Cursor、Gemini CLI、Qwen Code 等。 One-click local setup for MCP servers, skills, and rules across AI coding agents.
- **Tags:** `mcp`, `config-sync`, `dsh-plugin`
- **Why use it:** One-click config sync for MCP, skills across 7+ AI agent platforms
...
- **Tags:** `data-visualization`, `token-usage`
- **Why use it:** Real-time token usage and cost tracking for DeepSeek API
...
- **Tags:** `plugin-health`, `conflict-resolution`
...
- **Tags:** `skin`, `theme`, `desktop`
- **Why use it:** Whale Girl skin series — visually appealing DSH theming
...
- **Tags:** `theme`, `ui`, `glassmorphism`, `customizable`
- **Why use it:** Frosted glass theme with full customization for toolbar, sidebar, inputs, and background wallpaper effects.
...
- **Tags:** `theme`, `ocean`, `webgpu`, `threejs`
- **Why use it:** WebGPU ocean-themed skin providing immersive animated background visuals inside the DSH web interface.
...
- **Tags:** `ai-resources`, `tutorials`, `prompts`
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and knowledge base for LLM users
...
- **Why use it:** Beginner-friendly tutorial series for mastering DeepSeek Harness engineering from scratch
...
- **Why use it:** Curated bilingual plugin directory covering agents, tools, skills, and integrations for DSH ecosystem.
...
- **Tags:** `knowledge-base`, `encyclopedia`, `rAG`, `learning`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, multimodal tools, MLOps, and curated learning roadmaps.
...
- **Tags:** `arxiv`, `latex`, `research`, `gpu-cluster`
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiment tracking, GPU SSH orchestration.
...
- **Tags:** `mcp`, `academic-search`, `citation-management`, `research-workflow`
- **Why use it:** Multi-source academic search with citation graph and verification for Chinese researchers
...
- **Tags:** `financial-data`, `tushare`, `multi-agent`, `mcp`, `stock-analysis`
- **Why use it:** Tushare-based local financial DB with multi-agent analysis and IM alert integration
...
- **Tags:** `handbook`, `documentation`, `agent-runtime`, `troubleshooting`
- **Why use it:** Authoritative agent-first handbook with 173 source-backed runtime docs and troubleshooting
...
- **Tags:** `agent-skills`, `research`, `marketing`, `deep-research`, `fact-checking`
- **Why use it:** 88 installable agent skills for research, marketing automation and business intelligence
...
- **Tags:** `list`, `awesome`, `catalog`
- **Why use it:** Official curated plugin catalog by cordis.run
...
- **Tags:** `list`, `awesome`, `resources`
- **Why use it:** Meticulously curated DSH plugin resource list
...
- **Why use it:** Industry chain mapping and policy tracking skills
...
- **Why use it:** Auto-syncing plugin community catalog updated hourly
...
- **Why use it:** Searches 65k+ API docs from 20 Chinese platforms with zero config
...
- **Why use it:** Produces patent infringement analysis reports with multi-agent support
...
- **Tags:** `kline`, `trading`, `dsh-plugin`
- **Why use it:** Interactive K-line analysis with multi-market data and technical indicators
...
- **Tags:** `evaluation`, `rag`, `prompt-engineering`, `agent-evaluation`
- **Why use it:** Evidence-backed eval framework for prompts, RAG, agents
...
- **Why use it:** Spam-filtered curated registry of DSH plugins and skills
...
- **Why use it:** Comprehensive curated awesome list covering all DSH resources
...
- **Why use it:** Evidence-led verified plugin directory with permission guidance
...
- **Why use it:** 2026 updated curated list with quality checks
...
- **Tags:** `finance`, `stock`, `niche`
- **Why use it:** Niche curated stock/finance plugin list, bilingual verified
...
- **Why use it:** Star-ranked verified community plugins list
...
- **Why use it:** Plugin manual and navigation by scenario with risk info
...
- **Tags:** `awesome-list`, `comprehensive`
...
- **Why use it:** Curated plugin catalog — the best starting point to discover quality DSH ecosystem tools
...
- **Tags:** `plugin-shop`, `marketplace`, `curation`
- **Why use it:** Daily-updated plugin marketplace with cross-source collection and pre-publication review quality control.
...
- **Tags:** `awesome-list`, `plugin-catalog`, `discovery`
- **Why use it:** Curated plugin directory with daily GitHub scraping and real plugin verification.
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, curated plugins and toolkits.
...
- **Why use it:** Learn DSH principles, browse plugin marketplace and discover best practices.
...
- **Why use it:** Curated list of plugins, skills, MCP servers, patches and orchestrators for DSH.
...
- **Why use it:** Plugin marketplace with 11,000+ entries, search, rankings, and public API access.
...
- **Why use it:** Unofficial community plugin catalog for DSH ecosystem
...
- **Why use it:** Curated list of selected DSH ecosystem plugins
...
- **Why use it:** Curated collection of DSHA plugins for quick reference.
...
- **Tags:** `awesome-list`, `ai-agent`, `2origin`
...
- **Tags:** `plugin-recommender`, `awesome-list`, `mcp`
...
- **Tags:** `dsh-bundle`, `dsh-plugin-verify`
- **Why use it:** DSH plugin repository with bundle and verification features.
...
- **Why use it:** Moved repository — legacy awesome list for DSH plugins.
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated plugin shortlist, not a plugin itself

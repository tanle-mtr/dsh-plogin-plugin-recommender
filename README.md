...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 860,952 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 09:44:26 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 193,805 | Core harness platform for DSH plugin ecosystem |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,259 | Open-source design tool with AI-powered UI generat |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,338 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Versatile AI assistant with memory and multi-model support
...
- **Why use it:** Terminal-native coding agent with prompt caching for stability
...
- **Tags:** `agent-runtime`, `desktop`, `coding`
...
- **Tags:** `coding-agents`, `agent-skills`, `dsh-plugin`
- **Why use it:** Architecture-aware coding with drift detection and safety
...
- **Tags:** `vision`, `agent-skills`, `ocr`, `dsh-plugin`
- **Why use it:** Powerful vision tools for text-only AI coding agents
...
- **Tags:** `context-migration`, `preset`, `session`
...
- **Why use it:** Build and test Android apps via live emulator or USB device stream.
...
- **Tags:** `dsh-plugin`, `agent-skills`, `plugin-dev`
- **Why use it:** Agent skill for standard DSH plugin development workflow
...
- **Why use it:** Agent skill for managing DSH plugin slots and credentials
...
- **Tags:** `coding-agent`, `code-simplification`, `codex`
- **Why use it:** Codex skill adapted from DSH for automated code simplification and refactoring.
...
- **Why use it:** Bidirectional bridge syncing chats, skills, and MCPs between OpenAI Codex and DSH.
...
- **Why use it:** Audit and optimize DSH context injection with token cost analysis and conflict detection.
...
- **Tags:** `plugin-development`, `documentation`
- **Why use it:** DSH plugin dev pitfalls archive with real-world solutions.
...
- **Why use it:** Engineering discipline distilled from DSH: fact-finding, durable decisions.
...
- **Why use it:** Fast Neovim plugin manager written in Lua — elegant and simple.
...
- **Tags:** `deepseek-harness`, `migration`, `agent-migration`, `mcp`
- **Why use it:** Migrate Claude Code/Codex/OpenCode configs and skills into DSH seamlessly.
...
- **Tags:** `plugin-tools`, `conflict-resolution`
- **Why use it:** Detects and resolves plugin conflicts automatically
...
- **Why use it:** Modern desktop client built specifically for DSH ecosystem
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thoughts, and rollback
...
- **Tags:** `tauri`, `desktop`, `dsh-plugin`
- **Why use it:** Lightweight 5mb desktop app, zero setup, multi-platform
...
- **Why use it:** Animated desktop pet companion with plugin SDK
...
- **Why use it:** Cute whale widget monitoring DeepSeek balance in DSH
...
- **Tags:** `desktop`, `electron`, `mcp`, `dsh-plugin`
- **Why use it:** Local-first DSH desktop workspace for projects and files
...
- **Why use it:** Visual non-linear conversation canvas with session explorer and branching workspace
...
- **Why use it:** Full-featured Windows desktop GUI client
...
- **Why use it:** Browse, install, and update all DSH plugins directly from the Web GUI.
...
- **Tags:** `desktop-app`, `electron`, `dsh-plugins`
- **Why use it:** Desktop Electron app for multi-tab Harness/plugin/MCP management
...
- **Tags:** `deepseek-harness`, `desktop`, `dsh-plugins`
- **Why use it:** Local container-based DSH manager with embedded WebView UI
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer for quick selection.
...
- **Tags:** `dsh-plugin`, `menu`, `mcp`, `skills`
- **Why use it:** Unified menu to manage MCP tools and skills exposure levels and execution modes.
...
- **Tags:** `dsh-plugin`, `skills`, `mcp`
- **Why use it:** Browser-based skills & MCP management card in DSH settings.
...
- **Why use it:** Persistent bottom bar showing provider, balance, and pricing.
...
- **Tags:** `deepseek-harness`, `data-visualization`, `token-usage`
- **Why use it:** Web plugin showing real-time token usage, cost charts, and API balance.
...
- **Tags:** `desktop`, `docker`, `ssh`, `deepseek-harness`
- **Why use it:** Cross-platform desktop app integrating DB, SSH/SFTP, Docker panels with AI.
...
- **Why use it:** Electron desktop shell for DSH web service with integrated sidebar tools.
...
- **Why use it:** Enterprise knowledge base with RAG and self-maintaining wiki
...
- **Why use it:** Persistent unified memory layer for all AI agents backed by Milvus
...
- **Why use it:** Unlimited memory for OpenClaw agents
...
- **Why use it:** Comprehensive AI knowledge encyclopedia covering agents, RAG, MLOps and more
...
- **Tags:** `agent-memory`, `embeddings`, `reranking`
- **Why use it:** Build retrieval-ready agent skill corpora
...
- **Why use it:** Durable, inspectable long-term agent memory with recall tools.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `memory`, `agent`
- **Why use it:** Connects DSH to PowerContext Server for memory, recall, and skill handoff.
...
- **Why use it:** Distills human thinking into reusable AI agent skills
...
- **Why use it:** Cognitive-enhancement skills based on Anthropic's J-space research
...
- **Tags:** `workflow`, `agent-skills`, `automation`
...
- **Tags:** `video`, `generative-ai`, `skill`
- **Why use it:** End-to-end Vox-style paper-collage video generation via agent skill
...
- **Tags:** `workflow`, `chrome-extension`, `ai-workflow`
- **Why use it:** Turn AI conversations into reusable organized workflows
...
- **Tags:** `agent`, `desktop`, `privacy`, `multi-model`
...
- **Tags:** `agent`, `orchestration`, `coding-agents`
- **Why use it:** Orchestrates multiple coding agents (Claude, Codex, Grok, DSH) as a unified team
...
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools in DSH
...
- **Tags:** `creative-writing`, `novel-writing`, `screenwriting`
- **Why use it:** Creative writing skills for novels and drama
...
- **Why use it:** Adds multimodal vision to Claude Code
...
- **Tags:** `skills`, `coding`, `architecture`
- **Why use it:** Framework for creating repeatable skills
...
- **Why use it:** Skill to discover and verify GitHub plugins
...
- **Tags:** `notes`, `smartisan`, `skill`
- **Why use it:** Smartisan-style notes with skill integration and public account export.
...
- **Why use it:** Specialized agent skills for writing and debugging high-performance infrastructure.
...
- **Why use it:** TDD, debugging, and planning skills adapted for DeepSeek Harness.
...
- **Why use it:** Complete reverse-engineering and pentesting skill set
...
- **Tags:** `agent-skills`, `research-tools`, `market-research`
- **Why use it:** 88 open-source skills for research, marketing, social intelligence
...
- **Why use it:** Portable spec-driven development skill for repositories
...
- **Why use it:** Enables cross-platform agent continuity memory for seamless handoffs.
...
- **Why use it:** Bazi/Fengshui/IChing等传统智慧技能包，本地确定性引擎+可视化面板。
...
- **Why use it:** Dedicated skills management plugin for organizing and controlling DSH agent skills.
...
- **Tags:** `agent-skills`, `swift-cycle`, `governance`
- **Why use it:** Version-pinned Swift Cycle governance skill adapter for deterministic DSH workflows.
...
- **Why use it:** Enables image reading & generation for DSH agents.
...
- **Why use it:** Full workflow Chinese official document processing per national standard.
...
- **Tags:** `agent-skills`, `package-manager`, `mcp`
...
- **Why use it:** Game-like mission system with fog-of-war map for skills.
...
- **Tags:** `deepseek-harness`, `godot`, `game-development`
- **Why use it:** Godot 4.x game dev skill for DSH — full-stack GDScript support.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `agent-skills`
- **Why use it:** Agent skills for scaffolding and testing DSH plugins internally.
...
- **Tags:** `agent-skills`, `dsh-plugin`, `canvas`, `mcp`
- **Why use it:** WeShop Cordis integration with infinite canvas and creative skills.
...
- **Tags:** `deepseek-harness`, `record-replay`, `macos`, `computer-use`
- **Why use it:** Record macOS workflows and convert them into agent skills automatically.
...
- **Why use it:** Simulates a full product team for guided workflows
...
- **Tags:** `agent-tools`, `capability-index`
- **Why use it:** Pre-flight plugin injection for predictable agent tasks
...
- **Tags:** `search`, `web`, `mcp`
- **Why use it:** Strongest free web search plugin bridging all models lacking native web access
...
- **Why use it:** Web UI panel for managing skills and MCP configurations.
...
- **Why use it:** Image OCR and pixel-to-text tools for text-only models
...
- **Tags:** `mcp`, `skill`, `zhihu`
- **Why use it:** Zhihu search and Zhida ask via Skill, CLI, and MCP.
...
- **Why use it:** Paste JSON to connect MCP servers; hot-reload, skill management.
...
- **Why use it:** OAuth-bridges ChatGPT Subscription models into DSH
...
- **Why use it:** Open-source design tool with AI-powered UI generation
...
- **Why use it:** Industrial-grade image generation prompts with 530+ templates
...
- **Why use it:** AI-generated visual design and PPT studio for DSH
...
- **Why use it:** Interactive UI components rendered inline in DSH replies — charts, forms, quizzes
...
- **Why use it:** Generate AI images directly in chat
...
- **Tags:** `deepseek-harness`, `design`, `ui-design`
- **Why use it:** Preview and edit OpenPencil documents directly in DSH conversations.
...
- **Why use it:** Legal litigation visualization tool generating timelines and diagrams
...
- **Why use it:** Design aesthetics skill pack preventing AI-generated look with 6 curated styles.
...
- **Why use it:** Cross-browser enhancement suite with prompt management
...
- **Tags:** `content-discovery`, `cross-platform`, `privacy`
- **Why use it:** Local-first cross-platform content discovery agent for major platforms
...
- **Why use it:** Use logged-in browser for AI agent automation seamlessly
...
- **Why use it:** Tabbit browser automation with Playwright for DSH.
...
- **Tags:** `deepseek-harness`, `community`
- **Why use it:** GitHub OAuth group photo wall for DSH community.
...
- **Why use it:** DingTalk IM integration turning chats into tool-capable DSH agents
...
- **Why use it:** Core harness platform for DSH plugin ecosystem
...
- **Why use it:** Privacy-focused open-source resume builder with MCP support
...
- **Tags:** `electron`, `image-uploader`
- **Why use it:** Essential image uploader supporting 60+ hosting services
...
- **Why use it:** Unified model switcher for Claude Code, Codex, DeepSeek, and more
...
- **Why use it:** Zero-dependency web toy simulation with real audio sampling
...
- **Tags:** `context`, `dsh-plugin`, `utilities`
- **Why use it:** Context dashboard and insight management for DSH
...
- **Tags:** `security`, `auditing`, `cybersecurity`
- **Why use it:** AI code security auditor detecting hallucinated packages and missing safeguards
...
- **Tags:** `desktop`, `client`, `cross-platform`
- **Why use it:** Cross-platform desktop client and plugin suite inspired by CodePilot for DSH
...
- **Tags:** `cost-tracking`, `token-usage`, `llm`
- **Why use it:** Track session costs and usage budgets
...
- **Why use it:** Large plugin marketplace with search API
...
- **Why use it:** Bridge Pi extensions to run as DSH plugins
...
- **Why use it:** Crash recovery with undo, snapshots, and one-click SAFE MODE.
...
- **Tags:** `plugin-management`, `dsh-repository-plugin`, `ui`
- **Why use it:** Plugin management console and official dev skill guide
...
- **Why use it:** Backup, restore, and sync complete DSH configuration via WebDAV and migration tools.
...
- **Why use it:** DSH plugin marketplace similar to CodeX for discovering tools
...
- **Why use it:** Whale Girl theme series for DeepSeek Harness customization
...
- **Why use it:** Beautiful frosted glass UI theme with full customization controls for DSH
...
- **Why use it:** Beautiful WebGPU ocean theme extension
...
- **Tags:** `theme`, `skins`, `ui`
- **Why use it:** One-click swap 34 opencode classic themes for DSH.
...
- **Why use it:** Custom DSH web UI backgrounds with presets and upload
...
- **Why use it:** Comprehensive AI resource hub and learning guide
...
- **Tags:** `agent-harness`, `awesome-list`, `deepseek-harness`
- **Why use it:** Comprehensive DSH guide and resource list
...
- **Why use it:** Curated list of DSH plugins and MCP servers
...
- **Tags:** `ai-agents`, `chinese-api`, `api-documentation`
- **Why use it:** Search 65,600+ Chinese platform API docs across multiple CLI tools
...
- **Why use it:** Official DSH plugin dev knowledge base with bilingual docs and Cordis primer.
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories for quick discovery.
...
- **Tags:** `kline`, `analysis`, `market-data`
- **Why use it:** Interactive K-line analysis plugin with multi-market support and technical indicators.
...
- **Tags:** `evaluation`, `llm-evaluation`, `rag-evaluation`
...
- **Why use it:** Curated 24 finance/quant plugins for trading research
...
- **Why use it:** Built-in plugin search across npm and curated lists from inside agents
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Complete sorted listing of 1000+ DSH plugins by star count
...
- **Tags:** `awesome-list`, `ai-agents`, `mcp`
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated resource hub for DSH plugins, tools, skills and more
...
- **Tags:** `awesome-list`, `industry`, `dsh-plugin`
- **Why use it:** Industry-specific DSH plugins for IT, finance, law, healthcare etc.
...
- **Tags:** `low-code`, `internal-tools`, `crm`
...
- **Why use it:** Curated plugin radar with real-tested top 50 list
...
- **Tags:** `awesome-list`, `dsh-plugin`, `ecosystem`
- **Why use it:** Curated DSH plugins and tools index
...
- **Why use it:** Curated bilingual directory of DSH plugins, tools, skills, and integrations
...
- **Why use it:** 30-second plugin discovery with scene-based categorization and popularity rankings
...
- **Tags:** `armor-breaking`, `jailbreak`, `prompt`
- **Why use it:** Armor-breaking prompt stabilization plugin specifically designed for DeepSeek
...
- **Why use it:** Plugin marketplace collection for DSH
...
- **Why use it:** Search anime and show details in chat
...
- **Tags:** `awesome`, `awesome-list`, `directory`
- **Why use it:** Curated awesome-list directory of all DSH plugins.
...
- **Tags:** `reasonix`, `skills`, `superpowers`
- **Why use it:** Superpowers skill port for Reasonix coding harness, not DSH-native.
...
- **Why use it:** Auto-syncing community plugin marketplace catalog
...
- **Tags:** `awesome-list`, `dsh-plugin`, `cordis`
...
- **Why use it:** Curated DSH plugin directory for ecosystem discovery.
...
- **Why use it:** Verified plugin registry with spam filtering
...
- **Why use it:** Plugin manual with scenario-based selection guide
...
- **Tags:** `radar`, `research`
- **Why use it:** Evidence-backed plugin radar with lab experiments
...
- **Why use it:** General DSH plugin repository and ecosystem listing
...
- **Why use it:** Plugin list (redirected to new repo)

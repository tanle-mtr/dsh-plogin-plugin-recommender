...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,030,975 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225,238 | Core platform powering the entire DSH plugin ecosy |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,362 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,529 | Original agent harness for multi-player swarms and |
...
- **Why use it:** First vision plugin for DSH; turns images into structured JSON evidence for agents.
...
- **Why use it:** Virtual terminal with VFS for isolated, sandboxed agent command execution.
...
- **Tags:** `documentation`, `code-analysis`, `agent-context`
- **Why use it:** Generates accurate technical docs and AI-ready context from codebases in minutes.
...
- **Tags:** `agent-runtime`, `ai-coding`, `computer-use-agent`
- **Why use it:** High-performance Rust agent runtime with polished desktop and code agent integration.
...
- **Why use it:** Enables multi-agent team orchestration within DeepSeek Harness environment.
...
- **Tags:** `vision-tools`, `computer-vision`, `ocr`
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, and screenshot analysis.
...
- **Why use it:** Comprehensive daily-updated plugin marketplace with curated reviews
...
- **Tags:** `web-search`, `free`, `utility`
- **Why use it:** Free web search bridge for all models without native web access
...
- **Tags:** `cli`, `developer-tools`, `plugin-manager`
- **Why use it:** CLI, schemas, and resolver tools for managing DSH Plugin Hub — essential for devs
...
- **Why use it:** DSH skill that automates plugin discovery, installation, and verification from GitHub
...
- **Why use it:** Superpowers skills ported to Reasonix coding harness for developers
...
- **Tags:** `plugin-development`, `dsh-plugin`, `codex`
...
- **Tags:** `official`, `docs`, `api`
- **Why use it:** Official API docs and plugin examples from Tencent.
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge syncing OpenAI Codex with DSH skills and MCP.
...
- **Tags:** `launcher`, `plugin`, `core`
- **Why use it:** Unlocks DSH plugin kernel: unified orchestration of Runtime, Provider, Plugin, Skill, MCP.
...
- **Why use it:** Web GUI plugin to manage Skills and MCP servers in settings.
...
- **Tags:** `migration`, `import`, `claude`
- **Why use it:** Migration wizard importing sessions and skills from Claude Code, Codex, OpenCode, Hermes.
...
- **Tags:** `plugin-dev`, `skills`, `developer`
...
- **Why use it:** Pre-flight plugin check for agents — auto-injects Top-K plugin hints per task.
...
- **Why use it:** Open-source Figma alternative with local-first desktop design
...
- **Why use it:** Web UI aggregation for DSH plugins with Creative Workshop
...
- **Tags:** `sidebar`, `ui-extension`, `coding-tools`
- **Why use it:** Extensible sidebar with file editor, terminal, chat, Git, and sub-agent panels.
...
- **Why use it:** Adorable floating whale widget tracking your DeepSeek account balance with animations.
...
- **Why use it:** Lightweight Tauri desktop with preset plugins, zero setup across Windows/macOS/Linux.
...
- **Why use it:** Local-first desktop workspace for DSH sessions, projects, and Office automation
...
- **Why use it:** Zero-setup Windows desktop client with Codex, SSH, and mobile remote access
...
- **Tags:** `ui`, `components`, `charts`
- **Why use it:** Render interactive UI components — charts, forms, quizzes — inline in replies
...
- **Tags:** `desktop`, `local-first`, `agent`
- **Why use it:** Local-first desktop agent with multi-model support and self-evolving skills
...
- **Tags:** `office`, `desktop`, `ui-extension`
- **Why use it:** Brings full office suite—spreadsheets, docs, slides, canvases—into DeepSeek Harness
...
- **Why use it:** Native iOS app for DeepSeek Harness via WebSocket — workspaces, sessions, agent traces on iPhone
...
- **Why use it:** CodePilot-inspired desktop client and plugin suite for macOS, Windows, and Linux
...
- **Why use it:** Secure P2P multi-device remote access to DSH from PC, Android and Web with end-to-end encryption
...
- **Why use it:** Open-source Smartisan Notes clone with Docker deploy, skill call support, and WeChat/MP export
...
- **Tags:** `plugin-market`, `webui`, `installation`
- **Why use it:** Community plugin market for browsing and one-click installing DSH plugins
...
- **Tags:** `dsh-plugin`, `desktop`, `electron`, `ui`
- **Why use it:** Electron-based desktop console for multi-tab Harness/Plugin/MCP management
...
- **Why use it:** Persistent bottom bar showing provider/model, balance, and peak pricing info.
...
- **Tags:** `desktop-app`, `tauri`, `bioinformatics`
...
- **Why use it:** WorkBuddy-style skill picker for DSH composer with slash command insertion.
...
- **Tags:** `desktop-app`, `electron`, `dsh-integration`
- **Why use it:** Electron-based desktop DSH with integrated web UI and sidebars.
...
- **Why use it:** Open-source RAG knowledge platform with self-maintaining wiki and search
...
- **Tags:** `agent-memory`, `hybrid-retrieval`, `token-savings`
...
- **Why use it:** Memory library for building stateful, self-evolving agents
...
- **Tags:** `memory`, `rag`, `agent-skills`
- **Why use it:** Agent memory management kit with refine capabilities for long-term context retention.
...
- **Tags:** `memory`, `rag`, `milvus`, `persistent-storage`
...
- **Tags:** `memory`, `long-term-memory`, `agent`
- **Why use it:** Shared local memory hub giving all AI agents persistent cross-agent context.
...
- **Tags:** `skill-corpus`, `rag`, `agent-skills`
- **Why use it:** Turns SKILL.md files into retrievable agent-skill corpora with eval tooling
...
- **Tags:** `dsh-plugin`, `memory`, `rag`, `consolidation`
...
- **Why use it:** Original agent harness for multi-player swarms and autonomous workflows
...
- **Why use it:** 530+ GPT Image prompt templates and reusable skills library
...
- **Tags:** `agent-workspaces`, `skill`, `multi-device`
- **Why use it:** Unified agent workspace with cross-device task tracking
...
- **Tags:** `skill-store`, `marketplace`, `skills`
- **Why use it:** Largest curated skills marketplace with auto-updating collections
...
- **Tags:** `agent-team`, `enterprise`, `multi-agent`
...
- **Tags:** `preset`, `workflow`, `agent-bootstrap`
- **Why use it:** Two-phase preset: minimal bootstrap then full standard tools for reliable agent operation.
...
- **Tags:** `cognition`, `reasoning`, `agent-skills`
...
- **Tags:** `conversation`, `canvas`, `workflow`
- **Why use it:** Visual non-linear canvas for branching conversations and session exploration
...
- **Why use it:** Gives AI agents video/audio/screen perception with verifiable timestamped evidence
...
- **Why use it:** Complete workflow for novel, short-drama, game and video-recap writing in one plugin
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and native Web UI, no iframes
...
- **Tags:** `agent-review`, `self-evolving`, `plan-mode`
- **Why use it:** Enables composable, reviewable agent workflows for continuous self-evolution in DSH
...
- **Tags:** `agent-skills`, `architecture`, `cross-platform`
- **Why use it:** Turns experience into repeatable execution skills across multiple AI coding platforms
...
- **Why use it:** 88 open-source skills for research, social intelligence, marketing automation across multiple platforms
...
- **Why use it:** Specialized agent skills for AI infrastructure development, optimization, and debugging
...
- **Why use it:** Complete reverse engineering skill pack with 87 SKILL.md for security research
...
- **Tags:** `agent-skills`, `skill-generator`, `learning`
- **Why use it:** Automatically converts successful sessions into reusable agent skills
...
- **Why use it:** TDD, debugging, planning skills adapted for DSH agent workflows
...
- **Tags:** `dsh-plugin`, `agent`, `mentoring`, `code-review`
- **Why use it:** AI mentor that scans projects and guides coding step-by-step
...
- **Tags:** `dsh-plugin`, `skills`, `matt-pocock`, `workflow`
- **Why use it:** 25 pre-installed Matt Pocock engineering skills, right-panel access
...
- **⭐ Stars:** 52
- **Language:** Python
- **Description:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能���统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `dsh-plugin`, `gongwen`, `document`, `workflow`
- **Why use it:** Full GB/T 9704 government document workflow with format check and optimization
...
- **Tags:** `dsh-plugin`, `spec-driven`, `development`, `workflow`
- **Why use it:** Repository-native Spec-driven development skill for DSH engineering workflows
...
- **Why use it:** Official DSH knowledge base as an on-demand agent skill with EN/ZH docs archive.
...
- **Tags:** `multi-agent`, `dsh-plugin`, `skills`
...
- **Why use it:** DirectorX AI video/image/audio skills with configurable vision tools.
...
- **Why use it:** 11 QA testing skills framework enabling AI agents to work like senior testers.
...
- **Why use it:** Engineering discipline skill bundle: grill requirements, test implementation.
...
- **Tags:** `code-simplification`, `dsh-plugin`, `skill`
- **Why use it:** Code simplification skill adapted from DSH's built-in dsh-find-simplifications.
...
- **Why use it:** Cross-platform handoff skill preserving repository-local continuity memory.
...
- **Tags:** `math`, `modeling`, `agent`
- **Why use it:** Multi-agent math modeling solver for competitions with 33 models.
...
- **Why use it:** Full-stack Godot 4.x game dev agent skill at runtime.
...
- **Tags:** `marketplace`, `dsh-plugin-bundle`, `dsh-plugin-market`
- **Why use it:** CodeX-style plugin marketplace specifically for DSH agents.
...
- **Why use it:** In-agent npm + awesome-list search for DSH plugin discoverability.
...
- **Tags:** `finance`, `mcp`, `tushare`, `multi-agent`
- **Why use it:** Local financial database via Tushare with auto-generated HTTP API, MCP calls, and IM alerting integration
...
- **Tags:** `architecture-diagram`, `diagram-as-code`, `dsh-plugin`
- **Why use it:** Beautiful architecture and sequence diagrams via code as agent skill
...
- **Tags:** `design`, `vector`, `vibedesign`, `flutter`
...
- **Why use it:** AI-generated native design system with visual editor, templates, and PPT studio.
...
- **Tags:** `vision`, `multimodal`, `ui-analysis`
- **Why use it:** Adds multimodal vision capability to text-only LLMs for screenshots, UI, and chart analysis
...
- **Tags:** `dsh-plugin`, `visualization`, `legal`, `svg`
- **Why use it:** Convert messy litigation diagrams into court-admissible timeline visuals
...
- **Why use it:** 6 design aesthetic styles to avoid AI-looking websites.
...
- **Why use it:** Cross-platform content discovery agent scraping Bilibili, YouTube, Reddit and more.
...
- **Why use it:** Enables AI agents to leverage real logged-in browsers without work interruption.
...
- **Why use it:** Persistent identity browser with fingerprint spoofing, unlimited local profiles, Android emulation
...
- **Why use it:** Run live iOS Simulator or USB-connected iPhone directly inside DSH conversation with 22 agent tools
...
- **Why use it:** OAuth binds ChatGPT account to DSH for native ChatGPT model chat.
...
- **Why use it:** AI-powered no-code platform for building internal business tools fast
...
- **Tags:** `routing`, `infrastructure`, `mcp`
- **Why use it:** Task-aware reasoning-mode router with injector kit
...
- **Tags:** `orchestration`, `long-horizon`, `control-plane`
- **Why use it:** Long-horizon agent orchestration across multiple harnesses
...
- **Tags:** `utility`, `model-switch`, `multi-tool`
...
- **Why use it:** Best context insight and management tool with dashboard, browser, and sidebar views.
...
- **Tags:** `llm-provider`, `oauth`, `utilities`
...
- **Why use it:** Track session/daily costs, budgets, history, and token usage across multiple LLM providers
...
- **Tags:** `llm-provider`, `command-code`, `provider`
- **Why use it:** Adds Command Code model provider with live catalog, plan-aware selection, and reasoning efficiency
...
- **Tags:** `backup`, `config-manager`, `migration`, `sync`
- **Why use it:** Backup, restore and sync complete DSH configuration via WebDAV
...
- **Why use it:** Centralized control over MCP tool exposure and execution modes
...
- **Tags:** `dsh-plugin`, `plugin-registry`, `infrastructure`
- **Why use it:** Essential plugin ecosystem infrastructure with zero-patch management console
...
- **Tags:** `dsh-plugin`, `skills-manager`, `utility`
...
- **Tags:** `dsh-plugin`, `huawei-cloud`, `mcp`, `cloud`
- **Why use it:** Official Huawei Cloud plugin with MCP tools, safety guardrails, and cloud sandbox
...
- **Tags:** `dsh-plugin`, `awesome-list`, `directory`, `curated`
- **Why use it:** Curated directory of 280+ plugins across 14 categories, quick navigation links
...
- **Why use it:** Audit context tokens, detect duplicates/conflicts with a Web UI ring panel.
...
- **Tags:** `utility`, `dsh-plugin`, `containers`
...
- **Why use it:** Fast, elegant Neovim plugin manager for streamlined workflow.
...
- **Tags:** `diagnostic`, `plugin-conflict`, `utility`
- **Why use it:** Diagnoses and resolves inter-plugin and version conflicts.
...
- **Why use it:** Zero-dependency static web portal for browsing and installing 227+ DSH plugins.
...
- **Tags:** `pets`, `theme`, `pixel-art`, `mascot`
- **Why use it:** Animated pet gallery theme for various AI coding agents
...
- **Why use it:** Whale Girl themed skins for DeepSeek Harness desktop customization.
...
- **Why use it:** Frosted glass theme with fully adjustable opacity, blur, and background options
...
- **Tags:** `theme`, `ocean`, `animation`
- **Why use it:** Real-time ocean theme with animated waves, sunset effects, and glassmorphism
...
- **Why use it:** Web background customization with preset themes and image uploads.
...
- **Why use it:** Curated DSH plugin directory for discovering ecosystem tools
...
- **Why use it:** Beginner-friendly DSH engineering tutorial from zero to one
...
- **Tags:** `awesome-list`, `discovery`, `research`
- **Why use it:** Daily-curated plugin discovery with real classification, rankings, and usage guides
...
- **Tags:** `awesome-list`, `reference`, `curation`
- **Why use it:** Comprehensive curated list of plugins, skills, MCP servers, patches, and orchestrators
...
- **Tags:** `awesome-list`, `guide`, `documentation`
- **Why use it:** Ultimate DSH guide: quickstart, resources, curated plugins, and toolkit references
...
- **Why use it:** Essential guide for learning DSH principles and plugin best practices
...
- **Tags:** `academic-search`, `mcp`, `citation`
- **Why use it:** Cross-platform academic search with citation graph, MeSH, and verification across major databases
...
- **Why use it:** Comprehensive agent-first handbook covering 173 source-backed topics on runtime, plugins, MCP and more
...
- **Why use it:** AI investment desk with multi-strategy fund backtesting capabilities
...
- **Why use it:** Industry and company research domain pack with methodology skills
...
- **Tags:** `dsh-plugin`, `api-docs`, `chinese-platforms`, `research`
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms without config
...
- **Tags:** `dsh-plugin`, `patent`, `infringement`, `legal-research`
- **Why use it:** Patent infringement analysis with competitive report generation
...
- **Tags:** `dsh-plugin`, `chinese-wisdom`, `bazi`, `prediction`
- **Why use it:** Bazi/Fengshui/IChing prediction engine with local deterministic reasoning
...
- **Why use it:** Interactive K-line analysis with indicators and market news.
...
- **Why use it:** Real-time token usage, cost charts, and API balance tracking.
...
- **Why use it:** Star-ranked community plugin directory for DSH discovery.
...
- **Why use it:** Plugin navigation with installation, permissions, and risk guidance.
...
- **Why use it:** AI-curated 190+ plugin list across 12 categories, hourly updates.
...
- **Why use it:** Evidence-backed plugin radar with 2Origin plugin lab insights.
...
- **Tags:** `awesome-list`, `curation`
- **Why use it:** Auto-updating curated plugin directory with bilingual README generation
...
- **Tags:** `awesome-list`, `review`
- **Why use it:** Evidence-led plugin directory with immutable commit reviews
...
- **Why use it:** DSH plugin collection directory for plugin discovery
...
- **Why use it:** Self-deployable ecosystem radar discovering and validating 15900+ candidate plugins.
...
- **Why use it:** Organized AI novel writing workflow with worldbuilding, characters, and revision support.
...
- **Why use it:** Bilingual curated list of DSH plugins, extensions, skills, and integrations
...
- **Why use it:** AI security platform auditing hallucinated packages and code vulnerabilities
...
- **Why use it:** 11,000+ plugin marketplace with search, rankings, and public API for DSH ecosystem
...
- **Why use it:** Plugin catalog with 1,958 repos and 1,819 verified plugins, multi-language search and STAR sorting
...
- **Why use it:** Comprehensive curated list of DSH plugins for discovery
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Official auto-generated curated list maintained by cordis.run
...
- **Tags:** `awesome-list`, `productivity`, `plugins`
- **Why use it:** Curated list covering productivity tools and DSH development resources
...
- **Why use it:** Community plugin catalog auto-synced every 4 hours with marketplace
...
- **Why use it:** Comprehensive awesome list of plugins, tools, skills & resources.
...
- **Why use it:** Spam-filtered open-data registry for DSH plugins and skills.
...
- **Why use it:** 2026 quality-checked curated list of DSH plugins.
...
- **Why use it:** Comprehensive sorted catalog of 1000+ DSH ecosystem plugins.
...
- **Why use it:** Official DSHA-curated精选插件合集，authoritative source.
...
- **Tags:** `dsh-plugins`, `dsh-plugin-verify`, `dsh-ecosystem`
- **Why use it:** DSH plugins repository with verify and analytics features.
...
- **Why use it:** Deprecated; migrated to awesome-dsh-plugin/awesome-dsh-plugin.

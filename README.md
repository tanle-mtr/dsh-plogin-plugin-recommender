...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 976,221 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-07 00:50:32 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 214,002 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,465 | Local-first open-source design tool with AI-powere |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,978 | Deploy multi-agent swarms and autonomous workflows |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 27 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 29 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 9 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 31 plugins
...
- [Research & Analysis](#research-&-analysis) — 29 plugins
- [Other](#other) — 20 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (27)
- [UI & Desktop Extensions](ui-desktop-extensions) (29)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (9)
- [Agent Skills & Workflows](agent-skills-workflows) (31)
...
- [Research & Analysis](research-analysis) (29)
- [Other](other) (20)
---
...
- **Why use it:** Full-featured agent harness with self-evolving memory and multi-model support
...
- **Why use it:** Terminal-native coding agent optimized for DeepSeek prefix caching
...
- **Tags:** `agent`, `dsh`, `harness`
- **Why use it:** Excellent beginner guide from zero to harness engineering mastery.
...
- **Tags:** `agent-orchestration`, `no-code`, `mcp`
- **Why use it:** Unified agent workspace across desktop, mobile and browser with task boards.
...
- **Tags:** `agent-control-plane`, `loop-engineering`, `workflow`
...
- **Why use it:** Enterprise-grade local-first multi-agent workspace with visual editor.
...
- **Why use it:** First vision plugin for DSH; enables image-to-text for text-only coding agents
...
- **Why use it:** World's first virtual terminal for AI agents with VFS and virtual terminal support
...
- **Why use it:** High-performance Rust-based agent runtime paired with polished desktop coding application
...
- **Why use it:** Code reviews grounded in 12 classic engineering books with severity diagnostics
...
- **Tags:** `security`, `redteam`, `vulnerabilities`
- **Why use it:** AI security platform for auditing code against hallucinated packages and vulnerabilities
...
- **Why use it:** Multi-agent coding with RPC, sub-agents, and MCP support
...
- **Why use it:** Adds multimodal vision to pure-text LLMs for UI/chart analysis workflows.
...
- **Tags:** `infra`, `coding`, `performance`
- **Why use it:** Specialized skills for AI infra dev: write, optimize and debug high-perf systems.
...
- **Why use it:** Ports Superpowers coding skills to the Reasonix harness.
...
- **Tags:** `coding`, `mentor`, `education`, `skills`
- **Why use it:** AI coding mentor that guides learners through structured chapters.
...
- **Tags:** `plugin-dev`, `coding`, `skills`, `harness-tools`
- **Why use it:** Meta skill for developing DSH plugins — covers slots, services, events, tools, and packaging standards
...
- **Tags:** `plugin-creator`, `coding`, `codex`, `template`
- **Why use it:** Reusable Codex skill template for building and validating DeepSeek Harness and Cordis plugins
...
- **Tags:** `context`, `audit`
- **Why use it:** Audit context injection, detect token cost and conflicts
...
- **Tags:** `quality-gate`, `engineering-discipline`, `delivery-gate`
- **Why use it:** Engineering discipline guard: grill requirements and prove delivery quality.
...
- **Tags:** `marketplace`, `skills`, `dsh-plugin`
- **Why use it:** Plugin marketplace for DSH agent skill discovery
...
- **Tags:** `mcp`, `recommender`, `coding-agents`
...
- **Tags:** `design-systems`, `desktop-app`, `dsh-plugin`
- **Why use it:** Local-first open-source design tool with AI-powered prototyping
...
- **Why use it:** AI-enhanced no-code platform for building business systems fast
...
- **Why use it:** Modern desktop client built for the DSH plugin ecosystem
...
- **Tags:** `dsh-web`, `dsh-plugin`, `web-ui`
- **Why use it:** Web-based DSH plugin ecosystem with Creative Workshop distribution.
...
- **Tags:** `sidebar`, `ui`, `desktop`
- **Why use it:** Open sidebar platform with built-in file editor, terminal, chat, Git, and sub-agent pages
...
- **Tags:** `taskboard`, `ui`, `extension`
- **Why use it:** Modern flexible task panel embeddable in Codex and DeepSeek Harness interfaces
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status, streaming thought, and rollback
...
- **Tags:** `floating-widget`, `deepseek`, `dsh-plugin`
- **Why use it:** Adorable floating whale widget tracking DeepSeek balance with drag support
...
- **Why use it:** Lightweight Tauri desktop with zero env setup, preset plugins, cross-platform
...
- **⭐ Stars:** 855
- **Language:** TypeScript
- **Description:** [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片���接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **Tags:** `computer-vision`, `ocr`, `dsh-plugin`
- **Why use it:** Powerful vision toolkit for text-only LLMs: OCR, screenshot analysis, Q&A
...
- **Tags:** `desktop`, `electron`, `mcp`, `dsh-plugin`
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, files, and research
...
- **Tags:** `ui`, `interactive`, `charts`
- **Why use it:** Generates interactive UI components inline in assistant replies
...
- **Tags:** `desktop`, `gui`, `windows`, `ssh`
- **Why use it:** Open-source Windows desktop GUI client for DSH with SSH and mobile remote access
...
- **Tags:** `desktop`, `local-first`, `multi-model`, `privacy`
- **Why use it:** Local-first desktop AI agent with multi-model support and self-evolving skills
...
- **Tags:** `canvas`, `ui`, `conversation`
- **Why use it:** Visual non-linear conversation canvas with session branching and exploration
...
- **Tags:** `office`, `productivity`, `desktop`
...
- **Why use it:** CodePilot-inspired desktop client across macOS, Windows, Linux
...
- **Why use it:** Native iOS client bringing Harness workspace, sessions and agent traces to iPhone.
...
- **Tags:** `notes`, `productivity`, `docker`
- **Why use it:** Open-source Smartisan Notes with Docker deploy and WeChat export.
...
- **Why use it:** Electron-based desktop console for managing Harness, plugins, MCP, and skills in one UI
...
- **Tags:** `ui`, `info-bar`
- **Why use it:** Status bar with live balance, pricing and countdown
...
- **Why use it:** WorkBuddy-style skill picker for fast composer insertion
...
- **Tags:** `bioinformatics`, `desktop-app`, `tauri`, `single-cell`
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消���气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `theme`, `webui`, `personalization`
- **Why use it:** Customizable background with preset themes, real-time preview, and auto-save.
...
- **Tags:** `desktop`, `electron`, `integration`, `modlens`
- **Why use it:** Electron desktop shell wrapping DSH web with integrated sidebar, ModLens and plugins.
...
- **Why use it:** One-click compact button for the context meter panel, improves UI efficiency.
...
- **Why use it:** Lightweight memory library for building stateful agents with continual learning.
...
- **Why use it:** Dedicated memory management kit: remember and refine agent knowledge efficiently
...
- **Tags:** `memory`, `context`, `rag`, `knowledge`
- **Why use it:** Proactive associative memory with zero-prompt recall injection and three-layer auto-consolidation
...
- **Why use it:** Distill any expert thinking into reusable agent skills
...
- **Tags:** `preset`, `agent-tools`, `workflow`
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for efficient agent setup
...
- **Why use it:** Intelligent skill routing and workflow orchestration with significant token savings
...
- **Tags:** `cognitive-enhancement`, `skills`, `agent-skills`
...
- **Why use it:** Multi-agent team orchestration plugin for DeepSeek Harness workflows
...
- **Tags:** `agent-skills`, `embeddings`, `skill-routing`
...
- **⭐ Stars:** 336
- **Language:** Python
- **Description:** Give AI agents eyes and ears. Watch Skill turns video, audio and screen activity into timestamped, searchable evidence, and verifies what a tool actually did with a deterministic contract rather than a model's opinion. DeepWatch brings it into an agent workspace built on the DeepSeek Harness. MCP, CLI, REST and Web.
- **Tags:** `multimodal`, `computer-vision`, `ocr`, `verification`
- **Why use it:** Gives AI agents eyes and ears via video, audio, and screen activity monitoring
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and dedicated Web UI
...
- **Why use it:** Creative writing plugin for novel and short-drama production with specialized skills
...
- **Tags:** `math-modeling`, `competition`, `skill`
...
- **Tags:** `agent`, `workflow`, `self-evolution`
- **Why use it:** Composable, reviewable agent workflows for self-evolution
...
- **Tags:** `skills`, `agent`, `framework`
- **Why use it:** Reusable agent skill framework supporting Claude, Codex, GPT and more.
...
- **Tags:** `skills`, `agent-learning`, `automation`
...
- **Tags:** `skills`, `tdd`, `debugging`, `collaboration`
...
- **Tags:** `skills`, `productivity`, `github`, `workflow`
- **Why use it:** Batteries-included 25-engineer productivity skill deck for DSH with GitHub issue support
...
- **Tags:** `document`, `chinese`, `office`, `compliance`
- **Why use it:** Complete Chinese official document processor following national GB/T 9704 standard with full formatting pipeline
...
- **Tags:** `spec-driven`, `coding`, `vibe-coding`, `workflow`
- **Why use it:** Spec-driven development skill with repository-native patterns for vibe coding and spec programming
...
- **Why use it:** Centralized skill management with safe loading and audit control
...
- **Tags:** `skill`, `chinese-wisdom`
- **Why use it:** Unique Chinese traditional wisdom AI skill with dashboard
...
- **Why use it:** Multi-agent collaboration with shared workspace and contexts
...
- **Why use it:** Adapts DSH code simplification skill for broader use
...
- **Why use it:** Cross-platform agent handoff with session continuity memory
...
- **Tags:** `qa`, `testing`
- **Why use it:** AI-powered QA testing framework with 10 skills and shared KB
...
- **Tags:** `ai-director`, `ai-video`, `directorx`, `storyboard`
- **Why use it:** Full AI video/image/audio generation skill with storyboard and corpus support.
...
- **Why use it:** Godot 4.x full-stack game dev skill registered at runtime.
...
- **Tags:** `media-skills`, `image-generation`, `vision`
- **Why use it:** Free image paste-reading and generation with auto vision transcoding.
...
- **Why use it:** Virtual product team agent preset simulating PM→Engineer→QA→Release workflow.
...
- **Why use it:** Pre-flight plugin check boosts agent task success
...
- **Why use it:** Convenient web UI for managing skills and MCP servers in one place.
...
- **Tags:** `mcp`, `menu`, `control`, `security`
- **Why use it:** Unified menu to control MCP tool and skill exposure levels.
...
- **Tags:** `api`, `documentation`, `mcp`, `chinese-platforms`
- **Why use it:** Searches 65,600+ API docs from 20 Chinese open platforms directly.
...
- **Tags:** `mcp`, `cloud`, `huawei`, `sdk`, `cli`
- **Why use it:** Official Huawei Cloud MCP toolkit with CLI, SDK, sandbox, and guardrails for AI agents
...
- **Why use it:** One-click MCP/Skill config sync across 7+ AI agent platforms
...
- **Tags:** `mcp`, `manager`
- **Why use it:** Manage skills and MCP servers via DSH Web GUI settings
...
- **Tags:** `diagrams`, `architecture-as-code`, `dsh-plugin`
- **Why use it:** Generate beautiful, verifiable architecture and sequence diagrams
...
- **Why use it:** 530+ professional image generation prompts with reusable skills
...
- **Tags:** `video-generation`, `ai-video`, `dsh-plugin`
- **Why use it:** End-to-end automated paper-collage explainer video generation via LLM agents
...
- **Why use it:** AI-generated editable design system, template marketplace, and PPT studio
...
- **Tags:** `visualization`, `legal-tech`, `timeline`, `svg`
- **Why use it:** Transforms messy legal documents into professional litigation timeline diagrams and visuals
...
- **Tags:** `ocr`, `vision`, `image-reading`, `multimodal`
- **Why use it:** Pixel-to-text OCR skill enabling text-only models to read and understand images via trained methodology
...
- **Tags:** `design-skills`, `ui`, `vibe-coding`, `web-design`
- **Why use it:** 6 design styles prevent AI-generic vibes in vibe-coded websites.
...
- **Tags:** `knowledge-cards`, `ui`, `visual`
- **Why use it:** Turn chat history into shareable knowledge cards
...
- **Why use it:** Chrome extension suite enhancing Gemini, Claude, ChatGPT interfaces
...
- **⭐ Stars:** 3,212
- **Language:** Python
- **Description:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻��内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `web-automation`, `cross-platform`
- **Why use it:** Cross-platform AI content agent scraping B站/抖音/YouTube/X/Zhihu with privacy-first design
...
- **Why use it:** Lets AI agents control your logged-in browser seamlessly without disruption
...
- **⭐ Stars:** 395
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费���注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `browser`, `free`
- **Why use it:** Strongest free web search bridge for DSH models without native web access
...
- **Why use it:** Control iOS Simulator and real iPhone via 22 agent tools
...
- **Why use it:** Playwright-based browser automation for DeepSeek Harness.
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `ai-agents`
- **Why use it:** ChatGPT OAuth binding for DSH internal chat
...
- **Why use it:** DingTalk IM stream-mode bot for DSH agents
...
- **Why use it:** Privacy-first, fully customizable open-source resume builder
...
- **Tags:** `cordis`, `dsh-plugin`, `routing`
- **Why use it:** Runtime injector + task-aware router kit for advanced DSH routing control.
...
- **Tags:** `cli`, `mascot`, `dsh-plugin`
- **Why use it:** Public animated pet gallery to personalize your coding agent experience.
...
- **Tags:** `marketplace`, `plugin-manager`, `utility`
- **Why use it:** In-DSH plugin marketplace: browse, search, and one-click install extensions visually
...
- **Tags:** `model-switch`, `multi-agent`, `utility`
- **Why use it:** One-click model switching across Claude Code, Codex, Grok, DeepSeek, Kimi, and more
...
- **Tags:** `plugin-registry`, `ecosystem`, `dsh-plugin`
- **Why use it:** Self-hosted plugin radar discovering and validating 15900+ DSH candidates
...
- **Tags:** `armor-breaking`, `deepseek`, `dsh-plugin`
- **Why use it:** Stable armor-breaking plugin for DeepSeek Harness sessions
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools, and MCP infrastructure
...
- **Tags:** `awesome-list`, `dsh-plugins`, `plugin-ecosystem`
- **Why use it:** Curated DSH plugin ecosystem directory covering CLI to web UI
...
- **Why use it:** Uses ChatGPT, Claude, and Grok subscriptions as DSH LLM providers via OAuth
...
- **Why use it:** Daily-updated comprehensive plugin marketplace
...
- **Why use it:** Track session/daily costs, budgets, and token usage
...
- **Why use it:** Bridge Pi ecosystem extensions to run natively on DeepSeek Harness via ABI.
...
- **Tags:** `infrastructure`, `plugin-management`, `devtools`
- **Why use it:** Essential DSH infrastructure: plugin registry console and official dev skill scaffolding
...
- **Tags:** `build`, `validation`, `plugin-tools`, `credentials`
- **Why use it:** Build and validate installed DSH plugins including slots, Typert remotes, and credential management
...
- **Why use it:** Real-time token usage and cost tracking with per-round charts for API monitoring.
...
- **Tags:** `conflict-resolution`, `debugging`, `plugin-health`
- **Why use it:** Diagnoses and resolves plugin conflicts across versions for stable operation.
...
- **Why use it:** npm+awesome search for DSH plugin discoverability
...
- **Tags:** `auto-updating`, `vercel`, `bilingual`
- **Why use it:** Auto-updating bilingual README with Vercel hosting
...
- **Tags:** `theme`, `glass`, `ui`
- **Why use it:** Frosted glass themed UI with fully customizable blur and background options
...
- **Tags:** `ai`, `rag`, `mcp`
- **Why use it:** Comprehensive AI resource hub with tutorials and prompts for all major models.
...
- **Tags:** `awesome`, `dsh-plugin`, `list`
- **Why use it:** Curated plugin directory — the best starting point for discovering DSH plugins.
...
- **Why use it:** Auto-searches top 8 Chinese platforms and generates citable research reports
...
- **Why use it:** Ultimate DSH guide with quickstart and curated resources
...
- **Why use it:** Learn DSH principles and best practices with marketplace
...
- **Why use it:** Curated list of plugins, skills, MCPs, and UIs for DSH
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU orchestration
...
- **Tags:** `finance`, `stock`, `multi-agent`
- **Why use it:** Local financial database with multi-agent analysis and IM alert integration.
...
- **Tags:** `research`, `marketing`, `skills`
...
- **Tags:** `research`, `industry`, `analysis`, `policy`
- **Why use it:** Industry research toolkit with methodology skills and news tracking.
...
- **Why use it:** Patent infringement analysis with RAG-powered reports and multi-agent skill support
...
- **Tags:** `fintech`, `backtesting`, `investment`, `research`
- **Why use it:** AI-powered investment desk with multi-strategy backtesting and compliance-first research workflows
...
- **Tags:** `kline`, `financial`
- **Why use it:** Interactive K-line analysis with indicators and market data
...
- **Tags:** `evaluation`, `rag-evaluation`, `prompt-testing`, `agent-evaluation`
- **Why use it:** Evidence-backed eval framework for prompts, RAG, skills, and agents.
...
- **Why use it:** Curated 2026 plugin directory with quality checks for reliable selection.
...
- **Why use it:** 24 verified stock/finance/quant plugins in a bilingual curated directory.
...
- **Why use it:** Evidence-led directory with verified plugins and permission-aware install guidance.
...
- **Why use it:** Collection of useful DSH plugins for quick discovery and reference.
...
- **Why use it:** Verified star-ranked community plugins for trusted DSH extensions discovery.
...
- **Why use it:** Complete 1000+ repo inventory sorted by stars for comprehensive DSH tool exploration.
...
- **Tags:** `documentation`, `guide`, `plugin-directory`
- **Why use it:** Plugin product manual with scenario-based navigation, installation and compatibility info.
...
- **Why use it:** Auto-crawled bilingual plugin directory updated daily via GitHub Actions.
...
- **Why use it:** Zero-dependency static portal for discovering, filtering and installing 227+ plugins.
...
- **Tags:** `dsh-bundle`, `dsh-ecosystem`, `research`
- **Why use it:** Plugin repository analytics for DSH ecosystem
...
- **Tags:** `awesome-list`, `deepseek`, `evidence-led`
- **Why use it:** Immutable commit-reviewed bilingual plugin directory
...
- **Tags:** `plugin-registry`, `2origin`, `radar`
- **Why use it:** Plugin radar with 2Origin lab collaboration
...
- **Description:** DSH插件
- **Tags:** `dsh`, `plugins`
- **Why use it:** General DSH plugin listing
...
- **Tags:** `encyclopedia`, `mcp`, `rag`, `knowledge-base`
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, multimodal, and learning paths
...
- **Why use it:** Daily auto-curated plugin directory with scene classification and verified reviews
...
- **Tags:** `catalog`, `plugin-marketplace`, `directory`
- **Why use it:** Centralized DSH plugin catalog with 1958 repos, search and filter support.
...
- **Why use it:** Multi-source anime search via Bangumi with magnet link support.
...
- **Why use it:** Official auto-generated plugin catalog curated by cordis.run.
...
- **Why use it:** Community plugin marketplace with one-click install/uninstall.
...
- **Why use it:** Curated resource list covering DSH plugins and development tools.
...
- **Tags:** `community`, `catalog`, `plugins`, `awesome`
...
- **Tags:** `directory`, `awesome-list`, `community`, `resources`
- **Why use it:** Curated directory of 280+ community DSH plugins across 14 categories with direct repo links
...
- **Why use it:** Official plugin dev knowledge base with EN/ZH docs archive
...
- **Tags:** `awesome-list`, `curated-list`
- **Why use it:** Unofficial community plugin catalog for DSH ecosystem discovery.
...
- **Why use it:** Curated awesome list with website showcase for DSH plugins.
...
- **Tags:** `awesome-list`, `resources`, `registry`
- **Why use it:** Comprehensive curated list of plugins, tools, skills and resources.
...
- **Why use it:** Spam-filtered open-data plugin registry with bundles and skills catalog.
...
- **Tags:** `moved`, `deprecated`
- **Why use it:** Moved to github.com/awesome-dsh-plugin
...
- **Why use it:** Curated list of DSH plugins; a discovery resource rather than a functional plugin.

...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 853,108 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 13:02:08 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 190,757 | Core DSH ecosystem — everything is a plugin archit |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,972 | Best DSH design plugin, open-source Figma alternat |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,240 | Original multi-agent swarm framework with workflow |
...
- **Why use it:** Complete beginner-to-pro tutorial for DeepSeek Harness engineering
...
- **Why use it:** Runtime injector + task-aware reasoning-mode router for optimal routing
...
- **Why use it:** Self-improving agent OS with loop engineering and automated evaluation
...
- **Tags:** `enterprise-agent-workspace`, `multi-agent`, `visual-editor`
- **Why use it:** Enterprise multi-engine agent workspace with visual editor and collaboration
...
- **Tags:** `dsh-plugin`, `llm-agent`, `preset`
- **Why use it:** Minimal bootstrap then full Standard tools preset for reliable DSH setup
...
- **Why use it:** AI code reviews grounded in 12 classic engineering books with severity labels and fixes.
...
- **Tags:** `coding-agents`, `architecture-driven-development`, `dsh-plugin`
- **Why use it:** Makes coding agents architecture-aware with baseline-first safety
...
- **Why use it:** Best context insight, dashboard, and management plugin for DSH
...
- **Tags:** `coding`, `agent`, `team`
- **Why use it:** Unify multiple coding agents into one collaborative team
...
- **Tags:** `coding-agent`, `orchestration`, `subagent`, `mcp`
- **Why use it:** Dispatch work to DSH agents from Claude Code/Codex with native subagent progress
...
- **Why use it:** Agent Skill for developing DSH plugins following standard conventions
...
- **Tags:** `spec-driven-development`, `agent-skills`, `ai-coding`
- **Why use it:** Portable spec-driven development skill for repository-native workflow
...
- **Tags:** `build-tools`, `dsh-plugin`, `agent-skill`
- **Why use it:** Build and configure DSH plugins with slots, credentials, and remote management
...
- **Why use it:** Official DSH plugin dev guide with multilingual docs archive
...
- **Why use it:** Centralized control over MCP tool and skill exposure levels
...
- **Why use it:** Practical DSH plugin development guide with real-world solutions
...
- **Why use it:** GUI plugin manager with hot reload, no restart required
...
- **Tags:** `ai-agents`, `oauth`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** OAuth-bind ChatGPT to chat via DSH with your subscription
...
- **Why use it:** Modern desktop solution for DSH where the desktop itself is a plugin
...
- **Tags:** `agent-workspaces`, `no-code`, `multi-device`
- **Why use it:** Unified multi-device workspace with board-based task tracking for agents
...
- **Tags:** `dsh-web`, `dsh-plugin`, `plugin-marketplace`
- **Why use it:** Web-based plugin aggregator for DSH with creative marketplace distribution
...
- **Why use it:** Claude Code-style TUI with whale topbar, streaming thoughts, and rollback support.
...
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop application.
...
- **Tags:** `desktop-pet`, `electron`, `mcp`, `dsh-plugin`
...
- **Why use it:** Lightweight Tauri desktop app with preset plugins, zero setup
...
- **⭐ Stars:** 828
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接��来你的dsh安装
- **Tags:** `floating-widget`, `plugin`, `dsh-plugin`
- **Why use it:** Cute whale widget tracking your DeepSeek account balance in DSH
...
- **Tags:** `desktop-app`, `electron`, `local-first`, `mcp`, `dsh-plugin`
...
- **Tags:** `desktop`, `agent`, `local-first`
...
- **Why use it:** Render interactive UI components inline in DSH replies
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite for DSH
...
- **Why use it:** Visual non-linear canvas workspace for conversation exploration
...
- **Why use it:** Full-featured Windows desktop client with SSH, plugins, and mobile remote access
...
- **Why use it:** Community plugin market directly in DSH Web GUI with one-click install/uninstall
...
- **Why use it:** Electron desktop console for multi-tab Harness, Plugin, MCP, and Skill management
...
- **Tags:** `deepseek-harness`, `desktop-app`, `dsh-plugin`
- **Why use it:** Container-based DSH manager with embedded WebView and one-click plugin import
...
- **Tags:** `canvas`, `dsh-plugin`
- **Why use it:** Infinite canvas with creative skills for visual brainstorming
...
- **Why use it:** All-in-one desktop app with DB, SSH, Docker panels and AI assistant
...
- **Why use it:** Electron desktop wrapper with integrated DSH plugins
...
- **Why use it:** Open-source LLM knowledge platform with RAG, Wiki, and reasoning
...
- **Why use it:** Portable, user-owned memory layer with Markdown-native local-first storage
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Markdown and Milvus.
...
- **Tags:** `dsh-plugin`
- **Why use it:** Provides unlimited memory for AI agents and conversations
...
- **Why use it:** Comprehensive AI knowledge base and skill encyclopedia
...
- **Why use it:** Curates SKILL.md files into retrievable agent-skill corpora with semantic search
...
- **Why use it:** Durable long-term memory with recall tools and inspectable storage for agents
...
- **Why use it:** External memory, recall, handoff and experience system
...
- **Why use it:** Original multi-agent swarm framework with workflow orchestration
...
- **Why use it:** Distill AI thinking patterns into reusable skills for any agent
...
- **Why use it:** Intelligently routes and orchestrates local skills across multi-agent workflows.
...
- **Tags:** `agent-skills`, `vision`, `computer-use`, `dsh-plugin`
...
- **Tags:** `vision-tools`, `ocr`, `gui-automation`, `dsh-plugin`
- **Why use it:** DSH-native vision toolkit: image Q&A, OCR, UI restoration in one line
...
- **Why use it:** AI-powered novel and short-drama writing toolkit with Oh Story integration
...
- **Tags:** `skills`, `agent`, `workflow`, `execution`
- **Why use it:** Turn repetitive experience into reusable execution skills for any LLM agent
...
- **Tags:** `vision`, `multimodal`, `agent-skills`, `claude-code`
- **Why use it:** Adds multimodal vision analysis to text-only LLMs, great for UI automation checks
...
- **Why use it:** Automatically search, install, and verify DSH plugins from GitHub via skill
...
- **Tags:** `image-generation`, `multi-model`, `creative`
- **Why use it:** Generate AI images directly in DSH chat using multiple models (Gemini, OpenAI)
...
- **Why use it:** Multi-source anime search plugin with Bangumi ratings, descriptions, and magnet links
...
- **Why use it:** Specialized skills for AI infra dev, optimization and debugging workflows
...
- **Tags:** `agent-workflow`, `dsh-plugin`
- **Why use it:** Agent workflow management plugin for DeepSeek Harness
...
- **Tags:** `ctf`, `security`, `reverse-engineering`, `dsh-plugin`
- **Why use it:** Complete RE and pentest skill with 85 SKILL.md for security research
...
- **⭐ Stars:** 66
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你�� AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `deepseek-harness`, `agent-skills`, `dsh-plugin`
- **Why use it:** AI coding mentor that scans projects, generates chapters, and reviews code
...
- **Tags:** `agent-skills`, `legal`, `visualization`, `diagram`
- **Why use it:** Legal visualization tool generating timelines and litigation diagrams from case files
...
- **Tags:** `ocr`, `image-reading`, `vision`, `dsh-plugin`
- **Why use it:** OCR and image-reading skill with trained methodology for text-only models
...
- **Why use it:** Enables cross-agent session continuity and context recovery
...
- **Why use it:** WorkBuddy-style skill picker to quickly insert skills in composer
...
- **Why use it:** Codex-adapted skill for automated code simplification
...
- **Why use it:** Fusion of Bazi, Fengshui, IChing and TCM into an AI skill
...
- **Why use it:** Multi-agent team collaboration with shared workspace and independent models
...
- **Tags:** `agent-skills`, `dsh-plugin`
- **Why use it:** Comprehensive skill package manager with 42 skills for AI engineering
...
- **Tags:** `agent-skills`, `dsh-plugin`
- **Why use it:** Version-pinned Swift Cycle governance skill adapter for DSH
...
- **Tags:** `ai-docs`, `dsh-plugin`
- **Why use it:** Full Chinese official document workflow per GB/T 9704 national standard
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Engineering discipline portable skill for evidence-based development
...
- **Why use it:** Manage skills and MCPs with hot reload, no restart needed
...
- **Why use it:** Record macOS desktop workflows and convert to agent skills
...
- **Why use it:** Godot 4.x full-stack game dev skill for DSH agents
...
- **Why use it:** Math modeling toolkit with 17 hand-crafted skill cards
...
- **Tags:** `gamification`, `skills`, `tasks`
- **Why use it:** Game-like task bar quest system powered by mattpocock skills
...
- **Tags:** `run-to-skill`, `local-first`, `agent-skills`
- **Why use it:** Local-first DSH plugin to convert runs into reusable skills
...
- **Tags:** `agent-preset`, `product-management`, `ai-agents`, `dsh-plugin`
- **Why use it:** Simulate a full product team in conversation workflows
...
- **Tags:** `agent-tools`, `llm-agents`, `deepseek-harness`
- **Why use it:** Pre-flight plugin check to boost library utilization predictably
...
- **Tags:** `design-systems`, `figma-alternative`, `dsh-plugin`
- **Why use it:** Best DSH design plugin, open-source Figma alternative
...
- **Tags:** `diagram-as-code`, `agent-skills`, `dsh-plugin`
- **Why use it:** Agent skill for generating beautiful verifiable architecture diagrams
...
- **Tags:** `image-prompts`, `prompt-engineering`, `gpt-image-2`
- **Why use it:** 530+ reverse-engineered image prompts with industrial templates for GPT-Image2
...
- **Tags:** `vibedesign`, `flutter`, `design-as-code`
...
- **Tags:** `video-generation`, `ffmpeg`, `vox`
- **Why use it:** End-to-end automated Vox-style paper-collage explainer video generation via ffmpeg.
...
- **Tags:** `ai-design`, `design`, `ppt`
- **Why use it:** AI-powered design system with PPT and prototyping studio
...
- **Tags:** `design`, `ui-design`, `openpencil`, `prototyping`
- **Why use it:** Preview, inspect, and edit OpenPencil .op design files directly within DSH conversations
...
- **Why use it:** 6 design style presets to eliminate generic AI-generated look from websites
...
- **Tags:** `media`, `image-generation`, `vision`, `agent-skills`
- **Why use it:** Image reading and generation skills with vision transcription for DSH
...
- **Tags:** `ai-director`, `dsh-plugin`
- **Why use it:** AI video/image/audio skills with DirectorX integration for creatives
...
- **Tags:** `visualization`, `token-usage`, `cost`
...
- **Why use it:** Browser extension suite enhancing major AI web UIs including DeepSeek
...
- **Tags:** `content-discovery`, `bilibili`, `xiaohongshu`, `cross-platform`
- **Why use it:** Local-first cross-platform content discovery agent for major Chinese and global platforms.
...
- **Tags:** `browser-extension`, `chatgpt`, `productivity`, `dsh-plugin`
- **Why use it:** Browser extension turning AI chats into organized reusable workflows
...
- **Why use it:** Tabbit Browser automation plugins with Playwright integration for DSH
...
- **Why use it:** OAuth-based group photo wall for DSH community events
...
- **Why use it:** Privacy-first resume builder, secure and self-hostable
...
- **Why use it:** Open-source AI low-code platform for fast business system building
...
- **Tags:** `vfs`, `agent-sandbox`, `virtual-filesystem`
- **Why use it:** Unified virtual filesystem for AI agents across Python and TypeScript
...
- **Why use it:** One-click multi-model switch utility covering Claude, Codex, DeepSeek, etc.
...
- **Tags:** `marketplace`, `plugin`, `deepseek-harness`
- **Why use it:** Official DSH plugin marketplace with one-click install and visual browsing.
...
- **Why use it:** OAuth integration to use ChatGPT/Claude/Grok subscriptions as providers
...
- **Why use it:** Live iOS Simulator automation directly inside DSH conversations
...
- **Tags:** `cost-tracking`, `token-usage`, `billing`
- **Why use it:** Track session and daily token costs with budget alerts across providers
...
- **Tags:** `compatibility`, `migration`, `ecosystem-bridge`
- **Why use it:** Bridges Pi and DSH ecosystems — run unmodified Pi extensions as native DSH plugins
...
- **Tags:** `notes`, `productivity`, `docker`, `smartisan`
- **Why use it:** Open-source Smartisan-style notes with Docker deployment, multi-tenant support and WeChat export
...
- **Tags:** `plugin-marketplace`, `dsh-plugin`, `javascript`
...
- **Tags:** `context-migration`, `preset-migration`, `dsh-plugin`
- **Why use it:** Cross-preset session migration preserving state and model intent safely
...
- **Tags:** `backup`, `crash-recovery`, `undo`, `windows`
- **Why use it:** Crash-rescue with undo, snapshots, SAFE MODE and offline CLI/GUI support
...
- **Tags:** `console`, `plugin-management`, `ui`, `dsh-plugin`
- **Why use it:** Plugin infrastructure with console, UI panel manager, and dev guide
...
- **Why use it:** Backup, restore, migrate and sync entire DSH configuration via WebDAV
...
- **Tags:** `utility`, `deepseek-harness`, `plugin`
...
- **Tags:** `deepseek-harness`, `plugin-manager`, `registry`, `discovery`
- **Why use it:** Merged registry for DSH plugin discovery
...
- **Why use it:** CLI tool for DSH plugin install and management
...
- **Tags:** `mascot`, `pixel-art`, `claude-code`
- **Why use it:** Animated pet mascots gallery for coding agents, personalized UI flair
...
- **Why use it:** Whale Girl skin series specifically designed for DeepSeek Harness UI.
...
- **Tags:** `theme`, `ui`, `glass`
- **Why use it:** Frosted glass theme with full customization for DSH
...
- **Why use it:** WebGPU-powered ocean-themed skin with Three.js visual effects
...
- **Tags:** `theme`, `dsh-plugin`
- **Why use it:** 34 classic opencode themes with one-click DSH skin switching
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `webui`, `theme`
- **Why use it:** Personalize DSH web UI with custom backgrounds and presets
...
- **Tags:** `ai-resources`, `vibe-coding`, `rag`
- **Why use it:** Comprehensive AI resource hub with tutorials and prompt library
...
- **Why use it:** Auto-searches 8 major Chinese platforms for the last 30 days and generates cited reports.
...
- **Why use it:** Curated bilingual plugin and tool reference library
...
- **Why use it:** Daily curated plugin discovery with scenario-based classification
...
- **Why use it:** Strongest free web search bridge for all DSH models
...
- **Tags:** `docs`, `learning`, `guide`
- **Why use it:** Learn DSH principles with marketplace and best practices guide
...
- **Tags:** `guide`, `awesome-list`, `beginner`
- **Why use it:** Ultimate bilingual DSH quickstart guide with curated resources
...
- **Tags:** `ai-agents`, `api-documentation`, `chinese-api`, `research-tools`
...
- **Tags:** `deepseek-harness-plugin`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Public plugin directory with install commands and ecosystem map
...
- **Tags:** `deepseek-harness`, `industry`, `dsh-plugin`
- **Why use it:** Industry-specific DSH plugins for finance, law, HR
...
- **Why use it:** Curated meta-list of all DSH plugins, ideal for discovery and exploration
...
- **Tags:** `toy`, `web-simulation`, `mobile-first`
- **Why use it:** Zero-dependency web sim of a traditional Chinese toy with real audio sampling.
...
- **Why use it:** Curated DSH plugin radar with 9000+ candidates and top 50 picks
...
- **Why use it:** Curated DSH plugin ecosystem list and resource hub
...
- **Tags:** `awesome-list`, `plugin-registry`, `dsh-plugin`
- **Why use it:** Curated DSH plugin ecosystem directory and index
...
- **Why use it:** Comprehensive curated list covering DSH plugins, MCP servers, and tools
...
- **Tags:** `marketplace`, `plugin-hub`, `deepseek-harness`
- **Why use it:** Plugin marketplace and directory for DeepSeek Harness ecosystem
...
- **Tags:** `agents`, `awesome`, `deepseek`, `dsh-plugin`
- **Why use it:** Curated DSH plugin resource list for productivity and development
...
- **Tags:** `awesome`, `dsh-plugin`, `awesome-list`
...
- **Why use it:** Curated, evidence-led DSH plugin directory with verified entries
...
- **Tags:** `plugin-portal`, `static-site`, `deepseek-harness`, `web`
- **Why use it:** Zero-dependency static portal to browse and install plugins
...
- **Why use it:** Redirect notice — moved to new repo
...
- **Tags:** `search`, `discoverability`, `deepseek-harness`
- **Why use it:** Search npm and awesome lists directly from DSH agents
...
- **Tags:** `awesome-list`, `ai-agents`, `mcp`, `deepseek-harness`
...
- **Why use it:** General DSH plugin repository list
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple Chinese DSH plugin collection
...
- **Why use it:** Auto-crawled bilingual DSH plugin catalog
...
- **Why use it:** Comprehensive DSH plugin registry for models and tools
...
- **Why use it:** 70+ verified DSH plugins organized by function
...
- **Tags:** `deepseek-harness`, `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ DSH tools sorted by popularity

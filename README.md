...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,033,387 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-16 05:51:33 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225,699 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,421 | Local-first design tool with AI-generated UI and p |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,571 | Multi-agent swarm orchestration for autonomous wor |
...
- **Tags:** `agentic-ai`, `multi-agent`, `dsh-plugin`
- **Why use it:** Multi-agent swarm orchestration for autonomous workflows
...
- **Why use it:** Self-evolving multi-agent system with memory and skills
...
- **Why use it:** Excellent beginner guide to harness engineering from scratch
...
- **Tags:** `agent-workspace`, `enterprise`, `multi-engine`
...
- **Tags:** `agent-control-plane`, `long-horizon`, `workflow`
- **Why use it:** Long-horizon agent control plane for durable governed work
...
- **Tags:** `marketplace`, `dsh-plugin`, `install`
...
- **Tags:** `preset`, `bootstrap`, `agent-config`
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tools integration
...
- **Tags:** `terminal`, `vfs`, `virtual-filesystem`
- **Why use it:** World's first virtual terminal with VFS support for AI agent workflows
...
- **Tags:** `model-switch`, `claude-code`, `codex`
- **Why use it:** One-click model switcher across Claude Code, Codex, Grok, DeepSeek, Kimi
...
- **Tags:** `taskboard`, `cli`, `coding`
- **Why use it:** Modern flexible task panel embeddable with Codex and DeepSeek Harness
...
- **Why use it:** Official TUI plugin with real-time status, streaming thought, and Esc rollback
...
- **Tags:** `agent-teams`, `agentic`, `harness`
...
- **Why use it:** Vision toolkit enabling image Q&A and OCR for text-only LLMs
...
- **Why use it:** AI security offense & defense platform auditing AI-generated code for hallucinated packages and vulnerabilities
...
- **Why use it:** Coding agent with RPC sub-agents, hashline edits, and MCP integration for CLI workflows
...
- **Tags:** `plugin-creator`, `codex`
- **Why use it:** Build and validate DSH plugins with reusable Codex skill
...
- **Tags:** `workbench`, `plugin`, `platform`
...
- **Tags:** `launcher`, `orchestration`, `kernel`
- **Why use it:** Unlocks DSH plugin kernel: unifies Runtime, Provider, Plugin, Skill, and MCP orchestration.
...
- **Why use it:** Agent Skill for developing DSH plugins: standards for services, events, tools, and bundling.
...
- **Why use it:** Fast, simple, and elegant Neovim plugin manager
...
- **Tags:** `agent-tools`, `awesome-dsh-plugin`, `automation`
...
- **Tags:** `web-ui`, `plugin-aggregation`
- **Why use it:** Web-based plugin ecosystem aggregator with creative distribution
...
- **Why use it:** Lightweight Tauri desktop with zero-setup installer
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, projects, web research, and Office artifacts
...
- **Tags:** `desktop`, `windows`, `gui`
- **Why use it:** Windows GUI client with zero-setup installer, SSH, mobile remote access, and plugin system
...
- **Why use it:** Generates interactive UI components inline—charts, plots, forms, and quizzes via dsh-ui fence
...
- **Why use it:** Local-first multi-model desktop app with self-evolving skills and privacy-first MCP architecture
...
- **Why use it:** Brings full office suite—spreadsheets, docs, slides, canvases—to DeepSeek Harness desktop.
...
- **Tags:** `mobile`, `ios`, `native-app`
- **Why use it:** Native iOS app connecting via WebSocket — workspaces, sessions, and agent traces on the go.
...
- **Tags:** `desktop`, `electron`, `ui-client`
- **Why use it:** CodePilot-inspired desktop client with plugin suite for macOS, Windows, and Linux.
...
- **Tags:** `dsh-plugin`, `notes`, `smartisan`, `docker`
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Web UI panel for managing skills and MCP tools visually
...
- **Why use it:** One-click install/uninstall plugins from Web GUI marketplace
...
- **Tags:** `ui`, `info-bar`, `balance`
- **Why use it:** Shows provider, balance, pricing with countdown in one bar
...
- **Tags:** `desktop`, `devops`, `docker`, `ssh`, `database`
- **Why use it:** All-in-one DevOps desktop with DB, SSH, Docker, AI
...
- **Why use it:** Electron desktop wrapper integrating DSH web services
...
- **Why use it:** Open-source RAG knowledge platform with semantic search
...
- **Tags:** `agent-memory`, `hybrid-retrieval`, `token-optimization`
...
- **Tags:** `agent-memory`, `stateful-agents`, `continual-learning`
...
- **Why use it:** Memory management kit: Remember Me, Refine Me — essential for agent persistence
...
- **Tags:** `memory`, `long-term-memory`, `personal-ai`
- **Why use it:** Shared persistent memory hub across all AI agents
...
- **Tags:** `skill-corpus`, `rhetrieval`, `agent-memory`
- **Why use it:** Transforms SKILL.md files into retrieval-ready agent-skill corpora with evaluation tooling
...
- **Tags:** `knowledge-base`, `encyclopedia`, `ai-pedia`
...
- **Why use it:** Auto-updating bilingual plugin directory with YAML automation.
...
- **Why use it:** Evidence-led immutable commit reviews for reliable plugin discovery.
...
- **Why use it:** Simple bilingual DSH plugin list for quick reference.
...
- **Why use it:** Most comprehensive skill store with auto-synced GitHub projects
...
- **Tags:** `skills`, `routing`, `workflow`
- **Why use it:** Intelligent skill routing with +21pp reward improvement on SkillsBench
...
- **Tags:** `video-generation`, `skill`, `ffmpeg`
- **Why use it:** Automated Vox-style explainer video generation pipeline
...
- **Tags:** `novel-writing`, `creative-writing`, `local-first`
- **Why use it:** End-to-end novel writing workflow with character/world management
...
- **Why use it:** Gives AI agents video/audio/screenshot observation with timestamped evidence and verification.
...
- **Tags:** `task-management`, `agent-workflow`, `native-ui`
- **Why use it:** Native SQLite-backed task board with agent claim/review workflow and pure Web UI.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `mcm`, `automation`
...
- **Tags:** `agent-skills`, `skills`, `dsh`, `coding`
- **Why use it:** Turn experience into repeatable execution across major AI agents.
...
- **Tags:** `agent-skills`, `research`, `marketing`, `deepseek-harness`
...
- **Tags:** `agent-skills`, `dsh-plugin`, `plugin-discovery`
- **Why use it:** Skill to discover, install, and verify DSH plugins from GitHub.
...
- **Tags:** `agent-skills`, `vision`, `multimodal`, `deepseek`
- **Why use it:** Multimodal vision skill for screenshot/UI/chart analysis on text LLMs.
...
- **Tags:** `dsh-plugin`, `skills`, `ai-infra`, `agent-skills`
...
- **Why use it:** Converts successful sessions into reusable agent skills automatically
...
- **Why use it:** Superpowers skill port optimized for Reasonix coding harness
...
- **Tags:** `bioinformatics`, `desktop`, `agent`
- **Why use it:** Specialized bioinformatics agent desktop for clinicians
...
- **Why use it:** Multi-agent collaboration with shared workspace and independent skills
...
- **Why use it:** Engineering discipline guard: grill requirements and verify delivery
...
- **Why use it:** Professional QA testing framework with 11 skills and shared KB
...
- **Why use it:** Adapted skill for finding and applying code simplifications
...
- **Why use it:** WorkBuddy-style skill picker for quick skill insertion in DSH composer
...
- **Why use it:** Cross-platform agent handoff skill preserving session memory and context
...
- **Why use it:** Official SkillHub API with examples and DSH plugin for skill discovery
...
- **Why use it:** Persistent multi-agent team with private memory, notes, and skills across sessions.
...
- **Why use it:** 5-role multi-agent math modeling solver with 33 model library and paper templates.
...
- **Tags:** `evaluation`, `benchmark`, `observability`
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, skills, and agents across platforms.
...
- **Tags:** `academic-search`, `mcp`, `agent-skills`, `research`
...
- **⭐ Stars:** 29
- **Language:** TypeScript
- **Description:** 一键配置各类 AI Agent 工���的 MCP、Skills 和规则；支持 Claude Code、Codex、DeepSeek Harness、OpenCode、Cursor、Gemini CLI、Qwen Code 等。 One-click local setup for MCP servers, skills, and rules across AI coding agents.
- **Tags:** `mcp`, `config-sync`, `multi-agent`
- **Why use it:** One-click MCP/Skill config sync across Claude, Codex, Cursor, DSH and more
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live MCP mirroring.
...
- **Why use it:** Browser-based Skills and MCP server manager integrated into DSH Web UI settings.
...
- **Tags:** `agent-skills`, `ui-generator`, `dsh-plugin`
- **Why use it:** Local-first design tool with AI-generated UI and prototyping
...
- **Tags:** `agent-skills`, `architecture-diagram`, `dsh-plugin`
- **Why use it:** Beautiful architecture and workflow diagrams as code
...
- **Why use it:** 530+ image generation prompts with reusable skill templates
...
- **Why use it:** Enables text-only models to read images via OCR and pixel analysis
...
- **Why use it:** AI video/image/audio creation with storyboard and knowledge corpus
...
- **Why use it:** 6 design style presets (dark-saas, Apple-minimal, neo-neu...) to avoid generic AI aesthetics.
...
- **Tags:** `data-visualization`, `ai-cost`, `deepseek-api`
...
- **Tags:** `dsh-plugin`, `knowledge-cards`, `ui`
...
- **Why use it:** Enhancement suite for Gemini, Claude & ChatGPT browser interfaces
...
- **Why use it:** Local-first cross-platform AI agent discovering content from Bilibili, YouTube, etc.
...
- **Tags:** `browser-automation`, `web-use`, `agent`
- **Why use it:** Use real logged-in browser for AI agent web automation
...
- **⭐ Stars:** 487
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，���费免注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `free`, `no-signup`
- **Why use it:** Strongest free web search plugin for DSH; bridges non-native web access for all models
...
- **Why use it:** Persistent browser identity with fingerprint spoofing, Android emulation, and Playwright integration.
...
- **Why use it:** Tabbit Browser automation integration with Playwright for DSH
...
- **Tags:** `electron`, `image-uploader`, `dsh-plugin`
...
- **Tags:** `no-code`, `internal-tools`, `dsh-plugin`
...
- **Why use it:** Runtime injector + task-aware router kit for intelligent routing
...
- **Why use it:** First vision bridge enabling OCR and image-to-structured-JSON for coding agents
...
- **Why use it:** Self-hosted plugin radar with 15900+ indexed candidates
...
- **Why use it:** Context insight dashboard with browser and sidebar views
...
- **Why use it:** CLI and resolver tools for DSH Plugin Hub — manage plugins from the terminal efficiently.
...
- **Why use it:** Tracks session and daily token costs, budget alerts, and multi-provider balance monitoring.
...
- **Why use it:** Adds Command Code LLM provider to DSH with live catalog, plan-aware selection, and reasoning effects.
...
- **Tags:** `dsh-plugin`, `agent-review`, `plan-mode`, `self-evolving`
- **Why use it:** Enables composable task controls and self-evolving agent workflows.
...
- **Tags:** `dsh-plugin`, `remote-access`, `p2p`, `multi-device`
- **Why use it:** Secure P2P remote access to DSH from PC, Android, and Web.
...
- **Why use it:** Auto-upgrades plugins when DSH version changes seamlessly
...
- **Tags:** `config-manager`, `backup`, `restore`
- **Why use it:** Backup, restore and sync all DSH configs via WebDAV
...
- **Why use it:** Audit and visualize context injection, detect token costs and conflicts
...
- **Tags:** `container`, `management`, `devops`
...
- **Tags:** `tts`, `text-to-speech`, `xiaomi-mimo`
- **Why use it:** Integrates free Xiaomi MiMo TTS for text-to-speech
...
- **Tags:** `plugin-conflict`, `version-management`, `utility`
- **Why use it:** Resolves plugin conflicts and version compatibility
...
- **Why use it:** DSH version of CodeX-style plugin marketplace for skill discovery
...
- **Why use it:** OAuth bridge to ChatGPT models inside DSH with subscription support
...
- **Why use it:** Public gallery of animated mascots for multiple AI coding tools
...
- **Why use it:** Cute whale girl skin series for DSH desktop UI
...
- **Why use it:** Glassmorphism theme with adjustable blur, opacity, and custom wallpaper for DSH web UI
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单���受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `customization`, `themes`
- **Why use it:** Customize DSH web background with images and effects
...
- **Tags:** `ai-guide`, `resources`, `tutorials`
...
- **Why use it:** Curated DSH plugin discovery list, essential starting point
...
- **Why use it:** Model-agnostic inference-time control for deep reasoning and long-horizon verification
...
- **Why use it:** Turn code into clear technical docs and AI-ready context for human teams
...
- **Why use it:** Auto-searches 8 major CN platforms for research reports
...
- **Tags:** `finance`, `mcp`, `multi-agent`, `research`, `deepseek-harness`
- **Why use it:** Local financial DB with tushare, multi-agent analysis and IM alerts.
...
- **Tags:** `industry-research`, `report`, `research`
...
- **Why use it:** Interactive K-line analysis with technical indicators and news, displayed natively in sidebar.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin navigation guide with installation and compatibility info
...
- **Tags:** `awesome-list`, `ai-curated`, `mcp`
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** DSHA selected plugin collection from official ecosystem team
...
- **Why use it:** Auto-crawled daily via GitHub Actions, bilingual catalog
...
- **Tags:** `awesome-list`, `plugin-registry`, `research`
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for testing
...
- **Tags:** `awesome-list`, `static-site`, `web-portal`
- **Why use it:** Static web portal for browsing 227+ curated DSH plugins
...
- **Why use it:** Search npm + curated list directly from inside DSH agents
...
- **Tags:** `dsh-plugins`, `ecosystem`
- **Why use it:** Diverse DSH plugin ecosystem collection and analytics
...
- **Why use it:** Original awesome-dsh-plugins repo, now redirects to new home
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `directory`
...
- **Tags:** `plugin-market`, `dsh`, `community`
- **Why use it:** Daily refreshed comprehensive DSH plugin marketplace with community reviews
...
- **⭐ Stars:** 340
- **Language:** JavaScript
- **Description:** 30 ��找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `discovery`, `plugin-curator`
- **Why use it:** Curated plugin discovery with daily GitHub scraping, categorization, and popularity rankings.
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCP servers, patches, and UIs.
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, curated plugins, and toolkit recommendations.
...
- **Why use it:** Great for learning DSH principles and exploring the plugin marketplace.
...
- **Tags:** `awesome-list`, `marketplace`, `catalog`, `dsh-plugin`
- **Why use it:** Comprehensive plugin marketplace with 11,000+ plugins and free API.
...
- **Tags:** `handbook`, `agent-runtime`, `mcp`, `deepseek-harness`
- **Why use it:** Agent-first handbook with 173 source-backed guides on runtime and MCP.
...
- **Tags:** `catalog`, `awesome-list`, `dsh-plugin`, `plugin-marketplace`
- **Why use it:** Plugin catalog with 1958 repos, 1819 real plugins, multilingual search.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated awesome list of all DSH plugins in one place
...
- **Why use it:** Meticulously curated DSH plugins, tools and dev resources list
...
- **Why use it:** Community-maintained plugin marketplace with 4-hour auto-sync
...
- **⭐ Stars:** 56
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，直接读案件材料画准一张时间轴，并提供庭前三大法宝（大事记表、庭审对抗图、���律关系图）。Claude Skill / DeepSeek Harness 通用。
...
- **Why use it:** Curated plugin list for DSH with descriptions and tags.
...
- **Why use it:** Comprehensive awesome list covering plugins, tools, skills, and resources for DSH.
...
- **Why use it:** Curated registry of verified DSH plugins and skills
...
- **Why use it:** Evidence-led curated directory with verified plugins
...
- **Why use it:** Curated vertical list of stock/finance/quant plugins
...
- **Tags:** `awesome-list`, `directory`, `deepseek-harness`
- **Why use it:** Comprehensive awesome list of 1000+ DSH tools sorted
...
- **Tags:** `awesome-list`, `curated`, `deepseek-harness`
- **Why use it:** Useful curated collection of DSH plugins

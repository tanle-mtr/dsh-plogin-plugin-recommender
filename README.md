...
|--------|-------|
| **Plugins tracked** | 195 |
| **Total community stars** | 954,062 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-02 23:09:11 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 209,551 | Core platform enabling everything-as-plugin agent  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,619 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,248 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Core platform enabling everything-as-plugin agent extensibility
...
- **Tags:** `multi-agent`, `memory`, `dsh-plugin`
...
- **Why use it:** Enterprise-grade multi-engine agent workspace with visual editor
...
- **Tags:** `vision`, `ocr`, `dsh-plugin`, `multimodal`
- **Why use it:** First vision plugin enabling image-to-text for text-only coding agents via structured JSON output.
...
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for reliable agent setup.
...
- **Tags:** `virtual-terminal`, `sandbox`, `vfs`, `dsh-plugin`
- **Why use it:** World's first virtual terminal providing isolated sandboxed environments for AI agents.
...
- **Why use it:** One-click multi-model switch supporting Claude Code, Codex, Grok, DeepSeek, Kimi, Qwen, and more.
...
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop app for agentic coding workflows.
...
- **Tags:** `code-review`, `static-analysis`, `quality`
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, and UI restoration.
...
- **Why use it:** Coding agent with NPC plugin, sub-agents and MCP support.
...
- **Why use it:** Standards-based plugin dev skill for DSH/Cordis, works with Claude Code and Codex.
...
- **Why use it:** Portable spec-driven development skill for repository-native coding workflows.
...
- **Tags:** `plugin-development`, `knowledge-base`, `cordis`
- **Why use it:** Official DSH plugin dev docs archive as installable knowledge base agent skill.
...
- **Why use it:** Reusable Codex skill for building and validating DeepSeek Harness plugins.
...
- **⭐ Stars:** 15
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件开发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。��于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型适配器、工具注册表、Agent 循环、网页界面都是插件
...
- **Why use it:** Portable skill for developing and auditing DSH plugins offline
...
- **Why use it:** Pre-flight plugin check for predictable agent tool usage
...
- **Tags:** `design-systems`, `dsh-plugin`, `desktop-app`
...
- **Why use it:** Modern flexible task panel embeddable in Codex and DeepSeek Harness with real-time management.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thoughts, rollback, and real-time TPS display.
...
- **Tags:** `desktop`, `tauri`, `workspace`
- **Why use it:** Local-first desktop workspace for DSH with projects, files, and Office artifacts.
...
- **Tags:** `gui`, `interactive`, `charts`, `forms`
...
- **Why use it:** Local-first desktop app alternative with multi-model and self-evolving skills
...
- **Why use it:** Visual non-linear canvas workspace for conversation branching and exploration
...
- **Why use it:** Open-source Windows desktop client with Codex, SSH, and mobile remote access
...
- **Why use it:** Full desktop client with plugin suite for DSH on all platforms.
...
- **Tags:** `ui`, `plugin-market`, `webui`
- **Why use it:** Web GUI plugin market for browsing and installing DSH plugins with one click.
...
- **Why use it:** Electron desktop hub for multi-tab management of Harness, plugins, MCP and Skills.
...
- **Tags:** `dsh`, `desktop`, `container`
- **Why use it:** Local DSH manager with isolated containers, embedded WebView UI, and one-click plugin import.
...
- **Tags:** `ui`, `info-bar`, `pricing`, `usage-tracking`
- **Why use it:** Live model/balance/pricing info bar with persistent display
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理��上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `webui`, `customization`
- **Why use it:** Web UI background customization with presets and upload support
...
- **Tags:** `ui`, `button`, `dsh-plugin-market`
- **Why use it:** One-click compact context button for DSH Web UI
...
- **Why use it:** Open-source LLM knowledge platform with RAG, reasoning agent and Wiki
...
- **Why use it:** Portable local-first memory layer for AI agents across platforms
...
- **Why use it:** Dedicated memory management kit helping agents remember and refine context over time.
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus for cross-agent semantic search.
...
- **Tags:** `agent-memory`, `embeddings`, `vector-search`, `skill-routing`
- **Why use it:** Transforms SKILL.md files into retrieval-ready corpora with evaluation
...
- **Tags:** `search`, `discoverability`, `agent`
- **Why use it:** In-agent plugin search and discovery tool
...
- **Why use it:** Unified agent workspace accessible across all devices and platforms
...
- **Why use it:** Task-aware reasoning-mode router for agent orchestration
...
- **Why use it:** Most comprehensive skills marketplace with auto-updating packages
...
- **Why use it:** Self-improving agent OS with loop engineering framework
...
- **Tags:** `long-horizon`, `agent-control`
- **Why use it:** Long-horizon agent control plane for durable multi-agent workflows
...
- **Tags:** `skills`, `workflow`, `orchestration`, `vibe-coding`
- **Why use it:** Intelligent skill routing and workflow orchestration, improving reward by 21pp and cutting tokens 30%.
...
- **Tags:** `cognitive`, `skills`, `agent-skills`, `dsh-plugin`
- **Why use it:** Cognitive-enhancement skills based on Anthropic J-space global workspace research for AI agents.
...
- **Tags:** `agent-teams`, `workflow`, `collaboration`
- **Why use it:** Enables multi-agent team collaboration within the DeepSeek Harness environment.
...
- **Why use it:** Creative writing and short-drama production skill powered by AI.
...
- **Tags:** `self-evolving`, `agent-review`, `prompt-engineering`
...
- **Tags:** `plugin-discovery`, `skill`, `installation`
...
- **Why use it:** Port of Superpowers skill to Reasonix coding harness for enhanced agent abilities.
...
- **Tags:** `agent-skill`, `mentor`, `coding`
- **Why use it:** AI coding agent skill that transforms assistant into a mentor with code review.
...
- **Why use it:** Auto-convert successful DSH sessions into reusable and reviewable Agent Skills.
...
- **Tags:** `skills`, `agent`, `dsh-better-sidebar`
- **Why use it:** Unofficial Matt Pocock skills deck integrated into DSH with wayfinder maps and 25 skills.
...
- **Tags:** `agent-skill`, `dsh-plugin`, `credentials`
- **Why use it:** Agent skill managing installed DSH plugins including slots, remotes, and credentials.
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `agent`
- **Why use it:** Chinese traditional wisdom skills: Bazi, Fengshui, IChing, TCM with local deterministic engine.
...
- **Why use it:** Full workflow Chinese official document processing following GB/T 9704 national standard.
...
- **Tags:** `multi-agent`, `team`, `deepseek-harness`
- **Why use it:** Multi-agent collaboration with independent models, skills, and shared workspace per agent.
...
- **Tags:** `skills`, `manager`, `deepseek-harness`
- **Why use it:** Centralized skill management for safe local agent skill loading
...
- **Tags:** `mcp`, `skills`, `config-sync`, `multi-agent`
- **Why use it:** One-click MCP/skills config across 7+ AI agent platforms
...
- **Tags:** `skills`, `picker`, `composer`
- **Why use it:** WorkBuddy-style skill picker for quick skill insertion in composer
...
- **Why use it:** Cross-platform session memory skill for agent continuity handoffs
...
- **Tags:** `code-simplification`, `skills`, `codex`
- **Why use it:** Code simplification skill adapted from official DSH skill set
...
- **Why use it:** 6 design aesthetic styles to prevent generic AI-generated website looks
...
- **Tags:** `qa`, `testing`, `skills`, `pytest`
- **Why use it:** 10 QA skills with shared knowledge base and type decision matrix
...
- **Tags:** `agent`, `skills`, `cli`, `package`
- **Why use it:** 42 skills + 5 CLIs package for AI agent engineering and eval-driven dev
...
- **Tags:** `media`, `image`, `vision`, `skills`
...
- **Tags:** `video`, `audio`, `directorx`, `media`
- **Why use it:** AI video/image/audio skills with configurable models and knowledge corpus
...
- **Why use it:** Enables full-stack Godot 4.x game dev skills for AI agents
...
- **Why use it:** Swift Cycle governance skill for structured agent project management
...
- **Why use it:** Virtual product team agent preset with multi-role conversation
...
- **Why use it:** Search 65,600+ Chinese API docs from 20 platforms directly in your coding agent.
...
- **Tags:** `mcp`, `skills`, `web-ui`, `manager`
...
- **Tags:** `huawei-cloud`, `mcp`, `cloud`, `terraform`
...
- **Tags:** `diagram`, `architecture`, `dsh-plugin`
- **Why use it:** Beautiful architecture and sequence diagrams via code with HTML output
...
- **Why use it:** Industrial-grade image prompt engine with 530+ reverse-engineered cases
...
- **Why use it:** Open-source AI-native vector design tool with Agent Teams
...
- **Tags:** `image-generation`, `multi-model`, `visual`
...
- **Why use it:** Litigation visualization toolkit generating timelines and diagrams from case materials.
...
- **Tags:** `knowledge-cards`, `ui`, `design`
...
- **Tags:** `browser-extension`, `ai-tools`, `dsh-plugin`
- **Why use it:** Enhancement suite for Gemini, Claude and ChatGPT plus universal prompt manager
...
- **Tags:** `content-discovery`, `browser`, `multi-platform`, `dsh-plugin`
- **Why use it:** Cross-platform self-evolving content discovery agent covering Bilibili, YouTube, X, Reddit, and more.
...
- **Why use it:** Leverages your real logged-in browser for seamless AI agent web automation.
...
- **Why use it:** Live iOS Simulator integration with 22 agent tools for mobile automation
...
- **Why use it:** Tabbit Browser automation plugins extending DeepSeek Harness web capabilities.
...
- **Why use it:** ChatGPT OAuth integration for DSH conversations
...
- **Why use it:** DingTalk IM channel with agent tool capabilities
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services across platforms
...
- **Tags:** `marketplace`, `utility`, `plugin`, `dsh-plugin`
- **Why use it:** Built-in visual plugin marketplace for browsing, searching, and one-click installing DSH plugins.
...
- **Tags:** `ecosystem`, `registry`, `infrastructure`
- **Why use it:** Ecosystem radar scanning 15900+ candidates with k8s-validated plugin directory.
...
- **Why use it:** Comprehensive context dashboard and management for DeepSeek Harness sessions.
...
- **Tags:** `awesome-list`, `tools`, `ecosystem`
- **Why use it:** Curated collection of DSH plugins, tools, and infrastructure resources.
...
- **Tags:** `security`, `redteam`, `vulnerability`, `aisecurity`
- **Why use it:** AI security platform auditing hallucinated packages and vulnerabilities
...
- **Tags:** `oauth`, `subscription`, `infrastructure`
- **Why use it:** OAuth integration using ChatGPT/Claude/Grok subscriptions as LLM providers
...
- **Why use it:** Track session/daily costs, budget and token usage easily.
...
- **Tags:** `compatibility-layer`, `migration`, `bridge`
- **Why use it:** Bridge Pi ecosystem plugins to run natively on DSH seamlessly.
...
- **Tags:** `capability-menu`, `mcp`, `management`
...
- **Why use it:** Backup, restore, export and sync complete DSH configuration including MCP and skills.
...
- **Tags:** `plugin-management`, `registry`, `console`
- **Why use it:** Lightweight console for managing DSH repository plugins and official plugin dev guide.
...
- **Why use it:** OCR and pixel-to-text vision tools enabling image reading for text-only DSH models.
...
- **Tags:** `upgrade`, `dsh-plugin`, `automation`
- **Why use it:** Automatically upgrades DSH plugins to stay compatible with new DSH versions.
...
- **Why use it:** Context injection audit tool with token cost analysis, conflict detection, and Web UI panel.
...
- **Tags:** `migration`, `import`, `configuration`
- **Why use it:** Seamlessly migrate Claude Code config into DeepSeek Harness
...
- **Tags:** `visualization`, `cost`, `token-usage`
- **Why use it:** Real-time token usage dashboard with cost estimates and API balance
...
- **Tags:** `doctor`, `conflict-resolution`, `utilities`
- **Why use it:** Solves plugin conflicts and version compatibility issues
...
- **Why use it:** Animated pet gallery to personalize your coding agent experience
...
- **Tags:** `theme`, `skin`, `ui`, `dsh-plugin`
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness with cute anime aesthetic customization.
...
- **Why use it:** High-freedom glassmorphism theme with adjustable blur and wallpaper
...
- **Why use it:** One-click swap for 34 classic opencode color themes with persistence
...
- **Why use it:** Curated plugin list for DSH ecosystem exploration
...
- **Why use it:** Curated bilingual plugin directory for DSH discovery
...
- **Tags:** `knowledge-base`, `encyclopedia`, `ai-resources`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, and MLOps
...
- **Why use it:** Daily automated plugin discovery with curated classifications and rankings
...
- **Why use it:** Learn DSH principles, explore marketplace and best practices.
...
- **Tags:** `marketplace`, `plugin-store`, `api`
- **Why use it:** Plugin marketplace hub with 11,000+ plugins and public API.
...
- **Why use it:** Comprehensive plugin catalog with 1958 repos and 1819 real plugins.
...
- **Tags:** `patent`, `analysis`, `legal-tech`
- **Why use it:** Patent infringement analysis system with skill packaging for any agent framework.
...
- **Tags:** `company-research`, `industry-research`, `cordis`
- **Why use it:** Industry research methodology with policy/news tracking and company analysis skills.
...
- **Tags:** `kline`, `finance`, `analysis`, `charting`
- **Why use it:** Interactive K-line analysis with multi-market, indicators, and fundamentals
...
- **Tags:** `evaluation`, `RAG`, `prompt-engineering`
- **Why use it:** Evidence-backed LLM evaluation framework with multi-judge ensemble support
...
- **Why use it:** Verified curated directory with installation guidance
...
- **Why use it:** Bilingual curated stock/finance plugin list
...
- **Why use it:** Comprehensive 1000+ DSH tools inventory sorted by stars
...
- **Tags:** `awesome-list`, `manual`, `guide`
- **Why use it:** Plugin manual with scenario-based selection and risk info
...
- **Tags:** `portal`, `static-site`, `discover`
...
- **Why use it:** AI-curated hourly-updated plugin recommendation list
...
- **Tags:** `resume`, `self-hosted`, `dsh-plugin`
- **Why use it:** Privacy-first resume builder, customizable and open-source forever free
...
- **Why use it:** Distilly — Distill how they think into reusable Skills for any Agent or Bot. For
...
- **Why use it:** DeepSeek Harness Tauri 桌面版 | Only 5mb installer, zero environment setup, preset 
...
- **Tags:** `armor-breaking`, `override`, `experimental`
- **Why use it:** Armor-breaking plugin for DeepSeek — bypasses limitations for extended usage.
...
- **Why use it:** Complete reverse-skill (87 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin —
...
- **Why use it:** Curated awesome list of DSH plugins, extensions, tools and development resources.
...
- **Why use it:** Community-maintained auto-syncing catalog of DeepSeek Harness plugins every 4 hours.
...
- **Why use it:** Unofficial community-curated plugin catalog for DSH ecosystem
...
- **Why use it:** Curated list of精选 DSH plugins for ecosystem discovery
...
- **Why use it:** Public GitHub directory for DSH plugins and install commands
...
- **Why use it:** Comprehensive curated awesome list for all DSH plugins and resources
...
- **Tags:** `dsh-bundle`, `plugin-registry`, `dsh-ecosystem`
- **Why use it:** DSH plugin bundle and ecosystem directory
...
- **Why use it:** Bilingual reviewed DSH plugin directory
...
- **Why use it:** Evidence-backed DSH plugin radar and registry
...
- **Why use it:** Original awesome-dsh-plugins repository (moved)
...
- **Tags:** `awesome-list`, `auto-updating`, `curated`
- **Why use it:** Auto-updating curated DSH plugin list with scripts
...
- **Why use it:** Comprehensive curated DSH plugins across 12 categories
...
- **Tags:** `awesome-list`, `curated`, `evidence-aware`

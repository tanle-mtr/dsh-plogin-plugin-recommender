...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 971,235 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-05 21:03:32 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 213,085 | DeepSeek Harness: Everything is a Plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,271 | 🎨 Best DeepSeek Harness Design Plugin.  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,662 | 🌊 The original agent meta-harness. Depl |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 15 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 23 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 8 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 39 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 6 plugins
- [Visual & Design](#visual-&-design) — 6 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 4 plugins
- [Communication & Social](#communication-&-social) — 1 plugins
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 20 plugins
- [Themes & Skins](#themes-&-skins) — 3 plugins
- [Research & Analysis](#research-&-analysis) — 22 plugins
- [Other](#other) — 49 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (15)
- [UI & Desktop Extensions](ui-desktop-extensions) (23)
...
- [Research & Analysis](research-analysis) (22)
- [Other](other) (49)
---
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `harness`
- **Why use it:** First vision plugin for DSH, enables image-to-JSON for text-only agents
...
- **Tags:** `model-switch`, `claude`, `codex`, `grok`
- **Why use it:** One-click model switch between Claude Code, Codex, Grok, DeepSeek, Kimi
...
- **Tags:** `runtime`, `rust`, `desktop`, `agent`
- **Why use it:** High-performance agent runtime in Rust with polished desktop app
...
- **Why use it:** Professional code review based on 12 classic engineering books
...
- **Why use it:** CLI and resolver for DSH Plugin Hub — install and manage plugins.
...
- **Tags:** `marketplace`, `dsh-plugin`, `webui`, `install`
- **Why use it:** One-click install/uninstall from community market. Great for plugin discovery.
...
- **Why use it:** Auto-upgrades skills with DSH version. Keeps your skills current automatically.
...
- **Tags:** `plugin-development`, `skill`, `coding`
- **Why use it:** Master skill for developing DSH plugins following official standards
...
- **Tags:** `plugin`, `slots`, `credentials`
- **Why use it:** Manage slots, Typert remotes and credentials for installed DSH plugins
...
- **Why use it:** Repository-native spec-driven development with portable agent skill support
...
- **Tags:** `plugin`, `creator`, `validation`
...
- **Why use it:** Official plugin development knowledge base with EN/ZH docs and Cordis primer
...
- **Tags:** `code-simplification`, `refactoring`, `coding`
- **Why use it:** Adapted code simplification skill from official DSH for smarter refactoring.
...
- **Why use it:** Fast, simple Neovim plugin manager written in Lua — lightweight and elegant.
...
- **Tags:** `dsh-web`, `dsh-web-ui`, `plugin-ecosystem`
- **Why use it:** Web-based plugin aggregation ecosystem for DeepSeek Harness
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `developer-tools`
- **Why use it:** Animated pet gallery adding personality to multiple AI coding agents
...
- **Tags:** `terminal`, `vfs`, `virtual`, `desktop`
...
- **Tags:** `task`, `panel`, `ui`, `codex`
- **Why use it:** Modern flexible embedded task panel supporting Codex and DSH
...
- **Tags:** `tui`, `terminal`, `claude-code`, `ui`
- **Why use it:** Claude Code style TUI with whale toolbar, real-time status, streaming
...
- **Why use it:** Cute floating whale widget monitors DeepSeek balance
...
- **Why use it:** Lightweight Tauri desktop, zero setup, cross-platform
...
- **Tags:** `desktop`, `workspace`, `local-first`
- **Why use it:** Local AI desktop workspace for DSH sessions and projects
...
- **Tags:** `genui`, `interactive-ui`, `charts`, `forms`, `inline-rendering`
- **Why use it:** GenUI renders interactive charts/forms inline within assistant replies
...
- **Tags:** `desktop-app`, `local-first`, `multi-model`, `privacy`
...
- **Tags:** `desktop`, `windows`, `ssh-client`, `remote-access`
- **Why use it:** Zero-setup Windows desktop client with plugins, SSH, and mobile remote access
...
- **Tags:** `canvas`, `workspace`, `branching`, `visual-conversation`
- **Why use it:** Canvas-based visual conversation workspace with branching session explorer
...
- **Why use it:** CodePilot-inspired desktop client for DSH on macOS/Windows/Linux.
...
- **Tags:** `ios`, `mobile`, `deepseek-harness`
- **Why use it:** Native iOS client with WebSocket connection for real-time agent tracking on iPhone
...
- **Why use it:** Smartisan-style note app with Docker deployment, skill integration, and WeChat export
...
- **Why use it:** Persistent bottom bar showing provider, model, balance and peak/off-peak pricing.
...
- **Why use it:** WorkBuddy-style skill picker with /skill-name command insertion in composer.
...
- **Why use it:** Bioinformatics agent desktop app built on Tauri — great for wet-lab scientists.
...
- **Tags:** `desktop-app`, `devops`, `docker`, `ssh`
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker, AI sandbox and Android control.
...
- **Tags:** `webui`, `background`, `theme`, `customization`
- **Why use it:** Customizable web background plugin with preset atmospheres and image upload.
...
- **Tags:** `webui`, `button`, `compact`
- **Why use it:** One-click compact button for the DSH Web context meter panel UI.
...
- **Tags:** `agent-memory`, `rag`, `memory-management`, `long-term-memory`
...
- **Tags:** `long-term-memory`, `rag`, `memory-management`, `skill-reuse`
...
- **Tags:** `memory`, `rag`, `knowledge`, `reme`
- **Why use it:** Memory management kit for agents: remember me, refine me
...
- **Tags:** `memory`, `milvus`, `rag`, `persistent`
...
- **Tags:** `context`, `memory`, `management`
- **Why use it:** Best context insight and management with dashboard
...
- **Tags:** `skill-corpus`, `retrieval`, `embeddings`, `vector-search`
...
- **Tags:** `context`, `audit`, `token-optimization`
- **Why use it:** Audit and optimize context tokens — detects duplicates, conflicts with Web UI dashboard.
...
- **Tags:** `agent-orchestration`, `no-code`, `multi-device`, `agent-workspaces`
...
- **Tags:** `routing`, `dsh-plugin`, `agent-control`
- **Why use it:** Task-aware reasoning-mode router with injector for DSH workflows
...
- **⭐ Stars:** 6,224
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创��、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **Tags:** `agent-skills`, `skill-store`, `coding`, `automation`
- **Why use it:** Most comprehensive skill store with auto-categorized GitHub skills
...
- **Tags:** `agent-os`, `loop-engineering`, `llm-evaluation`, `mcp`
- **Why use it:** Self-improving Agent OS with staged evaluation and budgeted evolution
...
- **Tags:** `agent-control-plane`, `loop-engineering`, `workflow-automation`, `long-horizon`
- **Why use it:** Long-horizon agent control plane for durable governed work across harnesses
...
- **Tags:** `agent-collaboration`, `enterprise`, `multi-agent`, `visual-editor`
- **Why use it:** Enterprise local-first agent workbench with unified multi-engine workspace
...
- **Tags:** `preset`, `bootstrap`, `workflow`
- **Why use it:** Two-phase preset for minimal-aligned bootstrap with full Standard tools
...
- **Tags:** `skills`, `workflow`, `routing`, `automation`
- **Why use it:** Intelligent skill routing and workflow orchestration with +21pp reward
...
- **Tags:** `cognition`, `skills`, `anthropic`, `j-space`
- **Why use it:** AI cognitive-enhancement skills based on Anthropic's J-space research
...
- **Why use it:** Vision toolkit for text-only models: OCR, screenshot Q&A
...
- **⭐ Stars:** 334
- **Language:** Python
- **Description:** DeepWatch, powered by Watch Skill: a local-first perception and verification stack for AI agents. Understand video, audio and screen activity, keep timestamped evidence, and independently verify what a tool or workflow actually did. MCP, CLI, REST, Web and DeepSeek Harness.
- **Tags:** `perception`, `ocr`, `speech-to-text`, `video-analysis`
- **Why use it:** Local-first perception stack for video/audio/screen observation and verification
...
- **Tags:** `taskboard`, `sqlite`, `project-management`, `native-ui`
- **Why use it:** Native SQLite-backed taskboard with project claim/review and inline Web UI
...
- **Tags:** `novel-writing`, `drama-skills`, `creative-writing`, `oh-story`
- **Why use it:** Specialized skill for novel writing and short-drama production with Oh Story
...
- **Tags:** `competition`, `math-modeling`, `workflow`
- **Why use it:** Full-stack math modeling competition skill with GitOps pipeline.
...
- **Tags:** `self-evolution`, `workflow`, `review`
- **Why use it:** Composable task controls and human-reviewed agent self-evolution.
...
- **Why use it:** Turns experience into repeatable agent execution workflows across multiple AI platforms
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot/UI/chart analysis
...
- **Why use it:** Specialized skills for writing, optimizing, and debugging high-performance AI infra
...
- **Tags:** `skills`, `research`, `marketing`
- **Why use it:** 88 open-source skills for research, marketing, and social intelligence workflows
...
- **Why use it:** 87 specialized skills for reverse engineering, pentesting, and security research
...
- **Tags:** `skills`, `superpowers`, `reasonix`, `coding`
- **Why use it:** Ports Superpowers skills to Reasonix. Expand agent capabilities.
...
- **Tags:** `skills`, `superpowers`, `tdd`, `debugging`
- **Why use it:** TDD, debugging, planning skills for DSH. Directly improves coding workflow.
...
- **Tags:** `skill-generator`, `automatic-learning`, `reusable`
- **Why use it:** Turns successful sessions into reusable skills. Automatic skill learning.
...
- **Tags:** `mentor`, `code-review`, `project-analysis`, `skills`
- **Why use it:** AI mentor that scans projects, generates chapters, does code review. Transformative.
...
- **⭐ Stars:** 48
- **Language:** JavaScript
- **Description:** Matt Pocock 技能面板（DSH Deck）：安装即自带 25 个工程与效率技能（mattpocock/skills v1.2.3：triage、grilling、wayfinder、handoff 等），右侧面板直接调用，无需手动装技能。当前主力支持 GitHub issue；Markdown 本地文件为预览版；GitLab 暂不在支持范围。希望它能帮你把想法更快变成现实。
- **Tags:** `skills`, `agent`, `workflow`
- **Why use it:** 25 pre-installed engineering skills including triage, wayfinder, and handoff
...
- **Why use it:** Unique fusion of Bazi, Fengshui, IChing and TCM in one local deterministic agent skill pack.
...
- **Why use it:** Cross-platform session memory handoff for Codex/Claude Code/DSH continuity.
...
- **⭐ Stars:** 24
- **Language:** Python
- **Description:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **Tags:** `qa`, `testing`, `automation`
- **Why use it:** 10 QA engineering skills with shared knowledge base and type-decision matrix for AI agents.
...
- **Tags:** `ai-director`, `ai-image`, `ai-video`
- **Why use it:** AI video/image/audio skills with configurable model tools for content creation.
...
- **Tags:** `agent-skills`, `eval-driven-dev`, `mcp`
- **Why use it:** Package manager with 42 agent skills covering eval-driven dev, DB, Docker, Kubernetes.
...
- **Tags:** `game-development`, `godot-engine`, `gdscript`
- **Why use it:** Full-stack Godot 4.x game dev skill plugin — ideal for game developers using DSH.
...
- **⭐ Stars:** 19
- **Language:** Python
- **Description:** Free image reading & generation for DeepSeek Harness (rc.7 / rc.8 / v0.1.1-rc.1 / rc.2 / v0.1.2-alpha.3) — paste-image reading with auto vision transcription, DeepSeek-V4-Flash-Vision-Exp / GLM-4V-Flash / SenseNova / Gemini failover, Kolors + U1 Fast generation. No keys in repo.
- **Tags:** `agent-skills`, `image-generation`, `vision`
- **Why use it:** Free image reading and generation skills — paste-image vision auto-transcoding.
...
- **Tags:** `api-documentation`, `skillhub`, `integration`
- **Why use it:** Official Tencent SkillHub API docs and examples for DSH integration.
...
- **Tags:** `agent-skills`, `project-governance`, `swift-cycle`
- **Why use it:** Swift Cycle governance skill — user-invoked, version-pinned, offline-verifiable.
...
- **Tags:** `agent-preset`, `product-management`, `workflow`
- **Why use it:** Virtual product team agent preset for collaborative PM-to-engineer workflows.
...
- **Why use it:** Auto-checks and injects relevant plugins for agents pre-flight
...
- **Tags:** `mcp`, `skills`, `dsh-plugin`, `webui`
- **Why use it:** Built-in skill/MCP management for DSH Web UI. Essential for organizing tools.
...
- **Tags:** `mcp`, `skills`, `capability`, `menu`
- **Why use it:** Unified menu to manage MCP tools and skills exposure levels. Clean interface.
...
- **Tags:** `mcp`, `cloud`, `sdk`
- **Why use it:** Official Huawei Cloud plugin with MCP tools, SDK, and cloud sandbox
...
- **Why use it:** One-click MCP/skills/rules setup across 7+ AI agents including DSH, Codex, Cursor.
...
- **Why use it:** Web GUI plugin to manage skills and MCP servers directly from DSH settings page.
...
- **Tags:** `design`, `ui`, `vibedesign`, `flutter`, `react`
- **Why use it:** AI-native vector design tool with concurrent Agent Teams for UI
...
- **Tags:** `video`, `design`, `generative-ai`
- **Why use it:** Generates Vox-style explainer videos automatically
...
- **Tags:** `design`, `template`, `ai`
- **Why use it:** AI-generated design system with template marketplace
...
- **Tags:** `visualization`, `diagram`, `litigation`
- **Why use it:** Turns messy litigation diagrams into professional SVG timelines and visuals
...
- **Why use it:** Pixel-to-text OCR and image reading for text-only models with training method
...
- **Why use it:** 6 design style presets (dark-saas, apple-minimal, neo-neumorphism) to avoid AI-generated look.
...
- **Tags:** `agent`, `browser-use`, `automation`
- **Why use it:** AI agents use real logged-in browser without interruption
...
- **Tags:** `web-search`, `bridge`, `free`, `no-signup`
- **Why use it:** Free web search bridge for models without native web access, no signup required
...
- **Tags:** `ios`, `automation`, `webdriveragent`
- **Why use it:** 22 tools for iOS Simulator and iPhone automation inside DSH.
...
- **Tags:** `browser`, `playwright`, `automation`, `tabbit`
- **Why use it:** Playwright-based browser automation for DSH. Automate web tasks easily.
...
- **Why use it:** DingTalk IM channel with streaming bot and agent capabilities
...
- **Tags:** `marketplace`, `plugin`, `install`, `utility`
- **Why use it:** Plugin marketplace inside DSH for browse, search, one-click install
...
- **Tags:** `plugin`, `registry`, `discovery`
- **Why use it:** Auto-discovers and indexes 15900+ plugin candidates
...
- **Why use it:** Curated list of DSH plugins and ecosystem resources
...
- **Tags:** `awesome-list`, `ecosystem`, `infrastructure`
- **Why use it:** Curated DSH ecosystem: plugins, tools, and infrastructure
...
- **Tags:** `security`, `audit`, `hallucination-detection`, `redteam`
...
- **Tags:** `oauth`, `subscription-bridge`, `llm-provider`, `authentication`
- **Why use it:** OAuth login bridge using ChatGPT/Claude/Grok subscriptions as DSH LLM providers
...
- **Why use it:** Track session/daily costs, budgets, and token usage across providers.
...
- **Tags:** `compatibility`, `migration`, `plugin`
- **Why use it:** Compatibility layer running Pi extensions as native DSH plugins via shared ABI
...
- **Tags:** `remote`, `encryption`, `multi-device`
- **Why use it:** P2P encrypted remote access to Harness from PC, Android, and Web
...
- **Tags:** `migration`, `session`, `context`
- **Why use it:** Cross-preset session migration preserving state and model intent with fixed schema
...
- **Tags:** `backup`, `restore`, `migration`, `config`
- **Why use it:** Complete DSH backup/restore with export/import/migration. Essential safety tool.
...
- **Tags:** `desktop`, `electron`, `hub`, `management`, `console`
- **Why use it:** Desktop console for multi-tab management of Harness/Plugin/MCP/Skills. Plug-and-play.
...
- **Why use it:** Essential plugin management console and official registry for DSH ecosystem
...
- **Tags:** `gongwen`, `docx`, `formatting`
- **Why use it:** Full Chinese official document processing following national GB/T standard
...
- **Tags:** `container`, `deployment`, `multi-version`
...
- **Tags:** `codex`, `sync`, `bridge`
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live chat sync and MCP mirroring.
...
- **Tags:** `ai-cost`, `data-visualization`, `token-usage`
- **Why use it:** Real-time token usage, cost estimates, and per-round charts for DeepSeek API tracking.
...
- **Tags:** `desktop-app`, `electron`, `integration`
- **Why use it:** Electron desktop wrapper integrating DSH web with sidebar, ModLens, and marketplace.
...
- **Tags:** `diagnostic`, `conflict-resolution`, `utilities`
...
- **Tags:** `theme`, `skin`, `whale`, `customization`
- **Why use it:** Whale Girl skin series for DeepSeek Harness customization
...
- **Tags:** `glassmorphism`, `theme`, `blur-effect`, `transparency`
- **Why use it:** Glassmorphism theme with adjustable blur/matte effects on every UI element
...
- **Why use it:** WebGPU ocean-themed skin with Three.js visuals for DSH.
...
- **Tags:** `ai`, `vibe-coding`, `rag`, `mcp`
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and knowledge base
...
- **Tags:** `harness`, `dsh-plugin`, `agent`, `tutorial`
- **Why use it:** Beginner-friendly harness engineering tutorial from scratch
...
- **Why use it:** Curated plugin collection for DeepSeek Harness ecosystem discovery
...
- **Tags:** `content`, `discovery`, `research`, `bilibili`
- **Why use it:** Local-first open-source cross-platform AI content discovery agent
...
- **Tags:** `research`, `analysis`, `china`
- **Why use it:** Auto-searches Chinese platforms, generates research reports
...
- **Tags:** `awesome-list`, `curated`, `bilingual`, `plugin-directory`
- **Why use it:** Curated plugin index with bilingual entries for discovery and evaluation
...
- **Tags:** `ai-encyclopedia`, `knowledge-base`, `awesome-list`, `navigation`
- **Why use it:** Comprehensive AI encyclopedia covering LLMs, agents, RAG, multimodal, and MLOps
...
- **⭐ Stars:** 316
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` ��目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `plugin-discovery`, `auto-scrape`, `curation`, `recommendation`
- **Why use it:** Daily auto-scrapes GitHub for real plugins, filters out tag-junk with curated lists
...
- **Why use it:** Ultimate guide with quickstart, resources, plugins and tools.
...
- **Tags:** `guide`, `marketplace`, `best-practices`
...
- **Tags:** `catalog`, `marketplace`, `directory`
- **Why use it:** 11,000+ plugins with search, rankings, install commands and API.
...
- **Tags:** `awesome-list`, `catalog`, `mcp`
- **Why use it:** Curated list of plugins, skills, MCP servers, patches and UIs.
...
- **Tags:** `research`, `latex`, `arxiv`, `gpu`
- **Why use it:** One-stop research workbench: LaTeX, arXiv, experiments, GPU SSH.
...
- **Why use it:** Catalog of 1,958 repos / 1,819 real plugins with search and filtering.
...
- **Why use it:** Comprehensive academic search across PubMed, arXiv, OpenAlex with citation graph and verification
...
- **⭐ Stars:** 184
- **Language:** Python
- **Description:** 基于tushare构建本地财经数据库。AI原生的多Agent金融分析系统，支持skill拓展Agent能力并自适应生成http接口与mcp调用。支持本���数据库访问的skill对接deepseek-harness/openclaw等通用智能体与微信/QQ/飞书等IM通道盯盘
- **Tags:** `stock`, `multi-agent`, `mcp`
- **Why use it:** Multi-agent financial analysis with local database and IM alerts via Tushare
...
- **Tags:** `api-documentation`, `research`, `chinese-platforms`, `zero-config`
- **Why use it:** Searches 65,600+ API docs from 20 Chinese platforms. Zero config. Extremely useful.
...
- **Tags:** `industry-research`, `company-research`, `research`
- **Why use it:** Comprehensive industry research with chain mapping and policy tracking
...
- **Why use it:** Powerful patent infringement analysis with RAG and multi-agent support

---

### [JingHao-Leon/dsh-alpha-desk](https://github.com/JingHao-Leon/dsh-alpha-desk)

- **⭐ Stars:** 30
- **Language:** Python
- **Description:** Alpha Desk — a deepseek-harness (dsh) skill pack that turns an agent session into a compliance-first AI investment desk: multi-strategy fund backtesting via ai-hedge-fund, a tools/pre-execute risk gate, cron monitoring and thesis memory. 把 dsh 会话变成合规、可复现、可追责的 AI 投研工作台。
- **Tags:** `fintech`, `backtesting`, `investment`
- **Why use it:** Compliance-first AI investment desk with multi-strategy fund backtesting capabilities.
...
- **Why use it:** Interactive K-line analysis with multi-market quotes, indicators and fundamental data.
...
- **Tags:** `evaluation-as-code`, `rag-evaluation`, `llm-judge`
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, skills, and agents with multi-judge ensemble.
...
- **Why use it:** DeepSeek Harness: Everything is a Plugin
...
- **Tags:** `agent-skills`, `ai-design`, `byok`, `claude-code-for-design`, `claude-design`, `codex-design`, `coding-agents`, `cursor-design`, `deepseek`, `deepseek-harness`, `design-systems`, `desktop-app`, `dsh`, `dsh-plugin`, `figma-alternative`, `hermes-agent`, `local-first`, `prototyping`, `ui-generator`, `vibe-coding`
- **Why use it:** 🎨 Best DeepSeek Harness Design Plugin. 
...
- **Tags:** `agentic-ai`, `agentic-framework`, `agentic-workflow`, `agents`, `ai-agents`, `ai-assistant`, `ai-skills`, `autonomous-agents`, `claude-code`, `codex`, `dsh-plugin`, `harness`, `mcp-server`, `multi-agent`, `multi-agent-systems`, `npm`, `skills`, `swarm`, `swarm-intelligence`, `typescript`
- **Why use it:** 🌊 The original agent meta-harness. Depl
...
- **Tags:** `ai`, `ai-agent`, `ai-agents`, `chatgpt-on-wechat`, `claude`, `claude-code`, `codex`, `cowagent`, `deepseek`, `harness`, `llm`, `mcp`, `multi-agent`, `openai`, `openclaw`, `skills`
- **Why use it:** Open-source super AI assistant & Agent H
...
- **Tags:** `agent-skills`, `ai`, `dsh-plugin`, `hacktoberfest`, `javascript`, `mcp-server`, `react`, `resume-builder`, `self-hosted`, `typescript`
- **Why use it:** A one-of-a-kind resume builder that keep
...
- **Why use it:** Self-evolving Context Database for AI Ag
...
- **Tags:** `agent`, `agent-framework`, `ai-agent`, `ai-coding`, `cli`, `coding-agent`, `deepseek`, `developer-tools`, `dsh`, `dsh-plugin`, `ink`, `llm`, `prompt-caching`, `r1`, `terminal`, `tool-use`, `tui`, `typescript`
- **Why use it:** DeepSeek-native AI coding agent for your
...
- **Why use it:** Prompt as Code | GPT-Image2 工业级提示词引擎与模板库
...
- **Tags:** `aliyun-oss`, `cloudflare-r2`, `dsh-plugin`, `electron`, `electron-app`, `electron-vue`, `github`, `image`, `imageuploader`, `imgur`, `imgur-uploader`, `qiniu`, `s3-uploader`, `smms`, `tencent-cos`, `upyun`, `vue`, `weibo`
- **Why use it:** :rocket: The Ultimate Image Uploader for
...
- **Tags:** `agent-skills`, `agentic-ai`, `ai-agent`, `ai-agents`, `ai-assistants`, `ai-persona`, `claude-code`, `claude-skills`, `codex`, `codex-skills`, `deepseek-harness`, `digital-human`, `dsh-plugin`, `hermes-agent`, `knowledge-distillation`, `llm-agent`, `meta-skill`, `openclaw`, `opencode`
- **Why use it:** Distilly — Distill how they think into r
...
- **Tags:** `admin-dashboard`, `ai-agent`, `ai-agents`, `ai-assistant`, `ai-tools`, `crm`, `crud`, `dsh-plugin`, `erp`, `internal-tool`, `internal-tools`, `low-code`, `lowcode`, `no-code`, `nocode`, `project-management`, `salesforce`, `self-hosted`, `workflows`
- **Why use it:** NocoBase is an open-source AI + no-code 
...
- **Why use it:** 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决
...
- **Tags:** `agent`, `agentic`, `ai`, `chatbot`, `dsh-plugin`, `embeddings`, `evaluation`, `generative-ai`, `golang`, `knowledge-base`, `llm`, `multi-tenant`, `ollama`, `openai`, `question-answering`, `rag`, `reranking`, `semantic-search`, `vector-search`, `wiki`
- **Why use it:** Open-source LLM knowledge platform: turn
...
- **Tags:** `ai-studio`, `browser-extension`, `bun`, `chat-management`, `chatgpt`, `chrome-extension`, `claude-ai`, `dsh`, `dsh-plugin`, `edge-addon`, `firefox-addons`, `gemini`, `safari-extension`
- **Why use it:** Enhancement suite for Gemini, AI Studio,
...
- **Tags:** `deepseek`, `armor-breaking`, `plugin`
- **Why use it:** Armor-breaking plugin for DeepSeek
...
- **Why use it:** Brings spreadsheets, docs, slides, and canvases into DSH.
...
- **Tags:** `anime`, `bangumi`, `torrent`
- **Why use it:** Anime search via Bangumi with magnetic link support and card-style results
...
- **Tags:** `awesome-list`, `plugin`, `resource`
...
- **Why use it:** Official auto-generated plugin catalog. Good overview, not a functional plugin.
...
- **Tags:** `awesome-list`, `catalog`, `productivity`
- **Why use it:** Curated plugin list covering productivity and development resources.
...
- **Tags:** `catalog`, `community`, `sync`, `reference`
- **Why use it:** Community-maintained plugin catalog with auto-sync every 4 hours. Good reference.
...
- **Tags:** `awesome-list`, `plugin-catalog`, `community`
- **Why use it:** Unofficial community catalog of DSH plugins for ecosystem discovery.
...
- **⭐ Stars:** 12
- **Language:** Python
- **Description:** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness 插件列表https://billliao.github.io/awesome-dsh-plugin
- **Tags:** `awesome-list`, `curated-list`, `plugin-directory`
- **Why use it:** Curated list of DSH plugins with web documentation and discoverability.
...
- **Tags:** `awesome-list`, `plugin-catalog`, `mcp`
- **Why use it:** Comprehensive curated awesome list of DSH plugins, tools, skills, and MCP resources.
...
- **Why use it:** Public GitHub directory with DSH plugin install commands and ecosystem discovery.
...
- **Why use it:** Curated open-data registry for discovering and exploring DSH plugins and skills.
...
- **Why use it:** 2026 quality-checked curated DSH plugin list with reliable filtering.
...
- **Why use it:** Focused 24-entry curated list for stock, finance, and quant DSH plugins.
...
- **Why use it:** Evidence-led directory with verified loadable extensions and permission guidance.
...
- **Why use it:** Simple curated collection of useful DSH plugins in Chinese.
...
- **Why use it:** Star-ranked verified community plugins for DSH discovery.
...
- **Why use it:** Complete 1000+ plugin directory sorted by stars from topic:dsh-plugin ecosystem.
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选插���，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `directory`, `guide`
- **Why use it:** Plugin product manual with scenario-based selection and compatibility guidance.
...
- **Tags:** `awesome-list`, `catalog`, `automated`
- **Why use it:** Auto-crawled daily bilingual plugin directory via GitHub Actions.
...
- **Tags:** `web-portal`, `static-site`, `directory`
- **Why use it:** Zero-dependency static web portal to browse, filter, and install 227+ DSH plugins.
...
- **Why use it:** Plugin marketplace for DSH similar to CodeX store
...
- **Tags:** `awesome-dsh-plugin`, `dsh-ecosystem`
- **Why use it:** Curated DSH plugin directory and repository
...
- **Why use it:** Evidence-led bilingual plugin directory with immutable reviews
...
- **Why use it:** Plugin radar with evidence-backed 2Origin plugin lab
...
- **Tags:** `discoverability`, `search`, `dsh-plugin`
- **Why use it:** Search npm and curated lists for DSH plugin discoverability
...
- **Why use it:** Plugin list — moved to new repository
...
- **⭐ Stars:** 1
- **Language:** JavaScript
- **Description:** A curated, auto-updating list of plugins for DeepSeek Harness (dsh). Data-driven: YAML entries + scripts auto-generate bilingual README and a Vercel site; a daily GitHub Action crawler discovers new dsh plugins, classifies them, and writes back.
- **Why use it:** Auto-updating plugin list with YAML data and bilingual README
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** General DSH plugin collection
...
- **Why use it:** Evidence-aware curated DSH plugin shortlist
...
- **Tags:** `plugin-directory`, `registry`, `curated-list`, `awesome`
- **Why use it:** Curated plugin directory for DSH ecosystem discovery and browsing

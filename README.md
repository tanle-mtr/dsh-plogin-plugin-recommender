...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 855,967 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-25 01:30:33 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 192,086 | Core DSH framework. The foundation of everything p |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,103 | Open-source design tool for coding agents. Local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,300 | Multi-agent swarm orchestrator. Coordinate autonom |
...
- **Why use it:** Core DSH framework. The foundation of everything plugin-based AI.
...
- **Tags:** `ai-agents`, `skills`, `dsh-plugin`
- **Why use it:** Super assistant harness with memory, skills, and multi-model support.
...
- **Why use it:** Native DeepSeek terminal coding agent. Prefix-cache stability.
...
- **Why use it:** Beginner-friendly tutorial from zero to harness engineering
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `tool-use`
- **Why use it:** Unified agent workspace accessible across all devices
...
- **Why use it:** Task-aware routing injector for optimized reasoning
...
- **Why use it:** Self-improving agent OS with iterative loop engineering
...
- **Why use it:** Two-phase bootstrap preset aligning to Project 98/99
...
- **Why use it:** Unified virtual filesystem for seamless agent file ops
...
- **Tags:** `code-review`, `agent-skills`, `code-quality`
...
- **Why use it:** Makes coding agents architecture-aware with baseline-first drift checking
...
- **Tags:** `security`, `cybersecurity`, `dsh-plugin`
- **Why use it:** AI security offense/defense platform auditing generated code for vulnerabilities
...
- **Why use it:** Agent skill for developing DSH plugins with standards guide
...
- **Why use it:** Agent skill for managing installed DSH plugin configurations
...
- **Tags:** `container`, `multi-version`, `plugin-import`
...
- **⭐ Stars:** 20
- **Language:** TypeScript
- **Description:** DSH 上下文注入审计���件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context-audit`, `optimization`, `tool`
- **Why use it:** Audits context injection cost, detects duplicates and conflicts in AGENTS.md
...
- **Why use it:** Practical DSH plugin dev notes covering tsconfig, junctions, zstd
...
- **Why use it:** Essential dev skills for building and testing DSH plugins.
...
- **Why use it:** Godot 4.x game dev skill for DSH workflows.
...
- **Why use it:** In-panel GUI plugin/MCP/skill manager with hot reload.
...
- **Tags:** `agent-tools`, `plugin-discovery`
...
- **Why use it:** Open-source design tool for coding agents. Local-first desktop app.
...
- **Why use it:** Enhancement suite for AI browser UIs. Chrome/Firefox/Safari extension.
...
- **Why use it:** Modern desktop client for DSH. Treats desktop itself as a plugin.
...
- **Tags:** `dsh-web`, `marketplace`, `plugin-hub`
- **Why use it:** Web-based DSH plugin marketplace and ecosystem hub
...
- **Why use it:** High-performance Rust-based agent runtime paired with a polished desktop app.
...
- **Why use it:** Desktop companion with animated pets, MCP, and plugin SDK
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** 5MB Tauri desktop app, zero env setup, cross-platform
...
- **Why use it:** Local-first desktop workspace for sessions, projects, files and research
...
- **Why use it:** Renders interactive UI components—charts, forms, quizzes—inline in replies
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite for all major OS platforms
...
- **Why use it:** Full Electron desktop GUI with SSH, skills & mobile access
...
- **Why use it:** Console plugin registry with browser management panel
...
- **Why use it:** Electron desktop console managing Harness/Plugin/MCP/Skills
...
- **Tags:** `mcp`, `ui`, `skills`
- **Why use it:** Manages skills and MCP servers directly in DSH Web GUI settings
...
- **Why use it:** Shows provider, model, live balance, and peak/off-peak pricing info
...
- **Why use it:** Cross-platform Tauri desktop with DB/SSH/Docker tools.
...
- **Why use it:** Electron desktop wrapper for DSH with integrated sidebar and UI tools
...
- **Why use it:** Open-source knowledge platform turning docs into RAG and wiki.
...
- **Why use it:** Portable, user-owned memory layer for all AI agents
...
- **Why use it:** Ultra-persistent memory with 35% token savings
...
- **Why use it:** Essential memory management toolkit for AI agents with RAG support.
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Milvus hybrid search.
...
- **Why use it:** Unlimited memory solution for OpenClaw/DSH agents
...
- **Tags:** `rag`, `embeddings`, `skill-corpus`
- **Why use it:** Turn SKILL.md files into curated retrieval-ready agent-skill corpora
...
- **Why use it:** Cross-preset session migration preserving state, model intent, and unresolved image context.
...
- **Why use it:** Long-term durable agent memory with recall tools and inspectable settings page.
...
- **Why use it:** On-demand plugin development knowledge base skill
...
- **Why use it:** Multi-agent swarm orchestrator. Coordinate autonomous workflows.
...
- **Tags:** `agent-skills`, `llm-agent`, `dsh-plugin`
...
- **Why use it:** 530+ GPT-Image2 prompts as code with 20+ industrial skill templates.
...
- **Why use it:** Self-contained architecture diagrams with motion effects
...
- **⭐ Stars:** 3,605
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插���，为 DeepSeek、GLM 等纯文本模型外挂视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `image-to-text`
- **Why use it:** First vision plugin bridging image-to-JSON for text agents
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `ai-agents`
...
- **Why use it:** Intelligent workflow orchestration and skill routing for AI agents.
...
- **Why use it:** Turns AI conversations into organized reusable workflows across platforms
...
- **Tags:** `agent`, `workflow`, `teamwork`
- **Why use it:** Unifies multiple coding agents into one coordinated team with spawn/dispatch
...
- **Why use it:** Novel writing and short-drama production powered by Oh Story
...
- **Tags:** `agent-skills`, `workflow`, `experience`
- **Why use it:** Turn experience into repeatable execution skills
...
- **Why use it:** Add multimodal vision to pure-text LLMs for screenshots/UI analysis
...
- **Why use it:** Specialized agent skills for AI infra development — write, optimize, debug high-perf systems.
...
- **Why use it:** Native SQLite-backed taskboard with Agent claim/review and zero-iframe Web UI.
...
- **Tags:** `ai-agents`, `orchestration`, `multimodal`, `dsh-plugin`
...
- **Why use it:** Agent workflow plugin for structured multi-step automation in DSH.
...
- **Why use it:** Superpowers TDD and debugging skills ported to Reasonix coding harness.
...
- **Why use it:** TDD, debugging, planning and collaboration skills adapted from obra/superpowers for DSH.
...
- **Why use it:** Complete reverse engineering skill for security research
...
- **Tags:** `dsh-plugin`, `agent-skills`, `ai-coding`
- **Why use it:** AI coding mentor that guides through project architecture and reviews
...
- **Why use it:** 88 open-source skills for research and marketing workflows
...
- **Why use it:** Enables cross-platform agent continuity memory between Codex and Claude Code
...
- **Why use it:** WorkBuddy-style skill picker that inserts /skill-name gestures in composer
...
- **Tags:** `chinese-tradition`, `metaphysics`, `niche`
- **Why use it:** Comprehensive Chinese metaphysics skill pack: Bazi, Fengshui, I Ching, TCM
...
- **Tags:** `code-quality`, `simplification`, `codex`
...
- **Why use it:** Dedicated skills management plugin for organizing DSH skill ecosystem
...
- **Tags:** `agent-skills`, `mcp`, `database`
- **Why use it:** Package manager with 42 skills, 5 CLIs, and plugin for agent engineering
...
- **Why use it:** Complete Chinese official document workflow tool per national standard
...
- **Tags:** `swift-cycle`, `project-governance`
...
- **Why use it:** Engineering discipline skill: fact-finding, evidence, honest reporting
...
- **Tags:** `agent-skills`, `skill-learning`
...
- **Why use it:** Virtual product team preset simulating PM to Engineer to QA workflow
...
- **Tags:** `design`, `vibecoding`, `agent-team`
...
- **Why use it:** Powerful vision toolkit with OCR, image Q&A for text-only models
...
- **Why use it:** Native design system with AI generation, visual editor and PPT studio
...
- **Tags:** `image-generation`, `ai-art`, `multimodal`
- **Why use it:** Generate AI images directly inside DeepSeek Harness chats
...
- **Why use it:** Preview and edit .op design documents directly in chat
...
- **Why use it:** Pixel-to-text OCR reading for text-only models
...
- **Why use it:** 6 design style skill packs (dark-saas, apple-minimal, neo-neu) for vibe-coded sites
...
- **Why use it:** Free image generation and vision-based paste transcription for DSH
...
- **Why use it:** AI video/image/audio skills with storyboard and configurable models
...
- **Tags:** `content-discovery`, `browser-automation`, `ai-agent`
- **Why use it:** Cross-platform content discovery agent across major Chinese and global platforms.
...
- **Why use it:** AI agents can control your real logged-in browser via CLI+extension
...
- **Why use it:** Live iOS Simulator and iPhone automation with 22 agent tools in-conversation
...
- **Why use it:** Tabbit Browser automation plugin for DSH — Playwright-based web interaction.
...
- **Tags:** `agent`, `canvas`, `mcp`, `skills`
- **Why use it:** Infinite canvas with creative web skills for DSH.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services. Essential tool.
...
- **Tags:** `claude-code`, `deepseek-harness`, `installation`
- **Why use it:** One-click install and model switch between major AI coding tools.
...
- **Tags:** `marketplace`, `installation`, `dsh-plugin`
...
- **Why use it:** Context insight dashboard with statistics and browser for DSH
...
- **Why use it:** Uses ChatGPT/Claude/Grok subscriptions as LLM providers via OAuth, no API keys
...
- **Tags:** `migration`, `compatibility`, `ecosystem`
...
- **Tags:** `backup`, `crash-recovery`, `rollback`, `dsh-plugin`
- **Why use it:** Crash-rescue plugin: undo config changes, secret-safe snapshots, one-click SAFE MODE.
...
- **Why use it:** Auto-synced community plugin catalog updated every 4 hours
...
- **Tags:** `cost`, `data-visualization`, `tokens`
...
- **Why use it:** Unified plugin registry merging multiple discovery sources with deduplication
...
- **Tags:** `mascot`, `pixel-art`, `personalization`
- **Why use it:** Animated mascot pets to personalize your coding agents
...
- **Why use it:** Whale girl themed skins for DeepSeek Harness with a cute aesthetic.
...
- **Why use it:** Glass-morphism theme with full UI customization without modifying source code
...
- **Why use it:** WebGPU ocean-themed skin with Three.js visuals
...
- **Why use it:** 34 opencode themes with one-click switching, persists across restarts
...
- **Why use it:** Customizable DSH web background with presets and image upload support
...
- **Why use it:** Comprehensive AI resource hub and tutorial collection for developers.
...
- **Why use it:** Automated research skill scanning 8 major Chinese platforms for 30-day trend reports.
...
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms
...
- **Why use it:** Interactive K-line analysis with multi-market data, indicators and fundamental analysis
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, agents
...
- **Why use it:** Verified stock/finance/quant DSH plugin collection.
...
- **Why use it:** Plugin manual and navigation with scene-based selection guide
...
- **Tags:** `radar`, `lab`, `evidence-backed`
...
- **Why use it:** Static web portal to browse, filter and install 227+ DSH plugins
...
- **Why use it:** In-agent plugin search across npm and awesome-dsh-plugin lists
...
- **Tags:** `mcp-server`, `dsh-plugin`, `javascript`
- **Why use it:** Privacy-focused open-source resume builder. Secure and customizable.
...
- **Tags:** `toy`, `simulation`, `fun`
- **Why use it:** Zero-dependency web simulation of a traditional Chinese bamboo dragonfly toy.
...
- **Why use it:** Curated plugin radar and top 50 list with real installation verification
...
- **Why use it:** Curated DSH plugin ecosystem list covering agents and tools
...
- **Tags:** `awesome-list`, `resources`, `bilingual`
- **Why use it:** Curated bilingual plugin resource list covering extensions, tools, and integrations
...
- **Why use it:** Daily-verified plugin catalog with scenario-based classification and rankings
...
- **⭐ Stars:** 252
- **Language:** TypeScript
- **Description:** AI skills大全 mcp ai知识库 Agent 全维度 AI 资源百科，DSH插件 收录大模型、智能 Agent、RAG 检索增强、多模态、MLOps、AI 应用工具、AI面试集、Vibe coding 大全、零基础学习路线，持续���新前沿 AI 开源项目，开发者一站式 AI 导航库
- **Tags:** `encyclopedia`, `resources`, `ai-knowledge`
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, and open-source projects
...
- **Why use it:** Learn DSH principles, browse plugin marketplace, and access best practices
...
- **Tags:** `guide`, `awesome-list`, `tutorial`
...
- **Tags:** `awesome-list`, `plugin-catalog`, `deepseek-harness`
- **Why use it:** Curated mega-list of DSH plugins, skills, MCP servers & tools
...
- **Tags:** `plugin-marketplace`, `bundle`, `harness`
- **Why use it:** Plugin marketplace/bundle for DeepSeek Harness v4 Pro
...
- **⭐ Stars:** 169
- **Language:** JavaScript
- **Description:** 帮 DSH 搜索、安装并验证插��的 Skill｜A DSH skill that finds, installs, and verifies GitHub plugins
- **Tags:** `plugin-discovery`, `automation`, `skill`
- **Why use it:** Auto-search, install and verify GitHub DSH plugins via skill
...
- **Why use it:** Smartisan-style notes with Docker deployment, WeChat export, multi-tenant support.
...
- **Why use it:** Official DSH plugin marketplace — browse, install and update all GitHub dsh-plugin repos in one click.
...
- **Why use it:** Curated awesome list of DSH plugins — best discovery resource for the ecosystem.
...
- **Tags:** `plugin-market`, `web`, `dsh-plugin`
- **Why use it:** Community plugin marketplace for DSH Web GUI — browse and install from awesome-dsh-plugin.com.
...
- **Why use it:** Community group photo wall with GitHub OAuth, DSH beta testing milestone project
...
- **Why use it:** Community-cataloged DSH plugins discovery resource.
...
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Curated evidence-led DSH plugin directory.
...
- **Why use it:** OAuth integration to chat with ChatGPT models inside DSH using Plus plan
...
- **Why use it:** Curated DSH plugin collection for ecosystem exploration
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Automated bilingual plugin directory with daily GitHub crawl
...
- **Why use it:** Evidence-led bilingual curated plugin directory with immutable commits
...
- **Tags:** `coding-agents`, `plugin-directory`
- **Why use it:** Curated plugins for extending models, tools, UI, and agent loops
...
- **Why use it:** Industry-specific DSH plugin directory across computing, finance, law and more

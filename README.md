...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 967,787 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-05 05:27:30 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 212,446 | Core harness enabling plugin-based AI agent develo |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,128 | Local-first design tool turning agents into design |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,510 | Multi-agent swarm meta-harness for autonomous work |
...
- **Why use it:** Core harness enabling plugin-based AI agent development
...
- **Tags:** `multi-agent`, `memory`, `mcp`, `skills`
- **Why use it:** Self-evolving multi-model AI assistant with memory
...
- **Tags:** `coding-agent`, `prompt-caching`, `tool-use`, `tui`
- **Why use it:** DeepSeek-native terminal coding agent with prefix cache
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `dsh-plugin`
- **Why use it:** Pioneering vision plugin enabling image analysis for text-only coding agents via structured JSON output
...
- **Tags:** `preset`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Two-phase preset combining minimal bootstrap with comprehensive Standard tools (Project2 98/99)
...
- **Tags:** `model-switch`, `installer`, `multi-agent`, `dsh-plugin`
- **Why use it:** One-click installation and model switching across Claude Code, Codex CLI, DeepSeek Harness and other agents
...
- **Tags:** `code-review`, `clean-architecture`, `lint`
...
- **Tags:** `armor-breaking`, `generation`, `performance`
- **Why use it:** Dedicated armor-breaking plugin for stable DeepSeek generations
...
- **Tags:** `security`, `code-audit`, `redteam`
- **Why use it:** Audits AI-generated code for security vulnerabilities and hallucinations
...
- **Tags:** `coding-agent`, `mcp`, `terminal`
...
- **Why use it:** Seamlessly migrate Pi extensions to DSH via one ABI compatibility layer
...
- **Why use it:** One-skill solution to discover, install, and verify DSH plugins from GitHub
...
- **Tags:** `context-migration`, `dsh-plugin`, `session`
- **Why use it:** Cross-preset session migration preserving state and model intent
...
- **Why use it:** Specialized agent skills for AI infra dev, code writing and debugging
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI panel for visual skill and MCP management within DSH ecosystem
...
- **Tags:** `plugin-dev`, `agent-skill`, `dsh`
- **Why use it:** Standard agent skill for developing DSH plugins — services, events, tools, and packaging
...
- **Tags:** `plugin-creator`, `codex`, `cordis`
- **Why use it:** Reusable skill for scaffolding, building, and validating DSH and Cordis plugins
...
- **Tags:** `plugin-guide`, `knowledge-base`, `scaffold`
- **Why use it:** On-demand plugin development knowledge base with official docs archive and scaffold
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `container`, `plugin-import`
- **Why use it:** Run multiple DSH versions in isolated containers with one-click imports
...
- **Tags:** `ui-generator`, `design-systems`, `desktop-app`, `figma-alternative`
- **Why use it:** Local-first design tool turning agents into designers
...
- **Tags:** `desktop`, `dsh-plugin-desktop`, `cordis`
- **Why use it:** Modern desktop client designed for the DSH plugin ecosystem
...
- **Tags:** `dsh`, `web-ui`, `plugin`
- **Why use it:** Web UI aggregation ecosystem for DSH plugin distribution
...
- **Tags:** `ui`, `pet`, `terminal`
- **Why use it:** Animated pet gallery for DSH and other coding agent terminals
...
- **Tags:** `sidebar`, `ui`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, chat, Git, and sub-agent pages; extensible
...
- **Tags:** `taskboard`, `ui`, `cli`, `dsh-plugin`
- **Why use it:** Modern flexible task panel supporting Codex and DeepSeek Harness with embeddable design
...
- **Tags:** `tui`, `terminal`, `ui`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thoughts, real-time status, and Esc rollback
...
- **Tags:** `widget`, `desktop`, `monitoring`
- **Why use it:** Adorable floating whale widget tracking DeepSeek account balance
...
- **Why use it:** Lightweight Tauri desktop app with zero setup and preset plugins
...
- **Tags:** `desktop`, `electron`, `office`
- **Why use it:** Local-first Electron desktop workspace for DSH sessions and office tasks
...
- **Tags:** `ui-components`, `genui`, `charts`
- **Why use it:** Rich inline UI components—charts, forms, quizzes in chat
...
- **Tags:** `desktop-client`, `windows`, `ssh`
- **Why use it:** Windows desktop client with SSH, mobile remote access, and plugin system
...
- **Tags:** `office`, `deepseek-harness`
- **Why use it:** Brings spreadsheets, docs, slides into DSH as a full office suite.
...
- **Why use it:** Desktop client plugin suite inspired by CodePilot for DSH.
...
- **Tags:** `ios`, `mobile`, `deepseek-harness-plugin`
- **Why use it:** Native iOS client extending DSH workspace and agent execution to iPhone
...
- **Why use it:** Smartisan-style notes with Docker deployment, skill support, and OneNote export
...
- **Why use it:** Community plugin marketplace for DSH web GUI
...
- **Tags:** `desktop`, `ui`
- **Why use it:** Desktop management console for DSH (Electron app)
...
- **Tags:** `ui`, `info-bar`, `pricing`, `balance-tracking`
- **Why use it:** Persistent bottom bar showing provider, balance, and pricing info
...
- **Tags:** `awesome-dsh-plugin`, `knowledge-cards`, `deepseek-harness`
...
- **Tags:** `multi-agent`, `swarm`, `mcp-server`, `skills`
- **Why use it:** Multi-agent swarm meta-harness for autonomous workflows
...
- **Tags:** `knowledge-distillation`, `meta-skill`, `agent-persona`
- **Why use it:** Distill agent thinking into reusable cross-platform skills
...
- **Tags:** `agent`, `workspace`, `mcp`
- **Why use it:** Unified agent workspace with task board across all devices
...
- **Tags:** `skills`, `agent`, `marketplace`
- **Why use it:** Most comprehensive skills marketplace with auto-crawled GitHub skills
...
- **Tags:** `agent`, `workflow`, `loop`
- **Why use it:** Long-horizon agent control plane with durable governed workflows
...
- **Tags:** `agent`, `enterprise`, `multi-agent`
- **Why use it:** Enterprise multi-agent workbench with visual editor across harnesses
...
- **Tags:** `skills`, `workflow`, `orchestration`, `dsh-plugin`
- **Why use it:** Intelligent skill routing and workflow orchestration; +21pp reward with 29.6% token reduction on SkillsBench
...
- **Tags:** `cognitive`, `agent-skills`, `global-workspace`, `dsh-plugin`
- **Why use it:** Cognitive enhancement skills based on Anthropic J-space global workspace research for agentic reasoning
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, UI restoration
...
- **Tags:** `desktop-agent`, `local-first`, `multi-model`
- **Why use it:** Local-first desktop AI agent with self-evolving skills and multi-model
...
- **Why use it:** Visual canvas-based conversation workspace with branching sessions
...
- **Tags:** `taskboard`, `sqlite`, `workflow`
...
- **Tags:** `creative-writing`, `novel`, `drama`
- **Why use it:** Specialized plugin for novel writing and short-drama script production
...
- **Tags:** `agent`, `self-evolving`
- **Why use it:** Composable task controls for agent self-evolution with review.
...
- **Why use it:** Multi-agent financial analysis with tushare DB and IM notifications.
...
- **Why use it:** Reusable skill framework for turning experience into repeatable executions
...
- **Why use it:** 87 reverse-engineering SKILL.md files for CTF, pentesting and security research
...
- **Why use it:** Superpowers skills adapted for DSH (TDD, debugging)
...
- **Tags:** `skills`, `agent-learning`
- **Why use it:** Automatically turns successful sessions into reusable skills
...
- **⭐ Stars:** 69
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架���、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `skills`, `coding-agent`
- **Why use it:** AI coding mentor skill that guides through projects step‑by‑step
...
- **Tags:** `skills`, `agent`, `github-issues`, `wayfinder`
- **Why use it:** Pre-loaded 25 engineering skills deck — triage, grilling, wayfinder, handoff and more
...
- **Tags:** `spec-driven`, `agent-skills`, `developer-tools`
- **Why use it:** Repository-native spec-driven development skill inspired by DeepSeek Harness patterns
...
- **Tags:** `skills-manager`, `dsh`, `security`
- **Why use it:** Centralized load and secure management of local Agent Skills within the DSH environment
...
- **Tags:** `chinese-wisdom`, `fengshui`, `bazi`, `iching`, `tcm`
- **Why use it:** Fusion of Bazi, Fengshui, I Ching and TCM into a deterministic local engine with dashboard
...
- **Tags:** `multi-agent`, `collaboration`, `workspace`, `skill-sharing`
- **Why use it:** Multi-agent team with shared workspace and independent contexts
...
- **Tags:** `code-simplification`, `codex`, `skill`, `refactoring`
- **Why use it:** Codex-inspired skill for automated code simplification
...
- **Tags:** `skill-picker`, `completion`, `ui-helper`
- **Why use it:** WorkBuddy-style skill picker with /skill-name completion
...
- **Tags:** `fintech`, `backtesting`, `investment`, `multi-strategy`
- **Why use it:** AI investment desk with multi-strategy backtesting
...
- **Tags:** `qa`, `testing`, `playwright`, `pytest`, `skill-framework`
- **Why use it:** 10 QA skills with shared knowledge base and decision matrix
...
- **Tags:** `ai-agents`, `chatgpt`, `deepseek-harness`
- **Why use it:** OAuth integration lets you chat with ChatGPT models inside DSH.
...
- **Why use it:** Search 65k+ Chinese API docs directly in DSH/Cursor/Claude Code
...
- **Tags:** `cloud`, `mcp`, `huaweicloud`, `terraform`, `sdk`
- **Why use it:** Official Huawei Cloud MCP tools, SDK, and sandbox for AI agent cloud operations
...
- **Tags:** `mcp-setup`, `multi-agent`, `config-sync`, `one-click`
- **Why use it:** One-click MCP/Skills setup for 7+ AI agent tools
...
- **Tags:** `mcp-manager`, `skill-manager`, `web-ui`
- **Why use it:** Web UI plugin manager for skills and MCP servers
...
- **Tags:** `diagrams-as-code`, `mermaid-alternative`, `software-architecture`
- **Why use it:** Beautiful architecture diagrams as self-contained HTML
...
- **Why use it:** 530+ GPT-Image2 prompt cases distilled into reusable skills
...
- **Tags:** `video-generation`, `tts`, `explainer`
- **Why use it:** Turn any topic into a finished Vox-style explainer video end-to-end
...
- **Why use it:** AI-generated design system with visual editor, templates and PPT studio
...
- **Why use it:** Adds multimodal vision analysis to text-only LLMs for UI and screenshot review
...
- **Tags:** `visualization`, `legal`, `litigation`, `svg`
- **Why use it:** Generates professional litigation timelines and diagrams directly from case materials
...
- **Why use it:** 6 design styles to avoid AI-generic website aesthetics
...
- **Tags:** `browser-extension`, `chrome-extension`, `chat-management`, `prompt-manager`
- **Why use it:** AI studio browser extension suite with prompt management
...
- **Why use it:** Local-first, privacy-focused cross-platform content discovery agent covering Bilibili, YouTube, X and more
...
- **Why use it:** Free web search bridge for all models without native browsing
...
- **Why use it:** iOS Simulator and USB iPhone automation directly in conversation
...
- **Why use it:** DingTalk IM channel with stream-mode agent capabilities.
...
- **Why use it:** Privacy-first self-hosted resume builder with MCP
...
- **Tags:** `electron`, `image-uploader`, `s3`, `cloudflare-r2`
...
- **Tags:** `dsh`, `routing`, `mcp`
- **Why use it:** Runtime injector and task-aware routing kit for DSH agents
...
- **Tags:** `virtual-terminal`, `vfs`, `agent-tools`, `dsh-plugin`
- **Why use it:** Virtual terminal and filesystem enabling AI agents to operate in sandboxed, reproducible environments
...
- **Why use it:** Official plugin marketplace within DSH for browsing, searching, and one-click installing community plugins
...
- **Tags:** `plugin-registry`, `ecosystem`, `discovery`
- **Why use it:** Self-hostable ecosystem radar discovering and validating 15900+ plugins
...
- **Why use it:** Curated list of DSH plugins — essential ecosystem navigation guide
...
- **Why use it:** Comprehensive curated catalog of DSH plugins, tools, and MCP resources
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as LLM providers via OAuth
...
- **Why use it:** Tracks token usage, session costs, budgets, and balance history.
...
- **Why use it:** CLI and resolver for DSH Plugin Hub with schema definitions.
...
- **Tags:** `remote-access`, `dsh-plugin`, `infrastructure`
- **Why use it:** Secure P2P remote access to DSH from PC, Android, and Web simultaneously
...
- **Tags:** `mcp`, `skills`
- **Why use it:** Unified menu to manage MCP tools and skills exposure
...
- **Tags:** `config`, `backup`, `sync`
- **Why use it:** Backup, restore, and sync complete DSH configuration
...
- **Tags:** `plugin-management`, `upgrade`
- **Why use it:** Helps plugins auto-upgrade with DSH version updates
...
- **Tags:** `plugin-management`, `registry`
- **Why use it:** Registry console for plugin ecosystem + development guide
...
- **Tags:** `plugin`, `utility`, `credentials`
- **Why use it:** Manage installed DSH plugin slots, Typert remotes, and credentials efficiently
...
- **Tags:** `gongwen`, `docx`, `wps-office`, `templates`
- **Why use it:** Full Chinese official document workflow — format validation, optimization, and template generation per GB/T 9704
...
- **Tags:** `awesome-list`, `dsh`, `plugins`, `discovery`
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories — essential plugin discovery tool
...
- **Why use it:** Pixel-to-text OCR image reading skill specifically for text-only LLM models
...
- **Tags:** `codex`, `sync`, `bridge`, `mcp-mirror`
- **Why use it:** 2-way bridge between Codex and DSH with chat sync
...
- **Tags:** `package-manager`, `skills`, `clis`, `agent-assets`
- **Why use it:** Package manager for 42 skills, 5 CLIs, and 1 plugin
...
- **Why use it:** Search npm and awesome lists for plugin discoverability in DSH.
...
- **Tags:** `ai-agents`, `coding-agents`, `dsh-plugin`
- **Why use it:** AI-curated comprehensive plugin list with 190+ entries hourly updated.
...
- **Tags:** `skin`, `theme`, `customization`, `dsh-plugin`
- **Why use it:** Whale Girl anime-style skin series specifically designed for DeepSeek Harness desktop customization
...
- **Tags:** `theme`, `glass-effect`, `transparent`
- **Why use it:** Frosted glass theme with fully customizable opacity and backgrounds
...
- **Tags:** `theme`, `webgpu`
- **Why use it:** WebGPU ocean-themed skin for DSH via Chrome/Edge extension.
...
- **Tags:** `ai`, `rag`, `vibecoding`
- **Why use it:** Comprehensive AI resource hub and Vibe Coding tutorial for beginners
...
- **Why use it:** Curated plugin list for DSH ecosystem discovery and exploration
...
- **Tags:** `research`, `web-search`, `cn-content`
- **Why use it:** Auto-searches 8 major CN platforms and generates citable research reports
...
- **Why use it:** Comprehensive curated list of all DSH plugins with bilingual support
...
- **Tags:** `ai-pedia`, `knowledge-base`, `awesome-list`
- **Why use it:** One-stop AI encyclopedia covering RAG, agents, MLOps, and learning paths
...
- **Why use it:** Auto-curated plugin rankings with scenario-based categories and guides
...
- **Why use it:** Curated list of plugins, skills, MCP servers, and orchestrators.
...
- **Why use it:** 11,000+ plugin store with search, rankings, and public API.
...
- **Why use it:** Plugin catalog with 1819 real plugins, search and STAR sorting.
...
- **Tags:** `academic-search`, `mcp`, `citation-verification`
- **Why use it:** Comprehensive academic search with multi-source dedup and citation verification
...
- **Why use it:** 88 open-source skills for deep research, social intelligence, and marketing workflows
...
- **Tags:** `patent-analysis`, `rag`, `legal-tech`
- **Why use it:** End-to-end patent infringement analysis with RAG and multi-agent reporting
...
- **Why use it:** Comprehensive industry research framework with policy and news tracking skills
...
- **Tags:** `kline`, `technical-analysis`, `market-data`, `finance`
- **Why use it:** Interactive K-line analysis with technical indicators and news
...
- **Why use it:** Curated DSH plugin directory for ecosystem exploration.
...
- **Why use it:** Plugin radar with 2Origin lab for DSH ecosystem tracking.
...
- **Tags:** `ai-agents`, `awesome-list`, `dsh-plugins`
...
- **Why use it:** Auto-updating data-driven plugin list with bilingual README.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`
- **Why use it:** Curated DSH plugin collection for reference.
...
- **Tags:** `agent-runtime`, `desktop`, `runtune`, `dsh-plugin`
- **Why use it:** High-performance Rust-based agent runtime paired with a polished desktop app combining agent teams and IDE
...
- **Why use it:** Curated awesome list of DSH plugins, useful reference for ecosystem discovery
...
- **Why use it:** Official curated list of DSH plugins
...
- **Why use it:** Curated list of useful DSH plugins and tools
...
- **Why use it:** DirectorX as a DeepSeek Harness plugin: 
...
- **Why use it:** Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek
...
- **Tags:** `bioinformatics`, `deepseek`, `desktop-app`, `dsh-plugin`, `llm-agent`, `single-cell`, `tauri`
- **Why use it:** The bioinformatics agent desktop for cli
...
- **Why use it:** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一键换上——
...
- **Why use it:** OMK — Evidence-backed evaluation and obs
...
- **Why use it:** SkillHub Open API documentation, example
...
- **Why use it:** Unofficial community catalog for DeepSee
...
- **Why use it:** A curated list of plugins for DeepSeek H
...
- **Why use it:** StarHub — All-in-One DevOps Desktop Comm
...
- **Why use it:** A fast, simple, and elegant Neovim plugi
...
- **Why use it:** Awesome DeepSeek Harness (dsh) — curated
...
- **Why use it:** Awesome DSH Plugins: a public GitHub dir
...
- **Why use it:** A DeepSeek Harness Web plugin for real-t
...
- **Why use it:** Curated list of DeepSeek Harness (DSH) plugins for 2026, with quality check.
...
- **Why use it:** Curated vertical list of stock/finance/quant plugins for DeepSeek Harness (dsh) 
...
- **Why use it:** A curated, evidence-led directory of DeepSeek Harness (DSH) plugins: verified lo
...
- **Why use it:** 桌面版 DeepSeek Harness：Electron 壳 + 自托管 dsh web 服务，集成 dsh-better-sidebar / dsh-web
...
- **Why use it:** Product Team Mode - a DeepSeek Harness agent preset: user-led conversation with 
...
- **Why use it:** 🐳 DeepSeek Harness（DSH）工具全量清单——GitHub topic:dsh-plugin 生态 1000+ 仓库按 star 排序。Awe
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin-bundle`, `dsh-plugin-market`
- **Why use it:** Plugin marketplace bundle for DSH, similar to CodeX store.
...
- **Why use it:** Moved to new repository - redirect only.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `registry`, `plugin-directory`
- **Why use it:** Curated registry of DSH plugins for easy discovery and installation.

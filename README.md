...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 977,822 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-07 05:55:31 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 214,321 | Core DSH framework enabling plugin-based AI agent  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,523 | Local-first design tool acting as Claude Design al |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,088 | Multi-agent swarm orchestrator for autonomous work |
...
- **Tags:** `ai`, `ai-agent`, `ai-agents`, `claude`, `claude-code`, `codex`, `deepseek`, `harness`, `llm`, `mcp`, `multi-agent`, `openai`, `openclaw`, `skills`
...
- **Tags:** `agent-orchestration`, `mcp`, `workspace`, `coding-agent`
...
- **Tags:** `agent-os`, `llm-orchestration`, `mcp`, `skills`
...
- **Why use it:** Enterprise local-first workbench unifying Codex, DSH, and OpenCode agents
...
- **Why use it:** First vision plugin for DSH, enables image-to-text for text-only agents
...
- **Tags:** `terminal`, `vfs`, `dsh-plugin`
- **Why use it:** Virtual terminal for AI agents with VFS support
...
- **Why use it:** RPC plugin with sub-agents and MCP support for advanced coding workflows
...
- **Why use it:** Open-source CLI with schemas and resolver for DSH Plugin Hub
...
- **Why use it:** Seamlessly migrates Pi ecosystem extensions to DSH via ABI compatibility layer.
...
- **Why use it:** Agent skill guiding standard DSH plugin development across all adapter types
...
- **Tags:** `plugin-dev`, `build`, `harness`
- **Why use it:** Agent skill for building DSH plugins with slots, Typert remotes, and credentials
...
- **Tags:** `spec-driven`, `coding`, `development`
- **Why use it:** Repository-native spec-driven development skill adapted for DSH patterns
...
- **Why use it:** Audit instruction chain, detect duplicates/conflicts; Web UI ring panel
...
- **Tags:** `agent-memory`, `rag`, `markdown`, `long-term-memory`
- **Why use it:** Portable local-first Markdown memory layer with cross-app persistence
...
- **Why use it:** Self-evolving memory OS achieving 35% token savings via hybrid retrieval
...
- **Why use it:** Dedicated memory library for building stateful, self-evolving agents
...
- **Why use it:** Memory management kit: remember and refine agent memories
...
- **Why use it:** Context dashboard and management for better AI conversation tracking
...
- **Why use it:** Curates SKILL.md files into retrieval-ready corpora with evaluation tooling.
...
- **Tags:** `memory`, `consolidation`, `proactive`
- **Why use it:** Auto-consolidating three-layer memory with zero-prompt recall injection
...
- **Why use it:** On-demand plugin dev knowledge base; official docs archive EN/ZH
...
- **Tags:** `agentic-ai`, `agentic-framework`, `agentic-workflow`, `agents`, `ai-assistant`, `ai-skills`, `autonomous-agents`, `dsh-plugin`, `harness`, `mcp-server`, `multi-agent`, `skills`, `swarm`, `swarm-intelligence`
...
- **Why use it:** Distills thinking patterns into reusable skills for any agent or bot.
...
- **Tags:** `agent-skills`, `workflow`, `mcp`, `router`
- **Why use it:** Runtime injector + task-aware router for intelligent mode switching
...
- **Tags:** `agent-skills`, `skill-store`, `finance`, `office`
- **Why use it:** Largest skills marketplace with auto-curation by category, stars, updates
...
- **Why use it:** Intelligent skill routing and workflow orchestration with benchmark improvements
...
- **Tags:** `video`, `skill`, `generation`
- **Why use it:** End-to-end Vox-style explainer video generation via AI agent skill
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, screenshots
...
- **Tags:** `computer-vision`, `ocr`, `multimodal`
- **Why use it:** Gives agents eyes and ears — converts video/audio/screen into searchable evidence.
...
- **Tags:** `creative-writing`, `novel`, `drama-skills`
- **Why use it:** Specialized skills for novel writing and short-drama production with Oh Story engine.
...
- **Tags:** `workflow`, `math-modeling`, `gitops`
...
- **Tags:** `agent`, `self-evolution`, `workflows`
- **Why use it:** Composable task controls and human-reviewed self-evolving agent modes
...
- **Why use it:** Turns experience into repeatable agent execution patterns across multiple AI platforms.
...
- **Why use it:** Automates plugin discovery, installation and verification directly within DSH.
...
- **Why use it:** 88 open-source skills for research, marketing automation and social intelligence across platforms.
...
- **Why use it:** Complete reverse engineering and pentesting skill suite with 87 SKILL.md files for security research.
...
- **Tags:** `skill`, `agent`, `automation`, `learning`
...
- **Why use it:** AI coding mentor that guides you through project structure.
...
- **Why use it:** 25 pre-packaged engineering and productivity skills ready to use via sidebar
...
- **Why use it:** Complete Chinese official document processor compliant with national GB/T standard
...
- **Tags:** `traditional-wisdom`, `agent-skill`, `bazi`
- **Why use it:** Fusion Bazi/Fengshui/I-Ching AI skill with local deterministic engine
...
- **Why use it:** Codex skill adapted from DSH for AI-generated code simplification
...
- **Tags:** `video`, `ai-media`, `directorx`
- **Why use it:** AI video/image/audio skills with configurable vision and media models
...
- **Why use it:** 11 QA skills + shared knowledge base for AI agent test automation
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`, `skills`, `mcp`
- **Why use it:** Manage skills and MCP servers directly in the DSH Web UI
...
- **Tags:** `godot`, `godot-engine`, `gdscript`, `game-development`, `dsh-plugin`
...
- **Tags:** `skillhub`, `deepseek-harness`, `dsh-plugin`, `api`
- **Why use it:** Official SkillHub with Open API docs and DSH plugin integration
...
- **Why use it:** Image reading and generation skills with auto vision transcription
...
- **Tags:** `engineering-discipline`, `quality-gate`, `delivery-gate`, `dsh-plugin`, `skill`
- **Why use it:** Engineering discipline bundle: grill requirements and prove delivery
...
- **Why use it:** Simulates PM-to-QA product team conversation workflow for users
...
- **Tags:** `agent-skills`, `architecture-as-code`, `architecture-diagram`, `code-visualization`, `data-flow-diagram`, `deepseek-harness`, `diagram-as-code`, `diagrams`, `mermaid-alternative`, `sequence-diagram`, `software-architecture`, `text-to-diagram`
...
- **Why use it:** Transforms litigation timelines and legal diagrams into presentation-ready SVGs
...
- **Why use it:** Pixel-to-text OCR and image analysis tools for text-only LLM models
...
- **Tags:** `design-skills`, `design-system`, `ui`, `vibe-coding`, `web-design`
- **Why use it:** 6 design styles prevent AI-generated websites from looking generic
...
- **Tags:** `background`, `customization`, `webui`
...
- **Why use it:** Cross-browser extension suite enhancing Gemini, Claude, ChatGPT, and DeepSeek UI.
...
- **Tags:** `content-discovery`, `web`, `dsh-plugin`
- **Why use it:** Cross-platform AI content discovery agent for multiple social platforms
...
- **Why use it:** Strongest free web search plugin, no signup or API key required.
...
- **Why use it:** iOS Simulator and device automation via 22 built-in agent tools
...
- **Why use it:** Powerful Playwright-based browser automation for DSH.
...
- **Why use it:** OAuth-based ChatGPT binding enables model access within DSH
...
- **Why use it:** DingTalk IM channel with stream-mode agent and emotion read-receipts
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and multiple editors.
...
- **Why use it:** Built-in plugin marketplace with one-click install
...
- **Why use it:** One-click multi-agent platform installer with model switching
...
- **Tags:** `armor-breaking`, `utility`, `enhancement`
- **Why use it:** Stable armor-breaking plugin for enhanced DeepSeek capabilities
...
- **Why use it:** Tracks session/daily costs, budgets, token usage and provider balances
...
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet support inside DSH conversations.
...
- **Why use it:** Backup, migrate and sync all DSH configs and skills.
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories for quick discovery
...
- **Why use it:** Centralized local agent skills loader with unified safety management in DSH
...
- **Tags:** `container`, `utility`, `dsh-manager`
...
- **Tags:** `sync`, `bridge`, `codex`
- **Why use it:** Bidirectional bridge: chat sync, skills mount, auto MCP mirroring
...
- **Tags:** `token-usage`, `cost-tracking`, `dashboard`
- **Why use it:** Real-time token usage tracking with cost estimates and API balance display
...
- **Why use it:** Searches npm + awesome lists for plugin discoverability inside DSH agents
...
- **Why use it:** Frosted glass theme for DSH web UI with fully customizable blur and background.
...
- **Tags:** `theme`, `skin`, `webgpu`, `visual`
- **Why use it:** WebGPU ocean-themed visual skin with Three.js and WebGPU effects
...
- **Tags:** `ai-agent`, `chatgpt`, `deepseek`, `prompt`, `tutorial`
...
- **Tags:** `harness`, `tutorial`, `dsh-plugin`, `beginner`
- **Why use it:** Best beginner guide for DSH harness engineering from scratch
...
- **⭐ Stars:** 230
- **Language:** TypeScript
- **Description:** Mimir — 一站式科研工作台插件：LaTeX 论文边写边���译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the whole research cycle.
- **Tags:** `research`, `latex`, `arxiv`, `gpu`
- **Why use it:** One-stop research workbench: LaTeX, arXiv, GPU SSH, experiment tracking
...
- **⭐ Stars:** 198
- **Language:** Python
- **Description:** Academic Paper Search：中文科研用户的 Codex / Claude Code / DeepSeek Harness Skill + MCP；跨 CrossRef、PubMed、arXiv、OpenAlex、Europe PMC 检索去重，��持 MeSH、引用核验、引文图谱、试验检索与审计导出。
- **Tags:** `academic`, `mcp`, `research`, `citation`
- **Why use it:** Multi-source academic search with citation verification and graph, ideal for Chinese researchers.
...
- **Tags:** `api`, `documentation`, `research`, `chinese-platforms`
...
- **Why use it:** Specialized patent infringement analysis with RAG and multi-agent support
...
- **Why use it:** AI investment desk with multi-strategy backtesting and compliance-first design
...
- **Tags:** `evaluation`, `rag-evaluation`, `prompt-engineering`, `agent-evaluation`, `dsh-plugin`
...
- **Tags:** `dsh-bundle`, `dsh-plugin-verify`, `dsh-repository-plugin`
- **Why use it:** Curated DSH plugin directory with verification support
...
- **Tags:** `2origin`, `ai-agent`, `plugin-registry`
- **Why use it:** Plugin radar with 2Origin lab integration for DSH
...
- **Tags:** `ai-agents`, `awesome-list`, `plugins`
...
- **Why use it:** Official DSHA selected plugin collection
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Community-contributed DSH plugin list
...
- **Why use it:** Auto-updating YAML-driven bilingual plugin repository with Vercel deployment
...
- **Why use it:** AI-powered no-code platform for building CRM, ERP, and business systems.
...
- **Tags:** `mascot`, `pixel-art`, `claude-code`, `codex`, `dsh-plugin`
- **Why use it:** Charming animated pet gallery integrating with major coding agent harnesses
...
- **Tags:** `radar`, `registry`, `ecosystem`
- **Why use it:** Self-hosted plugin ecosystem radar discovering 15900+ candidates
...
- **Why use it:** Bilingual curated list of all DSH plugins, extensions, and integrations.
...
- **Why use it:** AI security platform auditing code for hallucinations, vulnerabilities & safety gaps.
...
- **Tags:** `encyclopedia`, `knowledge-base`, `resources`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, RAG, MLOps, and learning paths.
...
- **Why use it:** Daily-curated plugin discovery with real reviews, scene-based filtering and rankings.
...
- **Tags:** `marketplace`, `plugins`, `directory`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with review process
...
- **Why use it:** Plugin store with 11,000+ entries, search, rankings and public API
...
- **Why use it:** Comprehensive DSH plugin catalog with 1819+ plugins, search and category filtering.
...
- **Why use it:** Curated awesome-list of DSH plugins for quick reference and discovery.
...
- **Tags:** `awesome`, `plugin`, `directory`
- **Why use it:** Official curated plugin index maintained by cordis.run.
...
- **Tags:** `community`, `catalog`, `marketplace`, `awesome`
...
- **Why use it:** Curated list of DSH plugins with interactive web directory
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `mcp`, `skills`
...
- **Tags:** `awesome-list`, `plugin-directory`, `typescript`, `dsh-plugin`
...
- **Tags:** `plugin-registry`, `curated-list`, `dsh-plugins`, `skills`, `open-data`
- **Why use it:** Spam-filtered open-data plugin registry and skill catalog for DSH
...
- **Why use it:** Curated 2026 plugin directory with quality checks for DSH ecosystem
...
- **Why use it:** Full tool inventory with 1000+ DSH repos sorted by stars
...
- **Why use it:** Plugin product manual and navigation for scenario-based selection
...
- **Tags:** `awesome-list`, `portal`, `static-site`
- **Why use it:** Zero-dependency static web portal for discovering and installing plugins
...
- **Why use it:** Curated plugin showcase, not an actual plugin itself

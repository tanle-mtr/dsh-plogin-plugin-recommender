...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,007,285 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-11 21:40:40 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 220,493 | Core plugin ecosystem framework for DeepSeek Harne |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,605 | Local-first AI design tool, Figma alternative for  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,127 | Multi-agent swarms with autonomous workflows and M |
...
- **Why use it:** Core plugin ecosystem framework for DeepSeek Harness
...
- **Why use it:** Super AI assistant with multi-agent, multi-model and self-evolving memory
...
- **Tags:** `coding-agent`, `tui`, `r1`
- **Why use it:** Terminal-native AI coding agent with prefix-cache optimization
...
- **Why use it:** First vision plugin for DSH, enables text-only agents to process images via structured JSON output.
...
- **Why use it:** Two-phase preset with minimal bootstrap then full Standard tools — ideal for structured DSH setup.
...
- **Tags:** `virtual-terminal`, `agent-tools`, `dsh-plugin`
- **Why use it:** Virtual terminal providing sandboxed VFS and virtual terminal access for AI coding agents.
...
- **Tags:** `agent-runtime`, `dsh-plugin`, `desktop`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for deep code agent workflows.
...
- **Tags:** `plugin-marketplace`, `daily-refresh`, `reviewed`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with review before publishing
...
- **Tags:** `observability`, `video-analysis`, `audio`, `ocr`, `evidence`
- **Why use it:** Agent observability: turns video, audio, screen into searchable timestamped evidence
...
- **Tags:** `coding-agent`, `rpc`, `sub-agents`, `mcp`, `cli`
- **Why use it:** Coding agent RPC plugin: sub-agents, hashline edits, MCP integration for AI workflows
...
- **Why use it:** CLI and resolver tools for managing DSH plugin hub installations via agent
...
- **Tags:** `vision`, `skills`
- **Why use it:** Adds vision capabilities to Claude Code for screenshot and UI analysis
...
- **Why use it:** Superpowers coding skills adapted for Reasonix harness
...
- **Tags:** `coding`, `tdd`, `debugging`, `skills`
...
- **Tags:** `plugin-dev`, `tooling`, `scaffold`
- **Why use it:** Reusable skill for building and validating DeepSeek Harness and Cordis plugins.
...
- **Why use it:** Adapted code simplification skill from DSH for cleaner, efficient code
...
- **Why use it:** AI-curated plugin list with 190+ entries across 12 categories
...
- **Tags:** `pets`, `gallery`, `ui-extension`
- **Why use it:** Public gallery of animated pets for AI coding tools
...
- **Why use it:** Official plugin marketplace with browse, search, and one-click install — essential DSH utility.
...
- **Why use it:** Extensible sidebar with built-in pages for files, terminal, chat, Git, and sub-agents.
...
- **Tags:** `task-panel`, `dsh-plugin`, `skills`
- **Why use it:** Modern flexible task panel with deep Codex and DSH integration for streamlined workflow management.
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thinking display, and rollback — officially featured.
...
- **Tags:** `widget`, `dsh-plugin`, `floating-ui`
- **Why use it:** Cute floating whale widget monitoring your DeepSeek account balance with drag-and-drop UX.
...
- **Why use it:** Lightweight Tauri desktop app, no env setup needed.
...
- **Why use it:** Local AI desktop workspace for DSH Sessions, projects, files, web research, plugins
...
- **Tags:** `windows`, `desktop`, `codex`, `ssh`, `remote-access`
- **Why use it:** Open-source Windows desktop client with Codex, plugins, skills, SSH, mobile remote access
...
- **Tags:** `conversation`, `canvas`, `non-linear`, `workspace`, `branching`
- **Why use it:** Non-linear visual conversation workspace: canvas-based session explorer with branching
...
- **Tags:** `desktop`, `local-first`, `multi-model`, `tauri`, `privacy`
- **Why use it:** Open-source Claude Cowork alternative: local-first, multi-model, self-evolving skills
...
- **Why use it:** Brings full office suite (sheets, docs, slides) into DSH desktop experience
...
- **Tags:** `ios`, `kotlin-multiplatform`, `mobile`
- **Why use it:** Native iOS mobile client bringing workspace, sessions, and agent traces to iPhone
...
- **Tags:** `notes`, `desktop`
- **Why use it:** Hammer-style note-taking with Docker deployment and skill integration
...
- **Tags:** `mcp`, `ui`, `webui`, `management`
- **Why use it:** Web UI tool for convenient skill and MCP management
...
- **Tags:** `marketplace`, `ui`, `webui`, `plugins`
...
- **Tags:** `mcp`, `ui`, `menu`, `configuration`
...
- **Why use it:** Electron desktop console managing Harness, plugins, MCPs, and skills across multiple tabs.
...
- **Why use it:** Persistent bottom bar showing model, balance, and pricing info at a glance
...
- **Why use it:** WorkBuddy-style skill picker for easy skill selection and insertion
...
- **Why use it:** Bioinformatics desktop app with skill store and offline mode for scientists
...
- **Tags:** `kline`, `finance`, `trading`, `sidebar`, `chart`
- **Why use it:** Interactive K-line chart analysis with technical indicators in native sidebar
...
- **Why use it:** All-in-one DevOps desktop: SSH, DB, SFTP, Docker with AI assistant
...
- **Why use it:** One-click compact context button for DSH context meter panel
...
- **Why use it:** Open-source RAG platform with knowledge base and wiki capabilities
...
- **Why use it:** Portable memory layer for AI agents, local-first and user-owned
...
- **Tags:** `memory`, `token-savings`, `evolving`
- **Why use it:** Self-evolving memory OS with 35.24% token savings
...
- **Why use it:** Dedicated memory management kit for agents — remember and refine agent knowledge automatically.
...
- **Why use it:** Persistent unified memory layer for all agents backed by Milvus vector database and hybrid search.
...
- **Tags:** `knowledge-base`, `documentation`, `plugin-dev`
- **Why use it:** Installable knowledge base bundle of official DSH/Cordis plugin dev docs in EN and ZH.
...
- **Tags:** `evaluation`, `rag`, `benchmark`, `observability`
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, agents, skills
...
- **Tags:** `curated`, `plugin-list`, `evidence-aware`, `rag`
- **Why use it:** Evidence-aware curated plugin shortlist with smart recommendations
...
- **Why use it:** Multi-agent swarms with autonomous workflows and MCP support
...
- **Why use it:** Distill expertise into reusable skills for any AI agent
...
- **Why use it:** Unified agent workspaces across all devices and platforms
...
- **Tags:** `skills`, `store`, `comprehensive`
- **Why use it:** Most comprehensive skills store with auto-updating packages
...
- **Why use it:** Enterprise-grade local-first agent workbench for teams
...
- **Why use it:** Intelligent skill routing and workflow orchestration boosting agent reward by 21pp with fewer tokens.
...
- **Why use it:** Cognitive-enhancement skills based on Anthropic's J-space global workspace research for agents.
...
- **Why use it:** End-to-end video generation skill from a single topic.
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, Q&A.
...
- **Tags:** `writing`, `novel`, `dsh-plugin`
- **Why use it:** Organized workflow for AI-assisted novel writing.
...
- **Tags:** `skills`, `memory`, `dsh-plugin`
- **Why use it:** Turns SKILL.md files into searchable agent-skill corpora.
...
- **Tags:** `creative-writing`, `fiction-writing`, `oh-story`, `drama-skills`
- **Why use it:** Dedicated skill for novel writing and short-drama production workflows
...
- **Why use it:** Native taskboard with SQLite projects, agent claim/review, and clean Web UI
...
- **Tags:** `skill`, `math-modeling`, `agent-skills`
- **Why use it:** Full-stack auto math modeling competition skill with GitOps pipeline and self-proof
...
- **Tags:** `skills`, `agent`
- **Why use it:** Enables agent self-evolution with composable task review workflows
...
- **Tags:** `skills`, `agent`
- **Why use it:** Repeatable AI execution skills across major coding agents
...
- **Why use it:** Automatically searches, installs, and verifies DSH plugins
...
- **Why use it:** 88 open-source agent skills for research and marketing automation
...
- **Why use it:** Comprehensive reverse engineering and CTF skill pack for security research
...
- **Tags:** `fintech`, `investment`, `backtesting`, `llm-agents`
- **Why use it:** AI-powered compliance-first investment desk with fund backtesting
...
- **Why use it:** 25 ready-to-use engineering skills in a sidebar panel, no manual skill installation needed.
...
- **Tags:** `document`, `chinese`, `office`
- **Why use it:** Full Chinese official document processing: format check, templates, Markdown conversion per GB/T standard.
...
- **Tags:** `spec-driven`, `workflow`, `agent-skill`
...
- **Tags:** `bazi`, `fengshui`, `iching`, `tcm`, `skill`
- **Why use it:** Unique fusion of Bazi/Fengshui/TCM AI skills with local deterministic engine
...
- **Why use it:** Enables text-only models to process images via pixel-to-text OCR method
...
- **Tags:** `multi-agent`, `collaboration`, `team`, `workspace`
...
- **Why use it:** Comprehensive AI video/image/audio skills with storyboard and corpus support
...
- **Tags:** `roleplay`, `narrative`, `npc`, `yaml`, `skill`
- **Why use it:** Rich interactive narrative skill with NPCs, memory, and YAML存档系统
...
- **Tags:** `qa`, `testing`, `playwright`, `pytest`, `automation`
- **Why use it:** Professional QA skill framework with 11 skills and shared knowledge base
...
- **Tags:** `handoff`, `session-memory`, `context-engineering`, `cross-platform`
- **Why use it:** Cross-platform agent handoff with repository-local session continuity memory
...
- **Tags:** `quality-gate`, `engineering`, `workflow`
- **Why use it:** Engineering discipline bundle: test, grill requirements, prove delivery
...
- **Tags:** `plugin-dev`, `skills`, `dsh`
- **Why use it:** Guide AI to build DSH plugins from scratch (v0.1.1-rc.2)
...
- **Tags:** `video`, `motion-design`, `remotion`, `agent-skill`
- **Why use it:** 152 cinematic shot recipes + Remotion templates for product videos
...
- **Tags:** `plugin-dev`, `agent-skills`, `skills`
- **Why use it:** Agent Skills skill for building DSH plugins/services/adapters
...
- **Tags:** `agent-tools`, `llm-agents`, `ai-agents`
- **Why use it:** Pre-flight plugin check for DSH agents — boosts plugin discovery
...
- **Tags:** `router`, `injector`, `mcp`
- **Why use it:** Injector + router-standard kit for task-aware reasoning
...
- **Tags:** `subscriptions`, `oauth`, `chatgpt`, `claude`, `grok`, `mcp`
...
- **Why use it:** Official Huawei Cloud plugin with skills, MCP tools, guardrails, and cloud sandbox for AI agents.
...
- **Why use it:** Bidirectional Codex↔DSH sync with auto MCP mirroring
...
- **Why use it:** Web GUI card to manage skills and MCP servers in browser
...
- **Tags:** `design-systems`, `figma-alternative`, `local-first`
- **Why use it:** Local-first AI design tool, Figma alternative for DSH
...
- **Why use it:** 530+ GPT Image prompt templates and case library for design workflows
...
- **Why use it:** AI-generated editable design system and PPT studio.
...
- **Tags:** `genui`, `ui-components`, `charts`, `interactive`, `forms`
- **Why use it:** GenUI for DSH: interactive UI components (layout, charts, plots, forms, quizzes) inline
...
- **Why use it:** Legal litigation visualization toolkit — redraw messy case diagrams and create accurate timelines.
...
- **Why use it:** 6 design styles to avoid the generic AI-generated look
...
- **Why use it:** Cross-browser extension suite for AI chat platforms enhancement
...
- **Why use it:** Cross-platform content discovery agent auto-scraping B站/小红书/抖音/YouTube等多平台内容。
...
- **Why use it:** AI agents can use real logged-in browser seamlessly.
...
- **Tags:** `web-search`, `free`, `no-signup`, `search-bridge`
- **Why use it:** Strongest free web search plugin, search bridge for models without native web access
...
- **Tags:** `ios`, `ios-simulator`, `webdriveragent`, `ui-automation`
- **Why use it:** Integrate live iOS Simulator and USB iPhone into DSH with 22 automation tools
...
- **Why use it:** Enables Playwright-based browser automation within DSH
...
- **Why use it:** Connect ChatGPT accounts via OAuth to chat inside DSH
...
- **Why use it:** Agent OS with interview-gated staged evaluation
...
- **Why use it:** Long-horizon agent control plane for governed workflows
...
- **Tags:** `utility`, `dsh-plugin`, `multi-agent`
- **Why use it:** One-click switch between Claude Code, Codex, DeepSeek, Kimi, Qwen and other coding agents.
...
- **Tags:** `context`, `utility`, `dsh-plugin`
- **Why use it:** Best context insight, dashboard, and management tool.
...
- **Tags:** `security`, `cybersecurity`, `redteam`, `vulnerabilities`, `shield`
- **Why use it:** AI Security Offense & Defense Platform: shields AI code from hallucinated packages
...
- **Why use it:** Session/daily cost tracking with budget alerts and multi-provider balance display
...
- **Tags:** `provider`, `infrastructure`
- **Why use it:** Dynamic model selection and cost optimization for DSH
...
- **Why use it:** Centralized plugin directory with bilingual search and ranking
...
- **Why use it:** Bridges Pi ecosystem extensions to native DSH plugins seamlessly
...
- **Tags:** `docs`, `reference`
- **Why use it:** Comprehensive runtime and plugin reference for DSH development
...
- **Tags:** `remote`, `p2p`
- **Why use it:** Secure P2P remote access to Harness across multiple devices
...
- **Why use it:** Curated awesome list of quality DeepSeek Harness plugins
...
- **Why use it:** Automates plugin upgrades aligned with DSH version updates
...
- **Tags:** `backup`, `config`, `migration`, `sync`
- **Why use it:** Full backup and restore for DSH config, plugins, MCP servers and skills
...
- **Tags:** `plugin-mgmt`, `infrastructure`, `registry`
- **Why use it:** Infrastructure for DSH plugin ecosystem: browser console for repository management + dev guide.
...
- **Tags:** `skills`, `plugin-mgmt`, `utility`
- **Why use it:** Unified loading and secure management of local Agent Skills within DeepSeek Harness.
...
- **Tags:** `context`, `audit`, `token`, `ui`, `optimization`
...
- **Tags:** `container`, `management`, `websocket`, `multi-version`
- **Why use it:** Isolated container management for multiple DSH versions with plugin import
...
- **Why use it:** One-click MCP/skill config sync across Claude Code, Codex, DSH, Cursor etc.
...
- **Tags:** `migration`, `claude-code`, `utility`, `sessions`
- **Why use it:** Migration wizard: move Claude Code/Codex/Hermes sessions to DSH
...
- **Why use it:** Static web portal for browsing and discovering DSH plugins
...
- **Why use it:** Plugin search engine integrated inside DSH agents
...
- **Tags:** `ai-guide`, `deepseek`, `resource`
- **Why use it:** Comprehensive AI resource guide covering DeepSeek, GPT, and more
...
- **Tags:** `tutorial`, `beginner`, `harness`
- **Why use it:** Beginner tutorial for harness engineering from 0 to 1
...
- **Why use it:** Curated bilingual plugins, extensions, tools, skills, clients, runtimes, integrations
...
- **Tags:** `knowledge-base`, `ai-pedia`, `resources`, `awesome-list`
- **Why use it:** AI skills encyclopedia: curated LLMs, agents, RAG, multimodal, MLOps resources
...
- **Why use it:** One-stop research workbench: LaTeX editing, arXiv, GPU SSH, experiment tracking
...
- **Tags:** `finance`, `research`, `mcp`
- **Why use it:** Local financial database with multi-agent stock analysis workflows
...
- **Tags:** `research`, `industry`, `company`, `report`
- **Why use it:** Industry research skill pack with company mapping and news tracking
...
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms directly inside coding agents.
...
- **Why use it:** Patent infringement analysis system producing competitor reports from publication numbers.
...
- **Tags:** `ecosystem`, `radar`, `dsh-plugin`
- **Why use it:** Self-hosted plugin radar discovering 15900+ candidates.
...
- **⭐ Stars:** 329
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你��� DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `plugin-marketplace`
- **Why use it:** Daily curated plugin aggregation with filtering and scenario-based recommendations
...
- **Tags:** `awesome-list`, `quickstart`, `resources`
- **Why use it:** Ultimate DSH guide covering quickstart, curated plugins, and practical toolkits
...
- **Why use it:** Learn DSH internals, plugin marketplace, and best practices in one resource
...
- **Why use it:** Curated list of plugins, skills, MCP servers, patches, and UIs for DSH ecosystem
...
- **Why use it:** Massive plugin marketplace with 11k+ entries, search, rankings, and public API
...
- **Why use it:** Official curated plugin catalog auto-generated by cordis.run
...
- **Why use it:** Curated collection of DSH plugins, tools and development resources
...
- **Tags:** `awesome-list`, `directory`, `typescript`, `nextjs`
...
- **Tags:** `awesome-list`, `plugin`, `dsh`
- **Why use it:** Official curated awesome list of DSH plugins and resources
...
- **Tags:** `registry`, `awesome-list`, `plugin`
...
- **Tags:** `awesome-list`, `verified`, `plugin`
- **Why use it:** Evidence-led curated directory with verified loadable plugins
...
- **Why use it:** Complete DSH tool inventory sorted by stars, 1000+ repos
...
- **Why use it:** Plugin directory and navigation guide for DSH users
...
- **Why use it:** Curated collection of DSHA plugins
...
- **Why use it:** Automated daily-updated bilingual plugin directory via GitHub Actions
...
- **Tags:** `dsh-ecosystem`, `plugin-repository`
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugin-list`, `awesome`, `collection`

...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 974,572 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-06 14:07:48 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 213,748 | Core plugin harness enabling everything as a plugi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,385 | Open-source design system with Figma-like capabili |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,838 | Multi-agent swarm orchestration with MCP support |
...
- **Tags:** `agent-harness`, `agent-orchestration`, `mcp`, `local-first`
- **Why use it:** Unified agent workspace across devices.
...
- **Tags:** `agent-os`, `loop-engineering`, `mcp`, `evaluation`
- **Why use it:** Agent OS with self-evolution loop.
...
- **Tags:** `multi-agent-workspace`, `enterprise`, `local-first`, `visual-editor`
- **Why use it:** Enterprise agent workbench for multiple engines.
...
- **Why use it:** First vision plugin enabling image-to-text for text-only coding agents via structured JSON evidence
...
- **Why use it:** Multi-agent coding tool with sub-agents and MCP support
...
- **Tags:** `vision`, `multimodal`, `claude-code`, `coding`
- **Why use it:** Adds multimodal vision capabilities to text-only LLM-based coding agents.
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill collection for security research.
...
- **Tags:** `plugin-dev`, `coding`, `dsh`
- **Why use it:** Agent skill for building DSH plugins following official standards
...
- **Why use it:** Skill for managing slots, Typert remotes, and credentials
...
- **Tags:** `plugin-dev`, `coding`, `validation`
...
- **Why use it:** Audits instruction chain, skills, tool schemas and detects token cost and conflicts
...
- **Tags:** `skillhub`, `api`, `dsh-plugin`
- **Why use it:** Official Open API docs and examples for DSH skill development
...
- **Tags:** `agent-harness`, `curated-list`, `deepseek-harness-plugin`, `skills`
- **Why use it:** Curated plugin registry for extending DeepSeek Harness capabilities
...
- **Tags:** `dsh-web`, `dsh-web-ui`, `creative-workshop`
- **Why use it:** Web aggregation ecosystem for plugins.
...
- **Tags:** `taskboard`, `ui`, `embeddable`
- **Why use it:** Modern flexible task board embeddable into Codex and DeepSeek Harness workflows
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought display, and rollback support
...
- **Why use it:** Cute floating whale widget tracks DeepSeek balance with animations.
...
- **Why use it:** Local-first desktop workspace integrating sessions, files, and plugins.
...
- **Tags:** `genui`, `interactive-ui`, `charts`
- **Why use it:** Generates interactive UI components like charts, forms, and layouts inline.
...
- **Why use it:** Open-source Electron desktop client with SSH, skills, and mobile access.
...
- **Why use it:** Canvas-based non-linear conversation workspace with branching exploration.
...
- **Why use it:** Adds full office suite (spreadsheets, docs, slides) to DSH
...
- **Why use it:** CodePilot-inspired desktop client plugin for cross-platform DSH
...
- **Tags:** `ios`, `deepseek-harness`, `mobile`
- **Why use it:** Native iOS client for DSH, enabling mobile workspace and session access.
...
- **Tags:** `notes`, `smartisan`, `docker`, `dsh-plugin`
- **Why use it:** Open-source Smartisan Notes clone with Docker deployment and skill support.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Convenient web UI for managing skills and MCP tools
...
- **Tags:** `market`, `ui`, `plugins`
- **Why use it:** One-click install/community plugin marketplace
...
- **Why use it:** Electron desktop console for multi-tab DSH/MCP/Skill management
...
- **Tags:** `dsh-plugin`, `plugin`, `usage-tracking`
- **Why use it:** Clean bottom bar showing provider, model, live balance and peak/off-peak pricing
...
- **Why use it:** Dedicated bioinformatics desktop app with offline mode and skill store
...
- **Why use it:** All-in-one DevOps desktop with SSH, Docker, DB client and AI sandbox
...
- **Why use it:** Electron desktop wrapper integrating multiple DSH extensions
...
- **Why use it:** Self-evolving context database for agent memory
...
- **Why use it:** Open-source RAG knowledge platform with vector search
...
- **Why use it:** Portable memory layer for AI agents.
...
- **Tags:** `memory-management`, `long-term-memory`, `self-evolving`, `skills`
- **Why use it:** Self-evolving memory OS with token savings.
...
- **Tags:** `agent-memory`, `agentic-rag`, `memory`, `continual-learning`
- **Why use it:** Memory library for stateful agents.
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus for semantic search across agents
...
- **Tags:** `context-management`, `dashboard`, `dsh-plugin`
- **Why use it:** Comprehensive context dashboard and management for DSH sessions.
...
- **Tags:** `skill-corpus`, `reranking`, `vector-search`
...
- **Why use it:** Three-layer auto-consolidating associative memory system
...
- **Tags:** `agent-skill`, `knowledge-base`, `dsh-plugin`
- **Why use it:** Official DSH docs archive with EN/ZH knowledge base as on-demand agent skill
...
- **Why use it:** Distill expert thinking into reusable AI skills
...
- **Tags:** `no-code`, `workflows`, `internal-tools`
- **Why use it:** AI-powered no-code platform for building business apps
...
- **Tags:** `agent-skills`, `skill-md`, `coding`, `automation`
- **Why use it:** Comprehensive skills store with thousands of projects.
...
- **Why use it:** Long-horizon agent control plane for workflows.
...
- **Why use it:** Two-phase preset with minimal bootstrap then full Standard tools for DSH agents
...
- **Why use it:** Intelligent skill routing and workflow orchestration improving agent reward by 21pp
...
- **Why use it:** Auto-generate Vox-style paper-collage explainer videos end-to-end.
...
- **Why use it:** Orchestrate multiple AI agents working together as a team.
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: OCR, screenshots, image Q&A.
...
- **Tags:** `security`, `redteam`, `auditing`
- **Why use it:** AI security audit tool detecting hallucinated packages and vulnerabilities.
...
- **Tags:** `multimodal`, `computer-vision`, `ocr`
- **Why use it:** Local-first multimodal perception stack for video, audio, and screen understanding.
...
- **Why use it:** Native SQLite-backed task management with agent claim and review workflow.
...
- **Why use it:** Specialized plugin for novel writing and short-drama production workflows.
...
- **Tags:** `finance`, `agent`, `tushare`, `mcp`
- **Why use it:** AI-native multi-agent financial analysis system with Tushare integration.
...
- **Why use it:** Reusable agent skills framework that turns experience into repeatable workflows.
...
- **Why use it:** Specialized agent skills for writing, optimizing, and debugging AI infra.
...
- **Tags:** `agent-skills`, `research`, `marketing`, `workflow`
...
- **Why use it:** Port of proven Superpowers skills to Reasonix harness
...
- **Tags:** `mentor`, `skills`, `coding`
- **Why use it:** AI coding mentor: scans project, generates chapters, reviews code
...
- **Tags:** `skills`, `agent-skills`, `productivity`
- **Why use it:** 25 pre-built Matt Pocock skills ready in right sidebar
...
- **⭐ Stars:** 41
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与��复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `document`, `gongwen`, `word`, `automation`
- **Why use it:** Complete Chinese official document creation and formatting tool
...
- **Why use it:** Unified local agent skills loader and manager for safe DSH integration
...
- **Why use it:** Unique fusion of Bazi, Fengshui, IChing and TCM via local deterministic engine
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `multi-agent`
...
- **Tags:** `dsh-plugin`, `skill`, `codex`
- **Why use it:** Codex-inspired skill adapted for DSH to auto-find and simplify code patterns
...
- **Why use it:** WorkBuddy-style skill picker integrated directly into DSH composer UI
...
- **Why use it:** Cross-platform handoff skill preserving context and objectives across agent sessions
...
- **Why use it:** Professional QA skill framework with 10 skills, shared KB and type decision matrix
...
- **Tags:** `ai-video`, `image-generation`, `ai-director`
- **Why use it:** AI-powered video/image/audio creation pipeline for content generation
...
- **Why use it:** Enables full-stack Godot game dev with GDScript support via AI
...
- **Why use it:** Free image generation and vision reading with multi-version support
...
- **Tags:** `agent-preset`, `product-management`, `dsh-plugin`
- **Why use it:** Virtual product team agent for PM-to-Engineer-to-QA workflows
...
- **Why use it:** Pre-flight plugin check for agents.
...
- **Tags:** `mcp`, `skills`, `agent-config`, `dsh`
- **Why use it:** One-click config sync for MCP, skills and rules across 8+ AI agent platforms
...
- **⭐ Stars:** 23
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分���中新增一张「技能与 MCP」卡片，用于在浏览器里管理技能（skills）与 MCP 服务器。
- **Tags:** `dsh-plugin`, `skills`, `mcp`, `web-ui`
- **Why use it:** Web GUI plugin managing skills and MCP servers directly from DSH settings page
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** ChatGPT OAuth integration for DSH.
...
- **Why use it:** Open-source design system with Figma-like capabilities
...
- **Tags:** `diagrams`, `architecture-diagram`, `mermaid-alternative`
- **Why use it:** Generates beautiful architecture and sequence diagrams
...
- **Tags:** `ai-image-generation`, `image-prompts`, `skills`
- **Why use it:** 530+ professional image generation prompt templates
...
- **Tags:** `ui`, `vibedesign`, `agent-team`, `flutter`
- **Why use it:** Open-source AI vector design tool with agent teams.
...
- **Tags:** `visualization`, `legal`, `svg`, `litigation`
- **Why use it:** Generate litigation timelines and legal diagrams from case files
...
- **Why use it:** Pixel-level OCR and image scanning for text-only models
...
- **Tags:** `design-system`, `ui`, `vibe-coding`
- **Why use it:** Elevates vibe-coded websites with 6 professional design styles
...
- **Why use it:** Generate visual knowledge cards from chat.
...
- **Why use it:** Enhancement suite and prompt manager for major AI web UIs
...
- **Why use it:** Cross-platform AI agent that discovers content from Bilibili, YouTube, Reddit and more
...
- **Why use it:** Enable AI agents to use your real logged-in browser seamlessly.
...
- **Why use it:** Free, no-signup web search bridge for models without native browsing.
...
- **Tags:** `mobile-automation`, `ios-simulator`, `mcp`
- **Why use it:** Automate iOS Simulator and physical iPhone via 22 agent tools
...
- **Why use it:** Powerful browser automation via Playwright integration
...
- **Why use it:** DingTalk bot integration for DSH.
...
- **Tags:** `cordis`, `dsh-plugin`, `router-standard`
- **Why use it:** Task-aware router for agent reasoning.
...
- **Why use it:** Virtual terminal and filesystem sandbox enabling isolated agent runtime environments
...
- **Tags:** `installer`, `multi-agent`, `model-switch`
- **Why use it:** One-click multi-agent installer with model switching for Claude Code, Codex, DSH and more
...
- **Why use it:** Self-hostable plugin radar discovering 15900+ candidates automatically.
...
- **Why use it:** Armor-breaking plugin for stable DeepSeek model enhancement.
...
- **Why use it:** Daily-updated comprehensive plugin marketplace for DSH
...
- **Why use it:** Track session/daily costs and budget across multiple providers
...
- **Tags:** `cli`, `plugin-manager`, `open-source`
- **Why use it:** Open-source CLI plugin manager with resolver and schemas
...
- **Tags:** `marketplace`, `registry`, `api`
- **Why use it:** 11,000+ plugin marketplace with search, rankings and free API
...
- **Why use it:** Compatibility bridge running Pi extensions natively as DSH plugins.
...
- **Why use it:** Secure P2P multi-device remote access solution for DSH workspaces.
...
- **Tags:** `utility`, `upgrade`, `infrastructure`
- **Why use it:** Helps plugins auto-adapt to DSH version upgrades
...
- **Why use it:** Full DSH config backup/restore with sync and migration
...
- **Tags:** `capability`, `menu`, `utility`
- **Why use it:** Unified menu to control tool/skill exposure and mode
...
- **Why use it:** Core plugin registry console + make-dsh-plugin dev guide
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `developer-tools`
...
- **Tags:** `codex`, `dsh-plugin`, `mcp`, `sync`
...
- **Why use it:** Tracks token usage and API costs in real-time with visual charts
...
- **Tags:** `utilities`, `dsh-plugin`, `debugging`
...
- **Why use it:** Curated plugin marketplace for DSH.
...
- **Tags:** `agent`, `discoverability`
- **Why use it:** Search npm and awesome list inside DSH.
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `cli`
- **Why use it:** Animated pets gallery for CLI tools.
...
- **Why use it:** Frosted glass theme for DSH web UI with full customization controls.
...
- **Tags:** `webui`, `themes`, `dsh-plugin`
- **Why use it:** Customizable background with presets and real-time preview
...
- **Tags:** `ai-agent`, `deepseek`, `chatgpt`, `claude`, `mcp`, `rag`
- **Why use it:** Comprehensive AI resource collection and tutorials.
...
- **Tags:** `dsh`, `harness`, `agent`, `llm`
- **Why use it:** Beginner tutorial for harness engineering.
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates research reports.
...
- **Why use it:** Comprehensive curated list of DeepSeek Harness plugin ecosystem.
...
- **Why use it:** Ultimate DSH guide with quickstart, resources and plugin picks
...
- **Tags:** `awesome-list`, `curation`, `mcp`
- **Why use it:** Curated list of plugins, MCP servers, skills and orchestrators
...
- **Why use it:** Multi-source academic search with citation graph, ideal for Chinese researchers.
...
- **Why use it:** Industry research methodology, chain mapping, news tracking
...
- **Why use it:** Search 65,600+ Chinese platform API docs across multiple agents
...
- **Tags:** `fintech`, `backtesting`, `investment`, `mcp`
...
- **Tags:** `kline`, `deepseek-harness-plugin`, `ftshare`
...
- **Tags:** `llm-evaluation`, `rag-evaluation`, `benchmark`
...
- **Tags:** `finance`, `stock`, `quant`, `dsh-plugin`
- **Why use it:** Verified stock/finance plugin directory with 24 entries
...
- **Why use it:** Curated plugin repository.
...
- **Tags:** `ai-agent`, `awesome-list`
- **Why use it:** Plugin radar and community lab.
...
- **Tags:** `ai-agents`, `mcp`
- **Why use it:** AI-curated plugin recommendations.
...
- **Tags:** `ai-agents`, `awesome-list`
- **Why use it:** Function-based plugin directory.
...
- **Why use it:** Auto-updating plugin list with YAML.
...
- **Why use it:** Curated bilingual DSH plugin and extension reference list.
...
- **Tags:** `encyclopedia`, `ai-knowledge`, `learning`
...
- **Why use it:** Daily auto-curated DSH plugin discovery with verified, tagged listings.
...
- **Tags:** `plugin-catalog`, `deepseek-harness`, `directory`
- **Why use it:** Official DSH plugin catalog with 1819 plugins, bilingual search and sorting.
...
- **Tags:** `anime`, `bangumi`, `torrent`, `search`
...
- **Tags:** `awesome-list`, `dsh-plugin`, `curation`
...
- **Why use it:** Curated awesome list with web showcase for DSH plugin discovery
...
- **Tags:** `awesome-list`, `plugin-registry`, `mcp`
- **Why use it:** Comprehensive awesome list covering plugins, skills, MCP tools and more
...
- **Why use it:** Evidence-led plugin directory with permission-aware installation guidance
...
- **Why use it:** Collection of useful DSH plugins in Chinese
...
- **Why use it:** 1000+ DSH tools ranked by stars from GitHub topic index
...
- **Tags:** `awesome-list`, `directory`, `dsh-plugin`
- **Why use it:** Plugin product manual with scenario-based navigation and risk info
...
- **Why use it:** Auto-generated daily plugin directory via GitHub Actions
...
- **Tags:** `plugin-portal`, `web`, `dsh-plugin`
...
- **Why use it:** Redirected repository.

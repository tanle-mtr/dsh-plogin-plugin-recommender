...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 861,423 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 10:42:01 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 193,974 | Core DSH framework enabling plugin-based AI develo |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,296 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,347 | Multi-agent swarm framework with autonomous workfl |
...
- **Tags:** `router`, `routing`, `harness-tools`
- **Why use it:** Task-aware reasoning-mode router for DSH harness injection
...
- **Why use it:** AI code reviews based on 12 classic engineering books with severity diagnostics
...
- **Why use it:** Makes coding agents architecture-aware with baseline-first approach
...
- **Why use it:** Powerful vision toolkit for text-only models with one-line install
...
- **Tags:** `reasonix`, `superpowers`, `skills`
- **Why use it:** Superpowers skill port to Reasonix coding harness for enhanced coding workflows
...
- **Why use it:** Agent skill for managing installed DSH plugins and credentials
...
- **Tags:** `coding-agent`, `code-simplification`, `skill`
- **Why use it:** Adapted code simplification skill for cleaner, maintainable code
...
- **Why use it:** Two-way bridge between Codex and DSH with live sync and MCP mirroring
...
- **Tags:** `plugin-dev`, `tooling`, `audit`
- **Why use it:** Portable Agent Skill for developing and auditing DSH plugins with a profile-installable bundle adapter
...
- **Why use it:** Plugin dev best-practice archive covering cordis, tsconfig, junctions, zstd, and Windows pitfalls
...
- **Tags:** `agent-tool`, `pre-flight`, `plugin-injection`
- **Why use it:** Pre-flight plugin injection to boost agent capability.
...
- **Why use it:** Ultimate Electron image uploader supporting 60+ hosting services
...
- **Why use it:** Modern desktop solution for DSH plugin ecosystem, everything is a plugin
...
- **Tags:** `dsh-plugin`, `browser-extension`, `prompt-manager`
- **Why use it:** Enhancement suite and prompt manager for major AI chat web platforms
...
- **Tags:** `sidebar`, `deepseek-harness`, `ui-extension`
- **Why use it:** Extensible sidebar with built-in file/rendering/terminal/chat/Git pages
...
- **Tags:** `agent-runtime`, `desktop`, `rust`, `computer-use-agent`
...
- **Why use it:** Lightweight 5MB desktop app with zero setup and preset plugins
...
- **Tags:** `ui`, `dsh-plugin`, `components`
- **Why use it:** Renders interactive UI components inline in DSH assistant replies.
...
- **Tags:** `desktop`, `client`, `dsh-plugin`
...
- **Tags:** `electron`, `desktop-app`, `gui`
- **Why use it:** Full-featured Windows desktop GUI for DSH with SSH and mobile support.
...
- **Tags:** `console`, `plugin-management`
- **Why use it:** Browser-panel plugin management console with dev guide
...
- **Why use it:** Persistent bottom bar showing provider, model, live balance, and real-time pricing info
...
- **Why use it:** Tauri 2 desktop integrating DB, SSH, Docker panels with AI
...
- **Why use it:** Electron desktop wrapper for DSH web with sidebar integrations
...
- **Why use it:** Customizable DSH Web background with presets and upload.
...
- **Why use it:** Self-evolving AI assistant with memory, knowledge and multi-model support
...
- **Why use it:** LLM knowledge platform with RAG, reasoning agent and wiki features
...
- **Why use it:** Portable long-term memory layer, local-first and user-owned
...
- **Tags:** `memory`, `token-savings`, `hybrid-retrieval`
...
- **Why use it:** Dedicated memory management kit for agents with RAG support
...
- **Tags:** `agent-memory`, `milvus`, `embeddings`, `rag`, `long-term-memory`
...
- **Tags:** `knowledge`, `r&d`, `dsh-plugin`
- **Why use it:** Comprehensive AI skills encyclopedia covering agents, RAG, and MLOps.
...
- **Tags:** `agent-memory`, `skill-rag`, `semantic-search`
- **Why use it:** Builds retrieval-ready agent-skill corpora from scattered SKILL.md files.
...
- **Why use it:** HTTP-connected memory, recall and experience handoff server
...
- **Tags:** `dsh-plugin`, `mcp-server`, `multi-agent`
...
- **Why use it:** 530+ GPT-Image2 prompt cases distilled into reusable industry skills
...
- **Tags:** `workspace`, `orchestration`, `cross-device`
- **Why use it:** Unified agent workspace with cross-device task tracking board
...
- **Why use it:** Enterprise multi-agent workspace with visual editor across engines
...
- **Why use it:** Intelligent workflow orchestrator routing skills across harness tools
...
- **Why use it:** Enables multi-agent team collaboration for complex tasks
...
- **Tags:** `workflow`, `productivity`, `prompt`
...
- **Tags:** `prompt`, `skill`, `dsh-plugin`
- **Why use it:** Armor-breaking prompt stabilization plugin for DeepSeek models.
...
- **Tags:** `agent`, `skills`, `execution`
- **Why use it:** Turn AI agent experience into repeatable execution workflows.
...
- **Why use it:** Auto-searches, installs and verifies GitHub DSH plugins via skill.
...
- **Why use it:** Specialized AI infra skills for writing, optimizing, and debugging systems
...
- **Tags:** `task-management`, `taskboard`, `deepseek-harness`
- **Why use it:** SQLite-backed task management with Agent claim/review and native Web UI
...
- **Why use it:** AI coding mentor that guides through architecture and review
...
- **Tags:** `spec-programming`, `dsh-plugin`
...
- **Why use it:** Enables cross-platform agent continuity and session memory handoff
...
- **Why use it:** Unique Bazi/Fengshui/I Ching AI agent skill with local engine
...
- **Why use it:** WorkBuddy-style skill picker to quickly insert skill commands
...
- **Tags:** `multi-agent`, `team`, `dsh-plugins`
...
- **Tags:** `skills-manager`, `dsh-plugin`, `deepseek`
...
- **Tags:** `vision`, `image-generation`, `skill`
- **Why use it:** Adds image reading and generation capabilities to DSH seamlessly
...
- **Tags:** `document`, `gongwen`, `word`
- **Why use it:** Full workflow tool for Chinese official document writing with format compliance and review
...
- **Tags:** `package-manager`, `agent-skills`, `cli`
- **Why use it:** Package manager delivering 42 agent skills, 5 CLIs and 1 plugin for AI engineering workflows
...
- **Tags:** `gamification`, `skills`, `mission`
- **Why use it:** Game-like mission system for DSH skills: fog-of-war map and task bar progression
...
- **Why use it:** AI video/image/audio generation and editing skills with configurable vision tools in DSH
...
- **Why use it:** Portable Agent Skill distilling DSH engineering discipline: evidence-based decisions and honest reporting
...
- **Tags:** `plugin-dev`, `skills`
- **Why use it:** Agent skills for scaffolding, building and testing DSH plugins
...
- **Why use it:** Infinite canvas with creative skills and MCP tool support
...
- **Why use it:** Record macOS workflows as agent skills for reuse
...
- **Why use it:** Virtual product team agent preset for project workflows.
...
- **Why use it:** Vision bridge plugin: paste image, get structured JSON evidence
...
- **Why use it:** Manage skills and MCP servers directly from the DSH Web GUI settings page
...
- **Why use it:** Zhihu search, Zhida Q&A, and official open-platform API via MCP and Skill
...
- **Why use it:** Hot-reload MCP server management and skill CRUD from DSH settings—paste JSON and connect instantly
...
- **Tags:** `dsh-plugin`, `figma-alternative`, `ui-generator`
...
- **Why use it:** Beautiful verifiable diagrams as code with motion effects
...
- **Tags:** `video-generation`, `ai-video`, `ffmpeg`, `agent-skill`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation via AI agents
...
- **Tags:** `design`, `ui`, `vibe-coding`, `visual`
- **Why use it:** 6 design styles to prevent AI-generic look in vibe-coded websites
...
- **Tags:** `bilibili`, `xiaohongshu`, `douyin`, `content-discovery`, `agent`
- **Why use it:** Cross-platform content discovery agent covering 8 major Chinese/Global platforms
...
- **Why use it:** Run live iOS Simulator and iPhone inside DSH with 22 agent automation tools.
...
- **Why use it:** Core DSH framework enabling plugin-based AI development
...
- **Why use it:** Minimal bootstrap to full Standard tools preset for DSH
...
- **Why use it:** Unified virtual filesystem abstraction for all AI agents
...
- **Tags:** `deepseek-harness`, `claude-code`, `opencode`, `installation`
- **Why use it:** One-click multi-tool installation and model switching utility
...
- **Why use it:** Best context insight and management with dashboard and stats
...
- **Why use it:** Runs Pi extensions as native DSH plugins via ABI compatibility layer.
...
- **Why use it:** Open-source Smartisan notes with Docker deployment and one-click WeChat export
...
- **Tags:** `marketplace`, `plugin-market`, `deepseek-harness`
- **Why use it:** One-click browse, install and update all GitHub dsh-plugin market plugins
...
- **Tags:** `context-migration`, `session-migration`, `deepseek-harness`
...
- **Why use it:** Crash-rescue plugin with undo, snapshots, and one-click SAFE MODE
...
- **Tags:** `awesome-list`, `plugin-curation`, `deepseek-harness`
...
- **Tags:** `market`, `plugin-market`, `webui`
- **Why use it:** Community plugin marketplace: browse and one-click install from awesome-dsh-plugin.com
...
- **Tags:** `dsh-plugin`, `deepseek-harness`
- **Why use it:** Local multi-version DSH container management with WebView UI
...
- **Tags:** `config-manager`, `backup`, `restore`, `mcp`
- **Why use it:** Essential backup/restore for full DSH config, plugins and MCP servers
...
- **Tags:** `dsh-plugin`, `mcp`, `capabilities`
...
- **Tags:** `migration`, `agent-migration`
- **Why use it:** Migrate Claude Code/Codex/OpenCode setup into DSH seamlessly
...
- **Tags:** `token-usage`, `cost-tracking`
...
- **Tags:** `plugin-diagnostic`, `conflict-resolution`
...
- **Why use it:** Frosted glass UI theme with full customization and zero source modifications.
...
- **Tags:** `chrome-extension`, `theme`, `webgpu`
...
- **Tags:** `theme`, `skins`, `ui`
- **Why use it:** 34 opencode classic themes one-click swap for DSH, persists across restarts
...
- **Tags:** `research`, `web-search`, `agent-skill`, `chinese-platforms`
...
- **Tags:** `security`, `audit`, `dsh-plugin`
...
- **Why use it:** Community plugin catalog with auto-sync every 4 hours
...
- **Tags:** `ai-agents`, `chinese-api`, `dsh-plugin`
- **Why use it:** Search 65K+ Chinese platform API docs across multiple AI tools
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, agents with multi-judge ensemble
...
- **Why use it:** Beginner-friendly DSH tutorial from scratch
...
- **Tags:** `curated-list`, `discovery`, `directory`
...
- **Tags:** `web`, `aggregation`, `marketplace`
- **Why use it:** Web-based plugin aggregation hub for DSH ecosystem
...
- **Tags:** `toy`, `simulation`, `single-file`, `web`
- **Why use it:** Single-file web simulation of traditional Chinese toy with real audio samples
...
- **Tags:** `awesome-list`, `plugin-registry`, `curation`
...
- **Why use it:** Curated plugin ecosystem list for DeepSeek Harness developers
...
- **Why use it:** Comprehensive curated list of DSH plugins and infrastructure
...
- **Why use it:** Curated bilingual plugin and extension directory for DeepSeek Harness.
...
- **Tags:** `awesome-list`, `plugin`, `dsh-plugin`
- **Why use it:** Daily-curated plugin discovery with场景化分类 and usage guidance.
...
- **Tags:** `education`, `marketplace`, `dsh-plugin`
...
- **Why use it:** Comprehensive DSH beginner guide with curated plugins and resources.
...
- **Why use it:** Plugin marketplace with 3100+ plugins, search, rankings and API.
...
- **Why use it:** Curated plugin marketplace for DeepSeek Harness ecosystem.
...
- **Tags:** `android`, `emulator`, `device-stream`
- **Why use it:** Build, run and interact with Android emulators or USB devices in conversation
...
- **Tags:** `community`, `oauth`, `plugin`
- **Why use it:** Fun community plugin: group photo wall with GitHub OAuth and polaroid-style display
...
- **Why use it:** Evidence-led directory of verified, loadable DSH plugins
...
- **Why use it:** Curated spam-filtered plugin registry for DSH.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Star-ranked community plugin verification list.
...
- **Why use it:** Hand-picked useful DSH plugin collection in Chinese.
...
- **Tags:** `guide`, `plugin-navigator`
- **Why use it:** Plugin guide and navigator covering install and risks.
...
- **Tags:** `awesome-list`, `plugin-index`
- **Why use it:** Community plugin index and verification resource.
...
- **Why use it:** Archived; moved to awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Why use it:** Daily auto-crawled bilingual plugin directory.
...
- **Why use it:** Searches npm + curated lists for DSH plugin discoverability inside agents.
...
- **Why use it:** 1000+ DSH repos sorted by stars, full ecosystem overview.
...
- **Why use it:** CodeX-style marketplace for DSH plugins, centralized plugin management.
...
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Curated plugins, tools, skills & resources for DeepSeek Harness.
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Concise DSH plugin directory.
...
- **Tags:** `curated-list`, `dsh-plugin`, `ui`, `skills`
- **Why use it:** Curated DSH plugins covering models, tools, sandboxes, UI and agent loops.
...
- **Why use it:** Industry-specific DSH plugins for finance, legal, medical, e-commerce etc.

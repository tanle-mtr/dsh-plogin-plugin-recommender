...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,083,374 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 233,712 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,694 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,094 | Multi-agent swarm orchestration with MCP server su |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 32 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (32)
...
- **Why use it:** Super AI assistant with self-evolving memory and multi-agent
...
- **Tags:** `routing`, `agent`, `harness`
- **Why use it:** Task-aware reasoning router with runtime injector
...
- **Why use it:** Enterprise multi-agent workbench with visual editor and teamwork
...
- **Tags:** `agent-os`, `evaluation`, `mcp`, `self-evolving`
- **Why use it:** Self-evolving agent OS with staged evaluation and MCP support
...
- **Why use it:** Virtual terminal and filesystem that gives AI agents isolated execution environments.
...
- **Tags:** `vision`, `ocr`, `computer-vision`, `screenshot`
- **Why use it:** Vision toolkit for text-only models: OCR, screenshots, Q&A
...
- **Why use it:** RPC-based coding agent with sub-agents, hashline edits, and MCP integration via TUI interface.
...
- **Why use it:** AI security offensive/defensive platform: audits code for hallucinated packages and missing safeguards.
...
- **Why use it:** Embed live iOS Simulator inside DSH conversations with 22 automation tools.
...
- **Tags:** `superpowers`, `reasonix`, `skills`, `coding`
...
- **Tags:** `plugin-creator`, `codex-skill`, `development-tool`
- **Why use it:** Reusable Codex skill to build and validate DSH/Cordis plugins — meta-tool for harness devs
...
- **Tags:** `skill-picker`, `ux`, `utility`
- **Why use it:** WorkBuddy-style skill picker for quick command insertion
...
- **Tags:** `ai-agents`, `chatgpt`, `codex`, `deepseek-harness`, `oauth`
- **Why use it:** Access ChatGPT models directly in DSH via official OAuth binding.
...
- **Tags:** `browser-extension`, `prompt-manager`, `chatgpt`, `deepseek`
- **Why use it:** Universal AI chat enhancement with prompt manager
...
- **Tags:** `desktop`, `ui`, `official`
- **Why use it:** Official DeepSeek Harness desktop application
...
- **Tags:** `mascot`, `pixel-art`, `ui`, `developer-tools`
- **Why use it:** Gallery of animated mascot pets that bring life to CLI coding agents.
...
- **Tags:** `taskboard`, `ui`, `desktop`, `codex`
- **Why use it:** Modern flexible task panel embeddable into Codex and DeepSeek Harness.
...
- **Tags:** `tui`, `terminal`, `ui`, `dashboard`
- **Why use it:** TUI overlay plugin with whale bar, streaming thought display, and rollback features.
...
- **Tags:** `floating-widget`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracking your balance
...
- **Why use it:** Full-featured Windows desktop GUI with SSH, skills, and mobile remote access built in.
...
- **Tags:** `desktop`, `local-first`, `mcp`, `office-automation`
...
- **Why use it:** Generates interactive UI components—charts, forms, quizzes—rendered inline in assistant replies.
...
- **Why use it:** Visual canvas-based non-linear conversation workspace with session exploration and branching.
...
- **Tags:** `deepseek-harness`, `office`, `plugin`
- **Why use it:** Brings full office suite into DSH with spreadsheets, docs, and slides.
...
- **Tags:** `desktop-app`, `privacy`, `agent-framework`
...
- **Why use it:** Native iOS client for DSH via WebSocket, bringing workspaces to mobile.
...
- **Tags:** `mcp`, `ui`, `skills`, `management`
- **Why use it:** Web UI plugin for managing skills and MCP servers via interface.
...
- **Tags:** `market`, `ui`, `plugin-management`, `web`
...
- **Tags:** `platform`, `workbench`, `skills`
...
- **Why use it:** Bioinformatics agent desktop for clinicians and wet-lab scientists with offline mode
...
- **Tags:** `ui-enhancement`, `status-bar`, `usage-tracking`
- **Why use it:** Enhances the composer stats bar with provider, model, balance and pricing info
...
- **Tags:** `context-audit`, `ui-panel`, `token-optimization`
- **Why use it:** Audits context injection with token cost stats, duplicate/conflict detection, and web UI panel
...
- **Why use it:** Electron desktop shell integrating DSH web services and useful plugins.
...
- **Why use it:** Adds one-click compact toggle for the DSH Web context meter panel.
...
- **Why use it:** Transforms recent chat history into beautifully designed shareable knowledge cards.
...
- **Why use it:** Enterprise RAG platform with semantic search and wiki
...
- **Tags:** `memory`, `rag`, `self-evolving`, `markdown`
- **Why use it:** Portable, local-first memory layer with cross-app self-evolution
...
- **Why use it:** Hybrid-retrieval memory with 35% token savings and skill reuse
...
- **Tags:** `memory`, `context-engineering`, `continual-learning`
...
- **Tags:** `rag`, `skill`, `embeddings`, `semantic-search`
- **Why use it:** Converts scattered SKILL.md files into curated, vector-search-ready agent skill corpora.
...
- **Why use it:** Proactive associative memory with zero-prompt recall injected before model speaks
...
- **Tags:** `agent-orchestration`, `skills`, `workspaces`, `mcp`
- **Why use it:** Cross-device agent orchestration with boards and workspace management
...
- **Tags:** `writing`, `novel`, `agent-skills`
- **Why use it:** AI long-form novel writing assistant solving forgetting and hallucination
...
- **Tags:** `skills`, `marketplace`, `coding`, `writing`
- **Why use it:** Comprehensive skills marketplace with auto-curated GitHub sources
...
- **Why use it:** Vision bridge plugin enabling text-only agents to process images as JSON.
...
- **Tags:** `skills`, `workflow-automation`, `agent-skills`, `orchestration`
...
- **Why use it:** Inference-time control for deep reasoning and recovery
...
- **Why use it:** Complete AI novel writing pipeline from idea to manuscript
...
- **Why use it:** Dedicated workflow plugin for web novel, short drama, game, and video script creative writing.
...
- **Why use it:** Gives AI agents visual/audio perception with verifiable evidence output.
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review workflow built in.
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill pack with 87 skills.
...
- **Why use it:** AI infra-focused skills for writing, optimizing, and debugging systems.
...
- **Why use it:** Superpowers skills for TDD, debugging, planning adapted to DSH.
...
- **Tags:** `skills`, `agent`, `efficiency`
- **Why use it:** 25 pre-loaded engineering skills, 10x dev efficiency out of the box
...
- **Tags:** `mentor`, `skills`, `coding-agent`
- **Why use it:** AI coding mentor that scans projects and guides learning step by step
...
- **⭐ Stars:** 64
- **Language:** Python
- **Description:** 公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、��实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `office`, `chinese-docs`
- **Why use it:** Complete Chinese official document processing based on national GB/T standard
...
- **Why use it:** Integrates Bazi, Fengshui, I Ching and TCM into one skill with local deterministic engine
...
- **Why use it:** On-demand plugin dev knowledge base as an installable agent skill bundle
...
- **Why use it:** Engineering discipline guard: verifies requirements, tests implementation, ensures delivery quality
...
- **Why use it:** End-to-end math modeling skill: from data preprocessing to paper writing and AIGC detection
...
- **Tags:** `spec-driven`, `vibe-coding`, `agent-skill`
...
- **Tags:** `multi-agent`, `persistent-memory`, `agent-team`
- **Why use it:** Durable multi-agent teams with persistent memory and skills across sessions
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-assisted software testing workflows
...
- **Why use it:** 5-role multi-agent math modeling with 33 model templates, thesis templates and visual progress
...
- **Tags:** `collaboration`, `planning`, `agent-skill`
- **Why use it:** Separates discussion from execution for AI collaboration, preventing premature implementation
...
- **Why use it:** Codex-compatible code simplification skill from DSH
...
- **Why use it:** Cinematic product video skill with 152 camera recipe cards
...
- **Tags:** `agent-tools`, `awesome-dsh-plugin`, `cordis`
- **Why use it:** Pre-flight plugin library check injects Top-K relevant plugins for task requests.
...
- **Tags:** `awesome-dsh-plugin`, `workflow`, `task-management`
- **Why use it:** Engineering workflow plugin with task stages, verification, commits, and skill management.
...
- **Tags:** `ui-generator`, `figma-alternative`
...
- **Why use it:** 530+ GPT Image prompt templates with industrial-grade skills
...
- **Tags:** `design`, `ai-agents`, `vibedesign`, `ui`
- **Why use it:** AI-native vector design with concurrent agent teams and Design-as-Code approach.
...
- **Why use it:** AI-generated design system with PPT and prototyping
...
- **Why use it:** Legal litigation visualization toolkit, draws timelines and relation diagrams
...
- **Why use it:** Pixel-to-text image reader with 34-image trained OCR methodology for text-only models
...
- **Why use it:** Real-time token usage charts, cost estimates, and API balance visualizer.
...
- **Why use it:** Browser automation for AI agents with real logged-in sessions
...
- **Tags:** `content-discovery`, `browser`, `automation`, `cross-platform`
- **Why use it:** Self-evolving cross-platform content discovery agent across Bilibili, YouTube, X and more.
...
- **Why use it:** Strongest free web search plugin — no signup, no API, bridges web access to all DSH models.
...
- **Why use it:** Fingerprint-spoofed persistent browser profiles for agents, Playwright-based with residential proxies.
...
- **Tags:** `account-management`, `multi-model`, `routing`, `utility`
- **Why use it:** Multi-model account manager with smart routing, priority, and automatic failover.
...
- **Tags:** `api-keys`, `secrets`, `registry`, `mcp`
...
- **Why use it:** Context dashboard and management for DSH insights
...
- **Why use it:** Ecosystem radar discovering and validating 21k+ plugins
...
- **Why use it:** CLI plugin manager and schema resolver for the DSH Plugin Hub ecosystem.
...
- **Tags:** `backup`, `config-manager`, `sync`, `migration`
...
- **Tags:** `cordis`, `mcp`, `skills`, `management`
- **Why use it:** Unified capability management with dynamic tool/skill exposure control.
...
- **Why use it:** Community plugin catalog with auto-sync, keeps DSH ecosystem organized
...
- **Why use it:** Unified skill loading and management console for local Agent Skills
...
- **Why use it:** Plugin ecosystem infrastructure with browser console and dev guidance
...
- **Why use it:** Manage multiple DSH versions in isolated containers
...
- **Tags:** `migration`, `session`, `import`
- **Why use it:** Migration wizard for Claude Code/Codex/OpenCode sessions
...
- **Why use it:** Task notifications, trace inspection, keybindings, and built-in terminal for DSH.
...
- **Why use it:** Free Xiaomi MiMo TTS API integration for DSH with custom voices.
...
- **Tags:** `plugin`, `diagnostic`, `compatibility`
...
- **Tags:** `skin`, `theme`, `deepseek-harness`
- **Why use it:** Whale girl themed skin series for DSH desktop
...
- **⭐ Stars:** 406
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感��题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `glass`, `transparency`, `ui`
- **Why use it:** Fully customizable frosted glass transparency theme for DSH web UI, adjustable blur and opacity.
...
- **Why use it:** Beautiful animated ocean theme with customizable waves and glassmorphism effects.
...
- **Tags:** `dsh-plugin`, `webui`, `background`
- **Why use it:** Customize DSH web background with personal images or presets, supports real-time preview.
...
- **Tags:** `documentation`, `research`, `code-analysis`, `wiki`
...
- **Why use it:** One-stop research workbench: LaTeX live compile, arXiv management, GPU SSH task orchestration.
...
- **Why use it:** Native epistemic loop plugin for structured scientific discovery workflows.
...
- **Tags:** `academic-search`, `research`, `mcp`
- **Why use it:** Chinese academic search skill with cross-source dedup and citation graph support.
...
- **Why use it:** Specialized industry and company research methodology with chain mapping.
...
- **Why use it:** Search 65k+ API docs from 20 Chinese platforms directly in coding tools
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories, ideal for discovery
...
- **Why use it:** Curated stock/finance/quant plugins with 24 verified entries.
...
- **Why use it:** Curated awesome list of DSH plugins and tools
...
- **Why use it:** Daily refreshed comprehensive DSH plugin marketplace
...
- **Why use it:** Curated bilingual awesome list of DSH plugins, skills, tools, and runtime integrations.
...
- **Tags:** `knowledge-base`, `encyclopedia`, `ai-learning`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering models, agents, RAG, MLOps, and learning paths.
...
- **Why use it:** Daily-curated DSH plugin directory with real categorization and recommendations.
...
- **Why use it:** Curated list covering plugins, skills, MCP servers, patches and UIs for DSH.
...
- **Why use it:** Ultimate DSH guide with quickstart, resources, and curated plugin recommendations.
...
- **Why use it:** Agent-first DeepSeek Harness handbook: 1
...
- **Why use it:** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过
...
- **Why use it:** Bridge the Pi and DeepSeek Harness ecosy
...
- **Why use it:** DSH 技能调用审计 + 应用内 skill 管理器
...
- **Why use it:** 让 Agent 的工作方式可组合、可审查、可持续改进，最终实现 Agent Se
...
- **Why use it:** 🐋 DeepSeek Harness 插件总目录 · The catalog 
...
- **Why use it:** 💡 Turn experience into repeatable execu
...
- **Why use it:** 基于tushare构建本地财经数据库。AI原生的多Agent金融分���系统，支
...
- **Why use it:** 帮 DSH 搜索、安��并验证插件的 Skill｜A DSH skill tha
...
- **Why use it:** Official auto-generated awesome plugin list curated by cordis.run.
...
- **Tags:** `catalog`, `community`, `resource`
...
- **Tags:** `plugin-registry`, `curated-list`, `dsh-plugins`
...
- **Why use it:** Public directory for DSH plugins with install commands and ecosystem tools.
...
- **Why use it:** Handy curated collection of DeepSeek Harness plugins.
...
- **Why use it:** Evidence-led plugin directory with verified loadable extensions and guidance.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Comprehensive awesome list catalog of 1000+ DSH plugins ranked by stars.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Verified community plugin directory with star-based ranking.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Plugin product guide with installation, permissions, and compatibility info.
...
- **Why use it:** DSH version of a CodeX-style plugin marketplace for skills discovery.
...
- **Why use it:** AI-curated hourly-updated plugin list covering 190+ plugins in 12 categories.
...
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for DSH discovery.
...
- **Why use it:** Curated selection of DSHA plugins in a concise collection.
...
- **Why use it:** In-agent plugin discoverability tool searching npm and curated lists.
...
- **Tags:** `deepseek-harness`, `dsh-plugin-verify`, `dsh-ecosystem`
- **Why use it:** DSH plugin collection with analytics and verification support.
...
- **Why use it:** Auto-updating bilingual plugin list with YAML-based data pipeline.

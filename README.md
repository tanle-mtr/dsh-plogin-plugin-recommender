...
|--------|-------|
| **Plugins tracked** | 202 |
| **Total community stars** | 1,092,998 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 235,443 | Core DSH platform — everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,013 | Open-source Claude Design alternative with UI gene |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,233 | Multi-agent swarm orchestration with autonomous wo |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 53 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (53)
...
- **Tags:** `dsh`, `harness`, `ai-agents`, `plugin-system`
...
- **Why use it:** Super AI assistant with self-evolving memory & skills
...
- **Tags:** `coding-agent`, `cli`, `prompt-caching`, `r1`, `tui`
...
- **Tags:** `no-code`, `ai-agent`, `crm`, `low-code`, `workflows`
...
- **Tags:** `routing`, `harness-tool`
- **Why use it:** Router kit for task-aware reasoning mode injection in DSH workflows
...
- **Tags:** `vision`, `ocr`, `multimodal`, `harness`
- **Why use it:** Vision bridge plugin adding image-to-JSON OCR to text-only coding agents.
...
- **Tags:** `terminal`, `vfs`, `sandbox`, `agent-tools`
- **Why use it:** World's first virtual terminal providing isolated Bash and Python environments for agents.
...
- **Tags:** `inference`, `reasoning`, `agent-tools`
- **Why use it:** Model-agnostic inference control suite enabling deep reasoning and recovery for agents
...
- **Why use it:** Bridges Pi and DSH ecosystems via shared ABI for seamless plugin migration
...
- **Tags:** `skills`, `mcp`, `cordis`
- **Why use it:** Dynamic skill exposure strategy reduces context usage effectively
...
- **Tags:** `workbench`, `skills`, `plugin-system`
...
- **Why use it:** Unified local Agent Skills loader and safety manager for DSH
...
- **Why use it:** In-agent plugin search via npm and curated lists
...
- **Why use it:** Boosts plugin usage predictability via pre-flight auto-check.
...
- **Tags:** `desktop`, `dsh-plugin`, `cordis`, `ui-extension`
...
- **Tags:** `desktop`, `ui`
- **Why use it:** Official desktop wrapper bringing native DSH experience to your OS
...
- **Tags:** `tui`, `terminal`, `status`, `dsh`
- **Why use it:** Feature-rich TUI with whale bar, live status, streaming thought, and rollback support.
...
- **Tags:** `widget`, `deepseek`, `balance`
- **Why use it:** Cute floating whale widget tracks your DeepSeek balance with smooth animations
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero setup and preset plugins included
...
- **Tags:** `desktop`, `gui`, `ssh-client`
- **Why use it:** Full-featured Windows desktop GUI with SSH, mobile access, and zero-setup install.
...
- **Why use it:** Local-first desktop workspace integrating DSH sessions, files, and MCP tools.
...
- **Tags:** `canvas`, `visualization`, `branching`
...
- **Tags:** `office`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Brings full office suite—spreadsheets, docs, slides—into Harness seamlessly
...
- **Tags:** `ios`, `mobile`, `dsh-plugin`
- **Why use it:** Native iOS client connecting via WebSocket—workspaces, chats, and agent traces on the go
...
- **Why use it:** Full-featured note app with Docker deployment and WeChat export.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI tool for skill and MCP management in DSH.
...
- **Why use it:** Community plugin market built into DSH web GUI.
...
- **Why use it:** Electron desktop console for multi-tab Harness/MCP/Skills management
...
- **Why use it:** Tauri-based bioinformatics desktop app with offline mode and skill store
...
- **Why use it:** Replaces composer stats with provider info, balance and pricing details
...
- **⭐ Stars:** 12
- **Language:** Rust
- **Description:** StarHub — All-in-One DevOps Desktop Command Center。把开发运维���天要用到的工具收进同一个窗口:数据库客户端 · SSH 终端 · SFTP · Docker · AI 助手,以及 AI 驱动的沙箱桌面与 Android 实体机操作。
...
- **Why use it:** Electron desktop wrapper with integrated plugins and services
...
- **Tags:** `agent-memory`, `rag`, `context-database`, `self-evolving`
...
- **Tags:** `rag`, `knowledge-base`, `wiki`, `embeddings`, `vector-search`
- **Why use it:** Knowledge platform turning docs into RAG, agent & wiki
...
- **Why use it:** Local-first persistent memory layer with RAG for cross-app AI agent continuity
...
- **Tags:** `agent-memory`, `rag`, `token-optimization`
...
- **Why use it:** Lightweight memory library enabling stateful, context-aware agent builds
...
- **Why use it:** Agent memory management kit with recall and refinement capabilities.
...
- **Tags:** `agent-memory`, `skill-routing`, `semantic-search`
- **Why use it:** Transforms SKILL.md files into curated, semantically searchable skill corpora.
...
- **Tags:** `knowledge-base`, `encyclopedia`, `resources`
- **Why use it:** Comprehensive AI encyclopedia covering skills, RAG, multimodal, and MLOps resources.
...
- **Tags:** `resume-builder`, `mcp-server`, `mcp`, `self-hosted`
- **Why use it:** Privacy-first resume builder with AI skills integration
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `meta-skill`, `persona`
...
- **Tags:** `writing`, `skill`, `chinese-novel`
- **Why use it:** Specialized skill for long-form Chinese web novel writing up to 2M words
...
- **Why use it:** Comprehensive skill marketplace with coding, docs, ML, and automation packs
...
- **Why use it:** Self-evolving agent OS with interview-gated evaluation and MCP support
...
- **Tags:** `agent-control`, `multi-agent`, `workflow`
...
- **Why use it:** Two-phase preset that bootstraps minimal config then loads full Standard tools.
...
- **Tags:** `skills`, `workflow`, `orchestration`, `agent`
...
- **Why use it:** Enables multi-agent team coordination and collaborative workflows in DSH
...
- **Why use it:** Organized AI novel writing pipeline covering worldbuilding, chapters, and editing
...
- **Why use it:** Versatile creative writing workflows for novels, drama, games, and video scripts
...
- **Why use it:** Gives agents eyes/ears—turns video, audio, and screens into verifiable evidence
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and clean Web UI—no iframe needed
...
- **Why use it:** Live iOS Simulator inside DSH with 22 agent tools for booting, building, and driving
...
- **Tags:** `skill-management`, `audit`, `panel`
- **Why use it:** In-app skill audit and management panel for DSH agents
...
- **Tags:** `self-evolution`, `review`, `agent-modes`
- **Why use it:** Composable, reviewable agent modes enabling continuous self-improvement
...
- **Tags:** `skills`, `repeatable`, `workflow`
- **Why use it:** Turn experience into repeatable execution across multiple AI coding tools
...
- **Why use it:** 87 SKILL.md covering reverse engineering and authorized pentesting.
...
- **Why use it:** Comprehensive research methodology skills with industry chain mapping.
...
- **Why use it:** AI infra-specific skills for writing, optimizing and debugging.
...
- **Why use it:** Superpowers skill collection ported to Reasonix harness.
...
- **Why use it:** 25 pre-installed engineering skills, 10x dev efficiency boost
...
- **Tags:** `web-search`, `mcp`, `skills`
- **Why use it:** Web search, research and integration discovery for AI agents
...
- **⭐ Stars:** 78
- **Language:** TypeScript
- **Description:** ProMentor 是���个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `skills`, `agent`, `coding`
- **Why use it:** AI coding mentor: generates chapters, auto-grades, code reviews
...
- **Tags:** `skills`, `docx`, `chinese-docs`
- **Why use it:** Chinese official document formatting and content optimization
...
- **Why use it:** Legal timeline diagrams, case charts and trial preparation tools
...
- **Tags:** `skills`, `patent`, `legal-tech`
- **Why use it:** Patent infringement analysis and prior art comparison reports
...
- **Tags:** `chinese-traditional-wisdom`, `skill`, `agent`
- **Why use it:** Unique skill pack integrating Chinese metaphysics with deterministic local engine
...
- **Why use it:** Engineering discipline quality gate: grill requirements and test before shipping
...
- **Tags:** `spec-programming`, `agent-skill`, `coding`
- **Why use it:** Repository-native spec-driven development skill inspired by DSH patterns
...
- **Why use it:** Comprehensive math modeling skill suite for competitions and research
...
- **Why use it:** Durable multi-agent team with persistent memory and cross-session rollover
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-driven test engineering
...
- **Why use it:** 5-role multi-agent math modeling system with 33 model library templates
...
- **Tags:** `skill`, `workflow`, `plan-first`
...
- **Why use it:** 152 cinematic shot cards and Remotion templates for video production
...
- **Why use it:** Official SkillHub API docs and examples from Tencent
...
- **Why use it:** Code simplification skill inspired by DSH find-simplifications
...
- **Why use it:** Standard skill for building DSH plugins, works with Claude Code and Codex
...
- **Why use it:** Structured workflow with task stages and verification records.
...
- **Tags:** `design`, `ui-generator`, `figma-alternative`, `desktop`
- **Why use it:** Open-source Claude Design alternative with UI generation
...
- **Tags:** `diagrams`, `mermaid-alternative`, `architecture`, `visualization`
- **Why use it:** Beautiful architecture & sequence diagrams as code
...
- **Tags:** `design`, `agent`, `ui`, `vibedesign`
...
- **Why use it:** AI-powered design studio with visual editor, templates, and native PPT creation
...
- **Tags:** `3d`, `blender`, `automation`
- **Why use it:** Real-time AI-driven Blender 3D modeling via direct TCP channel
...
- **Why use it:** Pixel-to-text OCR skill enabling vision capabilities for text-only models
...
- **Why use it:** Enhances multiple AI platforms via browser extension with prompt management
...
- **Why use it:** Browser automation allowing AI agents to use real logged-in sessions seamlessly
...
- **Why use it:** Free no-signup web search plugin bridging models without native web access.
...
- **Why use it:** Browser automation with persistent identity and engine-level fingerprint spoofing.
...
- **Why use it:** Playwright-based browser automation plugin for DSH.
...
- **Why use it:** Bind ChatGPT account via OAuth to chat models inside DSH.
...
- **Tags:** `image-uploader`, `s3`, `cloudflare-r2`, `electron`
...
- **Tags:** `account`, `routing`, `utility`, `multi-model`
...
- **Why use it:** Essential context dashboard and management tool for monitoring DSH conversations
...
- **Tags:** `plugin-discovery`, `ecosystem`, `validation`
- **Why use it:** Ecosystem radar discovering and validating 21k+ plugins with k8s runtime checks
...
- **Tags:** `curated-list`, `resources`, `awesome`
...
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-publishing quality review
...
- **Why use it:** CLI and resolver for managing and discovering DSH plugins from the hub.
...
- **Why use it:** AI security platform auditing generated code for vulnerabilities and hallucinations.
...
- **Tags:** `llm-provider`, `commandcode`, `dsh-plugin`
...
- **Why use it:** Secure P2P multi-device remote access with end-to-end encryption
...
- **Why use it:** Imports conversation history from 25+ AI agents as resumable DSH sessions
...
- **Why use it:** Full DSH config backup/restore with WebDAV sync support.
...
- **Tags:** `plugin-management`, `console`, `dsh-infrastructure`
- **Why use it:** Essential plugin registry with thin console for DSH ecosystem management
...
- **Why use it:** Audit context injection, detect duplicates and token costs via Web UI
...
- **Why use it:** Community-curated catalog of DSH plugins and resources
...
- **Why use it:** Useful utilities: task notifications, LLM traces, keybindings, terminal
...
- **Why use it:** Real-time token usage, cost estimates, per-round charts and API balance
...
- **Tags:** `conflict-resolution`, `compatibility`
- **Why use it:** Solves plugin conflicts and compatibility issues
...
- **Tags:** `mascot`, `pixel-art`, `cli`, `fun`
- **Why use it:** Gallery of animated mascot pets for CLI coding agents.
...
- **Tags:** `theme`, `glass`, `customization`
...
- **Tags:** `theme`, `animated-background`, `skin`
- **Why use it:** Stunning animated ocean theme with adjustable waves, sunset, and glassmorphism
...
- **Tags:** `background`, `customization`, `theme`
...
- **Tags:** `ai-guide`, `tutorials`, `prompt-library`, `knowledge-base`
...
- **Why use it:** Generates accurate technical docs from code, structured for both humans and agents
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, experiments, GPU orchestration.
...
- **Why use it:** Implements Epistemic Loop for structured scientific discovery workflows.
...
- **Tags:** `research`, `mcp`, `academic-search`
- **Why use it:** MCP+skill for academic search across PubMed/arXiv/CrossRef with citation graphs and verification
...
- **Why use it:** Great for learning DSH principles and discovering best practices
...
- **Why use it:** Massive plugin marketplace with 11,000+ plugins and free API
...
- **Why use it:** Complete plugin directory with 1958 repos and bilingual search/filter
...
- **Tags:** `plugin-discovery`, `search`, `verify`
- **Why use it:** Skill for searching, installing, and verifying DSH GitHub plugins
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories for DSH discovery
...
- **Tags:** `stock`, `quant`, `backtest`
- **Why use it:** 39 tools + 20 strategies for A/HK/US/JP/KR/TW stock analysis
...
- **Why use it:** Verified stock/finance/quant plugins, bilingual curated list
...
- **Tags:** `image-prompts`, `prompt-engineering`, `gpt-image-2`, `template-library`
- **Why use it:** GPT Image 2 prompt library with 530+ cases and templates
...
- **Why use it:** Curated directory of DSH plugins, great starting point for discovering tools
...
- **Why use it:** Beginner-friendly tutorial for learning DSH plugin development from scratch
...
- **Tags:** `web`, `aggregation`, `ecosystem`
- **Why use it:** Web plugin aggregation ecosystem for DSH with creative workshop distribution
...
- **Why use it:** Curated bilingual list of verified DSH plugins, skills, and tools.
...
- **Why use it:** Daily-curated plugin discovery with real reviews, rankings, and scene-based categorization
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, curated plugins, and developer tools
...
- **Why use it:** Carefully curated DSH plugins and development resources list.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Curated plugin list with clear Chinese documentation
...
- **Tags:** `plugin-registry`, `dsh-plugins`, `skills`
- **Why use it:** Spam-filtered official plugin registry with open data approach
...
- **Tags:** `plugin-directory`, `dsh-plugin`, `typescript`
...
- **Why use it:** Curated collection of practical DSH plugins with Chinese descriptions
...
- **Why use it:** Evidence-led curated directory with verified plugins and install guidance
...
- **Why use it:** Comprehensive DSH plugin ecosystem list with CLI and web-ui coverage
...
- **Why use it:** Complete curated catalog of 1000+ DSH plugins
...
- **Why use it:** Verified, star-ranked community plugin list
...
- **Tags:** `guide`, `documentation`, `directory`
- **Why use it:** Plugin guide and navigation for DSH users
...
- **Tags:** `ai-curated`, `recommendation`, `awesome-list`
- **Why use it:** AI-curated 190+ plugin list across 12 categories
...
- **Why use it:** Evidence-backed plugin radar and research lab
...
- **Why use it:** Automated daily-curated bilingual plugin directory
...
- **Why use it:** Curated collection of DSHA selected plugins
...
- **Why use it:** Static web portal for discovering and installing plugins
...
- **Why use it:** DSH plugin repository and ecosystem collection.

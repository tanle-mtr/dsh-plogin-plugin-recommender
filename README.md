...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 992,910 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-09 17:45:28 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 217,329 | The foundational harness enabling plugin-based AI  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,119 | Open-source Figma alternative with AI-powered UI p |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,781 | Deploy multi-agent swarms and autonomous coordinat |
...
- **Why use it:** The foundational harness enabling plugin-based AI agent orchestration
...
- **Why use it:** Super AI assistant with self-evolving memory, multi-agent, multi-model support
...
- **Why use it:** First vision plugin for DSH, enables image-to-text for text-only agents via OCR and JSON output.
...
- **Tags:** `preset`, `tools`, `workflow`
- **Why use it:** Two-phase preset with minimal bootstrap then full Standard tools, ideal for project initialization.
...
- **Why use it:** Virtual terminal for AI agents with bash, VFS, and multi-language support for isolated execution.
...
- **Tags:** `model-switch`, `cli`, `multi-agent`
- **Why use it:** One-click model switcher supporting Claude Code, Codex CLI, DeepSeek Harness, and more platforms.
...
- **Why use it:** Comprehensive context insight, dashboard, and statistics management tool
...
- **⭐ Stars:** 870
- **Language:** TypeScript
- **Description:** [dsh]为纯文本模型设计更强大���视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **Tags:** `vision`, `ocr`, `gui-automation`
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A and UI restoration
...
- **Why use it:** Coding agent with sub-agents, RPC edits, and MCP integration.
...
- **Tags:** `provider`, `llm`, `coding`
- **Why use it:** LLM provider with plan-aware model picker and reasoning support
...
- **Why use it:** Ports Superpowers coding skill to Reasonix harness for DSH
...
- **Why use it:** AI coding mentor that scans projects and guides hands-on learning
...
- **Why use it:** Agent skill for managing installed DSH plugins including slots and credentials
...
- **Tags:** `dsh-plugin`, `plugin-creator`
...
- **Why use it:** Adapted from official dsh-find-simplifications; streamlines code review
...
- **Why use it:** 11 QA skills + shared knowledge base; test automation for AI agents
...
- **Why use it:** Bidirectional bridge between Codex and DSH; live skill mount and MCP mirror
...
- **Tags:** `agent-tools`, `capability-index`, `plugin-discovery`
- **Why use it:** Pre-flight plugin check boosts agent utility predictability
...
- **Tags:** `desktop`, `dsh-plugin`, `dsh-plugin-desktop`
- **Why use it:** Modern desktop solution for DSH plugin ecosystem with plugin-based design
...
- **Tags:** `taskboard`, `tui`, `ui`
- **Why use it:** Modern flexible task panel embeddable in Codex and DeepSeek Harness with clean TUI design.
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status, streaming thinking, and context progress.
...
- **Why use it:** Cute floating whale widget monitoring DeepSeek account balance with drag, flip, and animation.
...
- **Why use it:** Lightweight 5MB desktop app with zero setup, cross-platform support
...
- **Why use it:** Local-first AI desktop workspace supporting projects, research, and Office
...
- **Why use it:** Windows GUI desktop client with plugins, SSH, and remote access.
...
- **Why use it:** Renders interactive charts, forms, and quizzes inline in replies.
...
- **Tags:** `desktop`, `local-first`, `agent`, `multi-model`
- **Why use it:** Local-first desktop app with multi-model support and evolving skills.
...
- **Why use it:** Visual canvas-based branching conversation workspace.
...
- **Why use it:** Brings full office suite into DeepSeek Harness environment.
...
- **⭐ Stars:** 234
- **Language:** Kotlin
- **Description:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将工作区、会话、实时回复和 Agent ��行轨迹带到 iPhone，同时延续 DeepSeek WebUI 克制、清晰的视觉语言
- **Tags:** `ios`, `mobile`, `client`
- **Why use it:** Native iOS client with real-time agent execution tracking.
...
- **Why use it:** Cross-device encrypted remote access to DSH via P2P network
...
- **Why use it:** Smartisan-style notes app with Docker and DSH integration
...
- **Why use it:** Streamlines skill and MCP management directly in the DSH web UI
...
- **Tags:** `marketplace`, `webui`, `plugins`
...
- **Why use it:** Electron-based desktop hub for multi-tab DSH/Plugin/MCP/Skill management
...
- **Why use it:** Bioinformatics desktop app for clinicians; offline mode and skill store
...
- **Why use it:** Electron desktop wrapper for DSH with integrated tools and sidebar.
...
- **Tags:** `ui`, `compact`, `web-extension`
- **Why use it:** One-click compact mode for DSH Web context panel
...
- **Tags:** `ui`, `knowledge-cards`, `visualization`
- **Why use it:** Transforms chat history into downloadable visual knowledge cards
...
- **Why use it:** Open-source RAG knowledge platform with self-maintaining wiki and agent support
...
- **Tags:** `memory`, `stateful-agent`, `rag`
- **Why use it:** Stateful agent memory library for continual learning
...
- **Why use it:** Memory management kit for agents with remember and refine capabilities for long-term retention.
...
- **Why use it:** Shared persistent memory hub enabling all AI agents to remember context
...
- **Tags:** `skill-corpus`, `rag`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into searchable agent skill corpora with RAG
...
- **Why use it:** Distill expertise into reusable skills for any agent or bot
...
- **Tags:** `agent-workspace`, `multi-device`, `workflow`
...
- **Tags:** `skills`, `store`, `agent-skills`
...
- **Why use it:** Long-horizon control plane for governed multi-agent work
...
- **Why use it:** Intelligent skill routing and workflow orchestration, boosting reward and reducing tokens significantly.
...
- **Why use it:** Cognitive-enhancement skills based on J-space global workspace research for improved agent reasoning.
...
- **Why use it:** Orchestrate multiple AI agents working collaboratively in teams
...
- **Tags:** `multimodal`, `ocr`, `video`, `audio`, `agent-skill`
- **Why use it:** Gives agents vision and hearing via video, audio, and OCR analysis.
...
- **Why use it:** Native local taskboard with SQLite projects and agent claim workflow.
...
- **Why use it:** Powerful novel and short drama writing workflow with AI.
...
- **Tags:** `agent-reviews`, `self-evolving`, `workflow`
...
- **Tags:** `skills`, `agent`, `reusable`
- **Why use it:** Turns experience into repeatable agent skills across platforms
...
- **Tags:** `vision`, `multimodal`, `automation`
- **Why use it:** Adds multimodal vision to text-only LLMs for UI automation
...
- **Tags:** `infra`, `skills`, `devops`
- **Why use it:** Specialized skills for AI infra dev and system debugging
...
- **Why use it:** Complete reverse engineering and pentesting skill suite
...
- **Tags:** `skill-generator`, `automation`, `agent-skills`
...
- **Why use it:** AI investment desk with multi-strategy backtesting and compliance
...
- **Tags:** `patent`, `multi-agent`, `rag`
- **Why use it:** Patent infringement analysis skill callable by any agent (DSH, Codex, Claude)
...
- **⭐ Stars:** 55
- **Language:** JavaScript
- **Description:** Matt Pocock 技能面板（DSH Deck）：安装即自带 25 个工程与效率技能（mattpocock/skills v1.2.3：triage、grilling、wayfinder、handoff 等），右侧面板直接调用，无需手动装技能。当前主力支持 GitHub issue；Markdown 本地文件为预览版；GitLab 暂不在支持范围。希望它��帮你把想法更快变成现实。
- **Tags:** `skills`, `agent`, `github-issues`
- **Why use it:** 25 built-in engineering skills panel by Matt Pocock, no manual install needed
...
- **Tags:** `gongwen`, `docx`, `deepseek-harness-plugin`
- **Why use it:** Full workflow Chinese official document processor compliant with GB/T 9704 standard
...
- **Tags:** `skills`, `dsh-plugin`, `dsh-plugins`
- **Why use it:** Unified local Agent Skills loader and manager with safety controls for DSH
...
- **Tags:** `agent-skill`, `knowledge-base`, `docs`
- **Why use it:** Official docs archive as on-demand agent skill; EN/ZH support
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `dashboard`
- **Why use it:** Bazi/Fengshui/Iching fusion with local deterministic engine and dashboard
...
- **Tags:** `handoff`, `memory`, `session`, `cross-platform`
- **Why use it:** Repository-local continuity memory; cross-agent session recovery
...
- **Tags:** `agent-skills`, `ai-roleplay`, `dsh-plugin`
- **Why use it:** Rich NPC roleplay skill with memory, positions and YAML存档
...
- **Tags:** `skillhub`, `dsh-plugin`, `api`
- **Why use it:** Official SkillHub Open API docs and DSH integration examples
...
- **Why use it:** Engineering quality gate: requirements grill, test, prove delivery
...
- **Tags:** `plugin-dev`, `dsh-plugin`, `skills`
- **Why use it:** Guides AI agents to build DSH plugins from scratch (0→1)
...
- **Tags:** `video`, `motion-design`, `remotion`, `dsh-plugin`
- **Why use it:** Cinematic product video agent with 152 shot cards and Remotion
...
- **Tags:** `plugin-dev`, `agent-skills`, `dsh-plugin`
- **Why use it:** Agent Skills skill for DSH plugin/service/tool development
...
- **Why use it:** AI-curated 190+ plugin recommender updated hourly
...
- **Why use it:** Local financial DB with MCP integration for multi-agent analysis
...
- **Why use it:** Browser-based skills and MCP server management via DSH Web GUI
...
- **Why use it:** Open-source Figma alternative with AI-powered UI prototyping
...
- **Tags:** `diagrams-as-code`, `architecture-diagram`, `dsh-plugin`
...
- **Why use it:** 530+ industrial-grade image generation prompts and reusable skills
...
- **Why use it:** AI-native design studio with templates, PPT generation, and visual editing
...
- **Why use it:** Visual litigation tool: generate diagrams and timelines from legal documents
...
- **Tags:** `ai-video`, `ai-image`, `director`, `storyboard`
- **Why use it:** AI video/image/audio skills with configurable vision and storyboard tools
...
- **Why use it:** 6 design style presets prevent AI-generic UI look in websites
...
- **Tags:** `content-discovery`, `browser`, `social`
- **Why use it:** Cross-platform content discovery agent scraping Bilibili, Douyin, YouTube, Reddit, and more.
...
- **Why use it:** Enable AI agents to control your logged-in browser seamlessly
...
- **Why use it:** Free web search bridge with no signup or API needed.
...
- **Why use it:** 22 iOS automation tools for mobile app development and testing.
...
- **Why use it:** Playwright-based browser automation for DSH agent workflows
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `integration`
- **Why use it:** OAuth binding lets DSH users access ChatGPT models directly
...
- **Tags:** `self-hosted`, `resume-builder`, `dsh-plugin`
- **Why use it:** Privacy-first self-hosted resume builder with full customization
...
- **Tags:** `plugin-registry`, `discovery`, `ecosystem`
- **Why use it:** Auto-discovers and indexes 15900+ plugins with production-grade validation
...
- **Why use it:** Track session and daily costs across multiple API providers.
...
- **Why use it:** Comprehensive DSH plugin catalog with search and categorization
...
- **Tags:** `compatibility`, `migration`, `ecosystem`
...
- **Why use it:** Discovers, installs, and verifies DSH plugins automatically
...
- **Why use it:** Auto-upgrades plugins to match DSH version updates seamlessly
...
- **Why use it:** Full backup/restore for DSH config, plugins, MCP servers and skills
...
- **Why use it:** Core DSH plugin ecosystem infrastructure with browser console and dev guidance
...
- **Why use it:** Live provider/model balance display with peak pricing countdown
...
- **Tags:** `context-audit`, `token`, `ui`, `tool`
- **Why use it:** Audit AGENTS.md token costs; detect duplicates and conflicts via Web UI
...
- **Tags:** `container`, `local`, `webview`, `plugin-import`
- **Why use it:** Isolated DSH containers with embedded WebView and one-click plugin import
...
- **Why use it:** One-click MCP/Skills setup for 7+ AI agents; local-first config sync
...
- **Why use it:** Fast, simple, elegant Neovim plugin manager in Lua
...
- **Tags:** `token-usage`, `cost-tracking`, `data-visualization`
- **Why use it:** Real-time token usage tracking and cost visualization for DSH.
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset/custom voices.
...
- **Tags:** `troubleshooting`, `compatibility`, `diagnostics`
...
- **Why use it:** Popular whale girl skin series for DSH, great for personalization
...
- **Tags:** `theme`, `webgpu`, `ocean`, `visual`
- **Why use it:** WebGPU ocean-themed immersive visual skin for DSH web interface.
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性��插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `background`, `webui`, `customization`
- **Why use it:** Customize DSH web background with personal images and presets.
...
- **Why use it:** Curated plugin discovery with daily GitHub automated updates.
...
- **Why use it:** Complete research workflow: LaTeX, arXiv, GPU task orchestration.
...
- **Why use it:** Ultimate DSH guide with quickstart and curated resource list.
...
- **Why use it:** Learn DSH principles and discover marketplace best practices.
...
- **Tags:** `handbook`, `documentation`, `research`
- **Why use it:** Comprehensive agent-first handbook covering runtime and tools
...
- **Why use it:** Industry research methodology skills with policy and news tracking
...
- **Tags:** `evaluation`, `rag`, `benchmark`, `dsh-plugin`
...
- **Tags:** `finance`, `quant`, `stock`, `curated-list`
- **Why use it:** Specialized curated list of 24 verified stock/finance/quant plugins.
...
- **Tags:** `awesome-list`, `radar`, `catalog`
- **Why use it:** Evidence-backed plugin radar with 2Origin lab curation
...
- **Tags:** `awesome-list`, `curated`, `official`
...
- **Tags:** `automation`, `directory`, `awesome-list`
- **Why use it:** Automated daily crawl via GitHub Actions keeps list fresh
...
- **Tags:** `search`, `discoverability`, `plugin-finding`
- **Why use it:** In-agent plugin search combining npm and awesome lists
...
- **Tags:** `repository`, `analytics`, `ecosystem`
...
- **Why use it:** Built-in marketplace for browsing, searching, and one-click installing DSH plugins visually.
...
- **Why use it:** Comprehensive curated plugin directory for the DSH ecosystem
...
- **Why use it:** Curated DSH plugin reference with bilingual support for discovery.
...
- **Tags:** `plugin-market`, `dsh`, `marketplace`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace.
...
- **Tags:** `encyclopedia`, `knowledge-base`, `ai-resources`
- **Why use it:** Encyclopedic AI resource hub covering agents, RAG, and learning paths.
...
- **Why use it:** Curated resource list of DSH plugins, tools and development guides
...
- **Why use it:** Community-maintained auto-syncing DSH plugin marketplace and catalog
...
- **Why use it:** Curated spam-filtered registry of DSH plugins, bundles, and skills.
...
- **Tags:** `awesome-list`, `resource-directory`, `deepseek-harness`
...
- **Tags:** `documentation`, `plugin-guide`, `navigation`
- **Why use it:** Plugin product manual and navigation by scenario for DSH users.
...
- **Tags:** `redirect`, `moved`, `legacy`
- **Why use it:** Redirect notice — original moved to awesome-dsh-plugin org
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `awesome-list`, `meta-resource`
- **Why use it:** Curated list of DSH plugins; useful as a discovery resource.

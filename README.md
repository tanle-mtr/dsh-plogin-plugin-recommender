...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 835,308 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-23 06:11:09 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 185,693 | Core harness powering the entire DSH plugin ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,510 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,875 | Multi-agent swarm harness with autonomous workflow |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 42 plugins
...
- **Why use it:** Super AI assistant with memory, self-evolution, multi-model support
...
- **Tags:** `agent`, `harness-engineering`, `dsh`
- **Why use it:** Best starting point for DSH harness engineering
...
- **Tags:** `routing`, `injector`, `dsh`
- **Why use it:** Task-aware reasoning router and injector kit
...
- **Tags:** `preset`, `bootstrap`, `dsh`
- **Why use it:** Two-phase minimal bootstrap with full standard tools
...
- **Why use it:** First vision plugin enabling image-to-JSON for agents
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `claude-code`
- **Why use it:** One-click model switching for major AI coding agents
...
- **Why use it:** Rust agent runtime paired with polished desktop coding IDE
...
- **Tags:** `dsh-plugin`, `code-review`, `agent-skills`
...
- **Tags:** `dsh-plugin`, `agents`, `coding`
- **Why use it:** Architecture-aware AI coding agents
...
- **Tags:** `dsh-plugin`, `vision`, `agents`
- **Why use it:** Vision toolkit for text-only LLMs
...
- **Tags:** `dsh-plugin`, `macos`, `swift`
- **Why use it:** Swift-native macOS coding agent
...
- **Why use it:** Best context insight and management
...
- **Why use it:** Strong vision toolkit for text models
...
- **⭐ Stars:** 65
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写���心逻辑、自动判题、AI Code Review。
- **Tags:** `agent`, `coding`, `mentor`, `skill`
- **Why use it:** AI编程导师，扫描架构、自动判题
...
- **Why use it:** 开发DSH插件的标准Agent Skill指南
...
- **Tags:** `spec`, `coding`, `agent`, `developer-tools`
- **Why use it:** Spec驱动编程，仓库原生可移植Skill
...
- **Tags:** `plugin-build`, `agent`, `installation`
- **Why use it:** 构建安装DSH插件的Agent Skill
...
- **Tags:** `guide`, `knowledge-base`, `plugin-dev`, `docs`
- **Why use it:** 插件开发知识库，按需调用中英双语
...
- **Why use it:** One-tap Codex import with two-way Skills/MCP sync
...
- **Why use it:** Portable plugin dev and audit skill with bundle adapter
...
- **Why use it:** Practical plugin dev notes: cordis, tsconfig, Windows tips
...
- **Tags:** `nvim`, `lua`
- **Why use it:** Fast Neovim plugin manager in Lua — simple and elegant
...
- **Why use it:** Scaffold and test DSH plugins inside the harness directly
...
- **Why use it:** GUI plugin manager with hot-reload and no restart needed
...
- **Tags:** `agent-tools`, `llm-agents`, `pre-flight`
...
- **Why use it:** OAuth ChatGPT integration for using Plus models in DSH
...
- **Tags:** `awesome-list`, `plugin-recommender`, `dsh`
- **Why use it:** AI-curated comprehensive DSH plugin directory
...
- **Why use it:** DSH plugin listing and discovery
...
- **Tags:** `curated`, `awesome-list`
- **Why use it:** Evidence-aware curated DSH plugin list
...
- **Tags:** `curated-list`, `plugins`, `registry`
- **Why use it:** Comprehensive DSH plugin customization guide
...
- **Why use it:** Multi-source plugin discovery and dedupe
...
- **Why use it:** CLI tool for DSH plugin management
...
- **Why use it:** Full DSH tool catalog sorted by stars
...
- **Tags:** `publisher`, `plugin`, `skill`
- **Why use it:** One-click DSH plugin publishing tool
...
- **Why use it:** Dynamic DSH plugin marketplace UI
...
- **Why use it:** Browser extension suite enhancing Gemini, Claude, ChatGPT UIs
...
- **Why use it:** Modern desktop client built as a DSH plugin ecosystem
...
- **Why use it:** Cross-device agent workspaces and task boards
...
- **⭐ Stars:** 5,620
- **Language:** TypeScript
- **Description:** DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。梁神模式、任务看板、移动端远程与 SSH 运维构筑开发工作台；皮肤深度优化 WebGL、支持 Wallpaper Engine 壁纸；皮肤、宠物、插件经 DSH 大市场一键安装，正成长为 DSH 创意工坊。A pluggable plugin & skin ecosystem for the DSH Web GUI - LiangShen mode, task boards, remote UI, SSH ops, WebGL-optimized skins with Wallpaper Engine wallpapers - growing into a DSH creative workshop.
- **Tags:** `web-ui`, `skin`, `desktop`
- **Why use it:** Web GUI, task boards, wallpapers, and skins
...
- **Why use it:** Fun web-simulated traditional toy, mobile-first
...
- **Why use it:** Extensible sidebar with file editor, terminal, Git, and sub-agents
...
- **⭐ Stars:** 2,327
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，���鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `deepseek-harness`, `dsh-plugin`, `tui`
- **Why use it:** Claude Code-style TUI with whale header and streaming status
...
- **Why use it:** Animated desktop companion pets
...
- **Why use it:** Lightweight 5mb cross-platform desktop
...
- **Tags:** `dsh-plugin`, `desktop`, `local`
- **Why use it:** Local-first AI desktop workspace
...
- **Why use it:** Cute whale widget tracking balance
...
- **Why use it:** Local-first multi-model AI desktop app with self-evolving skills
...
- **Why use it:** CodePilot-style desktop client and plugin suite for DSH
...
- **Why use it:** Native Windows desktop GUI with SSH & mobile access
...
- **Why use it:** Visual non-linear canvas workspace for sessions
...
- **Tags:** `dsh-plugin`, `ui`
- **Why use it:** Live info bar: provider, balance, pricing, countdown at bottom
...
- **Why use it:** Floating HUD showing git status, MCP, skills, model info
...
- **Tags:** `desktop`, `tauri`, `database`, `ssh`
- **Why use it:** Tauri desktop app integrating DB, SSH, Docker + AI
...
- **Tags:** `desktop-app`, `electron`, `modlens`
...
- **Why use it:** Local-first portable memory for all AI agents
...
- **Tags:** `dsh-plugin`, `memory`, `storage`
- **Why use it:** Unlimited memory storage for agents
...
- **Tags:** `agent-memory`, `long-term-memory`, `noema`
...
- **Why use it:** PowerContext memory recall and handoff integration
...
- **Tags:** `claude-code`, `compat`, `memory`
- **Why use it:** Native Claude Code directory integration for DSH
...
- **Why use it:** Digital persona skill for warm, personalized AI interaction
...
- **Why use it:** 470+ prompt templates with Skills automation
...
- **Tags:** `dsh-plugin`, `video-generation`, `agent-skill`
- **Why use it:** Auto-generates Vox-style paper-collage explainer videos
...
- **Tags:** `dsh-plugin`, `workflow`, `agent`
- **Why use it:** Realtime conversational task manager
...
- **Tags:** `dsh-plugin`, `workflow`, `productivity`
- **Why use it:** Organized reusable AI workflows
...
- **Tags:** `multi-agent`, `teamwork`, `workflow`
- **Why use it:** Unifies Claude Code, Codex, Grok, DSH into one collaborating team
...
- **Tags:** `skills`, `vision`, `multimodal`
- **Why use it:** Adds multimodal vision to DeepSeek for UI analysis
...
- **Why use it:** Skill to discover, install & verify DSH plugins
...
- **Tags:** `skills`, `infra`
- **Why use it:** Specialized skills for AI infra dev & debugging
...
- **Tags:** `creative-writing`, `novel-writing`, `skills`
...
- **Tags:** `agent-skills`, `semantic-search`, `skill-routing`
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review
...
- **Why use it:** TDD, debugging and planning skills for DSH
...
- **Why use it:** 85条安全逆向Skill，CTF与渗透测试
...
- **Why use it:** 88个研究营销Agent Skills，跨平台兼容
...
- **Tags:** `ocr`, `image`, `vision`, `skill`
- **Why use it:** 图像转文字OCR，纯文本模型可用
...
- **Why use it:** Cross-platform agent handoff with session memory continuity
...
- **Why use it:** Codex skill adapted from DSH for code simplification
...
- **Why use it:** Bazi/Fengshui/I-Ching traditional wisdom agent skill pack
...
- **Why use it:** 42 skills, 5 CLIs, 1 plugin — all-in-one agent asset package
...
- **Why use it:** Engineering discipline distilled from DSH — portable agent skill
...
- **Tags:** `agent-skills`, `docx`
- **Why use it:** Full Chinese official doc workflow: format, optimize, template
...
- **Why use it:** Infinite canvas with creative agentic skills and MCP tools
...
- **Tags:** `record-replay`, `agent-skills`
- **Why use it:** Record macOS workflows and convert to reusable agent skills
...
- **Why use it:** JSON-based MCP config and .skill upload with hot reload
...
- **Why use it:** Math modeling toolkit with 17 skill cards for DSH
...
- **Tags:** `agent-preset`, `product-management`, `agent`
- **Why use it:** Virtual PM-to-QA team simulation for guided product workflows
...
- **Tags:** `diagrams-as-code`, `agent-skills`, `dsh-plugin`
- **Why use it:** Agent skill generating beautiful architecture and sequence diagrams
...
- **Why use it:** AI-native vector design with Agent Teams
...
- **Why use it:** AI-powered design studio with templates, PPT, and prototyping
...
- **Why use it:** Preview and edit OpenPencil .op docs in-chat
...
- **Why use it:** Generate AI images directly in DSH chats
...
- **Tags:** `design`, `ui`, `styles`, `aesthetics`
- **Why use it:** 6 design style presets to avoid generic AI-looking sites
...
- **Tags:** `ai-agent`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Cross-platform AI content discovery from major Chinese platforms
...
- **Why use it:** Chrome sidebar for direct browser control by DSH without vision
...
- **Why use it:** iOS Simulator and USB device automation with 22 agent tools
...
- **Why use it:** Tabbit browser automation for DSH agents
...
- **Why use it:** DSH beta group photo wall with GitHub OAuth login
...
- **Why use it:** Built-in plugin marketplace for browsing and one-click installs
...
- **Tags:** `dsh-plugin`, `plugin-registry`, `awesome-list`
- **Why use it:** Plugin radar with curated top 50 and auto-updated index
...
- **Why use it:** Curated plugin finder with daily updates and verification
...
- **Why use it:** OAuth login to use ChatGPT/Claude/Grok subscriptions as LLM backends
...
- **Tags:** `web-search`, `free`, `universal`
- **Why use it:** Free web search bridge plugin for all DSH models, no API key needed
...
- **⭐ Stars:** 207
- **Language:** TypeScript
- **Description:** DSH (DeepSeek Harness) 原理学习、插件市场���最佳实践 · Learn DSH principles, plugin marketplace & best practices
- **Tags:** `documentation`, `learning`, `guide`
- **Why use it:** Learn DSH principles, plugin marketplace tips, and best practices
...
- **Tags:** `awesome-list`, `guide`, `starter`
...
- **Tags:** `cost-tracking`, `utilities`
- **Why use it:** Track session/daily costs and API quota usage
...
- **Why use it:** Run Pi Agent extensions as native DSH plugins
...
- **Why use it:** Crash recovery, snapshots, and one-click SAFE MODE
...
- **Tags:** `plugin`, `management`, `ui`, `registry`
- **Why use it:** 插件控制台+开发引导，生态基建
...
- **Tags:** `desktop`, `electron`, `management`, `ui`
- **Why use it:** 桌面控制台，多Tab管理插件与技能
...
- **Tags:** `context`, `audit`, `ui`, `utility`
- **Why use it:** Context audit tool with token cost analysis and Web UI
...
- **Why use it:** Awesome list and plugin directory for DSH ecosystem discovery
...
- **Why use it:** Full DSH config backup/restore with sync via WebDAV
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated DSH plugin list — quick ecosystem overview
...
- **Tags:** `mascot`, `pixel-art`, `skins`
- **Why use it:** Animated pixel-art pet mascots for agents
...
- **Why use it:** Whale girl themed skin series for DSH
...
- **Why use it:** Glassmorphism theme with full visual customization controls
...
- **Why use it:** WebGPU ocean theme with Three.js visuals for DSH
...
- **Tags:** `theme`, `ui`
- **Why use it:** 34 opencode color themes, one-click apply, persists restarts
...
- **Why use it:** Searches 8 major CN platforms and generates cited research reports
...
- **Why use it:** Comprehensive AI encyclopedia covering MCP, RAG, agents, and tools
...
- **Why use it:** 20平台65K+ API文档，零配置搜索
...
- **Tags:** `kline`, `trading`, `analysis`, `finance`
...
- **Tags:** `plugin-directory`, `awesome-list`, `compatibility`
...
- **Tags:** `plugin-registry`, `evidence-backed`, `radar`
...
- **Why use it:** Static portal for discovering and filtering 227+ plugins
...
- **Why use it:** Redirect — migrated to new repository
...
- **Tags:** `bilingual`, `evidence-led`, `curated`
- **Why use it:** Bilingual evidence-led directory with immutable reviews
...
- **Tags:** `catalog`, `automated`, `daily-update`
- **Why use it:** Auto-crawled bilingual plugin catalog updated daily
...
- **Why use it:** Search npm and curated lists from inside DSH agents
...
- **Tags:** `dsh-plugin`, `awesome-list`, `ecosystem`
- **Why use it:** Curated DSH ecosystem tools list
...
- **Why use it:** Curated plugin & skill directory for DSH ecosystem
...
- **Why use it:** Plugin marketplace hub for DeepSeek Harness
...
- **Tags:** `anime`, `search`
- **Why use it:** Search anime across multiple sources in-chat
...
- **Why use it:** Smartisan-style notes with Docker deploy & exports
...
- **Why use it:** One-click DSH plugin marketplace for web GUI
...
- **Tags:** `awesome-list`, `community`, `plugin-marketplace`
- **Why use it:** 社区精选目录，每4小时自动维护
...
- **Why use it:** Curated verified DSH plugin directory
...
- **Why use it:** Spam-filtered open-data plugin registry
...
- **Why use it:** Verified stock/finance/quant DSH plugins list

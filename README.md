...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 865,273 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 18:46:16 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 194,995 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,431 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,383 | Multi-agent swarm framework with autonomous workfl |
...
- **Why use it:** First vision plugin providing OCR and image-to-structured-JSVision bridge.
...
- **Tags:** `code-review`, `agent-skills`, `quality`
...
- **Why use it:** Makes coding agents architecture-aware with drift detection and baseline verification.
...
- **Tags:** `security`, `audit`, `redteam`, `coding`
...
- **Why use it:** Build and test Android apps via live emulator or USB in chat.
...
- **Why use it:** Superpowers skill ported for Reasonix coding harness workflows.
...
- **Why use it:** Agent skill for developing DSH plugins: slots, tools, LLM adapters and packaging standards
...
- **Why use it:** Agent skill guiding plugin development: slots, Typert remotes, credentials and build steps
...
- **Why use it:** Codex skill adapted from DSH code simplification patterns
...
- **Why use it:** Web UI card for managing skills and MCP servers in browser
...
- **Tags:** `plugin-dev`, `documentation`, `guide`
- **Why use it:** DSH plugin development guide covering known pitfalls and fixes
...
- **Tags:** `migration`, `claude-code`, `mcp`, `dsh-plugin`
- **Why use it:** Seamlessly migrates Claude Code settings into DSH with MCP and skill support
...
- **Why use it:** OAuth-bound ChatGPT integration allowing native ChatGPT use inside DSH
...
- **Why use it:** Modern desktop solution for DSH ecosystem with plugin-based architecture
...
- **Tags:** `web-ui`, `aggregation`, `creative-workshop`
- **Why use it:** Web UI aggregation plugin for DSH with creative workshop distribution.
...
- **Tags:** `sidebar`, `ui`, `desktop-extension`
- **Why use it:** Extensible sidebar with file editor, terminal, Git, and chat
...
- **Why use it:** Lightweight 5MB Tauri desktop app, zero-env setup for Windows/macOS/Linux.
...
- **Why use it:** Local-first AI desktop workspace with session, project, and Office support.
...
- **Why use it:** Local-first multi-model AI agent desktop app with privacy focus and self-evolving skills.
...
- **Why use it:** Visual non-linear canvas-based conversation workspace for branching sessions and exploration.
...
- **Why use it:** Full-featured Windows desktop client for DSH
...
- **Why use it:** Thin browser console for managing DSH official repository plugins, zero patch
...
- **Why use it:** Electron desktop hub for managing Harness, plugins, MCP and skills with multi-tab UI
...
- **Why use it:** Pixel-to-text OCR and image reading tools for text-only AI models
...
- **Tags:** `canvas`, `creative`, `cordis`
- **Why use it:** Infinite canvas with creative AI skills for extended productivity
...
- **Tags:** `visualization`, `cost-tracking`, `token-usage`
- **Why use it:** Real-time token usage charts and cost tracking for DeepSeek API
...
- **Why use it:** All-in-one desktop with DB, SSH, Docker and AI assistant in one window
...
- **Why use it:** Desktop shell bundling multiple DSH tools into one integrated app
...
- **Tags:** `ui`, `background`, `personalization`
- **Why use it:** Customizable web background with presets and upload support, real-time preview
...
- **Tags:** `memory`, `local-first`, `markdown-native`, `rag`
- **Why use it:** Portable, local-first memory layer for persistent agent knowledge.
...
- **Tags:** `memory`, `self-evolving`, `hybrid-retrieval`, `token-savings`
...
- **Why use it:** Essential memory management kit for persistent agent recall
...
- **Why use it:** Persistent memory layer powered by Milvus and Markdown
...
- **Tags:** `memory`, `rag`, `persistent-knowledge`
...
- **Tags:** `rag`, `skill-retrieval`, `embeddings`
- **Why use it:** Turn SKILL.md files into retrievable corpora
...
- **Why use it:** Private note-taking with Docker deploy, skill support, image export.
...
- **Tags:** `memory`, `handoff`, `context-engineering`
- **Why use it:** Cross-platform continuity memory for agent handoff and recovery
...
- **Tags:** `context`, `audit`, `memory`, `ui`
- **Why use it:** Context injection audit tool detecting duplicates and conflicts
...
- **Tags:** `evaluation`, `rag`, `agent-evaluation`
...
- **Why use it:** Distill agent thinking patterns into reusable cross-platform skills
...
- **Why use it:** Self-improving Agent OS with continuous loop engineering capabilities.
...
- **Why use it:** Enterprise-grade multi-agent workbench for Codex and DSH teams.
...
- **Why use it:** Intelligent workflow orchestrator for local skills routing
...
- **Why use it:** Enables multi-agent collaboration and team coordination for DSH.
...
- **Tags:** `agent`, `team`, `workflow`, `collaboration`
- **Why use it:** Unifies multiple coding agents into one team for collaborative session dispatch and management.
...
- **Tags:** `math-modeling`, `skill`, `automation`
- **Why use it:** Auto math modeling contest skill with GitOps
...
- **Why use it:** Add multimodal vision to text-only LLMs
...
- **Tags:** `skills`, `framework`, `agent`
- **Why use it:** Turn experience into repeatable agent skills
...
- **Why use it:** SQLite-backed task management with agent claim/review in native UI.
...
- **Why use it:** 85 SKILL.md covering reverse engineering, pentesting and security research
...
- **Tags:** `knowledge-base`, `plugin-development`, `dsh-plugin`
- **Why use it:** Official DSH plugin dev knowledge base and agent skill
...
- **Tags:** `fengshui`, `chinese-traditional`, `agent-skill`
- **Why use it:** Bazi, Fengshui, IChing and TCM fusion AI agent skill with local engine
...
- **Why use it:** Centralized skills manager for DeepSeek Harness ecosystem
...
- **Tags:** `swift-cycle`, `governance`, `project`
- **Why use it:** Swift Cycle governance skill adapter for DSH project management
...
- **Why use it:** Free image reading and generation via vision transcription
...
- **Tags:** `docs`, `gongwen`, `office`
- **Why use it:** Full Chinese official document processing per GB/T 9704 standard
...
- **Tags:** `agent-skill`, `engineering`, `deepseek-harness`
- **Why use it:** Portable agent skill distilling engineering discipline and honest reporting practices
...
- **Tags:** `plugin-creator`, `codex`, `skill`
...
- **Why use it:** Full-stack Godot 4.x development skill for game creation workflows
...
- **Why use it:** Complete plugin scaffolding and testing skill suite inside DSH
...
- **Tags:** `agent`, `workflow`, `product`
- **Why use it:** Simulates a full product team (PM/QA/Eng) conversation flow for decision-making
...
- **Tags:** `agent`, `plugin`, `automation`
- **Why use it:** Pre-flight plugin check for agents — auto-injects relevant plugins per task
...
- **Why use it:** 2-way bridge between OpenAI Codex and DSH with live MCP mirroring
...
- **Tags:** `mcp`, `capability`, `tools`
- **Why use it:** Unified menu to manage MCP tools exposure and execution modes
...
- **Why use it:** Cross-browser extension suite enhancing Gemini, Claude and ChatGPT UIs
...
- **Tags:** `content-discovery`, `web-automation`, `chinese-platforms`
- **Why use it:** Cross-platform content discovery agent for Chinese platforms
...
- **Why use it:** Runs live iOS Simulator and USB iPhone inside conversation with 22 agent automation tools.
...
- **Why use it:** Tabbit Browser automation powered by Playwright inside DSH.
...
- **Tags:** `social`, `community`, `photo`
- **Why use it:** DSH community photo wall with OAuth login
...
- **Why use it:** DingTalk IM channel with streaming bot and emotion features.
...
- **Tags:** `self-hosted`, `mcp-server`, `resume-builder`
- **Why use it:** Privacy-first resume builder with full customization and self-hosting
...
- **Tags:** `electron`, `image-uploader`, `cloudflare-r2`
...
- **Tags:** `low-code`, `workflows`, `self-hosted`
- **Why use it:** Open-source AI-powered low-code platform for rapid business system building
...
- **Tags:** `router`, `injector`, `task-aware`
- **Why use it:** Task-aware router and injector kit for intelligent request routing.
...
- **Why use it:** Two-phase preset for minimal bootstrap to full Standard tools coverage.
...
- **Why use it:** Unified virtual filesystem providing consistent file access for agents.
...
- **Tags:** `claude-code`, `deepseek-harness`, `utility`
- **Why use it:** One-click model switch between major coding agents
...
- **Why use it:** Built-in plugin marketplace with browse, search, and install
...
- **Why use it:** Dashboard and CLI for context insight, statistics, and management.
...
- **Why use it:** Free web search plugin and search bridge for all models without native web access.
...
- **Why use it:** Track session costs and API quotas
...
- **Why use it:** Run Pi extensions as native DSH plugins
...
- **Why use it:** Crash recovery via undo snapshots, SAFE MODE, offline CLI/GUI.
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms across multiple AI tools
...
- **Why use it:** Backup, restore, sync and migrate complete DSH configuration
...
- **Tags:** `utility`, `info`, `monitoring`
- **Why use it:** Live provider, model, balance and pricing info bar
...
- **Tags:** `mascot`, `pixel-art`, `animation`, `pets`
- **Why use it:** Gallery of animated pet mascots for coding agents personalization.
...
- **Why use it:** Glass-style frosted theme with full customization, no source code modification needed.
...
- **Why use it:** Stunning WebGPU ocean theme for DSH
...
- **Why use it:** 6 design styles to avoid generic AI website aesthetics
...
- **Why use it:** 34 opencode themes for DSH, one-click switch without restart
...
- **Why use it:** Beginner-friendly tutorial to learn harness engineering from scratch.
...
- **Why use it:** Curated plugin list for discovering top DSH ecosystem tools.
...
- **Why use it:** Comprehensive plugin discovery and ranking with 9000+ candidates tested.
...
- **Tags:** `awesome-list`, `ecosystem`, `index`
- **Why use it:** Comprehensive curated index of DSH plugins and ecosystem tools.
...
- **Why use it:** Curated bilingual plugin and extension list for DeepSeek Harness with verified references.
...
- **⭐ Stars:** 274
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复���：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `discovery`, `plugin`, `awesome-list`
- **Why use it:** Daily automated plugin discovery with real classification, heat rankings, and usage guides.
...
- **Tags:** `ai-pedia`, `resource`, `encyclopedia`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, MLOps, and learning roadmaps.
...
- **Why use it:** Learn DSH principles, plugin marketplace exploration, and best practices in one place.
...
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet copy support.
...
- **Tags:** `kline`, `analysis`, `market`, `trading`
- **Why use it:** Interactive K-line analysis with technical indicators and fundamentals
...
- **Tags:** `research`, `mcp`, `zhihu`
- **Why use it:** Zhihu search and Zhida Q&A via Skill, CLI and MCP
...
- **Why use it:** Public plugin directory with install commands and ecosystem discovery tools
...
- **Why use it:** 2026 curated plugin list with quality verification checks
...
- **Why use it:** Open-data spam-filtered registry for plugins, bundles, and skills
...
- **Tags:** `verified`, `evidence-led`, `directory`
- **Why use it:** Evidence-led verified directory with permission-aware installation guidance
...
- **Tags:** `finance`, `stock`, `quant`, `directory`
- **Why use it:** Curated finance/stock plugin directory with bilingual entries for DSH
...
- **Why use it:** Curated evidence-led directory of DSH plugins for discovery.
...
- **Why use it:** Built-in plugin search tool for DSH agent discoverability.
...
- **Why use it:** Comprehensive 1000+ DSH plugin repo sorted by stars.
...
- **Why use it:** Curated collection of plugins, tools, skills & resources.
...
- **Why use it:** Basic DSH plugin directory for quick reference.
...
- **Tags:** `curated`, `typescript`, `registry`
...
- **Tags:** `industry`, `awesome-list`, `niche`
- **Why use it:** Industry-specific DSH plugins for finance, legal, HR, healthcare.
...
- **Tags:** `game`, `web-simulation`, `chinese-culture`
- **Why use it:** Web-based Bilibili toy simulation with real audio samples
...
- **Tags:** `armor-breaking`, `prompt`, `deepseek`
...
- **Why use it:** Comprehensive DSH starter guide and resource hub
...
- **Why use it:** Curated plugin/skill/MCP catalog for DSH
...
- **Why use it:** 3100+ plugin marketplace with search API
...
- **Tags:** `marketplace`, `plugin-catalog`
...
- **Why use it:** Auto-search-install-verify DSH GitHub plugins
...
- **Why use it:** Curated awesome list of useful DSH plugins, extensions and tools
...
- **Why use it:** Official auto-generated list of DeepSeek Harness Cordis plugins curated by cordis.run
...
- **Why use it:** Verified star-ranked community plugin directory for DeepSeek Harness
...
- **Why use it:** Plugin documentation and navigation guide organized by usage scenario
...
- **Tags:** `radar`, `evidence`, `testing`
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for testing community plugins
...
- **Tags:** `portal`, `directory`, `static-site`
- **Why use it:** Zero-dependency static portal to browse and install 227+ curated plugins
...
- **Why use it:** Deekseek Harness plugin repository listing
...
- **Why use it:** Redirect notice — original repo moved to github.com/awesome-dsh-plugin/awesome-dsh-plugin
...
- **Why use it:** Automated daily GitHub crawl building a bilingual plugin directory
...
- **Why use it:** CodeX-style marketplace for browsing and installing DSH plugins.

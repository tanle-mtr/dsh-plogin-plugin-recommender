...
|--------|-------|
| **Plugins tracked** | 190 |
| **Total community stars** | 834,268 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 03:18:09 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 185,354 | Core DSH framework; essential plugin ecosystem fou |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,472 | Open-source design system generator for coding age |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,872 | Multi-agent swarm orchestration with autonomous wo |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 34 plugins
...
- **Why use it:** Core DSH framework; essential plugin ecosystem foundation
...
- **Why use it:** Beginner tutorial for DSH plugin development
...
- **Tags:** `agent-orchestration`, `coding-agent`, `workspaces`
- **Why use it:** Unified multi-agent workspace & task orchestration
...
- **Why use it:** Two-phase DSH preset for Standard tool integration
...
- **Why use it:** Switch models一键安装多编码Agent
...
- **Tags:** `coding-agent`, `spec-driven`
- **Why use it:** Architecture-aware safe coding agent
...
- **Tags:** `coding`, `multi-agent`, `teamwork`
- **Why use it:** Unifies Claude Code, Codex, Grok, DSH into one team
...
- **Why use it:** One-click install & update for all DSH plugins via GUI
...
- **Tags:** `multi-agent`, `orchestration`, `subagent`
...
- **Why use it:** Web UI panel for managing skills & MCP tools
...
- **Tags:** `plugin-dev`, `coding`, `harness-tools`
- **Why use it:** Standard skill for developing DSH plugins
...
- **Tags:** `plugin-dev`, `harness-tools`, `build`
- **Why use it:** Build & manage DSH plugins with slots & credentials
...
- **⭐ Stars:** 18
- **Language:** TypeScript
- **Description:** DSH 上下文���入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context`, `audit`
- **Why use it:** Audit context tokens, detect duplicates and conflicts
...
- **Tags:** `codex`, `sync`
- **Why use it:** One-tap Codex import with Skills and MCP sync
...
- **Why use it:** Skill for developing and auditing DSH plugins
...
- **Tags:** `best-practices`, `dsh-plugin`
- **Why use it:** DSH plugin dev practices and troubleshooting archive
...
- **Why use it:** Skills for building and testing DSH plugins inside DSH
...
- **Tags:** `plugin-manager`, `hot-reload`
- **Why use it:** Essential plugin manager with hot-reload GUI for MCP and skills
...
- **Why use it:** Bridges Claude Code memory and skills into DSH seamlessly
...
- **Why use it:** Native .claude/ directory bridge for skills, commands, rules
...
- **Tags:** `conflict-resolution`, `harness`
- **Why use it:** Solves plugin and version conflicts
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** OAuth ChatGPT integration in DSH
...
- **Tags:** `dsh-plugin`, `registry`, `discovery`
- **Why use it:** Unified plugin discovery via merged multi-source search
...
- **Why use it:** CLI tool for discover, install, update and manage DSH plugins
...
- **Why use it:** Interactive plugin marketplace with search and install
...
- **Why use it:** Web UI skins: task board, git graph, mobile, live stats
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `agent-runtime`
- **Why use it:** 高性能Rust Agent桌面应用
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Tauri desktop app, lightweight installer
...
- **Tags:** `desktop`, `office-automation`
...
- **Tags:** `widget`, `ui`
- **Why use it:** Cute whale widget tracks account balance
...
- **Why use it:** Native Windows desktop GUI with SSH and mobile remote access
...
- **Why use it:** Visual non-linear canvas workspace for conversation branching
...
- **Tags:** `ui`, `dsh-plugin`
- **Why use it:** Persistent bottom bar showing provider, model, pricing info
...
- **Why use it:** Floating HUD panel showing git, MCP, skills, and token status
...
- **Why use it:** Tauri 2 desktop app with DB, SSH, Docker, and AI in one window
...
- **Why use it:** Electron desktop with dsh web integration
...
- **Why use it:** Self-evolving context database unifying agent memory
...
- **Why use it:** LLM knowledge platform with RAG, reasoning & wiki
...
- **Why use it:** Portable long-term memory layer for AI agents
...
- **Why use it:** Self-evolving memory with hybrid retrieval & token savings
...
- **Why use it:** Unlimited context memory for agents
...
- **Why use it:** Curated agent-skill corpora with retrieval & evaluation
...
- **Why use it:** Official DSH plugin dev knowledge base as agent skill
...
- **Tags:** `memory`, `agent-skills`
- **Why use it:** HTTP recall, memory, handoff and experience plugin
...
- **Tags:** `agent-skills`, `ai-persona`, `digital-human`
- **Why use it:** Digital persona skill for emotional AI companionship
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `video-generation`
- **Why use it:** 一键生成Vox风格视频
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `code-review`
- **Why use it:** AI代码审查与架构建议
...
- **Why use it:** Reusable agent skills across Claude, Codex, GPT, and Grok
...
- **Why use it:** Adds multimodal vision to DSH for screenshot and UI analysis
...
- **Tags:** `anime`, `search`, `torrent`
- **Why use it:** Search anime across sources with Bangumi ratings and magnet links
...
- **Tags:** `notes`, `docker`, `skill`
- **Why use it:** Smartisan-style notes with Docker deploy and skill integration
...
- **Tags:** `creative-writing`, `screenwriting`, `fiction`
- **Why use it:** Novel writing & short-drama production with Oh Story
...
- **Why use it:** Full reverse engineering & pentest skill set (85 SKILL.md)
...
- **Why use it:** AI coding mentor with step-by-step project guidance
...
- **Why use it:** 88 skills for research, social intel & marketing workflows
...
- **Why use it:** Spec-driven development skill for DSH projects
...
- **Why use it:** OCR & pixel-to-text tools for text-only models
...
- **Why use it:** Code simplification skill adapted from DSH for Codex
...
- **Why use it:** Fusion Bazi, Fengshui, IChing AI agent skill pack
...
- **Why use it:** Manage DSH skills directly from the plugin
...
- **Why use it:** Image reading and generation skills for DSH
...
- **Why use it:** Swift Cycle governance skill for DSH projects
...
- **Why use it:** 42 agent skills, 5 CLIs for AI/LLM agent engineering
...
- **⭐ Stars:** 12
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，��持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `agent-skill`, `gongwen`
- **Why use it:** Chinese official document formatting and writing skill
...
- **Why use it:** Infinite canvas with agentic creative skills
...
- **Why use it:** 17 math modeling skill cards with presets for DSH
...
- **Why use it:** Full-stack Godot 4.x dev skill for game development
...
- **Why use it:** Virtual PM-to-engineer-to-QA agent team preset
...
- **Why use it:** In-agent plugin search & discovery
...
- **Why use it:** One-click publish workflow for skills and plugins
...
- **Tags:** `routing`, `mcp`, `agent-tools`
- **Why use it:** Runtime injector & task-aware reasoning router for DSH
...
- **Why use it:** Unified virtual filesystem for AI agents
...
- **Why use it:** Vision bridge: paste images, get structured JSON evidence
...
- **⭐ Stars:** 162
- **Language:** TypeScript
- **Description:** DeepSeek Harness plugin store, marketplace and hub — 3,100+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与格式校验，��费搜索 API。deepseek1024.com
- **Tags:** `marketplace`, `directory`, `catalog`
- **Why use it:** 3,100+ plugin marketplace with search and public API access
...
- **Why use it:** JSON config MCP connection with hot reload, no restart needed
...
- **Why use it:** Open-source design system generator for coding agents
...
- **Tags:** `diagram-as-code`, `architecture`, `mermaid`
- **Why use it:** AI-generated architecture and workflow diagrams as code
...
- **Why use it:** GPT-Image2 prompt templates & image generation skills
...
- **Tags:** `vision`, `ocr`
- **Why use it:** DSH-native vision & OCR toolkit
...
- **Why use it:** AI-powered design studio with PPT, prototyping & templates
...
- **Why use it:** Generate images directly within DSH chat interface
...
- **Why use it:** Turn litigation materials into courtroom-ready visuals
...
- **Why use it:** 6 design styles to keep vibe-coded sites unique
...
- **Tags:** `ai-image`, `ai-video`, `dsh-plugin`
- **Why use it:** AI video/image/audio generation and storyboard skills
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `browser-use`
- **Why use it:** 真实浏览器自动化Agent
...
- **Why use it:** Browser extension for AI workflows
...
- **Tags:** `browser`, `chrome-extension`, `automation`
- **Why use it:** Direct Chrome sidebar control for DSH browser automation
...
- **Why use it:** iOS Simulator + USB iPhone automation with 22 agent tools
...
- **Why use it:** Tabbit Browser automation plugins for DSH agents
...
- **Why use it:** Record macOS desktop workflows as agent skills
...
- **Tags:** `community`, `photo`
- **Why use it:** OAuth-gated group photo wall for DSH community
...
- **Why use it:** AI + no-code platform for rapid business system builds
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `plugin-registry`
- **Why use it:** 精选插件雷达与索引
...
- **Why use it:** Curated plugin finder with auto-scraping and verification
...
- **Tags:** `guide`, `learning`, `best-practices`
- **Why use it:** DSH principles, plugin marketplace guide & best practices
...
- **Why use it:** Ultimate DSH guide with quickstart, plugins & toolkits
...
- **Why use it:** Track session/daily costs and token usage with budget alerts
...
- **Why use it:** Crash recovery with undo config & plugin snapshots
...
- **Why use it:** Official plugin console & dev guide for DSH ecosystem
...
- **Tags:** `containers`, `utils`, `infrastructure`
- **Why use it:** Isolated container runner for multiple DSH versions
...
- **Tags:** `config-manager`, `dsh-plugin`
- **Why use it:** Backup, restore, sync DSH config and plugins via WebDAV
...
- **Why use it:** Public gallery of animated pets for agent tools
...
- **Why use it:** Frosted glass theme with full customization controls
...
- **Why use it:** WebGPU ocean skin for immersive DSH visual experience
...
- **⭐ Stars:** 12
- **Language:** JavaScript
- **Description:** 🎨 看腻了 DSH 默认���肤？34 款 opencode 经典配色一键换上——tokyonight、dracula、gruvbox、matrix、rose-pine……即点即换，重启不丢。34 opencode themes for DeepSeek Harness, one click, persisted. More by @FeatherHunter: ⚡ dsh-prompt · 🧠 dsh-mattpocock-skills-deck
- **Tags:** `theme`, `skins`, `dsh-plugin`
- **Why use it:** 34 opencode color themes, one-click switch for DSH
...
- **Tags:** `ai-guide`, `tutorials`, `research`
- **Why use it:** Comprehensive AI resources & vibe coding tutorial hub
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `research`
- **Why use it:** 自动搜索生成研究报告
...
- **Why use it:** Curated DSH tools & infrastructure list
...
- **Why use it:** Curated DSH ecosystem resource list and plugin index
...
- **Why use it:** Curated awesome list of DSH plugins & resources
...
- **Why use it:** Curated directory of DSH plugins, tools & resources
...
- **Why use it:** Auto-synced plugin community catalog & curated list
...
- **Why use it:** Search 65,600+ Chinese platform API docs instantly
...
- **Tags:** `directory`, `community`, `awesome-list`
- **Why use it:** Official curated plugin directory by cordis.run
...
- **Why use it:** Awesome list and plugin discovery directory for DSH
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated plugin directory with permission-aware install guide
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Curated DSH plugin list for 2026
...
- **Tags:** `navigation`, `awesome-list`
- **Why use it:** Plugin navigator with install & risk guides
...
- **Why use it:** Evidence-backed DSH plugin radar
...
- **Why use it:** Moved to awesome-dsh-plugin org
...
- **Why use it:** Star-ranked verified community plugins
...
- **Tags:** `bilingual`, `awesome-list`
- **Why use it:** Evidence-led bilingual reviewed directory
...
- **Why use it:** Auto-crawled bilingual DSH plugin directory
...
- **Tags:** `recommender`, `ai-curate`
- **Why use it:** AI-curated 190+ plugin recommender list
...
- **Why use it:** Curated DSH plugin directory and reference list
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** DSH plugin curated listing for discovery
...
- **Tags:** `dsh-plugin`, `coding-agents`, `skills`
- **Why use it:** Comprehensive curated DSH plugin directory
...
- **Tags:** `dsh-plugin`, `cordis-plugin`
- **Why use it:** Official auto-generated Cordis plugin index
...
- **Why use it:** Full ecosystem plugin catalog sorted by stars
...
- **Why use it:** Comprehensive AI encyclopedia: skills, MCP, RAG, resources
...
- **Tags:** `web`, `plugin-portal`
- **Why use it:** Static web portal for DSH plugin discovery

...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,064,610 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 230,752 | Core framework for the entire DSH plugin ecosystem |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,197 | Local-first open-source design tool for AI agents |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,889 | Multi-agent swarm orchestration with autonomous wo |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 50 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (50)
...
- **Why use it:** Core framework for the entire DSH plugin ecosystem
...
- **Tags:** `routing`, `injector`, `harness-tool`, `performance`
...
- **Why use it:** Vision bridge enabling image-to-JSON OCR for agents
...
- **Why use it:** Two-phase preset for minimal bootstrap then full tools
...
- **Tags:** `agent-runtime`, `rust`, `coding`
...
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits, and MCP integration for terminal workflows
...
- **Tags:** `ios`, `mobile-automation`, `coding-agent`, `webdriveragent`
- **Why use it:** Run live iOS Simulator inside DSH with 22 agent tools for booting, building and driving
...
- **Tags:** `agent-skills`, `multimodal`, `vision`, `claude-code`
- **Why use it:** Adds multimodal vision to Claude Code for UI/frontend analysis
...
- **Tags:** `deepseek-harness`, `huaweicloud`, `mcp`, `cloud-sdk`
- **Why use it:** Official Huawei Cloud devkit with MCP tools, skills, and sandbox support.
...
- **Tags:** `plugin-development`, `knowledge-base`, `scaffold`, `cordis`
- **Why use it:** Official DSH plugin dev knowledge base and scaffold bundle
...
- **Tags:** `context-audit`, `tool`, `ui`, `optimization`
- **Why use it:** Audit context injection: token cost analysis, duplicate/conflict detection
...
- **Why use it:** Fast and elegant Neovim plugin manager for coding workflow enhancement
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset and custom voice options
...
- **Tags:** `chatgpt`, `oauth`, `dsh-plugin`, `ai-agents`
- **Why use it:** Enables ChatGPT OAuth integration directly within DSH for model access.
...
- **Why use it:** Browser extension enhancing multiple AI platforms with prompt management
...
- **Why use it:** Official desktop app wrapping DeepSeek Harness with native experience
...
- **Tags:** `web`, `aggregation`, `ecosystem`, `marketplace`
- **Why use it:** Web-based plugin aggregation hub distributed via creative workshop
...
- **Why use it:** Visual plugin marketplace for one-click DSH installs
...
- **Why use it:** Open sidebar foundation with extensible third-party pages
...
- **⭐ Stars:** 3,112
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实���状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `terminal`, `ui`
- **Why use it:** Claude Code-style TUI with whale theme and streaming thinking
...
- **⭐ Stars:** 2,778
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动���用，建议直接喊来你的dsh安装
...
- **Why use it:** Zero-setup Tauri desktop with only 5mb installer across all OS
...
- **Why use it:** Zero-setup Windows desktop GUI for DSH with plugins, SSH, and mobile remote access
...
- **Why use it:** Local-first desktop AI agent with Tauri, multi-model and self-evolving skills
...
- **Tags:** `office`, `productivity`, `desktop-extension`
- **Why use it:** Brings spreadsheets, docs, slides and canvases natively into DeepSeek Harness
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and native Web UI
...
- **Tags:** `mobile`, `ios`, `kmp`, `native-client`
- **Why use it:** Native iOS client connecting via WebSocket to bring workspace and agent traces to iPhone
...
- **Tags:** `cordis`, `dsh-plugin`, `skill-manager`
- **Why use it:** In-app skill manager with invocation auditing for DSH
...
- **Tags:** `mcp`, `skills`, `ui`, `plugin`
- **Why use it:** Web UI plugin for visual skill and MCP management in DSH
...
- **Tags:** `plugin-market`, `ui`, `web`, `community`
- **Why use it:** Community plugin market in Web GUI with one-click install/uninstall
...
- **Tags:** `deepseek-harness`, `desktop-app`, `electron`, `ui`
- **Why use it:** Desktop management console with multi-tab Harness/Plugin/MCP/Skill manager.
...
- **Tags:** `bioinformatics`, `desktop-app`, `tauri`, `llm-agent`
- **Why use it:** Desktop bioinformatics agent with offline mode and skill store
...
- **Tags:** `ui-extension`, `info-bar`, `pricing`, `usage-tracking`
...
- **Tags:** `terminal`, `keybindings`, `enhancement`
- **Why use it:** Keybindings, terminal, task notifications and LLM trace inspection UI tools
...
- **Tags:** `ui`, `compact`, `webui`
- **Why use it:** One-click compact button for context meter panel
...
- **Why use it:** Distill human thinking patterns into reusable agent skills
...
- **Tags:** `no-code`, `workflows`, `low-code`
...
- **Tags:** `workspace`, `task-board`, `cross-platform`, `no-code`
- **Why use it:** Unified agent workspace with task boards across all devices and APIs
...
- **Tags:** `skills`, `marketplace`, `coding`, `finance`, `automation`
- **Why use it:** Largest skills marketplace covering coding, finance, automation workflows
...
- **Tags:** `enterprise`, `multi-agent`, `workspace`, `visual-editor`
...
- **Tags:** `agent-os`, `evaluation`, `loop`, `mcp`, `evolution`
- **Why use it:** Self-evolving agent OS with staged evaluation loop and budget management
...
- **Tags:** `control-plane`, `long-horizon`, `governance`, `workflow`
- **Why use it:** Long-horizon agent control plane with durable governance across harnesses
...
- **Why use it:** Intelligent skill routing with significant token reduction
...
- **Why use it:** Inference-time control for deep reasoning and error recovery
...
- **Tags:** `video`, `skill`, `ffmpeg`
- **Why use it:** End-to-end automated Vox-style paper-collage video generation
...
- **Why use it:** Multi-agent team coordination plugin for collaborative DSH tasks
...
- **Why use it:** Complete AI novel writing pipeline from inspiration to final draft
...
- **Tags:** `creative-writing`, `novel-writing`, `workflows`
- **Why use it:** Built-in workbenches for novel, short drama, game script, and video recap creative writing
...
- **Tags:** `multimodal`, `computer-vision`, `agent-skills`
- **Why use it:** Gives agents video/audio/screen observation with timestamped verifiable evidence
...
- **Tags:** `agent-skills`, `math-modeling`, `codex`
...
- **Tags:** `agent-preset`, `scientific-discovery`, `dsh-plugin`
- **Why use it:** Brings epistemic loop for scientific discovery to DSH
...
- **Tags:** `acceptance-review`, `plan-mode`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `cross-platform`, `coding`
...
- **Tags:** `agent-skills`, `research-automation`, `deep-research`
...
- **Tags:** `stock`, `mcp`, `financial-analysis`
- **Why use it:** Multi-agent financial system with local DB and IM alerts
...
- **Tags:** `agent-learning`, `skill-generator`, `agent-skills`
...
- **⭐ Stars:** 86
- **Language:** TypeScript
- **Description:** 一个面向 DeepSeek Harness 的统一能力管理插件，为 Tools/Skills 提供常驻、按需、禁用三档暴露策略，以减少上下文占用并支持运行时动态发现���执行。
- **Tags:** `deepseek-harness`, `dsh-plugin`, `capability-management`
- **Why use it:** Dynamic skill exposure strategy reduces context overhead effectively.
...
- **Why use it:** Transforms AI into a coding mentor with structured learning workflows.
...
- **Tags:** `agent-skills`, `web-search`, `mcp`, `multi-agent`
- **Why use it:** Comprehensive web search and research skills for AI agents across platforms.
...
- **Tags:** `deepseek-harness`, `skills`, `dsh-plugin`
- **Why use it:** 25 ready-to-use engineering skills including triage, grilling, wayfinder.
...
- **Tags:** `deepseek-harness`, `gongwen`, `docx`, `skill`
- **Why use it:** Professional Chinese official document processing with format validation.
...
- **Why use it:** Spec-driven development agent skill with repo-native patterns
...
- **Why use it:** Chinese metaphysics skill: Bazi, Fengshui, IChing with dashboard
...
- **Tags:** `quality-gate`, `engineering-discipline`, `delivery`
- **Why use it:** Engineering discipline skill: grill requirements before shipping
...
- **Tags:** `multi-agent`, `agent-team`, `collaboration`
...
- **Tags:** `qa`, `testing`, `playwright`, `pytest`, `agent-skills`
- **Why use it:** 11 QA agent skills with shared KB and type decision matrix
...
- **Why use it:** Durable multi-agent team with per-member memory across sessions
...
- **Why use it:** Enables quick skill selection via slash commands in DSH composer
...
- **Why use it:** Cross-platform skill maintains agent context continuity across sessions
...
- **Tags:** `config-sync`, `mcp`, `skills`, `multi-agent`
- **Why use it:** One-click config sync for MCP and skills across AI agent tools
...
- **Tags:** `math-modeling`, `agent`, `competition`, `multi-agent`
- **Why use it:** 5-role multi-agent math modeling system with 33 models and paper templates
...
- **Why use it:** Comprehensive math modeling toolkit covering data prep to paper writing
...
- **Tags:** `plan-first`, `workflow`, `collaboration`
- **Why use it:** Deliberation-action separation mechanism improves AI task collaboration
...
- **Tags:** `godot`, `game-development`, `gdscript`, `skill`
- **Why use it:** Full-stack Godot 4.x game dev skill with GDScript and runtime registration
...
- **Tags:** `video`, `remotion`, `motion-design`, `skill`
- **Why use it:** 152-shot film-grade video production skill with Remotion templates and assets
...
- **Why use it:** Agent skill for standard DSH plugin development workflows with Claude Code/Codex
...
- **Why use it:** Pre-flight plugin check for agents, boosts library utilization
...
- **Tags:** `vision`, `ocr`, `tools`
- **Why use it:** Powerful vision toolkit enabling image Q&A and OCR for text-only models
...
- **⭐ Stars:** 512
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的模��补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `free`, `mcp`
- **Why use it:** Free web search bridge for any model without native web access — no signup required
...
- **Why use it:** Local-first open-source design tool for AI agents
...
- **Tags:** `image-generation`, `prompt-engineering`, `gpt-image-2`
...
- **Tags:** `design`, `vector`, `ui`, `agent-team`, `flutter`
...
- **Tags:** `ui-components`, `charts`, `visual`
- **Why use it:** Generates interactive UI components—charts, layouts, forms—rendered inline in responses
...
- **Tags:** `deepseek-harness`, `legal`, `diagram`, `svg`, `litigation`
- **Why use it:** Legal litigation visualization with timeline, confrontation charts, and entity graphs.
...
- **Tags:** `video-generation`, `image-generation`, `ai-director`
- **Why use it:** AI video/image/audio generation with storyboard and corpus support
...
- **Why use it:** Real-time token usage charts, cost estimates and API balance dashboard
...
- **Tags:** `knowledge-cards`, `visual`, `shareable`
- **Why use it:** Transforms chat history into downloadable knowledge cards
...
- **Why use it:** Use logged-in browser for agent automation seamlessly
...
- **Tags:** `content-discovery`, `cross-platform`, `web`
- **Why use it:** Cross-platform self-evolving content discovery from major sites
...
- **Tags:** `browser-automation`, `fingerprint-spoofing`, `playwright`
- **Why use it:** Persistent identity browser with fingerprint spoofing and unlimited local profiles via Playwright
...
- **Why use it:** Tabbit Browser plugins for DeepSeek Harness with Playwright support
...
- **Why use it:** Private, self-hosted resume builder with MCP integration
...
- **Why use it:** First virtual terminal for isolated agent sandboxing
...
- **Tags:** `model-switch`, `install`, `utility`
...
- **Why use it:** Ecosystem radar discovering and continuously validating 21k+ plugins
...
- **Why use it:** Best context dashboard, browser sidebar and management insights
...
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with curated reviews
...
- **Why use it:** CLI, schemas, and resolver for DSH Plugin Hub — essential infrastructure for plugin management
...
- **Why use it:** Track session/daily costs, budgets, history and multi-provider balance in one view
...
- **Tags:** `llm-provider`, `command-code`, `infrastructure`
- **Why use it:** Adds Command Code model access with live catalog, plan-aware selection and reasoning support
...
- **Why use it:** Bridges Pi and DSH ecosystems with shared ABI layer
...
- **Why use it:** Complete DSH backup/restore with export, import, migration and WebDAV sync
...
- **Tags:** `deepseek-harness`, `plugin-management`, `dsh-plugin`
- **Why use it:** Essential plugin infrastructure with registry console and skill scaffolding.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `skill-manager`
- **Why use it:** Unified and safe local Agent Skills management within DSH ecosystem.
...
- **Why use it:** OCR/vision tools enabling text-only models to read images
...
- **Tags:** `dsh-plugin`, `container`, `multi-version`
...
- **Tags:** `launcher`, `orchestration`, `runtime`, `plugin`
- **Why use it:** Unified orchestrator for DSH runtime, plugins, skills and MCP capabilities
...
- **Tags:** `migration`, `session-import`, `claude-code`, `coding`
- **Why use it:** Migration wizard moving sessions and skills from Claude Code, Codex and more
...
- **Tags:** `marketplace`, `desktop`, `plugin-store`
...
- **Tags:** `directory`, `automated`, `bilingual`
...
- **Why use it:** Animated pet gallery adding personality to coding agents
...
- **Why use it:** Adorable whale girl skin series for DSH interface customization
...
- **Tags:** `theme`, `glassmorphism`, `ui-customization`
- **Why use it:** Highly customizable frosted-glass theme for the DSH web UI with adjustable blur and opacity
...
- **Tags:** `theme`, `skin`, `animated-background`, `threejs`
- **Why use it:** Real-time ocean theme with adjustable waves, sunset and glassmorphism effects
...
- **Tags:** `webui`, `customization`, `themes`
...
- **Why use it:** Comprehensive AI resource hub and beginner-friendly tutorials
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, experiment tracking, and GPU SSH orchestration
...
- **Why use it:** Comprehensive DSH handbook with runtime and MCP coverage
...
- **Why use it:** Industry research domain pack with chain mapping, policy tracking and reports
...
- **Tags:** `awesome-dsh-plugin`, `plugin-marketplace`, `deepseek-harness`
- **Why use it:** Curated plugin catalog with auto-sync, essential DSH ecosystem discovery.
...
- **Tags:** `deepseek-harness`, `api-documentation`, `chinese-api`, `mcp`
- **Why use it:** Search 65,600+ API docs from 20 major Chinese platforms instantly.
...
- **Tags:** `deepseek-harness`, `patent`, `legal-tech`, `rag`
- **Why use it:** Patent infringement analysis with skill packaging for any agent platform.
...
- **Tags:** `skillhub`, `api-docs`, `examples`, `reference`
- **Why use it:** SkillHub open API docs with DSH plugin examples and references
...
- **Tags:** `kline`, `trading`, `analysis`, `sidebar`
...
- **Why use it:** Curated awesome list for discovering DSH plugins and ecosystem resources
...
- **Tags:** `plugin-registry`, `skills`, `curated-list`
- **Why use it:** Spam-filtered open-data registry with skills and bundles catalog
...
- **Tags:** `awesome-list`, `typescript`, `nextjs`
- **Why use it:** Public GitHub directory with install commands and ecosystem discovery tools
...
- **Why use it:** Bilingual curated list of 24 verified stock/finance/quant DSH plugins
...
- **Why use it:** Evidence-led directory with permission-aware installation guidance
...
- **Why use it:** 2026 curated list with quality checks for reliable plugin discovery
...
- **Why use it:** Curated collection of useful and practical DSH plugins
...
- **Tags:** `radar`, `evidence-backed`, `analysis`
...
- **Why use it:** Curated plugin directory for discovering quality DSH extensions
...
- **Why use it:** Bilingual curated list of DSH plugins, tools, skills, and verified integrations
...
- **Why use it:** Comprehensive AI knowledge encyclopedia covering agents, RAG, MLOps, and learning roadmaps
...
- **⭐ Stars:** 348
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图��导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **Tags:** `awesome-list`, `discovery`, `plugin-marketplace`
- **Why use it:** Curated plugin discovery with daily GitHub scans, scenario-based classification and ranking
...
- **Tags:** `awesome-list`, `resource`, `curation`
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCP servers and orchestrators
...
- **Tags:** `guide`, `resource`, `documentation`
- **Why use it:** Ultimate DSH guide with quickstart, resources, curated plugins and practical toolkits
...
- **Tags:** `discovery`, `education`, `marketplace`
...
- **Tags:** `catalog`, `marketplace`, `dsh-plugins`
- **Why use it:** 11,000+ plugin catalog with search and free public API
...
- **Why use it:** Chinese DSH plugin catalog with 1958 repos and STAR ranking
...
- **Why use it:** Open-source Smartisan-style notes with Docker deployment and DSH integration
...
- **Tags:** `deepseek-harness`, `agent-platform`, `web-workbench`, `plugin-system`
- **Why use it:** Plugin-based web workbench with global skill management and workspace integration.
...
- **Why use it:** Community-curated catalog of unofficial DSH plugins and resources
...
- **Why use it:** Comprehensive curated awesome list of DSH plugins, tools, skills and resources
...
- **Why use it:** Comprehensive 1000+ plugin star-rank list for DSH
...
- **Why use it:** Plugin navigation guide with install and risk info
...
- **Why use it:** Verified star-ranked community plugin collection
...
- **Why use it:** AI-curated 190+ plugin list with hourly updates
...
- **Tags:** `dsh-plugins`, `dsh-ecosystem`, `plugin-repository`
- **Why use it:** Community-maintained DSH plugin index covering multiple ecosystem tools.
...
- **Why use it:** Redirect page pointing to the updated awesome-dsh-plugin repository.
...
- **Why use it:** Auto-updating bilingual plugin catalog with YAML-driven data source.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `curated-list`, `plugin-directory`
- **Why use it:** Comprehensive curated plugin registry covering models, tools, UI, and agent loops.

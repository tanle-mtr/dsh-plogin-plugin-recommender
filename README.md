...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,003,334 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-11 05:54:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 219,553 | Core platform for everything-is-a-plugin agent eco |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,480 | Open-source design system alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,021 | Original multi-agent swarm harness for autonomous  |
...
- **Tags:** `ai-agents`, `cordis`, `dsh`
- **Why use it:** Core platform for everything-is-a-plugin agent ecosystem
...
- **Tags:** `harness`, `agent`, `dsh-plugin`, `tutorial`
- **Why use it:** Zero-to-one harness engineering tutorial; ideal for beginners building custom agent workflows.
...
- **Why use it:** Unified agent orchestration platform with multi-device access, task boards, and self-hosted data control.
...
- **Tags:** `agent-os`, `mcp`, `skills`, `llm-orchestration`
- **Why use it:** Self-improving Agent OS with interview-gated evolution, staged evaluation, and MCP server integration.
...
- **Tags:** `agent-control-plane`, `dsh-plugin`, `workflow-automation`
- **Why use it:** Long-horizon agent control plane enabling durable, governed multi-agent workflows across Codex and Claude Code.
...
- **Tags:** `dsh-plugin`, `multi-agent-workspace`, `skill`, `visual-editor`
- **Why use it:** Enterprise-grade local-first agent workbench with unified multi-engine workspace and visual editor.
...
- **Why use it:** First vision plugin for DSH, enables OCR/image-to-text for text-only agents
...
- **Why use it:** Two-phase preset providing minimal bootstrap then full Standard tools
...
- **Why use it:** Virtual terminal with VFS for isolated agent code execution
...
- **Tags:** `vision`, `ocr`, `dsh-plugin`, `computer-vision`
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, UI restore.
...
- **Why use it:** Coding agent with sub-agents, hashline edits, and MCP integration via CLI/TUI.
...
- **Tags:** `ios`, `automation`, `coding-agent`
- **Why use it:** Live iOS Simulator and USB iPhone automation inside DSH with 22 agent tools
...
- **Tags:** `skills`, `ai-infra`, `development`
- **Why use it:** Specialized skills for AI infrastructure development and system optimization.
...
- **Why use it:** On-demand plugin dev knowledge base as installable agent skill.
...
- **Tags:** `plugin-dev`, `codex`, `harness`
- **Why use it:** Essential toolkit for developing and validating DSH plugins efficiently
...
- **Why use it:** Fast Neovim plugin manager in Lua, lightweight and elegant.
...
- **Why use it:** Bind ChatGPT account via OAuth to use ChatGPT models inside DSH directly.
...
- **Why use it:** Open-source design system alternative with local-first desktop app
...
- **Why use it:** Web-based DSH plugin aggregation ecosystem; brings browser-accessible plugin discovery to the harness.
...
- **Tags:** `sidebar`, `ui`, `extensible`
- **Why use it:** Extensible sidebar with file editor, terminal, Git, and sub-agent panels
...
- **Tags:** `task-panel`, `ui`, `coding-agent`
- **Why use it:** Modern flexible task panel embedding into Codex and DSH interfaces
...
- **⭐ Stars:** 2,950
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录��� TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `tui`, `terminal`, `ui`
- **Why use it:** Claude Code-style TUI with whale topbar, streaming thoughts, and rollback
...
- **Tags:** `widget`, `ui`, `balance-monitor`
- **Why use it:** Cute floating whale widget monitoring DeepSeek account balance in DSH
...
- **Why use it:** Zero-setup desktop app with Tauri, available for Windows/macOS/Linux.
...
- **Tags:** `desktop-app`, `electron`, `mcp`, `local-first`
- **Why use it:** Local-first Electron desktop workspace integrating DSH sessions and MCP tools.
...
- **Why use it:** Open-source Windows GUI with SSH, Codex, plugins, and mobile remote access.
...
- **Tags:** `ui-components`, `charts`, `forms`
- **Why use it:** Interactive inline UI components—charts, forms, quizzes—rendered in DSH replies.
...
- **Tags:** `canvas`, `visual`, `workspace`, `conversation`
- **Why use it:** Canvas-based visual conversation workspace with non-linear branching sessions.
...
- **Tags:** `desktop-app`, `tauri`, `multi-model`, `privacy`
- **Why use it:** Local-first Tauri desktop agent with multi-model support and self-evolving skills.
...
- **Why use it:** CodePilot-inspired desktop client with native DSH plugin suite for all OS
...
- **Tags:** `mobile`, `ios`, `ui`
- **Why use it:** Native iOS app bringing DSH workspaces and Agent tracks to iPhone
...
- **Why use it:** Smartisan-style notes app with Docker deployment and social export.
...
- **Why use it:** One-click install/uninstall community plugins via DSH web GUI market
...
- **Why use it:** Browser-based plugin registry console with official dev scaffolding.
...
- **Why use it:** Clean info bar showing model, balance, and pricing at a glance
...
- **Tags:** `context`, `audit`, `ui`, `token`
- **Why use it:** Audits context tokens and detects conflicts via visual dashboard
...
- **Why use it:** WorkBuddy-style skill picker enhances DSH composer UX significantly
...
- **Tags:** `web-ui`, `mcp`, `plugin-manager`
- **Why use it:** Web UI plugin for managing skills and MCP servers in browser
...
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker and AI assistant
...
- **Why use it:** Web background customization with presets and image upload support.
...
- **Tags:** `desktop`, `electron`, `ui`, `integration`
- **Why use it:** Desktop wrapper for DSH with ModLens and sidebar integration.
...
- **Tags:** `ui`, `button`, `panel`
- **Why use it:** One-click compact button for DSH web context meter panel, improves UX.
...
- **Tags:** `knowledge-base`, `rag`, `semantic-search`
...
- **Tags:** `memory`, `rag`, `mcp`, `skills`, `long-term-memory`
- **Why use it:** Portable, local-first memory layer with Markdown-native storage and cross-app self-evolving capabilities.
...
- **Tags:** `memory`, `rag`, `mcp`, `skills`, `token-savings`
- **Why use it:** Ultra-persistent self-evolving memory with hybrid retrieval, skill reuse, and significant token savings.
...
- **Tags:** `memory`, `agentic-rag`, `mcp`, `continual-learning`
- **Why use it:** Lightweight memory library for stateful agents with agentic RAG and continual learning support.
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus vector search
...
- **Tags:** `memory`, `agent`, `dsh-plugin`, `rag`
- **Why use it:** Shared persistent memory hub so all your AI agents remember everything.
...
- **Tags:** `skill-retrieval`, `rag`, `dsh-plugin`, `semantic-search`
- **Why use it:** Turn SKILL.md files into retrieval-ready corpora with semantic search.
...
- **Tags:** `knowledge-base`, `rag`, `encyclopedia`, `mcp`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering LLMs, agents, RAG, and MLOps resources.
...
- **Why use it:** Zero-prompt recall memory with three-layer auto-consolidation.
...
- **Tags:** `rag-evaluation`, `llm-evaluation`, `benchmark`, `prompt-engineering`
...
- **Tags:** `skills`, `dsh-plugin`, `agent-skills`, `finance-skill`
- **Why use it:** Largest and fastest-updating skills store with auto-crawled GitHub skills across multiple agent frameworks.
...
- **Why use it:** Auto-generate Vox-style explainer videos from a single topic end-to-end.
...
- **Tags:** `agent-teams`, `dsh-plugin`, `workflow`
...
- **Why use it:** Organized novel writing workflow with characters, worldbuilding, and editing.
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `agent-skills`
- **Why use it:** Gives AI agents vision and audio capabilities—video, screen, and speech analysis.
...
- **Tags:** `creative-writing`, `drama-skills`
- **Why use it:** Great for novel writing and short-drama production workflows
...
- **Why use it:** Native task management with Agent claim/review and SQLite backend
...
- **Tags:** `math-modeling`, `agent-skill`, `competition`
- **Why use it:** Full-stack math modeling autopilot for MCM/ICM with GitOps pipeline
...
- **Tags:** `agent-skills`, `agent-review`, `prompt-engineering`
- **Why use it:** Enables composable, reviewable agent modes for self-evolution.
...
- **Why use it:** Framework to turn experience into repeatable agent execution skills.
...
- **Tags:** `skills`, `mcp`, `finance`
- **Why use it:** Multi-agent financial analysis system with Tushare data and skill extension.
...
- **Why use it:** Adds multimodal vision capabilities to text-only LLM-based agents.
...
- **Why use it:** 88 open-source skills for research, social intelligence, and marketing workflows.
...
- **Why use it:** Comprehensive RE and pentest skill pack with 87 SKILL.md entries
...
- **Why use it:** AI investment desk with multi-strategy fund backtesting and compliance
...
- **Tags:** `patent-analysis`, `legal-tech`, `dsh-plugin`
- **Why use it:** Patent infringement analysis skill usable by any agent.
...
- **Why use it:** 25 engineering skills pre-installed with one-click sidebar access.
...
- **⭐ Stars:** 55
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能��材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **Tags:** `legal`, `visualization`, `dsh-plugin`
- **Why use it:** Legal litigation timeline visualization and diagram generation skill.
...
- **Why use it:** Full workflow for official Chinese document formatting and editing.
...
- **Tags:** `spec-driven-development`, `agent-skills`, `dsh-plugin`
- **Why use it:** Repository-native spec-driven development portable skill.
...
- **Why use it:** Enables powerful multi-agent collaboration with shared workspaces
...
- **Why use it:** Unique Bazi/Fengshui/IChing agent skill with deterministic local engine
...
- **Why use it:** Adapts DSH code simplification patterns as reusable Codex skill
...
- **Tags:** `video`, `ai-creative`, `directorx`, `skill`
- **Why use it:** Full AI video/image/audio pipeline via DirectorX skill integration
...
- **Tags:** `roleplay`, `narrative`, `interactive`, `skill`
- **Why use it:** Immersive interactive narrative with NPCs, memory, and YAML saves
...
- **Why use it:** Cross-platform session continuity skill for agent handoff workflows
...
- **Tags:** `deepseek-harness`, `delivery-gate`, `quality-gate`, `engineering-discipline`
- **Why use it:** Quality gate and engineering discipline for DSH deployments
...
- **Tags:** `skillhub`, `open-api`, `documentation`
- **Why use it:** Official SkillHub Open API with examples for DSH integration
...
- **Why use it:** Cinematic product video agent skill with 152 shot recipe cards
...
- **⭐ Stars:** 22
- **Language:** TypeScript
- **Description:** dsh-plugin-developer — DeepSeek Harness 插件���发 Skill  > 指导 AI Agent 从 0 到 1 开发、构建、安装、测试 DeepSeek Harness（dsh）插件。基于 **dsh 0.1.1-rc.2** 与 dsh-openmaic 项目的完整实战经验，并内置一个**已通过 web 界面实测**的天气插件作为整包参考案例。  ## 这是什么  dsh 采用"无特权内核、万物皆插件"的设计：模型适配器、工具注册表、Agent 循环、网页界面都是插件
- **Tags:** `dsh-plugin`, `skill`, `developer`
- **Why use it:** Guides AI agents through full DSH plugin development lifecycle
...
- **Why use it:** Free image reading and generation skill for DSH with vision support
...
- **Tags:** `agent-skills`, `dsh-plugin`, `development`
- **Why use it:** Agent Skills skill for building DSH plugins following standards
...
- **Tags:** `tts`, `xiaomi`, `voice`, `skill`
- **Why use it:** Free Xiaomi MiMo TTS integration with customizable voices.
...
- **Why use it:** CodeX-style plugin marketplace for DSH, enables easy skill discovery and installation.
...
- **Why use it:** Pre-flight plugin check injects top-K suitable plugins, boosts agent reliability.
...
- **Tags:** `web-search`, `mcp`, `free`, `agent-skills`
- **Why use it:** Free no-signup web search bridge for models without native internet access.
...
- **Tags:** `mcp`, `config`, `multi-agent`, `setup`
...
- **Tags:** `codex`, `openai-codex`, `model-context-protocol`, `sync`
- **Why use it:** Bidirectional sync between Codex and DSH with auto MCP mirroring
...
- **Why use it:** Beautiful architecture and workflow diagram-as-code generator
...
- **Why use it:** 530+ GPT Image prompt cases with 20 industrial templates
...
- **Tags:** `design`, `ui`, `mcp`, `skill`, `vibedesign`
- **Why use it:** First open-source AI-native vector design tool with concurrent Agent Teams—turn prompts directly into UI.
...
- **Tags:** `kline`, `finance`, `visualization`, `trading`
- **Why use it:** Interactive K-line chart with multi-market support in native sidebar
...
- **Why use it:** 6 design styles keep vibe-coded sites away from generic AI look
...
- **Tags:** `visual`, `knowledge-cards`, `design`
- **Why use it:** Transforms chat history into shareable knowledge cards with beautiful design.
...
- **Why use it:** Multi-AI browser extension suite with cross-platform prompt management
...
- **Tags:** `content-discovery`, `web`, `cross-platform`
- **Why use it:** Cross-platform content discovery agent across 8+ Chinese and global platforms
...
- **Why use it:** Let AI agents use your logged-in browser directly without interruption.
...
- **Why use it:** Tabbit Browser integration with Playwright for DSH automation
...
- **Tags:** `dingtalk`, `communication`, `chat-bot`
...
- **Why use it:** Privacy-first open-source resume builder, self-hostable
...
- **Why use it:** Open-source AI + no-code platform for fast business system building
...
- **Tags:** `dsh-plugin`, `router`, `cordis`
- **Why use it:** Runtime injector and task-aware reasoning-mode router—essential infrastructure for advanced DSH routing.
...
- **Tags:** `marketplace`, `installation`, `utility`
...
- **Tags:** `model-switch`, `utility`, `multi-platform`
- **Why use it:** One-click model switch across Claude Code, Codex, DSH, Kimi, Qwen and more
...
- **Why use it:** Self-hosted plugin radar discovering and validating 15900+ candidates.
...
- **Tags:** `oauth`, `llm-provider`, `subscription`, `integration`
- **Why use it:** Leverages ChatGPT/Claude/Grok subscriptions as DSH LLM providers via OAuth.
...
- **Why use it:** 30-second plugin discovery with curated real plugin filtering
...
- **Why use it:** Brings spreadsheets, docs, slides, and tables into DSH
...
- **Why use it:** Track session/daily LLM costs, budgets and token usage history
...
- **Why use it:** CLI plugin manager with resolver and schemas for DSH Plugin Hub
...
- **Why use it:** Ultimate DSH guide with QuickStart, plugins and toolkits
...
- **Why use it:** Learn DSH principles and explore plugin marketplace best practices
...
- **Why use it:** Curated list of plugins, skills, MCP servers and orchestrators for DSH
...
- **Why use it:** Compatibility bridge running Pi extensions natively on DSH.
...
- **Why use it:** Secure P2P remote access to DSH from PC, Android, and Web clients.
...
- **Why use it:** Auto-upgrades plugins to keep pace with DSH version updates
...
- **Why use it:** Full DSH config backup, restore, migrate and sync via WebDAV
...
- **Tags:** `skills`, `plugin-management`, `dsh-plugin`
- **Why use it:** Unified local Agent Skills loader and manager for DSH.
...
- **Why use it:** Pixel-to-text OCR and image analysis tools for text-only models.
...
- **Tags:** `container`, `infrastructure`, `management`
- **Why use it:** Containerized multi-version DSH management with embedded WebView UI
...
- **Tags:** `cost-tracking`, `visualization`, `dsh-web`
- **Why use it:** Real-time token usage tracking and cost estimation for DeepSeek API.
...
- **Tags:** `debugging`, `compatibility`, `plugin-doctor`
- **Why use it:** Detects and resolves plugin conflicts and version incompatibilities.
...
- **Why use it:** Search npm and curated lists directly inside DSH agents for plugin discovery.
...
- **Why use it:** Whale girl themed skins to customize your DSH interface beautifully.
...
- **⭐ Stars:** 406
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃���糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `glass-effect`, `customizable`
- **Why use it:** Frosted-glass theme with fully customizable transparency, blur, and wallpaper settings.
...
- **Tags:** `theme`, `webgpu`, `threejs`, `chrome-extension`
- **Why use it:** WebGPU-powered ocean-themed visual skin via Chrome/Edge extension.
...
- **Tags:** `ai`, `llm`, `vibe-coding`, `rag`, `mcp`
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and model guides for all major LLMs.
...
- **Why use it:** Searches 8 major Chinese platforms and generates evidence-based reports.
...
- **Why use it:** Curated ecosystem list of DSH plugins, tools, and infrastructure.
...
- **Why use it:** Comprehensive curated list of DSH plugin ecosystem resources.
...
- **Why use it:** One-stop research workbench with LaTeX, arXiv, GPU SSH and experiment tracking
...
- **Tags:** `mcp`, `agent-skills`, `academic-search`
- **Why use it:** Cross-source academic search with citation verification and graph generation.
...
- **Why use it:** Industry chain mapping, policy tracking and company research skills
...
- **Why use it:** Search 65,600+ Chinese API docs across 20 platforms with zero config.
...
- **Tags:** `awesome-list`, `automation`, `directory`
- **Why use it:** Auto-updated daily directory via GitHub Actions, keeps plugin ecosystem trackable.
...
- **Tags:** `radar`, `evidence`, `registry`
- **Why use it:** Evidence-backed plugin radar helps evaluate plugin quality and origins.
...
- **Tags:** `dsh`, `awesome-list`, `dsh-plugin`
- **Why use it:** Curated index of all DSH plugins—best starting point for discovering available tools.
...
- **Why use it:** A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Herm
...
- **Why use it:** Daily-updated plugin marketplace with community-reviewed DSH extensions.
...
- **Tags:** `catalog`, `plugin-marketplace`, `awesome-list`
- **Why use it:** Comprehensive DSH plugin catalog with search and ranking features.
...
- **Tags:** `handbook`, `agent-runtime`, `documentation`
- **Why use it:** Comprehensive DSH handbook covering runtime, plugins, MCP, and troubleshooting.
...
- **Tags:** `awesome`, `awesome-list`, `reference`
...
- **Tags:** `awesome-list`, `dsh-plugins`, `plugin`
...
- **Why use it:** Curated list of DeepSeek Harness plugins for ecosystem discovery
...
- **Tags:** `awesome-list`, `registry`, `dsh-plugins`
- **Why use it:** Curated DSH plugin registry with spam filtering and open data.
...
- **Why use it:** Comprehensive awesome list covering all DSH ecosystem resources.
...
- **Tags:** `awesome-list`, `quality-check`, `2026`
- **Why use it:** 2026 edition with quality checks for DSH plugins.
...
- **Tags:** `finance`, `stock`, `quant`, `niche`
- **Why use it:** Niche curated list for stock/finance/quant DSH plugins (24 entries).
...
- **Why use it:** Collection of useful DSH plugins from the community.
...
- **Why use it:** Static web portal for discovering and filtering 227+ DSH plugins.
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Comprehensive star-ranked catalog of 1000+ DSH plugins for quick ecosystem overview.
...
- **Why use it:** Curated collection of selected DSH plugins for quick reference.
...
- **Tags:** `repository`, `ecosystem`
- **Why use it:** Plugin repository listing for DeepSeek Harness ecosystem exploration.
...
- **Tags:** `redirect`, `notice`
- **Why use it:** Redirect notice; original repo moved to awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Why use it:** Community-curated DSH plugin collection, limited visibility.
...
- **Tags:** `awesome-list`, `plugin-catalog`
- **Why use it:** Evidence-aware curated DSH plugin shortlist, niche resource.

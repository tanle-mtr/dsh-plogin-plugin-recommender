...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,062,770 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 230,379 | Core DSH framework enabling plugin-based AI agent  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,134 | Local-first design tool integrating AI agent into  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,875 | Multi-agent swarm coordination with autonomous wor |
...
- **Tags:** `agent-os`, `mcp`, `dsh-plugin`, `loop-engineering`
- **Why use it:** Self-improving Agent OS with evaluation loops and MCP server integration
...
- **Tags:** `agent-sandbox`, `vfs`, `virtual-terminal`, `dsh-plugin`
- **Why use it:** World's first virtual terminal with VFS and virtual filesystem for agents
...
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits, and MCP support for multi-model workflows
...
- **Tags:** `cybersecurity`, `redteam`, `vulnerability`, `code-audit`
- **Why use it:** AI security red-team platform auditing hallucinated packages, missing safeguards, and code vulnerabilities
...
- **Tags:** `cli`, `plugin-manager`, `developer-tools`, `schema`
- **Why use it:** CLI, schemas, and resolver for DSH Plugin Hub — essential developer tooling for plugin management
...
- **Tags:** `dsh-plugin`, `codex`, `plugin-development`
- **Why use it:** Reusable Codex skill for building and validating DSH/Cordis plugins — essential dev toolkit.
...
- **Why use it:** Context audit tool: token cost analysis, duplicate/conflict detection in AGENTS.md with Web UI panel.
...
- **Tags:** `dsh-plugin`, `orchestration`, `cordis`
...
- **Why use it:** Agent skill for developing DSH plugins with standards and patterns.
...
- **Why use it:** Pre-flight plugin check to auto-inject relevant suggestions
...
- **Why use it:** Local-first design tool integrating AI agent into UI prototyping workflow.
...
- **Why use it:** Web-based plugin aggregation ecosystem with marketplace distribution
...
- **Why use it:** Official desktop client bringing DSH to your local machine with native performance
...
- **Tags:** `deepseek-harness`, `dsh`, `sidebar`
...
- **Tags:** `cli`, `dsh-plugin`, `skills`, `taskboard`
...
- **Why use it:** Cute floating whale widget tracking your DeepSeek balance with animations
...
- **Why use it:** Lightweight 5MB Tauri desktop version with preset plugins and zero setup
...
- **Tags:** `desktop-app`, `electron`, `codex`, `ssh-client`
- **Why use it:** Zero-setup Electron desktop client with Codex, SSH, plugins, and mobile remote access
...
- **Tags:** `desktop-app`, `mcp`, `local-first`, `office-automation`
- **Why use it:** Local-first AI desktop workspace with DSH sessions, projects, MCP, and Office integration
...
- **Tags:** `canvas`, `conversation-ui`, `non-linear`, `workspace`
- **Why use it:** Visual non-linear conversation canvas — branching sessions and dynamic workspace exploration
...
- **Why use it:** Local-first Claude Cowork alternative with multi-model support, self-evolving skills, and privacy focus
...
- **Why use it:** Native iOS/Android client with WebSocket connection to DSH
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI tool for managing skills and MCP servers visually.
...
- **Tags:** `workbench`, `agent-platform`, `skills`
...
- **Why use it:** Desktop bioinformatics agent with one-click install, offline mode, and skill store for wet-lab scientists.
...
- **Why use it:** Live provider/model info, balance tracking, peak pricing countdown — essential DSH dashboard widget.
...
- **Why use it:** WorkBuddy-style skill picker — select and insert skills directly in the DSH composer interface.
...
- **Why use it:** Electron desktop wrapper for DSH with sidebar, ModLens, and marketplace integration.
...
- **Why use it:** Turn raw documents into queryable RAG, reasoning agents, and self-maintaining wikis.
...
- **Why use it:** Local-first, self-evolving memory layer portable across all AI apps and workflows
...
- **Tags:** `long-term-memory`, `rag`, `dsh-plugin`, `token-savings`
- **Why use it:** Ultra-persistent hybrid-retrieval memory with proven token savings and skill reuse
...
- **Tags:** `agent-memory`, `dsh-plugin`, `context-engineering`
- **Why use it:** Purpose-built memory library for building persistent, stateful AI agents
...
- **Why use it:** Dedicated memory management kit with refinement for AI agents
...
- **Why use it:** Unified memory layer for all AI agents backed by Milvus and Markdown
...
- **Tags:** `memory`, `agent`, `desktop`
- **Why use it:** Personal AI agent providing shared memory hub for all your AI tools
...
- **Tags:** `agent-memory`, `embeddings`, `vector-search`, `skill-reranking`
- **Why use it:** Turns scattered skills into retrieval-ready corpora with embeddings and vector search
...
- **Why use it:** Official DSH plugin dev docs archive as an agent skill, bilingual EN/ZH support.
...
- **Tags:** `knowledge-distillation`, `agent-skills`, `persona`
- **Why use it:** Distill expert thinking patterns into reusable AI agent skills and personas.
...
- **Tags:** `agent-orchestration`, `dsh-plugin`, `no-code`
...
- **Why use it:** Largest curated skills marketplace covering code, docs, ML and automation workflows
...
- **Why use it:** Enterprise-grade multi-agent workspace supporting Codex, DSH and Opencode engines
...
- **Why use it:** Long-horizon agent control plane enabling durable, governed multi-engine workflows
...
- **Tags:** `agent-skills`, `vision`, `ocr`, `dsh-plugin`
- **Why use it:** First vision plugin turning images into structured JSON for text-only agents
...
- **Tags:** `agent-skills`, `workflow`, `skills`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `dsh-plugin`, `deep-reasoning`
...
- **Why use it:** End-to-end automated Vox-style paper-collage video generation agent skill
...
- **Why use it:** Full pipeline AI novel writer with character, worldbuilding and chapter management
...
- **Tags:** `ai-writer`, `workflow`, `creative`
- **Why use it:** Built-in workflows for novels, short-drama, games, and video scripts
...
- **Tags:** `observability`, `multimodal`, `verification`
- **Why use it:** Turns video, audio, and screen activity into searchable evidence
...
- **Tags:** `task-management`, `native`, `sqlite`
...
- **Tags:** `skill-panel`, `auditing`, `management`
- **Why use it:** Skill call auditing and in-app skill manager for DSH
...
- **Tags:** `agent-self-evolve`, `workflow`, `review`
- **Why use it:** Composable, reviewable agent self-evolving workflow modes
...
- **Why use it:** Turn experience into repeatable execution across multiple agent platforms
...
- **Why use it:** Ports Superpowers skills to Reasonix coding harness effectively.
...
- **Tags:** `agent-skills`, `web-search`, `integration-discovery`
- **Why use it:** Comprehensive web search and research skills for AI agents
...
- **Tags:** `agent-skills`, `deepseek-harness`, `ai-coding`
...
- **Tags:** `skills`, `dsh-better-sidebar`, `agent`
- **Why use it:** 25 pre-built engineering skills in a side panel with GitHub issue support
...
- **Tags:** `skills-manager`, `dsh-plugins`, `agent-skills`
...
- **Tags:** `gongwen`, `ai-docs`, `docx`
- **Why use it:** Complete official document processing tool with format checking and optimization
...
- **Why use it:** Repository-native spec-driven development skill with public DSH engineering patterns.
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `tcm`
- **Why use it:** Chinese traditional wisdom AI agent covering bazi, fengshui, TCM with deterministic local engine.
...
- **Why use it:** Engineering discipline quality gate: grill requirements, test implementation, prove delivery before ship.
...
- **Why use it:** 11 testing skills + shared KB with type decision matrix — makes AI work like a senior QA engineer.
...
- **Tags:** `agent-skills`, `session-memory`, `dsh-plugin`
...
- **Why use it:** Adapted DSH skill for automated code simplification in Codex
...
- **Why use it:** Multi-agent math modeling with 5 roles, 33 models, and thesis templates
...
- **Why use it:** Comprehensive math modeling skill covering data prep, coding, and writing
...
- **Tags:** `agent-skills`, `workflow`, `planning`
...
- **Why use it:** 530+ GPT Image prompts with industrial templates for AI image generation.
...
- **Tags:** `design`, `mcp`, `dsh-plugin`, `vibedesign`
...
- **Why use it:** Public gallery of animated pixel-art pets for multiple coding agents
...
- **Why use it:** Native design studio with AI generation, visual editing and PPT creation
...
- **Tags:** `ui-components`, `charts`, `forms`, `visual-rendering`
- **Why use it:** Generates interactive inline UI — layouts, charts, forms, quizzes rendered directly in replies
...
- **Why use it:** Adds multimodal vision capability for screenshots and UI analysis
...
- **Why use it:** Visualize legal cases with timelines, confrontation charts and relationship diagrams
...
- **Why use it:** Pixel-to-text image OCR skill for text-only LLMs — enables vision without native image support.
...
- **Why use it:** AI video/image/audio creative suite with storyboard tools and configurable vision models as DSH plugin.
...
- **Why use it:** All-in-one enhancement suite for major AI chat platforms with built-in prompt manager
...
- **Why use it:** Seamless real-browser automation for AI agents without interrupting work
...
- **Tags:** `bilibili`, `content-discovery`, `dsh-plugin`, `self-hosted`
- **Why use it:** Self-evolving cross-platform content discovery agent from Bilibili, YouTube, Reddit etc.
...
- **Tags:** `web-search`, `browser-automation`, `free`, `no-signup`
...
- **Why use it:** Browser automation with persistent fingerprint spoofing, unlimited local profiles, and Android emulation
...
- **Why use it:** Live iOS Simulator and USB-connected iPhone inside conversations
...
- **Why use it:** Tabbit Browser integration for DSH with Playwright automation.
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services with IDE integrations.
...
- **Why use it:** Two-phase preset: minimal bootstrap to full Standard tools
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `model-switch`
- **Why use it:** One-click install and model switch across multiple coding agents and CLIs
...
- **Tags:** `plugin-registry`, `validation`, `infrastructure`
...
- **Tags:** `remote-access`, `infrastructure`, `encryption`
- **Why use it:** P2P encrypted remote access for DSH across PC, Android, Web
...
- **Why use it:** Bridge Pi extensions as native DSH plugins via compatibility layer
...
- **Tags:** `finance`, `datasource`, `mcp`
- **Why use it:** Local financial database with auto HTTP/MCP interface generation
...
- **Tags:** `capability`, `tools`, `skills`
- **Why use it:** Unified capability management with three-tier exposure strategy for Tools/Skills.
...
- **Tags:** `migration`, `session-import`, `dsh-plugin`
- **Why use it:** Migration wizard for sessions, memories, and skills from Claude/Codex
...
- **Why use it:** Real-time token usage, cost estimates, and API balance visualisation.
...
- **Tags:** `doctor`, `conflict-resolution`, `debugging`
...
- **Tags:** `theme`, `glass-effect`, `ui-customization`, `visual`
- **Why use it:** Fully customizable frosted-glass theme with adjustable blur,磨砂度, and custom wallpapers
...
- **Tags:** `theme`, `visual`, `animation`
- **Why use it:** Real-time ocean theme with adjustable waves and glassmorphism
...
- **Tags:** `background`, `ui`, `theme`
- **Why use it:** Custom backgrounds with real-time preview and presets
...
- **Tags:** `deepwiki`, `documentation`, `dsh-plugin`, `code-analysis`
...
- **Tags:** `marketplace`, `plugins`, `discovery`
- **Why use it:** Most comprehensive daily-refreshed plugin marketplace with pre-reviewed listings
...
- **Why use it:** One-stop research workbench: LaTeX editing, arXiv management, experiment tracking, GPU orchestration
...
- **Tags:** `discovery`, `curated`, `marketplace`
- **Why use it:** Auto-fetches and reviews real DSH plugins daily with curated rankings
...
- **Why use it:** Patent infringement analysis system generating competitor reports
...
- **Tags:** `kline`, `finance`, `dsh-plugin`
- **Why use it:** Interactive K-line financial analysis with multi-market and indicators
...
- **Why use it:** Comprehensive AI resource library with tutorials, prompts, and knowledge base.
...
- **Why use it:** Curated plugin directory — ideal starting point for exploring the DSH ecosystem
...
- **Why use it:** Beginner-friendly tutorial from zero to hero for harness engineering
...
- **Why use it:** Built-in DSH plugin marketplace for one-click browsing and installation
...
- **Tags:** `resource-encyclopedia`, `awesome-list`, `bilingual`, `knowledge-base`
- **Why use it:** Comprehensive bilingual AI resource encyclopedia covering agents, RAG, multimodal, and learning paths
...
- **Why use it:** 11,000+ plugin marketplace with search and free API
...
- **Why use it:** Comprehensive DSH handbook covering runtime, plugins, MCP and more
...
- **Why use it:** Plugin catalog with 1958 repos, search and category filtering
...
- **Why use it:** Community plugin catalog with auto-sync and curated listings
...
- **Tags:** `awesome-list`, `dsh-plugins`, `plugin-marketplace`
...
- **Why use it:** Official SkillHub Open API docs, examples, and DSH plugin — Tencent-backed skill ecosystem resource.
...
- **Tags:** `awesome-list`, `comprehensive`, `dsh`
...
- **Why use it:** Curated open-data registry for discovering DSH plugins and skills.
...
- **Why use it:** Verified stock/finance/quant plugin collection with bilingual docs.
...
- **Why use it:** Comprehensive curated plugin ecosystem directory for DSH.
...
- **Why use it:** Comprehensive awesome list for DSH ecosystem navigation
...
- **Tags:** `guide`, `documentation`, `navigation`
...
- **Tags:** `recommender`, `awesome-list`, `ai-curate`
...
- **Tags:** `automated`, `directory`, `crawler`
- **Why use it:** Automated daily crawler building bilingual plugin directory
...
- **Tags:** `portal`, `static`, `discoverability`
...
- **Tags:** `dsh-plugins`, `plugin-verify`, `dsh-repository`
- **Why use it:** Plugin repository and verification listing for DSH.
...
- **Tags:** `dsh-plugins`, `awesome-list`, `redirect`
- **Why use it:** Redirect to updated awesome-dsh-plugin repo.
...
- **Tags:** `dsh-plugins`, `awesome-list`, `auto-update`, `bilingual`
...
- **Tags:** `dsh-plugins`, `plugin-directory`, `registry`, `curated-list`
- **Why use it:** Curated registry covering models, tools, UI, and agent loops.

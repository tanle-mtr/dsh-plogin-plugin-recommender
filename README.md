...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 987,284 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-08 15:07:17 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 216,002 | Core framework: everything is a plugin. Essential  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,868 | Local-first open-source Figma alternative with AI  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,617 | Meta-harness for multi-agent swarms and autonomous |
...
- **Tags:** `desktop`, `dsh-plugin-desktop`, `deepseek-harness`
...
- **Tags:** `web-ui`, `plugin-store`, `ecosystem`
...
- **Why use it:** Extensible sidebar with file editor, terminal, chat, Git and sub-agents
...
- **⭐ Stars:** 1,915
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你��着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `floating-widget`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracking your DeepSeek balance with drag-and-drop and animation.
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero setup, preset plugins, and cross-platform support.
...
- **Why use it:** Local-first Electron desktop workspace integrating DSH sessions, files, web research, and Office tools.
...
- **Why use it:** Generates interactive UI components like charts, forms, and quizzes inline in replies
...
- **Why use it:** Full-featured open-source Windows desktop client with SSH, skills, and mobile remote access
...
- **Why use it:** Local-first multi-model desktop agent alternative to Claude Cowork with self-evolving skills
...
- **Why use it:** Visual non-linear canvas workspace for session exploration and branching conversations
...
- **Why use it:** CodePilot-inspired desktop app with plugin suite for DSH across all OS.
...
- **Why use it:** Native iOS client bringing DSH workspaces and agent tracks to iPhone.
...
- **Why use it:** Electron-based DSH desktop console with multi-tab plugin/MCP/skill management
...
- **Why use it:** Bioinformatics desktop app with offline mode, great for clinicians and wet-lab scientists.
...
- **Tags:** `devops`, `desktop`, `docker`, `ssh`
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker, and AI sandbox in one window.
...
- **Tags:** `electron`, `desktop-app`, `deepseek-harness`, `dsh`
- **Why use it:** Electron desktop wrapper for DSH with sidebar and ModLens
...
- **Why use it:** One-click compact button improves context meter usability
...
- **Tags:** `rag`, `knowledge-base`, `vector-search`, `question-answering`
...
- **Why use it:** Dedicated memory library for building stateful long-running agents
...
- **Why use it:** Memory management kit with refinement capabilities for agent recall
...
- **Tags:** `memory`, `milvus`, `rag`, `hybrid-search`
- **Why use it:** Persistent memory layer backed by Milvus with hybrid search across agents
...
- **Tags:** `skill-retrieval`, `embeddings`, `vector-search`
- **Why use it:** Turns scattered skills into retrieval-ready corpora with vector search and evaluation tooling
...
- **Why use it:** Proactive three-layer associative memory with auto-consolidation and skill crystallization
...
- **Tags:** `ai-agent`, `multi-agent`, `skills`, `mcp`
- **Why use it:** Self-evolving super agent with memory, tools, and multi-model support.
...
- **Tags:** `skills`, `marketplace`, `collection`
- **Why use it:** Largest skills marketplace with auto-curation from GitHub ecosystems
...
- **Tags:** `agent-os`, `evolution`, `evaluation`
...
- **Tags:** `video-generation`, `agent-skills`, `dsh-plugin`
- **Why use it:** End-to-end automated video generation skill turning any topic into a polished explainer video.
...
- **Why use it:** Enable multi-agent team collaboration within DeepSeek Harness for complex task delegation.
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, long-screenshot OCR, and UI restoration.
...
- **Why use it:** Gives agents vision and audio via video analysis with timestamped verifiable evidence
...
- **Why use it:** Specialized creative writing agent for novels and short drama production workflows
...
- **Why use it:** Enables composable, reviewable agent workflows for sustainable self-evolution.
...
- **Why use it:** Turns experience into repeatable execution patterns across multiple AI platforms.
...
- **Why use it:** Specialized agent skills for writing, optimizing, and debugging AI infrastructure.
...
- **Why use it:** 87 specialized skill files for reverse engineering, pentesting, and security research.
...
- **Why use it:** Auto-updates plugin skills when DSH version changes
...
- **Why use it:** AI coding mentor that generates lessons and reviews code
...
- **⭐ Stars:** 53
- **Language:** JavaScript
- **Description:** Matt Pocock 技能面板（DSH Deck）：安装即自带 25 个工程与效率技能（mattpocock/skills v1.2.3：triage、grilling、wayfinder、handoff 等），右侧面板直接调用，无需手动装技能。当前主力支持 GitHub issue；Markdown 本地文件为预览版；GitLab 暂不在支持范围。希望它能帮你把想法��快变成现实。
- **Tags:** `agent-skills`, `skills-deck`, `efficiency`
- **Why use it:** 25 pre-installed engineering efficiency skills in a right-panel deck, GitHub issue ready
...
- **Why use it:** Full Chinese official document processing: format validation, template generation, revision tracking
...
- **Why use it:** Spec-driven development workflow skill inspired by DeepSeek Harness engineering patterns
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `agent-skill`
- **Why use it:** Integrated Bazi/Fengshui/I Ching AI agent with local engine
...
- **Why use it:** Audit AGENTS.md chains, detect duplicates and conflicts via Web UI
...
- **Why use it:** 11 QA testing skills with shared knowledge base for AI agents
...
- **Why use it:** Cross-platform session memory for agent continuity across tools
...
- **Why use it:** Full-stack Godot 4.x game dev skill — ideal for building games with AI assistance.
...
- **Why use it:** Simulates a full product team (PM→Eng→QA→Release) workflow
...
- **Why use it:** Skills marketplace enables CodeX-style plugin discovery
...
- **Why use it:** Pre-flight plugin check boosts agent task success rate
...
- **Why use it:** Official Huawei Cloud MCP tools with sandbox, guardrails, and deploy-to-cloud workflow
...
- **Why use it:** Official SkillHub API plugin from Tencent for skill integration and management.
...
- **Why use it:** In-browser manager for skills and MCP servers, seamless DSH Web GUI integration.
...
- **Tags:** `discoverability`, `agent`, `deepseek-harness`
- **Why use it:** In-agent plugin search across npm and awesome-lists
...
- **Tags:** `agent-skills`, `ai-design`, `design-systems`, `ui-generator`, `vibe-coding`
- **Why use it:** Local-first open-source Figma alternative with AI design generation.
...
- **Why use it:** 530+ reverse-engineered industrial image prompts with reusable skills.
...
- **Tags:** `mascot`, `gallery`, `cli-enhancement`
- **Why use it:** Public animated mascot gallery enhancing CLI tool personalization
...
- **Why use it:** Native design and PPT studio for DSH with AI generation, visual editing, and template marketplace.
...
- **Tags:** `design`, `ui`, `ppt`
- **Why use it:** Preview, inspect, and edit .op documents directly within DSH conversations.
...
- **Why use it:** Legal litigation timeline and diagram generation tool, zero-dependency SVG output
...
- **Why use it:** AI video/image/audio skills with DirectorX integration for DSH
...
- **Why use it:** 6 design styles prevent AI-generic look; essential for vibe-coded web projects.
...
- **Why use it:** Enhancement suite and prompt manager for major AI platforms.
...
- **Why use it:** Cross-platform content discovery agent across Bilibili, YouTube, Reddit etc
...
- **Why use it:** Let AI agents access your real logged-in browser sessions seamlessly for web automation.
...
- **Why use it:** Strongest free web search plugin with no signup or API required for any model
...
- **Tags:** `chatgpt`, `oauth`, `ai-agents`, `awesome-dsh-plugin`
- **Why use it:** OAuth integration enables ChatGPT access within DSH
...
- **Why use it:** DingTalk IM channel turns chats into tool-capable agents
...
- **Tags:** `agent-skills`, `javascript`, `resume-builder`, `self-hosted`
- **Why use it:** Privacy-focused, open-source resume builder. Fully portable and free.
...
- **Tags:** `no-code`, `low-code`, `internal-tools`, `workflows`, `crm`
...
- **Tags:** `marketplace`, `plugin-store`, `infrastructure`
- **Why use it:** Built-in plugin marketplace with visual browse, search and one-click install
...
- **Why use it:** Self-hostable ecosystem radar auto-discovering and validating 15900+ DSH plugins with CI pipeline.
...
- **Why use it:** Best context insight and management plugin with dashboard, browser view, and statistics for DSH.
...
- **Why use it:** Curated awesome list of DSH ecosystem plugins, tools, and infrastructure from hub and public topic.
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `dsh-plugin`
- **Why use it:** Comprehensive curated plugin list covering coding agents, MCP, web UI, and LLM tools for DSH.
...
- **Why use it:** Bridges ChatGPT, Claude, and Grok subscriptions as LLM providers via OAuth in DSH
...
- **Why use it:** CLI plugin manager for DSH Hub with schemas and resolver tools.
...
- **Why use it:** Comprehensive DSH plugin catalog with search, filtering, and star ranking.
...
- **Why use it:** Bridges Pi and DSH ecosystems via a single ABI compatibility layer.
...
- **Tags:** `remote-access`, `multi-device`, `dsh-plugin`
- **Why use it:** Secure P2P-based multi-device remote access for DSH across PC, Android, and Web.
...
- **Why use it:** Open-source Smartisan-style notes with Docker deployment and multi-tenant support.
...
- **Why use it:** Backup, restore, migrate and sync your DSH config and plugins
...
- **Why use it:** Zero-patch plugin registry console + official skill creation guide for DSH ecosystem
...
- **Tags:** `plugin-dev`, `tools`, `infrastructure`
- **Why use it:** Agent skill for DSH plugin development covering slots, services, events, tools and packaging
...
- **Why use it:** Agent skill for building/installing DSH plugins with slot, Typert remote, and credential config
...
- **Why use it:** Pixel-to-text OCR plugin for text-only models with 34-image trained methodology
...
- **Tags:** `container`, `version-manager`, `utility`
- **Why use it:** Manage multiple DSH versions in isolated containers with WebView
...
- **Why use it:** Community plugin catalog — good starting point for exploring the DSH ecosystem.
...
- **Why use it:** Curated plugin list for quick DSH ecosystem discovery and reference.
...
- **Tags:** `registry`, `open-data`, `discovery`
- **Why use it:** Spam-filtered plugin registry with open data — reliable DSH ecosystem discovery.
...
- **Tags:** `directory`, `typescript`, `nextjs`
- **Why use it:** Public plugin directory with install commands — great for Next.js/TS developers.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `ai-cost`, `data-visualization`
- **Why use it:** Track token usage and API costs in real-time with charts
...
- **Tags:** `tts`, `xiaomi-mimo`, `dsh-plugin`, `text-to-speech`
- **Why use it:** Free Xiaomi MiMo TTS API integration with custom voices
...
- **Tags:** `dsh-plugin`, `deepseek-harness`, `troubleshooting`
...
- **Tags:** `theme`, `glass-ux`, `customizable`
- **Why use it:** Highly customizable frosted glass theme that leaves zero trace on original DSH source code
...
- **Why use it:** WebGPU-powered ocean-themed visual skin for DeepSeek Harness.
...
- **Tags:** `background`, `webui`, `themes`, `dsh-plugin`
- **Why use it:** Customizable Web UI backgrounds with presets and live preview
...
- **Tags:** `ai-guide`, `tutorials`, `prompt-library`
- **Why use it:** Comprehensive AI resource guide with tutorials and prompt library
...
- **Why use it:** Step-by-step DSH harness engineering tutorial for beginners
...
- **Why use it:** Auto-searches 8 major Chinese platforms for recent 30-day content and generates cited research reports.
...
- **Why use it:** Curated bilingual plugin list serving as a comprehensive DSH ecosystem directory
...
- **Tags:** `encyclopedia`, `awesome-list`, `mcp`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MCP, MLOps and learning resources
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU cluster SSH, paper writing.
...
- **Why use it:** Local financial database with multi-agent analysis and auto API/MCP generation.
...
- **Tags:** `deep-research`, `social-listening`, `agent-skills`
- **Why use it:** 88 open-source skills for deep research, social intelligence, and marketing automation.
...
- **Why use it:** Search 65000+ API docs from 20 Chinese open platforms instantly
...
- **Why use it:** End-to-end patent infringement analysis with RAG-powered competitive insights
...
- **Why use it:** Curated stock/finance/quant plugins for DSH ecosystem
...
- **Tags:** `plugin-portal`, `deepseek-harness`, `web`
...
- **Tags:** `2origin`, `ai-agent`, `awesome-list`
- **Why use it:** Evidence-backed plugin radar with 2Origin lab insights
...
- **Why use it:** AI-curated plugin list covering 190+ plugins in 12 categories
...
- **Why use it:** Armor-breaking plugin for DeepSeek with stable breakthrough capabilities for extended requests.
...
- **Tags:** `marketplace`, `plugin-store`, `curated`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace sourced from across the internet
...
- **Why use it:** Curated plugin discovery tool filtering fake listings automatically.
...
- **⭐ Stars:** 252
- **Language:** Unknown
- **Description:** DeepSeek Harness 终极指南：快速入门、资源���荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
...
- **Tags:** `education`, `practices`, `marketplace`
...
- **Why use it:** Plugin store with 11,000+ entries, search, rankings, and free API.
...
- **Why use it:** Official curated list of DSH plugins from cordis.run
...
- **Why use it:** Curated list of DSH plugins, tools, and resources
...
- **Why use it:** Curated DeepSeek Harness plugin repository index
...
- **Why use it:** Official DSH app plugin collection
...
- **Why use it:** Bilingual reviewed plugin directory with immutable commits
...
- **Tags:** `ai-agents`, `awesome`, `dsh-plugins`
...
- **Why use it:** Moved to new repo; no longer active here

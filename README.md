...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 981,964 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-07 21:21:18 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215,096 | Core plugin-based AI agent platform with open ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,670 | Local-first open-source design plugin with Figma-l |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,339 | Deploy intelligent multi-agent swarms for autonomo |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 28 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (28)
...
- **Why use it:** Core plugin-based AI agent platform with open ecosystem.
...
- **Why use it:** Terminal-native DeepSeek coding agent with stable prefix caching.
...
- **Why use it:** Unified multi-device agent workspace with task tracking and API access
...
- **Tags:** `agent-os`, `llm-evaluation`, `mcp`
- **Why use it:** Self-improving Agent OS with interview-gated evaluation and budgeted evolution loop
...
- **Tags:** `agent-harness`, `loop-engineering`, `workflow-automation`
...
- **Tags:** `agent-workspace`, `multi-agent`, `coding-agent`
...
- **Tags:** `security`, `vulnerability`, `redteam`, `dsh-plugin`
- **Why use it:** AI security offensive & defensive platform auditing generated code for hallucinated packages and vulnerabilities
...
- **Why use it:** Bridge Pi ecosystem plugins to run natively on DSH
...
- **Tags:** `llm-provider`, `typescript`, `provider`
- **Why use it:** Unofficial LLM provider with live model catalog support
...
- **Tags:** `plugin-dev`, `agent-skills`, `adapter`
- **Why use it:** Standardized agent skill for developing DSH plugins and LLM adapters
...
- **Tags:** `plugin-build`, `credentials`, `slots`
...
- **Why use it:** Portable spec-driven development skill for repository-native coding
...
- **Why use it:** Audits AGENTS.md token costs, detects conflicts and duplicates in context
...
- **Why use it:** Modern desktop client with plugin-native architecture for DSH ecosystem.
...
- **Tags:** `dsh-plugin`, `floating-widget`, `deepseek`
- **Why use it:** Cute floating whale widget monitoring DeepSeek balance with drag-and-drop.
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero environment setup needed.
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions and Office artifacts.
...
- **Tags:** `dsh-plugin`, `ui-components`, `charts`, `forms`
...
- **Why use it:** Open-source Electron desktop client with Codex, SSH, skills, and mobile remote access
...
- **Tags:** `desktop-app`, `local-first`, `privacy`, `multi-model`
...
- **Tags:** `canvas`, `workspace`, `conversation`, `non-linear`
...
- **Why use it:** Native iOS client for DSH with real-time WebSocket sync
...
- **Why use it:** Smartisan-style open-source notes with Docker deployment
...
- **Why use it:** Essential Web UI for managing skills and MCP tools directly in DSH
...
- **Tags:** `marketplace`, `ui`, `webui`
- **Why use it:** One-click install/uninstall plugins directly from web GUI marketplace
...
- **Tags:** `ui`, `menu`, `capabilities`
- **Why use it:** Unified menu to control MCP/skill exposure level and execution mode
...
- **Why use it:** Electron-based desktop console for multi-tab DSH/plugin/MCP management
...
- **Why use it:** WorkBuddy-style skill picker for quick skill selection in the composer
...
- **Tags:** `bioinformatics`, `desktop`, `tauri`, `llm-agent`, `dsh-plugin`
- **Why use it:** Bioinformatics desktop app with skill store and offline mode for researchers.
...
- **Tags:** `desktop`, `devops`, `ssh`, `docker`, `dsh-plugin`
...
- **Why use it:** Customizable web UI backgrounds with presets and uploads.
...
- **Why use it:** Deploy intelligent multi-agent swarms for autonomous workflows.
...
- **Tags:** `low-code`, `ai-agents`, `dsh-plugin`
...
- **Why use it:** Largest skills marketplace with auto-collected GitHub skill projects by category
...
- **Tags:** `task-management`, `sqlite`, `workflow`, `agent`
...
- **Why use it:** Dedicated novel writing and short-drama production plugin powered by Oh Story skills
...
- **Tags:** `agent`, `self-evolve`, `workflow`
- **Why use it:** Composable agent controls with human-reviewed self-evolution workflows
...
- **Why use it:** Turn experience into repeatable AI agent execution patterns
...
- **Tags:** `infra`, `skills`, `ai-infrastructure`
...
- **Why use it:** Ports proven Superpowers skill framework to Reasonix coding harness
...
- **Why use it:** Adapted Superpowers skills: TDD, debugging, planning for DSH
...
- **Tags:** `mentor`, `coding`, `review`
- **Why use it:** AI coding mentor: scans projects, generates chapters, reviews code
...
- **Why use it:** 25 built-in engineering and efficiency skills directly callable from sidebar
...
- **Why use it:** Chinese official document processing compliant with GB/T 9704 national standard
...
- **Tags:** `knowledge-base`, `agent-skill`, `guide`
- **Why use it:** Official docs archive with on-demand agent skill and knowledge base
...
- **Why use it:** Integrates Bazi, Fengshui, IChing and TCM into a local AI agent skill
...
- **Tags:** `simplification`, `codex`, `skill`
- **Why use it:** Codex skill that finds and simplifies complex code patterns automatically
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-powered test automation
...
- **Why use it:** Full-stack Godot 4.x game dev skill; registers at runtime automatically.
...
- **Tags:** `video`, `motion-design`, `remotion`, `agent-skills`, `dsh-plugin`
- **Why use it:** 152 cinematic shot recipe cards with Remotion templates for product videos.
...
- **Why use it:** Virtual product team agent preset for project simulation.
...
- **⭐ Stars:** 3
- **Language:** JavaScript
- **Description:** 给 DSH agent 的插件库"起���前检查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **Tags:** `agent-tools`, `ai-agents`, `dsh-plugin`
- **Why use it:** Pre-flight plugin check boosts agent plugin utilization predictably
...
- **Tags:** `finance`, `mcp`, `stock`, `tushare`
- **Why use it:** Tushare-based financial data with MCP/HTTP接口和多Agent分析
...
- **Why use it:** Manages skills and MCP servers directly from DSH Web UI settings page.
...
- **Tags:** `agent-skills`, `design-systems`, `dsh-plugin`
- **Why use it:** Local-first open-source design plugin with Figma-like UI generation.
...
- **Tags:** `agent-skills`, `diagrams-as-code`, `dsh-plugin`
- **Why use it:** Generate beautiful, verifiable architecture and flow diagrams from code.
...
- **Why use it:** 20+ industrial-grade prompt templates for consistent image generation.
...
- **Tags:** `visual-design`, `mcp`, `vibecoding`
...
- **Tags:** `deepseek`, `armor-breaking`, `dsh-plugin`
- **Why use it:** Armor-breaking plugin for stable DeepSeek image generation outputs.
...
- **Why use it:** AI video/image/audio generation skills with configurable model tools
...
- **Tags:** `design`, `ui`, `vibe-coding`, `dsh-plugin`
- **Why use it:** 6 professional design styles to avoid generic AI-generated looks.
...
- **Tags:** `dsh-plugin`, `knowledge-cards`
...
- **Why use it:** Multi-platform AI browser extension with universal prompt management.
...
- **Why use it:** Let AI agents automate your real logged-in browser seamlessly.
...
- **Tags:** `web-search`, `free`, `no-signup`, `dsh-plugin`
...
- **⭐ Stars:** 338
- **Language:** Python
- **Description:** Give AI agents eyes, ears, and verifiable results. Watch Skill provides video, audio and screen understanding with timestamped evidence; DeepWatch brings that evidence and independent verification into an agent workspace built on the official DeepSeek Harness. MCP, CLI, REST and Web.
- **Tags:** `computer-vision`, `ocr`, `multimodal`, `ffmpeg`
- **Why use it:** Gives agents eyes and ears with video, audio, and screen understanding plus timestamped evidence
...
- **Why use it:** Powerful browser automation via Tabbit/Playwright for DSH
...
- **Tags:** `ai-agent`, `chat-bot`, `dingtalk`, `dsh-plugin`
...
- **Tags:** `dsh-plugin`, `mcp-server`, `resume-builder`
- **Why use it:** Privacy-focused self-hosted resume builder with MCP server integration.
...
- **Why use it:** Essential image uploader supporting 60+ cloud services with Obsidian/VS Code integration.
...
- **Why use it:** Runtime injector and task-aware router kit for DSH agent orchestration
...
- **Why use it:** Self-deployable ecosystem radar discovering and validating 15900+ plugins.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `plugins`
- **Why use it:** Comprehensive curated plugin catalog for the DeepSeek Harness ecosystem.
...
- **Tags:** `oauth`, `subscriptions`, `llm-provider`, `utility`
...
- **Why use it:** Open-source CLI and resolver for managing DSH Plugin Hub efficiently
...
- **Why use it:** P2P encrypted multi-device remote access to DSH
...
- **Tags:** `utility`, `upgrade`, `maintenance`
...
- **Why use it:** Complete backup, restore, sync and migration for all DSH config
...
- **⭐ Stars:** 59
- **Language:** TypeScript
- **Description:** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开���引导
- **Tags:** `plugin-management`, `infrastructure`
- **Why use it:** Thin browser console for managing official DSH repository plugins
...
- **Tags:** `skills-manager`, `security`, `plugin-management`
- **Why use it:** Centralized loader and security manager for local Agent Skills in DSH
...
- **Why use it:** Shows provider, model, live balance and pricing with real-time countdown
...
- **Why use it:** One-click MCP/Skills/config setup for Claude Code, DSH, Cursor and more
...
- **Tags:** `quality-gate`, `engineering`, `delivery`, `dsh-plugin`
- **Why use it:** Engineering discipline bundle: grill requirements, test, prove delivery quality.
...
- **Tags:** `neovim`, `lua`, `plugin-manager`, `nvim`
- **Why use it:** Fast, simple Neovim plugin manager in Lua; lightweight and elegant.
...
- **Tags:** `ai-cost`, `data-visualization`, `deepseek-api`
- **Why use it:** Tracks token usage and API costs with real-time charts.
...
- **Tags:** `diagnostic`, `conflict-resolution`, `plugin-health`
...
- **Tags:** `mascot`, `themes`, `developer-tools`
- **Why use it:** Animated pet mascot gallery adding personality to multiple AI coding agent platforms
...
- **Tags:** `theme`, `glass-ui`, `desktop`, `dsh-plugin`
...
- **Why use it:** WebGPU ocean-themed visual skin for DSH Harness UI
...
- **Why use it:** Curated plugin collection, essential for discovering DSH ecosystem tools
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, experiments, GPU orchestration
...
- **⭐ Stars:** 205
- **Language:** Python
- **Description:** Academic Paper Search：中文科���用户的 Codex / Claude Code / DeepSeek Harness Skill + MCP；跨 CrossRef、PubMed、arXiv、OpenAlex、Europe PMC 检索去重��支持 MeSH、引用核验、引文图谱、试验检索与审计导出。
- **Tags:** `academic`, `research`, `mcp`
...
- **Tags:** `research`, `social-listening`, `marketing`
- **Why use it:** 88 skills for research, social intelligence and marketing
...
- **Why use it:** Domain pack for industry/company research with methodology and news
...
- **Tags:** `api-docs`, `chinese-platforms`, `research`
- **Why use it:** Search 65K+ API docs across 20 major Chinese platforms instantly
...
- **Why use it:** Multi-agent patent infringement analysis with RAG and skill packaging
...
- **Why use it:** AI investment desk with multi-strategy fund backtesting and compliance guardrails
...
- **Tags:** `awesome-list`, `plugin-curation`, `directory`
...
- **Why use it:** Verified stock/finance plugins for DSH ecosystem.
...
- **Why use it:** Search npm + awesome lists directly inside DSH agents for discoverability
...
- **Tags:** `ai-agents`, `coding-agents`, `dsh-plugin`, `mcp`
...
- **Why use it:** OpenBitFun combines a high-performance a
...
- **Tags:** `knowledge-base`, `encyclopedia`, `ai-skills`, `awesome-list`
...
- **Tags:** `awesome-list`, `plugin-discovery`, `curated`, `guide`
- **Why use it:** Daily auto-scraped curated plugin guide with scenario classification and hot rankings
...
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-reviewed quality
...
- **Tags:** `guide`, `awesome-list`, `resource`
...
- **Tags:** `marketplace`, `directory`, `catalog`
- **Why use it:** Massive plugin marketplace with 11,000+ plugins, search, and public API
...
- **Why use it:** Official curated plugin catalog, keeps you updated on ecosystem
...
- **Tags:** `awesome-list`, `curated`
- **Why use it:** Meticulously curated awesome list of DSH plugins and resources
...
- **Why use it:** Official skill API docs with examples; useful reference resource.
...
- **Why use it:** Unofficial community plugin catalog; good for discovering DSH ecosystem tools.
...
- **Why use it:** Curated plugin list with website; clean discovery experience for DSH users.
...
- **Tags:** `awesome-list`, `curated`, `dsh-plugin`
- **Why use it:** Comprehensive curated awesome list covering plugins, tools, skills and resources.
...
- **Tags:** `awesome-list`, `directory`, `plugin-discovery`, `dsh-plugin`
- **Why use it:** Public GitHub directory with install commands; great for plugin discovery.
...
- **Tags:** `registry`, `awesome-list`, `plugin-registry`, `dsh-plugin`
- **Why use it:** Spam-filtered plugin registry with open data; trustworthy community resource.
...
- **Tags:** `awesome-list`, `directory`, `installation-guide`
...
- **Tags:** `awesome-list`, `chinese`, `plugin-collection`
...
- **Why use it:** Complete 1000+ DSH tool catalog sorted by stars.
...
- **Tags:** `guide`, `navigation`, `plugin-directory`
- **Why use it:** Plugin guide with scenario-based selection and risks.
...
- **Why use it:** Static web portal to discover and filter DSH plugins.
...
- **Why use it:** CodeX-like plugin marketplace for DSH ecosystem discovery
...
- **Why use it:** Curated DSH plugin collection with verification support
...
- **Why use it:** Moved repository — redirect to new location github.com/awesome-dsh-plugin
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** DSH plugin collection for community reference
...
- **Why use it:** Auto-updating curated list with bilingual README and Vercel deployment
...
- **Tags:** `plugin-directory`, `curated-list`, `dsh`, `awesome-list`
- **Why use it:** Curated plugin registry for discovering and installing DSH extensions

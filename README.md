...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,009,524 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-12 09:09:57 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 221,019 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,687 | Open-source Claude-like design tool with local-fir |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,186 | Deploy multi-agent swarms with autonomous workflow |
...
- **Why use it:** Self-evolving multi-agent harness with memory and skill support.
...
- **Tags:** `agent-orchestration`, `multi-device`, `mcp`
- **Why use it:** Unified agent workspace across desktop, mobile and browser with board tracking
...
- **Tags:** `router`, `routing`, `agent-control`
- **Why use it:** Task-aware reasoning-mode router with runtime injector for optimized agents
...
- **Why use it:** Enterprise multi-agent workbench with visual editor and cross-harness support
...
- **Why use it:** Self-improving Agent OS with interview-gated evolution and MCP server
...
- **Why use it:** Coding agent with RPC plugin, sub-agents, and MCP support via CLI
...
- **Tags:** `ai-agent`, `llm`, `oauth`, `deepseek-harness`
- **Why use it:** OAuth login for ChatGPT/Claude/Grok as LLM providers without API keys
...
- **Tags:** `coding-agent`, `skill`, `mentor`
- **Why use it:** AI coding tutor with project scanning, chapter-based guidance, and auto code review
...
- **Tags:** `registry`, `plugin`, `infrastructure`
- **Why use it:** Official plugin registry console with browser UI and zero-patch development guide
...
- **Why use it:** Unified local Agent Skills loader and safe manager within DeepSeek Harness
...
- **Why use it:** Enables vision capabilities for text-only models via OCR and image scanning
...
- **Why use it:** Adapted Codex skill for intelligent code simplification workflows
...
- **Why use it:** One-click MCP and skill config sync across 7+ AI agent platforms
...
- **Tags:** `deepseek-harness`, `skillhub`
...
- **Why use it:** Quality gate ensuring requirements and delivery are solid.
...
- **Tags:** `codex`, `deepseek-harness`, `sync`, `mcp`
...
- **Tags:** `chatgpt`, `oauth`, `ai-agents`, `subscription`
...
- **Tags:** `agent-tools`, `llm-agents`, `plugin-checklist`
- **Why use it:** Pre-flight plugin check for DSH agents — injects Top-K applicable plugins automatically
...
- **Why use it:** Modern desktop wrapper for DSH plugin ecosystem.
...
- **Tags:** `terminal`, `vfs`, `virtual`
- **Why use it:** World's first virtual terminal for AI agents with VFS
...
- **Why use it:** Open sidebar foundation with file rendering, editor, terminal, chat
...
- **Tags:** `task`, `panel`, `ui`
- **Why use it:** Modern flexible task panel supporting Codex and DeepSeek Harness
...
- **Why use it:** Official TUI plugin: whale bar, streaming thought, context progress
...
- **Why use it:** Cute whale widget monitoring DeepSeek account balance with animations
...
- **Tags:** `deepseek-harness`, `desktop`, `tauri`
- **Why use it:** Lightweight Tauri desktop with preset plugins, zero setup needed
...
- **Tags:** `novel-writing`, `desktop-app`, `dsh-plugin`
- **Why use it:** Desktop novel writing software with DSH preview, organized creative workflow
...
- **Why use it:** Local-first desktop workspace for DSH sessions, projects, and plugins
...
- **Why use it:** Windows desktop client with GUI, SSH, plugins and mobile remote access
...
- **Tags:** `gui`, `interactive`, `charts`, `inline-ui`
- **Why use it:** Generates interactive inline UI components like charts, forms, and quizzes
...
- **Tags:** `canvas`, `workspace`, `branching`, `visualization`
...
- **Why use it:** Brings spreadsheets, docs, slides and canvases into the Harness UI
...
- **Tags:** `ios`, `mobile`, `ui-automation`, `mcp`
...
- **Why use it:** Native iOS client connecting via WebSocket for workspace and agent tracking on iPhone
...
- **Why use it:** CodePilot-inspired desktop client plugin suite for DSH across macOS/Windows/Linux
...
- **Why use it:** Web UI for managing skills and MCP servers visually
...
- **Why use it:** Community plugin marketplace directly in the Web GUI
...
- **Why use it:** Electron desktop console managing Harness, Plugins, MCP, and Skills via multi-tab UI
...
- **Why use it:** Useful live balance and pricing info bar for DSH desktop
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI with sidebar and plugins.
...
- **Tags:** `memory`, `rag`, `long-term-memory`, `agent-memory`
...
- **Tags:** `memory`, `rag`, `token-savings`, `skill-reuse`
...
- **Tags:** `memory`, `agentic-rag`, `stateful-agent`
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus DB
...
- **Tags:** `memory`, `agentic-ai`, `mcp`
- **Why use it:** Shared persistent memory hub across all AI agents with full control
...
- **Tags:** `context`, `dsh-plugins`
- **Why use it:** Context dashboard and sidebar for insight and management in DSH
...
- **Tags:** `skill-corpus`, `retrieval`, `long-term-memory`, `vector-search`
- **Why use it:** Transforms scattered SKILL.md files into retrievable agent skill corpora
...
- **Why use it:** Three-layer auto-consolidation with zero-prompt proactive associative memory
...
- **Tags:** `agentic-ai`, `multi-agent`, `swarm`, `mcp-server`
...
- **Tags:** `skills`, `marketplace`, `workflow`
- **Why use it:** Largest skills marketplace with auto-crawled GitHub projects, regularly updated
...
- **Tags:** `content`, `discovery`, `agent`
- **Why use it:** Cross-platform content discovery agent from Bilibili, Douyin, X, etc
...
- **Why use it:** Intelligent skill routing +21.12pp reward with workflow orchestration
...
- **Tags:** `ai-video`, `ffmpeg`, `agent-skill`
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `observability`
- **Why use it:** Gives agents vision and hearing by turning screen/video/audio into evidence
...
- **Tags:** `skill`, `competition`, `gitops`, `automation`
...
- **Tags:** `agent-skills`, `automation`, `learning`
...
- **Tags:** `skills`, `deck`, `agent`
- **Why use it:** Pre-loaded 25 engineering skills panel with triage, wayfinder, handoff and more
...
- **Tags:** `document`, `gongwen`, `workflow`
- **Why use it:** GB/T 9704 compliant official document processor with format check, diff, and template
...
- **Tags:** `chinese-wisdom`, `metaphysics`, `skill`
- **Why use it:** Chinese metaphysics fusion skill: Bazi, Fengshui, I Ching with local deterministic engine
...
- **Tags:** `dsh-plugin`, `plugin-development`, `skill`
- **Why use it:** Skill guiding AI agents to develop DSH plugins from scratch.
...
- **Tags:** `agent-skills`, `remotion`, `video-production`
- **Why use it:** Cinematic product video agent skill with Remotion templates.
...
- **Why use it:** Agent skill for building DSH plugins/services/adapters.
...
- **Why use it:** 530+ GPT Image prompts and industrial-grade templates collection.
...
- **Why use it:** First vision plugin for DSH with OCR and image-to-JSON
...
- **Why use it:** AI-native design studio with visual editor, templates, and PPT creation
...
- **Why use it:** Legal litigation timeline and diagram visualization tool for case materials
...
- **Why use it:** AI video/image/audio generation suite with configurable model tools
...
- **Why use it:** Design system styles to avoid generic AI-generated look.
...
- **Why use it:** Transform chat history into beautifully designed downloadable knowledge cards
...
- **Why use it:** Enhancement suite and prompt manager for AI browser platforms.
...
- **Why use it:** Real logged-in browser automation for AI agents without disruption
...
- **Tags:** `tts`, `voice`, `xiaomi-mimo`
- **Why use it:** Free Xiaomi MiMo TTS integration with preset, custom and browser voices.
...
- **Tags:** `web`, `plugin-ecosystem`, `dsh-web`
- **Why use it:** Web-based plugin aggregation ecosystem for distributed DSH discovery
...
- **Tags:** `marketplace`, `installer`, `browse`
- **Why use it:** Official marketplace: browse, search, one-click install plugins
...
- **Tags:** `switch`, `models`, `installer`
- **Why use it:** One-click model switch between Claude Code, Codex, DeepSeek, Kimi
...
- **Why use it:** Self-hosted ecosystem radar scanning 15900+ candidate plugins with validation
...
- **Tags:** `cost-tracking`, `utility`, `llm`
- **Why use it:** Tracks session/daily costs, budgets, and multi-provider token usage
...
- **Why use it:** Open-source CLI and schemas for DSH Plugin Hub management and discovery
...
- **Why use it:** Backup, restore, sync and migrate entire DSH configuration
...
- **Why use it:** Official Huawei Cloud plugin with skills, MCP tools, safety guardrails, and sandbox
...
- **Why use it:** Manages multiple isolated DSH containers with embedded WebView UI
...
- **Tags:** `deepseek-harness`, `mcp-manager`, `web-ui`
- **Why use it:** Web UI plugin to manage skills and MCP servers.
...
- **Tags:** `cordis`, `deepseek-harness`, `infrastructure`
- **Why use it:** Orchestrates runtime, providers, plugins, and MCPs in DSH.
...
- **Tags:** `diagnostics`, `conflict-resolution`, `utility`
...
- **Tags:** `mascot`, `pixel-art`, `cli`, `theme`
- **Why use it:** Public gallery of animated CLI pets to personalize your agent terminal
...
- **Tags:** `theme`, `glassmorphism`, `customizable`, `visual`
- **Why use it:** Glassmorphism theme with fully customizable frosted-glass UI effects
...
- **Tags:** `theme`, `animated`, `ocean`, `webgpu`
- **Why use it:** Animated ocean theme with real-time waves, sunset and glass effects
...
- **Why use it:** Custom background images with presets (aurora, ember, rice paper) and fine-tuning.
...
- **Tags:** `ai`, `rag`, `mcp`, `guide`
- **Why use it:** Comprehensive AI resource library and tutorials for all major models
...
- **Tags:** `awesome-list`, `plugin-discovery`, `deepseek-harness`
- **Why use it:** Curated plugin discovery with auto-scraper, real plugin classification and heat rankings
...
- **Tags:** `research`, `arxiv`, `latex`, `gpu-cluster`
...
- **Why use it:** Learn DSH principles, browse plugin marketplace and study best practices
...
- **Why use it:** Curated list of DSH plugins, skills, MCP servers, patches, orchestrators and UIs
...
- **Why use it:** Cross-platform academic search skill with MCP: arXiv, PubMed, CrossRef, citation graphs
...
- **Why use it:** Industry research methodology with company and policy tracking
...
- **Why use it:** Searches 65,600+ API docs across 20 Chinese platforms, zero-config plugin
...
- **Why use it:** Interactive K-line analysis with technical indicators in DSH sidebar
...
- **Why use it:** Comprehensive plugin guide covering installation, permissions and risk awareness
...
- **Tags:** `awesome-dsh-plugin`, `plugin-directory`
- **Why use it:** Curated collection of精选 DSHA plugins from the official team
...
- **Why use it:** Automatically crawled daily directory of DSH plugins via GitHub Actions
...
- **Why use it:** Search npm + awesome-dsh-plugin from inside DSH agents for plugin discovery
...
- **Tags:** `awesome-list`, `ai-agents`, `plugins`
...
- **Why use it:** DeepSeek Harness plugin repository and bundle ecosystem directory
...
- **Tags:** `awesome-dsh-plugin`, `archive`
- **Why use it:** Moved — archived legacy awesome-dsh-plugin directory (redirects to new repo)
...
- **Why use it:** Simple community-contributed DSH plugin directory listing
...
- **Tags:** `low-code`, `no-code`, `ai-agent`, `crm`
...
- **Why use it:** Curated collection of DSH plugin ecosystem resources and references
...
- **Tags:** `plugin-market`, `dsh-plugin`
- **Why use it:** Daily refreshed plugin marketplace sourced and reviewed across the internet
...
- **Why use it:** Curated bilingual plugin and tool reference list for DSH ecosystem
...
- **Tags:** `awesome-list`, `encyclopedia`, `resources`, `learning`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, tools, and learning paths
...
- **Tags:** `command-code`, `commandcode`, `deepseek-harness`, `dsh`, `dsh-plugin`, `llm`, `llm-provider`, `plugin`, `provider`, `typescript`
- **Why use it:** Command Code provider plugin for DeepSee
...
- **Why use it:** 基于tushare构建本地财经数据库。AI原生的多Agent金融分析系统，支持s
...
- **⭐ Stars:** 178
- **Language:** TypeScript
- **Description:** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，��过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness 和 CodeX。 (A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling PC, Android, and Web clients to securely access and operate remote Harness and CodeX over a low-latency, end-to-end encrypted, P2P-first network.)
- **Tags:** `deepseek`, `dsh-plugin`
- **Why use it:** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，��
...
- **Why use it:** 帮 DSH 搜索、安装并验证插件的 Skill｜A DSH skill that
...
- **Tags:** `awesome-list`, `catalog`, `curated`
...
- **Why use it:** Curated collection of DSH plugins, tools and dev resources
...
- **Why use it:** Community-maintained plugin aggregation and auto-synced catalog
...
- **Tags:** `directory`, `awesome-list`, `catalog`
...
- **Why use it:** Specialized bioinformatics agent desktop for clinical and wet-lab use
...
- **Tags:** `roleplay`, `narrative`, `agent-skills`
- **Why use it:** Interactive narrative roleplay skill with memory and YAML save system
...
- **Why use it:** Comprehensive curated list of all DSH plugins, tools, skills & resources.
...
- **Why use it:** Hand-picked collection of useful DSH plugins and tools.
...
- **Tags:** `awesome-list`, `inventory`, `registry`
- **Why use it:** Full 1000+ repo inventory of DSH plugins sorted by star count.
...
- **Why use it:** Verified, star-ranked community plugins for DSH ecosystem.
...
- **Tags:** `directory`, `index`, `plugin-list`
- **Why use it:** Curated plugin directory with auto-generated bilingual README

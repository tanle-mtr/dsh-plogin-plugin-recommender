...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,089,254 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-24 09:13:52 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 234,726 | Core harness framework enabling plugin-first agent |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,881 | Local-first design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,179 | Deploy multi-agent swarms and coordinate autonomou |
...
- **Why use it:** Core harness framework enabling plugin-first agent ecosystem design
...
- **Why use it:** Self-evolving multi-agent harness with memory and MCP support
...
- **Why use it:** Terminal-native coding agent optimized for DeepSeek prefix-cache stability
...
- **Tags:** `agent-orchestration`, `no-code`, `coding-agent`
- **Why use it:** Unified agent workspace with task tracking across devices
...
- **Tags:** `preset`, `standard-tools`, `bootstrap`
- **Why use it:** Two-phase preset: minimal bootstrap then full Standard tools for reliable agent initialization.
...
- **Tags:** `multi-model`, `routing`, `account-management`
- **Why use it:** Unified multi-model account manager with smart routing and automatic failover across ChatGPT, Codex, Claude.
...
- **Tags:** `coding-agent`, `rust`, `runtime`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop for AI coding and use.
...
- **Tags:** `coding-agent`, `mcp`, `rpc-plugin`
- **Why use it:** Coding agent with RPC plugins, sub-agents, hashline edits, and MCP integration for developer workflows.
...
- **Why use it:** Ports Superpowers coding skills to Reasonix harness framework
...
- **Tags:** `coding`, `skills`, `superpowers`, `tdd`
...
- **Tags:** `context`, `dsh-plugin`, `ui`
- **Why use it:** Audits context token costs, detects conflicts in DSH instruction chains
...
- **Why use it:** WorkBuddy-style skill picker with slash command insertion in DSH
...
- **Tags:** `migration`, `dsh-plugin`, `session-import`
- **Why use it:** Four-source migration wizard for sessions, memories, skills and configs
...
- **Tags:** `dsh-plugin`, `cordis`, `orchestration`
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill and MCP orchestration in DSH
...
- **Tags:** `agent-tools`, `pre-flight`, `plugin-check`
- **Why use it:** Pre-flight plugin check for DSH agents — ensures predictable plugin utilization.
...
- **Why use it:** Official desktop client extending DSH to native experience
...
- **Tags:** `dsh-web`, `plugin-ecosystem`, `cordis`
...
- **Why use it:** Open sidebar foundation supporting third-party pages — file editor, terminal, chat, Git, sub-agents.
...
- **Why use it:** Modern embeddable task board with flexible layout, supports Codex and DeepSeek Harness.
...
- **Why use it:** Feature-rich TUI overlay: whale bar, streaming thought display, double-Esc rollback, real-time TPS.
...
- **Why use it:** Cute floating widget tracks DeepSeek balance with drag-and-drop and scroll animation.
...
- **Why use it:** Lightweight Tauri desktop with preset plugins, zero environment setup across all OSes.
...
- **Why use it:** Full-featured Windows GUI client with SSH, skills, mobile access, and zero-setup install.
...
- **Tags:** `desktop-app`, `mcp`, `local-first`
- **Why use it:** Local-first desktop workspace integrating sessions, files, web research, MCP, and Office artifacts.
...
- **Tags:** `ui-components`, `interactive`, `charts`
- **Why use it:** Generates interactive inline UI components—layouts, charts, plots, forms, quizzes—directly in assistant replies.
...
- **Why use it:** Canvas-based non-linear conversation workspace with visual session branching and exploration.
...
- **Tags:** `office`, `desktop-app`
- **Why use it:** Bring spreadsheets, docs, slides and canvases into DSH natively
...
- **Tags:** `desktop-app`, `ai-agent`, `privacy`
...
- **Tags:** `mobile`, `ios`, `ui-design`
- **Why use it:** Native iOS client connecting via WebSocket to DSH workspace
...
- **Tags:** `desktop-app`, `electron`, `ui-design`
...
- **Tags:** `notes`, `docker`, `smartisan`, `im-integration`
...
- **Tags:** `workbench`, `typescript`, `dsh-plugin`
- **Why use it:** Plugin-based web work platform with global skill management and workspace
...
- **Tags:** `bioinformatics`, `desktop-app`, `tauri`, `dsh-plugin`
...
- **Tags:** `ui-extension`, `stats`, `balance`
- **Why use it:** Replaces composer stats row with provider/model, balance, and pricing info.
...
- **Why use it:** All-in-one DevOps desktop hub integrating DB client, SSH, SFTP, Docker and AI assistant.
...
- **Why use it:** Fast and elegant Neovim plugin manager written in Lua for streamlined plugin setup.
...
- **Tags:** `desktop`, `electron`, `web-ui`, `integration`
- **Why use it:** Electron-based desktop shell for DSH web service with integrated sidebar and ModLens.
...
- **Why use it:** One-click compact button for DSH context meter panel, cleaner UI.
...
- **Why use it:** Transforms recent chat history into shareable knowledge cards with beautiful design.
...
- **Why use it:** Local-first persistent memory layer for cross-app AI agents
...
- **Why use it:** Lightweight memory library for stateful agent development
...
- **Why use it:** Memory management kit for agents — remember context, refine knowledge across interactions.
...
- **Why use it:** Persistent unified memory layer for all AI agents backed by Markdown and Milvus vectors.
...
- **Tags:** `agent-memory`, `vector-search`, `skill-routing`
- **Why use it:** Turns SKILL.md files into searchable corpora with retrieval, reranking, and evaluation tools.
...
- **Tags:** `ai-writing`, `webnovel`, `chinese-novel`
- **Why use it:** Specialized workflow for long-form Chinese web novel writing
...
- **⭐ Stars:** 7,170
- **Language:** Python
- **Description:** 收录最全、更��最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **Tags:** `skills`, `skill-store`, `agent-skills`
- **Why use it:** Largest skill marketplace covering dev, finance, office use
...
- **⭐ Stars:** 5,967
- **Language:** Python
- **Description:** Open-source, local-first control plane for long-running personal agents and agent teams. Keep goals, decisions, and work moving across sessions.
- **Tags:** `multi-agent`, `workflow`, `control-plane`
- **Why use it:** Local-first control plane for long-running agents; keeps goals and decisions flowing across sessions.
...
- **Why use it:** Intelligent skill routing and workflow orchestration with measurable token savings and reward gains.
...
- **Tags:** `agent-skills`, `cognition`, `workflow`
...
- **Why use it:** Enables multi-agent team collaboration workflows within the DeepSeek Harness ecosystem.
...
- **Tags:** `novel-writing`, `workflow`, `desktop`
- **Why use it:** Desktop novel-writing assistant organizing characters, worldbuilding and chapter workflow end-to-end.
...
- **Tags:** `ai-writing`, `agent-skills`, `novel-writing`
- **Why use it:** Multi-workbench for novel, drama, game and video writing workflows
...
- **Tags:** `multimodal`, `agent-skills`, `computer-vision`
- **Why use it:** Gives agents eyes and ears via video/audio/screen analysis
...
- **Tags:** `task-management`, `agent-skills`
- **Why use it:** Native SQLite-backed task board with Agent claim and review
...
- **Tags:** `cordis`, `skill-management`, `audit`
- **Why use it:** Skill audit and in-app skill manager for DSH workflows.
...
- **Why use it:** Enable composable, reviewable agent self-evolution modes.
...
- **Tags:** `agent-skills`, `research`, `marketing`, `business`
...
- **Tags:** `agent-skills`, `cross-platform`, `workflow`
- **Why use it:** Turn experience into repeatable agent execution across platforms.
...
- **Tags:** `finance`, `stock`, `multi-agent`, `mcp`
- **Why use it:** Multi-agent financial analysis system with skill expansion and IM alerts.
...
- **Tags:** `plugin-discovery`, `verification`, `automation`
...
- **Tags:** `security`, `pentest`, `reverse-engineering`, `ctf`
- **Why use it:** Full reverse engineering and pentest skill set for security research
...
- **Why use it:** 25 pre-installed engineering skills, 10x dev efficiency, GitHub-focused
...
- **Tags:** `agent-skills`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** AI coding mentor: scans architecture, generates chapters, reviews code
...
- **Tags:** `dsh-plugin`, `skills`, `deepseek-harness`
...
- **Why use it:** Full official document workflow: format check, optimization, template gen
...
- **Why use it:** Integrates Bazi, Fengshui, IChing into a local deterministic AI agent skill.
...
- **Tags:** `engineering-discipline`, `quality-gate`, `skill`
- **Why use it:** Engineering discipline bundle for requirement grilling and delivery proof.
...
- **Tags:** `spec-programming`, `agent-skill`, `development`
- **Why use it:** Portable agent skill for repository-native spec-driven development.
...
- **Why use it:** Plugin development knowledge base as an on-demand agent skill.
...
- **Why use it:** Math modeling resource with skills for preprocessing, coding, and writing.
...
- **Why use it:** Multi-agent team with durable memory, notes, and skills across sessions.
...
- **Why use it:** Testing engineering skill framework with 11 skills and shared knowledge base.
...
- **Why use it:** Multi-agent solver for math modeling competitions with 5 roles and 33 models.
...
- **Tags:** `planning`, `workflow`, `collaboration`
- **Why use it:** Separation-of-discussion-and-action skill for AI collaborative task planning.
...
- **⭐ Stars:** 31
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、���码组件和音频资产。
- **Tags:** `agent-skills`, `video`, `remotion`
- **Why use it:** 152 cinematic shot templates with Remotion assets for product videos
...
- **Why use it:** Cross-platform session continuity skill for Codex and Claude Code
...
- **Why use it:** Code simplification skill adapted from DeepSeek Harness to Codex
...
- **Tags:** `agent-skill`, `plugin-dev`, `workflow`
- **Why use it:** Agent skill providing standardized workflow for DSH plugin development.
...
- **Why use it:** Engineering workflow with task stages, verification, commits and skill management.
...
- **Tags:** `agent-os`, `mcp`, `llm-orchestration`, `loop-engineering`
- **Why use it:** Self-evolving agent OS with MCP and built-in evaluation loop
...
- **Why use it:** First vision plugin for DSH — paste images and get structured JSON evidence via OCR.
...
- **Tags:** `mcp`, `agent-skills`, `web-search`
- **Why use it:** Web search, content extraction, finance and research MCP skills
...
- **Why use it:** 65,600+ Chinese platform API docs search, zero-config skill integration
...
- **Why use it:** Official Huawei Cloud SDK, MCP tools, sandbox for agent cloud operations
...
- **Why use it:** Image reading/OCR tools for text-only models via pixel-to-text method.
...
- **Tags:** `api`, `integration`, `skillhub`
- **Why use it:** SkillHub Open API integration with documentation and examples.
...
- **Why use it:** One-click MCP, Skills and rules config for 7+ AI coding tools
...
- **Why use it:** Local-first design tool turning coding agents into visual designers
...
- **Why use it:** Generate beautiful verifiable architecture and sequence diagrams via code
...
- **Why use it:** 530+ image generation prompts and industrial-grade template library
...
- **Tags:** `design`, `ai-agents`, `ui`
- **Why use it:** Open-source AI-native vector design tool with concurrent Agent Teams for Design-as-Code workflows.
...
- **Why use it:** Public gallery of animated pet mascots that bring personality to your coding agent terminals.
...
- **Why use it:** AI-generated visual editor with template marketplace, prototyping and PPT capabilities built in.
...
- **Tags:** `visualization`, `legal`, `svg`, `dsh-plugin`
- **Why use it:** Legal litigation visualization: timelines, case diagrams, relationship maps
...
- **Tags:** `browser-extension`, `ai-studio`, `deepseek`, `chatgpt`, `claude`
- **Why use it:** Cross-platform AI chat enhancement with prompt management
...
- **Why use it:** Authenticated browser automation for AI agents by Tencent
...
- **Why use it:** Strongest free web search bridge—no signup, no API key needed, works across all LLM models.
...
- **Why use it:** Persistent-identity browser for agents with fingerprint spoofing, unlimited local profiles, and Android emulation.
...
- **Why use it:** Playwright-based browser automation plugins for DSH workflows
...
- **Why use it:** Local-first cross-platform content discovery agent covering Bilibili, YouTube, Reddit, Xiaohongshu, etc.
...
- **Tags:** `routing`, `agent`, `cordis`
- **Why use it:** Router and injector kit for intelligent agent task routing
...
- **Why use it:** World's first virtual terminal and VFS for AI agents — isolates agent workspaces securely.
...
- **Tags:** `api-keys`, `proxy`, `infrastructure`
- **Why use it:** OpenRouter-style API key and credential proxy registry for agent tools and MCP.
...
- **Why use it:** Context insight dashboard, browser integration and sidebar with real-time context statistics.
...
- **Tags:** `marketplace`, `plugin-shop`, `utilities`
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with community-sourced and reviewed plugins.
...
- **Why use it:** Official CLI, schema definitions, and resolver for DSH Plugin Hub—essential for plugin development.
...
- **Why use it:** AI security platform auditing generated code for hallucinated packages, missing safeguards, and pattern errors.
...
- **Tags:** `remote`, `p2p`, `multi-device`, `encryption`
...
- **Tags:** `compatibility`, `migration`, `pi-agent`, `dsh-plugin`
- **Why use it:** Bridges Pi and DSH ecosystems via unified ABI compatibility.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI panel for managing skills and MCP servers efficiently
...
- **Tags:** `utils`, `mcp`, `skills`, `management`
- **Why use it:** Unified capability management with dynamic exposure strategies for tools and skills
...
- **Why use it:** Infrastructure for DSH ecosystem: plugin console + official dev guide skill
...
- **Why use it:** Enhances DSH with task notifications, LLM trace inspection, keybindings, and built-in terminal.
...
- **Why use it:** Web plugin for real-time token usage tracking, cost estimates, and API balance monitoring.
...
- **Tags:** `tts`, `xiaomi`, `voice`, `utility`
- **Why use it:** Integrates free Xiaomi MiMo TTS API with preset, custom, and browser built-in voices.
...
- **Tags:** `diagnostic`, `conflict-resolution`, `utility`
- **Why use it:** Diagnoses and resolves plugin conflicts and version incompatibilities across the DSH ecosystem.
...
- **Why use it:** Whale Girl skin series beautifies the DeepSeek Harness interface with anime-style themes.
...
- **Tags:** `theme`, `glass-effect`, `customization`
- **Why use it:** Frosted glass theme for DSH web UI with full customization of blur,磨砂度, and background options.
...
- **Why use it:** Real-time ocean theme with animated waves and glassmorphism
...
- **Tags:** `theme`, `webui`, `background`
- **Why use it:** Customize DSH web background with upload or preset themes, real-time preview.
...
- **Tags:** `ai-resources`, `vibe-coding`, `tutorials`
...
- **Why use it:** Generate accurate technical docs and AI-ready context from codebases in minutes.
...
- **Tags:** `radar`, `research`, `validation`
- **Why use it:** Ecosystem radar with k8s-validated plugin discovery from 21k+ candidates across DSH topic.
...
- **Tags:** `awesome-list`, `research`, `curated`
- **Why use it:** Curated collection of DSH ecosystem plugins, tools and infrastructure from the public topic.
...
- **Why use it:** All-in-one research workbench: LaTeX writing, arXiv management, experiment tracking, GPU SSH orchestration.
...
- **Why use it:** Brings the Epistemic Loop methodology to DSH for structured scientific discovery and knowledge validation.
...
- **Why use it:** Daily curated DSH plugin discovery with rankings and guides
...
- **Why use it:** Comprehensive curated list of plugins, skills, MCPs and more
...
- **Why use it:** Ultimate Chinese guide with quickstart, resources and plugin picks
...
- **Why use it:** Comprehensive agent-first handbook covering runtime, MCP, sandbox.
...
- **Tags:** `research`, `industry-research`, `report`
- **Why use it:** Industry chain mapping and policy tracking with structured research methodology
...
- **Tags:** `patent`, `rag`, `python`, `dsh-plugin`
- **Why use it:** Patent infringement analysis system with RAG, outputs competitor reports
...
- **Why use it:** Interactive K-line chart with multi-market data and technical indicators
...
- **Why use it:** Curated plugin directory, essential DSH discovery resource
...
- **Why use it:** Best starting point for DSH plugin development beginners
...
- **Why use it:** Official DSH plugin marketplace — browse, search, and one-click install plugins.
...
- **Why use it:** Vision toolkit for text-only models: image paste recognition, multi-image Q&A and screenshot UI restoration.
...
- **Why use it:** Curated bilingual plugin directory covering extensions, skills, clients, runtimes, and integrations.
...
- **Tags:** `awesome-list`, `knowledge-base`, `ai-resources`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, MCP, RAG, multimodal, MLOps, and learning roadmaps.
...
- **Why use it:** Massive plugin marketplace with 11,000+ DSH plugins indexed.
...
- **Tags:** `awesome-list`, `plugins`, `official`
...
- **Why use it:** Meticulously curated DSH plugin and tool resource directory
...
- **Why use it:** Unofficial community plugin catalog for cross-platform DSH
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Curated collection of DeepSeek Harness plugins in Chinese
...
- **Why use it:** Spam-filtered curated registry for DSH plugins, bundles, and skills discovery.
...
- **Why use it:** Public GitHub directory for DSH plugin ecosystem discovery and install commands.
...
- **Why use it:** Hand-picked collection of useful DSH plugins for practical development workflows.
...
- **Why use it:** Evidence-led curated directory with verified plugins and permission-aware installation guidance.
...
- **Why use it:** Curated list covering the full DSH plugin ecosystem including CLI, web UI, and agent tools.
...
- **Why use it:** Quality-checked curated plugin list for DSH covering the latest 2026 ecosystem additions.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Complete curated awesome list of 1000+ DSH plugins sorted by stars.
...
- **Tags:** `awesome-list`, `documentation`
- **Why use it:** Plugin product manual with navigation by scenario for DSH users.
...
- **Tags:** `awesome-list`, `ai-curated`, `recommendation`
...
- **Why use it:** Auto-crawled daily DSH plugin directory via GitHub Actions, bilingual.
...
- **Why use it:** Zero-dependency static portal to browse, filter and install 227+ DSH plugins.
...
- **Why use it:** Search npm + awesome-dsh-plugin directly from inside DSH agents.
...
- **Why use it:** Curated directory of 80+ verified DSH plugins by function
...
- **Tags:** `dsh-ecosystem`, `dsh-plugins`, `curated`
...
- **Tags:** `moved`, `awesome-list`
- **Why use it:** Moved to new repo — formerly an awesome DSH plugins list

...
|--------|-------|
| **Plugins tracked** | 202 |
| **Total community stars** | 1,094,939 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 235,969 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 98,082 | Open-source design system alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,275 | Deploy multi-player AI swarms with autonomous coor |
...
- **Why use it:** Self-evolving multi-agent harness with memory and tool planning
...
- **Tags:** `coding-agent`, `deepseek`, `mcp`, `dsh-plugin`
...
- **Tags:** `routing`, `cog-stack`, `dsh-plugin`
- **Why use it:** Task-aware reasoning-mode router with runtime injector for optimized DSH workflows
...
- **Why use it:** Self-evolving Agent OS with MCP support, staged evaluation and budgeted loops
...
- **Why use it:** Vision toolkit for text-only models: image QA, OCR, screenshot UI restoration.
...
- **Why use it:** Coding agent with sub-agents, RPC plugin support, hashline edits, and MCP integration in a TUI.
...
- **Why use it:** AI directly drives Blender viewport via TCP for real-time rendering
...
- **Why use it:** Official plugin registry and development guide infrastructure for DSH ecosystem.
...
- **Why use it:** Official DSH plugin dev knowledge base as on-demand agent skill with EN/ZH docs.
...
- **Tags:** `plugin-creator`, `scaffold`, `cordis`
- **Why use it:** Codex skill scaffold for building and validating DSH/Cordis plugins from scratch.
...
- **Tags:** `agent-skill`, `plugin-dev`, `coding-agent`
...
- **Why use it:** Auto-recommends relevant plugins for DSH agents before task execution.
...
- **Tags:** `dsh`, `desktop`, `dsh-plugin`, `cordis-plugin`
- **Why use it:** Modern desktop solution for DSH ecosystem where the desktop itself is a plugin
...
- **Why use it:** Universal enhancement suite for major AI platforms with browser extension and prompt manager
...
- **Why use it:** Native desktop application for DeepSeek Harness with enhanced UI
...
- **Why use it:** Featured TUI plugin with whale bar, streaming status and rollback
...
- **Why use it:** Cute floating whale widget for monitoring DeepSeek balance, drag-and-drop support.
...
- **Why use it:** Zero-setup Tauri desktop app for DSH, tiny 5MB installer across all platforms.
...
- **Why use it:** Zero-setup Electron desktop GUI for DSH with SSH, plugins, and mobile remote access.
...
- **Why use it:** Interactive UI components rendered inline in assistant replies — layouts, charts, forms, quizzes via dsh-ui fence.
...
- **Tags:** `conversation`, `canvas`, `session-explorer`, `visual`
- **Why use it:** Visual non-linear conversation workspace with canvas-based session explorer and branching navigation.
...
- **Why use it:** Brings spreadsheets, docs, slides and canvases directly into DSH.
...
- **Why use it:** Native iOS client with WebSocket connection bringing workspace and agent traces to iPhone.
...
- **Why use it:** Cross-device remote access via secure P2P encrypted network
...
- **Why use it:** Smartisan-style notes with Docker deployment and export features
...
- **Why use it:** Community plugin marketplace directly in DSH web GUI
...
- **Tags:** `workbench`, `plugin-system`, `platform`
...
- **Why use it:** Electron desktop console for managing Harness/Plugins/MCP/Skills
...
- **Why use it:** Bioinformatics desktop app with offline mode, single-cell analysis for wet-lab scientists.
...
- **Why use it:** Replaces composer stats row with provider, model, balance, and pricing info display.
...
- **Why use it:** Visual context audit dashboard with circular panel UI
...
- **Why use it:** All-in-one DevOps desktop: SSH, SFTP, Docker, DB client and AI
...
- **Why use it:** Electron desktop client with full DSH integration
...
- **Why use it:** Open-source RAG knowledge platform with reasoning agent and wiki
...
- **Why use it:** Portable, local-first Markdown-native memory layer for cross-app agent knowledge
...
- **Why use it:** Memory library enabling stateful, self-improving agent behavior
...
- **Tags:** `deepwiki`, `dsh-plugin`, `rust`
- **Why use it:** Generates structured technical docs and AI-ready context from code efficiently.
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Milvus and embeddings.
...
- **Tags:** `agent-memory`, `vector-search`, `skill-md`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora with vector search.
...
- **Why use it:** DSH plugins repository and discovery tool for the ecosystem.
...
- **Tags:** `dsh-plugins`
- **Why use it:** Plugin index (moved to new repo).
...
- **Why use it:** Bilingual verified plugin directory with immutable commit reviews.
...
- **Why use it:** Deploy multi-player AI swarms with autonomous coordination workflows
...
- **Why use it:** Distill expert thinking patterns into reusable AI skills for any agent
...
- **Tags:** `skills-store`, `agent-skills`, `marketplace`
- **Why use it:** Comprehensive skills marketplace covering coding, writing, finance and automation
...
- **Why use it:** Long-form web novel writing assistant solving AI hallucination and forgetting
...
- **Why use it:** Enterprise-grade local-first agent workbench with multi-engine workspace support
...
- **Tags:** `agent-harness`, `multi-agent`, `workflow-automation`
...
- **Tags:** `llm-agent`, `preset`, `deepseek-harness`
- **Why use it:** Two-phase bootstrap preset aligning agents to Project2 standard tools
...
- **Tags:** `agent-teams`, `dsh-plugin`, `multi-agent`
- **Why use it:** Enables multi-agent team coordination within the DeepSeek Harness ecosystem.
...
- **Why use it:** Brings the Epistemic Loop framework to DSH for structured scientific discovery and agentic reasoning.
...
- **Tags:** `creative-writing`, `novel-writing`, `ai-writing`, `screenwriting`
- **Why use it:** Creative writing workflow plugin for novels, short dramas, games, and video recaps with dedicated workbenches.
...
- **Tags:** `agent-skills`, `multimodal`, `ocr`
- **Why use it:** Gives agents video/audio/OCR eyes with timestamped, verifiable evidence.
...
- **Why use it:** SQLite-backed local taskboard with agent claim/review — no iframe runtime needed.
...
- **Why use it:** Enables self-evolving agents with composable, human-reviewed tasks
...
- **Tags:** `agent`, `skills`
- **Why use it:** Turn experience into repeatable AI execution across multiple platforms
...
- **Why use it:** Financial data source with multi-agent analysis and IM notifications
...
- **Why use it:** 87 SKILL.md reverse engineering and pentesting automation skill
...
- **Why use it:** AI infra-specific agent skills for system optimization and debugging
...
- **Why use it:** Converts successful DSH sessions into reusable agent skills
...
- **Why use it:** Unified capability management with configurable exposure strategies
...
- **Tags:** `skills`, `productivity`, `agent`
- **Why use it:** 25 pre-installed productivity skills trained on 30B tokens
...
- **Tags:** `mentor`, `education`, `code-review`
- **Why use it:** AI coding mentor that teaches through guided chapters and review
...
- **Tags:** `gongwen`, `docx`, `wps-office`, `skills`
- **Why use it:** Full Chinese official document workflow per GB/T 9704 standard
...
- **Why use it:** Fusion of Bazi, Fengshui, TCM wisdom into a local deterministic AI agent skill.
...
- **Why use it:** Engineering-quality gate skill: grill requirements, test implementations before shipping.
...
- **Why use it:** Math modeling toolkit: data preprocessing, coding, paper writing, visualization skills.
...
- **Why use it:** Spec-driven development skill ported from DSH patterns, works across major coding agents.
...
- **Tags:** `multi-agent`, `agent-team`, `memory`
- **Why use it:** Durable multi-agent teams with persistent memory, notes, and skills across sessions.
...
- **Tags:** `multi-agent`, `agent-orchestration`, `dsh-plugins`
...
- **Why use it:** Pixel-to-text OCR and vision skill enabling text-only models to read images accurately.
...
- **Tags:** `video`, `motion-design`, `agent-skills`
...
- **Why use it:** QA engineering skill framework: 11 skills + shared knowledge base for AI testing workflows.
...
- **Why use it:** Complete multi-agent math modeling framework with 33 models
...
- **Tags:** `skill`, `agent`
- **Why use it:** Cross-platform deliberation-before-action coordination skill
...
- **Tags:** `skillhub`, `skill`
- **Why use it:** Official SkillHub integration for skill discovery and management
...
- **Why use it:** WorkBuddy-style skill picker with slash command insertion
...
- **Why use it:** Cross-platform session memory for agent continuity handoff
...
- **Tags:** `workflow`, `task-management`, `deepseek-harness`
- **Why use it:** Provides structured task management, verification, and commit workflows.
...
- **Why use it:** World's first virtual terminal with VFS for isolated agent sandboxes
...
- **Why use it:** OpenRouter for agent tools with community-powered API key registry
...
- **Tags:** `mcp`, `web-search`, `research`, `agent-skills`
- **Why use it:** Web search, content extraction and research skills via You.com
...
- **Why use it:** Search 65,600+ APIs from 20 Chinese platforms with zero config
...
- **Why use it:** Official Huawei Cloud SDK with skills, MCP tools and sandbox
...
- **Why use it:** OAuth integration to use ChatGPT models directly within DSH.
...
- **Tags:** `agent-skills`, `diagrams-as-code`, `dsh-plugin`, `developer-tools`
- **Why use it:** Beautiful self-contained architecture diagrams as code with animations
...
- **Tags:** `ai-image-generation`, `skills`, `workflow-automation`, `dsh-plugin`
...
- **Why use it:** Native design studio with AI generation, visual editor and PPT templates.
...
- **Why use it:** Generate litigation timelines, diagrams and legal case visualizations
...
- **Why use it:** AI video/image/audio creation pipeline with storyboard support
...
- **Why use it:** Real-time token usage, cost estimates and per-round API charts
...
- **Tags:** `knowledge-cards`, `visual`, `share`
- **Why use it:** Converts chat history into shareable knowledge cards
...
- **Why use it:** Local-first self-evolving agent discovering content across 8+ platforms
...
- **Why use it:** Strongest free web search plugin for DSH — no signup, no API key, works as a search bridge for all models.
...
- **Why use it:** Browser automation with persistent identity — engine-level fingerprint spoofing and unlimited local profiles.
...
- **Why use it:** 22 agent tools for live iOS Simulator/USB iPhone control inside conversations.
...
- **Why use it:** Tabbit Browser plugins for advanced web automation via Playwright
...
- **Tags:** `electron`, `image`, `dsh-plugin`, `cloud-storage`
...
- **Tags:** `cli`, `api-keys`, `credentials`
- **Why use it:** Multi-model account manager with smart routing and auto failover
...
- **Why use it:** Context dashboard and management tool with browser and sidebar integrations.
...
- **Why use it:** Open-source ecosystem radar discovering and validating 21k+ DSH plugin candidates.
...
- **Why use it:** Comprehensive daily-refreshed DSH plugin marketplace with pre-published reviews.
...
- **Why use it:** CLI, schemas, and resolver for DSH Plugin Hub — manage and discover plugins from the command line.
...
- **Why use it:** Bridges Pi and DSH ecosystems with ABI compatibility layer
...
- **Why use it:** One-click MCP, Skills and rules setup across 7+ AI tools
...
- **Why use it:** Isolated container management for multiple DSH versions
...
- **Why use it:** Four-source migration wizard for seamless DSH onboarding
...
- **Why use it:** Task notifications, LLM trace inspection, keybindings and terminal
...
- **Why use it:** Animated pet mascot gallery enhancing CLI agent terminal aesthetics
...
- **⭐ Stars:** 405
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全���能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `glassmorphism`, `deepseek-harness`
- **Why use it:** Frosted glass theme with full customization; zero source code changes needed.
...
- **Why use it:** Animated ocean theme with adjustable waves, sunset & glass opacity effects.
...
- **Why use it:** Custom backgrounds with preset atmospheres and real-time preview
...
- **Tags:** `ai`, `rag`, `prompt-engineering`, `dsh-plugin`
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and model guides
...
- **Tags:** `awesome-list`, `bilingual`, `curated-list`, `developer-tools`
- **Why use it:** Bilingual curated awesome list of DSH plugins, extensions, tools, skills, and verified references.
...
- **Why use it:** All-in-one research workbench: LaTeX editing, arXiv management, experiment tracking, GPU SSH orchestration.
...
- **Tags:** `ai-knowledge-base`, `awesome-list`, `mcp`, `rag`
- **Why use it:** Comprehensive AI resource encyclopedia covering models, agents, RAG, multimodal tools, and learning roadmaps.
...
- **Tags:** `research`, `mcp`, `academic`
- **Why use it:** Cross-database academic search with citation graphs, MeSH tags, and verification.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Great DSH learning resource and best practices guide
...
- **Tags:** `awesome-list`, `dsh-plugin-market`
- **Why use it:** Comprehensive plugin marketplace with 11,000+ plugins and search API
...
- **Why use it:** Comprehensive 173-page source-backed DSH handbook with 74 resources
...
- **Why use it:** Auto-discover, install and verify DSH plugins from GitHub
...
- **Why use it:** Complete industry research methodology with policy and news tracking
...
- **Tags:** `patent`, `rag`, `legal-tech`, `analysis`
- **Why use it:** Patent infringement analysis with competitor report generation
...
- **Tags:** `stock-analysis`, `technical-analysis`, `kline`
- **Why use it:** Interactive multi-market K-line analysis with technical indicators
...
- **Tags:** `stock-analysis`, `quantitative-trading`, `backtesting`
- **Why use it:** 39 tools + 20 strategies for multi-market quantitative analysis
...
- **Why use it:** Verified open-data registry of DSH plugins and skills
...
- **Why use it:** Comprehensive curated list covering all DSH plugins and resources
...
- **Why use it:** Curated plugin list with bilingual descriptions
...
- **Why use it:** Public GitHub directory with install commands for ecosystem discovery
...
- **Why use it:** Verified stock/finance/quant DSH plugins, bilingual curation
...
- **Tags:** `awesome-list`, `cli`, `web-ui`, `agent`
- **Why use it:** Broad plugin ecosystem list covering CLI, web UI and agents
...
- **Why use it:** Plugin manual with installation and compatibility guide
...
- **Tags:** `recommender`, `ai-curved`, `awesome-list`
...
- **Why use it:** Curated plugin collection from DSH team
...
- **Why use it:** Zero-dependency static portal for 227+ plugins discovery
...
- **Why use it:** Search plugins directly inside DSH agents
...
- **⭐ Stars:** 2,253
- **Language:** JavaScript
- **Description:** DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star ��藏 ⭐
- **Tags:** `jailbreak`, `dsh-plugin`, `llm`
- **Why use it:** Jailbreak plugin enabling all models to break through restrictions with custom prompts.
...
- **Tags:** `writing`, `ai-novel`, `long-form-fiction`
- **Why use it:** AI-powered novel writing software with worldbuilding, characters and chapter workflow.
...
- **Tags:** `cybersecurity`, `ai-security`, `vulnerabilities`, `redteam`
- **Why use it:** AI Security Offense & Defense platform — audits AI-generated code for hallucinated packages and vulnerabilities.
...
- **Why use it:** Daily auto-curated DSH plugin directory; filters real plugins from noise tags.
...
- **Why use it:** Ultimate DSH guide covering quickstart, curated plugins, resources and tools.
...
- **Tags:** `awesome-list`, `plugins`
- **Why use it:** Curated plugin list covering productivity and functional extensions
...
- **Why use it:** Unofficial community plugin catalog and discovery resource

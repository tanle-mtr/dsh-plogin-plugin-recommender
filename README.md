...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,091,487 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-24 22:10:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 235,111 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,969 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,218 | Deploy multi-agent swarms with autonomous workflow |
...
- **Tags:** `coding-agent`, `rpc`, `mcp`, `go`
- **Why use it:** Go-based coding agent with RPC, sub-agents, hashline edits, and MCP support.
...
- **Why use it:** Shields AI-generated code from hallucinated packages and missing safeguards.
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH LLM providers — OAuth login, no API keys.
...
- **Why use it:** Adds Command Code model access with live catalog and plan-aware reasoning-efficiency selection.
...
- **Tags:** `multimodal`, `vision`, `claude-code`, `agent-skills`
...
- **Why use it:** Unified capability management with dynamic exposure strategies.
...
- **Tags:** `agent-platform`, `skills`, `typescript`
- **Why use it:** Plugin-based web work platform with global skill management for DSH.
...
- **Why use it:** Official DSH plugin dev knowledge base bundled as an on-demand skill
...
- **Tags:** `plugin-creator`, `developer-tools`, `harness`
...
- **Why use it:** Context injection audit with UI panel, detects conflicts and waste
...
- **Tags:** `agent-skill`, `plugin-dev`, `toolkit`
...
- **Tags:** `search`, `agent`, `discoverability`
- **Why use it:** Agent-native search across npm and curated DSH plugin lists
...
- **Tags:** `agent-tools`, `preflight`, `capability`
- **Why use it:** Auto-preflights top-K relevant plugins before task-type requests
...
- **Why use it:** Manages DSH engineering workflows with task stages and verification
...
- **Why use it:** Binds ChatGPT OAuth to chat with AI models inside DSH
...
- **Why use it:** Modern desktop client specifically built for DSH plugin ecosystem.
...
- **Tags:** `browser-extension`, `chatgpt`, `deepseek`
- **Why use it:** Enhances AI chat UIs with prompt management across platforms.
...
- **Tags:** `taskboard`, `cli`, `skills`
- **Why use it:** Modern flexible task panel embeddable into Codex and DSH workflows.
...
- **Tags:** `tui`, `terminal`, `dsh-plugin`, `react`
- **Why use it:** TUI plugin with live status, streaming thought, and context progress indicator.
...
- **Why use it:** Cute floating whale widget tracks DeepSeek balance with drag-and-drop.
...
- **Why use it:** 5MB Tauri desktop app with zero setup and preset plugins across platforms.
...
- **Tags:** `desktop-app`, `mcp`, `office-automation`
- **Why use it:** Local-first desktop workspace for DSH sessions, projects, web research, and Office.
...
- **Why use it:** Canvas-based non-linear conversation explorer with session branching and visual graph.
...
- **Tags:** `office`, `desktop-extension`
- **Why use it:** Brings spreadsheets, docs, slides and canvases into DSH — a full office suite.
...
- **Why use it:** Local-first multi-model DSH desktop app with self-evolving skills and privacy focus.
...
- **Why use it:** Native iOS client for DSH with workspace sync, sessions and live agent tracking.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with plugin suite for macOS, Windows, Linux.
...
- **Tags:** `cordis`, `deepseek-harness`, `dsh-plugin`, `skill-manager`
...
- **Why use it:** Web UI plugin for managing skills and MCP configurations
...
- **Why use it:** Community plugin marketplace with one-click install in web GUI
...
- **Why use it:** Electron-based desktop hub for multi-tab Harness/Plugin/MCP/Skill management.
...
- **Why use it:** Bioinformatics desktop app with offline mode and skill store for scientists
...
- **Why use it:** Replaces composer stats with provider/model info, balance and pricing display
...
- **Why use it:** All-in-one DevOps desktop with database, SSH, SFTP, Docker and AI tools
...
- **Why use it:** Single-click to compact the DSH Web context meter panel
...
- **Why use it:** Turn documents into queryable RAG with semantic search.
...
- **Why use it:** Portable local-first Markdown memory layer for all agents.
...
- **Why use it:** Turns SKILL.md files into retrieval-ready corpora with embedding and reranking.
...
- **Tags:** `knowledge-base`, `awesome-list`, `ai-resources`
- **Why use it:** Comprehensive AI knowledge encyclopedia — covers agents, RAG, MLOps, and learning paths.
...
- **Tags:** `memory`, `handoff`, `session`, `cross-platform`
- **Why use it:** Cross-platform session memory continuity for future agent recovery
...
- **Tags:** `agent-workspaces`, `multi-device`
...
- **Why use it:** Long-form web novel writing assistant solving AI memory issues.
...
- **Tags:** `skills`, `skill-store`
- **Why use it:** Comprehensive skills store with auto-updating organized collection.
...
- **Tags:** `multi-agent`, `workflow-automation`, `agent-harness`
- **Why use it:** Durable state kernel for long-horizon multi-agent workflow automation.
...
- **Why use it:** Intelligent skill routing and workflow orchestration, -29.6% tokens on SkillsBench.
...
- **Why use it:** Enable multi-agent team collaboration directly within DeepSeek Harness.
...
- **Why use it:** Structured AI novel writing tool organizing inspiration, characters, worldbuilding.
...
- **Tags:** `agent-skills`, `epistemic-loop`, `scientific-discovery`
- **Why use it:** Brings the Epistemic Loop framework for rigorous scientific discovery workflows.
...
- **Tags:** `agent-skills`, `creative-writing`
- **Why use it:** All-in-one creative writing workflow for novels, short dramas, games and video recaps.
...
- **Why use it:** Turns video/audio/screen into searchable, timestamped evidence with verifiable results.
...
- **Why use it:** Native SQLite-backed task management with agent claim/review — no iframe runtime needed.
...
- **Tags:** `mobile-automation`, `ios`, `agent-skills`
- **Why use it:** Run iOS Simulator inside DSH chat — 22 tools for booting, building and automating iPhone apps.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `math-modeling`
...
- **Tags:** `agent-review`, `ai-agents`, `deepseek-harness`, `prompt-engineering`
- **Why use it:** Enable agent self-evolution with composable, human-reviewed task modes.
...
- **Tags:** `agent-skills`, `deep-research`, `marketing-automation`, `workflow`
...
- **Tags:** `skills`, `coding`, `agent`, `multi-tool`
- **Why use it:** Turn experience into repeatable execution skills across multiple AI tools.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `plugin-discovery`, `dsh-plugin`
- **Why use it:** DSH skill that finds, installs and verifies GitHub plugins automatically.
...
- **Why use it:** TDD, debugging and planning skills adapted from Superpowers
...
- **Tags:** `dsh-ecosystem`, `plugin-marketplace`
...
- **Tags:** `skills`, `github-issues`, `agent`
- **Why use it:** 25 ready-to-use skills covering GitHub, Markdown, GitLab with 30B token training.
...
- **Why use it:** AI coding mentor skill that generates staged chapters and performs code review.
...
- **Tags:** `gongwen`, `dsh-plugin`, `ai-docs`
- **Why use it:** Full workflow GB/T 9704 official document skill: format, optimize, template generation.
...
- **Tags:** `legal-tech`, `agent-skills`, `diagram`
- **Why use it:** Legal litigation visualization skill: timelines,对抗图, and relation diagrams.
...
- **Why use it:** Fusion Bazi/TCM/Fengshui agent skill with local deterministic engine
...
- **Tags:** `math-modeling`, `competition`, `academic`
- **Why use it:** Comprehensive math modeling resource: preprocessing, coding, paper writing skills
...
- **Why use it:** Durable multi-agent teams with independent memory, notes, and skills across sessions
...
- **Why use it:** Multi-agent collaboration with independent models, skills, MCP tools, shared workspace
...
- **Why use it:** Pixel-to-text image reading via trained methodology for text-only LLMs
...
- **Why use it:** 11-test-engineer skills with shared knowledge base for AI-powered QA automation
...
- **Why use it:** 5-role multi-agent math modeling with 33 models, templates, and visual progress
...
- **Why use it:** Plan-before-execute separation mechanism for AI collaborative task workflows
...
- **Why use it:** 152 shot recipes + Remotion templates for cinematic video production
...
- **Why use it:** Code simplification skill adapted from DeepSeek Harness patterns
...
- **Why use it:** Self-evolving Agent OS with MCP server and evaluation loop.
...
- **Why use it:** Vision bridge for text-only agents — paste images to get structured JSON evidence.
...
- **Tags:** `virtual-terminal`, `vfs`, `agent-tools`, `agent-sandbox`
...
- **Why use it:** Official Huawei Cloud MCP toolkit for AI agent cloud build and deploy.
...
- **Why use it:** Open-source design system with local-first desktop support.
...
- **Tags:** `ai-director`, `video`, `image`, `audio`
...
- **Why use it:** CLI + extension for AI agents to use logged-in browsers.
...
- **Why use it:** Cross-platform content discovery agent from Bilibili, Xiaohongshu, YouTube, etc.
...
- **Why use it:** Free no-signup web search bridge — gives every model native-equivalent web access.
...
- **Why use it:** Web-based plugin aggregation and distribution platform.
...
- **Tags:** `multi-model`, `quota-tracking`, `smart-routing`
- **Why use it:** Multi-model smart routing with priority and auto-failover for agent accounts.
...
- **Tags:** `api-keys`, `secrets`, `mcp`, `registry`
...
- **Why use it:** Comprehensive context dashboard, browser, sidebar and command management tool.
...
- **Why use it:** CLI plugin manager with schemas and resolver — essential for DSH Hub workflow.
...
- **Tags:** `compatibility-layer`, `deepseek-harness`, `dsh-plugin`, `migration`
- **Why use it:** Bridge Pi ecosystem to DSH — run Pi extensions as native DSH plugins.
...
- **Tags:** `migration`, `deepseek-harness`, `dsh-plugin`, `import`
- **Why use it:** Import chat history from 25+ AI agents into DSH as resumable sessions.
...
- **Why use it:** Private note-taking app with DSH integration and skill support
...
- **Tags:** `backup`, `config-manager`, `migrate`
...
- **Tags:** `mcp`, `config`, `setup`, `multi-tool`
- **Why use it:** One-click config sync for MCP servers across 6+ AI tools
...
- **Tags:** `container`, `version`, `management`, `ui`
- **Why use it:** Multi-version DSH management in isolated containers with WebView UI
...
- **Tags:** `migration`, `wizard`, `claude-code`, `import`
- **Why use it:** Four-source migration wizard for sessions, memories, skills, configs
...
- **Why use it:** Unified launcher for Runtime, Provider, Plugin, Skill orchestration
...
- **Why use it:** Web plugin for real-time token usage tracking and cost visualization
...
- **Why use it:** Free Xiaomi MiMo TTS integration with preset and custom voices
...
- **Tags:** `marketplace`, `utility`, `discovery`
- **Why use it:** CodeX-style marketplace for discovering and managing plugins
...
- **Tags:** `deepwiki`, `documentation`, `code-analysis`
- **Why use it:** Generates accurate technical docs from code for humans and AI agents.
...
- **Tags:** `plugin-discovery`, `radar`, `ecosystem`
- **Why use it:** Open ecosystem radar discovering 21k+ plugins with k8s runtime validation.
...
- **Why use it:** Daily-refreshed comprehensive plugin marketplace with pre-publication reviews.
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, GPU SSH, experiment tracking & charts.
...
- **Why use it:** Daily-curated DSH plugin discovery list with filters, rankings, and usage guides.
...
- **Why use it:** Comprehensive curated catalog of DSH plugins, skills, MCP servers, patches and more.
...
- **Why use it:** Ultimate DSH guide covering quick start, curated resources, top plugins and practical tools.
...
- **Why use it:** Cross-database academic search skill + MCP with citation verification and knowledge graphs.
...
- **Tags:** `finance`, `agent`, `mcp`, `tushare`, `research`
- **Why use it:** Multi-agent financial analysis system with Tushare data and IM alerts.
...
- **Why use it:** Patent infringement analysis system producing competitive analysis reports.
...
- **⭐ Stars:** 30
- **Language:** HTML
- **Description:** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持多市场行情、技术指标、支撑压力位、新闻与���本面分析，并在原生侧栏中直接展示。
- **Tags:** `kline`, `finance`, `analysis`, `sidebar`
- **Why use it:** Interactive K-line analysis with tech indicators in DSH sidebar
...
- **Why use it:** Scenario-based plugin selection guide with installation notes
...
- **Tags:** `radar`, `awesome-list`, `evidence`
...
- **Why use it:** Daily automated crawl of dsh-plugin ecosystem for plugin discovery
...
- **Why use it:** Hand-picked DSHA premium plugin collection
...
- **Why use it:** Curated plugin directory, not a functional plugin itself.
...
- **Why use it:** Curated bilingual plugin directory — ideal starting point for exploring DSH ecosystem.
...
- **Why use it:** Great starting point for learning DSH principles and plugin marketplace.
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin-market`, `marketplace`
- **Why use it:** Largest DSH plugin marketplace with 11K+ plugins, search and API access.
...
- **Tags:** `deepseek-harness`, `awesome-list`, `mcp`, `developer-tools`
...
- **Tags:** `catalog`, `deepseek-harness`, `dsh-plugin`, `directory`
- **Why use it:** Curated catalog of 1819 real DSH plugins with search, categories and rankings.
...
- **Why use it:** Curated collection of DSH plugins and productivity tools
...
- **Why use it:** DSH ecosystem infrastructure: thin console + official plugin dev guide skill.
...
- **Tags:** `documentation`, `api`, `tencent`
- **Why use it:** Official Tencent SkillHub API docs and plugin examples
...
- **Why use it:** Curated awesome list of DSH plugins, tools, skills & resources
...
- **Why use it:** Curated list to discover DSH plugins and ecosystem resources
...
- **Tags:** `registry`, `plugins`, `skills`
- **Why use it:** Open-data registry with spam filtering for DSH plugins and skills
...
- **Why use it:** Chinese curated collection of useful DSH plugins
...
- **Why use it:** Evidence-led directory with verified plugins and permission-aware guidance
...
- **Why use it:** Curated DSH plugin ecosystem list covering CLI, web UI and agents
...
- **Tags:** `awesome-list`, `quality-check`
...
- **Why use it:** Curated registry of 80+ verified DSH plugins by function
...
- **Tags:** `repository`, `plugins`, `dsh-bundle`
- **Why use it:** DSH plugins repository for discovery and browsing
...
- **Tags:** `redirect`, `moved`
- **Why use it:** Moved repository, points to new location
...
- **Why use it:** Auto-updating plugin list with bilingual README generation

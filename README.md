...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 857,037 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 03:09:24 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 192,459 | Core DSH platform — everything is a plugin, extend |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,136 | Local-first desktop design tool for AI coding agen |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,305 | Multi-agent swarm framework with autonomous workfl |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 17 plugins
...
- [Other](#other) — 43 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (17)
...
- **Why use it:** Core DSH platform — everything is a plugin, extendable and modular.
...
- **Why use it:** Multi-agent swarm framework with autonomous workflows and conversational AI.
...
- **Tags:** `multi-agent`, `skills`, `dsh-plugin`
- **Why use it:** Super AI agent harness with self-evolving memory, multi-model and multi-channel support.
...
- **Tags:** `coding-agent`, `dsh-plugin`, `tool-use`
- **Why use it:** Terminal-native DeepSeek coding agent optimized for prefix-cache stability and tool use.
...
- **Why use it:** Beginner-friendly DSH tutorial from zero to production
...
- **Tags:** `coding-agents`, `architecture`, `drift-check`
- **Why use it:** Architecture-aware coding agent with baseline-first drift checking.
...
- **Tags:** `security`, `agent`, `cybersecurity`
...
- **Why use it:** Live iOS Simulator and iPhone automation inside DSH with 22 specialized agent tools.
...
- **Why use it:** Dispatch work to DSH subagents from Claude Code or Codex natively
...
- **Why use it:** Agent Skill for developing DSH plugins following official standards and patterns
...
- **Why use it:** Agent skill for building installed DSH plugins with slots, Typert remotes, credentials
...
- **Tags:** `dsh`, `containers`, `plugin-manager`
...
- **Tags:** `capability`, `menu`, `mcp`, `skills`
- **Why use it:** Unified menu to manage MCP tools and skills exposure level and mode
...
- **Tags:** `plugin-dev`, `auditing`, `cordis`
...
- **Tags:** `documentation`, `plugin-dev`, `best-practices`
- **Why use it:** Plugin dev troubleshooting guide with practical solutions
...
- **Why use it:** Pre-flight plugin check for predictable agent performance
...
- **Why use it:** Local-first desktop design tool for AI coding agents with Figma-alternative UX.
...
- **Why use it:** Modern desktop client for DSH ecosystem — treats the desktop itself as a plugin.
...
- **Why use it:** Web UI aggregation pack for the entire DSH plugin ecosystem
...
- **Tags:** `desktop-companion`, `pets`, `sdk`
...
- **Why use it:** Adorable floating whale widget tracks your DeepSeek balance.
...
- **Why use it:** Local-first Electron desktop workspace for sessions and plugins.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client with rich plugin suite for DSH.
...
- **Why use it:** Visual non-linear conversation canvas enabling branching and session exploration.
...
- **Why use it:** Zero-setup Windows desktop GUI with SSH and mobile access
...
- **Tags:** `desktop-app`, `electron`, `typescript`, `dsh-plugins`
- **Why use it:** Electron desktop console for managing Harness/Plugin/MCP/Skills in multi-tab UI
...
- **Tags:** `web-ui`, `mcp`, `skills`
- **Why use it:** Browser-based skill and MCP server management via DSH Web GUI
...
- **Tags:** `canvas`, `creative`, `deepseek-harness`
- **Why use it:** Native WeShop canvas integration with infinite creative agent skills
...
- **Tags:** `plugin-manager`, `gui`, `dsh-plugin`
- **Why use it:** Built-in DSH GUI for managing MCP, skills and plugins with hot reload
...
- **Why use it:** Tauri 2 desktop app integrating DB, SSH, Docker and AI assistant
...
- **Why use it:** Electron desktop shell with integrated DSH web services and plugins
...
- **Why use it:** LLM knowledge platform with RAG, semantic search, and self-maintaining wiki capabilities.
...
- **Tags:** `agent-memory`, `rag`, `long-term-memory`, `self-evolving`
- **Why use it:** Portable Markdown-native memory layer for all AI agents
...
- **Why use it:** Comprehensive memory management kit for agents with refine capabilities
...
- **Why use it:** Unlimited memory solution for persistent agent context.
...
- **Why use it:** Best context insight dashboard for statistics and management.
...
- **Why use it:** Comprehensive AI knowledge base covering RAG, MCP, agents, and learning resources.
...
- **Tags:** `rag`, `embeddings`, `skill-corpus`, `retrieval`
- **Why use it:** Turns SKILL.md files into curated retrieval-ready corpora
...
- **Tags:** `memory`, `mcp`, `agent`
- **Why use it:** Durable long-term agent memory with recall tools and inspectability
...
- **Why use it:** Connects DSH to PowerContext server for recall, memory and handoff
...
- **Why use it:** Distills AI reasoning into reusable skills for any agent or bot via knowledge distillation.
...
- **Tags:** `skills`, `workflow-automation`, `dsh-plugin`
- **Why use it:** Industrial-grade GPT-Image2 prompt engine with 530+ reverse-engineered cases and reusable skills.
...
- **Tags:** `agent-workspaces`, `no-code`, `multi-platform`
...
- **Tags:** `agent-os`, `self-evolving`, `loop-engineering`
- **Why use it:** Agent OS where the agent gets smarter on its own through self-evaluation
...
- **Tags:** `agent-collaboration`, `multi-agent`, `enterprise`
- **Why use it:** Enterprise-grade local-first multi-agent workbench for teams
...
- **Tags:** `workflow`, `productivity`, `browser-extension`
- **Why use it:** Turn AI conversations into organized reusable workflows.
...
- **Why use it:** Creative writing skills for novels and short dramas
...
- **Tags:** `agent-skills`, `execution`, `multi-agent`
- **Why use it:** Turn experience into repeatable execution skills for agents
...
- **Why use it:** Adds multimodal vision for screenshots/UI/chart analysis
...
- **Tags:** `plugin-discovery`, `automation`, `skills`
- **Why use it:** Auto-searches, installs, and verifies GitHub plugins
...
- **Why use it:** Specialized agent skills for AI infra development and debugging
...
- **Tags:** `task-management`, `sqlite`, `ui`
...
- **Tags:** `agent`, `workflow`
- **Why use it:** Agent workflow plugin for automating DSH agent processes
...
- **Why use it:** TDD, debugging, and planning skills adapted for DSH agents
...
- **Why use it:** AI coding mentor skill: architecture scan, step-by-step chapters, code review
...
- **Tags:** `agent-skills`, `deep-research`, `fact-checking`, `market-research`
- **Why use it:** 88 open-source skills for research, social intel, marketing & business workflows
...
- **Tags:** `spec-programming`, `vibe-coding`, `developer-tools`, `ai-coding`
- **Why use it:** Repository-native spec-driven development skill aligned with DSH engineering patterns
...
- **Tags:** `agent-handoff`, `session-memory`, `skills`
- **Why use it:** Cross-platform agent continuity memory for Codex and Claude Code
...
- **Why use it:** Fusion skill pack: Bazi, Fengshui, IChing with local deterministic engine
...
- **Tags:** `skill-picker`, `ux`, `composer`
- **Why use it:** WorkBuddy-style skill picker for quick /skill-name insertion in composer
...
- **Why use it:** Adapted code simplification skill from DeepSeek Harness for Codex
...
- **Why use it:** Multi-agent team collaboration with independent models and shared workspace
...
- **Tags:** `skills`, `manager`, `dsh`
- **Why use it:** Dedicated skills management plugin for DeepSeek Harness
...
- **Tags:** `agent-skills`, `package-manager`, `eval-driven-dev`
- **Why use it:** Package manager with 42 skills for AI agent engineering
...
- **Why use it:** Complete Chinese official document workflow following GB/T 9704
...
- **Tags:** `swift-cycle`, `governance`, `offline`
- **Why use it:** Version-pinned, offline-verifiable Swift Cycle governance skill
...
- **Tags:** `skills`, `gamification`, `mission-system`
- **Why use it:** Game-like mission system with fog-of-war map and task bar
...
- **Tags:** `practices`, `engineering`, `discipline`
- **Why use it:** Engineering discipline distilled from DSH实践经验总结
...
- **Why use it:** Streamlines DSH plugin development and testing via built-in agent skills
...
- **Why use it:** Full-stack Godot 4.x game dev skills registered at runtime for DSH
...
- **Tags:** `skill-learning`, `agent-skills`, `automation`
...
- **Why use it:** Virtual product team agent preset (PM→Eng→QA)
...
- **Tags:** `mcp-server`, `dsh-plugin`, `self-hosted`
...
- **Tags:** `mcp`, `skill`, `ui`
- **Why use it:** Web UI panel for managing skills and MCP connections in DSH
...
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH with live sync
...
- **Tags:** `mcp`, `zhihu`, `deepseek-harness`
- **Why use it:** MCP-enabled Zhihu search and Zhida Q&A integration for DSH agents
...
- **Why use it:** Hot-reload MCP server config and skill management without restarts
...
- **Why use it:** Self-contained HTML diagrams with motion for architecture and workflows
...
- **Tags:** `design-as-code`, `vibedesign`, `ui`, `flutter`
...
- **Why use it:** Powerful vision toolkit: OCR, image Q&A for text-only models.
...
- **Why use it:** AI design studio with visual editor and PPT generation.
...
- **Tags:** `ui`, `visual`, `dsh-plugin`
- **Why use it:** Renders interactive charts, forms, and quizzes directly in assistant replies.
...
- **Why use it:** Generate AI images directly within DeepSeek Harness chats
...
- **Tags:** `design`, `ppt`, `ui-design`, `openpencil`
- **Why use it:** Preview, inspect and edit OpenPencil .op design documents
...
- **Tags:** `legal`, `visualization`, `timeline`, `diagram`
- **Why use it:** Legal litigation visualization: timeline diagrams and case material rendering
...
- **Tags:** `design`, `ui`, `style`, `vibe-coding`
- **Why use it:** 6 design style presets to keep AI-coded sites away from generic AI look
...
- **Tags:** `video`, `image`, `storyboard`
- **Why use it:** AI video/image/audio generation with configurable model tools
...
- **Why use it:** Browser extension enhancement suite for Gemini, Claude, ChatGPT with prompt management.
...
- **Why use it:** Bind ChatGPT account via OAuth to chat in DSH
...
- **Tags:** `image`, `electron-app`, `dsh-plugin`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services, integrates with Obsidian/VS Code.
...
- **Tags:** `routing`, `harness-engineering`, `injector`
- **Why use it:** Runtime injector with task-aware reasoning-mode router preset
...
- **Tags:** `preset`, `dsh-plugin`, `standard-tools`
...
- **Why use it:** First vision plugin bridging image-to-text for any text-only coding agent
...
- **Why use it:** Unified virtual filesystem enabling cross-language agent tool access
...
- **Tags:** `claude-code`, `deepseek-harness`, `workflow`
- **Why use it:** One-click install and model switch across 9+ AI coding tools
...
- **Tags:** `oauth`, `infrastructure`, `llm-provider`
...
- **Tags:** `search`, `web-fetch`, `utility`
- **Why use it:** Strongest free web search bridge for models lacking native web access. No signup.
...
- **Tags:** `compatibility`, `migration`, `integration`
- **Why use it:** Bridges Pi and DSH ecosystems via one ABI compatibility layer
...
- **Tags:** `marketplace`, `plugin`, `ui`
- **Why use it:** Browse, install and update all DSH plugins directly from web GUI
...
- **Tags:** `backup`, `crash-recovery`, `windows`
- **Why use it:** Crash-rescue plugin with undo, snapshots, and SAFE MODE for DSH
...
- **Tags:** `marketplace`, `ui`, `web`
- **Why use it:** Community plugin marketplace browser for DSH web GUI
...
- **Tags:** `plugin-management`, `ui`, `console`, `dsh-repository-plugin`
- **Why use it:** Plugin management console + official dev skill guide, zero patch required
...
- **Why use it:** Image-to-text for vision-disabled models: OCR, pixel scanning, sampled reading tools
...
- **Tags:** `knowledge-base`, `plugin-development`, `scaffold`, `dsh-plugin`
- **Why use it:** On-demand plugin dev knowledge base with official docs archive in EN/ZH
...
- **Tags:** `config`, `backup`, `migration`, `webdav`
...
- **Why use it:** Audit AGENTS.md tokens, detect duplicates/conflicts with web UI panel
...
- **Why use it:** Curated plugin list for ecosystem discovery and learning
...
- **Why use it:** Public GitHub directory for plugin discovery and install
...
- **Why use it:** Real-time token usage charts, cost estimates and API balance tracking
...
- **Why use it:** Resolves plugin and version conflicts in DSH
...
- **Why use it:** Search npm and curated lists for plugin discovery
...
- **Tags:** `publisher`, `utility`, `workflow`
- **Why use it:** One-click plugin publisher with validation & docs
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `themes`
- **Why use it:** Public gallery of animated pets to personalize your coding agent
...
- **Why use it:** Beautiful frosted glass theme with full customization. No source modifications needed.
...
- **Tags:** `theme`, `threejs`, `webgpu`, `ocean-skin`
- **Why use it:** Stunning WebGPU ocean-themed visual skin for DSH
...
- **Why use it:** 34 opencode themes with one-click switch and no config loss
...
- **Tags:** `deepseek-harness`, `webui`, `theme`
- **Why use it:** Customizable web UI backgrounds with presets
...
- **Why use it:** Comprehensive AI resource library and Vibe Coding tutorials covering DeepSeek/GPT/Gemini.
...
- **Why use it:** Search 65,600+ API docs across 20 major Chinese platforms instantly
...
- **Tags:** `kline`, `finance`, `analysis`, `chart`
...
- **Tags:** `evaluation`, `benchmark`, `RAG-evaluation`
...
- **Tags:** `awesome`, `deepseek-harness`, `finance`, `quant`, `stock`
- **Why use it:** Curated stock/finance/quant plugins for DSH
...
- **Tags:** `awesome-list`, `dsh-repository`
- **Why use it:** Plugin directory with ecosystem analytics
...
- **Why use it:** Auto-crawled bilingual plugin directory daily
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** Chinese-focused DSH plugin collection
...
- **Why use it:** Evidence-led reviewed plugin directory
...
- **Tags:** `awesome-list`, `typescript`, `curated`
- **Why use it:** Comprehensive curated plugins for models, tools, UI
...
- **Why use it:** Industry-specific plugin directory (finance, legal, etc.)
...
- **Why use it:** Largest collection: 1000+ tools by star ranking
...
- **Why use it:** Open-source AI + no-code platform for fast business system development with CRUD/ERP support.
...
- **Why use it:** Curated plugin list for discovering best DSH ecosystem tools
...
- **Why use it:** J-Space Cognition Suite V3.7 - AI cognitive-enhancement Skills based on Anthropi
...
- **Why use it:** VibeSkills is a general-purpose Skill that automatically routes local Skills and
...
- **Why use it:** 竹知了 —— 一转就哇哇叫的传统玩具，Web 模拟版。零依赖单文件，真实录音采样，移动端优先。
...
- **Why use it:** BitFun combines a high-performance agent runtime written in Rust with a polished
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** Whale Girl skin series for DeepSeek Harness. 适用于 DeepSeek Harness 的，鲸鱼娘系列皮肤。
...
- **Why use it:** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析后生成有据可查的研
...
- **Why use it:** Turn one topic into a finished Vox-style paper-collage explainer/ad video — auto
...
- **Why use it:** AI code reviews grounded in 12 classic engineering books — decay risk diagnostic
...
- **Tags:** `plugin-registry`, `awesome-list`, `curated`
- **Why use it:** Curated plugin registry with real installation testing and Top 50 picks.
...
- **Tags:** `awesome-list`, `ecosystem`, `registry`
- **Why use it:** Curated plugin ecosystem list covering all DSH categories.
...
- **Why use it:** Comprehensive curated list of plugins, tools and infrastructure.
...
- **Why use it:** Curated bilingual plugin list covering extensions, tools, skills, and integrations.
...
- **⭐ Stars:** 274
- **Language:** JavaScript
- **Description:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件��快被发现。
- **Tags:** `awesome-list`, `discovery`, `plugin-market`
- **Why use it:** Daily-scraped plugin discovery with scenario classification and popularity rankings.
...
- **Tags:** `learning`, `documentation`, `marketplace`
- **Why use it:** DSH learning resource and plugin marketplace guide with best practices.
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, resources, and toolkit.
...
- **Why use it:** Curated comprehensive plugin directory for DSH ecosystem
...
- **Why use it:** Plugin marketplace and bundle hub for DeepSeek Harness
...
- **Why use it:** Anime search plugin with Bangumi ratings and magnet links
...
- **Tags:** `awesome-list`, `directory`
- **Why use it:** Curated awesome list of DSH community plugins and resources
...
- **Why use it:** Curated DSH plugin & resource meta-list
...
- **Tags:** `awesome-dsh-plugin`, `plugin-marketplace`, `awesome-list`
...
- **Tags:** `community`, `photo`, `oauth`, `beta`
- **Why use it:** DSH beta closing group photo wall with GitHub OAuth polaroid station
...
- **Why use it:** Curated DSH plugin directory with verified and permission-aware guidance
...
- **Tags:** `registry`, `open-data`, `plugins`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `plugins`
- **Why use it:** Star-ranked verified DSH community plugins
...
- **Why use it:** Plugin manual and navigation by use case
...
- **Why use it:** Static portal to discover and install DSH plugins
...
- **Why use it:** Redirect to new repo location
...
- **Tags:** `dsh-plugin-market`, `plugin-bundle`
- **Why use it:** Plugin marketplace for DeepSeek Harness

...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 868,221 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 03:20:32 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,678 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,513 | Open-source Claude/Figma-like design tool with loc |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,411 | Deploy multi-agent swarms and coordinate autonomou |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 11 plugins
...
- [Coding Agents & Harness Tools](coding-agents-harness-tools) (11)
...
- **Why use it:** Native terminal AI coding agent with prefix-cache stability
...
- **Why use it:** First vision plugin for text-only agents — paste image, get structured JSON
...
- **Tags:** `coding-agent`, `runtime`, `desktop`
...
- **Tags:** `code-review`, `quality`, `agent-tool`
...
- **Tags:** `coding-agents`, `architecture`, `deepseek-harness`
- **Why use it:** Architecture-aware coding agent with baseline-first drift detection
...
- **Why use it:** Security audit tool for AI-generated code vulnerability detection
...
- **Why use it:** Standard guide for developing DSH plugins — slots, tools, adapters and packaging
...
- **Why use it:** Repository-native spec-driven development workflow for coding agents
...
- **Tags:** `codex`, `mcp`, `sync`, `coding-agent`
...
- **Tags:** `multi-agent`, `team-collaboration`, `coding-agent`
- **Why use it:** Multi-agent team with shared workspace, independent models and skills
...
- **Tags:** `figma-alternative`, `ui-generator`, `desktop-app`
- **Why use it:** Open-source Claude/Figma-like design tool with local-first desktop app
...
- **Tags:** `desktop`, `dsh-plugin`, `modern`
- **Why use it:** Modern desktop client for DSH plugin ecosystem with plugin-based architecture
...
- **Tags:** `browser-extension`, `chat-management`, `multi-platform`
- **Why use it:** Cross-browser AI enhancement suite with unified prompt management
...
- **Tags:** `dsh-web`, `marketplace`, `plugin-store`
- **Why use it:** Web-based DSH plugin marketplace and creative workshop distribution
...
- **⭐ Stars:** 2,915
- **Language:** TypeScript
- **Description:** 开放的侧边栏底座，支持三方拓展注册新���边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
- **Tags:** `ui`, `sidebar`, `extension`
- **Why use it:** Extensible sidebar with built-in file editor, terminal, chat, and Git
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, and rollback
...
- **Why use it:** Lightweight Tauri desktop client, 5MB installer, cross-platform
...
- **Tags:** `desktop`, `mcp`, `deepseek-harness`
- **Why use it:** Desktop companion with animated pets and plugin SDK for coding agents
...
- **Tags:** `widget`, `desktop`, `deepseek-harness`
...
- **Tags:** `desktop`, `agent`, `multi-model`
...
- **Why use it:** Open-source Electron desktop GUI with SSH and remote access
...
- **Tags:** `notes`, `smartisan`, `multi-tenant`
- **Why use it:** Smartisan-style notes with multi-tenant support
...
- **Why use it:** OCR and pixel-art image reading for text-only LLM models in DSH
...
- **Why use it:** Cross-platform desktop integrating DB, SSH, Docker, and AI assistant in one window.
...
- **Why use it:** Electron-based desktop wrapper for DSH with sidebar, ModLens, and plugin integrations.
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览��端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `webui`, `background`, `personalization`
- **Why use it:** Personalizable web background with preset atmospheres
...
- **Why use it:** Self-evolving context database unifying memory, RAG and agent skills
...
- **Why use it:** LLM knowledge platform with RAG, autonomous reasoning and self-maintaining wiki
...
- **Tags:** `long-term-memory`, `self-evolving`, `rag`
...
- **Why use it:** Essential memory management kit with RAG for agent persistence
...
- **Tags:** `memory`, `rag`, `deepseek-harness`
- **Why use it:** Unlimited long-term memory layer for OpenClaw/DSH agents
...
- **Tags:** `vector-search`, `embeddings`, `agent-memory`
- **Why use it:** Transforms SKILL.md files into retrieval-ready agent corpora
...
- **Why use it:** Deploy multi-agent swarms and coordinate autonomous AI workflows
...
- **Why use it:** Super AI assistant with task planning, self-evolving memory and knowledge
...
- **Why use it:** Distill expert thinking patterns into reusable skills for any agent
...
- **Why use it:** Complete beginner tutorial for harness engineering, 0 to 1 guide
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `multi-device`
- **Why use it:** Unified agent workspace and task board accessible across all devices
...
- **Why use it:** Self-improving agent OS with continuous loop engineering and evaluation
...
- **Tags:** `enterprise-agent`, `multi-agent-workspace`, `visual-editor`
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `workflow`
...
- **Tags:** `agent-skills`, `workflow-automation`, `orchestration`
- **Why use it:** Intelligent workflow orchestrator with automatic skill routing
...
- **Tags:** `agent-teams`, `workflow`, `deepseek-harness`
- **Why use it:** Multi-agent team orchestration plugin for DeepSeek Harness
...
- **Tags:** `workflow`, `ai-assistant`, `productivity`
- **Why use it:** Turns AI conversations into reusable workflows across major platforms
...
- **Why use it:** Orchestrates multiple coding agents into a collaborative team
...
- **Why use it:** Free no-signup web search bridge for models without native access
...
- **Tags:** `agent-skill`, `math-modeling`, `workflow`
...
- **Why use it:** Adds multimodal vision to text-only LLM-based coding agents
...
- **Why use it:** Skill that searches, installs, and verifies DSH plugins
...
- **⭐ Stars:** 163
- **Language:** TypeScript
- **Description:** DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评分与详情，支持���制磁力。
- **Tags:** `anime-search`, `bangumi`, `torrent`
- **Why use it:** Multi-source anime search with Bangumi ratings
...
- **Why use it:** Specialized skills for AI infra dev and debugging
...
- **Why use it:** Native SQLite-backed task management with agent claim
...
- **Why use it:** Structured agent workflow orchestration
...
- **Tags:** `reasonix`, `skills`, `coding-agent`
- **Why use it:** Superpowers skill port optimized for Reasonix
...
- **Why use it:** TDD, debugging and planning skills adapted from proven superpowers framework
...
- **Why use it:** Comprehensive 85-skill module for reverse engineering and security research
...
- **Tags:** `agent-skills`, `mentor`, `code-review`
- **Why use it:** AI coding mentor that generates learning paths and performs code review
...
- **Why use it:** 88 cross-platform agent skills for research, marketing and business workflows
...
- **Tags:** `ai-agent`, `chinese-wisdom`, `dashboard`
- **Why use it:** Local deterministic engine for Bazi/Fengshui/I Ching analysis with dashboard
...
- **Tags:** `skill-picker`, `dsh-plugin`, `composer`
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer workflow
...
- **Why use it:** Adapted code simplification skill from DSH for Codex workflow integration
...
- **Why use it:** Version-pinned governance skill adapter with offline verification support
...
- **Why use it:** Enables infinite canvas with agentic creative skills in DSH.
...
- **Tags:** `agent-skill`, `best-practices`
- **Why use it:** Portable agent skill encoding engineering discipline and evidence-based workflows.
...
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH agents, covering GDScript and engine.
...
- **Why use it:** Virtual product team preset for guided dev workflows
...
- **Tags:** `mcp`, `capability-management`, `dsh-plugin`
- **Why use it:** Centralized control panel for MCP tool exposure and skill execution modes
...
- **Tags:** `context-audit`, `mcp`, `ui-tool`
- **Why use it:** Context injection audit with token cost stats and conflict detection UI
...
- **Why use it:** Beautiful architecture & workflow diagrams from code, with motion effects
...
- **Tags:** `vibecoding`, `design-as-code`, `ui`
...
- **Tags:** `design`, `ppt`, `deepseek-harness`
- **Why use it:** AI-generated design system with visual editor and PPT studio for DSH
...
- **Tags:** `ui`, `interactive`, `components`
...
- **Tags:** `image-generation`, `multimodal`, `ai-agent`
- **Why use it:** Generate images directly within DSH chat conversations
...
- **Tags:** `openpencil`, `ui-design`, `design`
- **Why use it:** Preview and edit .op design docs in-chat
...
- **Why use it:** Generate litigation timelines and diagrams directly from case materials
...
- **Why use it:** Real-time token usage and cost visualization for DSH via web plugin.
...
- **Why use it:** Bind ChatGPT via OAuth for model access inside DSH
...
- **Why use it:** Turns DingTalk chats into tool-capable agent sessions
...
- **Tags:** `low-code`, `crm`, `erp`, `workflows`
- **Why use it:** Open-source AI+no-code platform for fast business system development
...
- **Why use it:** Two-phase DSH preset for minimal bootstrap to full standard tooling
...
- **Tags:** `virtual-filesystem`, `vfs`, `agent-tools`
- **Why use it:** First unified virtual filesystem abstracting storage for AI agents
...
- **Tags:** `installation`, `multi-agent`, `utility`
- **Why use it:** One-click multi-agent installation and model switching hub
...
- **Tags:** `utility`, `toy`, `lightweight`
- **Why use it:** Zero-dependency web simulation of a traditional Chinese toy
...
- **Tags:** `context`, `utility`, `deepseek-harness`
- **Why use it:** Context insight dashboard and management for DeepSeek Harness
...
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image Q&A, screenshot UI restoration
...
- **Why use it:** Tracks session costs, budgets, and token usage in DSH
...
- **Why use it:** Bridges Pi extensions as native DSH plugins seamlessly
...
- **Tags:** `marketplace`, `plugin-manager`, `web-gui`
...
- **Why use it:** Crash rescue with undo and safe-mode snapshots
...
- **Why use it:** Web UI for managing skills and MCP integrations
...
- **Tags:** `market`, `community`, `web-gui`
- **Why use it:** Community plugin market integrated in DSH web GUI
...
- **Why use it:** Plugin registry console with browser management and development guide
...
- **Tags:** `api-documentation`, `chinese-api`, `tools`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in your coding agent
...
- **Tags:** `plugin-management`, `utilities`, `skills`
...
- **Why use it:** Official docs archive for DSH plugin development, bilingual EN/ZH support
...
- **Tags:** `dsh`, `container`, `plugin-manager`
- **Why use it:** Run multiple DSH versions in isolated containers, easy plugin import
...
- **Tags:** `awesome-list`, `plugin-curator`, `dsh-plugins`
...
- **Tags:** `best-practices`, `dsh-plugin`, `skill`
- **Why use it:** Practical DSH plugin dev troubleshooting guide with real-world fixes.
...
- **Tags:** `migration`, `import`, `mcp`
- **Why use it:** Seamlessly migrate Claude Code setups into DSH with skills, hooks, and MCP config.
...
- **Tags:** `dsh-plugin`, `development`, `testing`
- **Why use it:** Build and test DSH plugins end-to-end with scaffolding and tiered testing skills.
...
- **Why use it:** Fast, elegant Neovim plugin manager for streamlined editor workflows.
...
- **Tags:** `diagnostics`, `conflict-resolution`, `utilities`
...
- **Tags:** `agent-tools`, `utility`, `pre-flight`
- **Why use it:** Pre-flight plugin check boosts agent plugin utilization predictability

---

### [f20880479-lab/dsh-peak-gate](https://github.com/f20880479-lab/dsh-peak-gate)

- **⭐ Stars:** 3
- **Language:** JavaScript
- **Description:** deep seek harness插件，可以将高峰时段的工作延迟到空闲时段再工作
- **Tags:** `utility`, `peak-pricing`, `scheduling`
- **Why use it:** Defer peak-hour work to idle periods for cost efficiency
...
- **Why use it:** Search and discover DSH plugins from within agents
...
- **Why use it:** AI-curated list with 190+ plugins in 12 categories
...
- **Tags:** `awesome-list`, `ui`, `coding-agents`
- **Why use it:** Install and customize models, tools, sandboxes, UI
...
- **Why use it:** Public gallery of animated pet companions for various coding agents
...
- **Why use it:** Stunning WebGPU-powered ocean-themed visual skin for DSH
...
- **Tags:** `rag`, `vibe-coding`, `tutorials`
- **Why use it:** Comprehensive AI resource hub with tutorials for DeepSeek, GPT, Gemini, Claude
...
- **Tags:** `prompt-engineering`, `skills`, `image-generation`
- **Why use it:** Industrial-grade prompt engineering library with 530+ reverse-engineered cases
...
- **Why use it:** Curated plugin discovery list for DeepSeek Harness ecosystem
...
- **Why use it:** Auto-searches 8 major Chinese platforms for comprehensive research reports
...
- **Tags:** `awesome-list`, `directory`, `curated`
- **Why use it:** Curated bilingual plugin directory with verified references
...
- **Tags:** `discovery`, `curation`, `awesome-list`
- **Why use it:** Daily curated plugin discovery with scenario-based categorization
...
- **Tags:** `encyclopedia`, `resources`, `ai-guide`
...
- **Why use it:** Learn DSH principles, marketplace guide and best practices
...
- **Why use it:** Curated catalog of DSH plugins, MCP servers, skills & patches
...
- **Tags:** `kline`, `financial-analysis`, `technical-indicators`
...
- **Tags:** `awesome-list`, `curated`, `directory`
- **Why use it:** Curated list of DSH plugins for discovery and ecosystem exploration.
...
- **Why use it:** Unofficial community catalog for broad DSH plugin discovery.
...
- **Why use it:** Quality-checked curated plugin list for 2026 DSH ecosystem.
...
- **Why use it:** Plugin radar with evidence-backed curation
...
- **Why use it:** Curated resources covering plugins, tools, skills
...
- **Why use it:** Moved to mainawesome-dsh-plugin registry
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** Basic DSH plugin collection
...
- **Why use it:** Evidence-aware shortlist of useful plugins
...
- **Tags:** `industry`, `awesome-list`, `specialized`
- **Why use it:** Industry-specific plugins for finance, law, healthcare
...
- **Why use it:** Comprehensive curated plugin registry with auto-updating index
...
- **Why use it:** Curated plugin ecosystem list covering DSH web UI and CLI tools
...
- **Tags:** `awesome-list`, `plugin-registry`, `deepseek-harness`
- **Why use it:** Comprehensive DSH ecosystem index from dsh-external hub and public plugins
...
- **Tags:** `jailbreak`, `armor-breaking`
- **Why use it:** Armor-breaking jailbreak plugin for DeepSeek models
...
- **Why use it:** Comprehensive starter guide and resource catalog for DSH
...
- **Why use it:** Plugin marketplace hub with 3100+ searchable DSH plugins
...
- **Tags:** `plugin-marketplace`, `catalog`
- **Why use it:** DSH plugin marketplace and collection hub
...
- **Why use it:** Curated plugin list great for discovering DSH ecosystem resources
...
- **Why use it:** Community plugin marketplace with auto-sync every 4 hours
...
- **Why use it:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准
...
- **Why use it:** 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the 
...
- **Why use it:** Bottom Info Bar — an information bar plu
...
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`, `mcp`, `zhihu`
- **Why use it:** DeepSeek Harness plugin, Skill, CLI and 
...
- **Why use it:** Portable Agent Skill for developing and 
...
- **Why use it:** 改配置+重启才能加 MCP？DeepSeek Harness (DSH) 插件「
...
- **Why use it:** Reusable Codex skill for building and va
...
- **Tags:** `awesome-list`, `curated`, `directory`
- **Why use it:** Evidence-led curated DSH plugin directory with install guidance
...
- **Why use it:** Chinese-language curated DSH plugin collection
...
- **Why use it:** Plugin manual and navigation guide by use case
...
- **Why use it:** General DSH plugin repository and verification list
...
- **Why use it:** Automatically crawled bilingual plugin directory via GitHub Actions
...
- **Tags:** `awesome-list`, `bilingual`, `verified`
- **Why use it:** Evidence-led bilingual plugin directory at immutable commits

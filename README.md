...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 845,669 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 07:09:04 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 189,510 | Core plugin harness enabling everything as plugins |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,858 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,172 | Deploy multi-agent swarms and autonomous workflows |
...
- **Why use it:** Core plugin harness enabling everything as plugins
...
- **Tags:** `coding-agent`, `tui`, `terminal`
- **Why use it:** Terminal-native AI coding agent with prefix caching
...
- **Why use it:** Best beginner tutorial for learning harness engineering from scratch
...
- **Tags:** `routing`, `cordis`, `dsh-plugin`, `agent-orchestration`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for optimized agent routing
...
- **Tags:** `agent-os`, `loop-engineering`, `mcp`, `llm-orchestration`
- **Why use it:** Self-improving Agent OS that gets smarter over time with loop engineering
...
- **Why use it:** Enterprise multi-engine agent workbench with visual editor for Codex and DSH
...
- **Tags:** `preset`, `dsh-plugin`, `standard-tools`, `llm-agent`
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tools (Project2 98/99)
...
- **Why use it:** Unified one-click install and model switching for multiple AI coding tools.
...
- **Tags:** `coding-agents`, `architecture`, `agent-skills`
- **Why use it:** Makes coding agents architecture-aware with evidence verification
...
- **Tags:** `vision`, `multimodal`, `coding-agent`
- **Why use it:** Adds multimodal vision to text-only LLM coding agents
...
- **⭐ Stars:** 39
- **Language:** Unknown
- **Description:** An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插��/服务/事件/工具/LLM 适配器/打包安装的标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any compatible agent.
- **Tags:** `agent-skill`, `plugin-development`, `dsh-plugin`
- **Why use it:** Build DSH plugins with standard slot/event/tool/adapter patterns
...
- **Why use it:** OCR and image-to-text skill trained on 34 images for text-only models
...
- **Tags:** `dsh-plugin`, `plugin-management`, `agent-skill`
- **Why use it:** Manage installed DSH plugins, slots and credentials via agent skill
...
- **Why use it:** Official DSH plugin dev knowledge base with EN/ZH docs and scaffold
...
- **Tags:** `agent-framework`, `dsh-plugin`, `cli`
- **Why use it:** Package manager with 42 skills, 5 CLIs for AI agent engineering workflows
...
- **Why use it:** Practical DSH dev troubleshooting guide and best practices
...
- **Tags:** `agent-tools`, `pre-flight`, `capability-index`
...
- **Why use it:** CLI tool for discovering, installing, updating and managing DSH plugins with multi-source search
...
- **Tags:** `dsh-web`, `web-ui`, `theme`, `desktop`
- **Why use it:** Web GUI, task boards, remote SSH ops, and WebGL-optimized themes for DSH
...
- **Why use it:** Claude Code-style TUI with whale bar, real-time status, streaming thoughts, and rollback.
...
- **Why use it:** Cute floating whale widget displaying DeepSeek account balance
...
- **Why use it:** Local-first desktop workspace integrating files, research and office
...
- **Tags:** `gui`, `components`, `interactive`
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes in replies.
...
- **Tags:** `desktop-app`, `client`, `cross-platform`
- **Why use it:** CodePilot-inspired desktop client with cross-platform plugin support.
...
- **Tags:** `marketplace`, `dsh-plugin`, `javascript`
- **Why use it:** One-click browse and install all dsh-plugins from GitHub in Web GUI
...
- **Tags:** `market`, `ui`, `web`
- **Why use it:** Community plugin market in DSH Web GUI with one-click install/uninstall
...
- **Why use it:** Desktop Electron console for managing Harness, plugins, MCP and Skills
...
- **Tags:** `balance`, `usage-tracking`, `dsh-plugin`
- **Why use it:** Persistent bottom bar showing provider, model, and pricing
...
- **Why use it:** Floating HUD panel showing git, MCP, skills, model, and tokens.
...
- **Why use it:** Electron desktop wrapper with integrated DSH web services and plugins
...
- **Why use it:** LLM knowledge platform turning docs into queryable RAG
...
- **Why use it:** Local-first portable memory layer, Markdown-native and user-owned across apps
...
- **Tags:** `agentic-workflow`, `multi-agent`, `swarm`
...
- **Tags:** `ai-agent`, `skills`, `mcp`
- **Why use it:** Self-evolving AI assistant with memory and knowledge
...
- **Why use it:** Distill agent thinking patterns into reusable skills
...
- **Tags:** `gpt-image-2`, `prompt-engineering`, `skills`, `workflow-automation`
- **Why use it:** 470+ reverse-engineered prompts with 20+ industrial templates and reusable skills
...
- **Why use it:** Intelligent workflow orchestrator that automatically routes and manages local Skills.
...
- **Why use it:** End-to-end automated Vox-style paper-collage explainer video generation via agent skill.
...
- **Why use it:** Enables text-only LLMs to understand images and automate UI
...
- **Why use it:** Human-in-the-loop task manager with real-time web and mobile control
...
- **Why use it:** Multi-agent team orchestration plugin for DSH
...
- **Tags:** `vision`, `gui-automation`, `ocr`
- **Why use it:** Native DSH vision toolkit for image Q&A and UI restoration
...
- **Tags:** `agent`, `desktop-app`, `multi-model`
- **Why use it:** Local-first multi-model AI agent with self-evolving skills and privacy focus.
...
- **Why use it:** Live iOS Simulator and iPhone control inside DSH with 22 agent tools.
...
- **Why use it:** Turn experience into repeatable AI agent workflows
...
- **Why use it:** Auto-search, install and verify DSH plugins via skill
...
- **Why use it:** Novel writing and short-drama production assistant
...
- **Why use it:** Specialized skills for AI infra dev, debugging and optimization
...
- **Tags:** `agent-skills`, `skills`, `retrieval`
- **Why use it:** Curates SKILL.md files into searchable agent-skill corpora with retrieval
...
- **Tags:** `multimodal`, `orchestration`, `subagent`
...
- **Tags:** `skills`, `reasonix`, `coding-agent`
...
- **⭐ Stars:** 65
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你��写核心逻辑、自动判题、AI Code Review。
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** AI mentor skill that guides coding through architecture analysis and review
...
- **Why use it:** 88 open-source skills for research, social intelligence and marketing
...
- **Tags:** `legal-tech`, `visualization`, `timeline`
- **Why use it:** Visualize legal cases into court-ready timelines and diagrams
...
- **Why use it:** Repository-native spec-driven development skill for DSH projects
...
- **Tags:** `agent-skills`, `session-memory`
- **Why use it:** Enables cross-session agent memory continuity between Codex and DSH
...
- **Why use it:** WorkBuddy-style skill picker simplifies skill insertion in composer
...
- **Tags:** `agent-skills`, `chinese-traditional-wisdom`
- **Why use it:** Comprehensive Bazi/Fengshui/I Ching AI agent skill with visual dashboard
...
- **Why use it:** Free image reading and generation skills with vision transcription for DSH
...
- **Why use it:** Version-pinned governance skill with offline verification
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Centralized tool exposure and execution mode management
...
- **Why use it:** Full workflow Chinese official document processing tool
...
- **Why use it:** Engineering discipline skill: fact-finding and evidence-based
...
- **Why use it:** Infinite canvas with agentic creative skills integration
...
- **Why use it:** Full-stack Godot 4.x game dev skill for DSH at runtime.
...
- **Tags:** `agent-skills`, `human-in-the-loop`, `local-first`
- **Why use it:** Local-first Run-to-Skill plugin with human-in-the-loop support.
...
- **Why use it:** Virtual product team agent preset simulating PM/QA workflows
...
- **Tags:** `design`, `ui`, `agent-team`, `vibedesign`, `mcp`
...
- **Why use it:** AI-powered design studio with templates, PPT creation, and visual editing.
...
- **Tags:** `design`, `ui-design`, `opendocument`
- **Why use it:** Preview and edit OpenPencil design docs inside chat
...
- **Why use it:** 6 design styles prevent AI-generic look for vibe-coded websites
...
- **Tags:** `ai-video`, `ai-image`, `directorx`, `dsh-plugin`
- **Why use it:** AI video/image/audio generation with configurable models
...
- **Why use it:** Enhancement suite for AI chat browsers with prompt manager
...
- **Tags:** `ai-agent`, `cross-platform`, `dsh-plugin`
- **Why use it:** Local-first cross-platform AI content discovery agent across B站, YouTube, Reddit etc.
...
- **Why use it:** Let AI agents use your real logged-in browser without interrupting your work flow.
...
- **Tags:** `browser-extension`, `chrome-extension`, `workflow`
- **Why use it:** Browser extension organizing AI conversations into reusable workflows
...
- **Why use it:** Tabbit Browser plugins for Playwright-based browser automation in DSH
...
- **Tags:** `dsh-plugin`, `social`
- **Why use it:** GitHub OAuth photo wall for DSH community内测收官合影
...
- **Tags:** `low-code`, `internal-tool`, `workflows`
- **Why use it:** AI-powered low-code platform for building business systems
...
- **Tags:** `vfs`, `virtual-filesystem`, `agent-tools`, `mcp`
- **Why use it:** First unified virtual filesystem abstraction for AI agents across environments
...
- **⭐ Stars:** 975
- **Language:** TypeScript
- **Description:** The best DeepSeek Harness plugin for context insight and management, with context dashboard / browser and context command, for context statistics, composition, breakdown, evolution details, understanding how the context is made of, and how it evolves. 一站式 DeepSeek Harness 上下文可视化插件，Context 面板及浏览���与 Context 命令，透视上下文组成、演进、压缩、剪枝等事件与动作。
- **Tags:** `context`, `dashboard`, `utility`
- **Why use it:** Context insight dashboard and management for DSH sessions
...
- **Tags:** `cost-tracking`, `token-usage`, `infrastructure`
- **Why use it:** Track session and daily LLM costs with budget alerts
...
- **Why use it:** Bridge Pi ecosystem extensions to run natively in DSH
...
- **Why use it:** Private note-taking app with Docker deployment and skill support
...
- **Tags:** `context-migration`, `preset-migration`, `session`
- **Why use it:** Cross-preset session migration with fixed-schema state handoffs
...
- **Why use it:** Crash recovery via undo, snapshot, and SAFE MODE even offline
...
- **Why use it:** Essential plugin management console with browser UI for DSH ecosystem
...
- **Why use it:** Containerized multi-version DSH manager with embedded WebView UI
...
- **⭐ Stars:** 19
- **Language:** TypeScript
- **Description:** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环���板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context-audit`, `utility`, `ui`
- **Why use it:** Audits context tokens, detects duplicates and conflicts with Web UI dashboard
...
- **Why use it:** Full backup/restore/migrate for DSH config, plugins, MCP and skills via WebDAV
...
- **Why use it:** Built-in GUI for managing MCP, skills, and plugins with hot reload.
...
- **Why use it:** Real-time token usage, cost estimates, and balance charts.
...
- **Tags:** `plugin-doctor`, `conflict-resolution`, `dsh-plugin`
- **Why use it:** Diagnoses and resolves plugin conflicts and version issues in DSH
...
- **Tags:** `pets`, `mascot`, `pixel-art`, `theme`
- **Why use it:** Public gallery of animated pixel-art pets for Codex, Claude, DSH and more
...
- **Why use it:** Whale Girl themed visual skin series for DeepSeek Harness desktop app.
...
- **Why use it:** Frosted glass theme with fully customizable blur and background.
...
- **Why use it:** Stunning WebGPU ocean-themed UI for DSH
...
- **Why use it:** 34 opencode themes one-click swap, persists after restart
...
- **Why use it:** Web background customization with presets and upload support.
...
- **Why use it:** Comprehensive AI resources and vibe coding tutorials
...
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days content, generates citable research reports.
...
- **Tags:** `awesome-list`, `resource`, `plugin-market`
...
- **Why use it:** Auto-scraped, human-verified plugin directory with eligibility recommendations.
...
- **Tags:** `encyclopedia`, `knowledge-base`, `resource`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MCP, and learning paths.
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, and toolkit resources.
...
- **Why use it:** Complete reverse engineering and pentest skillset for security researchers
...
- **Why use it:** Search 65,600+ Chinese API docs across 20 platforms instantly
...
- **Tags:** `awesome-deepseek-harness`, `dsh-plugin`, `dsh-plugin-market`
- **Why use it:** Interactive K-line analysis with multi-market and news support
...
- **Tags:** `plugin-directory`, `awesome-list`, `dsh`
...
- **Tags:** `awesome-list`, `verified`, `dsh-plugins`
- **Why use it:** Verified star-ranked community plugins for DeepSeek Harness
...
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for DSH
...
- **Tags:** `plugin-portal`, `static-site`, `awesome-dsh`
- **Why use it:** Static portal for browsing and filtering 227+ curated DSH plugins
...
- **Why use it:** Hourly AI-updated list of 190+ DSH plugins across 12 categories
...
- **Tags:** `dsh-plugins`, `plugin-verify`, `bundle`
- **Why use it:** DSH plugin bundle and repository with verification support
...
- **Why use it:** Curated starter list of all essential DSH plugins for quick discovery
...
- **Tags:** `fun`, `toy`, `dsh-plugin`
- **Why use it:** Web-simulated traditional Chinese toy with real audio sampling, mobile-first design.
...
- **Why use it:** Plugin radar and curated top-50 list with real installation path testing and auto updates.
...
- **Why use it:** Plugin marketplace with 3100+ entries and public API
...
- **Why use it:** Plugin marketplace and hub for DSH ecosystem
...
- **Tags:** `awesome`, `awesome-list`, `plugins`
- **Why use it:** Curated list of DSH plugins covering productivity and features
...
- **Tags:** `awesome-list`, `dsh-plugins`
- **Why use it:** Comprehensive curated directory of 280+ community DSH plugins
...
- **Why use it:** Curated plugin directory with verified extensions and guidance.
...
- **Why use it:** Repository moved; redirect reference only
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple DSH plugin catalog collection
...
- **Why use it:** Auto-generated daily crawl of dsh-plugin topic for plugin discovery
...
- **Tags:** `awesome-list`, `dsh-plugins`, `ui`
...
- **Tags:** `industry`, `dsh-plugin`
- **Why use it:** Industry-specific plugins for computing, finance, law, HR, manufacturing, healthcare, e-commerce
...
- **Why use it:** Unified plugin registry merging awesome list, GitHub topic, and npm keyword search
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ DSH repos sorted by stars, full ecosystem catalog

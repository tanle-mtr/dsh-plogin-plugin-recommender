...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,018,879 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 222,495 | Core DSH framework; everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,932 | Open-source design system with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,315 | Multi-agent swarm coordination and autonomous work |
...
- **Tags:** `dsh-routing`, `mcp`, `agent-harness`
- **Why use it:** Runtime injector with task-aware reasoning-mode router for DSH.
...
- **Tags:** `agent-collaboration`, `multi-agent`, `enterprise-agent`
- **Why use it:** Enterprise multi-agent workbench supporting multiple harness engines.
...
- **Why use it:** First vision plugin for DSH enabling image-to-JSON OCR for text-only agents
...
- **Why use it:** Two-phase preset with minimal bootstrap and full Standard tools integration
...
- **Tags:** `virtual-terminal`, `agent-sandbox`, `vfs`, `dsh-plugin`
- **Why use it:** Virtual terminal and filesystem sandbox for safe AI agent execution
...
- **Tags:** `agent-runtime`, `coding-agent`, `desktop`
- **Why use it:** High-performance Rust agent runtime with coding agent depth and polished desktop UX
...
- **Tags:** `vision`, `ocr`, `agent-tool`
- **Why use it:** Vision toolkit for text-only LLMs: image Q&A, OCR, and UI restoration in one line
...
- **Why use it:** Coding agent with RPC plugin, sub-agents, hashline edits, and MCP integration.
...
- **Tags:** `cli`, `plugin-manager`, `deepseek-harness`, `typescript`, `developer-tools`
- **Why use it:** Open-source CLI and resolver toolkit for managing the DSH Plugin Hub ecosystem.
...
- **Tags:** `provider`, `model-access`, `llm`
...
- **Tags:** `coding`, `superpowers`, `reasonix`
- **Why use it:** Superpowers skills adapted for Reasonix coding harness
...
- **Why use it:** TDD, debugging and planning skills from superpowers
...
- **Tags:** `plugin-creator`, `codex`, `harness-tools`
- **Why use it:** Build and validate DSH/Cordis plugins with a reusable Codex skill.
...
- **Why use it:** Codex skill to find and apply code simplifications directly in your workflow.
...
- **Tags:** `quality-gate`, `engineering`, `requirements`, `guard`
...
- **Why use it:** 11 testing skills with shared KB and decision matrix for AI agent QA engineering.
...
- **Tags:** `plugin-dev`, `skill`, `deepseek-harness`
- **Why use it:** End-to-end guide for building, testing, and installing DSH plugins
...
- **Tags:** `plugin-dev`, `agent-skill`, `deepseek-harness`
- **Why use it:** Agent skill for developing DSH plugins, services, and LLM adapters
...
- **Why use it:** Fast elegant Neovim plugin manager written in Lua for coding workflows
...
- **Why use it:** Pre-flight check that auto-injects Top-K applicable plugin hints for agents.
...
- **Why use it:** Extensible sidebar with built-in file editor, terminal, chat, Git, and sub-agent pages
...
- **Tags:** `taskboard`, `ui-extension`, `skills`, `dsh-plugin`
- **Why use it:** Modern flexible task board embeddable in Codex and DeepSeek Harness
...
- **Tags:** `tui`, `terminal`, `ui-extension`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with whale bar, streaming thoughts, and rollback support
...
- **Tags:** `widget`, `floating-ui`, `balance-tracker`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracking your DeepSeek account balance with animations
...
- **Why use it:** Zero-setup Tauri desktop app with preset plugins across Windows, macOS, and Linux
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, projects, and Office artifacts.
...
- **Tags:** `desktop`, `windows`, `gui`, `codex`, `ssh`
- **Why use it:** Zero-setup Windows desktop GUI client with Codex, SSH, mobile remote access, and plugin system.
...
- **Tags:** `canvas`, `branching`, `visualization`, `workspace`
- **Why use it:** Visual non-linear canvas-based session explorer with branching conversation workspace.
...
- **Why use it:** Local-first multi-model AI agent desktop app with self-evolving skills and multi-Harness support.
...
- **Tags:** `office`, `spreadsheet`, `docs`, `slides`, `deepseek-harness-plugin`
- **Why use it:** Integrates a full office suite—spreadsheets, docs, slides—directly into DeepSeek Harness.
...
- **⭐ Stars:** 289
- **Language:** Kotlin
- **Description:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将��作区、会话、实时回复和 Agent 执行轨迹带到 iPhone，同时延续 DeepSeek WebUI 克制、清晰的视觉语言
- **Tags:** `ios`, `ios-app`, `kotlin-multiplatform`, `mobile`, `deepseek-harness`
- **Why use it:** Native iOS client bringing DSH workspaces, sessions and real-time agent traces to your iPhone.
...
- **Tags:** `desktop-app`, `electron`, `codepilot`, `macos`, `linux`
- **Why use it:** CodePilot-inspired cross-platform desktop client and plugin suite for macOS, Windows and Linux.
...
- **Why use it:** Smartisan-style notes app with Docker deployment and DSH plugin support
...
- **Tags:** `ui`, `web`, `management`
- **Why use it:** Web UI panel for managing skills and MCPs
...
- **Why use it:** Electron-based desktop console for multi-tab Harness/Plugin/MCP/Skills management
...
- **Tags:** `ui`, `status-bar`, `billing`, `provider-info`
- **Why use it:** Persistent info bar showing provider, model, balance and pricing at a glance.
...
- **Tags:** `bioinformatics`, `desktop`, `clinical`, `tauri`
...
- **Why use it:** WorkBuddy-style skill picker that inserts /skill-name gestures into the composer.
...
- **Tags:** `kline`, `visualization`, `sidebar`
- **Why use it:** Interactive K-line analysis displayed directly in the native sidebar
...
- **Why use it:** All-in-one DevOps desktop: SSH, SFTP, Docker, DB client and AI tools
...
- **Tags:** `desktop`, `electron`, `dsh-integration`
- **Why use it:** Electron desktop wrapper integrating DSH web UI, sidebar and ModLens
...
- **Tags:** `ui`, `theme`, `background`, `webui`
- **Why use it:** Web background customization with custom images and preset themes
...
- **Tags:** `ui`, `compact`, `context-meter`, `dsh-plugin`
- **Why use it:** One-click compact button for DSH context meter panel to save space
...
- **Tags:** `knowledge-cards`, `ui`, `dsh-plugin`
...
- **Tags:** `long-term-memory`, `rag`, `memory-management`, `token-savings`
...
- **Tags:** `agent-memory`, `agentic-rag`, `context-engineering`
...
- **Tags:** `memory`, `rag`, `milvus`, `semantic-search`, `dsh-plugin`
...
- **Why use it:** Shared local memory hub giving all AI agents persistent context and recall
...
- **Why use it:** Multi-agent swarm coordination and autonomous workflows.
...
- **Tags:** `multi-agent`, `self-evolving`, `memory`
- **Why use it:** Self-evolving multi-agent system with memory and knowledge.
...
- **Tags:** `knowledge-distillation`, `meta-skill`, `ai-persona`
- **Why use it:** Distill expert thinking patterns into reusable AI skills.
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `no-code`, `tool-use`
...
- **Tags:** `agent-skills`, `skill-marketplace`, `dsh-plugin`
- **Why use it:** Largest skills marketplace with auto-collected GitHub skills by category.
...
- **Tags:** `agent-control-plane`, `long-horizon`, `workflow-automation`
...
- **Why use it:** Self-evolving Agent OS with evaluation-gated staged learning loops.
...
- **Tags:** `agent-skills`, `workflow`, `orchestration`, `dsh-plugin`
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `j-space`, `dsh-plugin`
...
- **Tags:** `video`, `skill`, `automation`
- **Why use it:** End-to-end Vox-style paper-collage video generation from a single topic prompt
...
- **Tags:** `agent-teams`, `multi-agent`, `orchestration`
- **Why use it:** Enable multi-agent team orchestration and collaboration within DeepSeek Harness
...
- **Tags:** `writing`, `creative`, `rag`
- **Why use it:** Organized creative writing workflow with RAG, character management, and review pipeline
...
- **Tags:** `agent-skills`, `skill-corpus`, `retrieval`, `evaluation`
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `computer-vision`
- **Why use it:** Gives agents eyes and ears — turns video, audio, and screen activity into searchable evidence.
...
- **Tags:** `novel-writing`, `creative-writing`, `agent-skills`, `drama-skills`, `fiction-writing`
- **Why use it:** Dedicated workflow plugin for novel, short-drama, game and video-recap AI writing.
...
- **Tags:** `task-management`, `taskboard`, `agent`, `sqlite`, `deepseek-harness`
- **Why use it:** Native SQLite-backed taskboard with agent claim/review and a clean Web UI—no iframes needed.
...
- **Tags:** `agent-skills`, `math-modeling`, `competition`, `gitops`, `claude-code`
- **Why use it:** Full-stack auto math modeling competition skill with GitOps pipeline and forced code self-verification.
...
- **Tags:** `skills`, `architecture`, `multi-agent`
...
- **Tags:** `finance`, `multi-agent`, `stock-analysis`
- **Why use it:** Tushare-based financial DB with multi-agent analysis and IM monitoring
...
- **Tags:** `agent-skills`, `research-automation`, `business`
...
- **Why use it:** Specialized skills for AI infra dev, enabling code write and debug workflows
...
- **Tags:** `ai-coding-agent`, `mentor`, `code-review`
- **Why use it:** AI coding mentor that generates step-by-step chapters and auto-reviews code
...
- **Tags:** `skills`, `engineering`, `deck`
- **Why use it:** 25 pre-installed engineering skills including triage, grilling, and wayfinder
...
- **Tags:** `gongwen`, `docx`, `legal-docs`, `wps`
- **Why use it:** Full workflow for official document processing per GB/T 9704 national standard
...
- **Tags:** `spec-driven`, `agent-skill`, `vibe-coding`
...
- **Why use it:** Installable plugin development knowledge base as on-demand agent skill
...
- **Why use it:** Fusion of Bazi, Fengshui, IChing and TCM into one local AI agent skill.
...
- **Tags:** `ocr`, `image-reading`, `vision`, `skill`
- **Why use it:** Enables text-only models to read images via OCR and pixel-scanning skills.
...
- **Tags:** `multi-agent`, `collaboration`, `team`, `mcp`
...
- **Tags:** `roleplay`, `narrative`, `18+`, `skill`
- **Why use it:** Rich 18+ interactive narrative skill with NPC memory, positions, and YAML存档。
...
- **Why use it:** Repository-local continuity memory for cross-platform agent handoff
...
- **Tags:** `math-modeling`, `multi-agent`, `deepseek-harness`
...
- **Tags:** `multi-agent`, `agent-team`, `deepseek-harness`
...
- **Why use it:** Cinematic product video agent with 152 shot recipes and Remotion templates
...
- **Why use it:** Free Xiaomi MiMo TTS integration for voice narration of DSH content
...
- **Why use it:** Beautiful architecture and sequence diagrams as code.
...
- **Why use it:** 530+ GPT Image prompts and 20+ industrial templates.
...
- **Tags:** `vibedesign`, `ui`, `flutter`, `react`
- **Why use it:** AI-native vector design tool with concurrent Agent Teams and UI generation.
...
- **Why use it:** AI-generated editable design system with template marketplace and native PPT studio
...
- **Tags:** `gui`, `ui-generation`, `charts`, `interactive`
- **Why use it:** Generates interactive inline UI components — layouts, charts, forms, and quizzes in replies.
...
- **Tags:** `visualization`, `legal`, `svg`, `timeline`
- **Why use it:** Transform messy litigation timelines into professional SVG diagrams
...
- **Tags:** `video`, `image`, `audio`, `directorx`, `ai-creative`
- **Why use it:** AI video/image/audio skills with configurable model tools and storyboard support.
...
- **Why use it:** 6 design aesthetic styles to avoid generic AI-generated look
...
- **Why use it:** Browser extension suite for Gemini, Claude, ChatGPT prompt management.
...
- **Tags:** `content-discovery`, `cross-platform`, `web-automation`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent spanning Bilibili, YouTube, Reddit, and more
...
- **Why use it:** Let AI agents control your logged-in browser seamlessly via CLI and extension
...
- **Tags:** `web-search`, `free`, `no-api-key`, `browser`
- **Why use it:** Strongest free web search plugin for DSH — no signup or API key required.
...
- **Tags:** `ios`, `ios-simulator`, `webdriveragent`, `mobile-automation`, `mcp`
- **Why use it:** Live iOS Simulator and USB iPhone control inside conversations with 22 agent automation tools.
...
- **Tags:** `browser-automation`, `anti-detect`, `mcp-server`
- **Why use it:** Persistent identity browser with fingerprint spoofing and Android emulation
...
- **Why use it:** Playwright-based browser automation plugins
...
- **Tags:** `plugin-portal`, `github-pages`, `static-site`
- **Why use it:** Zero-dependency static web portal for browsing and installing 227+ plugins.
...
- **Tags:** `pixel-art`, `sprites`, `cli`, `mascot`
- **Why use it:** Public gallery of animated pets enhancing CODing agent CLI UX.
...
- **Why use it:** One-click install and model switch across multiple coding agent platforms
...
- **Tags:** `plugin`, `discovery`, `ecosystem`
- **Why use it:** Self-deployable plugin radar discovering 15900+ candidates with k8s-level validation
...
- **Why use it:** Dashboard and sidebar for context insight, management, and status visualization
...
- **Why use it:** Curated ecosystem list of DSH plugins, tools, and infrastructure from public sources
...
- **Why use it:** Comprehensive curated plugin directory covering the full DeepSeek Harness ecosystem
...
- **Tags:** `security`, `audit`, `cybersecurity`, `redteam`
- **Why use it:** AI security platform auditing generated code for hallucinated packages and missing safeguards.
...
- **Tags:** `oauth`, `chatgpt`, `claude`, `llm`, `deepseek-harness`
- **Why use it:** Bridge ChatGPT/Claude/Grok subscriptions as DSH LLM providers via OAuth, no API keys needed.
...
- **Tags:** `cost-tracking`, `token-usage`, `deepseek-api`, `llm`, `deepseek-harness`
- **Why use it:** Track session and daily costs, budgets, history, and multi-provider balances at a glance.
...
- **Why use it:** Bridges Pi ecosystem to DSH via unified ABI, enables plugin migration
...
- **Tags:** `backup`, `sync`, `migration`
- **Why use it:** Backup, restore and sync complete DSH configurations
...
- **Tags:** `capabilities`, `menu`, `management`
...
- **Tags:** `plugin-management`, `infrastructure`, `registry`
- **Why use it:** Plugin ecosystem infrastructure with browser console and dev guidance skill
...
- **Why use it:** Unified local agent skills loader with safety management in DSH
...
- **Why use it:** Audits AGENTS.md instructions, skills and tools; detects duplicates and conflicts.
...
- **Tags:** `container`, `management`, `isolated`, `infra`
...
- **Tags:** `diagnostic`, `plugin-management`, `dsh-plugin`
- **Why use it:** Diagnoses and resolves plugin version conflicts with practical solutions
...
- **Tags:** `marketplace`, `dsh-plugin-bundle`, `dsh-plugins`
- **Why use it:** CodeX-style plugin marketplace for DSH ecosystem discovery.
...
- **Why use it:** OAuth-based ChatGPT integration to use Plus models inside DSH.
...
- **Why use it:** Whale girl themed skins collection for DeepSeek Harness desktop customization
...
- **Why use it:** Highly customizable glassmorphism theme for DSH web interface with adjustable blur and wallpaper.
...
- **Tags:** `documentation`, `deepwiki`, `code-analysis`, `dsh-plugin`
- **Why use it:** Generates accurate technical docs and AI-ready context from codebases quickly
...
- **Tags:** `research`, `skill`, `chinese-web`
- **Why use it:** Automatically searches 8 major Chinese platforms and generates cited research reports
...
- **Tags:** `arxiv`, `latex`, `research`, `experiment-tracking`, `gpu-cluster`
- **Why use it:** All-in-one research workbench with LaTeX, arXiv, experiment tracking and GPU SSH orchestration.
...
- **Tags:** `marketplace`, `awesome-list`, `registry`
- **Why use it:** Comprehensive plugin marketplace with 11K+ plugins, search and rankings
...
- **Why use it:** Cross-platform academic search with citation verification and graph
...
- **Tags:** `handbook`, `awesome-list`, `documentation`
- **Why use it:** 173-source handbook covering runtime, plugins, MCP, and troubleshooting
...
- **Why use it:** CN/EN plugin catalog with 1958 repos, STAR sorting and category filtering
...
- **Why use it:** Auto-discovers, installs and verifies GitHub DSH plugins via skill
...
- **Why use it:** Curated plugin discovery list for DSH ecosystem
...
- **Tags:** `awesome-list`, `resources`, `development`
- **Why use it:** Curated list of plugins, tools and development resources
...
- **Tags:** `api-documentation`, `chinese-api`, `multi-platform`
...
- **Tags:** `patent`, `legal-tech`, `rag`, `analysis`
- **Why use it:** Patent infringement analysis producing competitive reports from publication numbers
...
- **Tags:** `2origin`, `plugin-registry`, `ai-agent`
- **Why use it:** Evidence-backed plugin radar and 2Origin plugin lab for analysis.
...
- **Tags:** `awesome-list`, `bilingual`, `plugin-curation`
- **Why use it:** Curated bilingual plugin directory with evidence-based reviews at immutable commits.
...
- **Why use it:** Auto-updating bilingual plugin index with YAML-driven generation and Vercel hosting.
...
- **Why use it:** Curated plugin index for the entire DSH ecosystem.
...
- **Why use it:** Web-based DSH plugin aggregation ecosystem with Creative Workshop.
...
- **Tags:** `marketplace`, `plugin-shop`, `curated`
- **Why use it:** Comprehensive daily-updated DSH plugin marketplace with curated reviews.
...
- **Why use it:** Bilingual curated awesome list of DSH plugins, tools, skills, and integrations.
...
- **Tags:** `encyclopedia`, `knowledge-base`, `awesome-list`, `learning`
- **Why use it:** All-in-one AI resource encyclopedia covering agents, RAG, MLOps, and zero-to-hero learning paths.
...
- **Tags:** `awesome-list`, `plugin-discovery`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Daily-curated plugin discovery with real plugin filtering, scenario-based categories and popularity rankings.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `developer-tools`, `guide`
- **Why use it:** Ultimate DSH guide covering quickstart, resource recommendations and curated plugins & tools.
...
- **Tags:** `deepseek-harness`, `dsh`, `plugin-marketplace`, `best-practices`
- **Why use it:** Learn DSH internals, browse the plugin marketplace and discover best practices in one place.
...
- **Tags:** `awesome-list`, `mcp`, `coding-agent`, `llm-agent`, `deepseek-harness`
- **Why use it:** Curated collection of plugins, skills, MCP servers, patches and UIs with visualization and PPT support.
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories with direct repo links
...
- **Why use it:** Curated list of DeepSeek Harness plugins
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools, skills, and resources
...
- **Why use it:** Public GitHub directory for DSH plugin discovery and ecosystem navigation
...
- **Why use it:** Official spam-filtered registry of DSH plugins, bundles, and skills
...
- **Why use it:** 2026 curated DSH plugin list with quality checks and updates
...
- **Why use it:** Curated collection of practical and useful DeepSeek Harness plugins
...
- **Tags:** `awesome-list`, `inventory`, `dsh-plugin`
- **Why use it:** Full-scope DSH tool inventory with 1000+ repos sorted by stars
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选���件，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `plugin-directory`, `dsh-plugin`
- **Why use it:** Bilingual plugin guide covering install, permissions, and risks.
...
- **Tags:** `dsh-plugins`, `plugin-collection`
- **Why use it:** Curated collection of DSHA精选精选插件合集精选D精选选插件集合。
...
- **Tags:** `dsh-bundle`, `dsh-ecosystem`, `dsh-plugins-net`
- **Why use it:** DSH plugin repository and ecosystem analytics platform.
...
- **Tags:** `redirect`, `moved`
- **Why use it:** Redirect notice — moved to awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `awesome-list`, `minimal`
- **Why use it:** Minimal DSH plugin listing; limited metadata makes purpose unclear.

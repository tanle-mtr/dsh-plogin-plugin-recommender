...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 981,429 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-07 17:46:20 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215,038 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,639 | Open-source design tool for coding agents; local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,290 | Meta-harness for multi-agent swarms, autonomous wo |
...
- **Why use it:** Core DSH framework enabling everything-as-plugin architecture for AI agents.
...
- **Why use it:** Super AI assistant harness with multi-model support, memory, and skill evolution.
...
- **Tags:** `terminal`, `coding-agent`, `prompt-caching`
- **Why use it:** Terminal-native AI coding agent with DeepSeek prefix-cache stability optimization.
...
- **Tags:** `routing`, `orchestration`, `performance`
...
- **Why use it:** Self-improving agent OS with interview-gated staged evaluation loop
...
- **Why use it:** Enterprise local-first multi-engine workbench with visual editor support
...
- **Why use it:** Virtual terminal for AI agents, isolated sandboxed execution environment
...
- **Why use it:** One-click model switch between Claude Code, Codex, DSH, Kimi Code and more
...
- **Tags:** `deepseek`, `optimization`, `plugin`
- **Why use it:** Armor-breaking plugin optimized for DeepSeek model capabilities.
...
- **Tags:** `agent-skills`, `plugin-dev`, `dsh-plugin`, `skill`
- **Why use it:** Agent skill for developing DSH plugins with standard slot/tool/adapter patterns.
...
- **Tags:** `dsh-plugin`, `plugin-dev`, `agent-skill`, `build`
- **Why use it:** Agent skill for building and installing DSH plugins with credential management.
...
- **Tags:** `skills-manager`, `dsh-plugins`, `plugin-management`, `dsh`
...
- **Why use it:** Engineering discipline guard for code delivery quality
...
- **Tags:** `ui-generator`, `design-systems`, `desktop-app`
- **Why use it:** Open-source design tool for coding agents; local-first desktop UX prototype.
...
- **Why use it:** Ultimate image uploader with 60+ service support for Obsidian, VS Code, and more.
...
- **Why use it:** Modern desktop client for DSH ecosystem; turns the desktop into a plugin too.
...
- **Why use it:** Web-based DSH plugin aggregation ecosystem with distributed marketplace
...
- **Why use it:** Modern flexible task board integrating Codex and DSH workflows
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status and streaming thought
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, files and Office artifacts.
...
- **Tags:** `dsh-plugin`, `ui`, `genui`, `interactive`
...
- **Why use it:** Open-source Windows desktop GUI for DSH with SSH, plugins, skills, and mobile remote access
...
- **Why use it:** Canvas-based visual non-linear conversation workspace with branching session exploration
...
- **Why use it:** Native iOS app with WebSocket sync for Harness workspaces and agents.
...
- **Why use it:** Smartisan-style open notes with Docker deploy and DSH plugin integration.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Convenient web UI for managing skills and MCP tools in DSH.
...
- **Why use it:** One-click browse and install community plugins via web GUI.
...
- **Tags:** `desktop-app`, `dsh-plugins`, `electron`, `ui`
- **Why use it:** Full-featured Electron desktop console for DSH plugin/MCP/skill management.
...
- **Why use it:** Status bar showing provider, model, balance, and pricing in real time
...
- **Tags:** `devops`, `desktop`, `ssh`, `docker`
...
- **Why use it:** Electron desktop wrapper integrating DSH web with sidebar and ModLens.
...
- **Why use it:** Meta-harness for multi-agent swarms, autonomous workflows, and skills coordination.
...
- **Why use it:** Distills expert thinking patterns into reusable agent skills and meta-skills.
...
- **Why use it:** AI-powered no-code platform for rapid business system and workflow construction.
...
- **Why use it:** Intelligent skill routing and workflow orchestration, significant token savings
...
- **Tags:** `video`, `agent-skill`, `generation`
- **Why use it:** End-to-end Vox-style video generation from a single topic via agent skill.
...
- **Tags:** `multi-agent`, `team`, `workflow`
...
- **⭐ Stars:** 856
- **Language:** TypeScript
- **Description:** [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图��直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
...
- **Tags:** `agent-skills`, `skill-md`, `semantic-search`, `embeddings`
...
- **Tags:** `multimodal`, `computer-vision`, `audio-understanding`, `mcp`
- **Why use it:** Gives agents vision, audio and screen understanding with timestamped verifiable evidence
...
- **Tags:** `task-management`, `dsh-plugin`, `sqlite`, `native-ui`
...
- **Tags:** `creative-writing`, `novel-writing`, `drama-skills`, `fiction`
- **Why use it:** Specialized plugin for novel writing and short-drama production with dedicated drama skills
...
- **Why use it:** Transform experience into repeatable agent execution workflows.
...
- **Why use it:** Specialized skills for AI infra dev, optimization and high-perf systems.
...
- **Why use it:** 87 reverse-engineering and pentest SKILL.md files for security research.
...
- **Why use it:** Brings Superpowers skills to the Reasonix coding harness.
...
- **Why use it:** Transforms AI coding assistant into a mentor with guided practice.
...
- **Why use it:** 25 pre-installed productivity skills with right-panel quick access.
...
- **Tags:** `gongwen`, `docx`, `ai-docs`, `wps-office`
- **Why use it:** Full-cycle Chinese official document processing with GB/T 9704 compliance.
...
- **Tags:** `spec-programming`, `agent-skills`, `vibe-coding`, `dsh-plugin`
...
- **Tags:** `guide`, `knowledge-base`, `plugin-development`
...
- **Why use it:** Fusion of Chinese metaphysics skills: Bazi, Fengshui, IChing, TCM
...
- **Why use it:** Professional QA skill framework: 11 skills with knowledge base and decision matrix
...
- **Tags:** `skillhub`, `deepseek-harness`, `plugin`
...
- **Why use it:** 152 shot cards for cinematic product videos via Remotion
...
- **Why use it:** Pre-flight plugin injection improves agent plugin utilization predictably.
...
- **Why use it:** Unofficial LLM provider with live model catalog and reasoning support.
...
- **Why use it:** Official Huawei Cloud MCP tools with AI agent sandbox and guardrails.
...
- **Why use it:** One-click MCP/Skills/config setup for 7+ AI agent tools locally
...
- **Why use it:** Unified skills and MCP management in DSH web UI
...
- **Why use it:** Search npm + awesome lists for plugin discoverability from inside agents.
...
- **Why use it:** Agent skill generating verifiable architecture and sequence diagrams as self-contained HTML.
...
- **Why use it:** Industrial-grade GPT-Image2 prompt library with 530+ reverse-engineered templates.
...
- **Tags:** `visualization`, `litigation`, `diagram`, `svg`
- **Why use it:** Transform messy litigation diagrams into court-ready visual timelines.
...
- **Why use it:** AI video/image/audio generation with configurable model tools and corpus
...
- **Why use it:** Prevents AI-generic look with 6 curated design styles
...
- **Why use it:** Browser extension suite enhancing Gemini, Claude, ChatGPT, and prompt management.
...
- **Why use it:** Cross-platform content discovery agent from Bilibili, Douyin, YouTube etc.
...
- **Tags:** `web-search`, `dsh-plugin`, `free`, `no-api-key`
...
- **Why use it:** Enables browser automation via Playwright in DSH ecosystem.
...
- **Why use it:** DingTalk IM channel with streaming-mode bot and tool-capable agents.
...
- **Tags:** `self-hosted`, `resume-builder`, `mcp-server`
- **Why use it:** Privacy-first open-source resume builder with self-hosting and customization.
...
- **Why use it:** In-app marketplace for browsing, searching, and installing DSH plugins
...
- **Tags:** `plugin-discovery`, `ecosystem`, `tool`
- **Why use it:** Self-hostable plugin radar discovering 15900+ candidates with k8s validation.
...
- **Tags:** `oauth`, `subscription`, `dsh-plugin`, `utility`
- **Why use it:** Use ChatGPT/Claude/Grok subscription accounts as DSH LLM providers via OAuth, no API keys
...
- **Why use it:** P2P encrypted remote access for Harness across PC, Android and Web.
...
- **Why use it:** Backup, sync, and migrate full DSH config via WebDAV.
...
- **Tags:** `plugin-management`, `ui`, `console`, `dsh`
- **Why use it:** Zero-patch browser console for DSH plugin ecosystem management.
...
- **Why use it:** Pixel-to-text OCR and image analysis for text-only LLM models.
...
- **Why use it:** Audit AGENTS.md instructions, detect duplicates/conflicts, shows token costs
...
- **Tags:** `awesome-list`, `community`, `registry`
...
- **Why use it:** Curated list with web documentation for DSH plugins
...
- **Tags:** `awesome-list`, `registry`, `ecosystem`
- **Why use it:** Comprehensive awesome list covering plugins, skills, and MCPs
...
- **Why use it:** Tracks token usage, costs, and API balance in real-time with visual charts.
...
- **Tags:** `conflict-resolution`, `plugin-health`, `utilities`
...
- **Tags:** `pets`, `theming`, `animations`
- **Why use it:** Public animated pet gallery for multiple coding agent platforms
...
- **Tags:** `theme`, `dsh-plugin`, `glass-effect`, `ui-customization`
- **Why use it:** Frosted glass theme with full customization for all DSH UI elements, zero source changes
...
- **Why use it:** Stunning WebGPU ocean-themed Chrome/Edge extension for DSH.
...
- **Tags:** `background`, `webui`, `personalization`
- **Why use it:** Customizable DSH Web background with presets and fine-tuning controls.
...
- **Why use it:** Curated plugin discovery list, essential for finding quality DSH tools
...
- **Tags:** `research`, `china`, `agent-skill`
...
- **Tags:** `patent-analysis`, `multi-agent`, `rag`, `legal-tech`
- **Why use it:** Automated patent infringement analysis with multi-agent RAG pipeline.
...
- **Tags:** `fintech`, `backtesting`, `investment-research`, `mcp`
...
- **Tags:** `awesome-list`, `curated`, `resource`
- **Why use it:** Curated list covering DSH plugins across CLI, web UI and agent ecosystems.
...
- **Why use it:** Curated bilingual list of all DSH plugins, extensions, tools and integrations
...
- **Tags:** `awesome-list`, `curated`, `plugin-discovery`, `daily-update`
- **Why use it:** Daily auto-crawled curated plugin directory with scenario-based classification and rankings
...
- **Tags:** `catalog`, `directory`, `marketplace`
- **Why use it:** Comprehensive plugin catalog with 1958 repos and multi-language search.
...
- **Why use it:** Meticulously curated list of DSH plugins and resources.
...
- **Why use it:** Community-maintained auto-syncing plugin catalog and marketplace.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `plugin-curation`, `directory`
...
- **Why use it:** Specialized curated list of 24 verified stock/finance/quant DSH plugins.
...
- **Tags:** `manual`, `navigation`, `plugin-guide`
- **Why use it:** Plugin manual and navigation by scenario with compatibility info.
...
- **Tags:** `catalog`, `automated`, `bilingual`
...
- **Why use it:** Static web portal for discovering and filtering 227+ curated DSH plugins.
...
- **Why use it:** Connects ChatGPT subscription via OAuth, enabling ChatGPT model access in DSH.
...
- **Why use it:** Curated plugin repository listing for DeepSeek Harness ecosystem.
...
- **Why use it:** DSHA精选插件合集，精选优质插件列表。
...
- **Tags:** `2origin`, `ai-agent`, `awesome-list`, `plugin-registry`
- **Why use it:** Plugin radar with 2Origin lab integration, evidence-backed curated list.
...
- **Tags:** `ai-agents`, `coding-agents`, `mcp`, `plugin`
- **Why use it:** AI-curated comprehensive plugin recommender with 190+ plugins across 12 categories.
...
- **Why use it:** Repository migrated to a new location; original curated plugin list.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** DSH plugin collection for general discovery and reference.
...
- **Why use it:** Auto-updating plugin list with YAML data, bilingual README and Vercel site.

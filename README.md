...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 860,420 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-25 08:54:51 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 193,621 | Core DSH framework - everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,241 | Open-source Figma alternative with AI design |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,332 | Multi-agent swarm orchestration meta-harness |
...
- **Tags:** `multi-agent`, `swarm`
- **Why use it:** Multi-agent swarm orchestration meta-harness
...
- **Why use it:** Self-evolving AI assistant with memory
...
- **Why use it:** DeepSeek-native terminal coding agent
...
- **Tags:** `dsh-web`, `dsh-plugin`, `ecosystem`
- **Why use it:** Web plugin aggregation ecosystem with community workshop distribution
...
- **Why use it:** Enterprise multi-engine agent workbench with unified local-first workspace
...
- **Tags:** `agent-tools`, `vfs`, `virtual-filesystem`
- **Why use it:** Unified virtual filesystem for AI agents enabling cross-engine file access
...
- **Tags:** `coding-agent`, `agent-runtime`
...
- **Why use it:** Architecture-aware coding agent with baseline-first drift detection and evidence verification
...
- **Tags:** `agent`, `desktop`, `multi-model`, `privacy`
...
- **Tags:** `security`, `ai-agents`, `redteam`
- **Why use it:** AI code security platform: detects hallucinated packages, missing safeguards
...
- **Tags:** `multi-agent`, `coordination`, `harness`
- **Why use it:** Unify Claude Code, Codex, Grok, DeepSeek Harness into one coordinated team
...
- **Why use it:** TDD, debugging, planning skills for DSH
...
- **Tags:** `agent-skill`, `awesome-dsh-plugin`, `dsh-plugin`
- **Why use it:** Standard skill for developing and packaging DSH plugins
...
- **Why use it:** Build and manage DSH plugin slots, remotes, and credentials
...
- **Why use it:** Codex-adapted skill for automated code simplification and refactoring.
...
- **Tags:** `package-manager`, `skills`, `database`, `agent-framework`
- **Why use it:** Package manager with 42 skills, 5 CLIs for AI agent engineering and dev workflows.
...
- **Tags:** `plugin-development`, `cordis`, `auditing`
- **Why use it:** Portable skill for developing and auditing DSH plugins with Cordis adapter.
...
- **Why use it:** Practical DSH plugin dev playbook covering common pitfalls and best practices.
...
- **Tags:** `engineering`, `practices`, `agent-skills`, `development`
- **Why use it:** Engineering discipline skill distilled from DSH experience: evidence, fact-finding, durable decisions.
...
- **Tags:** `cost`, `token-usage`, `visualization`
- **Why use it:** Real-time token usage charts and cost tracking dashboard
...
- **Why use it:** Pre-flight plugin check-injection for task-based agents
...
- **Why use it:** Lightweight 5MB Tauri desktop client with zero setup across Windows/macOS/Linux
...
- **Tags:** `desktop-companion`, `mcp`, `dsh-plugin`
- **Why use it:** Animated desktop companion platform with plugin SDK and coding-agent integrations
...
- **Tags:** `widget`, `floating-ui`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracks DSH account balance with drag-and-drop and animations
...
- **Tags:** `desktop`, `local-first`, `mcp`, `dsh-plugin`
- **Why use it:** Full local-first AI desktop workspace for sessions, projects, files, web research and plugins
...
- **Why use it:** CodePilot-inspired native desktop client for DSH across macOS/Windows/Linux
...
- **Tags:** `desktop`, `gui`, `electron`, `windows`
- **Why use it:** Full-featured Windows desktop client with GUI and SSH support
...
- **Why use it:** Smartisan-style notes with one-click deployment
...
- **Why use it:** Essential marketplace for DSH plugin management
...
- **Why use it:** Android emulator control via DSH conversation
...
- **Why use it:** Community plugin browser for DSH Web GUI
...
- **Tags:** `desktop-app`, `dsh`, `dsh-plugin`, `electron`
- **Why use it:** Electron desktop console for managing Harness/plugins/MCP
...
- **Why use it:** WorkBuddy-style skill picker for easy DSH skill insertion via composer.
...
- **Tags:** `capability-menu`, `ui`, `mcp-management`
- **Why use it:** Unified menu to manage MCP tool and skill exposure level and execution.
...
- **Tags:** `ui`, `status-bar`, `pricing`, `web`
...
- **Why use it:** Tauri desktop app combining DB, SSH, Docker, and AI assistant
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI and plugins
...
- **Why use it:** Custom backgrounds with filters and presets for DSH Web
...
- **Why use it:** LLM knowledge platform with RAG and Wiki
...
- **Tags:** `agent-memory`, `rag`, `self-evolving`, `token-savings`
...
- **Tags:** `agent`, `memory`, `rag`
- **Why use it:** Excellent memory management kit for agents with RAG capabilities.
...
- **Why use it:** Unlimited persistent memory layer for OpenClaw agents with cross-session recall
...
- **Tags:** `knowledge`, `wiki`, `rag`
- **Why use it:** Comprehensive AI knowledge wiki — LLMs, agents, RAG, MLOps all-in-one
...
- **Tags:** `rag`, `skill-retrieval`, `embeddings`, `memory`
- **Why use it:** Curates SKILL.md files into retrievable agent-skill corpora
...
- **Why use it:** HTTP-connected memory, recall, and skill handoff server
...
- **Why use it:** Distill AI thinking into reusable skills
...
- **Tags:** `deepseek`, `dsh-plugin`, `workflow`
- **Why use it:** Two-phase DSH preset: minimal bootstrap then full Standard tools coverage
...
- **Tags:** `agent-skills`, `cognitive-enhancement`
...
- **Why use it:** General-purpose skill that intelligently routes and orchestrates harness workflows.
...
- **Why use it:** Multi-agent team collaboration plugin enabling coordinated task execution in DSH
...
- **Tags:** `workflow`, `prompt-management`, `ai-assistant`
- **Why use it:** Transform scattered AI chats into organized reusable workflows across all major platforms
...
- **Tags:** `prompt`, `generation`, `deepseek`
- **Why use it:** Armor-breaking prompt generator specialized for DeepSeek model limitations
...
- **Why use it:** Specialized skill for novel writing and short-drama production
...
- **Tags:** `skills`, `infra`, `workflow`
- **Why use it:** Agent skills for AI infra dev workflows
...
- **Tags:** `task`, `management`, `sqlite`
- **Why use it:** SQLite-backed task management in native UI
...
- **Why use it:** Ports Superpowers skills to Reasonix framework
...
- **Tags:** `ctf`, `dsh-plugin`, `pentest`, `reverse-engineering`, `security`
...
- **Tags:** `agent-skills`, `deep-research`, `research-tools`, `skill-md`
...
- **Tags:** `agent-skills`, `dsh-plugin`, `spec-driven-development`
...
- **Why use it:** OCR and image-reading skill for text-only AI models
...
- **Why use it:** Official DSH docs archive as on-demand agent skill for plugin dev.
...
- **Why use it:** Enables cross-platform agent session continuity and context recovery.
...
- **Why use it:** Fusion of Bazi, Fengshui, IChing and TCM as a local deterministic skill.
...
- **Why use it:** Free image vision transcription and generation for DSH agents.
...
- **Tags:** `gongwen`, `docx`, `word`, `chinese-documents`
- **Why use it:** Full Chinese official document pipeline: formatting, optimization, template generation.
...
- **Tags:** `video`, `ai-image`, `storyboard`, `vision`
- **Why use it:** AI video/image/audio pipeline with storyboard, knowledge corpus, and vision tools.
...
- **Tags:** `skills`, `gamification`, `task-system`, `wayfinder`
...
- **Why use it:** Full-stack Godot 4.x dev skill plugin for DSH agents
...
- **Why use it:** Build and test DSH plugins with scaffolding and tiered testing
...
- **Why use it:** Infinite canvas with creative agentic AI skills integration
...
- **Why use it:** Simulates PM-Engineer-QA team for product workflows
...
- **Why use it:** CodeX-style plugin marketplace for DSH with bundle and desktop support
...
- **Tags:** `mcp`, `skill`, `management`
- **Why use it:** Unified skill and MCP management in Web UI
...
- **Why use it:** Web UI panel to manage DSH skills and MCP servers directly in browser.
...
- **Why use it:** Zhihu search and Zhida Q&A via Skill, CLI, and MCP server integrations.
...
- **Why use it:** Hot-reload MCP connection and zip/.skill upload for instant DSH plugin setup.
...
- **Why use it:** Open-source Figma alternative with AI design
...
- **Why use it:** Industrial-grade GPT-Image2 prompt engine
...
- **Why use it:** Self-contained HTML diagrams with motion, great for architecture visualization
...
- **Tags:** `agent-team`, `vibedesign`, `ui`, `flutter`
...
- **Tags:** `ocr`, `multimodal`, `vision`, `image-to-text`
- **Why use it:** First vision bridge plugin converting images to structured JSON evidence
...
- **Tags:** `vision`, `ocr`, `agent-vision-toolkit`
- **Why use it:** Powerful vision toolkit for text-only models: image paste, OCR, and screenshot restoration
...
- **Tags:** `ui`, `visualization`, `dsh-plugin`
- **Why use it:** Inline interactive UI components — charts, forms, quizzes rendered in replies
...
- **Why use it:** Generate images directly in DSH chats via Seedream
...
- **Tags:** `design`, `ui`, `ppt`
- **Why use it:** Enables editing .op designs directly in chat
...
- **Tags:** `agent-skills`, `diagram`, `legal`, `visualization`
- **Why use it:** Create litigation timeline diagrams directly from case files
...
- **Why use it:** 6 aesthetic design styles to avoid generic AI-generated website looks.
...
- **Tags:** `browser-extension`, `chatgpt`
- **Why use it:** Browser extension suite for AI chat platforms
...
- **Why use it:** Let AI agents control your real logged-in browser seamlessly via CLI + extension
...
- **Tags:** `record-replay`, `automation`, `macos`
- **Why use it:** Record macOS workflows as agent skills via demonstration
...
- **Why use it:** DingTalk IM channel turning each chat into a tool-capable agent with emotion read-receipts
...
- **Tags:** `resume-builder`, `javascript`
...
- **Why use it:** Ultimate image uploader with 60+ services
...
- **Why use it:** AI-enhanced no-code business system platform
...
- **Tags:** `dsh-plugin`, `routing`, `injector`
- **Why use it:** Runtime injector and reasoning-mode router standard kit for DSH
...
- **Why use it:** One-click install and model switching across multiple AI CLI tools.
...
- **Tags:** `dsh-plugin`
- **Why use it:** Fun web simulation of traditional bamboo dragonfly toy, zero-dependency single file.
...
- **Why use it:** Built-in plugin marketplace for DSH with browse, search, and one-click install features.
...
- **Why use it:** Context dashboard and statistics management for deep insight and optimization in DSH
...
- **Tags:** `provider`, `oauth`, `subscription`
- **Why use it:** Bridge ChatGPT/Claude/Grok subscriptions into DSH — no API keys needed
...
- **Why use it:** Track session/daily costs, budgets and token usage easily
...
- **Why use it:** Runs unmodified Pi extensions as native DSH plugins seamlessly
...
- **Why use it:** Preserves cross-preset session state reliably
...
- **Tags:** `backup`, `undo`, `recovery`
- **Why use it:** Safety net for undoing config/plugin changes
...
- **Tags:** `console`, `dsh`, `dsh-plugin`, `plugin-management`, `ui`
- **Why use it:** Essential plugin registry console and dev skill for DSH
...
- **Tags:** `config-manager`, `backup`, `migration`, `mcp`
- **Why use it:** Full DSH config backup, restore, migration with WebDAV sync support.
...
- **Tags:** `context`, `audit`, `optimization`, `ui`
- **Why use it:** Audits context token costs, detects duplicates and conflicts in instructions.
...
- **Tags:** `skills-manager`, `utility`, `organization`
- **Why use it:** Dedicated plugin for managing and organizing DSH skills efficiently.
...
- **Tags:** `migration`, `claude-code`, `configuration`
- **Why use it:** Migrate Claude Code/Codex configs to DSH seamlessly
...
- **Why use it:** Diagnoses and resolves plugin conflicts automatically
...
- **Why use it:** Enables plugin discovery inside DSH agents via npm and awesome-list search
...
- **Why use it:** Animated pet mascot gallery for multiple coding agents and CLI tools
...
- **Why use it:** Whale girl themed skins for DeepSeek Harness with attractive visual design.
...
- **Why use it:** Frosted glass theme with full UI customization, zero source changes
...
- **Why use it:** Stunning WebGPU ocean theme for DSH desktop experience
...
- **Tags:** `theme`, `dark-mode`, `color-scheme`, `ui`
- **Why use it:** One-click switch among 34 opencode classic color themes for DSH UI.
...
- **Tags:** `ai-guide`, `tutorials`
- **Why use it:** Comprehensive AI resource guide and tutorials
...
- **Tags:** `ai-agent`, `content-discovery`, `privacy-first`
- **Why use it:** Local-first cross-platform AI content discovery from major Chinese platforms.
...
- **Why use it:** Auto-searches 8 major Chinese platforms for recent 30 days and generates citable research reports.
...
- **Why use it:** Curated plugin radar with 9000+ candidates and top 50 picks via real runtime tests
...
- **Why use it:** Curated plugin ecosystem index covering tools, harness features, and web UIs for DSH
...
- **Why use it:** Comprehensive curated list of DSH plugins, tools and infrastructure from official hubs
...
- **Why use it:** Curated bilingual plugin directory — reliable reference for DSH ecosystem
...
- **Tags:** `awesome-list`, `discovery`, `catalog`
- **Why use it:** Daily auto-scraped plugin catalog with real-vs-spam filtering and rankings
...
- **Tags:** `marketplace`, `education`, `best-practices`
...
- **Why use it:** Curated list covering plugins, MCP servers, skills & UIs
...
- **Why use it:** Search anime across multiple sources with Bangumi ratings
...
- **Tags:** `awesome-list`, `deepseek`, `dsh-plugin`, `plugins`
...
- **Tags:** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `plugin-marketplace`, `plugins`
- **Why use it:** Auto-synced community plugin catalog, essential browsing
...
- **Tags:** `ai-agents`, `chinese-api`, `dsh-plugin`, `api-documentation`
...
- **Why use it:** Official auto-generated plugin list maintained by cordis.run
...
- **Tags:** `kline`, `finance`, `analysis`, `interactive`
- **Why use it:** Interactive K-line financial analysis with technical indicators and news.
...
- **Tags:** `evaluation`, `rag`, `prompt-engineering`, `benchmark`
...
- **Why use it:** Curated plugin ecosystem list, essential discovery hub for DSH
...
- **Tags:** `deepseek-harness`, `photo-wall`, `oauth`
- **Why use it:** DSH event photo wall with OAuth login and instant Polaroid-style captures.
...
- **Why use it:** Curated plugin directory for easy DSH ecosystem discovery
...
- **Why use it:** Public plugin directory with install commands and ecosystem tools
...
- **Tags:** `verified`, `curated`, `installation`
...
- **Tags:** `curated`, `quality-check`, `2026`
- **Why use it:** 2026 curated list with quality-checked DSH plugins
...
- **Why use it:** 24 verified stock/finance/quant plugins curated list
...
- **Tags:** `awesome-list`, `radar`, `verify`
...
- **Tags:** `portal`, `static-site`, `directory`
- **Why use it:** Static web portal to discover and install 227+ plugins
...
- **Tags:** `plugin-repository`, `verify`
- **Why use it:** General DSH plugin repository and verification hub
...
- **Tags:** `awesome-list`, `auto-crawl`, `directory`
- **Why use it:** Auto-crawled bilingual daily-updated plugin directory
...
- **Why use it:** Comprehensive 1000+ DSH plugin index sorted by stars with Docker theme
...
- **Why use it:** Curated collection of plugins, tools, skills and resources for DSH

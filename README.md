...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,038,712 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 226,573 | The foundational plugin harness for the entire DSH |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,571 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,634 | Multi-agent swarm framework for autonomous coordin |
...
- **Why use it:** The foundational plugin harness for the entire DSH ecosystem
...
- **Why use it:** Daily-refreshed curated marketplace for DSH plugins
...
- **Why use it:** Bilingual curated Awesome-list of DSH plugins and tools
...
- **Why use it:** DSH插件搜索安装验证一站式Skill工具
...
- **Why use it:** AI基础设施开发专用Skill集合，写优化调试系统
...
- **Why use it:** Reusable Codex skill for building and validating DSH plugins efficiently.
...
- **Tags:** `plugin-dev`, `skill`, `pipeline`
- **Why use it:** Agent skill for developing DSH plugins with full pipeline
...
- **Why use it:** Pre-flight plugin check for DSH agents, boosts utilization predictability
...
- **Tags:** `design`, `desktop-app`, `ui-generator`
...
- **⭐ Stars:** 27,054
- **Language:** TypeScript
- **Description:** 为 DeepSeek Harness (DSH) ���件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- **Tags:** `desktop`, `dsh-plugin`, `cordis`
- **Why use it:** Modern desktop solution where the desktop itself is a plugin
...
- **Why use it:** Web-based plugin aggregation and creative workshop UI
...
- **Why use it:** Cute floating whale widget for tracking DeepSeek account balance with drag-and-drop.
...
- **Tags:** `dsh-desktop`, `tauri`, `dsh-plugin`
...
- **Why use it:** Windows GUI client with Codex, SSH, and mobile remote access
...
- **Why use it:** Renders interactive UI components like charts and forms inline in replies
...
- **Tags:** `desktop`, `privacy`, `multi-model`
- **Why use it:** Local-first AI desktop app alternative to Claude Cowork with privacy focus
...
- **Why use it:** Full office suite: spreadsheets, docs, slides embedded in DSH
...
- **Why use it:** Native iOS client bringing DSH workspaces and agents to iPhone
...
- **Why use it:** Bioinformatics desktop agent with skill store and offline mode via Tauri.
...
- **Why use it:** Essential status bar showing model, balance, and pricing in real time.
...
- **Tags:** `workbench`, `plugin-system`, `typescript`
...
- **Why use it:** Electron desktop shell integrating DSH web UI and sidebar tools
...
- **Why use it:** Self-evolving context database unifying agent memory and knowledge RAG
...
- **Why use it:** Portable local-first memory layer for cross-app AI agents
...
- **Why use it:** Memory library for building stateful agentic RAG systems
...
- **Tags:** `dsh-plugin`, `memory`, `mcp`
- **Why use it:** Personal AI memory hub giving all agents shared persistent context and control.
...
- **Tags:** `database`, `financial`, `mcp`
- **Why use it:** 基于Tushare构建本地金融数据库，支持Skill扩展
...
- **Why use it:** Enables cross-session context recovery for agent handoffs
...
- **Why use it:** Distill expertise into reusable meta-skills for any AI agent or bot
...
- **Why use it:** Largest skill marketplace with extensive curated skill packs
...
- **Why use it:** Self-improving agent OS with staged evaluation and budget loops
...
- **Tags:** `loop-engineering`, `long-horizon`, `workflow`
...
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation via AI agent.
...
- **Tags:** `dsh-plugin`, `creative-writing`, `rag`
- **Why use it:** Full workflow AI novel writing tool with characters, worldbuilding, and editing.
...
- **Tags:** `skill-management`, `rag`, `agent-skills`
...
- **Why use it:** Gives agents eyes and ears via video, audio, and screen capture
...
- **Why use it:** 全栈数学建模自动化Skill，GitOps流水线+代码自证
...
- **Why use it:** 可组合任务控制与人类审查，实现Agent自我进化
...
- **Tags:** `agent-skills`, `code-skills`, `experience`
- **Why use it:** 将经验转化为可重复执行流程，多平台兼容
...
- **Why use it:** 88个开源Agent技能，覆盖研究营销商业工作流
...
- **Why use it:** 纯文本LLM赋能多模态视觉，支持截图UI图表分析
...
- **Why use it:** Complete reverse engineering and pentest skills
...
- **Why use it:** Auto-upgrade plugins with DSH version
...
- **Tags:** `skills`, `dsh-plugin`, `github-issues`
- **Why use it:** 25 pre-built engineering and efficiency skills in one installable deck
...
- **Why use it:** Chinese official document processor: format check, optimization, template generation
...
- **Why use it:** Comprehensive Chinese traditional wisdom agent with Bazi, Fengshui, IChing skills.
...
- **Why use it:** Engineering discipline bundle for requirements validation and quality gates.
...
- **⭐ Stars:** 31
- **Language:** Python
- **Description:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + ���型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **Tags:** `qa`, `testing`, `agent-skills`
- **Why use it:** 11 QA skills with knowledge base and decision matrix for test automation.
...
- **Tags:** `math`, `modeling`, `agent-team`
- **Why use it:** Multi-agent math modeling solver with 5 roles and 33 models
...
- **Why use it:** Official Huawei Cloud plugin with skills, MCP tools and cloud sandbox
...
- **Why use it:** One-click MCP/Skills sync across Claude Code, Codex, Cursor, Gemini.
...
- **Tags:** `design`, `vector`, `vibedesign`, `agent-teams`
...
- **Why use it:** Native design studio with AI generation, visual editor, templates, and PPT.
...
- **Tags:** `legal-tech`, `visualization`, `svg`, `agent-skills`
- **Why use it:** Visualize legal cases into timelines, confrontation charts and relationship diagrams
...
- **Why use it:** AI video/image/audio generation with DirectorX workflow integration.
...
- **Why use it:** Cinematic product video skill with 152 shot recipe cards
...
- **Why use it:** 6 design styles to avoid AI look in vibe-coded websites
...
- **Why use it:** Runtime injector and task-aware router kit for DSH
...
- **Tags:** `dsh-plugin`, `ecosystem-radar`
- **Why use it:** Ecosystem radar scanning 21k+ plugins with continuous k8s validation.
...
- **Why use it:** Best context insight tool with dashboard, browser sidebar, and stats.
...
- **Why use it:** Use existing ChatGPT/Claude/Grok subscriptions as DSH LLM providers
...
- **Tags:** `cost-tracking`, `billing`, `usage`
...
- **Tags:** `llm-provider`, `command-code`, `catalog`
...
- **Why use it:** P2P加密远程访问，支持PC/Android/Web多端操作
...
- **Why use it:** Backup, restore, and sync DSH config and plugins
...
- **Why use it:** DSH plugin ecosystem infrastructure with browser console and dev scaffolding
...
- **Why use it:** Audit context tokens, detect duplicates and conflicts in AGENTS.md.
...
- **Tags:** `container`, `dsh-management`, `utility`
...
- **Tags:** `pets`, `mascot`, `theming`, `sprites`
- **Why use it:** Animated pet gallery providing themed mascots for coding agents
...
- **Why use it:** Glassmorphism theme with fully adjustable blur and background for DSH web
...
- **Why use it:** DSH Web background customization with preset atmospheres and uploads
...
- **Why use it:** Full-cycle research workbench: LaTeX, arXiv, GPU SSH orchestration
...
- **Why use it:** 跨多学术数据库检索，支持引用核验与图谱生成
...
- **Tags:** `api-documentation`, `dsh-plugin`, `chinese-api`
...
- **Why use it:** Patent infringement analysis system producing competitive reports via agents
...
- **Tags:** `kline`, `technical-analysis`, `sidebar`
...
- **Why use it:** Curated stock/finance/quant DSH plugins (24 entries)
...
- **Why use it:** Curated star-ranked community plugin directory for DSH
...
- **⭐ Stars:** 3
- **Language:** Unknown
- **Description:** 面向 DeepSeek Harness 用户的插件产品说明书与导���：按场景选插件，了解安装、权限、兼容性和风险
- **Tags:** `awesome-list`, `plugin-guide`
- **Why use it:** Plugin guide covering installation, permissions and risks
...
- **Tags:** `repository`, `plugin-verify`
- **Why use it:** DSH plugin repository with ecosystem analytics
...
- **Why use it:** Original awesome-dsh-plugins, now moved elsewhere
...
- **Why use it:** Privacy-focused open-source resume builder with MCP server support
...
- **Why use it:** Let AI agents use your real, logged-in browser without interrupting your work. C
...
- **Tags:** `curated-list`, `discovery`, `plugin`
- **Why use it:** Auto-crawled curated DSH plugin directory with daily review and ratings
...
- **Tags:** `awesome-list`, `resources`, `coding`
- **Why use it:** Curated awesome list covering plugins, skills, MCP servers, and UIs
...
- **Why use it:** Ultimate DSH guide: quickstart, resources, plugins and toolkit curation
...
- **Why use it:** DSH原理学习、插件市场与最佳实践的综合性资源
...
- **Why use it:** 11000+插件目录，含搜索、排名及免费API
...
- **Why use it:** 173个源码支撑的DSH运行时、插件、MCP权威手册
...
- **Why use it:** 1958仓库/1819插件中英搜索分类STAR排序总目录
...
- **Why use it:** 开源锤子便签复刻，Docker私有化部署支持Skill调用
...
- **Why use it:** Community plugin marketplace with auto-sync
...
- **Why use it:** Awesome list covering plugins, tools, skills and resources
...
- **Why use it:** CodeX-style marketplace for discovering DSH plugins
...
- **Tags:** `awesome-list`, `awesome`, `ai-agents`
...
- **Description:** DSH插件
- **Tags:** `awesome-list`
- **Why use it:** Minimal DSH plugin listing resource

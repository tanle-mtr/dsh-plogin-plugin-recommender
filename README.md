...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 994,900 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-10 03:53:29 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 217,692 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,209 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,836 | Multi-agent swarm orchestration with autonomous wo |
...
- **Tags:** `multi-agent`, `mcp`, `dsh-plugin`, `skills`
...
- **Why use it:** First vision plugin for DSH, adds OCR and image-to-text to coding agents
...
- **Why use it:** Virtual terminal providing sandboxed isolated execution for AI agents
...
- **Why use it:** One-click switch between Claude Code, Codex, DeepSeek Harness and other agents
...
- **Why use it:** Coding agent CLI with sub-agent and mcp support
...
- **Why use it:** SQLite-backed taskboard with native Web UI and Agent claim/review workflow
...
- **Why use it:** 22 agent tools for live iOS Simulator and USB iPhone automation inside conversation
...
- **Why use it:** Open-source CLI and agent tools for DSH Plugin Hub management and installation
...
- **Tags:** `code-simplification`, `coding-agent`
- **Why use it:** Codex-style code simplification adapted for DSH
...
- **⭐ Stars:** 24,872
- **Language:** TypeScript
- **Description:** 为 DeepSeek Harness (DSH) 插件��态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
...
- **Tags:** `no-code`, `low-code`, `dsh-plugin`, `internal-tools`
...
- **Tags:** `dsh-web`, `plugin-distribution`, `ui`
- **Why use it:** Web-based DSH plugin aggregation and distribution platform
...
- **⭐ Stars:** 3,469
- **Language:** TypeScript
- **Description:** 开放的侧边栏底座，支持三方拓展���册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
...
- **Tags:** `taskboard`, `ui`, `codex`, `dsh-plugin`
...
- **Tags:** `widget`, `ui`, `balance`, `dsh-plugin`
...
- **Why use it:** Local-first Electron desktop workspace with web research and Office support.
...
- **Why use it:** Open-source Windows desktop GUI client
...
- **Why use it:** Local-first AI agent desktop app alternative
...
- **Why use it:** CodePilot-inspired native desktop client for DSH across macOS, Windows, and Linux
...
- **Why use it:** Native iOS client with WebSocket connection for workspace, sessions and Agent traces
...
- **Tags:** `marketplace`, `ui`, `web`, `plugins`
...
- **Why use it:** Electron desktop hub for multi-tab DSH plugin/MCP management.
...
- **Tags:** `ui`, `balance`, `usage-tracking`
- **Why use it:** Live balance, model info, and pricing countdown bar
...
- **Tags:** `ui`, `skill-picker`, `agent`
- **Why use it:** WorkBuddy-style skill picker for quick agent skill insertion
...
- **Why use it:** Interactive K-line charts with technical indicators in sidebar
...
- **Why use it:** DevOps一体化桌面中心：DB/SSH/SFTP/Docker/AI整合
...
- **Why use it:** Web background customization with presets and real-time preview
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI and multiple plugins
...
- **Why use it:** LLM knowledge platform with RAG, reasoning, and self-maintaining wiki
...
- **Why use it:** Portable local-first memory layer across all AI agents
...
- **Tags:** `memory-management`, `token-savings`, `self-evolving`
...
- **Why use it:** Memory library for building stateful LLM agents
...
- **Tags:** `memory`, `rag`, `milvus`, `vector-db`
...
- **Tags:** `agent-memory`, `embeddings`, `dsh-plugin`
- **Why use it:** Turns scattered SKILL.md files into retrievable agent-skill corpora.
...
- **Why use it:** AI knowledge encyclopedia with RAG browsing
...
- **Tags:** `finance`, `agent`, `database`
- **Why use it:** Local financial DB with multi-agent analysis and adaptive MCP
...
- **Tags:** `rag-evaluation`, `llm-evaluation`, `dsh-plugin`
- **Why use it:** 证据驱动提示词/RAG/Agent评估框架，支持多Judge集成
...
- **Tags:** `multi-agent`, `swarm`, `mcp-server`, `dsh-plugin`
...
- **Why use it:** Unified agent workspace across devices with board tracking
...
- **Tags:** `skill-store`, `agent-skills`, `marketplace`
- **Why use it:** Largest skills store with auto-categorized thousands of skills
...
- **Why use it:** Self-improving agent OS with staged evaluation loop
...
- **Tags:** `cognition`, `skills`, `research`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `video-generation`, `dsh-plugin`
- **Why use it:** End-to-end automated video generation from a single topic input.
...
- **Tags:** `vision`, `agent-skills`, `dsh-plugin`
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A and OCR.
...
- **Why use it:** Best free web search skill without API
...
- **Tags:** `multimodal`, `video`, `ocr`
- **Why use it:** Video-audio-screen multimodal observation skill
...
- **Why use it:** Novel-writing and short-drama creation skill plugin
...
- **Tags:** `agent-skill`, `workflow`, `competition`
- **Why use it:** Full-stack math modeling competition skill with GitOps pipeline and self-verifying code
...
- **Why use it:** Enables composable, self-improving agent workflows with human review
...
- **Why use it:** Specialized skills for AI infra development and high-performance debugging
...
- **Tags:** `upgrade`, `automation`, `skills`
...
- **Tags:** `agent-skills`, `automation`, `skill-generation`
...
- **Tags:** `skills`, `coding`, `mentor`, `tutoring`
- **Why use it:** AI coding mentor that scans projects and guides step-by-step.
...
- **Tags:** `skills`, `fintech`, `backtesting`, `investment`
- **Why use it:** AI investment desk with backtesting and multi-strategy support.
...
- **Why use it:** 25 pre-installed engineering skills in a right-panel deck.
...
- **Why use it:** Full GB/T 9704 official document workflow and format checker.
...
- **Tags:** `skill`, `plugin-management`, `slots`
...
- **Why use it:** Portable spec-driven development skill for DSH repos.
...
- **Tags:** `plugin-creator`, `skill`, `dsh-plugin`
...
- **Why use it:** Official DSH plugin dev knowledge base and docs archive
...
- **Why use it:** Unique Bazi/Fengshui/IChing agent skill with local engine
...
- **Why use it:** Professional QA testing skill framework for AI agents
...
- **Tags:** `agent-skills`, `ai-roleplay`, `deepseek-harness`
- **Why use it:** Roleplay narrative skill with NPC memory, stance and YAML存档
...
- **Tags:** `game-development`, `godot`, `dsh-plugin`
- **Why use it:** Godot 4.x全栈游戏开发Skill，运行时注册
...
- **Tags:** `delivery-gate`, `guard`, `dsh-plugin`
- **Why use it:** 工程纪律工具：审查需求、测试实现、验证交付质量
...
- **Why use it:** 指导AI Agent从零开发、构建、安装DSH插件
...
- **Why use it:** 152张镜头配方卡+Remotion模板，电影感产品视频生成
...
- **Why use it:** 开发DSH插件的Agent Skill，兼容Claude Code/Codex
...
- **Why use it:** Virtual product team agent preset guiding users through PM-to-QA workflow
...
- **Why use it:** LLM provider plugin with live model catalog and reasoning support
...
- **Why use it:** Official Huawei Cloud MCP tools, skills, and sandbox.
...
- **Why use it:** One-click MCP/skills config sync for multiple AI agents
...
- **Why use it:** Official SkillHub Open API docs and DSH plugin integration examples
...
- **Tags:** `mcp`, `dsh-plugin`
- **Why use it:** Web GUI插件，浏览器内管理技能与MCP服务器
...
- **Tags:** `design-systems`, `dsh-plugin`, `figma-alternative`
...
- **Why use it:** Self-contained animated architecture and sequence diagrams
...
- **Why use it:** Industrial-grade GPT-Image2 prompt templates and skill library
...
- **Tags:** `genui`, `ui-components`, `visual`
- **Why use it:** Interactive inline UI components generator
...
- **Why use it:** Visualizes litigation timelines and case diagrams in SVG.
...
- **Tags:** `design-skills`, `ui`, `dsh-plugin`
- **Why use it:** 6种视觉风格包，避免AI味设计
...
- **Tags:** `resume-builder`, `self-hosted`, `dsh-plugin`, `mcp-server`
...
- **Tags:** `routing`, `injector`, `dsh-plugin`, `infrastructure`
- **Why use it:** Injector + router-standard kit for DSH runtime
...
- **Tags:** `control-plane`, `long-horizon`, `agent-ops`
...
- **⭐ Stars:** 3,528
- **Language:** TypeScript
- **Description:** The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH 可视��插件市场
- **Tags:** `marketplace`, `install`, `dsh-plugin`
...
- **Why use it:** Self-deployable ecosystem radar auto-discovering and validating plugins.
...
- **Why use it:** Best context insight dashboard with stats, browser, and CLI commands.
...
- **Tags:** `marketplace`, `plugin-shop`, `dsh`
- **Why use it:** Daily-updated plugin marketplace hub
...
- **Why use it:** AI code security audit offense-defense platform
...
- **Why use it:** OAuth bridge for ChatGPT-Claude-Grok subscriptions
...
- **Why use it:** Backup, restore, and sync full DSH configuration.
...
- **Tags:** `capabilities`, `tools`, `ui`, `utility`
- **Why use it:** Unified menu to manage tool exposure and execution modes.
...
- **Why use it:** Core infrastructure for DSH plugin ecosystem management.
...
- **Tags:** `skills`, `plugin-management`, `dsh-plugins`
...
- **Why use it:** OCR/image-reading tools enabling vision for text-only models.
...
- **Why use it:** Audits AGENTS.md tokens, detects duplicates and conflicts
...
- **Tags:** `desktop`, `container`, `plugin-management`
...
- **Why use it:** Real-time token cost tracking with per-round charts and API balance
...
- **Why use it:** Free Xiaomi MiMo TTS integration with customizable voice options
...
- **Why use it:** Cute whale girl skin series, easy to customize DSH appearance.
...
- **Tags:** `theme`, `glass`, `ui`
- **Why use it:** Frosted glass transparent theme plugin
...
- **Why use it:** WebGPU ocean-themed browser extension skin
...
- **Tags:** `ai-guide`, `tutorial`, `resource`, `vibe-coding`
...
- **Why use it:** Beginner-friendly harness engineering tutorial from zero
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, GPU SSH, experiment tracking all in one
...
- **Why use it:** Cross-database academic search (PubMed, arXiv, CrossRef) with citations and MeSH support
...
- **Tags:** `awesome-list`, `handbook`, `runtime`
...
- **Why use it:** Industry research methods, chain mapping, policy tracking.
...
- **Why use it:** Searches 65K+ Chinese API docs instantly, zero config.
...
- **Why use it:** Verified plugin registry for DSH discovery and evaluation
...
- **Why use it:** Comprehensive curated resource list covering all DSH plugins and tools
...
- **Tags:** `stock`, `finance`, `quant`, `bilingual`
- **Why use it:** Bilingual curated stock/finance/quant plugin directory with 24 entries
...
- **Why use it:** Curated collection of useful DSH plugins for quick reference
...
- **Tags:** `plugin-directory`, `guide`, `navigation`
...
- **Why use it:** Zero-dependency static portal to browse and filter 227+ DSH plugins
...
- **Tags:** `pixel-art`, `mascot`, `gallery`, `fun`
- **Why use it:** Public animated pet gallery for AI coding agents
...
- **Why use it:** Curated awesome list covering DSH ecosystem plugins and tools.
...
- **Why use it:** Curated DSH plugin ecosystem index
...
- **Why use it:** Auto-curated DSH plugin directory with daily GitHub scanning and fake-tag filtering
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, curated plugins and practical tools
...
- **Why use it:** Learn DSH internals, browse plugin marketplace and explore best practices in one place
...
- **Why use it:** Curated list of DSH plugins, skills, MCP servers, patches and orchestrators with visualization
...
- **Tags:** `plugin-marketplace`, `catalog`, `api`
- **Why use it:** 11,000+ DSH plugins searchable with rankings, install commands and free public API
...
- **Why use it:** Official curated plugin list for exploring DSH ecosystem.
...
- **Why use it:** Curated collection of DSH plugins and resources.
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 精选DeepSeek Harness插件列表
...
- **Why use it:** 公开GitHub插件目录，含安装命令和生态发现
...
- **Why use it:** one-click Compact context button for the
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugin-list`, `awesome-list`
- **Why use it:** Curated list of DSH plugins for discovery

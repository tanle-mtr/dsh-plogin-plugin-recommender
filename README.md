...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 852,472 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-24 11:37:13 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 190,517 | Core harness powering the entire DSH plugin ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,954 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,230 | Multi-agent swarm orchestration with MCP support |
...
- **Tags:** `ai-agent`, `dsh-plugin`
- **Why use it:** Super AI assistant with multi-model and memory support
...
- **Tags:** `agent-runtime`, `ai-ide`, `vibe-coding`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop AI IDE.
...
- **Why use it:** Architecture-aware coding with baseline-first, drift-checked safety
...
- **Tags:** `vision-toolkit`, `computer-vision`, `ocr`
- **Why use it:** Powerful vision toolkit for text-only LLM agents: OCR, image Q&A, UI restore
...
- **Why use it:** Unifies Claude Code, Codex, Grok and DSH into one collaborative team
...
- **Why use it:** Dispatch work to DSH agents with native subagent progress tracking
...
- **Tags:** `development`, `plugin-dev`, `audit`
...
- **Why use it:** Practical DSH plugin dev guide covering real-world gotchas and fixes
...
- **Why use it:** Skills for scaffolding and testing DSH plugins from scratch
...
- **Why use it:** Hot-reload MCP and skill management without restart
...
- **Why use it:** Built-in GUI plugin/MCP/skill manager with hot reload
...
- **Why use it:** Pre-flight plugin check that auto-injects Top-K relevant plugins
...
- **Tags:** `desktop-companion`, `mcp`, `electron`
- **Why use it:** Desktop companion platform with animated pets and coding-agent integrations
...
- **Why use it:** Lightweight 5MB Tauri desktop app, zero setup, cross-platform
...
- **Tags:** `widget`, `desktop`, `utility`
- **Why use it:** Cute floating whale widget monitoring DeepSeek account balance
...
- **Why use it:** Local-first desktop workspace with projects, research, plugins and Office support
...
- **Tags:** `desktop`, `electron`, `client`
- **Why use it:** CodePilot-inspired cross-platform desktop client for DeepSeek Harness
...
- **Tags:** `canvas`, `workspace`, `visualization`
- **Why use it:** Visual non-linear canvas workspace with branching conversation explorer
...
- **Tags:** `desktop`, `gui`, `electron`, `ssh-client`
- **Why use it:** Full-featured Windows desktop GUI with SSH, mobile remote access
...
- **Tags:** `marketplace`, `web-gui`, `plugin`
...
- **Tags:** `web-gui`, `marketplace`, `plugin`
- **Why use it:** Community plugin market integrated into DSH Web GUI with one-click install
...
- **Why use it:** Electron desktop hub managing Harness/plugins/MCP/skills via tabs
...
- **Tags:** `ui`, `status-bar`, `pricing`
- **Why use it:** Persistent status bar showing provider, balance, and pricing info
...
- **Why use it:** Cross-platform desktop with DB, SSH, Docker + AI assistant
...
- **Tags:** `deepseek-harness`, `desktop-app`, `electron`
...
- **Tags:** `rag`, `dsh-plugin`
- **Why use it:** Open-source knowledge platform with RAG and self-maintaining wiki
...
- **Why use it:** Powerful memory management kit for AI agents with RAG support.
...
- **Tags:** `knowledge`, `encyclopedia`, `rag`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, MCP, RAG and agents
...
- **Tags:** `long-term-memory`, `mcp`, `recall`
...
- **Why use it:** Connects to PowerContext for recall and memory handoff
...
- **Why use it:** Multi-agent swarm orchestration with MCP support
...
- **Tags:** `code-review`, `agent-skills`, `architecture-review`
- **Why use it:** AI code review grounded in 12 classic engineering books with severity labels.
...
- **Why use it:** Organize AI conversations into reusable workflows across platforms
...
- **Tags:** `agentteams`, `multi-agent`, `workflow`
...
- **Why use it:** Local-first AI agent desktop with self-evolving skills and multi-model support
...
- **Tags:** `taskboard`, `agent`, `sqlite`
- **Why use it:** SQLite-backed task management with native Web UI and agent workflow
...
- **Why use it:** Dedicated agent workflow plugin for DeepSeek Harness
...
- **Why use it:** TDD, debugging and planning skills from obra/superpowers for DSH
...
- **Why use it:** 85 SKILL.md covering reverse engineering and pentesting
...
- **Why use it:** 88 skills for research, social intel, marketing and business workflows
...
- **Why use it:** Agent skill guiding standard DSH plugin development workflow
...
- **Tags:** `agent-skills`, `dsh-plugin`
- **Why use it:** Agent skill for managing DSH plugin slots, credentials and remotes
...
- **Why use it:** Cross-platform agent continuity memory for seamless session handoff
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer interface
...
- **Why use it:** Codex skill for automated code simplification adapted from DSH
...
- **Tags:** `chinese-traditional-wisdom`, `fengshui`, `iching`, `bazi`
...
- **Why use it:** Dedicated skills management plugin for organizing DSH agent capabilities
...
- **Tags:** `skills`, `agent-framework`, `cli`
- **Why use it:** Package manager with 42 skills and 5 CLIs for agent engineering
...
- **Tags:** `governance`, `swift-cycle`, `skills`
- **Why use it:** User-invoked, offline-verifiable Swift Cycle governance skill
...
- **Tags:** `document`, `gongwen`, `chinese`
- **Why use it:** Complete Chinese official document workflow per GB/T 9704 standard
...
- **Tags:** `engineering`, `discipline`, `workflow`
- **Why use it:** Engineering discipline skill for fact-finding and evidence-based work
...
- **Tags:** `canvas`, `creative`, `agentic-workflow`
- **Why use it:** Infinite canvas with creative agent skills for WeShop integration
...
- **Tags:** `skills`, `agent`, `gamification`
- **Why use it:** Game-like mission system to guide agent task execution
...
- **Tags:** `agent-skills`, `local-first`, `human-in-the-loop`
- **Why use it:** Local-first DSH-native run-to-skill conversion plugin
...
- **Tags:** `agent`, `agent-preset`, `product-management`
- **Why use it:** Virtual product team agent preset (PM/Eng/QA roles)
...
- **Tags:** `design-systems`, `dsh-plugin`
- **Why use it:** Open-source design tool with local-first desktop app
...
- **Tags:** `diagram-as-code`, `dsh-plugin`
- **Why use it:** Agent skill for generating beautiful architecture and workflow diagrams
...
- **Tags:** `video-generation`, `tts`, `motion-graphics`
...
- **Why use it:** Preview, inspect and edit OpenPencil design documents in-chat
...
- **Why use it:** Legal litigation timeline and diagram visualization tool
...
- **Why use it:** 6 aesthetic design styles to avoid generic AI-looking websites
...
- **Why use it:** Free image reading and generation skills with auto vision transcription
...
- **Tags:** `ai-video`, `ai-image`, `multimedia`
- **Why use it:** DirectorX AI video/image/audio skills integrated into DSH
...
- **Tags:** `browser-extension`, `dsh-plugin`
- **Why use it:** Browser extension suite enhancing Gemini, Claude and ChatGPT
...
- **Tags:** `bilibili`, `content-discovery`, `ai-agent`, `privacy-first`
- **Why use it:** Local-first cross-platform content discovery agent from major Chinese platforms.
...
- **Why use it:** AI agents automate your logged-in browser seamlessly via CLI + extension
...
- **Why use it:** Live iOS Simulator and device automation with 22 agent control tools
...
- **Why use it:** Tabbit Playwright-based browser automation plugin for DeepSeek Harness
...
- **Why use it:** One-click multi-model switch for popular AI coding tools.
...
- **Tags:** `context`, `utility`, `dashboard`
- **Why use it:** Context insight dashboard and management with browser integration
...
- **Tags:** `oauth`, `subscription`, `provider`
- **Why use it:** OAuth login for ChatGPT, Claude and Grok subscriptions as DSH providers
...
- **Why use it:** Compatibility layer running Pi extensions as native DSH plugins
...
- **Why use it:** Smartisan-style notes app with Docker deployment and export
...
- **Tags:** `crash-recovery`, `undo`, `backup`
- **Why use it:** Crash-rescue with undo, snapshots, SAFE MODE and offline CLI/GUI
...
- **Why use it:** Plugin management console and official dev guide for DSH
...
- **Why use it:** Run multiple isolated DSH containers with embedded WebView UI
...
- **Tags:** `config-manager`, `backup`, `restore`, `webdav`
...
- **Tags:** `skills-mcp-manager`, `web-gui`, `plugin`
- **Why use it:** Web GUI plugin for managing skills and MCP servers in DSH settings
...
- **Why use it:** Real-time token usage charts and API balance monitoring
...
- **Why use it:** Diagnoses and resolves plugin version conflicts
...
- **Why use it:** Whale Girl character skin series for DeepSeek Harness customization.
...
- **⭐ Stars:** 377
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、���景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `glass`, `ui`
- **Why use it:** Frosted glass UI theme with fully customizable transparency effects
...
- **Why use it:** Stunning WebGPU ocean-themed visual skin for DSH interface
...
- **Tags:** `theme`, `skin`, `ui`
- **Why use it:** 34 opencode classic themes one-click applied, persists across restarts
...
- **Tags:** `deepseek`, `deepseek-harness`, `dsh-plugin`, `webui`
- **Why use it:** Custom background themes with image upload and preset atmospheres
...
- **Why use it:** Auto-searches 8 major Chinese platforms and generates citable research reports.
...
- **Why use it:** Auto-synced community plugin catalog updated every 4h
...
- **Tags:** `context`, `audit`, `ui`, `analysis`
- **Why use it:** Audit context injection costs, detect duplicates and conflicts in AGENTS.md
...
- **Why use it:** Interactive K-line analysis with multi-market support and indicators
...
- **Tags:** `math-modeling`, `skills`, `preset`
...
- **Tags:** `deepseek-harness`, `discoverability`, `search`
- **Why use it:** Search npm and curated lists for DSH plugin discovery
...
- **Why use it:** Harness engineering beginner tutorial, f
...
- **Why use it:** One portable memory layer for every AI a
...
- **Why use it:** Self-evolving memory OS for LLM & AI Age
...
- **Why use it:** ✨ All your agents and workspaces in one 
...
- **Why use it:** dsh-routing-suite — injector + router-st
...
- **Tags:** `cordis`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-web`, `dsh-web-ui`
- **Why use it:** DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件
...
- **Why use it:** Agent OS: the agent gets smarter on its 
...
- **Why use it:** The world's first open-source AI-native 
...
- **Why use it:** Enterprise-grade, local-first Agent Work
...
- **Why use it:** A public gallery of animated pets for Co
...
- **Why use it:** The World's First Unified Virtual Filesy
...
- **Tags:** `toy`, `web`, `entertainment`
- **Why use it:** Web simulation of a traditional Chinese bamboo dragon toy. Fun and lightweight.
...
- **Tags:** `awesome-list`, `plugin-registry`, `automation`
- **Why use it:** Comprehensive curated plugin registry with real installation testing
...
- **Why use it:** Curated DSH plugin ecosystem list covering agents and developer tools
...
- **Tags:** `awesome-list`, `ecosystem`, `mcp`
- **Why use it:** Curated DSH ecosystem plugins, tools, and infrastructure index
...
- **Why use it:** Curated bilingual DSH plugins and extensions reference list
...
- **Tags:** `awesome-list`, `discovery`, `curation`
- **Why use it:** Daily-curated plugin discovery with scenario-based classification and rankings
...
- **Why use it:** Learn DSH principles, explore the plugin marketplace and best practices
...
- **Tags:** `guide`, `resources`, `awesome-list`
- **Why use it:** Ultimate bilingual DSH guide with quickstart, resources and curated plugins
...
- **Tags:** `awesome-list`, `catalog`, `dsh-plugins`
- **Why use it:** Comprehensive curated catalog of all DSH ecosystem resources
...
- **Tags:** `marketplace`, `plugin-store`, `registry`
- **Why use it:** Largest plugin marketplace with 3100+ plugins and free public API
...
- **Why use it:** Curated awesome list of all DSH ecosystem plugins and resources
...
- **Tags:** `awesome-list`, `dsh-plugins`, `community`
...
- **Tags:** `community`, `photo-wall`, `github-oauth`
- **Why use it:** DSH community group photo wall with GitHub OAuth and polaroid-style snapshots
...
- **Why use it:** Public GitHub directory with install commands and ecosystem map
...
- **Tags:** `awesome-list`, `curated`, `guide`
- **Why use it:** Curated verified plugin directory with installation guidance
...
- **Tags:** `registry`, `plugin-registry`, `curated`
- **Why use it:** Spam-filtered open-data plugin and skill registry
...
- **Why use it:** Curated quality-checked plugin list for DSH 2026
...
- **Why use it:** Plugin directory with scenario-based selection and risk info
...
- **Tags:** `deepseek-harness`, `plugin-portal`, `static-site`
- **Why use it:** Static web portal to browse and install 227+ DSH plugins
...
- **Why use it:** Redirect — moved to new repo
...
- **Tags:** `ai-agents`, `coding-agents`, `mcp`
...
- **Why use it:** Deekseek Harness Plugins
...
- **Why use it:** Evidence-led bilingual directory of DeepSeek Harness plugins, reviewed at immuta
...
- **Why use it:** A curated, evidence-aware shortlist of useful DeepSeek Harness plugins
...
- **Why use it:** Curated plugins for DeepSeek Harness (dsh) — install, extend, and customize mode
...
- **Why use it:** DSH plugins directory: 70+ verified DeepSeek Harness plugins, organized by what 
...
- **Why use it:** 计算机｜金融｜法律｜HR｜制造｜医疗｜电商等行业精选 dsh 插件目录
...
- **Why use it:** @dsh-pm/registry — discover dsh plugins by merging the awesome-dsh-plugin list, 
...
- **Why use it:** dsh pm — discover, install, update, and manage dsh plugins from the CLI: multi-s

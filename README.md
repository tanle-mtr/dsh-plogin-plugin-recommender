...
|--------|-------|
| **Plugins tracked** | 195 |
| **Total community stars** | 916,346 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-30 22:33:31 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 204,649 | Core DSH platform — everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,831 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,830 | Multi-agent swarm meta-harness for autonomous work |
...
- **Tags:** `preset`, `harness`, `benchmark`
- **Why use it:** Minimal-to-full harness preset achieving 98/99 Project2 benchmark scores
...
- **⭐ Stars:** 40
- **Language:** Unknown
- **Description:** An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插件/服务/事件/工具/LLM 适配器/打包安装���标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any compatible agent.
- **Tags:** `plugin-dev`, `skill`, `tools`, `development`
- **Why use it:** Agent skill that guides DSH plugin development following official standards
...
- **Why use it:** Manage installed DSH plugins, slots and credentials easily.
...
- **Tags:** `plugin-creator`, `validation`, `scaffold`
- **Why use it:** Reusable skill to build and validate DSH and Cordis plugins.
...
- **Tags:** `conflict-resolution`, `tools`, `stable`
...
- **Tags:** `coding-agents`, `skills`
- **Why use it:** Curated plugins covering models, tools, sandboxes, and agent loops.
...
- **Tags:** `dsh-plugin`, `design-systems`, `figma-alternative`
...
- **Why use it:** Modern desktop wrapper making DSH plugins accessible on desktop.
...
- **Tags:** `web-ui`, `plugin-aggregator`, `ecosystem`
- **Why use it:** Web-based plugin ecosystem aggregator with workshop distribution
...
- **Tags:** `sidebar`, `ui`, `dsh`
- **Why use it:** Extensible sidebar with built-in file editor, terminal, Git, and agent pages
...
- **Why use it:** Modern task panel with flexible embedding and multi-agent support
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status, and flow streaming
...
- **Tags:** `desktop`, `tauri`, `user-friendly`
- **Why use it:** 5MB Tauri desktop app with zero setup and preset plugins
...
- **Why use it:** Interactive UI components rendered inline via custom fence syntax
...
- **Why use it:** CodePilot-inspired desktop client with plugin suite for all major OSes
...
- **Tags:** `desktop`, `windows`, `ssh`, `gui`
- **Why use it:** Full-featured Windows desktop client with SSH, mobile access, and plugins
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `office`
...
- **Why use it:** Self-hosted notepad with Smartisan aesthetics and social export
...
- **Why use it:** WorkBuddy-style skill picker for easy skill insertion in composer.
...
- **Tags:** `desktop`, `tauri`, `devops`
- **Why use it:** Tauri 2 desktop unifying DB, SSH, Docker + AI
...
- **Tags:** `desktop`, `electron`, `webui`
- **Why use it:** Electron desktop wrapper integrating DSH web service and plugins.
...
- **Tags:** `memory`, `rag`, `markdown`, `portable`
- **Why use it:** Portable, Markdown-native memory layer for persistent agent recall
...
- **Tags:** `memory`, `rag`, `self-evolving`, `token-saving`
...
- **Why use it:** Purpose-built memory management kit for AI agents with RAG support
...
- **Why use it:** Best context management and insight dashboard for DSH
...
- **Tags:** `rag`, `skills`, `retrieval`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into retrievable, evaluated skill corpora
...
- **Why use it:** Unified agent workspace with cross-device task tracking and orchestration
...
- **Tags:** `agent-os`, `loop-engineering`, `self-evolving`
- **Why use it:** Self-improving Agent OS with loop-engineering and continuous self-evolution
...
- **Why use it:** Enterprise multi-engine agent workbench with unified team workspace
...
- **Tags:** `agent-skills`, `cognitive`, `research`
...
- **Tags:** `workflow`, `organization`, `productivity`
- **Why use it:** Turns AI conversations into reusable workflows across platforms
...
- **Tags:** `agent`, `task-management`, `taskboard`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `ai-agents`, `creative-writing`, `deepseek-harness`, `dsh-plugin`, `oh-story`
- **Why use it:** Powerful novel writing and short-drama production skill for DSH
...
- **Tags:** `ai-agents`, `skill`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Full-stack auto math modeling skill with GitOps pipeline and self-verification
...
- **Tags:** `agent-review`, `self-evolving`, `deepseek-harness`, `dsh-plugin`, `prompt-engineering`
- **Why use it:** Enables composable, reviewable agent self-evolution with task controls
...
- **Tags:** `agent`, `skills`, `architecture`, `deepseek-harness`, `dsh`
- **Why use it:** Turn experience into repeatable cross-agent execution skills
...
- **Tags:** `agent-skills`, `multimodal`, `vision`, `deepseek`, `claude-code`
- **Why use it:** Adds multimodal vision for screenshots, UI and chart analysis to LLMs
...
- **Tags:** `plugin-discovery`, `agent-skills`, `deepseek-harness`
- **Why use it:** Essential skill for discovering and installing DSH plugins quickly
...
- **Why use it:** Powerful TDD, debugging and planning skills for developers
...
- **Tags:** `reverse-engineering`, `security`, `pentest`, `ctf`
- **Why use it:** Complete reverse engineering skill set for security research and pentesting
...
- **Why use it:** Popular Superpowers skill adapted for Reasonix coding harness
...
- **Tags:** `agent-skills`, `research`, `marketing`, `cross-compatible`
- **Why use it:** 88 cross-compatible agent skills for research, marketing, and business workflows
...
- **Tags:** `skill`, `mentor`, `coding`, `education`
- **Why use it:** AI coding mentor skill that guides step-by-step project development
...
- **Why use it:** Portable spec-driven coding skill following DSH patterns.
...
- **Tags:** `skills-deck`, `task-board`, `agent-skills`
- **Why use it:** Visual task board bringing MattSkillsDeck into DSH.
...
- **Why use it:** Official DSH plugin dev docs as on-demand agent skill.
...
- **Why use it:** Unique Bazi/Fengshui/I Ching agent skill with local engine.
...
- **Tags:** `gongwen`, `docx`, `office`, `chinese-docs`
...
- **Why use it:** Cross-platform agent continuity memory for seamless handoffs.
...
- **Tags:** `codex`, `skill`, `code`
- **Why use it:** Adapted Codex skill for automated code simplification
...
- **Tags:** `agent`, `skills`, `database`
- **Why use it:** 42-agent asset package manager with CLI and database skills
...
- **Tags:** `governance`, `skill`, `swift`
- **Why use it:** Version-pinned offline-verifiable governance skill adapter
...
- **Why use it:** Free image reading, generation and vision transcription skills
...
- **Why use it:** Professional QA skill framework for AI agents
...
- **Why use it:** Godot 4.x game dev skill for DSH agents
...
- **⭐ Stars:** 14
- **Language:** JavaScript
- **Description:** 改配置+重���才能加 MCP？DeepSeek Harness (DSH) 插件「技能配置」解决：设置页粘贴 JSON 即连 MCP 服务器、热加载免重启；上传 zip/.skill 自动识别 SKILL.md，创建/编辑/启停技能，即点即用
- **Tags:** `skill-mgmt`, `mcp`, `hot-reload`
- **Why use it:** Hot-reload skill config with MCP server integration
...
- **Why use it:** WeShop native plugin with infinite canvas skills
...
- **Why use it:** Virtual product team agent preset for guided PM-to-Release workflows.
...
- **Why use it:** OAuth-bind ChatGPT accounts to chat with models inside DSH.
...
- **Why use it:** Enables plugin search and discovery inside DSH agents.
...
- **Tags:** `dsh-plugin`, `diagram-as-code`, `agent-skills`
...
- **Tags:** `dsh-plugin`, `skills`, `workflow-automation`
- **Why use it:** 530+ industrial-grade image generation prompts with templates.
...
- **Why use it:** Native design studio for AI-generated PPTs and visual prototypes
...
- **Tags:** `image-generation`, `visual`, `multi-model`
...
- **Tags:** `design`, `openpencil`, `ui-design`, `dsh-plugin`
- **Why use it:** Preview and edit OpenPencil designs directly inside conversations
...
- **Why use it:** Legal timeline and case diagram generator for litigation documentation
...
- **Why use it:** Enables text-only models to read images via OCR and scanning.
...
- **Why use it:** AI video/image/audio generation with storyboard and corpus tools
...
- **Tags:** `content-discovery`, `ai-agent`, `web`
- **Why use it:** Self-evolving AI agent discovering content across 8+ Chinese and global platforms
...
- **Why use it:** Let AI use your logged-in browser seamlessly without interruption
...
- **Why use it:** Free web search bridge for models lacking native browsing access
...
- **Tags:** `ios`, `automation`, `mobile`, `simulator`
- **Why use it:** Live iOS Simulator and device automation with 22 agent tools in-chat
...
- **Why use it:** Playwright-based browser automation for DSH with Tabbit integration
...
- **Why use it:** DingTalk IM channel with agent capabilities and emotion read.
...
- **Why use it:** Runtime injector and task-aware router for intelligent request routing
...
- **Why use it:** Unified virtual filesystem providing persistent cross-agent data storage
...
- **Tags:** `model-switch`, `coding-agent`, `utility`
- **Why use it:** One-click install and model switching across major coding agents
...
- **Tags:** `marketplace`, `dsh`, `utility`
- **Why use it:** Built-in visual plugin marketplace with search and one-click installation
...
- **Tags:** `ecosystem`, `plugin-registry`, `automation`
- **Why use it:** Auto-discovers 15900+ plugins with k8s-level testing pipeline
...
- **Tags:** `cost-tracking`, `deepseek-api`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Track session/daily costs, budget, and token usage across providers
...
- **Tags:** `compatibility-layer`, `migration`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Bridges Pi ecosystem into DSH via ABI compatibility layer
...
- **Why use it:** Seamlessly migrate sessions across different DSH presets
...
- **Why use it:** One-click browse and install all DSH plugins from Web GUI
...
- **Why use it:** Crash recovery with snapshots and one-click SAFE MODE
...
- **Why use it:** Secure P2P remote access to DSH from any device
...
- **Tags:** `api`, `documentation`, `chinese-platforms`, `utility`
- **Why use it:** Search 65,600+ Chinese platform API docs directly in DSH without config
...
- **Tags:** `infrastructure`, `registry`, `plugin-management`
- **Why use it:** Core infrastructure: thin console for official plugin registry management
...
- **Tags:** `config`, `backup`, `sync`, `migration`
- **Why use it:** Backup, restore, sync and migrate complete DSH configurations via WebDAV
...
- **Tags:** `container`, `multi-version`, `management`
...
- **Tags:** `config-sync`, `mcp`, `multi-agent`
...
- **Why use it:** Audits DSH context tokens, detects duplicates and conflicts
...
- **Tags:** `migration`, `utility`, `claude-code`
- **Why use it:** Seamless migration from Claude Code to DSH
...
- **Tags:** `plugin-dev`, `audit`, `portable`
...
- **Tags:** `analytics`, `tokens`, `monitoring`
...
- **Tags:** `mascot`, `pixel-art`, `ui`, `themes`
- **Why use it:** Animated pet gallery that personalizes coding agent interfaces
...
- **⭐ Stars:** 393
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套��� DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glass-effect`
- **Why use it:** Frosted glass theme with full customization, no source code modification needed
...
- **Tags:** `chrome-extension`, `ocean-skin`, `theme`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `theme`, `dark-mode`, `palette`
- **Why use it:** 34 opencode classic color themes with one-click application
...
- **Why use it:** Customizable web background with presets and image upload support.
...
- **Tags:** `tutorial`, `harness`, `learning`
...
- **Why use it:** Curated plugin directory, essential for discovering DSH tools
...
- **Tags:** `research`, `skill`, `china`
- **Why use it:** Automatically searches 8 major Chinese platforms and generates citable research reports
...
- **Tags:** `curated-list`, `awesome`, `reference`
- **Why use it:** Curated collection of DSH plugins, tools and infrastructure
...
- **Why use it:** Daily automated curation filtering spam, helping find right plugins quickly
...
- **Why use it:** Comprehensive DSH principles guide and best practices resource
...
- **Tags:** `agent`, `awesome-list`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `agent-framework`, `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Curated list covering plugins, MCPs, orchestrators, UIs and patches
...
- **Tags:** `academic-search`, `arxiv`, `mcp`, `research-workflow`
- **Why use it:** Comprehensive academic search with citation graph and verification
...
- **Why use it:** Patent infringement analysis with competitive reports; works as standalone skill
...
- **Why use it:** Methodology skills and news/policy tracking for industry research
...
- **Why use it:** Curated stock/finance plugins for DSH with 24 verified entries.
...
- **Tags:** `industry-plugins`
- **Why use it:** Industry-specific plugins for computing, finance, legal, healthcare.
...
- **Why use it:** Privacy-first resume builder, free and self-hosted.
...
- **Why use it:** [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-nativ
...
- **Tags:** `armor-breaking`, `rate-limit`, `specialized`
- **Why use it:** Specialized armor-breaking plugin for DeepSeek rate limits
...
- **Tags:** `awesome-list`, `plugins`, `bilingual`
- **Why use it:** Curated DSH plugin list with bilingual entries for quick discovery
...
- **Tags:** `encyclopedia`, `resources`, `learning`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MCPs, and learning paths
...
- **Tags:** `awesome-list`, `catalog`, `dsh-plugin-market`, `plugin-directory`
- **Why use it:** Massive plugin marketplace hub with 11,000+ plugins and search API
...
- **Tags:** `deepseek-harness`, `deepseek-harness-plugin`, `plugin-marketplace`
- **Why use it:** DeepSeek Harness plugin marketplace and hub collection
...
- **Tags:** `anime`, `bangumi`, `torrent`, `dsh-plugin`
- **Why use it:** Fun anime search plugin with Bangumi ratings and magnet support
...
- **Why use it:** Curated awesome list of all DSH community plugins
...
- **Why use it:** Curated plugin catalog and resource directory for DSH ecosystem
...
- **Why use it:** Community-maintained auto-syncing plugin catalog for DSH ecosystem
...
- **Why use it:** Creative community photo wall with OAuth login
...
- **Why use it:** Curated directory of DSH plugins
...
- **Why use it:** Public GitHub directory for DSH ecosystem discovery
...
- **Why use it:** Spam-filtered open-data registry of DSH plugins
...
- **Tags:** `awesome-list`, `2026`, `quality`
...
- **Why use it:** Comprehensive awesome list covering plugins, tools, skills & MCP.
...
- **Tags:** `collection`, `plugins`, `community`
...
- **Tags:** `verified`, `star-ranked`, `community`
...
- **Tags:** `guide`, `navigation`, `compatibility`
- **Why use it:** Plugin guide with scenario-based selection and compatibility info.
...
- **Why use it:** Complete 1000+ DSH tool inventory sorted by stars from GitHub topics.
...
- **Tags:** `marketplace`, `skills`, `plugins`
- **Why use it:** CodeX-style plugin marketplace for the DSH ecosystem.
...
- **Tags:** `dsh-plugin`, `dsh-repository-plugin`
- **Why use it:** General DSH plugin repository with ecosystem analytics focus.
...
- **Why use it:** Bilingual curated directory reviewed at immutable commits.
...
- **Tags:** `redirect`
- **Why use it:** Redirect notice — original moved elsewhere.
...
- **Why use it:** Auto-updating YAML-driven bilingual plugin directory.
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Basic DSH plugin collection page.

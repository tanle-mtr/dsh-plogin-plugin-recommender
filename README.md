...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 839,352 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 15:30:30 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,216 | Core plugin ecosystem framework for DeepSeek agent |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,640 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,961 | Multi-agent swarm orchestration with autonomous wo |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 41 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 17 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 11 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 33 plugins
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 17 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 26 plugins
- [Other](#other) — 18 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (41)
- [UI & Desktop Extensions](ui-desktop-extensions) (17)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (11)
- [Agent Skills & Workflows](agent-skills-workflows) (33)
...
- [Utilities & Infrastructure](utilities-infrastructure) (17)
- [Themes & Skins](themes-skins) (6)
- [Research & Analysis](research-analysis) (26)
- [Other](other) (18)
---
...
- **Why use it:** Core plugin ecosystem framework for DeepSeek agents
...
- **Tags:** `dsh-plugin`, `harness-engineering`, `tutorial`
- **Why use it:** Best beginner guide from 0 to 1 for DSH harness engineering.
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `dsh-plugin`
- **Why use it:** Unified agent workspace with cross-device access and task board.
...
- **Why use it:** Self-improving agent OS with grading and loop-engineering capabilities.
...
- **Tags:** `preset`, `standard`, `harness`, `dsh-plugin`
- **Why use it:** Two-phase preset bootstrap achieving Project2 98/99 Standard tools rating.
...
- **Tags:** `vfs`, `agent-tools`, `sandbox`, `mcp`
- **Why use it:** Unified virtual filesystem for AI agents across Bash, Python, and TypeScript.
...
- **⭐ Stars:** 3,549
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网��强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本模型外挂视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `multimodal`, `dsh-plugin`
- **Why use it:** First vision plugin for DSH — paste images and get structured JSON evidence.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `claude-code`, `codex`
- **Why use it:** One-click install and model switch across multiple coding agents
...
- **⭐ Stars:** 2,362
- **Language:** TypeScript
- **Description:** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时���态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **Tags:** `dsh-plugin`, `tui`, `terminal`, `coding-agent`
- **Why use it:** Claude Code-style TUI with whale topbar, real-time status, streaming thoughts
...
- **Tags:** `dsh-plugin`, `coding-agent`, `agentic-runtime`, `desktop`
- **Why use it:** Rust-based high-performance agent runtime paired with polished desktop app
...
- **Tags:** `dsh-plugin`, `code-review`, `static-analysis`, `clean-architecture`
...
- **Tags:** `coding-agents`, `architecture`, `spec-driven`
- **Why use it:** Architecture-aware coding with drift checking
...
- **Tags:** `agent`, `desktop-app`, `local-first`, `mcp`
...
- **Tags:** `ios`, `mobile-automation`, `simulator`, `coding-agent`
- **Why use it:** Live iOS Simulator and USB iPhone inside DSH conversation with 22 agent tools
...
- **Tags:** `coding`, `skills`, `superpowers`
- **Why use it:** Superpowers TDD and debugging skills ported to Reasonix harness.
...
- **Tags:** `agent-skills`, `dsh-plugin`, `skill`
- **Why use it:** Standard skill for developing DSH plugins from scratch
...
- **Tags:** `spec-programming`, `dsh-plugin`, `developer-tools`
- **Why use it:** Spec-driven development skill aligned with DSH patterns
...
- **Why use it:** Practical skill for managing plugin slots and credentials
...
- **Tags:** `dsh-plugin`, `knowledge-base`, `scaffold`
- **Why use it:** On-demand plugin dev knowledge base with EN/ZH docs
...
- **Why use it:** WorkBuddy-style skill picker integrated into DSH composer UI.
...
- **Why use it:** One-tap Codex migration with two-way skills and MCP sync.
...
- **Why use it:** Dedicated skills management plugin for organizing DSH agent skills.
...
- **Tags:** `mcp-manager`, `skills-manager`, `web-ui`
- **Why use it:** Web GUI plugin to manage skills and MCP servers from DSH settings page.
...
- **Tags:** `dev-guide`, `best-practices`, `documentation`
- **Why use it:** Practical plugin dev guide covering common pitfalls and best practices.
...
- **Why use it:** Agent skills for scaffolding and testing DSH plugins entirely inside DSH.
...
- **Why use it:** Pre-flight plugin check that injects top-K relevant plugins per task
...
- **Why use it:** AI-curated plugin list updated hourly with 190+ entries across 12 categories
...
- **Why use it:** DSH plugin ecosystem list with verify and analytics support
...
- **Tags:** `registry`, `plugin-manager`
- **Why use it:** Unified registry merging awesome list, GitHub search, and npm keywords with deduplication
...
- **Why use it:** CLI tool for discovering, installing, updating DSH plugins with multi-source search and audit
...
- **Tags:** `publisher`, `plugin`
- **Why use it:** One-click plugin publishing tool with validation and auto-generated repo descriptions
...
- **Why use it:** Modern desktop solution for DeepSeek Harness ecosystem
...
- **Tags:** `dsh-web-ui`, `themes`, `desktop`
- **Why use it:** Web GUI with task boards, remote SSH, Wallpaper Engine support and themes.
...
- **Tags:** `dsh-plugin`, `sidebar`, `ui`, `desktop-extension`
...
- **Why use it:** Cute desktop companion with plugin SDK support
...
- **Why use it:** Lightweight 5MB Tauri desktop app, zero setup
...
- **Tags:** `widget`, `ui`, `cute`
- **Why use it:** Adorable whale widget monitoring DeepSeek balance
...
- **Tags:** `desktop`, `local-first`, `mcp`
- **Why use it:** Local-first desktop workspace with MCP support
...
- **Tags:** `ui`, `interactive`, `charts`, `forms`
- **Why use it:** Inline interactive UI components: layouts, charts, forms, quizzes rendered in replies
...
- **Tags:** `desktop-app`, `electron`, `ui`, `cross-platform`
- **Why use it:** CodePilot-inspired desktop client for DSH on macOS, Windows and Linux
...
- **Why use it:** Unique canvas-based branching conversation workspace
...
- **Tags:** `task-management`, `ui`, `sqlite`
- **Why use it:** Native SQLite-backed taskboard with agent claim/review UI.
...
- **Why use it:** Electron desktop console for managing DSH, plugins, MCP
...
- **Why use it:** Persistent bottom bar showing provider, model, balance, and pricing info in real-time.
...
- **Why use it:** Floating HUD panel showing git status, MCP servers, skills, and tokens
...
- **Tags:** `desktop`, `ssh`, `docker`
- **Why use it:** Cross-platform desktop integrating DB, SSH, Docker, and AI assistant
...
- **Why use it:** Electron desktop shell integrating multiple DSH plugins and web UI
...
- **Why use it:** LLM knowledge platform with RAG, reasoning agent and auto-wiki
...
- **Tags:** `agent-memory`, `rag`, `long-term-memory`, `dsh-plugin`
- **Why use it:** Local-first portable memory layer, user-owned and self-evolving across apps.
...
- **Tags:** `agent-memory`, `rag`, `token-savings`, `dsh-plugin`
...
- **Why use it:** Unlimited memory for agents with persistent storage
...
- **Why use it:** Context dashboard and statistics management
...
- **Tags:** `knowledge-base`, `rag`, `encyclopedia`
- **Why use it:** Comprehensive AI knowledge encyclopedia with RAG, MCP, skills and learning paths
...
- **Tags:** `rag`, `skill`, `embeddings`, `retrieval`
- **Why use it:** Turn scattered SKILL.md files into searchable, eval-ready corpora.
...
- **Tags:** `deepseek-harness`, `memory`
- **Why use it:** Connects PowerContext server for memory recall and handoff
...
- **Why use it:** Bridges Claude Code memory, skills, and config into DSH ecosystem
...
- **Tags:** `ai-persona`, `skill-generator`, `digital-human`
- **Why use it:** Digital life persona skill preserving memories through AI
...
- **Tags:** `routing`, `cordis`, `dsh-plugin`, `skills`
- **Why use it:** Task-aware reasoning-mode router with runtime injector for intelligent routing.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `cognitive-enhancement`
...
- **Tags:** `agent-skills`, `dsh-plugin`, `workflow-automation`, `vibe-coding`
- **Why use it:** Auto-routes and intelligently orchestrates harness workflows and skills
...
- **Tags:** `dsh-plugin`, `video-generation`, `agent-skill`, `ffmpeg`
- **Why use it:** End-to-end automated Vox-style paper-collage explainer video generation from one topic
...
- **Why use it:** Vision toolkit for text-only LLMs with image Q&A
...
- **Tags:** `task-manager`, `human-in-loop`, `self-hosted`
- **Why use it:** Self-hosted human-in-loop task manager for agents
...
- **Tags:** `workflow`, `browser-extension`, `productivity`
- **Why use it:** Organize AI conversations into reusable workflows
...
- **Tags:** `vision`, `ocr`, `dsh-native`
- **Why use it:** Native DSH vision toolkit with OCR and screenshot
...
- **Tags:** `agent`, `team`, `automation`, `multi-agent`
- **Why use it:** Turns multiple coding agents into one coordinated team with cross-session dispatch
...
- **Why use it:** Turn experience into repeatable AI execution workflows
...
- **Why use it:** Adds multimodal vision analysis to text-only LLM agents
...
- **Tags:** `skills`, `plugin-discovery`, `automation`
- **Why use it:** Automates plugin discovery, installation and verification
...
- **Tags:** `anime`, `skill`, `search`
- **Why use it:** Fun anime search skill with Bangumi ratings and magnet links
...
- **Tags:** `writing`, `creative`, `skill`
- **Why use it:** Creative writing and short-drama production skill suite
...
- **Why use it:** Specialized skills for AI infra dev: write, optimize, debug systems.
...
- **Tags:** `skills`, `tdd`, `superpowers`
- **Why use it:** TDD, debugging, planning, and collaboration skills for DSH agents.
...
- **Why use it:** Complete reverse-engineering and pentesting skill pack
...
- **Why use it:** AI mentor that guides you through coding with code review
...
- **Tags:** `agent-skills`, `research-tools`, `skill-md`
- **Why use it:** 88 open-source skills for research, marketing, social intel
...
- **Why use it:** Enables cross-platform agent handoff with local continuity memory.
...
- **Why use it:** Codex-adapted skill for automated code simplification workflows.
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `skill`
- **Why use it:** Fusion Bazi/Fengshui/IChing agent skill with local deterministic engine and dashboard.
...
- **Tags:** `image-generation`, `vision`, `skill`
- **Why use it:** Free image reading and generation via vision models for DSH agents.
...
- **Tags:** `governance`, `swift-cycle`, `agent-skills`
- **Why use it:** Swift Cycle governance skill adapter, version-pinned and offline-verifiable.
...
- **Tags:** `gongwen`, `docx`, `word-processing`
- **Why use it:** Full workflow tool for Chinese official documents with format validation and optimization.
...
- **Tags:** `engineering`, `discipline`, `agent-skill`
- **Why use it:** Engineering discipline distilled from DSH — fact-finding and evidence-based decisions.
...
- **Tags:** `canvas`, `creative`, `we shop`
- **Why use it:** Native WeShop plugin enabling infinite canvas with creative agent skills.
...
- **Tags:** `math`, `skills`
- **Why use it:** Math modeling suite with 17 manual skill cards and presets
...
- **Why use it:** Godot Engine 4.x game dev skill with GDScript support
...
- **Why use it:** Virtual product team agent preset for role-playing PM-to-engineer workflows
...
- **Why use it:** Hot-reload MCP servers and skill management without config restarts
...
- **Tags:** `ai-agents`, `chatgpt`, `oauth`, `subscription`
- **Why use it:** OAuth bind ChatGPT account to chat with ChatGPT models inside DSH
...
- **Why use it:** Open-source Claude Design alternative with local-first desktop
...
- **Tags:** `gpt-image-2`, `prompt-engineering`, `image-generation`
- **Why use it:** 470+ reverse-engineered GPT-Image2 prompts with industrial templates.
...
- **Why use it:** AI-powered design studio with PPT generation, prototyping and template marketplace
...
- **Why use it:** Direct AI image generation integrated into DSH conversations
...
- **Why use it:** Preview and edit OpenPencil designs directly in DSH conversations.
...
- **Why use it:** Generate litigation timelines and legal diagrams from cases
...
- **Why use it:** Adds vision/OCR capabilities to text-only DSH models
...
- **Tags:** `design`, `ui`, `vibe-coding`, `web-design`
- **Why use it:** 6 design style presets to keep vibe-coded websites polished and professional.
...
- **Why use it:** AI video/image/audio creation with storyboard and configurable vision model tools.
...
- **Why use it:** Enhancement suite for Gemini, Claude, ChatGPT browser UIs
...
- **Tags:** `ai-agent`, `bilibili`, `dsh-plugin`, `cross-platform`
- **Why use it:** Local-first cross-platform AI content discovery agent from Bilibili, YouTube, Reddit etc.
...
- **Tags:** `dsh-plugin`, `browser-automation`, `agent`, `tencent`
...
- **Why use it:** Chrome sidebar for direct browser control without vision capabilities needed
...
- **Why use it:** Tabbit Browser automation plugin using Playwright for DSH.
...
- **Tags:** `record-replay`, `workflow`, `automation`
...
- **Why use it:** GitHub OAuth photo wall for DSH community event memories.
...
- **Tags:** `dsh-plugin`, `marketplace`, `utility`, `plugin-management`
- **Why use it:** Visual plugin marketplace for browsing, searching and one-click installing DSH plugins
...
- **Tags:** `dsh-plugin`, `awesome-list`, `plugin-registry`, `discovery`
- **Why use it:** Plugin radar with 9000+ auto-discovered candidates and real-installation tested top 50 picks
...
- **Why use it:** OAuth login to use ChatGPT, Claude and Grok subscriptions as DSH LLM providers
...
- **Tags:** `web-search`, `utility`, `free`
- **Why use it:** Free no-signup web search bridge plugin for models lacking native web access
...
- **Tags:** `cost`, `utility`, `tracking`
- **Why use it:** Essential cost tracking for session and budget management
...
- **Why use it:** Bridges Pi ecosystem extensions to run natively on DSH
...
- **⭐ Stars:** 150
- **Language:** TypeScript
- **Description:** 开源���锤子便签，复刻锤科美学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **Tags:** `notes`, `utility`, `productivity`
- **Why use it:** Smartisan-style note-taking with Docker and WeChat export
...
- **Tags:** `backup`, `rollback`, `utility`
- **Why use it:** Crash-rescue with one-click rollback and safe-mode recovery.
...
- **Tags:** `migration`, `session`, `utility`
- **Why use it:** Cross-preset session migration preserving state and context.
...
- **Why use it:** Zero-patch plugin management console for DSH ecosystem
...
- **Why use it:** Containerized multi-version DSH manager with WebView UI
...
- **Tags:** `package-manager`, `agent-framework`, `multi-tool`
- **Why use it:** Package manager for AI agent assets with 42 skills, 5 CLIs, and 1 plugin.
...
- **Tags:** `backup`, `config`, `migration`
- **Why use it:** Backup, restore, migrate and sync all DSH configs and plugins via WebDAV.
...
- **Why use it:** Fast, simple Neovim plugin manager — lightweight and elegant in Lua.
...
- **Tags:** `token-usage`, `data-visualization`
- **Why use it:** Real-time token usage tracking, cost estimates, and API balance charts
...
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness-plugin`
...
- **Tags:** `mascot`, `themes`, `pixel-art`, `dsh-plugin`
- **Why use it:** Public gallery of animated mascot pets for multiple agent harnesses.
...
- **Tags:** `dsh-plugin`, `theme`, `skin`, `customization`
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness visual customization
...
- **⭐ Stars:** 370
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶��、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glass-effect`
- **Why use it:** Frosted glass UI theme with fully customizable blur and wallpaper settings
...
- **Why use it:** Beautiful WebGPU ocean-themed visual customization for DSH
...
- **Why use it:** 34 opencode themes like tokyonight and dracula, one-click switch with persistence.
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支��细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `background`
- **Why use it:** Custom background images and preset atmospheres for DSH web UI
...
- **Tags:** `ai-resources`, `vibe-coding`, `tutorial`
...
- **Tags:** `dsh-plugin`, `research`, `web-search`, `china`
- **Why use it:** Searches 8 major Chinese platforms for last 30 days content, generates cited research reports
...
- **Why use it:** Curated bilingual plugin directory covering tools, skills, clients and integrations
...
- **Tags:** `awesome-list`, `discovery`, `verification`
- **Why use it:** Daily auto-scraped plugin finder with manual verification and transparent blacklist
...
- **Tags:** `education`, `guide`, `best-practices`
- **Why use it:** Learn DSH principles, plugin marketplace navigation and best practices
...
- **Tags:** `guide`, `quickstart`, `awesome-list`
- **Why use it:** Ultimate DSH quickstart guide with curated plugins and practical tool recommendations
...
- **Why use it:** Auto-synced curated plugin catalog, saves discovery time
...
- **Why use it:** Search 65k+ Chinese API docs across 20 platforms instantly
...
- **Why use it:** Official auto-generated curated plugin index by cordis.run
...
- **Why use it:** Audits context injection costs, detects duplicates and conflicts via Web UI.
...
- **Tags:** `kline`, `analysis`, `technical-indicators`
...
- **Why use it:** Curated directory with verified plugins and permission-aware guidance
...
- **Why use it:** Curated vertical list of 24 stock/finance/quant plugins, bilingual
...
- **Why use it:** Curated quality-checked plugin list for 2026 DSH ecosystem
...
- **Why use it:** Community-curated collection of useful DeepSeek Harness plugins
...
- **Tags:** `awesome-list`, `plugin-directory`, `deepseek-harness`
- **Why use it:** Plugin navigation guide with scenario-based selection and risk info
...
- **Tags:** `awesome-list`, `ai-agents`, `deepseek-harness`
...
- **Why use it:** Zero-dependency static portal for browsing and installing 227+ plugins
...
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Archived — redirected to github.com/awesome-dsh-plugin/awesome-dsh-plugin
...
- **Tags:** `ai-agents`, `awesome-list`, `dsh-plugin`
...
- **Why use it:** Auto-crawled bilingual plugin catalog via daily GitHub Actions
...
- **Why use it:** In-agent plugin search across npm and curated awesome-dsh-plugin list
...
- **Tags:** `industry`, `awesome-list`
- **Why use it:** Industry-specific plugins for finance, legal, healthcare, e-commerce and more
...
- **Tags:** `resume-builder`, `self-hosted`, `javascript`
- **Why use it:** Privacy-first resume builder, completely free and self-hosted
...
- **Why use it:** Curated plugin directory — the essential starting point for DSH discovery.
...
- **Why use it:** Enterprise-grade, local-first Agent Workbench for people and agent teams. A unif
...
- **Tags:** `dsh-plugin`, `fun`, `traditional-toy`, `single-file`
- **Why use it:** Single-file web sim of a traditional Chinese toy with real audio samples
...
- **Tags:** `awesome-list`, `ecosystem`, `resources`
- **Why use it:** Curated plugin ecosystem list for DSH
...
- **Why use it:** Comprehensive curated DSH plugin and tool list
...
- **Why use it:** Curated ecosystem resource list for DSH plugin discovery
...
- **Why use it:** Massive 3100+ plugin marketplace with search and API
...
- **Why use it:** Plugin marketplace and collection for DSH ecosystem
...
- **Why use it:** One-click browse, install, and update all DSH plugins via web GUI.
...
- **Tags:** `marketplace`, `webui`, `community`
- **Why use it:** Community plugin marketplace integrated into DSH Web GUI.
...
- **Why use it:** Curated resource list of DSH plugins, tools, and extensions.
...
- **Why use it:** Curated directory of 280+ DSH plugins across 14 categories, easy discovery.
...
- **Why use it:** Public GitHub directory for discovering DSH plugins, install commands and ecosystem.
...
- **Why use it:** Curated list of essential DSH plugins — a hand-picked discovery resource.
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Simple DSH plugin collection

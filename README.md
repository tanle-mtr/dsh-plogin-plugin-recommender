...
|--------|-------|
| **Plugins tracked** | 195 |
| **Total community stars** | 912,612 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-30 10:30:30 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 204,027 | Core plugin harness for the entire DSH ecosystem |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,712 | Local-first AI design tool, Figma alternative for  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,768 | Meta-harness for multi-agent swarms and autonomous |
...
- [Research & Analysis](#research-&-analysis) — 36 plugins
...
- [Research & Analysis](research-analysis) (36)
- [Other](other) (18)
---
...
- **Why use it:** Core plugin harness for the entire DSH ecosystem
...
- **Tags:** `no-code`, `low-code`, `dsh-plugin`, `workflows`
...
- **Tags:** `agent-orchestration`, `no-code`, `mcp`, `tool-use`
- **Why use it:** Unified agent workspace across desktop, mobile, browser with task boards.
...
- **Why use it:** Self-improving agent OS with loop engineering and evaluation framework.
...
- **Why use it:** Enterprise multi-agent workspace supporting Codex, DSH, and OpenCode.
...
- **Why use it:** AI-powered code review with engineering book citations and fix suggestions
...
- **Why use it:** Context management dashboard and insights for DSH sessions
...
- **Why use it:** Vision toolkit for text-only models: OCR, screenshot analysis, image Q&A
...
- **Why use it:** AI security audit tool detecting hallucinated packages and missing safeguards in generated code.
...
- **Tags:** `dsh-plugin`, `dev-tools`, `agent-skills`
...
- **Why use it:** Centralized local skill management for DSH agents
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge between Codex and DSH with live sync
...
- **Tags:** `package-manager`, `skills`, `agents`
- **Why use it:** Full AI agent asset package manager with 42 skills
...
- **Tags:** `dsh-plugin`, `desktop`, `dsh-plugin-desktop`
...
- **Why use it:** Web-based plugin aggregator with creative workshop distribution.
...
- **Why use it:** Extensible sidebar with built-in file/terminal/git pages
...
- **Why use it:** Cute whale widget floating on DSH UI showing DeepSeek account balance
...
- **Why use it:** Live iOS Simulator and USB-connected iPhone automation with 22 agent tools inside DSH.
...
- **Why use it:** CodePilot-inspired cross-platform desktop client and plugin suite for DSH (macOS/Win/Linux).
...
- **Why use it:** Visual non-linear conversation canvas — branching workspace for exploring DSH sessions.
...
- **Tags:** `desktop-app`, `windows`, `ssh`
- **Why use it:** Open-source Windows desktop client with Codex, SSH, skills, and remote mobile access built in.
...
- **Why use it:** Brings spreadsheets, docs, slides, and tables into DSH as real office.
...
- **Why use it:** Self-hostable note-taking app with export and WeChat article support
...
- **Why use it:** Persistent bottom bar showing model, balance and live pricing
...
- **Why use it:** Context injection audit with Web UI ring panel
...
- **Why use it:** Hot-reload MCP server via config page; no restart needed
...
- **Why use it:** Real-time token usage charts and cost estimates in DSH web UI
...
- **Why use it:** Electron desktop wrapper for DSH web service with rich integrations
...
- **Tags:** `rag`, `knowledge-base`, `dsh-plugin`, `wiki`
...
- **Tags:** `long-term-memory`, `rag`, `self-evolving`, `token-savings`
...
- **Why use it:** Essential memory kit for agent persistence and refinement
...
- **Tags:** `skill-corpus`, `retrieval`, `semantic-search`
- **Why use it:** Turns SKILL.md files into retrieval-ready corpora with semantic search and evaluation tooling.
...
- **Tags:** `cordis`, `dsh-plugin`, `agent-skills`
- **Why use it:** Task-aware reasoning-mode router with injector for optimized agent routing.
...
- **Why use it:** Intelligent skill routing reduces tokens by 29.6% on benchmarks
...
- **Tags:** `cognition`, `skills`, `j-space`
- **Why use it:** Cognitive enhancement skills based on J-space global workspace theory
...
- **Tags:** `workflow`, `organization`, `cross-platform`
...
- **Why use it:** AI-powered novel and short-drama writing skill with creative tools.
...
- **Why use it:** Native SQLite-backed taskboard with Web UI, agent claim and review.
...
- **Tags:** `agent`, `math-modeling`, `gitops`
...
- **Why use it:** Discovers and installs GitHub plugins automatically via skill
...
- **Tags:** `agent`, `workflow`, `deepseek-harness`
- **Why use it:** Structured agent workflow plugin for DeepSeek Harness
...
- **Why use it:** Adapts TDD, debugging, planning skills from obra/superpowers
...
- **Why use it:** Port of Superpowers skill to Reasonix coding harness
...
- **Why use it:** 87 SKILL.md for reverse engineering and pentesting
...
- **Why use it:** 88 open-source agent skills for research and business
...
- **Why use it:** AI coding mentor skill: architecture scan, code review
...
- **Tags:** `plugin-mgmt`, `skills`, `credentials`
- **Why use it:** Manage DSH plugins, slots and credentials via agent skill
...
- **Why use it:** Visual task board that deploys MattSkillsDeck in DSH
...
- **Why use it:** Bazi, Fengshui, I Ching and TCM agent skill with local engine
...
- **Why use it:** Cross-platform agent handoff with repository-local session memory
...
- **⭐ Stars:** 26
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等���整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese-docs`
- **Why use it:** Full Chinese official document workflow compliant with GB/T 9704
...
- **Why use it:** Multi-agent team with shared workspace and independent configs
...
- **Tags:** `skill-generation`, `automation`
...
- **Why use it:** Comprehensive AI media creation toolkit with video/image/audio/skills
...
- **Why use it:** Professional QA testing skill framework for AI agents with 10 skills
...
- **Why use it:** Infinite canvas with agentic creative skills for WeShop integration
...
- **Tags:** `agent-tools`, `capability-index`, `plugin-selection`
...
- **Why use it:** Vision bridge plugin converting images to structured JSON for text-only agents.
...
- **Why use it:** Free web search bridge for models without native access — no signup or API key required.
...
- **Tags:** `academic-search`, `arxiv`, `mcp`, `semantic-scholar`
- **Why use it:** Cross-platform academic search via MCP with citation verification
...
- **Tags:** `deepseek`, `dsh-plugin`, `mcp`, `skills`
- **Why use it:** Web UI panel for managing skills and MCP integrations
...
- **Why use it:** Web GUI plugin card for managing skills and MCP servers
...
- **Why use it:** Local-first AI design tool, Figma alternative for agents
...
- **Why use it:** Agent skill for beautiful verifiable architecture and workflow diagrams
...
- **Why use it:** 530+ industrial image generation prompts with reusable skills
...
- **Tags:** `flutter`, `react`, `vibedesign`, `agent-team`
...
- **Why use it:** AI-powered design studio with visual editor and PPT creation for DSH
...
- **Why use it:** Generate images directly within DSH chats using Seedream and other AI image models.
...
- **Tags:** `design`, `openpencil`, `ppt`, `ui-design`
...
- **Why use it:** Pixel-to-text image reading and OCR for text-only models
...
- **Why use it:** 6 design style presets to avoid generic AI look
...
- **Why use it:** Browser extension suite for Gemini, Claude and ChatGPT with prompt management
...
- **Tags:** `bilibili`, `content-discovery`, `web-agent`
- **Why use it:** Cross-platform content discovery agent for Chinese and global platforms
...
- **Why use it:** Browser automation plugin for AI agents using real logged-in sessions
...
- **Tags:** `chat-bot`, `dingtalk`, `ai-agent`
...
- **Tags:** `dsh-plugin`, `self-hosted`, `resume-builder`, `mcp-server`
...
- **Tags:** `image-uploader`, `electron`, `dsh-plugin`, `s3`
...
- **Tags:** `vfs`, `agent-tools`, `dsh-plugin`, `python`
- **Why use it:** Unified virtual filesystem providing consistent file operations for agents.
...
- **Tags:** `deepseek`, `dsh-plugin`, `multi-model`
- **Why use it:** Multi-platform model switcher with one-click install
...
- **Why use it:** Official plugin marketplace with browse, search, one-click install
...
- **Why use it:** Bridge Pi extensions to run as native DSH plugins via ABI compatibility.
...
- **Tags:** `context-migration`, `cordis`, `deepseek-harness`, `session-migration`
- **Why use it:** Enables cross-preset session migration with preserved state
...
- **Tags:** `plugin-marketplace`, `deepseek-harness`, `nodejs`
- **Why use it:** Browse and install all GitHub dsh-plugin tagged plugins in one click
...
- **Why use it:** Crash recovery with undo and SAFE MODE even when DSH won't start
...
- **Tags:** `deepseek-harness`, `plugin-management`
- **Why use it:** Plugin ecosystem infrastructure: registry console + dev guide
...
- **Why use it:** Run multiple DSH versions in isolated containers with one-click UI
...
- **Why use it:** One-click MCP/Skills config sync for Claude, Codex, DSH and more
...
- **Tags:** `agent-migration`, `deepseek-harness`, `mcp`
- **Why use it:** Easily migrate Claude Code settings and skills to DeepSeek Harness
...
- **Tags:** `plugin-doctor`, `conflict-resolution`, `utility`
...
- **Why use it:** Enables in-agent npm and awesome-list plugin discovery and search.
...
- **Why use it:** Animated pet gallery adding personality to coding assistant interfaces.
...
- **Why use it:** Frosted glass theme with adjustable blur,磨砂 background, fully customizable.
...
- **Why use it:** 34 opencode classic color themes with one-click switch
...
- **Tags:** `ai`, `deepseek`, `mcp`, `rag`, `vibecoding`
...
- **Why use it:** Curated bilingual DSH plugin list with verified references and integrations.
...
- **Why use it:** Daily-curated plugin discovery with ratings, scene-based classification, and usage guides.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Essential DSH learning guide with plugin marketplace and best practices.
...
- **Why use it:** Ultimate DSH guide covering quickstart, resources, and curated plugins.
...
- **Why use it:** Curated list of DSH plugins, skills, MCP servers, and UI tools.
...
- **⭐ Stars:** 205
- **Language:** JavaScript
- **Description:** DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插��市场 / 插件商店：自动收集与格式校验，免费搜索 API。deepseek1024.com
- **Tags:** `marketplace`, `plugin-directory`, `registry`
- **Why use it:** 11,000+ plugin marketplace with search, rankings, and install commands.
...
- **Why use it:** Plugin marketplace listing for DeepSeek Harness ecosystem.
...
- **Why use it:** Search 65K+ Chinese platform API docs directly in agents
...
- **Tags:** `awesome-list`, `discovery`, `plugins`
...
- **Why use it:** Interactive multi-market K-line analysis with indicators
...
- **Why use it:** Comprehensive industry and company research methodology pack
...
- **Tags:** `awesome`, `stock`, `finance`, `quant`
- **Why use it:** Curated stock/finance plugin directory with 24 verified entries
...
- **Why use it:** Comprehensive awesome list covering plugins, tools, skills and resources
...
- **Tags:** `awesome-list`, `community`, `chinese`
...
- **Tags:** `portal`, `web`, `plugin-discovery`
...
- **Tags:** `awesome-list`, `comprehensive`, `catalog`
- **Why use it:** Complete 1000+ repo catalog sorted by stars from GitHub topic
...
- **Tags:** `marketplace`, `plugins`, `skills`
- **Why use it:** DSH plugin marketplace similar to CodeX store
...
- **Tags:** `dsh-bundle`, `dsh-plugins`
- **Why use it:** Community-curated DSH plugin repository covering ecosystem analytics.
...
- **Why use it:** Bilingual plugin directory reviewed at immutable commits for reliability.
...
- **Why use it:** 70+ verified DSH plugins organized by functional category.
...
- **Why use it:** Original awesome-dsh-plugins repo, now migrated to new location.
...
- **Why use it:** Auto-updating curated plugin list with bilingual README and Vercel site.
...
- **Tags:** `coding-agents`, `plugin-directory`, `ui`
- **Why use it:** Comprehensive curated plugins for models, tools, sandboxes, UI, and loops.
...
- **Why use it:** Evidence-aware shortlist of useful DSH plugins for quick reference.
...
- **Why use it:** Industry-specific DSH plugins for computing, finance, law, healthcare etc.
...
- **Why use it:** Curated plugin directory for quick DSH ecosystem discovery.
...
- **Why use it:** Web simulation of traditional Chinese toy with real recording
...
- **Tags:** `ecosystem`, `plugin-registry`, `radar`
- **Why use it:** Plugin ecosystem radar discovering and testing 15900+ candidate plugins
...
- **Tags:** `awesome-list`, `curated`, `directory`
- **Why use it:** Curated list of DSH plugins serving as a plugin ecosystem guide
...
- **Why use it:** Armor-breaking plugin for DeepSeek stable prompt stabilization
...
- **Tags:** `encyclopedia`, `resources`, `knowledge-base`
- **Why use it:** One-stop AI encyclopedia covering agents, RAG, multimodal tools, and learning roadmaps.
...
- **Tags:** `anime`, `bangumi`, `deepseek-harness`, `magnet`
...
- **⭐ Stars:** 97
- **Language:** JavaScript
- **Description:** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选维护的 DeepSeek Harness Cordis 插件官方自动生成列��。
- **Tags:** `awesome-list`, `plugin-catalog`
- **Why use it:** Official curated plugin list maintained by cordis.run
...
- **Why use it:** Curated list of DSH plugins, extensions and resources
...
- **Why use it:** Community-maintained DSH plugin catalog, auto-synced
...
- **Why use it:** DSH beta community group photo wall with OAuth login
...
- **Why use it:** Curated collection of DSH plugins for ecosystem discovery
...
- **Tags:** `awesome-list`, `plugin-catalog`
- **Why use it:** Unofficial community catalog for exploring DSH plugins

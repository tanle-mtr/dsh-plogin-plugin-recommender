...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 987,639 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-08 23:59:13 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 216,220 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,930 | Local-first AI design tool, Figma alternative for  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,677 | Multi-agent swarm meta-harness with autonomous wor |
...
- **Why use it:** Multi-agent swarm meta-harness with autonomous workflow coordination
...
- **Why use it:** Self-evolving multi-agent harness with memory, planning, and multi-model support
...
- **Why use it:** Task-aware reasoning-mode router for DSH runtime injection.
...
- **⭐ Stars:** 3,918
- **Language:** TypeScript
- **Description:** The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本模型外挂视觉能力，粘贴图片���得结构化 JSON 证据（OCR、版面、语义）。
- **Tags:** `vision`, `ocr`, `multimodal`
- **Why use it:** First vision plugin adding OCR to text-only coding agents
...
- **Why use it:** One-click install and model switch across Claude Code, Codex, Grok, DeepSeek, Kimi and more
...
- **Tags:** `code-review`, `coding-agent`
- **Why use it:** AI code review based on 12 classic engineering books with severity labels
...
- **Why use it:** Audits AI-generated code for hallucinated packages and vulnerabilities.
...
- **Tags:** `ios-simulator`, `mcp`, `ui-automation`, `webdriveragent`
- **Why use it:** Integrates live iOS Simulator and real device into DSH conversation with 22 agent tools
...
- **Tags:** `provider`, `llm`, `model-picker`
- **Why use it:** LLM provider with live model catalog and plan-aware model picker
...
- **Tags:** `plugin-dev`, `coding-tool`
- **Why use it:** Agent skill to build and validate DSH plugins with slots and credentials.
...
- **Tags:** `plugin-creator`, `coding-tool`, `codex`
...
- **Tags:** `deepseek-harness`, `quality-gate`, `engineering-discipline`
- **Why use it:** Engineering discipline bundle for quality gates and requirements validation
...
- **Why use it:** Pre-flight plugin check for DSH agents, boosts plugin utilization predictably.
...
- **Why use it:** Connect ChatGPT via OAuth to use ChatGPT models inside DSH.
...
- **Tags:** `dsh-plugin`, `floating-widget`
- **Why use it:** Cute floating widget tracking DeepSeek balance with animations
...
- **Why use it:** Lightweight 5MB Tauri desktop client with zero setup and preset plugins
...
- **Tags:** `desktop-app`, `agentic-workflows`
- **Why use it:** Local-first desktop workspace with Sessions, projects, MCP, and Office integration
...
- **Why use it:** Renders interactive charts, layouts and forms inline in chat.
...
- **Tags:** `office`, `deepseek-harness-plugin`, `dsh-plugin`
- **Why use it:** Adds spreadsheets, docs, and slides directly into the DSH environment
...
- **Why use it:** CodePilot-inspired desktop client and plugin suite for cross-platform DSH use
...
- **Tags:** `ios-app`, `ios-swift`, `deepseek-harness-plugin`
...
- **Why use it:** Smartisan-style notes with Docker deployment and skill support
...
- **Why use it:** Essential web UI for managing skills and MCP servers directly in DSH
...
- **Why use it:** One-click install/uninstall plugins via Web GUI marketplace
...
- **Tags:** `mcp`, `skills`, `ui`, `capability`
- **Why use it:** Unified menu to manage tool exposure levels and execution modes
...
- **Why use it:** Electron-based DSH desktop console with multi-tab plugin management.
...
- **Why use it:** Persistent bottom bar showing model, balance, and pricing
...
- **Why use it:** WorkBuddy-style quick skill picker in DSH composer interface
...
- **Why use it:** Bioinformatics desktop app for clinicians and wet-lab scientists with offline mode
...
- **Why use it:** All-in-One DevOps desktop: SSH, SFTP, Docker, DB client and AI sandbox
...
- **Why use it:** Electron desktop wrapper bundling DSH web with multiple plugins
...
- **Why use it:** Adds one-click compact button to context meter panel.
...
- **Why use it:** Convert chat history into shareable visual knowledge cards.
...
- **Tags:** `memory`, `local-first`, `markdown`
- **Why use it:** Portable local-first memory layer for AI agents, user-owned and self-evolving.
...
- **Why use it:** Dedicated memory management kit helping agents remember and refine knowledge
...
- **Tags:** `agent-memory`, `vector-search`
...
- **Why use it:** Distills expert thinking into reusable skills for any AI agent
...
- **Tags:** `skills`, `store`, `marketplace`
- **Why use it:** Most comprehensive skills store with auto-updated categorized packs.
...
- **Why use it:** Self-improving agent OS with evaluation loop and MCP server.
...
- **Tags:** `video-generation`, `agent-skills`
...
- **Tags:** `vision-tools`, `agent-skills`
- **Why use it:** One-line vision toolkit for text-only LLMs: image Q&A, OCR, and UI restoration
...
- **Why use it:** Canvas-based branching workspace for non-linear conversation flows.
...
- **Why use it:** Vision and audio skill turning video/screen activity into evidence.
...
- **Why use it:** SQLite-backed task board with agent claim and native Web UI.
...
- **Tags:** `ai-agents`, `agent-skills`, `math-modeling`
...
- **Why use it:** Turn successful sessions into reusable skills automatically
...
- **Why use it:** Auto-updates plugins when DSH version upgrades
...
- **Why use it:** Brings proven Superpowers skills to the Reasonix coding harness
...
- **Why use it:** TDD, debugging, planning skills adapted from Superpowers for DSH
...
- **Tags:** `skills`, `mentoring`, `coding-agent`
- **Why use it:** AI coding mentor skill: project scanning, guided chapters, code review
...
- **Tags:** `fintech`, `backtesting`, `agent-skills`
...
- **Why use it:** 25 pre-built engineering and productivity skills ready to use out of box.
...
- **Why use it:** Chinese official document processing with format compliance and template gen.
...
- **Why use it:** Official DSH plugin dev knowledge base and skill scaffold
...
- **Tags:** `chinese-traditional-wisdom`, `bazi`, `fengshui`
- **Why use it:** Unique Bazi/Fengshui/TCM agent skill with local engine
...
- **Tags:** `code-simplification`, `refactoring`, `skill`
- **Why use it:** Adapted code simplification skill from DSH for better refactoring
...
- **⭐ Stars:** 27
- **Language:** Python
- **Description:** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框��——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **Tags:** `qa`, `testing`, `test-automation`
- **Why use it:** 11 QA test skills with shared KB; makes AI act as senior tester
...
- **Why use it:** Official Tencent SkillHub API docs and plugin for DSH ecosystem
...
- **Tags:** `video`, `motion-design`, `remotion`, `agent-skills`
...
- **Tags:** `dsh-plugin`, `agent-skill`, `development`
- **Why use it:** Agent skills for standard DSH plugin/service/tool/LLM adapter development
...
- **Why use it:** Local-first AI design tool, Figma alternative for coding agents
...
- **Why use it:** Beautiful self-contained architecture and workflow diagram generator
...
- **Why use it:** 530+ industrial prompt templates for GPT-Image2 generation
...
- **Why use it:** AI-generated design system with visual editor and PPT studio templates
...
- **Why use it:** Preview, inspect, and edit OpenPencil designs inside conversations
...
- **Tags:** `ai-video`, `ai-image`, `creative`
- **Why use it:** DirectorX AI video/image/audio skills for creative workflows
...
- **Why use it:** 6 design style presets to help vibe-coded sites avoid the generic AI look
...
- **Why use it:** Cross-platform content discovery agent from Bilibili, YouTube, Xiaohongshu and more
...
- **Tags:** `web-search`, `browser`, `dsh-plugin`
...
- **Why use it:** Powerful browser automation via Tabbit + Playwright integration
...
- **Why use it:** DingTalk IM channel turning chats into tool-capable agent workflows.
...
- **Why use it:** AI-augmented no-code platform for rapidly building business systems
...
- **Tags:** `infrastructure`, `ecosystem-radar`
- **Why use it:** Self-hosted plugin radar discovering and validating 15900+ plugins
...
- **Why use it:** Best context management plugin with dashboard, stats, and browser integration
...
- **Why use it:** Tracks session and daily costs, budgets, token usage, and multi-provider balance
...
- **Why use it:** Secure P2P multi-device remote access to Harness and CodeX
...
- **Tags:** `backup`, `config`, `mcp`, `webdav`
- **Why use it:** Full backup/restore for DSH config, plugins, skills and MCP via WebDAV
...
- **Why use it:** Core DSH plugin infrastructure: registry console and official dev guide.
...
- **Why use it:** Pixel-to-text image reading via OCR for text-only LLM models.
...
- **Tags:** `container`, `version-management`, `utility`
- **Why use it:** Container-based multi-DSH version manager with embedded WebView
...
- **Tags:** `context-audit`, `token-management`, `ui`
- **Why use it:** Audits context token costs and detects AGENTS.md conflicts
...
- **⭐ Stars:** 6
- **Language:** TypeScript
- **Description:** 致力于���决各插件之间也与版本之间可能存在的冲突问题并提供解决方案
...
- **Tags:** `pets`, `gallery`, `theme`
- **Why use it:** Public gallery of animated pets for various AI coding assistants.
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness customizing visual appearance
...
- **Tags:** `ocean-skin`, `theme`, `threejs`, `webgpu`
- **Why use it:** Beautiful WebGPU ocean-themed skin with Three.js and native integration
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮��、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `webui`, `theme`
- **Why use it:** Personalized DSH web background with presets, upload and fine-tune
...
- **Why use it:** Comprehensive AI resource hub with tutorials, prompts, and agent knowledge.
...
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MLOps and more.
...
- **Why use it:** Curated plugin discovery with daily GitHub scraping and quality filtering
...
- **Tags:** `arxiv`, `latex`, `research-tools`, `gpu-cluster`
- **Why use it:** One-stop research workbench: LaTeX, arXiv, experiments, and GPU SSH orchestration
...
- **Why use it:** Learn DSH principles, browse the plugin marketplace, and follow best practices
...
- **Why use it:** 11000+ plugin marketplace with search, rankings, install commands and public API
...
- **Tags:** `academic-search`, `mcp`, `arxiv`, `citation-management`
- **Why use it:** Cross-database academic search with citation graph, MeSH, and trial data for Chinese researchers
...
- **Why use it:** Local financial database with multi-agent analysis and MCP integration
...
- **Tags:** `research`, `industry`, `report`, `cordis`
- **Why use it:** Industry research toolkit: methodology, chain mapping, news tracking
...
- **⭐ Stars:** 63
- **Language:** TypeScript
- **Description:** 在 DeepSeek Harness / Claude Code / Cursor / Codex / Gemini CLI 里直��搜索 20 个中国开放平台的 65,600+ 篇 API 文档；零配置，支持 Skill 与 DSH 原生插件。
...
- **Why use it:** Patent infringement analysis with RAG-powered multi-agent reports.
...
- **Why use it:** Interactive K-line financial analysis with technical indicators
...
- **Tags:** `evaluation`, `rag-evaluation`, `prompt-testing`, `benchmark`
...
- **Why use it:** Spam-filtered curated registry of verified DSH plugins and skills
...
- **Why use it:** Real-time token usage charts and cost tracking via web UI
...
- **Why use it:** Curated stock/finance/quant plugins — 24 verified bilingual entries
...
- **Why use it:** Evidence-led plugin directory with permission-aware install guidance
...
- **Why use it:** Complete 1000+ plugin catalog sorted by stars from GitHub topics
...
- **Tags:** `plugin-directory`, `guide`, `documentation`
- **Why use it:** Plugin product manual with scenario-based selection and risk info
...
- **Why use it:** Curated evidence-aware plugin shortlist; good for discovery.
...
- **Why use it:** Curated one-stop index of all DSH plugins, skills and tools.
...
- **Why use it:** Daily-updated plugin marketplace with community-reviewed listings.
...
- **Why use it:** Official auto-generated curated list of all DSH plugins
...
- **Why use it:** Hand-curated plugin directory covering tools and resources
...
- **Why use it:** Unofficial community catalog for discovering DSH plugins across ecosystems
...
- **Tags:** `awesome-list`, `curated-list`, `dsh-plugin`
- **Why use it:** Curated list of DeepSeek Harness plugins for ecosystem exploration
...
- **Tags:** `awesome-list`, `dsh`, `resources`
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `plugin-portal`
- **Why use it:** Static web portal to discover and browse DSH plugins easily.
...
- **Why use it:** DSHA精选插件合集，收录优质插件资源。
...
- **Why use it:** Plugin radar with evidence-backed reviews and 2Origin plugin lab.
...
- **Why use it:** Search npm and curated DSH plugin lists from within agents.
...
- **Why use it:** Hourly AI-curated plugin list across 12 categories, 190+ plugins.
...
- **Why use it:** General DSH plugin collection; minimal info limits assessment.

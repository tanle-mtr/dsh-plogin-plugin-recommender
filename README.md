...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 973,780 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-06 10:38:02 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 213,588 | Core plugin infrastructure — everything is a plugi |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,354 | Open-source design plugin with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,798 | Deploy multi-agent swarms and autonomous workflows |
...
- **Why use it:** Core plugin infrastructure — everything is a plugin.
...
- **Why use it:** Multi-model agent harness with self-evolving memory.
...
- **Why use it:** Terminal AI coding agent with R1 reasoning and caching.
...
- **Tags:** `multi-agent`, `dsh-plugin`, `workspace`
- **Why use it:** Enterprise multi-agent workbench with unified workspace across harnesses
...
- **Why use it:** First vision plugin enabling OCR and image understanding for text-only coding agents
...
- **Why use it:** Two-phase preset providing minimal-aligned bootstrap and full Standard tools integration
...
- **Why use it:** World's first virtual terminal with VFS and virtual terminal for AI agents
...
- **Tags:** `agent-runtime`, `desktop`, `dsh-plugin`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for agentic coding
...
- **Tags:** `code-review`, `lint`, `ai-audit`
- **Why use it:** AI code review grounded in 12 classic engineering books with decay diagnostics and auto-fix
...
- **Why use it:** iOS Simulator automation with 22 agent tools for mobile dev
...
- **Tags:** `catalog`, `plugin-discovery`
- **Why use it:** Centralized catalog for discovering and filtering all DSH plugins.
...
- **Why use it:** Seamlessly runs Pi ecosystem plugins as native DSH plugins via bridge.
...
- **Why use it:** Curated awesome-list of DSH plugins for community reference.
...
- **Tags:** `coding`, `reasonix`, `superpowers`, `skills`
...
- **Tags:** `plugin-dev`, `skills`, `tooling`, `development`
- **Why use it:** Agent skill for developing DSH plugins with standard patterns
...
- **Tags:** `plugin-dev`, `build`, `tooling`
- **Why use it:** Agent skill for building and managing DSH plugins
...
- **Tags:** `plugin-dev`, `validation`, `creator`
- **Why use it:** Reusable skill for building and validating DSH plugins
...
- **Tags:** `knowledge-base`, `docs`, `plugin-dev`, `guide`
- **Why use it:** Plugin development knowledge base and official docs archive
...
- **Tags:** `godot`, `godot-engine`, `gdscript`
- **Why use it:** Full-stack Godot 4.x game dev skill — code GDScript and build games with AI assistance
...
- **Tags:** `plugin-development`, `dsh-plugins`, `skill`
- **Why use it:** Guides AI agents through 0-to-1 plugin development — build, install, and test DSH plugins
...
- **Tags:** `dsh-plugin`, `dsh-plugin-market`, `awesome-dsh-plugin`
- **Why use it:** Marketplace-style plugin hub for DSH agents
...
- **Why use it:** Web UI aggregation platform for DSH plugin ecosystem distribution
...
- **Why use it:** Modern flexible task panel embedded in Codex and DeepSeek Harness interfaces
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, rollback, and TPS display
...
- **Why use it:** Cute floating whale widget tracks your DeepSeek balance with drag-and-drop UI
...
- **Why use it:** Official Tauri desktop wrapper with zero setup, 5MB installer, cross-platform support
...
- **Tags:** `desktop`, `mcp`, `local-first`
- **Why use it:** Local-first AI desktop workspace with DSH sessions, MCP, web research, and Office automation
...
- **Tags:** `gui`, `interactive`, `components`, `charts`
- **Why use it:** Inline interactive UI components — layouts, charts, forms, quizzes in assistant replies
...
- **Tags:** `desktop`, `windows`, `electron`, `ssh`
- **Why use it:** Open-source Windows desktop client with Codex, plugins, SSH, and mobile remote access
...
- **Why use it:** Local-first multi-model AI desktop app with self-evolving skills and privacy-first design
...
- **Tags:** `canvas`, `workspace`, `conversation`, `branching`
- **Why use it:** Visual non-linear conversation canvas with branching session workspace for DeepSeek Harness
...
- **Tags:** `office`, `document`, `spreadsheet`
- **Why use it:** Brings spreadsheets, docs, slides and relational tables into DSH
...
- **Why use it:** Native iOS app extends Harness to mobile with real-time agent tracking.
...
- **Why use it:** Open-source Smartisan Notes clone with skill support and Docker deploy.
...
- **Tags:** `ui`, `menu`, `capability`, `controls`
- **Why use it:** Unified menu to control MCP/skill exposure and execution mode
...
- **Tags:** `plugin-management`, `ui`, `console`, `repository`
- **Why use it:** Plugin registry console and official dev guide skill
...
- **Why use it:** Standalone bioinformatics desktop app with one-click install, skill store, and offline mode
...
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker, AI assistant, and sandbox in one window
...
- **Why use it:** One-click compact button for DSH Web context meter
...
- **Why use it:** LLM knowledge platform with RAG, Q&A, and self-maintaining wiki.
...
- **Tags:** `memory`, `rag`, `mcp`
- **Why use it:** Portable local-first memory layer with cross-app self-evolving persistence
...
- **Why use it:** Self-evolving hybrid-retrieval memory with significant token savings
...
- **Tags:** `memory`, `agentic-rag`, `llm`
- **Why use it:** Stateful agent memory library with agentic RAG capabilities
...
- **Why use it:** Dedicated memory management kit for agents with memory scoping and refinement capabilities
...
- **Tags:** `context`, `management`, `rAG`
- **Why use it:** Best-in-class context management with dashboard, browser view, and command interface for DSH
...
- **Tags:** `skill-corpus`, `retrieval`, `agent-memory`, `embeddings`
- **Why use it:** Curates skill corpora with retrieval and evaluation tooling for agents
...
- **Tags:** `memory`, `rag`, `knowledge`, `consolidation`
- **Why use it:** Proactive associative memory with auto-consolidation
...
- **Tags:** `evaluation`, `rag-evaluation`, `llm-judge`
...
- **Why use it:** 530+ industrial prompt templates as reusable skills.
...
- **Tags:** `agent-skills`, `workflow`, `mcp`
- **Why use it:** Unified multi-device agent workspace with task board orchestration
...
- **Why use it:** Largest skill store with auto-sorted updates across 10k+ GitHub projects
...
- **Why use it:** Self-improving Agent OS with staged evaluation and budgeted evolution loops
...
- **Tags:** `loop-engineering`, `agent-ops`, `workflow`
- **Why use it:** Long-horizon agent control plane for durable governed multi-engine work
...
- **Tags:** `skills`, `workflow`, `agent-framework`, `dsh-plugin`
- **Why use it:** Intelligent skill routing and workflow orchestration improving reward by 21pp and reducing tokens by 30%
...
- **Why use it:** End-to-end automated video generation from a single topic via Vox-style collages
...
- **Why use it:** Enables multi-agent team collaboration workflows within DeepSeek Harness
...
- **Tags:** `multimodal`, `perception`, `computer-vision`, `audio`
- **Why use it:** Local-first multimodal perception stack for video, audio, and screen understanding by agents
...
- **Tags:** `task-management`, `native`, `sqlite`, `workflow`
- **Why use it:** Native SQLite-backed taskboard with agent claim review and Web UI — no iframe or second runtime
...
- **Tags:** `creative-writing`, `novel`, `drama`, `fiction`
- **Why use it:** Specialized plugin for novel writing and short-drama production with Drama Skills engine
...
- **Tags:** `skill`, `math-modeling`, `workflow`
- **Why use it:** Full-stack auto math modeling skill with GitOps pipeline support
...
- **Tags:** `agent-evolution`, `workflow`, `review`
- **Why use it:** Composable task controls enabling human-reviewed self-evolving agents
...
- **Tags:** `skills`, `architecture`, `agent`
- **Why use it:** Turns experience into repeatable execution patterns across AI tools.
...
- **Why use it:** Adds multimodal vision to Claude Code for screenshot/UI analysis.
...
- **Tags:** `skills`, `agent-skills`, `automation`, `learning`
- **Why use it:** Auto-convert successful sessions into reusable agent skills
...
- **Tags:** `superpowers`, `skills`, `tdd`, `coding`
- **Why use it:** TDD, debugging, planning and collab skills for DSH
...
- **Tags:** `skills`, `mentor`, `coding`, `education`
- **Why use it:** AI coding mentor skill: architecture scan, scaffolding, code review
...
- **Tags:** `skills`, `agent`, `productivity`, `github`
- **Why use it:** 25 ready-to-use engineering and productivity agent skills
...
- **⭐ Stars:** 41
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向��文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `workflow`, `formatting`
- **Why use it:** Chinese official document processing with format checking and optimization
...
- **Tags:** `spec`, `development`, `workflow`, `coding`
...
- **Why use it:** Official SkillHub Open API docs and examples — learn and integrate Tencent skills into DSH
...
- **Why use it:** Virtual product team agent preset: PM to QA workflow
...
- **Why use it:** Auto-preresolves top-K plugins before agent tasks
...
- **Why use it:** OAuth-bind ChatGPT to use its models inside DSH
...
- **Why use it:** Centralized skill and MCP panel for DSH Web UI
...
- **Tags:** `api`, `documentation`, `china`, `mcp`
- **Why use it:** Search 65K+ APIs across 20 Chinese open platforms, zero config
...
- **Tags:** `mcp`, `cloud`, `huawei`, `infrastructure`
...
- **Tags:** `agent`, `search`, `dsh-plugin`
- **Why use it:** Search npm + awesome-dsh-plugin from inside DSH
...
- **Why use it:** AI-native vector design tool with concurrent Agent Teams and vibe coding
...
- **Tags:** `mascot`, `visual`, `developer-tools`
- **Why use it:** Animated pet gallery extension adding personality to coding agent tools
...
- **Why use it:** Powerful computer vision toolkit for text-only LLMs with OCR, image Q&A, and screenshot restore
...
- **Why use it:** AI-generated design system with visual editor, template marketplace, and PPT studio built natively
...
- **Why use it:** Litigation timeline and diagram visualization for legal cases
...
- **Why use it:** AI-powered video/image/audio generation and editing skills for creative workflows
...
- **Tags:** `design-skills`, `design-system`, `ui`
- **Why use it:** Pre-built design system styles (dark-saas, apple-minimal, neo-neu) to improve web output quality
...
- **Why use it:** Free image reading and generation with vision model support — paste images for AI analysis
...
- **Tags:** `knowledge-cards`, `dsh-plugin`, `visual`
...
- **Why use it:** Browser extension suite for Gemini, Claude, ChatGPT and more.
...
- **Tags:** `content-discovery`, `cross-platform`, `ai-agent`, `dsh-plugin`
- **Why use it:** Local-first cross-platform content discovery agent covering B站, YouTube, Reddit, Zhihu, and more
...
- **Why use it:** Allows AI agents to leverage your real logged-in browser seamlessly via CLI
...
- **Why use it:** Free web search bridge for models without native web access — no signup or API key needed
...
- **Why use it:** DingTalk bot turns chats into tool-capable agents
...
- **Tags:** `utility`, `model-switch`, `dsh-plugin`
- **Why use it:** One-click multi-agent tool switcher supporting Claude Code, Codex, DeepSeek, Kimi Code, and more
...
- **Tags:** `ecosystem`, `radar`, `infrastructure`
- **Why use it:** Self-hostable plugin ecosystem radar discovering 15900+ candidates with k8s-tested pipelines
...
- **Tags:** `oauth`, `subscriptions`, `provider`, `integration`
- **Why use it:** Use ChatGPT Codex Claude and Grok subscriptions as free LLM providers via OAuth in DSH
...
- **Tags:** `cost`, `billing`, `metering`
- **Why use it:** Tracks session/daily costs, budgets, and token usage history
...
- **Why use it:** End-to-end encrypted P2P remote access across PC, Android, and Web.
...
- **Tags:** `upgrade`, `maintenance`, `utility`
- **Why use it:** Auto-upgrade plugins along with DSH version updates
...
- **Tags:** `config`, `backup`, `migration`, `sync`
- **Why use it:** Backup/restore/migrate full DSH config via WebDAV sync
...
- **Why use it:** Fast and elegant Neovim plugin manager in Lua — useful if you manage DSH plugins via Neovim
...
- **Why use it:** Track token usage and API costs with real-time charts
...
- **Tags:** `finance`, `stock`, `quant`, `curated-list`
- **Why use it:** Curated stock/finance/quant plugin collection for DSH
...
- **Why use it:** Evidence-led directory with installation guidance
...
- **⭐ Stars:** 6
- **Language:** TypeScript
- **Description:** 致力于解决各插件之间也与版本之间��能存在的冲突问题并提供解决方案
- **Tags:** `troubleshooting`, `compatibility`, `utilities`
...
- **Why use it:** Star-ranked verified community plugins directory
...
- **Why use it:** Complete 1000+ repo DSH tool directory sorted by stars
...
- **Why use it:** Auto-crawled daily plugin directory, bilingual support
...
- **Tags:** `portal`, `static-site`, `web`, `directory`
- **Why use it:** Static web portal to discover, filter and install plugins
...
- **Tags:** `theme`, `glass-morphism`, `desktop`, `customization`
- **Why use it:** Frosted glass theme with full customization of blur, background, and磨砂 effects
...
- **Why use it:** WebGPU ocean-themed visual skin for DeepSeek Harness
...
- **Tags:** `webui`, `background`, `customization`, `themes`
- **Why use it:** Customize DSH Web backgrounds with images or presets
...
- **⭐ Stars:** 1,756
- **Language:** Python
- **Description:** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析���生成有据可查的研究报告。
- **Tags:** `research`, `web-search`, `china`
- **Why use it:** Auto-searches 8 major Chinese platforms for recent 30-day content and generates citable research reports
...
- **Tags:** `security`, `redteam`, `auditing`, `vulnerability`
- **Why use it:** AI security platform auditing hallucinated packages and safeguard vulnerabilities in generated code
...
- **Tags:** `awesome-list`, `guide`, `reference`
...
- **Tags:** `learning`, `marketplace`, `reference`
...
- **Tags:** `awesome-list`, `catalog`, `reference`
- **Why use it:** Curated list of plugins, skills, MCPs and orchestrators for DSH
...
- **Tags:** `catalog`, `directory`, `plugin-store`
- **Why use it:** Plugin directory with 11,000+ entries, search, rankings and API
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv, GPU SSH orchestration
...
- **Why use it:** Cross-database academic search with citation management for researchers.
...
- **Why use it:** Financial data analysis system with multi-agent support and IM alerts.
...
- **Tags:** `research`, `marketing`, `workflows`
- **Why use it:** 88 open-source skills for deep research, marketing, and business workflows.
...
- **Tags:** `research`, `industry`, `analysis`, `report`
- **Why use it:** Industry research domain pack with policy/news tracking skills
...
- **Tags:** `patent-analysis`, `legal-tech`, `rag`, `multi-agent`
...
- **Why use it:** Community-curated catalog of DSH plugins — good for discovering what's available in the ecosystem
...
- **Why use it:** Curated plugin list with website showcase — well-organized reference for DSH ecosystem discovery
...
- **Why use it:** Comprehensive awesome list covering plugins, tools, skills, MCP, and resources — broad ecosystem overview
...
- **Why use it:** Public GitHub directory with install commands and plugin discovery — handy quick reference for devs
...
- **Tags:** `plugin-registry`, `curated-list`, `skills`
- **Why use it:** Spam-filtered official-style plugin registry with open data — reliable source for plugin discovery
...
- **Tags:** `awesome-list`, `mcp`, `ai-agents`
- **Why use it:** 190+ plugins, 12 categories, hourly AI updates
...
- **Why use it:** Open-source no-code platform for rapid business system building.
...
- **Tags:** `armor-breaking`, `deepseek`, `specialized`
- **Why use it:** Specialized DeepSeek armor-breaking plugin for enhanced generation capabilities
...
- **Tags:** `awesome-list`, `curated`, `directory`
- **Why use it:** Curated comprehensive plugin and tool catalog from dsh-external/hub ecosystem
...
- **Why use it:** Curated awesome list covering the full DeepSeek Harness plugin ecosystem
...
- **Why use it:** Comprehensive curated DSH plugin and resource list in English and Chinese
...
- **Tags:** `encyclopedia`, `knowledge-base`, `resources`, `learning`
- **Why use it:** One-stop AI encyclopedia covering skills, MCP, RAG, multimodal tools, and learning roadmaps
...
- **Tags:** `directory`, `discovery`, `curated`, `weekly`
- **Why use it:** Daily auto-curated plugin discovery with scene-based classification and usage guides
...
- **Tags:** `awesome-list`, `plugin-catalog`, `curated`
- **Why use it:** Official auto-generated curated plugin catalog
...
- **Tags:** `marketplace`, `plugin-market`, `web-ui`
- **Why use it:** One-click install/uninstall community plugins via Web UI
...
- **Why use it:** Meticulously curated DSH plugin, tool, and resource list
...
- **Tags:** `marketplace`, `catalog`, `community`
- **Why use it:** Community-maintained plugin catalog auto-synced every 4h
...
- **Tags:** `directory`, `awesome-list`, `community`
...
- **Why use it:** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP��卡片，用于在浏览器里管理
...
- **Tags:** `awesome-list`, `dsh-plugin`, `dsh-ecosystem`
- **Why use it:** Curated awesome-list index for DSH plugins
...
- **Why use it:** Evidence-led bilingual plugin directory, reviewed
...
- **Tags:** `awesome-list`, `plugin-registry`, `2origin`
- **Why use it:** Plugin radar + 2Origin lab, evidence-backed
...
- **Why use it:** Moved to new org, legacy list reference only
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** YAML-driven auto-updating bilingual plugin list
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** Small DSH plugin collection, limited scope
...
- **Tags:** `plugin-directory`, `registry`, `deepseek-harness`, `curated-list`
- **Why use it:** Curated plugin directory for DeepSeek Harness ecosystem discovery and management

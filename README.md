...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,026,644 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-15 04:06:34 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 224,270 | Core DSH framework enabling everything-is-a-plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,216 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,453 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Core DSH framework enabling everything-is-a-plugin architecture
...
- **Tags:** `ai-agents`, `multi-agent`, `mcp`, `skills`
- **Why use it:** Super AI assistant with self-evolving memory and multi-agent support
...
- **Tags:** `coding-agent`, `tui`, `r1`, `tool-use`
...
- **Tags:** `dsh-plugin`, `mcp`, `agent-orchestration`
- **Why use it:** Runtime injector + task-aware router kit for advanced reasoning mode control
...
- **Why use it:** Two-phase preset for minimal bootstrap then full Standard tools setup
...
- **Why use it:** Virtual terminal and filesystem for AI agents, isolates execution environments
...
- **Tags:** `cognition`, `reasoning`, `agent`, `dsh-plugin`
- **Why use it:** Model-agnostic inference-time control suite for deep reasoning and long-horizon tasks
...
- **Tags:** `documentation`, `wiki`, `dsh-plugin`
- **Why use it:** Generates accurate technical docs and AI-ready context from codebase quickly
...
- **Tags:** `agent-teams`, `agentic-runtime`, `ai-coding`
- **Why use it:** Rust agent runtime with polished desktop app, combines coding depth and usability
...
- **Tags:** `agent-teams`, `dsh`, `multi-agent`
- **Why use it:** Enables multi-agent team coordination within DeepSeek Harness ecosystem
...
- **Why use it:** AI security platform auditing hallucinated packages and vulnerable code patterns
...
- **Tags:** `command-code`, `llm-provider`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Provides Command Code model access with live catalog and plan-aware selection for DSH agents.
...
- **Tags:** `migration`, `compatibility-layer`, `dsh-plugin`, `pi-agent`
- **Why use it:** Bridge Pi ecosystem to DSH — run unmodified Pi extensions as native plugins.
...
- **Tags:** `plugin-discovery`, `agent-skills`, `dsh-plugin`, `automation`
- **Why use it:** Auto-discovers, installs, and verifies GitHub plugins directly within DSH environment.
...
- **Why use it:** Superpowers coding skills ported to Reasonix harness
...
- **Why use it:** Centralized control over MCP tools exposure level and execution mode in DSH
...
- **Why use it:** Unified loader and safety manager for local Agent Skills within the DSH ecosystem
...
- **Tags:** `context`, `ui`
- **Why use it:** Audits context injection costs and detects duplicate/conflicting instructions
...
- **Why use it:** Codex-adapted skill for automatic code simplification and refactoring
...
- **Why use it:** Agent skill for DSH plugin development with Claude Code and Codex support
...
- **Why use it:** Fast, elegant Neovim plugin manager for DSH workflow
...
- **Why use it:** Modern desktop solution for DSH ecosystem with plugin-based design
...
- **Tags:** `dsh-web`, `deepseek-harness`, `plugin-ecosystem`
- **Why use it:** Web UI aggregation ecosystem bringing plugins to browser distribution
...
- **Why use it:** Open sidebar foundation with built-in files, terminal, chat, Git, and sub-agent views
...
- **Why use it:** Modern flexible task board embeddable in Codex and DSH interfaces
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status, streaming thoughts, and rollback
...
- **Why use it:** Cute floating whale widget that tracks DeepSeek account balance with animations
...
- **Why use it:** Zero-setup desktop client for DSH, only 5MB installer across all platforms
...
- **Tags:** `desktop-app`, `electron`, `mcp`
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, files, web research
...
- **Tags:** `desktop-app`, `windows`, `gui`
- **Why use it:** Windows GUI desktop client with Codex, SSH, mobile remote access
...
- **Tags:** `gen-ui`, `interactive`, `dsh-plugin`
- **Why use it:** Generates interactive inline UI components — charts, forms, quizzes in replies
...
- **Why use it:** Visual non-linear canvas-based conversation workspace with branching sessions
...
- **Tags:** `desktop-app`, `agent`, `mcp`
- **Why use it:** Local-first AI desktop app with multi-model and self-evolving skills
...
- **Why use it:** Brings spreadsheets, docs, slides, canvases into Harness desktop
...
- **Why use it:** Native iOS client with WebSocket for workspace and agent tracking
...
- **Tags:** `ios-simulator`, `mobile-automation`, `xcode`
- **Why use it:** Live iOS Simulator in conversation with 22 agent tools for mobile dev
...
- **⭐ Stars:** 163
- **Language:** TypeScript
- **Description:** 开源版锤子便签，复刻锤科美学，��键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **Tags:** `notes`, `dsh-plugin`, `smartisan`, `docker`
- **Why use it:** Open-source Smartisan-style notes with Docker private deploy, WeChat/OA export support.
...
- **Tags:** `marketplace`, `ui`, `webgui`
- **Why use it:** One-click install community plugins directly from web GUI
...
- **Why use it:** Electron desktop console for multi-tab management of Harness, plugins, MCPs and Skills
...
- **Tags:** `ui`, `usage-tracking`
- **Why use it:** Clean bottom bar with provider, balance, pricing info at a glance
...
- **Tags:** `desktop-app`, `bioinformatics`
- **Why use it:** Specialized bioinformatics desktop agent with offline mode and skill store
...
- **Tags:** `ui`, `skill-picker`
- **Why use it:** WorkBuddy-style skill picker improves DSH composer UX significantly
...
- **Why use it:** All-in-one DevOps desktop: DB, SSH, Docker, AI assistant
...
- **Why use it:** Electron desktop shell for DSH with ModLens and web UI
...
- **Tags:** `rag`, `knowledge-base`, `vector-search`, `semantic-search`
- **Why use it:** Open-source knowledge platform turning documents into queryable RAG
...
- **Tags:** `agent-memory`, `rag`, `long-term-memory`, `skills`
- **Why use it:** Portable self-evolving memory layer for all AI agents, user-owned and local-first
...
- **Tags:** `agent-memory`, `rag`, `self-evolving`, `mcp`
- **Why use it:** Ultra-persistent hybrid-retrieval memory with 35% token savings for agents
...
- **Why use it:** Stateful agent memory library with context engineering and continual learning
...
- **Why use it:** Dedicated memory management kit for agents with remember and refine capabilities
...
- **Why use it:** Persistent unified memory layer for all AI agents backed by Markdown and Milvus
...
- **Tags:** `memory`, `agent`, `long-term-memory`
- **Why use it:** Local memory hub giving all AI agents shared persistent context and recall
...
- **Tags:** `agent-memory`, `vector-search`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready corpora with evaluation tooling
...
- **Tags:** `knowledge-base`, `ai-pedia`, `r aggregation`
- **Why use it:** Comprehensive AI knowledge encyclopedia covering RAG, agents, MLOps and learning paths
...
- **Why use it:** Three-layer proactive associative memory with zero-prompt recall injected before model responses
...
- **Why use it:** Official DSH docs archive as on-demand knowledge base for plugin devs
...
- **Tags:** `vision`, `ocr`
- **Why use it:** Enables text-only models to read images via trained OCR methodology
...
- **Tags:** `agentic-workflow`, `multi-agent`, `swarm`, `skills`
- **Why use it:** Multi-agent swarm orchestration with autonomous workflow coordination
...
- **Tags:** `agent-orchestration`, `agent-skills`, `no-code`, `mcp`
...
- **Tags:** `agent-skills`, `skill-md`, `automation-workflow`
- **Why use it:** Most comprehensive skills store with auto-crawled GitHub skills across categories
...
- **Tags:** `agent-workspace`, `multi-agent`, `visual-editor`
- **Why use it:** Enterprise multi-engine agent workbench with visual editor for team collaboration
...
- **Tags:** `agent-os`, `mcp`, `loop-engineering`, `llm-orchestration`
- **Why use it:** Self-improving agent OS with evaluation-gated loop and budgeted evolution
...
- **Why use it:** Long-horizon control plane for durable governed multi-agent workflows
...
- **Tags:** `skills`, `workflow`, `agent-skills`, `dsh-plugin`
...
- **Tags:** `novel-writing`, `creative`, `long-form-fiction`
- **Why use it:** End-to-end novel writing assistant with world-building, chapters, and review workflow
...
- **Tags:** `computer-vision`, `video-analysis`, `multimodal`
- **Why use it:** Gives agents eyes and ears — turns video/audio/screen into searchable timestamped evidence
...
- **Tags:** `creative-writing`, `agent-skills`, `novel-writing`
- **Why use it:** Novel, drama, game and video-recap writing workflows built-in
...
- **Tags:** `task-management`, `workflow`, `native-ui`
...
- **Tags:** `agent-skills`, `math-modeling`, `automation`, `dsh`
- **Why use it:** Full-stack auto math modeling skill with GitOps pipeline, ideal for MCM/ICM competitions.
...
- **Tags:** `agent-review`, `self-evolving`, `dsh-plugin`, `plan-mode`
- **Why use it:** Enables composable, human-reviewed Agent self-evolution with isolated task controls.
...
- **Tags:** `agent-skills`, `framework`, `multi-platform`, `dsh`
- **Why use it:** Turn experience into repeatable execution; multi-platform Agent skills framework.
...
- **Tags:** `agent-skills`, `research`, `marketing`, `multi-platform`
- **Why use it:** 88 open-source Agent skills for research, social intelligence, and marketing workflows.
...
- **Tags:** `multimodal`, `vision`, `agent-skills`, `claude-code`
- **Why use it:** Adds multimodal vision to text-only LLMs; great for screenshot/UI/chart analysis.
...
- **Tags:** `ai-infra`, `agent-skills`, `dsh-plugin`, `infrastructure`
...
- **Why use it:** AI investment desk with multi-strategy fund backtesting
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `agent-skill`
- **Why use it:** AI mentor skill that scans project architecture and guides handwritten coding with auto-grading
...
- **Tags:** `skills`, `deepseek-harness`, `agent`
- **Why use it:** 25 ready-to-use engineering skills in sidebar panel, no manual installation needed
...
- **Tags:** `deepseek-harness`, `docx`, `gongwen`
- **Why use it:** Full workflow gov-doc processor: format check, optimization, template generation per GB/T 9704 standard
...
- **Tags:** `agent-skills`, `spec-driven-development`, `deepseek-harness`
- **Why use it:** Repository-native spec-driven development skill ported from DeepSeek Harness engineering patterns
...
- **Tags:** `deepseek-harness`, `chinese-traditional-wisdom`, `skill`
- **Why use it:** Chinese traditional wisdom skill: Bazi, Fengshui, I-Ching with local deterministic engine and dashboard
...
- **Tags:** `plugin-development`, `scaffold`
- **Why use it:** Reusable skill to build and validate DSH/Cordis plugins efficiently
...
- **Why use it:** Multi-agent collaboration with shared workspace and independent configs
...
- **Tags:** `testing`, `qa`
- **Why use it:** 11 QA skills + knowledge base for AI-driven test engineering workflows
...
- **Tags:** `quality-gate`, `engineering-discipline`
- **Why use it:** Engineering discipline guard: validates requirements, tests, and delivery
...
- **Why use it:** Cross-platform session continuity skill for persistent agent handoff
...
- **Tags:** `math-modeling`, `agent`, `competition`
...
- **Tags:** `video`, `remotion`, `agent`
- **Why use it:** Cinematic video agent skill with 152 shot templates via Remotion
...
- **Why use it:** Free Xiaomi MiMo TTS for DSH with customizable voices
...
- **Tags:** `agent-tools`, `awesome-dsh-plugin`, `llm-agents`
- **Why use it:** Pre-flight plugin check for DSH agents to boost library utilization.
...
- **Why use it:** Strongest free web search bridge for any model without native web access
...
- **Tags:** `huaweicloud`, `mcp`, `ai-coding`
- **Why use it:** Official Huawei Cloud plugin: skills, MCP tools, guardrails and cloud sandbox for AI agents
...
- **Why use it:** One-click MCP/Skills/config sync across all major AI agent frameworks
...
- **Why use it:** Open-source design alternative with local-first desktop and UI generation
...
- **Why use it:** Self-contained HTML architecture and sequence diagram generation
...
- **Why use it:** 530+ image prompts and 20+ industrial templates for GPT image generation
...
- **Tags:** `vibedesign`, `flutter`, `react`, `mcp`
...
- **Why use it:** First vision plugin for DSH, enables image-to-JSON OCR for coding agents
...
- **Why use it:** Native design studio for AI-generated visuals, PPT creation, and prototype editing
...
- **Why use it:** Draw clear litigation timelines and diagrams from messy case materials, zero-dependency SVG output
...
- **Why use it:** AI video/image/audio creation suite integrated into DSH
...
- **Tags:** `design`, `aesthetics`, `ui`
- **Why use it:** 6 design aesthetics styles to avoid generic AI-generated look
...
- **Tags:** `knowledge-cards`, `awesome-dsh-plugin`, `visual`
- **Why use it:** Transforms chat history into beautiful downloadable knowledge cards.
...
- **Tags:** `content-discovery`, `browser`, `cross-platform`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent from Bilibili, YouTube, X, Reddit etc.
...
- **Why use it:** Lets agents use your logged-in browser non-disruptively via CLI + extension
...
- **Tags:** `electron`, `image-uploader`, `s3`, `github`
...
- **Why use it:** Curated plugin list essential for discovering DSH ecosystem tools
...
- **Tags:** `model-switch`, `utility`, `dsh-plugin`
- **Why use it:** One-click multi-model switcher supporting Claude Code, Codex, Grok, Kimi, and more
...
- **Why use it:** Self-deployable ecosystem radar scanning 15900+ candidates with k8s-grade pipelines
...
- **Why use it:** Best context insight tool with dashboard, sidebar, and command-line management
...
- **Why use it:** Comprehensive daily-updated plugin marketplace with community reviews
...
- **Tags:** `oauth`, `llm-provider`, `infrastructure`
...
- **Why use it:** CLI and plugin manager tools for DSH Plugin Hub with schemas
...
- **Why use it:** Track session cost, daily budget, token usage across multiple providers
...
- **Tags:** `catalog`, `marketplace`, `dsh-plugins`, `awesome-list`
- **Why use it:** 11,000+ plugin catalog with search and rankings — essential DSH ecosystem resource.
...
- **Tags:** `handbook`, `agent-runtime`, `mcp`, `dsh`
- **Why use it:** Comprehensive agent-first handbook with 173 resources covering runtime, plugins, and MCP.
...
- **Tags:** `catalog`, `directory`, `dsh-plugins`, `plugin-marketplace`
- **Why use it:** Complete DSH plugin directory with 1958 repos, categorized and STAR-sorted for discovery.
...
- **Why use it:** Full config backup, restore, sync and migration via WebDAV
...
- **Tags:** `plugin-management`, `deepseek-harness`, `ui`
- **Why use it:** Plugin ecosystem foundation: browser-panel console + official plugin development guidance skill
...
- **Tags:** `utilities`, `docker`
- **Why use it:** Containerized multi-DSH management with embedded WebView UI
...
- **Tags:** `launcher`, `orchestration`, `infrastructure`
- **Why use it:** Orchestrates Runtime, Provider, Plugin, Skill, MCP into unified local AI platform
...
- **Tags:** `cost-tracking`, `data-visualization`
- **Why use it:** Real-time token usage, cost tracking, and API balance charts
...
- **Tags:** `mascot`, `pixel-art`, `sprites`, `dsh-plugin`
- **Why use it:** Public gallery of animated mascot pets for CLI coding agents
...
- **Why use it:** Cute whale-themed visual skins for DeepSeek Harness desktop
...
- **Tags:** `skin`, `animated`, `threejs`
- **Why use it:** Real-time animated ocean theme with adjustable waves, sunset and glass effects
...
- **Tags:** `background`, `customization`
- **Why use it:** Customizable DSH web background with presets and auto-compression
...
- **Tags:** `ai`, `ai-agent`, `deepseek`, `claude`, `gpt`
- **Why use it:** Comprehensive AI resource guide with tutorials, prompts, and knowledge base
...
- **Tags:** `agent`, `harness`, `harness-engineering`, `dsh`
...
- **Why use it:** Auto-searches 8 major Chinese platforms for last 30 days and generates cited reports
...
- **Tags:** `awesome-list`, `ecosystem`, `research`
- **Why use it:** Curated ecosystem index of plugins, tools, and infrastructure from DSH hubs
...
- **Tags:** `awesome-list`, `plugin-ecosystem`, `reference`
- **Why use it:** Comprehensive curated list covering the full DeepSeek Harness plugin ecosystem
...
- **Why use it:** Curated bilingual awesome list of DSH plugins, tools, and integrations
...
- **Why use it:** One-stop academic research workbench: LaTeX, arXiv, experiment tracking, GPU SSH
...
- **Why use it:** Curated plugin discovery with auto-scanning and scenario classification
...
- **Tags:** `awesome-list`, `resources`, `guide`
- **Why use it:** Curated list of plugins, skills, MCPs, patches and UIs for DSH
...
- **Tags:** `marketplace`, `learning`, `best-practices`
...
- **Why use it:** Cross-source academic search with citation graph and verification, perfect for Chinese researchers.
...
- **Tags:** `finance`, `multi-agent`, `mcp`, `dsh-plugin`
- **Why use it:** Local financial database with multi-Agent analysis, auto MCP generation, and IM alerts.
...
- **Why use it:** Industry research domain pack with company analysis skills
...
- **Tags:** `api-documentation`, `deepseek-harness`, `chinese-api`
- **Why use it:** Search 65,600+ API docs across 20 Chinese platforms directly in coding agents with zero config
...
- **Why use it:** Patent infringement analysis system producing competitive reports from patent numbers via RAG
...
- **Why use it:** Interactive K-line chart with multi-market and technical indicators
...
- **Why use it:** Curated stock/finance/quant DSH plugins (24 verified)
...
- **Tags:** `dsh-plugin`, `mcp-server`, `resume-builder`, `self-hosted`
...
- **Tags:** `low-code`, `no-code`, `ai-agent`, `workflows`
...
- **Why use it:** Built-in plugin marketplace with browse, search, and one-click install
...
- **Why use it:** Official auto-generated curated plugin directory by cordis.run
...
- **⭐ Stars:** 86
- **Language:** Python
- **Description:** 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动���护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic
- **Tags:** `community`, `marketplace`, `awesome`
...
- **Tags:** `skillhub`, `documentation`
- **Why use it:** Official skillhub documentation and examples from Tencent
...
- **Why use it:** Comprehensive curated awesome list of all DSH plugins and resources
...
- **Why use it:** Comprehensive DSH plugin discovery directory and registry
...
- **Why use it:** Spam-filtered official DSH plugin registry with skills
...
- **Why use it:** Evidence-led curated list with permission-aware installation
...
- **Why use it:** Complete 1000+ DSH plugin inventory sorted by stars
...
- **Why use it:** Plugin guide with scenario-based recommendations for DSH users.
...
- **Tags:** `dsh-plugin-market`, `dsh-plugins`, `awesome-dsh-plugin`
...
- **Tags:** `awesome-list`, `mcp`, `ai-agents`, `coding-agents`
...
- **Why use it:** Automated daily plugin directory via GitHub Actions.
...
- **Tags:** `dsh-plugins`, `awesome-dsh-plugin`
...
- **Why use it:** Evidence-backed plugin radar from 2Origin Lab.
...
- **Tags:** `plugin-portal`, `github-pages`, `static-site`, `web`
- **Why use it:** Zero-dependency static portal for browsing 227+ DSH plugins.
...
- **Tags:** `discoverability`, `dsh-plugin`, `search`, `agent`
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `javascript`
- **Why use it:** Bind ChatGPT account via OAuth to chat with GPT models in DSH.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `ai-agents`
...
- **Tags:** `dsh-plugins`, `dsh-bundle`, `plugin-verify`
- **Why use it:** DSH plugin repository with verification and bundle support.
...
- **Why use it:** Moved to awesome-dsh-plugin — original plugin directory.
...
- **Why use it:** Immutable, review-based bilingual plugin directory
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Minimal DSH plugin collection reference
...
- **Tags:** `auto-update`, `vercel`
- **Why use it:** Auto-updating YAML-based plugin list generator

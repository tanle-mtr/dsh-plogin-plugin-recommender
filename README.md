...
|--------|-------|
| **Plugins tracked** | 193 |
| **Total community stars** | 869,637 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-08-26 05:50:16 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,957 | Core harness powering the entire DSH plugin ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,539 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,420 | Meta-harness for deploying multi-agent swarms and  |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 21 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 3 plugins
- [Visual & Design](#visual-&-design) — 5 plugins
- [Browser & Web Automation](#browser-&-web-automation) — 6 plugins
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 12 plugins
- [Themes & Skins](#themes-&-skins) — 4 plugins
- [Research & Analysis](#research-&-analysis) — 4 plugins
- [Other](#other) — 85 plugins
...
- **Why use it:** Terminal-native coding agent with prompt caching and TUI
...
- **Why use it:** Unified multi-device agent workspace with task board and cross-platform sync
...
- **Tags:** `router`, `agent-orchestration`, `cordis`
- **Why use it:** Task-aware router kit that significantly improves agent reasoning performance
...
- **Tags:** `agent-os`, `loop-engineering`, `coding-agent`
- **Why use it:** Self-improving agent OS with loop engineering and continuous grading
...
- **Why use it:** Enterprise-grade local-first workbench supporting multiple agent harnesses
...
- **Tags:** `preset`, `dsh-plugin`, `harness`
- **Why use it:** Two-phase preset that bootstraps minimal setup then loads full standard tools
...
- **Why use it:** One-click model switch across multiple coding agents including DSH.
...
- **Why use it:** Architecture-aware coding agent with evidence-driven development.
...
- **Tags:** `security`, `code-audit`, `redteam`, `safety`
...
- **Tags:** `multi-agent`, `coding`, `teamwork`, `automation`
...
- **Tags:** `oauth`, `subscription`, `llm-provider`, `integration`
...
- **Tags:** `marketplace`, `plugin-install`, `dsh`
- **Why use it:** Browse install and update all dsh-plugin GitHub repos in one click
...
- **Tags:** `context-migration`, `session`, `preset`
...
- **Why use it:** Crash-rescue undo config changes with secret-safe snapshots
...
- **Tags:** `skill`, `mcp`, `webui`
- **Why use it:** Web UI for skill and MCP management in DSH
...
- **Tags:** `market`, `community`, `webui`
- **Why use it:** Community plugin market for DSH Web GUI one-click install
...
- **Why use it:** Practical DSH plugin development knowledge base
...
- **Why use it:** Web-based DSH plugin hub with creative workshop distribution ecosystem
...
- **Why use it:** Extensible sidebar foundation with file editor, terminal, chat and Git.
...
- **Tags:** `deepseek-harness`, `tui`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with real-time status, streaming thoughts and rollback.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight desktop app (5MB), zero setup, cross-platform support.
...
- **Tags:** `widget`, `desktop`
- **Why use it:** Cute whale widget monitors DeepSeek account balance with animations.
...
- **Why use it:** Local-first desktop workspace for DSH sessions, files, and plugins.
...
- **Tags:** `desktop-app`, `agent`, `privacy`, `tauri`
...
- **Tags:** `ui`, `components`, `interactive`, `gen-ui`
- **Why use it:** Generates interactive UI components (charts, forms, quizzes) inline in chat.
...
- **Tags:** `desktop`, `electron`, `cross-platform`, `client`
- **Why use it:** Cross-platform desktop client inspired by CodePilot for DeepSeek Harness.
...
- **Why use it:** Full-featured Windows desktop GUI with SSH, plugins and mobile access
...
- **Why use it:** Smartisan-style notes with Docker deploy and export features
...
- **Tags:** `openpencil`, `ui-design`, `ppt`
- **Why use it:** Preview and edit real .op documents inside conversation
...
- **Why use it:** SQLite-backed taskboard with agent claim and native Web UI
...
- **Why use it:** Build and run Android apps via emulator or USB stream in chat
...
- **Why use it:** All-in-one Tauri desktop with DB, SSH, Docker panels
...
- **Why use it:** Electron desktop wrapper integrating DSH web and tools
...
- **Tags:** `ui`, `theme`, `personalization`, `webui`
- **Why use it:** Upload custom images or use presets for DSH web UI background themes.
...
- **Why use it:** Ultra-persistent memory OS with hybrid retrieval and significant token savings
...
- **Tags:** `memory`, `rag`
- **Why use it:** Unlimited memory plugin, essential for persistent AI conversations.
...
- **Tags:** `knowledge-base`, `rag`, `mcp`, `learning`
- **Why use it:** Comprehensive AI knowledge base covering agents, RAG, MCP, and learning paths.
...
- **Why use it:** Transforms scattered SKILL.md files into retrieval-ready agent skill corpora
...
- **Tags:** `memory`, `noema`, `mcp`
- **Why use it:** Durable inspectable agent memory with recall tools and settings
...
- **Why use it:** Super AI assistant with memory, skills, and self-evolution
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `skills`
...
- **Why use it:** Powerful agent skill for generating beautiful architecture and sequence diagrams
...
- **Why use it:** General-purpose skill for intelligent workflow orchestration and routing.
...
- **Tags:** `ai-video`, `ffmpeg`, `dsh-plugin`
- **Why use it:** End-to-end Vox-style video generation skill using text-to-video and ffmpeg.
...
- **Why use it:** Enable multi-agent team workflows for complex tasks coordination.
...
- **Why use it:** Specialized skill for novel writing and short-drama production workflows
...
- **Tags:** `agent-skills`, `coding`, `multi-framework`
- **Why use it:** Turns experience into repeatable execution across multiple agent frameworks
...
- **Why use it:** Adds multimodal vision capability for screenshot and UI analysis
...
- **Why use it:** Discovers, installs and verifies GitHub plugins directly in DSH
...
- **Why use it:** Specialized skills for AI infra write optimize and debug
...
- **Why use it:** Agent workflow automation for DSH
...
- **Why use it:** Infinite canvas with creative agent skills integration
...
- **Tags:** `agent-skill`, `engineering`, `practices`
- **Why use it:** Portable agent skill for engineering discipline
...
- **Why use it:** Full-stack Godot 4.x game dev skill at runtime
...
- **Why use it:** Simulates PM-to-engineer-to-QA workflows for product development.
...
- **Tags:** `agent-tools`, `pre-flight`, `plugin-optimization`
...
- **Tags:** `vision`, `ocr`, `mcp`
- **Why use it:** First vision plugin enabling text-only agents to process images via structured JSON
...
- **Tags:** `chatgpt`, `oauth`, `integration`, `models`
- **Why use it:** OAuth-connect ChatGPT accounts to chat with models inside DSH.
...
- **Why use it:** Industrial-grade GPT-Image2 prompt engine with 530+ cases
...
- **Why use it:** AI-powered design studio with visual editor, templates, and PPT.
...
- **Tags:** `image-generation`, `deepseek-harness`, `plugin`
- **Why use it:** Enables AI image generation directly within DSH chat sessions
...
- **Why use it:** Browser extension suite enhancing major AI platforms
...
- **Why use it:** Cross-platform AI content discovery agent from Bilibili, YouTube, X etc.
...
- **Why use it:** Seamless browser automation for AI agents with logged-in sessions.
...
- **Tags:** `web-search`, `free`, `bridge`, `utility`
...
- **Why use it:** Run live iOS Simulator inside chat with 22 agent tools for mobile automation.
...
- **Why use it:** Unified virtual filesystem giving AI agents portable cross-environment file access
...
- **Why use it:** Powerful context insight and management with dashboard and browser.
...
- **Tags:** `plugin-marketplace`, `deepseek-harness`, `plugins`
...
- **Why use it:** Compatibility layer bridging Pi ecosystem extensions to native DSH plugins
...
- **Tags:** `migration`, `utility`, `import`
- **Why use it:** One-click migration from Claude Code/Codex to DSH
...
- **Tags:** `visualization`, `cost`, `tokens`
...
- **Tags:** `conflict-resolution`, `plugin-management`, `utility`
...
- **Why use it:** Creative animated pet gallery that personalizes your coding agent experience
...
- **Why use it:** Frosted glass theme with fully customizable transparency and background.
...
- **Why use it:** Auto-searches top 8 Chinese platforms for last 30 days, generates citable reports.
...
- **Why use it:** Multi-source anime search with Bangumi ratings and magnet copy
...
- **Tags:** `finance`, `stock`, `quant`, `research`
- **Why use it:** 24 verified stock/finance/quant plugins for DSH in bilingual list.
...
- **Tags:** `dsh-plugin`, `tutorial`, `harness-engineering`
- **Why use it:** Excellent beginner tutorial from zero to harness engineering mastery
...
- **Why use it:** Curated plugin list — essential starting point for DSH exploration
...
- **Why use it:** Web simulation of traditional bamboo dragon toy with real audio samples.
...
- **Tags:** `plugin-registry`, `awesome-list`
- **Why use it:** Comprehensive plugin radar with real-world testing and curated top picks.
...
- **Tags:** `awesome-list`, `hub`
- **Why use it:** Curated plugins, tools, and infrastructure index for DSH ecosystem.
...
- **Tags:** `awesome-list`, `directory`, `curated`, `bilingual`
- **Why use it:** Curated bilingual plugin directory for DeepSeek Harness ecosystem.
...
- **Tags:** `jailbreak`, `prompt`, `deepseek`, `stability`
- **Why use it:** Stabilized prompt engineering plugin for DeepSeek model unlocking.
...
- **Tags:** `directory`, `curation`, `awesome-list`, `verification`
- **Why use it:** Auto-curated plugin directory with real verification, categorized by use case.
...
- **Tags:** `documentation`, `learning`, `marketplace`, `guide`
...
- **Why use it:** Comprehensive DSH guide and plugin resource catalog for quick onboarding
...
- **Tags:** `awesome-list`, `mcp`, `deepseek-harness-plugins`
- **Why use it:** Extensive curated list covering plugins, MCP servers, patches and UIs
...
- **Tags:** `marketplace`, `plugin-directory`, `plugin-store`
...
- **Tags:** `awesome-list`, `resources`, `dsh`
...
- **Why use it:** Superpowers skills for DeepSeek Harness:
...
- **Why use it:** Complete reverse-skill (85 SKILL.md) as 
...
- **Why use it:** 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-pl
...
- **Why use it:** 88 installable open-source Agent Skills 
...
- **Why use it:** Awesome DSH Cordis Plugins �� the offici
...
- **Why use it:** DSH plugin: pixel-to-text image reading 
...
- **Why use it:** Agent skill for installed DeepSeek Harne
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Unified capability menu for DeepSeek Har
...
- **Why use it:** Manage DeepSeek Harness locally: run mul
...
- **Why use it:** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持多市场行情
...
- **⭐ Stars:** 12
- **Language:** Shell
- **Description:** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness ���件列表
...
- **Why use it:** Unofficial community plugin catalog
...
- **Tags:** `registry`, `curated-list`, `plugin-directory`
- **Why use it:** Curated open-data registry with spam filtering for DSH plugins.
...
- **Tags:** `registry`, `verified`, `plugin-directory`
- **Why use it:** Evidence-led directory with verified loadable plugins and permissions.
...
- **Tags:** `registry`, `community`, `verified`
- **Why use it:** Star-ranked community verified plugins for DeepSeek Harness.
...
- **Tags:** `registry`, `plugin-collection`, `curated`
...
- **Tags:** `documentation`, `guide`, `plugin-navigation`
...
- **Tags:** `registry`, `resource`, `awesome-list`
- **Why use it:** Curated plugins, tools, skills and resources — everything is a plugin.
...
- **Tags:** `repository`, `bundle`, `verification`
...
- **Tags:** `automated`, `directory`, `catalog`
...
- **Why use it:** DingTalk IM channel for DeepSeek Harness
...
- **Why use it:** The most comprehensive AI-curated list o
...
- **Why use it:** DSH plugins directory: 70+ verified Deep
...
- **Why use it:** A curated, evidence-aware shortlist of u
...
- **Why use it:** Curated plugins for DeepSeek Harness (ds

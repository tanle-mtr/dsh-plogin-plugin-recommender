...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 958,574 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-03 13:27:38 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 210,645 | Core platform for the DSH plugin ecosystem, enabli |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,794 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,310 | Original agent meta-harness for deploying multi-pl |
...
- **Why use it:** Core platform for the DSH plugin ecosystem, enabling plugin-first AI agent development
...
- **Tags:** `agentic-framework`, `multi-agent`, `swarm`, `mcp-server`
- **Why use it:** Original agent meta-harness for deploying multi-player swarms and autonomous workflows
...
- **Why use it:** Open-source super AI assistant with multi-model support, memory, and self-evolving skills
...
- **Tags:** `coding-agent`, `deepseek`, `tui`, `tool-use`
- **Why use it:** DeepSeek-native terminal coding agent with prefix-cache stability for long-running tasks
...
- **Tags:** `harness`, `tutorial`, `beginner`
- **Why use it:** Best starting point for learning DSH plugin development from scratch
...
- **Tags:** `orchestration`, `agent-workspace`, `multi-device`
...
- **Tags:** `routing`, `agent-control`, `harness`
- **Why use it:** Task-aware routing kit for intelligent agent reasoning mode selection
...
- **Why use it:** Self-improving agent OS with built-in loop engineering and evaluation
...
- **Tags:** `enterprise`, `workbench`, `multi-agent`
- **Why use it:** Enterprise-grade local-first workbench with visual editor for agent teams
...
- **Why use it:** First vision plugin for DSH; enables image-to-JSON for text-only coding agents
...
- **Why use it:** Two-phase preset with minimal bootstrap then full Standard tools (Project2 98/99)
...
- **Why use it:** World's first virtual terminal for AI agents with VFS and sandbox support
...
- **Tags:** `model-switch`, `cli`, `dsh-plugin`
- **Why use it:** One-click install and model switch across Claude Code, Codex CLI, Grok, DeepSeek, Kimi and more
...
- **Tags:** `agent-runtime`, `desktop`, `rust`, `dsh-plugin`
...
- **Why use it:** Security audit tool for AI-generated code — catches hallucinations and vulnerabilities
...
- **Why use it:** Ports popular Superpowers skill to Reasonix coding harness
...
- **Why use it:** Specialized skill for developing and packaging DSH plugins.
...
- **Tags:** `codex`, `mcp`, `sync`, `dsh-plugin`
...
- **Why use it:** Resolves plugin and version conflicts automatically
...
- **Why use it:** DSH plugin marketplace similar to CodeX style
...
- **Why use it:** Access ChatGPT models inside DSH via official OAuth integration
...
- **Why use it:** Modern desktop solution for DSH ecosystem where even the desktop itself is a plugin
...
- **Tags:** `web-ui`, `plugin-ecosystem`, `distribution`
...
- **Tags:** `taskboard`, `ui-extension`, `dsh-plugin`
...
- **Tags:** `tui`, `ui-extension`, `dsh-plugin`
- **Why use it:** Claude Code-style TUI with whale header, real-time status, streaming thinking and TPS
...
- **Tags:** `widget`, `ui`, `dsh`
- **Why use it:** Cute floating whale widget tracks DeepSeek account balance
...
- **Why use it:** Lightweight Tauri desktop with zero setup across platforms
...
- **Why use it:** Local-first desktop workspace integrating DSH sessions and files
...
- **Why use it:** Open-source Windows desktop client with SSH, mobile remote access, and full plugin support
...
- **Why use it:** Run live iOS Simulator and USB-connected iPhone inside DSH conversations with 22 automation tools
...
- **Why use it:** Cross-platform desktop client for DeepSeek Harness
...
- **Tags:** `ui`, `plugin-management`, `console`
- **Why use it:** Console for managing official DSH repository plugins without patching
...
- **Tags:** `desktop`, `electron`, `ui`
- **Why use it:** Electron desktop console: multi-tab manager for Harness/Plugin/MCP/Skills
...
- **Why use it:** Live balance, pricing and model info bar for DSH Web UI
...
- **Tags:** `bioinformatics`, `desktop`, `llm-agent`
...
- **Tags:** `background`, `ui`, `webui`
- **Why use it:** Customizable Web UI background with presets and auto-compression
...
- **Why use it:** One-click compact context button for DSH Web meter panel
...
- **Tags:** `knowledge-cards`, `ui`, `shareable`
- **Why use it:** Transform chat history into shareable beautiful knowledge cards
...
- **Why use it:** Self-evolving context database unifying agent memory, knowledge RAG, and skills
...
- **Tags:** `rag`, `knowledge-base`, `vector-search`, `multi-tenant`
- **Why use it:** LLM knowledge platform turning documents into queryable RAG, reasoning agent, and wiki
...
- **Why use it:** Portable local-first memory layer enabling cross-app agent continuity
...
- **Tags:** `memory`, `stateful-agents`, `library`
- **Why use it:** Core memory library for building stateful, context-aware AI agents
...
- **Why use it:** Best context management dashboard and insights for DSH
...
- **Tags:** `skill-routing`, `vector-search`, `embeddings`
- **Why use it:** Transforms scattered SKILL.md files into retrieval-ready corpora with evaluation tooling
...
- **Why use it:** Distill expert thinking patterns into reusable skills for any agent or bot system
...
- **Tags:** `low-code`, `crm`, `erp`, `workflows`, `ai-agent`
- **Why use it:** Open-source AI + no-code platform for building CRM, ERP, and internal tools fast
...
- **Tags:** `skills`, `marketplace`, `workflows`
- **Why use it:** Largest skills marketplace with auto-updated categorized skill packages
...
- **Tags:** `agent-skills`, `workflow`, `vibe-coding`, `dsh-plugin`
- **Why use it:** Intelligent skill routing and workflow orchestration with +21pp reward boost
...
- **Tags:** `research`, `web-search`, `ai-agent`
- **Why use it:** Auto-searches Chinese platforms and generates researched reports
...
- **Tags:** `video`, `agent-skills`, `automation`
- **Why use it:** End-to-end automated Vox-style explainer video generation
...
- **Why use it:** Enables multi-agent team coordination in DSH
...
- **Why use it:** Visual non-linear conversation workspace with canvas-based session branching
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review workflow, no iframe needed
...
- **Tags:** `competition`, `workflow`
- **Why use it:** Automated math modeling competition skill with GitOps
...
- **Why use it:** Essential skill for discovering and installing DSH plugins from GitHub.
...
- **Why use it:** Turn your experience into repeatable, sharable agent skills.
...
- **Why use it:** Proven TDD, debugging, planning skills adapted for DeepSeek.
...
- **Why use it:** 87 skill files for reverse engineering and authorized pentesting.
...
- **Why use it:** Brings proven engineering skills deck with wayfinder into DSH.
...
- **Tags:** `spec-driven`, `agent-skills`
- **Why use it:** Enables portable spec-driven development within repositories.
...
- **Why use it:** Full Chinese official document processing with format validation and optimization.
...
- **Why use it:** Cross-platform skill preserving session continuity between agents
...
- **Tags:** `design`, `skill`, `ui`, `dsh-plugin`
- **Why use it:** Design aesthetics skill pack with 6 styles to avoid AI-generated look
...
- **Tags:** `qa`, `skill`, `testing`, `dsh-plugin`
- **Why use it:** 10+ QA skills with shared knowledge base for AI-assisted testing
...
- **Tags:** `godot`, `game-dev`, `skill`, `dsh-plugin`
...
- **Tags:** `media`, `vision`, `skill`, `dsh-plugin`
...
- **Tags:** `video`, `image`, `skill`, `dsh-plugin`
- **Why use it:** AI video/image/audio skills with configurable model tools and corpus
...
- **Tags:** `skillhub`, `api-docs`, `skills`
- **Why use it:** Official SkillHub open API docs and examples for DSH skill development
...
- **Tags:** `skill`, `plugin-development`, `dsh`
...
- **Why use it:** One-click MCP, Skills and rule setup across major AI agent platforms
...
- **Why use it:** Pre-flight plugin check injects Top-K plugins for task requests
...
- **Why use it:** Open-source Claude Design alternative with local-first desktop app and design system support
...
- **Tags:** `agent-skills`, `architecture-diagram`, `mermaid-alternative`, `diagrams-as-code`
- **Why use it:** Agent skill for generating beautiful architecture, workflow, and sequence diagrams as code
...
- **Tags:** `ai-image-generation`, `prompt-engineering`, `skills`, `workflow-automation`
- **Why use it:** Industrial-grade GPT-Image2 prompt engine with 530+ cases and 20+ reusable skill templates
...
- **Tags:** `mascot`, `pixel-art`, `ui`, `pets`
- **Why use it:** Public gallery of animated mascot pets enhancing developer agent experience
...
- **Why use it:** Powerful vision toolkit for text-only LLMs with OCR
...
- **Why use it:** Generate images directly in DSH chats using multiple AI model backends
...
- **Tags:** `creative-writing`, `drama`, `novel`
- **Why use it:** Powerful creative writing toolkit for novels and short dramas
...
- **Why use it:** Legal visualization toolkit: redraw litigation diagrams and generate timelines
...
- **Tags:** `image-reading`, `ocr`
- **Why use it:** Enables pixel-art image reading and OCR for text-only models.
...
- **Tags:** `browser-extension`, `chat-management`, `prompt-manager`, `chrome-extension`
- **Why use it:** Enhancement suite for Gemini, Claude, ChatGPT with cross-browser support and prompt management
...
- **⭐ Stars:** 3,187
- **Language:** Python
- **Description:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台���开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `cross-platform`, `privacy-first`, `dsh-plugin`
...
- **Why use it:** Use real logged-in browser with AI agents seamlessly
...
- **Why use it:** Strongest free web search plugin for DSH — no signup, no API key required
...
- **Tags:** `dingtalk`, `chat-bot`, `im-channel`
- **Why use it:** DingTalk IM channel with stream-mode bot and agent capabilities
...
- **Why use it:** Privacy-first resume builder with self-hosting support and customizable templates
...
- **Tags:** `electron-app`, `image-uploader`, `s3`, `github`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services, works with Obsidian, Typora, VS Code
...
- **Tags:** `infrastructure`, `discovery`, `plugin`
- **Why use it:** Ecosystem radar discovering and validating 15900+ plugins
...
- **Tags:** `catalog`, `awesome-list`, `plugins`
- **Why use it:** Curated plugin catalog for the DSH ecosystem
...
- **Tags:** `awesome-list`, `catalog`, `tools`
...
- **Tags:** `breaking`, `utility`, `deepseek`
- **Why use it:** Armor-breaking plugin extending DeepSeek capabilities
...
- **Why use it:** Brings full office suite to DSH with docs and spreadsheets
...
- **Tags:** `cost-tracking`, `billing`
- **Why use it:** Track session costs and API usage budgets in real-time
...
- **Why use it:** Plugin marketplace with 11,000+ DSH plugins and API
...
- **Tags:** `catalog`, `search`
- **Why use it:** Comprehensive plugin catalog with 1,958 repos and search
...
- **Why use it:** Bridge Pi ecosystem to DSH with ABI compatibility layer
...
- **Tags:** `context-migration`, `utility`
- **Why use it:** Seamless cross-preset session migration with full state preservation.
...
- **Tags:** `remote`, `p2p`, `security`
- **Why use it:** Secure P2P multi-device remote access to your DSH instance.
...
- **Why use it:** Smartisan-style open notes app with Docker and WeChat export.
...
- **Tags:** `mcp`, `management`, `menu`
- **Why use it:** Unified menu to manage MCP tools exposure and execution mode
...
- **Why use it:** Backup, restore, migrate and sync your full DSH config via WebDAV
...
- **Tags:** `plugin-mgmt`, `infrastructure`
- **Why use it:** Manages slots, remotes, and credentials for installed DSH plugins.
...
- **Tags:** `upgrade`, `plugin-mgmt`
- **Why use it:** Auto-upgrades plugins to stay compatible with DSH version changes.
...
- **Tags:** `dsh-box`, `management`
- **Why use it:** Isolated container management for multiple DSH versions with WebView.
...
- **Tags:** `skills-mgr`, `utilities`
- **Why use it:** Unified loader and manager for safe local Agent Skills in DSH.
...
- **Tags:** `package-manager`, `skill`, `mcp`, `dsh-plugin`
- **Why use it:** Package manager with 42 skills, 5 CLIs and 1 plugin for agent dev
...
- **Tags:** `dashboard`, `cost-tracking`, `token-usage`
- **Why use it:** Real-time token usage, cost tracking, and API balance dashboard
...
- **Why use it:** Whale Girl anime-style skin series for DeepSeek Harness customization
...
- **Why use it:** Highly customizable frosted glass UI theme for DSH web interface
...
- **Tags:** `theme`, `visual`
- **Why use it:** Stunning WebGPU ocean-themed skin for DSH interface
...
- **Tags:** `encyclopedia`, `ai-resources`, `knowledge-base`
- **Why use it:** Comprehensive AI resource encyclopedia covering skills, MCP, RAG, and learning paths
...
- **Tags:** `learning`, `guide`
- **Why use it:** Learn DSH principles and discover best practices
...
- **Why use it:** Ultimate guide with curated plugins and resources
...
- **Why use it:** Curated collection of DSH plugins, skills and MCP servers
...
- **Why use it:** Academic paper search across PubMed, arXiv, Crossref and more
...
- **Tags:** `research`, `arxiv`, `latex`
- **Why use it:** Full-stack research workbench: LaTeX, arXiv, experiments, SSH.
...
- **Tags:** `api`, `research`, `chinese-platforms`
- **Why use it:** Search 65,600+ API docs from 20 Chinese open platforms directly in agent
...
- **Tags:** `patent`, `research`, `legal-tech`
- **Why use it:** Patent infringement analysis system generating competitive reports from patent IDs
...
- **Why use it:** Comprehensive industry research methodology and company analysis toolkit.
...
- **Why use it:** 24 verified finance/quant plugins for stock analysis
...
- **Tags:** `awesome-list`, `plugin-directory`, `dsh-ecosystem`
- **Why use it:** Comprehensive DSH plugin directory with verification tools
...
- **Tags:** `ai-agents`, `awesome-list`, `bilingual`
...
- **Tags:** `ai-agent`, `plugin-registry`, `2origin`
- **Why use it:** Plugin radar and 2Origin lab for DSH ecosystem exploration
...
- **Tags:** `discoverability`, `search`, `agent-tool`
...
- **Tags:** `recommender`, `ai-curated`, `plugin-list`
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugin-collection`, `dsh-plugins`
- **Why use it:** DSH plugin collection resource
...
- **Tags:** `auto-updating`, `data-driven`, `bilingual`
- **Why use it:** Auto-updating data-driven plugin directory with bilingual README
...
- **Tags:** `curated`, `typescript`, `plugin-directory`
- **Why use it:** Curated plugin guide covering models, tools, sandboxes, and UI
...
- **Tags:** `evidence-aware`, `shortlist`, `useful-plugins`
...
- **Why use it:** Essential curated plugin directory for discovering DSH ecosystem tools
...
- **Why use it:** Essential curated list for discovering DSH plugins and resources
...
- **Why use it:** Daily auto-curated plugin discovery with scene-based categorization and quality filtering
...
- **⭐ Stars:** 164
- **Language:** TypeScript
- **Description:** DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评分���详情，支持复制磁力。
- **Tags:** `anime`, `torrent`, `bangumi`
- **Why use it:** Search anime across multiple sources directly in conversation.
...
- **Why use it:** Auto-generated official curated list of DSH Cordis plugins.
...
- **Why use it:** Curated awesome list of DSH plugins, extensions and tools
...
- **Tags:** `community`, `catalog`, `plugin-marketplace`
- **Why use it:** Community-maintained auto-syncing plugin catalog every 4 hours
...
- **Tags:** `fengshui`, `tradition`
- **Why use it:** Unique Bazi, Fengshui, and IChing skill with local deterministic engine.
...
- **Why use it:** Unofficial community catalog listing DSH plugins and resources
...
- **Tags:** `awesome-list`, `curated-list`, `plugins`
- **Why use it:** Curated list of quality DeepSeek Harness plugins
...
- **Tags:** `awesome-list`, `directory`, `plugin-discovery`
- **Why use it:** Public GitHub directory for plugin discovery and install commands
...
- **Why use it:** Comprehensive curated awesome list covering plugins, tools, skills, and MCP
...
- **Why use it:** 2026 curated plugin list with quality checks for DSH ecosystem
...
- **Why use it:** Chinese community curated DSH plugin collection
...
- **Why use it:** Star-ranked verified community DSH plugin list
...
- **Tags:** `plugin-guide`, `awesome-list`
- **Why use it:** Plugin product manual with scene-based selection guide
...
- **Why use it:** Auto-updated bilingual DSH plugin directory via GitHub Actions
...
- **Tags:** `moved`, `archived`
- **Why use it:** Moved to new repo — no longer active at this location

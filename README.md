...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 940,269 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-01 20:48:36 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 207,971 | Core harness framework powering the entire DSH plu |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,334 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,131 | Original meta-harness for multi-agent swarms and a |
...
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 26 plugins
...
- [Agent Skills & Workflows](agent-skills-workflows) (26)
...
- **Tags:** `no-code`, `low-code`, `internal-tools`, `dsh-plugin`
...
- **Tags:** `deepseek`, `dsh-plugin`, `preset`
- **Why use it:** Essential DSH preset combining minimal bootstrap with full Standard tools for optimal agent setup.
...
- **Why use it:** Groundbreaking virtual terminal enabling isolated sandbox environments for AI agents.
...
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for agentic coding workflows.
...
- **Why use it:** Specialized skills for writing and debugging high-performance AI infrastructure
...
- **Why use it:** Superpowers skill ported to Reasonix coding harness for enhanced DSH coding.
...
- **Tags:** `agent-skills`, `plugin-dev`, `dsh-plugin`
- **Why use it:** Agent Skill for developing DSH plugins — standard guide for plugins, services, tools and adapters.
...
- **Tags:** `ocr`, `vision`
- **Why use it:** OCR and pixel-to-text tools for text-only model vision
...
- **Tags:** `plugin-creation`, `validation`
...
- **Why use it:** Godot 4.x full-stack game dev skill
...
- **Why use it:** In-development agent skill for building and auditing DSH plugins.
...
- **Tags:** `neovim`, `plugin-manager`, `lua`, `developer-tools`
- **Why use it:** Fast and elegant Neovim plugin manager for coding workflows.
...
- **Tags:** `agent-tools`, `pre-flight`, `optimization`
- **Why use it:** Pre-flight plugin library check for DSH agents, boosts utilization predictably.
...
- **Why use it:** Modern flexible task board embedding seamlessly into Codex and DeepSeek Harness workflows.
...
- **Why use it:** Claude Code-style TUI with whale topbar, real-time status, streaming thoughts and context progress.
...
- **Why use it:** Cute floating whale widget for account balance monitoring
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero setup
...
- **Why use it:** Local-first AI desktop workspace for DSH sessions and files
...
- **Why use it:** Render interactive UI components—charts, forms, quizzes—in chat replies inline.
...
- **Why use it:** Visual non-linear conversation workspace with canvas-based session exploration and branching.
...
- **Tags:** `desktop`, `windows`, `ssh-client`, `electron`
- **Why use it:** Open-source Windows desktop GUI client with Codex, SSH, plugins, and mobile remote access.
...
- **Tags:** `desktop`, `cross-platform`, `codepilot`, `electron`
...
- **Tags:** `dsh-plugin`, `capability-menu`, `mcp`
...
- **Tags:** `balance`, `pricing`, `ui`
- **Why use it:** Useful live balance and pricing info bar
...
- **Tags:** `agent-skills`, `canvas`, `agentic-workflow`, `mcp`
- **Why use it:** Native WeShop plugin enabling infinite canvas with creative skills.
...
- **Why use it:** Adds a compact context button to the DSH Web panel.
...
- **Tags:** `multi-agent`, `agent-workflow`, `dsh-plugin`
- **Why use it:** Original meta-harness for multi-agent swarms and autonomous workflows
...
- **Tags:** `knowledge-distillation`, `agent-skills`, `dsh-plugin`
- **Why use it:** Distill expert thinking into reusable agent skills and personas
...
- **Why use it:** Intelligent skill routing and workflow orchestration significantly boosting agent reward and efficiency.
...
- **Why use it:** Cognitive enhancement skills based on Anthropic J-space global workspace research for deeper reasoning.
...
- **Why use it:** Multi-agent team coordination for complex tasks
...
- **Why use it:** Native SQLite-backed task management board with agent claim/review workflow built in.
...
- **Why use it:** Adds multimodal vision to text-only LLM agents for screenshot and UI analysis
...
- **Why use it:** 87 specialized skills for reverse engineering and authorized pentesting
...
- **Tags:** `dsh-plugin`, `agent-skills`, `coding`
- **Why use it:** AI coding mentor skill: scans project, generates chapters, codes review.
...
- **Why use it:** Manages DSH slots, remotes, and credentials as agent skill
...
- **Tags:** `spec-driven`, `agent-skill`
- **Why use it:** Portable spec-driven development skill for repository coding
...
- **Tags:** `skills`, `gamification`
- **Why use it:** Game-like quest system for MattSkillsDeck in DSH
...
- **Tags:** `knowledge-base`, `plugin-dev`
- **Why use it:** Official docs archive as on-demand plugin dev knowledge base
...
- **Tags:** `chinese-wisdom`, `agent-skill`
- **Why use it:** Bazi, Fengshui, IChing and TCM fused as AI Agent skill
...
- **Why use it:** Unified loading and safe management of local Agent Skills
...
- **Why use it:** Multi-agent collaboration with independent tools and shared workspace
...
- **Why use it:** WorkBuddy-style skill picker in composer
...
- **Why use it:** Simplifies code automatically in Codex
...
- **Why use it:** QA testing skills framework for AI agents
...
- **Why use it:** Provides structured Swift Cycle governance as a portable agent skill.
...
- **Why use it:** Virtual product team agent preset for PM-to-engineer workflows.
...
- **Tags:** `mcp`, `hot-reload`, `skill-management`, `mcp-server`
- **Why use it:** Hot-reload MCP connections via UI; no restart needed for config changes.
...
- **Why use it:** Bind ChatGPT account via OAuth and chat with ChatGPT models inside DSH.
...
- **Why use it:** Beautiful architecture and workflow diagrams as code with animations
...
- **Why use it:** Automated end-to-end explainer video generation with AI
...
- **Why use it:** Vision toolkit for text-only models: OCR, screenshot testing
...
- **Why use it:** AI design studio with template marketplace and PPT support
...
- **Tags:** `image-generation`, `multi-model`, `openai`
- **Why use it:** Generate images directly in DSH chats via multiple AI model integrations.
...
- **Why use it:** Legal litigation visualization toolkit — generate accurate timelines and case diagrams.
...
- **Tags:** `design`, `styles`, `ui`
- **Why use it:** 6 design styles to avoid generic AI look
...
- **Why use it:** Free image reading and generation skills
...
- **Tags:** `video`, `audio`, `vision`
- **Why use it:** AI video/image/audio skills and vision tools
...
- **Why use it:** Enhancement suite and prompt manager for major AI web interfaces
...
- **Tags:** `content-discovery`, `bilibili`, `cross-platform`
- **Why use it:** Cross-platform AI content discovery agent locally self-hosted, scraping major Chinese and global platforms.
...
- **Why use it:** Real logged-in browser automation for AI agents
...
- **Why use it:** Live iOS Simulator and USB iPhone control with 22 agent tools for mobile automation.
...
- **Why use it:** Official Tabbit browser automation plugin for DeepSeek Harness.
...
- **Tags:** `dingtalk`, `chat-bot`, `ai-agent`, `dsh-plugin`
- **Why use it:** Brings DeepSeek Harness agent capabilities to DingTalk IM.
...
- **Tags:** `multi-agent`, `installer`, `tool-switch`
- **Why use it:** One-click multi-agent-install tool switching between DSH, Claude Code, Codex, Grok and more.
...
- **Tags:** `armor-breaking`, `utility`, `extension`
- **Why use it:** Armor-breaking utility to extend DeepSeek usage limits
...
- **Why use it:** Curated daily plugin discovery hub with accurate categorization and beginner guides.
...
- **Tags:** `context-migration`, `session`, `presets`
- **Why use it:** Preserves session state and intent across preset migrations
...
- **Why use it:** Web UI tool for managing DSH skills and MCP configurations
...
- **Tags:** `marketplace`, `web-gui`, `plugin-management`
...
- **Why use it:** Backup and restore your complete DSH config, plugins, MCPs and skills via WebDAV.
...
- **Why use it:** Plugin registry infrastructure with console UI and official dev guide skill.
...
- **Why use it:** Auto-upgrades plugins alongside DSH version changes
...
- **Why use it:** Multi-version DSH container management with embedded WebView
...
- **Tags:** `config-sync`, `multi-agent`
- **Why use it:** One-click MCP, skills, and rules config for multiple AI agents
...
- **Why use it:** Audits context token costs and detects conflicts
...
- **Tags:** `package`, `manager`, `skills`
- **Why use it:** Package manager for 42 agent skills and CLIs
...
- **Tags:** `migration`, `import`, `mcp`, `skills`, `configuration-migration`
- **Why use it:** Seamlessly migrates Claude Code/Codex/OpenCode setups into DSH.
...
- **Tags:** `utility`, `conflict-resolution`, `maintenance`
...
- **Why use it:** Whale Girl themed cosmetic skin series for DeepSeek Harness visual customization.
...
- **Why use it:** Frosted glass UI theme with full customization for DSH web interface.
...
- **Tags:** `color-scheme`, `theme`, `skin`, `ui`, `customization`
- **Why use it:** 34 opencode themes in one click; visually refreshing for DSH UI.
...
- **Tags:** `theme`, `customization`, `background`
- **Why use it:** Custom DSH web background with presets and image upload support.
...
- **Tags:** `research`, `skill`, `web-search`, `china`
- **Why use it:** Auto-searches 8 major Chinese internet platforms over 30 days and generates citable research reports.
...
- **Tags:** `plugin-registry`, `ecosystem`, `k8s`
- **Why use it:** Radar auto-discovering 15900+ DSH plugins with validation
...
- **Why use it:** AI security platform for auditing code against hallucinations and vulnerabilities.
...
- **Tags:** `academic-search`, `arxiv`, `pubmed`, `mcp`
...
- **Why use it:** Full-cycle research workbench: LaTeX, arXiv, GPU SSH, experiment tracking
...
- **Why use it:** Community-maintained auto-synced catalog of DSH plugins every 4 hours.
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms directly in your coding agent.
...
- **Why use it:** Patent infringement analysis system — input patent number, get competitive analysis report.
...
- **Why use it:** Industry research methodology, chain mapping, and news tracking
...
- **Why use it:** Curated awesome list helping discover and learn DSH plugins.
...
- **Why use it:** Public directory with install commands for ecosystem discovery.
...
- **Tags:** `data-visualization`, `token-usage`, `ai-cost`, `api`
- **Why use it:** Visualizes real-time token usage and API cost for budgeting insights.
...
- **Why use it:** Spam-filtered registry with open data for reliable plugin discovery.
...
- **Tags:** `awesome-list`, `plugins`, `skills`, `resources`
- **Why use it:** Comprehensive curated list covering plugins, skills, tools, and resources.
...
- **Why use it:** Evidence-led directory with verified plugins and safe installation guidance.
...
- **⭐ Stars:** 6,031
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：416个精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。
...
- **Why use it:** 收录最全、更新最快的技能Skills商店：416个精选原创技能包（涵盖文档处理、
...
- **Why use it:** Curated awesome list of DSH plugins and ecosystem tools
...
- **Why use it:** Give DeepSeek Harness a real office environment.  Univer Office Plugin brings sp
...
- **Tags:** `ai`, `ai-agent`, `claude`, `claude-code`, `cli`, `coding-agent`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `go`, `oh-my-pi`, `omp`, `openai`, `pi`, `terminal`, `tui`
- **Why use it:** a coding Agent, npc plugin, sub-agents, hashline edits, and mcp
...
- **Why use it:** 让 Agent 的工作方式可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin 
...
- **Why use it:** Auto-generated official list of DSH Cordis plugins by cordis.run
...
- **Why use it:** Complete 1000+ plugin directory sorted by stars for DSH.
...
- **Tags:** `guide`, `navigation`, `directory`
- **Why use it:** Plugin guide and navigation by scenario with compatibility info.
...
- **Why use it:** Community-curated DSH plugin collection and ecosystem directory.
...
- **Why use it:** Bilingual curated plugin directory with immutable reviews.
...
- **Tags:** `awesome-list`, `dsh-plugin-directory`, `catalog`
- **Why use it:** Auto-updating bilingual plugin directory via GitHub Actions.
...
- **Tags:** `agent`, `discoverability`, `search`, `dsh-plugin`
- **Why use it:** Enables in-agent plugin search and discovery from npm.
...
- **Tags:** `recommender`, `awesome-list`, `mcp`, `coding-agents`
...
- **Why use it:** Archived; redirected to awesome-dsh-plugin repo.
...
- **Why use it:** Data-driven auto-generated bilingual plugin README.
...
- **Tags:** `coding-agents`, `curated-list`, `deepseek-harness-plugins`, `ui`
- **Why use it:** Curated DSH plugins covering models, tools, sandboxes, and UI.
...
- **Why use it:** Industry-specific DSH plugins: finance, legal, medical, e-commerce.

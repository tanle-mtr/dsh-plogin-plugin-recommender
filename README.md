...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 975,758 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-06 20:13:28 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 213,947 | Core DSH framework; everything is a plugin archite |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,444 | Open-source Figma alternative with local-first des |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,932 | Multi-agent swarm orchestration with MCP server su |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 25 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (25)
...
- **Why use it:** Core DSH framework; everything is a plugin architecture
...
- **Why use it:** Multi-model, multi-channel AI assistant with self-evolving memory
...
- **Tags:** `coding-agent`, `tui`, `prompt-caching`, `dsh-plugin`
...
- **Tags:** `agent-orchestration`, `mcp`, `skills`, `no-code`
- **Why use it:** All-in-one agent workspace across desktop, mobile, browser with board-based task tracking.
...
- **Why use it:** Self-improving Agent OS with staged evaluation and budgeted evolution loop.
...
- **Tags:** `agent-ops`, `workflow-automation`, `loop-engineering`
...
- **Tags:** `agent-workspace`, `multi-agent`, `mcp`, `skills`
- **Why use it:** Enterprise local-first agent workbench with multi-engine workspace support.
...
- **Tags:** `vision`, `ocr`, `deepseek-harness`
...
- **Tags:** `code-review`, `lint`, `architecture`
...
- **Tags:** `security`, `cybersecurity`, `code-audit`, `redteam`
- **Why use it:** Audits AI code for hallucinated packages & vulns
...
- **Tags:** `coding-agent`, `mcp`, `deepseek-harness`
- **Why use it:** Sub-agents and MCP integration for powerful coding workflows
...
- **Tags:** `agent`, `self-evolving`, `review`
- **Why use it:** Composable, human-reviewed self-evolving agent modes for DSH
...
- **Tags:** `migration`, `compatibility-layer`, `dsh-plugin`
- **Why use it:** Bridge Pi ecosystem extensions to run natively on DSH
...
- **Why use it:** Adds multimodal vision to text-only LLMs for UI and layout analysis
...
- **Why use it:** Superpowers skill ported for coding agents
...
- **Why use it:** TDD, debugging, planning skills for coding agents
...
- **Tags:** `plugin-dev`, `skills`, `tooling`
- **Why use it:** Agent skill that standardizes DSH plugin development from scaffolding to packaging
...
- **Tags:** `plugin-dev`, `validation`, `build`
- **Why use it:** Builds and validates DSH plugins with slots, Typert remotes, and credential management
...
- **Why use it:** Multi-agent team collaboration with shared workspace in DSH
...
- **Tags:** `desktop`, `dsh-plugin`, `cordis`, `dsh`
- **Why use it:** Modern desktop client for DSH ecosystem where the desktop itself is a plugin
...
- **Tags:** `dsh-web`, `dsh-plugin`, `ui`
- **Why use it:** Web UI aggregation ecosystem for DSH plugins via Creative Workshop.
...
- **Why use it:** Extensible sidebar foundation with built-in file editor, terminal, Git
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, rollback support
...
- **Why use it:** Rust-built high-performance agent runtime with polished desktop application
...
- **Why use it:** Cute floating whale widget tracking account balance with animations
...
- **Why use it:** 5MB Tauri desktop with zero setup, preset plugins, cross-platform
...
- **Why use it:** Local-first Electron desktop for DSH sessions, projects, files and Office
...
- **Tags:** `gui`, `ui-components`, `charts`, `forms`
- **Why use it:** Inline GenUI components: charts, forms, quizzes
...
- **Tags:** `desktop`, `electron`, `windows`, `ssh-client`
- **Why use it:** Zero-setup Electron desktop client with SSH & mobile
...
- **Tags:** `desktop`, `local-first`, `privacy`, `tauri`
- **Why use it:** Local-first multi-model desktop app, privacy-focused
...
- **Tags:** `office`, `desktop`, `deepseek-harness`
...
- **Tags:** `ios`, `mobile`, `harness`
- **Why use it:** Native iOS client for DSH with WebSocket real-time agent tracking
...
- **Why use it:** Open-source Smartisan Notes with Docker deployment and WeChat export
...
- **Tags:** `deepseek`, `dsh`, `mcp`, `plugin`, `skills`
- **Why use it:** Manage skills and MCPs directly in DSH web UI
...
- **Why use it:** Browse and install community plugins via web GUI
...
- **Why use it:** Unified menu to manage MCP tool exposure levels
...
- **Tags:** `desktop-app`, `electron`, `plugin-management`
- **Why use it:** Electron desktop hub for managing DSH plugins, MCPs, and skills in one UI
...
- **Tags:** `ui`, `usage-tracking`, `balance`
- **Why use it:** Adds provider/model info, balance, and pricing countdown to DSH UI
...
- **Why use it:** Bioinformatics desktop agent for clinicians with skill store
...
- **Why use it:** All-in-one DevOps desktop with DB, SSH, Docker and AI
...
- **Tags:** `desktop-app`, `electron`, `deepseek-harness`, `plugin`
- **Why use it:** Electron desktop wrapper for DSH Web with integrated plugins and ModLens.
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin-market`, `ui`
- **Why use it:** One-click button to compact the DSH Web context meter panel.
...
- **Tags:** `agent-memory`, `agentic-rag`, `context-database`, `dsh-plugin`
...
- **Why use it:** RAG platform turning documents into queryable knowledge base and wiki
...
- **Tags:** `memory`, `rag`, `mcp`, `agent-memory`
- **Why use it:** Portable, local-first memory layer for all AI agents with Markdown-native storage.
...
- **Why use it:** Memory library for building stateful agents with continual learning support.
...
- **Why use it:** Persistent unified memory layer backed by Milvus with hybrid semantic search
...
- **Why use it:** Best context insight and management tool with dashboard and commands
...
- **Tags:** `vector-search`, `semantic-search`, `embeddings`, `skill-routing`
- **Why use it:** Semantic skill corpus with vector search and reranking
...
- **Tags:** `skills`, `agent-skills`, `dsh-plugin`
- **Why use it:** Largest skill marketplace with auto-curation by category, stars, and update time.
...
- **Tags:** `preset`, `tools`, `deepseek-harness`
...
- **Tags:** `skills`, `workflow`, `agent`
- **Why use it:** Intelligent skill routing and workflow orchestration with proven token savings
...
- **Why use it:** End-to-end auto-generated Vox-style explainer videos from one topic
...
- **Why use it:** Multi-agent teamwork plugin for orchestrating collaborative DSH agents
...
- **Tags:** `armor-breaking`, `deepseek`, `generation`
- **Why use it:** DeepSeek-specific armor-breaking plugin for stable high-capacity generation
...
- **Tags:** `workspace`, `canvas`, `conversation`, `workflow`
...
- **Tags:** `multimodal`, `ocr`, `video-analysis`, `speech-to-text`
- **Why use it:** Gives agents vision & hearing via video/audio/OCR
...
- **Tags:** `task-management`, `sqlite`, `native-ui`, `workflow`
- **Why use it:** Native SQLite taskboard with agent claim/review
...
- **Why use it:** Specialized workflow for novel writing & short drama
...
- **Tags:** `math-modeling`, `skill`, `competition`
- **Why use it:** Full-stack auto math modeling workflow for national/intl contests
...
- **⭐ Stars:** 184
- **Language:** Python
- **Description:** 基于tushare构建本地财经数据库。AI��生的多Agent金融分析系统，支持skill拓展Agent能力并自适应生成http接口与mcp调用。支持本地数据库访问的skill对接deepseek-harness/openclaw等通用智能体与微信/QQ/飞书等IM通道盯盘
- **Tags:** `finance`, `agent-skills`, `mcp`
- **Why use it:** Multi-agent financial analysis with local DB and IM monitoring
...
- **Tags:** `agent-skills`, `coding`, `architecture`
- **Why use it:** Turn experience into repeatable AI agent execution workflows
...
- **Tags:** `agent-learning`, `agent-skills`, `ai-agent`, `skill-generator`
- **Why use it:** Auto-turn successful sessions into reusable skills
...
- **Why use it:** Auto-upgrade plugins as DSH version evolves
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** AI mentor skill: scaffold projects, review code
...
- **Tags:** `skills`, `productivity`, `github-issues`
- **Why use it:** 25 ready-to-use engineering and productivity skills installed via one command
...
- **Why use it:** Official DSH plugin dev knowledge base as on-demand agent skill
...
- **Tags:** `dsh-plugins`, `skill-management`
- **Why use it:** Unified management and safe loading of local Agent Skills in DSH
...
- **Why use it:** Chinese traditional wisdom AI skill: Bazi, Fengshui, IChing and more
...
- **Tags:** `code-simplification`, `agent-skill`
- **Why use it:** Code simplification skill adapted from DeepSeek Harness
...
- **Tags:** `skill-picker`, `composer`, `ui`
- **Why use it:** WorkBuddy-style skill picker in DSH composer with /skill-name inserts
...
- **Why use it:** Cross-platform agent handoff for repository-local continuity memory
...
- **Why use it:** QA testing skill framework with 10 skills for AI agents
...
- **Why use it:** Virtual product team agent preset for user-led PM to QA conversations.
...
- **Tags:** `ai-design`, `figma-alternative`, `ui-generator`, `dsh-plugin`
- **Why use it:** Open-source Figma alternative with local-first desktop app for AI design
...
- **Tags:** `architecture-diagram`, `diagrams-as-code`, `mermaid-alternative`, `dsh-plugin`
...
- **Why use it:** Industrial-grade GPT-Image2 prompt templates with 530+ reverse-engineered cases
...
- **Tags:** `design`, `ui`, `agent-team`, `vibedesign`
...
- **Why use it:** Vision toolkit for text-only models: image Q&A, OCR, screenshot UI restore
...
- **Why use it:** AI-generated editable design system with template market and PPT studio
...
- **Why use it:** Creates professional litigation timelines and legal diagrams from case materials
...
- **Why use it:** Pixel-to-text OCR and image analysis tool for text-only AI models
...
- **Why use it:** AI video/image generation skills with configurable model tools
...
- **Why use it:** 6 design styles to prevent AI-looking websites
...
- **Why use it:** Free image reading and generation with vision support
...
- **Tags:** `browser-extension`, `chat-management`, `prompt-manager`, `dsh-plugin`
- **Why use it:** Browser extension suite enhancing Gemini, Claude, ChatGPT with prompt management
...
- **Tags:** `web-search`, `free`, `no-api-key`, `fetch`
- **Why use it:** Free web search bridge — no signup, no API key
...
- **Why use it:** Live iOS simulator and device automation for AI agents
...
- **Why use it:** Privacy-focused, self-hosted resume builder with MCP integration
...
- **Tags:** `image-uploader`, `electron`, `github`, `s3`, `dsh-plugin`
- **Why use it:** Ultimate image uploader supporting 60+ hosting services and popular apps
...
- **Tags:** `no-code`, `low-code`, `ai-agent`, `workflows`, `dsh-plugin`
- **Why use it:** Open-source no-code platform with AI-powered business system building
...
- **Tags:** `dsh-plugin`, `mcp`, `agent`
- **Why use it:** Router-standard kit with runtime injector for DSH task-aware reasoning.
...
- **Tags:** `marketplace`, `utility`, `dsh`
- **Why use it:** In-app plugin marketplace for browsing and one-click installation
...
- **Tags:** `utility`, `model-switch`, `installer`
- **Why use it:** One-click install and model switching across 10+ AI coding platforms
...
- **Why use it:** Self-hostable radar discovering 15900+ plugins with k8s-tested pipelines
...
- **Why use it:** Curated awesome-list of DSH ecosystem plugins, tools, and infrastructure
...
- **Why use it:** Curated plugin ecosystem list covering agents, MCP, and web-ui tools
...
- **Tags:** `oauth`, `subscriptions`, `llm-providers`, `authentication`
- **Why use it:** OAuth login lets you use ChatGPT/Claude/Grok subs
...
- **Why use it:** Comprehensive curated plugin marketplace refreshed daily
...
- **Why use it:** Track session costs, budgets and API token usage in real-time
...
- **Why use it:** CLI and resolver for managing DSH Plugin Hub efficiently
...
- **Tags:** `marketplace`, `catalog`, `utility`
...
- **Tags:** `remote-access`, `p2p`, `dsh-plugin`
- **Why use it:** Secure P2P multi-device remote access to DSH and CodeX
...
- **Tags:** `backup`, `config-manager`, `mcp`, `migration`, `sync`, `webdav`
- **Why use it:** Backup, restore, sync and migrate DSH config
...
- **Why use it:** Search 65K+ Chinese API docs across multi-platforms
...
- **Why use it:** Plugin registry console + dev guide, zero-patch infrastructure for DSH ecosystem
...
- **Why use it:** Complete Chinese official document processor following national formatting standards
...
- **Tags:** `container`, `multi-version`, `infrastructure`
...
- **Why use it:** Audit context tokens, detect duplicates and conflicts with Web UI
...
- **Why use it:** Bidirectional chat sync between OpenAI Codex and DSH with MCP mirroring
...
- **Tags:** `deepseek-harness`, `delivery-gate`, `dsh`, `dsh-plugin`, `engineering-discipline`, `guard`, `quality-gate`, `requirements`, `skill`
- **Why use it:** Engineering discipline guard for requirements and quality
...
- **Tags:** `ai-cost`, `data-visualization`, `deepseek-api`, `token-usage`
- **Why use it:** Track token usage and API costs with real-time charts and balance info.
...
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness-plugin`, `compatibility`
- **Why use it:** Diagnoses and resolves plugin conflicts and version compatibility issues.
...
- **Tags:** `mascot`, `cli`, `themes`, `pixel-art`
- **Why use it:** Public gallery of animated pets for developer tools, adds charm to CLI sessions.
...
- **Tags:** `theme`, `skin`, `aesthetic`
- **Why use it:** Adorable whale girl themed skin series for DeepSeek Harness
...
- **Tags:** `theme`, `glassmorphism`, `ui-customization`, `transparent`
- **Why use it:** Frosted-glass theme with fully customizable blur
...
- **Why use it:** Stunning WebGPU ocean theme to visually enhance DSH interface
...
- **Tags:** `background`, `webui`, `personalization`, `dsh-plugin-market`
- **Why use it:** Customize DSH Web backgrounds with presets and personal image uploads.
...
- **Tags:** `ai`, `llm`, `vibe-coding`, `rag`
- **Why use it:** Comprehensive AI resource hub with tutorials and prompts for all major LLMs.
...
- **Tags:** `dsh`, `harness`, `agent`, `tutorial`
...
- **⭐ Stars:** 3,212
- **Language:** Python
- **Description:** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、��乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `research`, `multi-platform`
- **Why use it:** Cross-platform content discovery agent across 10+ Chinese and global platforms
...
- **Why use it:** Searches 8 major Chinese platforms for last 30 days, generates cited reports
...
- **Tags:** `awesome-list`, `curated-list`, `bilingual`, `extensions`
- **Why use it:** Curated bilingual plugin index for DSH discovery
...
- **Tags:** `encyclopedia`, `knowledge-base`, `mcp`, `mlops`
- **Why use it:** One-stop AI encyclopedia: agents, RAG, MLOps, skills
...
- **Tags:** `awesome-list`, `verification`, `discovery`, `plugin-curator`
- **Why use it:** Auto-verifies plugins daily, filters fake listings
...
- **Tags:** `guide`, `awesome-list`, `research`
...
- **Tags:** `guide`, `education`, `best-practices`
...
- **Why use it:** Curated catalog of plugins, skills, MCP servers and patches
...
- **Why use it:** One-stop research workbench with LaTeX, arXiv and GPU task orchestration
...
- **Why use it:** Cross-platform academic search with citation graphs and verification
...
- **Tags:** `company-research`, `industry-research`, `report`
...
- **Why use it:** Patent infringement analysis with RAG, callable as a skill by any agent
...
- **Why use it:** AI investment desk with multi-strategy backtesting and compliance guardrails
...
- **Tags:** `kline`, `financial-analysis`, `interactive`
...
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos and bilingual search
...
- **Tags:** `plugin-discovery`, `dsh-plugin`, `agent-skills`
...
- **Why use it:** Anime search via multiple sources with Bangumi ratings and magnet links
...
- **Why use it:** Official auto-generated curated plugin directory
...
- **Tags:** `agents`, `awesome-list`, `deepseek`, `dsh-plugin`
- **Why use it:** Curated plugin list and development resources
...
- **Why use it:** Community-maintained auto-syncing plugin catalog
...
- **Why use it:** Curated awesome list of DSH plugins, tools and skills
...
- **Why use it:** Curated 2026 DSH plugin list with quality checks and updates.
...
- **Why use it:** Focused stock/finance plugin directory for DSH with 24 verified entries.
...
- **Why use it:** Evidence-led plugin directory with installation and permission guidance.
...
- **Why use it:** Verified star-ranked community plugins for DSH.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Complete 1000+ DSH plugin inventory sorted by stars from GitHub topics.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin manual and navigation by use case with installation guidance.
...
- **Why use it:** Auto-updated bilingual plugin directory via daily GitHub Actions crawl.
...
- **Tags:** `plugin-portal`, `static-site`, `web`, `awesome-dsh-plugin`
- **Why use it:** Static web portal to discover, filter and install 227+ curated DSH plugins.
...
- **Why use it:** DingTalk IM channel for DeepSeek Harness: Stream-mode bot that turns each chat i
...
- **Why use it:** DSH plugins directory: 80+ verified DeepSeek Harness plugins, organized by what 
...
- **Why use it:** Moved → github.com/awesome-dsh-plugin/awesome-dsh-plugin
...
- **Why use it:** A curated, auto-updating list of plugins for DeepSeek Harness (dsh). Data-driven

...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,019,143 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-13 23:59:51 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 222,546 | Core DSH framework; everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,939 | Open-source design tool with local-first approach |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,321 | Multi-agent swarms with autonomous workflows |
...
- **Why use it:** Super AI assistant with memory, multi-agent, multi-model
...
- **Why use it:** Unified agent workspace across desktop, mobile, browser.
...
- **Why use it:** Task-aware reasoning-mode router for better agent routing.
...
- **Why use it:** Enterprise multi-engine agent workbench for teams.
...
- **Tags:** `preset`, `dsh-plugin`, `deepseek-harness`
...
- **Why use it:** Virtual terminal and filesystem sandbox designed for AI agent workflows
...
- **Tags:** `model-switch`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** One-click model switching across Claude Code, Codex, DeepSeek, Kimi and more agents
...
- **Tags:** `documentation`, `deepwiki`, `dsh-plugin`, `grok`
...
- **Why use it:** Rust-based agent runtime with polished desktop UI
...
- **Tags:** `agent-teams`, `collaboration`, `dsh`
...
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits and MCP
...
- **Tags:** `command-code`, `provider`, `typescript`
...
- **Tags:** `skill-generator`, `automation`, `learning`
- **Why use it:** Converts successful agent sessions into reusable Skill files automatically.
...
- **Why use it:** Superpowers coding skills ported to DeepSeek coding harness.
...
- **Why use it:** Plugin development knowledge base bundled as on-demand agent skill with official docs
...
- **Why use it:** Codex skill for automated code simplification and refactoring
...
- **Tags:** `codex`, `mcp`, `sync`, `integration`
- **Why use it:** Bidirectional bridge syncing Codex and DSH chats, skills, and MCPs
...
- **Why use it:** Lightweight Neovim plugin manager in Lua, fast and elegant
...
- **Why use it:** Pre-flight plugin check for DSH agents, improves utilization
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** Bind ChatGPT account via OAuth to use inside DSH
...
- **Tags:** `desktop`, `dsh`, `dsh-plugin`
- **Why use it:** Modern desktop client built for DSH plugin ecosystem
...
- **Tags:** `sidebar`, `ui`, `dsh-plugin`, `deepseek-harness`
...
- **Tags:** `taskboard`, `ui`, `dsh-plugin`, `codex`
- **Why use it:** Modern flexible task board embeddable in Codex and DeepSeek Harness interfaces
...
- **Tags:** `tui`, `ui`, `dsh-plugin`, `terminal`
...
- **Tags:** `widget`, `ui`, `dsh-plugin`, `floating-widget`
- **Why use it:** Cute floating whale widget monitoring your DeepSeek account balance with animations
...
- **Why use it:** Lightweight 5MB Tauri desktop with preset plugins
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions
...
- **Why use it:** Windows GUI desktop client with SSH and mobile access
...
- **Why use it:** Full office suite with spreadsheets, docs, slides and canvases inside DSH
...
- **Tags:** `ios`, `mobile-client`, `websocket`
- **Why use it:** Native iOS client with real-time sessions and Agent execution tracking via WebSocket
...
- **Why use it:** Open-source notes app with hammer aesthetic, Docker deploy
...
- **Why use it:** Web UI panel for centralized skill and MCP management.
...
- **Tags:** `marketplace`, `ui`, `plugin-manager`
...
- **Tags:** `capability`, `menu`, `management`
- **Why use it:** Unified menu to control MCP tool and skill exposure levels and execution modes.
...
- **Tags:** `ui`, `balance`, `pricing`, `info-bar`
- **Why use it:** Shows provider, model, live balance and pricing at a glance
...
- **⭐ Stars:** 29
- **Language:** TypeScript
- **Description:** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重���与冲突；Web UI 圆环面板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **Tags:** `context`, `audit`, `ui`, `optimization`
- **Why use it:** Audits context token costs, detects duplicates and conflicts in AGENTS.md
...
- **Tags:** `kline`, `trading`, `ui`, `sidebar`
- **Why use it:** Interactive K-line analysis plugin with sidebar display and multi-market support
...
- **Why use it:** Electron desktop wrapper integrating multiple DSH web services
...
- **Tags:** `ui`, `compact`, `button`, `panel`
- **Why use it:** One-click compact button to optimize DSH context meter panel
...
- **Why use it:** LLM knowledge platform with RAG, reasoning and wiki features
...
- **Why use it:** Local-first portable memory layer for cross-app AI agents.
...
- **Tags:** `agent-memory`, `agentic-rag`, `mcp`, `context-engineering`
- **Why use it:** Stateful agent memory library with continual learning.
...
- **Tags:** `memory`, `rag`, `dsh-plugin`, `memoryscope`
- **Why use it:** Dedicated memory management kit with refine capabilities for agent context retention
...
- **Why use it:** Persistent unified memory layer backed by Milvus with semantic and hybrid search
...
- **Tags:** `memory`, `persistent-context`, `multi-agent`
- **Why use it:** Shared persistent memory hub connecting all AI agents
...
- **Tags:** `skill-corpus`, `semantic-search`, `embeddings`
...
- **Why use it:** Comprehensive AI knowledge base and plugin encyclopedia with continuous updates
...
- **Why use it:** Proactive associative memory with auto-consolidation and skill crystallization
...
- **Why use it:** Multi-agent swarms with autonomous workflows
...
- **Why use it:** Distill expert thinking into reusable AI agent skills
...
- **Why use it:** AI-powered no-code platform for rapid business system builds
...
- **Tags:** `agent-skills`, `dsh-plugin`, `skill-md`
- **Why use it:** Largest skills store with multi-category ready-to-install packs.
...
- **Why use it:** Self-improving Agent OS with evaluation-gated evolution.
...
- **Tags:** `skills`, `workflow`, `dsh-plugin`, `vibe-coding`
...
- **Tags:** `cognitive-enhancement`, `skills`, `dsh-plugin`, `j-space`
...
- **Tags:** `novel-writing`, `creative-writing`, `long-form`
- **Why use it:** Complete novel writing workflow: worldbuilding to editing
...
- **Tags:** `multimodal`, `ocr`, `computer-vision`
- **Why use it:** Gives agents eyes and ears via video, audio and OCR analysis
...
- **Tags:** `creative-writing`, `agent-skills`, `workflow`
- **Why use it:** Complete creative writing workflows for novels, short dramas, games and video recaps
...
- **Tags:** `task-management`, `native-ui`, `agent-workflow`
...
- **Why use it:** Full-stack automated math modeling competition skill with GitOps pipeline and self-proof
...
- **Tags:** `agent-review`, `prompt-engineering`, `plan-mode`
- **Why use it:** Composable, human-reviewed self-evolving agent modes
...
- **Why use it:** Turn experience into repeatable execution patterns
...
- **Why use it:** 88 open-source skills for research, marketing, social
...
- **Why use it:** 87 specialized reverse-engineering and pentesting skills for security research.
...
- **Tags:** `fintech`, `investment`, `backtesting`
- **Why use it:** AI investment desk with multi-strategy backtesting and compliance features.
...
- **Tags:** `research`, `industry`, `reporting`
- **Why use it:** Industry research skill pack with company analysis and news tracking.
...
- **Tags:** `agent`, `ai-coding`, `code-review`
- **Why use it:** AI mentor skill: scans architecture, generates chapters, auto-reviews code
...
- **Why use it:** 25 pre-installed engineering skills via sidebar panel, zero manual setup
...
- **Tags:** `patent`, `legal-tech`, `multi-agent`
- **Why use it:** Patent infringement analysis skill: input patent number, output competition report
...
- **Why use it:** Legal litigation visualization: generates timelines and diagrams from case files
...
- **Why use it:** Full-process official document tool: format check, optimization, template generation
...
- **Why use it:** Portable spec-driven development skill, repository-native, multi-agent compatible
...
- **Tags:** `bazi`, `fengshui`, `tcm`, `skill`
- **Why use it:** Comprehensive Bazi/Fengshui/TCM AI agent skill with local deterministic engine
...
- **Tags:** `quality-gate`, `engineering`, `guard`, `skill`
- **Why use it:** Engineering discipline guard: grill requirements, test, prove delivery
...
- **Tags:** `qa`, `testing`, `skill`, `playwright`
- **Why use it:** 11 QA skills for AI agents with shared knowledge base and decision matrix
...
- **Tags:** `agent`, `skill`, `math-modeling`
- **Why use it:** Multi-agent math modeling with 33 models and paper templates
...
- **Why use it:** Persistent multi-agent team with durable memory and cross-session skills
...
- **Why use it:** Guides AI agents through DSH plugin development from scratch
...
- **Why use it:** Full-stack Godot 4.x game development skill for DSH agents
...
- **Why use it:** Cinematic video production agent with 152 shot recipes and Remotion templates
...
- **Tags:** `plugin-dev`, `skill`, `cross-platform`
- **Why use it:** Agent skill for DSH plugin development, compatible with Claude Code and Codex
...
- **Why use it:** Open-source design tool with local-first approach
...
- **Tags:** `diagrams-as-code`, `architecture`, `dsh-plugin`
- **Why use it:** Diagram-as-code for architecture and sequence flows
...
- **Why use it:** 530+ image prompts and reusable design skills library
...
- **Why use it:** AI-generated visual design studio with PPT and prototyping
...
- **Why use it:** Interactive inline UI components: charts, forms, quizzes
...
- **Why use it:** Multimodal vision for Claude Code with screenshot analysis
...
- **Why use it:** Enables image OCR and pixel-to-text for text-only models via vision tools
...
- **Why use it:** AI video/image/audio creation skills with DirectorX integration
...
- **Tags:** `design`, `ui`, `aesthetics`, `vibe-coding`
- **Why use it:** 6 design style presets to avoid generic AI-generated UI aesthetics
...
- **Why use it:** Enhancement suite for Gemini, Claude & ChatGPT browser extensions
...
- **Tags:** `content-discovery`, `bilibili`, `youtube`, `dsh-plugin`
- **Why use it:** Cross-platform content discovery agent covering Bilibili, YouTube, Reddit and more
...
- **Tags:** `browser-automation`, `cli`, `extension`
- **Why use it:** Agents operate your real logged-in browser seamlessly
...
- **Tags:** `ios`, `automation`, `mobile-testing`
...
- **Why use it:** Persistent browser identity with fingerprint spoofing
...
- **Why use it:** Browser automation via Tabbit/Playwright integration for DSH.
...
- **Tags:** `ecosystem`, `plugin-discovery`, `radar`
- **Why use it:** Self-hosted ecosystem radar scanning 15900+ candidate plugins
...
- **Why use it:** AI security audit platform for hallucinated code vulnerabilities
...
- **Tags:** `oauth`, `llm`, `subscription`
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions directly in DSH without API keys via OAuth
...
- **Why use it:** Official handbook with 173 source-backed runtime guide
...
- **Why use it:** Bridge Pi ecosystem as native DSH plugins via ABI
...
- **Tags:** `plugin-discovery`, `skill`, `verification`
...
- **Tags:** `infra`, `skills`, `optimization`
- **Why use it:** AI infra dev skills for Claude Code optimization and debug
...
- **Tags:** `upgrade`, `maintenance`, `automation`
- **Why use it:** Auto-upgrades plugins when DSH version changes. Essential maintenance tool.
...
- **Tags:** `backup`, `migration`, `sync`
- **Why use it:** Full DSH config backup, restore, migration and sync via WebDAV.
...
- **Why use it:** Plugin ecosystem infrastructure: browser console + official dev guide skill
...
- **Tags:** `skills`, `plugin-management`, `utility`
...
- **Tags:** `container`, `management`, `infrastructure`
...
- **Why use it:** Unifies Runtime, Provider, Plugin, Skill, MCP orchestration for extensible AI platform
...
- **Tags:** `cost-monitoring`, `token-usage`, `visualization`
- **Why use it:** Real-time token usage tracking and cost estimation for DSH
...
- **Tags:** `troubleshooting`, `diagnostic`, `conflict-resolution`
...
- **⭐ Stars:** 6
- **Language:** TypeScript
- **Description:** 给DSH接入免费的 Xiaomi MiMo TTS API，支持使用预置/自定义/浏览器内置声音朗读正���
- **Tags:** `tts`, `xiaomi`, `audio`, `voice`
...
- **Tags:** `mascot`, `pixel-art`, `dsh-plugin`, `sprites`
- **Why use it:** Public gallery of animated pets for various coding agents.
...
- **Tags:** `theme`, `skin`, `desktop-customization`
- **Why use it:** Cute whale girl skin series for DSH desktop
...
- **Why use it:** Frosted glass theme with fully customizable blur and opacity
...
- **Tags:** `theme`, `animation`, `threejs`
- **Why use it:** Real-time animated ocean theme with Three.js and WebGPU
...
- **⭐ Stars:** 6
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩�� 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `theme`, `customization`
- **Why use it:** Personalize DSH web background with custom images and presets
...
- **Why use it:** Curated plugin directory for quick DSH discovery.
...
- **Tags:** `research`, `web-search`, `china-focused`
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day reports
...
- **Why use it:** One-stop academic research bench: LaTeX, arXiv, GPU tracking
...
- **Why use it:** Cross-ref PubMed/arXiv/CrossRef with MeSH citation graph
...
- **Tags:** `finance`, `multi-agent`, `data-source`
- **Why use it:** Multi-agent financial analysis with tushare-based DB
...
- **Why use it:** Comprehensive curated plugin list for DSH ecosystem discovery.
...
- **Tags:** `awesome-list`, `resources`, `productivity`
- **Why use it:** Curated resource list covering DSH productivity tools and extensions.
...
- **Why use it:** Curated plugin discovery directory for DSH ecosystem exploration
...
- **Tags:** `official`, `registry`, `deepseek-harness`
- **Why use it:** Official spam-filtered plugin registry for DSH ecosystem
...
- **Why use it:** Evidence-led curated plugin directory with permission guidance
...
- **Tags:** `curated`, `2026`, `quality-checked`
- **Why use it:** 2026 updated curated DSH plugin list with quality checks
...
- **Tags:** `finance`, `stock`, `quant`, `bilingual`
- **Why use it:** Bilingual curated stock/finance plugin list for DSH
...
- **Tags:** `catalog`, `comprehensive`, `awesome-list`
...
- **Tags:** `awesome-list`, `curation`, `deepseek-harness`
...
- **Tags:** `awesome-list`, `automation`, `curation`
...
- **Tags:** `awesome-list`, `curation`, `ecosystem`
...
- **Tags:** `awesome-list`, `plugin-curation`, `ecosystem`
- **Why use it:** Curated list of DSH plugins covering CLI and web UI tools
...
- **Why use it:** Curated bilingual awesome list of DSH ecosystem resources
...
- **Tags:** `awesome-list`, `discovery`, `plugin-curation`
- **Why use it:** Daily auto-scraped plugin discovery with scenario-based categorization and rankings
...
- **Why use it:** Plugin marketplace catalog with 11,000+ plugins
...
- **Why use it:** Catalog of 1958 repos with STAR sorting and Chinese search
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Curated community plugin list for DSH discovery
...
- **Tags:** `awesome-list`, `plugin-guide`
...
- **⭐ Stars:** 3
- **Language:** TypeScript
- **Description:** DeepSeek Harness 版本���类 CodeX 插件市场
- **Tags:** `marketplace`, `dsh-plugins`
...
- **Tags:** `awesome-list`, `ai-recommender`
- **Why use it:** AI-curated comprehensive plugin list with 190+ entries
...
- **Tags:** `portal`, `web-ui`
- **Why use it:** Static web portal for browsing 227+ DSH plugins
...
- **Why use it:** Search and discover DSH plugins inside agents
...
- **Tags:** `bundle`, `verification`
- **Why use it:** Plugin bundle with verification and analytics
...
- **Tags:** `redirect`, `meta`
- **Why use it:** Redirect to main awesome-dsh-plugin repository

...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 854,956 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 20:37:06 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 191,713 | Core framework powering the entire DSH plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,064 | Local-first AI design tool with prototyping and UI |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,286 | Deploy multi-agent swarms with autonomous coordina |
...
- **Tags:** `low-code`, `ai-agent`, `crm`, `erp`
...
- **Tags:** `preset`, `harness-tools`, `bootstrapping`
- **Why use it:** Two-phase DSH preset: minimal bootstrap then full Standard tools for optimal results
...
- **Why use it:** Rust-based high-performance agent runtime with polished desktop app.
...
- **Why use it:** Architecture-aware coding agent with baseline-first and drift-checking.
...
- **Why use it:** Context insight dashboard and management for DSH.
...
- **Why use it:** Vision toolkit for text-only LLMs: OCR, image Q&A, screenshot.
...
- **Why use it:** Audits AI-generated code for hallucinations, missing safeguards and vulnerabilities
...
- **Tags:** `multi-agent`, `orchestration`, `teamwork`
- **Why use it:** Orchestrates multiple coding agents (Claude, Codex, Grok) as a coordinated team
...
- **Tags:** `agent-skills`, `spec-driven-development`, `ai-coding`, `dsh-plugin`
...
- **Why use it:** WorkBuddy-style skill picker for DSH composer with quick insert
...
- **Why use it:** Audits context injection token costs and detects conflicts in AGENTS.md
...
- **Why use it:** Unified menu to manage MCP tool and skill exposure levels and execution
...
- **Tags:** `plugin-dev`, `development`, `tools`
...
- **Tags:** `plugin-dev`, `documentation`, `tools`
- **Why use it:** DSH plugin development notes covering cordis, tsconfig, Windows junction.
...
- **Why use it:** Merges multiple sources into a deduplicated plugin registry.
...
- **Why use it:** Modern desktop client treating the desktop itself as a plugin
...
- **Why use it:** Web-based DSH plugin ecosystem aggregator with marketplace distribution
...
- **Why use it:** Extensible sidebar with file editor, terminal, and Git integration.
...
- **Why use it:** Local-first desktop AI agent with multi-model and self-evolving skills
...
- **Why use it:** CodePilot-inspired desktop client with full plugin suite for all major OSes
...
- **Why use it:** Full-featured Electron desktop GUI with SSH, mobile access & plugins
...
- **Why use it:** Smartisan-style notes with one-click Docker deploy and WeChat export
...
- **Why use it:** Plugin management console for DSH ecosystem
...
- **Why use it:** Desktop Electron console for DSH management
...
- **Tags:** `UI`, `MCP`, `skills`
- **Why use it:** Browser-based skills and MCP server management card for DSH Web GUI.
...
- **Why use it:** Electron desktop wrapper for DSH with integrated plugins
...
- **Why use it:** Production-grade RAG knowledge platform with semantic search and wiki
...
- **Tags:** `agent-memory`, `long-term-memory`, `rag`, `markdown-native`
- **Why use it:** Portable local-first memory layer with Markdown-native, self-evolving cross-app storage
...
- **Why use it:** Dedicated memory management for AI agents with RAG support.
...
- **Tags:** `agent-memory`, `retrieval`, `embeddings`
- **Why use it:** Infrastructure for curating SKILL.md files with retrieval and evaluation
...
- **Tags:** `agent-skill`, `knowledge-base`, `plugin-development`, `dsh-plugin`
- **Why use it:** On-demand plugin dev knowledge base skill
...
- **Why use it:** Deploy multi-agent swarms with autonomous coordinated workflows
...
- **Why use it:** Distill agent thinking patterns into reusable cross-agent skills
...
- **Tags:** `harness-engineering`, `tutorial`, `dsh-framework`
- **Why use it:** Beginner-friendly tutorial covering DSH harness engineering from scratch
...
- **Tags:** `agent-orchestration`, `agent-workspaces`, `task-tracking`
- **Why use it:** Unified agent orchestration platform with cross-device task tracking and workspaces
...
- **Why use it:** Task-aware reasoning-mode router with injector for optimized agent workflows
...
- **Why use it:** Self-improving Agent OS with loop engineering and automatic capability growth
...
- **Why use it:** Enterprise multi-engine agent workbench with unified workspace and collaboration
...
- **Why use it:** Intelligently routes and orchestrates harness workflows across skills.
...
- **Why use it:** End-to-end automated Vox-style video generation agent skill.
...
- **Tags:** `code-review`, `agent-skills`, `static-analysis`
...
- **Why use it:** Multi-agent team orchestration for DeepSeek Harness.
...
- **Why use it:** Specialized creative writing skill for novels and short-drama production
...
- **Why use it:** Turns experience into repeatable agent execution patterns across platforms
...
- **Why use it:** Adds multimodal vision capability to text-only LLM agents for analysis
...
- **Why use it:** Automatically discovers, installs and verifies plugins from GitHub
...
- **⭐ Stars:** 160
- **Language:** TypeScript
- **Description:** DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评��与详情，支持复制磁力。
...
- **Why use it:** Agent workflow orchestration plugin for DSH
...
- **Why use it:** 85 reverse engineering skills for pentesting
...
- **Why use it:** AI coding mentor with project analysis and review
...
- **Tags:** `agent-skills`, `research-tools`, `marketing-automation`, `deep-research`
- **Why use it:** 88 agent skills for research and marketing
...
- **Tags:** `dsh-plugin`, `image-reading`, `ocr`, `vision`
- **Why use it:** OCR and image reading for text-only models
...
- **Why use it:** Enables cross-agent session continuity and memory transfer between Codex/Claude Code
...
- **Tags:** `chinese-wisdom`, `skills`
- **Why use it:** Fusion AI agent skill covering Bazi, Fengshui, IChing with dashboard
...
- **Why use it:** Codex skill adapted from DSH for code simplification workflows
...
- **Tags:** `skills`, `package-manager`, `agent`
- **Why use it:** Package manager with 42 skills covering agent engineering and databases.
...
- **Tags:** `swift-cycle`, `governance`, `skills`
- **Why use it:** Version-pinned, offline-verifiable Swift Cycle governance skill adapter.
...
- **⭐ Stars:** 14
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/���异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `document`, `chinese`, `office`
- **Why use it:** Complete Chinese official document processing following national GB/T standard.
...
- **Why use it:** Game-like mission system with fog-of-war map for tracking skill tasks.
...
- **Tags:** `video`, `image`, `skills`
- **Why use it:** AI video/image/audio skills with knowledge corpus and configurable models.
...
- **Tags:** `engineering`, `best-practices`, `skills`
- **Why use it:** Engineering discipline distilled: fact-finding, decisions, evidence reporting.
...
- **Why use it:** Virtual product team agent preset for role-play workflows
...
- **Tags:** `vfs`, `virtual-filesystem`, `agent-tools`, `abstraction`
- **Why use it:** Unified virtual filesystem abstraction layer providing persistent storage for AI agents
...
- **Why use it:** Local-first AI design tool with prototyping and UI generation
...
- **Tags:** `architecture-diagram`, `diagrams-as-code`, `code-visualization`
- **Why use it:** Creates beautiful, verifiable architecture and sequence diagrams as self-contained HTML
...
- **Tags:** `design-tool`, `vector`, `design-as-code`, `vibedesign`
...
- **Why use it:** Native design studio with AI generation, PPT, and visual editor.
...
- **Why use it:** Generate AI images directly within DSH chat conversations
...
- **Tags:** `ai-agent`, `cross-platform`, `content-discovery`
- **Why use it:** Cross-platform content discovery agent with self-evolving capabilities.
...
- **Why use it:** Integrates live iOS Simulator and USB iPhone into DSH with 22 agent tools
...
- **Why use it:** Tabbit Browser plugins for DeepSeek Harness automation
...
- **Tags:** `photo`, `social`, `community`
- **Why use it:** DSH beta group photo wall with GitHub OAuth and polaroid-style sharing
...
- **Why use it:** Connect ChatGPT accounts via OAuth for use inside DSH
...
- **Why use it:** One-click multi-model CLI switch for DSH ecosystem.
...
- **Why use it:** Official DSH plugin marketplace with one-click install support.
...
- **Why use it:** Essential cost tracking with session/daily budgets and usage history
...
- **Why use it:** Compatibility layer running unmodified Pi extensions as native DSH plugins
...
- **Why use it:** Crash rescue with undo, snapshots and one-click SAFE MODE for DSH
...
- **Tags:** `utility`, `plugin-management`, `dsh`
...
- **Why use it:** Pre-flight plugin check system for DSH agent task requests
...
- **Tags:** `ai-curator`, `plugin-recommender`, `awesome-list`
...
- **Why use it:** Community gallery of animated mascot pets for popular coding agent tools
...
- **Why use it:** Whale Girl character skin series for DSH theming.
...
- **Why use it:** Frosted glass UI with full customization, no source code changes required
...
- **Why use it:** One-click swap to 34 opencode themes including Dracula, TokyoNight, Gruvbox.
...
- **Tags:** `webui`, `background`, `dsh-plugin`
- **Why use it:** Customizable DSH Web backgrounds with presets and fine-tuning
...
- **Tags:** `ai-guide`, `rag`, `vibe-coding`, `tutorial`
- **Why use it:** Comprehensive AI resource library with tutorials and prompt encyclopedia
...
- **Why use it:** Curated bilingual plugin and tool collection for DeepSeek Harness ecosystem
...
- **Tags:** `awesome-list`, `discovery`, `crawler`
- **Why use it:** Daily GitHub scraping with verified classification to find the right plugin fast
...
- **Tags:** `encyclopedia`, `knowledge`, `resources`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, skills, and learning paths
...
- **Why use it:** Ultimate guide covering quickstart, curated plugins, and practical toolkits
...
- **Tags:** `api-documentation`, `ai-agents`, `dsh-plugin`, `chinese-api`
...
- **Why use it:** Interactive K-line chart analysis with multi-market support in sidebar
...
- **Why use it:** Evidence-backed evaluation framework for prompts, RAG, agents and workflows.
...
- **Why use it:** Privacy-focused open-source resume builder, self-hostable
...
- **Why use it:** Vision bridge plugin enabling image-to-text OCR for text-only coding agents
...
- **Why use it:** Web-simulated traditional Chinese toy with real audio samples.
...
- **⭐ Stars:** 1,374
- **Language:** Python
- **Description:** DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器��实安装路径运行级实测（四档判定），精选 Top 50 · 11 类人工策展，全量索引 PLUGINS-ALL.md，自动更新。
...
- **Why use it:** Curated comprehensive plugin & skill index for DSH ecosystem
...
- **Why use it:** Plugin marketplace bundle for DeepSeek Harness v4 pro ecosystem
...
- **Why use it:** Curated list of DeepSeek Harness plugins — ecosystem discovery resource.
...
- **Why use it:** Curated DSH plugin list with quality checks for 2026
...
- **Tags:** `awesome-list`, `plugins`, `verified`
- **Why use it:** Verified and star-ranked community plugin directory
...
- **Why use it:** Plugin encyclopedia with scenario-based discovery and guidance
...
- **Tags:** `awesome-list`, `radar`, `plugin-lab`
...
- **Tags:** `portal`, `web`, `plugin-directory`
- **Why use it:** Static web portal for discovering and browsing DSH plugins
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Automated bilingual plugin directory.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** Basic DSH plugin listing.
...
- **Tags:** `agent-harness`, `coding-agents`, `typescript`
- **Why use it:** Curated plugins for models, tools, UI, and agent loops.

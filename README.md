...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 907,194 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-29 13:08:10 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 202,859 | Core plugin harness platform for DSH ecosystem. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,530 | Open-source Claude Design alternative for AI desig |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,695 | Deploy multi-agent swarms and autonomous workflows |
...
- **Tags:** `coding-agent`, `terminal`, `cli`
- **Why use it:** Terminal AI coding agent with prefix-cache stability.
...
- **Tags:** `dsh-plugin`, `cordis`, `harness`
- **Why use it:** Injector + task-aware reasoning-mode router for DSH harness optimization
...
- **Why use it:** Two-phase DSH preset: minimal bootstrap then full Standard tools suite
...
- **Why use it:** First vision plugin for DSH — text-only agents get OCR and multimodal input
...
- **Tags:** `claude-code`, `codex`, `deepseek-harness`
- **Why use it:** One-click model switch across Claude,Codex,Grok,DeepSeek
...
- **Why use it:** Modern task panel embedding seamlessly into Codex and DSH
...
- **Tags:** `tui`, `claude-code`, `dsh`
- **Why use it:** Claude Code style TUI with whale theme,real-time status and rollback
...
- **Tags:** `agent`, `desktop-app`, `mcp`, `privacy`
- **Why use it:** Local-first Claude Cowork alternative with multi-model, privacy-first agent
...
- **Why use it:** AI security offense/defense platform auditing hallucinated packages and vulns
...
- **Why use it:** Use ChatGPT, Claude, Grok subscriptions as LLM providers via OAuth, no API keys
...
- **Why use it:** Bring full office productivity—spreadsheets, docs, slides—directly into the DSH environment.
...
- **Tags:** `migration`, `compatibility`, `pi`
- **Why use it:** Seamlessly migrate Pi ecosystem extensions to DSH with a native ABI compatibility layer.
...
- **Tags:** `ai-infra`, `coding-agents`
- **Why use it:** Specialized skills for writing, optimizing and debugging AI infra
...
- **Tags:** `agent-skill`, `plugin-development`
- **Why use it:** Standardized workflow for building DSH plugins
...
- **Why use it:** Official DSH plugin dev docs as on-demand skill
...
- **Why use it:** Bidirectional sync bridge between Codex and DSH with auto MCP mirroring
...
- **Tags:** `code-simplification`, `skill`, `deepseek-harness`
- **Why use it:** Adapted code simplification skill from DSH for cleaner code generation
...
- **Why use it:** Audits context injection, detects conflicts and token costs via Web UI
...
- **Tags:** `package-manager`, `agent`, `cli`, `deepseek-harness`
- **Why use it:** Package manager with 42 skills and 5 CLIs for AI agent engineering
...
- **Tags:** `plugin-development`, `agent-skills`, `deepseek-harness`
...
- **Tags:** `neovim`, `plugin-manager`, `lua`, `editor`
- **Why use it:** Fast, simple Neovim plugin manager — essential for Lua devs.
...
- **Why use it:** Web UI aggregation ecosystem for DeepSeek Harness plugin marketplace
...
- **Why use it:** Open sidebar foundation with file editor,terminal,chat,Git
...
- **Tags:** `floating-widget`, `desktop`, `dsh-plugin`
...
- **Why use it:** Local-first AI desktop workspace with multi-feature support
...
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes, layouts
...
- **Why use it:** Visual non-linear canvas-based conversation workspace with branching exploration
...
- **Why use it:** Full-featured Windows desktop GUI with SSH, skills, and remote access built in.
...
- **Why use it:** Community plugin marketplace integrated directly into DSH web GUI
...
- **Tags:** `ui`, `plugin-management`, `capability-menu`
...
- **Why use it:** Live pricing, balance, and usage tracking info bar
...
- **Tags:** `desktop`, `tauri`, `docker`, `ssh`, `deepseek-harness`
- **Why use it:** Tauri desktop combining DB, SSH, Docker panels with AI assistant.
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI and sidebar
...
- **Why use it:** Self-evolving context database for agent memory and RAG.
...
- **Why use it:** LLM knowledge platform with RAG, Wiki and agent capabilities.
...
- **Why use it:** Portable local-first memory layer for all AI agents, Markdown-native
...
- **Why use it:** Dedicated memory layer for agents with RAG support
...
- **Why use it:** Provide unlimited memory capability for AI agents
...
- **Tags:** `long-term-memory`, `agent`, `dsh-plugin`
- **Why use it:** Personal AI agent with shared persistent memory hub
...
- **Why use it:** Distill thinking patterns into reusable AI skills.
...
- **Tags:** `low-code`, `business`, `workflows`
...
- **Tags:** `agent-orchestration`, `coding-agent`, `mcp`
- **Why use it:** Unified agent workspace across devices with board-based task tracking
...
- **Why use it:** End-to-end Vox-style paper-collage video generation from one topic
...
- **Tags:** `ai-workflow`, `plugin`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `embeddings`, `rag`
- **Why use it:** Turns SKILL.md files into retrieval-ready agent-skill corpora with evaluation
...
- **Why use it:** Specialized plugin for novel writing and short-drama production with rich skill sets.
...
- **Why use it:** Full-stack auto math modeling skill supporting MCM/ICM competitions with GitOps pipeline.
...
- **Tags:** `task-management`, `project`, `sqlite`
- **Why use it:** Native taskboard with SQLite backend and web UI — no iframes needed for project management.
...
- **Tags:** `skills`, `cross-platform`, `workflow`
- **Why use it:** Cross-platform skills system turning experience into repeatable execution across major agents.
...
- **Tags:** `vision`, `multimodal`, `screen-analysis`
- **Why use it:** Adds multimodal vision capabilities to Claude Code for screenshot, UI, and chart analysis.
...
- **Tags:** `agent-skills`, `self-evolution`
...
- **Tags:** `skills`, `tdd`, `collaboration`
- **Why use it:** Proven TDD, debugging and planning skills adapted for DSH agents
...
- **Why use it:** Superpowers skill adapted for Reasonix coding harness
...
- **Why use it:** 87 reverse-engineering skills for CTF and security research
...
- **Tags:** `coding-agent`, `mentor`, `education`
- **Why use it:** AI coding mentor that scans projects and guides step-by-step learning
...
- **Why use it:** Manages installed DSH plugins, slots, and credentials
...
- **Tags:** `chinese-wisdom`, `fengshui`, `bazi`
- **Why use it:** Fengshui, Bazi, IChing AI agent skill with dashboard
...
- **Tags:** `skills`, `task-board`, `workflow`
- **Why use it:** Visual task board for MattSkillsDeck management
...
- **Why use it:** Cross-platform session continuity and memory recovery
...
- **⭐ Stars:** 25
- **Language:** JavaScript
- **Description:** DSH Skills Manager — �� DeepSeek Harness 中统一加载并安全管理本机 Agent Skills · Load and safely manage local Agent Skills in DSH
- **Tags:** `skills`, `management`, `deepseek-harness`
- **Why use it:** Centralized skill loading and management for DSH agents
...
- **Tags:** `gongwen`, `document`, `chinese`, `deepseek-harness`
- **Why use it:** Full pipeline Chinese official document processing following GB/T 9704 standard
...
- **Tags:** `swift-cycle`, `governance`, `deepseek-harness`
- **Why use it:** Swift Cycle governance skill, version-pinned and offline-verifiable
...
- **Tags:** `qa`, `testing`, `agent-skills`, `deepseek-harness`
- **Why use it:** 10 AI testing skills with shared knowledge base for QA automation.
...
- **Tags:** `agent-learning`, `skill-generator`, `deepseek-harness`
...
- **Tags:** `godot`, `game-development`, `gdscript`, `deepseek-harness`
- **Why use it:** Godot 4.x full-stack game dev skill, registers at runtime.
...
- **Why use it:** Virtual product team agent preset (PM→Eng→QA→Release workflow)
...
- **Why use it:** Open-source Claude Design alternative for AI designers.
...
- **Why use it:** Powerful vision toolkit for text-only LLM agents
...
- **Tags:** `design`, `ppt`, `visual-editor`, `ai-design`
- **Why use it:** AI design studio with PPT support, visual editor and template marketplace
...
- **Tags:** `image-generation`, `ai-art`, `seedream`
- **Why use it:** Generate images directly in DSH chats via Seedream and other model integrations
...
- **⭐ Stars:** 87
- **Language:** Python
- **Description:** Photo-to-editorial Skill with Original (Codex) and V3 Adaptive editions. Scene-aware layouts, creative controls, Strict Fidelity composition, structured QA, and a validated DeepSeek Harness capability path.
- **Tags:** `image-processing`, `photo-editing`, `design`
- **Why use it:** AI-powered photo-to-editorial composition with creative controls
...
- **Tags:** `visualization`, `legal`, `diagram`, `litigation`
- **Why use it:** Legal visualization tools for litigation timelines and case diagrams
...
- **Why use it:** Adds image-reading and OCR to text-only models
...
- **Tags:** `media`, `image`, `vision`, `deepseek-harness`
- **Why use it:** Image reading and generation skills with vision transcription support
...
- **Tags:** `design`, `ui`, `vibe-coding`, `deepseek-harness`
- **Why use it:** 6 design style packs to avoid generic AI look in vibe-coded websites
...
- **Tags:** `ai-director`, `ai-image`, `ai-video`, `deepseek-harness`
- **Why use it:** AI video/image/audio creative suite with configurable model tools.
...
- **Tags:** `browser`, `extension`, `web`
- **Why use it:** Browser extension enhancement suite for AI platforms.
...
- **Tags:** `bilibili`, `youtube`, `xiaohongshu`
- **Why use it:** Cross-platform content discovery from Bilibili,YouTube,X,Zhihu
...
- **Tags:** `ai-agent`, `dingtalk`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** DingTalk IM channel enabling tool-capable agent chats.
...
- **Tags:** `vfs`, `agent-tools`, `virtual-filesystem`
- **Why use it:** World's first unified virtual filesystem for all AI agent workflows
...
- **Tags:** `marketplace`, `plugin`, `infrastructure`
...
- **Why use it:** Comprehensive context insight dashboard and management
...
- **Tags:** `armor-breaking`, `prompt`, `dsh-plugin`
- **Why use it:** Specialized prompt stabilization plugin for DeepSeek
...
- **Why use it:** Essential cost tracker for sessions, budgets, and token usage across providers.
...
- **Why use it:** Auto-discovers, installs and verifies plugins for DSH
...
- **Why use it:** Smoothly migrate sessions across presets while preserving state
...
- **Why use it:** Crash rescue with snapshot rollback and safe mode recovery
...
- **Why use it:** Curated awesome list of all DSH plugins for easy discovery
...
- **Why use it:** Infrastructure console for plugin ecosystem with make-dsh-plugin guide
...
- **Why use it:** Essential backup/restore tool for DSH configs and plugins
...
- **Why use it:** One-click MCP/Skills setup for multiple AI agents
...
- **Tags:** `agent-migration`, `deepseek-harness`, `mcp`, `skills`
- **Why use it:** Migrate Claude Code/Codex/OpenCode configs and skills to DSH.
...
- **Tags:** `data-visualization`, `ai-cost`, `deepseek-api`, `dsh-plugin`
...
- **Tags:** `plugin-tools`, `automation`
- **Why use it:** Pre-flight plugin library check to auto-inject relevant plugins
...
- **Tags:** `ai-agents`, `chatgpt`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Integrates ChatGPT models into DSH via OAuth subscription.
...
- **Why use it:** Public gallery of animated mascot pets for coding agent terminals
...
- **Why use it:** Whale Girl skin series specifically for DeepSeek Harness
...
- **⭐ Stars:** 390
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调���糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glass-effect`
- **Why use it:** Frosted glass theme with fully customizable blur, background and transparency
...
- **Tags:** `theme`, `skin`, `ocean`, `webgpu`
- **Why use it:** Stunning WebGPU ocean-themed skin with Three.js visual effects for a beautiful DSH interface.
...
- **Tags:** `theme`, `skin`, `opencode`, `deepseek-harness`
...
- **Tags:** `prompt-engineering`, `research`, `analysis`
...
- **Tags:** `learning`, `reference`, `marketplace`
- **Why use it:** Great reference for learning DSH principles, plugin marketplace, and best practices.
...
- **Why use it:** Comprehensive ultimate guide with quickstart, resources, and curated plugin recommendations.
...
- **Why use it:** Curated collection covering plugins, skills, MCP servers, patches, and orchestrators.
...
- **Tags:** `plugin-store`, `marketplace`, `directory`
- **Why use it:** Massive plugin directory with 11,000+ entries, search, rankings, and a free API.
...
- **Tags:** `marketplace`, `listing`, `plugins`
- **Why use it:** Plugin marketplace listing showcasing available DeepSeek Harness plugins.
...
- **Tags:** `academic`, `citation`, `research`
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms directly in agents
...
- **Tags:** `patent`, `research`, `legal-tech`, `rag`
...
- **Tags:** `kline`, `finance`, `analysis`, `deepseek-harness`
...
- **Tags:** `industry-research`, `report`, `deepseek-harness`
- **Why use it:** Industry research domain pack with methodology skills and policy tracking
...
- **Why use it:** Verified curated plugin directory for 2026 DSH ecosystem
...
- **Why use it:** Bilingual stock/finance plugin directory with 24 verified entries
...
- **Why use it:** Star-ranked verified community plugin listings for DSH
...
- **Why use it:** 1000+ DSH tools ranked by stars from GitHub topic dsh-plugin
...
- **Why use it:** In-agent plugin search combining npm and awesome-list data.
...
- **Tags:** `ai-agents`, `deepseek-harness`, `dsh-plugin`, `mcp`
- **Why use it:** AI-curated hourly-updated plugin recommender with 190+ plugins.
...
- **Tags:** `toy`, `web`, `simulation`
- **Why use it:** Web simulation of traditional Chinese toy Zhuzhiliao
...
- **Why use it:** Auto-discover and validate 15900+ DSH candidate plugins
...
- **Why use it:** Curated collection of DSH plugins and infrastructure tools
...
- **Why use it:** Curated bilingual DSH plugin awesome list with verified references
...
- **Why use it:** Daily curated plugin discovery with scenario classification and top rankings
...
- **Tags:** `ai-encyclopedia`, `knowledge-base`, `learning`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, MCP, multimodal and learning paths
...
- **Why use it:** Smartisan-style notes app with Docker deployment and export features
...
- **Why use it:** Community curated plugin and resource list for DSH ecosystem
...
- **Tags:** `evaluation`, `observability`, `rag`, `deepseek-harness`
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `community`
- **Why use it:** Fun community photo wall for DSH beta finale with OAuth login.
...
- **Why use it:** Curated list of DSH plugins — ecosystem discovery guide.
...
- **Why use it:** Unofficial community catalog for DSH plugins and skills.
...
- **Tags:** `plugin-registry`, `open-data`, `awesome-list`, `deepseek-harness`
- **Why use it:** Spam-filtered open-data registry for DSH plugins, bundles, skills.
...
- **Tags:** `deepseek-harness`, `dsh-plugins`, `plugin-registry`
- **Why use it:** Curated plugin registry for DeepSeek Harness ecosystem.
...
- **Tags:** `ai-agent`, `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Plugin radar with evidence-backed curation for DSH.
...
- **Why use it:** Bilingual plugin directory reviewed at immutable commits.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin-directory`
...
- **Why use it:** Redirect notice; moved to new repository location.
...
- **Why use it:** Auto-updating bilingual plugin list with Vercel deployment.
...
- **Tags:** `awesome`, `coding-agents`, `deepseek-harness`, `dsh-plugin`, `ui`
- **Why use it:** Comprehensive curated list covering models, tools, sandboxes, UI.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Why use it:** General DSH plugin listing repository.
...
- **Why use it:** Curated directory of industry-specific DSH plugins across 7 sectors.

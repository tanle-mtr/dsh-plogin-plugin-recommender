...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 982,319 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-08 00:07:39 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215,119 | Core infrastructure for the DSH ecosystem. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,688 | Local-first desktop design alternative. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,386 | Meta-harness for multi-agent swarms. |
...
- **Why use it:** Core infrastructure for the DSH ecosystem.
...
- **Why use it:** Native DeepSeek terminal coding agent.
...
- **Tags:** `agent-harness`, `agent-orchestration`, `multi-device`, `workspace`
...
- **Tags:** `routing`, `injector`, `harness`, `task-aware`
- **Why use it:** Runtime injector and task-aware router for intelligent agent routing.
...
- **Why use it:** Web-based plugin aggregation ecosystem for DSH community.
...
- **Tags:** `agent-control-plane`, `long-horizon`, `orchestration`, `workflow`
- **Why use it:** Long-horizon control plane for durable multi-agent orchestration.
...
- **Why use it:** Virtual terminal and filesystem giving agents isolated sandbox environments.
...
- **Why use it:** AI security offensive/defensive platform auditing code for hallucinated packages and vulnerabilities.
...
- **Tags:** `oauth`, `subscriptions`, `multi-provider`
...
- **Why use it:** Full-featured coding agent with RPC, sub-agents and MCP support
...
- **Why use it:** CLI tool for DSH Plugin Hub with schema resolution
...
- **Why use it:** Seamlessly migrate Pi extensions as native DSH plugins via ABI bridge.
...
- **Why use it:** LLM provider plugin with live model catalog and reasoning-effort support.
...
- **Why use it:** Superpowers coding skill ported to Reasonix harness
...
- **Why use it:** AI mentor skill that guides you through project architecture and code review
...
- **Why use it:** Meta-skill for developing DSH plugins: slots, events, tools, and LLM adapters
...
- **Tags:** `plugin-dev`, `build`, `dsh`
- **Why use it:** Agent skill for building and managing installed DSH plugin components
...
- **Why use it:** Reusable Codex skill to build and validate DSH plugins quickly.
...
- **Tags:** `context-audit`, `token-optimization`, `tool`
- **Why use it:** Audits instruction chains, detects conflicts, reduces token cost.
...
- **Why use it:** Codex skill adapted for simplifying code within DSH workflows.
...
- **Tags:** `codex`, `sync`, `bridge`, `mcp`
- **Why use it:** Bidirectional bridge syncing chats, skills, MCP between Codex and DSH.
...
- **Tags:** `design-systems`, `desktop-app`
- **Why use it:** Local-first desktop design alternative.
...
- **Why use it:** Modern desktop solution for the DSH ecosystem.
...
- **Tags:** `sidebar`, `ui`, `extension-platform`
...
- **Why use it:** Modern flexible task panel embedding into Codex and DeepSeek Harness UI.
...
- **Why use it:** Lightweight 5MB Tauri desktop app with zero setup for DSH
...
- **Tags:** `ui-components`, `charts`, `forms`, `dsh-ui`
- **Why use it:** Interactive UI components like charts, forms, quizzes rendered inline in assistant replies.
...
- **Tags:** `canvas`, `non-linear`, `conversation-workspace`
- **Why use it:** Visual non-linear conversation canvas with session branching and explorer workspace.
...
- **Tags:** `office`, `desktop`
- **Why use it:** Brings spreadsheet, docs, and slides into DSH desktop
...
- **Why use it:** CodePilot-inspired desktop client for DSH across all platforms
...
- **Why use it:** Native iOS client with WebSocket sync for Harness on the go.
...
- **Why use it:** Encrypted P2P remote access to Harness from PC, Android, and Web.
...
- **Why use it:** Smartisan-style notes app with Docker deploy, skill calls, and export.
...
- **Tags:** `dsh`, `mcp`, `skills`, `webui`
- **Why use it:** Centralized skill and MCP management for DSH Web UI
...
- **Tags:** `plugin-market`, `webui`, `dsh`
- **Why use it:** One-click browse and install community plugins from DSH web GUI
...
- **Why use it:** Live provider info, balance tracking, pricing countdown in UI.
...
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, SFTP, Docker in one window.
...
- **Why use it:** Electron desktop wrapper integrating DSH Web with sidebar and tools.
...
- **Why use it:** One-click compact mode toggle for the DSH Web context meter panel.
...
- **Why use it:** Transform recent chat history into beautiful downloadable knowledge cards.
...
- **Tags:** `agent-memory`, `rag`, `markdown-native`, `long-term-memory`
...
- **Tags:** `memory`, `agentic-rag`, `stateful-agents`, `continual-learning`
- **Why use it:** Memory library enabling stateful, context-aware agent operations.
...
- **Tags:** `memory`, `rag`, `refinement`
- **Why use it:** Dedicated memory management kit with refine capabilities for AI agents.
...
- **Why use it:** Persistent unified memory layer for all agents backed by Markdown and Milvus RAG.
...
- **Why use it:** Best context dashboard for insight, stats, and management in DSH
...
- **Tags:** `skill-md`, `vector-search`, `reranking`
- **Why use it:** Turns skill files into retrieval-ready corpora with reranking and eval tools.
...
- **Tags:** `memory`, `agentic`, `dsh`
- **Why use it:** Proactive associative memory with three-layer auto-consolidation for DSH agents
...
- **Tags:** `knowledge-base`, `docs`, `agent-skill`
- **Why use it:** Official docs archive as on-demand agent skill for plugin dev.
...
- **Why use it:** Meta-harness for multi-agent swarms.
...
- **Why use it:** Industrial-grade prompt templates and skills.
...
- **Why use it:** Distill expert thinking into reusable skills.
...
- **Tags:** `skills`, `skill-store`, `agent-skills`, `automation`
- **Why use it:** Largest skill store with auto-collected skills across multiple domains.
...
- **Why use it:** Two-phase preset providing minimal bootstrap then full Standard tools for DSH.
...
- **Tags:** `cognitive`, `skills`, `global-workspace`
...
- **Why use it:** Coordinate multiple AI agents as teams for complex workflows
...
- **Why use it:** Add vision capabilities to text-only models with one-line installation
...
- **Tags:** `multimodal`, `video-understanding`, `ocr`, `deepwatch`
- **Why use it:** Gives AI agents video, audio, and screen understanding with timestamped verifiable evidence.
...
- **Tags:** `creative-writing`, `fiction`, `screenwriting`, `drama`
- **Why use it:** Specialized plugin for novel writing and short-drama production powered by Oh Story skills.
...
- **Tags:** `skills`, `workflows`, `competition`
...
- **Why use it:** Reusable agent skills that turn experience into automated workflows.
...
- **Tags:** `finance`, `tushare`, `mcp`, `multi-agent`
- **Why use it:** Multi-agent financial analysis with Tushare integration and MCP.
...
- **Why use it:** Discovers, installs, and verifies GitHub plugins for DSH automatically.
...
- **Why use it:** Specialized agent skills for AI infrastructure dev, optimization and debug.
...
- **Tags:** `skills`, `research`, `marketing`, `cross-platform`
...
- **Tags:** `agent-skills`, `skill-generator`, `deepseek`
...
- **Why use it:** Specialized patent infringement analysis skill with RAG-based claim chart generation
...
- **Why use it:** Pre-packaged 25 engineering skills from Matt Pocock, ready-to-use in sidebar
...
- **Why use it:** Visual litigation timeline and case diagram generator for legal professionals
...
- **Why use it:** Multi-strategy fund backtesting skill pack for compliant AI investment desk
...
- **Why use it:** Full workflow Chinese official document processor compliant with national GB standard
...
- **Tags:** `spec-programming`, `agent-skill`, `dev`
- **Why use it:** Repository-native spec-driven development skill with vibe-coding support
...
- **Why use it:** Unique fusion of Bazi, Fengshui, I Ching with local engine.
...
- **Why use it:** Cross-platform session memory for seamless agent handoffs.
...
- **Why use it:** 11 QA skills with shared KB and decision matrix for test automation.
...
- **Why use it:** Official SkillHub Open API docs and plugin for DSH ecosystem.
...
- **Why use it:** Simulate a full product team (PM to QA) for guided project workflows.
...
- **Why use it:** Official Huawei Cloud MCP with skills, tools, guardrails, and cloud sandbox
...
- **Why use it:** CodeX-style marketplace for DSH plugins discovery and management.
...
- **Tags:** `diagrams-as-code`, `visualization`
- **Why use it:** Generates verifiable architecture diagrams.
...
- **Tags:** `design`, `ui`, `vibedesign`, `vector`, `agent-team`
- **Why use it:** AI-native vector design tool with concurrent agent team collaboration.
...
- **Tags:** `video`, `ai-video`, `generative`
...
- **Tags:** `design-skills`, `design-system`, `ui`, `vibe-coding`
- **Why use it:** 6 design style packs to avoid generic AI-generated website aesthetics.
...
- **Tags:** `motion-design`, `remotion`, `video`
- **Why use it:** Cinematic video production skill with 152 shot recipe cards.
...
- **Why use it:** Enhancement suite for AI web interfaces.
...
- **Why use it:** Let AI agents control your real browser seamlessly via CLI+extension
...
- **Why use it:** Strongest free web search plugin for DSH, no signup or API keys needed.
...
- **Why use it:** Live iOS simulator and USB iPhone control inside conversation
...
- **Why use it:** Ultimate image uploader for creators.
...
- **Tags:** `no-code`, `internal-tools`
- **Why use it:** Open-source AI no-code platform for business.
...
- **Why use it:** Official plugin marketplace with search and one-click install inside DSH.
...
- **Tags:** `radar`, `ecosystem`, `infrastructure`
...
- **Why use it:** Curated plugin ecosystem hub with tools and infrastructure list
...
- **Why use it:** Comprehensive curated list of all DSH plugins and agent tools
...
- **Why use it:** Tracks session and daily token costs with budget management
...
- **Why use it:** Export/import and sync your full DSH configuration via WebDAV
...
- **Why use it:** Core DSH plugin infrastructure with browser console and plugin scaffolding skill
...
- **Tags:** `skills-manager`, `utility`, `dsh`
- **Why use it:** Centralized skill loader and manager for safely loading local Agent Skills in DSH
...
- **Tags:** `containers`, `multi-version`, `infrastructure`
- **Why use it:** Run multiple DSH versions in isolated containers, embeds WebView UI.
...
- **Tags:** `agent-evaluation`, `rag-evaluation`, `llm-evaluation`
...
- **Why use it:** Engineering quality gate to grill requirements and prove delivery.
...
- **Tags:** `token-usage`, `data-visualization`, `deepseek-api`
- **Why use it:** Track token usage, costs, and API balance in real-time with visual charts.
...
- **Tags:** `mascot`, `pixel-art`, `cli`, `theme`, `skins`
- **Why use it:** Animated pet gallery for coding agents, adds personality to CLI tools.
...
- **Why use it:** Frosted glass themed UI with fully adjustable blur, background, and磨砂 effects.
...
- **Tags:** `background`, `webui`, `theme`, `personalization`
- **Why use it:** Customize DSH Web backgrounds with personal images or preset themes.
...
- **Tags:** `ai`, `ai-agent`, `chatgpt`, `deepseek`
...
- **Tags:** `agent`, `dsh`, `harness`, `tutorial`
- **Why use it:** Excellent beginner tutorial for harness engineering from scratch.
...
- **Why use it:** Cross-platform AI agent that discovers content from Bilibili, YouTube, Reddit, Xiaohongshu, and more.
...
- **Why use it:** All-in-one research workbench: LaTeX, arXiv, SSH task orchestration
...
- **Why use it:** Interactive K-line analysis with multi-market, indicators, news.
...
- **Why use it:** Auto-updating curated plugin list with bilingual README via YAML data.
...
- **Tags:** `deepseek`, `plugin`, `specialized`
- **Why use it:** DeepSeek-specific armor-breaking plugin for specialized tasks
...
- **Why use it:** Bilingual curated list of DSH plugins, skills, tools and integrations.
...
- **Tags:** `knowledge-base`, `resources`, `awesome-list`, `mcp`
- **Why use it:** Comprehensive AI resource encyclopedia covering agents, RAG, multimodal tools and learning paths.
...
- **Tags:** `plugin-market`, `marketplace`, `curation`
- **Why use it:** Most comprehensive DSH plugin marketplace with daily updates and pre-publishing review.
...
- **Why use it:** Curated plugin list with daily auto-sync and classification
...
- **Why use it:** Ultimate DSH guide with quickstart, resources and plugins
...
- **Why use it:** Learn DSH principles and explore the plugin marketplace
...
- **Why use it:** Comprehensive DSH plugin catalog with 1900+ entries and search.
...
- **Why use it:** Curated directory of DSH plugins, tools and resources
...
- **Tags:** `plugin-marketplace`, `community`, `awesome-list`
- **Why use it:** Community-maintained auto-syncing DSH plugin marketplace
...
- **Why use it:** Unofficial community catalog cataloging DSH plugins.
...
- **Why use it:** Curated awesome list of DSH plugins with web showcase.
...
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Comprehensive curated awesome list of DSH plugins and resources.
...
- **Tags:** `plugin-registry`, `curated-list`
- **Why use it:** Spam-filtered open-data plugin registry and skills catalog.
...
- **Why use it:** Curated 2026 plugin directory with quality checks for DSH users.
...
- **Why use it:** 24 verified stock/finance/quant plugins in a bilingual curated list.
...
- **Tags:** `awesome-list`, `community`, `collection`
- **Why use it:** Handpicked collection of useful DeepSeek Harness community plugins.
...
- **Why use it:** Plugin manual and navigation: choose by scenario with compatibility info.
...
- **Tags:** `automated`, `directory`, `daily-sync`
...
- **Why use it:** Curated directory of DeepSeek Harness plugins for reference.
...
- **Why use it:** DSHA selected plugin collection for DSH users.
...
- **Why use it:** Evidence-led bilingual directory of DSH plugins, reviewed at immutable commits.
...
- **Why use it:** Repository has moved to a new URL.
...
- **Why use it:** Curated plugin directory for easy DSH ecosystem discovery and installation.

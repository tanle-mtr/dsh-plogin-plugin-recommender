...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 838,144 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 12:50:54 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 186,783 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,600 | Local-first design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 68,921 | Multi-agent swarm orchestration with autonomous wo |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 23 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 22 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 11 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 39 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 9 plugins
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 21 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 3 plugins
- [Other](#other) — 40 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (23)
- [UI & Desktop Extensions](ui-desktop-extensions) (22)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (11)
- [Agent Skills & Workflows](agent-skills-workflows) (39)
- [MCP Servers & Tools](mcp-servers-tools) (9)
- [Visual & Design](visual-design) (9)
- [Browser & Web Automation](browser-web-automation) (7)
- [Communication & Social](communication-social) (1)
- [Utilities & Infrastructure](utilities-infrastructure) (21)
- [Themes & Skins](themes-skins) (6)
- [Research & Analysis](research-analysis) (3)
- [Other](other) (40)
---
...
- **Why use it:** Self-evolving multi-model assistant with memory and skills
...
- **Why use it:** Terminal-native coding agent with prefix-cache stability
...
- **Tags:** `agent`, `harness-engineering`, `tutorial`, `dsh`
- **Why use it:** Comprehensive beginner tutorial for DSH harness engineering
...
- **Tags:** `agent-orchestration`, `workspace`, `no-code`, `multi-device`
- **Why use it:** Unified agent workspace with task boards across all devices
...
- **Tags:** `routing`, `orchestration`, `dsh`, `agent`
- **Why use it:** Professional task-aware router standard for DSH agent orchestration
...
- **Tags:** `agent-os`, `loop-engineering`, `self-improving`, `llm-evaluation`
- **Why use it:** Self-improving Agent OS with loop engineering and auto-grading
...
- **Tags:** `enterprise`, `multi-agent`, `workspace`, `coding-agent`
- **Why use it:** Enterprise multi-engine workspace for Codex, DSH, and OpenCode
...
- **Tags:** `preset`, `standard`, `bootstrap`, `toolkit`
- **Why use it:** Two-phase preset: minimal bootstrap to full Standard tools (98/99)
...
- **Why use it:** First vision plugin for text-only agents — turns images into structured JSON
...
- **Why use it:** One-click switch between Claude Code, Codex CLI, DeepSeek, and more AI coding tools.
...
- **Why use it:** Claude Code-style TUI with whale header, real-time status, streaming thoughts, and rollback.
...
- **Tags:** `agent-runtime`, `coding-agent`, `desktop-app`
- **Why use it:** High-performance Rust agent runtime paired with polished desktop app for coding agents.
...
- **Tags:** `code-review`, `code-quality`, `agent-skill`
- **Why use it:** AI code reviews grounded in 12 classic engineering books with decay risk diagnostics and citations.
...
- **Tags:** `deepseek`, `swift`, `macos`, `coding-agent`
- **Why use it:** Official DeepSeek Swift-native macOS coding agent by DeepSeek team
...
- **Tags:** `agent`, `coding-agent`, `dsh-plugin`, `mcp`
- **Why use it:** Unifies Claude Code, Codex, Grok, and DSH into one collaborative coding agent team.
...
- **Tags:** `skill-picker`, `dsh-plugin`, `ui-tool`
- **Why use it:** WorkBuddy-style skill picker, quick skill selection
...
- **Tags:** `codex`, `sync`, `mcp`, `import`
- **Why use it:** One-tap Codex-to-DSH migration with Skills/MCP sync
...
- **Tags:** `skills-manager`, `dsh-plugin`, `configuration`
- **Why use it:** Centralized Skills management interface for DSH
...
- **Tags:** `discovery`, `dsh-plugin`, `plugin-manager`, `registry`
- **Why use it:** 多源合并去重的DSH插件注册表工具。
...
- **Tags:** `cli`, `dsh-plugin`, `plugin-manager`, `registry`
- **Why use it:** CLI插件管理器，支持搜索安装审计。
...
- **Tags:** `dsh-plugin`, `publisher`, `skills`
- **Why use it:** 一键发布插件，自动生成描述和PR命令。
...
- **Why use it:** Local-first design tool turning coding agents into designers
...
- **Why use it:** AI-enhanced no-code platform for rapid business system building
...
- **Why use it:** Modern desktop solution with plugin-native architecture
...
- **Tags:** `web-ui`, `gui`, `skin`, `ssh`
- **Why use it:** Full DSH Web GUI with task boards, remote SSH, and GPU-accelerated skins
...
- **Tags:** `desktop`, `mcp`, `electron`, `plugins`
...
- **Tags:** `tauri`, `desktop`, `deepseek-harness`
- **Why use it:** Lightweight 5MB Tauri desktop app for DeepSeek Harness users
...
- **Tags:** `desktop`, `electron`, `local-first`, `mcp`
- **Why use it:** Full-featured local-first desktop workspace for DSH sessions and projects
...
- **Tags:** `desktop-app`, `agent`, `dsh-plugin`, `privacy`
- **Why use it:** Local-first multi-model AI agent desktop app, privacy-focused alternative to Claude Cowork.
...
- **Tags:** `ui`, `dsh-plugin`, `interactive`
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes via dsh-ui fence.
...
- **Why use it:** Visual non-linear conversation canvas with branching workspace for DSH.
...
- **Why use it:** Full-featured Electron desktop GUI for DSH with SSH, skills, and Codex.
...
- **Tags:** `task-management`, `taskboard`, `ui`
- **Why use it:** Native SQLite-backed taskboard UI for project management and agent review
...
- **Why use it:** Electron desktop hub for managing DSH, plugins, MCPs and skills via multi-tab UI
...
- **Tags:** `kline`, `analysis`, `sidebar`
- **Why use it:** Interactive K-line analysis with multi-market support directly in DSH sidebar.
...
- **Tags:** `canvas`, `creative`, `weSHOP`
- **Why use it:** Native WeShop infinite canvas plugin with powerful creative skills for DSH.
...
- **Tags:** `visualization`, `token-usage`
- **Why use it:** Real-time token usage, cost charts, and API balance display
...
- **Tags:** `ui`, `hud`
- **Why use it:** Floating HUD panel showing git status, MCP, skills, and tokens
...
- **Tags:** `electron`, `desktop`, `ui`
- **Why use it:** Electron desktop wrapper for DSH with rich sidebar integrations.
...
- **Why use it:** Open-source RAG platform with autonomous reasoning wiki
...
- **Why use it:** Portable, Markdown-native long-term memory for all AI agents
...
- **Why use it:** Unlimited memory storage for AI agents with persistent recall
...
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, multimodal tools, and learning roadmaps.
...
- **Tags:** `agent-memory`, `skill-routing`, `embeddings`
- **Why use it:** Curates scattered SKILL.md files into searchable, evaluation-ready corpora
...
- **Tags:** `session-memory`, `agent-handoff`, `context-engineering`
- **Why use it:** Cross-session continuity memory for agent handoffs
...
- **Tags:** `memory`, `mcp-server`
- **Why use it:** Connects to PowerContext server for memory recall and handoff
...
- **Why use it:** Multi-agent swarm orchestration with autonomous workflows
...
- **Tags:** `agent-skills`, `digital-human`, `meta-skill`
- **Why use it:** Transform memories into digital life skills with warmth
...
- **Why use it:** Intelligently orchestrates harness workflows and routes local skills automatically.
...
- **Tags:** `agent-skills`, `architecture`, `coding-agents`
- **Why use it:** Makes coding agents architecture-aware with drift detection
...
- **Why use it:** Vision toolkit enabling text-only LLMs to see and understand images
...
- **Tags:** `agent-rq`, `task-manager`, `mcp`
- **Why use it:** Self-hosted task manager with human-in-the-loop agent control
...
- **Tags:** `vision`, `dsh-plugin`, `ocr`
- **Why use it:** Native DSH vision integration with free OCR and screenshot support
...
- **Tags:** `agent`, `skills`, `coding`, `orchestrator`
- **Why use it:** Turn experience into repeatable agent execution workflows across platforms.
...
- **Tags:** `vision`, `multimodal`, `agent-skills`, `browser`
- **Why use it:** Adds multimodal vision capability to Claude Code/DeepSeek for screenshot analysis.
...
- **Tags:** `agent-skills`, `plugin-discovery`, `automation`
- **Why use it:** Auto-searches, installs and verifies DSH plugins directly from GitHub.
...
- **Why use it:** Dedicated creative writing skills for novels and short-drama production
...
- **Tags:** `ai-infra`, `skills`, `coding-agent`
- **Why use it:** Specialized skills for AI infra development, debugging and optimization
...
- **Tags:** `superpowers`, `reasonix`, `skills`
- **Why use it:** Superpowers skill port adapted for the Reasonix coding harness
...
- **Why use it:** Complete reverse engineering and pentesting skill set for security research
...
- **Why use it:** AI coding mentor with architecture scanning, code review, and lesson plans
...
- **Why use it:** 88 agent skills for research, social intelligence, marketing and business workflows
...
- **Tags:** `agent-skills`, `legal-tech`, `visualization`
- **Why use it:** Legal case timeline and diagram visualization tool for litigation workflows
...
- **Tags:** `agent-skills`, `dsh-plugin`, `ai-agent`
- **Why use it:** Agent skill for developing DSH plugins following official standards
...
- **Tags:** `agent-skills`, `spec-programming`, `vibe-coding`
- **Why use it:** Portable spec-driven development skill with repository-native patterns
...
- **Why use it:** Agent skill for managing DSH plugin slots, Typert remotes and credentials
...
- **Tags:** `agent-skill`, `plugin-development`, `knowledge-base`
- **Why use it:** On-demand plugin dev knowledge base with official EN/ZH docs archive
...
- **Tags:** `code-simplification`, `codex-skill`, `refactor`
- **Why use it:** Codex skill for refactoring and code simplification
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `iching`, `dashboard`
- **Why use it:** Bazi/Fengshui/I-Ching agent skill with local engine
...
- **Why use it:** Multi-agent team with shared workspace and tools
...
- **Tags:** `governance`, `swift-cycle`, `project-management`
- **Why use it:** Version-pinned governance skill for project control
...
- **Tags:** `plugin-dev`, `agent-skill`, `audit`
- **Why use it:** Portable agent skill for developing and auditing DSH plugins with profile adapter.
...
- **Tags:** `development`, `docs`, `best-practices`
- **Why use it:** Practical DSH plugin dev troubleshooting guide covering cordis, tsconfig, and Windows tricks.
...
- **⭐ Stars:** 13
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生���订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese-documents`
- **Why use it:** Complete Chinese official document processing tool following national GB/T 9704 standard.
...
- **Tags:** `engineering`, `discipline`, `skill`
- **Why use it:** Portable agent skill distilling engineering discipline and fact-finding practices from DSH.
...
- **Tags:** `directorx`, `ai-video`, `multimodal`
- **Why use it:** DirectorX AI video/image/audio skills with configurable vision and multimodal model tools.
...
- **Why use it:** Agent skills for scaffolding new DSH plugins and choosing appropriate test tiers.
...
- **Tags:** `record-replay`, `macos`, `workflow`
- **Why use it:** Record macOS desktop workflows by demonstration and convert them into reusable agent skills.
...
- **⭐ Stars:** 10
- **Language:** Python
- **Description:** DeepSeek Harness 0.1.0-rc.6 数学建模增强套件：外��插件 + Preset + 17 个手动 Skill 卡片 + Windows 便携版脚本
- **Tags:** `math`, `skills`
- **Why use it:** Math modeling toolkit with 17 manual Skill cards for DSH
...
- **Tags:** `game-dev`, `godot`
- **Why use it:** Godot Engine 4.x full-stack game dev skill for DSH
...
- **Why use it:** Virtual product team agent preset for guided PM-to-engineering workflows.
...
- **Why use it:** Pre-flight plugin check for agents to boost library utilization.
...
- **Tags:** `vfs`, `virtual-filesystem`, `sandbox`, `mcp`
- **Why use it:** First unified virtual filesystem providing sandboxed storage for AI agents
...
- **Tags:** `compatibility`, `migration`, `plugin-migration`
- **Why use it:** Compatibility bridge running Pi extensions as native DSH plugins seamlessly.
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI panel for managing skills and MCP configurations easily
...
- **Tags:** `ai-agents`, `chinese-api`, `deepseek-harness`
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms, zero config
...
- **Why use it:** Pixel-to-text OCR and image reading tools for text-only LLM models
...
- **Tags:** `mcp-manager`, `web-gui`, `skill-management`
...
- **Tags:** `mcp`, `tool-management`
- **Why use it:** Unified menu to manage MCP tools and skills exposure levels
...
- **Tags:** `mcp-server`, `skill-management`
- **Why use it:** Hot-reload MCP server and skill management without restart
...
- **Tags:** `mcp`, `chatgpt`, `oauth`
- **Why use it:** OAuth-based ChatGPT integration for DSH agents.
...
- **Tags:** `architecture-diagram`, `diagrams-as-code`, `mermaid`
- **Why use it:** Self-contained HTML diagrams with motion and clarity
...
- **Tags:** `image-generation`, `prompt-engineering`, `gpt-image-2`, `skills`
- **Why use it:** 470+ GPT-Image2 prompts and industrial templates for AI art
...
- **Tags:** `design`, `ui`, `vibecoding`, `agent-team`
...
- **Tags:** `video-generation`, `ai-video`, `agent-skill`
- **Why use it:** Turn one topic into finished Vox-style paper-collage explainer videos end-to-end via AI.
...
- **Tags:** `design`, `ppt`, `dsh-plugin`, `visual-editor`
- **Why use it:** Native design & PPT studio with AI generation, visual editing, and template marketplace.
...
- **Tags:** `design`, `ui`, `openpencil`, `ppt`
- **Why use it:** Preview, inspect and edit .op design documents directly inside DSH conversations.
...
- **Tags:** `image-generation`, `ai`, `gemini`, `seedream`
- **Why use it:** Generate AI images directly in DSH chats using Gemini, Seedream and other models.
...
- **Tags:** `image-generation`, `vision`, `media-skills`
- **Why use it:** Free image reading and generation with Vision models
...
- **Tags:** `design-system`, `vibe-coding`, `web-design`, `ui`
- **Why use it:** 6 design system styles to avoid generic AI look
...
- **Why use it:** Browser extension suite enhancing Gemini, Claude & ChatGPT
...
- **Why use it:** Local-first cross-platform AI agent discovers content from Bilibili, Douyin, YouTube, etc.
...
- **Why use it:** Let AI agents use your real logged-in browser without interrupting your workflow.
...
- **Why use it:** Chrome extension organizing AI conversations into reusable workflows
...
- **Why use it:** Direct browser control via Chrome sidebar without vision model required.
...
- **Tags:** `ios`, `mobile-automation`, `dsh-plugin`, `mcp`
- **Why use it:** Live iOS Simulator and USB iPhone control inside DSH with 22 agent automation tools.
...
- **Why use it:** Tabbit Browser integration for powerful Playwright-based web automation
...
- **Tags:** `social`, `oauth`, `community`, `photo-wall`
- **Why use it:** Beta tester photo wall with GitHub OAuth login
...
- **Why use it:** Plugin radar with 9000+ candidates auto-discovered, container-tested, and curated into top 50.
...
- **Why use it:** Context dashboard and management tool with usage statistics
...
- **Tags:** `oauth`, `dsh-plugin`, `llm-provider`
- **Why use it:** Use ChatGPT, Claude, and Grok subscription accounts as free DSH LLM providers via OAuth.
...
- **⭐ Stars:** 232
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册�� API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `dsh-plugin`, `free`
- **Why use it:** Strongest free web search plugin for DSH, works as bridge for models without native web access.
...
- **Why use it:** Track session and daily costs, budget, history, and quota for DSH usage.
...
- **Tags:** `marketplace`, `plugin`, `dsh-plugin`
- **Why use it:** One-click browse, install and update all DSH plugins from GitHub topics
...
- **Why use it:** Essential crash-recovery with safe-mode snapshots and one-click rollback
...
- **Why use it:** Previewable cross-preset session migration with fixed-schema handoffs
...
- **Tags:** `plugin-market`, `web`, `ui`
- **Why use it:** Community plugin market integrated directly into DSH web GUI
...
- **Why use it:** Auto-syncs plugin catalog every 4 hours, curated community list
...
- **Why use it:** Plugin management console with browser panel, zero patch needed
...
- **Why use it:** Official auto-generated plugin list curated by cordis.run
...
- **Tags:** `dsh-plugins`, `deepseek-harness`
...
- **Tags:** `context-audit`, `token-optimization`, `ui-tool`
- **Why use it:** Context audit tool with Web UI, detects conflicts
...
- **Tags:** `package-manager`, `multi-agent`, `cli-tools`, `database`
- **Why use it:** Package manager with 42 skills, 5 CLIs, multi-agent support
...
- **Why use it:** Complete DSH config backup/restore with WebDAV sync for plugins, MCP servers, and skills.
...
- **⭐ Stars:** 11
- **Language:** JavaScript
- **Description:** DSH 插件管理器:在 DeepSeek Harness ��置面板内嵌 GUI,管理 MCP 服务 / Skills / 内置插件包,改动热生效无需重启
- **Tags:** `plugin-manager`, `utilities`
- **Why use it:** Built-in GUI plugin manager with hot-reload for MCP and skills
...
- **Why use it:** Detects and resolves conflicts between DSH plugins and versions.
...
- **Tags:** `pet`, `pixel-art`, `mascot`, `theme`
- **Why use it:** Public gallery of animated pixel-art pets for multiple AI coding agents
...
- **Tags:** `theme`, `skin`, `visual-customization`
- **Why use it:** Whale girl themed skins for DeepSeek Harness visual customization.
...
- **Tags:** `theme`, `dsh-plugin`, `ui`
- **Why use it:** Frosted glass theme with full customizability, no source code changes needed.
...
- **Tags:** `theme`, `chrome-extension`, `threejs`
- **Why use it:** Beautiful WebGPU ocean theme for DSH with Three.js and WebGPU rendering.
...
- **Tags:** `theme`, `skin`, `customization`
- **Why use it:** One-click swap to 34 opencode classic themes including tokyonight, dracula, and gruvbox.
...
- **Why use it:** Web background customization with image upload and presets
...
- **Tags:** `ai-resources`, `tutorial`, `vibe-coding`
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day content and generates well-sourced research reports.
...
- **Tags:** `stock`, `quant`, `finance`
- **Why use it:** Curated stock/finance/quant plugins vertical for DSH
...
- **Why use it:** Curated plugin list — essential DSH ecosystem discovery resource
...
- **Tags:** `entertainment`, `single-file`, `dsh-plugin`
- **Why use it:** Web simulation of traditional Chinese buzzing toy, zero-dependency single file.
...
- **Why use it:** Comprehensive curated list of DSH plugins and ecosystem tools
...
- **Tags:** `awesome-list`, `dsh-plugin`, `curated`
- **Why use it:** Curated bilingual awesome list of DSH plugins, tools, skills, and integrations.
...
- **Why use it:** Automated daily-curated plugin discovery with verification, blacklist, and matching guide.
...
- **Tags:** `dsh-plugin`, `learning`, `guide`
- **Why use it:** DSH learning resource covering principles, plugin marketplace, and best practices.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `guide`
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, resources, and toolkits in bilingual format.
...
- **Tags:** `awesome-list`, `agent-framework`, `plugins`
- **Why use it:** Curated catalog of DSH plugins, skills, MCP servers and orchestrators.
...
- **Tags:** `marketplace`, `registry`, `catalog`, `hub`
- **Why use it:** Plugin marketplace hub with 3,100+ plugins, search, rankings and free API.
...
- **Tags:** `plugin-marketplace`, `plugins`, `harness`
- **Why use it:** Plugin marketplace hub featuring DeepSeek Harness plugins for various tasks.
...
- **Tags:** `anime`, `bangumi`, `torrent`, `typescript`
...
- **Tags:** `notes`, `smartisan`, `docker`, `multi-tenant`
- **Why use it:** Open-source Smartisan-style notes with Docker, multi-tenant and export support.
...
- **Why use it:** Curated list covering plugins, extensions and dev resources for DSH
...
- **Tags:** `awesome-list`, `plugin-directory`, `dsh-plugins`
- **Why use it:** Curated 280+ plugin directory, essential discovery hub
...
- **Why use it:** Community-curated public GitHub directory for discovering DSH plugins and installation commands.
...
- **Why use it:** Curated list of精选 DSH plugins serving as a discovery reference.
...
- **Why use it:** Fast Neovim plugin manager in Lua — not a DSH plugin but a useful standalone tool.
...
- **Why use it:** StarHub 是一款跨平台桌面应用（Tauri 2 + Rust 主进程 + DeepSeek Harness React 工作台 + Go Sidecar）
...
- **Why use it:** Curated evidence-led directory of verified DSH plugins
...
- **Why use it:** Curated 2026 DSH plugin list with quality review.
...
- **Why use it:** Plugin guide and navigation by use-case with compatibility info.
...
- **Why use it:** Plugin radar with evidence-backed reviews and lab.
...
- **Tags:** `portal`, `web`
- **Why use it:** Static web portal for browsing and installing 227+ DSH plugins.
...
- **Why use it:** Archived; redirected to awesome-dsh-plugin/awesome-dsh-plugin.
...
- **Why use it:** Auto-crawled bilingual plugin directory via GitHub Actions.
...
- **Tags:** `ai-agents`, `awesome-list`, `dsh-plugin`, `mcp`
- **Why use it:** AI-curated comprehensive plugin list updated hourly.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `dsh-repository-plugin`
- **Why use it:** DSH插件集合与仓库列表资源。
...
- **Tags:** `agent-harness`, `coding-agents`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** 覆盖模型、工具、沙箱、UI的插件目录。
...
- **Tags:** `cordis-plugin`, `dsh-plugin`
- **Why use it:** 官方自动生成的Cordis插件列表。
...
- **Why use it:** GitHub生态1000+ DSH工具按星排序。
...
- **⭐ Stars:** 1
- **Language:** JavaScript
- **Description:** DSH 插件市场动态插件：浏览 awesome-dsh-plugin 社区精��（227），搜索/分类/星标排名/一键安装/已装检测/收藏
- **Tags:** `dsh-plugin`, `marketplace`
- **Why use it:** 动态插件市场，支持浏览搜索和一键安装。

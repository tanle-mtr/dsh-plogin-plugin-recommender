...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,008,449 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-12 04:30:25 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 220,736 | Core DSH platform — everything is a plugin, extens |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,652 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,159 | Deploy multi-agent swarms with autonomous workflow |
...
- **Why use it:** Core DSH platform — everything is a plugin, extensible and modular.
...
- **Tags:** `coding-agent`, `r1`, `tui`, `dsh-plugin`
...
- **Tags:** `no-code`, `ai-agent`, `self-hosted`, `dsh-plugin`
...
- **Tags:** `routing`, `harness-tool`, `injector`
- **Why use it:** Task-aware reasoning-mode router with runtime injector for DSH.
...
- **Why use it:** Self-improving agent OS with staged evaluation and MCP integration.
...
- **Why use it:** Coding agent CLI with RPC plugin, sub-agents, hashline edits, and MCP integration for terminal workflows
...
- **Why use it:** CLI tool for DSH Plugin Hub with schemas, resolver, and agent tools.
...
- **Tags:** `skills-manager`, `harness-tool`
- **Why use it:** Centralized manager for loading and safely orchestrating local Agent Skills in DSH.
...
- **Why use it:** Installable plugin dev knowledge base as on-demand skill. Official EN/ZH docs archive bundled.
...
- **Tags:** `code`, `simplification`
- **Why use it:** Adapted code simplification skill from DSH
...
- **Why use it:** Official Open API docs and examples for DSH plugin development.
...
- **Tags:** `plugin-dev`, `skill`, `dsh-plugins`
...
- **Why use it:** Agent Skill that teaches plugin/service/event/tool development standards for DSH.
...
- **Why use it:** Fast and elegant Neovim plugin manager in Lua, great for coding workflows.
...
- **Why use it:** Free Xiaomi MiMo TTS API integration for text-to-speech playback.
...
- **Why use it:** Pre-flight plugin check that auto-injects top-K relevant plugin hints
...
- **Why use it:** Modern desktop solution for DSH — even the desktop is a plugin.
...
- **Why use it:** Virtual terminal giving agents a simulated terminal environment.
...
- **Tags:** `desktop`, `dsh`, `dsh-desktop`, `tauri`
- **Why use it:** Zero-setup 5MB desktop app with preset plugins, cross-platform.
...
- **Why use it:** Local-first AI desktop workspace integrating DSH Sessions, files, web research, plugins and Office artifacts
...
- **Why use it:** Windows desktop GUI client with Codex, plugins, skills, SSH, and mobile remote access out of the box
...
- **Why use it:** Canvas-based visual conversation workspace with non-linear session explorer and branching navigation
...
- **Why use it:** Local-first multi-model Tauri desktop app with self-evolving skills and multi-Harness routing for privacy
...
- **Tags:** `office`, `desktop`, `plugin`
- **Why use it:** Full office suite (spreadsheets, docs, slides) integrated into DSH desktop.
...
- **Tags:** `ios`, `mobile`, `kotlin-multiplatform`, `native`
- **Why use it:** Native iOS client with WebSocket connection to DSH workspace.
...
- **Tags:** `notes`, `productivity`, `ui`
- **Why use it:** Open-source Smartisan-style notes with Docker deployment support
...
- **Why use it:** Electron desktop hub for multi-tab managing Harness/Plugin/MCP/Skills. Double-click to use.
...
- **Why use it:** Live info bar showing model balance and pricing
...
- **Why use it:** Electron desktop wrapper integrating DSH web UI and sidebar tools.
...
- **Tags:** `theming`, `customization`, `webui`
...
- **Why use it:** One-click compact button to toggle the DSH context meter panel.
...
- **Why use it:** Turn documents into RAG knowledge base with self-maintaining wiki.
...
- **Tags:** `memory`, `stateful-agent`, `continual-learning`
...
- **Why use it:** Persistent unified memory layer for agents backed by Milvus and Markdown.
...
- **Why use it:** Shared persistent memory hub for all AI agents with full user control.
...
- **Why use it:** Turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora with evaluation tooling
...
- **Tags:** `memory`, `handoff`
- **Why use it:** Cross-platform session continuity memory recovery
...
- **Tags:** `skill-store`, `agent-skills`, `automation`
- **Why use it:** Most comprehensive skill store with auto-crawled GitHub skills.
...
- **Why use it:** Enterprise multi-agent workbench with unified cross-engine workspace.
...
- **Why use it:** Cognitive-enhancement skills based on Anthropic J-space global workspace.
...
- **Tags:** `ai-video`, `agent-skill`, `dsh-plugin`, `ffmpeg`
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, OCR, UI restoration.
...
- **Tags:** `ai-writing`, `novel`, `dsh-plugin`, `rag`
- **Why use it:** Organized AI novel writing with characters, worldbuilding, drafting and editing.
...
- **Why use it:** Turns video, audio and screen activity into searchable timestamped evidence with OCR and speech-to-text
...
- **Tags:** `creative-writing`, `novel-writing`, `drama-skills`, `agent-skills`
- **Why use it:** Specialized plugin for novel writing and short-drama production powered by Oh Story and Drama Skills
...
- **Why use it:** Native SQLite-backed task management with agent claim/review flow.
...
- **Tags:** `math-modeling`, `competition`, `gitops`, `skill`
...
- **⭐ Stars:** 206
- **Language:** TypeScript
- **Description:** 让 Agent 的工作方式可组合、可审查、可持续��进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **Tags:** `agent`, `evolution`, `workflows`
...
- **Why use it:** Complete reverse engineering and pentesting skill pack with 87 SKILL.md entries
...
- **Tags:** `skills`, `deck`, `agent-skills`
- **Why use it:** 25 ready-to-use engineering skills in sidebar. No manual install needed for triage, grilling, etc.
...
- **Why use it:** Full GB/T 9704 official document workflow: format check, template, Markdown-to-doc conversion.
...
- **Why use it:** Portable spec-driven development skill for repository-native workflow. Vibe coding friendly.
...
- **Tags:** `bazi`, `fengshui`, `agent`
- **Why use it:** Unique cultural AI agent with deterministic local engine
...
- **⭐ Stars:** 29
- **Language:** Python
- **Description:** DeepSeek自带破��18+互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。
- **Tags:** `narrative`, `18+`
- **Why use it:** 18+ interactive narrative with NPC memory system
...
- **Why use it:** Engineering discipline guard for quality-gating requirements and delivery.
...
- **Why use it:** Full-stack Godot 4.x dev skill for AI-assisted game development.
...
- **Why use it:** Official Huawei Cloud SDK with MCP tools, skills, guardrails, and cloud sandbox for AI agents.
...
- **Tags:** `mcp`, `config`
- **Why use it:** One-click MCP server setup for multi-agent tools
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional bridge syncing Codex sessions and MCP tools with DSH.
...
- **Tags:** `diagrams-as-code`, `mermaid-alternative`
- **Why use it:** Generate verifiable architecture and sequence diagrams from code.
...
- **Why use it:** 530+ GPT Image prompt cases and 20+ reusable industrial templates.
...
- **Why use it:** Interactive UI components rendered inline in replies — charts, plots, forms, quizzes via dsh-ui fence
...
- **Why use it:** Enables image reading for text-only models via OCR
...
- **Tags:** `video`, `audio`, `ai`
- **Why use it:** AI video/image/audio generation with storyboard
...
- **Why use it:** 6 aesthetic style packs preventing generic AI-looking websites.
...
- **Why use it:** Two-phase preset: bootstrap then full Standard tools integration.
...
- **Tags:** `installer`, `model-switch`
- **Why use it:** One-click install and model switch across multiple AI coding tools.
...
- **Why use it:** Self-hosted plugin discovery radar with 15900+ candidates and k8s testing.
...
- **Tags:** `dsh-plugin`, `context`, `dsh-external`
- **Why use it:** Best context dashboard/sidebar for insight and management in DSH.
...
- **Tags:** `dsh-plugin`, `marketplace`, `harness`
- **Why use it:** Comprehensive plugin marketplace with daily updates and pre-publish reviews.
...
- **Tags:** `cybersecurity`, `vulnerabilities`, `plugin-verify`, `redteam`
- **Why use it:** AI security offense/defense platform auditing hallucinated packages, missing safeguards and AI pattern errors
...
- **Why use it:** OAuth integration for multiple LLM providers without API keys needed.
...
- **Tags:** `marketplace`, `registry`, `catalog`
- **Why use it:** Essential plugin marketplace and registry for DSH ecosystem discovery
...
- **Why use it:** Comprehensive DSH plugin catalog with multilingual search and filtering
...
- **Why use it:** Bridge Pi and DSH ecosystems with one ABI compatibility layer
...
- **Why use it:** Authoritative agent-first handbook with 173 source-backed resources
...
- **Why use it:** Skill that automates plugin search, installation, and verification
...
- **Why use it:** Curated awesome list of top DSH plugins and resources
...
- **Why use it:** Auto-upgrades plugins with DSH version updates seamlessly
...
- **Tags:** `config`, `backup`, `restore`, `sync`
- **Why use it:** Backup, restore, migrate and sync full DSH config via WebDAV
...
- **Why use it:** Infrastructure for DSH plugin ecosystem: browser-based registry console plus plugin scaffolder.
...
- **Why use it:** Context injection audit with token cost analysis
...
- **Why use it:** Local DSH version management in isolated containers
...
- **Why use it:** Migration wizard for moving Claude Code/Codex sessions into DSH seamlessly.
...
- **Tags:** `theme`, `pet`, `customization`
- **Why use it:** Public gallery of animated pets for coding agents and CLIs.
...
- **Tags:** `dsh`, `dsh-plugin`
- **Why use it:** Whale girl theme collection enhances DSH visual appeal.
...
- **Why use it:** Frosted-glass theme for DSH web UI with adjustable blur,磨砂度, backgrounds and fluid wallpaper effects
...
- **Tags:** `theme`, `animated-background`, `ocean-skin`, `threejs`
- **Why use it:** Real-time animated ocean theme with adjustable waves, sunset effects and glass opacity via Chrome/Edge extension
...
- **Tags:** `ai-guide`, `tutorial`, `resource`
...
- **Why use it:** Auto-searches 8 major CN platforms and generates cited research reports.
...
- **Why use it:** Curated DSH plugin ecosystem directory spanning agents and CLI tools.
...
- **Tags:** `academic`, `arxiv`, `mcp`, `citation`, `research`
- **Why use it:** Cross-source academic search with citation graph, MeSH, and verification.
...
- **Tags:** `finance`, `research`, `database`
- **Why use it:** AI-native multi-agent financial analysis with Tushare data source
...
- **Why use it:** Searches 65K+ Chinese platform API docs directly in coding agents. Zero config needed.
...
- **Why use it:** Patent infringement analysis system producing competitor reports from patent numbers.
...
- **Why use it:** Bioinformatics agent desktop for clinicians
...
- **Tags:** `kline`, `finance`
- **Why use it:** Interactive K-line analysis with market data
...
- **Tags:** `api-cost`, `data-visualization`, `token-usage`
- **Why use it:** Real-time token usage tracking and cost estimation dashboard.
...
- **Why use it:** Specialized curated list for stock/finance/quant DSH plugins.
...
- **Why use it:** Curated bilingual (EN/ZH) awesome list of DSH plugins, extensions, tools, skills, clients and runtimes
...
- **Tags:** `dsh-bundle`, `knowledge-base`, `awesome-list`, `mcp`
...
- **Why use it:** Curated daily-updated plugin discovery list with smart filtering.
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, and resources.
...
- **Tags:** `awesome-list`, `mcp`, `plugin`, `skill`
...
- **Tags:** `awesome-list`, `plugin-list`, `curated`
- **Why use it:** Official auto-generated curated plugin listing by cordis.run
...
- **Why use it:** Meticulously curated plugin, tool, and resource directory for DSH
...
- **⭐ Stars:** 74
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描��目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `deepseek-harness`, `dsh`, `dsh-plugin`
- **Why use it:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描��目架构、生成阶梯式 Chapter
...
- **Why use it:** Legal visualization toolkit: redraws litigation diagrams and generates case timeline SVGs.
...
- **Why use it:** Curated directory of 280+ community plugins across 14 categories. Quick links to repos.
...
- **Why use it:** Unofficial community catalog browsing all DSH plugins in one place.
...
- **Why use it:** Curated list of DSH plugins, great starting point for ecosystem exploration.
...
- **Why use it:** Public GitHub directory for DSH plugin discovery, install commands, and ecosystem.
...
- **Tags:** `awesome-list`, `plugin`, `resources`
...
- **Why use it:** 2026 updated curated DSH plugins with quality checks included.
...
- **Why use it:** 1000+ DSH tools sorted by stars with GitHub topic coverage.
...
- **Why use it:** Verified and star-ranked community plugins for DSH ecosystem.
...
- **Why use it:** Plugin navigation guide for DSH users covering install, permissions, compatibility
...
- **Why use it:** Zero-dependency static web portal to browse and discover 227+ DSH plugins
...
- **Why use it:** Search npm + awesome-dsh-plugin for plugin discoverability inside agents
...
- **Why use it:** AI-curated hourly-updated plugin list across 12 categories, 190+ plugins
...
- **Tags:** `awesome-list`, `plugins`, `ai-agents`
...
- **Tags:** `dsh-plugins`, `dsh-bundle`, `dsh-repository-plugin`
...
- **Tags:** `plugin-directory`, `curated-list`, `dsh`
- **Why use it:** Curated plugin directory for discovering useful DSH plugins
...
- **Tags:** `plugin-directory`, `curated-list`, `dsh`, `coding-agents`
- **Why use it:** Comprehensive curated registry for DSH plugins and tools

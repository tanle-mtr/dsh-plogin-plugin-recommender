...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 840,490 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 19:27:48 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,657 | Core DSH platform enabling everything-as-plugin ar |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,701 | Local-first AI design tool with UI generation and  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,015 | Multi-agent swarm orchestrator with autonomous wor |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 24 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 16 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 15 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 32 plugins
- [MCP Servers & Tools](#mcp-servers-&-tools) — 4 plugins
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 28 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 7 plugins
- [Other](#other) — 38 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (24)
- [UI & Desktop Extensions](ui-desktop-extensions) (16)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (15)
- [Agent Skills & Workflows](agent-skills-workflows) (32)
- [MCP Servers & Tools](mcp-servers-tools) (4)
- [Visual & Design](visual-design) (12)
- [Browser & Web Automation](browser-web-automation) (8)
- [Communication & Social](communication-social) (1)
- [Utilities & Infrastructure](utilities-infrastructure) (28)
- [Themes & Skins](themes-skins) (6)
- [Research & Analysis](research-analysis) (7)
- [Other](other) (38)
---
...
- **Why use it:** Core DSH platform enabling everything-as-plugin architecture
...
- **Tags:** `agentic-ai`, `multi-agent`, `mcp-server`, `dsh-plugin`
- **Why use it:** Multi-agent swarm orchestrator with autonomous workflows
...
- **Why use it:** Multi-model super assistant with memory, skills and self-evolution
...
- **Tags:** `coding-agent`, `terminal`, `dsh-plugin`, `tool-use`
...
- **Why use it:** Self-improving agent OS that gets smarter through continuous loop engineering
...
- **Why use it:** Vision plugin enabling text-only agents to understand images via OCR
...
- **Tags:** `claude-code`, `deepseek-harness`, `opencode`
- **Why use it:** One-click switch between Claude Code, Codex, Grok, DeepSeek and more.
...
- **Why use it:** Claude Code-style TUI with streaming thinking, real-time status, and rollback support.
...
- **Tags:** `code-review`, `code-quality`, `agent-skills`
- **Why use it:** AI code review grounded in 12 classic engineering books with severity labels and auto-fix.
...
- **Why use it:** Architecture-aware coding agent with baseline-first, drift-checked approach for safe long tasks.
...
- **Why use it:** Official Swift-native macOS coding agent built by DeepSeek for DSH ecosystem.
...
- **Tags:** `agent`, `desktop-app`, `multi-model`, `tauri`
- **Why use it:** Local-first multi-model agent desktop app with self-evolving skills
...
- **Tags:** `agent`, `coding-agent`, `team-orchestration`
- **Why use it:** Orchestrate multiple coding agents as one collaborative team
...
- **Tags:** `agent-skill`, `dsh-plugin`, `developer-tools`
- **Why use it:** Agent skill for building DSH plugins covering slots, tools, adapters, and packaging.
...
- **Tags:** `spec-driven-development`, `ai-coding`, `developer-tools`
- **Why use it:** Repository-native spec-driven development skill following DSH engineering patterns.
...
- **Tags:** `dsh-plugin`, `agent-skill`
- **Why use it:** Agent skill for managing slots, Typert remotes, and credentials of DSH plugins.
...
- **Tags:** `plugin-development`, `dsh-plugin`, `cordis`
- **Why use it:** Portable agent skill for developing and auditing DSH plugins with Cordis profile installation.
...
- **Tags:** `documentation`, `dsh-plugin`, `best-practices`
- **Why use it:** Practical DSH plugin dev notes covering tsconfig, Windows junctions, and zstd multi-frame fixes.
...
- **Tags:** `plugin-development`, `dsh-plugin`, `testing`
- **Why use it:** Build and test DSH plugins from scaffolding to test tier selection entirely within DSH.
...
- **Why use it:** Godot Engine 4.x full-stack game dev skill — registers gdscript coding agents at runtime.
...
- **Tags:** `capability`, `mcp`, `menu`
- **Why use it:** Unified menu to manage MCP tool exposure and execution modes
...
- **Why use it:** All-in-one desktop app integrating DB, SSH, Docker and AI assistant
...
- **Tags:** `plugin-manager`, `dsh-plugin`, `discovery`
- **Why use it:** Merges multiple plugin sources into one deduplicated registry for discovery
...
- **Tags:** `dsh-plugin`, `plugin-manager`, `cli`
- **Why use it:** Full-featured CLI plugin manager with search, install, update and audit
...
- **Tags:** `agent-skills`, `ai-design`, `figma-alternative`, `dsh-plugin`
- **Why use it:** Local-first AI design tool with UI generation and prototyping
...
- **Why use it:** Modern desktop client for DSH ecosystem with plugin-native design
...
- **Tags:** `web-ui`, `skins`, `desktop`
- **Why use it:** Web GUI with WebGL-optimized skins, wallpaper support, and plugin marketplace
...
- **Tags:** `sidebar`, `dsh-plugin`, `ui-extension`
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, and sub-agent pages.
...
- **Tags:** `agentic-os`, `desktop`, `vibe-coding`
- **Why use it:** Rust-based agent runtime paired with a polished desktop IDE experience.
...
- **Why use it:** Desktop companion platform with animated pets and plugin SDK for coding agents.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight 5MB Tauri desktop client for DSH — zero setup, cross-platform.
...
- **Tags:** `desktop`, `electron`
- **Why use it:** Local-first Electron desktop workspace for DSH — sessions, files, research, and office.
...
- **Tags:** `ui`, `genui`, `interactive-components`
- **Why use it:** Generative UI components: charts, layouts, forms rendered inline
...
- **Why use it:** CodePilot-inspired cross-platform desktop client for DSH
...
- **Why use it:** Canvas-based branching conversation workspace with visual navigation
...
- **Why use it:** Full-featured Electron desktop client with SSH, skills and Codex support
...
- **Why use it:** Electron desktop console for multi-tab management of Harness/Plugin/MCP.
...
- **Tags:** `ui`, `usage-tracking`, `deepseek-harness`
- **Why use it:** Persistent bottom bar showing provider, model, live balance, and peak/off-peak pricing countdown.
...
- **Why use it:** Electron desktop wrapper integrating multiple DSH tools
...
- **Tags:** `agent-memory`, `agentic-rag`, `dsh-plugin`, `self-evolving`
...
- **Tags:** `rag`, `knowledge-base`, `dsh-plugin`, `vector-search`
...
- **Why use it:** Portable local-first memory layer that evolves across apps and workflows
...
- **Tags:** `memory`, `rag`, `token-optimization`
- **Why use it:** Ultra-persistent self-evolving memory with 35% token savings via hybrid retrieval
...
- **Tags:** `memory`, `rag`
- **Why use it:** Unlimited memory storage for AI agents, essential for long-term context retention.
...
- **Why use it:** Context insight dashboard and management — best-in-class for DSH context stats.
...
- **Tags:** `knowledge-base`, `mcp`, `rag`, `ai-resources`
- **Why use it:** Comprehensive AI knowledge base covering skills, MCP, RAG and more
...
- **Why use it:** Durable inspectable long-term memory with recall tools for agents.
...
- **Tags:** `skill-corpus`, `vector-search`, `embeddings`
- **Why use it:** Turns scattered SKILL.md files into curated retrieval-ready corpora.
...
- **Why use it:** Community-maintained curated catalog with auto-sync every 4 hours.
...
- **⭐ Stars:** 42
- **Language:** JavaScript
- **Description:** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选��护的 DeepSeek Harness Cordis 插件官方自动生成列表。
...
- **Why use it:** On-demand agent skill bundling official DSH plugin dev docs in EN/ZH.
...
- **Tags:** `session-memory`, `agent-handoff`
- **Why use it:** Enables cross-platform session continuity and memory recovery
...
- **Why use it:** Connects to PowerContext for memory recall and skill handoff
...
- **Tags:** `claude-bridge`, `memory`, `skills`
...
- **Tags:** `agent-skills`, `knowledge-distillation`, `dsh-plugin`, `meta-skill`
...
- **Why use it:** Unified agent workspace accessible from desktop, mobile, browser, and API
...
- **Why use it:** Enterprise-grade multi-agent workbench with unified workspace across engines
...
- **Why use it:** Anthropic J-space cognitive-enhancement skills for deeper agent reasoning.
...
- **Tags:** `agent-skills`, `vibe-coding`, `workflow-automation`
- **Why use it:** Intelligently routes local skills and orchestrates DSH harness workflows.
...
- **Tags:** `vision`, `agent-skills`
- **Why use it:** Enables text-only LLMs to see images — Q&A, UI restoration, GUI automation.
...
- **Tags:** `task-manager`, `workflow`
- **Why use it:** Self-hosted human-in-loop task manager with mobile and web control for AI agents.
...
- **Tags:** `vision`, `agent-skills`
- **Why use it:** Native DSH vision toolkit — OCR, screenshot-to-UI, free and easy to install.
...
- **Why use it:** Adds multimodal vision to pure-text LLMs for UI and screenshot analysis
...
- **Tags:** `skill`, `plugin-discovery`, `automation`
- **Why use it:** Skill that auto-discovers, installs and verifies GitHub plugins
...
- **Tags:** `skills`, `ai-infra`, `coding`
- **Why use it:** Specialized skills for AI infra development, write/optimize/debug.
...
- **Why use it:** Superpowers skill port for Reasonix coding harness, battle-tested skills.
...
- **Why use it:** TDD, debugging, planning and collaboration skills from Superpowers.
...
- **Why use it:** 85 SKILL.md covering reverse engineering and authorized pentesting.
...
- **Tags:** `dsh-plugin`, `ai-agents`
- **Why use it:** AI coding mentor that generates scaffolded chapters and does auto review.
...
- **Tags:** `agent-skills`, `research-tools`, `marketing-automation`
- **Why use it:** 88 open-source agent skills for research, marketing, and social intelligence.
...
- **Tags:** `skill-picker`, `composer`
- **Why use it:** WorkBuddy-style skill picker for quick skill selection
...
- **Why use it:** Adapts DSH code simplification skill for Codex workflows
...
- **Tags:** `chinese-wisdom`, `tradition`, `dashboard`
- **Why use it:** Integrates Bazi, Fengshui, IChing and TCM into one skill pack
...
- **Tags:** `skills-manager`, `management`
- **Why use it:** Dedicated plugin for managing DSH skills effectively
...
- **Tags:** `governance`, `swift-cycle`, `skill`
- **Why use it:** Version-pinned governance skill for Swift Cycle projects
...
- **Tags:** `agent-skills`, `dsh-plugin`, `mcp`
- **Why use it:** Comprehensive skill pack for AI agent engineering with eval-driven and spec-driven dev approaches.
...
- **Tags:** `docx`, `gongwen`, `wps-office`
- **Why use it:** End-to-end Chinese official document processing compliant with GB/T 9704 national standard.
...
- **Tags:** `agent-skills`, `deepseek-harness`
- **Why use it:** Engineering discipline skill emphasizing fact-finding, durable decisions, and evidence-based reporting.
...
- **Why use it:** Infinite canvas native plugin with unlimited creative agent skills for WeShop workflows.
...
- **Why use it:** Turns recorded desktop workflows into reusable agent skills
...
- **Tags:** `skill-management`, `mcp`, `hot-reload`
- **Why use it:** Hot-load MCP servers and manage skills directly from settings page
...
- **Why use it:** Virtual PM-to-engineer-to-QA team walkthrough for product development
...
- **Tags:** `agent-tools`, `ai-agents`, `llm-agents`
- **Why use it:** Pre-flight plugin check ensures optimal plugin suggestions
...
- **Tags:** `mcp`, `skills`, `management`
- **Why use it:** Web UI panel for managing skills and MCP tools in one place.
...
- **Tags:** `codex`, `mcp`, `sync`
- **Why use it:** Bidirectional bridge syncing Codex and DSH with MCP mirroring
...
- **Why use it:** Browser-based GUI to manage skills and MCP servers in DSH
...
- **Why use it:** OAuth integration to chat with ChatGPT models inside DSH
...
- **Tags:** `agent-skills`, `diagram-as-code`, `dsh-plugin`, `code-visualization`
- **Why use it:** Generate beautiful architecture and workflow diagrams from code
...
- **Tags:** `image-generation`, `prompt-engineering`, `visual`
- **Why use it:** 470+ reverse-engineered image prompts with 20+ industrial templates
...
- **Tags:** `video-generation`, `tts`, `ffmpeg`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation via agent + ffmpeg.
...
- **Tags:** `design`, `ppt`, `prototyping`, `visual-editor`
- **Why use it:** AI-powered design studio with PPT, prototyping and visual editing
...
- **Tags:** `image-generation`, `visual`, `design`
- **Why use it:** Generate images directly in DeepSeek Harness using Seedream and Gemini
...
- **Why use it:** Preview and edit .op design documents directly in conversation.
...
- **Why use it:** Redraw messy litigation diagrams into court-ready timelines and SVGs.
...
- **Why use it:** Pixel-to-text OCR and image analysis tools for text-only AI models.
...
- **Why use it:** Free image reading and generation skills for DSH agents
...
- **Tags:** `design`, `vibe-coding`, `web-design`
- **Why use it:** 6 design style packs to avoid generic AI-generated looks
...
- **Why use it:** AI video/image/audio generation with configurable models, storyboarding, and knowledge corpus.
...
- **Why use it:** Cross-browser enhancement suite for Gemini, Claude and ChatGPT
...
- **Tags:** `ai-agent`, `bilibili`, `cross-platform`, `privacy-first`
- **Why use it:** Local-first cross-platform content discovery agent covering Bilibili, YouTube, Reddit and more.
...
- **Why use it:** Let AI agents use your real logged-in browser seamlessly without interrupting your workflow.
...
- **Why use it:** Browser extension turning AI conversations into reusable workflows across platforms.
...
- **Tags:** `browser-automation`, `chrome-extension`, `coding-agent`
- **Why use it:** Chrome sidebar extension for direct browser control by DSH agents
...
- **⭐ Stars:** 235
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的模型��上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `free`, `no-signup`
- **Why use it:** Free web search bridge for models without native internet access
...
- **Tags:** `ios`, `mobile-automation`, `xcode`
- **Why use it:** Live iOS Simulator and USB iPhone automation inside DSH conversations
...
- **Why use it:** Tabbit Browser plugin for DSH with Playwright-powered automation.
...
- **Tags:** `social`, `community`, `oauth`
- **Why use it:** GitHub OAuth photo wall for DSH community memories
...
- **Tags:** `agent-skills`, `mcp-server`, `dsh-plugin`, `self-hosted`
- **Why use it:** Privacy-first resume builder, fully open-source and free
...
- **Tags:** `dsh-plugin`, `electron-app`, `image-uploader`
...
- **Tags:** `dsh-plugin`, `low-code`, `workflows`, `self-hosted`
...
- **Tags:** `routing`, `infrastructure`, `performance`
...
- **Tags:** `preset`, `standard`, `bootstrap`
- **Why use it:** Two-phase preset for minimal-aligned bootstrap then full Standard tools
...
- **Why use it:** First unified virtual filesystem abstraction layer for AI agents
...
- **Tags:** `marketplace`, `dsh-plugin`, `plugin-discovery`
...
- **Tags:** `plugin-registry`, `awesome-list`, `dsh-plugin`
- **Why use it:** Plugin radar with 9000+ candidates, ranked by real install-level testing and human curation.
...
- **Why use it:** OAuth bridge to use ChatGPT/Claude/Grok subscriptions as LLM backends
...
- **Why use it:** Bridge Pi Agent ABI to run unmodified Pi extensions as native DSH plugins
...
- **Tags:** `marketplace`, `plugin-management`, `utility`
- **Why use it:** One-click browse, install and update all DSH plugins from GitHub.
...
- **Tags:** `backup`, `crash-recovery`, `snapshot`
- **Why use it:** Crash-rescue with undo, snapshots, and SAFE MODE for DSH stability.
...
- **Tags:** `migration`, `session`, `preset`
- **Why use it:** Cross-preset session migration preserving state and source intent.
...
- **Why use it:** Native SQLite-backed taskboard with clean Web UI, no iframe needed.
...
- **Tags:** `awesome-list`, `discovery`, `resources`
- **Why use it:** Curated awesome list of DSH plugins, a must-bookmark discovery resource.
...
- **Why use it:** Community plugin market for DSH Web GUI with one-click install/uninstall.
...
- **Why use it:** Meticulously curated list of DSH plugins covering productivity tools.
...
- **Why use it:** Thin console for browser-panel plugin management plus official dev guide.
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `desktop-app`
...
- **Why use it:** Audits context tokens, detects duplicates and conflicts via Web UI
...
- **Why use it:** Backup, restore and sync entire DSH config via WebDAV
...
- **Why use it:** Fast, simple, and elegant Neovim plugin manager written in pure Lua.
...
- **Tags:** `plugin-manager`, `gui`, `hot-reload`
- **Why use it:** Built-in GUI for managing MCP services, skills, and plugins with hot-reload
...
- **Why use it:** Real-time token usage tracking with cost estimates and balance display
...
- **Tags:** `hud`, `status`, `visualization`
- **Why use it:** Floating HUD panel showing git status, MCP servers, skills, and token usage
...
- **Tags:** `awesome`, `deepseek-harness-plugin`, `utilities`
- **Why use it:** Detects and resolves plugin version conflicts automatically
...
- **Tags:** `dsh`, `plugin-manager`, `publishing`
- **Why use it:** One-click plugin publisher with validation and auto-generated descriptions
...
- **Tags:** `pets`, `mascot`, `pixel-art`
- **Why use it:** Public gallery of animated pixel-art pets for Codex, Claude, and DSH
...
- **Why use it:** Cute whale-girl skin series that customizes the DeepSeek Harness UI.
...
- **Why use it:** Glassmorphism theme with fully customizable frosted glass UI
...
- **Tags:** `theme`, `ocean-skin`, `chrome-extension`
- **Why use it:** WebGPU ocean skin with Three.js for immersive DSH visuals
...
- **Tags:** `theme`, `skins`, `ui`, `opencode`
- **Why use it:** 34 opencode classic themes with one-click switching and persistent preferences across restarts.
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮��菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `background`, `theme`, `customization`
- **Why use it:** Customizable web background with preset atmospheres and real-time preview
...
- **Tags:** `ai-resources`, `vibe-coding`, `llm`, `dsh-plugin`
- **Why use it:** Comprehensive AI resource library and vibe coding tutorial hub
...
- **Tags:** `research`, `web-search`, `agent-skills`
- **Why use it:** Automatically scans 8 major Chinese platforms over 30 days and generates citable research reports.
...
- **Tags:** `awesome-list`, `catalog`, `plugin-discovery`
- **Why use it:** Curated plugin, skill & MCP server discovery list for DSH
...
- **Why use it:** Public API with 3100+ searchable plugins, rankings and install commands
...
- **Tags:** `deepseek-harness`, `analysis`, `kline`
- **Why use it:** Interactive K-line analysis with multi-market support, technical indicators, and news integration.
...
- **⭐ Stars:** 10
- **Language:** Python
- **Description:** DeepSeek Harness 0.1.0-rc.6 数学建模增��套件：外置插件 + Preset + 17 个手动 Skill 卡片 + Windows 便携版脚本
- **Tags:** `math`, `modeling`, `skills`
- **Why use it:** Math modeling toolkit with 17 preset skills and Windows portable script
...
- **Why use it:** Beginner-friendly tutorial to learn DSH plugin development from scratch
...
- **Tags:** `awesome-list`, `directory`, `resource`
- **Why use it:** Curated collection of best DSH plugins, a must-visit resource list
...
- **Tags:** `toy`, `single-file`, `entertainment`
- **Why use it:** Fun web-based creaky-toy simulator — zero dependency single file.
...
- **Why use it:** Curated plugin ecosystem list — great starting point for exploring DSH plugins.
...
- **Tags:** `awesome-list`, `resource`
- **Why use it:** Comprehensive curated list of DSH ecosystem plugins, tools, and infrastructure.
...
- **Why use it:** Curated bilingual DSH plugins, tools, skills and integrations list
...
- **Tags:** `awesome-list`, `plugin-finder`, `curated`
- **Why use it:** Daily auto-scraped plugin finder with human-verified quality checks
...
- **Tags:** `tutorial`, `marketplace`, `best-practices`
- **Why use it:** DSH principles tutorial with plugin marketplace and best practices
...
- **⭐ Stars:** 192
- **Language:** Unknown
- **Description:** DeepSeek Harness 终极指南：快速入���、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **Tags:** `awesome-list`, `guide`, `bilingual`
- **Why use it:** Ultimate bilingual guide: quickstart, resources and curated plugins
...
- **Tags:** `marketplace`, `hub`, `plugins`
- **Why use it:** DSH plugin marketplace and hub for plugin browsing and distribution
...
- **Why use it:** In-chat anime search with Bangumi ratings and magnet link support
...
- **Tags:** `creative-writing`, `drama`, `fiction`
- **Why use it:** Creative writing and short-drama production plugin powered by Oh Story
...
- **⭐ Stars:** 150
- **Language:** TypeScript
- **Description:** 开���版锤子便签，复刻锤科美学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **Tags:** `notes`, `productivity`, `smartisan`
- **Why use it:** Smartisan-style notes with Docker deployment, skill calls and public export
...
- **Why use it:** Comprehensive curated directory of 280+ community plugins
...
- **Tags:** `awesome-list`, `plugin-directory`, `nextjs`
- **Why use it:** Public GitHub directory for discovering DSH plugins with install commands and ecosystem browsing.
...
- **Why use it:** Curated list of DeepSeek Harness plugins — a well-organized discovery resource.
...
- **Why use it:** Curated plugin directory with verified entries and permission guidance
...
- **Why use it:** Curated list of 24 verified stock/finance/quant DSH plugins
...
- **Tags:** `awesome-list`, `curated-list`, `deepseek-harness`
- **Why use it:** Curated 2026 DSH plugin list with quality checks
...
- **Why use it:** Community-curated collection of useful DSH plugins
...
- **Tags:** `plugin-directory`, `awesome-list`, `deepseek-harness`
- **Why use it:** Plugin guide with scenario-based selection and risk info
...
- **Tags:** `awesome-list`, `ai-agents`, `dsh-plugin`
- **Why use it:** Verified star-ranked community DSH plugin directory
...
- **Why use it:** Evidence-backed DSH plugin radar with lab integration
...
- **Tags:** `plugin-portal`, `static-site`, `web`
- **Why use it:** Static web portal to discover and install 227+ DSH plugins
...
- **Tags:** `awesome-dsh-plugin`, `deprecated`
- **Why use it:** Deprecated — redirected to new repository location
...
- **Tags:** `awesome-list`, `coding-agents`, `mcp`
- **Why use it:** AI-curated hourly-updated 190+ plugin directory by category
...
- **Why use it:** DSH plugin repository with verification and analytics
...
- **Tags:** `awesome-list`, `deepseek-harness`, `plugin-directory`
- **Why use it:** Curated bilingual plugin directory with evidence-led reviews at immutable commits
...
- **Why use it:** Simple Chinese-focused DSH plugin list for quick reference
...
- **Tags:** `deepseek-harness`, `plugin-directory`
...
- **Tags:** `awesome-list`, `dsh-plugin-directory`, `deepseek-harness`
- **Why use it:** Auto-generated bilingual plugin directory via daily GitHub Actions
...
- **Tags:** `deepseek-harness`, `plugin-directory`, `coding-agents`
- **Why use it:** Comprehensive curated list covering models, tools, sandboxes, UI and agent loops

---

### [hotpot-labs/awesome-dsh-industry-plugins](https://github.com/hotpot-labs/awesome-dsh-industry-plugins)

- **⭐ Stars:** 1
- **Language:** Python
- **Description:** 计算机｜金融｜法律｜HR｜制造｜医疗｜电商等行业精选 dsh 插件目录
- **Tags:** `dsh-plugin`, `industry`, `plugin-directory`
- **Why use it:** Industry-specific plugin directory covering finance, law, healthcare and more
...
- **Tags:** `dsh-plugin`, `cordis`, `awesome-list`
- **Why use it:** Official auto-generated Cordis plugin list curated by cordis.run
...
- **Tags:** `dsh-plugin`, `awesome-list`, `catalog`
- **Why use it:** Complete DSH tool catalog sorted by stars from 1000+ GitHub repos

...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,086,746 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-23 20:04:55 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 234,265 | Core DSH framework; everything is a plugin foundat |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,812 | Open-source Claude Design alternative with local-f |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,149 | Deploy multi-agent swarms with autonomous workflow |
...
- **Tags:** `agent-collaboration`, `dsh-plugin`
- **Why use it:** Enterprise-grade unified workspace for multi-engine agent teams and collaboration
...
- **Why use it:** Self-evolving agent OS with gated evaluation and budgeted improvement loops
...
- **Why use it:** Two-phase preset bootstrap with minimal-aligned Standard tools.
...
- **Tags:** `agents`, `ai-coding`, `dsh-plugin`
...
- **Tags:** `vision`, `ocr`, `agent-skills`, `dsh-plugin`
- **Why use it:** Powerful vision toolkit for text-only models: OCR, image QA and screenshot UI
...
- **Tags:** `coding`, `rpc`, `sub-agents`
- **Why use it:** Coding agent plugin with RPC, sub-agents, hashline edits, and MCP support
...
- **Why use it:** Seamlessly run Pi extensions as native DSH plugins via compatibility layer
...
- **Tags:** `cordis`, `skills`, `mcp`
- **Why use it:** Manages tool/skill exposure strategies to reduce context usage
...
- **Why use it:** DSH plugin infrastructure: browser console + skill dev guide
...
- **Tags:** `knowledge-base`, `plugin-development`, `cordis`
- **Why use it:** Official DSH plugin dev docs archive as an installable agent skill
...
- **Tags:** `plugin-creator`, `coding-tools`, `cordis`
- **Why use it:** Reusable skill scaffold for building and validating DSH/Cordis plugins
...
- **Tags:** `agent-tools`, `capability`, `dsh-plugin`
- **Why use it:** Pre-flight plugin check for agents, boosting plugin library utilization predictably.
...
- **Why use it:** Modern desktop client for DSH ecosystem, desktop itself is a plugin.
...
- **Why use it:** Universal AI enhancement suite with prompt manager for multiple platforms
...
- **Why use it:** Animated pet mascot gallery for CLI coding tools.
...
- **Why use it:** Modern flexible task board embeddable in DSH and Codex.
...
- **Why use it:** TUI enhancement with live status, streaming thought, and context progress.
...
- **Why use it:** Official DSH desktop client with zero-setup installer and full feature set
...
- **Why use it:** Local-first DSH desktop workspace with projects, sessions, and Office integration
...
- **Why use it:** Interactive UI components rendered inline in DSH assistant replies via dsh-ui fence
...
- **Why use it:** Brings full Office suite into DSH for spreadsheets, docs and slides.
...
- **Tags:** `task-management`, `native`, `web-ui`
...
- **Why use it:** Native iOS client bringing DSH workspaces and agent execution to iPhone.
...
- **Why use it:** Web UI plugin for managing skills and MCP configurations visually.
...
- **Why use it:** Replaces composer stats bar with provider, balance and pricing info
...
- **Why use it:** Audit instruction chains and detect conflicts via Web UI ring panel
...
- **Why use it:** Interactive K-line analysis in native sidebar with multi-market support
...
- **Why use it:** Electron desktop wrapper integrating DSH web, sidebar and ModLens
...
- **Tags:** `dsh-plugin`, `ui`, `compact`
- **Why use it:** One-click toggle for compact context display in DSH panel.
...
- **Why use it:** Converts chat history into shareable knowledge cards with nice design.
...
- **Tags:** `multi-agent`, `dsh-plugin`, `memory`
- **Why use it:** Self-evolving multi-agent with memory, knowledge and skill support.
...
- **Tags:** `agent-memory`, `dsh-plugin`, `rag`
...
- **Why use it:** Turn documents into RAG, reasoning agent and self-maintaining wiki.
...
- **Why use it:** Portable, local-first memory layer enabling persistent agent memory across tools
...
- **Why use it:** Dedicated memory library for building stateful, self-aware AI agents
...
- **Why use it:** Memory management kit: remember and refine agent knowledge.
...
- **Why use it:** Deploy multi-agent swarms with autonomous workflow orchestration.
...
- **Tags:** `no-code`, `dsh-plugin`, `workflows`
- **Why use it:** AI-powered no-code platform for rapid business system and workflow building.
...
- **Why use it:** Specialized workflow solving AI forgetting and hallucination in long-form writing
...
- **Tags:** `agent-skills`, `dsh-plugin`
- **Why use it:** Comprehensive skill marketplace covering coding, content, automation and more
...
- **Why use it:** Local-first control plane for long-running multi-agent workflows.
...
- **Why use it:** Intelligent skill routing with +21pp reward on SkillsBench.
...
- **Why use it:** Enables multi-agent team coordination within the DeepSeek Harness
...
- **Tags:** `context`, `cordis-plugin`, `dsh-plugin`
- **Why use it:** Comprehensive context dashboard, browser sidebar and insight management
...
- **Tags:** `ai-writing`, `rag`, `novel`, `dsh-plugin`
- **Why use it:** Organized AI novel writing workflow with worldbuilding, drafting and editing
...
- **Tags:** `skills`, `memory`, `evaluation`
- **Why use it:** Curates SKILL.md files into retrieval-ready agent-skill corpora with evaluation
...
- **Why use it:** Novel/short-drama/game video workflow plugin with four dedicated workbenches built-in
...
- **Tags:** `agent-preset`, `epistemic-loop`, `dsh-plugin`
- **Why use it:** Brings Epistemic Loop methodology for scientific discovery workflows.
...
- **Why use it:** Gives agents multimodal vision and audio with verifiable timestamped results.
...
- **Tags:** `ai-agents`, `agent-skills`, `deepseek-harness`
- **Why use it:** Full-stack auto math modeling skill with GitOps pipeline and code verification
...
- **Tags:** `agent-review`, `plan-mode`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `dsh`, `coding`
- **Why use it:** Cross-platform framework to turn experience into repeatable agent skills
...
- **Tags:** `agent-skills`, `research-tools`, `dsh`
...
- **Tags:** `agent-skills`, `mcp`, `finance`
- **Why use it:** Local finance DB with multi-agent analysis and MCP/skill integration
...
- **Tags:** `agent-learning`, `skill-generator`, `run-to-skill`
...
- **Tags:** `skills`, `agent`
- **Why use it:** 25 pre-installed dev skills covering GitHub issues and Markdown workflows
...
- **Tags:** `skill`, `coding-agent`
- **Why use it:** AI coding mentor skill: scaffolds projects and guides hand-coding
...
- **Tags:** `docx`, `gongwen`
- **Why use it:** Full workflow GB/T 9704 compliant official document processor
...
- **Why use it:** Covers Bazi, Fengshui, IChing, TCM with deterministic local engine and dashboard
...
- **Tags:** `quality-gate`, `skill`, `engineering-discipline`
- **Why use it:** Engineering discipline guard: reviews requirements before shipping code
...
- **Why use it:** Comprehensive math modeling skill set: preprocessing, coding, writing, plotting
...
- **Tags:** `multi-agent`, `collaboration`, `mcp`
...
- **Why use it:** 11 QA skills with shared knowledge base and type-decision matrix for test automation
...
- **Why use it:** 5-role multi-agent math modeling with 33 models, paper templates and progress viz
...
- **Why use it:** Separates planning from execution for reliable AI-assisted task workflows
...
- **Why use it:** WorkBuddy-style skill picker in composer with slash command insertion
...
- **Tags:** `simplification`, `code-quality`
- **Why use it:** Adapted code simplification skill from DSH for Codex compatibility
...
- **Why use it:** Agent skill for building DSH plugins, works with Claude Code and Codex
...
- **Why use it:** CodeX-style plugin marketplace for DeepSeek Harness skills.
...
- **Why use it:** Manages task stages, verification, and engineering workflows effectively.
...
- **Tags:** `mcp`, `api-keys`, `secrets`, `dsh-plugin`
- **Why use it:** OpenRouter-style registry for agent tool API keys and credentials management
...
- **Why use it:** Strongest free web search bridge for any model without native web access, no signup
...
- **Tags:** `ocr`, `vision`, `mcp-tools`
- **Why use it:** Pixel-to-text OCR tools enabling vision capabilities for text-only LLMs
...
- **Why use it:** One-click MCP, Skills and rules config sync across 7+ AI agent tools
...
- **Tags:** `chatgpt`, `codex`, `oauth`, `ai-agents`
- **Why use it:** Integrates ChatGPT models into DSH via official OAuth binding.
...
- **Tags:** `image-generation`, `dsh-plugin`, `skills`
- **Why use it:** 530+ GPT Image prompts and 20 industrial templates for design work.
...
- **Why use it:** AI-generated design system with visual editor and PPT creation studio
...
- **Why use it:** Legal litigation visualization: timelines, case diagrams, relationships
...
- **Why use it:** Seamlessly let AI agents operate your real logged-in browser without disruption
...
- **Tags:** `content-discovery`, `social`, `agent`
- **Why use it:** Cross-platform self-evolving content discovery from 8+ social platforms.
...
- **Tags:** `browser`, `automation`, `fingerprint`
- **Why use it:** Persistent identity browser engine with fingerprint spoofing and Android emulation
...
- **Why use it:** Live iOS Simulator with 22 agent tools for device automation inside conversation.
...
- **Why use it:** Tabbit Browser plugin enabling Playwright-based browser automation.
...
- **Why use it:** Essential image uploader supporting 60+ hosting services and integrations.
...
- **Why use it:** Runtime injector with task-aware reasoning-mode router for optimal routing
...
- **Why use it:** Built-in plugin marketplace with one-click install for DSH.
...
- **Tags:** `routing`, `quota`, `utility`
- **Why use it:** Multi-model smart routing with quota tracking and auto failover.
...
- **Why use it:** Ecosystem radar discovering and validating 21k+ plugins via k8s runtime
...
- **Why use it:** Daily refreshed comprehensive plugin marketplace with pre-reviewed listings
...
- **Why use it:** CLI, schemas, and resolver for DSH Plugin Hub — essential infrastructure tool
...
- **Tags:** `security`, `audit`, `defense`
- **Why use it:** AI security platform: shields code from hallucinated packages and pattern errors
...
- **Tags:** `provider`, `command-code`, `llm-provider`
...
- **Why use it:** Secure P2P remote access for multi-device DSH operation
...
- **Why use it:** Audit skill calls and manage in-app skills efficiently
...
- **Tags:** `migration`, `sessions`, `dsh-plugin`
- **Why use it:** Import conversations from 25+ AI coding agents as resumable DSH sessions
...
- **Why use it:** Smartisan-style notes app with Docker deployment and WeChat MP export.
...
- **Why use it:** Migration wizard for Claude Code/Codex sessions and skills to DSH
...
- **Tags:** `doctor`, `diagnostics`, `conflict-resolution`
- **Why use it:** Diagnoses plugin conflicts and version incompatibilities in DSH
...
- **Tags:** `themes`, `skins`, `dsh-plugin`
- **Why use it:** Whale girl skin series to customize your DSH interface aesthetics
...
- **Tags:** `theme`, `glass`, `transparent`
- **Why use it:** Frosted glass transparent theme with full customization for DSH web interface
...
- **Why use it:** Stunning animated ocean theme with real-time wave effects and glassmorphism.
...
- **Why use it:** Personalize DSH Web background with custom images or preset themes.
...
- **Why use it:** One-stop research workbench: LaTeX, arXiv management, experiment tracking, GPU SSH
...
- **Why use it:** Daily auto-scraped curated DSH plugin list with real classifications and rankings.
...
- **Tags:** `awesome-list`, `curated`, `comprehensive`
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCPs, patches and UIs.
...
- **Tags:** `guide`, `awesome-list`, `chinese`
...
- **Tags:** `academic`, `mcp`, `citation-management`
- **Why use it:** Academic search across PubMed/arXiv/CrossRef with citation graphs and verification.
...
- **Tags:** `awesome-list`, `marketplace`, `dsh-plugin`
- **Why use it:** Massive 11,000+ plugin catalog with search, rankings and public API
...
- **Why use it:** Comprehensive agent-first handbook with runtime, MCP, sandbox references
...
- **Why use it:** Industry chain mapping and company research methodology with public-source tracking.
...
- **⭐ Stars:** 63
- **Language:** Python
- **Description:** 专利侵权分析系统 —— 输入��利公开号，产出竞品侵权分析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 调用。
- **Tags:** `patent`, `legal-tech`, `rag`
- **Why use it:** Patent infringement analysis: input patent number, get comparison report
...
- **Tags:** `resume-builder`, `dsh-plugin`, `self-hosted`
- **Why use it:** Privacy-focused open-source resume builder, self-hosted and free.
...
- **Tags:** `ai-guide`, `dsh-plugin`, `vibe-coding`
...
- **Why use it:** Curated directory of all DSH ecosystem plugins and resources
...
- **Tags:** `harness-engineering`, `dsh-plugin`
...
- **Why use it:** Curated bilingual list of all DSH plugins, extensions, tools, and verified references
...
- **Tags:** `wiki`, `resource`, `encyclopedia`
...
- **Tags:** `awesome`, `dsh-plugin`, `cordis`
...
- **Tags:** `awesome`, `agents`, `plugins`
- **Why use it:** Curated list of DSH plugins, tools, and productivity resources.
...
- **Why use it:** Specialized bioinformatics desktop app with offline mode and skill store
...
- **Tags:** `registry`, `plugins`, `skills`, `open-data`
...
- **Why use it:** Public GitHub directory for DSH plugin installation and discovery
...
- **Tags:** `awesome-list`, `dsh-plugin`, `curated`
- **Why use it:** Handy DSH plugin collection for general use
...
- **Why use it:** Evidence-led verified plugin directory with permission-aware installation
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** 1000+ DSH plugins ranked by stars, comprehensive ecosystem overview.
...
- **Why use it:** Plugin handbook with installation guide, permissions and risk info.
...
- **Tags:** `awesome-list`, `ai-curator`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `radar`, `dsh-plugin`
...
- **Tags:** `awesome-list`, `dsha-plugin`, `curated`
- **Why use it:** DSHA精选插件合集，官方背书的高质量插件集合。
...
- **Tags:** `portal`, `static-site`, `dsh-plugin`
...
- **Why use it:** In-agent plugin discoverability via npm + awesome list search.
...
- **Tags:** `dsh-plugins`, `plugin-verify`
- **Why use it:** DSH plugins repository with verification and analytics features.
...
- **Why use it:** Redirect repo pointing to the main awesome-dsh-plugin collection.

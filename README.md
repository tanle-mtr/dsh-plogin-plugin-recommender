...
|--------|-------|
| **Plugins tracked** | 191 |
| **Total community stars** | 840,811 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-23 21:27:34 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,782 | Core DSH platform for everything-is-a-plugin agent |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,725 | Open-source Figma alternative with AI-powered desi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,037 | Deploy multi-agent swarms with autonomous workflow |
...
- **Why use it:** Core DSH platform for everything-is-a-plugin agent ecosystem
...
- **Why use it:** Self-evolving multi-model AI assistant with memory and skills
...
- **Tags:** `agent`, `dsh-plugin`, `harness`, `harness-engineering`
- **Why use it:** Excellent beginner guide to build DSH plugins from scratch
...
- **Tags:** `agent-collaboration`, `agent-skills`, `multi-agent-workspace`, `visual-editor`
- **Why use it:** Enterprise multi-engine workspace with visual editor and agent collaboration
...
- **Why use it:** Two-phase bootstrap preset with Project2 98/99 standard tools
...
- **Why use it:** One-click model switch across major coding agents
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking, rollback
...
- **Why use it:** AI code review grounded in 12 classic engineering books with risk diagnostics
...
- **Why use it:** Architecture-aware coding with baseline-first and drift-checked safety
...
- **Tags:** `dsh-plugin`, `plugin-development`, `cli`
- **Why use it:** Build and manage DSH plugin slots and credentials
...
- **Tags:** `oauth`, `chatgpt`, `coding-agent`
...
- **Why use it:** CLI tool for discovering, installing, and managing DSH plugins with audit.
...
- **Why use it:** One-click publish tool for validating and distributing DSH skills/plugins.
...
- **Tags:** `cordis`, `dsh-web`, `dsh-web-ui`
- **Why use it:** Rich web GUI with tasks board, mobile SSH, and Wallpaper Engine skin
...
- **Tags:** `desktop`, `electron`, `companion`
- **Why use it:** Desktop companion with animated pets and rich plugin SDK
...
- **Why use it:** Local-first desktop workspace for sessions, files and office automation
...
- **Tags:** `desktop-app`, `tauri`, `multi-model`
...
- **Why use it:** Interactive UI components like charts and forms rendered inline
...
- **Tags:** `session-migration`, `context`, `preset`
- **Why use it:** Cross-preset session migration with preserved context.
...
- **Why use it:** Electron desktop console for multi-tab DSH management
...
- **Why use it:** WorkBuddy-style skill picker improves DSH composer UX.
...
- **Why use it:** Audits context tokens with a web UI ring panel for conflict detection.
...
- **Why use it:** Electron desktop app integrating DSH web service with plugins
...
- **Tags:** `agent-memory`, `memory-management`, `rag`, `skills`
- **Why use it:** Portable local-first memory layer with self-evolving RAG capability
...
- **Tags:** `long-term-memory`, `memory-management`, `rag`, `token-savings`
...
- **Why use it:** Best context dashboard and management plugin with statistics insights
...
- **Why use it:** Comprehensive AI knowledge base covering models, agents, RAG, and MLOps
...
- **Tags:** `skill-corpus`, `embedding`, `retrieval`
- **Why use it:** Curate and retrieve SKILL.md files with semantic search.
...
- **Why use it:** Connects to PowerContext for persistent memory, recall, and handoff.
...
- **Tags:** `skill-generator`, `knowledge-distillation`
...
- **Tags:** `agent-orchestration`, `agent-skills`, `agent-workspaces`, `mcp`
- **Why use it:** Unified agent workspace across all devices with task board tracking
...
- **Why use it:** Task-aware reasoning-mode router — optimizes agent reasoning paths
...
- **Tags:** `agent-os`, `agentic-ai`, `loop-engineering`, `mcp`
- **Why use it:** Self-improving agent OS with loop engineering and grading system
...
- **Why use it:** AI cognitive enhancement based on J-space research
...
- **Why use it:** Native DSH vision toolkit with free image recognition and OCR
...
- **Why use it:** Free web search bridge plugin for models without native web access
...
- **Why use it:** Reusable experience-to-execution framework for AI agents
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot analysis
...
- **Why use it:** Creative writing and short-drama production assistant powered by Oh Story
...
- **Why use it:** Native SQLite taskboard with agent claim and review.
...
- **Why use it:** 85 SKILL.md reverse engineering and pentesting skill
...
- **Why use it:** AI coding mentor with scaffolded chapters and code review
...
- **Why use it:** 88 open-source skills for research, marketing, business
...
- **Tags:** `spec-programming`, `vibe-coding`, `agent-skills`
- **Why use it:** Portable spec-driven development skill for DSH patterns
...
- **Tags:** `codex`, `code-simplification`, `skill`
- **Why use it:** Adapts DSH code simplification patterns to Codex workflows.
...
- **Why use it:** Unique fusion of Bazi, Fengshui, IChing into a local deterministic engine.
...
- **Why use it:** Comprehensive agent asset package with 42 skills and useful CLIs.
...
- **Why use it:** Portable skill for developing and auditing DSH plugins efficiently.
...
- **Tags:** `documentation`, `dsh-plugin`
- **Why use it:** Practical DSH plugin dev docs and tested solutions archive.
...
- **Why use it:** Full workflow Chinese official document generation and formatting tool.
...
- **Why use it:** Engineering discipline skill distilled from DSH experience.
...
- **Why use it:** Dedicated Godot 4.x skill for game dev workflows in DSH.
...
- **Why use it:** Record macOS desktop actions and convert to reusable agent skills.
...
- **Why use it:** Math modeling kit with 17 skill cards and preset configs for DSH.
...
- **Why use it:** Virtual product team preset for guided AI conversation workflows
...
- **Tags:** `agent-tools`, `workflow`, `utility`
- **Why use it:** Pre-flight plugin check for DSH agents to boost utilization
...
- **Why use it:** First vision plugin — turns text-only agents into multimodal with OCR JSON
...
- **Tags:** `mcp`, `skills`, `manager`, `gui`
- **Why use it:** Manage skills and MCP servers directly in DSH web GUI settings.
...
- **Why use it:** Hot-reload MCP server config + skill management directly in settings.
...
- **Why use it:** Multi-source deduped plugin registry for unified DSH discovery.
...
- **Tags:** `diagram-as-code`, `architecture`
...
- **Tags:** `ai-image-generation`, `image-prompts`, `skills`, `workflow-automation`
- **Why use it:** 470+ GPT-Image2 prompt templates with industrial-grade quality
...
- **Tags:** `agent-team`, `fimga`, `ui`, `vibecoding`, `vibedesign`
...
- **Why use it:** Generate images directly inside DeepSeek Harness chat conversations
...
- **Why use it:** Edit and preview OpenPencil designs directly in chat.
...
- **Tags:** `visualization`, `diagram`, `legal`
- **Why use it:** Generate litigation SVG diagrams and timelines from cases
...
- **Why use it:** Community group photo wall with GitHub OAuth and whitelist validation.
...
- **Why use it:** First unified virtual filesystem — sandbox-safe file operations for agents
...
- **Tags:** `marketplace`, `dsh-plugin`, `plugin-registry`
- **Why use it:** Built-in plugin marketplace for browsing, search, and one-click install
...
- **Why use it:** Plugin radar with 9000+ candidates, runtime-tested top 50 curated list
...
- **Tags:** `cost`, `billing`, `token-tracking`
- **Why use it:** Track session and daily costs with budget alerts and token history
...
- **Tags:** `backup`, `undo`, `snapshot`, `crash-recovery`
- **Why use it:** Crash rescue with undo, snapshots and SAFE MODE.
...
- **Tags:** `marketplace`, `web-ui`, `community`
- **Why use it:** Community plugin market in DSH web GUI interface.
...
- **Why use it:** Plugin management console with official dev guidance
...
- **Tags:** `dsh-plugins`, `desktop-app`, `utilities`
...
- **Why use it:** Complete DSH config backup, import, migrate and sync via WebDAV.
...
- **Why use it:** Built-in GUI plugin/MCP manager with hot-reload, no restart needed.
...
- **Why use it:** Evidence-led bilingual DSH plugin directory for discovery.
...
- **Tags:** `awesome-list`
- **Why use it:** Curated evidence-aware shortlist of DSH plugins.
...
- **Why use it:** Auto-generated bilingual DSH plugin directory via GitHub Actions.
...
- **Tags:** `registry`, `plugin-directory`
- **Why use it:** Broad curated DSH plugin registry covering models, UI, and agent loops.
...
- **Why use it:** Official auto-generated list of DSH Cordis plugins by cordis.run.
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Comprehensive 1000+ DSH tool catalog sorted by GitHub stars.
...
- **⭐ Stars:** 371
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调��。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glass-effect`
- **Why use it:** Fully customizable frosted glass theme with high freedom of adjustment
...
- **Why use it:** Beautiful WebGPU ocean-themed visual skin for DSH interface
...
- **Tags:** `theme`, `skins`, `ui`
- **Why use it:** 34 opencode themes one-click swap for DSH, per-session persistence.
...
- **Why use it:** Customizable DSH web background with presets, live preview, and auto-save.
...
- **Why use it:** Comprehensive AI resources library and vibe coding tutorials
...
- **Why use it:** Searches top 8 Chinese platforms for 30-day content and generates research reports
...
- **Why use it:** Plugin marketplace with 3100+ plugins and free public API
...
- **Why use it:** Public plugin directory for ecosystem discovery and installation.
...
- **Why use it:** Curated list of DSH plugins for easy ecosystem browsing.
...
- **Tags:** `industry`, `plugin-directory`
- **Why use it:** Industry-focused plugin catalog across computing, finance, law, and more.
...
- **Tags:** `resume-builder`, `self-hosted`
...
- **Tags:** `no-code`, `internal-tools`, `crm`
...
- **Why use it:** Curated community list — essential starting point for DSH exploration
...
- **Tags:** `toy`, `dsh-plugin`
- **Why use it:** Web simulation of a traditional Chinese toy with real audio
...
- **Tags:** `awesome-list`, `directory`, `hub`
...
- **Tags:** `awesome-list`, `plugin-finder`, `verified`
- **Why use it:** Daily auto-scraped plugin directory with human verification and filtering
...
- **Tags:** `learning`, `documentation`, `best-practices`
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins and developer tools
...
- **Why use it:** DeepSeek Harness plugin collection and marketplace hub
...
- **Tags:** `awesome-list`, `resources`
- **Why use it:** Meticulously curated DSH plugin ecosystem list.
...
- **Why use it:** Curated plugin catalog auto-synced every 4 hours
...
- **Why use it:** Auto-generated official plugin catalog by cordis.run
...
- **Why use it:** Plugin handbook with scenario-based selection guide
...
- **Tags:** `awesome-list`, `plugin-radar`, `research`
...
- **Tags:** `web-portal`, `plugin-directory`, `static-site`
- **Why use it:** Static web portal for browsing and filtering 227+ DSH plugins
...
- **Why use it:** Archived; moved to awesome-dsh-plugin repository
...
- **Tags:** `plugin-repository`, `verification`, `ecosystem`
- **Why use it:** General DSH plugin repository and verification platform

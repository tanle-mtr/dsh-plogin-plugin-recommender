...
|--------|-------|
| **Plugins tracked** | 198 |
| **Total community stars** | 1,039,213 ⭐ |
| **Categories** | 12 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 226,649 | Core DSH framework with plugin ecosystem for AI ag |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,585 | Open-source design plugin for AI coding agents. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,637 | Multi-agent swarm framework with MCP server suppor |
...
- **Why use it:** Core DSH framework with plugin ecosystem for AI agents.
...
- **Why use it:** Super AI assistant with multi-agent and self-evolving memory.
...
- **Tags:** `dsh-plugin`, `routing`, `cordis`
...
- **Why use it:** Self-evolving agent OS with interview-gated evaluation and budgeted loops.
...
- **Why use it:** First vision plugin enabling text-only agents to process images via OCR JSON
...
- **Why use it:** World's first virtual terminal with VFS for isolated AI agent execution
...
- **Tags:** `model-switch`, `multi-agent`, `installer`
- **Why use it:** One-click model switch and install across Claude Code, Codex, DeepSeek and more
...
- **Why use it:** CLI and agent tools for managing DSH Plugin Hub efficiently
...
- **Why use it:** Live iOS Simulator and USB device automation with 22 agent tools built in
...
- **Why use it:** Find, install and verify DSH plugins automatically via Skill.
...
- **Why use it:** Superpowers skill port for Reasonix coding harness platform
...
- **Why use it:** Engineering discipline guard — grill requirements, test implementation
...
- **Why use it:** Audit context token costs, detect AGENTS.md conflicts via web UI
...
- **Why use it:** OAuth-based ChatGPT binding to use subscribed models inside DSH
...
- **Why use it:** Modern flexible task board plugin embedding into Codex and DSH interfaces
...
- **Why use it:** Claude Code-style TUI with whale bar, streaming thought, and rollback support
...
- **Why use it:** Open-source Windows GUI client with SSH, plugins, skills and remote access.
...
- **Tags:** `canvas`, `visualization`, `workspace`
...
- **Tags:** `desktop-app`, `privacy`, `agent`
...
- **Why use it:** Brings spreadsheets docs slides and canvases into the Harness environment
...
- **Tags:** `mobile`, `ios`, `kotlin-multiplatform`
- **Why use it:** Native iOS client with workspace sessions and agent execution tracking
...
- **Why use it:** Smartisan-style notes app with Docker deployment and DSH support.
...
- **Why use it:** Community plugin market browser with one-click install in web GUI
...
- **Tags:** `desktop-app`, `ui`, `dsh-plugin`
- **Why use it:** Electron desktop console for multi-tab management of plugins, MCPs, and skills.
...
- **Why use it:** Bioinformatics desktop agent with Tauri, offline mode, skill store
...
- **Why use it:** Shows provider, model, balance, pricing and usage tracking at a glance
...
- **Tags:** `workbench`, `web`, `plugin-system`
...
- **Why use it:** Electron desktop shell integrating multiple DSH components
...
- **Why use it:** Transforms chat history into shareable downloadable knowledge cards
...
- **Why use it:** LLM knowledge platform with RAG, search, and wiki capabilities.
...
- **Tags:** `agent-memory`, `context-engineering`, `mcp`
- **Why use it:** Memory library for building stateful agents with context engineering.
...
- **Tags:** `memory`, `rag`, `milvus`, `search`
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus for all agents
...
- **Tags:** `skill-corpus`, `embeddings`, `vector-search`
...
- **Why use it:** Three-layer auto-consolidating memory injected before model responses.
...
- **Why use it:** Multi-agent swarm framework with MCP server support.
...
- **Tags:** `agent-orchestration`, `mcp`, `workflow`
- **Why use it:** Unified agent workspace with task boards, accessible everywhere.
...
- **Why use it:** Most comprehensive skills marketplace with auto-curation and categories.
...
- **Tags:** `cognition`, `reasoning`, `verification`
...
- **Why use it:** Gives agents eyes and ears — video, audio, screen analysis with timestamped proof.
...
- **Why use it:** Integrated workflows for novel, short-drama, game and video script writing
...
- **Why use it:** Native SQLite-backed taskboard with agent claim and review features
...
- **Tags:** `deepseek-harness`, `agent-review`
- **Why use it:** Enable agent self-evolution with composable review modes.
...
- **Why use it:** Turn AI experience into repeatable cross-platform execution.
...
- **Why use it:** Add multimodal vision capability to text-only LLM agents.
...
- **Why use it:** 87 reverse engineering SKILL.md files for CTF and security research
...
- **Tags:** `agent-plugins`, `agent-skills`, `mcp`
...
- **Why use it:** 25 ready-to-use engineering skills in sidebar panel, zero manual setup needed.
...
- **Why use it:** Full Chinese official document processing: format check, templates, style enhancement.
...
- **Tags:** `agent-skills`, `spec-driven`, `dsh-plugin`
...
- **Tags:** `ai-agent`, `chinese-traditional-wisdom`, `fengshui`, `tcm`
- **Why use it:** Covers Bazi, IChing, Fengshui, TCM — one-line install with local engine
...
- **Why use it:** Multi-agent collaboration with shared workspace, independent models
...
- **Why use it:** 11 QA skills with shared knowledge base for AI-assisted testing
...
- **Why use it:** Codex skill for automated code simplification from DSH community
...
- **Why use it:** WorkBuddy-style skill picker with /skill-name gesture insertion
...
- **Why use it:** Search npm + curated list from inside DSH agents for discoverability
...
- **Why use it:** Pre-flight check injects top-K relevant plugin hints for agents
...
- **Why use it:** Free web search bridge plugin — no signup, no API, works with all models.
...
- **Why use it:** Unified menu to manage MCP tools and skills exposure/execution modes
...
- **Why use it:** Pixel-to-text image OCR tools for text-only models via vision skill
...
- **Why use it:** One-click MCP/skill/config sync for Claude Code, Cursor, DSH and more
...
- **Tags:** `ai-design`, `ui-generator`, `figma-alternative`
- **Why use it:** Open-source design plugin for AI coding agents.
...
- **Why use it:** Generate beautiful architecture and workflow diagrams via code.
...
- **Why use it:** Generates inline UI components — charts, forms, quizzes rendered via dsh-ui.
...
- **⭐ Stars:** 56
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，直接读案件材料画准一张时间轴，并提供庭前三大法宝（大事记表、庭审对抗图、法律关系图）。Claude Skill / DeepSeek Harness ���用。
- **Tags:** `visualization`, `legal`, `agent-skills`
- **Why use it:** Legal visualization toolkit: timelines, case diagrams, and trial strategy maps.
...
- **Why use it:** Self-evolving cross-platform content agent covering Bilibili, YouTube, Reddit and more
...
- **Why use it:** Free Xiaomi MiMo TTS API with custom voices
...
- **Why use it:** Essential plugin marketplace for DSH ecosystem discovery and installation
...
- **Why use it:** Track session daily costs and token usage across multiple LLM providers
...
- **Why use it:** Backup, restore, migrate and sync complete DSH configuration
...
- **Why use it:** Infrastructure for plugin ecosystem with browser console and dev scaffolding.
...
- **Why use it:** Centralized safe loading and management of local Agent Skills in DSH.
...
- **Why use it:** Official plugin dev knowledge base installed as on-demand agent skill.
...
- **Tags:** `container`, `management`, `multi-version`
...
- **Tags:** `awesome-list`, `curation`, `directory`
- **Why use it:** Auto-updating curated plugin directory for DSH ecosystem
...
- **Tags:** `awesome-list`, `bilingual`, `curation`
...
- **Why use it:** Simple DSH plugin listing for quick reference
...
- **Why use it:** Public animated pet gallery adding personality to your agent interface.
...
- **⭐ Stars:** 404
- **Language:** JavaScript
- **Description:** 是一层高自由���的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `glassmorphism`, `customization`
- **Why use it:** Glassmorphism theme with full customization — blur,磨砂, background controls.
...
- **Why use it:** Web background customization with preset themes
...
- **Why use it:** Curated plugin directory for discovering DSH ecosystem resources.
...
- **Why use it:** Generate accurate technical docs and AI-ready context from codebases fast
...
- **Why use it:** All-in-one academic research workbench: LaTeX, arXiv, GPU SSH, experiment tracking.
...
- **Why use it:** AI-native stock analysis with multi-agent and IM notifications.
...
- **Tags:** `api-documentation`, `dsh-plugin`, `ai-agents`
...
- **Tags:** `patent`, `rag`, `multi-agent`
- **Why use it:** Patent infringement analysis system with skill packaging for any agent.
...
- **Why use it:** Verified stock/finance/quant plugins list
...
- **Why use it:** Curated star-ranked community plugin directory for DSH discovery
...
- **Why use it:** Auto-crawled bilingual plugin directory updated via GitHub Actions
...
- **Tags:** `awesome-list`, `plugin-verify`
- **Why use it:** DSH plugins repository with bundle and verification tools
...
- **Why use it:** Redirect to primary awesome-dsh-plugin repository
...
- **Why use it:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘
...
- **Why use it:** DeepSeek Harness Tauri 桌面版 | Only 5mb in
...
- **Why use it:** Turn one topic into a finished Vox-style
...
- **Why use it:** 🍙  A personal AI agent & local memory h
...
- **Why use it:** last30days-cn 是一个 AI Agent 技能（Skill），能够自
...
- **Why use it:** AgentTeams plugin for DeepSeek Harness
...
- **⭐ Stars:** 1,471
- **Language:** Python
- **Description:** DSH Plugin Radar — open-source ecosystem radar for DeepSeek Harness plugins: continuous discovery (21k+ candidates), k8s runtime validation (13k+ tests), 15-min snapshots; the catalog is a generated artifact — 开源 DSH 插件生态雷达：持续发现 2.1 万+ 候选、k8s 运行级实测 1.3 万+、15 分钟快照；插件���录为自动生成的产物
- **Tags:** `agent-plugins`, `continuous-validation`, `deepseek-harness`, `dsh`, `dsh-plugin`, `ecosystem-radar`, `plugin-registry`
- **Why use it:** DSH Plugin Radar — open-source ecosystem
...
- **Why use it:** The best DeepSeek Harness plugin for con
...
- **Why use it:** DeepSeek Harness (DSH) ecosystem: curate
...
- **⭐ Stars:** 919
- **Language:** TypeScript
- **Description:** AI 小说创作软件：把灵感、角色、世界观、大���、章节写作、审稿和修稿组织成可控流程；提供 Windows/macOS 桌面版，支持本地和在线模型。AI Novel Writing Software: Organizes inspirations, characters, worldbuilding, outlines, chapter drafting, review, and revision into a controllable workflow. Features desktop apps for Windows/macOS, Ollama integration, and a DeepSeek Harness (DSH) plugin preview.
...
- **Why use it:** AI 小说创作软件：把灵感、角色、世界观、大���、章节写作、审稿和修稿组织成可
...
- **Why use it:** [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多
...
- **Tags:** `marketplace`, `plugin-curation`
- **Why use it:** Daily refreshed comprehensive plugin marketplace with review process.
...
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, multimodal, and more.
...
- **Why use it:** Curated plugin discovery platform with daily GitHub scraping and filtering
...
- **Tags:** `awesome-list`, `resources`, `coding-agent`
- **Why use it:** Comprehensive curated list of plugins skills MCP servers and patches
...
- **Why use it:** Ultimate DSH guide with quick start resources curated plugins and tools
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Comprehensive DSH learning resource and plugin marketplace guide.
...
- **Tags:** `deepseek-harness-plugins`, `marketplace`
...
- **Why use it:** Authoritative handbook covering runtime, plugins, MCP and more.
...
- **Tags:** `deepseek-harness-plugins`, `catalog`
- **Why use it:** Largest DSH plugin catalog with 1,958 repos and smart filtering.
...
- **Why use it:** Meticulously curated list of DSH plugins and development resources
...
- **Why use it:** Give DeepSeek Harness a persistent agent team: durable Member identities with pr
...
- **Why use it:** Curated plugin registry with spam filtering
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Public directory for plugin discovery and install commands
...
- **Why use it:** Evidence-led directory with permission-aware installation
...
- **Why use it:** Complete DSH tools inventory sorted by stars
...
- **Why use it:** DSH plugin marketplace similar to CodeX for plugin distribution

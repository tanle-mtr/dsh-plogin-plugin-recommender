...
**Last updated:** 2026-08-22 23:25:54 UTC  
...
- **Recommendation:** Core DSH ecosystem — everything is a plugin foundation
...
- **Tags:** `ai-agent`, `multi-agent`, `mcp`
- **Recommendation:** Super AI assistant with self-evolving memory and skills
...
- **Recommendation:** Beginner tutorial for DSH engineering, 0 to 1
...
- **Tags:** `preset`, `harness-tools`
- **Recommendation:** Bootstrap + Standard tools preset for DSH
...
- **Tags:** `claude-code`, `deepseek-harness`, `model-switch`
- **Recommendation:** Unified model switch across major coding agents
...
- **Tags:** `code-review`, `lint`, `clean-architecture`
- **Recommendation:** AI code review citing 12 classic engineering books
...
- **Tags:** `architecture`, `coding-agents`, `dsh-plugin`
- **Recommendation:** Architecture-aware coding agent plugin
...
- **Tags:** `swift`, `macos`, `coding-agent`
- **Recommendation:** Native macOS Swift coding agent by DeepSeek
...
- **Tags:** `coding`, `agent`
- **Recommendation:** Teams multiple coding agents across sessions
...
- **Tags:** `orchestration`, `subagent`, `multimodal`
...
- **Tags:** `plugin-dev`, `tools`, `skills`
- **Recommendation:** Build DSH plugins following official standards and patterns
...
- **Tags:** `documentation`, `plugin-dev`, `guide`
- **Recommendation:** Complete DSH plugin dev knowledge base with official docs archive
...
- **Tags:** `codex`, `sync`, `import`
- **Recommendation:** One-tap Codex import with two-way sync
...
- **Recommendation:** Practical DSH dev pitfalls & solutions
...
- **Recommendation:** GUI plugin manager for DSH with hot-reload
...
- **Tags:** `agent-tools`, `pre-flight`
- **Recommendation:** Pre-flight plugin check for task-type agent requests
...
- **Recommendation:** OAuth integration to use ChatGPT models in DSH
...
- **Tags:** `ui`, `web-ui`, `desktop`
- **Recommendation:** Web UI with task board, git graph, live stats
...
- **Tags:** `sidebar`, `ui-extension`, `desktop`
- **Recommendation:** Extensible sidebar with files/terminal/chat
...
- **Recommendation:** Claude Code-style TUI with whale theme
...
- **Tags:** `desktop-app`, `agent-runtime`, `rust`
- **Recommendation:** Rust agent runtime with polished desktop app
...
- **Recommendation:** Lightweight Tauri desktop client for DSH
...
- **Tags:** `widget`, `ui`, `macos`
- **Recommendation:** Cute floating whale widget tracking balance
...
- **Tags:** `desktop`, `client`
- **Recommendation:** CodePilot-style desktop client for DSH
...
- **Tags:** `desktop-app`, `gui`, `electron`
- **Recommendation:** Full-featured desktop GUI for DSH.
...
- **Tags:** `conversation`, `workspace`, `plugin`
- **Recommendation:** Canvas-based branching workspace.
...
- **Recommendation:** Smartisan-style notes with export.
...
- **Tags:** `marketplace`, `plugin-management`, `web-gui`
- **Recommendation:** One-click plugin browsing and installation in DSH web GUI.
...
- **Tags:** `marketplace`, `web-gui`, `plugin-market`
- **Recommendation:** Community plugin market integrated into DSH web GUI.
...
- **Recommendation:** Manage skills and MCP tools from the DSH web panel.
...
- **Recommendation:** Browser-based plugin registry console with zero-patch integration
...
- **Recommendation:** Full Electron desktop console for managing Harness/plugins/MCPs
...
- **Recommendation:** Shows provider, balance, pricing info
...
- **Tags:** `cost`, `visualization`, `api`
- **Recommendation:** Token usage charts and cost estimates dashboard
...
- **Tags:** `hud`, `status-panel`, `ui`
- **Recommendation:** Floating HUD panel with git, MCP, skills status
...
- **Recommendation:** All-in-one desktop: DB, SSH, Docker + AI assistant
...
- **Recommendation:** Electron desktop app integrating DSH web UI
...
- **Tags:** `marketplace`, `ui`, `plugin-browser`
- **Recommendation:** Interactive plugin marketplace UI with search
...
- **Recommendation:** LLM knowledge platform with RAG and semantic search
...
- **Recommendation:** Local-first portable memory for every AI agent
...
- **Recommendation:** Unlimited memory storage for agents
...
- **Tags:** `context`, `insight`, `dashboard`
- **Recommendation:** Context insight dashboard and management
...
- **Tags:** `knowledge`, `rag`
- **Recommendation:** AI knowledge base covering skills, RAG, MLOps
...
- **Tags:** `long-term-memory`, `memory`, `noema`
...
- **Recommendation:** Preserve session continuity and objectives across agent handoffs
...
- **Recommendation:** Memory, recall & handoff via server
...
- **Tags:** `agentic-workflow`, `multi-agent`, `skills`
- **Recommendation:** Multi-agent swarm orchestration and workflow engine
...
- **Recommendation:** Digital persona skill for warm conversational AI
...
- **Tags:** `agent-orchestration`, `multi-device`
- **Recommendation:** Unified agent orchestration across all devices
...
- **Tags:** `routing`, `agent-orchestration`
- **Recommendation:** Task-aware reasoning-mode router with injector
...
- **Tags:** `agent-os`, `loop-engineering`
...
- **Recommendation:** Enterprise agent workbench for multi-agent teams
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `global-workspace`
- **Recommendation:** J-space global workspace cognitive skills
...
- **Tags:** `workflow-automation`, `vibe-coding`, `multi-agent`
- **Recommendation:** Intelligent workflow orchestration skill
...
- **Tags:** `video-generation`, `vox`, `automation`
- **Recommendation:** End-to-end Vox-style video generation skill
...
- **Tags:** `vision`, `skill`, `multimodal`
- **Recommendation:** Vision toolkit for text-only LLMs with image Q&A
...
- **Tags:** `task-manager`, `workflow`, `self-hosted`
...
- **Tags:** `vision`, `ocr`, `ui-restoration`
- **Recommendation:** Native DSH vision toolkit for text-only models
...
- **Tags:** `agent`, `skills`, `dsh`
- **Recommendation:** Reusable skills for AI agents.
...
- **Recommendation:** Adds multimodal vision to coding agents.
...
- **Recommendation:** Finds, installs, verifies plugins.
...
- **Recommendation:** Skills for AI infrastructure dev.
...
- **Tags:** `creative-writing`, `novel-writing`, `oh-story`
- **Recommendation:** Novel and short-drama writing workflow powered by Oh Story.
...
- **Tags:** `agent-skills`, `skill-corpus`, `semantic-search`
- **Recommendation:** Turns SKILL.md files into retrieval-ready skill corpora.
...
- **Recommendation:** Superpowers skill port for the Reasonix harness.
...
- **Tags:** `superpowers`, `tdd`, `skills`
- **Recommendation:** TDD, debugging, and planning skills for DSH agents.
...
- **Recommendation:** Full reverse-engineering/pentest skill suite for security research
...
- **⭐ Stars:** 65
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手���核心逻辑、自动判题、AI Code Review。
- **Tags:** `coding`, `mentor`, `skill`
- **Recommendation:** Transforms AI into a coding mentor with guided chapters and review
...
- **Recommendation:** 88 open-source skills for research, marketing, and social intel
...
- **Tags:** `spec-driven`, `development`, `skill`
- **Recommendation:** Native spec-driven development skill for structured coding
...
- **Recommendation:** WorkBuddy-style skill picker in composer
...
- **Tags:** `coding-skill`, `code-simplification`
- **Recommendation:** Adapted Codex skill for code simplification
...
- **Recommendation:** Chinese metaphysics AI agent skill pack with dashboard
...
- **Tags:** `skills`, `manager`
- **Recommendation:** Manage DSH skills via web GUI
...
- **Recommendation:** Multi-agent team with shared workspace
...
- **Tags:** `skills`, `mcp`, `manager`
- **Recommendation:** Manage skills and MCP servers from web UI
...
- **Recommendation:** Swift Cycle governance skill adapter
...
- **Tags:** `package-manager`, `skills`, `clis`
- **Recommendation:** Package manager with 42 skills and 5 CLIs
...
- **Tags:** `agent-skills`, `cordis`, `plugin-development`
- **Recommendation:** Plugin dev & audit agent skill bundle
...
- **Recommendation:** Engineering discipline for DSH workflows
...
- **Tags:** `agent-skills`, `canvas`, `mcp`
- **Recommendation:** Infinite canvas with creative skills
...
- **Recommendation:** Scaffold & test DSH plugins as skills
...
- **Recommendation:** Record macOS desktop → agent skills
...
- **Tags:** `ai-docs`, `docx`, `wps-office`
- **Recommendation:** Chinese official document processing
...
- **Tags:** `math`, `skills`, `preset`
- **Recommendation:** Math modeling preset + 17 skill cards for DSH
...
- **Tags:** `godot`, `game-dev`, `skill`
- **Recommendation:** Godot 4.x game dev skill for DSH
...
- **Tags:** `agent`, `product-management`, `preset`
- **Recommendation:** Virtual product team agent preset for DSH
...
- **Tags:** `vision`, `mcp`, `ocr`
- **Recommendation:** First vision plugin for text-only coding agents
...
- **Tags:** `mcp`, `hot-reload`, `skills`
- **Recommendation:** Hot-reload MCP config and skill management from UI
...
- **Recommendation:** Open-source design system generator and UI prototyper
...
- **Tags:** `diagram-as-code`, `mermaid-alternative`, `architecture`
- **Recommendation:** Diagram-as-code agent skill for architecture visualization
...
- **Tags:** `gpt-image-2`, `prompt-engineering`
- **Recommendation:** 470+ prompt templates and 20+ industrial image engines
...
- **Tags:** `design`, `vector`, `ui`
- **Recommendation:** Open-source vector design tool with Agent Teams
...
- **Tags:** `design`, `visual`
- **Recommendation:** AI design studio with templates and PPT support
...
- **Tags:** `ui`, `components`
- **Recommendation:** Inline UI components, charts, forms in chat
...
- **Recommendation:** Edit OpenPencil documents in chat.
...
- **Recommendation:** Generate AI images directly inside DSH chats.
...
- **Recommendation:** Generate professional litigation timelines and legal diagrams in SVG
...
- **Recommendation:** Free image reading and generation via vision models
...
- **Tags:** `design`, `ui`, `web-design`
- **Recommendation:** 6 design styles to avoid generic AI look
...
- **Recommendation:** AI video/image/audio generation skills
...
- **Recommendation:** Enhancement suite for Gemini, Claude, ChatGPT browsers
...
- **Tags:** `bilibili`, `content-discovery`, `self-hosted`
- **Recommendation:** Cross-platform AI content discovery agent
...
- **Recommendation:** Login-preserving browser automation for agents
...
- **Recommendation:** Browser extension for organized AI workflows
...
- **Recommendation:** Live iOS Simulator and USB automation in-chat
...
- **Recommendation:** Playwright-based browser automation for DSH.
...
- **Tags:** `photo`, `social`, `event`
- **Recommendation:** OAuth-powered group photo wall for events
...
- **Recommendation:** Privacy-first resume builder with MCP server support
...
- **Tags:** `image`, `electron-app`, `uploader`
...
- **Recommendation:** AI-powered no-code platform for fast business systems
...
- **Tags:** `vfs`, `utility`, `sandbox`
- **Recommendation:** Unified virtual filesystem for AI agents
...
- **Tags:** `marketplace`, `plugin-discovery`, `infrastructure`
- **Recommendation:** Built-in plugin marketplace for DSH
...
- **Recommendation:** Plugin radar with 9000+ indexed candidates
...
- **Tags:** `utility`, `oauth`
- **Recommendation:** Use ChatGPT/Claude/Grok subs as DSH providers
...
- **Tags:** `plugin-marketplace`, `harness-ai`
- **Recommendation:** Plugin marketplace hub.
...
- **Tags:** `awesome-list`, `marketplace`, `registry`
- **Recommendation:** Large plugin catalog with API.
...
- **Tags:** `anime-search`, `bangumi`, `torrent`
- **Recommendation:** Anime search with ratings.
...
- **Tags:** `cost-tracking`, `token-usage`
- **Recommendation:** Tracks session and daily costs.
...
- **Recommendation:** Bridges Pi and DSH ecosystems.
...
- **Recommendation:** Crash rescue with undo and snapshot rollback.
...
- **Recommendation:** OCR and pixel-to-text tools for vision-capable text-only models
...
- **Tags:** `plugin`, `build`, `utility`
- **Recommendation:** Manage plugin slots, Typert remotes, and credentials easily
...
- **Tags:** `desktop`, `management`, `containers`
- **Recommendation:** Isolated multi-version DSH containers with embedded WebView UI
...
- **Recommendation:** Audits context token costs and detects conflicts
...
- **Recommendation:** Backup/restore DSH config & plugins
...
- **Tags:** `claude-code`, `bridge`, `memory`
...
- **Tags:** `claude-code`, `compatibility`, `bridge`
- **Recommendation:** Native Claude Code .claude/ compat for DSH
...
- **Tags:** `utilities`, `plugin-health`
- **Recommendation:** Detects and resolves plugin conflicts automatically
...
- **Tags:** `plugin-manager`, `registry`, `discovery`
- **Recommendation:** Unified deduped plugin discovery registry
...
- **Tags:** `cli`, `plugin-manager`, `utilities`
- **Recommendation:** CLI plugin manager with multi-source search
...
- **Tags:** `publisher`, `plugin-dev`, `utilities`
- **Recommendation:** One-click plugin publish with validation
...
- **Tags:** `mascot`, `theme`, `pixel-art`
- **Recommendation:** Animated pet gallery for coding agents
...
- **Recommendation:** Cute whale girl skin series for DSH
...
- **Tags:** `theme`, `ui`
- **Recommendation:** Frosted glass UI theme, fully customizable
...
- **Tags:** `theme`, `visual`
- **Recommendation:** WebGPU animated ocean theme for DSH
...
- **Tags:** `theme`, `skins`, `dark-mode`
- **Recommendation:** 34 opencode themes for DSH UI
...
- **Recommendation:** Custom backgrounds and visual themes for DSH
...
- **Tags:** `ai-guide`, `rag`, `vibe-coding`
- **Recommendation:** Comprehensive AI resources and prompt engineering guide
...
- **Tags:** `research`, `chinese-web`, `analysis`
- **Recommendation:** Auto-researches CN platforms for 30-day reports
...
- **Recommendation:** Free web search bridge for all DSH models
...
- **Recommendation:** Searches 65K+ Chinese platform API docs across 20+ open platforms
...
- **Recommendation:** Interactive K-line analysis with multi-market support
...
- **Recommendation:** Curated stock/finance/quant DSH plugins
...
- **Recommendation:** Curated 2026 plugin list with quality checks
...
- **Recommendation:** Plugin guide: scenario-based selection & risks
...
- **Recommendation:** Evidence-backed plugin radar with lab support
...
- **Tags:** `web`, `plugin-portal`, `static-site`
- **Recommendation:** Static portal for browsing 227+ curated plugins
...
- **Tags:** `awesome-list`, `archived`
- **Recommendation:** Moved; legacy awesome list archive
...
- **Recommendation:** Star-ranked verified community plugin list
...
- **Recommendation:** Bilingual evidence-led reviewed plugin directory
...
- **Recommendation:** Auto-crawled bilingual plugin directory via GitHub
...
- **Recommendation:** Search npm + curated list from inside DSH agents
...
- **Tags:** `ai`, `recommender`
- **Recommendation:** AI-powered automatic plugin discovery and categorization
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Recommendation:** Curated DSH plugin awesome list collection
...
- **Tags:** `toy`, `web-app`, `entertainment`
- **Recommendation:** Web sim toy, pure fun, no dev utility
...
- **Recommendation:** Curated DSH plugin ecosystem list
...
- **Recommendation:** Curated DSH tools and infrastructure list
...
- **Recommendation:** Curated plugin discovery with verification
...
- **Recommendation:** Bilingual curated plugin and tool directory
...
- **Recommendation:** DSH learning guide and plugin marketplace
...
- **Tags:** `agent`, `awesome-list`, `deepseek-harness`
- **Recommendation:** Ultimate guide and resource list.
...
- **Tags:** `agent-framework`, `awesome-list`, `plugins`
- **Recommendation:** Curated list of plugins and tools.
...
- **Recommendation:** Curated awesome list of DSH plugins and resources.
...
- **Tags:** `awesome-list`, `curated`, `resources`
- **Recommendation:** Curated directory of useful DSH plugins and tools.
...
- **Recommendation:** Community-maintained DSH plugin catalog with auto-sync.
...
- **Tags:** `meta`, `directory`, `awesome-list`
- **Recommendation:** Official curated plugin index maintained by cordis.run
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Recommendation:** Community plugin discovery directory
...
- **Recommendation:** Curated DSH plugin collection
...
- **Recommendation:** Community plugin catalog listing
...
- **Tags:** `awesome-list`, `verified`
- **Recommendation:** Curated verified DSH plugin directory
...
- **Tags:** `awesome-list`, `registry`
- **Recommendation:** Spam-filtered DSH plugin registry
...
- **Recommendation:** Curated DSH plugin meta-list for ecosystem discovery
...
- **Description:** DSH插件
- **Tags:** `dsh-plugins`
- **Recommendation:** DSH plugin curated list for exploration
...
- **Recommendation:** Comprehensive curated DSH plugin directory
...
- **Recommendation:** Evidence-aware shortlisted DSH plugins
...
- **Tags:** `cordis`, `awesome-list`
- **Recommendation:** Auto-generated official Cordis plugin listings
...
- **Tags:** `awesome-list`, `catalog`, `ecosystem`
- **Recommendation:** Full ecosystem 1000+ plugin catalog by stars

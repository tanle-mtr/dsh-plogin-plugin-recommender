...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 1,006,270 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-11 14:58:16 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 220,267 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,562 | Open-source design plugin with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,080 | Multi-agent swarm orchestration with autonomous wo |
...
- **Why use it:** Super AI assistant with memory, multi-agent, and multi-model support
...
- **Tags:** `low-code`, `ai`, `business-systems`
...
- **Tags:** `agent`, `harness-engineering`, `dsh-plugin`, `llm`
...
- **Why use it:** Runtime injector + router-standard kit for task-aware reasoning mode in DSH
...
- **Tags:** `agent-os`, `mcp`, `llm-orchestration`, `skill`, `codex`
...
- **Why use it:** First vision plugin enabling OCR and image-to-structured-Jason for text-only coding agents
...
- **Tags:** `preset`, `deepseek-harness`, `agent`
- **Why use it:** Two-phase preset combining minimal bootstrap with full Standard tools for robust agent workflows
...
- **Why use it:** World's first virtual terminal providing sandboxed VFS and virtual terminal for AI agents
...
- **Tags:** `dsh`, `security`, `cybersecurity`, `code-audit`
- **Why use it:** AI security platform auditing generated code for hallucinations, vulnerabilities, and missing safeguards.
...
- **Tags:** `dsh`, `coding-agent`, `mcp`, `rpc`
- **Why use it:** Coding agent with sub-agents, RPC plugin, hashline edits, and MCP integration.
...
- **Tags:** `dsh-plugin`, `plugin-development`, `knowledge-base`
- **Why use it:** Official plugin development knowledge base as on-demand skill
...
- **Why use it:** Code simplification skill adapted from Codex
...
- **Why use it:** One-click MCP/skills/config sync for agents
...
- **Why use it:** Fast Lua Neovim plugin manager with elegant design
...
- **Why use it:** CodeX-style plugin marketplace bundled for DSH desktop.
...
- **Tags:** `deepseek-harness`, `dsh-web`, `dsh-plugin`
...
- **Tags:** `sidebar`, `ui`, `deepseek-harness`
...
- **Tags:** `taskboard`, `ui`, `coding-agent`
...
- **Tags:** `tui`, `ui`, `deepseek-harness`
- **Why use it:** Claude Code-style TUI with whale toolbar, streaming thinking, and context progress indicators
...
- **⭐ Stars:** 2,159
- **Language:** JavaScript
- **Description:** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻���、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装
- **Tags:** `widget`, `ui`, `deepseek-harness`
- **Why use it:** Cute floating whale widget that tracks your DeepSeek account balance with drag-and-drop
...
- **Tags:** `deepseek-harness`, `desktop`, `tauri`, `dsh`
- **Why use it:** Lightweight Tauri desktop with preset plugins and zero setup
...
- **Tags:** `dsh`, `desktop`, `electron`, `local-first`
- **Why use it:** Local-first Electron desktop workspace with projects, files, and plugin management.
...
- **Tags:** `dsh`, `desktop`, `electron`, `windows`
- **Why use it:** Windows desktop GUI with Codex, SSH, mobile remote access, and plugin support.
...
- **Tags:** `dsh`, `ui-components`, `react`
- **Why use it:** Interactive UI components rendered inline — charts, forms, layouts via dsh-ui fence.
...
- **Tags:** `dsh`, `desktop`, `tauri`, `local-first`
...
- **Why use it:** Full office suite with spreadsheets, docs, slides
...
- **Why use it:** Open-source Smartisan-style notes with Docker and DSH integration
...
- **Why use it:** Community plugin marketplace built into the DSH web GUI
...
- **Tags:** `dsh-plugin`, `desktop-app`, `electron`
- **Why use it:** Electron desktop console for managing plugins, MCPs, and skills
...
- **Why use it:** Live model/balance/pricing info bar
...
- **Why use it:** All-in-One DevOps desktop with DB, SSH, Docker.
...
- **Tags:** `electron`, `desktop`, `webui`
- **Why use it:** Electron desktop shell for DSH with web UI and sidebar integration
...
- **Why use it:** Customizable background themes with presets and image upload for DSH Web
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `web`
- **Why use it:** Clean static portal for discovering and filtering 227+ DSH plugins.
...
- **Why use it:** Adds one-click compact mode to DSH context meter panel.
...
- **Tags:** `rag`, `agent-memory`, `context-database`
...
- **Tags:** `agent-memory`, `rag`, `mcp`, `long-term-memory`, `skills`
...
- **Tags:** `agent-memory`, `agentic-rag`, `continual-learning`, `mcp`
...
- **Why use it:** Agent memory management kit enabling persistent remembering and refinement across sessions
...
- **Tags:** `memory`, `skill-corpus`, `RAG`, `dsh-plugin`
...
- **Tags:** `memory`, `handoff`, `session`, `continuity`
- **Why use it:** Cross-agent session continuity memory
...
- **Why use it:** 530+ image prompts with reusable skills for GPT Image generation
...
- **Tags:** `agent-orchestration`, `mcp`, `no-code`, `deepseek-harness`
- **Why use it:** Unified agent workspace across desktop, mobile, browser with board-based task tracking
...
- **Tags:** `agent-skills`, `deepseek-harness`, `skill-md`, `mcp`
- **Why use it:** Most comprehensive skill store with auto-crawled GitHub skills across categories
...
- **Tags:** `agent-control-plane`, `loop-engineering`, `workflow-automation`, `codex`
...
- **Tags:** `agent-collaboration`, `multi-agent`, `visual-editor`, `deepseek-harness`
- **Why use it:** Enterprise local-first agent workbench with multi-engine workspace and visual editor
...
- **Tags:** `video`, `agent-skill`, `dsh-plugin`, `ffmpeg`
...
- **Tags:** `agent-skill`, `research`, `dsh-plugin`, `web-search`
...
- **Tags:** `agent-teams`, `dsh`, `dsh-plugin`
- **Why use it:** Enable multi-agent collaboration and team workflows in DSH
...
- **Tags:** `ai-writing`, `novel`, `dsh-plugin`, `creative`
...
- **Tags:** `dsh`, `canvas`, `conversation`, `workflow`
- **Why use it:** Visual non-linear conversation canvas for branching exploration and session navigation.
...
- **Tags:** `dsh`, `multimodal`, `ocr`, `video-analysis`
- **Why use it:** Grants agents vision and hearing — converts video, audio, and screen into timestamped evidence.
...
- **Why use it:** Creative writing agent with drama/novel workflows
...
- **Why use it:** Native taskboard with SQLite and native Web UI
...
- **Why use it:** Enables composable, reviewable agent self-evolution workflows
...
- **Why use it:** Turns experience into repeatable AI agent execution patterns
...
- **Why use it:** Skill that auto-discovers, installs and verifies DSH plugins
...
- **Why use it:** Adds multimodal vision for screenshot and UI analysis to LLMs
...
- **Why use it:** Specialized skills for AI infra development and high-perf debugging
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill pack for DSH agents
...
- **Why use it:** Auto-upgrades DSH plugins when the harness version updates
...
- **Why use it:** Convert successful agent sessions into reusable skills automatically
...
- **Why use it:** AI coding mentor with auto code review and chapter-based learning
...
- **Tags:** `dsh-plugin`, `patent`, `legal-tech`, `rag`
- **Why use it:** Patent infringement analysis with automated report generation
...
- **Tags:** `dsh-plugin`, `skills`, `agent`
- **Why use it:** 25 ready-to-use engineering skills including triage and wayfinder
...
- **Why use it:** Full GB/T 9704 standard document processing with format validation
...
- **Tags:** `dsh-plugin`, `spec-programming`, `agent-skills`
...
- **Why use it:** OCR/vision skill for text-only models
...
- **Why use it:** Bazi/Fengshui/TCM traditional wisdom skill pack
...
- **Why use it:** Multi-agent team collaboration framework
...
- **Why use it:** QA testing skill framework with 11 skills
...
- **Tags:** `roleplay`, `narrative`, `npc`, `skills`
- **Why use it:** Narrative roleplay with NPC memory/stance
...
- **Tags:** `engineering`, `quality-gate`, `workflow`
- **Why use it:** Engineering discipline workflow for quality gates.
...
- **Tags:** `plugin-development`, `skill`, `guide`
- **Why use it:** Guides AI to build and test DSH plugins from scratch.
...
- **Why use it:** Cinematic video agent skill with 152 camera cards.
...
- **Tags:** `agent-skill`, `plugin-dev`, `standards`
- **Why use it:** Agent skill for standard DSH plugin development.
...
- **Why use it:** Free Xiaomi MiMo TTS API integration with preset and custom voices
...
- **Why use it:** Pre-flight plugin check boosts agent plugin library utilization.
...
- **Tags:** `mcp`, `capability-management`, `security`
- **Why use it:** Manage MCP tool exposure level and execution mode visibility
...
- **Tags:** `design`, `figma-alternative`, `ui-generator`
- **Why use it:** Open-source design plugin with local-first desktop and Figma alternative
...
- **Tags:** `ai`, `ui`, `vibedesign`, `flutter`, `react`, `mcp`
...
- **Why use it:** AI-powered design system with visual editor and PPT studio
...
- **Tags:** `vision`, `computer-vision`, `dsh-plugin`, `OCR`
- **Why use it:** Vision toolkit for text-only LLMs: image QA, OCR and UI restoration
...
- **Tags:** `dsh-plugin`, `legal-tech`, `diagram`, `svg`
- **Why use it:** Legal timeline and case diagram generation from case materials
...
- **Tags:** `video`, `image`, `director`, `storyboard`
- **Why use it:** AI video/image generation with storyboard
...
- **Why use it:** 6 design styles to avoid generic AI-looking websites.
...
- **Why use it:** Free image reading and generation skills for DSH.
...
- **Tags:** `visualization`, `api-cost`, `webui`
- **Why use it:** Real-time token usage charts and cost estimation for DSH Web
...
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness`, `knowledge-cards`
- **Why use it:** Turns recent chat history into shareable, beautifully designed cards.
...
- **Why use it:** Local-first cross-platform content discovery agent for Bilibili, YouTube, Reddit, and more
...
- **Tags:** `agent`, `browser-use`, `dsh-plugin`, `automation`
- **Why use it:** Use real logged-in browser for AI agents without interrupting work
...
- **Why use it:** Tabbit browser automation plugin for DeepSeek Harness integration
...
- **Tags:** `ai-agents`, `chatgpt`, `dsh-plugin`
- **Why use it:** OAuth ChatGPT binding lets you chat with ChatGPT inside DSH.
...
- **Tags:** `ai-agent`, `dingtalk`, `dsh-plugin`
- **Why use it:** DingTalk IM channel with stream-mode bots and emotion read receipts.
...
- **Tags:** `image-uploader`, `electron`, `cdn`
...
- **Why use it:** Built-in marketplace for browsing, searching, and one-click installing DSH plugins
...
- **Tags:** `multi-agent`, `tool-switch`, `utility`
- **Why use it:** One-click plugin for switching between Claude Code, Codex, DeepSeek, Kimi, and other agents
...
- **Tags:** `ecosystem-radar`, `dsh-plugin`, `plugin-registry`
- **Why use it:** Self-hostable ecosystem radar discovering 15900+ plugins automatically
...
- **Tags:** `context`, `dsh-plugin`, `dashboard`, `management`
- **Why use it:** Comprehensive context dashboard and management for DSH insights
...
- **Tags:** `dsh`, `oauth`, `llm-provider`, `subscription`
- **Why use it:** Bridge ChatGPT, Claude, and Grok subscriptions as DSH LLM providers via OAuth — no API keys needed.
...
- **Tags:** `commandcode`, `llm-provider`, `dsh-plugin`
...
- **Tags:** `plugin-catalog`, `awesome-list`, `directory`
- **Why use it:** Comprehensive DSH plugin catalog with filtering and sorting
...
- **Tags:** `handbook`, `runtime`, `agent-runtime`
- **Why use it:** Authoritative DSH runtime, plugin, MCP and troubleshooting guide
...
- **Tags:** `remote`, `p2p`, `dsh-plugin`
- **Why use it:** P2P-encrypted remote access to Harness across PC and mobile
...
- **Why use it:** Curated awesome list of top DSH plugins for quick discovery
...
- **Tags:** `dsh-plugin`, `plugin-management`, `console`
- **Why use it:** Plugin ecosystem infrastructure with browser-based management console
...
- **Tags:** `dsh-plugin`, `agent-skills`, `plugin-management`
...
- **Tags:** `context`, `audit`, `tokens`, `ui`
- **Why use it:** Context token audit and conflict detection
...
- **Tags:** `containers`, `multi-version`, `management`
- **Why use it:** Multi-version DSH container management
...
- **Tags:** `awesome-list`, `registry`, `dsh`
- **Why use it:** Open-data registry of verified DSH plugins and skills
...
- **⭐ Stars:** 8
- **Language:** TypeScript
- **Description:** 致力于解决��插件之间也与版本之间可能存在的冲突问题并提供解决方案
- **Tags:** `diagnostic`, `conflict-resolution`, `plugin`
...
- **Why use it:** Star-ranked verified community DSH plugins directory
...
- **Tags:** `mascot`, `sprites`, `pixel-art`, `deepseek-harness`, `claude-code`
...
- **Why use it:** Beautiful whale girl skin series for DeepSeek Harness customization
...
- **Tags:** `dsh`, `theme`, `webgpu`, `threejs`
- **Why use it:** WebGPU-powered ocean-themed visual skin for DSH with Three.js rendering.
...
- **Tags:** `ai`, `ai-agent`, `deepseek`, `chatgpt`, `claude`
- **Why use it:** Comprehensive AI resources and Vibe Coding tutorials for all major LLMs
...
- **Tags:** `awesome-list`, `dsh-plugin`, `ecosystem`
- **Why use it:** Curated plugin ecosystem catalog for DeepSeek Harness
...
- **Tags:** `dsh`, `web-search`, `agent-skills`
- **Why use it:** Free web search plugin bridging all models without native browsing capability.
...
- **Why use it:** Curated plugin discovery with ratings and guides
...
- **Tags:** `arxiv`, `latex`, `research`
- **Why use it:** All-in-one research bench: LaTeX, arXiv, GPU SSH
...
- **Why use it:** Cross-source academic search with citation verification for researchers
...
- **Tags:** `stock`, `finance`, `mcp`, `agent`
- **Why use it:** AI-native multi-agent financial analysis with local Tushare database
...
- **Tags:** `industry-research`, `research`, `report`
...
- **⭐ Stars:** 64
- **Language:** TypeScript
- **Description:** 在 DeepSeek Harness / Claude Code / Cursor / Codex / Gemini CLI 里直接搜索 20 个中国开放平台的 65,600+ 篇 API 文档；零配置，支持 Skill ��� DSH 原生插件。
- **Tags:** `dsh-plugin`, `api-documentation`, `chinese-api`
- **Why use it:** Search 65,600+ Chinese API docs across 20 platforms without config
...
- **Tags:** `dsh-plugin`, `awesome-list`, `plugin-directory`
...
- **Tags:** `kline`, `chart`, `technical-analysis`, `finance`
- **Why use it:** Interactive K-line chart with technical indicators
...
- **Why use it:** Evidence-backed evaluation for prompts, RAG, agents.
...
- **Why use it:** Curated awesome list covering all DSH plugins, tools, and resources
...
- **Why use it:** Evidence-led directory with verified loadable extensions
...
- **Tags:** `awesome-list`, `catalog`, `dsh`
- **Why use it:** Complete 1000+ DSH plugin ecosystem sorted by stars
...
- **Why use it:** Plugin product manual and navigation by scenario with compatibility info
...
- **Why use it:** Comprehensive daily-updated DSH plugin marketplace with curation and review.
...
- **⭐ Stars:** 405
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃���。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `deepseek-harness`, `deepseek-harness-plugin`, `dsh`, `dsh-plugin`, `theme`
- **Why use it:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃���。玻璃模糊度、磨砂度、背
...
- **Tags:** `awesome-list`, `ai-resources`, `knowledge-base`
- **Why use it:** Comprehensive AI encyclopedia covering models, agents, RAG, multimodal, and learning paths.
...
- **Why use it:** Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub
...
- **Tags:** `android`, `android-app`, `coding-agent`, `deepseek`, `deepseek-harness`, `deepseek-harness-plugin`, `dsh-plugin`, `ios`, `ios-app`, `ios-swift`, `kmp`, `kotlin-multiplatform`, `kotlin-multiplatform-mobile`, `ui-design`
- **Why use it:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile
...
- **Why use it:** Curated directory of useful DSH plugins, extensions, and tools
...
- **Why use it:** Community-maintained auto-syncing DSH plugin catalog and marketplace
...
- **Tags:** `bioinformatics`, `desktop`, `clinicians`, `tauri`
- **Why use it:** Bioinformatics desktop agent for clinicians
...
- **Tags:** `curated-list`, `awesome`, `directory`
- **Why use it:** Curated list of DSH plugins with descriptions.
...
- **Tags:** `directory`, `discovery`, `awesome`
...
- **Why use it:** Vertical curated list of stock/finance/quant DSH plugins
...
- **Why use it:** In-agent plugin search across npm and awesome lists for discoverability.
...
- **Tags:** `dsh-bundle`, `dsh-plugins`, `dsh-repository-plugin`
- **Why use it:** DSH plugin repository bundle with verification support.
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugin-list`, `ds h`
- **Why use it:** Curated list of DSH plugins for quick reference
...
- **Tags:** `plugin-list`, `curated`, `evidence`

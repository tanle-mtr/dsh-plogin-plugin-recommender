...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 866,906 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-26 01:32:38 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,348 | Core DSH framework, everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,486 | Open-source design system and desktop UI generator |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,408 | Multi-agent swarm orchestrator with autonomous wor |
...
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 20 plugins
...
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (20)
...
- **Why use it:** Super AI assistant harness with self-evolving memory.
...
- **Why use it:** Terminal-native DeepSeek coding agent with prefix-cache.
...
- **Why use it:** Unified workspace for all agents across desktop, mobile, and browser
...
- **Tags:** `routing`, `injector`, `cordis`
- **Why use it:** Task-aware reasoning-mode router, critical runtime injector for DSH
...
- **Why use it:** Self-improving Agent OS with grading-based loop engineering
...
- **Why use it:** Enterprise-grade multi-agent workspace with visual editor
...
- **Why use it:** Two-phase preset ensuring reliable bootstrap and full tool access
...
- **Tags:** `coding-agent`, `architecture`, `safety`
...
- **Tags:** `dsh-plugin`, `ui`, `coding-agent`
...
- **Tags:** `compatibility-layer`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Run Pi extensions natively as DSH plugins via compatibility layer.
...
- **Tags:** `plugin-dev`, `skill`, `meta`
- **Why use it:** Meta-skill for building DSH plugins — covers slots, events, tools, adapters, and packaging standards.
...
- **Why use it:** OCR and image-reading tools for text-only LLMs — 34-image trained methodology included.
...
- **Tags:** `plugin-dev`, `tools`, `credentials`
- **Why use it:** Agent skill for managing DSH plugin slots, Typert remotes, and credentials — hands-on dev support.
...
- **Tags:** `mcp`, `capability-menu`, `dsh-plugin`
...
- **Why use it:** Bidirectional bridge syncing chats, skills and MCP servers between Codex and DSH
...
- **Tags:** `agent-framework`, `skills`, `database`
...
- **Why use it:** Portable skill for developing, testing, and auditing DSH plugins
...
- **Tags:** `documentation`, `best-practices`, `plugin`
- **Why use it:** Practical plugin dev archive covering cordis, tsconfig, Windows tips
...
- **Why use it:** Reusable skill for building and validating DSH plugins efficiently.
...
- **Why use it:** End-to-end plugin scaffolding and testing skills inside DSH.
...
- **Why use it:** Open-source design system and desktop UI generator.
...
- **Why use it:** Ultimate cross-platform image uploader with 60+ hosting services.
...
- **Tags:** `dsh-web`, `web-ui`, `plugin-aggregator`
- **Why use it:** Web plugin aggregator with creative workshop distribution model
...
- **Why use it:** Extensible sidebar with file editor, terminal, chat, and sub-agent pages
...
- **Why use it:** Claude Code-style terminal UI with whale header and streaming status
...
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop app
...
- **Why use it:** 5MB Tauri desktop app with zero environment setup
...
- **Why use it:** Windows desktop GUI for DSH with SSH and mobile access.
...
- **Why use it:** Electron desktop console for managing Harness/Plugin/MCP/Skills — multi-tab, double-click to run.
...
- **Why use it:** All-in-one Tauri desktop: DB, SSH, Docker + AI assistant.
...
- **Why use it:** Electron shell wrapping DSH web UI with sidebars and integrations.
...
- **Why use it:** Portable local-first Markdown memory layer, user-owned and cross-app
...
- **Tags:** `memory-management`, `rag`, `self-evolving`
...
- **Why use it:** Specialized memory kit for agents with RAG support
...
- **Why use it:** Persistent memory layer using Markdown and Milvus for hybrid semantic search
...
- **Why use it:** Provides unlimited memory for AI agents
...
- **Why use it:** Comprehensive AI encyclopedia covering DSH, agents, RAG, multimodal and more
...
- **Tags:** `agent-skills`, `embeddings`, `dsh-plugin`
- **Why use it:** Convert scattered SKILL.md files into searchable skill corpora.
...
- **Why use it:** Curated 1000+ DSH plugins sorted by stars
...
- **Tags:** `recommender`, `awesome-list`, `curated`
...
- **Why use it:** Curated plugins, tools, skills & resources
...
- **Why use it:** Redirect to main awesome-dsh-plugin list
...
- **Tags:** `curated`, `registry`, `plugins`
- **Why use it:** Comprehensive curated plugins for models and UI
...
- **Tags:** `industry`, `curated`, `directory`
- **Why use it:** Industry-specific DSH plugins for computing, finance, legal
...
- **Why use it:** Distill AI thinking patterns into reusable agent skills.
...
- **Tags:** `agent-skills`, `cognitive`, `global-workspace`
...
- **Why use it:** Intelligently orchestrates skills and routes harness workflows
...
- **Why use it:** Enables multi-agent team collaboration workflows
...
- **Why use it:** Converts AI conversations into reusable organized workflows
...
- **Why use it:** Vision toolkit for text-only models with OCR support
...
- **Tags:** `agent`, `ai-agent`, `tauri`
- **Why use it:** Local-first AI agent with self-evolving skills and multi-model support
...
- **Tags:** `security`, `cybersecurity`, `agent`
- **Why use it:** AI security platform auditing generated code for hallucinated packages
...
- **Why use it:** Orchestrates Claude Code, Codex, Grok agents into collaborative teams
...
- **Tags:** `deepseek`, `prompt-engineering`, `agent`
- **Why use it:** DeepSeek专用破甲提示词插件，无限代稳定化优化
...
- **Tags:** `search`, `agent`, `web`
- **Why use it:** Free web search bridge for every DSH model without native access, no API key
...
- **Tags:** `ios`, `mobile-automation`, `agent`
...
- **Tags:** `canvas`, `workspace`, `agent`
- **Why use it:** Canvas-based non-linear conversation workspace with session branching explorer
...
- **Why use it:** Auto-pilot for math modeling competitions with GitOps pipeline.
...
- **Tags:** `creative-writing`, `deepseek-harness`, `dsh-plugin`
...
- **Tags:** `agent-skills`, `multimodal`, `claude-code`
- **Why use it:** Adds multimodal vision analysis to Claude Code and text LLMs.
...
- **Tags:** `agent-skills`, `coding`, `dsh`
- **Why use it:** Framework to turn experience into repeatable execution skills.
...
- **Why use it:** Orchestrates multi-step agent workflows natively within DeepSeek Harness.
...
- **Why use it:** Superpowers skill ported to Reasonix coding harness for enhanced agent abilities.
...
- **Why use it:** TDD, debugging, planning skills adapted from Superpowers — practical and battle-tested.
...
- **Why use it:** 85 SKILL.md covering reverse engineering and authorized pentesting for security professionals.
...
- **Tags:** `skill`, `mentor`, `coding`, `review`
- **Why use it:** Transforms your AI coding assistant into a mentor — scans architecture, generates chapters, code reviews.
...
- **Tags:** `skills`, `research`, `marketing`, `business`
- **Why use it:** 88 open-source agent skills for research, marketing, and business workflows across multiple platforms.
...
- **Why use it:** Spec-driven development skill — portable, repository-native, inspired by DeepSeek engineering patterns.
...
- **Why use it:** Official docs archive with bilingual knowledge base as on-demand agent skill
...
- **Tags:** `chinese-wisdom`, `fengshui`, `agent-skill`
- **Why use it:** Comprehensive Chinese metaphysics skill with Bazi, Fengshui, IChing integration
...
- **Why use it:** Cross-platform skill enabling agent session continuity and context recovery
...
- **Why use it:** Full workflow for Chinese official documents per national standard
...
- **Why use it:** Game-like mission system with fog-of-war map for skill tasks
...
- **Why use it:** Portable agent skill distilling DSH engineering discipline.
...
- **Why use it:** Full-stack Godot 4.x development skill at runtime.
...
- **Why use it:** Pre-flight plugin check for DSH agents, auto-injects Top-K relevant plugins
...
- **Why use it:** First vision plugin turning images into structured JSON evidence
...
- **Tags:** `api`, `mcp`, `documentation`, `chinese-platforms`
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms — zero config, works as MCP-compatible tool.
...
- **Why use it:** In-browser skill and MCP server management card for DSH GUI
...
- **Why use it:** MCP server and CLI for Zhihu search and Zhida Q&A integration
...
- **Why use it:** Hot-reload MCP config and zip skill management without restart
...
- **Tags:** `chatgpt`, `oauth`, `subscription`, `codex`
...
- **Why use it:** Industrial-grade GPT image prompts with 530+ reverse-engineered cases.
...
- **Why use it:** Beautiful verifiable architecture and sequence diagrams with motion
...
- **Why use it:** AI-native vector design tool with concurrent agent teams and D2C
...
- **Why use it:** AI-powered design system with PPT and visual editor
...
- **Tags:** `image-generation`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Generate AI images directly within DSH chat sessions.
...
- **Why use it:** Preview and edit real .op design documents directly inside conversations.
...
- **Why use it:** Visualize legal cases into court-ready diagrams and timelines — essential for legal tech workflows.
...
- **Why use it:** 6 curated design styles to escape the generic AI look
...
- **Tags:** `ai-video`, `storyboard`, `text-to-video`
- **Why use it:** AI video, image, and audio skills with configurable vision tools
...
- **Tags:** `canvas`, `creative`, `mcp-tools`
- **Why use it:** Infinite canvas with creative skills for visual workflows.
...
- **Tags:** `content-discovery`, `bilibili`, `local-first`
- **Why use it:** Local-first cross-platform content discovery agent with privacy focus
...
- **Why use it:** CLI+extension for seamless logged-in browser automation
...
- **Why use it:** Tabbit Browser plugin for DeepSeek Harness with Playwright-powered automation.
...
- **Why use it:** Unified virtual filesystem enabling persistent agent file operations
...
- **Tags:** `multi-agent`, `claude-code`, `deepseek`
- **Why use it:** One-click installs and switches between multiple CLI coding agents
...
- **Why use it:** Built-in plugin marketplace with search and one-click install for DSH
...
- **Why use it:** Best context dashboard and statistics for DSH
...
- **Why use it:** Curated bilingual DSH plugin and extension collection with verified references
...
- **Tags:** `discovery`, `plugin`, `marketplace`
- **Why use it:** Auto-grabbed daily DSH plugin discovery with real-vs-spam verification
...
- **Tags:** `llm`, `oauth`, `integration`
- **Why use it:** Routes ChatGPT/Claude/Grok subscriptions as DSH LLM providers via OAuth
...
- **Tags:** `documentation`, `learning`, `plugin`
- **Why use it:** Learn DSH principles, plugin marketplace, and best practices in one place
...
- **Tags:** `cost-tracking`, `deepseek-api`, `dsh-plugin`
- **Why use it:** Track session costs, token usage, and budgets in DSH.
...
- **Tags:** `plugin-discovery`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Search, install, and verify DSH plugins from GitHub.
...
- **Why use it:** Smartisan-style notes with Docker deploy, export, and multi-tenant support.
...
- **Why use it:** One-click browse, install and update all dsh-plugin GitHub topics in Web GUI.
...
- **Tags:** `task-management`, `sqlite`, `web-ui`
...
- **Why use it:** Crash rescue with undo config changes, snapshots, and offline SAFE MODE.
...
- **Why use it:** Community-maintained plugin catalog with auto-sync every 4 hours — great for staying updated.
...
- **Tags:** `infrastructure`, `plugin-management`, `ui`
- **Why use it:** Essential DSH infrastructure — browser-based plugin console and official plugin development guide.
...
- **Tags:** `dsh-plugins`, `containers`, `webview`
- **Why use it:** Isolated multi-version DSH containers with embedded WebView UI
...
- **Why use it:** Context audit tool detecting token costs, duplicates and conflicts in AGENTS.md
...
- **Tags:** `dsh`, `oauth`, `community`
- **Why use it:** Zero-permission GitHub OAuth group photo wall for community events
...
- **Tags:** `migration`, `config-migration`, `import`
- **Why use it:** Migrate Claude Code/OpenCode/Codex configs into DSH seamlessly.
...
- **Tags:** `token-usage`, `cost-tracking`, `data-viz`
- **Why use it:** Real-time token usage charts and cost estimation for DSH.
...
- **Tags:** `diagnostics`, `conflict-resolution`, `plugin-health`
- **Why use it:** Detects and resolves conflicts between DSH plugins automatically.
...
- **Tags:** `mascot`, `pixel-art`, `animated`
- **Why use it:** Gallery of animated pixel-art mascots for coding agents
...
- **Why use it:** Glass-morphism theme with fully customizable blur,磨砂, and backgrounds
...
- **Tags:** `theme`, `chrome-extension`, `dsh-plugin`
- **Why use it:** WebGPU-powered ocean skin for DSH interface.
...
- **Why use it:** 34 classic opencode color themes with one-click swap and persistence
...
- **Tags:** `webui`, `background`, `theme`, `personalization`
- **Why use it:** Custom web background plugin with presets and real-time preview
...
- **Tags:** `ai-resources`, `rag`, `vibe-coding`
...
- **Tags:** `kline`, `trading`, `analysis`, `dashboard`
- **Why use it:** Interactive K-line analysis with multi-market support, technical indicators and fundamentals
...
- **Tags:** `agent-evaluation`, `rag-evaluation`, `prompt-engineering`
...
- **Why use it:** Public plugin directory with install commands and discovery.
...
- **Tags:** `awesome-list`, `2026`, `quality-check`
...
- **Why use it:** Curated plugin discovery list, essential starting point for DSH
...
- **Tags:** `toy`, `fun`, `web`
- **Why use it:** Zero-dependency web simulation of a traditional Chinese toy with real audio
...
- **Why use it:** Auto-discovery plugin radar with real installation verification
...
- **Tags:** `awesome-list`, `community`, `ecosystem`
...
- **Why use it:** Community-curated DSH plugins and infrastructure list
...
- **Why use it:** Ultimate DSH guide with quickstart and plugin resources.
...
- **Tags:** `deepseek-harness`, `plugins`, `dsh-plugin`
- **Why use it:** Collection of DeepSeek Harness plugins.
...
- **Why use it:** Curated awesome list of all notable DeepSeek Harness community plugins.
...
- **Why use it:** Curated awesome-list for discovering DSH plugins and development resources.
...
- **Tags:** `awesome-list`, `official`, `discovery`
- **Why use it:** Official auto-generated plugin list curated by cordis.run — a reliable discovery source.
...
- **Why use it:** Fast Neovim plugin manager — not DSH-specific.
...
- **Why use it:** 24 verified stock/finance/quant DSH plugins, bilingual curated list
...
- **Tags:** `plugins`, `collection`, `chinese`
- **Why use it:** Useful DeepSeek Harness plugin collection in Chinese
...
- **Tags:** `plugin-directory`, `awesome-list`, `guide`
- **Why use it:** Plugin manual and navigation by scenario with install and risk info
...
- **Tags:** `plugin-portal`, `static-site`, `directory`
- **Why use it:** Zero-dependency static portal for discovering and installing 227+ DSH plugins
...
- **Tags:** `dsh-plugins`, `registry`, `ecosystem`
- **Why use it:** DeepSeek Harness plugins directory and ecosystem listing
...
- **Why use it:** Auto-crawled bilingual DSH plugin catalog via daily GitHub Actions
...
- **Tags:** `awesome-list`, `evidence-led`, `bilingual`
...
- **Tags:** `plugin-radar`, `awesome-list`, `2origin`
- **Why use it:** Plugin radar and 2Origin plugin lab with evidence-backed listings

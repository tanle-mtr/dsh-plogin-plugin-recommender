...
|--------|-------|
| **Plugins tracked** | 194 |
| **Total community stars** | 945,315 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-02 13:27:56 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 209,138 | Core platform enabling everything-as-plugin archit |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,533 | Open-source design tool with local-first desktop a |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,207 | Multi-agent swarm harness for coordinating autonom |
...
- **Why use it:** Core platform enabling everything-as-plugin architecture for AI agents.
...
- **Why use it:** Self-evolving multi-model agent harness with memory and tool use.
...
- **Tags:** `coding-agent`, `deepseek`, `tui`, `dsh-plugin`
- **Why use it:** Terminal-native AI coding agent optimized for DeepSeek with prefix caching.
...
- **Tags:** `dsh`, `routing`, `agent`, `cordis`
- **Why use it:** Task-aware routing injector for optimized agent reasoning
...
- **Tags:** `agent-control`, `loop`, `workflow`
- **Why use it:** Long-horizon agent control plane for durable governance
...
- **Why use it:** Enterprise local-first multi-engine agent workbench
...
- **Tags:** `deepseek-harness`, `preset`, `bootstrap`
...
- **Tags:** `agent-sandbox`, `virtual-filesystem`, `terminal`
- **Why use it:** Virtual terminal with VFS for AI agents, first of its kind
...
- **Tags:** `security`, `vulnerability`, `redteam`, `code-review`
...
- **Tags:** `subscriptions`, `oauth`, `multi-provider`, `llm`
- **Why use it:** Uses ChatGPT, Claude, and Grok subscription accounts as LLM providers without needing API keys
...
- **Tags:** `coding-agent`, `sub-agents`, `mcp`, `go`
- **Why use it:** Full-featured coding agent with NPC plugin, sub-agents and MCP support
...
- **Tags:** `self-evolving`, `agent-review`, `plan-mode`
- **Why use it:** Composable task controls enabling Agent self-evolution and human review loops
...
- **Why use it:** Adapts proven TDD, debugging, and planning superpowers skills for code development.
...
- **Tags:** `reverse-engineering`, `security`, `pentest`
- **Why use it:** Comprehensive reverse engineering and authorized pentesting skill collection.
...
- **Tags:** `agent-skill`, `dsh-plugin`, `plugin-dev`
- **Why use it:** Standardized skill for developing DSH plugins with plug/skill/event integration.
...
- **Tags:** `dsh-plugin`, `agent-skill`, `management`
- **Why use it:** Agent skill for managing installed DSH plugin slots, remotes, and credentials.
...
- **Tags:** `plugin-dev`, `coding-agent`, `validator`
- **Why use it:** Reusable skill for building and validating DSH and Cordis plugins, integrates with Codex.
...
- **Why use it:** Pre-flight plugin check — auto-injects relevant plugins for tasks.
...
- **Why use it:** Bind ChatGPT account via OAuth and chat with models in DSH.
...
- **Why use it:** Open sidebar framework with built-in files, terminal, Git and sub-agents
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status and streaming
...
- **Tags:** `widget`, `ui`, `dashboard`
- **Why use it:** Cute floating whale widget monitoring your balance.
...
- **Why use it:** Zero-setup Tauri desktop app with preset plugins.
...
- **Why use it:** Local-first desktop workspace for DSH sessions.
...
- **Why use it:** Renders interactive UI components like charts, forms, and quizzes inline in DSH chat replies
...
- **Tags:** `desktop-app`, `multi-model`, `local-first`, `privacy`
- **Why use it:** Local-first multi-model desktop app with self-evolving skills and privacy-first architecture
...
- **Tags:** `desktop-app`, `electron`, `ssh`, `gui`
- **Why use it:** Open-source Windows desktop client with plugins, skills, SSH client, and mobile remote access
...
- **Tags:** `canvas`, `conversation`, `workspace`, `ui`
- **Why use it:** Visual canvas-based conversation workspace with non-linear session exploration and branching
...
- **Tags:** `desktop-app`, `cross-platform`, `electron`
- **Why use it:** Cross-platform desktop client inspired by CodePilot with plugin suite for macOS, Windows, Linux
...
- **Tags:** `office`, `spreadsheets`, `productivity`
...
- **Why use it:** Directly preview and edit OpenPencil UI design documents inside the conversation.
...
- **Tags:** `marketplace`, `ui`, `plugin-management`
- **Why use it:** Plugin marketplace for the DSH web GUI to browse and install community plugins easily.
...
- **Tags:** `dsh-plugin`, `balance`, `usage-tracking`
- **Why use it:** Bottom bar showing provider, balance, pricing info
...
- **Why use it:** All-in-one DevOps desktop: DB, SSH, Docker, AI.
...
- **Tags:** `dsh-plugin`, `dsh-plugin-market`
- **Why use it:** One-click compact context button for the DSH Web context meter
...
- **Tags:** `memory`, `rag`, `agent`, `markdown`
...
- **Why use it:** Dedicated memory management kit with RAG support for agents
...
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus for agents
...
- **Why use it:** Best context dashboard and management for DSH sessions.
...
- **Tags:** `agentic-ai`, `multi-agent`, `swarm`, `dsh-plugin`
- **Why use it:** Multi-agent swarm harness for coordinating autonomous workflows.
...
- **Tags:** `agent`, `workspace`, `mcp`, `no-code`
- **Why use it:** Unified agent workspace with board tracking across devices
...
- **Why use it:** Largest skills marketplace with auto-updated GitHub integration
...
- **Why use it:** Self-improving agent OS with continuous loop engineering
...
- **Why use it:** Intelligent skill routing and workflow orchestration, proven reward gains
...
- **Tags:** `video-generation`, `agent-skills`, `ffmpeg`
- **Why use it:** Automated end-to-end video generation from a single topic.
...
- **Why use it:** Powerful vision toolkit for text-only models with OCR.
...
- **Tags:** `agent-skills`, `skill-md`, `embeddings`, `vector-search`
- **Why use it:** Turns scattered SKILL.md files into organized, retrievable agent-skill corpora with built-in evaluation
...
- **Why use it:** Native SQLite-backed taskboard with project management and agent claim/review workflow
...
- **Why use it:** Specialized skill for AI-powered novel and short-drama writing workflows
...
- **Why use it:** Complete math modeling competition skill with GitOps pipeline and self-verification
...
- **Tags:** `skills`, `experience`, `repeatable`
- **Why use it:** Turn experience into repeatable execution patterns across multiple agent platforms
...
- **Why use it:** Adds multimodal vision capabilities to code workflows, ideal for UI automation analysis.
...
- **Tags:** `migration`, `context`, `workflow`
- **Why use it:** Enables seamless state and context migration between different preset sessions.
...
- **Why use it:** Specialized skills for writing and debugging high-performance AI infrastructure systems.
...
- **Tags:** `skills`, `agent-workflow`, `dsh`
- **Why use it:** Game-like skill task management: one-click claim and dispatch for DSH workflows.
...
- **Why use it:** Repository-native spec-driven development skill following DeepSeek engineering patterns.
...
- **Tags:** `knowledge-base`, `plugin-dev`, `scaffold`
- **Why use it:** On-demand plugin development knowledge base with official EN/ZH docs as an agent skill.
...
- **Tags:** `agent-skill`, `chinese-wisdom`, `dashboard`
- **Why use it:** Fusion of Bazi, Fengshui, TCM, and I Ching into a local deterministic engine with dashboard.
...
- **Tags:** `agent-skill`, `docx`, `gongwen`
- **Why use it:** End-to-end Chinese official document processing with format check, template, and style enhancement.
...
- **Why use it:** Centralized local agent skill management for DSH
...
- **Tags:** `dsh-plugin`
- **Why use it:** WorkBuddy-style quick skill picker in composer
...
- **Tags:** `agent-handoff`, `agent-skills`, `dsh-plugin`
- **Why use it:** Cross-platform session continuity memory for agents
...
- **Tags:** `dsh-plugin`, `code-simplification`
- **Why use it:** Adapted code simplification skill for Codex from DSH
...
- **Tags:** `qa`, `agent-skills`, `testing`, `dsh-plugin`
- **Why use it:** Professional QA agent framework with 10 skills and test knowledge base
...
- **Tags:** `agent-framework`, `skills`, `dsh-plugin`
- **Why use it:** Package manager with 42 agent skills and 5 CLIs
...
- **Why use it:** Swift Cycle governance skill for project management.
...
- **Tags:** `skill`, `plugin-development`, `agent-skills`
- **Why use it:** Guides AI Agent to build DSH plugins from scratch.
...
- **Tags:** `agent-skills`, `plugin-development`, `cordis`
...
- **Why use it:** Agent preset simulating a virtual product team workflow.
...
- **Why use it:** Vision bridge plugin converting images to structured JSON for text agents
...
- **Why use it:** Web UI tool for managing skills and MCP servers directly within the harness interface.
...
- **Why use it:** Manage skills and MCP servers via web UI settings
...
- **Why use it:** Open-source design tool with local-first desktop and AI agent integration.
...
- **Tags:** `agent-skills`, `architecture-diagram`, `mermaid-alternative`, `dsh-plugin`
- **Why use it:** Agent skill generating beautiful interactive architecture and sequence diagrams.
...
- **Why use it:** 530+ industrial image prompt templates distilled into reusable agent skills.
...
- **Tags:** `design`, `ui`, `vibedesign`, `flutter`
- **Why use it:** Open-source AI vector design tool with concurrent Agent Teams
...
- **Why use it:** AI-powered design system and PPT studio for DSH.
...
- **Why use it:** Generate AI images directly within DSH chats using Seedream, OpenAI, or Gemini models
...
- **Tags:** `image-generation`, `vision`, `dsh-plugin`
- **Why use it:** Free image reading and generation with vision capabilities
...
- **Tags:** `video`, `image-generation`, `directorx`, `dsh-plugin`
...
- **Tags:** `knowledge-cards`, `dsh-plugin`
- **Why use it:** Transforms chat history into beautifully designed downloadable cards
...
- **Why use it:** Cross-browser enhancement suite for Gemini, Claude, ChatGPT, and DeepSeek.
...
- **Why use it:** Cross-platform content discovery agent across Bilibili, YouTube, X and more
...
- **Why use it:** Enable agents to control your logged-in browser directly.
...
- **Tags:** `web-search`, `free`, `no-signup`, `browser`
- **Why use it:** Free web search bridge for any model without native browsing — no signup or API keys required
...
- **Why use it:** Live iOS Simulator and USB-connected iPhone automation with 22 specialized agent tools
...
- **Why use it:** DingTalk IM channel turning chats into tool-capable agent conversations
...
- **Tags:** `agent-skills`, `mcp-server`, `self-hosted`, `dsh-plugin`
- **Why use it:** Privacy-focused, self-hosted resume builder with MCP server support.
...
- **Tags:** `image-uploader`, `electron`, `s3`, `dsh-plugin`
- **Why use it:** Ultimate image uploader supporting 60+ services, widely used across tools.
...
- **Tags:** `low-code`, `crm`, `workflows`, `dsh-plugin`
- **Why use it:** Open-source AI-powered no-code platform for building business systems fast.
...
- **Why use it:** One-click install and model switching across multiple AI coding tools
...
- **Tags:** `plugin-registry`, `validation`, `ecosystem`
- **Why use it:** Auto-discover and validate 15900+ DSH plugins.
...
- **Why use it:** Track session costs, budgets, and token usage across providers in real-time
...
- **Why use it:** Seamlessly bridges Pi ecosystem extensions as native DSH plugins via ABI layer
...
- **Why use it:** Skill that discovers, installs and verifies GitHub plugins directly in Harness
...
- **Tags:** `notes`, `utility`, `docker`
- **Why use it:** Open-source Smartisan Notes clone with Docker deployment and WeChat export support.
...
- **Why use it:** Secure P2P remote access solution to operate Harness from PC, Android, or Web.
...
- **Tags:** `plugin-dev`, `utility`, `upgrade`
- **Why use it:** Auto-upgrades DSH plugins when the DSH version changes, reducing manual maintenance.
...
- **Tags:** `dsh`, `container`, `management`
- **Why use it:** Run multiple DSH versions in isolated containers with embedded WebView UI and one-click imports.
...
- **Why use it:** Audit instruction chains and tool schemas for token costs, duplicates, and conflicts with Web UI.
...
- **Tags:** `config-sync`, `mcp`, `agent-config`
- **Why use it:** One-click MCP, Skills, and rule setup for Claude Code, Codex, DSH, Cursor, Gemini CLI, and more.
...
- **Tags:** `agent-migration`, `configuration-migration`, `mcp`, `skills`
- **Why use it:** Migrate Claude Code/Codex/OpenCode setup to DSH.
...
- **Tags:** `claude-code`, `migration`, `session-import`, `resume`
- **Why use it:** Four-source migration wizard for sessions and skills.
...
- **Why use it:** Fast, simple Neovim plugin manager in Lua.
...
- **Why use it:** Real-time token usage, cost charts, and API balance.
...
- **Tags:** `utility`, `conflict-resolution`
...
- **Why use it:** Cute whale girl visual theme series for DeepSeek Harness
...
- **⭐ Stars:** 397
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨��度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **Tags:** `theme`, `ui`, `glassmorphism`
- **Why use it:** Glassmorphism theme with full customization for DSH web UI without modifying source code
...
- **Why use it:** Stunning WebGPU ocean-themed skin with Three.js and native Chrome/Edge integration
...
- **Tags:** `color-scheme`, `customization`, `dark-mode`, `theme`
- **Why use it:** 34 opencode themes one-click swap for DSH.
...
- **⭐ Stars:** 5
- **Language:** JavaScript
- **Description:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸���种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **Tags:** `theme`, `customization`, `webui`
- **Why use it:** Customize DSH Web background with images and presets.
...
- **Tags:** `ai`, `llm`, `rag`, `mcp`
- **Why use it:** Comprehensive AI resource library and coding tutorials
...
- **Tags:** `research`, `web-search`, `china`, `skill`
...
- **Tags:** `awesome-list`, `curated`, `tools`
...
- **Tags:** `awesome-list`, `bilingual`, `resources`
- **Why use it:** Bilingual curated plugin and extension resource list.
...
- **Tags:** `ai-knowledge`, `resource-hub`, `awesome-list`
- **Why use it:** Comprehensive AI resource encyclopedia covering LLMs, agents, RAG, MLOps, and learning roadmaps
...
- **Why use it:** Curated daily-updated plugin directory with real classifications and filtered fake entries
...
- **Why use it:** Essential guide covering DSH principles, plugin marketplace and best practices
...
- **Tags:** `awesome-list`, `mcp`, `visualization`
- **Why use it:** Curated catalog of plugins, skills, MCPs and orchestrators with visualization
...
- **Why use it:** Massive plugin store with 11,000+ entries, search and public API access
...
- **Why use it:** Comprehensive plugin directory with 1,958 repos, search and STAR ranking
...
- **Tags:** `academic-search`, `research`, `citation`
- **Why use it:** Comprehensive academic search with citation graphs and verification across major databases.
...
- **Tags:** `research`, `latex`, `gpu-cluster`
- **Why use it:** All-in-one research workbench: LaTeX writing, arXiv management, and GPU task orchestration.
...
- **Why use it:** Curated directory of 280+ community plugins across 14 categories for DSH exploration.
...
- **Tags:** `dsh-plugin`, `kline`, `analysis`
- **Why use it:** Interactive K-line analysis with multi-market support
...
- **Tags:** `evaluation`, `rag`, `prompt-engineering`, `dsh-plugin`
...
- **Tags:** `awesome-dsh-plugin`, `dsh-repository-plugin`
- **Why use it:** Curated DSH plugin directory with verification tools
...
- **Why use it:** Plugin radar with evidence-backed curation and 2Origin lab
...
- **Why use it:** Built-in plugin search across npm and curated awesome lists
...
- **Why use it:** Auto-updating curated list with YAML data and bilingual README
...
- **Tags:** `curated-list`, `coding-agents`, `ui`
...
- **Why use it:** Built-in plugin marketplace for browsing, search and one-click install in DSH
...
- **Tags:** `armor-breaking`, `deepseek`, `plugin`
- **Why use it:** Armor-breaking plugin for DeepSeek-specific needs.
...
- **Why use it:** Fun anime search plugin with Bangumi ratings and magnet links directly in chat.
...
- **Tags:** `awesome-list`, `directory`, `curation`
- **Why use it:** Curated awesome list of essential DeepSeek Harness plugins for discovery.
...
- **Why use it:** Unified capability menu for DeepSeek Harness: manage exposure level (context foo
...
- **Why use it:** 🐳 DeepSeek Harness 插��聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH
...
- **Why use it:** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、��成阶梯式 Chapter
...
- **⭐ Stars:** 50
- **Language:** Python
- **Description:** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通��。
...
- **Why use it:** Pixel-to-text image reading and OCR tools for text-only LLM models via DSH.
...
- **Tags:** `awesome-list`, `plugin-registry`, `open-data`
- **Why use it:** Spam-filtered open-data plugin registry for DSH.
...
- **Why use it:** Comprehensive curated awesome list for DSH ecosystem.
...
- **Why use it:** Evidence-led plugin directory with permission guidance.
...
- **Why use it:** Vertical curated list for stock/finance/quant plugins.
...
- **Tags:** `awesome-list`, `inventory`
- **Why use it:** Complete inventory of 1000+ DSH tools sorted by stars.
...
- **Why use it:** Plugin product manual and navigation for DSH users.
...
- **Why use it:** Repository moved to new location

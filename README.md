...
|--------|-------|
| **Plugins tracked** | 201 |
| **Total community stars** | 1,091,794 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-25 01:19:50 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 235,171 | Core DSH platform — everything is a plugin. |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,985 | Local-first design system & prototyping for coding |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,218 | Multi-agent swarm orchestration & autonomous workf |
...
- **Why use it:** Self-evolving multi-agent harness with memory and tools.
...
- **Why use it:** Enterprise multi-harness workspace unifying Codex, DSH and OpenCode.
...
- **Why use it:** Vision bridge for text-only agents — paste images, get structured JSON
...
- **Why use it:** First virtual terminal and VFS for AI agents — isolated sandboxed environments
...
- **Tags:** `agent-skills`, `inference`, `deep-reasoning`
...
- **Why use it:** High-performance Rust agent runtime with polished desktop interface
...
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A and OCR support
...
- **Why use it:** Powerful coding agent with RPC, sub-agents, hashline edits, and MCP support
...
- **Tags:** `provider`, `oauth`, `multi-model`
...
- **Tags:** `provider`, `command-code`, `model-access`
- **Why use it:** Adds Command Code model access with live catalog and plan-aware reasoning optimization
...
- **Why use it:** Bridges Pi ecosystem to DSH via ABI compatibility layer
...
- **Why use it:** Skill audit and in-app manager for DSH plugin governance
...
- **Why use it:** Imports sessions from 25+ AI agents preserving tool calls and reasoning
...
- **Why use it:** Codex skill for building and validating DSH/Cordis plugins — essential dev tool
...
- **Why use it:** Audit AGENTS.md context, detect token costs, duplicates and conflicts via Web UI panel.
...
- **Why use it:** WorkBuddy-style skill picker for quick skill selection and slash command insertion.
...
- **Tags:** `migration`, `session-import`, `claude-code`, `dsh-plugin`
- **Why use it:** Migration wizard for moving sessions, memories, and skills between Codex, Claude Code, and DSH.
...
- **Tags:** `cordis`, `dsh`, `dsh-plugin`, `mcp`
- **Why use it:** Unlock native DSH core capabilities with unified Runtime, Provider, Plugin, Skill and MCP orchestration.
...
- **Tags:** `neovim`, `plugin-manager`, `lua`, `dev-tools`
- **Why use it:** Fast Lua Neovim plugin mgr
...
- **Why use it:** Integrate ChatGPT models directly via OAuth into DSH.
...
- **Why use it:** Modern desktop client for DSH ecosystem with plugin paradigm.
...
- **Why use it:** All-in-one enhancement suite for major AI chat platforms with prompt management.
...
- **Why use it:** Official desktop client bringing DSH to your native operating system.
...
- **Tags:** `taskboard`, `skills`, `dsh-plugin`
...
- **Why use it:** TUI supplement with whale bar, live status, streaming thought display
...
- **Why use it:** Cute draggable whale widget tracking DeepSeek account balance
...
- **Why use it:** Lightweight 5MB Tauri desktop client with preset plugins included
...
- **Why use it:** Full-featured Windows desktop GUI for DeepSeek Harness with SSH and mobile access
...
- **Why use it:** Local-first AI desktop workspace integrating sessions, files, and Office artifacts
...
- **Why use it:** Generates interactive UI components inline — charts, forms, quizzes, and layouts
...
- **Why use it:** Visual non-linear canvas-based conversation workspace for branching sessions
...
- **Tags:** `office`, `desktop-extension`, `productivity`
...
- **Why use it:** Native iOS client for DeepSeek Harness with real-time agent execution tracking
...
- **Why use it:** Web UI plugin for managing skills and MCP servers in DSH interface
...
- **Why use it:** Community plugin marketplace browser with one-click install in DSH web GUI
...
- **Why use it:** Electron desktop console for multi-tab DSH/plugin/MCP/skills management
...
- **Why use it:** Desktop bioinformatics agent with one-click install, skill store, offline mode
...
- **Tags:** `desktop`, `ssh`, `docker`, `sftp`, `db-client`
- **Why use it:** All-in-one DevOps desktop hub
...
- **Tags:** `desktop`, `electron`, `self-hosted`, `web-ui`
- **Why use it:** Desktop DSH via Electron shell
...
- **Why use it:** Open-source RAG platform turning docs into queryable knowledge.
...
- **Why use it:** Portable, local-first memory layer enabling cross-app persistent agent memory.
...
- **Tags:** `memory-os`, `rag`, `token-optimization`
...
- **Tags:** `memory-library`, `stateful-agents`, `rag`
- **Why use it:** Lightweight memory library for building stateful, context-aware AI agents.
...
- **Why use it:** Memory management kit with RAG for persistent agent knowledge
...
- **Tags:** `deepwiki`, `deepseek`, `context`
- **Why use it:** Generates structured technical docs and AI-ready context automatically
...
- **Why use it:** Converts scattered SKILL.md files into curated, retrieval-ready skill corpora
...
- **Tags:** `memory`, `context`
- **Why use it:** Proactive auto-consolidating memory injected before model speaks
...
- **Tags:** `multi-agent`, `agentic-workflow`, `swarm`
- **Why use it:** Multi-agent swarm orchestration & autonomous workflows.
...
- **Tags:** `agent-workspace`, `task-management`, `multi-device`
- **Why use it:** Unified agent workspace with task boards accessible across all devices.
...
- **Why use it:** Specialized skill for long-form web novel writing with hallucination control.
...
- **Why use it:** Comprehensive skills marketplace covering coding, docs, ML and automation.
...
- **Tags:** `agent-skills`, `workflow-automation`, `skills`
- **Why use it:** Intelligent skill routing with 21pp reward gain and 30% token reduction
...
- **Why use it:** Structured AI novel writing workflow from inspiration to final draft
...
- **Why use it:** Built-in creative writing workflows for novels, drama, games, and video scripts
...
- **Why use it:** Gives agents eyes/ears with verifiable video, audio, and OCR evidence
...
- **Tags:** `task-management`, `agent-workflow`, `local-first`
- **Why use it:** Native local task management with Agent claim/review workflow, no iframe dependencies
...
- **Why use it:** Full-stack math modeling automation, GitOps + self-verification
...
- **Tags:** `self-evolving`, `review`, `prompt-engineering`
...
- **Why use it:** Complete reverse engineering and authorized pentesting skill pack with 87 SKILL.md files
...
- **Why use it:** Industry research methodology skills with chain mapping and policy/news tracking
...
- **Why use it:** Auto-upgrades plugins in sync with DSH version changes
...
- **Why use it:** Superpowers skill port for Reasonix coding harness workflows
...
- **Why use it:** Unified skills/tools management with dynamic exposure strategies
...
- **Tags:** `skills`, `agent`
- **Why use it:** 25 pre-installed productivity skills, 10x dev efficiency boost
...
- **Why use it:** Web search, research, and integration discovery skills for agents
...
- **Tags:** `skills`, `workbench`, `typescript`
- **Why use it:** Plugin-based work platform with global skill and workspace integration
...
- **Why use it:** GB/T 9704 compliant official document processing skill for China
...
- **Why use it:** Legal litigation timeline and visualization tool for Chinese lawyers
...
- **Why use it:** Patent infringement analysis skill producing competitive reports
...
- **Tags:** `agent-skill`, `fengshui`, `iching`
- **Why use it:** Unique TCM/fengshui/I-Ching agent skill with local deterministic engine and dashboard
...
- **Why use it:** Official DSH docs archive as on-demand agent skill — essential plugin dev reference
...
- **Why use it:** Engineering quality gate: requirements grill, test, and delivery proof before ship
...
- **Why use it:** Complete math modeling toolkit: preprocessing, programming, paper writing, visualization
...
- **Why use it:** Multi-agent collaboration with independent models, MCP tools, shared workspace
...
- **Why use it:** 5-role multi-agent math modeling solver with 33 model library for competitions
...
- **Tags:** `agent-skill`, `planning`
- **Why use it:** Plan-then-act separation mechanism for AI collaboration — works across DSH/Claude/ZCode
...
- **Tags:** `agent-skills`, `deepseek-harness`, `plugin`
- **Why use it:** Official Tencent SkillHub API integration for DSH with documentation and examples.
...
- **Why use it:** Cross-platform session continuity memory for handoff between Codex and Claude Code agents.
...
- **Why use it:** Adapted code simplification skill from DSH for Codex with refactoring focus.
...
- **Why use it:** Full-stack Godot 4.x game development skill with GDScript support at runtime.
...
- **Tags:** `agent-skill`, `dev-tools`, `plugin-dev`, `llm-agent`
- **Why use it:** DSH plugin dev skill pack
...
- **Tags:** `design-systems`, `prototyping`, `ui-generator`
- **Why use it:** Local-first design system & prototyping for coding agents.
...
- **Tags:** `architecture-diagram`, `diagrams-as-code`, `agent-skills`
- **Why use it:** Generate beautiful architecture & workflow diagrams as code.
...
- **Why use it:** 530+ GPT image prompts with industrial-grade reusable templates.
...
- **Tags:** `design`, `visual`, `ppt`, `prototyping`
...
- **⭐ Stars:** 34
- **Language:** TypeScript
- **Description:** 面向 DeepSeek Harness 的电影感产品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码���件和音频资产。
- **Tags:** `agent-skills`, `remotion`, `video`
- **Why use it:** Film-quality video creation skill with 152 camera shot templates and Remotion integration.
...
- **Tags:** `ai-video`, `directorx`, `storyboard`, `dsh-plugin`
- **Why use it:** AI video/image/audio skills with configurable models and storyboard support.
...
- **Tags:** `browser-automation`, `Tencent`, `web`
...
- **Why use it:** Persistent fingerprint-spoofing browser with unlimited local profiles for agents
...
- **Tags:** `ios-automation`, `mobile-testing`, `webdriver`
- **Why use it:** Integrates live iOS Simulator and USB iPhone control into Harness conversations
...
- **Why use it:** Playwright-based browser automation plugins for DSH ecosystem
...
- **Why use it:** Cross-platform AI content discovery from Bilibili, YouTube, Xiaohongshu and more
...
- **Tags:** `routing`, `infrastructure`, `harness-tools`
- **Why use it:** Task-aware router and injector kit for intelligent DSH request routing.
...
- **Tags:** `claude-code`, `codex`, `dsh-plugin`
- **Why use it:** Multi-model account manager with smart routing and automatic failover
...
- **Tags:** `mcp`, `proxy`, `secrets`, `api-keys`
- **Why use it:** OpenRouter-style registry for agent tools, MCP proxy, and secret management
...
- **Why use it:** Comprehensive context dashboard and management tools for DSH
...
- **Tags:** `shop`, `marketplace`, `plugin-directory`
- **Why use it:** Daily-refreshed plugin marketplace with pre-review quality filtering
...
- **Why use it:** CLI and plugin manager for seamlessly installing and managing DSH ecosystem plugins
...
- **Tags:** `cybersecurity`, `ai-security`, `redteam`
- **Why use it:** AI security audit platform that detects hallucinated packages and safeguard gaps
...
- **Tags:** `remote-access`, `encryption`, `p2p`
- **Why use it:** P2P encrypted remote access across PC, Android and Web
...
- **Why use it:** Local financial DB with MCP support and IM channel integration
...
- **Why use it:** Backup, restore, migrate and sync complete DSH config including MCP and skills
...
- **Why use it:** Plugin ecosystem infrastructure with browser-based console and dev guide
...
- **Why use it:** Manage multiple isolated DSH containers with embedded WebView UI and one-click plugin import.
...
- **Tags:** `curated-list`, `directory`, `dsh-plugin`
- **Why use it:** Curated DSH plugin index
...
- **Tags:** `registry`, `open-data`, `dsh-plugins`, `skills`
- **Why use it:** Spam-filtered open-data registry
...
- **Tags:** `directory`, `ecosystem`, `install-commands`
- **Why use it:** Public DSH plugin directory
...
- **Why use it:** DSH enhancement plugin bundle
...
- **Tags:** `curated`, `practical`, `dsh-plugin`
- **Why use it:** Practical DSH plugin list
...
- **Tags:** `verified`, `directory`, `install-guidance`
- **Why use it:** Verified DSH plugin directory
...
- **Tags:** `ecosystem`, `curated-list`, `coding-agent`
- **Why use it:** DSH plugin ecosystem index
...
- **Tags:** `tts`, `xiaomi-mimo`, `audio`, `free`
- **Why use it:** Free MiMo TTS integration
...
- **Why use it:** Quality-checked DSH list 2026
...
- **Why use it:** Curated bilingual collection of DSH plugins, extensions, skills, and integrations
...
- **Why use it:** One-stop academic research platform with LaTeX, arXiv, experiments, and GPU management
...
- **Tags:** `scientific-discovery`, `agent-preset`, `epistemic-loop`
- **Why use it:** Brings Epistemic Loop methodology to scientific discovery and hypothesis testing
...
- **Tags:** `ai-encyclopedia`, `rag`, `awesome-list`
- **Why use it:** Comprehensive AI encyclopedia covering models, agents, RAG, MLOps, and learning paths
...
- **Why use it:** Cross-database academic search with citation graph, verification, and Chinese researcher support
...
- **Why use it:** Great learning resource for DSH principles and best practices
...
- **Why use it:** 11,000+ plugins catalog with search, rankings and public API
...
- **Why use it:** Plugin directory with 1958 repos, Chinese/English search and sorting
...
- **Why use it:** Interactive K-line chart analysis with technical indicators, support/resistance, and news.
...
- **Why use it:** Finance/quant DSH plugin list
...
- **Tags:** `data-visualization`, `token-usage`, `ai-cost`, `api-balance`
- **Why use it:** Real-time token cost dashboard
...
- **Why use it:** Comprehensive star-ranked plugin catalog of 1000+ DSH plugins
...
- **Tags:** `directory`, `awesome-list`, `automated`
- **Why use it:** Auto-updated daily bilingual plugin directory via GitHub Actions
...
- **Why use it:** Curated plugin catalog for discovering and exploring DSH ecosystem tools.
...
- **Why use it:** Beginner-friendly tutorial series for learning DSH harness engineering from scratch.
...
- **Tags:** `web-ui`, `plugin-ecosystem`, `aggregation`
...
- **Why use it:** Ecosystem radar scanning 21k+ plugins with automated k8s validation
...
- **Why use it:** Curated daily-scraped plugin directory with scenario filtering and real plugin verification
...
- **Why use it:** Ultimate guide and resource hub covering quickstart, plugins, and developer tools
...
- **Why use it:** Self-hosted Smartisan-style notes with Docker support and multi-tenant capability
...
- **Why use it:** Curated index of 280+ DSH plugins across 14 categories — essential discovery tool
...
- **Tags:** `awesome`, `plugin-catalog`
- **Why use it:** Unofficial community catalog of DSH plugins — useful reference but not an active plugin.
...
- **Tags:** `awesome-list`, `dsh-plugin`, `skills`, `mcp`
- **Why use it:** Curated awesome list of DSH plugins, tools, skills and resources — community index.
...
- **Tags:** `awesome-list`, `plugin-directory`
- **Why use it:** Plugin directory with 80+ verified DSH plugins organized.
...
- **Why use it:** DSH plugin repository with ecosystem tools listed.
...
- **Tags:** `awesome-list`, `bilingual`, `review`

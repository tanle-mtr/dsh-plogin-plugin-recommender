...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,052,039 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-19 04:32:15 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 229,286 | Core DSH platform enabling plugin-based agent deve |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,968 | Local-first design tool turning coding agents into |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,808 | Deploy multi-agent swarms with autonomous coordina |
...
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 31 plugins
...
- [UI & Desktop Extensions](ui-desktop-extensions) (31)
...
- **Why use it:** Core DSH platform enabling plugin-based agent development
...
- **Why use it:** Unified agent workspace with task tracking across all devices
...
- **Why use it:** Task-aware reasoning-mode router and runtime injector for DSH
...
- **Why use it:** Enterprise multi-agent workspace for Codex, DSH, and Opencode
...
- **Why use it:** Provides minimal-aligned bootstrap then full Standard tools preset for DSH.
...
- **Tags:** `ai-coding`, `ai-ide`, `agent-runtime`
- **Why use it:** High-performance Rust agent runtime
...
- **Why use it:** Enable multi-agent team collaboration
...
- **Tags:** `coding-agent`, `mcp`, `tui`
- **Why use it:** Coding agent with RPC plugin, sub-agents, hashline edits, and MCP support in a TUI interface.
...
- **Tags:** `cli`, `plugin-manager`, `developer-tools`, `ai-agent`
- **Why use it:** CLI tool for managing DSH plugins and hub operations efficiently.
...
- **Why use it:** Use ChatGPT/Claude/Grok subscriptions as DSH LLM providers seamlessly.
...
- **Tags:** `tools`, `skills`, `menu`
- **Why use it:** Unified tool/skill management with context optimization
...
- **Tags:** `plugin-creator`, `harness-tools`
- **Why use it:** Reusable skill for building and validating DSH/Cordis plugins efficiently
...
- **Tags:** `code-simplification`, `codex`, `agent-skills`
...
- **Tags:** `chatgpt`, `oauth`
- **Why use it:** Bind ChatGPT account via OAuth to use ChatGPT models in DSH
...
- **Tags:** `coding-agents`, `dsh-plugin`, `agent-harness`, `skills`
...
- **Tags:** `agent-skills`, `ui-generator`
...
- **Why use it:** Modern desktop solution treating the OS itself as a plugin
...
- **Why use it:** Adds animated pixel-art pets to your coding agent workspace for personality.
...
- **Why use it:** Modern flexible task panel embeddable into Codex and DSH workspaces.
...
- **Tags:** `desktop`, `tauri`, `easy-install`
- **Why use it:** Zero-setup desktop app, only 5MB
...
- **Tags:** `novel-writing`, `creative`, `desktop`
- **Why use it:** Organized workflow for AI novel writing
...
- **Why use it:** Zero-setup Windows desktop GUI for DSH with Codex, plugins, SSH, and mobile remote access.
...
- **Tags:** `desktop-app`, `electron`, `react`
- **Why use it:** Local-first AI desktop workspace for DSH sessions, projects, files, web research, and Office artifacts.
...
- **Tags:** `dsh-plugin`, `workspace`, `canvas`
- **Why use it:** Canvas-based non-linear conversation workspace with session explorer and branching workflows.
...
- **Tags:** `desktop-app`, `local-first`, `tauri`
- **Why use it:** Local-first multi-model AI agent desktop with self-evolving skills, privacy focus, and Tauri-based architecture.
...
- **Why use it:** Native SQLite-backed taskboard with agent claim/review features.
...
- **⭐ Stars:** 312
- **Language:** Kotlin
- **Description:** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将工作区、会话、实时回复和 Agent 执行轨迹带到 iPhone，同���延续 DeepSeek WebUI 克制、清晰的视觉语言
- **Tags:** `ios`, `mobile`, `kmp`, `coding-agent`
...
- **Why use it:** Smartisan-style notes with Docker private deploy, skill and DSH support
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI plugin for skill and MCP management
...
- **Tags:** `skills`, `audit`, `ui`
- **Why use it:** Skill call auditing and in-app skill manager
...
- **Why use it:** Electron desktop console for multi-tab management of DSH, plugins, MCP, and skills.
...
- **Tags:** `bioinformatics`, `desktop`, `tauri`, `llm-agent`
- **Why use it:** Bioinformatics agent desktop with one-click installers and offline mode
...
- **Why use it:** Web UI dashboard auditing AGENTS.md tokens, detecting duplicates and conflicts
...
- **⭐ Stars:** 29
- **Language:** JavaScript
- **Description:** DSH 实现 workbuddy 同款��择 skill 功能 | WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the official /skill-name gesture, and DSH loads it with your message.
...
- **Why use it:** All-in-one DevOps desktop: SSH, SFTP, Docker, DB, AI sandbox.
...
- **Tags:** `desktop`, `electron`, `web-ui`
- **Why use it:** Electron desktop shell wrapping DSH web with sidebar and ModLens.
...
- **Why use it:** Portable local-first memory layer for AI agents with RAG support
...
- **Tags:** `agent-memory`, `continual-learning`, `context-engineering`
- **Why use it:** Memory library for building stateful, self-evolving AI agents
...
- **Why use it:** Agent memory management kit with RAG support for long-term recall.
...
- **Why use it:** Unified memory layer for all AI agents
...
- **Tags:** `memory`, `personal-ai`, `long-term`
- **Why use it:** Personal AI memory hub with full control
...
- **Why use it:** Three-layer proactive memory with zero-prompt recall injected before responses.
...
- **Why use it:** Self-evolving multi-agent system with memory and skill planning
...
- **⭐ Stars:** 6,935
- **Language:** Python
- **Description:** 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、��新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **Tags:** `agent-skills`, `skill-store`, `coding-agent`
- **Why use it:** Largest skills store covering coding, docs, finance and more
...
- **Tags:** `agent-skills`, `skill-routing`, `vector-search`
- **Why use it:** Curates scattered SKILL.md files into retrieval-ready agent-skill corpora with evaluation tooling.
...
- **Why use it:** Gives AI agents eyes and ears — converts video, audio, and screen activity into timestamped searchable evidence.
...
- **Tags:** `agent-skills`, `creative-writing`, `novel-writing`, `ai-writing`
- **Why use it:** Full-featured AI writing toolkit for novels, short dramas, and games.
...
- **Tags:** `agent-skills`, `workflow`, `math-modeling`
- **Why use it:** Full-stack auto math modeling with GitOps pipeline and self-proof code verification
...
- **Why use it:** Comprehensive agent-first handbook with runtime, plugin and MCP guides
...
- **⭐ Stars:** 199
- **Language:** TypeScript
- **Description:** �� Agent 的工作方式可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **Tags:** `agent-skills`, `self-evolving`, `review`
- **Why use it:** Composable self-evolving agent modes with human review and plan control
...
- **Tags:** `agent-skills`, `reusable`, `multi-agent`
...
- **Why use it:** AI-native multi-agent financial analysis with local Tushare DB and IM alerts
...
- **Why use it:** Auto-finds, installs and verifies DSH plugins from GitHub
...
- **Tags:** `agent-skills`, `reverse-engineering`, `security`
- **Why use it:** Complete reverse engineering skill set with 87 SKILL.md for security research
...
- **Why use it:** Convert successful sessions into reusable agent skills
...
- **Why use it:** You.com skills for web search, research, and agent integration discovery.
...
- **Tags:** `agent-skills`, `deepseek-harness`, `mentor`
- **Why use it:** AI coding mentor that guides learners through project architecture step-by-step.
...
- **Why use it:** 25 pre-packaged Matt Pocock engineering skills for instant productivity.
...
- **Why use it:** Unified loading and secure management of local Agent Skills within DSH.
...
- **Tags:** `ai-docs`, `docx`, `gongwen`
- **Why use it:** Full lifecycle official document processing compliant with GB/T 9704 national standard.
...
- **Why use it:** Official DSH docs archive with English/Chinese support for plugin development
...
- **Tags:** `spec-driven`, `agent-skills`, `vibe-coding`
...
- **Tags:** `chinese-wisdom`, `fengshui`, `tcm`, `dashboard`
- **Why use it:** Fusion of Bazi, Fengshui, IChing, TCM via local deterministic engine
...
- **Why use it:** Engineering discipline guard: grill requirements, test implementation, prove delivery
...
- **Why use it:** QA engineer-level test automation framework with 11 skills and knowledge base
...
- **Why use it:** Cross-platform repository-local continuity memory for agent session handoff
...
- **Tags:** `skillhub`, `deepseek-harness`, `api`
- **Why use it:** Official SkillHub Open API docs and DSH plugin integration.
...
- **Why use it:** Full math modeling toolkit: data prep, coding, writing, and visualization.
...
- **Tags:** `video`, `remotion`, `skill`
- **Why use it:** Cinematic video production skill with 152 shot recipes and Remotion templates.
...
- **Why use it:** Full-stack Godot 4.x game dev skill plugin for DSH at runtime.
...
- **Why use it:** Separation-of-debate-and-action workflow for AI collaborative tasks.
...
- **Why use it:** Curated DSH plugins: notifications, LLM trace, keybindings, terminal.
...
- **Why use it:** Official Huawei Cloud plugin with MCP tools, skills, and cloud sandbox integration.
...
- **Tags:** `mcp`, `agent-config`, `deepseek-harness`
- **Why use it:** One-click MCP and skill config for Claude Code, DSH, Cursor and more.
...
- **Why use it:** Self-contained HTML architecture and sequence diagram generator
...
- **Tags:** `image-prompts`, `skills`
- **Why use it:** 530+ GPT Image prompt templates with industrial-grade reusable skills
...
- **Why use it:** First AI-native open-source vector design tool with Agent Teams
...
- **Why use it:** Auto-generate Vox-style explainer videos
...
- **⭐ Stars:** 1,355
- **Language:** JavaScript
- **Description:** DeepSeek Harness 可编辑设计系��：AI 生成、可视化编辑、模板市场与 PPT｜Native Design & PPT Studio for DeepSeek Harness.
- **Tags:** `design`, `ppt`, `templates`
- **Why use it:** AI design studio with templates and PPT
...
- **Why use it:** Generates interactive UI components — charts, forms, quizzes — rendered inline within assistant replies.
...
- **Why use it:** Legal visualization toolkit: timelines, trial diagrams, and relationship charts.
...
- **Why use it:** AI video/image/audio skills with storyboard and configurable vision tools
...
- **Why use it:** Real-time token usage charts, cost estimates, API balance monitor.
...
- **Tags:** `browser-extension`, `ai-studio`, `chatgpt`
- **Why use it:** Powerful AI browser extension with prompt manager across platforms
...
- **Tags:** `browser-use`, `cli`, `agent`
- **Why use it:** Seamless real-browser automation for AI agents without disruption
...
- **Tags:** `web-search`, `agent-skills`, `agentic-workflow`
- **Why use it:** Strongest free web search bridge plugin for models lacking native web access — no signup required.
...
- **Why use it:** Persistent identity browser with engine-level fingerprint spoofing, unlimited local profiles via Playwright.
...
- **Tags:** `ios`, `automation`, `mcp`, `ui-automation`
- **Why use it:** Live iOS Simulator inside DSH with 22 agent tools for automation.
...
- **Tags:** `agent-platform`, `web`, `workbench`
...
- **Tags:** `content-discovery`, `social`, `ai-agent`
- **Why use it:** Cross-platform AI content discovery agent from Bilibili, YouTube, X, and more.
...
- **Tags:** `resume-builder`, `mcp-server`
...
- **Tags:** `low-code`, `ai-agent`
- **Why use it:** AI-powered no-code platform for rapid business system construction
...
- **Why use it:** Essential marketplace for browsing and installing DSH plugins with one-click setup.
...
- **Why use it:** Virtual terminal with VFS for isolated agent execution environments.
...
- **Tags:** `model-switch`, `installer`, `utility`
- **Why use it:** One-click install with model switch across 10+ coding agent platforms.
...
- **Tags:** `ecosystem`, `validation`, `monitoring`
- **Why use it:** Continuous ecosystem discovery & validation
...
- **Why use it:** Context insight dashboard and management
...
- **Tags:** `marketplace`, `plugins`, `shop`
- **Why use it:** Daily refreshed comprehensive plugin market
...
- **Tags:** `cybersecurity`, `ai-security`, `vulnerabilities`
- **Why use it:** AI security offense & defense platform that audits AI-generated code for hallucinated packages and vulnerabilities.
...
- **Tags:** `cost-tracking`, `token-usage`, `utilities`
- **Why use it:** Track session and daily token costs with budget alerts and history.
...
- **Why use it:** Secure multi-device remote access to Harness via P2P encrypted network
...
- **Why use it:** One-click bridge to run Pi extensions as native DSH plugins
...
- **Why use it:** Backup, restore and sync DSH config via WebDAV
...
- **Why use it:** Plugin ecosystem infrastructure: browser console for official repository management.
...
- **Why use it:** Pixel-to-text OCR skill enabling text-only models to process images
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `containers`
...
- **Tags:** `migration`, `dsh-plugin`, `claude-code`
- **Why use it:** Migrate sessions, memories and skills from Claude Code/Codex to DSH.
...
- **Tags:** `cordis`, `dsh-plugin`, `orchestration`
...
- **Why use it:** Evidence-backed evaluation and observability for prompts, RAG, and agents.
...
- **Tags:** `debugging`, `conflict-resolution`, `utility`
...
- **Why use it:** Cute whale girl skin series
...
- **Why use it:** Highly customizable frosted glass theme for DSH web UI — adjustable blur,磨砂, backgrounds, and wallpaper.
...
- **Tags:** `theme`, `skin`, `customization`, `animated-background`
- **Why use it:** Beautiful ocean theme with adjustable waves and glassmorphism effects.
...
- **Tags:** `webui`, `dsh-plugin`
- **Why use it:** Customizable web UI backgrounds with presets and image upload
...
- **Tags:** `ai-guide`, `vibe-coding`
- **Why use it:** Comprehensive AI resource library covering prompts, skills, and RAG
...
- **Why use it:** Generates accurate technical docs and AI-ready context from codebases.
...
- **Why use it:** Searches Chinese platforms for research
...
- **Tags:** `arxiv`, `latex`, `research-tools`
- **Why use it:** All-in-one research workbench: LaTeX writing, arXiv management, experiment tracking, and GPU SSH orchestration.
...
- **Tags:** `awesome-list`, `plugin-curation`, `guide`
- **Why use it:** Curated plugin directory with scenario classification and reviews.
...
- **Tags:** `awesome-list`, `mcp`, `plugin-curation`
- **Why use it:** Comprehensive curated list of DSH plugins, MCP servers, and tools.
...
- **Tags:** `awesome-list`, `guide`, `developer-tools`
...
- **Tags:** `guide`, `practices`, `marketplace`
...
- **Why use it:** Comprehensive academic search with cross-source dedup and citation graph support
...
- **Tags:** `chinese-api`, `api-documentation`, `research`
- **Why use it:** Search 65,600+ API docs from 20 major Chinese platforms directly in DSH.
...
- **Why use it:** Patent infringement analysis system with RAG-backed claim chart generation.
...
- **Tags:** `quant`, `finance`, `stock`, `trading`
- **Why use it:** Verified stock/finance/quant plugins for DSH — bilingual list.
...
- **Why use it:** Comprehensive curated plugin directory for DSH ecosystem
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Verified and star-ranked community plugin listings
...
- **Tags:** `awesome-list`
- **Why use it:** Curated DSHA精选插件合集 plugin collection
...
- **Why use it:** Auto-updated daily GitHub Actions plugin directory, bilingual
...
- **Why use it:** Zero-dependency static portal for discovering 227+ DSH plugins
...
- **Why use it:** Searchable plugin discoverability tool from inside DSH agents
...
- **Tags:** `dsh-web`, `plugin-marketplace`
- **Why use it:** DSH web plugin marketplace for community-driven plugin discovery
...
- **Tags:** `awesome-list`, `resources`, `meta`
- **Why use it:** Curated plugin list and resources
...
- **Why use it:** Powerful vision toolkit for text models
...
- **Why use it:** Bilingual curated awesome list of DSH plugins, extensions, tools, skills, clients, and runtimes.
...
- **Tags:** `dsh-plugin`, `ai-pedia`, `awesome-list`
- **Why use it:** Comprehensive AI resource encyclopedia covering LLMs, agents, RAG, MLOps, and zero-to-hero learning paths.
...
- **Why use it:** Largest DSH plugin directory with 11K+ plugins, search and rankings
...
- **Tags:** `catalog`, `awesome-list`, `directory`
- **Why use it:** Plugin catalog with 1958 repos, bilingual search and STAR rankings
...
- **Why use it:** Curated list of DSH tools and development resources
...
- **Why use it:** Community-curated DSH plugin catalog with auto-sync and weekly maintenance.
...
- **Why use it:** Unofficial community catalog listing all DSH plugins.
...
- **Tags:** `awesome-list`, `curated-list`, `plugin-registry`
...
- **Why use it:** Evidence-led directory with verified extensions and permission guidance.
...
- **Tags:** `awesome-list`, `inventory`, `1000+`
- **Why use it:** Complete DSH tool inventory: 1000+ repos sorted by stars.
...
- **Tags:** `dsh-plugin-market`, `plugins`
...
- **Why use it:** Curated directory of 80+ verified DSH plugins for easy discovery.
...
- **Tags:** `deepseek-harness`, `dsh-plugins`, `plugin-verify`
- **Why use it:** DSH plugin repository with verification and analytics features.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `auto-update`

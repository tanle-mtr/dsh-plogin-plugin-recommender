...
|--------|-------|
| **Plugins tracked** | 197 |
| **Total community stars** | 988,924 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-09 04:02:59 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 216,487 | Core DSH platform — everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,979 | Local-first design tool with vibe coding support |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,697 | Multi-agent swarm coordination with autonomous wor |
...
- **Why use it:** Terminal-native coding agent with prompt caching for R1
...
- **Why use it:** Essential zero-to-one harness engineering tutorial for beginners.
...
- **Tags:** `agent-harness`, `agent-skills`, `no-code`, `mcp`
...
- **Tags:** `agent-ops`, `long-horizon`, `workflow-automation`
...
- **Tags:** `virtual-terminal`, `vfs`, `agent-sandbox`, `agent-tools`
- **Why use it:** Virtual terminal and filesystem layer that gives agents sandboxed compute isolation.
...
- **Tags:** `model-switch`, `claude-code`, `deepseek-harness`, `multi-agent`
- **Why use it:** One-click install and model switch across Claude Code, Codex, DeepSeek, Kimi, Qwen, etc.
...
- **Tags:** `taskboard`, `cli`, `skills`, `dsh-plugin`
...
- **Tags:** `agent-runtime`, `rust`, `desktop`, `vibe-coding`, `openclaw`
- **Why use it:** High-performance Rust agent runtime paired with a polished desktop coding application.
...
- **Why use it:** Powerful vision toolkit for text-only LLMs: image Q&A, OCR, UI restoration
...
- **Tags:** `plugin`, `build-tool`, `developer`
- **Why use it:** Streamlines plugin building with slots and credential management
...
- **Tags:** `ocr`, `vision`, `image`, `utility`
- **Why use it:** Enables image-to-text for text-only models via OCR and scanning
...
- **Tags:** `plugin`, `creator`, `toolkit`, `developer`
- **Why use it:** Reusable toolkit for building and validating DSH/Cordis plugins
...
- **Tags:** `deepseek-harness`, `guard`, `quality-gate`, `engineering-discipline`
- **Why use it:** Quality gate and requirements grill bundle before shipping code.
...
- **Tags:** `deepseek-harness`, `plugin`, `developer`, `skill`
- **Why use it:** Guides AI agents through 0-to-1 DSH plugin development workflow.
...
- **Tags:** `deepseek-harness`, `plugin`, `agent-skill`, `development`
- **Why use it:** Agent skill for standard DSH plugin/service/tool/adapter development.
...
- **Why use it:** Fast Neovim plugin manager written in pure Lua
...
- **Why use it:** Pre-flight plugin check for agents, boosts plugin utilization predictably
...
- **Tags:** `design-systems`, `ui-generator`, `vibe-coding`
- **Why use it:** Local-first design tool with vibe coding support
...
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, Git, sub-agent pages.
...
- **Tags:** `tui`, `terminal`, `claude-code`, `deepseek-harness`
- **Why use it:** Claude Code-style TUI with whale header, streaming thought, and TPS progress display.
...
- **Tags:** `widget`, `deepseek-harness`, `ui`
- **Why use it:** Cute floating whale widget showing your DeepSeek account balance in real time
...
- **Why use it:** Lightweight 5MB Tauri desktop app with preset plugins, zero setup needed
...
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, projects and Office files
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Unified skill/MCP management panel for DSH Web UI
...
- **Why use it:** One-click install/uninstall plugins via web GUI market
...
- **Tags:** `desktop`, `electron`, `ui`, `plugin-mgmt`
...
- **Tags:** `ui`, `balance`, `pricing`, `usage-tracking`
- **Why use it:** Live balance, pricing info and countdown in a persistent bottom bar
...
- **Why use it:** Audit context tokens, detect conflicts with a visual ring dashboard
...
- **Tags:** `deepseek-harness`, `desktop`, `devops`, `docker`, `ssh`
...
- **Why use it:** Free Xiaomi MiMo TTS integration with browser voices
...
- **Why use it:** Custom web backgrounds with real-time preview and presets
...
- **Why use it:** Desktop Electron wrapper with ModLens and sidebar integration
...
- **Tags:** `ui`, `desktop`
- **Why use it:** Adds one-click compact button to DSH Web context meter panel
...
- **Why use it:** LLM knowledge platform with RAG, reasoning agent and wiki
...
- **Tags:** `agent-memory`, `rag`, `local-first`, `markdown`
- **Why use it:** Local-first portable memory layer across all AI agents.
...
- **Why use it:** Lightweight memory library enabling stateful agent persistence.
...
- **Why use it:** Dedicated memory management kit: remember, refine, and persist agent context.
...
- **Why use it:** Persistent unified memory layer backed by Markdown + Milvus hybrid search.
...
- **Tags:** `skill-corpus`, `semantic-search`, `rag`
- **Why use it:** Turns SKILL.md files into retrieval-ready corpora with semantic search and evaluation
...
- **Why use it:** Proactive three-layer associative memory with auto-consolidation
...
- **Why use it:** Self-evolving AI assistant with multi-agent and memory support
...
- **Why use it:** 20+ industrial prompt templates for GPT-Image2
...
- **Tags:** `agent-skills`, `skill-marketplace`, `automation`
- **Why use it:** Largest skill marketplace with auto-synced GitHub skills by category.
...
- **Tags:** `agent-collaboration`, `multi-agent`, `enterprise`, `workspace`
- **Why use it:** Enterprise multi-agent workspace with visual editor for teams.
...
- **Why use it:** Two-phase preset for clean bootstrap then full Standard tools adoption.
...
- **Tags:** `agent-skills`, `workflow-automation`, `prompt-engineering`, `multi-agent`
- **Why use it:** Intelligent skill routing and workflow orchestration boosting reward by +21pp.
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `inference-time-control`, `global-workspace`
...
- **Why use it:** Enable multi-agent team collaboration within the DeepSeek Harness ecosystem
...
- **Tags:** `agent-review`, `self-evolving`, `skills`
...
- **Why use it:** Turns experience into repeatable agent execution patterns
...
- **Tags:** `vision`, `multimodal`, `claude-code`, `skills`
...
- **Tags:** `skills`, `research`, `marketing`, `multi-platform`
...
- **Tags:** `security`, `reverse-engineering`, `ctf`, `skills`
- **Why use it:** 87 SKILL.md files covering reverse engineering and pentesting workflows
...
- **⭐ Stars:** 72
- **Language:** TypeScript
- **Description:** ProMentor 是一��� AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `mentor`, `skills`, `coding`
- **Why use it:** AI coding mentor: architecture scan, chapter guidance, review
...
- **Tags:** `fintech`, `backtesting`, `skills`, `mcp`
- **Why use it:** AI investment desk skill pack with multi-strategy backtesting
...
- **Tags:** `skills`, `engineering`, `deck`, `productivity`
- **Why use it:** 25 pre-built engineering skills, right-panel access, zero config
...
- **Tags:** `spec`, `coding`, `agent`, `workflow`
- **Why use it:** Spec-driven development skill with repository-native patterns
...
- **Why use it:** Official docs archive with agent skill integration for plugin development
...
- **Why use it:** Multi-agent team with shared workspace and independent models/tools
...
- **Why use it:** Unique Chinese metaphysics skill covering Bazi, Fengshui, IChing and TCM
...
- **Tags:** `agent-skill`, `code-simplification`, `codex`
- **Why use it:** Codex-style skill adapted for DSH to auto-find and simplify code
...
- **Why use it:** 11 QA skills with shared knowledge base and decision matrix for tests
...
- **Why use it:** Cross-platform session continuity memory for agent task handoff
...
- **Tags:** `deepseek-harness`, `skill`, `api`, `documentation`
...
- **Tags:** `agent-skills`, `ai-agent`, `interactive-narrative`, `roleplay`
- **Why use it:** Rich interactive narrative skill with NPC memory and YAML save system.
...
- **Tags:** `deepseek-harness`, `godot`, `game-development`, `gdscript`
...
- **Tags:** `deepseek-harness`, `video`, `motion-design`, `remotion`
...
- **Why use it:** Multi-agent product team simulation for project workflows
...
- **Tags:** `diagrams-as-code`, `mermaid-alternative`, `architecture`
...
- **Tags:** `design`, `agent-team`, `vibedesign`, `flutter`
- **Why use it:** First open-source AI-native vector design tool with Agent Teams.
...
- **Tags:** `vision`, `ocr`, `image-to-text`, `agent-skills`
- **Why use it:** Adds vision/OCR to any text-only coding agent via structured JSON output.
...
- **Why use it:** Native design system with AI generation, visual editor, templates and PPT support
...
- **Tags:** `design`, `ui`, `openpencil`, `visual`
...
- **Why use it:** Legal timeline and case diagram generator, court-ready output
...
- **Tags:** `ai-video`, `ai-image`, `directorx`, `multimodal`
...
- **Tags:** `deepseek-harness`, `design`, `ui`, `vibe-coding`, `web-design`
- **Why use it:** 6 design styles to keep vibe-coded sites away from generic AI look.
...
- **Why use it:** Cross-platform AI chat enhancement suite with prompt manager
...
- **Tags:** `browser-automation`, `agent`, `tencent`
- **Why use it:** Let AI agents automate your real logged-in browser without interruption
...
- **Tags:** `chatgpt`, `oauth`, `web`
- **Why use it:** OAuth integration to use ChatGPT models inside DSH directly
...
- **Tags:** `notes`, `productivity`, `communication`
- **Why use it:** Smartisan-style open notes app with skill calls and multi-tenant support
...
- **Tags:** `dingtalk`, `communication`, `bot`
- **Why use it:** DingTalk IM channel with streaming bot and tool-capable agent
...
- **Why use it:** Ultra-fast image uploader supporting 60+ hosting services
...
- **Tags:** `low-code`, `internal-tools`, `ai-agent`
...
- **Tags:** `routing`, `agent-ops`, `mcp`, `infrastructure`
- **Why use it:** Runtime injector + task-aware router for enhanced agent reasoning.
...
- **Why use it:** Built-in plugin marketplace for browsing, searching, and one-click DSH installs.
...
- **Tags:** `plugin-discovery`, `ecosystem`, `radar`
- **Why use it:** Self-deployable plugin ecosystem radar discovering 15900+ candidates automatically
...
- **Why use it:** Comprehensive curated plugin ecosystem list for DeepSeek Harness
...
- **Tags:** `catalog`, `plugin-discovery`, `directory`
- **Why use it:** Comprehensive plugin catalog with search, filters, and star ranking
...
- **Why use it:** Bridge Pi and DSH ecosystems via ABI compatibility layer
...
- **Tags:** `remote`, `p2p`, `infrastructure`, `encryption`
- **Why use it:** Secure P2P multi-device remote access for DSH with E2E encryption
...
- **Why use it:** Official LLM provider plugin with plan-aware model picker support
...
- **Why use it:** Curated awesome list of the best DSH plugins and resources
...
- **Why use it:** Auto-upgrades skills when DSH version updates
...
- **Why use it:** Backup/restore DSH config via WebDAV sync
...
- **Why use it:** Plugin ecosystem infrastructure with zero-patch management
...
- **⭐ Stars:** 45
- **Language:** Python
- **Description:** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制���景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `office`, `docx`, `utility`
- **Why use it:** GB/T 9704 compliant Chinese official document processing tool
...
- **Why use it:** Container-based multi-DSH management with WebView and plugin import
...
- **Why use it:** One-click MCP/skills config sync across 7+ AI agent tools locally
...
- **Why use it:** Bidirectional bridge between Codex and DSH with chat sync and MCP mirroring
...
- **Tags:** `token-usage`, `data-visualization`, `api-cost`
- **Why use it:** Track token usage and API costs in real-time
...
- **Tags:** `plugin-doctor`, `conflict-resolution`, `debug`
...
- **Tags:** `pixel-art`, `mascot`, `theme`, `css`
- **Why use it:** Animated pet mascot gallery for popular AI coding agent platforms.
...
- **Tags:** `theme`, `skin`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Whale Girl themed visual skin series for personalizing your DeepSeek Harness.
...
- **Tags:** `ai-agent`, `vibe-coding`, `mcp`, `rag`
...
- **Tags:** `content-discovery`, `ai-agent`, `cross-platform`, `self-hosted`
- **Why use it:** Self-evolving cross-platform content discovery agent across B站、小红书、YouTube等。
...
- **Why use it:** Auto-searches 8 major Chinese platforms for 30-day content analysis and reports
...
- **Tags:** `finance`, `research`, `multi-agent`, `mcp`
- **Why use it:** AI-native financial analysis with multi-agent support and MCP
...
- **Tags:** `research`, `analysis`, `industry`
- **Why use it:** Industry/company research methodology skills pack
...
- **Why use it:** Patent analysis with RAG; produces infringement reports
...
- **Tags:** `kline`, `finance`, `chart`, `analysis`
- **Why use it:** Interactive K-line chart with technical indicators and market analysis
...
- **Tags:** `deepseek-harness`, `evaluation`, `rag-evaluation`, `prompt-engineering`
...
- **Tags:** `dsh-plugin`, `registry`, `curated-list`
- **Why use it:** Spam-filtered curated DSH plugin registry with quality control
...
- **Tags:** `finance`, `stock`, `trading`, `quant`
...
- **Tags:** `curated-list`, `dsh-plugin`, `installation`
- **Why use it:** Evidence-led plugin directory with permission-aware installation guide
...
- **Tags:** `awesome-list`, `verified`, `dsh-plugin`
...
- **Why use it:** Full 1000+ repo DSH tool directory sorted by stars
...
- **Why use it:** Search npm and awesome-dsh-plugin directly from DSH agents
...
- **Tags:** `recommender`, `ai-curated`
- **Why use it:** AI-curated plugin list with 12 categories updated hourly
...
- **⭐ Stars:** 407
- **Language:** JavaScript
- **Description:** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或���定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
...
- **Why use it:** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 G
...
- **Why use it:** Give DeepSeek Harness a real office envi
...
- **Why use it:** WebGPU ocean skin for DeepSeek Harness —
...
- **Why use it:** DeepSeek Harness session cost meter plug
...
- **Why use it:** A curated list of plugins, skills, MCP s
...
- **Why use it:** 全栈式自动数学建模竞赛Skill，支持 Claude Code / Codex 
...
- **Why use it:** DeepSeek Harness plugin store, marketpla
...
- **Tags:** `deepseek`, `deepseek-harness`, `deepseek-harness-plugin`, `dsh-plugin`, `ios`, `ios-app`, `ios-swift`
- **Why use it:** DeepSeek Harness Mobile 是一个面向 DeepSeek H
...
- **Why use it:** Academic Paper Search：中文科研用户的 Codex / Cl
...
- **Why use it:** Curated list of DSH plugins and development resources
...
- **Tags:** `bioinformatics`, `desktop-app`, `single-cell`, `clinical`
- **Why use it:** Specialized bioinformatics agent desktop for clinicians and wet-lab scientists
...
- **Tags:** `deepseek-harness`, `awesome-list`, `plugin-catalog`
...
- **Tags:** `deepseek-harness`, `awesome-list`, `curated`
- **Why use it:** Curated list of精选 DSH plugins for ecosystem exploration.
...
- **Tags:** `deepseek-harness`, `awesome-list`, `resources`
- **Why use it:** Comprehensive curated awesome list of DSH plugins, tools, and resources.
...
- **Tags:** `deepseek-harness`, `awesome-list`, `plugin-directory`
...
- **Tags:** `awesome-list`, `catalog`
- **Why use it:** Curated automated plugin directory with daily GitHub updates
...
- **Why use it:** Static portal for browsing and filtering 227+ DSH plugins
...
- **Why use it:** DeepSeek Harness plugin ecosystem directory and analytics
...
- **Why use it:** DSHA精选插件合集， curated plugin collection
...
- **Tags:** `awesome-list`, `evidence-led`
...
- **Why use it:** Plugin radar and 2Origin lab with evidence-backed listings
...
- **Tags:** `index`, `metadata`, `migrated`
- **Why use it:** Plugin index repo, now migrated elsewhere; not directly useful
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `index`, `list`, `low-activity`
- **Why use it:** DSH plugin list, minimal activity, not a functional plugin

...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 993,278 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-09 20:44:12 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 217,378 | Core framework for plugin-based AI agent developme |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,136 | Open-source design tool powered by AI agents. |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,801 | Multi-agent swarm orchestrator with autonomous wor |
...
- [Communication & Social](#communication-&-social) — 4 plugins
...
- **Tags:** `ai-agent`, `multi-agent`, `skills`
- **Why use it:** Super AI assistant with memory, multi-agent, and self-evolution.
...
- **Tags:** `routing`, `mcp`, `harness-tools`
- **Why use it:** Task-aware router and injector kit for reasoning mode routing
...
- **Why use it:** First vision plugin for text-only coding agents with OCR and structured JSON output
...
- **Tags:** `agent-runtime`, `desktop`, `rust`, `coding-agent`
...
- **Tags:** `agent-skills`, `computer-vision`, `dsh-plugin`, `ocr`
- **Why use it:** One-line vision toolkit for text-only LLMs: image Q&A, long-screenshot OCR, and UI restoration.
...
- **Why use it:** Terminal coding agent with RPC, sub-agents, hashline edits, and MCP support.
...
- **Why use it:** Live iOS Simulator and USB iPhone access with 22 agent automation tools
...
- **Why use it:** Runs Pi extensions natively in DSH via ABI compatibility layer
...
- **Why use it:** Superpowers skills ported for Reasonix coding harness
...
- **Why use it:** AI coding mentor that guides project architecture and reviews code
...
- **Why use it:** Core plugin management console for DSH ecosystem infrastructure
...
- **Tags:** `plugin-dev`, `coding-agents`
- **Why use it:** Agent skill to build and validate DSH/Cordis plugins easily
...
- **Why use it:** Audits context token cost, detects duplicates/conflicts in AGENTS.md and tools
...
- **Tags:** `game-development`, `godot-engine`, `dsh-plugin`
- **Why use it:** Enables Godot 4.x full-stack game dev skills in DSH runtime
...
- **Why use it:** Pre-flight plugin-library check for DSH agents to boost utilization.
...
- **Tags:** `web-ui`, `plugin-aggregation`, `dsh-web`
- **Why use it:** Web UI aggregation platform for DSH plugin ecosystem
...
- **Tags:** `sidebar`, `ui`, `desktop-extension`, `dsh`
...
- **Tags:** `taskboard`, `ui`, `coding-agent`, `skills`
- **Why use it:** Modern flexible task panel embeddable into Codex and DeepSeek Harness interfaces
...
- **Why use it:** Claude Code style TUI with whale theme, real-time status, streaming thinking display
...
- **Tags:** `deepseek-harness`, `desktop`, `dsh-plugin`, `tauri`
- **Why use it:** Lightweight Tauri desktop client with zero setup, preset plugins, cross-platform support.
...
- **Tags:** `agentic-workflows`, `dsh-plugin`, `electron`, `desktop-app`
- **Why use it:** Local-first Electron desktop workspace for DSH sessions, projects, files, and Office artifacts.
...
- **Why use it:** Open-source Windows desktop GUI with plugins, SSH, and mobile remote access.
...
- **Why use it:** Interactive inline UI components (charts, forms, quizzes) in assistant replies.
...
- **Tags:** `desktop`, `tauri`, `local-first`, `multi-model`
...
- **Why use it:** Full office suite: spreadsheets, docs, slides, canvases integrated into Harness
...
- **Why use it:** CodePilot-inspired desktop client with cross-platform Electron support
...
- **Why use it:** Native iOS client with WebSocket connection for workspace and session access
...
- **Tags:** `ui`, `mcp`, `capability`
- **Why use it:** Unified menu to manage MCP tool exposure and execution mode
...
- **Tags:** `desktop`, `ui`, `plugin-management`
- **Why use it:** Desktop hub for managing plugins, MCP, skills via Electron UI
...
- **Why use it:** Shows provider/model, balance, pricing with countdown in persistent bottom bar
...
- **Why use it:** WorkBuddy-style skill picker in DSH composer, insert /skill-name gesture instantly
...
- **Why use it:** All-in-one DevOps desktop: DB client, SSH, Docker, SFTP in one window
...
- **Why use it:** Transforms recent chat history into beautiful downloadable knowledge cards.
...
- **Tags:** `memory`, `rag`, `agent-memory`, `markdown`
- **Why use it:** Portable, user-owned Markdown-based memory layer for agents
...
- **Tags:** `memory`, `agentic-rag`, `continual-learning`
- **Why use it:** Memory library for building stateful and continual-learning agents
...
- **Why use it:** Professional memory management kit for agents with remember and refine capabilities
...
- **Why use it:** Persistent unified memory layer for AI agents backed by Milvus and semantic search
...
- **Tags:** `agent`, `memory`, `dsh-plugin`, `long-term-memory`
- **Why use it:** Personal AI memory hub providing shared persistent context across all AI agents.
...
- **Why use it:** Best context insight and management tool with dashboard, browser view, and statistics.
...
- **Tags:** `agent-memory`, `dsh-plugin`, `embeddings`, `semantic-search`
- **Why use it:** Turns scattered SKILL.md files into retrieval-ready corpora with semantic search and evaluation.
...
- **Tags:** `knowledge-base`, `ai-encyclopedia`, `mcp`, `rag`
- **Why use it:** Comprehensive AI encyclopedia covering skills, MCP, RAG, and learning roadmaps.
...
- **Tags:** `evaluation`, `rag-evaluation`, `dsh-plugin`
- **Why use it:** Evidence-backed evaluation and observability for prompts and RAG systems
...
- **Why use it:** Distill expert thinking into reusable skills for any agent.
...
- **Tags:** `skills`, `skills-store`, `agent-skills`
- **Why use it:** Largest skills store with auto-curated package installation
...
- **Tags:** `agent-os`, `loop-engineering`, `mcp`, `llm-evaluation`
...
- **Tags:** `agent-control-plane`, `workflow`, `loopx`
...
- **Tags:** `preset`, `skills`, `workflow`, `deepseek-harness`
- **Why use it:** Two-phase preset combining minimal bootstrap with full Standard tools for DSH
...
- **Tags:** `skills`, `workflow`, `orchestration`, `agent-skills`
- **Why use it:** Intelligent skill routing and workflow orchestration reducing tokens by 29.6%
...
- **Tags:** `cognitive-enhancement`, `agent-skills`, `j-space`, `workflow`
...
- **Tags:** `ai-video`, `dsh-plugin`, `ffmpeg`, `agent-skill`
- **Why use it:** End-to-end automated Vox-style video generation agent skill with ffmpeg pipeline.
...
- **Tags:** `dsh-plugin`, `research`, `web-search`, `claude-code`
- **Why use it:** Automatically searches 8 major Chinese platforms and generates well-sourced research reports.
...
- **Why use it:** Enables multi-agent team collaboration workflows within DeepSeek Harness ecosystem.
...
- **Why use it:** Multimodal skill turning video, audio, and screen into timestamped evidence.
...
- **Why use it:** Specialized skills for novel writing and short-drama production workflows.
...
- **Tags:** `task-management`, `agent`, `native`
- **Why use it:** Native SQLite-backed taskboard with agent claim/review workflow, no iframes needed
...
- **Tags:** `competition`, `modeling`, `skill`
...
- **Tags:** `acceptance-review`, `plan-mode`, `prompt-engineering`
- **Why use it:** Enables composable agent self-evolution with human-reviewed improvements
...
- **Tags:** `finance`, `agent`, `tushare`
- **Why use it:** Multi-agent financial analysis with Tushare data and skill extensibility
...
- **Tags:** `patent`, `legal-tech`, `skills`
- **Why use it:** Patent infringement analysis with multi-agent skill support
...
- **Why use it:** 25 built-in engineering skills via sidebar panel integration
...
- **Tags:** `docx`, `gongwen`, `skills`
- **Why use it:** Full government document workflow per GB/T 9704 national standard
...
- **Tags:** `spec-driven`, `skills`, `coding`
...
- **Why use it:** Official DSH plugin dev knowledge base with EN/ZH docs as agent skill
...
- **Why use it:** Multi-agent collaboration with shared workspace and independent skills/MCP per agent
...
- **Why use it:** Adapted Codex skill for code simplification, works as DSH agent skill
...
- **Why use it:** 11 QA testing skills with shared knowledge base and type-decision matrix for agents
...
- **Why use it:** Cross-platform agent handoff skill preserving repo-local continuity memory
...
- **Why use it:** Rich NPC roleplay skill with memory,立场 and YAML存档 support
...
- **Tags:** `skill`, `dsh-plugin`
- **Why use it:** Official SkillHub Open API docs and plugin from Tencent
...
- **Why use it:** Engineering discipline bundle: grill requirements before shipping
...
- **Tags:** `dsh-plugin`, `skill`, `plugin-dev`
- **Why use it:** Guides AI agents through 0-to-1 DSH plugin development lifecycle
...
- **Tags:** `agent`, `preset`, `product-team`
...
- **Why use it:** Official Huawei Cloud MCP tools, skills, guardrails and sandbox
...
- **Why use it:** One-click MCP/Skills/config sync across Claude Code, Codex, DSH, Cursor, Gemini CLI
...
- **Tags:** `codex`, `sync`, `mcp`
- **Why use it:** Bidirectional chat sync and auto MCP mirroring bridge between Codex and DSH
...
- **Tags:** `mcp`, `dsh-plugin`, `web-ui`
- **Why use it:** Manage skills and MCP servers via DSH Web GUI settings panel
...
- **Why use it:** Open-source design tool powered by AI agents.
...
- **Tags:** `diagrams`, `mermaid`, `architecture-as-code`
...
- **Tags:** `design`, `ui`, `vibedesign`, `agent-team`
...
- **Tags:** `ai-design`, `deepseek-harness`, `dsh-plugin`, `visual-editor`
- **Why use it:** Native design system with AI generation, visual editor, template marketplace, and PPT studio.
...
- **Why use it:** Legal litigation visualization tools for timelines and diagrams
...
- **Why use it:** Pixel-to-text OCR for text-only models via image reading skills
...
- **Why use it:** AI video/image/audio skills with DirectorX, configurable vision and media models
...
- **Why use it:** Browser extension suite enhancing Gemini, Claude, ChatGPT UX.
...
- **Tags:** `content-discovery`, `browser`, `cross-platform`, `automation`
- **Why use it:** Cross-platform AI content discovery agent from Bilibili, YouTube, Reddit and more
...
- **Why use it:** Enables AI agents to use real logged-in browsers via CLI and extension integration.
...
- **Why use it:** Free web search bridge for models without native browsing, no signup needed.
...
- **Why use it:** Privacy-first open-source resume builder for professionals.
...
- **Why use it:** DingTalk IM channel plugin enabling stream-mode bot with emotion read-receipts.
...
- **Why use it:** Built-in plugin marketplace with one-click install and search within DSH
...
- **Tags:** `utility`, `model-switch`, `multi-agent`, `infrastructure`
- **Why use it:** One-click switch between Claude Code, Codex, DeepSeek, Kimi and other coding agents
...
- **Why use it:** Curated plugin discovery with daily GitHub scraping and real plugin verification
...
- **Why use it:** Session and daily cost tracking with budget alerts and token usage history
...
- **Tags:** `learning`, `marketplace`, `education`
...
- **Why use it:** Open-source CLI and resolver for DSH Plugin Hub with schema definitions
...
- **Why use it:** Curated list of plugins, skills, MCP servers and UIs with visualization features
...
- **Why use it:** Plugin marketplace with 11,000+ plugins, search, rankings and public API
...
- **Why use it:** LLM provider plugin with plan-aware model picker and reasoning support
...
- **Tags:** `remote-access`, `dsh-plugin`, `security`
...
- **Why use it:** Full backup, restore, sync and migration for DSH configs
...
- **Tags:** `container`, `multi-version`, `dsh-plugin`
...
- **Why use it:** Real-time token usage and cost tracking charts
...
- **Tags:** `doctor`, `conflicts`, `utilities`
- **Why use it:** Plugin conflict detection and resolution tool
...
- **Tags:** `theme`, `pets`, `pixel-art`, `mascot`
- **Why use it:** Animated pet gallery theme for multiple AI coding agents
...
- **Why use it:** Popular whale girl skin series with high star count and strong community adoption.
...
- **Why use it:** Glassmorphism theme with full customization for blur,磨砂, and background.
...
- **Tags:** `theme`, `webgpu`, `ocean`, `chrome-extension`
- **Why use it:** WebGPU ocean-themed visual skin via Chrome/Edge extension with Three.js.
...
- **Tags:** `background`, `ui`, `themes`
- **Why use it:** Web UI background personalization with presets
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `ecosystem-radar`, `plugin-registry`
- **Why use it:** Self-hostable plugin ecosystem radar auto-discovering 15900+ candidates with CI validation.
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `plugins`
- **Why use it:** Curated list of DSH ecosystem plugins, tools, and infrastructure from hub and public topics.
...
- **Why use it:** Comprehensive curated plugin ecosystem list covering CLI, web UI, and agent harness features.
...
- **Why use it:** Complete research workbench: LaTeX editing, arXiv management, GPU SSH orchestration
...
- **Why use it:** Academic paper search across CrossRef, PubMed, arXiv with citation graph support
...
- **Why use it:** Domain research skills with methodology and news tracking
...
- **Why use it:** Interactive K-line analysis with multi-market data, indicators, and fundamental news
...
- **Why use it:** Stock/finance/quant DSH plugin vertical list
...
- **Why use it:** Comprehensive curated list of DSH plugins sorted by popularity.
...
- **Why use it:** Automated daily crawled DSH plugin directory with bilingual support.
...
- **Why use it:** Plugin discoverability: search npm and curated lists inside DSH agents.
...
- **Tags:** `dsh-bundle`, `dsh-ecosystem`
- **Why use it:** General DSH plugins repository.
...
- **Why use it:** Redirect notice to moved repository.
...
- **Tags:** `awesome-list`, `curated-list`, `bilingual`, `plugins`
- **Why use it:** Curated DSH plugin directory with bilingual coverage, ideal starting point.
...
- **Tags:** `plugin-market`, `curated-list`, `daily-update`
- **Why use it:** Comprehensive daily-updated plugin marketplace with pre-screening quality.
...
- **Why use it:** Comprehensive DSH plugin catalog with 1819+ plugins and search/filter
...
- **Why use it:** Comprehensive agent-first DSH handbook with 173+ resources
...
- **Tags:** `awesome-list`, `plugins`
- **Why use it:** Official curated list of DSH Cordis plugins
...
- **Tags:** `marketplace`, `community`, `awesome-list`
...
- **Why use it:** Public GitHub directory with DSH plugin install commands
...
- **Why use it:** Open-data plugin registry for DSH ecosystem
...
- **Tags:** `awesome-list`, `plugins`, `skills`
- **Why use it:** Curated awesome list of DSH plugins and skills
...
- **Tags:** `curated`, `directory`, `plugins`
- **Why use it:** Evidence-led curated DSH plugin directory
...
- **Tags:** `2026`, `quality`, `curated`
- **Why use it:** Quality-checked 2026 DSH plugin list
...
- **Tags:** `star-ranked`, `community`, `verified`
...
- **Tags:** `manual`, `navigation`, `docs`
- **Why use it:** Plugin product manual and navigation guide
...
- **Language:** Unknown
- **Description:** DSH插件
- **Tags:** `plugin-list`, `dsh`
- **Why use it:** General DSH plugin listing; no clear functionality described yet.

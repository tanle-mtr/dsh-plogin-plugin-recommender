...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,081,337 ⭐ |
| **Categories** | 11 |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 233,324 | The foundational plugin ecosystem — everything is  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 97,625 | Open-source Figma alternative with AI-powered UI g |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 73,067 | Deploy multi-agent swarms and autonomous workflows |
...
- **Tags:** `ai-agents`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** The foundational plugin ecosystem — everything is a plugin.
...
- **Tags:** `multi-agent`, `mcp`, `agent-memory`, `dsh-plugin`
...
- **Tags:** `terminal`, `cli`, `prompt-caching`, `deepseek`
...
- **Tags:** `dsh-plugin`, `routing`, `corderis`
- **Why use it:** Runtime injector with task-aware reasoning-mode routing for DSH
...
- **Why use it:** Self-evolving Agent OS with staged evaluation and budgeted loop engineering
...
- **Tags:** `agent-control-plane`, `long-horizon`, `codex`
...
- **Why use it:** First vision plugin bridging image-to-JSON for text-only coding agents.
...
- **Why use it:** Virtual terminal with VFS enabling stateful, sandboxed agent shell sessions.
...
- **Why use it:** Model-agnostic inference control for deep reasoning and verification
...
- **Why use it:** Powerful vision toolkit with OCR and screenshot-based UI restoration for agents
...
- **Why use it:** Full coding agent with RPC plugin, sub-agents, and MCP integration in TUI.
...
- **Why use it:** Seamlessly migrate Pi extensions to DSH native plugins
...
- **Why use it:** Transforms AI into a coding mentor with scaffolded chapters and review
...
- **Why use it:** Official plugin development knowledge base with bilingual docs and Cordis primer.
...
- **Why use it:** Reusable Codex skill for building and validating DSH/Cordis plugins efficiently.
...
- **Tags:** `documentation`, `official`, `skills`
- **Why use it:** Official skill documentation and examples for DSH plugin development
...
- **Why use it:** Agent skill for developing DSH plugins with standard conventions.
...
- **Tags:** `debugging`, `plugin-conflict`, `utility`
- **Why use it:** Diagnoses and resolves plugin version conflicts for DSH.
...
- **Tags:** `agent-tools`, `pre-flight`, `reliability`
- **Why use it:** Pre-flight plugin check for DSH agents boosts reliability
...
- **Why use it:** Bind ChatGPT account via OAuth, chat with models in DSH
...
- **Tags:** `browser-extension`, `prompt-manager`, `dsh-plugin`
- **Why use it:** All-in-one browser extension enhancing multiple AI chat interfaces
...
- **Why use it:** Official desktop wrapper for DeepSeek Harness with native app experience
...
- **Why use it:** Animated pet gallery that personalizes your coding agent desktop experience.
...
- **Why use it:** Extensible sidebar foundation with built-in files, terminal, chat, Git, and sub-agent pages.
...
- **Why use it:** Feature-rich TUI upgrade: whale bar, streaming thought, rollback, and context progress.
...
- **Tags:** `floating-widget`, `dsh-plugin`
- **Why use it:** Cute floating widget tracking DeepSeek account balance with animations
...
- **Why use it:** Lightweight Tauri desktop app with zero setup for Windows/macOS/Linux
...
- **Tags:** `desktop`, `gui`, `ssh`, `remote-access`
- **Why use it:** Official desktop GUI with zero setup, SSH and mobile remote access support.
...
- **Tags:** `desktop`, `mcp`, `office-automation`, `local-first`
- **Why use it:** Local-first desktop workspace with web research, MCP, and Office automation support.
...
- **Tags:** `workspace`, `canvas`, `conversation`, `nonlinear`
- **Why use it:** Canvas-based branching conversation workspace for non-linear multi-path discussions.
...
- **Tags:** `office`, `univer`, `docs`, `spreadsheets`
- **Why use it:** Brings spreadsheets, docs, slides and tables into DSH natively
...
- **Why use it:** Native iOS client bringing DSH workspaces and agent traces to your iPhone
...
- **⭐ Stars:** 166
- **Language:** TypeScript
- **Description:** 开源版锤子便签，复刻锤科��学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **Tags:** `notes`, `productivity`, `social`
- **Why use it:** Open-source smartisan-style notes with WeChat/QQ alerts
...
- **Tags:** `ui`, `mcp`, `skills`
- **Why use it:** Web UI panel for visual skill and MCP server management
...
- **Why use it:** Plugin-based web workbench with global skill management integration
...
- **Why use it:** Context injection auditor with Web UI ring panel, token cost analysis and conflict detection.
...
- **Why use it:** Electron desktop app with self-hosted DSH web and sidebar integration.
...
- **Why use it:** One-click compact toggle for context meter panel
...
- **Tags:** `agent-memory`, `agentic-rag`, `self-evolving`, `context-database`
...
- **Tags:** `rag`, `vector-search`, `knowledge-base`, `wiki`
- **Why use it:** Open-source RAG platform with self-maintaining wiki and reasoning.
...
- **Tags:** `agent-memory`, `rag`, `skills`, `token-optimization`
...
- **Why use it:** Lightweight memory library enabling stateful agent development easily
...
- **Why use it:** Memory management kit with RAG for agents — Remember Me, Refine Me.
...
- **Tags:** `rag`, `skill-management`, `retrieval`, `embeddings`
- **Why use it:** Curates SKILL.md files into retrievable agent-skill corpora with evaluation tooling.
...
- **Why use it:** Local financial DB with auto MCP/H API generation
...
- **Why use it:** Three-layer auto-consolidation memory injected before model speaks
...
- **Tags:** `multi-agent`, `swarm`, `mcp-server`, `agentic-workflow`
- **Why use it:** Deploy multi-agent swarms and autonomous workflows seamlessly.
...
- **Why use it:** Distill any persona into reusable agent skills and meta-skills.
...
- **Tags:** `low-code`, `internal-tools`, `workflows`, `dsh-plugin`
- **Why use it:** AI + no-code platform for building business systems and workflows.
...
- **Tags:** `agent-workspaces`, `skills`, `no-code`, `mcp`
- **Why use it:** Unified workspace hub for managing agents across all devices seamlessly
...
- **Tags:** `ai-writing`, `webnovel`, `dsh-plugin`
- **Why use it:** Long-form Chinese web novel writing assistant solving AI forgetting and hallucination
...
- **Why use it:** Largest curated skills store covering docs, coding, ML, and automation workflows
...
- **Tags:** `agent-collaboration`, `skills`, `multi-agent`
- **Why use it:** Enterprise-grade multi-engine agent workbench with visual editor support
...
- **Why use it:** Intelligent skill routing and workflow orchestration with measurable token savings.
...
- **Why use it:** Enable multi-agent team coordination and collaboration in DeepSeek Harness
...
- **Why use it:** Organized AI-assisted novel writing workflow from inspiration to revision
...
- **Tags:** `creative-writing`, `novel`, `workflow`, `fiction`
...
- **Tags:** `agent-observability`, `multimodal`, `ocr`, `video-understanding`
- **Why use it:** Gives agents eyes and ears with verifiable multimodal evidence
...
- **Tags:** `task-management`, `taskboard`, `sqlite`, `agent-workflow`
...
- **Why use it:** Full-stack math modeling competition autopilot with GitOps
...
- **Tags:** `audit`, `skills`, `management`
- **Why use it:** Skill invocation auditing with in-app skill manager
...
- **Tags:** `agent-review`, `self-evolving`, `workflow`
- **Why use it:** Composable, reviewable agent modes for self-evolution
...
- **Why use it:** 88 ready-to-use skills for research, marketing and business
...
- **Why use it:** Auto-find, install and verify DSH plugins via skill
...
- **⭐ Stars:** 77
- **Language:** JavaScript
- **Description:** 安装即自带mattpocock/skills v1.2.3的25个���程与效率技能，无需手动装技能。300亿token打造。本插件在原始技能之上提供10倍的开发效率。主力支持GitHub issue；Markdown为预览版；GitLab暂不支持。
- **Tags:** `skills`, `agent`, `productivity`
- **Why use it:** 25 pre-loaded dev & productivity skills from 30B token training
...
- **Why use it:** Web search, research, finance and integration discovery for agents
...
- **Why use it:** Unified local skill loading and safe management for DSH agents
...
- **Tags:** `doc`, `office`, `chinese-docs`
- **Why use it:** Full GB/T 9704 compliant official document workflow with formatting
...
- **Tags:** `ai-agent`, `bazi`, `iching`, `fengshui`
- **Why use it:** Unique traditional wisdom agent with local deterministic engine and visualization dashboard.
...
- **Tags:** `quality-gate`, `delivery`, `engineering`
- **Why use it:** Engineering discipline bundle for requirements grilling, testing, and delivery proof.
...
- **Why use it:** Comprehensive math modeling suite with data preprocessing, coding, and paper writing skills.
...
- **Why use it:** Multi-agent orchestration with durable memory, notes, and skills across sessions.
...
- **Why use it:** 11-test-skill framework with shared knowledge base for AI-powered QA engineering.
...
- **Why use it:** 5-role multi-agent math modeling with 33 model library and paper template.
...
- **Why use it:** Separation-of-deliberation-and-execution mechanism for collaborative AI task planning.
...
- **Tags:** `skill-picker`, `ui`, `productivity`
...
- **Why use it:** Open-source Figma alternative with AI-powered UI generation.
...
- **Why use it:** Beautiful agent-driven architecture and sequence diagrams as code.
...
- **Why use it:** 530+ GPT Image prompt templates and case library for image gen.
...
- **Why use it:** AI-generated design system with visual editor and template marketplace for PPT
...
- **Tags:** `ui-components`, `charts`, `forms`, `rendering`
- **Why use it:** Generates interactive UI components (charts, forms, quizzes) rendered inline in replies.
...
- **Why use it:** Adds multimodal vision for screenshots and UI analysis
...
- **Why use it:** Generate litigation timelines,对抗 diagrams, and legal relationship maps
...
- **Why use it:** Pixel-to-text OCR tool enabling text-only models to read and analyze images.
...
- **Tags:** `visual`, `knowledge-cards`, `sharing`
...
- **Why use it:** Enables AI agents to use real logged-in browser without disrupting your workflow
...
- **Tags:** `content-discovery`, `cross-platform`, `personal-ai`
- **Why use it:** Self-evolving cross-platform content discovery agent from Bilibili, YouTube, Reddit and more.
...
- **Tags:** `web-search`, `free`, `no-signup`, `mcp`
- **Why use it:** Free no-signup web search plugin — bridges web access for all models.
...
- **Tags:** `ios-simulator`, `mobile-automation`, `webdriveragent`, `ui-automation`
- **Why use it:** Live iOS Simulator automation with 22 agent tools for mobile testing
...
- **Why use it:** Tabbit Browser integration with Playwright-based web automation
...
- **Tags:** `multi-model`, `quota`, `routing`
...
- **Why use it:** Centralized API key registry and MCP proxy for agent tool authentication
...
- **Why use it:** Comprehensive context dashboard with sidebar, browser view and management commands
...
- **Why use it:** CLI plugin manager and resolver for DSH Hub — essential infrastructure tool.
...
- **Tags:** `oauth`, `llm-provider`, `chatgpt`, `claude`, `grok`
...
- **Why use it:** Adds Command Code model access with plan-aware selection and reasoning
...
- **Why use it:** Plugin ecosystem infrastructure with browser-panel registry console
...
- **Tags:** `container`, `version-management`, `infrastructure`
- **Why use it:** Run multiple DSH versions in isolated containers with easy plugin import
...
- **Tags:** `migration`, `session-import`, `utility`
- **Why use it:** Migration wizard for sessions, memories and skills from Claude Code/Codex
...
- **Tags:** `launcher`, `orchestration`, `core-tools`
- **Why use it:** Unifies Runtime, Provider, Plugin and MCP orchestration for DSH
...
- **Why use it:** Curated DSH plugins: task notifications, trace inspection, keybindings.
...
- **Tags:** `skin`, `dsh-plugin`
- **Why use it:** Whale girl skin series customizing DeepSeek Harness visual appearance
...
- **Why use it:** Frosted glass theme for DSH web UI with full customization — zero source code changes needed.
...
- **Tags:** `animated-background`, `ocean-skin`, `glassmorphism`, `threejs`
- **Why use it:** Stunning animated ocean theme with adjustable waves and glassmorphism
...
- **Why use it:** Customizable backgrounds with presets and live preview
...
- **Tags:** `ai-resources`, `vibe-coding`, `prompt`, `rag`
...
- **Why use it:** Generates accurate technical docs and AI-ready context from codebases fast.
...
- **Why use it:** Curated bilingual plugin & skill reference list — excellent starting point for exploration.
...
- **Why use it:** One-stop academic research tool: LaTeX, arXiv, GPU SSH, experiment tracking.
...
- **Tags:** `encyclopedia`, `resources`, `learning`, `ai-basics`
- **Why use it:** Comprehensive AI resource encyclopedia: agents, RAG, multimodal, MLOps, and learning paths.
...
- **Why use it:** Brings the Epistemic Loop framework for scientific discovery into DSH
...
- **Tags:** `academic-search`, `arxiv`, `pubmed`, `citation-graph`, `mcp`
...
- **Why use it:** Great starting point for learning DSH and exploring plugins
...
- **Why use it:** Comprehensive handbook with 173 source-backed docs
...
- **Tags:** `catalog`, `marketplace`, `directory`
- **Why use it:** Largest DSH plugin catalog with multi-language search
...
- **Why use it:** Industry chain mapping and policy/news tracking methodology for company research
...
- **Tags:** `api`, `search`, `chinese-platforms`
...
- **Why use it:** Curated directory of 280+ plugins across 14 categories, excellent for discovery.
...
- **Why use it:** Verified stock/finance/quant plugins list for DSH, bilingual.
...
- **Why use it:** Curated discovery list for DSH plugins, great starting point
...
- **Tags:** `tutorial`, `dsh-plugin`, `education`
...
- **Tags:** `plugin-registry`, `ecosystem`, `radar`
- **Why use it:** Open-source ecosystem radar with continuous discovery and k8s validation for plugins
...
- **Why use it:** Curated comprehensive plugin and tool listing for the DSH ecosystem
...
- **Why use it:** Comprehensive daily-refreshed plugin marketplace with community-sourced reviews
...
- **Why use it:** AI security offense & defense: audits AI-generated code for hallucinated packages and vulns.
...
- **Why use it:** Curated daily-scraped plugin directory with scenario-based classification
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, MCP servers and more
...
- **Why use it:** Ultimate Chinese guide for DSH quickstart, resources, and plugin toolkit
...
- **Why use it:** Curated awesome list of DSH plugins, useful discovery resource
...
- **Tags:** `awesome-list`, `plugin`
- **Why use it:** Curated plugin and tool list covering productivity and functionality
...
- **Why use it:** Unofficial community catalog listing DSH plugins
...
- **Tags:** `awesome-list`, `curated`, `plugins`
- **Why use it:** Curated collection of DeepSeek Harness plugins and resources
...
- **Tags:** `awesome-list`, `curated-list`, `dsh-plugins`, `plugin-registry`
...
- **Why use it:** Public GitHub directory for DSH plugins discovery and installation.
...
- **Tags:** `awesome-list`, `cli`, `web-ui`, `ai-agent`
- **Why use it:** Curated list covering CLI, web UI, and autonomous agent plugins.
...
- **Why use it:** Comprehensive star-ranked DSH plugin catalog
...
- **Why use it:** Plugin guide with install, permissions and risk info
...
- **Tags:** `awesome-list`, `ai-curated`, `recommendations`
...
- **Tags:** `awesome-list`, `evidence-backed`, `radar`
- **Why use it:** Evidence-backed plugin radar and lab resource
...
- **Tags:** `awesome-list`, `bilingual`, `automated`
...
- **Why use it:** Static portal to discover, filter and install 227+ plugins
...
- **Why use it:** In-agent npm and awesome-list plugin search tool
...
- **Why use it:** Community-curated DSH plugin repository covering verification and analytics.
...
- **Tags:** `awesome-list`, `archived`, `plugin-directory`
- **Why use it:** Original awesome list now migrated; reference for archived DSH plugin collections.
...
- **Why use it:** Auto-updating bilingual curated list with YAML-driven entries and Vercel deployment.
...
- **Tags:** `plugin-directory`, `curated-list`, `registry`, `typescript`
- **Why use it:** Comprehensive curated registry covering models, tools, sandboxes, UI, and agent loops.

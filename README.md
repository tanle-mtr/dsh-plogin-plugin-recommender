...
|--------|-------|
| **Plugins tracked** | 196 |
| **Total community stars** | 986,110 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-09-08 10:59:57 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215,766 | Core DSH framework and plugin ecosystem foundation |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 94,832 | Open-source design alternative with agent integrat |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,578 | Multi-agent swarm coordination with advanced workf |
...
- **Why use it:** Extensible sidebar with file editor, terminal, Git panels
...
- **Why use it:** Modern flexible task board for Codex and DSH integration
...
- **Why use it:** Claude Code-style TUI with whale bar and streaming thinking
...
- **Why use it:** Rust-based agent runtime with polished desktop application
...
- **Tags:** `floating-widget`, `deepseek`
- **Why use it:** Cute floating whale widget tracking DeepSeek account balance with drag & animations.
...
- **Tags:** `genui`, `ui`, `interactive`
- **Why use it:** Generates interactive UI components—charts, forms, quizzes—rendered inline via dsh-ui fence.
...
- **Why use it:** Open-source Electron Windows desktop client with plugins, skills, SSH, and mobile remote access.
...
- **Why use it:** Canvas-based non-linear conversation workspace enabling session exploration and branching.
...
- **Why use it:** Brings spreadsheet, docs, slides, and canvases into DSH
...
- **Why use it:** Native iOS client for DSH with workspace, sessions, and agent traces
...
- **Tags:** `mcp`, `skills`, `ui`
- **Why use it:** Web UI tool for managing skills and MCPs easily
...
- **Why use it:** Community plugin marketplace with one-click install
...
- **Why use it:** All-in-one Electron desktop console for managing DSH plugins and MCPs.
...
- **Why use it:** Live balance, pricing, and model info in status bar
...
- **Why use it:** WorkBuddy-style skill picker with /skill-name gesture
...
- **Why use it:** Bioinformatics desktop agent with offline mode and skill store for scientists.
...
- **Tags:** `deepseek-harness`, `desktop`, `devops`, `dsh-plugin`
- **Why use it:** All-in-one DevOps desktop: SSH, Docker, DB client, SFTP, and AI assistant.
...
- **Why use it:** Free Xiaomi MiMo TTS with preset/custom/built-in voices
...
- **Why use it:** One-click context compaction for DSH panel
...
- **Tags:** `ui`, `knowledge-cards`, `shareable`
- **Why use it:** Transform chats into shareable knowledge cards
...
- **Why use it:** Open-source RAG platform with autonomous reasoning agent
...
- **Tags:** `agent-memory`, `rag`, `mcp`, `skills`
- **Why use it:** Portable local-first memory layer with Markdown-native cross-app support.
...
- **Why use it:** Stateful memory library for building persistent, self-learning agents.
...
- **Why use it:** Dedicated memory management kit with RAG refinement
...
- **Why use it:** Persistent unified memory layer backed by Milvus vector DB
...
- **Why use it:** Best context management plugin with dashboard, browser integration and stats.
...
- **Tags:** `skill-corpus`, `r ag`, `vector-search`
- **Why use it:** Curates SKILL.md files into retrieval-ready corpora with vector search and evaluation tooling.
...
- **Tags:** `finance`, `stock`, `datasource`, `rag`
- **Why use it:** Local financial data RAG with multi-Agent stock analysis.
...
- **Tags:** `api`, `knowledge`, `documentation`
- **Why use it:** 65,600+ Chinese API docs searchable across multiple IDEs
...
- **Why use it:** Auto-consolidation memory with proactive recall injected before model responses.
...
- **Why use it:** Multi-agent swarm coordination with advanced workflows
...
- **Why use it:** Most comprehensive skills store covering docs, coding, automation workflows.
...
- **Why use it:** Long-horizon agent control plane for durable cross-platform workflows.
...
- **Why use it:** Intelligent skill routing reduces tokens by 29.6%
...
- **Tags:** `vision-tools`, `computer-vision`
- **Why use it:** Powerful vision toolkit for text-only models: image Q&A, OCR, screenshot restoration.
...
- **Tags:** `multimodal`, `ocr`, `video-understanding`
- **Why use it:** Provides video, audio, and screen understanding with OCR, STT, and timestamped evidence for agents.
...
- **Why use it:** SQLite-backed native taskboard with agent claim/review workflow and zero iframe dependency.
...
- **Why use it:** Specialized creative writing plugin for novel and short-drama production powered by Drama Skills.
...
- **Why use it:** 88 research and business workflow skills for cross-platform agents.
...
- **Why use it:** 87 reverse engineering and pentesting skills for CTF and security.
...
- **Why use it:** 25 ready-to-use engineering and efficiency skills with sidebar integration.
...
- **⭐ Stars:** 44
- **Language:** Python
- **Description:** 中文公��全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **Tags:** `gongwen`, `docx`, `chinese-docs`
- **Why use it:** Full Chinese official document pipeline: format check, optimization, template gen.
...
- **Why use it:** Official docs archive with on-demand agent skill
...
- **Tags:** `chinese-traditional-wisdom`, `ai-agent`
- **Why use it:** Fusion of Bazi, Fengshui, IChing into one skill
...
- **Tags:** `coding`, `code-simplification`
- **Why use it:** Codex skill for automated code simplification
...
- **Why use it:** Cross-platform agent continuity memory bridge
...
- **Why use it:** Official SkillHub API docs and examples bundled as a DSH plugin.
...
- **Why use it:** Godot 4.x full-stack game dev skill registered at runtime for DSH.
...
- **Tags:** `deepseek-harness`, `agent-skills`, `remotion`
- **Why use it:** Film-quality video agent skill with 152 shot recipes and Remotion templates.
...
- **Why use it:** Virtual product team agent preset from PM to QA workflow
...
- **Tags:** `agent-tools`, `workflow`, `plugin-check`
- **Why use it:** Auto pre-flight plugin check for agents
...
- **Why use it:** Official Huawei Cloud MCP tools, skills, and sandbox for AI agent cloud workflows.
...
- **Why use it:** Open-source design alternative with agent integration
...
- **Why use it:** Beautiful verifiable architecture diagrams as code
...
- **Tags:** `agents`, `ai-image-generation`, `dsh-plugin`
- **Why use it:** Industrial-grade prompt engine for image generation
...
- **Why use it:** AI-native vector design tool with concurrent Agent Teams, prompts to UI.
...
- **Tags:** `design`, `ppt`
- **Why use it:** AI-generated design system with visual editor, template marketplace and PPT support.
...
- **Why use it:** Lawyer-friendly litigation timeline and diagram visualization, SVG output.
...
- **Why use it:** AI video/image/audio creation with vision tools
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `design-skills`
...
- **Why use it:** Enhancement suite for AI chat interfaces with prompt manager
...
- **⭐ Stars:** 3,226
- **Language:** Python
- **Description:** 本地私有、开源的��进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **Tags:** `content-discovery`, `bilibili`, `youtube`
- **Why use it:** Cross-platform content discovery from Bilibili, YouTube, X etc.
...
- **Why use it:** Free no-signup web search bridge for any DSH model lacking native web access.
...
- **Tags:** `ios`, `automation`, `mcp`, `deepseek-harness`
- **Why use it:** Live iOS Simulator and USB-connected iPhone automation in conversation
...
- **Tags:** `agent-skills`, `dsh-plugin`, `mcp-server`
- **Why use it:** Privacy-focused resume builder with full customization
...
- **Why use it:** AI-enhanced no-code platform for business systems
...
- **Why use it:** Virtual terminal + VFS for isolated agent environments
...
- **Why use it:** Built-in marketplace for browsing and installing plugins
...
- **Tags:** `model-switch`, `multi-tool`, `cli`
- **Why use it:** One-click model switch across 8+ AI coding tools
...
- **Why use it:** Self-hosted plugin radar discovering 15900+ candidates with k8s-level testing.
...
- **Why use it:** Specialized armor-breaking plugin for enhanced DeepSeek capabilities.
...
- **Why use it:** Curated list of DSH plugins, tools and infrastructure from the ecosystem.
...
- **Why use it:** Curated awesome list covering the full DSH plugin ecosystem.
...
- **Why use it:** OAuth bridge using ChatGPT, Claude, and Grok subscriptions as DSH LLM providers—no API keys needed.
...
- **Tags:** `cost-tracking`, `deepseek-api`, `deepseek-harness`
- **Why use it:** Track session/daily costs, budget limits, and token usage history
...
- **Tags:** `backup`, `utility`, `sync`
- **Why use it:** Full DSH backup/restore with WebDAV sync support
...
- **Why use it:** Core infrastructure for DSH plugin ecosystem with browser console and dev guidance.
...
- **Tags:** `dev-skills`, `plugin-dev`, `infrastructure`
- **Why use it:** Standard guide for building DSH plugins: services, events, tools, adapters.
...
- **Tags:** `plugin-build`, `credential`, `slots`
- **Why use it:** Skill for managing installed DSH plugin slots, Typert remotes, and credentials.
...
- **Tags:** `skills-manager`, `plugin-management`, `utils`
- **Why use it:** Unified loader and manager for local Agent Skills within DSH environment.
...
- **Tags:** `container`, `local-management`
...
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness`, `dsh-plugin`
...
- **Why use it:** Public animated pet gallery and mascot for multiple AI coding agents.
...
- **Why use it:** Whale girl themed visual skins for DSH interface
...
- **Why use it:** Glassmorphism theme with full customization—blur,磨砂,background—all toggleable without modifying source.
...
- **Tags:** `theme`, `webgpu`, `ocean-skin`
- **Why use it:** Stunning WebGPU ocean-themed UI skin for DeepSeek Harness.
...
- **Why use it:** Comprehensive AI resource hub with tutorials and prompts collection.
...
- **Why use it:** Comprehensive AI encyclopedia covering models, agents, RAG, MLOps, skills, and learning roadmaps.
...
- **Tags:** `academic-search`, `mcp`, `research`, `arxiv`
- **Why use it:** Academic search skill+MCP across CrossRef, PubMed, arXiv, OpenAlex
...
- **Why use it:** Industry research toolkit with methodology and tracking
...
- **Why use it:** End-to-end patent infringement analysis with RAG and multimodal support.
...
- **Why use it:** AI hedge-fund desk with multi-strategy backtesting and compliance-first design.
...
- **Why use it:** Interactive K-line chart with multi-market analysis
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `llm-evaluation`
...
- **Why use it:** Track token usage and API costs in real-time with visual charts
...
- **Why use it:** Curated stock/finance/quant plugins for DeepSeek Harness
...
- **Why use it:** Plugin product manual with scene-based navigation and risk info
...
- **Why use it:** Beginner tutorial for DSH plugin development from scratch.
...
- **Why use it:** Curated list of DSH plugins, great starting point for discovery.
...
- **Why use it:** Bilingual curated awesome list of DSH plugins, extensions, skills, and verified references.
...
- **Tags:** `marketplace`, `plugin-shop`, `directory`
- **Why use it:** Daily-updated plugin marketplace aggregating and reviewing DSH plugins from across the internet.
...
- **Why use it:** Curated plugin discovery with daily automated GitHub scans
...
- **Why use it:** Learn DSH principles, plugin marketplace browsing, and best practices
...
- **Tags:** `awesome-list`, `coding-agent`, `mcp`, `deepseek-harness`
...
- **Tags:** `marketplace`, `plugin-directory`, `deepseek-harness`
- **Why use it:** Plugin store with 11000+ entries, search, rankings, and public API
...
- **Why use it:** Comprehensive DSH plugin catalog with 1800+ entries and search.
...
- **Tags:** `awesome`, `directory`, `curated`
...
- **Why use it:** Official auto-curated plugin list by cordis.run
...
- **Why use it:** Curated collection of DSH plugins and dev resources
...
- **Tags:** `community`, `catalog`, `awesome`
...
- **Why use it:** Comprehensive curated list covering plugins, skills, tools, and MCP resources.
...
- **Tags:** `deepseek-harness`, `plugin-registry`, `dsh-plugins`
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Evidence-led plugin directory with verified loadable extensions
...
- **Tags:** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **Why use it:** Full DSH tool inventory sorted by stars, 1000+ repos listed
...
- **Why use it:** Auto-generated plugin directory via daily GitHub Actions crawl
...
- **Tags:** `dsh-plugin`, `marketplace`, `bundle`
...
- **Why use it:** Curated DSH plugins directory bundle
...
- **Tags:** `awesome-list`, `radar`, `plugin-registry`
- **Why use it:** Plugin radar with 2Origin integration
...
- **Why use it:** Search npm and awesome lists inside DSH
...
- **Why use it:** AI-curated list of 190+ plugins hourly updated
...
- **Tags:** `awesome-list`, `verified`, `organized`
...
- **Tags:** `awesome-list`, `moved`, `archive`
- **Why use it:** Original awesome list moved to new repo
...
- **Tags:** `awesome-list`, `curated`, `shortlist`
- **Why use it:** Evidence-aware curated shortlist of plugins
...
- **Why use it:** A curated collection of DSH plugins serving as a discovery hub for the ecosystem.

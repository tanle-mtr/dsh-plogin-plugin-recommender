...
|--------|-------|
| **Plugins tracked** | 192 |
| **Total community stars** | 851,648 ⭐ |
| **Categories** | 12 |
| **Last updated** | 2026-08-24 09:57:04 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 190,260 | Core harness powering the entire DSH ecosystem; es |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,929 | Open-source design system generator with local-fir |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,212 | Multi-agent meta-harness enabling swarm coordinati |
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 37 plugins
- [Themes & Skins](#themes-&-skins) — 6 plugins
- [Research & Analysis](#research-&-analysis) — 11 plugins
- [Other](#other) — 25 plugins
...
- [Utilities & Infrastructure](utilities-infrastructure) (37)
...
- **Why use it:** Core harness powering the entire DSH ecosystem; essential starting point for all plugins.
...
- **Why use it:** Multi-agent meta-harness enabling swarm coordination and autonomous workflow deployment.
...
- **Why use it:** Versatile multi-model agent harness with self-evolving memory and multi-channel support.
...
- **Tags:** `coding-agent`, `cli`, `prompt-caching`
- **Why use it:** Native DeepSeek terminal coding agent with prefix-cache stability for long-running sessions.
...
- **Tags:** `routing`, `orchestration`, `dsh`
- **Why use it:** Task-aware reasoning-mode router with measured performance gains for DSH agent orchestration.
...
- **Why use it:** Enterprise multi-engine agent workbench with unified workspace and visual editor for agent teams.
...
- **Tags:** `preset`, `harness-tools`, `dsh`
- **Why use it:** Two-phase DSH preset with minimal bootstrap leading to full Standard tools for reliable performance.
...
- **Tags:** `claude-code`, `deepseek-harness`, `codex`
- **Why use it:** One-click install and model switch for multiple AI coding agents.
...
- **Tags:** `code-review`, `code-quality`, `static-analysis`
- **Why use it:** AI code review grounded in 12 classic engineering books with decay risk diagnostics.
...
- **Why use it:** Makes coding agents architecture-aware with baseline-first and evidence-verified workflows.
...
- **Why use it:** Swift-native macOS coding agent built by DeepSeek, optimized for DSH workflows.
...
- **Tags:** `coding`, `agents`, `team`
- **Why use it:** Unifies Claude Code, Codex, Grok, Kimi, DSH into one collaborative team.
...
- **Why use it:** Specialized agent skills for AI infra dev, writing, optimization and debugging
...
- **Tags:** `coding-agent`, `orchestration`, `subagent`
- **Why use it:** Dispatch work to DSH agents from Claude Code/Codex with subagent progress tracking
...
- **Tags:** `agent-skills`, `dsh-plugin`, `developer-tools`
...
- **Tags:** `code-simplification`, `codex`, `coding`
- **Why use it:** Codex skill for automatic code simplification
...
- **Why use it:** Portable Agent Skill for developing and auditing DSH plugins with optional DSH bundle adapter
...
- **Tags:** `best-practices`, `documentation`, `skill`
- **Why use it:** Practical plugin dev guide covering cordis duplicates, tsconfig, Windows junctions, zstd compression
...
- **Why use it:** Agent skills for scaffolding new plugins and choosing appropriate test tiers entirely inside DSH
...
- **Tags:** `agent-harness`, `coding-agents`, `cordis-plugin`, `deepseek-harness-plugin`, `ui`
- **Why use it:** Curated plugins for models, tools, UI, agent loops
...
- **Why use it:** Modern desktop client for DSH where even the desktop itself is a plugin—true extensibility.
...
- **Tags:** `agent-orchestration`, `ui`, `multi-platform`
- **Why use it:** Unified cross-device agent workspace with board-based task tracking and multi-platform access.
...
- **Why use it:** Web simulation of a traditional Chinese toy with real audio sampling.
...
- **Tags:** `sidebar`, `terminal`, `git`
- **Why use it:** Open sidebar foundation with built-in file editor, terminal, and Git pages.
...
- **Why use it:** Claude Code-style TUI plugin with whale bar, streaming thoughts, and TPS display.
...
- **Tags:** `desktop`, `agent-runtime`, `rust`
- **Why use it:** High-performance Rust-based agent runtime paired with polished desktop app.
...
- **Why use it:** Local-first desktop companion with animated pets and coding-agent integrations.
...
- **Why use it:** 5MB Tauri desktop app, zero env setup, cross-platform with preset plugins.
...
- **Tags:** `widget`, `desktop`, `ui`
- **Why use it:** Cute floating whale widget monitoring DeepSeek account balance with animations.
...
- **Why use it:** Local-first desktop workspace integrating sessions, files, research and Office.
...
- **Why use it:** Generates interactive UI components inline via code — layouts, charts, forms.
...
- **Why use it:** Visual non-linear canvas workspace for branching conversations and sessions.
...
- **Tags:** `desktop`, `electron`, `gui`, `ssh-client`
- **Why use it:** Full-featured Electron desktop GUI with SSH, mobile access, and Codex
...
- **Tags:** `task-management`, `webui`, `sqlite`
- **Why use it:** Native local taskboard with SQLite, agent claim/review and clean Web UI
...
- **Why use it:** Web UI panel for managing DSH skills and MCP integrations at a glance
...
- **Why use it:** Electron desktop hub for managing Harness/Plugin/MCP/Skills.
...
- **Tags:** `deepseek-harness`, `usage-tracking`, `ui`
- **Why use it:** Persistent bottom bar showing provider, model, live balance, peak/off-peak pricing with countdown
...
- **Why use it:** Floating HUD panel showing git status, MCP, skills, and token usage.
...
- **Why use it:** Electron desktop wrapper integrating DSH web with sidebar and plugins
...
- **Why use it:** Official auto-generated Cordis plugin list
...
- **Why use it:** Self-evolving context database unifying agent memory, RAG knowledge, and skills in one system.
...
- **Why use it:** Enterprise-grade RAG platform turning documents into queryable knowledge bases and wikis.
...
- **Why use it:** Portable, local-first Markdown memory layer enabling persistent cross-tool agent memory.
...
- **Why use it:** Self-evolving hybrid-retrieval memory OS achieving 35%+ token savings with cross-task skill reuse.
...
- **Why use it:** Comprehensive memory management kit for AI agents with RAG support.
...
- **Tags:** `memory`, `milvus`, `semantic-search`
- **Why use it:** Persistent unified memory layer backed by Markdown and Milvus vector DB.
...
- **Why use it:** Unlimited memory provider for AI agents, ideal for persistent knowledge storage.
...
- **Tags:** `knowledge`, `rag`, `encyclopedia`
- **Why use it:** Comprehensive AI encyclopedia covering MCP, RAG, agents and learning paths.
...
- **Why use it:** Private note-taking with Docker deployment, exports, and multi-tenant support
...
- **Tags:** `agent-memory`, `skill-md`, `vector-search`
- **Why use it:** Turns scattered SKILL.md into curated retrieval-ready agent-skill corpora with eval tooling
...
- **Why use it:** Durable inspectable long-term memory with recall tools and settings page for DSH
...
- **Why use it:** Cross-platform agent continuity memory for handoff
...
- **Why use it:** Distills AI agent behavior into reusable meta-skills for any agent or bot platform.
...
- **Tags:** `architecture-as-code`, `diagrams`, `agent-skills`
- **Why use it:** Agent skill that generates beautiful, verifiable architecture and workflow diagrams as code.
...
- **Tags:** `prompt-engineering`, `skills`, `workflow-automation`
- **Why use it:** 530+ reverse-engineered prompts with 20+ industrial template sets for GPT-Image2.
...
- **Tags:** `agent-os`, `self-improving`, `agentic-ai`
- **Why use it:** Self-improving agent OS where agents autonomously learn and upgrade capabilities over time.
...
- **Why use it:** First vision plugin for DSH, enabling text-only agents to receive structured JSON evidence from images.
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `react`
...
- **Tags:** `skills`, `workflow-automation`, `prompt-engineering`
- **Why use it:** Intelligently orchestrates and routes local Skills for workflow automation.
...
- **Tags:** `video`, `ffmpeg`, `tts`
- **Why use it:** End-to-end Vox-style paper-collage explainer video generation skill.
...
- **Why use it:** Turn AI conversations into organized reusable workflows across major platforms.
...
- **Tags:** `agent-teams`, `collaboration`, `dsh-plugin`
- **Why use it:** Enables multi-agent team collaboration within the DeepSeek Harness ecosystem.
...
- **Tags:** `agent-skills`, `workflow`, `codex`
...
- **Why use it:** Specialized creative writing and short-drama production skill
...
- **Tags:** `plugin-discovery`, `agent-skills`, `automation`
- **Why use it:** Auto-discovers, installs, and verifies GitHub DSH plugins

---

### [xuanyuanzhifeng/dsh-plugin-agent-workflow](https://github.com/xuanyuanzhifeng/dsh-plugin-agent-workflow)

- **⭐ Stars:** 105
- **Language:** TypeScript
- **Description:** DeepSeek Harness Agent Workflow
- **Tags:** `agent`, `workflow`, `automation`
- **Why use it:** Agent workflow plugin for structured and repeatable DSH task execution
...
- **Why use it:** Superpowers skill port adapted for Reasonix coding harness workflows
...
- **Why use it:** TDD, debugging, planning and collaboration skills from obra/superpowers for DSH
...
- **Why use it:** Comprehensive reverse engineering and pentesting skill.
...
- **Why use it:** AI coding mentor that guides you through project architecture.
...
- **Why use it:** 88 open-source agent skills for research and marketing workflows.
...
- **Tags:** `agent-skills`, `spec-driven-development`, `ai-coding`
- **Why use it:** Spec-driven development skill for repository-native programming.
...
- **Why use it:** OCR and pixel-to-text tools for vision-capable text-only models.
...
- **Why use it:** WorkBuddy-style skill picker and composer for DSH
...
- **Why use it:** Multi-agent team collaboration with shared workspace
...
- **Tags:** `agent-framework`, `agent-skills`, `dsh-plugin`, `mcp`
- **Why use it:** Comprehensive package manager with 42 skills, 5 CLIs for AI agent engineering and eval-driven dev
...
- **Tags:** `agent-skills`, `deepseek-harness`, `project-governance`
- **Why use it:** Swift Cycle governance skill; user-invoked, version-pinned, offline-verifiable for project governance
...
- **Tags:** `ai-docs`, `gongwen`, `docx`, `dsh-plugin`
- **Why use it:** Full workflow Chinese official document tool following GB/T 9704 standard with format checking and optimization
...
- **Why use it:** Engineering discipline portable skill emphasizing fact-finding, durable decisions, and evidence-based reporting
...
- **Why use it:** Native WeShop Cordis plugin with infinite canvas and creative agentic skills for DSH
...
- **Tags:** `computer-use`, `record-replay`, `skills`
- **Why use it:** Record macOS desktop workflows and convert them into reusable agent skills.
...
- **⭐ Stars:** 10
- **Language:** Python
- **Description:** DeepSeek Harness 0.1.0-rc.6 数学建模增强套��：外置插件 + Preset + 17 个手动 Skill 卡片 + Windows 便携版脚本
- **Tags:** `math`, `modeling`, `skills`
- **Why use it:** Math modeling enhancement suite with 17 manual skill cards.
...
- **Tags:** `skills`, `gamification`, `task-system`
- **Why use it:** Game-like mission system for skill-based task progression.
...
- **Tags:** `agent-preset`, `product-management`, `deepseek-harness`
- **Why use it:** Virtual product team agent preset simulating PM, Engineer, QA roles
...
- **Tags:** `agent-tools`, `ai-agents`, `deepseek-harness`
- **Why use it:** Pre-flight plugin check injects top-K relevant plugins for tasks
...
- **Tags:** `search`, `mcp`, `web`
- **Why use it:** Strongest free web search plugin — no signup, works for all models.
...
- **Why use it:** Web GUI manager for skills and MCP servers
...
- **Why use it:** Hot-reload MCP servers and skills without restart via JSON paste.
...
- **Why use it:** Open-source design system generator with local-first desktop app, great for visual prototyping.
...
- **Tags:** `design`, `vector`, `vibedesign`
- **Why use it:** First open-source AI-native vector design tool with concurrent Agent Teams and Design-as-Code.
...
- **Tags:** `image-generation`, `multimodal`, `seedream`
- **Why use it:** Generate images directly in DSH chats using multiple AI models
...
- **Why use it:** Preview and edit OpenPencil .op documents inside DSH conversations
...
- **Tags:** `agent-skills`, `legal`, `visualization`, `svg`
- **Why use it:** Legal litigation visualization: timelines, diagrams, SVG output.
...
- **Why use it:** Design aesthetics skill pack: dark-saas, apple-minimal styles
...
- **Why use it:** Image reading and generation with auto vision transcription
...
- **Tags:** `ai-director`, `ai-video`, `storyboard`
- **Why use it:** DirectorX integration for AI video/image/audio skills, knowledge corpus, and configurable multimodal tools
...
- **Tags:** `browser-extension`, `prompt-manager`, `chat-management`
- **Why use it:** Cross-browser extension suite enhancing Gemini, Claude, ChatGPT with prompt management tools.
...
- **Tags:** `bilibili`, `content-discovery`, `local-first`
- **Why use it:** Local-first cross-platform content discovery agent from major platforms.
...
- **Why use it:** Let AI agents use your real logged-in browser seamlessly via CLI + extension.
...
- **Why use it:** Live iOS Simulator and iPhone automation with 22 agent tools inside DSH.
...
- **Why use it:** Tabbit Browser plugins enabling Playwright-based web automation for DSH
...
- **Why use it:** Ultimate image uploader supporting 60+ hosting services, integrates with Obsidian and VS Code.
...
- **Tags:** `low-code`, `no-code`, `ai-agents`, `workflows`
- **Why use it:** AI-powered no-code platform for rapidly building internal business systems and workflows.
...
- **Why use it:** Curated plugin directory serving as the definitive DSH ecosystem reference catalog.
...
- **Tags:** `vfs`, `infrastructure`, `agent-tools`
- **Why use it:** Unified virtual filesystem abstraction providing persistent storage context for all AI agents.
...
- **Why use it:** Context insight and management with dashboard, browser and statistics tools.
...
- **Tags:** `infrastructure`, `oauth`, `subscription`
...
- **Why use it:** Track session and daily costs with budget alerts and history
...
- **Tags:** `compatibility`, `migration`, `abi`
- **Why use it:** Runs Pi ecosystem extensions as native DSH plugins seamlessly
...
- **Tags:** `marketplace`, `plugin`, `dsh`
- **Why use it:** One-click browse, install and update all dsh-plugin GitHub plugins in Web GUI
...
- **Tags:** `session-migration`, `preset-migration`, `cordis`
- **Why use it:** Previewable cross-preset session migration preserving state and model intent
...
- **Why use it:** Crash-rescue plugin with undo config, secret-safe snapshots and one-click SAFE MODE
...
- **Why use it:** Community plugin market Web GUI with one-click install/uninstall from awesome-dsh-plugin.com
...
- **Why use it:** Infrastructure for plugin management with console and dev guide.
...
- **Tags:** `plugin-development`, `knowledge-base`, `docs`
- **Why use it:** Official DSH plugin dev docs and knowledge base
...
- **Why use it:** Bidirectional bridge between OpenAI Codex and DSH
...
- **Tags:** `context-audit`, `ui`, `dashboard`
- **Why use it:** Context injection audit tool with Web UI dashboard
...
- **Why use it:** Backup/restore/migrate complete DSH configuration
...
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** Unified menu to manage exposure level and execution mode of MCP tools and skills in DSH
...
- **Why use it:** Built-in GUI plugin manager with hot-reload for MCP/skills/plugins.
...
- **Tags:** `discoverability`, `dsh-plugin`, `deepseek-harness`
- **Why use it:** Built-in plugin search across npm and curated lists from DSH agents
...
- **Why use it:** OAuth ChatGPT binding lets you use ChatGPT models inside DSH
...
- **Tags:** `ai-agents`, `coding-agents`, `deepseek-harness`
...
- **Why use it:** Curated DSH plugin repository
...
- **Description:** DSH插件
- **Tags:** `dsh-plugin`
- **Why use it:** DSH plugin collection
...
- **Why use it:** Evidence-led bilingual plugin directory
...
- **Tags:** `dsh-plugin`
- **Why use it:** Curated evidence-aware plugin shortlist
...
- **Tags:** `awesome-list`, `catalog`, `deepseek-harness`, `dsh-plugin-directory`
- **Why use it:** Automated daily crawled plugin directory
...
- **Why use it:** 70+ verified plugins organized by function
...
- **Why use it:** Industry-specific plugin directory
...
- **Tags:** `discovery`, `plugin-manager`, `registry`
- **Why use it:** Multi-source plugin registry with deduplication
...
- **Why use it:** CLI tool for plugin management
...
- **Why use it:** Comprehensive star-sorted plugin list
...
- **Tags:** `mascot`, `pixel-art`, `ui`
- **Why use it:** Animated pet mascot gallery enhancing the UX experience across multiple coding agent platforms.
...
- **Why use it:** Whale Girl themed skin series for DeepSeek Harness desktop interface.
...
- **Tags:** `theme`, `ui`, `transparency`
- **Why use it:** Highly customizable frosted glass theme with full UI control.
...
- **Why use it:** WebGPU-powered ocean-themed skin with Three.js visuals
...
- **Tags:** `color-scheme`, `dark-mode`, `theme`
- **Why use it:** 34 opencode classic color themes with one-click switching, persistent across restarts in DSH
...
- **Tags:** `deepseek-harness`, `dsh-plugin`, `webui`
- **Why use it:** Customizable backgrounds with presets and image upload for DSH Web UI
...
- **Tags:** `ai-guide`, `rag`, `vibe-coding`, `tutorials`
- **Why use it:** Comprehensive AI resource hub and tutorials covering DeepSeek, GPT, RAG, and Agent skills.
...
- **Tags:** `harness-engineering`, `tutorial`, `dsh`
- **Why use it:** Comprehensive 0-to-1 tutorial covering harness engineering fundamentals for DSH.
...
- **Tags:** `research`, `web-search`, `tiktok`
- **Why use it:** Auto-searches 8 major Chinese platforms for recent 30 days and generates citable reports.
...
- **Tags:** `research`, `learning`, `marketplace`
...
- **Why use it:** Search 65,600+ API docs from 20 Chinese platforms directly.
...
- **Tags:** `awesome-list`, `plugins`, `discovery`
- **Why use it:** Curated directory of 280+ DSH community plugins
...
- **Tags:** `deepseek-harness-plugin`, `dsh-plugin-market`
- **Why use it:** Interactive K-line analysis with multi-market data, technical indicators, support/resistance levels
...
- **Tags:** `curated`, `verified`, `directory`
- **Why use it:** Curated, evidence-led directory with verified loadable extensions.
...
- **Tags:** `registry`, `open-data`, `filtered`
...
- **Tags:** `finance`, `stock`, `quant`, `curated`
...
- **⭐ Stars:** 5,853
- **Language:** TypeScript
- **Description:** DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发（dsh-market.com）
- **Tags:** `web`, `marketplace`, `dsh`
- **Why use it:** Web-based DSH plugin aggregation hub with community-driven creative workshop distribution.
...
- **Tags:** `awesome-list`, `plugin-registry`, `dsh`
- **Why use it:** Curated plugin radar with 9000+ candidates, real-measure ranking and auto-updates.
...
- **Tags:** `awesome-list`, `plugin-registry`, `dsh`
- **Why use it:** Curated plugin directory for the DeepSeek Harness ecosystem and community.
...
- **Tags:** `awesome-list`, `ecosystem`, `dsh`
...
- **Why use it:** Bilingual curated list of DSH plugins, tools, skills and integrations.
...
- **⭐ Stars:** 270
- **Language:** JavaScript
- **Description:** 用 30 秒为你的 DeepSeek Harness找到合适的插件。 仓库由脚本每天自动抓取，再经��工逐个核实——真插件进目录，蹭热度的进黑名单，每条剔除理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **Tags:** `awesome-list`, `discovery`, `curated`
- **Why use it:** Auto-curated plugin discovery with daily verification and clear recommendations.
...
- **Why use it:** Ultimate DSH guide with quickstart, resources and curated plugin toolkit.
...
- **Why use it:** Comprehensive curated list of DSH plugins, skills, and resources
...
- **Tags:** `marketplace`, `plugin-directory`, `registry`
- **Why use it:** Plugin marketplace and hub with 3100+ plugins and public API
...
- **Tags:** `marketplace`, `plugins`, `community`
- **Why use it:** Plugin marketplace and community hub for DeepSeek Harness
...
- **Tags:** `awesome-list`, `community`, `dsh`
- **Why use it:** Curated awesome list of DeepSeek Harness plugins for discovery
...
- **Why use it:** Community-maintained plugin catalog with auto-sync.
...
- **Tags:** `chinese-wisdom`, `bazi`, `fengshui`, `iching`
- **Why use it:** Chinese traditional wisdom AI: Bazi, Fengshui, Iching
...
- **Why use it:** Curated awesome list of DeepSeek Harness plugins for ecosystem discovery and reference
...
- **Why use it:** Community-curated collection of useful DSH plugins for all users
...
- **Why use it:** Plugin navigator with installation guides, permissions and risk info
...
- **Why use it:** Verified star-ranked community plugin collection for DSH ecosystem
...
- **Why use it:** Evidence-backed plugin radar with 2Origin lab for DSH exploration
...
- **Tags:** `plugin-portal`, `static-site`, `deepseek-harness`
- **Why use it:** Static web portal to discover, filter and install 227+ DSH plugins
...
- **Tags:** `awesome-list`, `deepseek-harness`
- **Why use it:** Archived mirror — original repo moved to awesome-dsh-plugin org

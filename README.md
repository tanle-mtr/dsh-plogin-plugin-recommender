...
**Last updated:** 2026-08-22 16:30:33 UTC  
...
- **Tags:** `coding`, `terminal`, `r1`
- **Recommendation:** Terminal-native coding agent with R1
...
- **Recommendation:** Beginner tutorial for DSH harness engineering
...
- **Tags:** `coding-agent`, `llm-evaluation`, `mcp`
...
- **Recommendation:** Vision bridge for text-only coding agents via OCR
...
- **Tags:** `agent-runtime`, `desktop`, `coding-agent`
- **Recommendation:** Rust agent runtime with polished desktop IDE
...
- **Tags:** `code-review`, `static-analysis`, `tech-debt`
- **Recommendation:** AI code review with engineering book citations
...
- **Recommendation:** Official Swift-native macOS coding agent built by DeepSeek
...
- **Tags:** `agent`, `coding`
- **Recommendation:** Team coding agents across multiple harness platforms
...
- **Tags:** `superpowers`, `skills`, `coding-agent`
- **Recommendation:** TDD, debugging & planning skills for DSH
...
- **Recommendation:** Plugin development and audit tool
...
- **Recommendation:** Plugin dev best-practices and troubleshooting archive
...
- **Tags:** `skill`, `dsh-plugin`, `testing`
- **Recommendation:** Agent skills for building and testing DSH plugins
...
- **Tags:** `plugin-manager`, `mcp`, `gui`
- **Recommendation:** Built-in GUI plugin MCP skill manager with hot reload
...
- **Tags:** `claude`, `bridge`
- **Recommendation:** Bridges Claude Code memory
...
- **Tags:** `claude`, `compat`
- **Recommendation:** Claude Code compat layer
...
- **Recommendation:** Install, extend, customize DSH models and tools
...
- **Recommendation:** Unified deduplicated plugin discovery registry
...
- **Recommendation:** CLI for discover, install, update DSH plugins
...
- **Tags:** `marketplace`, `browser`, `ui`
- **Recommendation:** Browse, search, rate and install DSH plugins
...
- **Tags:** `desktop`, `ui`, `dsh`
- **Recommendation:** Modern desktop client for DSH
...
- **Tags:** `ui`, `desktop-extension`, `web-ui`
- **Recommendation:** Web UI with task board, git graph, mobile support
...
- **Tags:** `sidebar`, `ui`, `terminal`
- **Recommendation:** Open sidebar with file editor, terminal, Git, sub-agents
...
- **Tags:** `tui`, `terminal`, `react`
- **Recommendation:** Claude Code-style TUI with whale theme and streaming
...
- **Tags:** `desktop-companion`, `plugin-sdk`
...
- **Tags:** `desktop`, `tauri`
- **Recommendation:** Lightweight Tauri desktop app with preset plugins, zero setup
...
- **Tags:** `desktop-app`, `local-first`
- **Recommendation:** Local-first AI desktop workspace with files, web research, office
...
- **Tags:** `desktop`, `ui`
- **Recommendation:** CodePilot-inspired desktop client for DSH
...
- **Recommendation:** Open-source Electron GUI for DeepSeek Harness
...
- **Recommendation:** Visual non-linear canvas conversation workspace
...
- **Tags:** `task-management`, `taskboard`, `webui`
- **Recommendation:** Native SQLite-backed taskboard with Web UI
...
- **Tags:** `ui`, `usage-tracking`, `information-bar`
- **Recommendation:** Live provider model balance and pricing info bar
...
- **Tags:** `usage`, `charts`
- **Recommendation:** Token usage & cost charts
...
- **Tags:** `hud`, `status`
- **Recommendation:** Floating status HUD panel
...
- **⭐ Stars:** 8
- **Language:** Rust
- **Description:** StarHub 是一款跨���台桌面应用（Tauri 2 + Rust 主进程 + DeepSeek Harness React 工作台 + Go Sidecar），把开发运维日常高频工具整合到同一个窗口 —— 数据库、SSH/SFTP、Docker 面板与 AI 助手。目标是减少在 Navicat、Xshell、Portainer、文件管理器和 AI 对话窗口之间来回切换的成本。  前端架构：基于 DeepSeek Harness 原生 React 工作台（/starhub-react 路由）。资产、设置、SSH 终端、SFTP、数据库
- **Tags:** `desktop`, `tauri`
- **Recommendation:** All-in-one desktop app
...
- **Recommendation:** Electron desktop shell integrating DSH web services
...
- **Recommendation:** Self-evolving context database for agents
...
- **Tags:** `rag`, `knowledge`, `wiki`
- **Recommendation:** LLM knowledge base with RAG and wiki
...
- **Recommendation:** Portable local-first memory layer for AI agents
...
- **Tags:** `memory`, `rag`, `long-term-memory`
- **Recommendation:** Self-evolving memory OS with token savings
...
- **Recommendation:** Unlimited persistent memory system for OpenClaw
...
- **Tags:** `knowledge`, `rag`
- **Recommendation:** Comprehensive AI knowledge base and skill encyclopedia
...
- **Recommendation:** Durable long-term agent memory with recall
...
- **Tags:** `plugin-development`, `knowledge-base`, `dsh-plugin`
- **Recommendation:** Official DSH plugin dev docs as on-demand agent skill
...
- **Tags:** `memory`, `recall`, `handoff`, `dsh-plugin`
- **Recommendation:** HTTP recall memory handoff and experience via PowerContext
...
- **Tags:** `multi-agent`, `swarm`, `mcp`
- **Recommendation:** Multi-agent swarm orchestration platform
...
- **Tags:** `agent`, `memory`, `multi-model`
- **Recommendation:** Self-evolving AI assistant with memory
...
- **Tags:** `skill`, `persona`, `agent`
- **Recommendation:** Digital persona skill generator
...
- **Tags:** `low-code`, `crm`, `erp`
- **Recommendation:** AI no-code platform for business systems
...
- **Tags:** `agent-skills`, `agent-orchestration`, `mcp`
- **Recommendation:** Unified agent workspace and skill orchestration
...
- **Tags:** `agent-collaboration`, `multi-agent`, `skills`
- **Recommendation:** Enterprise multi-agent workspace and collaboration
...
- **Tags:** `agent-skills`, `ai-agent`, `cognitive-enhancement`
- **Recommendation:** Cognitive-enhancement skills from J-space research
...
- **Tags:** `ai-agent`, `content-discovery`, `personal-ai`
- **Recommendation:** Cross-platform local-first content discovery agent
...
- **Tags:** `agent-framework`, `workflow-automation`, `vibecoding`
- **Recommendation:** Auto-routes skills and orchestrates harness workflows
...
- **Tags:** `video`, `ffmpeg`, `agent-skill`
- **Recommendation:** Automated Vox-style paper-collage video generation
...
- **Recommendation:** Makes agents architecture-aware with baseline-first drift checking
...
- **Tags:** `vision`, `computer-use`
- **Recommendation:** Vision toolkit enabling text-only LLMs to see and understand images
...
- **Tags:** `task-manager`, `agent-skills`
- **Recommendation:** Self-hosted human-in-loop task manager with web/mobile access
...
- **Recommendation:** Turns AI conversations into organized reusable workflows across platforms
...
- **Recommendation:** Enable multi-agent team collaboration in DeepSeek Harness
...
- **Tags:** `vision`, `dsh-native`
- **Recommendation:** Native DSH vision integration: image Q&A, OCR, UI restoration
...
- **Tags:** `plugin-discovery`, `skill`, `automation`
- **Recommendation:** Skill for searching, installing & verifying DSH plugins
...
- **Tags:** `infra`, `skills`, `ai-dev`
- **Recommendation:** Specialized skills for AI infra dev & debugging
...
- **Tags:** `creative-writing`, `fiction-writing`, `screenwriting`
- **Recommendation:** Novel writing & short-drama production
...
- **Tags:** `agent-skills`, `embeddings`, `skill-md`
- **Recommendation:** Turn SKILL.md files into retrievable skill corpora
...
- **Recommendation:** Superpowers skill port to Reasonix
...
- **Tags:** `dsh`, `dsh-plugin`, `deepseek-harness`
...
- **Tags:** `ctf`, `pentest`, `security`
- **Recommendation:** Comprehensive reverse engineering and pentest skill with 85 SKILL.md
...
- **Recommendation:** Skill for developing DSH plugins with standard patterns
...
- **Tags:** `agent-skills`, `deep-research`, `marketing-automation`
- **Recommendation:** 88 open-source skills for research, marketing, and workflows
...
- **Tags:** `spec-programming`, `agent-skills`, `vibe-coding`
- **Recommendation:** Repository-native spec-driven development skill
...
- **Recommendation:** OCR and image-to-text skill trained on 34 images
...
- **Recommendation:** Build-manage DSH plugins with slots and credentials
...
- **Tags:** `agent-handoff`, `session-memory`, `agent-skills`
- **Recommendation:** Cross-agent session memory and context handoff
...
- **Tags:** `skill`, `ui`
- **Recommendation:** WorkBuddy-style skill picker for composer insertion
...
- **Tags:** `skill`, `agent`
- **Recommendation:** Chinese traditional wisdom AI agent with local engine
...
- **Tags:** `skill`, `coding`
- **Recommendation:** Codex skill adapted for code simplification
...
- **Tags:** `skill`, `image`
- **Recommendation:** Image reading & generation skill pack
...
- **Tags:** `agent-skills`, `canvas`, `dsh-skill`, `mcp-tools`
- **Recommendation:** Infinite canvas with agentic creative skills
...
- **Tags:** `skill`, `agent`, `development-practices`
- **Recommendation:** Portable engineering discipline skill for DSH agents
...
- **Recommendation:** Record macOS desktop workflows turn into agent skills
...
- **Tags:** `skill`, `docx`, `gongwen`, `ai-docs`
- **Recommendation:** Chinese official document processing with format check
...
- **Tags:** `math`, `skills`
- **Recommendation:** Math modeling skill cards + preset
...
- **Tags:** `godot`, `game-dev`
- **Recommendation:** Godot 4.x game dev skill
...
- **Tags:** `agent`, `product`
- **Recommendation:** Virtual product team preset
...
- **Tags:** `mcp-server`, `cloud-base`
- **Recommendation:** CloudBase backend with DB, auth, functions via MCP for AI agents
...
- **Tags:** `search`, `mcp`
- **Recommendation:** Strongest free web search bridge for all models
...
- **Recommendation:** Skill and MCP management panel for DSH Web UI
...
- **Recommendation:** Hot-reload MCP JSON config plus skill management UI
...
- **Tags:** `chatgpt`, `oauth`
- **Recommendation:** OAuth integration for ChatGPT models in DSH
...
- **Tags:** `design`, `figma`, `ui-generator`
- **Recommendation:** Open-source Figma alternative with AI design
...
- **Recommendation:** Architecture diagram-as-code tool
...
- **Recommendation:** 470+ industrial image generation prompt templates
...
- **Tags:** `design`, `vector`, `agent-team`
- **Recommendation:** AI-native vector design tool with agent teams
...
- **Tags:** `design`, `ppt`
- **Recommendation:** AI design system with PPT and visual editor
...
- **Recommendation:** Preview & edit OpenPencil .op documents in-chat
...
- **Recommendation:** Create litigation timelines and diagrams for legal docs
...
- **Tags:** `design`, `ui`
- **Recommendation:** Design aesthetics to avoid AI look in web apps
...
- **Tags:** `ai-image`, `ai-video`, `text-to-video`, `dsh-plugin`
- **Recommendation:** AI video/image/audio generation skills with vision tools
...
- **Recommendation:** Enhancement suite for AI chat platforms
...
- **Recommendation:** Browser automation for AI agents using real sessions
...
- **Recommendation:** Chrome sidebar for direct browser control via DSH
...
- **Recommendation:** Tabbit browser automation for DSH
...
- **Tags:** `resume`, `privacy`, `portfolio`
- **Recommendation:** Privacy-focused resume builder
...
- **Tags:** `image`, `upload`, `cdn`
- **Recommendation:** Ultimate image uploader for 60+ services
...
- **Tags:** `preset`, `configuration`, `dsh-plugin`
- **Recommendation:** Two-phase DSH preset with minimal and full tools
...
- **Tags:** `vfs`, `agent-tools`, `infrastructure`
...
- **Tags:** `model-switch`, `cli`, `utility`
- **Recommendation:** One-click model switch across multiple AI platforms
...
- **Tags:** `marketplace`, `utility`, `plugin`
- **Recommendation:** Visual plugin marketplace with one-click install
...
- **Recommendation:** Plugin radar discovering and rating 9000+ candidates
...
- **Recommendation:** Auto-curated plugin discovery with verification
...
- **Tags:** `awesome-list`, `utility`
- **Recommendation:** Bilingual curated DSH plugins and tools index
...
- **Tags:** `utility`, `oauth`
- **Recommendation:** Use ChatGPT/Claude/Grok subs as DSH LLM providers
...
- **Tags:** `compatibility`, `migration`, `infrastructure`
- **Recommendation:** Bridges Pi extensions as native DSH plugins
...
- **Tags:** `cost-tracking`, `utility`, `budget`
- **Recommendation:** Track session/daily costs & budget for DSH
...
- **Tags:** `notes`, `docker`, `utility`
- **Recommendation:** Smartisan-style notes with Docker & DSH plugin support
...
- **Recommendation:** Crash recovery & one-click rollback system
...
- **Tags:** `dsh`, `ui`, `plugin-management`
- **Recommendation:** Plugin management console with official repo browser
...
- **Tags:** `dsh`, `containers`, `dsh-plugins`
- **Recommendation:** Multi-container DSH runner with embedded WebView UI
...
- **Tags:** `plugin`, `awesome-list`
- **Recommendation:** Curated plugin directory, 280+ plugins across 14 categories
...
- **Tags:** `utility`, `audit`
- **Recommendation:** Context injection audit with token cost analysis
...
- **Tags:** `utility`, `skills`
- **Recommendation:** Skills management plugin for DSH
...
- **Recommendation:** Swift Cycle governance with version pinning
...
- **Recommendation:** Package manager for AI agent assets (42 skills)
...
- **Tags:** `utility`, `mcp`
- **Recommendation:** MCP server management via web UI
...
- **Tags:** `config`, `backup`
- **Recommendation:** Backup/restore DSH config
...
- **Recommendation:** Diagnoses and resolves plugin conflicts
...
- **Tags:** `publisher`, `publishing`, `tools`
- **Recommendation:** One-click plugin publishing and validation
...
- **Recommendation:** Public gallery of animated pets for CLI tools
...
- **Recommendation:** Whale Girl themed skins for DeepSeek Harness
...
- **Tags:** `theme`, `ui`
- **Recommendation:** Glass-morphism theme with full customization
...
- **Tags:** `theme`, `visual`
- **Recommendation:** WebGPU ocean-themed animated skin for DSH
...
- **Tags:** `theme`, `skins`, `dark-mode`, `ui`
- **Recommendation:** 34 opencode themes one-click for DSH UI
...
- **Recommendation:** Customizable backgrounds
...
- **Tags:** `guide`, `resources`, `tutorials`
- **Recommendation:** Comprehensive AI resource directory
...
- **Recommendation:** Curated DSH plugin discovery and reference list
...
- **Recommendation:** Searches CN internet for 30-day research reports
...
- **Recommendation:** Curated plugin list for the DSH ecosystem
...
- **Recommendation:** Curated DSH ecosystem plugins, tools and infrastructure list
...
- **Recommendation:** DSH principles, marketplace insights & best practices
...
- **Recommendation:** Ultimate DSH guide with curated plugins & resources
...
- **Recommendation:** Curated catalog of DSH plugins, skills & MCPs
...
- **Tags:** `marketplace`, `catalog`, `plugin-hub`
- **Recommendation:** 3100+ plugin marketplace with search & API
...
- **Recommendation:** Search 65k+ Chinese platform APIs across multiple AI agents
...
- **Recommendation:** Interactive K-line analysis with technical indicators
...
- **Tags:** `stock`, `finance`
- **Recommendation:** Stock/finance plugin list
...
- **Recommendation:** Curated community plugin collection
...
- **Recommendation:** Plugin navigation and installation guide
...
- **Tags:** `radar`, `awesome-list`
- **Recommendation:** Evidence-backed plugin radar and registry
...
- **Tags:** `portal`, `awesome-list`
- **Recommendation:** Static portal to discover and filter 227+ plugins
...
- **Tags:** `moved`
- **Recommendation:** Redirect to canonical awesome-dsh-plugin repo
...
- **Recommendation:** Verified star-ranked community plugin list
...
- **Tags:** `awesome-list`, `auto-crawled`
- **Recommendation:** Automatically crawled daily plugin directory
...
- **Tags:** `ai-recommender`
- **Recommendation:** AI-powered curated plugin recommendations
...
- **Tags:** `plugin-repo`
- **Recommendation:** General DSH plugin repository listing
...
- **Tags:** `toy`, `web`, `mobile-first`
- **Recommendation:** Web simulation of traditional Chinese cicada toy
...
- **Tags:** `marketplace`, `plugins`, `harness`
...
- **Recommendation:** Anime search plugin with Bangumi ratings & magnet
...
- **Tags:** `marketplace`, `plugin-marketplace`
- **Recommendation:** One-click plugin marketplace for DSH
...
- **Tags:** `marketplace`, `webui`, `plugin-market`
- **Recommendation:** Community plugin market for DSH Web GUI
...
- **Tags:** `awesome-list`, `community`
- **Recommendation:** Curated DSH plugin & tool directory
...
- **Recommendation:** Community-maintained plugin catalog
...
- **Recommendation:** Auto-generated curated list of all DSH Cordis plugins
...
- **Tags:** `community`
- **Recommendation:** Beta closing photo wall with OAuth login
...
- **Recommendation:** Public awesome-list directory for DSH ecosystem discovery
...
- **Recommendation:** Curated list of selected DSH plugins
...
- **Recommendation:** Community plugin catalog
...
- **Tags:** `curated`, `directory`
- **Recommendation:** Curated plugin directory
...
- **Tags:** `registry`, `open-data`
- **Recommendation:** Open plugin registry
...
- **Tags:** `curated`, `2026`
- **Recommendation:** 2026 curated plugin list
...
- **Recommendation:** Evidence-aware curated plugin list
...
- **Recommendation:** Complete DSH tools list, 1000+ repos by star

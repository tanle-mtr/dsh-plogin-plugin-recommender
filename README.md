...
|--------|-------|
| **Plugins tracked** | 200 |
| **Total community stars** | 1,058,851 ⭐ |
| **Categories** | 11 |
| **Last updated** | 2026-09-19 09:21:16 UTC |
...
| Plugin | Stars | Why |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 229,533 | Core DSH platform enabling plugin-based AI agent o |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 96,995 | Open-source design system plugin for AI coding age |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 72,819 | Multi-agent swarm coordination with autonomous wor |

---

## Categories

- [Coding Agents & Harness Tools](#coding-agents-&-harness-tools) — 18 plugins
- [UI & Desktop Extensions](#ui-&-desktop-extensions) — 26 plugins
- [Memory & Knowledge (RAG)](#memory-&-knowledge-(rag)) — 12 plugins
- [Agent Skills & Workflows](#agent-skills-&-workflows) — 43 plugins
...
- [Utilities & Infrastructure](#utilities-&-infrastructure) — 22 plugins
- [Themes & Skins](#themes-&-skins) — 4 plugins
- [Research & Analysis](#research-&-analysis) — 13 plugins
- [Other](#other) — 42 plugins

---

## 📂 Category Docs

- [Coding Agents & Harness Tools](coding-agents-harness-tools) (18)
- [UI & Desktop Extensions](ui-desktop-extensions) (26)
- [Memory & Knowledge (RAG)](memory-knowledge-rag) (12)
- [Agent Skills & Workflows](agent-skills-workflows) (43)
- [MCP Servers & Tools](mcp-servers-tools) (5)
- [Visual & Design](visual-design) (8)
- [Browser & Web Automation](browser-web-automation) (7)
- [Utilities & Infrastructure](utilities-infrastructure) (22)
...
- **Why use it:** Core DSH platform enabling plugin-based AI agent orchestration
...
- **Tags:** `ai-agents`, `multi-agent`, `skills`
- **Why use it:** Self-evolving multi-agent harness with memory and skill system
...
- **Tags:** `coding-agent`, `prompt-caching`, `terminal`
- **Why use it:** Terminal-native AI coding agent with prompt caching stability
...
- **Tags:** `agent-workspace`, `enterprise`, `dsh-plugin`
- **Why use it:** Enterprise-grade multi-engine agent workbench with visual editor
...
- **Tags:** `agent-os`, `evaluation`, `dsh-plugin`
- **Why use it:** Self-improving agent OS with gated evaluation and budgeted evolution loop
...
- **Why use it:** First vision plugin — paste images for structured JSON evidence
...
- **Tags:** `virtual-terminal`, `vfs`, `agent-sandbox`, `dsh-plugin`
- **Why use it:** Virtual terminal and filesystem for isolated agent sandboxes
...
- **Tags:** `agent-runtime`, `rust`, `coding-agent`, `openclaw`
- **Why use it:** High-performance Rust-based agent runtime paired with a polished desktop coding companion
...
- **Tags:** `coding-agent`, `rpc`, `sub-agents`, `mcp`, `terminal`, `tui`
- **Why use it:** Coding agent with RPC, sub-agents, hashline edits, and MCP — full terminal TUI control
...
- **Tags:** `cybersecurity`, `vulnerability`, `security-audit`, `redteam`
- **Why use it:** AI security offensive and defensive platform auditing code for hallucinations and vulnerabilities
...
- **Tags:** `cli`, `plugin-manager`, `schemas`, `resolver`
- **Why use it:** CLI and schemas for DSH Plugin Hub — resolver, manager, and agent tooling
...
- **Tags:** `agent-review`, `self-evolution`, `prompt-engineering`, `dsh-plugin`
- **Why use it:** Enables composable, reviewable agent workflows with self-evolution capabilities
...
- **Why use it:** Adds multimodal vision to text-only LLMs for screenshot, UI and chart analysis
...
- **Why use it:** Comprehensive 87-module reverse engineering and pentesting skill for security research
...
- **Tags:** `plugin-development`, `codex`, `validator`
...
- **Why use it:** Modern desktop client for DSH ecosystem with plugin support
...
- **Why use it:** Plugin aggregation ecosystem for DSH Web, distributed via creative workshop
...
- **Why use it:** Official desktop client extending DSH beyond the browser interface
...
- **Why use it:** Open sidebar foundation with file editor, terminal, Git, sub-agents
...
- **Tags:** `cli`, `skills`, `dsh-plugin`, `codex`
- **Why use it:** Modern flexible task panel embedding into coding agents
...
- **Tags:** `tui`, `terminal`, `dsh-plugin`, `claude-code`
- **Why use it:** Claude Code-style TUI with whale toolbar and real-time streaming status
...
- **Tags:** `deepseek-harness`, `floating-widget`, `dsh-plugin`
- **Why use it:** Cute floating whale widget tracks DeepSeek balance with drag-and-drop and smooth animations
...
- **Tags:** `dsh-desktop`, `tauri`, `desktop-app`
- **Why use it:** Tauri-based lightweight desktop client with zero setup and pre-installed plugins
...
- **Tags:** `desktop-app`, `electron`, `gui`, `ssh-client`, `remote-access`
- **Why use it:** Zero-setup Windows desktop GUI with Codex, plugins, SSH, and mobile remote access
...
- **Tags:** `desktop-app`, `local-first`, `mcp`, `office-automation`
- **Why use it:** Local-first AI desktop workspace with sessions, projects, web research, and Office
...
- **Tags:** `canvas`, `non-linear`, `session-explorer`, `branching-workspace`
...
- **Tags:** `desktop-app`, `local-first`, `multi-model`, `self-evolving`, `privacy`
- **Why use it:** Local-first AI desktop with multi-model support, self-evolving skills, and multi-Harness routing
...
- **Tags:** `office`, `ui-extension`, `productivity`
- **Why use it:** Brings full office suite—spreadsheets, docs, slides—into the Harness environment.
...
- **Tags:** `mobile`, `ios`, `ui-extension`
- **Why use it:** Native iOS client bringing workspaces, sessions, and real-time agent execution to iPhone.
...
- **Tags:** `desktop`, `ui-extension`, `client`
...
- **⭐ Stars:** 165
- **Language:** TypeScript
- **Description:** 开源版锤子便签，复刻锤科美学，一���Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **Tags:** `notes`, `docker`, `smartisan`, `multi-tenant`
- **Why use it:** Open-source Smartisan-style notes app with Docker, skill integration and public export
...
- **Why use it:** Web UI skill and MCP management tool
...
- **Why use it:** Community plugin market directly in DSH Web GUI
...
- **Why use it:** Electron desktop console for multi-tab Harness & plugin management
...
- **Why use it:** Bioinformatics desktop agent with skill store and offline mode
...
- **Tags:** `ui`, `usage-tracking`, `pricing`
- **Why use it:** Live usage tracking bar showing model, balance, and pricing
...
- **Why use it:** Context injection audit tool with ring-panel UI and token cost analysis
...
- **Why use it:** WorkBuddy-style skill picker for fast agent skill insertion
...
- **⭐ Stars:** 12
- **Language:** Rust
- **Description:** StarHub — All-in-One DevOps Desktop Command Center。��开发运维每天要用到的工具收进同一个窗口:数据库客户端 · SSH 终端 · SFTP · Docker · AI 助手,以及 AI 驱动的沙箱桌面与 Android 实体机操作。
...
- **Tags:** `enhancement`, `keybindings`, `terminal`, `trace`
- **Why use it:** Curated DSH plugins: notifications, traces, keybindings, terminal
...
- **Why use it:** Electron desktop wrapper integrating dsh-web-ui, ModLens, and more
...
- **Why use it:** LLM knowledge platform with RAG, agents and self-maintaining wiki
...
- **Tags:** `memory`, `rag`, `token-savings`, `dsh-plugin`
...
- **Tags:** `agent-memory`, `stateful-agents`, `dsh-plugin`
- **Why use it:** Dedicated memory library for building stateful agentic applications
...
- **Why use it:** Dedicated memory management kit that remembers and refines agent context
...
- **Tags:** `agent-memory`, `milvus`, `rag`, `hybrid-search`
- **Why use it:** Persistent unified memory layer for AI agents using Markdown and Milvus hybrid search
...
- **Tags:** `long-term-memory`, `mcp`, `personal-ai`, `memory-hub`
- **Why use it:** Personal AI memory hub giving all agents shared persistent context and long-term memory
...
- **Tags:** `context-management`, `dashboard`, `cordis-plugin`
- **Why use it:** Comprehensive context dashboard and management toolkit for monitoring and controlling conversations
...
- **Tags:** `knowledge-base`, `awesome-list`, `ai-encyclopedia`, `multimodal`, `mlops`
- **Why use it:** Comprehensive AI encyclopedia covering agents, RAG, multimodal, MLOps, and learning roadmaps
...
- **Why use it:** Proactive associative memory with zero-prompt recall injection
...
- **Tags:** `agent-skill`, `knowledge-base`, `documentation`
- **Why use it:** Official DSH docs archive as on-demand agent skill, supports EN/ZH
...
- **Tags:** `multi-agent`, `swarm`, `agentic-workflow`
- **Why use it:** Multi-agent swarm coordination with autonomous workflow engine
...
- **Why use it:** Distill reasoning patterns into reusable agent skills
...
- **Tags:** `agent-orchestration`, `workspace`, `dsh-plugin`
- **Why use it:** Unify agents and workspaces across all devices with task board tracking
...
- **Why use it:** Largest curated skills marketplace with auto-scraped GitHub skills catalog
...
- **Tags:** `agent-control-plane`, `long-horizon`, `dsh-plugin`
- **Why use it:** Long-horizon agent control plane for durable governed multi-harness work
...
- **Tags:** `agent-skills`, `workflow-automation`, `vibecoding`, `dsh-plugin`
- **Why use it:** Intelligent skill routing and workflow orchestration, 21pp reward boost
...
- **Tags:** `agent-skills`, `cognitive-enhancement`, `dsh-plugin`, `deepseek`
...
- **Tags:** `agent-skill`, `video-generation`, `ffmpeg`, `tts`
- **Why use it:** End-to-end automated video generation skill turning topics into Vox-style explainer videos
...
- **Tags:** `agent-teams`, `multi-agent`, `workflow`, `dsh-plugin`
- **Why use it:** Enables multi-agent collaboration and coordinated workflows within DeepSeek Harness
...
- **Tags:** `novel-writing`, `rag`, `creative-writing`, `long-form`
- **Why use it:** Structured AI novel writing workflow with worldbuilding, chapter management, and revision support
...
- **Tags:** `agent-skills`, `skill-routing`, `vector-search`, `reranking`
- **Why use it:** Turns scattered skills into curated, retrieval-ready corpora with evaluation tools
...
- **Why use it:** Gives AI agents multimodal perception via video, audio, and screen analysis with verifiable evidence.
...
- **Tags:** `agent-skills`, `creative-writing`, `novel-writing`
- **Why use it:** Complete workflow toolkit for novel, short-drama, game and video script writing.
...
- **Tags:** `task-management`, `workflow`, `agent`
- **Why use it:** Native SQLite-backed task management with agent claim/review workflow and Web UI.
...
- **Tags:** `agent-skills`, `math-modeling`, `competition`, `gitops`
- **Why use it:** Full-stack math modeling competition skill with GitOps pipeline and auto code verification
...
- **Tags:** `skills`, `agent`, `architecture`, `codex`
- **Why use it:** Turn experience into repeatable execution skills compatible with multiple agent platforms
...
- **Tags:** `agent-skills`, `research`, `marketing-automation`, `multi-platform`
- **Why use it:** 88 open-source agent skills for research, marketing automation, and business workflows
...
- **Tags:** `ai-infra`, `dsh-plugin`, `skills`
- **Why use it:** Specialized skills for AI infra development and debugging
...
- **Why use it:** Auto-upgrades plugins along with DSH version

---

### [VDERR/echocat-skill-panel-3.0](https://github.com/VDERR/echocat-skill-panel-3.0)

- **⭐ Stars:** 130
- **Language:** JavaScript
- **Description:** DSH 技能调用审计 + 应用内 skill 管理器
- **Tags:** `dsh-plugin`, `skills`
- **Why use it:** Skill audit and in-app skill manager combined
...
- **Tags:** `agent-skills`, `skill-generator`
...
- **Why use it:** Superpowers TDD, debugging, and planning skills for DSH
...
- **Tags:** `agent-skills`, `web-search`, `research`
- **Why use it:** Web search, research & finance skills for AI agents
...
- **Tags:** `agent-skill`, `mentoring`, `code-review`
- **Why use it:** AI coding mentor that guides through project architecture step by step
...
- **Why use it:** 25 engineering & productivity skills bundled for immediate use
...
- **Tags:** `patent`, `legal-tech`, `analysis`
- **Why use it:** Patent infringement analysis skill producing competitor reports
...
- **Tags:** `document`, `chinese`, `workflow`
- **Why use it:** Full workflow tool for Chinese official document formatting & review
...
- **Tags:** `spec-programming`, `agent-skills`, `workflow`
- **Why use it:** Portable spec-driven dev skill with repository-native patterns
...
- **Tags:** `chinese-wisdom`, `agent-skill`, `cultural`
- **Why use it:** Unique Chinese traditional wisdom agent skill with deterministic engine
...
- **Tags:** `engineering`, `quality-gate`, `delivery`
- **Why use it:** Engineering discipline bundle: requirements grill + quality gate
...
- **Tags:** `qa`, `testing`, `skill-framework`
- **Why use it:** 11 QA skills with shared knowledge base for AI testing workflows
...
- **Tags:** `multi-agent`, `memory`, `continuity`
- **Why use it:** Durable multi-agent system with cross-session memory and continuity
...
- **Tags:** `handoff`, `session-memory`, `continuity`
- **Why use it:** Cross-platform session continuity memory for agent handoffs
...
- **Tags:** `skill`, `code-simplification`, `deepseek-harness`
- **Why use it:** Code simplification skill adapted from DSH for cleaner code generation
...
- **Tags:** `skill`, `tencent`, `api`, `deepseek-harness`
...
- **Tags:** `math-modeling`, `agent`, `skill`, `mcm`, `cumcm`
...
- **Tags:** `math-modeling`, `skill`, `data-preprocessing`, `deepseek-harness`
- **Why use it:** Full math modeling skill suite: data prep, coding, writing, and visualization
...
- **Tags:** `video`, `skill`, `remotion`, `motion-design`, `deepseek-harness`
- **Why use it:** Cinematic product video agent skill with 152 shot cards and Remotion templates
...
- **Tags:** `godot`, `game-development`, `gdscript`, `skill`, `deepseek-harness`
...
- **Tags:** `skill`, `workflow`, `planning`, `deepseek-harness`
- **Why use it:** Plan-then-execute mechanism for AI collaborative task workflows
...
- **Tags:** `agent-skill`, `plugin-dev`, `claude-code`, `codex`
- **Why use it:** Agent skill for building DSH plugins with Claude Code and Codex
...
- **Tags:** `routing`, `mcp`, `dsh-plugin`
- **Why use it:** Injector + router-standard kit enabling task-aware reasoning mode routing
...
- **⭐ Stars:** 67
- **Language:** TypeScript
- **Description:** 在 DeepSeek Harness / Claude Code / Cursor / Codex / Gemini CLI 里直接搜索 20 ���中国开放平台的 65,600+ 篇 API 文档；零配置，支持 Skill 与 DSH 原生插件。
- **Tags:** `api-docs`, `mcp`, `chinese-api`
- **Why use it:** Search 65000+ Chinese API docs directly in DSH with zero config
...
- **Why use it:** Pixel-to-text OCR tools enabling image reading for text-only models
...
- **Tags:** `mcp`, `skills`, `agent-config`, `deepseek-harness`
- **Why use it:** One-click MCP/Skills setup across Claude Code, Codex, DSH, Cursor and more
...
- **Tags:** `agent-skills`, `ui-generator`, `design-systems`
- **Why use it:** Open-source design system plugin for AI coding agents
...
- **Tags:** `architecture-diagram`, `mermaid-alternative`, `agent-skills`
- **Why use it:** Generate verifiable architecture and sequence diagrams via code
...
- **Why use it:** 530+ GPT Image prompt cases with industrial templates
...
- **Tags:** `design-studio`, `ppt`, `prototyping`, `visual-editor`
- **Why use it:** AI-powered native design and PPT studio with visual editor, templates, and prototyping
...
- **Tags:** `ui-components`, `charts`, `forms`, `interactive`
- **Why use it:** Generates interactive UI components (charts, forms, quizzes) inline in assistant replies
...
- **Why use it:** Legal timeline & relationship diagram generator for litigation cases
...
- **Tags:** `video`, `image`, `multimedia`
- **Why use it:** AI video/image/audio generation skills with storyboard and corpus
...
- **Why use it:** Enhances major AI chat platforms with prompt management for any website
...
- **Why use it:** Seamless logged-in browser automation for AI agents
...
- **Tags:** `computer-vision`, `ocr`, `gui-automation`, `vision-tools`
- **Why use it:** Powerful vision toolkit for text-only LLMs with OCR, screenshot analysis, and UI restoration
...
- **⭐ Stars:** 508
- **Language:** TypeScript
- **Description:** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的模型补���搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **Tags:** `web-search`, `web-fetch`, `agent-tools`, `free`
- **Why use it:** Strongest free web search bridge — no signup, no API key required for any model
...
- **Tags:** `browser-automation`, `fingerprint-spoofing`, `playwright`, `android-emulation`
- **Why use it:** Persistent browser with fingerprint spoofing, unlimited local profiles, and Android emulation
...
- **Tags:** `mobile-automation`, `ios`, `mcp`
- **Why use it:** Live iOS Simulator + USB iPhone automation with 22 agent tools inside conversations.
...
- **Why use it:** Universal image uploader supporting 60+ hosting services
...
- **Tags:** `low-code`, `ai-assistant`, `self-hosted`
...
- **Why use it:** One-click install and seamless model switch across 10+ coding agents
...
- **Tags:** `deepwiki`, `documentation`, `dsh-plugin`, `deepseek`
- **Why use it:** Turns codebases into accurate technical docs and AI-ready context fast
...
- **Why use it:** Leverage existing ChatGPT, Claude, Grok subscriptions as DSH LLM providers.
...
- **Why use it:** Track session and daily costs, budgets, token usage across multiple LLM providers.
...
- **Tags:** `provider`, `llm`, `model-catalog`
- **Why use it:** Adds Command Code model access with live catalog and plan-aware model selection.
...
- **Tags:** `remote-access`, `p2p`, `encryption`, `multi-device`
- **Why use it:** P2P encrypted multi-device remote access solution for DSH Harness and CodeX
...
- **Tags:** `migration`, `compatibility-layer`, `pi-agent`, `dsh-plugin`
- **Why use it:** Bridges Pi and DSH ecosystems with one ABI running unmodified Pi extensions natively
...
- **Tags:** `plugin-discovery`, `automation`, `dsh-plugin`, `verification`
- **Why use it:** Automates plugin discovery, installation and verification directly from GitHub
...
- **Tags:** `config-manager`, `backup`, `sync`
- **Why use it:** Full DSH config backup, restore, and sync via WebDAV
...
- **Tags:** `infrastructure`, `plugin-management`, `utilities`
- **Why use it:** Infrastructure plugin for DSH ecosystem console and dev guide
...
- **Tags:** `skills`, `management`, `security`
- **Why use it:** Unified local Agent Skills loader with security management
...
- **⭐ Stars:** 42
- **Language:** TypeScript
- **Description:** A plugin-based Web work platform built on DeepSeek Harness, with global Skill management and native workspace integration. 基于 DeepSeek Harness 的插件化 Web 工作平台。
- **Tags:** `workbench`, `platform`, `infrastructure`
- **Why use it:** Plugin-based web workbench with global skill & workspace integration
...
- **Tags:** `dsh-plugin`, `container`, `launcher`
- **Why use it:** Run multiple DSH versions in isolated containers with one-click plugin import
...
- **Tags:** `migration`, `tool`, `utility`, `deepseek-harness`
- **Why use it:** Migration wizard moving sessions, memories and skills from Claude/Codex/OpenCode
...
- **Tags:** `dsh-plugin`, `launcher`, `runtime`, `cordis`
- **Why use it:** Plugin-native core unifying Runtime, Provider, Plugin, Skill and MCP orchestration
...
- **Tags:** `token-usage`, `ai-cost`, `data-visualization`
- **Why use it:** Real-time token usage, cost estimates, and API balance dashboard
...
- **Tags:** `tts`, `audio`, `xiaomi-mimo`
- **Why use it:** Free Xiaomi MiMo TTS API with preset/custom/browser voices
...
- **Tags:** `diagnostics`, `plugin-conflict`, `troubleshooting`
- **Why use it:** Diagnoses and resolves plugin version conflicts automatically
...
- **Tags:** `mascot`, `sprites`, `dsh-plugin`
- **Why use it:** Animated mascot pets that personalize any coding agent
...
- **Tags:** `theme`, `skin`, `whale-girl`, `dsh-plugin`
- **Why use it:** Adorable whale girl series skins to personalize your DeepSeek Harness interface
...
- **Tags:** `theme`, `glass-morphism`, `transparency`, `ui-customization`
- **Why use it:** Highly customizable glass-morphism theme for DSH web UI with adjustable blur and frosted effects
...
- **⭐ Stars:** 378
- **Language:** JavaScript
- **Description:** 🌊 DeepSeek Harness 海洋���肤与动态主题 | Real-time ocean theme with adjustable waves, sunset & glass opacity. DSH plugin + Chrome/Edge extension; keeps your new-tab homepage.
- **Tags:** `theme`, `skin`, `animated-background`
- **Why use it:** Beautiful animated ocean theme with adjustable waves and glassmorphism effects.
...
- **Tags:** `content-discovery`, `ai-agent`, `cross-platform`, `dsh-plugin`
- **Why use it:** Cross-platform self-evolving content discovery agent from major platforms
...
- **Tags:** `plugin-registry`, `ecosystem-radar`, `continuous-validation`
- **Why use it:** Ecosystem radar with 21k+ plugin discovery and k8s runtime validation for quality assurance
...
- **Tags:** `awesome-list`, `curated`, `plugin-index`
- **Why use it:** Curated comprehensive list of DSH plugins, tools, and infrastructure from the ecosystem
...
- **Why use it:** Curated bilingual plugin directory covering DSH extensions, skills, clients, and integrations
...
- **Tags:** `arxiv`, `latex`, `paper-writing`, `experiment-tracking`, `gpu-cluster`
- **Why use it:** One-stop academic research workbench: LaTeX writing, arXiv, experiments, GPU SSH orchestration
...
- **Tags:** `awesome-list`, `discovery`, `plugin-marketplace`
- **Why use it:** Curated plugin directory with daily GitHub scraping and scene-based categorization.
...
- **Tags:** `awesome-list`, `resources`, `plugins`
- **Why use it:** Comprehensive curated list covering plugins, MCPs, skills, patches, and orchestrators.
...
- **Why use it:** Ultimate DSH guide with quickstart, curated plugins, and practical toolkit resources.
...
- **Tags:** `education`, `marketplace`, `best-practices`
- **Why use it:** Learn DSH internals, browse the plugin marketplace, and explore best practices.
...
- **Tags:** `academic-search`, `mcp`, `citation-management`, `research-workflow`
- **Why use it:** Comprehensive academic search across multiple databases with citation verification and graph visualization
...
- **Tags:** `finance`, `stock`, `multi-agent`, `tushare`
- **Why use it:** Multi-agent financial analysis system with local Tushare DB and IM notification support
...
- **Tags:** `industry-research`, `skills`, `research`
- **Why use it:** Industry research with methodology skills and chain mapping
...
- **Tags:** `kline`, `trading`, `analysis`, `deepseek-harness`
- **Why use it:** Interactive K-line chart with multi-market tech indicators in DSH sidebar
...
- **Tags:** `ai-guide`, `llm`, `vibe-coding`
- **Why use it:** Comprehensive AI resource hub with tutorials for major LLMs
...
- **Why use it:** Official DSH marketplace for browsing and one-click plugin install
...
- **Tags:** `plugin-marketplace`, `curation`, `daily-update`
- **Why use it:** Daily-updated plugin marketplace with pre-reviewed submissions from across the internet
...
- **Tags:** `marketplace`, `catalog`, `plugin-directory`, `dsh`
- **Why use it:** Official DSH plugin marketplace and hub with 11000+ plugins and public API
...
- **Tags:** `handbook`, `documentation`, `agent-runtime`, `mcp`
- **Why use it:** Essential agent-first DSH handbook covering runtime, plugins, MCP, sandbox and troubleshooting
...
- **Tags:** `catalog`, `directory`, `plugin-marketplace`, `dsh`
- **Why use it:** Comprehensive DSH plugin catalog with 1958 repos, bilingual search and STAR sorting
...
- **Tags:** `awesome-list`, `dsh-plugin`
- **Why use it:** Auto-generated official plugin list by cordis.run
...
- **Why use it:** Curated list of useful DSH plugins and resources
...
- **Tags:** `awesome-list`, `plugin-marketplace`, `community`
- **Why use it:** Curated community plugin catalog auto-synced every 4 hours
...
- **Why use it:** Unofficial community-curated catalog of DSH plugins
...
- **Why use it:** Curated list of DSH plugins with community descriptions
...
- **Tags:** `awesome-list`, `resources`, `mcp`, `skills`, `deepseek-harness`
- **Why use it:** Comprehensive awesome list of DSH plugins, tools, skills and resources
...
- **Why use it:** Central plugin registry and curated list for DSH ecosystem discovery
...
- **Why use it:** Public GitHub directory for DSH plugin installation and ecosystem discovery
...
- **Tags:** `finance`, `stock`, `quant`, `trading`
- **Why use it:** 24 verified stock/finance/quant DSH plugins in bilingual list
...
- **Tags:** `awesome-list`, `curated-list`, `verified`
...
- **Why use it:** 2026 quality-checked curated DSH plugin list
...
- **Why use it:** Curated collection of useful DSH plugins in Chinese
...
- **⭐ Stars:** 6
- **Language:** Unknown
- **Description:** 🐳 DeepSeek Harness（DSH）工具全量清单——GitHub topic:dsh-plugin 生态 1000+ ��库按 star 排序。Awesome list for DeepSeek Harness tools.
- **Tags:** `awesome-list`, `inventory`, `github-topic`
...
- **Tags:** `agent-harness`, `ai-agent`, `ai-agents`, `autonomous-agent`, `awesome`, `awesome-list`, `cli`, `coding-agent`, `cordis`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `llm`, `llm-agent`, `open-source`, `plugin-ecosystem`, `plugins`, `web-ui`
- **Why use it:** A curated list of plugins for DeepSeek Harness (dsh) - DeepSeek Harness plugin e
...
- **Why use it:** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `dsh-plugin-market`, `dsh-plugins`
- **Why use it:** one-click Compact context button for the DSH Web context meter panel.
...
- **Why use it:** Verified, star-ranked community plugins for DeepSeek Harness (dsh).
...
- **Why use it:** 面向 DeepSeek Harness 用户的插件产品说明书与导航：按场景选插件，了解安装、权限、兼容性和风险
...
- **Tags:** `awesome-dsh-plugin`, `dsh-plugin`, `dsh-plugin-bundle`, `dsh-plugin-desktop`, `dsh-plugin-market`, `dsh-plugins`
- **Why use it:** DeepSeek Harness 版本的类 CodeX 插件市场
...
- **Tags:** `ai-agents`, `awesome-list`, `coding-agents`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `mcp`, `plugin`
- **Why use it:** The most comprehensive AI-curated list of DeepSeek Harness (DSH) plugins - 190+ 
...
- **Why use it:** Evidence-backed DeepSeek Harness plugin radar and 2Origin plugin lab
...
- **Why use it:** Awesome dsh plugin list — automated DeepSeek Harness plugin directory. Daily Git
...
- **Why use it:** DSH Plugin Portal — a zero-dependency static web portal for the awesome-dsh-plug
...
- **Why use it:** Plugin discoverability for DeepSeek Harness: search npm + awesome-dsh-plugin, lo
...
- **Tags:** `awesome-dsh-plugin`, `deepseek-harness`, `dsh-plugin`, `knowledge-cards`
- **Why use it:** A plugin of Deepseek Harness(DSH),transform your recent chat history into beauti
...
- **Why use it:** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注入 Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flig
...
- **Why use it:** ChatGPT Subscription - a DeepSeek Harness plugin: bind your ChatGPT account via 
...
- **Tags:** `dsh-plugins`, `awesome-list`, `deepseek-harness`
- **Why use it:** Curated DSH plugin directory with 80+ verified entries, good starting point.
...
- **Tags:** `dsh-plugins`, `plugin-verify`, `dsh-ecosystem`
- **Why use it:** Comprehensive DSH plugin index with verification and analytics features.
...
- **Tags:** `awesome-list`, `dsh-plugins`, `migrated`
- **Why use it:** Original awesome list, now migrated — check updated repo.
...
- **Tags:** `dsh-plugins`, `awesome-list`, `auto-updating`
- **Why use it:** Auto-updating curated list with bilingual README and YAML data.
...
- **Tags:** `dsh-plugin`, `registry`, `curated-list`, `ui`, `agent-harness`
- **Why use it:** Well-tagged curated registry covering models, tools, sandboxes, and UI.

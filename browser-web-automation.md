...
- **Why use it:** Enhancement suite for Gemini, Claude & ChatGPT web UIs with prompt manager
...
- **Why use it:** Cross-platform content discovery agent for Bilibili, Douyin, YouTube, etc.
...
- **Why use it:** Tabbit Browser Playwright-based automation for DeepSeek Harness

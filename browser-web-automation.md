...
- **Why use it:** Local-first cross-platform content discovery agent across major social platforms
...
- **Tags:** `mobile-automation`, `mcp`
- **Why use it:** Live iOS Simulator with 22 agent tools for mobile automation
...
- **Why use it:** Tabbit Browser plugin for DSH with Playwright-based web automation.

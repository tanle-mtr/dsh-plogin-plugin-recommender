...
- **Why use it:** Enhancement suite and prompt manager for AI web tools.
...
- **Tags:** `bilibili`, `content-discovery`, `ai-agent`
- **Why use it:** Cross-platform content discovery agent for Chinese social media.
...
- **Why use it:** Free web search plugin with no signup or API key required
...
- **Why use it:** Live iOS Simulator and physical iPhone automation inside conversations

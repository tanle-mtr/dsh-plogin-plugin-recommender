...
- **Tags:** `browser-use`, `browser-automation`
- **Why use it:** Enable AI agents to automate real logged-in browser sessions
...
- **Why use it:** Local-first cross-platform AI agent for content discovery from Bilibili, YouTube, Reddit, and more.
...
- **Why use it:** Strongest free web search plugin for DSH — no signup, no API key needed, bridges web access for all models.
...
- **Tags:** `anti-detect`, `browser`, `fingerprint`, `playwright`
- **Why use it:** Gives agents a browser with persistent fingerprint identity, unlimited local profiles, and Android emulation.

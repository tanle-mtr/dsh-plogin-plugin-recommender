...
- **Why use it:** Cross-platform AI content discovery agent scraping Bilibili, YouTube, Reddit, etc.
...
- **Why use it:** Browser automation plugins powered by Tabbit + Playwright

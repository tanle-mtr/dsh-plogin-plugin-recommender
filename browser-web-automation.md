...
- **Why use it:** Cross-browser enhancement suite for ChatGPT, Claude, Gemini with prompt management and DSH integration.
...
- **Why use it:** Local-first cross-platform content discovery agent across Bilibili, YouTube, Reddit and more
...
- **Why use it:** Agent browser automation with real sessions

...
- **Why use it:** Cross-browser AI enhancement suite with prompt manager
...
- **Why use it:** Local-first agent auto-discovers content from 8 major platforms.
...
- **Why use it:** Free web search bridge plugin with no signup or API key required
...
- **Why use it:** Playwright-based browser automation for DSH desktop

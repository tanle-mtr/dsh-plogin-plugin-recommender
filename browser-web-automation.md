...
- **Why use it:** Cross-browser extension suite enhancing Gemini, Claude, ChatGPT web experiences.
...
- **Why use it:** Cross-platform AI content discovery agent scraping B站, YouTube, Reddit and more locally
...
- **Tags:** `ios`, `mcp`, `ui-automation`
- **Why use it:** Full iOS Simulator control with 22 agent tools via MCP
...
- **Why use it:** Tabbit Browser automation plugins built for DeepSeek Harness

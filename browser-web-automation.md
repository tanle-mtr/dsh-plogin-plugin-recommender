...
- **Tags:** `browser`, `web-automation`, `content-discovery`, `bilibili`
...
- **Tags:** `ios`, `automation`, `mcp`, `mobile`
- **Why use it:** Live iOS Simulator and USB-connected iPhone automation with 22 agent tools

...
- **Why use it:** Cross-browser enhancement suite for Gemini, Claude, ChatGPT with universal prompt manager.
...
- **Why use it:** Cross-platform content discovery agent scraping multiple social platforms.
...
- **Why use it:** Free web search bridge plugin, no signup or API key needed
...
- **Tags:** `ios`, `mobile-automation`, `webdriveragent`, `typescript`
- **Why use it:** Live iOS Simulator and USB iPhone automation inside DSH chat
...
- **Why use it:** Tabbit Browser integration for powerful browser automation in DSH.

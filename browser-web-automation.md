...
- **Why use it:** Browser extension suite for Gemini, Claude, and ChatGPT.
...
- **Why use it:** Cross-platform content discovery agent aggregating from B站, YouTube, Reddit, and more.
...
- **Tags:** `web-search`, `agent-skills`, `free`, `no-api-key`
...
- **Why use it:** Powerful browser automation via Playwright integration for DSH

...
- **Tags:** `content-discovery`, `cross-platform`, `bilibili`, `privacy-first`
- **Why use it:** Cross-platform content discovery agent covering Bilibili, YouTube, X, etc.
...
- **Why use it:** Free web search bridge for models without native browsing — no signup required
...
- **Tags:** `ios`, `automation`, `mobile`, `dsh-plugin`
- **Why use it:** Run live iOS Simulator and USB iPhone directly inside DSH conversations with 22 agent tools

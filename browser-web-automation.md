...
- **Tags:** `ai-agent`, `content-discovery`, `bilibili`
- **Why use it:** Local-first cross-platform AI agent for content discovery across Bilibili, YouTube, and more.
...
- **Why use it:** Lets AI agents use your real logged-in browser seamlessly.
...
- **Tags:** `ios`, `mobile-automation`, `ui-testing`
- **Why use it:** Live iOS Simulator and USB iPhone automation with 22 agent tools for mobile UI testing inside chat.
...
- **Why use it:** Official Tabbit browser plugins for DSH with Playwright support.

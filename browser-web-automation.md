...
- **Tags:** `browser-extension`, `chat-management`, `dsh-plugin`, `prompt-manager`
- **Why use it:** Browser extension suite for Gemini, Claude & ChatGPT enhancement.
...
- **Why use it:** Cross-platform content discovery agent from 8+ platforms with local-first design.
...
- **Why use it:** Enables AI agents to automate any browser session with existing logins.
...
- **Why use it:** Playwright-based browser automation extension for DSH.

...
- **Why use it:** Enhancement suite for major AI platforms with prompt management.
...
- **Tags:** `ai-agent`, `bilibili`, `content-discovery`, `cross-platform`
- **Why use it:** Cross-platform content discovery agent covering Bilibili, YouTube, Reddit and more with local-first design.
...
- **Why use it:** AI agents can use your real logged-in browser seamlessly.
...
- **Why use it:** Playwright-based browser automation plugins for DeepSeek Harness integration.

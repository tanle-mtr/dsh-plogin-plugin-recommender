...
- **Why use it:** Local-first cross-platform content discovery agent covering B站, YouTube, Reddit etc.
...
- **Tags:** `ios`, `automation`, `ui-automation`
- **Why use it:** iOS Simulator and device automation via 22 agent tools

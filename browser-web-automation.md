...
- **Why use it:** Cross-platform self-evolving AI agent for content discovery across Bilibili, YouTube, X etc.
...
- **Tags:** `ios`, `mobile-automation`, `mcp`, `webdriveragent`
- **Why use it:** Live iOS Simulator + USB iPhone control inside conversation with 22 tools

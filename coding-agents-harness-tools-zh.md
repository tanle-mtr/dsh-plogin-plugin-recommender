...
- **推荐理由：** Core harness powering the entire DSH plugin ecosystem
...
- **推荐理由：** Super AI assistant with memory, self-evolution, multi-model support
...
- **推荐理由：** DeepSeek-native terminal coding agent with prompt caching
...
- **标签：** `low-code`, `crm`, `dsh-plugin`
- **推荐理由：** AI-powered no-code platform for rapid business system building
...
- **标签：** `agent`, `harness-engineering`, `dsh`
- **推荐理由：** Best starting point for DSH harness engineering
...
- **标签：** `routing`, `injector`, `dsh`
- **推荐理由：** Task-aware reasoning router and injector kit
...
- **推荐理由：** Self-improving agent OS with loop engineering
...
- **推荐理由：** Enterprise multi-agent workbench with visual editor
...
- **标签：** `preset`, `bootstrap`, `dsh`
- **推荐理由：** Two-phase minimal bootstrap with full standard tools
...
- **推荐理由：** First vision plugin enabling image-to-JSON for agents
...
- **推荐理由：** One-click model switching for major AI coding agents
...
- **推荐理由：** Rust agent runtime paired with polished desktop coding IDE
...
- **标签：** `dsh-plugin`, `code-review`, `agent-skills`
- **推荐理由：** AI code review grounded in 12 classic engineering books
...
- **标签：** `dsh-plugin`, `agents`, `coding`
- **推荐理由：** Architecture-aware AI coding agents
...
- **标签：** `dsh-plugin`, `vision`, `agents`
- **推荐理由：** Vision toolkit for text-only LLMs
...
- **标签：** `dsh-plugin`, `macos`, `swift`
- **推荐理由：** Swift-native macOS coding agent
...
- **推荐理由：** Best context insight and management
...
- **推荐理由：** Strong vision toolkit for text models
...
- **标签：** `agent`, `coding`, `mentor`, `skill`
- **推荐理由：** AI编程导师，扫描架构、自动判题
...
- **标签：** `plugin-dev`, `agent`, `skill`, `development`
- **推荐理由：** 开发DSH插件的标准Agent Skill指南
...
- **标签：** `spec`, `coding`, `agent`, `developer-tools`
- **推荐理由：** Spec驱动编程，仓库原生可移植Skill
...
- **标签：** `plugin-build`, `agent`, `installation`
- **推荐理由：** 构建安装DSH插件的Agent Skill
...
- **标签：** `guide`, `knowledge-base`, `plugin-dev`, `docs`
- **推荐理由：** 插件开发知识库，按需调用中英双语
...
- **标签：** `codex`, `sync`, `import`, `mcp`
- **推荐理由：** One-tap Codex import with two-way Skills/MCP sync
...
- **推荐理由：** Portable plugin dev and audit skill with bundle adapter
...
- **推荐理由：** Practical plugin dev notes: cordis, tsconfig, Windows tips
...
- **标签：** `nvim`, `lua`
- **推荐理由：** Fast Neovim plugin manager in Lua — simple and elegant
...
- **标签：** `dsh-plugin`, `skill`
- **推荐理由：** Scaffold and test DSH plugins inside the harness directly
...
- **推荐理由：** GUI plugin manager with hot-reload and no restart needed
...
- **标签：** `agent-tools`, `llm-agents`, `pre-flight`
- **推荐理由：** Pre-flight plugin check injects Top-K relevant plugins automatically
...
- **推荐理由：** OAuth ChatGPT integration for using Plus models in DSH
...
- **标签：** `awesome-list`, `plugin-recommender`, `dsh`
- **推荐理由：** AI-curated comprehensive DSH plugin directory
...
- **推荐理由：** Community-curated DSH plugin collection
...
- **描述：** DSH插件
- **标签：** `awesome-list`, `dsh`
- **推荐理由：** DSH plugin listing and discovery
...
- **推荐理由：** Evidence-aware curated DSH plugin list
...
- **标签：** `curated-list`, `plugins`, `registry`
- **推荐理由：** Comprehensive DSH plugin customization guide
...
- **标签：** `registry`, `discovery`, `plugin-manager`
- **推荐理由：** Multi-source plugin discovery and dedupe
...
- **推荐理由：** Official auto-generated Cordis plugin list
...
- **推荐理由：** CLI tool for DSH plugin management
...
- **推荐理由：** Full DSH tool catalog sorted by stars
...
- **标签：** `publisher`, `plugin`, `skill`
- **推荐理由：** One-click DSH plugin publishing tool
...
- **推荐理由：** Dynamic DSH plugin marketplace UI

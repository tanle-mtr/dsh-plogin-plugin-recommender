...
- **标签：** `coding-agent`, `terminal`, `prefix-cache`
- **推荐理由：** 终端原生AI编码智能体，前缀缓存稳定高效。
...
- **推荐理由：** 跨设备统一Agent工作台，支持桌面/手机/浏览器/API
...
- **标签：** `agent-os`, `evaluation`, `self-evolving`, `mcp`
- **推荐理由：** 自演进Agent OS，面试门禁式分阶段评估进化循环
...
- **标签：** `vision`, `ocr`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** DSH首个视觉插件，文本代理图像转JSON桥梁
...
- **标签：** `agent-runtime`, `coding-agent`, `dsh-plugin`, `desktop`
- **推荐理由：** 高性能Rust Agent运行时配合精美桌面编程应用
...
- **标签：** `agent-teams`, `dsh-plugin`, `agent`
...
- **标签：** `vision`, `computer-vision`, `ocr`, `dsh-plugin`
- **推荐理由：** 一行安装视觉工具箱：图片问答、OCR及UI还原，专为纯文本模型设计。
...
- **标签：** `coding-agent`, `mcp`, `tui`
- **推荐理由：** 支持子代理、hashline编辑与MCP的终端编码Agent
...
- **标签：** `huawei-cloud`, `mcp`, `devops`
- **推荐理由：** 华为云官方开发套件，MCP工具+云端沙箱
...
- **标签：** `plugin-dev`, `guide`, `scaffold`
- **推荐理由：** 插件开发知识库，内置脚手架和官方文档
...
- **标签：** `coding`, `simplification`, `codex`, `skill`
- **推荐理由：** 将Codex代码简化模式适配到DSH，提升代码可读性。
...
- **标签：** `chatgpt`, `oauth`, `coding-agent`
- **推荐理由：** OAuth绑定ChatGPT订阅账号访问付费模型。
...
- **标签：** `ui-generator`, `figma-alternative`, `desktop-app`
- **推荐理由：** 本地优先AI设计插件，让编码智能体变身设计师。
...
- **标签：** `workbench`, `enterprise`, `local-first`
- **推荐理由：** 企业级多引擎Agent工作台，视觉编辑器，本地优先
...
- **标签：** `task-panel`, `ui`, `dsh-plugin`, `codex`
- **推荐理由：** 现代化可嵌入Codex/DSH的灵活任务面板
...
- **标签：** `tui`, `ui`, `dsh-plugin`, `terminal`
- **推荐理由：** 鲸鱼顶栏/流式思考/双击回滚的DSH终端UI插件
...
- **标签：** `widget`, `ui`, `dsh-plugin`, `floating`
- **推荐理由：** DSH右下角可爱鲸鱼浮动组件监控账户余额
...
- **推荐理由：** 本地优先的Electron桌面应用，集成DSH会话、项目与办公产物
...
- **推荐理由：** 零安装Windows桌面客户端，集成Codex、SSH、插件与移动��远程访问
...
- **推荐理由：** 本地优先多模型桌面应用，具备自进化技能与隐私优先设计
...
- **标签：** `notes`, `ui-extension`
- **推荐理由：** 复刻锤子便签，支持Docker私有化部署和多端通知
...
- **标签：** `mcp`, `ui`, `skill-management`, `web`
- **推荐理由：** Web界面集中管理Skill和MCP服务器，提升效率
...
- **标签：** `marketplace`, `ui`, `plugin-install`, `web`
- **推荐理由：** 在DSH Web GUI中直接浏览安装社区插件，便捷易用
...
- **标签：** `ui`, `balance`, `pricing`, `info-bar`
- **推荐理由：** 底部状态栏实时显示模型、余额和峰谷价格，简洁实用。
...
- **推荐理由：** 集数据库、SSH、SFTP、Docker于一体的DevOps桌面端
...
- **标签：** `desktop`, `electron`, `ui`
- **推荐理由：** Electron桌面版DSH，集成侧边栏与ModLens
...
- **标签：** `ui`, `button`, `webui`, `compact`
- **推荐理由：** 一键折叠DSH上下文计量面板的便捷按钮
...
- **标签：** `multi-agent`, `self-evolving`, `skills`
- **推荐理由：** 自进化多智能体系统，支持记忆与多模型。
...
- **标签：** `image-prompts`, `skills`, `prompt-engineering`
- **推荐理由：** 530+图像提示词库，附可复用Skills模板。
...
- **标签：** `knowledge-distillation`, `skills`, `meta-skill`
...
- **标签：** `skills`, `store`, `automation`
- **推荐理由：** 最全技能商店，自动更新精选技能包，覆盖多领域
...
- **标签：** `agent-skills`, `workflow-automation`, `dsh-plugin`, `vibe-coding`
...
- **标签：** `cognitive-enhancement`, `agent-skills`, `dsh-plugin`
...
- **标签：** `video-generation`, `agent-skill`, `ffmpeg`, `dsh-plugin`
- **推荐理由：** 单主题自动生成Vox风格拼贴解说视频，端到端自动化。
...
- **标签：** `novel-writing`, `rag`, `creative`, `dsh-plugin`
- **推荐理由：** 端到端小说创作流程：角色、世界观、撰写与审稿一体化。
...
- **标签：** `multimodal`, `ocr`, `computer-vision`
- **推荐理由：** 多模态技能，将视频、音频和屏幕活动转化为可搜索的时间戳证据
...
- **标签：** `agent-skills`, `prompt-engineering`
- **推荐理由：** 支持Agent自我进化与工作流可审查控制，提升自动化质量
...
- **标签：** `agent-skills`, `research-automation`
- **推荐理由：** 88个开源技能，覆盖研究、营销自动化和情报分析
...
- **标签：** `ctf`, `reverse-engineering`, `security`, `pentest`
- **推荐理由：** 全面的逆向工程与渗透测试技能包，适合安全研究
...
- **推荐理由：** 自动将成功会话转为可复用Agent技能，高效沉淀经验
...
- **标签：** `superpowers`, `skills`, `coding`
- **推荐理由：** 将Superpowers技能适配到Reasonix编码工作流
...
- **推荐理由：** 从Superpowers移植的TDD调试规划技能，提升开发效率
...
- **标签：** `skills`, `efficiency`, `agent`
- **推荐理由：** 25个工程技能面板，安装即用无需手动配置
...
- **标签：** `gongwen`, `office`, `docx`
- **推荐理由：** 国标公文全流程处理，格式检查模板生成
...
- **标签：** `ai-agent`, `bazi`, `fengshui`, `iching`, `tcm`
- **推荐理由：** 八字/风水/中医全融合，本地引擎+可视化面板，开箱即用。
...
- **标签：** `roleplay`, `narrative`, `ai-roleplay`, `interactive`
- **推荐理由：** 沉浸式互动叙事技能，NPC有记忆立场，支持随机开局和YAML存档。
...
- **推荐理由：** 跨平台会话记忆技能，实现Agent无缝交接和状态恢复。
...
- **标签：** `agent`, `math-modeling`, `skill`
- **推荐理由：** 多Agent数学建模，5角色33模型+论文模板，竞赛利器
...
- **推荐理由：** Godot 4.x全栈游戏开发技能，覆盖GDScript开发
...
- **推荐理由：** 开发DSH插件的Agent Skill，涵盖标准规范与打包
...
- **标签：** `tts`, `xiaomi`, `audio`, `skill`
- **推荐理由：** 免费接入小米MiMo TTS，支持自定义及浏览器语音
...
- **标签：** `agent-tools`, `workflow`, `llm-agents`
- **推荐理由：** 任务前自动匹配适用插件的预检工具。
...
- **标签：** `ai-curated`, `recommender`, `mcp`
- **推荐理由：** AI每小时更新190+插件分类推荐。
...
- **推荐理由：** 一键同步MCP和技能配置到多种AI Agent工具，跨平台。
...
- **标签：** `skillhub`, `mcp`, `api`
- **推荐理由：** 腾讯SkillHub官方API文档与DSH集成指南
...
- **标签：** `codex`, `mcp`, `sync`
- **推荐理由：** OpenAI Codex与DSH双向同步桥，支持MCP自动镜像
...
- **推荐理由：** Web GUI技能与MCP管理卡片，集中管理插件配置
...
- **标签：** `design`, `vector`, `agent-teams`, `ui`
...
- **推荐理由：** 让纯文本模型具备图像识别能力，支持OCR和像素分析。
...
- **推荐理由：** AI视频/图像/音频创作套件，支持分镜和自定义视觉工具。
...
- **推荐理由：** 6种设计风格，让vibe-coded网站告别AI感
...
- **推荐理由：** 电影感产品视频Agent，152镜头配方+Remotion模板
...
- **标签：** `content-discovery`, `bilibili`, `browser-automation`, `dsh-plugin`
- **推荐理由：** 本地优先跨平台AI内容发现代理，覆盖B站/小红书等
...
- **推荐理由：** 免费免注册的全模型网页搜索桥接插件，无需API密钥
...
- **标签：** `browser`, `automation`, `playwright`, `web`
- **推荐理由：** Tabbit浏览器自动化集成，增强DSH网页操作能力
...
- **标签：** `model-switch`, `installer`, `dsh-plugin`, `utility`
- **推荐理由：** 一键安装切换Claude Code/Codex/DSH等多种模型
...
- **推荐理由：** 自部署插件生态雷达，自动发现并实测15900+插件。
...
- **标签：** `context`, `dsh-plugin`, `dashboard`
- **推荐理由：** 最佳上下文管理面板，含浏览器侧边栏和状态统计功能。
...
- **标签：** `plugin-marketplace`, `dsh-plugin`, `ecosystem`
- **推荐理由：** 每日更新、审核后发布的综合性插件商城。
...
- **标签：** `model-provider`, `dsh-plugin`
- **推荐理由：** 支持Command Code模型访问和智能选择，扩展模型覆盖
...
- **推荐理由：** 涵盖运行时、插件、MCP的全面手册，适合初学者和进阶
...
- **标签：** `migration`, `compatibility-layer`
- **推荐理由：** 打通Pi与DSH生态，Pi插件可直接在DSH运行
...
- **推荐理由：** 基于Tushare的本地财经数据库，支持MCP和多端推送
...
- **推荐理由：** 端到端加密远程访问，支持多设备管理Harness实例
...
- **标签：** `upgrade`, `plugin-management`, `infrastructure`
- **推荐理由：** 帮助插件随DSH版本自动升级，保持兼容性
...
- **标签：** `capability`, `mcp`, `utils`, `management`
- **推荐理由：** 统一管理MCP/Skill暴露级别与执行模式，强化控制
...
- **标签：** `plugin-mgmt`, `infrastructure`, `registry`
- **推荐理由：** 官方插件仓库控制台，零修改开箱即用
...
- **推荐理由：** 审计上下文Token成本，检测重复冲突，带WebUI面板。
...
- **推荐理由：** WorkBuddy风格技能选择器，快速插入/skill-name命令。
...
- **标签：** `container`, `management`, `import`
- **推荐理由：** 容器化隔离运行多版本DSH，内嵌WebView一键导入插件。
...
- **推荐理由：** 统一编排Runtime/Provider/Plugin/MCP的本地AI运行平台
...
- **标签：** `cost`, `usage`, `visualization`, `api`
- **推荐理由：** 实时Token用量、成本估算与API余额可视化监控
...
- **标签：** `diagnostic`, `conflict-resolution`, `utility`
- **推荐理由：** 自动诊断并解决插件间及版本冲突问题
...
- **标签：** `awesome-list`, `dsh`, `auto-update`, `bilingual`
- **推荐理由：** 自动更新的插件目录，支持中英双语
...
- **标签：** `pet`, `mascot`, `ui`, `theme`
- **推荐理由：** 多AI编码工具的动态宠物画廊，趣味化用户体验
...
- **推荐理由：** 高度可调的毛玻璃主题，支持模糊度、磨砂度和自定义壁纸
...
- **推荐理由：** 动态海洋主题，可调海浪、日落与玻璃效果，适配Chrome/Edge
...
- **标签：** `theme`, `background`, `visual`, `customization`
- **推荐理由：** 支持自定义图片与预设氛围的DSH主题背景插件
...
- **标签：** `research`, `web-search`, `agent-skill`, `dsh-plugin`
- **推荐理由：** 自动搜索中国八大主流平台近30天内容并生成研究报告。
...
- **推荐理由：** 产业链 mapping 与公司研究方法包，深度研究利器
...
- **标签：** `kline`, `finance`, `analysis`, `trading`
- **推荐理由：** 交互式K线分析，支持多市场、技术指标和新闻资讯。
...
- **标签：** `awesome-list`, `catalog`, `registry`
- **推荐理由：** 千余DSH仓库按星标排序的完整工具清单
...
- **标签：** `radar`, `research`, `plugin-registry`
- **推荐理由：** 有据可查的插件雷达和分析目录。
...
- **推荐理由：** 从零开始的Harness工程入门教程，适合新手快速上手
...
- **推荐理由：** 双语精选DSH插件资源导航库，涵盖工具、技能与验证参考
...
- **推荐理由：** 全维度AI资源百科，涵盖技能、MCP、RAG、MLOps与学习路线
...
- **推荐理由：** Give DeepSeek Harness a real office environment.  Univer Office Plugin brings sp
...
- **推荐理由：** Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub
...
- **标签：** `android`, `android-app`, `coding-agent`, `deepseek`, `deepseek-harness`, `deepseek-harness-plugin`, `dsh-plugin`, `ios`, `ios-app`, `ios-swift`, `kmp`, `kotlin-multiplatform`, `kotlin-multiplatform-mobile`, `ui-design`
- **推荐理由：** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile
...
- **标签：** `catalog`, `plugin-marketplace`
- **推荐理由：** 插件总目录，支持中英文搜索和分类筛选
...
- **推荐理由：** cordis.run官方精选插件目录，生态探索必备
...
- **标签：** `awesome-list`, `community`, `marketplace`
...
- **标签：** `bioinformatics`, `desktop`, `single-cell`, `tauri`
- **推荐理由：** 面向临床和实验生物学的专业桌面Agent，支持离线模式。
...
- **标签：** `portal`, `plugin-directory`
- **推荐理由：** 静态网页浏览227+插件的门户。

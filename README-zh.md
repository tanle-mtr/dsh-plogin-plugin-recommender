...
- **标签：** `ai-agents`, `mcp`, `multi-agent`
- **推荐理由：** 自进化多模型代理枢纽，支持记忆和技能跨平台
...
- **标签：** `coding-agent`, `terminal`, `prompt-caching`
- **推荐理由：** DeepSeek原生终端编码代理，优化前缀缓存稳定性
...
- **标签：** `low-code`, `ai-agent`, `workflows`
- **推荐理由：** 开源AI驱动的无代码平台，快速构建业务系统
...
- **标签：** `agent-runtime`, `coding-agent`, `dsh-plugin`
- **推荐理由：** Rust高性能Agent运行时配精美桌面IDE
...
- **标签：** `code-review`, `lint`, `dsh-plugin`
- **推荐理由：** 基于12本经典工程著作的AI代码审查
...
- **标签：** `dsh-plugin`, `coding-agents`, `architecture`
- **推荐理由：** 让AI编程代理具备架构感知能力，防止长期任务漂移。
...
- **标签：** `dsh-plugin`, `coding-agent`, `swift`
...
- **标签：** `agent`, `desktop-app`, `multi-model`, `privacy`
- **推荐理由：** 本地优先多模型Agent桌面，支持自我进化技能。
...
- **标签：** `dsh-plugin`, `documentation`, `best-practices`
- **推荐理由：** DSH插件开发实战经验文档与解决方案
...
- **标签：** `dsh-plugin`, `agent-skills`, `plugin-development`
- **推荐理由：** 端到端插件脚手架与测试技能
...
- **标签：** `dsh-plugin`, `desktop`, `cordis-plugin`
- **推荐理由：** DSH现代化桌面端，桌面本身也是插件
...
- **标签：** `web-ui`, `theme`, `desktop`
- **推荐理由：** 完整Web UI+任务看板，WebGL皮肤支持Wallpaper Engine。
...
- **推荐理由：** 鲸鱼顶栏实时状态TUI，Claude Code风格
...
- **标签：** `dsh-plugin`, `desktop`, `electron`
- **推荐理由：** 本地优先桌面伴侣平台，含动态宠物和插件SDK。
...
- **标签：** `dsh-plugin`, `widget`, `desktop`
- **推荐理由：** DSH界面浮动小鲸鱼，实时显示账户余额。
...
- **标签：** `dsh-ui`, `interactive`, `components`
- **推荐理由：** 在对话回复中直接渲染图表、表单等交互组件。
...
- **推荐理由：** 开源Electron桌面客户端，支持SSH与远程访问
...
- **标签：** `dsh-plugin`, `ui`, `usage-tracking`
- **推荐理由：** 持久显示模型、余额和定价信息的状态栏
...
- **推荐理由：** 浮动 HUD 面板，实时显示 Git、MCP、技能与 Token 状态
...
- **推荐理由：** 跨平台桌面应用，整合数据库、SSH、Docker 与 AI 助手
...
- **标签：** `agentic-ai`, `multi-agent`, `swarm`
- **推荐理由：** 多代理蜂群框架，支持自主工作流和对话AI系统
...
- **标签：** `agent-skills`, `skill-generator`, `meta-skill`
- **推荐理由：** 将思维模式提炼为可复用的代理技能
...
- **标签：** `agent-workspace`, `multi-platform`, `no-code`
- **推荐理由：** 全平台统一Agent工作台，支持看板任务管理。
...
- **标签：** `agent-os`, `self-improving`, `loop-engineering`
- **推荐理由：** 自我进化的Agent OS，持续学习优化自身能力。
...
- **标签：** `dsh-plugin`, `vision`, `agent-skills`
- **推荐理由：** 为纯文本模型提供看图、图片问答和GUI自动化技能。
...
- **标签：** `dsh-plugin`, `task-manager`, `workflow`
- **推荐理由：** 自托管人机协作实时任务管理器，支持移动端控制。
...
- **标签：** `dsh-plugin`, `agent-teams`, `collaboration`
...
- **⭐ 星标：** 818
- **语言：** TypeScript
- **描述：** [dsh]为纯文本模型设计更强大的视觉工具箱：安装免费使用、粘贴图片直���识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **标签：** `dsh-plugin`, `vision`, `ocr`
- **推荐理由：** 原生DSH视觉工具包：支持OCR、UI还原和多图问答。
...
- **标签：** `agent`, `workflow`, `coding-agents`
- **推荐理由：** 将多个编程Agent整合为一个协作团队。
...
- **标签：** `skills`, `agent`, `architecture`
- **推荐理由：** 将经验转化为可重复执行的AI智能体技能
...
- **标签：** `skill`, `vision`, `multimodal`, `claude-code`
- **推荐理由：** 为纯文本LLM添加视觉能力，支持UI截图分析
...
- **标签：** `ai-infra`, `skills`, `debugging`
- **推荐理由：** AI基础设施开发专用agent技能与调试工具。
...
- **标签：** `task-management`, `workflow`, `ui`
...
- **推荐理由：** Superpowers技能移植到Reasonix代码平台。
...
- **标签：** `chinese-wisdom`, `skill`
- **推荐理由：** 八字风水易经AI技能包，本地确定性引擎
...
- **标签：** `agent-framework`, `database`, `cli`
- **推荐理由：** 42技能5CLI插件包，覆盖数据库与LLM工程
...
- **标签：** `agent-skills`, `dsh-plugin`, `project-governance`
- **推荐理由：** 版本锁定的治理技能，适合可靠工作流
...
- **标签：** `agent-skills`, `docx`, `gongwen`, `wps-office`
- **推荐理由：** 符合国标的中文公文全流程处理技能
...
- **标签：** `agent-skills`, `cordis`, `best-practices`
- **推荐理由：** 源自DeepSeek Harness的工程纪律技能
...
- **标签：** `agent-skills`, `dsh-plugin`, `canvas`, `mcp-tools`
- **推荐理由：** 原生WeShop无限画布创意技能插件
...
- **推荐理由：** Godot 4.x 全栈开发技能，为 DSH 工作流提供游戏开发支持
...
- **标签：** `record-replay`, `macos`, `computer-use`
- **推荐理由：** 录制 macOS 操作并转化为可复用的 Agent 技能
...
- **标签：** `agent-preset`, `ai-agents`, `product-management`
- **推荐理由：** 虚拟产品团队预设，引导式产品管理对话工作流
...
- **标签：** `agent-tools`, `llm-agents`, `plugin-matching`
- **推荐理由：** 任务预检插件匹配，提升Agent能力可预期性
...
- **标签：** `vfs`, `sandbox`, `abstraction`
- **推荐理由：** 跨平台统一虚拟文件系统，Agent可共享操作数据层。
...
- **标签：** `dsh-plugin`, `mcp`, `tool-management`
...
- **推荐理由：** 设置页粘贴 JSON 即连 MCP，自动识别 .skill 文件热加载
...
- **标签：** `agent-skills`, `diagram-as-code`, `mermaid-alternative`
- **推荐理由：** 生成精美架构图、流程图和序列图的代理技能
...
- **推荐理由：** 470+逆向工程案例与20+工业级模板，大幅提升出图质量。
...
- **标签：** `design`, `vector`, `agent-team`
- **推荐理由：** 首个开源AI原生矢量设计工具，支持Agent团队协作设计。
...
- **推荐理由：** 在DeepSeek Harness对话中直接生成图片
...
- **标签：** `design`, `web-design`, `ui`
- **推荐理由：** 6种设计风格，避免AI生成网页同质化
...
- **标签：** `dsh-plugin`, `ai-director`, `video-editing`, `ai-image`
- **推荐理由：** 通过DirectorX集成AI视频/图像/音频生成
...
- **标签：** `dsh-plugin`, `browser-extension`, `workflow`
- **推荐理由：** 浏览器扩展将AI对话转化为可复用工作流。
...
- **标签：** `ios`, `mobile-automation`, `simulator`, `ui-automation`
- **推荐理由：** 对话内直接运行iOS模拟器，22项移动端自动化Agent工具。
...
- **推荐理由：** 全能图片上传工具，支持60+图床，集成Obsidian
...
- **标签：** `router`, `infra`, `cordis`
- **推荐理由：** 运行时注入器+任务感知路由，优化Agent推理效率。
...
- **标签：** `preset`, `bootstrap`, `standards`
- **推荐理由：** 两阶段预设：轻量启动后加载完整标准工具链。
...
- **标签：** `marketplace`, `utility`, `dsh-plugin`
- **推荐理由：** 可视化插件���场，浏览搜索一键安装
...
- **标签：** `oauth`, `llm-provider`, `subscription`
- **推荐理由：** 通过OAuth将其他平台订阅转为DSH的LLM提供者。
...
- **标签：** `cost-tracking`, `token`, `budget`
- **推荐理由：** 追踪会话日成本、预算限制和Token用量
...
- **标签：** `plugin-manager`, `mcp`, `hot-reload`
- **推荐理由：** 内嵌 GUI 插件管理器，支持热加载，无需重启
...
- **标签：** `utilities`, `plugin-conflict`, `debugging`
- **推荐理由：** 检测并解决插件及版本冲突
...
- **推荐理由：** OAuth接入ChatGPT，在DSH中使用其模型
...
- **标签：** `discovery`, `dsh-plugin`, `plugin-manager`, `registry`
- **推荐理由：** 多源合并去重的DSH插件注册中心
...
- **标签：** `cli`, `dsh-plugin`, `plugin-manager`
- **推荐理由：** 支持多源搜索的DSH插件CLI管理工具
...
- **标签：** `pet`, `skin`, `pixel-art`
- **推荐理由：** 动画宠物画廊，为Agent提供可爱的个性化装饰。
...
- **标签：** `theme`, `deepseek-harness-plugin`, `ui`
- **推荐理由：** 磨砂玻璃质感主题，支持高度自定义DSH界面。
...
- **推荐理由：** WebGPU海洋主题皮肤，原生集成DeepSeek Harness
...
- **标签：** `dsh-plugin`, `theme`, `skins`, `ui`
- **推荐理由：** 34款opencode配色一键切换并持久化
...
- **标签：** `rag`, `vibe-coding`, `prompt-engineering`
- **推荐理由：** 全面AI资源库，含教程、提示词和知识百科
...
- **标签：** `awesome-list`, `plugin-directory`, `agent-framework`
- **推荐理由：** DSH插件、技能、MCP服务器精选资源清单
...
- **标签：** `dsh-plugin`, `ftshare`, `finance`
- **推荐理由：** 交互式K线分析，支持多市场与技术指标
...
- **标签：** `dsh-plugin`, `web-toy`
- **推荐理由：** 零依赖网页版传统玩具竹知了模拟
...
- **标签：** `dsh-plugin`, `awesome-list`, `plugins`
- **推荐理由：** DeepSeek Harness社区插件生态精选列表。
...
- **标签：** `awesome-list`, `plugin-marketplace`, `discovery`
- **推荐理由：** 自动抓取加人工核实的插件目录与推荐系统。
...
- **⭐ 星标：** 212
- **语言：** TypeScript
- **描述：** DSH (DeepSeek Harness) 原理学习、插件市场与���佳实践 · Learn DSH principles, plugin marketplace & best practices
- **标签：** `learning`, `plugin-marketplace`, `best-practices`
- **推荐理由：** 学习DSH原理、插件市场浏览与最佳实践指南。
...
- **标签：** `guide`, `awesome-list`, `quickstart`
- **推荐理由：** DSH终极指南，含快速入门与精选插件推荐。
...
- **标签：** `awesome-list`, `reference`
- **推荐理由：** 精选的DSH插件与资源汇总清单。
...
- **标签：** `marketplace`, `plugin`, `web`
- **推荐理由：** DSH社区插件市场，Web GUI一键安装。
...
- **标签：** `awesome-list`, `reference`, `resources`
- **推荐理由：** 精心整理的DSH插件、工具和资源清单。
...
- **标签：** `awesome-list`, `dsh-plugin`, `curated-list`
- **推荐理由：** 社区精选DSH插件合集列表
...
- **推荐理由：** 已迁移，请转向awesome-dsh-plugin仓库
...
- **标签：** `awesome-list`, `recommender`, `mcp`
- **推荐理由：** AI精选12类插件，每小时自动更新
...
- **标签：** `plugin-collection`, `dsh-ecosystem`
- **推荐理由：** DSH插件仓库与验证集合
...
- **标签：** `awesome-list`, `catalog`, `deepseek-harness`, `dsh-plugin-directory`
- **推荐理由：** 每日自动爬取的双语DSH插件目录
...
- **标签：** `agent-harness`, `awesome`, `coding-agents`, `deepseek-harness-plugin`, `dsh-plugin`, `skills`, `ui`
- **推荐理由：** 涵盖模型、工具、沙箱和UI的全面精选插件
...
- **推荐理由：** DeepSeek Harness Cordis插件官方自动生成列表

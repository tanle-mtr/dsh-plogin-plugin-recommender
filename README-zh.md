...
- [Agent 技能与工作流](#agent-技能与工作流) — 33 个插件
...
- [Agent 技能与工作流](agent-skills-workflows-zh) (33)
...
- **标签：** `coding-agent`, `tui`, `tool-use`
- **推荐理由：** DeepSeek原生终端编码智能体，前缀缓存稳定
...
- **标签：** `cordis`, `dsh-plugin`, `mcp`
- **推荐理由：** 任务感知的DSH推理模式路由注入器
...
- **标签：** `agent-collaboration`, `multi-agent`, `mcp`
- **推荐理由：** 企业级多引擎Agent工作台与可视编辑器
...
- **推荐理由：** 一键安装并切换Claude Code、DeepSeek等多款AI编程工具
...
- **标签：** `code-review`, `agent-skills`, `dsh-plugin`, `clean-architecture`
- **推荐理由：** 基于12本经典工程书籍的AI代码审查，含严重级别标签和自动修复
...
- **标签：** `architecture`, `coding-agents`, `spec-driven`
- **推荐理由：** 使AI编程代理具备架构感知和证据验证能力
...
- **标签：** `plugin-development`, `agent-skills`, `tools`
- **推荐理由：** 覆盖DSH插件开发全流程标准，工具链完整
...
- **标签：** `plugin-development`, `agent-skills`
- **推荐理由：** 插件开发辅助技能，处理插槽和凭证配置
...
- **推荐理由：** DSH插件管理器中类似WorkBuddy的技能选择器
...
- **标签：** `codex`, `sync`, `mcp`
- **推荐理由：** 一键从Codex迁移项目到DSH，双向同步Skill和MCP
...
- **推荐理由：** 上下文注入审计，检测重复冲突，Web UI面板可视化
...
- **标签：** `package-manager`, `agent-assets`, `cli`
- **推荐理由：** AI Agent资产包管理器，含42技能5 CLI，一站式工具集
...
- **标签：** `plugin-dev`, `agent-skill`, `scaffolding`, `cordis`
- **推荐理由：** 便携式插件开发审计Agent，含DSH Bundle适配器
...
- **标签：** `documentation`, `best-practices`, `tsconfig`, `zstd`
- **推荐理由：** 插件开发踩坑实战文档，覆盖cordis/tsconfig/zstd
...
- **标签：** `plugin-dev`, `scaffolding`, `testing`, `skills`
- **推荐理由：** DSH插件脚手架与测试分层Agent技能
...
- **推荐理由：** 开放侧边栏底座，支持文件编辑/终端/Git/子代理等扩展页面
...
- **⭐ 星标：** 2,341
- **语言：** TypeScript
- **描述：** DSH ��方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **标签：** `tui`, `terminal`, `dsh-plugin`, `claude-code`
- **推荐理由：** Claude Code风格TUI，鲸鱼顶栏/流式思考/双击回滚等功能
...
- **标签：** `agent-runtime`, `desktop`, `dsh-plugin`, `vibe-coding`
- **推荐理由：** Rust高性能Agent运行时配合精美桌面端AI编程应用
...
- **标签：** `desktop`, `electron`, `local-first`
- **推荐理由：** 本地优先桌面工作空间，集成会话和办公
...
- **标签：** `electron`, `desktop`, `ssh`
- **推荐理由：** 零配置Electron桌面客户端，支持SSH和技能扩展
...
- **推荐理由：** Electron桌面控制台，多Tab管理插件/MCP/技能
...
- **标签：** `ui`, `status-bar`, `balance`, `pricing`
- **推荐理由：** 持久化底部信息栏，显示余额/定价/倒计时
...
- **推荐理由：** 跨平台桌面应用，整合数据库/SSH/Docker与AI助手。
...
- **推荐理由：** 覆���MLOps、RAG、Agent的全维度AI知识库
...
- **标签：** `memory`, `handoff`, `deepseek-harness`
- **推荐理由：** 连接PowerContext实现跨会话记忆召回与交接。
...
- **推荐理由：** 桥接Claude Code记忆和技能到DSH，跨平台复用。
...
- **标签：** `agent-skills`, `digital-human`, `meta-skill`
- **推荐理由：** 将记忆转化为AI技能与数字人格
...
- **标签：** `agent-skills`, `diagrams`, `code-visualization`
- **推荐理由：** 智能体技能，生成精美���构图和流程图
...
- **标签：** `agent-workspaces`, `coding-agent`, `mcp`
...
- **推荐理由：** 基于Anthropic全局工作空间研究的AI认知增强技能套件
...
- **标签：** `agent-skills`, `workflow-automation`, `vibecoding`, `dsh-plugin`
- **推荐理由：** 智能编排harness工作流，自动路由本地技能
...
- **标签：** `video-generation`, `agent-skill`, `dsh-plugin`, `ffmpeg`
- **推荐理由：** 从一个主题自动生成Vox风格拼贴解说视频
...
- **标签：** `task-manager`, `workflow`, `human-loop`
- **推荐理由：** 支持人机协作的跨端任务管理器
...
- **标签：** `multi-agent`, `teams`, `collaboration`
- **推荐理由：** DSH多代理团队协作插件
...
- **标签：** `agent`, `desktop-app`, `mcp`
- **推荐理由：** 本地优先多模型AI代理，技能自进化
...
- **标签：** `infra`, `skills`, `system`
- **推荐理由：** AI基础设施专用技能：编写、优化和调试系统
...
- **标签：** `agent-skills`, `coding-agent`
- **推荐理由：** AI编程导师技能，自动扫描架构并指导编码
...
- **标签：** `agent-skills`, `research-tools`, `marketing`
- **推荐理由：** 88个开源Agent技能，覆盖研究、营销和社交
...
- **标签：** `spec-driven-development`, `agent-skills`, `coding`
- **推荐理由：** 仓库级规格驱动开发技能，内嵌DSH工程规范
...
- **标签：** `chinese-wisdom`, `bazi`, `fengshui`
- **推荐理由：** 八字/风水/易经等中华传统智慧AI技能，本地确定性引擎
...
- **推荐理由：** 多Agent协作团队，独立模型/技能/MCP与共享工作区
...
- **标签：** `governance`, `swift-cycle`, `agent-skills`
- **推荐理由：** Swift Cycle治理技能，版本锁定可离线验证
...
- **标签：** `skill`, `engineering`, `discipline`, `portable`
- **推荐理由：** 工程纪律Agent技能：实证、透明、诚实报告
...
- **标签：** `gongwen`, `document`, `word`, `templates`
- **推荐理由：** 国标公文全流程处理，格式检查/模板/修订批注
...
- **标签：** `record-replay`, `macos`, `workflows`, `computer-use`
...
- **推荐理由：** Godot 4.x全栈游戏开发技能，运行时自动注册。
...
- **标签：** `agent`, `agent-preset`, `ai-agents`
...
- **标签：** `ai-design`, `design-systems`, `prototyping`
...
- **标签：** `vibedesign`, `skill`, `mcp`
- **推荐理由：** 首个开源AI原生矢量设计工具，支持多Agent协作
...
- **标签：** `design`, `visual-editor`, `ppt`
- **推荐理由：** AI生成可视化编辑器，含PPT和模板市场
...
- **推荐理由：** 在DSH聊天中直接预览和编辑OpenPencil文档
...
- **标签：** `visualization`, `legal-tech`, `diagram`
- **推荐理由：** 将诉讼材料转化为可提交法庭的可视化时间轴图
...
- **标签：** `ai-video`, `ai-image`, `storyboard`, `vision`
- **推荐理由：** AI视频/图像/音频生成，含可配置模型与故事板
...
- **标签：** `canvas`, `creative`, `infinite`, `cordis`
- **推荐理由：** 无限创意画布，原生WeShop Cordis集成
...
- **推荐理由：** 本地优先的跨平台AI内容发现Agent，支持B站/抖音/YouTube等
...
- **推荐理由：** 通过CLI和扩展让AI Agent无缝使用已登录的真实浏览器
...
- **推荐理由：** DSH内测合影墙，GitHub零权限OAuth登录
...
- **标签：** `self-hosted`, `mcp-server`, `agent-skills`
...
- **推荐理由：** 9000+插件雷达与精选榜，运行级实测，自动更新索引
...
- **⭐ 星标：** 266
- **语言：** JavaScript
- **描述：** 用 30 秒为你的 DeepSeek Harness找到合适的插件。 ���库由脚本每天自动抓取，再经人工逐个核实——真插件进目录，蹭热度的进黑名单，每条剔除理由公开可查。并告诉你每个插件适合谁、从哪里开始。
- **标签：** `awesome-list`, `discovery`
- **推荐理由：** 精心筛选的插件发现工具，含人工核实机制
...
- **标签：** `oauth`, `infrastructure`
- **推荐理由：** 通过OAuth将订阅服务转为DSH的LLM提供商
...
- **标签：** `cost`, `token-tracking`, `billing`
- **推荐理由：** 追踪多提供商的会话级和日常token成本
...
- **标签：** `notes`, `docker`, `utility`
- **推荐理由：** 开源便签工具，支持Docker部署和公众号导出
...
- **标签：** `container`, `desktop`, `management`
- **推荐理由：** 隔离容器运行多版本DSH，内置WebView控制台
...
- **标签：** `config`, `backup`, `restore`, `mcp`, `webdav`
- **推荐理由：** 完整配置备份恢复，含MCP同步与WebDAV导出
...
- **标签：** `plugin-manager`, `ui`, `hot-reload`
- **推荐理由：** 设置面板内嵌GUI插件管理，热加载无需重启。
...
- **标签：** `analytics`, `cost`, `visualization`
- **推荐理由：** 实时Token用量、费用图表和API余额看板。
...
- **⭐ 星标：** 3
- **语言：** TypeScript
- **描述：** 致力于解��各插件之间也与版本之间可能存在的冲突问题并提供解决方案
- **标签：** `awesome-dsh-plugin`, `deepseek-harness`
- **推荐理由：** 检测并解决插件间及版本冲突问题
...
- **标签：** `plugin-manager`, `registry`
- **推荐理由：** 合并多源插件列表并去重，提供统一注册表。
...
- **标签：** `plugin-manager`, `cli`
- **推荐理由：** CLI插件管理工具，支持搜索、安装、审计。
...
- **标签：** `publisher`, `plugin-tools`
- **推荐理由：** 一键发布插件，自动生成文档和PR命令。
...
- **推荐理由：** 适用于DeepSeek Harness的鲸鱼娘系列主题皮肤
...
- **⭐ 星标：** 368
- **语言：** JavaScript
- **描述：** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自���义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **标签：** `theme`, `ui`
- **推荐理由：** 磨砂玻璃主题，支持高度自定义视觉效果
...
- **标签：** `theme`, `skin`, `opencode`, `palette`, `dark-mode`
...
- **标签：** `theme`, `background`, `ui-customization`
- **推荐理由：** Web背景个性化插件，支持预设/模糊/遮罩调整。
...
- **标签：** `rag`, `ai-guide`, `vibe-coding`
- **推荐理由：** 全面AI资源库，含教程与知识库
...
- **标签：** `research`, `web-search`, `dsh-plugin`, `china`
- **推荐理由：** 自动搜索国内8大平台近30天内容，生成有据可查研究报告
...
- **标签：** `web-search`, `research`
- **推荐理由：** 为无原生联网能力的模型提供强大免费搜索
...
- **标签：** `api-documentation`, `research`, `chinese-api`
- **推荐理由：** 集成20个中国平台6.5万+API文档，零配置搜索
...
- **标签：** `finance`, `technical-analysis`, `kline`, `sidebar`
- **推荐理由：** 侧栏交互式K线分析，支持多市场与技术指标
...
- **推荐理由：** 数学建模增强套件，含17张Skill卡片及预设配置。
...
- **标签：** `plugin-portal`, `web`, `awesome-dsh-plugin`
- **推荐理由：** 静态网页门户，浏览安装227+插件
...
- **标签：** `ai-agents`, `awesome-list`, `dsh-plugin`
- **推荐理由：** 双语插件目录，不可变提交审核
...
- **标签：** `dsh-plugin`, `toy`, `single-file`
- **推荐理由：** 零依赖网页版竹知了玩具，真实录音采样，移动端优先
...
- **标签：** `awesome-list`, `ecosystem`, `directory`
...
- **标签：** `awesome-list`, `catalog`, `mcp`
- **推荐理由：** DSH插件生态精选清单，涵盖MCP、技能与补丁
...
- **标签：** `marketplace`, `plugin-store`
- **推荐理由：** DeepSeek Harness插件市场扩展中心
...
- **标签：** `agent`, `ai-agents`, `cordis`, `deepseek-harness`, `dsh`, `dsh-plugin`, `javascript`, `llm`, `marketplace`, `nodejs`, `plugin`, `plugin-marketplace`
- **推荐理由：** DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub 
...
- **标签：** `agent-memory`, `ai-agents`, `coding-agent`, `deepseek-harness`, `dsh`, `dsh-plugin`, `long-term-memory`, `mcp`, `memory`, `noema`, `plugin`, `typescript`
- **推荐理由：** Noema long-term memory plugin for DSH: durable, inspectable agent memory with re
...
- **标签：** `backup`, `crash-recovery`, `deepseek-harness`, `dsh`, `dsh-plugin`, `powershell`, `rollback`, `snapshot`, `undo`, `windows`
- **推荐理由：** DSH crash-rescue plugin: undo config & plugin-code changes, secret-safe snapshot
...
- **推荐理由：** Open-source infrastructure that turns scattered SKILL.md files into curated, ret
...
- **推荐理由：** DeepSeek Harness plugin for previewable cross-preset session migration. Fixed-sc
...
- **推荐理由：** Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collabora
...
- **推荐理由：** A meticulously curated list of useful plugins, extensions, tools and development
...
- **标签：** `plugin-marketplace`, `awesome-list`
- **推荐理由：** 社区精选插件目录，每4小时自动同步更新
...
- **推荐理由：** 官方自动生成的插件精选列表，由cordis.run维护
...
- **推荐理由：** 精选280+插件目录，覆盖14大类，便于快速发现插件
...
- **标签：** `awesome-list`, `directory`, `discovery`, `nextjs`
- **推荐理由：** DSH插件生态目录与安装命令公开仓库
...
- **标签：** `catalog`, `curated`, `awesome-list`
- **推荐理由：** 有据可查的精选DSH插件目录，含安装指导。
...
- **标签：** `registry`, `open-data`, `plugin-catalog`
- **推荐理由：** 去垃圾插件的开源数据注册表，含技能管理。
...
- **标签：** `awesome-list`
- **推荐理由：** cordis.run自动生成的Cordis插件列表。
...
- **标签：** `marketplace`, `plugin-directory`
- **推荐理由：** 动态插件市场，支持浏览搜索一键安装。

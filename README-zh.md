...
- **标签：** `multi-agent`, `enterprise`, `visual-editor`
- **推荐理由：** 面向Agent团队协作的企业级多引擎工作台
...
- **标签：** `ai-coding`, `ai-ide`, `agent-runtime`
- **推荐理由：** 高性能Rust代理运行时
...
- **标签：** `agent-teams`, `collaboration`, `dsh`
- **推荐理由：** 支持多代理团队协作
...
- **推荐理由：** 内置RPC插件、子代理、哈希行编辑和MCP支持的高效编码代理。
...
- **标签：** `cli`, `plugin-manager`, `developer-tools`, `ai-agent`
- **推荐理由：** DSH插件管理CLI工具，功能强大且实用。
...
- **标签：** `llm-provider`, `oauth`, `chatgpt`, `claude`
- **推荐理由：** OAuth接入ChatGPT/Claude/Grok订阅作为LLM提供商。
...
- **推荐理由：** 新增Command Code模型支持，智能选择推理效能。
...
- **标签：** `tools`, `skills`, `menu`
- **推荐理由：** 统一管理Tools/Skills并优化上下文占用
...
- **标签：** `plugin-creator`, `harness-tools`
- **推荐理由：** 快速构建和验证DSH插件的可复用工具
...
- **标签：** `code-simplification`, `codex`, `agent-skills`
- **推荐理由：** 源自DSH的代码简化技能，支持Codex
...
- **标签：** `agent-tools`, `cordis`
- **推荐理由：** DSH Agent插件库起飞前检查单，提升利用率
...
- **标签：** `coding-agents`, `dsh-plugin`, `agent-harness`, `skills`
- **推荐理由：** 覆盖模型、工具、沙箱、UI和Agent的精选插件目录。
...
- **标签：** `agent-skills`, `ui-generator`
- **推荐理由：** 本地优先设计工具，让编程智能体变身设计师
...
- **标签：** `novel-writing`, `creative`, `desktop`
- **推荐理由：** AI小说创作的完整工作流
...
- **推荐理由：** 零安装Windows桌面客户端，集成Codex、插件、SSH和移动端远程控制。
...
- **标签：** `desktop-app`, `electron`, `react`
- **推荐理由：** 本地优先的AI桌面工作台，支持会话、项目、文件和Office文档。
...
- **标签：** `dsh-plugin`, `workspace`, `canvas`
- **推荐理由：** 基于画布的非线性对话工作区，支持会话探索和分支工作流。
...
- **标签：** `desktop-app`, `local-first`, `tauri`
- **推荐理由：** 本地优先的多模型AI代理桌面应用，支持自进化技能和隐私保护。
...
- **⭐ 星标：** 312
- **语言：** Kotlin
- **描述：** DeepSeek Harness Mobile 是一个面向 DeepSeek Harness 的原生 iOS 客户端。它通过 dsh-plugin-mobile-gateway 与 Harness 建立 WebSocket 连接，将工作区、会话、实时回复和 Agent 执行轨迹带到 iPhone，同���延续 DeepSeek WebUI 克制、清晰的视觉语言
- **标签：** `ios`, `mobile`, `kmp`, `coding-agent`
- **推荐理由：** DSH原生iOS客户端，支持实时Agent执行轨迹。
...
- **推荐理由：** CodePilot风格跨平台桌面客户端，支持macOS/Win/Linux。
...
- **标签：** `notes`, `ui`, `docker`
- **推荐理由：** 锤子便签开源版，Docker私有化，支持DSH插件
...
- **标签：** `context`, `ui`, `audit`, `tool`
- **推荐理由：** 上下文审计仪表盘，检测重复与冲突指令
...
- **⭐ 星标：** 29
- **语言：** JavaScript
- **描述：** DSH 实现 workbuddy 同款��择 skill 功能 | WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the official /skill-name gesture, and DSH loads it with your message.
- **标签：** `ui`, `skill-picker`
...
- **推荐理由：** 一站式DevOps桌面，集成SSH/Docker/AI沙箱。
...
- **标签：** `memory`, `personal-ai`, `long-term`
- **推荐理由：** 个人AI记忆中枢，完全可控
...
- **标签：** `multi-agent`, `mcp-server`
- **推荐理由：** 部署多智能体蜂群，支持自主协调工作流
...
- **⭐ 星标：** 6,935
- **语言：** Python
- **描述：** 收录最全、更新最快的技能Skills商店：精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工作流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、��新时间、Star数量整理。The most comprehensive and frequently updated AI Agent skill library, featuring curated skill packs across document processing, content creation, programming, machine learning, automated workflows, and many more domains.
- **标签：** `agent-skills`, `skill-store`, `coding-agent`
- **推荐理由：** 最全面的技能商店，涵盖编程、文档、财务等
...
- **推荐理由：** 将分散的SKILL.md文件整理为可检索的AI技能知识库，支持评估工具。
...
- **推荐理由：** 为AI代理赋予视听能力，将视频音频转化为���时间戳的可检索证据。
...
- **标签：** `agent-skills`, `creative-writing`, `novel-writing`, `ai-writing`
- **推荐理由：** 集小说、短剧、游戏创作于一体的AI写作工作流。
...
- **标签：** `agent-skills`, `workflow`, `math-modeling`
- **推荐理由：** 全流程数学建模AI自动解题，支持GitOps流水线
...
- **⭐ 星标：** 199
- **语言：** TypeScript
- **描述：** �� Agent 的工作方式可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **标签：** `agent-skills`, `self-evolving`, `review`
- **推荐理由：** Agent自进化工作流，支持人机审查与组合模式
...
- **推荐理由：** AI多Agent金融分析，支持本地数据库与IM盯盘
...
- **标签：** `agent-skills`, `reverse-engineering`, `security`
- **推荐理由：** 87个逆向工程技能文件，安全研究专用
...
- **标签：** `agent-skills`, `web-search`, `mcp-server`
- **推荐理由：** You.com技能集合，支持网页搜索、研究与代理集成。
...
- **标签：** `agent-skills`, `deepseek-harness`, `mentor`
- **推荐理由：** AI编程导师，逐层指导项目架构与代码手写。
...
- **推荐理由：** 25个预置Matt Pocock工程技能，开箱即用。
...
- **标签：** `skills`, `plugin-management`, `dsh-plugin`
...
- **标签：** `ai-docs`, `docx`, `gongwen`
- **推荐理由：** 符合国标的全流程公文处理，含格式检查与优化。
...
- **标签：** `spec-driven`, `agent-skills`, `vibe-coding`
- **推荐理由：** 仓库原生规格驱动开发技能，适合DSH项目
...
- **标签：** `chinese-wisdom`, `fengshui`, `tcm`, `dashboard`
- **推荐理由：** 八字/风水/易学/中医融合引擎，一行安装本地运行
...
- **标签：** `skillhub`, `deepseek-harness`, `api`
- **推荐理由：** SkillHub官方Open API文档及DSH插件集成。
...
- **标签：** `workflow`, `agent`, `collaboration`
- **推荐理由：** AI协作议行分离机制工作流，通用多平台。
...
- **标签：** `mcp`, `agent-config`, `deepseek-harness`
- **推荐理由：** 一键配置Claude Code、DSH、Cursor等工具的MCP和技能。
...
- **标签：** `image-prompts`, `skills`
- **推荐理由：** 530+个GPT图像提示词模板和工业级技能
...
- **⭐ 星标：** 1,355
- **语言：** JavaScript
- **描述：** DeepSeek Harness 可编辑设计系��：AI 生成、可视化编辑、模板市场与 PPT｜Native Design & PPT Studio for DeepSeek Harness.
- **标签：** `design`, `ppt`, `templates`
- **推荐理由：** AI设计工作室，含模板和PPT
...
- **推荐理由：** 在对话中内联生成交互式UI组件，支持图表、表单和测验。
...
- **推荐理由：** AI视频/图像/音频技能，支持故事板和视觉模型工具
...
- **标签：** `browser-use`, `cli`, `agent`
- **推荐理由：** 无缝真实浏览器自动化，不中断用户工作
...
- **标签：** `web-search`, `agent-skills`, `agentic-workflow`
- **推荐理由：** 最强免费网页搜索插件，无需注册即可为无联网能力的模型提供搜索桥接。
...
- **推荐理由：** 持久身份浏览器，支持指纹伪装和无限量本地配置文件，基于Playwright。
...
- **标签：** `ios`, `automation`, `mcp`, `ui-automation`
- **推荐理由：** DSH内置iOS模拟器，22个Agent自动化控制工具。
...
- **标签：** `agent-platform`, `web`, `workbench`
- **推荐理由：** 基于DSH的插件化Web工作台，原生工作区集成。
...
- **标签：** `content-discovery`, `social`, `ai-agent`
- **推荐理由：** 跨平台AI内容发现Agent，支持B站/YouTube等。
...
- **标签：** `image-uploader`, `electron-app`
- **推荐理由：** 支持60+图床服务的终极图片上传工具
...
- **标签：** `ecosystem`, `validation`, `monitoring`
- **推荐理由：** 持续发现与验证插件生态
...
- **标签：** `cybersecurity`, `ai-security`, `vulnerabilities`
- **推荐理由：** AI安全攻防平台，审计AI生成代码中的幻觉包和漏洞风险。
...
- **推荐理由：** 容器隔离运行多版本DSH，内置WebView打开UI。
...
- **标签：** `cordis`, `dsh-plugin`, `orchestration`
...
- **推荐理由：** 基于证据的Prompt、RAG和Agent评估观测框架。
...
- **推荐理由：** 高度可定制的磨砂玻璃主题，可调模糊度、磨砂度和自定义壁纸。
...
- **标签：** `theme`, `skin`, `customization`, `animated-background`
- **推荐理由：** 海洋动态主题，支持波浪、日落和玻璃效果自定义。
...
- **标签：** `ai-guide`, `vibe-coding`
- **推荐理由：** 全面的AI资源库，涵盖提示词、技能和RAG
...
- **标签：** `arxiv`, `latex`, `research-tools`
- **推荐理由：** 一站式科研工作台：LaTeX写作、arXiv文献管理、实验追踪与GPU服务器SSH编排。
...
- **标签：** `awesome-list`, `plugin-curation`, `guide`
- **推荐理由：** 精选插件目录，按场景分类，每日自动更新。
...
- **标签：** `awesome-list`, `mcp`, `plugin-curation`
- **推荐理由：** 全面的DSH生态插件、MCP和服务汇总清单。
...
- **标签：** `guide`, `practices`, `marketplace`
- **推荐理由：** 学习DSH原理、插件市场与最佳实践的指南。
...
- **标签：** `chinese-api`, `api-documentation`, `research`
- **推荐理由：** 直搜20家中国开放平台65,600+篇API文档。
...
- **标签：** `quant`, `finance`, `stock`, `trading`
- **推荐理由：** 经过验证的量化/金融DSH插件合集。
...
- **推荐理由：** Evidence-backed plugin radar and community lab
...
- **标签：** `awesome-list`, `dsh-plugin`
- **推荐理由：** DeepSeek Harness生态精选插件发现列表
...
- **标签：** `awesome-list`, `resources`, `meta`
- **推荐理由：** 精选插件列表和资源
...
- **推荐理由：** 双语精选DSH插件、扩展、工具和技能的Awesome列表导航库。
...
- **标签：** `dsh-plugin`, `ai-pedia`, `awesome-list`
- **推荐理由：** 全面AI资源百科，涵盖大模型、Agent、RAG、MLOps及学习路线。
...
- **标签：** `awesome-list`, `curated-list`, `plugin-registry`
- **推荐理由：**  curated DSH插件注册表，含技能与bundle。
...
- **标签：** `awesome-list`, `inventory`, `1000+`
- **推荐理由：** 千余DSH工具按Star排序的全量清单。
...
- **标签：** `deepseek-harness`, `dsh-plugins`, `plugin-verify`
...
- **标签：** `awesome-list`, `dsh-plugins`, `auto-update`
- **推荐理由：** 自动更新的双语DSH插件精选列表。

...
- [编程 Agent 与 Harness 工具](#编程-agent-与-harness-工具) — 26 个插件
...
- [编程 Agent 与 Harness 工具](coding-agents-harness-tools-zh) (26)
...
- **标签：** `cordis`, `dsh-plugin`, `routing`
- **推荐理由：** 任务感知推理模式路由器，提升路由效率
...
- **标签：** `enterprise-agent-workspace`, `multi-agent`, `visual-editor`
- **推荐理由：** 企业级多引擎Agent工作台，支持可视化协作
...
- **标签：** `dsh-plugin`, `llm-agent`, `preset`
- **推荐理由：** 最小引导到完整标准工具的稳定预设方案
...
- **标签：** `code-review`, `static-analysis`, `code-quality`
- **推荐理由：** 基于12本经典工程著作的AI代码审查，含严重性分级与修复建议。
...
- **标签：** `coding-agents`, `architecture-driven-development`, `dsh-plugin`
- **推荐理由：** 让编码代理具备架构感知与基线优先安全保障
...
- **推荐理由：** 从Claude Code/Codex调度工作到DSH Agent，支持原生子代理进度
...
- **推荐理由：** 开发DSH插件的Agent Skill，遵循标准规范
...
- **标签：** `spec-driven-development`, `agent-skills`, `ai-coding`
- **推荐理由：** 便携规格驱动开发技能，支持仓库原生工作流
...
- **标签：** `build-tools`, `dsh-plugin`, `agent-skill`
- **推荐理由：** 构建和配置DSH插件，管理插槽和凭证
...
- **标签：** `agent-skill`, `plugin-development`, `knowledge-base`
...
- **标签：** `ai-agents`, `oauth`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** OAuth绑定ChatGPT账户，在DSH内直接使用订阅模型
...
- **标签：** `agent-workspaces`, `no-code`, `multi-device`
- **推荐理由：** 跨设备统一Agent工作台，看板式任务追踪
...
- **标签：** `dsh-web`, `dsh-plugin`, `plugin-marketplace`
- **推荐理由：** DSH Web端插件���合生态，创意工坊分发
...
- **标签：** `sidebar`, `ui-extension`, `deepseek-harness`
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/子代理等页面。
...
- **推荐理由：** Claude Code风格终端UI，支持流式思考与上下文回滚。
...
- **标签：** `desktop`, `agent-runtime`, `vibe-coding`
- **推荐理由：** 高性能Rust Agent运行时配合精美桌面应用。
...
- **标签：** `desktop-pet`, `electron`, `mcp`, `dsh-plugin`
- **推荐理由：** 桌面伴侣平台，含动画宠物与插件SDK
...
- **⭐ 星标：** 828
- **语言：** JavaScript
- **描述：** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接��来你的dsh安装
- **标签：** `floating-widget`, `plugin`, `dsh-plugin`
- **推荐理由：** DSH右下角小鲸鱼挂件实时显示账户余额
...
- **标签：** `desktop-app`, `electron`, `local-first`, `mcp`, `dsh-plugin`
- **推荐理由：** 本地优先Electron桌面工作台，管理DSH会话与项目
...
- **标签：** `desktop`, `agent`, `local-first`
- **推荐理由：** 本地优先多模型AI代理桌面应用
...
- **标签：** `desktop`, `client`, `electron`
- **推荐理由：** 类CodePilot跨平台桌面客户端
...
- **推荐理由：** 功能丰富的Windows桌面客户端，支持SSH和远程访问
...
- **推荐理由：** Electron桌面控制台，多Tab管理Harness和插件
...
- **推荐理由：** 容器化DSH管理器，内嵌WebView一键导入插件
...
- **标签：** `canvas`, `dsh-plugin`
- **推荐理由：** 无限画布结合创意技能，激发视觉头脑风暴
...
- **推荐理由：** 集成数据库/SSH/Docker与AI助手的跨平台桌面应用
...
- **标签：** `desktop-app`, `electron`, `deepseek-harness`, `plugin`
- **推荐理由：** Electron桌面封装，集成多个DSH插件生态
...
- **推荐理由：** 本地优先的跨Agent持久化记忆层，Markdown原生
...
- **推荐理由：** 专为Agent设计的记忆管理RAG工具，支持记忆检索与优化。
...
- **推荐理由：** 基于Markdown和Milvus的持久化Agent统一记忆层。
...
- **推荐理由：** 将SKILL.md整理为可检索的技能语料库，支持语义搜索
...
- **推荐理由：** 基于Anthropic J-space研究的认知增强Agent技能套件。
...
- **标签：** `vision-tools`, `ocr`, `gui-automation`, `dsh-plugin`
- **推荐理由：** DSH原生视觉工具箱，一行安装多图问答与OCR
...
- **标签：** `skills`, `agent`, `workflow`, `execution`
- **推荐理由：** 将经验转化为可复用的执行技能，支持多LLM
...
- **标签：** `vision`, `multimodal`, `agent-skills`, `claude-code`
- **推荐理由：** 为纯文本LLM添加多模态视觉分析，支持UI自动化检查
...
- **推荐理由：** 通过技能自动搜索、安装和验证GitHub上的DSH插件
...
- **标签：** `image-generation`, `multi-model`, `creative`
- **推荐理由：** 在DSH对话中直接调用多模型生成AI图像
...
- **推荐理由：** 原生SQLite任务板，支持Agent领取/审核和干净Web界面
...
- **标签：** `agent-workflow`, `dsh-plugin`
- **推荐理由：** DSH Agent工作流管理插件
...
- **推荐理由：** Superpowers技能移植到Reasonix编码工具链
...
- **标签：** `ctf`, `security`, `reverse-engineering`, `dsh-plugin`
- **推荐理由：** 85条逆向与安全技能，适合CTF和渗透测试研究
...
- **⭐ 星标：** 66
- **语言：** TypeScript
- **描述：** ProMentor 是一个 AI Coding Agent Skill。装上它，你�� AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **标签：** `deepseek-harness`, `agent-skills`, `dsh-plugin`
- **推荐理由：** AI编程导师，扫描项目架构并生成阶梯式学习路径
...
- **标签：** `agent-skills`, `legal`, `visualization`, `diagram`
- **推荐理由：** 法律可视化工具，自动生成时间轴和诉讼图示
...
- **标签：** `ocr`, `image-reading`, `vision`, `dsh-plugin`
- **推荐理由：** OCR图像识别技能，专为文本模型训练优化
...
- **标签：** `agent-handoff`, `session-memory`, `agent-skills`
- **推荐理由：** 跨平台Agent会话记忆延续与状态恢复技能
...
- **推荐理由：** WorkBuddy风格技能选择器，快速插入技能指令
...
- **推荐理由：** 从DSH改编的Codex代码简化技能，自动精简代码
...
- **推荐理由：** 融合八字/风水/易经/中医的中华传统智慧AI技能包
...
- **标签：** `multi-agent`, `collaboration`, `dsh-plugins`
- **推荐理由：** 多Agent协作框架，共享工作区独立模型配置
...
- **标签：** `ai-docs`, `dsh-plugin`
- **推荐理由：** 符合国标的全流程中文公文处理技能，支持格式检查与优化
...
- **推荐理由：** DSH游戏开发技能，支持Godot 4.x全栈开发
...
- **标签：** `gamification`, `skills`, `tasks`
- **推荐理由：** 游戏化任务栏任务系统，拨雾见终点
...
- **标签：** `run-to-skill`, `local-first`, `agent-skills`
- **推荐理由：** 本地优先，将运行记录转换为可复用技能
...
- **标签：** `agent-preset`, `product-management`, `ai-agents`, `dsh-plugin`
- **推荐理由：** 虚拟产品团队角色模拟，对话式推动项目管理
...
- **标签：** `agent-tools`, `llm-agents`, `deepseek-harness`
- **推荐理由：** 任务预检插件库，提升插件利用率可预期性
...
- **推荐理由：** Web GUI中直接管理Skills和MCP服务器的插件
...
- **标签：** `design-systems`, `figma-alternative`, `dsh-plugin`
- **推荐理由：** 最佳DSH设计插件，开源Figma替代方案
...
- **标签：** `diagram-as-code`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 生成精美可验证架构图的Agent技能
...
- **标签：** `image-prompts`, `prompt-engineering`, `gpt-image-2`
- **推荐理由：** 530+逆向工程图像提示词，工业级模板库
...
- **标签：** `vibedesign`, `flutter`, `design-as-code`
...
- **标签：** `video-generation`, `ffmpeg`, `vox`
- **推荐理由：** 自动化生成Vox风格拼贴解说视频的端到端Agent技能。
...
- **标签：** `ai-design`, `design`, `ppt`
- **推荐理由：** AI设计系统，支持PPT生成与原型可视化编辑
...
- **标签：** `design`, `ui-design`, `openpencil`, `prototyping`
- **推荐理由：** 在DSH对话内直接预览和编辑OpenPencil设计文件
...
- **标签：** `media`, `image-generation`, `vision`, `agent-skills`
- **推荐理由：** 支持图片读取生成与视觉转录的媒体技能包
...
- **标签：** `ai-director`, `dsh-plugin`
- **推荐理由：** 集成DirectorX的AI音视频创作技能插件
...
- **标签：** `visualization`, `token-usage`, `cost`
- **推荐理由：** 实时Token用量图表与API成本估算
...
- **标签：** `content-discovery`, `bilibili`, `xiaohongshu`, `cross-platform`
- **推荐理由：** 本地优先的跨平台内容发现Agent，覆盖B站、抖音、小红书等。
...
- **标签：** `browser-extension`, `chatgpt`, `productivity`, `dsh-plugin`
...
- **推荐理由：** Tabbit浏览器自动化插件，支持Playwright集成
...
- **标签：** `low-code`, `no-code`, `dsh-plugin`
- **推荐理由：** 开源AI低代码平台，快速构建业务系统
...
- **标签：** `vfs`, `agent-sandbox`, `virtual-filesystem`
- **推荐理由：** AI Agent统一虚拟文件系统，跨语言支持
...
- **标签：** `marketplace`, `plugin`, `deepseek-harness`
- **推荐理由：** DSH官方可视化插件市场，支持一键安装与搜索浏览。
...
- **标签：** `cost-tracking`, `token-usage`, `billing`
- **推荐理由：** 精确追踪会话与日度费用，支持多提供商预算提醒
...
- **标签：** `compatibility`, `migration`, `ecosystem-bridge`
...
- **标签：** `plugin-marketplace`, `dsh-plugin`, `javascript`
- **推荐理由：** 在Web GUI中一键浏览、安装和更新所有DSH插件
...
- **标签：** `context-migration`, `preset-migration`, `dsh-plugin`
- **推荐理由：** 跨预设会话迁移，安全保留状态和模型意图
...
- **标签：** `backup`, `crash-recovery`, `undo`, `windows`
- **推荐理由：** 崩溃救援插件，支持撤销、快照和离线SAFE MODE
...
- **标签：** `utility`, `deepseek-harness`, `plugin`
- **推荐理由：** 自动检测并解决插件间版本冲突问题
...
- **标签：** `deepseek-harness`, `plugin-manager`, `registry`, `discovery`
- **推荐理由：** 合并搜索的DSH插件发现注册表
...
- **标签：** `mascot`, `pixel-art`, `claude-code`
- **推荐理由：** Agent宠物吉祥物画廊，个性化UI装饰
...
- **标签：** `skin`, `theme`, `whale`
- **推荐理由：** 鲸鱼娘主题皮肤系列，专用于DeepSeek Harness界面。
...
- **推荐理由：** WebGPU海洋主题皮肤，Three.js实现沉浸视觉效果
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `webui`, `theme`
- **推荐理由：** 支持自定义背景和多种预设氛围，所见即所得
...
- **标签：** `ai-resources`, `vibe-coding`, `rag`
...
- **推荐理由：** 自动搜索中国8大主流平台近30天内容并生成引用报告。
...
- **标签：** `guide`, `awesome-list`, `beginner`
- **推荐理由：** DSH终极双语入门指南与资源
...
- **标签：** `ai-agents`, `api-documentation`, `chinese-api`, `research-tools`
...
- **标签：** `awesome-list`, `dsh-plugins`, `discovery`
- **推荐理由：** 精选280+款DSH插件目录，覆盖14大类别
...
- **推荐理由：** 精选DeepSeek Harness插件目录，方便探索发现
...
- **标签：** `deepseek-harness`, `industry`, `dsh-plugin`
- **推荐理由：** 面向金融法律等行业的DSH插件目录
...
- **推荐理由：** 精选DSH插件雷达榜，覆盖9000+候选与Top50优质插件
...
- **推荐理由：** 3100+插件市场目录，支持搜索、排名和公共API
...
- **标签：** `marketplace`, `plugin-hub`, `deepseek-harness`
- **推荐理由：** DeepSeek Harness插件市场与目录服务
...
- **标签：** `agents`, `awesome`, `deepseek`, `dsh-plugin`
- **推荐理由：** 精心整理的DSH插件资源列表，提升开发效率
...
- **标签：** `awesome-list`, `deepseek-harness`, `plugin`
- **推荐理由：** 精选好用的DeepSeek Harness插件合集
...
- **标签：** `plugin-portal`, `static-site`, `deepseek-harness`, `web`
- **推荐理由：** 零依赖静态站点，浏览安装227+插件
...
- **标签：** `search`, `discoverability`, `deepseek-harness`
- **推荐理由：** 在DSH代理内直接搜索npm和插件列表
...
- **标签：** `awesome-list`, `ai-agents`, `mcp`, `deepseek-harness`
- **推荐理由：** AI推荐190+插件，12分类，每小时更新
...
- **标签：** `ai-agents`, `awesome-list`, `deepseek-harness`
- **推荐理由：** 证据驱动的双语插件目录
...
- **标签：** `awesome-list`, `catalog`, `deepseek-harness`
- **推荐理由：** 自动爬取的DSH插件目录
...
- **标签：** `deepseek-harness`, `awesome-list`, `dsh-plugin`
- **推荐理由：** 按热度排序的千项DSH工具清单

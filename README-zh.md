...
- [编程 Agent 与 Harness 工具](#编程-agent-与-harness-工具) — 24 个插件
- [UI 与桌面扩展](#ui-与桌面扩展) — 16 个插件
- [记忆与知识（RAG）](#记忆与知识（rag）) — 15 个插件
- [Agent 技能与工作流](#agent-技能与工作流) — 32 个插件
- [MCP 服务器与工具](#mcp-服务器与工具) — 4 个插件
- [视觉与设计](#视觉与设计) — 12 个插件
- [浏览器与 Web 自动化](#浏览器与-web-自动化) — 8 个插件
- [通信与社交](#通信与社交) — 1 个插件
- [实用工具与基础设施](#实用工具与基础设施) — 28 个插件
- [主题与皮肤](#主题与皮肤) — 6 个插件
- [研究与分析](#研究与分析) — 7 个插件
- [其他](#其他) — 38 个插件
...
- [编程 Agent 与 Harness 工具](coding-agents-harness-tools-zh) (24)
- [UI 与桌面扩展](ui-desktop-extensions-zh) (16)
- [记忆与知识（RAG）](memory-knowledge-rag-zh) (15)
- [Agent 技能与工作流](agent-skills-workflows-zh) (32)
- [MCP 服务器与工具](mcp-servers-tools-zh) (4)
- [视觉与设计](visual-design-zh) (12)
- [浏览器与 Web 自动化](browser-web-automation-zh) (8)
- [通信与社交](communication-social-zh) (1)
- [实用工具与基础设施](utilities-infrastructure-zh) (28)
- [主题与皮肤](themes-skins-zh) (6)
- [研究与分析](research-analysis-zh) (7)
- [其他](other-zh) (38)
---
...
- **标签：** `agentic-ai`, `multi-agent`, `mcp-server`, `dsh-plugin`
- **推荐理由：** 多智能体蜂群编排，支持自主工作流
...
- **标签：** `ai-agent`, `multi-agent`, `mcp`, `dsh-plugin`
- **推荐理由：** 多模型超级助手，支持记忆和技能自演化
...
- **标签：** `coding-agent`, `terminal`, `dsh-plugin`, `tool-use`
- **推荐理由：** 原生DeepSeek终端编程智能体，前缀缓存稳定
...
- **标签：** `agent-os`, `loop-engineering`, `self-improving`
- **推荐理由：** 自进化Agent操作系统，通过循环工程持续变强
...
- **推荐理由：** 让纯文本Agent理解图像的视觉插件，OCR结构化输出
...
- **标签：** `claude-code`, `deepseek-harness`, `opencode`
- **推荐理由：** 一键切换多种主流编码 Agent，省时省心。
...
- **推荐理由：** Claude Code 风格 TUI，支持流式思考与状态实时展示。
...
- **标签：** `code-review`, `code-quality`, `agent-skills`
- **推荐理由：** 基于 12 部经典工程书籍的 AI 代码审查，支持自动修复。
...
- **标签：** `coding-agent`, `architecture`
- **推荐理由：** 架构感知编码代理，基线优先、漂移检查，保障长任务安全。
...
- **推荐理由：** DeepSeek官方Swift原生macOS编码代理，专为DSH打造。
...
- **标签：** `agent`, `desktop-app`, `multi-model`, `tauri`
- **推荐理由：** 本地优先多模型代理桌面应用，支持技能自进化
...
- **标签：** `agent`, `coding-agent`, `team-orchestration`
- **推荐理由：** 将多个编码代理编排为协作团队
...
- **推荐理由：** 开发DSH插件的Agent Skill，覆盖标准全流程。
...
- **标签：** `spec-driven-development`, `ai-coding`, `developer-tools`
- **推荐理由：** 仓库原生规范驱动开发技能，遵循DSH工程模式。
...
- **标签：** `dsh-plugin`, `agent-skill`
- **推荐理由：** 管理DSH插件槽位、远程与凭据的Agent技能。
...
- **标签：** `plugin-development`, `dsh-plugin`, `cordis`
- **推荐理由：** 便携插件开发审计技能，支持Cordis配置安装。
...
- **标签：** `documentation`, `dsh-plugin`, `best-practices`
- **推荐理由：** DSH插件开发实战笔记，含tsconfig与Windows疑难解决。
...
- **标签：** `plugin-development`, `dsh-plugin`, `testing`
- **推荐理由：** 在DSH内完成插件搭建到测试全流程。
...
- **推荐理由：** Godot引擎全栈游戏开发技能，运行时注册GDScript。
...
- **标签：** `plugin-manager`, `dsh-plugin`, `discovery`
- **推荐理由：** 多源合并去重的插件注册中心，便于插件发现
...
- **标签：** `dsh-plugin`, `plugin-manager`, `cli`
- **推荐理由：** 功能完整的CLI插件管理器，支持搜索安装审计
...
- **标签：** `agent-skills`, `ai-design`, `figma-alternative`, `dsh-plugin`
- **推荐理由：** 本地优先AI设计工具，支持UI生成和原型
...
- **标签：** `web-ui`, `skins`, `desktop`
- **推荐理由：** Web GUI插件与皮肤生态，支持Wallpaper Engine壁纸
...
- **标签：** `agentic-os`, `desktop`, `vibe-coding`
- **推荐理由：** Rust 高性能 Agent 运行时 + 精美桌面应用，体验出色。
...
- **标签：** `desktop`, `electron`
- **推荐理由：** 桌面伴侣平台，带动态宠物和插件SDK，集成编码代理。
...
- **标签：** `desktop`, `tauri`
- **推荐理由：** 轻量5MB Tauri桌面客户端，零配置，跨平台支持。
...
- **标签：** `ui`, `genui`, `interactive-components`
- **推荐理由：** 内联渲染图表、布局、表单等生成式UI组件
...
- **标签：** `ui`, `canvas`, `workspace`
- **推荐理由：** 基于画布的对话分支工作空间，可视化导航
...
- **标签：** `electron`, `desktop`, `gui`
- **推荐理由：** 功能完整的Electron桌面客户端，支持SSH和技能
...
- **推荐理由：** Electron桌面版DSH，集成sidebar、web-ui等多模块
...
- **标签：** `agent-memory`, `agentic-rag`, `dsh-plugin`, `self-evolving`
- **推荐理由：** 自演化上下文数据库，统一记忆与RAG
...
- **标签：** `rag`, `knowledge-base`, `dsh-plugin`, `vector-search`
- **推荐理由：** LLM知识库平台，支持RAG和自维护维基
...
- **标签：** `knowledge-base`, `mcp`, `rag`, `ai-resources`
- **推荐理由：** 全面AI知识库，涵盖技能、MCP、RAG等资源
...
- **推荐理由：** 持久可检的可审查长期记忆，带回忆工具的Agent利器。
...
- **标签：** `skill-corpus`, `vector-search`, `embeddings`
- **推荐理由：** 将零散SKILL.md文件转化为可检索的聚合知识库。
...
- **标签：** `awesome-deepseek-harness`, `dsh-plugin`, `plugin-marketplace`
- **推荐理由：** 社区维护的精选目录，每4小时自动同步。
...
- **⭐ 星标：** 42
- **语言：** JavaScript
- **描述：** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选��护的 DeepSeek Harness Cordis 插件官方自动生成列表。
- **标签：** `awesome-dsh-plugin`, `plugin-marketplace`
- **推荐理由：** cordis.run官方自动生成的精选插件列表。
...
- **标签：** `session-memory`, `agent-handoff`
- **推荐理由：** 支持跨平台会话连续性与记忆恢复
...
- **推荐理由：** 连接PowerContext实现记忆回溯与技能交接
...
- **标签：** `agent-skills`, `knowledge-distillation`, `dsh-plugin`, `meta-skill`
- **推荐理由：** 提炼专家思维模式，生成可复用智能体技能
...
- **推荐理由：** 跨设备统一Agent工作台，支持桌面/移动/浏览器/API
...
- **标签：** `multi-agent`, `enterprise`, `workbench`
...
- **推荐理由：** 基于 Anthropic J-space 认知增强技能，提升 Agent 推理能力。
...
- **标签：** `agent-skills`, `vibe-coding`, `workflow-automation`
- **推荐理由：** 智能路由本地技能并编排 DSH 工作流，通用性强。
...
- **推荐理由：** 让纯文本模型具备看图能力，支持问答、UI还原和GUI自动化。
...
- **标签：** `task-manager`, `workflow`
- **推荐理由：** 自托管人机协作任务管理器，支持移动端和Web远程控制。
...
- **标签：** `vision`, `agent-skills`
- **推荐理由：** DSH原生视觉工具包，支持OCR和截图还原UI，免费易用。
...
- **标签：** `skill`, `plugin-discovery`, `automation`
- **推荐理由：** 自动发现、安装和验证GitHub插件的技能
...
- **推荐理由：** Superpowers技能移植到Reasonix，经过实战验证的技能。
...
- **推荐理由：** TDD调试规划协作技能，源自Superpowers生态。
...
- **标签：** `dsh-plugin`, `ai-agents`
- **推荐理由：** AI编程导师，生成阶梯课程并自动Code Review。
...
- **标签：** `agent-skills`, `research-tools`, `marketing-automation`
- **推荐理由：** 88个开源技能，覆盖研究、营销与社交情报。
...
- **标签：** `skill-picker`, `composer`
- **推荐理由：** 类WorkBuddy技能选择器，快速调用技能
...
- **标签：** `chinese-wisdom`, `tradition`, `dashboard`
- **推荐理由：** 融合八字、风水、易经、中医等传统智慧技能
...
- **标签：** `governance`, `swift-cycle`, `skill`
- **推荐理由：** 版本锁定Swift Cycle治理技能适配器
...
- **标签：** `agent-skills`, `dsh-plugin`, `mcp`
- **推荐理由：** 全面的AI代理技能包，支持评估驱动和规格驱动开发。
...
- **标签：** `docx`, `gongwen`, `wps-office`
- **推荐理由：** 符合国标的全流程中文公文处理工具。
...
- **标签：** `agent-skills`, `deepseek-harness`
- **推荐理由：** 强调事实调查与证据驱动的工程设计规范技能。
...
- **标签：** `canvas`, `agent-skills`, `mcp-tools`
- **推荐理由：** 无限画布原生插件，支持无限创意技能。
...
- **标签：** `record-replay`, `macos`, `agent-skills`
...
- **标签：** `skill-management`, `mcp`, `hot-reload`
- **推荐理由：** 设置页直接配置MCP并热加载技能，即点即用
...
- **标签：** `agent-tools`, `ai-agents`, `llm-agents`
- **推荐理由：** Agent任务预检插件库，智能推荐Top-K插件
...
- **标签：** `agent-skills`, `diagram-as-code`, `dsh-plugin`, `code-visualization`
- **推荐理由：** 从代码生成精美架构图和工作流图
...
- **标签：** `image-generation`, `prompt-engineering`, `visual`
- **推荐理由：** 470+逆向工程提示词与20+工业级模板库
...
- **标签：** `video-generation`, `tts`, `ffmpeg`
- **推荐理由：** 自动生成 Vox 风格拼贴解说视频，端到端自动化。
...
- **标签：** `image-generation`, `visual`, `design`
- **推荐理由：** 在对话中直接使用Seedream和Gemini生成图片
...
- **标签：** `design`, `vibe-coding`, `web-design`
- **推荐理由：** 6种设计样式包，避免AI感外观
...
- **推荐理由：** 跨浏览器增强套件，支持Gemini/Claude等
...
- **标签：** `ai-agent`, `bilibili`, `cross-platform`, `privacy-first`
- **推荐理由：** 本地私有跨平台内容发现 Agent，覆盖 B站、YouTube 等主流平台。
...
- **推荐理由：** 让 AI Agent 无缝使用你已登录的浏览器，不中断工作流程。
...
- **标签：** `browser-automation`, `chrome-extension`, `coding-agent`
- **推荐理由：** Chrome侧边栏扩展，让DSH代理直接操控浏览器
...
- **⭐ 星标：** 235
- **语言：** TypeScript
- **描述：** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费免注册免 API key。为不能联网的模型��上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **标签：** `web-search`, `free`, `no-signup`
- **推荐理由：** 免费网络搜索桥接，适配无原生上网能力的模型
...
- **标签：** `ios`, `mobile-automation`, `xcode`
- **推荐理由：** 对话内嵌iOS模拟器与真机自动化，22个代理工具
...
- **推荐理由：** 基于Playwright的Tabbit浏览器自动化插件，功能强大。
...
- **标签：** `social`, `community`, `oauth`
- **推荐理由：** GitHub OAuth合影墙，记录DSH社区时光
...
- **标签：** `agent-skills`, `mcp-server`, `dsh-plugin`, `self-hosted`
- **推荐理由：** 隐私优先的开源简历构建器，完全免费
...
- **标签：** `dsh-plugin`, `electron-app`, `image-uploader`
- **推荐理由：** 终极图床工具，支持60+托管服务
...
- **标签：** `dsh-plugin`, `low-code`, `workflows`, `self-hosted`
...
- **标签：** `routing`, `infrastructure`, `performance`
- **推荐理由：** 任务感知推理模式路由器，实测性能提升
...
- **标签：** `preset`, `standard`, `bootstrap`
- **推荐理由：** 两阶段预设：最小化引导后接入完整标准工具集
...
- **标签：** `marketplace`, `dsh-plugin`, `plugin-discovery`
- **推荐理由：** DSH 可视化插件市场，一键安装，浏览搜索方便。
...
- **推荐理由：** 9000+ 插件雷达精选榜，真实安装级实测 + 人工策展。
...
- **推荐理由：** OAuth桥接，用订阅账户作LLM后端无需API密钥
...
- **标签：** `cost-tracking`, `utility`, `token-usage`
- **推荐理由：** 跨提供商追踪会话成本、预算和token用量
...
- **推荐理由：** 桥接Pi Agent到DSH生态，无缝运行Pi扩展
...
- **标签：** `marketplace`, `plugin-management`, `utility`
- **推荐理由：** 一键浏览安装更新GitHub全部DSH插件，省心省力。
...
- **标签：** `backup`, `crash-recovery`, `snapshot`
- **推荐理由：** 崩溃恢复加撤销快照安全模式，DSH稳定性保障神器。
...
- **推荐理由：** 原生SQLite任务看板配干净Web UI，无需iframe。
...
- **标签：** `awesome-list`, `discovery`, `resources`
- **推荐理由：** 精选DSH插件汇总清单，发现优质插件的必备资源。
...
- **标签：** `marketplace`, `webui`, `plugin-market`
- **推荐理由：** DSH Web GUI社区插件市场，一键安装卸载插件。
...
- **标签：** `console`, `plugin-management`, `ui`
- **推荐理由：** 浏览器面板管理插件生态，附官方开发引导。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `desktop-app`
- **推荐理由：** 隔离容器运行多版本DSH，内置WebView界面。
...
- **标签：** `config`, `backup`, `webdav`
- **推荐理由：** 支持WebDAV备份还原DSH完整配置
...
- **标签：** `hud`, `status`, `visualization`
- **推荐理由：** 悬浮面板实时显示git状态、MCP和Token用量
...
- **标签：** `awesome`, `deepseek-harness-plugin`, `utilities`
- **推荐理由：** 检测并解决插件间及版本冲突
...
- **标签：** `dsh`, `plugin-manager`, `publishing`
- **推荐理由：** 一键发布插件，自动校验并生成描述文档
...
- **标签：** `pets`, `mascot`, `pixel-art`
- **推荐理由：** Codex、Claude和DSH的动画宠物公共画廊
...
- **推荐理由：** WebGPU海洋主题，Three.js沉浸式视觉体验
...
- **标签：** `theme`, `skins`, `ui`, `opencode`
- **推荐理由：** 34款经典配色一键切换，重启后持久保留。
...
- **⭐ 星标：** 5
- **语言：** JavaScript
- **描述：** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮��菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **标签：** `background`, `theme`, `customization`
- **推荐理由：** 自定义网页背景，支持预设氛围和实时预览
...
- **标签：** `ai-resources`, `vibe-coding`, `llm`, `dsh-plugin`
- **推荐理由：** 全面AI资源库和Vibe Coding教程中心
...
- **标签：** `research`, `web-search`, `agent-skills`
- **推荐理由：** 自动搜索国内 8 大平台近 30 天内容，生成可追溯研究报告。
...
- **标签：** `awesome-list`, `catalog`, `plugin-discovery`
- **推荐理由：** 精选DSH插件、技能与MCP服务器发现列表
...
- **标签：** `api-documentation`, `chinese-api`, `ai-agents`
...
- **标签：** `deepseek-harness`, `analysis`, `kline`
- **推荐理由：** 交互式K线分析，支持多市场、技术指标与新闻整合。
...
- **⭐ 星标：** 10
- **语言：** Python
- **描述：** DeepSeek Harness 0.1.0-rc.6 数学建模增��套件：外置插件 + Preset + 17 个手动 Skill 卡片 + Windows 便携版脚本
- **标签：** `math`, `modeling`, `skills`
- **推荐理由：** 数学建模套件，含17个预置技能和便携脚本
...
- **标签：** `awesome-list`, `directory`, `resource`
- **推荐理由：** DSH精选插件合集，必看的资源导航列表
...
- **标签：** `toy`, `single-file`, `entertainment`
- **推荐理由：** 传统玩具竹知了的 Web 模拟版，趣味十足。
...
- **标签：** `awesome-list`, `resource`
- **推荐理由：** 精选插件生态列表，探索DSH插件的最佳起点。
...
- **标签：** `awesome-list`, `plugin-finder`, `curated`
- **推荐理由：** 每日自动抓取并人工核验的插件发现工具
...
- **标签：** `tutorial`, `marketplace`, `best-practices`
...
- **⭐ 星标：** 192
- **语言：** Unknown
- **描述：** DeepSeek Harness 终极指南：快速入���、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **标签：** `awesome-list`, `guide`, `bilingual`
- **推荐理由：** 终极双语指南：快速入门、资源与精选插件
...
- **标签：** `marketplace`, `hub`, `plugins`
- **推荐理由：** DSH插件市场与中心，支持浏览和分发
...
- **⭐ 星标：** 150
- **语言：** TypeScript
- **描述：** 开���版锤子便签，复刻锤科美学，一键Docker私有化部署，支持skill调用，支持dsh plugin，支持多租户，一键生成公众号格式，支持导出便签为图片
- **标签：** `notes`, `productivity`, `smartisan`
- **推荐理由：** 锤子便签风格，支持Docker私有化部署和技能调用
...
- **标签：** `awesome-list`, `plugin-directory`, `nextjs`
- **推荐理由：** DSH插件发现目录，含安装命令与生态浏览。
...
- **标签：** `awesome-list`, `registry`
- **推荐理由：** 去垃圾插件注册表，含bundle和技能
...
- **标签：** `plugin-directory`, `awesome-list`, `deepseek-harness`
- **推荐理由：** 按场景选插件指南，含安装与风险分析
...
- **标签：** `awesome-list`, `ai-agents`, `dsh-plugin`
- **推荐理由：** 经过验证的DSH社区插件星级排名目录
...
- **标签：** `awesome-list`, `plugin-registry`, `ai-agent`
- **推荐理由：** 基于证据的DSH插件雷达，含2Origin实验
...
- **标签：** `plugin-portal`, `static-site`, `web`
- **推荐理由：** 静态插件门户，支持浏览和安装227+插件
...
- **标签：** `awesome-dsh-plugin`, `deprecated`
- **推荐理由：** 已迁移，请访问新地址
...
- **标签：** `awesome-list`, `coding-agents`, `mcp`
- **推荐理由：** AI驱动的分类插件目录，每小时更新
...
- **标签：** `dsh-plugins`, `dsh-ecosystem`, `plugin-verify`
- **推荐理由：** 含验证和分析的DSH插件仓库
...
- **标签：** `deepseek-harness`, `plugin-directory`
- **推荐理由：** 基于证据的精选插件短列表，质量可控
...
- **标签：** `deepseek-harness`, `plugin-directory`, `coding-agents`
- **推荐理由：** 覆盖模型、工具、UI和智能体循环的完整插件目录
...
- **标签：** `dsh-plugin`, `industry`, `plugin-directory`
- **推荐理由：** 按行业分类的插件目录，覆盖金融法律医疗等
...
- **标签：** `dsh-plugin`, `cordis`, `awesome-list`
...
- **标签：** `dsh-plugin`, `awesome-list`, `catalog`
- **推荐理由：** 按星标排序的千余个DSH工具完整清单

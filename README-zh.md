...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,075 | Core DSH framework enabling plugin-based agent eco |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,447 | Open-source design plugin with local-first desktop |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,392 | Multi-agent swarm orchestrator with MCP server int |
...
- **标签：** `coding-agent`, `dsh-plugin`, `terminal`
- **推荐理由：** 终端AI编程Agent，前缀缓存稳定高效。
...
- **标签：** `diagram`, `mermaid`, `architecture`, `agent-skills`
- **推荐理由：** 生成美观可验证架构图，自带动效和清晰说明
...
- **标签：** `agent-runtime`, `desktop-app`, `rust`, `vibe-coding`
- **推荐理由：** 高性能Rust Agent运行时搭配精美桌面IDE体验。
...
- **标签：** `code-review`, `architecture`, `static-analysis`, `auto-fix`
- **推荐理由：** 基于12本经典工程书籍的AI代码审查，支持自动修复。
...
- **标签：** `coding-agent`, `architecture`, `drift-check`
- **推荐理由：** 让编码代理具备架构感知与漂移检测能力
...
- **标签：** `vision`, `ocr`, `computer-vision`, `agent`
- **推荐理由：** 纯文本模型的强大视觉工具箱：OCR、图像问答
...
- **标签：** `agent`, `team`, `coding`
- **推荐理由：** 将多个编程Agent统一为协作团队，提升开发效率
...
- **推荐理由：** 内置iOS模拟器与真机控制，22个自动化Agent工具
...
- **标签：** `coding-agent`, `skills`, `reasonix`
- **推荐理由：** Superpowers技能移植至Reasonix编码工具链。
...
- **标签：** `agent-skills`, `dsh-plugin`, `developer-tools`
- **推荐理由：** 开发DSH插件的Agent技能，涵盖插件标准全流程
...
- **标签：** `spec-driven-development`, `vibe-coding`, `ai-coding`
- **推荐理由：** 基于DSH工程规范的仓库级规格驱动开发技能
...
- **标签：** `dsh-plugin`, `plugin-management`, `utilities`
...
- **标签：** `coding-agent`, `code-simplification`, `skill`
...
- **标签：** `plugin-development`, `coding`, `harness`, `tool`
- **推荐理由：** 便携插件开发审计技能，支持cordis适配器
...
- **标签：** `plugin-development`, `documentation`, `best-practices`, `guide`
- **推荐理由：** DSH插件开发踩坑实录：cordis/tsconfig/zstd等
...
- **标签：** `migration`, `claude-code`, `mcp`, `setup`
- **推荐理由：** 无缝迁移Claude Code技能、MCP配置和代理至DSH
...
- **标签：** `plugin-creator`, `scaffolding`, `validation`
- **推荐理由：** 高效脚手架和验证DSH/Cordis插件的复用技能
...
- **标签：** `sidebar`, `ui-extension`, `third-party`
- **推荐理由：** 开放侧边栏底座，支持三方扩展，内置多种页面。
...
- **标签：** `tui`, `terminal`, `claude-code-style`
- **推荐理由：** Claude Code风格终端UI，支持流式思考与回滚。
...
- **标签：** `desktop`, `companion`, `pet`, `electron`
- **推荐理由：** 桌面陪伴平台含动画宠物与编码代理集成
...
- **标签：** `widget`, `floating-ui`, `balance-monitor`
- **推荐理由：** 可爱浮动鲸鱼小部件监控DeepSeek账户余额
...
- **标签：** `desktop`, `agent`, `privacy`
- **推荐理由：** 本地优先的多模型AI代理桌面应用，注重隐私安全
...
- **推荐理由：** 跨平台Desktop客户端，集成插件套件，类CodePilot体验
...
- **标签：** `ui`, `workspace`, `canvas`
- **推荐理由：** 可视化画布式非线性会话空间，支持分支工作流
...
- **推荐理由：** 功能丰富的Electron桌面客户端，支持SSH和技能扩展
...
- **标签：** `marketplace`, `plugin-marketplace`, `web-gui`
- **推荐理由：** Web GUI一键浏览安装GitHub插件市场。
...
- **标签：** `market`, `web`, `plugin-market`
- **推荐理由：** DSH Web GUI社区插件市场一键安装卸载。
...
- **推荐理由：** Electron桌面控制台，多标签管理插件/MCP/Skills
...
- **标签：** `ui`, `skill-picker`, `composer`
- **推荐理由：** 类WorkBuddy技能选择器，提升Composer体验。
...
- **标签：** `ui`, `mcp`, `capability-menu`
- **推荐理由：** 统一控制面板，可视化调节MCP工具暴露级别。
...
- **标签：** `deepseek-harness`, `desktop-app`, `electron`
- **推荐理由：** Electron桌面封装，集成D sh核心组件
...
- **推荐理由：** 为所有AI智能体提供持久化统一记忆层，基于Milvus。
...
- **标签：** `knowledge`, `ai-encyclopedia`, `rag`
- **推荐理由：** 涵盖AI技能、RAG、MLOps的全维度百科知识库
...
- **标签：** `agent-memory`, `vector-search`, `skill-md`
- **推荐理由：** 将SKILL.md文件转为可检索的Agent技能知识库
...
- **标签：** `agent-skills`, `dsh-plugin`, `meta-skill`
...
- **标签：** `agent-skills`, `cognitive-enhancement`, `global-workspace`
- **推荐理由：** 基于Anthropic J-space研究的认知增强技能套件。
...
- **标签：** `prompt`, `armor-breaking`, `skill`
- **推荐理由：** 深度优化提示词，突破DeepSeek能力限制
...
- **标签：** `agent-skills`, `math-modeling`, `gitops`
- **推荐理由：** 全流程自动数学建模竞赛Skill，支持国赛美赛
...
- **标签：** `creative-writing`, `fiction-writing`, `screenwriting`
- **推荐理由：** 基于Oh Story的小说写作与短剧创作Skill
...
- **推荐理由：** 为纯文本LLM添加多模态视觉能力，支持截图/UI分析
...
- **推荐理由：** Claude/Codex/OpenAI等Agent的可复用技能框架
...
- **标签：** `notes`, `smartisan`, `skill`
- **推荐理由：** 一键私有化部署，支持skill调用和多租户。
...
- **标签：** `context-migration`, `session-migration`, `preset`
- **推荐理由：** 跨预设会话迁移，保留状态和上下文。
...
- **推荐理由：** 将Superpowers技能移植到DSH，支持TDD、调试和协作
...
- **标签：** `research-tools`, `deep-research`, `market-research`, `social-listening`
- **推荐理由：** 88个开源技能，覆盖研究、社交情报和营销自动化
...
- **标签：** `image-reading`, `ocr`, `vision`, `pixel-art`
- **推荐理由：** 为文本模型提供图像OCR和视觉识别能力
...
- **标签：** `agent-skill`, `fengshui`, `bazi`, `dashboard`
- **推荐理由：** 八字风水易经智能体技能，本地确定性引擎。
...
- **标签：** `agent-handoff`, `session-memory`, `cross-platform`
- **推荐理由：** 跨平台Agent交接技能，保持上下文连续性。
...
- **标签：** `skills`, `manager`, `organization`
- **推荐理由：** 专用技能管理插件，方便整理维护技能库。
...
- **标签：** `agent-skills`, `swift-cycle`, `governance`
...
- **标签：** `gongwen`, `docx`, `workflow`, `agent-skill`
...
- **标签：** `agent-skills`, `cli`, `package-manager`, `eval-driven`
- **推荐理由：** 42个技能+5个CLI，覆盖Agent工程与数据库操作
...
- **标签：** `agent-skills`, `game`, `mission`, `workflow`
- **推荐理由：** 游戏化任务系统，迷雾地图驱动技能进度推进
...
- **推荐理由：** 支持GDScript的Godot 4.x全栈开发技能
...
- **标签：** `design-systems`, `dsh-plugin`, `figma-alternative`
- **推荐理由：** 开源设计插件，本地优先桌面应用。
...
- **标签：** `image-generation`, `skills`, `dsh-plugin`
- **推荐理由：** 530+提示词案例，提炼为图像生成技能。
...
- **标签：** `video`, `generative-ai`, `ffmpeg`, `tts`
- **推荐理由：** 一键生成Vox风格拼贴解释视频，全自动流程。
...
- **标签：** `design`, `ppt`, `visual-editor`, `prototyping`
- **推荐理由：** AI生成可编辑设计系统含模板市场与PPT工作室
...
- **标签：** `ui`, `interactive`, `visual`
- **推荐理由：** 在回复中内联渲染交互式UI组件，支持图表和表单
...
- **推荐理由：** 在DeepSeek Harness聊天中直接生成图像
...
- **标签：** `legal`, `visualization`, `diagram`, `timeline`
- **推荐理由：** 法律诉讼可视化工具，生成时间轴和图表
...
- **标签：** `kline`, `chart`, `technical-analysis`, `dashboard`
- **推荐理由：** 交互式K线分析插件，侧栏直显技术指标。
...
- **标签：** `image-generation`, `vision`, `media`, `skill`
- **推荐理由：** 支持图片读取、生成和视觉转录的多媒体能力
...
- **标签：** `ai-video`, `image-generation`, `directorx`, `multimodal`
- **推荐理由：** 含分镜的AI视频/图像/音频多模态创作管线
...
- **标签：** `canvas`, `creative`, `weShop`
- **推荐理由：** 原生WeShop插件，支持��限画布和创意代理技能
...
- **标签：** `dashboard`, `token-tracking`, `cost`
- **推荐理由：** 实时Token使用仪表板，含成本估算和API余额追踪
...
- **标签：** `bilibili`, `content-discovery`, `cross-platform`, `privacy-first`
- **推荐理由：** 本地优先的跨平台AI内容发现Agent，覆盖主流平台。
...
- **标签：** `browser-use`, `automation`, `agent`
- **推荐理由：** CLI+扩展让AI代理无缝使用已登录的真实浏览器
...
- **标签：** `social`, `oauth`, `photo`, `event`
- **推荐理由：** 零权限GitHub OAuth合影墙，适合内测社区活动
...
- **标签：** `image-uploader`, `dsh-plugin`, `electron`
...
- **标签：** `tutorial`, `beginner`, `harness`
- **推荐理由：** 新手从0到1的harness工程入门教程
...
- **标签：** `marketplace`, `plugin`, `official`
- **推荐理由：** DSH内置插件市场，浏览搜索一键安装。
...
- **标签：** `context`, `dashboard`, `utility`
- **推荐理由：** DSH会话上下文洞察仪表板与管理工具
...
- **推荐理由：** 通过OAuth使用订阅服务作为DSH的LLM后端，省去API密钥
...
- **标签：** `search`, `web`, `utility`
- **推荐理由：** 最强免费网页搜索桥接插件，无需注册和API密钥
...
- **标签：** `cost-tracking`, `token-usage`, `deepseek-api`
- **推荐理由：** 跨提供商跟踪会话/每日成本、预算限制和Token使用量
...
- **推荐理由：** 打通Pi与DSH生态，让Pi扩展作为原生DSH插件运行
...
- **推荐理由：** 崩溃恢复，撤销配置，安全快照一键SAFE MODE。
...
- **标签：** `dsh-plugins`, `container`, `utility`
- **推荐理由：** 隔离容器运行多版本DSH，含内置UI面板。
...
- **标签：** `config-manager`, `backup`, `sync`, `webdav`
- **推荐理由：** 完整配置备份还原，支持WebDAV同步迁移。
...
- **标签：** `mcp`, `skill-management`, `web-ui`, `utility`
- **推荐理由：** 在DSH设置页直接管理技能与MCP服务器
...
- **标签：** `status-bar`, `utility`, `info`, `tracking`
- **推荐理由：** 持久显示模型、余额、定价信息的底部状态栏
...
- **标签：** `dsh-plugin`, `conflict-resolution`
- **推荐理由：** 诊断并解决插件版本冲突问题
...
- **推荐理由：** 为DeepSeek Harness打造震撼的WebGPU海洋动态皮肤
...
- **标签：** `deepseek-harness`, `design-skills`, `theme`, `ui`
- **推荐理由：** 6种预设美学风格，避免AI味设计
...
- **标签：** `theme`, `skin`, `customization`, `palette`
...
- **标签：** `ai-resources`, `rag`, `vibe-coding`
...
- **标签：** `research`, `web-search`, `china`, `report`
- **推荐理由：** 搜索8大中文平台近30天内容并生成有据研究报告。
...
- **标签：** `ai-agents`, `chinese-api`, `api-documentation`, `dsh-plugin`
- **推荐理由：** 在DSH中直接搜索20个中国开放平台6.5万+篇API文档
...
- **标签：** `evaluation`, `rag-evaluation`, `llm-judge`, `agent-evaluation`
- **推荐理由：** 多框架提示词/RAG/Agent量化评估与可观测性
...
- **标签：** `awesome-list`, `registry`, `typescript`
- **推荐理由：** 公开GitHub插件注册表，含安装命令和发现功能
...
- **推荐理由：** 经过垃圾过滤的DSH插件、捆绑包和技能开放数据注册表
...
- **标签：** `awesome-list`, `verified`, `evidence-led`
- **推荐理由：** 循证验证插件目录，含权限感知安装指南
...
- **标签：** `awesome-list`, `plugin-registry`, `research`
- **推荐理由：** 有据可查的插件雷达与2Origin分析
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh`
- **推荐理由：** DSH插件、工具和资源的精选总览
...
- **标签：** `awesome-list`, `dsh-plugins`, `deepseek-harness`
- **推荐理由：** 70+已验证DSH插件按功能分类
...
- **标签：** `awesome-list`, `dsh-plugin`, `industry`
- **推荐理由：** 涵盖6大行业的DSH插件精选目录
...
- **标签：** `resume-builder`, `self-hosted`, `dsh-plugin`
- **推荐理由：** 隐私优先的开源简历构建器。
...
- **标签：** `low-code`, `dsh-plugin`, `crm`
- **推荐理由：** AI增强的低代码业务系统构建平台。
...
- **标签：** `agent-memory`, `agentic-ai`, `ai`, `chats`, `clawdbot`, `clawdbot-skill`, `deepseek-harness`, `dsh`, `dsh-plugin`, `llm`, `long-term-memory`, `mcp`, `memory`, `memory-management`, `python3`, `rag`, `skills`
- **推荐理由：** One portable memory layer for every AI agent: local-first, Markdown-native, user
...
- **标签：** `agent`, `agentic-ai`, `ai`, `ai-agents`, `chatgpt`, `claude`, `deepseek-harness`, `dsh-plugin`, `hermes`, `llm`, `long-term-memory`, `mcp`, `memory`, `memory-management`, `openclaw`, `rag`, `self-evolving`, `self-hosted`, `skills`, `token-savings`
- **推荐理由：** Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-ret
...
- **标签：** `agent-harness`, `agent-orchestration`, `agent-skills`, `agent-workspaces`, `ai-agents`, `ai-native`, `claude-code`, `coding-agent`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `local-first`, `mcp`, `no-code`, `own-your-data`, `tool-use`
- **推荐理由：** ✨ All your agents and workspaces in one place, on every device you own. Track ta
...
- **推荐理由：** dsh-routing-suite — injector + router-standard kit: install the runtime injector
...
- **推荐理由：** DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发
...
- **标签：** `agent-os`, `agentic-ai`, `ai-agent`, `ai-coding-agent`, `claude-code`, `cli`, `codex`, `coding-agent`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `github-copilot`, `llm-evaluation`, `llm-orchestration`, `loop-engineering`, `mcp`, `opencode`
- **推荐理由：** Agent OS: the agent gets smarter on its own. We just hold the line: the grading 
...
- **标签：** `agent`, `agent-team`, `ai`, `claude`, `claude-code`, `codex`, `dsh-plugin`, `fimga`, `flutter`, `mcp`, `opencode`, `openpencil`, `pencil`, `react`, `react-native`, `rust`, `skill`, `ui`, `vibecoding`, `vibedesign`
- **推荐理由：** The world's first open-source AI-native vector design tool and the first to feat
...
- **标签：** `agent-collaboration`, `agent-skills`, `ai-agents`, `ai-work`, `claude-code`, `codex`, `codex-plugin`, `deepseek-harness`, `dsh-plugin`, `enterprise-agent-workspace`, `hermes-agent`, `ipollowork-plugin`, `ipollowork-skill`, `multi-agent-workspace`, `opencode`, `opencode-plugin`, `self-evolving-ai`, `visual-editor`
- **推荐理由：** Enterprise-grade, local-first Agent Workbench for people and agent teams. A unif
...
- **标签：** `claude-code`, `clerk`, `cli`, `codex`, `developer-tools`, `drizzle-orm`, `dsh-plugin`, `mascot`, `neon`, `nextjs`, `pixel-art`, `postgres`, `react`, `sprites`, `tailwindcss`, `vercel`
- **推荐理由：** A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Herm
...
- **推荐理由：** Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard
...
- **标签：** `agent-skills`, `claude-code`, `claude-skills`, `codex`, `cordis`, `deepseek`, `dsh`, `dsh-plugin`, `glm`, `harness`, `harness-engineering`, `hermes-agent`, `image-to-text`, `multimodal`, `ocr`, `openclaw`, `pi-agent`, `text-only-llm`, `vision`, `vision-transformer`
- **推荐理由：** The first vision plugin for DeepSeek Harness, and the vision bridge for every te
...
- **标签：** `agent-sandbox`, `agent-tools`, `ai-agents`, `bash`, `claude-code`, `dsh`, `dsh-plugin`, `fuse`, `llm-agents`, `openai-agents`, `python`, `typescript`, `vfs`, `virtual-filesystem`
- **推荐理由：** The World's First Unified Virtual Filesystem For AI Agents
...
- **标签：** `toy`, `web`, `fun`, `zero-dependency`
- **推荐理由：** 零依赖网页版传统玩具竹知了，趣味十足的插件。
...
- **标签：** `awesome-list`, `plugin-registry`, `curation`
- **推荐理由：** 精选插件雷达，自动发现9000+候选并精选Top50
...
- **推荐理由：** DeepSeek Harness社区精选插件生态列表
...
- **标签：** `awesome-list`, `curation`, `hub`
- **推荐理由：** 社区精选插件、工具与基础设施概览
...
- **标签：** `awesome-list`, `reference`, `curated`
- **推荐理由：** 双语精选DSH插件与工具参考目录，覆盖面广
...
- **标签：** `discovery`, `awesome-list`, `curated`
- **推荐理由：** 每日自动更新的插件发现工具，按场景分类推荐
...
- **标签：** `learning`, `guide`, `best-practices`
- **推荐理由：** 学习DSH原理、插件市场浏览与最佳实践的指南
...
- **标签：** `awesome-list`, `deepseek-harness`, `mcp`, `dsh-plugin`
- **推荐理由：** 覆盖插件、MCP服务器、补丁与编排器的精选列表
...
- **标签：** `marketplace`, `plugin-store`, `plugin-directory`
- **推荐理由：** 3100+插件市场，支持搜索、排行和公开API
...
- **推荐理由：** DeepSeek Harness生态插件市场和中心
...
- **标签：** `agents`, `awesome`, `awesome-list`, `dsh-plugin`
- **推荐理由：** 精心策划的DSH插件、工具和资源精选列表
...
- **标签：** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `plugin-marketplace`
- **推荐理由：** 社区维护的DSH插件目录，每4小时自动同步更新
...
- **标签：** `awesome-list`, `dsh-plugin`
- **推荐理由：** cordis.run官方精选自动生成的DSH插件目录
...
- **标签：** `ai-agent`, `awesome`, `awesome-list`, `curated-list`, `deepseek`, `deepseek-harness`, `dsh`, `plugin`
- **推荐理由：** Curated list of DeepSeek Harness (DSH) plugins for 2026, with quality check.
...
- **标签：** `awesome-list`, `plugin-directory`, `documentation`
- **推荐理由：** 按场景分类的插件说明书与导航
...
- **标签：** `redirect`, `awesome-list`
- **推荐理由：** 指向新版awesome-dsh-plugin仓库的跳转
...
- **标签：** `awesome-list`, `catalog`, `automation`
- **推荐理由：** 每日自动爬取的 bilingual 插件目录
...
- **标签：** `marketplace`, `dsh-plugin`, `awesome-dsh-plugin`
- **推荐理由：** 类CodeX的DSH插件市场，便于浏览

...
- **标签：** `agent`, `harness`, `dsh-plugin`
- **推荐理由：** 从零开始的学习教程，适合DSH新手快速上手
...
- **标签：** `agent`, `cordis`, `dsh-plugin`
- **推荐理由：** 任务感知的推理模式路由器，智能分发Agent请求
...
- **推荐理由：** 自进化Agent操作系统，通过循环工程实现自主成长
...
- **标签：** `vision`, `mcp`, `dsh-plugin`
- **推荐理由：** 首个视觉插件，为纯文本Agent提供OCR能力
...
- **标签：** `context-management`, `dashboard`, `statistics`
- **推荐理由：** DSH上下文管理与可视化面板，监控对话统计
...
- **推荐理由：** 纯文本模型视觉增强：OCR识别、多图问答、截图分析
...
- **标签：** `coding-agent`, `mcp`, `sub-agents`, `tui`
- **推荐理由：** 功能丰富的编码Agent，支持子Agent和MCP集成。
...
- **推荐理由：** 将Superpowers技能移植到Reasonix编码引擎，增强开发能力。
...
- **标签：** `plugin-creator`, `coding`, `validation`
- **推荐理由：** 通过可复用Codex技能构建验证DSH插件
...
- **标签：** `agent-tools`, `llm-agents`, `dsh-plugin`
- **推荐理由：** Agent任务预检插件库，提升工具利用率
...
- **标签：** `dsh-web`, `cordis`, `dsh-plugin`
- **推荐理由：** 基于Web的插件聚合生态，创意工坊分发便捷
...
- **标签：** `agent-sandbox`, `agent-tools`, `virtual-terminal`
- **推荐理由：** 首个AI代理虚拟终端，沙箱式隔离执行。
...
- **⭐ 星标：** 3,214
- **语言：** TypeScript
- **描述：** 开放的侧边��底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, supports third-party extensions to register new sidebar pages. Built-in file rendering/editing, terminal, side chat, Git, and sub-agent pages.
...
- **推荐理由：** 本地优先Electron桌面，管理DSH会话、文件与插件
...
- **推荐理由：** 在对话中直接渲染交互式UI组件，如图表、表单和测验
...
- **标签：** `desktop-app`, `tauri`, `local-first`, `privacy`
- **推荐理由：** 本地优先的开源桌面AI代理，支持多模型和自进化技能
...
- **标签：** `canvas`, `workspace`, `non-linear`, `session`
- **推荐理由：** 可视化非线性对话空间，支持画布探索和分支会话
...
- **推荐理由：** 开源Windows桌面客户端，集成Codex、技能、SSH和远程访问
...
- **标签：** `desktop-app`, `electron`, `cross-platform`, `macos`, `linux`
- **推荐理由：** CodePilot风格跨平台桌面客户端，支持三大主流操作系统
...
- **标签：** `desktop-app`, `electron`, `plugin-management`
- **推荐理由：** Electron桌面管理控制台，统一管理插件、MCP和技能。
...
- **标签：** `ui`, `balance`, `pricing`
- **推荐理由：** 底部信息栏，实时显示余额、定价峰值倒计时，简洁实用。
...
- **推荐理由：** 一体化DevOps桌面：数据库、SSH、Docker、AI
...
- **标签：** `plugin-portal`, `web`, `github-pages`
- **推荐理由：** 零依赖静态Web门户浏览227+插件
...
- **标签：** `dsh-plugin`, `ui`, `dsh-plugin-market`
- **推荐理由：** DSH Web面板一键折叠上下文按钮
...
- **推荐理由：** 本地优先的可移植记忆层，Markdown原生且用户自持
...
- **推荐理由：** 将分散的技能文档转为可检索的向量知识库，支持检索与评估
...
- **标签：** `architecture-as-code`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 代码生成美观的架构图和流程图技能。
...
- **标签：** `agent-harness`, `no-code`, `mcp`
- **推荐理由：** 全平台统一的智能体工作台，支持跨设备任务跟踪
...
- **⭐ 星标：** 6,033
- **语言：** Python
- **描述：** 收录最全、更新最快的技能Skills商店：416个精选原创技能包（涵盖文档处理、内容创作、编程开发、机器学习、自动化工���流），全部打包好可直接安装使用！同时自动抓取GitHub上万个Skills项目，按分类、更新时间、Star数量整理。
- **标签：** `skills`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 最大技能商店，416+精选技能包覆盖全场景
...
- **标签：** `loop-engineering`, `dsh-plugin`, `agent-harness`
- **推荐理由：** 长周期Agent控制平面，支持持久可控的多工具工作流
...
- **标签：** `agent-skills`, `multi-agent`, `dsh-plugin`
- **推荐理由：** 企业级多引擎Agent工作台，统一任务管理协作
...
- **标签：** `agent-skills`, `workflow`, `vibe-coding`
...
- **⭐ 星标：** 3,007
- **语言：** Python
- **描述：** J-Space Cognition Suite V3.7 - AI cognitive-enhancement Skills based on Anthropic's J-space global workspace research. | ���哩哔哩：Tiger380 (UID 3494375382321675) — https://space.bilibili.com/3494375382321675
...
- **标签：** `ai-video`, `ffmpeg`, `text-to-video`, `agent-skill`
- **推荐理由：** 一键自动生成Vox风格科普视频，端到端自动化
...
- **标签：** `task-management`, `sqlite`, `taskboard`, `native-ui`
- **推荐理由：** 本地SQLite任务看板，支持Agent认领审核，纯原生WebUI
...
- **推荐理由：** 全栈式数学建模竞赛自动化Skill，支持GitOps流水线。
...
- **标签：** `skills`, `agent-skills`, `multi-platform`
- **推荐理由：** 将经验转化为跨Agent的可复用执行技能。
...
- **推荐理由：** 为纯文本Claude Code添加多模态视觉，支持UI/图表分析
...
- **标签：** `ai-infra`, `skills`, `agent-skills`
...
- **标签：** `superpowers`, `skills`, `tdd`, `debugging`
- **推荐理由：** 适配DSH的TDD、调试、规划和协作专业技能包
...
- **标签：** `agent-skills`, `education`, `code-review`
- **推荐理由：** AI编程导师技能，自动生成阶梯教程并智能判题和Code Review。
...
- **推荐理由：** 自动将成功的DSH会话转化为可复用的Agent技能。
...
- **标签：** `agent-skills`, `plugin-dev`, `development`
- **推荐理由：** 引导你完成标准DSH插件开发的Agent技能。
...
- **标签：** `plugin-management`, `slots`, `credentials`
- **推荐理由：** 管理DSH插件槽位、凭证和远程配置
...
- **标签：** `skills`, `task-management`, `game-like`
- **推荐理由：** 游戏化一键领取派发技能的deck系统
...
- **标签：** `gongwen`, `document`, `chinese`
- **推荐理由：** 全流程中文公文写作与格式化工具
...
- **标签：** `skills-manager`, `safety`, `local`
- **推荐理由：** 统一安全加载管理本地Agent技能
...
- **标签：** `skill-picker`, `ui`
- **推荐理由：** 工作区快速选技能，支持 /skill-name 快捷指令。
...
- **标签：** `agent-skills`, `handoff`, `session-memory`
- **推荐理由：** 跨平台 Agent 交接技能，支持仓库本地记忆传承。
...
- **标签：** `agent-kit`, `skills`, `cli`
- **推荐理由：** 42 技能 +5 CLI 一站式包，覆盖评估驱动与规范驱动开发。
...
- **推荐理由：** Godot 4.x 全栈游戏开发技能，支持 GDScript 运行时注册。
...
- **标签：** `web-search`, `free`, `no-api-key`, `bridge`
- **推荐理由：** 最强免费网页搜索插件，无需注册和API密钥，通用对接
...
- **推荐理由：** 统一管理MCP工具和技能的暴露级别与执行模式的菜单。
...
- **推荐理由：** AI原生矢量设计工具，支持并发Agent团队协作设计
...
- **标签：** `webui`, `dsh-plugin-market`, `plugin`
- **推荐理由：** 自定义Web UI背景，支持上传和预设主题
...
- **标签：** `bilibili`, `douyin`, `cross-platform`
- **推荐理由：** 本地优先跨平台内容发现，覆盖8大中文平台。
...
- **标签：** `ios`, `simulator`, `webdriveragent`, `mobile-automation`
- **推荐理由：** 在对话内运行iOS模拟器并连接真机，提供22个自动化代理工具
...
- **推荐理由：** 基于Playwright的浏览器自动化插件，适配DeepSeek Harness。
...
- **标签：** `no-code`, `ai-agent`, `dsh-plugin`
...
- **标签：** `oauth`, `subscription`, `llm-provider`, `chatgpt`
- **推荐理由：** 通过OAuth将ChatGPT/Claude/Grok订阅转为DSH模型提供商
...
- **标签：** `context-migration`, `cordis`, `session-migration`
- **推荐理由：** 跨预设会话迁移，保留上下文状态和源模型意图
...
- **推荐理由：** 开源锤子便签复刻版，支持Docker私有化和DSH集成
...
- **推荐理由：** Web GUI内一键浏览安装更新GitHub DSH插件合集
...
- **标签：** `awesome-list`, `plugin-list`, `dsh-plugin`
- **推荐理由：** DSH插件精选列表，便于发现和探索社区插件
...
- **推荐理由：** DSH Web GUI社区插件市场，支持一键安装卸载
...
- **推荐理由：** 备份、恢复和同步完整的DSH配置、插件及MCP服务器。
...
- **标签：** `plugin-management`, `ui`, `development`
- **推荐理由：** 轻量级插件管理控制台，附官方插件开发引导技能。
...
- **标签：** `container`, `isolation`, `management`
- **推荐理由：** 隔离容器运行多版本DSH并嵌入WebView界面
...
- **标签：** `codex`, `sync`, `mcp`
- **推荐理由：** Codex 与 DSH 双向同步，支持技能与 MCP 实时镜像。
...
- **标签：** `skills`, `mcp`, `manager`
- **推荐理由：** 浏览器端管理技能与 MCP 服务器，操作便捷。
...
- **标签：** `evaluation`, `rag`, `observability`
- **推荐理由：** 证据驱动的评估框架，支持提示词、RAG 及 Agent 工作流评测。
...
- **标签：** `migration`, `configuration-migration`, `import`
...
- **标签：** `awesome-dsh`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 解决插件间及版本兼容冲突问题
...
- **标签：** `mascot`, `dsh-plugin`, `claude-code`
- **推荐理由：** 动画宠物吉祥物画廊，个性化你的Agent使用体验
...
- **标签：** `dsh-plugin`, `skin`, `theme`
- **推荐理由：** 鲸鱼娘系列皮肤，为DSH提供个性化视觉体验。
...
- **标签：** `theme`, `ocean-skin`, `webgpu`, `threejs`
- **推荐理由：** 基于WebGPU的海洋主题炫酷皮肤，视觉效果惊艳。
...
- **标签：** `ai`, `rag`, `mcp`, `vibe-coding`
- **推荐理由：** AI资源大全，含教程、提示词和知识百科，适合入门学习
...
- **标签：** `research`, `web-search`, `skill-cn`
...
- **标签：** `ecosystem-radar`, `plugin-registry`, `validation`
- **推荐理由：** 开源DSH插件生态雷达，自动发现并实测验证插件
...
- **推荐理由：** 精选DSH插件生态合集，社区 curated 列表资源
...
- **标签：** `awesome-list`, `bilingual`, `curated`, `references`
- **推荐理由：** 中英双语DSH插件精选列表，含验证参考来源
...
- **标签：** `knowledge-base`, `ai-resources`, `encyclopedia`, `mcp`
- **推荐理由：** 全面AI资源百科，涵盖大模型、Agent、RAG和MLOps项目
...
- **⭐ 星标：** 305
- **语言：** JavaScript
- **描述：** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插���分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **标签：** `awesome-list`, `plugin-directory`, `curation`
- **推荐理由：** 每日自动抓取GitHub插件，按真实场景分类精选推荐
...
- **标签：** `academic`, `mcp`, `arxiv`, `citation-graph`
- **推荐理由：** 跨平台学术检索，支持引文图谱和MeSH，适合中文科研
...
- **⭐ 星标：** 155
- **语言：** TypeScript
- **描述：** Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献��理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the whole research cycle.
- **标签：** `research`, `latex`, `arxiv`, `gpu-cluster`
- **推荐理由：** 一站式科研工作台：LaTeX编译、arXiv管理、GPU SSH编排
...
- **标签：** `awesome-list`, `curated-list`, `resources`
- **推荐理由：** 全面的DeepSeek Harness插件与资源列表
...
- **标签：** `awesome-list`, `verified`, `curated-list`
- **推荐理由：** 经认证的插件目录，含权限安装指南
...
- **标签：** `awesome-list`, `dsh-plugin-directory`, `plugin`
- **推荐理由：** 按场景推荐插件的产品说明书与导航
...
- **标签：** `ai-agents`, `awesome-list`, `mcp`
- **推荐理由：** AI精选190+插件列表每小时更新
...
- **标签：** `curated-list`, `coding-agents`, `mcp`
- **推荐理由：** 模型/工具/沙箱/代理循环插件精选
...
- **标签：** `industry`, `awesome-list`, `curated`
...
- **标签：** `armor-breaking`, `bypass`, `experimental`
- **推荐理由：** DeepSeek专用破甲插件，稳定化破甲功能
...
- **标签：** `deepseek-harness`, `plugin-marketplace`
- **推荐理由：** 学习DSH原理、浏览插件与最佳实践的一站式工具。
...
- **标签：** `plugin-store`, `marketplace`, `awesome-list`
- **推荐理由：** 11,000+插件市场，支持搜索和免费API访问。
...
- **推荐理由：** 对话内搜索番剧，展示Bangumi评分，支持磁力复制
...
- **⭐ 星标：** 31
- **语言：** TypeScript
- **描述：** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融合，本地��定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。
- **标签：** `chinese-wisdom`, `bazi`, `fengshui`
- **推荐理由：** 融合八字风水易经中医的AI智能技能

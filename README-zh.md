...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 203,634 | Core DSH platform; everything is a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,655 | Local-first desktop design tool with AI generation |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,746 | Original multi-agent swarm meta-harness with MCP |
...
- **标签：** `ai-agents`, `skills`, `mcp`, `multi-agent`
- **推荐理由：** 自进化超级助手，支持记忆、技能与多模型
...
- **标签：** `coding-agent`, `cli`, `tui`, `deepseek`, `llm`
- **推荐理由：** DeepSeek原生终端编程Agent，支持R1推理
...
- **标签：** `dsh`, `routing`, `injector`
- **推荐理由：** 任务感知推理路由套件，提升代理性能。
...
- **标签：** `preset`, `standard`, `harness`
- **推荐理由：** 两阶段预设，达成接近满分的标准工具评分。
...
- **标签：** `code-review`, `lint`, `code-quality`
...
- **推荐理由：** 来自Superpowers的TDD、调试、规划和协作技能集
...
- **标签：** `dsh-plugin`, `agent-skills`, `deepseek-harness`
- **推荐理由：** 开发DSH插件的Agent技能，含标准化模板
...
- **标签：** `plugin-creator`, `codex-skill`, `validation`
- **推荐理由：** 可复用Codex技能，构建并验证DSH/Cordis插件
...
- **标签：** `skills-manager`, `plugin-management`, `safety`
- **推荐理由：** DSH中统一加载和安全管理局部Agent Skills的管理器
...
- **标签：** `codex`, `sync`, `mcp`, `integration`
- **推荐理由：** Codex与DSH双向桥接，支持实时同步和MCP自动镜像
...
- **标签：** `package-manager`, `skills`, `agent-framework`
- **推荐理由：** 42项技能和5个CLI的AI代理工程包管理器
...
- **标签：** `migration`, `agent-skills`, `deepseek-harness`
- **推荐理由：** 一键迁移Claude Code配置到DSH
...
- **标签：** `awesome-list`, `comprehensive`, `resource`
- **推荐理由：** DSH生态最全资源导航，插件工具技能汇总
...
- **标签：** `plugins`, `collection`, `practical`
- **推荐理由：** 精选实用DSH插件集合，简单易用
...
- **标签：** `verified`, `star-ranked`, `community`
- **推荐理由：** Star-ranked verified community plugin list
...
- **标签：** `agent-tools`, `plugin-check`, `capability`
- **推荐理由：** Agent任务前预检插件库，提升效率
...
- **标签：** `guide`, `navigation`, `plugin-selection`
- **推荐理由：** 按场景推荐插件，附安装兼容风险说明
...
- **标签：** `catalog`, `comprehensive`, `listing`
- **推荐理由：** DSH全量工具清单，按星标排序
...
- **标签：** `ui-generator`, `desktop-app`, `design-systems`
- **推荐理由：** 本地优先AI设计工具，编码即设计
...
- **标签：** `dsh-web`, `ui`, `marketplace`
- **推荐理由：** Web UI插件聚合包，支持创意工坊分发��
...
- **标签：** `desktop`, `ui`, `local-first`
- **推荐理由：** 本地优先的桌面工作空间支持项目与文件管理
...
- **标签：** `desktop`, `ssh`, `windows`
- **推荐理由：** Windows桌面客户端，支持SSH与远程访问。
...
- **标签：** `ui-extension`, `info-bar`, `pricing`, `balance`
...
- **标签：** `ui-extension`, `skill-picker`, `composer`
- **推荐理由：** DSHComposer内WorkBuddy风格技能选择器，快速插入技能
...
- **标签：** `desktop`, `turi`, `docker`, `ssh`
- **推荐理由：** 跨平台桌面整合DB/SSH/Docker/AI工具
...
- **推荐理由：** Electron桌面壳集成DSH Web服务，一站式体验
...
- **标签：** `ui`, `button`, `web-extension`
- **推荐理由：** 一键折叠按钮，优化DSH Web上下文面板体验
...
- **标签：** `rag`, `knowledge-base`, `vector-search`, `llm`
- **推荐理由：** 腾讯开源LLM知识库平台，支持RAG与自维护Wiki
...
- **标签：** `rag`, `embeddings`, `skill-management`
- **推荐理由：** 将SKILL.md文件转为可检索评估的Agent知识库。
...
- **标签：** `knowledge-base`, `ai-resources`, `mcp`
- **推荐理由：** 涵盖Agent、RAG、MCP的全维度AI资源百科。
...
- **标签：** `patent-analysis`, `rag`, `dsh-plugin`
- **推荐理由：** 基于RAG的专利侵权分析系统，自动生成竞品报告
...
- **推荐理由：** 跨平台会话记忆技能，确保Agent交接时上下文连续
...
- **标签：** `context`, `audit`, `optimization`
- **推荐理由：** 审计上下文Token成本并检测指令冲突
...
- **标签：** `architecture-as-code`, `agent-skills`, `mermaid-alternative`
- **推荐理由：** 面向编码Agent的架构可视化与图表生成技能
...
- **标签：** `agent-skills`, `workspaces`, `orchestration`
- **推荐理由：** 统一多设备代理工作区，支持任务看板。
...
- **标签：** `agent-os`, `mcp`, `llm-orchestration`
- **推荐理由：** 内置循环工程和LLM评估的自我进化代理OS。
...
- **标签：** `workflow`, `productivity`, `ai-assistant`
...
- **标签：** `creative-writing`, `drama-skills`, `fiction-writing`
- **推荐理由：** 专为小说写作和短剧制作设计的技能插件。
...
- **标签：** `self-evolving`, `agent-review`, `prompt-engineering`
- **推荐理由：** 实现可组合任务控制和人工审查的自我进化。
...
- **标签：** `agent-skills`, `research-automation`, `deepseek`
- **推荐理由：** 88个跨平台研究与商业自动化技能
...
- **标签：** `agent-skill`, `plugin-management`, `credentials`
- **推荐理由：** 通过技能管理DSH插件、插槽和凭证，自动化配置
...
- **标签：** `agent-skill`, `spec-driven`, `vibe-coding`
- **推荐理由：** 基于DSH模式的规范驱动开发技能，支持vibe coding
...
- **标签：** `plugin-development`, `knowledge-base`, `agent-skill`
- **推荐理由：** 插件开发知识库作为按需技能，含官方文档和Cordis指南
...
- **⭐ 星标：** 31
- **语言：** JavaScript
- **描述：** 拨开战争迷雾看见终点，剩下的交给 MattSkillsDeck。让 mattpocock/skills 在 DSH 里化作一块看得见、派得动的任务板。 Part the fog of war, see the end — MattSkillsDeck handles the rest. A playable task board for mattpocock/skills in DeepSeek Harness.
- **标签：** `agent-skill`, `task-board`, `skills-deck`
- **推荐理由：** DSH内可视化任务看板，拨开迷雾精准规划任务
...
- **标签：** `chinese-wisdom`, `bazi`, `fengshui`, `agent-skill`
- **推荐理由：** 融合八字、风水、六爻等中华传统智慧的本地确定性技能
...
- **推荐理由：** 多Agent团队协作，独立模型/技能/MCP，共享工作空间
...
- **标签：** `gongwen`, `docx`, `wps`, `chinese-docs`
...
- **标签：** `image`, `vision`, `media`, `skills`
- **推荐理由：** 图片识别与生成技能，支持自动视觉转写
...
- **标签：** `game-dev`, `godot`, `agent-skills`
- **推荐理由：** Godot 4游戏开发全栈技能
...
- **标签：** `mcp`, `config-sync`, `multi-tool`, `local-first`
- **推荐理由：** 一键同步MCP/Skills配置，支持Claude/Codex/DSH等7+工具
...
- **标签：** `chatgpt`, `oauth`, `subscription`, `mcp`
...
- **标签：** `ai-image-generation`, `skills`, `prompt-engineering`
- **推荐理由：** 530+工业级提示词模板与Skill库
...
- **标签：** `design`, `vibedesign`, `agent-team`
...
- **标签：** `image-generation`, `multi-model`, `seedream`
- **推荐理由：** 在DSH聊天中直接生成图像。
...
- **标签：** `legal-tech`, `visualization`, `dsh-plugin`
- **推荐理由：** 诉讼可视化工具，生成时间轴和法律 diagrams
...
- **标签：** `ai-video`, `ai-image`, `deepseek-harness`
- **推荐理由：** AI视频图像音频创作，支持分镜与生成
...
- **推荐理由：** Tabbit浏览器自动化插件，支持Playwright驱动
...
- **标签：** `community`, `photo`, `social`, `oauth`
...
- **标签：** `dingtalk`, `chat-bot`, `im-integration`
- **推荐理由：** 钉钉IM频道，流式Bot支持工具调用
...
- **标签：** `mcp-server`, `self-hosted`, `agent-skills`
- **推荐理由：** 隐私优先的简历生成器，含MCP服务
...
- **标签：** `electron-app`, `image-uploader`, `dsh-plugin`
...
- **标签：** `low-code`, `no-code`, `internal-tools`, `workflows`
...
- **标签：** `widget`, `utility`, `ui`
- **推荐理由：** 可爱浮动小鲸鱼组件实时监控DeepSeek账户余额
...
- **标签：** `context`, `utility`, `dashboard`
- **推荐理由：** 全面的上下文洞察仪表盘和管理工具
...
- **推荐理由：** OAuth桥接ChatGPT/Claude/Grok订阅为LLM后端。
...
- **推荐理由：** 拥有11,000+插件的插件市场，支持搜索和API。
...
- **标签：** `plugin-marketplace`, `harness-ai`, `deepseek-harness`
- **推荐理由：** DSH生态系统的插件市场和枢纽AI集成。
...
- **推荐理由：** 锤子便签复刻，支持Docker部署、公众号导出和多租户
...
- **推荐理由：** 崩溃恢复插件，安全快照回滚，支持SAFE MODE

---

### [liguobao/deepseek-harness-remote](https://github.com/liguobao/deepseek-harness-remote)
...
- **推荐理由：** 端到端加密P2P远程访问，多设备随时随地操作Harness
...
- **标签：** `config-manager`, `dsh-plugin`, `backup`
...
- **标签：** `container`, `multi-version`, `utilities`
- **推荐理由：** 本地容器化运行多版本DSH，隔离环境一键导入插件
...
- **标签：** `data-visualization`, `token-usage`, `utility`
- **推荐理由：** 实时Token用量与成本追踪图表
...
- **标签：** `deepseek-harness`, `dsh-bundle`, `dsh-plugin-verify`
- **推荐理由：** 含插件验证和分析工具，适合基础设施扩展
...
- **推荐理由：** GitHub Actions自动爬取，每日更新的插件目录
...
- **⭐ 星标：** 390
- **语言：** JavaScript
- **描述：** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调��糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **标签：** `theme`, `ui`, `glass-effect`
- **推荐理由：** 磨砂玻璃主题，支持全面视觉自定义。
...
- **标签：** `themes`, `skins`, `color-scheme`, `customization`
...
- **标签：** `theme`, `customization`, `background`
- **推荐理由：** 自定义Web背景，支持预设主题与实时预览
...
- **标签：** `awesome-list`, `mcp`, `coding-agent`
- **推荐理由：** 精心策划的DSH插件、技能和MCP服务器列表。
...
- **标签：** `academic-search`, `arxiv`, `mcp`
- **推荐理由：** 跨库论文检索，支持引文图谱、去重和引用核验
...
- **标签：** `dsh-plugin`, `api-documentation`, `deepseek-harness`
...
- **标签：** `kline`, `trading`, `technical-analysis`
...
- **标签：** `evaluation`, `benchmark`, `rag`, `observability`
- **推荐理由：** 提示词、RAG和智能体工作流的评估基准框架
...
- **标签：** `stock`, `finance`, `quant`, `curated`
- **推荐理由：** D SH金融量化插件精选列表，双语支持
...
- **标签：** `recommender`, `ai-curated`, `plugin-list`
...
- **标签：** `ai`, `rag`, `skills`, `mcp`
- **推荐理由：** 全面的AI资源库和Vibe Coding零基础教程。
...
- **标签：** `ecosystem`, `radar`, `plugin-registry`
- **推荐理由：** 发现并验证15900+插件的生态雷达工具
...
- **⭐ 星标：** 298
- **语言：** JavaScript
- **描述：** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐���复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **标签：** `awesome-list`, `plugin-discovery`, `curated`
- **推荐理由：** 每日更新插件目录，智能过滤与热度排行。
...
- **标签：** `marketplace`, `plugin-market`
- **推荐理由：** Web GUI中一键浏览、安装和更新所有DSH插件
...
- **推荐理由：** DSH Web GUI内置社区插件市场，一键安装卸载
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `awesome-list`
- **推荐理由：** cordis.run官方自动维护的插件目录清单
...
- **标签：** `dsh-ecosystem`, `plugin-marketplace`, `awesome-list`
...
- **推荐理由：** 精选280+社区插件目录，覆盖MCP/Skill/UI等14类
...
- **标签：** `awesome-list`, `bilingual`, `plugin-directory`
- **推荐理由：** 双语精选插件目录，证据驱动的插件推荐
...
- **推荐理由：** 插件雷达与2Origin实验室，证据支撑的插件目录
...
- **标签：** `awesome-list`, `auto-updating`, `vercel`
- **推荐理由：** 自动更新双语列表，Vercel静态站点部署
...
- **标签：** `awesome-list`, `curated`, `typescript`
...
- **标签：** `awesome-list`, `curated`, `evidence-aware`
- **推荐理由：** 精选有证据支撑的插件短名单
...
- **标签：** `industry`, `curated`, `sector-specific`
- **推荐理由：** 精选金融、法律、医疗、电商等行业专用插件

...
- **推荐理由：** 统一多设备Agent工作空间，支持任务看板与API。
...
- **标签：** `agent-os`, `mcp`, `skills`, `coding-agent`
...
- **推荐理由：** AI安全攻防平台，审计AI生成代码中的幻觉包与漏洞风险。
...
- **标签：** `coding-agent`, `mcp`, `deepseek-harness`, `go`
- **推荐理由：** 支持子代理、hashline编辑和MCP的全功能编码智能体
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `quality-gate`
- **推荐理由：** 代码交付质量门禁，需求验证与工程纪律保障插件。
...
- **标签：** `floating-widget`, `deepseek`
- **推荐理由：** 可爱的浮动小鲸鱼，实时追踪余额，支持拖拽吸附与动画。
...
- **推荐理由：** 本地优先桌面工作区，支持会话、项目与 Office。
...
- **标签：** `genui`, `ui`, `interactive`
- **推荐理由：** 在对话内直接渲染图表、表单、测验等交互式UI组件。
...
- **推荐理由：** 开源Electron桌面客户端，支持插件、技能、SSH及手机远程访问。
...
- **推荐理由：** 本地优先的多模型AI Agent桌面应用，支持自演化技能与隐私保护。
...
- **推荐理由：** 基于画布的非线性对话工作区，支持会话探索与分支管理。
...
- **推荐理由：** 跨平台桌面客户端，CodePilot风格增强DSH体验
...
- **推荐理由：** 原生iOS客户端，通过WebSocket同步工作区与会话
...
- **推荐理由：** Electron桌面控制台，统一管理DSH插件、MCP和Skills。
...
- **标签：** `ui`, `usage-tracking`
- **推荐理由：** 状态栏实时显示余额、价格和模型信息
...
- **标签：** `deepseek-harness`, `desktop`, `devops`, `dsh-plugin`
- **推荐理由：** 集成SSH、Docker、数据库、SFTP与AI助手的DevOps桌面中心。
...
- **推荐理由：** 免费小米MiMo TTS，支持预设/自定义/浏览器语音
...
- **标签：** `ui`, `knowledge-cards`, `shareable`
- **推荐理由：** 聊天历史转知识卡片，便捷分享
...
- **标签：** `vision-tools`, `computer-vision`
- **推荐理由：** 为纯文本模型提供图像问答、OCR 与截图还原能力。
...
- **标签：** `multimodal`, `ocr`, `video-understanding`
- **推荐理由：** 赋予Agent视听能力，支持视频音频理解、OCR与语音转文字。
...
- **推荐理由：** SQLite驱动的原生任务看板，支持Agent认领审核流程，无iframe。
...
- **推荐理由：** 专注小说与短剧创作的AI写作插件，支持剧本结构化生产。
...
- **⭐ 星标：** 44
- **语言：** Python
- **描述：** 中文公��全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `gongwen`, `docx`, `chinese-docs`
- **推荐理由：** 中文公文全流程处理，格式检查、优化和模板生成。
...
- **标签：** `chinese-traditional-wisdom`, `ai-agent`
- **推荐理由：** 八字风水周易等中华智慧AI技能包
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `skillhub`
- **推荐理由：** SkillHub官方API文档与示例集成的DSH技能插件。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `godot`
...
- **标签：** `deepseek-harness`, `agent-skills`, `remotion`
...
- **标签：** `agent-tools`, `workflow`, `plugin-check`
- **推荐理由：** Agent任务前自动预检插件库
...
- **推荐理由：** 在浏览器Web GUI中直接管理技能与MCP服务器。
...
- **标签：** `agents`, `ai-image-generation`, `dsh-plugin`
- **推荐理由：** 工业级图像生成提示词引擎
...
- **标签：** `legal`, `visualization`, `svg`
- **推荐理由：** 诉讼可视化绘图工具，生成SVG时间轴和图表。
...
- **标签：** `ai-video`, `image-generation`
- **推荐理由：** AI视频/图像/音频生成技能插件
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `design-skills`
- **推荐理由：** 6种设计风格预设，避免AI生成网站的同质化外观。
...
- **⭐ 星标：** 3,226
- **语言：** Python
- **描述：** 本地私有、开源的��进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **标签：** `content-discovery`, `bilibili`, `youtube`
- **推荐理由：** 跨平台内容发现，支持B站/抖音/YouTube等
...
- **推荐理由：** 免费免注册的Web搜索插件，为无原生联网能力的模型提供搜索桥接。
...
- **标签：** `ios`, `automation`, `mcp`, `deepseek-harness`
- **推荐理由：** 对话中直接操控iOS模拟器及真机，22个自动化工具
...
- **标签：** `model-switch`, `multi-tool`, `cli`
- **推荐理由：** 一键切换Claude/Codex/DSH等8+模型工具
...
- **推荐理由：** 通过OAuth将订阅账号转为DSH模型提供商，无需API密钥。
...
- **标签：** `cost-tracking`, `deepseek-api`, `deepseek-harness`
- **推荐理由：** 实时追踪会话成本、预算限制和Token使用历史
...
- **推荐理由：** 安全P2P远程访问PC、Android和Web端Harness。
...
- **标签：** `dev-skills`, `plugin-dev`, `infrastructure`
- **推荐理由：** DSH插件开发标准指南，覆盖服务/事件/工具/适配器。
...
- **标签：** `plugin-build`, `credential`, `slots`
- **推荐理由：** 管理已安装DSH插件槽位、凭据和远程配置。
...
- **标签：** `skills-manager`, `plugin-management`, `utils`
- **推荐理由：** DSH内统一管理加载本地Agent Skills的工具。
...
- **标签：** `awesome-dsh-plugin`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 检测和解决插件冲突及版本不兼容问题
...
- **标签：** `mascot`, `pixel-art`, `dsh-plugin`, `cli`
- **推荐理由：** 多Agent动画宠物画廊与吉祥物集。
...
- **推荐理由：** 高自由度磨砂玻璃主题，顶栏侧边栏输入框全可调，无需改源码。
...
- **标签：** `theme`, `webgpu`, `ocean-skin`
- **推荐理由：** 基于WebGPU的海洋主题UI皮肤，视觉效果惊艳。
...
- **标签：** `webui`, `background`, `dsh-plugin`
- **推荐理由：** 自定义网页背景，支持多种预设与实时预览
...
- **推荐理由：** 全维度AI资源百科，覆盖大模型、Agent、RAG、MLOps及学习路线。
...
- **推荐理由：** 一站式科研工作台：LaTeX编译���arXiv管理、GPU编排
...
- **标签：** `academic-search`, `mcp`, `research`, `arxiv`
- **推荐理由：** 跨多个学术数据库的论文搜索Skill与MCP工具
...
- **推荐理由：** 专利侵权分析系统，支持RAG与多模态，适合知识产权研究。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `llm-evaluation`
- **推荐理由：** 证据驱动的提示词、RAG与智能体评估观测框架。
...
- **推荐理由：** 实时追踪Token用量与API成本，可视化图表直观清晰
...
- **推荐理由：** 中英文双语DSH插件精选列表，涵盖扩展、技能和验证参考。
...
- **标签：** `marketplace`, `plugin-shop`, `directory`
- **推荐理由：** 每日更新的DSH插件市场，全网收录并审核插件。
...
- **标签：** `awesome-list`, `coding-agent`, `mcp`, `deepseek-harness`
- **推荐理由：** 精选DSH插件、技能、MCP服务器、补丁和UI合集
...
- **标签：** `marketplace`, `plugin-directory`, `deepseek-harness`
- **推荐理由：** 插件商店收录11000+条目，支持搜索、排行和公开API
...
- **标签：** `awesome`, `directory`, `curated`
- **推荐理由：** 精选DeepSeek Harness优质插件列表。
...
- **推荐理由：** cordis.run官方精选插件目录，定期自动维护
...
- **标签：** `deepseek-harness`, `plugin-registry`, `dsh-plugins`
- **推荐理由：** 经垃圾过滤的开放数据DSH插件注册中心。
...
- **推荐理由：** 社区精选的实用DeepSeek Harness插件集合
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 社区验证星级排行的DeepSeek Harness插件列表
...
- **标签：** `dsh-plugin`, `marketplace`, `bundle`
- **推荐理由：** 类CodeX插件市场，丰富DSH生态
...
- **标签：** `awesome-list`, `radar`, `plugin-registry`
- **推荐理由：** 插件雷达图配合2Origin实验室
...
- **标签：** `awesome-list`, `moved`, `archive`
- **推荐理由：** 原awesome列表已迁移至新仓库

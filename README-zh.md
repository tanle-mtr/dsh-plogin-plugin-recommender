...
- **标签：** `ai-agents`, `multi-agent`, `mcp`, `dsh-plugin`
- **推荐理由：** 多模型AI助手，具备自演进记忆与知识能力
...
- **标签：** `ecosystem`, `plugin`, `tooling`
- **推荐理由：** 开源生态雷达，自动发现并实测上万插件
...
- **标签：** `code-review`, `linting`, `quality`
- **推荐理由：** 基于12本经典软件工程著作的AI代码审查工具
...
- **标签：** `armor-breaking`, `enhancement`, `plugin`
- **推荐理由：** DeepSeek专用破甲插件，增强模型能力
...
- **标签：** `ios`, `mobile-automation`, `coding-agent`, `mcp`
- **推荐理由：** 22 个工具实现 iOS 模拟器与真机自动化，嵌入对话操作。
...
- **推荐理由：** 编码 Agent，支持 RPC 插件、子 Agent 和 MCP。
...
- **标签：** `agent-skill`, `plugin-management`
- **推荐理由：** 安装和管理DSH插件插槽和凭证的关键技能。
...
- **标签：** `plugin-creator`, `codex`, `dsh-plugin`
- **推荐理由：** 构建和验证DSH插件的可复用Codex技能。
...
- **标签：** `agent-skills`, `ai-design`, `desktop-app`, `dsh-plugin`
- **推荐理由：** 本地优先开源设计工具，AI驱动原型生成
...
- **标签：** `desktop`, `dsh-plugin`, `deepseek-harness`, `dsh`
...
- **推荐理由：** 本地优先的Electron桌面工作空间集成DSH会话
...
- **标签：** `ui`, `interactive`, `components`, `genui`
- **推荐理由：** 内联渲染交互UI组件，支持图表表单测验等
...
- **标签：** `desktop-app`, `tauri`, `multi-model`, `privacy`
- **推荐理由：** 本地优先多模型桌面客户端，自进化技能系统
...
- **推荐理由：** 开源Electron桌面客户端，内置SSH与远程访问
...
- **标签：** `ui`, `canvas`, `conversation`, `workspace`
- **推荐理由：** 画布式非线性对话工作空间，支持分支探索
...
- **标签：** `desktop-app`, `electron`, `ui-extension`
- **推荐理由：** 跨平台桌面客户端，类似 CodePilot，支持三大系统。
...
- **标签：** `office`, `ui-extension`, `collaboration`
- **推荐理由：** 将表格、文档、幻灯片集成到 DSH 工作空间。
...
- **推荐理由：** 为纯文本LLM赋能多模态视觉能力，支持截图/UI/图表分析
...
- **推荐理由：** DSH Web界面Skill/MCP管理面板，可视化配置管理工具
...
- **推荐理由：** DSH Web GUI插件市场，一键浏览安装社区插件。
...
- **标签：** `dsh-plugin`, `mcp`, `capability-menu`
...
- **推荐理由：** Electron桌面Hub，多标签管理Harness、插件、MCP和技能。
...
- **标签：** `bioinformatics`, `desktop-app`, `llm-agent`
- **推荐理由：** 面向临床医生的生物信息学桌面Agent，支持离线模式。
...
- **推荐理由：** 一体化DevOps桌面：数据库、SSH、SFTP、Docker和AI助手。
...
- **推荐理由：** Electron桌面壳，集成sidebar和ModLens
...
- **标签：** `agent-skills`, `vector-search`, `embeddings`, `reranking`
- **推荐理由：** 将SKILL.md转为可检索的向量知识库，支持语义搜索
...
- **标签：** `knowledge-base`, `mcp`, `rag`, `learning-roadmap`
- **推荐理由：** AI知识百科，整合MCP/RAG技能与学习路线
...
- **标签：** `agentic-workflow`, `multi-agent`, `swarm`, `dsh-plugin`
- **推荐理由：** 部署多智能体集群与自主协调工作流
...
- **标签：** `agent-orchestration`, `mcp`, `workflows`
- **推荐理由：** 跨设备统一Agent工作空间
...
- **标签：** `skills`, `agent-skills`, `workflow`
- **推荐理由：** 最全技能商店，涵盖多领域
...
- **标签：** `agent-control-plane`, `workflow`, `loop-engineering`
- **推荐理由：** 长周期Agent控制面，跨引擎工作流
...
- **标签：** `agent-collaboration`, `workspace`, `skills`
- **推荐理由：** 企业级本地优先多引擎Agent工作台
...
- **⭐ 星标：** 1,740
- **语言：** Python
- **描述：** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天��内容，综合分析后生成有据可查的研究报告。
- **标签：** `research`, `web-search`, `agent-skills`
- **推荐理由：** 自动搜索中国主流平台30天热点并生成研究报告
...
- **标签：** `task-management`, `sqlite`, `workflow`, `native`
...
- **标签：** `creative-writing`, `novel`, `screenwriting`, `fiction`
- **推荐理由：** 专注小说创作与短剧剧本生产的技能插件
...
- **标签：** `agent-skill`, `workflow`, `math-modeling`
- **推荐理由：** 全栈数学建模竞赛技能，支持 GitOps 流水线与代码自证。
...
- **标签：** `agent-skill`, `self-evolution`, `prompt-engineering`
- **推荐理由：** 可组合任务控制与人工审查的 Agent 自我进化能力。
...
- **推荐理由：** 自动搜索、安装并验证DSH插件的Skill，提升插件发现效率
...
- **推荐理由：** 将经验转化为可复用Skill，支持多AI编码工具，提升工作效率
...
- **推荐理由：** AI基础设施开发专用Skill，支持代码编写、优化和调试
...
- **标签：** `skills`, `superpowers`, `tdd`, `collaboration`
- **推荐理由：** 将TDD/调试/规划等Superpowers技能适配到DSH平台使用
...
- **推荐理由：** 87个逆向工程Skill，覆盖CTF、渗透测试与安全研究
...
- **推荐理由：** 88个开源Agent技能，覆盖研究、营销与业务工作流。
...
- **推荐理由：** Superpowers技能移植至Reasonix，增强编码能力。
...
- **⭐ 星标：** 69
- **语言：** TypeScript
- **描述：** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带��手写核心逻辑、自动判题、AI Code Review。
- **标签：** `dsh-plugin`, `agent-skills`, `mentor`
- **推荐理由：** AI编程导师技能：扫描架构、生成章节并做代码审查。
...
- **推荐理由：** 自动将成功的DSH会话转换为可复用的Agent技能。
...
- **标签：** `agent`, `skills`, `wayfinder`
- **推荐理由：** 将Matt Pocock的技能套件带入DSH控制面板。
...
- **标签：** `skill`, `simplification`
- **推荐理由：** 从Codex适配的代码简化技能，生成更简洁代码
...
- **标签：** `skill`, `ui`, `composer`
- **推荐理由：** DSH内置WorkBuddy风格技能选择器
...
- **标签：** `skill`, `session`, `memory`
- **推荐理由：** 跨会话保持Agent工作连续性
...
- **标签：** `ai-director`, `ai-video`, `storyboard`
- **推荐理由：** AI视频/图像/音频导演技能，支持剧本和知识库。
...
- **推荐理由：** 官方SkillHub API文档和DSH插件开发示例。
...
- **推荐理由：** Swift Cycle项目治理技能，支持版本锁定和离线验证。
...
- **标签：** `dsh-plugin`, `skill`, `development`
...
- **标签：** `video`, `generative-ai`, `design`
- **推荐理由：** 一句话自动生成Vox风格纸拼贴解说视频
...
- **标签：** `image-generation`, `gemini`, `openai`, `seedream`
- **推荐理由：** 聊天内直接生成图片，支持多模型API
...
- **推荐理由：** 在对话中预览和编辑OpenPencil设计文档，支持UI/PPT设计
...
- **⭐ 星标：** 52
- **语言：** Python
- **描述：** 把法律画出来 · Make the Law Visible —— 给法律���的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。
- **标签：** `legal-tech`, `visualization`, `timeline`
- **推荐理由：** 诉讼可视化工具：将案件时间轴重绘为法庭级图表。
...
- **推荐理由：** 面向Gemini、Claude和ChatGPT的跨浏览器增强套件
...
- **⭐ 星标：** 346
- **语言：** TypeScript
- **描述：** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索���件，免费免注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **标签：** `web-search`, `browser`, `free`, `no-signup`
- **推荐理由：** 免费无需API的Web搜索桥接插件
...
- **推荐理由：** Tabbit浏览器自动化插件，支持Playwright驱动的DSH浏览。
...
- **标签：** `resume-builder`, `self-hosted`, `mcp-server`, `dsh-plugin`
- **推荐理由：** 隐私优先的自托管简历构建器，零数据收集
...
- **标签：** `low-code`, `ai-agent`, `internal-tools`, `dsh-plugin`
...
- **标签：** `security`, `cybersecurity`, `vulnerabilities`, `redteam`
- **推荐理由：** AI安全攻防平台，检测幻觉包与漏洞
...
- **标签：** `oauth`, `subscriptions`, `chatgpt`, `claude`, `grok`
- **推荐理由：** OAuth登录复用订阅账号作为LLM提供商
...
- **推荐理由：** 追踪会话/每日成本、预算和 token 用量，支持多提供商。
...
- **推荐理由：** 打通 Pi 与 DSH 生态，无需修改即可运行 Pi 扩展。
...
- **推荐理由：** 跨会话迁移插件，保留状态与上下文，支持预览迁移效果
...
- **推荐理由：** 端到端加密P2P远程访问方案，支持多设备随时操作Harness
...
- **推荐理由：** 开源锤子便签，支持Docker私有化、Skill调用和多租户部署
...
- **标签：** `upgrade`, `plugin-management`
- **推荐理由：** 自动升级插件以匹配新版本DSH。
...
- **标签：** `dsh-plugin`, `container`, `management`
- **推荐理由：** 在隔离容器中运行多个DSH版本并嵌入UI。
...
- **标签：** `skills-manager`, `plugin-management`, `dsh-plugins`
...
- **推荐理由：** 一键配置多款AI Agent的MCP和Skills
...
- **⭐ 星标：** 4
- **语言：** JavaScript
- **描述：** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并注�� Top-K 适用插件提示，让插件库利用率可预期、不靠运气。Pre-flight plugin-library check for DSH agents — task-type requests trigger a Top-K hint of suitable plugins injected into the runtime context, making plugin usage predictable instead of opportunistic.
- **标签：** `agent-tools`, `utility`
- **推荐理由：** Agent任务预检插件清单，提升利用率
...
- **标签：** `mascot`, `themes`, `cli`
- **推荐理由：** CLI代理界面个性化宠物动效库
...
- **标签：** `theme`, `ui`, `glass-effect`, `customizable`
- **推荐理由：** 高自由度磨砂玻璃主题，纯CSS无源码修改
...
- **推荐理由：** WebGPU 海洋主题视觉皮肤，Chrome/Edge 扩展安装。
...
- **标签：** `ai`, `llm`, `rag`, `tutorial`
- **推荐理由：** AI资源大全，教程和提示词指南
...
- **标签：** `tutorial`, `dsh-plugin`, `harness`
- **推荐理由：** DSH入门教程，从零开始学Harness工程
...
- **标签：** `research`, `academic`, `mcp`, `citation`
- **推荐理由：** 跨库学术搜索技能与 MCP，支持引文图谱和引用核验。
...
- **推荐理由：** 一站式科研工作台，支持LaTeX/arXiv/GPU集群，科研全周期管理
...
- **标签：** `chinese-api`, `api-documentation`, `deepseek-harness`
- **推荐理由：** 在Agent中直接搜索20个中国开放平台的6.5万篇API文档。
...
- **标签：** `industry-research`, `research`, `cordis`
- **推荐理由：** 行业研究全流程工具，支持产业链映射与政策追踪。
...
- **标签：** `kline`, `analysis`, `finance`
- **推荐理由：** 交互式K线分析，支持技术指标和新闻面
...
- **标签：** `evaluation-framework`, `rag-evaluation`, `skill-evaluation`
...
- **标签：** `awesome-list`, `index`
- **推荐理由：** 1000+仓库按星排序的全量生态索引
...
- **标签：** `awesome-list`, `curated`, `plugin-discovery`
- **推荐理由：** 每日自动抓取精选插件目录，场景化分类筛选
...
- **推荐理由：** DSH 插件、技能、MCP 服务器精选列表与资源目录。
...
- **标签：** `marketplace`, `catalog`, `plugin-hub`
- **推荐理由：** 11,000+ DSH 插件商店，支持搜索、排行和免费 API。
...
- **推荐理由：** 全面插件目录：1958 仓库、1819 真实插件，支持中英文搜索。
...
- **推荐理由：** 对话内多源搜番，卡片展示Bangumi评分，支持磁力链接
...
- **推荐理由：** cordis.run官方自动生成的DSH插件精选列表，持续更新
...
- **推荐理由：** 社区维护的DSH插件聚合目录，每4小时自动同步精选。
...
- **标签：** `chinese-traditional-wisdom`, `fengshui`, `iching`
- **推荐理由：** 融合八字、风水、易学的本地确定性引擎。
...
- **标签：** `awesome-list`, `curated`, `plugin`
- **推荐理由：** 精选DeepSeek Harness插件列表和资源。
...
- **标签：** `awesome-list`, `dsh-plugin-verify`
- **推荐理由：** 精选DSH插件目录
...
- **标签：** `awesome-list`
- **推荐理由：** 原版awesome-dsh-plugins（已迁移）
...
- **标签：** `coding-agents`, `curated-list`, `ui`
- **推荐理由：** 覆盖模型、工具、UI和代理的精选插件

...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 210,972 | Core DSH ecosystem hub, foundational agent harness |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 93,879 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 70,349 | Meta-harness for deploying multi-agent swarms and  |
...
- [Agent 技能与工作流](#agent-技能与工作流) — 26 个插件
- [视觉与设计](#视觉与设计) — 7 个插件
- [浏览器与 Web 自动化](#浏览器与-web-自动化) — 4 个插件
- [通信与社交](#通信与社交) — 1 个插件
- [实用工具与基础设施](#实用工具与基础设施) — 14 个插件
- [主题与皮肤](#主题与皮肤) — 3 个插件
- [研究与分析](#研究与分析) — 15 个插件
- [其他](#其他) — 81 个插件
...
- **标签：** `multi-agent`, `mcp-server`, `dsh-plugin`
- **推荐理由：** 多智能体集群元框架，支持自主工作流编排。
...
- **标签：** `ai-agent`, `multi-agent`, `dsh-plugin`
- **推荐理由：** 超级AI助手，任务规划与自进化记忆。
...
- **标签：** `routing`, `harness-tool`, `mcp`
- **推荐理由：** 任务感知推理路由器，实测提升P1性能。
...
- **标签：** `code-review`, `static-analysis`, `agent-skills`
...
- **标签：** `dsh-plugin`, `cybersecurity`, `vulnerabilities`, `redteam`
- **推荐理由：** AI代码安全审计工具，检测幻觉包和漏洞。
...
- **推荐理由：** 支持RPC、子代理、哈希线编辑和MCP的完整编码代理。
...
- **推荐理由：** 为纯文本LLM赋予多模态视觉能力，支持截图/UI分析
...
- **推荐理由：** AI基础设施开发专用技能，支持编写、优化和调试高性能系统
...
- **推荐理由：** 87个SKILL.md，覆盖逆向工程、渗透测试和安全研究技能
...
- **标签：** `skills`, `deepseek`, `reasonix`
- **推荐理由：** 将Superpowers技能移植到Reasonix编码工具链，增强AI编程能力。
...
- **标签：** `dsh`, `dsh-plugin`, `dsh-plugins`, `skill`, `skills`
- **推荐理由：** 指导AI智能体从零开发、测试和安装DSH插件。
...
- **标签：** `troubleshooting`, `conflict-resolution`
- **推荐理由：** 检测和解决DSH插件版本冲突
...
- **标签：** `agent-tools`, `plugin-discovery`
- **推荐理由：** 预检插件库并自动注入Top-K相关插件
...
- **标签：** `desktop`, `dsh-plugin`, `dsh-plugin-desktop`
- **推荐理由：** 专为DSH插件生态打造的现代化桌面客户端。
...
- **标签：** `dsh-web`, `plugin-hub`, `ui`
- **推荐理由：** 基于Web的DSH插件聚合生态，创意工坊分发。
...
- **标签：** `mascot`, `cli`, `community`
- **推荐理由：** 各Agent平台的动效宠物吉祥物画廊。
...
- **标签：** `widget`, `desktop`, `utility`
- **推荐理由：** 可爱鲸鱼悬浮组件，实时显示DeepSeek账户余额
...
- **推荐理由：** 本地优先的Electron桌面工作台，支持项目和插件
...
- **标签：** `dsh-plugin`, `ui-components`, `charts`
- **推荐理由：** 内联渲染图表、表单等交互UI组件，丰富对话体验。
...
- **标签：** `dsh-plugin`, `desktop-app`, `tauri`, `mcp`
- **推荐理由：** 本地优先多模型桌面客户端，支持自进化技能和MCP。
...
- **标签：** `dsh-plugin`, `electron-app`, `desktop`, `ssh-client`
- **推荐理由：** 功能完整的Windows桌面客户端，支持SSH和远程访问。
...
- **推荐理由：** 内置iOS模拟器与真机控制，22个工具覆盖构建和驱���流程。
...
- **标签：** `electron`, `desktop-app`, `codepilot`
- **推荐理由：** 类CodePilot桌面客户端，跨平台支持，插件套件丰富。
...
- **标签：** `office`, `productivity`, `univer`
- **推荐理由：** 将表格、文档、演示文稿等办公功能引入DSH生态。
...
- **标签：** `mcp`, `dsh-plugin`, `skills`, `ui`
- **推荐理由：** DSH Web界面技能与MCP管理插件，可视化配置
...
- **标签：** `dsh-plugin`, `ui`, `plugin-market`
- **推荐理由：** Web GUI插件市场，支持从插件目录一键安装/卸载。
...
- **标签：** `desktop-app`, `electron`, `typescript`, `dsh-plugin`
- **推荐理由：** Electron桌面管理控制台，多标签统一管理Harness/插件/MCP/技能。
...
- **标签：** `bioinformatics`, `deepseek`, `desktop-app`, `dsh-plugin`, `llm-agent`, `single-cell`, `tauri`
- **推荐理由：** 面向临床医生和科学家的生物信息学智能体桌面应用。
...
- **标签：** `awesome-dsh`, `awesome-dsh-plugin`, `db`, `deepseek-harness`, `desktop`, `docker`, `dsh`, `dsh-plugin`
- **推荐理由：** 集成数据库、SSH、Docker和AI助手的DevOps桌面。
...
- **标签：** `agent-skills`, `mcp-server`, `dsh-plugin`
- **推荐理由：** 隐私优先的简历构建器，支持自托管。
...
- **标签：** `skills`, `prompt-engineering`, `dsh-plugin`
- **推荐理由：** 530+逆向提示词工程，20+工业级模板。
...
- **标签：** `agent-skills`, `meta-skill`, `dsh-plugin`
...
- **标签：** `skills`, `marketplace`, `automation`
- **推荐理由：** 最全技能商店，覆盖多平台Agent技能包。
...
- **标签：** `agent-control-plane`, `long-horizon`, `workflow`
- **推荐理由：** 跨平台长程Agent控制面，持久治理工作流。
...
- **标签：** `agent-teams`, `workflow`, `dsh-plugin`
- **推荐理由：** 支持多智能体协作的团队工作流插件
...
- **标签：** `dsh-plugin`, `canvas`, `workflow`
- **推荐理由：** 可视化非线性对话画布，支持分支探索工作流。
...
- **标签：** `dsh-plugin`, `task-management`, `taskboard`
- **推荐理由：** 原生SQLite任务看板，支持Agent认领与审查。
...
- **标签：** `dsh-plugin`, `creative-writing`, `fiction`
- **推荐理由：** 专为小说创作和短剧制作设计的插件。
...
- **标签：** `competition`, `math-modeling`, `gitops`
...
- **标签：** `agent-evolution`, `review`, `workflow`
- **推荐理由：** 可组合任务控制与人类审查的Agent自演进模式。
...
- **标签：** `agent-skills`, `dsh-plugin`, `plugin-discovery`
- **推荐理由：** 自动搜索、安装并验证DSH插件，提升插件发现效率
...
- **标签：** `agent`, `skills`, `coding`, `docs`
- **推荐理由：** 通用技能框架，将经验转化为可重复执行的agent技能
...
- **标签：** `superpowers`, `dsh-plugin`, `skills`, `tdd`
- **推荐理由：** 源自Superpowers的TDD、调试、规划和协作技能集合
...
- **标签：** `agent-skills`, `deepseek-harness`, `research-automation`
- **推荐理由：** 88个开源Agent技能，覆盖研究、营销与商业工作流，多平台兼容。
...
- **标签：** `skills`, `deepseek-harness`, `ai-coding`
- **推荐理由：** AI编程导师技能：扫描项目架构，生成阶梯式教程，自动判题与Code Review。
...
- **⭐ 星标：** 19
- **语言：** Python
- **描述：** Free image reading & generation for DeepSeek Harness (rc.7 / rc.8 / v0.1.1-rc.1 / rc.2 / v0.1.2-alpha.3) — paste-image reading with auto vision transcription, DeepSeek-V4-Flash-Vision-Exp / GLM-4V-Flash / SenseNova / Gemini failover, Kolors + U1 Fast generation. No keys in repo.
- **标签：** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `image-generation`, `skill`, `vision`
- **推荐理由：** 为DSH智能体提供图像读取与生成能力。
...
- **标签：** `agent-evaluation`, `ai`, `benchmark`, `deepseek-harness`, `dsh-plugin`, `llm-evaluation`, `rag-evaluation`
...
- **推荐理由：** 为DSH项目提供Swift Cycle治理技能适配器。
...
- **标签：** `design`, `ui`, `vibedesign`, `figma-alternative`
...
- **推荐理由：** 为纯文本模型打造的视觉工具箱，支持图像问答和OCR
...
- **标签：** `dsh-plugin`, `image-generation`, `seedream`
- **推荐理由：** 在DSH聊天中直接生成图片，支持多模型。
...
- **标签：** `design`, `ui-design`, `ppt`, `ui`
- **推荐理由：** 在对话中直接预览���检查和编辑OpenPencil设计文档
...
- **标签：** `visualization`, `legal`, `diagram`, `svg`, `dsh-plugin`
- **推荐理由：** 法律可视化工具集：重绘诉讼图、自动生成案件时间轴。
...
- **标签：** `ai-director`, `ai-image`, `ai-video`, `deepseek-harness`, `directorx`, `dsh-plugin`, `storyboard`, `text-to-video`
- **推荐理由：** 为DSH提供AI视频/图像/音频技能与剧本工具。
...
- **标签：** `dsh-plugin`, `web-search`, `agent-skills`
- **推荐理由：** 免费网页搜索插件，无需API密钥，支持所有模型。
...
- **推荐理由：** 将Tabbit浏览器自动化能力接入DeepSeek Harness，基于Playwright。
...
- **⭐ 星标：** 1,445
- **语言：** Python
- **描述：** DSH Plugin Radar — 开源 DSH 插件生态雷达：自动发现 15900+ 候选、k8s 运行级实测 10000+、15 分钟快照管线；插件目录是其自动生成的 artifact
- **标签：** `plugin`, `ecosystem`, `registry`
- **推荐理由：** 自动发现超15900个DSH插件的生态雷达工具
...
- **标签：** `dsh-plugin`, `oauth`, `subscription`
- **推荐理由：** 通过OAuth使用ChatGPT/Claude订阅作为LLM提供者。
...
- **⭐ 星标：** 158
- **语言：** TypeScript
- **描述：** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness。 (A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling PC, Android, and Web clients to securely access and operate a remote Harness over a low-latency, end-to-end encrypted, P2P-first network.)
- **标签：** `deepseek`, `dsh-plugin`, `remote-access`
- **推荐理由：** 端到端加密的P2P远程访问方案，支持多设备操作Harness
...
- **标签：** `dsh-plugin`, `mcp`, `configuration`
...
- **标签：** `config-manager`, `backup`, `mcp`, `webdav`
- **推荐理由：** 支持配置、插件、MCP和技能的完整备份、导入与WebDAV同步。
...
- **标签：** `plugin-management`, `ui`, `dsh-plugin`
- **推荐理由：** 插件生态基建：提供仓库管理控制台和官方插件开发引导技能。
...
- **标签：** `ai-cost`, `awesome`, `awesome-dsh-plugin`, `data-visualization`, `deepseek`, `deepseek-api`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `token-usage`
- **推荐理由：** 实时Token用量与成本追踪的Web插件。
...
- **标签：** `dsh-plugin`, `theme`, `transparent-ui`
- **推荐理由：** 高自由度磨砂玻璃主题，背景模糊度可自由调节。
...
- **标签：** `theme`, `webgpu`, `ocean`
- **推荐理由：** 基于WebGPU的海洋主题视觉皮肤，效果惊艳。
...
- **标签：** `theme`, `customization`, `webui`
- **推荐理由：** 自定义DSH Web背景，支持上传和预设氛围
...
- **标签：** `ai-guide`, `tutorial`, `rag`, `prompt`
- **推荐理由：** AI资源大全，含教程、提示词和知识库，适合新手入门���
...
- **标签：** `tutorial`, `dsh`, `harness-engineering`
- **推荐理由：** DSH入门教程，从零学习Harness工程的最佳资源。
...
- **标签：** `research`, `web-search`, `claude-code`
- **推荐理由：** 自动搜索八大中文平台近30天内容生成研究报告
...
- **标签：** `dsh-plugin`, `knowledge-base`, `ai-pedia`
- **推荐理由：** 一站式AI资源百科，涵盖Agent、RAG、MCP等领域。
...
- **标签：** `documentation`, `marketplace`, `learning`
- **推荐理由：** 学习DSH原理、浏览插件市场与最佳实践的入门资源。
...
- **标签：** `catalog`, `browser`, `directory`
- **推荐理由：** 收录1958个仓库的插件目录，支持中英文搜索排序。
...
- **推荐理由：** 一站式科研工作台，支持LaTeX、arXiv、实验追踪与GPU管理。
...
- **标签：** `academic-search`, `citation-management`, `research-workflow`
- **推荐理由：** 跨源学术检索，支持引用核验、图谱与试验搜索，适合中文科研用户
...
- **标签：** `api-documentation`, `chinese-api`, `research-tools`
- **推荐理由：** 在编码Agent内直接搜索20个中国开放平台的6.5万篇API文档。
...
- **标签：** `patent-analysis`, `rag`, `multi-agent`, `legal-tech`
- **推荐理由：** 基于RAG的专利侵权分析系统，输入公开号自动生成竞品侵权报告。
...
- **推荐理由：** The first vision plugin for DeepSeek Har
...
- **推荐理由：** Two-phase DeepSeek Harness preset: Minim
...
- **标签：** `agent-sandbox`, `agent-tools`, `ai-agents`, `bash`, `claude-code`, `dsh`, `dsh-plugin`, `fuse`, `llm-agents`, `openai-agents`, `python`, `typescript`, `vfs`, `virtual-filesystem`, `virtual-terminal`
- **推荐理由：** The World's First Virtual Terminal for A
...
- **推荐理由：** ReMe: Memory Management Kit for Agents -
...
- **推荐理由：** Intelligent Skill routing and workflow o
...
- **标签：** `claude-code`, `cli`, `codex`, `codex-app`, `codex-desktop`, `codex-plugin`, `dsh`, `dsh-plugin`, `skills`
- **推荐理由：** 现代化可灵活嵌入的任务面板，支持 Codex、DeepSeek Harness
...
- **推荐理由：** A persistent, unified memory layer for a
...
- **⭐ 星标：** 1,905
- **语言：** TypeScript
- **描述：** Whale Girl skin series for DeepSeek Harness. 适��于 DeepSeek Harness 的，鲸鱼娘系列皮肤。
- **标签：** `dsh`, `dsh-plugin`
...
- **标签：** `armor-breaking`, `deepseek`, `plugin`
- **推荐理由：** DeepSeek破甲插件，稳定突破限制
...
- **标签：** `dsh-plugin`, `awesome-list`, `plugin-discovery`
- **推荐理由：** 每日抓取插件推荐，真实分类与热度排行。
...
- **推荐理由：** 对话内多源搜番，卡片展示Bangumi评分，支持复制磁力链接
...
- **推荐理由：** cordis.run维护的官方自动生成DSH插件精选清单
...
- **推荐理由：** 社区维护的DSH插件聚合目录，每4小时自动同步��选。
...
- **⭐ 星标：** 37
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修���、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
...
- **标签：** `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-plugins`
- **推荐理由：** DSH Skills Manager — 在 DeepSeek Harness 
...
- **推荐理由：** 一键配置各类 AI Agent 工具的 MCP、Skills 和规则；支持 Cl
...
- **⭐ 星标：** 22
- **语言：** Python
- **描述：** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——10 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **标签：** `agent-skills`, `ai-agents`, `ai-testing`, `claude-code`, `claude-skills`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `llm`, `playwright`, `pytest`, `qa`, `quality-assurance`, `software-testing`, `test-automation`, `test-case-writing`, `testing`
- **推荐理由：** 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skil
...
- **推荐理由：** Godot Engine 4.x 全栈游戏开发技能插件 for DeepSeek
...
- **标签：** `ai-coding`, `api`, `cli`, `cloud`, `codex`, `deepseek-harness`, `dsh`, `dsh-plugin`, `huaweicloud`, `koocli`, `mcp`, `opencode`, `plugins`, `sdk`, `terraform`
- **推荐理由：**  Official Huawei Cloud plugin for AI age
...
- **标签：** `awesome`, `awesome-list`, `curated-list`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `nextjs`, `plugin-directory`, `typescript`
- **推荐理由：** DSH插件发现的公共GitHub目录。
...
- **标签：** `agent-harness`, `ai-agent`, `ai-tools`, `awesome`, `awesome-list`, `coding-agent`, `cordis`, `deepseek`, `deepseek-ai`, `deepseek-harness`, `dsh`, `dsh-plugin`, `mcp`, `plugin`, `skills`
- **推荐理由：** DSH插件、工具、技能和资源的精选Awesome列表。
...
- **标签：** `awesome-list`, `installation-guide`
- **推荐理由：** 基于证据的DSH插件目录，含安装指导
...
- **标签：** `awesome-dsh-plugin`, `deepseek-harness`, `dsh-plugin`, `knowledge-cards`
- **推荐理由：** A plugin of Deepseek Harness(DSH),transf
...
- **推荐理由：** A curated, auto-updating list of plugins

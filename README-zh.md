...
- [Agent 技能与工作流](#agent-技能与工作流) — 29 个插件
- [视觉与设计](#视觉与设计) — 10 个插件
...
- [Agent 技能与工作流](agent-skills-workflows-zh) (29)
...
- **标签：** `agent-orchestration`, `multi-device`, `mcp`
- **推荐理由：** 跨设备统一Agent工作区，支持看板任务管理
...
- **标签：** `router`, `routing`, `agent-control`
- **推荐理由：** 任务感知的推理模式路由器，优化Agent路由效率
...
- **推荐理由：** 企业级多Agent工作台，支持可视化编辑器与多引擎
...
- **推荐理由：** 自进化Agent操作系统，支持面试关卡与MCP服务
...
- **推荐理由：** DeepSeek Harness多代理团队协作插件
...
- **标签：** `coding-agent`, `rpc`, `sub-agents`, `mcp`, `cli`
- **推荐理由：** 编码Agent，支持RPC插件、子Agent和MCP协议
...
- **标签：** `ai-agent`, `llm`, `oauth`, `deepseek-harness`
- **推荐理由：** 无需API密钥即可用ChatGPT/Claude/Grok订阅作��LLM提供商
...
- **标签：** `coding-agent`, `skill`, `mentor`
- **推荐理由：** AI编程导师，扫描项目架构，自动判题和Code Review
...
- **标签：** `registry`, `plugin`, `infrastructure`
- **推荐理由：** 官方插件注册表控制台，浏览器管理生态基建
...
- **推荐理由：** DSH内统一加载并安全管理本地Agent Skills
...
- **标签：** `creator`, `plugin`, `devtools`
- **推荐理由：** 构建和验证DSH/Cordis插件的可复用Skill
...
- **推荐理由：** 一键同步MCP和技能配置到7+种AI Agent平台
...
- **标签：** `deepseek-harness`, `quality-gate`, `engineering-discipline`
- **推荐理由：** 工程纪律插件，强化需求与交付质量把控。
...
- **标签：** `codex`, `deepseek-harness`, `sync`, `mcp`
- **推荐理由：** Codex与DSH双向同步桥，支持技能与MCP镜像。
...
- **标签：** `chatgpt`, `oauth`, `ai-agents`, `subscription`
...
- **标签：** `agent-tools`, `llm-agents`, `plugin-checklist`
- **推荐理由：** DSH代理任务前自动预检并注入合适插件
...
- **标签：** `terminal`, `vfs`, `virtual`
- **推荐理由：** 全球首个AI代理虚拟终端，支持VFS
...
- **标签：** `novel-writing`, `desktop-app`, `dsh-plugin`
- **推荐理由：** 桌面小说创作软件，集成DSH预览的组织化创作流程
...
- **推荐理由：** Windows桌面客户端，内置GUI、SSH和远程访问功能
...
- **标签：** `gui`, `interactive`, `charts`, `inline-ui`
...
- **标签：** `canvas`, `workspace`, `branching`, `visualization`
- **推荐理由：** 基于Canvas的非线性对话画布，支持分支工作流
...
- **标签：** `office`, `desktop`, `deepseek-harness`
- **推荐理由：** 将表格、文档、幻灯片和画布集成到Harness UI中
...
- **标签：** `ios`, `mobile`, `ui-automation`, `mcp`
- **推荐理由：** 对话内嵌入iOS模拟器及真机，22个Agent自动化控制工具
...
- **推荐理由：** 原生iOS客户端，通过WebSocket连接Harness实现移动端工作
...
- **推荐理由：** CodePilot风格桌面客户端，跨macOS/Windows/Linux三平台
...
- **推荐理由：** Electron桌面管理控制台，多Tab管理插件与技能
...
- **标签：** `ui`, `usage-tracking`, `information-bar`
- **推荐理由：** 实用的DSH桌面信息栏，显示余额和实时价格
...
- **推荐理由：** WorkBuddy风格技能选择器，快速插入到编辑器
...
- **推荐理由：** 一站式DevOps桌面，集成DB/SSH/SFTP/Docker/AI
...
- **标签：** `agentic-ai`, `multi-agent`, `swarm`, `mcp-server`
- **推荐理由：** 部署多智能体 swarm，协调自主工作流。
...
- **标签：** `skills`, `marketplace`, `workflow`
- **推荐理由：** 最大技能商店，自动抓取GitHub项目持续更新
...
- **标签：** `content`, `discovery`, `agent`
- **推荐理由：** 跨平台内容发现Agent，支持B站抖音X等
...
- **标签：** `ai-video`, `ffmpeg`, `agent-skill`
...
- **标签：** `creative-writing`, `novel`, `screenwriting`, `drama`
- **推荐理由：** 专为小说创作和短剧制作设计的Agent技能插件
...
- **推荐理由：** SQLite本地任务看板，支持Agent认领审核，原生Web UI
...
- **标签：** `skill`, `competition`, `gitops`, `automation`
...
- **标签：** `agent-skills`, `automation`, `learning`
...
- **标签：** `fintech`, `investment`, `backtesting`
- **推荐理由：** 多策略基金回测的AI投资工作台技能包
...
- **标签：** `skills`, `deck`, `agent`
- **推荐理由：** 内置25个工程技能面板，开箱即用的工作流
...
- **标签：** `chinese-wisdom`, `metaphysics`, `skill`
- **推荐理由：** 八字/风水/易经融合技能，本地确定性引擎
...
- **标签：** `multi-agent`, `collaboration`, `skills`
...
- **标签：** `agent-skills`, `remotion`, `video-production`
- **推荐理由：** 电影感产品视频制作技能，含152张镜头配方。
...
- **标签：** `agent-skills`, `ai-design`, `figma-alternative`
...
- **标签：** `agent`, `browser-use`
- **推荐理由：** 真实登录态浏览器自动化，不中断用户工作
...
- **标签：** `tts`, `voice`, `xiaomi-mimo`
- **推荐理由：** 免费小米MiMo语音合成，支持多音色
...
- **标签：** `image-uploader`, `electron`, `s3`, `cloudflare-r2`
...
- **标签：** `web`, `plugin-ecosystem`, `dsh-web`
- **推荐理由：** 基于Web的插件聚合生态，分布式插件发现平台
...
- **标签：** `marketplace`, `installer`, `browse`
- **推荐理由：** 官方插件市场：浏览搜索一键安装
...
- **标签：** `switch`, `models`, `installer`
- **推荐理由：** 一键切换Claude Code/Codex/DeepSeek/Kimi模型
...
- **标签：** `plugin-registry`, `ecosystem`
- **推荐理由：** 自部署���态雷达，扫描验证15900+候选插件
...
- **标签：** `cost-tracking`, `utility`, `llm`
- **推荐理由：** 追踪会话/日花费、预算及多提供商Token用量
...
- **推荐理由：** 开源CLI与Schema，用于DSH插件中心管理与发现
...
- **标签：** `container`, `management`, `infrastructure`
- **推荐理由：** 管理多个隔离DSH容器，内嵌WebView界面
...
- **标签：** `deepseek-harness`, `mcp-manager`, `web-ui`
- **推荐理由：** 通过Web UI管理技能与MCP服务器的实用插件。
...
- **标签：** `cordis`, `deepseek-harness`, `infrastructure`
- **推荐理由：** 统一编排DSH运行时、提供者与插件的核心工具。
...
- **⭐ 星标：** 7
- **语言：** TypeScript
- **描述：** 致力于解决各插件之间也与版��之间可能存在的冲突问题并提供解决方案
- **标签：** `diagnostics`, `conflict-resolution`, `utility`
- **推荐理由：** 诊断修复插件冲突与版本兼容问题
...
- **标签：** `mascot`, `pixel-art`, `cli`, `theme`
- **推荐理由：** animated宠物画廊，个性化你的Agent终端体验
...
- **标签：** `theme`, `glassmorphism`, `customizable`, `visual`
- **推荐理由：** 高自由度磨砂玻璃质感主题，支持自定义模糊效果
...
- **标签：** `theme`, `animated`, `ocean`, `webgpu`
- **推荐理由：** 动态海洋主题，支持实时海浪、日落和玻璃效果
...
- **推荐理由：** 自动搜索国内8大平台近30天内容，生成有据研究报告
...
- **推荐理由：** 自动抓取筛选，精选分类与热度排行，快速发现优质插件
...
- **标签：** `research`, `arxiv`, `latex`, `gpu-cluster`
- **推荐理由：** 一站式科研平台：LaTeX编译、arXiv管理、实验追踪、GPU调度
...
- **标签：** `awesome-list`, `plugins`, `mcp`, `orchestrators`
- **推荐理由：** 精选DSH插件、技能、MCP服务器、补丁和编排器汇总
...
- **推荐理由：** 跨平台学术搜索Skill+MCP，支持arXiv/PubMed/引用图谱核验
...
- **推荐理由：** 一键搜索20个中国平台6.5万篇API文档，零配置
...
- **语言：** Unknown
- **描述：** DSHA精选插件合集
- **标签：** `awesome-dsh-plugin`, `plugin-directory`
- **推荐理由：** DSHA官方精选插件合集
...
- **推荐理由：** GitHub Actions自动抓取更新的插件目录
...
- **标签：** `low-code`, `no-code`, `ai-agent`, `crm`
...
- **推荐理由：** DeepSeek Harness生态插件工具精选合集
...
- **推荐理由：** DeepSeek Harness插件生态精选资源集合
...
- **标签：** `plugin-market`, `dsh-plugin`
- **推荐理由：** 每日更新的综合插件市场，全网检索审核发布
...
- **标签：** `awesome-list`, `encyclopedia`, `resources`, `learning`
- **推荐理由：** AI资源百科大全，涵盖Agent、RAG、工具和学习路线
...
- **推荐理由：** Command Code provider plugin for DeepSee
...
- **推荐理由：** Bridge the Pi and DeepSeek Harness ecosy
...
- **推荐理由：** 基于tushare构建本地财经数据库。AI原生的多Agent金融分析系统，支持s
...
- **⭐ 星标：** 178
- **语言：** TypeScript
- **描述：** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，��过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness 和 CodeX。 (A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling PC, Android, and Web clients to securely access and operate remote Harness and CodeX over a low-latency, end-to-end encrypted, P2P-first network.)
- **标签：** `deepseek`, `dsh-plugin`
- **推荐理由：** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，��
...
- **推荐理由：** 帮 DSH 搜索、安装并验证插件的 Skill｜A DSH skill that
...
- **推荐理由：** 为 Claude Code 赋能多模态视觉能力，适配 纯文本 LLM 底座，用于
...
- **标签：** `awesome-list`, `catalog`, `curated`
- **推荐理由：** 官方自动维护的精选插件目录清单
...
- **标签：** `community`, `marketplace`, `catalog`
- **推荐理由：** 社区维护的插件聚合与自动同步目录
...
- **标签：** `directory`, `awesome-list`, `catalog`
- **推荐理由：** 精选280+社区插件目录，14类直达链接
...
- **标签：** `roleplay`, `narrative`, `agent-skills`
- **推荐理由：** 带记忆和YAML存档的互动叙事角色扮演技能
...
- **标签：** `awesome-list`, `inventory`, `registry`
- **推荐理由：** 千余DSH插件仓库按star排序全量清单
...
- **标签：** `directory`, `index`, `plugin-list`
- **推荐理由：** 自动更新的插件目录，双语README

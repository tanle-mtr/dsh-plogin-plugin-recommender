...
> 最全面的 DeepSeek Harness 插件 AI 精选合集 —— 每小时自动更新，按智能分类。
...
- [编程 Agent 与 Harness 工具](#编程-agent-与-harness-工具) — 22 个插件
- [UI 与桌面扩展](#ui-与桌面扩展) — 21 个插件
- [记忆与知识（RAG）](#记忆与知识（rag）) — 10 个插件
- [Agent 技能与工作流](#agent-技能与工作流) — 21 个插件
- [MCP 服务器与工具](#mcp-服务器与工具) — 3 个插件
- [视觉与设计](#视觉与设计) — 5 个插件
- [浏览器与 Web 自动化](#浏览器与-web-自动化) — 6 个插件
- [实用工具与基础设施](#实用工具与基础设施) — 12 个插件
- [主题与皮肤](#主题与皮肤) — 4 个插件
- [研究与分析](#研究与分析) — 4 个插件
- [其他](#其他) — 85 个插件
...
- [编程 Agent 与 Harness 工具](coding-agents-harness-tools-zh) (22)
- [UI 与桌面扩展](ui-desktop-extensions-zh) (21)
- [记忆与知识（RAG）](memory-knowledge-rag-zh) (10)
- [Agent 技能与工作流](agent-skills-workflows-zh) (21)
- [MCP 服务器与工具](mcp-servers-tools-zh) (3)
- [视觉与设计](visual-design-zh) (5)
- [浏览器与 Web 自动化](browser-web-automation-zh) (6)
- [实用工具与基础设施](utilities-infrastructure-zh) (12)
- [主题与皮肤](themes-skins-zh) (4)
- [研究与分析](research-analysis-zh) (4)
- [其他](other-zh) (85)
---
...
- **标签：** `router`, `agent-orchestration`, `cordis`
- **推荐理由：** 任务感知路由器套件，显著提升智能体推理能力
...
- **标签：** `agent-os`, `loop-engineering`, `coding-agent`
- **推荐理由：** 自进化的智能体OS，支持循环工程与持续评估
...
- **标签：** `preset`, `dsh-plugin`, `harness`
- **推荐理由：** 两阶段预设，从最小启动到完整标准工具链的渐进方案
...
- **标签：** `agent-runtime`, `ai-coding`, `dsh-plugin`
- **推荐理由：** 高性能Rust Agent运行时，结合精美桌面IDE体验。
...
- **标签：** `code-review`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 基于12本经典工程著作的AI代码审查工具，含严重性分级。
...
- **⭐ 星标：** 1,133
- **语言：** Python
- **描述：** Make AI coding agents architecture-aware: baseline-first, evidence-verified, drift-checked, and safe across long tasks.
- **标签：** `agent-skills`, `coding-agents`
- **推荐理由：** 架构感知编码代理，证据驱动开发，防止漂移。
...
- **标签：** `vision`, `computer-vision`
- **推荐理由：** 纯文本模型视觉工具箱：OCR、多图问答、截图。
...
- **标签：** `security`, `code-audit`, `redteam`, `safety`
- **推荐理由：** 审计AI生成代码中的幻觉包和安全漏洞。
...
- **⭐ 星标：** 327
- **语言：** Rust
- **描述：** ccteam turns the coding agents you already run (Claude Code, Codex, Grok, Kimi, DeepSeek Harness) into one team — any session can spawn, dispatch, and collect work from any vendor on any machine, while you steer it all from Telegram, Lark, or a browser tab. 把你在用的编程 agent 编成一支团队,跨厂商跨机器派活,Telegram/飞书/网页统一指挥。
- **标签：** `multi-agent`, `coding`, `teamwork`, `automation`
- **推荐理由：** 将多个编程AI助手整合为协作团队工作流。
...
- **标签：** `oauth`, `subscription`, `llm-provider`, `integration`
- **推荐理由：** 通过OAuth将订阅账号转为DSH的LLM提供商。
...
- **⭐ 星标：** 144
- **语言：** JavaScript
- **描述：** DSH插件市场 / DSH Plugin Marketplace: 在 DeepSeek Harness Web GUI 中一键浏览、安装与更新 GitHub topic:dsh-plugin 的全部插件 | browse, install & update all GitHub dsh-plugin plugins in the DSH Web GUI
- **标签：** `marketplace`, `plugin-install`, `dsh`
- **推荐理由：** Web GUI一键浏览安装更新所有DSH插件
...
- **标签：** `context-migration`, `session`, `preset`
- **推荐理由：** 跨预设会话迁移保留状态与意图
...
- **⭐ 星标：** 13
- **语言：** Unknown
- **描述：** DSH 插件开发踩坑与做法档案（skill + 文档）：cordis 双副本、tsconfig 三件套、Windows junction、多帧 zstd 等实测记录
- **标签：** `development`, `documentation`, `best-practices`
- **推荐理由：** DSH插件开发实测经验与最佳实践档案
...
- **⭐ 星标：** 12
- **语言：** Unknown
- **描述：** Agent skills for building and testing DeepSeek Harness plugins — from scaffolding a new plugin package to choosing the right test tiers, entirely inside an agent session.
- **标签：** `plugin-dev`, `testing`, `scaffolding`
- **推荐理由：** 在Harness内完整构建测试DSH插件
...
- **⭐ 星标：** 6,089
- **语言：** TypeScript
- **描述：** DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发
- **标签：** `dsh-web`, `plugin-ecosystem`, `web-ui`
- **推荐理由：** 基于Web的DSH插件枢纽，带创意工坊分发生态
...
- **标签：** `deepseek-harness`, `sidebar`, `dsh-plugin`
- **推荐理由：** 可扩展侧边栏底座，内置文件编辑/终端/Git等面板。
...
- **⭐ 星标：** 2,560
- **语言：** TypeScript
- **描述：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **标签：** `deepseek-harness`, `tui`, `dsh-plugin`
- **推荐理由：** Claude Code风格TUI界面，支持流式思考与回滚功能。
...
- **⭐ 星标：** 1,121
- **语言：** TypeScript
- **描述：** Local first, desktop companion platform with animated pets, plugin SDK and coding-agent integrations.
- **标签：** `desktop-pet`, `electron`
- **推荐理由：** 桌面宠物伴侣平台，支持插件SDK与编码代理。
...
- **标签：** `desktop-app`, `agent`, `privacy`, `tauri`
- **推荐理由：** 本地优先的多模型AI助手桌面应用，注重隐私保护。
...
- **标签：** `ui`, `components`, `interactive`, `gen-ui`
- **推荐理由：** 在聊天中内联生成交互式UI组件，如图表和表单。
...
- **标签：** `desktop`, `electron`, `cross-platform`, `client`
- **推荐理由：** 跨平台DSH桌面客户端，灵感源自CodePilot。
...
- **标签：** `canvas`, `conversation`, `visual`, `workspace`
- **推荐理由：** 基于画布的非线性对话工作区，支持分支会话。
...
- **标签：** `desktop-app`, `electron`, `ssh-client`
- **推荐理由：** 功能完整的Windows桌面GUI，支持SSH、插件和移动访问
...
- **标签：** `openpencil`, `ui-design`, `ppt`
- **推荐理由：** 对话内直接预览编辑OpenPencil文档
...
- **标签：** `task-management`, `taskboard`, `sqlite`
- **推荐理由：** SQLite任务看板，代理认领与审查
...
- **⭐ 星标：** 118
- **语言：** TypeScript
- **描述：** DeepSeek Harness plugin for Android — build, run, and interact with a live emulator or USB device stream inside a conversation, driven entirely through adb.
- **标签：** `android`, `emulator`, `mobile`
- **推荐理由：** 对话内构建运行Android应用
...
- **⭐ 星标：** 9
- **语言：** Rust
- **描述：** StarHub 是一款跨平台桌面应用（Tauri 2 + Rust 主进程 + DeepSeek Harness React 工作台 + Go Sidecar），把开发运维日常高频工具整合到同一个窗口 —— 数据库、SSH/SFTP、Docker 面板与 AI 助手。目标是减少在 Navicat、Xshell、Portainer、文件管理器和 AI 对话窗口之间来回切换的成本。  前端架构：基于 DeepSeek Harness 原生 React 工作台（/starhub-react 路由）。资产、设置、SSH 终端、SFTP、数据库
- **标签：** `desktop`, `tauri`, `devtools`
- **推荐理由：** Tauri桌面整合数据库SSH Docker与AI助手
...
- **标签：** `ui`, `theme`, `personalization`, `webui`
- **推荐理由：** 支持自定义图片上传和预设主题美化DSH网页界面。
...
- **标签：** `rag`, `knowledge-base`, `embeddings`
- **推荐理由：** 开源LLM知识平台，支持RAG和自维护Wiki
...
- **标签：** `agent`, `memory`, `rag`
- **推荐理由：** 专为AI Agent设计的记忆管理工具，支持RAG检索增强。
...
- **标签：** `agent-memory`, `milvus`, `rag`
- **推荐理由：** 基于Milvus的持久化统一Agent记忆层，支持语义检索。
...
- **标签：** `knowledge-base`, `rag`, `mcp`, `learning`
- **推荐理由：** AI知识库大全，涵盖Agent、RAG、MCP及学习路线。
...
- **推荐理由：** 将分散的SKILL.md文件转化为可检索的agent技能库
...
- **标签：** `ai-agent`, `mcp`, `multi-agent`
- **推荐理由：** 具备记忆、技能和自我进化的超级AI助手
...
- **标签：** `agent-skills`, `knowledge-distillation`, `skills`
- **推荐理由：** 将思维模式提炼为可复用的智能体技能
...
- **标签：** `agent-skills`, `architecture-diagram`, `dsh-plugin`
- **推荐理由：** 强大的智能体技能，可生成美观的架构与序列图
...
- **标签：** `agent-skills`, `cognitive-enhancement`, `deepseek-harness`
- **推荐理由：** 基于全局工作空间理论的AI认知增强技能套件。
...
- **⭐ 星标：** 2,996
- **语言：** Python
- **描述：** VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows.
- **标签：** `agent-skills`, `workflow-automation`, `vibe-coding`
- **推荐理由：** 通用型技能插件，智能编排工作流并自动路由任务。
...
- **标签：** `ai-video`, `ffmpeg`, `dsh-plugin`
- **推荐理由：** 端到端生成Vox风格解说视频，整合文���到视频技术。
...
- **标签：** `agent-teams`, `workflows`
- **推荐理由：** 多代理团队协作，支持复杂任务编排与���度。
...
- **标签：** `workflow`, `productivity`
- **推荐理由：** 将AI对话转化为可组织、可复用工作流。
...
- **标签：** `agent-skills`, `math-modeling`, `deepseek-harness`
- **推荐理由：** 全栈自动数学建模竞赛技能，支持GitOps流水线
...
- **⭐ 星标：** 182
- **语言：** Python
- **描述：** A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills.
- **标签：** `creative-writing`, `novel-writing`, `screenwriting`
- **推荐理由：** 专注于小说创作和短剧制作的工作流技能
...
- **标签：** `agent-skills`, `coding`, `multi-framework`
- **推荐理由：** 将经验转化为跨多agent框架的可重复执行流程
...
- **标签：** `agent-skills`, `plugin-discovery`, `dsh-plugin`
- **推荐理由：** 在DSH中直接发现、安装和验证GitHub插件
...
- **⭐ 星标：** 117
- **语言：** TypeScript
- **描述：** DeepSeek Harness Agent Workflow
- **标签：** `agent`, `workflow`, `automation`
- **推荐理由：** DSH代理工作流自动化插件
...
- **标签：** `agent-skills`, `canvas`, `mcp-tools`
- **推荐理由：** 无限画布结合创意技能，原生Cordis集成
...
- **⭐ 星标：** 13
- **语言：** Unknown
- **描述：** Engineering discipline distilled from DeepSeek Harness — fact-finding, durable decisions, evidence by surface, honest reporting. Portable Agent Skill.
- **标签：** `agent-skill`, `engineering`, `practices`
- **推荐理由：** 可移植的工程纪律Agent技能，实用规范
...
- **标签：** `godot`, `game-dev`, `skill`
- **推荐理由：** Godot 4全栈游戏开发技能，运行时注册
...
- **⭐ 星标：** 6
- **语言：** JavaScript
- **描述：** Product Team Mode - a DeepSeek Harness agent preset: user-led conversation with a virtual product team (PM to Engineer to QA to Release) walking you from idea to shipped product
- **标签：** `agent-preset`, `product-management`, `workflow`
- **推荐理由：** 模拟产品团队多角色协作流程，从PM到QA全流程。
...
- **标签：** `agent-tools`, `pre-flight`, `plugin-optimization`
- **推荐理由：** 任务前自动预检并注入Top-K相关插件，提升利用率。
...
- **标签：** `vision`, `ocr`, `mcp`
- **推荐理由：** 首个视觉插件，让纯文本智能体通过结构化JSON理解图片
...
- **标签：** `chatgpt`, `oauth`, `integration`, `models`
...
- **标签：** `agent-skills`, `design-systems`, `ui-generator`
- **推荐理由：** 开源设计替代方案，本地优先桌面应用
...
- **推荐理由：** 工业级GPT-Image2提示词引擎，530+案例
...
- **标签：** `design`, `ui`, `vibedesign`
- **推荐理由：** AI原生矢量设计工具，支持并发智能体团队与设计即代码
...
- **标签：** `design`, `visual-editor`
- **推荐理由：** AI设计工作室，可视化编辑、模板市场���PPT。
...
- **标签：** `image-generation`, `deepseek-harness`, `plugin`
...
- **⭐ 星标：** 19,838
- **语言：** TypeScript
- **描述：** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；提示词管理器可用于任�� Web UI，含 DeepSeek Harness。
- **标签：** `browser-extension`, `chat-management`, `prompt-manager`
- **推荐理由：** 增强主流AI平台的浏览器扩展套件
...
- **标签：** `ai-agent`, `bilibili`, `cross-platform`
- **推荐理由：** 跨平台AI内容发现Agent，覆盖B站、小红书、抖音等平台。
...
- **标签：** `web-search`, `free`, `bridge`, `utility`
- **推荐理由：** 为无网页访问能力的模型提供免费搜索桥梁。
...
- **推荐理由：** 在对话中运行iOS模拟器，提供22个自动化测试工具。
...
- **推荐理由：** 基于Tabbit Playwright的浏览器自动化
...
- **标签：** `vfs`, `virtual-filesystem`, `infrastructure`
- **推荐理由：** 统一的虚拟文件系统，为智能体提供跨环境文件访问能力
...
- **标签：** `deepseek-harness`, `marketplace`, `dsh-plugin`
- **推荐理由：** DSH官方插件市场，可视化浏览并一键安装插件。
...
- **标签：** `context`, `utilities`
- **推荐理由：** 强大的上下文洞察与管理，含仪表盘和浏览器。
...
- **标签：** `cost-tracking`, `deepseek-api`, `token-usage`
- **推荐理由：** 追踪各提供商的会话费用、预算和token用量
...
- **⭐ 星标：** 180
- **语言：** HTML
- **描述：** DeepSeek-Harness-Plugins
- **标签：** `plugin-marketplace`, `deepseek-harness`, `plugins`
- **推荐理由：** DeepSeek Harness生态的插件市场和中心
...
- **标签：** `compatibility-layer`, `migration`, `plugin-migration`
- **推荐理由：** 兼容层将Pi生态扩展桥接到原生DSH插件
...
- **⭐ 星标：** 13
- **语言：** JavaScript
- **描述：** Migrate Claude Code setup into DeepSeek Harness. Import skills, commands, agents, hooks, permission rules, and MCP config. Codex and OpenCode supported.
- **标签：** `migration`, `utility`, `import`
- **推荐理由：** 一键迁移Claude Code配置到DeepSeek Harness
...
- **标签：** `visualization`, `cost`, `tokens`
- **推荐理由：** 实时Token用量与成本可视化仪表板
...
- **标签：** `conflict-resolution`, `plugin-management`, `utility`
- **推荐理由：** 自动检测和修复插件间冲突与版本兼容问题。
...
- **⭐ 星标：** 385
- **语言：** JavaScript
- **描述：** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃��糊度、磨砂度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **标签：** `theme`, `ui`, `glass-effect`
- **推荐理由：** 磨砂玻璃主题，高度可定制透明度和背景效果。
...
- **推荐理由：** 为DSH界面提供精美的WebGPU海洋主题视觉皮肤
...
- **标签：** `research`, `web-search`, `dsh-plugin`
- **推荐理由：** 自动搜索中国8大主流平台近30天内容，生成研究报告。
...
- **标签：** `anime-search`, `bangumi`, `magnet`
- **推荐理由：** 对话内多源搜番，卡片展示评分与磁力链接
...
- **标签：** `finance`, `stock`, `quant`, `research`
- **推荐理由：** 收录24个经验证的股票/金融/量化相关插件。
...
- **标签：** `dsh-plugin`, `tutorial`, `harness-engineering`
- **推荐理由：** 从零到精通DSH工程的最佳入门教程
...
- **⭐ 星标：** 2,865
- **语言：** HTML
- **描述：** 竹知了 —— 一转就哇哇叫的传统玩具，Web 模拟版。零依赖单文件，真实录音采样，移动端优先。
- **标签：** `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 传统竹蜻蜓玩具的Web模拟版，含真实录音采样。
...
- **标签：** `plugin-registry`, `awesome-list`
- **推荐理由：** 插件雷达精选榜，真实安装实测， curated Top 50。
...
- **标签：** `awesome-list`, `directory`, `curated`, `bilingual`
- **推荐理由：** DSH插件双语精选目录，涵盖各类工具与集成。
...
- **⭐ 星标：** 310
- **语言：** PowerShell
- **描述：** DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐
- **标签：** `jailbreak`, `prompt`, `deepseek`, `stability`
- **推荐理由：** DeepSeek模型提示词优化插件，稳定突破限制。
...
- **标签：** `directory`, `curation`, `awesome-list`, `verification`
- **推荐理由：** 自动审核插件目录，按场景分类，每日更新。
...
- **标签：** `documentation`, `learning`, `marketplace`, `guide`
- **推荐理由：** 学习DSH原理、浏览插件市场与最佳实践指南。
...
- **标签：** `awesome-list`, `mcp`, `deepseek-harness-plugins`
- **推荐理由：** 涵盖插件、MCP服务器、补丁和UI的全面精选列表
...
- **⭐ 星标：** 189
- **语言：** TypeScript
- **描述：** DeepSeek Harness plugin store, marketplace and hub — 3,100+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收集与格式校验，免费搜索 API。deepseek1024.com
- **标签：** `marketplace`, `plugin-directory`, `plugin-store`
- **推荐理由：** 插件市场，含3100+条目、搜索、排名和公开API
...
- **推荐理由：** Superpowers skill port to Reasonix codin
...
- **推荐理由：** Superpowers skills for DeepSeek Harness:
...
- **推荐理由：** A meticulously curated list of useful pl
...
- **⭐ 星标：** 80
- **语言：** PowerShell
- **描述：** Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and security research skill pack.
- **标签：** `ctf`, `deepseek-harness`, `dsh-plugin`, `pentest`, `reverse-engineering`, `security`
- **推荐理由：** Complete reverse-skill (85 SKILL.md) as 
...
- **标签：** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `awesome-list`, `deepseek-harness`, `dsh`, `dsh-ecosystem`, `dsh-plugin`, `plugin-marketplace`, `plugins`
- **推荐理由：** 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-pl
...
- **推荐理由：** ProMentor 是一个 AI Coding Agent Skill。装上它，
...
- **标签：** `agent-plugins`, `agent-skills`, `ai-agents`, `claude-code`, `claude-code-marketplace`, `claude-code-plugin`, `codex-skills`, `cursor-ai`, `deep-research`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `fact-checking`, `gemini-cli`, `market-research`, `marketing-automation`, `research-tools`, `skill-md`, `social-listening`
...
- **推荐理由：** DSH 插件生态基建：薄控制台（浏览器面板管理官方 repository 插件，
...
- **推荐理由：** 在 DeepSeek Harness / Claude Code / Curso
...
- **推荐理由：** Awesome DSH Cordis Plugins �� the offici
...
- **标签：** `deepseek-harness`, `desktop-app`, `dsh`, `dsh-plugin`, `dsh-plugins`, `electron`, `typescript`
- **推荐理由：** DSH Desktop Hub — DeepSeek Harness 桌面管理控
...
- **标签：** `agent-skills`, `claude-code`, `claude-skills`, `codex`, `deepseek-harness`, `diagram`, `dsh-plugin`, `legal`, `legal-tech`, `litigation`, `python`, `svg`, `timeline`, `visualization`, `zero-dependency`
- **推荐理由：** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼
...
- **标签：** `agent`, `agent-skill`, `agent-skills`, `ai`, `ai-agent`, `awesome-dsh-plugin`, `claude-code`, `codex`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `llm-agent`, `skill`, `skills`
- **推荐理由：** An Agent Skills skill for developing Dee
...
- **标签：** `agent-skills`, `ai-coding`, `claude-code`, `codex`, `deepseek-harness`, `developer-tools`, `dsh-plugin`, `github-copilot`, `spec-driven-development`, `spec-programming`, `vibe-coding`
- **推荐理由：** Portable Agent Skill for repository-nati
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `image-reading`, `ocr`, `pixel-art`, `vision`
- **推荐理由：** DSH plugin: pixel-to-text image reading 
...
- **推荐理由：** Agent skill for installed DeepSeek Harne
...
- **标签：** `agent-skill`, `checker`, `cli`, `cordis`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `knowledge-base`, `plugin-development`, `scaffold`
- **推荐理由：** Installable DSH bundle: the dsh-plugin-g
...
- **标签：** `deepseek-harness`, `dsh-plugin`
- **推荐理由：** Unified capability menu for DeepSeek Har
...
- **推荐理由：** Manage DeepSeek Harness locally: run mul
...
- **标签：** `agnet`, `ai-agents`, `awesome`, `awesome-list`, `awesome-lists`, `coding-agent`, `coding-agents`, `cordis`, `cordis-plugin`, `deepseek`, `deepseek-harness`, `deepseek-harness-plugin`, `deepseek-harness-plugins`, `deepseek-v4-pro`, `dsh`, `dsh-plugin`, `dsh-plugins`, `plugins`
- **推荐理由：** DeepSeek Harness (DSH) 插件精选目录 — 14 类 280
...
- **标签：** `ai-agent`, `bazi`, `chinese-traditional-wisdom`, `dashboard`, `deepseek-harness`, `dsh-plugin`, `fengshui`, `iching`, `tcm`, `ziwei-doushu`
- **推荐理由：** 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness
...
- **标签：** `backup`, `config-manager`, `configuration`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `export`, `import`, `mcp`, `migration`, `restore`, `skills`, `sync`, `webdav`
- **推荐理由：** DeepSeek Harness (DSH) backup & restore 
...
- **标签：** `agent-handoff`, `agent-skills`, `claude-code`, `codex`, `context-engineering`, `deepseek-harness`, `dsh`, `dsh-plugin`, `session-memory`
- **推荐理由：** Use this cross-platform skill in Codex o
...
- **标签：** `dsh-plugin`
- **推荐理由：** DSH 实现 workbuddy 同款选择 skill 功能 | WorkBud
...
- **标签：** `codex`, `cordis`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `import`, `mcp`, `model-context-protocol`, `openai-codex`, `sync`
- **推荐理由：** The ultimate 2-way bridge between OpenAI
...
- **推荐理由：** Multi-agent team collaboration for DeepS
...
- **推荐理由：** This Codex skill is adapted from DeepSee
...
- **标签：** `awesome-deepseek-harness`, `awesome-dsh-plugin`, `deepseek-harness`, `deepseek-harness-plugin`, `deepseek-harness-plugin-dev`, `deepseek-harness-plugins`, `dsh-plugin`, `dsh-plugin-market`, `dsh-plugins`, `ftshare`
- **推荐理由：** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持多市场行情
...
- **标签：** `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-plugins`
- **推荐理由：** DSH Skills Manager 基于 DeepSeek Harness 的
...
- **⭐ 星标：** 21
- **语言：** JavaScript
- **描述：** Swift Cycle governance skill adapter for DeepSeek Harness; user-invoked, version-pinned, and offline-verifiable.
- **标签：** `agent-skills`, `deepseek-harness`, `dsh`, `dsh-plugin`, `project-governance`, `swift-cycle`
- **推荐理由：** Swift Cycle governance skill adapter for
...
- **推荐理由：** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 s
...
- **标签：** `deepseek-harness`, `design-skills`, `design-system`, `dsh-plugin`, `ui`, `vibe-coding`, `web-design`
- **推荐理由：** Design aesthetics skill pack for DeepSee
...
- **⭐ 星标：** 18
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `ai-docs`, `deepseek-harness`, `deepseek-harness-plugin`, `docx`, `dsh-plugin`, `gongwen`, `wps-office`
- **推荐理由：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准
...
- **标签：** `agent-evaluation`, `ai`, `benchmark`, `bootstrap-ci`, `claude`, `claude-code`, `deepseek-harness`, `dsh-plugin`, `evaluation-as-code`, `evaluation-framework`, `knowledge-engineering`, `krippendorff-alpha`, `llm`, `llm-evaluation`, `llm-judge`, `multi-judge-ensemble`, `prompt-engineering`, `prompt-testing`, `rag-evaluation`, `skill-evaluation`
- **推荐理由：** OMK — Evidence-backed evaluation and obs
...
- **标签：** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `image-generation`, `skill`, `vision`
- **推荐理由：** Free image reading & generation for Deep
...
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`
- **推荐理由：** DSH 内测收官合影墙：GitHub OAuth 零权限登录 + 冻结白名单校验
...
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`
- **推荐理由：** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的
...
- **⭐ 星标：** 16
- **语言：** JavaScript
- **描述：** 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the end — the task bar handles the rest. ���� mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A game-like mission system for Matt Pocock skills in DeepSeek Harness. More by @FeatherHunter: 🎨 dsh-opencode-palette · ⚡ dsh-prompt
- **标签：** `agent`, `ai`, `claude`, `deepseek-harness`, `dsh`, `dsh-better-sidebar`, `dsh-plugin`, `github-issues`, `skills`, `wayfinder`
- **推荐理由：** 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the 
...
- **标签：** `color-scheme`, `customization`, `dark-mode`, `deepseek`, `deepseek-harness`, `developer-tools`, `dsh`, `dsh-plugin`, `javascript`, `npm`, `open-source`, `opencode`, `opencode-plugin`, `palette`, `skins`, `theme`, `theme-engine`, `themes`, `typescript`, `ui`
- **推荐理由：** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一键换上——
...
- **标签：** `agent-framework`, `agent-skills`, `ai-agents`, `claude-code`, `claude-skills`, `codex`, `cursor`, `database`, `dify`, `docker`, `dsh`, `dsh-plugin`, `kiro`, `kubernetes`, `llm`, `mcp`, `mysql`, `nexus`, `python`, `sonarqube`
- **推荐理由：** Package manager for AI agent assets — 42
...
- **推荐理由：** Reusable Codex skill for building and va
...
- **⭐ 星标：** 16
- **语言：** JavaScript
- **描述：** Bottom Info Bar — an information bar plugin for DeepSeek Harness: provider/model, live balance, peak/off-peak pricing with countdown, and real persisted per-session spend in a single line.
- **标签：** `awesome-dsh-plugin`, `balance`, `deepseek-harness`, `deepseekharness`, `dsh`, `dsh-plugin`, `dsh-plugins`, `plugin`, `usage-tracking`, `web`
- **推荐理由：** Bottom Info Bar — an information bar plu
...
- **推荐理由：** DirectorX as a DeepSeek Harness plugin: 
...
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`, `mcp`, `zhihu`
- **推荐理由：** DeepSeek Harness plugin, Skill, CLI and 
...
- **标签：** `agent-skills`, `cordis`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `plugin-development`
- **推荐理由：** Portable Agent Skill for developing and 
...
- **⭐ 星标：** 12
- **语言：** Shell
- **描述：** A curated list of plugins for DeepSeek Harness (dsh) — 精选 DeepSeek Harness ���件列表
- **标签：** `awesome-list`, `curated`
- **推荐理由：** 精选DeepSeek Harness插件列表
...
- **标签：** `registry`, `curated-list`, `plugin-directory`
- **推荐理由：** 经筛选去垃圾的DSH插件公开数据注册表。
...
- **标签：** `registry`, `verified`, `plugin-directory`
- **推荐理由：** 基于证据验证的可加载插件目录，含权限指引。
...
- **标签：** `registry`, `community`, `verified`
- **推荐理由：** 按星标排序的社区验证插件列表。
...
- **标签：** `registry`, `plugin-collection`, `curated`
- **推荐理由：** 精选实用的DeepSeek Harness插件合集。
...
- **标签：** `documentation`, `guide`, `plugin-navigation`
- **推荐理由：** 插件产品说明书，涵盖安装、权限与兼容性指南。
...
- **标签：** `portal`, `static-site`, `plugin-discovery`
- **推荐理由：** 零依赖静态网站，发现筛选安装227+插件。
...
- **⭐ 星标：** 2
- **语言：** JavaScript
- **描述：** Awesome DeepSeek Harness (dsh) — curated plugins, tools, skills & resources. Everything is a plugin.
- **标签：** `registry`, `resource`, `awesome-list`
- **推荐理由：** 精选插件、工具、技能与资源大全，万物皆插件。
...
- **标签：** `repository`, `bundle`, `verification`
- **推荐理由：** 支持Bundle和验证的DSH插件仓库集合。
...
- **标签：** `automated`, `directory`, `catalog`
- **推荐理由：** 每日通过GitHub Actions自动抓取的双语插件目录。
...
- **标签：** `ai-agents`, `awesome-list`, `deepseek`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** Evidence-led bilingual directory of Deep
...
- **标签：** `agent`, `deepseek-harness`, `discoverability`, `dsh-plugin`, `search`
- **推荐理由：** Plugin discoverability for DeepSeek Harn
...
- **推荐理由：** 🐳 DeepSeek Harness（DSH）工具全量清单——GitHub t
...
- **标签：** `ai-agent`, `awesome-dsh-plugin`, `chat-bot`, `deepseek-harness`, `dingtalk`, `dsh`, `dsh-plugin`
- **推荐理由：** DingTalk IM channel for DeepSeek Harness
...
- **⭐ 星标：** 1
- **语言：** Python
- **描述：** DSH plugins directory: 70+ verified DeepSeek Harness plugins, organized by what they do.
- **标签：** `ai-agents`, `awesome`, `awesome-list`, `deepseek-harness`, `dsh`, `dsh-plugins`, `plugins`
- **推荐理由：** DSH plugins directory: 70+ verified Deep
...
- **推荐理由：** Moved → github.com/awesome-dsh-plugin/aw
...
- **推荐理由：** A curated, evidence-aware shortlist of u
...
- **⭐ 星标：** 1
- **语言：** Python
- **描述：** 计算机｜金融｜法律｜HR｜制造｜医疗｜电商等行业精选 dsh 插件目录
- **推荐理由：** 计算机｜金融｜法律｜HR｜制造｜医疗｜电商等行业精选 dsh 插件目录

---

## 工作原理

1. **发现插件** — 搜索 GitHub 上匹配 `dsh-plugin`、`deepseek-harness`、`awesome-dsh-plugin` 等关键词的仓库
2. **AI 分类** — 每个插件由 AI 分析并分配到最合适的分类
3. **人工校正** — 修正表修复已知错误分类（awesome 列表等）
4. **每小时更新** — GitHub Actions 每小时运行一次，获取新插件并重新生成列表

---

## 贡献

发现遗漏的优质 DSH 插件？想改进分类？

- **[提交 Issue](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/issues)** — 报告错误或建议新插件
- **[Fork & 提交 PR](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender/fork)** — 修正 `scripts/fix-categories.js` 中的错误分类
- **⭐ 点星支持** — 帮助更多人发现这个项目！
...
- **Twitter/X**: [分享](https://twitter.com/intent/tweet?text=Check%20out%20this%20amazing%20AI-curated%20DeepSeek%20Harness%20plugin%20list!&url=https://github.com/tanle-mtr/dsh-plogin-plugin-recommender)
- **Reddit**: r/deepseek, r/localllama, r/Cline
- **Discord**: DeepSeek 社区服务器
...
*由 AI 自动生成 · 每小时通过 GitHub Actions 更新*

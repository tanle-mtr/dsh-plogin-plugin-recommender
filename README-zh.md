...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 216,827 | Core plugin framework for AI agents |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,021 | Open-source design tool with agent integration |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,723 | Multi-agent swarm orchestration platform |
...
- **标签：** `dsh`, `ai-agents`, `plugin-framework`
- **推荐理由：** AI插件生态核心框架
...
- **标签：** `multi-agent`, `skills`, `self-evolve`
- **推荐理由：** 自进化多智能体AI助手
...
- **标签：** `agent-orchestration`, `workspaces`, `multi-device`
- **推荐理由：** 跨设备统一的Agent编排与Workspace管理
...
- **标签：** `routing`, `injector`, `task-aware`
- **推荐理由：** 运行时注入器+任务感知路由器，提升推理质量
...
- **标签：** `agent-os`, `evaluation`, `evolution-loop`
- **推荐理由：** 带面试筛选的分阶段Agent进化操作系统
...
- **标签：** `long-horizon`, `control-plane`, `workflow`
- **推荐理由：** 长周期Agent控制面，支持持久化治理工作流
...
- **标签：** `preset`, `deepseek-harness`, `standard-tools`
- **推荐理由：** 两阶段预设，最小启动后加载完整Standard工具
...
- **标签：** `security`, `audit`, `cybersecurity`, `vulnerability`
- **推荐理由：** 审计AI生成代码中的幻觉包、漏洞和安全隐患
...
- **推荐理由：** 含RPC插件、子智能体、hashline编辑的编码Agent工具
...
- **标签：** `ios`, `mobile-automation`, `mcp`, `coding-agent`
- **推荐理由：** 提供22个智能体工具，在对话中实时控制iOS模拟器或真机自动化。
...
- **推荐理由：** 为Claude Code添加多模态视觉能力，支持截图和UI分析
...
- **标签：** `container`, `management`, `dsh`
- **推荐理由：** 隔离容器管理多版本DSH，嵌入式WebView，一键导入插件技能。
...
- **推荐理由：** 一键配置MCP和技能同步，支持DSH、Cursor、Codex等7+工具。
...
- **标签：** `codex`, `sync`, `mcp`
- **推荐理由：** OpenAI Codex与DSH双向桥接，聊天同步+MCP镜像，无缝切换工具。
...
- **⭐ 星标：** 24,675
- **语言：** TypeScript
- **描述：** 为 DeepSeek Harness (DSH) 插件��态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- **标签：** `desktop`, `dsh`, `electron`
- **推荐理由：** DSH生态现代化桌面客户端
...
- **推荐理由：** 开放���边栏底座，内置文件编辑/终端/Git/子代理页面
...
- **标签：** `floating-widget`, `plugin`, `deepseek-harness`
- **推荐理由：** 萌系鲸鱼浮动小部件，实时查看DeepSeek���额
...
- **标签：** `desktop-app`, `agentic-workflows`, `dsh-plugin`
- **推荐理由：** 本地优先的桌面工作区，集成会话与办公能力
...
- **标签：** `ui-components`, `interactive`, `charts`
- **推荐理由：** 聊天内嵌交互式UI组件：图表、表单、测验等
...
- **标签：** `desktop`, `windows`, `electron`, `gui`
- **推荐理由：** 功能完整的Windows桌面客户端，内置SSH和远程控制
...
- **标签：** `desktop`, `multi-model`, `local-first`, `tauri`
- **推荐理由：** 本地优先多模型桌面AI，支持自进化技能与隐私保护
...
- **标签：** `canvas`, `conversation`, `workspace`, `non-linear`
- **推荐理由：** 基于画布的对话工作空间，支持会话分叉与可视化浏览
...
- **标签：** `office`, `deepseek-harness-plugin`, `productivity`
- **推荐理由：** 在Harness内集成电子表格、文档、演示等完整办公套件，功能强大。
...
- **推荐理由：** 跨平台桌面客户端，灵感来自CodePilot，支持macOS/Windows/Linux。
...
- **标签：** `ios`, `ios-app`, `deepseek-harness-plugin`
- **推荐理由：** DSH原生iOS客户端，通过WebSocket连接，支持工作区和Agent轨迹查看。
...
- **标签：** `remote`, `p2p`, `cross-platform`
- **推荐理由：** P2P加密远程访问Harness，支持多端操作
...
- **标签：** `ui`, `usage-tracking`, `balance`
- **推荐理由：** 持久底部状态栏，实时显示提供商、余额和定价信息，一目了然。
...
- **推荐理由：** WorkBuddy风格技能选择器，直接在DSH编辑器中调用/ skill-name。
...
- **标签：** `bioinformatics`, `desktop`, `clinical`
- **推荐理由：** 生物信息学桌面应用，面向临床医生，支持离线模式和技能商店。
...
- **推荐理由：** 集成数据库/SSH/SFTP/Docker/AI助手的DevOps桌面。
...
- **标签：** `ui`, `dsh-plugin`, `compact`
- **推荐理由：** 为DSH上下文仪表板添加一键紧凑模式按钮。
...
- **标签：** `memory`, `local-first`, `markdown`, `rag`
...
- **标签：** `memory`, `self-evolving`, `token-savings`, `rag`
- **推荐理由：** 自演进记忆系统，节省35% token，混合检索
...
- **标签：** `memory`, `stateful-agents`, `agentic-rag`
- **推荐理由：** 构建状态保持Agent和RAG应用的内存库
...
- **标签：** `context-management`, `cordis-plugin`, `dsh-plugin`
- **推荐理由：** DSH上下文管理与可视化分析工具
...
- **标签：** `agent-memory`, `embeddings`, `skill-reranking`
- **推荐理由：** 将分散技能文件转化为可检索的向量知识库
...
- **推荐理由：** 官方DSH插件开发知识库，中英双语，插件开发必备参考。
...
- **标签：** `skills`, `distillation`, `knowledge`
- **推荐理由：** 提炼专业知识为可复用技能
...
- **标签：** `skills`, `workflow`, `agent-skills`
- **推荐理由：** 智能技能路由与工作流编排，显著提升代理效能
...
- **标签：** `cognitive-enhancement`, `agent-skills`
...
- **标签：** `video-generation`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 端到端AI技能，自动生成剪纸风解说视频
...
- **标签：** `agent-skills`, `research`, `web-search`
- **推荐理由：** 自动搜索8大中文平台，生成有据可查的研究报告
...
- **标签：** `computer-vision`, `ocr`, `multimodal`, `observability`
- **推荐理由：** 赋予AI视听能力，视频音频屏幕OCR带时间戳验证
...
- **推荐理由：** SQLite本地任务看板，支持AI认领审核，零iframe依赖
...
- **标签：** `creative-writing`, `novel`, `screenplay`, `drama`
- **推荐理由：** 专注小说、剧本、短剧创作的AI写作技能插件
...
- **标签：** `agent-skills`, `math-modeling`, `codex`
- **推荐理由：** 全栈自动数学建模竞赛Skill，GitOps流水线+强制代码自证，通用国赛美赛。
...
- **推荐理由：** 基于tushare的本地金融数据引擎，支持多Agent和MCP
...
- **标签：** `infra`, `skills`, `development`
- **推荐理由：** AI基础设施开发、优化和调试的专业技能
...
- **标签：** `research`, `marketing`, `skills`
- **推荐理由：** 88个研究和营销技能，兼容多平台智能体
...
- **标签：** `security`, `reverse`, `ctf`
- **推荐理由：** 87个逆向工程技能，用于CTF和安全研究
...
- **标签：** `skills`, `agent-learning`, `automation`
- **推荐理由：** 自动将成功会话转为可复用skill
...
- **推荐理由：** 将Superpowers技能移植到Reasonix
...
- **标签：** `skills`, `coding-agent`, `mentor`
- **推荐理由：** AI编程导师技能，自动审查代码
...
- **标签：** `multi-agent`, `collaboration`, `deepseek-harness`
- **推荐理由：** 支持多Agent协作，独立模型与共享工作区，团队协作利器。
...
- **推荐理由：** 独特中华传统智慧技能包，覆盖八字、风水、易经等，本地确定性引擎。
...
- **推荐理由：** 从DSH适配的代码简化技能，帮助生成更简洁可维护的代码。
...
- **推荐理由：** AI视频/图像/音频生成技能，支持可配置模型工具，创作流程完整。
...
- **推荐理由：** 专业QA技能框架，11个技能+共享知识库，让AI像资深测试工程师。
...
- **标签：** `agent-handoff`, `memory`, `cross-platform`
- **推荐理由：** 跨平台Agent交接技能，保留会话记忆和上下文连续性，无缝切换。
...
- **标签：** `game-development`, `godot`, `gdscript`, `dsh-plugin`
- **推荐理由：** Godot 4.x全栈游戏开发技能插件，运行时注册。
...
- **标签：** `engineering-discipline`, `quality-gate`, `dsh-plugin`
- **推荐理由：** 工程纪律质检插件，验证需求与实现交付质量。
...
- **标签：** `dsh-plugin`, `plugin-development`, `skill`
- **推荐理由：** 指导AI从零开发构建测试安装DSH插件。
...
- **⭐ 星标：** 20
- **语言：** TypeScript
- **描述：** 面向 DeepSeek Harness 的电影感��品视频 Agent Skill，包含 152 张镜头配方卡、Remotion 模板、代码组件和音频资产。
- **标签：** `motion-design`, `remotion`, `video`, `agent-skills`
- **推荐理由：** 152张电影感镜头配方卡+Remotion模板视频Agent。
...
- **推荐理由：** 开发DSH插件的标准Agent技能，兼容Claude Code/Codex。
...
- **标签：** `agent-preset`, `product-management`, `multi-agent`
- **推荐理由：** 模拟产品团队对话工作流，适合产品设计协作。
...
- **标签：** `agent-tools`, `llm-agents`, `cordis`
- **推荐理由：** 插件预检机制，提升Agent插件库利用率。
...
- **标签：** `api-docs`, `tools`, `chinese-platforms`
- **推荐理由：** 在DSH中搜索20个中国平台6.5万篇API文档
...
- **标签：** `mcp`, `skills`, `web-gui`, `dsh-plugin`
...
- **标签：** `prompt-engineering`, `image-generation`
- **推荐理由：** 工业级图像提示词模板库
...
- **标签：** `design`, `vector`, `agent-teams`, `flutter`
...
- **标签：** `mascot`, `pixel-art`, `gallery`, `community`
- **推荐理由：** AI编程助手吉祥物宠物公共画廊
...
- **标签：** `knowledge-cards`, `ui`, `visual`
- **推荐理由：** 将对话历史转化为精美可分享的知识点卡片。
...
- **标签：** `image-uploader`, `electron`, `utility`
- **推荐理由：** 支持60+图床的终极上传工具
...
- **标签：** `model-switch`, `utility`
- **推荐理由：** 一键切换Claude Code/Codex/DeepSeek/Kimi等模型
...
- **标签：** `marketplace`, `plugin-store`, `curated`
- **推荐理由：** 每日更新，经过审核的插件市场，安全高效
...
- **推荐理由：** 用ChatGPT/Claude/Grok订阅作DSH后端，OAuth免API密钥
...
- **推荐理由：** DSH插件枢纽的CLI工具，支持插件安装、管理和发现，提升效率。
...
- **推荐理由：** 追踪会话/每日成本、预算和令牌用量，支持官方及自定义提供商。
...
- **标签：** `discovery`, `automation`, `plugin`
...
- **标签：** `provider`, `llm`, `typescript`
- **推荐理由：** LLM提供商插件，支持模型目录和智能选择
...
- **标签：** `context`, `audit`, `ui`
- **推荐理由：** 上下文审计工具，检测重复冲突并统计token成本，含Web UI面板。
...
- **标签：** `awesome-list`, `registry`, `plugin-registry`
- **推荐理由：** DSH插件开放数据注册表，适合生态发现和工具检索。
...
- **标签：** `plugin-conflict`, `diagnostic`, `compatibility`
- **推荐理由：** 解决插件冲突和版本兼容性问题。
...
- **标签：** `awesome-list`, `directory`, `catalog`
- **推荐理由：** 千余插件全量清单，按星标排序。
...
- **标签：** `theme`, `webgpu`, `threejs`, `deepseek-harness`
- **推荐理由：** WebGPU海洋主题皮肤，视觉体验出众，专为DSH设计的沉浸式界面。
...
- **标签：** `ai-guide`, `tutorials`, `resource-list`
- **推荐理由：** 最全AI资源库与教程合集，覆盖多模型玩法
...
- **标签：** `curated-list`, `awesome-list`, `reference`
- **推荐理由：** 精选DSH插件大全，一站式���现所有工具与集成
...
- **标签：** `encyclopedia`, `knowledge-base`, `learning`, `mcp`
- **推荐理由：** 全维度AI资源百科：MCP、RAG、多模态、学习路线
...
- **推荐理由：** 一站式科研工作台：LaTeX编译、arXiv管理、实验追踪、GPU远程编排。
...
- **标签：** `academic-search`, `mcp`, `arxiv`, `research-workflow`
- **推荐理由：** 跨PubMed/arXiv/CrossRef学术检索，支持引用核验和引文图谱生成。
...
- **推荐理由：** 交互式K线分析插件，支持多市场行情、技术指标、基本面分析。
...
- **标签：** `evaluation`, `rag-evaluation`, `prompt-testing`, `dsh-plugin`
- **推荐理由：** 提示词/RAG/技能的证据化评估与可观测框架。
...
- **标签：** `awesome-list`, `guide`, `plugin-directory`
- **推荐理由：** 插件导航手册，含安装权限和兼容性说明。
...
- **标签：** `plugin-registry`, `ecosystem-radar`, `dsh-plugin`
- **推荐理由：** 自部署插件生态雷达，k8s实测发现15900+候选插件
...
- **标签：** `awesome-list`, `plugin-ecosystem`, `dsh-plugin`
- **推荐理由：** DeepSeek Harness插件生态全面精选清单
...
- **推荐理由：** 每日自动抓取GitHub，剔除蹭标签项目，精选推荐适合你的DSH插件。
...
- **⭐ 星标：** 254
- **语言：** Unknown
- **描述：** DeepSeek Harness 终极指南：快速入门、��源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **标签：** `awesome-list`, `deepseek-harness`, `guide`
- **推荐理由：** DSH终极指南：快速入门、资源推荐、精选插件与实用工具合集。
...
- **推荐理由：** 学习DSH原理、浏览插件市场、掌握最佳实践的一站式学习工具。
...
- **推荐理由：** DSH插件、技能、MCP服务器、补丁、编排器和UI的精选目录合集。
...
- **推荐理由：** 插件商城收录11000+ DSH插件，支持搜索、排名和免费公共API。
...
- **推荐理由：** 1958个插件的DSH总目录，支持中英文搜索和筛选
...
- **标签：** `community`, `catalog`, `plugin-marketplace`
- **推荐理由：** 社区维护的DSH插件聚合目录
...
- **标签：** `context`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-plugins`, `memory`, `npm`, `plugin`
- **推荐理由：** Proactive associative memory for DSH: zero-prompt recall injected before the mod
...
- **推荐理由：** Matt Pocock 技能面板（DSH Deck）：安装即自带 25 个工程与效率技能（mattpocock/skills v1.2.3：triage、gri
...
- **推荐理由：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word
...
- **推荐理由：**  Official Huawei Cloud plugin for AI agents — skills, MCP tools, safety guardrai
...
- **推荐理由：** Reusable Codex skill for building and validating DeepSeek Harness and Cordis plu
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `documentation`
- **推荐理由：** 腾讯官方技能Hub API文档与DSH插件示例。
...
- **标签：** `awesome-list`, `deepseek-harness`, `mcp`, `skills`
- **推荐理由：** DSH生态全量插件/工具/技能/资源精选列表。
...
- **标签：** `awesome-list`, `dsh-plugin`, `directory`, `nextjs`
- **推荐理由：** 含安装命令的公开DSH插件GitHub目录。
...
- **标签：** `awesome-list`, `bilingual`, `ai-agents`
...
- **标签：** `search`, `discoverability`, `agent`
- **推荐理由：** 从DSH Agent内部直接搜索npm和插件库。
...
- **标签：** `recommender`, `ai-agents`, `awesome-list`
- **推荐理由：** AI策展每小时更新的插件推荐，12大类190+插件。
...
- **标签：** `awesome-list`, `verified`, `ai-agents`
- **推荐理由：** 80+经过验证的DSH插件按功能分类整理。

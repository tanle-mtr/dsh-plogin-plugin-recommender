...
- **标签：** `coding-agent`, `terminal`, `cli`
- **推荐理由：** 终端AI编码代理，前缀缓存稳定。
...
- **标签：** `dsh-plugin`, `cordis`, `harness`
- **推荐理由：** 注入器+任务感知路由，优化DSH推理模式
...
- **标签：** `claude-code`, `codex`, `deepseek-harness`
- **推荐理由：** 一键切换Claude/Codex/Grok/DeepSeek多模型
...
- **标签：** `tui`, `claude-code`, `dsh`
- **推荐理由：** Claude Code风格TUI，鲸鱼主题实时状态回滚
...
- **标签：** `agent`, `desktop-app`, `mcp`, `privacy`
- **推荐理由：** 本地优先的Claude Cowork替代，多模型隐私优先
...
- **标签：** `security`, `cybersecurity`, `code-audit`
...
- **推荐理由：** 通过OAuth将ChatGPT/Claude/Grok订阅转为LLM提供者
...
- **标签：** `office`, `productivity`, `documents`
- **推荐理由：** 将电子表格、文档、幻灯片等办公能力整合进DSH。
...
- **标签：** `ai-infra`, `coding-agents`
- **推荐理由：** AI基础设施开发调试专用技能集合
...
- **标签：** `agent-skill`, `plugin-development`
- **推荐理由：** 构建DSH插件的标准工作流程
...
- **标签：** `code-simplification`, `skill`, `deepseek-harness`
- **推荐理由：** 从DSH适配的代码简化技能，提升代码质量
...
- **标签：** `package-manager`, `agent`, `cli`, `deepseek-harness`
- **推荐理由：** 42个技能和5个CLI的AI Agent资产包管理器
...
- **标签：** `plugin-development`, `agent-skills`, `deepseek-harness`
- **推荐理由：** 便携式插件开发与审计Skill，适合DSH生态开发者。
...
- **标签：** `neovim`, `plugin-manager`, `lua`, `editor`
- **推荐理由：** 简洁快速的Neovim插件管理器，Lua开发者必备。
...
- **标签：** `floating-widget`, `desktop`, `dsh-plugin`
- **推荐理由：** 可爱鲸鱼小部件监控账户余额
...
- **标签：** `ui`, `mcp`, `skill-management`
- **推荐理由：** Web界面统一管理Skill和MCP配置
...
- **标签：** `ui`, `plugin-management`, `capability-menu`
...
- **标签：** `desktop`, `tauri`, `docker`, `ssh`, `deepseek-harness`
- **推荐理由：** Tauri桌面整合数据库/SSH/Docker面板与AI助手，一体化开发运维。
...
- **标签：** `rag`, `knowledge`, `wiki`
- **推荐理由：** LLM知识平台，支持RAG与Wiki。
...
- **推荐理由：** 持久统一记忆层，支持Markdown和Milvus
...
- **标签：** `long-term-memory`, `agent`, `dsh-plugin`
- **推荐理由：** 共享持久记忆的私人AI代理中枢
...
- **标签：** `ai-agent`, `skills`, `memory`
- **推荐理由：** 自演化AI助手，支持记忆与知识。
...
- **标签：** `low-code`, `business`, `workflows`
...
- **标签：** `ai-workflow`, `plugin`, `dsh-plugin`
- **推荐理由：** 将AI对话转化为可复用工作流
...
- **标签：** `agent-skills`, `embeddings`, `rag`
- **推荐理由：** 将SKILL.md转为可检索的Agent技能库并支持评估
...
- **标签：** `task-management`, `project`, `sqlite`
- **推荐理由：** 原生任务看板，SQLite驱动，无需iframe的项目管理工具。
...
- **标签：** `skills`, `cross-platform`, `workflow`
- **推荐理由：** 跨平台技能系统，将经验转化为可重复执行流程。
...
- **标签：** `vision`, `multimodal`, `screen-analysis`
- **推荐理由：** 为Claude Code增添多模态视觉能力，支持截图/UI分析。
...
- **标签：** `agent-skills`, `self-evolution`
- **推荐理由：** 可组合可审查的Agent自进化工作流
...
- **推荐理由：** Superpowers技能适配Reasonix编码引擎，增强Agent能力
...
- **标签：** `coding-agent`, `mentor`, `education`
- **推荐理由：** AI编程导师，扫描项目架构并分步指导学习
...
- **标签：** `skills`, `task-board`, `workflow`
- **推荐理由：** MattSkillsDeck可视化任务看板
...
- **标签：** `skills`, `management`, `deepseek-harness`
- **推荐理由：** 统一加载管理本地 Agent 技能，安全可靠
...
- **标签：** `gongwen`, `document`, `chinese`, `deepseek-harness`
...
- **标签：** `swift-cycle`, `governance`, `deepseek-harness`
...
- **标签：** `qa`, `testing`, `agent-skills`, `deepseek-harness`
- **推荐理由：** 10个AI测试Skill+共享知识库，让AI像资深测试工程师。
...
- **推荐理由：** 自动将成功会话转换为可复用Agent Skill，学习利器。
...
- **标签：** `godot`, `game-development`, `gdscript`, `deepseek-harness`
- **推荐理由：** Godot 4.x全栈游戏开发Skill，运行时自动注册。
...
- **标签：** `web-search`, `mcp`, `browser`
- **推荐理由：** 免费网页搜索桥接，无需注册即可使用
...
- **标签：** `mcp`, `skills`, `web-gui`, `deepseek-harness`
- **推荐理由：** 浏览器内直接管理技能和MCP服务器
...
- **标签：** `mcp`, `hot-reload`, `skill-management`, `deepseek-harness`
- **推荐理由：** 粘贴JSON即连MCP服务器，热加载免重启，技能管理便捷。
...
- **标签：** `browser`, `extension`, `web`
- **推荐理由：** 浏览器扩展增强套件，多平台支持。
...
- **标签：** `bilibili`, `youtube`, `xiaohongshu`
- **推荐理由：** 跨平台抓取B站/抖音/小红书/YouTube等内容
...
- **推荐理由：** DSH内置iOS模拟器与USB手机自动化，22个工具
...
- **推荐理由：** 基于Playwright的浏览器自动化工具，支持DSH深度集成
...
- **标签：** `ai-agent`, `dingtalk`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 钉钉IM通道，将对话转为工具化智能体。
...
- **标签：** `session-migration`, `utility`
- **推荐理由：** 跨预设会话迁移，保留上下文和状态
...
- **标签：** `container`, `multi-version`, `management`
- **推荐理由：** 在隔离容器中运行多个DSH版本
...
- **标签：** `agent-migration`, `deepseek-harness`, `mcp`, `skills`
- **推荐理由：** 一键迁移Claude Code配置和技能到DeepSeek Harness。
...
- **标签：** `data-visualization`, `ai-cost`, `deepseek-api`, `dsh-plugin`
...
- **标签：** `ai-agents`, `chatgpt`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 通过OAuth将ChatGPT接入DSH，扩展模型支持。
...
- **标签：** `mascot`, `cli`, `pixel-art`
- **推荐理由：** 编程Agent终端的动效吉祥物宠物画廊
...
- **标签：** `theme`, `skin`, `ocean`, `webgpu`
- **推荐理由：** 基于WebGPU的海洋主题皮肤，Three.js驱动精美界面。
...
- **标签：** `theme`, `skin`, `opencode`, `deepseek-harness`
- **推荐理由：** 34款opencode配色一键切换，重启不丢
...
- **标签：** `prompt-engineering`, `research`, `analysis`
- **推荐理由：** 工业级提示词引擎，530+逆向案例。
...
- **标签：** `learning`, `reference`, `marketplace`
- **推荐理由：** 学习DSH原理、插件市场和最佳实践的优质参考资料。
...
- **标签：** `plugin-store`, `marketplace`, `directory`
- **推荐理由：** 收录11000+插件的庞大目录，支持搜索排名和免费API。
...
- **标签：** `marketplace`, `listing`, `plugins`
- **推荐理由：** 展示可用DeepSeek Harness插件的市场清单。
...
- **推荐理由：** 在Agent中直接搜索20个中国平台65,600+篇API文档
...
- **标签：** `patent`, `research`, `legal-tech`, `rag`
- **推荐理由：** 专利侵权分析系统，自动生成竞品分析报告
...
- **推荐理由：** GitHub 1000+ DSH工具按星标排序全量清单
...
- **推荐理由：** 在DSH内搜索插件，聚合npm与awesome-list数据。
...
- **标签：** `toy`, `web`, `simulation`
- **推荐理由：** 中国传统玩具竹知了的Web模拟版
...
- **标签：** `ai-encyclopedia`, `knowledge-base`, `learning`
- **推荐理由：** 全维度AI资源百科，覆盖Agent、RAG、MCP等
...
- **标签：** `anime`, `entertainment`
- **推荐理由：** 对话内多源搜番，卡片展示Bangumi评分
...
- **标签：** `evaluation`, `observability`, `rag`, `deepseek-harness`
- **推荐理由：** 证据驱动的提示词/RAG/Agent评估框架
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `community`
- **推荐理由：** DSH内测合影墙，OAuth零权限登录，趣味社区功能。
...
- **标签：** `plugin-registry`, `open-data`, `awesome-list`, `deepseek-harness`
- **推荐理由：** 反垃圾开源插件注册表，DSH生态官方目录参考。
...
- **标签：** `deepseek-harness`, `dsh-plugins`, `plugin-registry`
- **推荐理由：** DSH插件注册表，方便查找和管理插件。
...
- **标签：** `ai-agent`, `awesome-list`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 证据驱动的DSH插件雷达目录。
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh-plugin-directory`
...
- **标签：** `awesome`, `coding-agents`, `deepseek-harness`, `dsh-plugin`, `ui`
- **推荐理由：** 覆盖模型、工具、沙箱、UI的全方位插件目录。
...
- **标签：** `awesome-list`, `industry`, `directory`
- **推荐理由：** 精选覆盖7大行业的DSH插件目录，便于快速查找。

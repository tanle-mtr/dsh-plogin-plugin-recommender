...
- **标签：** `multi-agent`, `memory`, `skills`
- **推荐理由：** 自演进多智能体框架，支持记忆与技能
...
- **标签：** `tutorial`, `beginner`
- **推荐理由：** 零起点Harness工程入门教程。
...
- **标签：** `orchestration`, `workspace`
- **推荐理由：** 统一多设备Agent工作空间，自主追踪任务。
...
- **标签：** `preset`, `deepseek-harness`
- **推荐理由：** 两阶段预设：最小引导启动后接入完整Standard工具链
...
- **标签：** `virtual-terminal`, `agent-sandbox`
- **推荐理由：** 全球首个虚拟终端，为AI Agent提供隔离执行环境
...
- **标签：** `plugin-development`, `knowledge-base`, `docs`
- **推荐理由：** 官方文档归档与插件开发知识库，可作为即时调用的Agent技能
...
- **标签：** `context-audit`, `debugging`, `tool`
- **推荐理由：** 审计指令链和技能目录的Token成本与冲突检测工具
...
- **标签：** `dsh-plugin`, `agent-tools`, `capability`
...
- **标签：** `chatgpt`, `oauth`, `ai-agents`, `deepseek-harness`
- **推荐理由：** 通过OAuth扩展DSH的ChatGPT模型访问能力
...
- **标签：** `low-code`, `crm`, `no-code`
- **推荐理由：** AI增强型低代码平台，快速构建业务系统
...
- **标签：** `browser-extension`, `prompt-manager`
- **推荐理由：** 增强AI平台，跨浏览器统一提示管理器。
...
- **标签：** `desktop`, `cross-platform`
- **推荐理由：** DeepSeek Harness桌面客户端。
...
- **标签：** `enterprise`, `workbench`
- **推荐理由：** 企业级本地优先Agent工作台，支持多引擎团队。
...
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/对话/子代理页面
...
- **标签：** `task-board`, `ui`
- **推荐理由：** 现代化灵活任务面板，无缝嵌入Codex和DeepSeek Harness
...
- **⭐ 星标：** 3,124
- **语言：** TypeScript
- **描述：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼��栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **标签：** `tui`, `terminal`
- **推荐理由：** Claude Code-style TUI with whale status bar, streaming thoughts and rollback
...
- **推荐理由：** 轻量Tauri桌面版DSH，零环境配置，跨平台支持。
...
- **标签：** `desktop`, `gui`, `windows`
- **推荐理由：** 零配置Windows桌面GUI，内置SSH插件系统和远程访问
...
- **标签：** `desktop`, `local-first`, `mcp`
- **推荐理由：** 本地优先的AI桌面工作空间，支持项目、文件、MCP集成
...
- **标签：** `canvas`, `conversation`, `visualization`
...
- **标签：** `desktop-app`, `agent`, `multi-model`, `privacy`
- **推荐理由：** 本地优先���模型AI桌面Agent，隐私安全且技能可进化
...
- **标签：** `ios`, `mobile`, `kmp`, `native-client`
- **推荐理由：** 原生iOS客户端，将工作区和Agent执行轨迹带入手机
...
- **标签：** `desktop-app`, `electron`, `codepilot`, `cross-platform`
- **推荐理由：** 类CodePilot多平台桌面客户端，支持macOS Windows Linux
...
- **推荐理由：** 锤子便签开源版，支持Docker私有化部署和公众号格式导出
...
- **标签：** `mcp`, `skills`, `dsh-plugin`, `ui`
- **推荐理由：** Web界面技能与MCP管理面板，便捷可视化管理
...
- **标签：** `plugin-market`, `ui`, `dsh-plugin`
...
- **推荐理由：** Electron桌面控制台，多Tab管理插件/MCP/Skills
...
- **推荐理由：** 面向科研人员的一站式生物信息学桌面Agent，支持离线模式
...
- **推荐理由：** 一体化DevOps桌面：数据库/SSH/SFTP/Docker/AI一体
...
- **标签：** `desktop`, `electron`, `integration`, `dsh-web`
- **推荐理由：** Electron桌面壳集成DSH Web与侧边栏/ModLens/市场
...
- **标签：** `dsh-plugin`, `ui`, `knowledge-cards`
...
- **标签：** `memory`, `local-first`
- **推荐理由：** 本地优先的用户自有记忆层，自我进化。
...
- **标签：** `memory`, `hybrid-retrieval`
- **推荐理由：** 自我进化记忆，混合检索省35% token。
...
- **标签：** `memory-library`, `stateful`
- **推荐理由：** 构建有状态持久Agent的记忆库。
...
- **标签：** `memory`, `rag`, `milvus`, `agent-memory`
- **推荐理由：** 持久统一记忆层，基于Milvus嵌入和混合搜索。
...
- **标签：** `skill-management`, `rag`, `evaluation`
- **推荐理由：** 将SKILL.md转为可检索的技能语料库，附带评估工具
...
- **标签：** `memory`, `context`, `deepseek-harness`
- **推荐理由：** 自动记忆固化，零提示词即可调用历史知识
...
- **推荐理由：** 长期任务控制面，支持跨Harness的耐久编排治理
...
- **推荐理由：** 智能技能路由，奖励提升21pp，Token消耗降低近30%
...
- **标签：** `cognitive-enhancement`, `inference-control`
- **推荐理由：** Model-agnostic inference control for deep reasoning, verification and recovery
...
- **标签：** `writing`, `novel`, `creative-workflow`
- **推荐理由：** 网文/短剧创作工作流，内置小说与剧本工作台
...
- **标签：** `computer-vision`, `audio-understanding`, `agent-skills`, `multimodal`
- **推荐理由：** 赋予AI视觉和音频能力，提供可验证的时间戳证据
...
- **标签：** `task-management`, `sqlite`, `native-ui`, `workflow`
- **推荐理由：** 原生SQLite任务看板，支持Agent认领审查工作流
...
- **标签：** `ios-simulator`, `mobile-automation`, `ui-automation`, `mcp`
- **推荐理由：** 对话内嵌入iOS模拟器，22个Agent工具实现自动测试
...
- **⭐ 星标：** 251
- **语言：** Python
- **描述：** 全栈式自动数学建模竞赛Skill，支持 Claude Code / Codex / opencode / DeepSeek Harness。AI 担任 Autopilot，人类担任 Copilot；国赛/美赛通用，GitOps ���水线 + 强制代码自证，可选 addons 模块。
- **标签：** `agent-skills`, `math-modeling`, `workflow`
- **推荐理由：** 全栈数学建模竞赛Skill，支持国赛美赛自动化
...
- **⭐ 星标：** 199
- **语言：** TypeScript
- **描述：** 让 Agent 的工作方��可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **标签：** `agent-review`, `self-evolving`, `prompt-engineering`
- **推荐理由：** 可组合可审查的Agent自我进化模式
...
- **标签：** `agent`, `skills`, `cross-platform`
- **推荐理由：** 将经验转化为跨平台可复用Agent技能
...
- **标签：** `plugin-discovery`, `agent-skills`, `installation`
...
- **标签：** `ctf`, `pentest`, `reverse-engineering`, `dsh-plugin`
- **推荐理由：** 87个逆向与渗透测试技能，适合安全研究与授权测试
...
- **推荐理由：** AI基础设施开发专用技能，支持编写优化和高性能调试
...
- **标签：** `industry-research`, `cordis`, `dsh-plugin`
- **推荐理由：** 行业与公司研究技能包，含产业链映射和公开信息追踪
...
- **推荐理由：** Superpowers技能移植到Reasonix编码平台
...
- **推荐理由：** 来自Superpowers的TDD调试规划和协作技能包
...
- **标签：** `patent`, `agent-skills`, `legal-tech`
- **推荐理由：** 专利侵权分析系统，打包为skill可供任意agent调用
...
- **标签：** `ai-docs`, `deepseek-harness`, `gongwen`
- **推荐理由：** 公文全流程处理，格式检查修复和内容优化
...
- **标签：** `agent-platform`, `skills`, `deepseek-harness`
...
- **推荐理由：** 融合八字/风水/中医的传统智慧技能包，本地确定性引擎
...
- **标签：** `engineering-discipline`, `quality-gate`, `delivery`
- **推荐理由：** 工程纪律技能：校验需求、测试实现、验证交付质量
...
- **推荐理由：** 针对纯文本模型的像素转文字OCR技能，34图训练方法论
...
- **推荐理由：** 多Agent团队协作，支持独立模型、技能和共享工作空间
...
- **标签：** `multi-agent`, `durable`, `memory`
- **推荐理由：** 持久化多Agent团队，跨会话保持记忆、笔记和技能
...
- **⭐ 星标：** 33
- **语言：** HTML
- **描述：** 让 AI 像资深测试工程���一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **标签：** `qa`, `testing`, `test-automation`
- **推荐理由：** 11项QA技能框架+共享知识库，AI驱动的测试工程方案
...
- **标签：** `math-modeling`, `competition`, `research`
- **推荐理由：** 数学建模竞赛全流程技能包：数据、编程、写作、绘图
...
- **标签：** `planning`, `collaboration`, `workflow`
- **推荐理由：** 议行分离协作机制，先规划后执行的AI任务决策框架
...
- **推荐理由：** SkillHub官方API文档与示例，便于DSH集成
...
- **标签：** `skill-picker`, `dsh-plugin`, `composer`
- **推荐理由：** WorkBuddy风格技能选择器，提升操作效率
...
- **标签：** `code-simplification`, `codex-skill`, `dsh`
- **推荐理由：** 代码简化技能，输出更简洁可读
...
- **推荐理由：** 首个视觉插件，将图像转化为结构化JSON供纯文本Agent使用
...
- **标签：** `finance`, `mcp`, `database`, `multi-agent`
- **推荐理由：** 基于Tushare的本地财经数据库，支持MCP自动接口
...
- **标签：** `agent-plugins`, `mcp`, `web-search`
- **推荐理由：** 多平台AI代理的网页搜索与内容提取技能
...
- **标签：** `api-documentation`, `deepseek-harness`, `mcp`
- **推荐理由：** 零配置搜索20个中国平台65000+篇API文档
...
- **标签：** `cloud`, `mcp`, `deepseek-harness`
- **推荐理由：** 华为云官方工具集，含MCP和云沙箱能力
...
- **标签：** `image-generation`, `prompts`, `templates`
- **推荐理由：** GPT图像提示词库，含530+案例与工业模板
...
- **⭐ 星标：** 1,406
- **语言：** JavaScript
- **描述：** DeepSeek Harness 可编辑设��系统：AI 生成、可视化编辑、模板市场与 PPT｜Native Design & PPT Studio for DeepSeek Harness.
- **标签：** `design`, `ppt`, `visual-editor`
- **推荐理由：** 原生设计与PPT工作室，含AI生成和可视化编辑器。
...
- **推荐理由：** 跨平台自进化内容发现Agent，覆盖B站/YouTube/X等
...
- **标签：** `resume`, `self-hosted`, `mcp-server`
...
- **标签：** `multi-model`, `quota-management`
- **推荐理由：** 统一管理多Agent账号，智能多模型路由与自动故障转移
...
- **标签：** `marketplace`, `plugin-shop`, `ecosystem`
- **推荐理由：** 全面插件市场，每日更新，发布前审核。
...
- **推荐理由：** DSH插件中心CLI工具，支持Schema验证和插件管理
...
- **标签：** `office`, `spreadsheets`, `docs`, `productivity`
- **推荐理由：** 为DSH提供完整的办公套件，含表格文档演示画布
...
- **推荐理由：** 通过OAuth使用现有订阅账户作为DSH LLM提供商
...
- **标签：** `cost-tracking`, `budget`, `token-usage`, `analytics`
- **推荐理由：** 追踪会话和日常成本，支持预算提醒和多提供商余额
...
- **推荐理由：** 为DSH添加Command Code模型访问和计划感知选择
...
- **推荐理由：** 完整备份恢复DSH配置，支持迁移同步与WebDAV
...
- **标签：** `plugin-management`, `deepseek-harness`, `ui`
- **推荐理由：** 插件生态基建，含开发引导和浏览器面板管理
...
- **标签：** `migration`, `claude-code`, `session-import`
- **推荐理由：** 迁移向导，支持4款AI编程工具数据迁移
...
- **标签：** `terminal`, `keybindings`, `trace`, `enhancement`
...
- **标签：** `diagnostic`, `plugin-conflict`, `dsh-plugin`
- **推荐理由：** 自动检测和解决插件版本冲突的诊断工具
...
- **标签：** `animated-background`, `glassmorphism`, `ocean`, `theme`
- **推荐理由：** 实时海洋主题，支持波浪、日落和玻璃态效果自定义
...
- **⭐ 星标：** 7,873
- **语言：** TypeScript
- **描述：** DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创��工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
- **标签：** `web`, `aggregation`
- **推荐理由：** DSH插件聚合生态，探索插件发现。
...
- **标签：** `documentation`, `code-analysis`
- **推荐理由：** Generates accurate technical docs and AI-ready context from your codebase
...
- **推荐理由：** 一站式科研工作台：LaTeX编译、arXiv管理、GPU任务编排
...
- **推荐理由：** 全维度AI百科资源库，覆盖Agent、RAG、MLOps及学习路线
...
- **标签：** `epistemic-loop`, `scientific-discovery`, `agent-preset`
- **推荐理由：** 将认知循环方法论引入DSH，支持科学发现和Agent预设
...
- **标签：** `academic-search`, `research-workflow`, `mcp`, `citation-management`
- **推荐理由：** 多源学术检索+引用核验+引文图谱，科研利器
...
- **标签：** `agent-skills`, `research`, `workflow`, `marketplace`
- **推荐理由：** 88个开源研究营销业务技能，跨平台兼容
...
- **推荐理由：** 收录280+插件的精选目录，覆盖14类，方便快速发现和使用
...
- **⭐ 星标：** 29
- **语言：** HTML
- **描述：** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持��市场行情、技术指标、支撑压力位、新闻与基本面分析，并在原生侧栏中直接展示。
- **标签：** `kline`, `financial`, `technical-analysis`
- **推荐理由：** 侧栏交互式K线分析，含技术指标和新闻
...
- **推荐理由：** Vertical curated list for stock/finance/quant DSH plugins (24 verified)
...
- **⭐ 星标：** 8
- **语言：** Unknown
- **描述：** 好用的DeepSeek Harness插件集���
- **标签：** `awesome-list`, `dsh-plugin`
- **推荐理由：** 好用的DeepSeek Harness插件精选集
...
- **标签：** `awesome-list`, `dsh-plugin`, `ai-curated`
- **推荐理由：** AI整理190+插件分12类，每小时更新。
...
- **标签：** `awesome-list`, `dsh-plugin`, `radar`
- **推荐理由：** 有数据支撑的DSH插件雷达与风险评级。
...
- **标签：** `awesome-list`, `dsh-plugin`, `automated`
- **推荐理由：** 每日自动抓取的双语插件目录。
...
- **标签：** `dsh-plugin`, `portal`, `static-site`
- **推荐理由：** 静态网页门户，浏览安装227+款DSH插件。
...
- **标签：** `novel`, `writing`, `rag`, `creative`
- **推荐理由：** 功能完整的AI小说创作软件，含世界观和章节管理。
...
- **推荐理由：** 每日更新精选DSH插件目录，真实分类剔除蹭标签项目
...
- **⭐ 星标：** 270
- **语言：** Unknown
- **描述：** DeepSeek Harness 终极指���：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **标签：** `awesome-list`, `quickstart`, `resources`, `guide`
- **推荐理由：** DSH终极指南，含快速入门资源和精选插件工具包
...
- **标签：** `awesome-list`, `plugin-marketplace`, `catalog`
- **推荐理由：** 万款插件目录，支持搜索排名和API查询
...
- **标签：** `handbook`, `agent-runtime`, `mcp`, `documentation`
- **推荐理由：** 173个源码支撑的Agent手册，覆盖运行与调试
...
- **标签：** `awesome-list`, `plugin-catalog`, `marketplace`
- **推荐理由：** 近两千插件目录，支持分类筛选和智能排序
...
- **标签：** `awesome`, `agents`, `dsh-plugin`
- **推荐理由：** 精心整理的DSH插件清单，覆盖生产力工具
...
- **标签：** `plugins`, `dsh-plugins`, `dsh-ecosystem`
- **推荐理由：** DSH生态系统的插件仓库列表
...
- **标签：** `plugins`, `registry`, `dsh-plugin`, `skills`
- **推荐理由：** 覆盖模型、工具、沙盒和UI的精选插件注册表

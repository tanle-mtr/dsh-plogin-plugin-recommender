...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 202,385 | Core harness powering the entire DSH plugin ecosys |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,453 | Open-source design agent with local-first desktop  |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,664 | Multi-agent swarm framework with conversational AI |
...
- **标签：** `router`, `harness`, `reasoning`
- **推荐理由：** 任务感知推理模式路由，提升P1准确率。
...
- **标签：** `agentic-runtime`, `ai-ide`, `rust`
- **推荐理由：** Rust高性能Agent运行时与桌面AI IDE
...
- **标签：** `agent-vision-toolkit`, `computer-vision`, `ocr`, `deepseek-harness`
- **推荐理由：** 纯文本模型的视觉工具箱：OCR、多图问答、UI还原
...
- **标签：** `desktop`, `windows`, `ssh`, `gui`
- **推荐理由：** 功能完整的Windows桌面客户端，含SSH和移动端
...
- **标签：** `codex`, `mcp`, `sync`
- **推荐理由：** Codex与DSH双向桥接，同步对话、技能和MCP
...
- **标签：** `codex`, `simplification`, `code`
- **推荐理由：** 灵感来自Codex的代码简化技能，适合自动化重构场景
...
- **标签：** `plugin-creator`, `dsh-plugin`, `validation`
- **推荐理由：** 可复用的DSH插件创建与验证工具，提升开发效率
...
- **标签：** `plugin-dev`, `auditing`, `portable`
- **推荐理由：** 开发审核DSH插件和Bundle的便携式必备技能
...
- **推荐理由：** 快速优雅的Lua Neovim插件管理器，简洁轻量
...
- **标签：** `coding-agents`, `deepseek-v4-pro`, `dsh-plugin`
- **推荐理由：** 覆盖模型、工具、沙箱和UI的插件目录
...
- **标签：** `web-ui`, `dsh-plugin`, `ecosystem`
- **推荐理由：** DSH插件生态Web UI聚合，创意工坊分发平台。
...
- **标签：** `sidebar`, `ui-extension`, `terminal`
- **推荐理由：** 开源侧边栏底座，内置终端/编辑器/Git等功能
...
- **标签：** `deepseek-harness`, `desktop`, `tauri`, `dsh-plugin`
- **推荐理由：** 5MB轻量Tauri桌面端，预装插件，支持三大平台
...
- **标签：** `deepseek-harness`, `floating-widget`, `dsh-plugin`, `developer-tools`
- **推荐理由：** 萌系鲸鱼浮动组件，实时监控DSH账户余额
...
- **标签：** `desktop-app`, `electron`, `local-first`, `dsh-plugin`
- **推荐理由：** 本地优先的Electron桌面工作区，支持会话与项目管理
...
- **标签：** `ios`, `mobile`, `simulator`, `automation`
- **推荐理由：** DSH内运行iOS模拟器，22个移动端自动化工具
...
- **标签：** `office`, `ui-extension`, `univer`
- **推荐理由：** 在DSH中集成表格文档幻灯片等办公功能
...
- **推荐理由：** Electron桌面控制台，统一管理Harness、插件与MCP。
...
- **标签：** `context`, `audit`, `ui`
- **推荐理由：** Web UI面板审计上下文注入，检测token成本与冲突
...
- **推荐理由：** Tauri跨平台桌面应用，整合数据库/SSH/Docker和AI助手
...
- **标签：** `dsh-plugin-market`, `ui`, `awesome-dsh-plugin`
...
- **标签：** `memory`, `agent`, `mcp`, `personal-ai`
- **推荐理由：** 个人AI代理本地记忆中枢，共享持久上下文
...
- **标签：** `memory`, `rag`, `skills`, `embeddings`
- **推荐理由：** SKILL.md文件转检索就绪的智能体技能语料库
...
- **标签：** `knowledge-base`, `docs`
- **推荐理由：** 官方DSH插件开发知识库，含EN/ZH文档存档
...
- **标签：** `agent-skills`, `ai-code-review`, `code-quality`, `deepseek-harness`
- **推荐理由：** 基于12本经典工程书籍的AI代码审查，带严重程度标签
...
- **标签：** `agentteams`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 让DSH支持多智能体团队协作的工作流插件
...
- **标签：** `ai-workflow`, `browser-extension`, `prompt-management`, `productivity`
- **推荐理由：** 跨平台AI对话转可复用工作流工具
...
- **标签：** `creative-writing`, `ai-agents`, `drama-skills`
- **推荐理由：** 小说写作与短剧创作自动化技能
...
- **推荐理由：** 来自 obra/superpowers 的成熟编程技能
...
- **推荐理由：** Superpowers 技能适配 Reasonix 编码助手
...
- **推荐理由：** 88个开源Agent技能，覆盖研究、营销与社交情报。
...
- **标签：** `dsh-plugin`, `deepseek-harness`, `agent-skills`
- **推荐理由：** AI编程导师，生成阶梯式章节并自动判题与Code Review。
...
- **标签：** `agent-skills`, `spec-programming`
- **推荐理由：** 便携式规范驱动开发代理技能，支持vibe coding
...
- **标签：** `agent-skills`, `chinese-wisdom`
- **推荐理由：** 八字/风水/六爻AI技能包，本地确定性引擎+Dashboard
...
- **标签：** `agent-skills`, `task-management`
- **推荐理由：** 将GitHub Issues转为可视化任务板，便于技能委派
...
- **推荐理由：** GB/T 9704标准中文公文全流程处理，支持格式检查与优化
...
- **标签：** `swift-cycle`, `governance`, `skills`
- **推荐理由：** 版本锁定治理技能适配器，支持离线验证
...
- **标签：** `video`, `directorx`, `multimedia`
- **推荐理由：** AI视频/图像/音频技能，支持可配置多模态模型
...
- **标签：** `migration`, `skills`, `mcp`
- **推荐理由：** 无缝迁移Claude Code配置到DSH，保留技能和MCP配置
...
- **推荐理由：** 专业QA技能框架，含决策矩阵，适合AI测试Agent使用
...
- **推荐理由：** Godot 4.x全栈游戏开发技能，支持GDScript AI辅助开发
...
- **标签：** `canvas`, `creative`, `workflow`
- **推荐理由：** 无限画布+智能创意技能，支持可视化头脑风暴工作流
...
- **标签：** `engineering`, `discipline`, `portable`
- **推荐理由：** 可移植的工程纪律技能，基于证据的AI辅助开发
...
- **标签：** `agent`, `product-management`, `workflow`
- **推荐理由：** 虚拟产品团队Agent预设，覆盖PM到发布全流程
...
- **标签：** `agent-tool`, `capability-check`
- **推荐理由：** Agent任务预检，自动注入最相关Top-K插件
...
- **推荐理由：** 从DSH Web GUI设置页直接管理技能与MCP服务器
...
- **推荐理由：** JSON粘贴即连MCP服务器，热加载免重启，开箱即用
...
- **推荐理由：** OAuth集成ChatGPT插件，在DSH内使用订阅模型
...
- **标签：** `ai-design`, `ui-generator`, `dsh-plugin`
- **推荐理由：** 本地优先的开源设计AI代理，类Figma体验
...
- **标签：** `image-processing`, `photo-editing`, `editorial-design`
- **推荐理由：** 照片转编辑设计技能，支持场景感知布局与严格保真构图。
...
- **标签：** `theme`, `background`, `visual`
- **推荐理由：** 可自定义Web背景，支持预设氛围与实时预览
...
- **标签：** `bilibili`, `xiaohongshu`, `content-discovery`, `cross-platform`
...
- **标签：** `low-code`, `dsh-plugin`, `self-hosted`
...
- **推荐理由：** 用ChatGPT/Claude订阅直接作为DSH模型源
...
- **标签：** `compatibility-layer`, `migration`, `ecosystem`
- **推荐理由：** Pi与DSH生态互通的兼容层桥接工具
...
- **标签：** `marketplace`, `plugin-market`, `browser`
- **推荐理由：** 一键浏览安装更新所有 DSH 插件
...
- **推荐理由：** Web UI 内管理 Skill 与 MCP 工具
...
- **标签：** `market`, `plugin-market`, `community`
- **推荐理由：** 社区插件市场，一键安装管理
...
- **标签：** `dsh-plugin`, `deepseek-harness`, `ui`
...
- **标签：** `config-manager`, `backup`, `dsh-plugin`
- **推荐理由：** 通过WebDAV备份、恢复和同步完整DSH配置。
...
- **标签：** `dsh`, `containers`, `infrastructure`
- **推荐理由：** 多版本DSH隔离容器管理，内嵌WebView运行UI
...
- **推荐理由：** 一键同步多AI代理工具的MCP、Skills和配置
...
- **标签：** `mascot`, `animation`, `pixel-art`
- **推荐理由：** 动画宠物画廊，为编码Agent终端增添个性。
...
- **标签：** `ai`, `rag`, `vibe-coding`, `prompt`
- **推荐理由：** 全面AI资源库，含教程、提示词和知识库。
...
- **标签：** `harness`, `tutorial`, `dsh-plugin`
- **推荐理由：** 优秀的DSH插件开发入门教程，从零到一。
...
- **标签：** `encyclopedia`, `research`, `resources`
- **推荐理由：** AI全维度资源百科，大模型Agent RAG一站式导航
...
- **推荐理由：** 直接搜索20个中国开放平台的65,600+篇API文档。
...
- **标签：** `visualization`, `cost`, `token-tracking`
- **推荐理由：** 实时Token用量图表和成本估算，直接嵌入DSH网页界面
...
- **标签：** `agent-plugins`, `deepseek-harness`, `dsh`, `ecosystem-radar`
- **推荐理由：** 自动发现15900+插件候选，15分钟快照管线生成目录
...
- **标签：** `awesome-list`, `deepseek-harness`, `plugins`, `dsh`
- **推荐理由：** DSH插件生态精选列表，收录最全
...
- **标签：** `awesome-list`, `deepseek-harness`, `mcp`, `plugins`
- **推荐理由：** DSH生态精选列表，涵盖插件、工具和MCP基础设施
...
- **标签：** `directory`, `discovery`, `awesome-list`
- **推荐理由：** 公开插件目录，含安装命令和生态发现工具
...
- **标签：** `community`, `catalog`, `unofficial`
- **推荐理由：** 社区驱动的非官方插件目录，便于广泛探索DSH生态
...
- **标签：** `registry`, `spam-filter`, `open-data`
- **推荐理由：** 反垃圾插件注册表，含质量过滤和技能索引
...
- **标签：** `awesome-list`, `dsh-plugin`, `dsh-repository-plugin`
- **推荐理由：** DSH插件精选库，含验证功能
...
- **标签：** `ai-agents`, `mcp`, `plugin-recommender`
- **推荐理由：** AI推荐190+插件跨12类目录
...
- **标签：** `industry-plugins`, `dsh-plugin`, `deepseek-harness`
- **推荐理由：** 金融法律医疗等行业精选插件目录

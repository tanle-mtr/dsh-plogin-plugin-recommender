...
- **标签：** `agent-orchestration`, `agent-workspaces`, `no-code`, `mcp`
- **推荐理由：** 跨多端统一Agent工作台，支持任务看板管理
...
- **标签：** `routing`, `cordis`, `dsh-plugin`, `agent-orchestration`
- **推荐理由：** 运行时注入器+任务感知推理路由，优化Agent路由
...
- **标签：** `agent-os`, `loop-engineering`, `mcp`, `llm-orchestration`
- **推荐理由：** 自进化Agent OS，通过循环工程让Agent持续变强
...
- **标签：** `agent-collaboration`, `enterprise`, `multi-agent`, `visual-editor`
- **推荐理由：** 企业级多引擎Agent工作台，支��Codex和DSH可视化编辑
...
- **标签：** `preset`, `dsh-plugin`, `standard-tools`, `llm-agent`
- **推荐理由：** 两阶段预设：最小引导启动后加载完整标准工具
...
- **标签：** `coding-agents`, `architecture`, `agent-skills`
- **推荐理由：** 让编码代理具备架构感知和证据验证能力
...
- **⭐ 星标：** 305
- **语言：** Rust
- **描述：** ccteam turns the coding agents you already run (Claude Code, Codex, Grok, Kimi, DeepSeek Harness) into one team — any session can spawn, dispatch, and collect work from any vendor on any machine, while you steer it all from Telegram, Lark, or a browser tab. 把你在用的编程 agent 编成一支团���,跨厂商跨机器派活,Telegram/飞书/网页统一指挥。
- **标签：** `coding-agent`, `team`, `automation`
- **推荐理由：** 将多个编码代理整合为团队，支持会话派发。
...
- **标签：** `vision`, `multimodal`, `coding-agent`
- **推荐理由：** 为纯文本LLM编码助手添加多模态视觉
...
- **⭐ 星标：** 39
- **语言：** Unknown
- **描述：** An Agent Skills skill for developing DeepSeek Harness (DSH) plugins（开发 DSH 插件的 Agent Skill）——插��/服务/事件/工具/LLM 适配器/打包安装的标准。Works with Claude Code, Codex, DSH, VS Code Copilot & any compatible agent.
- **标签：** `agent-skill`, `plugin-development`, `dsh-plugin`
- **推荐理由：** 开发DSH插件的标准技能，支持slot/event/tool适配器
...
- **标签：** `dsh-plugin`, `plugin-management`, `agent-skill`
- **推荐理由：** 管理已安装插件的槽位、远程和凭证配置
...
- **标签：** `agent-framework`, `dsh-plugin`, `cli`
- **推荐理由：** 42项技能5个CLI的AI Agent工程包管理器
...
- **推荐理由：** 用于插件脚手架搭建与测试的Agent Skills
...
- **标签：** `dsh-web`, `web-ui`, `theme`, `desktop`
- **推荐理由：** Web GUI界面、任务看板、SSH运维及WebGL主题
...
- **标签：** `sidebar`, `ui`, `dsh-plugin`
- **推荐理由：** 开放侧边栏底座，支持内置编辑/终端/Git等多页面。
...
- **标签：** `desktop`, `electron`, `plugin-sdk`
- **推荐理由：** 桌面伴侣平台，带动画宠物和插件SDK
...
- **标签：** `desktop`, `tauri`, `electron`
- **推荐理由：** 轻量级Tauri桌面应用，预装插件零配置
...
- **标签：** `gui`, `components`, `interactive`
- **推荐理由：** 在回复中内联渲染交互式UI组件，如图表、表单。
...
- **标签：** `desktop-app`, `client`, `cross-platform`
- **推荐理由：** 跨平台桌面客户端，支持插件套件。
...
- **标签：** `marketplace`, `dsh-plugin`, `javascript`
- **推荐理由：** 在Web GUI中一键浏览安装所有DSH插件
...
- **推荐理由：** Electron桌面控制台，统一管理Harness/插件/MCP
...
- **标签：** `balance`, `usage-tracking`, `dsh-plugin`
- **推荐理由：** 常驻底部栏，实时显示提供商、模型和价格
...
- **推荐理由：** 浮动HUD面板显示git、MCP、技能和Token状态。
...
- **推荐理由：** 跨平台桌面应用整合数据库、SSH、Docker和AI助手。
...
- **推荐理由：** Electron桌面版DeepSeek Harness，集成多插件与自托管服务
...
- **推荐理由：** 本地优先的跨应用可携带记忆层，Markdown原生
...
- **标签：** `memory`, `rag`, `mcp`, `skills`, `token-savings`
- **推荐理由：** 自演进记忆系统，混合检索，节省35%token
...
- **推荐理由：** 连接PowerContext实现记忆、回忆和任务交接。
...
- **标签：** `agentic-workflow`, `multi-agent`, `swarm`
- **推荐理由：** 部署多智能体群和自主工作流
...
- **标签：** `ai-agent`, `skills`, `mcp`
- **推荐理由：** 自带记忆和知识的自进化AI助手
...
- **标签：** `agent-skills`, `meta-skill`, `knowledge-distillation`
- **推荐理由：** 提炼智能体思维模式为可复用技能
...
- **标签：** `gpt-image-2`, `prompt-engineering`, `skills`, `workflow-automation`
- **推荐理由：** 470+逆向工程提示词，20+工业模板，持续更新
...
- **标签：** `video-generation`, `agent-skill`, `dsh-plugin`
- **推荐理由：** 端到端自动生成Vox风格剪纸解说视频的技能。
...
- **标签：** `vision`, `agent-skills`, `multimodal`
- **推荐理由：** 让纯文本模型具备图像理解能力
...
- **标签：** `task-manager`, `agentic-workflow`, `mcp`
- **推荐理由：** 人机协作的实时任务管理工具
...
- **标签：** `agent-teams`, `multi-agent`, `orchestration`
- **推荐理由：** DSH多代理团队协作编排插件
...
- **标签：** `vision`, `gui-automation`, `ocr`
- **推荐理由：** 原生DSH视觉工具包，支持图片问答和UI还原
...
- **标签：** `agent-skills`, `skills`, `retrieval`
- **推荐理由：** 将SKILL.md转化为可检索的技能库，支持语义搜索
...
- **推荐理由：** SQLite任务看板，支持Agent认领与审核的原生UI
...
- **标签：** `multimodal`, `orchestration`, `subagent`
- **推荐理由：** 从Claude Code/Codex调度DSH Agent，支持子Agent编排
...
- **标签：** `skills`, `reasonix`, `coding-agent`
...
- **⭐ 星标：** 65
- **语言：** TypeScript
- **描述：** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你��写核心逻辑、自动判题、AI Code Review。
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`
- **推荐理由：** AI导师技能，扫描架构并带写核心逻辑和Code Review
...
- **标签：** `agent-skills`, `deep-research`, `marketing-automation`
- **推荐理由：** 88个开源技能，覆盖研究、社交智能与营销自动化
...
- **标签：** `legal-tech`, `visualization`, `timeline`
- **推荐理由：** 法律可视化技能，自动生成诉讼时间轴和图表
...
- **标签：** `spec-driven-development`, `ai-coding`, `dsh-plugin`
- **推荐理由：** 仓库原生规格驱动开发技能，支持vibe coding模式
...
- **标签：** `agent-skills`, `session-memory`
- **推荐理由：** 跨Agent会话记忆延续，保持任务上下文连贯
...
- **标签：** `agent-skills`, `code-simplification`
- **推荐理由：** 从DSH改编的代码简化技能，提升代码质量
...
- **标签：** `agent-skills`, `chinese-traditional-wisdom`
- **推荐理由：** 融合八字/风水/易经等传统智慧的AI Agent技能包
...
- **标签：** `dsh-plugin`, `skills-manager`
- **推荐理由：** DSH技能集中管理平台，简化技能维护
...
- **标签：** `multi-agent`, `deepseek-harness-plugin`
...
- **标签：** `agent-skills`, `human-in-the-loop`, `local-first`
- **推荐理由：** 本地优先的Run-to-Skill插件，支持人工介入。
...
- **标签：** `vision`, `ocr`, `mcp`, `multimodal`, `dsh-plugin`
- **推荐理由：** 首个视觉插件，将图片转为结构化JSON供文本Agent使用
...
- **标签：** `mcp`, `codex-sync`, `deepseek-harness`
- **推荐理由：** Codex与DSH双向同步，支持MCP自动镜像
...
- **⭐ 星标：** 15
- **语言：** TypeScript
- **描述：** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，���于在浏览器里管理技能（skills）与 MCP 服务器。
- **标签：** `dsh-plugin`, `mcp`, `web-gui`
- **推荐理由：** 浏览器内管理技能与MCP的Web UI插件
...
- **推荐理由：** 通过OAuth绑定ChatGPT账号，在DSH内直接调用ChatGPT模型
...
- **标签：** `agent-skills`, `architecture-diagram`, `diagrams-as-code`
- **推荐理由：** 生成精美架构图的Agent技能
...
- **标签：** `design`, `ui`, `agent-team`, `vibedesign`, `mcp`
...
- **标签：** `image-generation`, `ai-art`, `visual`
...
- **标签：** `design`, `ui-design`, `opendocument`
...
- **标签：** `ai-agent`, `cross-platform`, `dsh-plugin`
- **推荐理由：** 本地优先的跨平台AI内容发现Agent，覆盖多平台。
...
- **标签：** `browser-extension`, `chrome-extension`, `workflow`
...
- **标签：** `low-code`, `internal-tool`, `workflows`
- **推荐理由：** AI驱动的无代码平台，构建业务系统
...
- **标签：** `vfs`, `virtual-filesystem`, `agent-tools`, `mcp`
- **推荐理由：** 首个AI Agent统一虚拟文件系统抽象层
...
- **⭐ 星标：** 975
- **语言：** TypeScript
- **描述：** The best DeepSeek Harness plugin for context insight and management, with context dashboard / browser and context command, for context statistics, composition, breakdown, evolution details, understanding how the context is made of, and how it evolves. 一站式 DeepSeek Harness 上下文可视化插件，Context 面板及浏览���与 Context 命令，透视上下文组成、演进、压缩、剪枝等事件与动作。
- **标签：** `context`, `dashboard`, `utility`
- **推荐理由：** DSH上下文洞察面板和管理工具
...
- **标签：** `cost-tracking`, `token-usage`, `infrastructure`
- **推荐理由：** 实时追踪LLM费用，支持预算预警
...
- **标签：** `anime`, `search`, `utility`
- **推荐理由：** 对话内多源搜番，显示Bangumi评分
...
- **标签：** `context-migration`, `preset-migration`, `session`
- **推荐理由：** 跨预设会话迁移，固定模式保留状态与意图
...
- **推荐理由：** 崩溃恢复插件，支持撤销、快照和离线SAFE MODE
...
- **标签：** `deepseek-harness`, `desktop-app`, `dsh-plugin`
- **推荐理由：** 容器化多版本DSH管理，内嵌WebView一键导入插件
...
- **⭐ 星标：** 19
- **语言：** TypeScript
- **描述：** DSH 上下文注入审计插件：统计 AGENTS.md 指令链/技能目录/工具 schema 的 token 成本，检测重复与冲突；Web UI 圆环���板 + context_audit 工具。Context Doctor for DeepSeek Harness: audit instruction-chain / skill catalog / tool schemas token cost.
- **标签：** `context-audit`, `utility`, `ui`
- **推荐理由：** 上下文注入审计工具，检测重复冲突，含Web UI
...
- **标签：** `config-manager`, `backup`, `migration`
- **推荐理由：** DSH配置完整备份恢复迁移，支持WebDAV同步
...
- **标签：** `plugin-manager`, `gui`, `mcp`
- **推荐理由：** 内嵌GUI管理MCP、技能和插件，支持热重载。
...
- **标签：** `plugin-doctor`, `conflict-resolution`, `dsh-plugin`
...
- **标签：** `pets`, `mascot`, `pixel-art`, `theme`
- **推荐理由：** 像素风动态宠物画廊，支持Codex、Claude、DSH等
...
- **标签：** `color-scheme`, `customization`, `dark-mode`, `theme`
...
- **推荐理由：** 自动搜索中国8大平台30天内容，生成可溯源研究报告。
...
- **标签：** `awesome-list`, `resource`, `plugin-market`
- **推荐理由：** 双语精选DSH插件与工具导航库。
...
- **标签：** `awesome-list`, `discovery`, `verification`
- **推荐理由：** 自动抓取、人工核实的插件发现目录。
...
- **标签：** `encyclopedia`, `knowledge-base`, `resource`
- **推荐理由：** 全维度AI资源百科，覆盖Agent、RAG、MCP。
...
- **标签：** `guide`, `resource`, `awesome-list`
...
- **标签：** `awesome-deepseek-harness`, `dsh-plugin`, `dsh-plugin-market`
- **推荐理由：** 交互式K线分析，支持多市场和技术指标
...
- **推荐理由：** 2026年精选插件合集，含质量审核，适合查找优质插件
...
- **标签：** `plugin-directory`, `awesome-list`, `dsh`
- **推荐理由：** 插件导航与说明书，含安装指南、权限和风险说明
...
- **标签：** `awesome-list`, `plugin-registry`, `2origin`
- **推荐理由：** 基于证据的插件雷达，含2Origin实验室评测
...
- **标签：** `plugin-portal`, `static-site`, `awesome-dsh`
- **推荐理由：** 零依赖静态门户，浏览筛选227+精选DSH插件
...
- **推荐理由：** 在DSH智能体内搜索npm和精选插件列表，便于发现插件
...
- **标签：** `recommender`, `ai-curated`, `awesome-list`
- **推荐理由：** AI每小时更新，覆盖12类190+插件的综合推荐列表
...
- **标签：** `dsh-plugins`, `plugin-verify`, `bundle`
- **推荐理由：** DSH插件仓库与Bundle，含验证功能
...
- **标签：** `fun`, `toy`, `dsh-plugin`
- **推荐理由：** 竹知了网页模拟版，零依赖单文件，移动端优先。
...
- **标签：** `marketplace`, `plugin-store`, `directory`
- **推荐理由：** 插件市场含3100+插件，支持API查询
...
- **标签：** `awesome`, `awesome-list`, `plugins`
- **推荐理由：** 精心整理的DSH插件优秀列表
...
- **标签：** `registry`, `plugin-registry`
- **推荐理由：** 防垃圾的DSH插件和技能开放数据注册表。
...
- **推荐理由：** 每日自动爬取dsh-plugin主题，自动化插件发现
...
- **标签：** `awesome-list`, `dsh-plugins`, `ui`
- **推荐理由：** 覆盖模型、工具、沙盒、UI和智能体循环的全方位清单
...
- **标签：** `industry`, `dsh-plugin`
- **推荐理由：** 计算机、金融、法律、HR、制造、医疗、电商等行业精选插件
...
- **标签：** `registry`, `plugin-manager`
- **推荐理由：** 合并多源搜索的插件注册中心，去重统一

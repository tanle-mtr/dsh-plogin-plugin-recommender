...
- **标签：** `ai-agent`, `multi-model`, `self-evolving`
- **推荐理由：** 多模型全能Agent，支持记忆与自我进化。
...
- **标签：** `agent-orchestration`, `workspace`, `mcp`, `no-code`
- **推荐理由：** 统一Agent工作空间，支持跨设备任务追踪编排。
...
- **推荐理由：** 自我进化Agent OS，支持循环工程与LLM评估。
...
- **标签：** `code-review`, `static-analysis`, `auto-fix`
- **推荐理由：** 基于经典工程书籍的AI代码审查，带自动修复能力。
...
- **推荐理由：** 打通Pi与DSH生态，无缝运行Pi扩展为DSH插件。
...
- **标签：** `plugin-discovery`, `agent-skills`, `verification`
- **推荐理由：** DSH内搜索、安装和验证GitHub插件的Skill。
...
- **标签：** `reasonix`, `superpowers`, `coding-agent`
- **推荐理由：** Superpowers技能移植到Reasonix编码Harness。
...
- **推荐理由：** 代码简化技能，源自DeepSeek Harness官方
...
- **推荐理由：** 便携式Agent技能，用于开发审计DSH插件并附带Bundle适配器
...
- **标签：** `dsh-web`, `web-ui`, `marketplace`, `plugin-aggregator`
- **推荐理由：** 基于Web的插件聚合器，创意工坊分发平台。
...
- **标签：** `widget`, `balance-monitor`, `ui`
- **推荐理由：** 可爱的浮动小鲸鱼，实时显示账户余额的桌面挂件。
...
- **标签：** `ui`, `dsh-plugin`, `charts`
- **推荐理由：** 在聊天回复中内联渲染交互式UI组件。
...
- **推荐理由：** 跨平台Electron桌面客户端，Inspired by CodePilot。
...
- **推荐理由：** DSH官方Windows桌面客户端，支持SSH、远程访问和插件系统。
...
- **推荐理由：** Electron桌面控制台，多标签管理DSH与插件
...
- **标签：** `context`, `audit`, `ui`
- **推荐理由：** 上下文审计插件，带Web UI和token成本统计
...
- **推荐理由：** 为WeShop Cordis提供无限画布与智能创意技能
...
- **推荐理由：** 跨平台桌面应用，整合数据库SSH Docker及AI助手
...
- **⭐ 星标：** 6
- **语言：** JavaScript
- **描述：** 桌��版 DeepSeek Harness：Electron 壳 + 自托管 dsh web 服务，集成 dsh-better-sidebar / dsh-web-ui / ModLens / awesome-dsh-plugin / dshmarket
- **标签：** `desktop`, `electron`, `integration`, `plugin`
- **推荐理由：** Electron桌面版DSH，集成多个插件，一键部署自托管服务
...
- **标签：** `ui`, `theme`, `background`, `customization`
- **推荐理由：** 自定义DSH Web背景，支持上传和预设，实时预览所见即所得
...
- **推荐理由：** 可移植自进化记忆层，Markdown原生本地优先存储。
...
- **标签：** `memory`, `local-first`, `multi-agent`
- **推荐理由：** 本地记忆中枢，为所有AI智能体提供共享持久记忆。
...
- **标签：** `rAG`, `skill-management`, `dsh-plugin`
- **推荐理由：** 将SKILL.md文件转化为可检索的技能语料库。
...
- **标签：** `knowledge-distillation`, `agent-skills`, `meta-skill`
...
- **标签：** `multi-agent`, `workbench`, `enterprise`, `skills`
- **推荐理由：** 企��级多引擎工作台，支持可视化编辑与Agent协作。
...
- **推荐理由：** 本地优先AI Agent，具自我进化技能与隐私保护。
...
- **标签：** `web-search`, `dsh-plugin`, `agent-skill`
- **推荐理由：** 最强免费网页搜索桥接，无需注册。
...
- **推荐理由：** 全自动数学建模竞赛Skill，支持GitOps和代码自证。
...
- **⭐ 星标：** 163
- **语言：** TypeScript
- **描述：** 让 Agent 的工作方式可组��、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human-reviewed self-evolution.
- **标签：** `agent-review`, `self-evolving`, `prompt-engineering`
- **推荐理由：** 可组合可审查的Agent自我进化工作流。
...
- **标签：** `superpowers`, `tdd`, `debugging`
- **推荐理由：** TDD调试规划超能力，适配DSH Agent。
...
- **标签：** `dsh-plugin`, `coding-agent`, `mentor`
- **推荐理由：** AI编程导师，教学架构并自动代码审查
...
- **标签：** `plugins`, `slots`, `credentials`
- **推荐理由：** 管理插件槽位、凭据和Typert远程连接
...
- **标签：** `spec-programming`, `agent-skills`, `vibe-coding`
- **推荐理由：** 面向仓库的规范驱动开发技能，内置DSH工程模式
...
- **标签：** `chinese-wisdom`, `fengshui`, `bazi`
- **推荐理由：** 八字/风水/易经/中医一体化传统智慧AI技能
...
- **标签：** `skills`, `task-board`, `visualization`
- **推荐理由：** 可视化任务板，让MattSkillsDeck技能可派发管理
...
- **标签：** `skill-picker`, `ux`, `shortcut`
- **推荐理由：** WorkBuddy风格技能选择器，支持快捷命令插入
...
- **⭐ 星标：** 23
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政��关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `gongwen`, `docx`, `ai-docs`
- **推荐理由：** 支持公文格式检查、内容优化、模板生成全流程
...
- **⭐ 星标：** 15
- **语言：** Python
- **描述：** 让 AI 像资深测试工程师一样工作：全生命周期 QA Agent Skills 框架——方法论 + 10 Skills + 可复现 Benchmark（Claude Code 等 Agent 可用）
- **标签：** `agent-skills`, `qa`, `test-automation`
- **推荐理由：** 全生命周期QA Agent框架，含10个技能与可复现评测基准
...
- **推荐理由：** 通过设置页热加载MCP和技能，无需重启即可配置管理
...
- **推荐理由：** Godot Engine 4.x全栈GDScript游戏开发技能插件
...
- **标签：** `agent-skills`, `development-practices`
- **推荐理由：** 从DSH提炼的工程纪律，制成便携式Agent技能
...
- **推荐理由：** 虚拟产品团队插件，模拟PM/工程师/QA/发布全流程协作
...
- **标签：** `figma-alternative`, `ui-generator`, `design-systems`
- **推荐理由：** 开源Figma替代，本地优先AI设计工具。
...
- **标签：** `diagram-as-code`, `architecture`, `mermaid-alternative`
- **推荐理由：** AI驱动架构图与工作流可视化即代码。
...
- **标签：** `design`, `flutter`, `react`, `vibedesign`, `agent-team`
...
- **推荐理由：** 内置AI生成、可视化编辑与PPT支持的原生设计工具。
...
- **标签：** `image-generation`, `dsh-plugin`, `visual`
- **推荐理由：** 直接在DSH对话中生成图片。
...
- **标签：** `openpencil`, `ui-design`, `design`
- **推荐理由：** 对话内预览编辑OpenPencil UI设计文档。
...
- **标签：** `visualization`, `legal-tech`, `litigation`, `svg`
- **推荐理由：** 法律诉讼可视化，自动生成时间轴与案件图
...
- **标签：** `design`, `styles`, `vibe-coding`
- **推荐理由：** 6种设计风格，避免网站AI生成外观
...
- **标签：** `image`, `generation`, `vision`
- **推荐理由：** 免费图像读取和生成，支持视觉转录
...
- **标签：** `browser-extension`, `prompt-manager`, `ai-studio`
- **推荐理由：** 全平台AI网页UI增强套件与提示词管理器。
...
- **标签：** `browser-extension`, `workflow`, `multi-platform`
...
- **标签：** `ios`, `mobile-automation`, `dsh-plugin`
- **推荐理由：** 内置iOS模拟器，22个工具控制真机与模拟器。
...
- **推荐理由：** Tabbit浏览器插件，基于Playwright自动化。
...
- **标签：** `portal`, `web`, `static-site`, `discovery`
- **推荐理由：** 零依赖静态网站，浏览筛选227+插件，轻量高效
...
- **标签：** `marketplace`, `skills`, `installation`
- **推荐理由：** 类CodeX插件市场，一站式浏览安装DSH技能插件
...
- **标签：** `photo`, `social`, `oauth`
- **推荐理由：** GitHub OAuth合影墙，含白名单校验
...
- **标签：** `routing`, `injector`, `cordis`, `dsh-plugin`
- **推荐理由：** 运行时注入器+任务感知路由器，优化Agent推理流程。
...
- **标签：** `preset`, `standard-tools`, `dsh-plugin`, `bootstrap`
- **推荐理由：** 两阶段预设，提供可靠的DSH启动与标准工具链。
...
- **推荐理由：** 首款视觉插件，将图像转为结构化JSON赋能文本Agent��
...
- **标签：** `vfs`, `virtual-filesystem`, `agent-tools`, `bash`
- **推荐理由：** 统一虚拟文件系统，抽象本地与远程存储供Agent使用。
...
- **标签：** `model-switch`, `cli`, `infrastructure`
- **推荐理由：** 一键切换Claude/Grok/DeepSeek等模型
...
- **标签：** `oauth`, `llm-provider`, `dsh-plugin`
- **推荐理由：** 通过OAuth将ChatGPT/Claude订阅作为DSH提供商。
...
- **标签：** `task-management`, `native-web-ui`, `sqlite`
...
- **推荐理由：** 锤子便签开源版，Docker部署，支持skill调用。
...
- **标签：** `marketplace`, `plugin-management`, `nodejs`
- **推荐理由：** 一键浏览安装更新DSH生态全部插件。
...
- **标签：** `config-manager`, `backup`, `mcp`, `sync`
- **推荐理由：** DSH配置备份恢复同步，支持WebDAV迁移
...
- **标签：** `containers`, `ui`, `multi-version`
- **推荐理由：** 隔离多版本容器管理DSH，内嵌WebView界面
...
- **标签：** `codex`, `sync`, `mcp`
- **推荐理由：** Codex与DSH双向同步桥接，自动镜像MCP和技能
...
- **标签：** `package`, `manager`, `assets`
- **推荐理由：** 包管理器，含42技能、5个CLI和1个插件
...
- **推荐理由：** 无缝迁移Claude Code配置、技能和MCP设置到DSH
...
- **标签：** `conflict`, `utility`, `plugin-manager`, `fix`
- **推荐理由：** 检测并解决插件冲突和版本不兼容问题，保障稳定运行
...
- **标签：** `mascot`, `pixel-art`, `sprites`, `theme`
- **推荐理由：** 动效宠物画廊，为多平台Agent增添趣味视觉主题。
...
- **⭐ 星标：** 18
- **语言：** JavaScript
- **描述：** 🎨 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一��换上——tokyonight、dracula、gruvbox、matrix、rose-pine……即点即换，重启不丢。34 opencode themes for DeepSeek Harness, one click, persisted. More by @FeatherHunter: ⚡ dsh-prompt · 🧠 dsh-mattpocock-skills-deck
- **标签：** `themes`, `skins`, `color-scheme`
- **推荐理由：** 34款opencode主题，一键切换且持久保存
...
- **标签：** `ai`, `rag`, `vibecoding`, `prompt`
- **推荐理由：** 全面AI资源库，适合新手学习大模型玩法与提示词。
...
- **标签：** `agent`, `harness`, `tutorial`, `dsh-plugin`
- **推荐理由：** 从零开始学习Harness工程的入门教程。
...
- **标签：** `knowledge-base`, `dsh-plugin`, `ai-encyclopedia`
- **推荐理由：** 全面AI知识百科，覆盖Agent、RAG、MLOps等。
...
- **标签：** `awesome-list`, `agent-harness`, `developer-tools`
- **推荐理由：** DSH终极指南，含快速入门和精选插件推荐。
...
- **⭐ 星标：** 199
- **语言：** JavaScript
- **描述：** DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动���集与格式校验，免费搜索 API。deepseek1024.com
- **标签：** `plugin-marketplace`, `catalog`, `registry`
- **推荐理由：** DSH插件市场，超1.1万插件、搜索和免费API。
...
- **标签：** `api-documentation`, `chinese-api`, `deep-research`
- **推荐理由：** 在Agent内直接搜索6.5万篇中国平台API文档
...
- **标签：** `patent-analysis`, `rag`, `legal-tech`, `intellectual-property`
- **推荐理由：** RAG专利侵权分析系统，自动生成权利要求对比图
...
- **标签：** `kline`, `trading`, `analysis`
- **推荐理由：** 交互式K线图分析，支持技术指标和市场资讯
...
- **推荐理由：** 公共GitHub目录，提供DSH插件发现和安装命令
...
- **标签：** `awesome-list`, `plugin-catalog`
- **推荐理由：** 非官方社区DSH插件目录，便于插件发现
...
- **标签：** `plugin-registry`, `open-data`, `curated-list`
- **推荐理由：** 经垃圾过滤的开放数据DSH插件注册表
...
- **标签：** `awesome-list`, `verified`, `guide`
- **推荐理由：** 基于证据的插件目录，提供已验证插件及安装指导
...
- **标签：** `awesome-list`, `star-ranked`, `verified`
- **推荐理由：** 按星标排序的已验证社区插件集合，便于筛选发现
...
- **标签：** `awesome-list`, `collection`, `useful`
- **推荐理由：** 精选好用的DSH插件合集，实用性强
...
- **标签：** `awesome-list`, `navigation`, `guide`
- **推荐理由：** 按场景选插件并了解权限、兼容性风险的实用导航
...
- **推荐理由：** 1000+ DSH工具全量清单，按Star排序，生态全景视图
...
- **标签：** `deepseek-harness`, `dsh-repository-plugin`, `dsh-plugin-verify`
- **推荐理由：** 带验证和分析功能的DSH插件仓库
...
- **标签：** `awesome-list`, `ai-agent`, `plugin-registry`
...
- **推荐理由：** AI curated 190+插件��表，每小时更新
...
- **标签：** `coding-agents`, `plugin-directory`, `ui`, `skills`
- **推荐理由：** 涵盖模型、工具、沙箱和UI的全面插件目录
...
- **标签：** `toy`, `simulation`, `lightweight`
- **推荐理由：** 传统玩具Web模拟版，零依赖单文件
...
- **标签：** `prompt`, `deepseek-specific`, `utility`
- **推荐理由：** DeepSeek专用提示词插件，请合规使用。
...
- **标签：** `documentation`, `dsh-plugin`, `guide`
...
- **标签：** `plugin-marketplace`, `collection`
- **推荐理由：** DSH插件市场合集页面，方便浏览发现插件。
...
- **标签：** `awesome-list`, `plugin-directory`, `reference`
- **推荐理由：** DSH插件精选合集，方便发现与参考。
...
- **标签：** `awesome-list`, `plugins`, `dsh-ecosystem`
- **推荐理由：** DSH插件精选列表，便于发现优质插件
...
- **⭐ 星标：** 84
- **语言：** JavaScript
- **描述：** Awesome DSH Cordis Plugins — the official, auto-generated list of DeepSeek Harness Cordis plugins, curated by cordis.run 由 cordis.run 精选维护的 DeepSeek Harness Cordis 插件官方自动生成��表。
- **标签：** `awesome-list`, `plugin-marketplace`, `dsh`
- **推荐理由：** cordis.run官方自动生成插件目录

...
- [Agent 技能与工作流](#agent-技能与工作流) — 36 个插件
...
- [Agent 技能与工作流](agent-skills-workflows-zh) (36)
...
- **标签：** `multi-agent`, `mcp-server`, `skills`
- **推荐理由：** 多智能体蜂群编排与自动化工作流框架
...
- **标签：** `multi-agent`, `mcp`, `skills`
- **推荐理由：** 多模型AI助手，支持自我进化记忆与技能
...
- **标签：** `agent-orchestration`, `coding-agent`, `no-code`
- **推荐理由：** 跨设备统一Agent工作空间，支持任务追踪与自托管
...
- **标签：** `agent-orchestration`, `dsh-plugin`, `cordis`
- **推荐理由：** 任务感知路由注入器，带可测量的推理模式预设
...
- **标签：** `agent-os`, `loop-engineering`, `llm-orchestration`
- **推荐理由：** 自进化Agent操作系统，支持循环工程与评估改进
...
- **标签：** `enterprise-agent-workspace`, `multi-agent`, `agent-skills`
- **推荐理由：** 企业级本地优先多Agent工作台，支持多引擎协作
...
- **标签：** `agent-runtime`, `desktop`, `coding-agent`
- **推荐理由：** Rust高性能Agent运行时，搭配精美桌面IDE应用。
...
- **标签：** `code-review`, `static-analysis`, `developer-tools`
- **推荐理由：** 基于12本经典工程书籍的AI代码审查，带严重性标签和引用。
...
- **标签：** `mobile-automation`, `mcp`, `dsh-plugin`
- **推荐理由：** 在对话中直接接入iOS模拟器与真机控制，22个自动化代理工具。
...
- **标签：** `ai-infra`, `skills`, `coding`
- **推荐理由：** AI基础设施开发调试专项技能包
...
- **标签：** `superpowers`, `reasonix`, `skills`
- **推荐理由：** Superpowers技能移植到Reasonix编码环境
...
- **推荐理由：** 一键搜索20个中国平台6.5万+API文档，零配置。
...
- **标签：** `codex`, `mcp`, `sync`, `developer-tools`
- **推荐理由：** Codex与DSH双向桥接，同步聊天、技能与MCP。
...
- **推荐理由：** 审计上下文注入成本，检测重复与冲突，Web UI可视化。
...
- **标签：** `plugin-development`, `cordis`, `skill`
- **推荐理由：** 便携式技能，用于开发审计DSH插件。
...
- **标签：** `dsh-web`, `dsh-web-ui`, `plugin-ecosystem`
- **推荐理由：** DSH网页UI聚合包，创意工坊分发一切插件
...
- **标签：** `sidebar`, `ui-extension`, `dsh`
- **推荐理由：** 可扩展侧边栏底座，内置文件编辑/终端/Git/子代理页面。
...
- **标签：** `tui`, `ui-extension`, `terminal`
- **推荐理由：** 鲸鱼顶栏风格的TUI插件，支持实时状态和流式思考。
...
- **⭐ 星标：** 960
- **语言：** JavaScript
- **描述：** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随��面自动启用，建议直接喊来你的dsh安装
- **标签：** `widget`, `ui`
- **推荐理由：** 可爱的浮动小鲸鱼组件，监控账户余额
...
- **标签：** `desktop-app`, `agent`, `dsh-plugin`, `privacy`
- **推荐理由：** 本地优先的多模型AI桌面代理，隐私保护且技能可自进化。
...
- **推荐理由：** 跨平台桌面客户端，类CodePilot体验，支持插件套件。
...
- **推荐理由：** 功能丰富的Electron桌面客户端，支持SSH和移动端
...
- **标签：** `notes`, `smartisan`, `multi-tenant`
- **推荐理由：** 锤子便签风格，一键部署，支持导出图片
...
- **推荐理由：** Electron桌面控制台，一站式管理DSH和插件生态。
...
- **标签：** `agent-memory`, `long-term-memory`, `rag`
- **推荐理由：** 可移植的本地优先Markdown记忆层，跨应用持久化
...
- **标签：** `memory`, `rag`, `agent`
- **推荐理由：** 强大的Agent记忆管理工具，支持持久化存储与RAG检索。
...
- **推荐理由：** 基于Milvus的持久统一记忆层，支持混合语义检索。
...
- **推荐理由：** 全维度AI资源百科，涵盖MCP、RAG、Agent及学习路线。
...
- **标签：** `agent-memory`, `embeddings`, `vector-search`
- **推荐理由：** 将SKILL.md文件转化为可检索的agent技能库
...
- **标签：** `memory`, `agent-memory`, `mcp`
- **推荐理由：** 持久化长期记忆，支持检索回忆工具
...
- **推荐理由：** 基于J-space全局工作空间研究的AI认知增强技能套件。
...
- **标签：** `agent`, `skill`, `workflow`
- **推荐理由：** 将多个编程代理整合为协同团队，跨会话调度能力强。
...
- **标签：** `creative-writing`, `drama-skills`, `skill`
- **推荐理由：** 小说和短剧创作的技能插件
...
- **标签：** `agent-skill`, `knowledge-base`, `scaffold`
- **推荐理由：** 官方DSH文档插件化，中英双语按需调用。
...
- **标签：** `agent-handoff`, `context-engineering`, `session-memory`
- **推荐理由：** 跨Agent会话记忆续传，工作上下文无缝衔接。
...
- **标签：** `chinese-traditional-wisdom`, `agent-skills`, `dashboard`
- **推荐理由：** 八字/风水/奇门等传统智慧融合为确定性AI技能包。
...
- **标签：** `dsh-plugin`, `agent-skills`, `ui`
- **推荐理由：** WorkBuddy风格技能选择器，Composer内一键插入。
...
- **标签：** `multi-agent`, `dsh-plugins`, `team-collaboration`
- **推荐理由：** 多Agent协作框架，独立模型/技能与共享工作区。
...
- **标签：** `skills-manager`, `dsh-plugins`, `utility`
- **推荐理由：** DSH技能集中管理插件，支持安装与组织技能。
...
- **标签：** `agent-skills`, `swift-cycle`, `project-governance`
- **推荐理由：** 版本锁定的Swift Cycle治理技能，离线可验证。
...
- **标签：** `agent-skills`, `image-generation`, `vision`
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `oauth`
- **推荐理由：** 零权限OAuth合影墙，含DSH Skill封装。
...
- **标签：** `gongwen`, `docx`, `skill`
- **推荐理由：** 中文公文全流程处理：格式检查、模板与修订。
...
- **标签：** `agent-framework`, `skills`, `mcp`
- **推荐理由：** 42个技能与CLI的智能体工程包管理器。
...
- **标签：** `ai-director`, `video-editing`, `skill`
- **推荐理由：** AI视频/图像/音频技能，支持可配置模型工具。
...
- **标签：** `skills`, `gamification`, `agent`
- **推荐理由：** 游戏化任务系统，迷雾地图与任务栏推进。
...
- **标签：** `godot-engine`, `game-development`
...
- **标签：** `canvas`, `mcp-tools`, `skills`
- **推荐理由：** 无限画布配合创意技能和MCP工具。
...
- **标签：** `record-replay`, `computer-use`
- **推荐理由：** 录制macOS工作流并转为agent技能。
...
- **推荐理由：** 首个视觉插件，将图像转为结构化JSON供文本Agent使用
...
- **推荐理由：** 统一虚拟文件系统抽象，实现Agent可移植文件操作
...
- **标签：** `design-tool`, `ui`, `vibecoding`
- **推荐理由：** 开源AI原生矢量设计工具，支持多Agent协作与设计即代码
...
- **标签：** `ui`, `dsh-plugin`, `visualization`
- **推荐理由：** 在对话中内联渲染图表、表单等交互式UI组件。
...
- **标签：** `canvas`, `workspace`, `dsh-plugin`
- **推荐理由：** 基于画布的可视化非线性对话工作空间，支持分支探索。
...
- **标签：** `design-skills`, `ui`, `vibe-coding`, `web-design`
- **推荐理由：** 6种视觉风格包，让vibe编码网页摆脱AI默认风格。
...
- **推荐理由：** 跨平台开源内容发现Agent，支持B站、抖音、小红书等多平台。
...
- **推荐理由：** 最强免费网页搜索插件，无需注册和API密钥即可使用。
...
- **标签：** `preset`, `harness-standard`, `dsh-plugin`
- **推荐理由：** 两阶段最小引导预设，Project2评分接近满分
...
- **标签：** `installer`, `model-switch`, `cli`
- **推荐理由：** 一键安装并切换Claude Code、Codex、DeepSeek等多种CLI工具。
...
- **标签：** `toy`, `web`, `single-file`
- **推荐理由：** 零依赖单文件网页竹知了玩具模拟，移动端优先。
...
- **推荐理由：** 通过OAuth将订阅账号转为DSH的LLM提供商，节省API费用。
...
- **标签：** `marketplace`, `plugin-manager`, `dsh`
- **推荐理由：** Web GUI一键浏览安装更新所有插件
...
- **标签：** `market`, `community`, `plugin`
- **推荐理由：** 社区插件市场，一键安装卸载到Profile
...
- **标签：** `awesome-list`, `dsh-plugins`, `plugin-market`
- **推荐理由：** 收录280+插件的分14类精选目录，快速发现优质插件。
...
- **标签：** `config-manager`, `backup`, `webdav`, `migration`
- **推荐理由：** 完整DSH配置备份恢复，支持WebDAV同步与迁移。
...
- **标签：** `dsh-plugin`, `mcp`, `capability-management`
- **推荐理由：** 统一管理MCP工具和技能的作用域及执行模式。
...
- **标签：** `agent-migration`, `configuration-migration`
- **推荐理由：** 无缝迁移Claude Code配置到DSH。
...
- **标签：** `ai-cost`, `data-visualization`
- **推荐理由：** 实时Token用量、成本图表和API余额。
...
- **标签：** `theme`, `color-scheme`, `ui`
- **推荐理由：** 34款opencode经典配色一键更换，重启不丢。
...
- **标签：** `research`, `web-search`, `china`
- **推荐理由：** 自动搜索国内8大平台近30天内容并生成可查证研究报告。
...
- **⭐ 星标：** 206
- **语言：** Unknown
- **描述：** DeepSeek Harness 终极���南：快速入门、资源推荐、精选插件与实用工具 ｜The Ultimate Guide to DeepSeek Harness: QuickStart, Resources, Plugins&Toolkit
- **标签：** `awesome-list`, `deepseek-harness`, `plugins`
- **推荐理由：** 全面的DSH指南，精选插件与资源合集
...
- **标签：** `awesome-list`, `mcp`, `dsh-plugins`
- **推荐理由：** 涵盖插件、MCP服务器、补丁的精选资源列表
...
- **推荐理由：** DeepSeek Harness生态系统的插件市场中心
...
- **⭐ 星标：** 162
- **语言：** TypeScript
- **描述：** DeepSeek Harness 搜番插件：对话内多源搜索番剧，��片展示 Bangumi 评分与详情，支持复制磁力。
- **标签：** `anime-search`, `bangumi`, `torrent`
- **推荐理由：** 多源番剧搜索，显示Bangumi评分和磁力链接
...
- **标签：** `kline`, `technical-analysis`, `finance`
- **推荐理由：** 交互式K线分析插��，支持多市场行情与技术指标。
...
- **标签：** `recommender`, `awesome-list`, `dsh-plugin`
- **推荐理由：** AI推荐插件列表，12分类每小时更新。
...
- **标签：** `awesome-list`, `deepseek-harness`, `resources`
- **推荐理由：** 涵盖插件、工具、技能的全面DSH资源库。
...
- **标签：** `awesome-list`, `dsh-plugins`, `verified`
- **推荐理由：** 70+经认证的插件，按功能分类整理。
...
- **标签：** `registry`, `dsh-plugin`, `curated`
- **推荐理由：** 覆盖模型、工具、沙箱、UI的注册表。
...
- **标签：** `industry`, `awesome-list`, `dsh-plugin`
- **推荐理由：** 计算机、金融、法律等行业精选插件目录。
...
- **推荐理由：** Distilly — Distill how they think into reusable Skills for any Agent or Bot. For
...
- **推荐理由：** NocoBase is an open-source AI + no-code platform for building business systems f
...
- **推荐理由：** Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an 
...
- **推荐理由：** 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
...
- **推荐理由：** Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manage
...
- **推荐理由：** 程��员鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 OpenClaw 保姆级教程、大模型玩法（DeepSeek / GPT / Gem
...
- **推荐理由：** Prompt as Code | GPT-Image2 工业级提示词引擎与模板库，530+ 个案例逆向工程，20+ 套工业级模板，并提炼出Skills，持续更新
...
- **推荐理由：** 插件雷达与精选榜，9000+候选自动发现与人工策展
...
- **标签：** `armor-breaking`, `prompt`, `dsh-plugin`
- **推荐理由：** DeepSeek专用破甲提示词稳定化工具插件。
...
- **标签：** `documentation`, `learning`, `dsh-plugin`
...
- **标签：** `agents`, `awesome-list`, `deepseek`, `dsh-plugin`, `plugins`
- **推荐理由：** DSH生态精选插件目录，便于发现和探索。
...
- **⭐ 星标：** 13
- **语言：** Unknown
- **描述：** DSH 插件开发踩坑与做法档案（skill + 文档）：cordis 双副本、tsconfig 三���套、Windows junction、多帧 zstd 等实测记录
- **标签：** `documentation`, `plugin-development`
- **推荐理由：** DSH插件开发踩坑档案与最佳实践文档。
...
- **标签：** `skill`, `engineering`, `practices`
- **推荐理由：** 便携式技能，浓缩DSH开发工程纪律。
...
- **标签：** `awesome`, `awesome-dsh`, `awesome-dsh-plugin`, `deepseek`, `deepseek-ai`, `deepseek-harness`, `deepseek-harness-plugin`, `deepseek-v4`, `dsh-plugin`
- **推荐理由：** 致力于解决各插件之间也与版本之间可能存在的冲突问题并提供解决方案
...
- **标签：** `agent`, `agent-preset`, `ai-agents`, `awesome-dsh-plugin`, `deepseek-harness`, `deepseekharness`, `dsh`, `dsh-plugin`, `dsh-plugins`, `preset`, `product-management`
- **推荐理由：** Product Team Mode - a DeepSeek Harness a
...
- **推荐理由：** Spam-filtered, open-data registry of Dee
...
- **标签：** `awesome`, `deepseek-harness`, `dsh-plugin`, `finance`, `quant`, `reusable`, `stock`, `trading`
- **推荐理由：** Curated vertical list of stock/finance/q
...
- **标签：** `agent-tools`, `ai-agents`, `awesome-dsh-plugin`, `cordis`, `dsh`, `dsh-plugin`, `llm-agents`
- **推荐理由：** 给 DSH agent 的插件库"起飞前检查单"——任务型请求时自动预检插件库并
...
- **标签：** `marketplace`, `dsh-plugin`, `bundle`
- **推荐理由：** 类CodeX的DSH插件市场，集中管理插件。

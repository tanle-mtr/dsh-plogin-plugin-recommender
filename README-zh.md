...
- **标签：** `agent-orchestration`, `workspace`, `no-code`, `mcp`
- **推荐理由：** 统一智能体工作区，支持看板任务追踪和多端访问。
...
- **标签：** `enterprise`, `multi-agent`, `workbench`, `coding-agent`
- **推荐理由：** 企业级多引擎智能体工作区，统一支持Codex、DeepSeek和OpenCode。
...
- **标签：** `agent-os`, `mcp`, `llm-orchestration`, `evaluation`
- **推荐理由：** 自演进智能体OS，带面试门禁评估、预算循环和14运行时MCP。
...
- **标签：** `vision`, `ocr`, `multimodal`, `image-to-text`, `agent-skills`
- **推荐理由：** 首个视觉插件，将图片转为结构化JSON供纯文本Agent使用。
...
- **推荐理由：** 虚拟终端与文件系统，为AI Agent提供隔离运行环境。
...
- **标签：** `agentic-runtime`, `rust`, `code-agent`, `desktop`
- **推荐理由：** 高性能Rust Agent运行时，集成桌面应用与多Agent协作能力
...
- **标签：** `vision-tools`, `ocr`, `gui-automation`, `computer-vision`
- **推荐理由：** 纯文本模型的视觉工具箱，支持图片问答、OCR与截图还原
...
- **推荐理由：** 支持RPC插件、子Agent、哈希行编辑和MCP的编码代理工具
...
- **标签：** `security`, `cybersecurity`, `vulnerability`, `audit`
- **推荐理由：** AI安全攻防平台，审计AI生成代码的幻觉包和漏洞风险
...
- **标签：** `deepseek-harness`, `office`, `dsh-plugin`
- **推荐理由：** 为DSH提供完整的办公套件，含文档/表格/演示
...
- **标签：** `llm-provider`, `oauth`, `dsh-plugin`
- **推荐理由：** 通过OAuth将ChatGPT/Claude/Grok订阅作为LLM提供商
...
- **推荐理由：** 原生SQLite任务看板，支持智能体认领与审核流程
...
- **推荐理由：** 新增Command Code模型支持与计划感知选择
...
- **标签：** `ios-simulator`, `mcp`, `mobile-automation`
- **推荐理由：** 在DSH中嵌入实时iOS模拟器，含22个智能体自动化工具
...
- **推荐理由：** 安全P2P远程访问方案，支持PC/Android/Web多端操作。
...
- **标签：** `audit`, `skill-management`
- **推荐理由：** DSH技能调用审计与应用内Skill管理工具。
...
- **标签：** `plugin-discovery`, `installation`, `skill`
- **推荐理由：** 自动搜索安装验证DSH GitHub插件的Skill。
...
- **推荐理由：** AI编程导师，扫描架构生成阶梯式教学，带手写核心逻辑
...
- **标签：** `plugin-creator`, `scaffold`, `development-tool`
- **推荐理由：** 可复用插件脚手架，快速构建和验证DSH插件
...
- **标签：** `context`, `deepseek-harness`, `ui`, `tool`
- **推荐理由：** 审计上下文token成本，检测指令链重复与冲突
...
- **推荐理由：** 类WorkBuddy技能选择器，集成至DSH作曲器
...
- **标签：** `cordis`, `orchestration`, `launcher`
- **推荐理由：** 统一DSH运行时、插件和MCP编排的核心能力
...
- **标签：** `plugin-doctor`, `conflict-resolution`, `deepseek-harness`
...
- **标签：** `chatgpt`, `dsh-plugin`, `oauth`, `ai-agents`
...
- **标签：** `desktop`, `dsh-desktop`, `native-app`
- **推荐理由：** DSH官方桌面客户端，为DeepSeek Harness提供原生应用体验。
...
- **推荐理由：** 基于Web的插件聚合中心，通过创意工坊发现和分发DSH插件。
...
- **标签：** `sidebar`, `ui-extension`, `dsh-plugin`, `terminal`
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/Git/子���理页面。
...
- **标签：** `taskboard`, `ui-extension`, `skills`, `codex`
- **推荐理由：** 现代化可灵活嵌��的任务面板，支持Codex和DSH。
...
- **推荐理由：** TUI补位插件：鲸鱼顶栏/流式思考/上下文进度实时展示。
...
- **标签：** `floating-widget`, `dsh-plugin`, `cordis`
- **推荐理由：** 可爱鲸鱼浮动小部件，实时显示账户余额，支持拖拽吸附
...
- **推荐理由：** 轻量Tauri桌面客户端，5MB安装，预装插件零配置
...
- **标签：** `desktop`, `gui`, `ssh-client`, `electron`
- **推荐理由：** 零配置Windows桌面GUI，内置SSH、Codex、插件和移动端远程访问
...
- **标签：** `desktop`, `local-first`, `react`, `typescript`
- **推荐理由：** 本地优先的AI桌面工作区，支持会话、项目、文件和Office文档管理
...
- **推荐理由：** 在回复中内联渲染交互式UI组件，支持图表、表单和测验
...
- **标签：** `canvas`, `workspace`, `conversation`, `visual`
- **推荐理由：** 基于画布的非线性对话工作区，支持可视化会话分支探索
...
- **标签：** `desktop-app`, `privacy`, `multi-model`
- **推荐理由：** 本地优先AI桌面应用，支持多模型和自进化技能
...
- **标签：** `mobile`, `ios`, `websocket`
- **推荐理由：** DSH原生iOS客户端，支持工作区和智能体轨迹
...
- **标签：** `desktop-app`, `electron`, `multi-os`
- **推荐理由：** 类CodePilot桌面客户端，全平台插件套件
...
- **推荐理由：** 开源锤子便签，支持Docker部署与Skill调用。
...
- **标签：** `ui`, `web`, `market`, `plugin`
- **推荐理由：** 集成于Web GUI的社区插件市场，一键安装
...
- **标签：** `web-platform`, `skills`, `typescript`
...
- **标签：** `bioinformatics`, `desktop-app`, `single-cell`
- **推荐理由：** 生物信息学Agent桌面，技能商店+离线模式
...
- **标签：** `ui-extension`, `info-bar`, `desktop`
- **推荐理由：** 替换composer状态栏，显示模型用量与配额信息
...
- **推荐理由：** 集成数据库、SSH、SFTP、Docker和AI助手的开发运维桌面中心。
...
- **推荐理由：** Electron桌面壳，集成dsh-web-ui、ModLens等插件。
...
- **推荐理由：** 可移植的本地优先记忆层，支持Markdown原生存储和跨应用RAG。
...
- **标签：** `memory`, `rag`, `agent`, `knowledge-management`
...
- **推荐理由：** 基于Milvus的统一持久记忆层，支持多Agent语义检索
...
- **标签：** `rag`, `embeddings`, `vector-search`, `skill-corpus`
- **推荐理由：** 将分散的SKILL.md转化为可检索的Agent技能库，支持语义搜索与重排序
...
- **推荐理由：** 官方文档知识库，按需查询DSH/Cordis开发指南
...
- **标签：** `skillhub`, `documentation`, `open-api`
- **推荐理由：** 腾讯SkillHub开放API知识库，插件示例丰富
...
- **标签：** `skills`, `skill-store`, `multi-platform`
- **推荐理由：** 最全面的技能商店，自动聚合多平台GitHub技能。
...
- **推荐理由：** 长程Agent控制面，支持跨Codex/Claude Code的持久化编排。
...
- **推荐理由：** 智能技能路由与工作流编排，经Benchmark验证性能提升显著。
...
- **标签：** `agent-skills`, `inference-time-control`, `cognitive-enhancement`
- **推荐理由：** 模型无关推理控制，支持深度推理、长程任务与恢复流程
...
- **标签：** `agent-teams`, `dsh-plugin`, `agentic`
- **推荐理由：** 支持多Agent团队协作与协调工作流
...
- **标签：** `writing`, `novel`, `workflow`, `creative`
- **推荐理由：** 网文、短剧、游戏视频解说创作工作流插件，内置多模式工作台
...
- **标签：** `agent-preset`, `scientific-discovery`
- **推荐理由：** 将认识论循环工作流引入DSH，助力科学发现
...
- **标签：** `evolution`, `self-improvement`, `agent`
- **推荐理由：** Agent可组合、可审查、可持续进化的Web插件。
...
- **标签：** `skills`, `workflow`, `cross-platform`
- **推荐理由：** 将AI经验转化为可重复执行的跨平台工作流。
...
- **推荐理由：** 88个开源Agent Skill，覆盖研究、营销与自动化。
...
- **推荐理由：** 含87个SKILL.md，覆盖逆向工程与授权渗透测试
...
- **推荐理由：** 将Superpowers技能移植到Reasonix框架
...
- **推荐理由：** 从Superpowers适配的TDD、调试与协作技能
...
- **推荐理由：** 预装25个工程技能，30B token训练，提升10倍开发效率
...
- **标签：** `gongwen`, `ai-docs`, `skill`
- **推荐理由：** 基于国标的公文全流程处理工具，支持格式检查与优化
...
- **标签：** `agent-skill`, `chinese-traditional-wisdom`, `bazi`, `fengshui`
- **推荐理由：** 独特八字风水技能包，本地确定性引擎驱动
...
- **推荐理由：** 11个专项QA技能+共享知识库，AI测试工程师级能力
...
- **推荐理由：** 5角色数学建模Agent，33篇模型库+进度可视化
...
- **标签：** `planning`, `agent-skill`, `collaboration`
- **推荐理由：** 议行分离机制，AI协作变更任务先议后行
...
- **标签：** `ai-director`, `ai-video`, `deepseek-harness`
- **推荐理由：** 集成AI视频/图像/音频技能及可配置模型工具
...
- **推荐理由：** 支持GDScript的Godot 4.x全栈游戏开发技能
...
- **标签：** `agent-tools`, `workflow`, `capability-check`
- **推荐理由：** Agent起飞前插件预检单，自动注入最相关Top-K插件
...
- **标签：** `diagrams`, `mermaid-alternative`
- **推荐理由：** 文本生成精美架构图和时序图
...
- **标签：** `design`, `vibecoding`, `agent-team`, `flutter`, `react`
- **推荐理由：** AI原生矢量设计工具，支持并行Agent团队和设计即代码。
...
- **推荐理由：** Web插件实时展示Token用量、成本估算和API余额图表。
...
- **推荐理由：** 跨浏览器扩展，增强所有主流AI对话平台并提供统一提示词管理。
...
- **推荐理由：** 通过CLI让AI智能体无缝控制已登录浏览器，实现强大自动化。
...
- **标签：** `content-discovery`, `ai-agent`, `bilibili`, `privacy-first`, `cross-platform`
- **推荐理由：** 本地优先的跨平台内容发现Agent，覆盖B站/小红书/抖音等。
...
- **推荐理由：** 免费免注册的网页搜索桥接插件，为无原生联网能力的模型提供搜索
...
- **标签：** `browser-automation`, `anti-detect`, `fingerprint`, `playwright`
- **推荐理由：** 引擎级指纹伪装浏览器，无限本地配置文件，支持反检测
...
- **⭐ 星标：** 7
- **语言：** TypeScript
- **描述：** 给DSH接入���费的 Xiaomi MiMo TTS API，支持使用预置/自定义/浏览器内置声音朗读正文
- **标签：** `tts`, `xiaomi-mimo`, `voice`
- **推荐理由：** 接入免费小米MiMo TTS API，支持自定义和浏览器语音。
...
- **标签：** `mcp-server`, `resume-builder`
- **推荐理由：** 隐私优先的简历生成器，支持MCP集成
...
- **标签：** `image`, `electron-app`
- **推荐理由：** 终极图床工具，支持60+图床服务
...
- **标签：** `routing`, `infrastructure`, `reasoning-mode`
- **推荐理由：** 运行时注入器配合任务感知推理路由，优化智能体决策路由。
...
- **标签：** `preset`, `configuration`, `deepseek-harness`, `llm-agent`
- **推荐理由：** 两阶段配置预设：精简引导后加载完整标准工具集。
...
- **标签：** `multi-model`, `account-management`, `cli`, `routing`
- **推荐理由：** 多模型账号统一管理，支持智能路由、配额追踪和自动故障转移。
...
- **标签：** `mcp`, `proxy`, `api-keys`, `registry`
- **推荐理由：** Agent工具注册中心，类似OpenRouter，支持MCP代理与密钥管理
...
- **标签：** `cli`, `plugin-manager`, `schemas`, `utility`
- **推荐理由：** DSH插件中心的CLI工具，支持开放Schema和代理工具集��
...
- **标签：** `backup`, `config`, `restore`, `migration`, `mcp`
- **推荐理由：** 支持WebDAV的完整DSH配置备份恢复工具
...
- **标签：** `cordis`, `mcp`, `skills`, `utility`
- **推荐理由：** 统一能力管理插件，减少上下文占用
...
- **推荐理由：** 精选280+插件目录，覆盖14大类，快速发现优质插件
...
- **标签：** `deepseek-harness`, `container`, `utility`
- **推荐理由：** 容器化隔离管理多个DSH实例的实用工具
...
- **标签：** `migration`, `session-import`, `claude-code`
- **推荐理由：** 四源迁移向导，移植会话/记忆/技能到DSH
...
- **标签：** `mascot`, `pixel-art`, `sprites`, `claude-code`, `codex`
- **推荐理由：** 动画宠物画廊，为编码Agent终端增添个性化视觉体验。
...
- **标签：** `theme`, `glass-morphism`, `customizable`, `skin`
- **推荐理由：** 高自由度玻璃质感主题，可调模糊度、磨砂度和自定义壁纸
...
- **标签：** `ui`, `theme`, `background`, `visual`
- **推荐理由：** 支持自定义背景和预设氛围，可精细调节视觉效果
...
- **标签：** `ai-guide`, `rag`, `prompt-library`
...
- **标签：** `documentation`, `deepwiki`, `analysis`, `code-understanding`
- **推荐理由：** 快速将代码库转化为精准技术文档和AI可读上下文。
...
- **标签：** `plugin-registry`, `ecosystem-radar`, `validation`
- **推荐理由：** 生态雷达扫描21k+插件，支持k8s运行时验证
...
- **推荐理由：** 一站式科研工作台：LaTeX、arXiv、实验追踪、GPU服务器SSH编排
...
- **标签：** `dsh-plugin`, `learning`
- **推荐理由：** DSH原理学习与插件探索的优质入门指南。
...
- **标签：** `handbook`, `documentation`, `mcp`
- **推荐理由：** 173条源码背书的手册，覆盖运行时、插件、MCP。
...
- **推荐理由：** 1958个仓库的DSH插件总目录，支持中英搜索分类。
...
- **标签：** `finance`, `data-source`, `mult-agent`
...
- **推荐理由：** Web搜索、内容提取与研究技能，助力AI代理高效工作
...
- **标签：** `kline`, `deepseek-harness`, `sidebar`
- **推荐理由：** 多行情K线交互式分析，侧栏直接展示技术指标
...
- **标签：** `ai-writing`, `novel`, `worldbuilding`, `long-form-fiction`
- **推荐理由：** 功能丰富的AI小说创作软件，支持世界观构建与章节管理
...
- **推荐理由：** 中英双语DSH插件与工具精选清单，涵盖扩展、技能和集成
...
- **标签：** `encyclopedia`, `ai-resources`, `knowledge-base`, `awesome-list`
- **推荐理由：** 全维度AI资源百科，涵盖Agent、RAG、MLOps和技能大全
...
- **标签：** `awesome-list`, `guide`, `plugins`
- **推荐理由：** DSH终极指南，含入门教程和精选插件推荐
...
- **标签：** `awesome`, `awesome-list`, `official`
- **推荐理由：** cordis.run官方维护的自动生成插件清���
...
- **标签：** `awesome-list`, `catalog`, `plugin`
- **推荐理由：** 非官方社区整理的DSH插件目录索引
...
- **标签：** `stock`, `quant`, `finance`, `awesome-list`
- **推荐理由：** 精选的24个股票/金融/量化DSH插件列表。
...
- **标签：** `terminal`, `keybindings`, `llm-trace`
- **推荐理由：** 精选DSH插件：通知、LLM��踪、内置终端快捷键绑定。
...
- **标签：** `awesome-list`, `curated`, `plugin-list`
...
- **推荐理由：** 涵盖CLI、Web UI和自主Agent的DSH插件生态精选列表。
...
- **标签：** `awesome-list`, `directory`, `plugin-catalog`
- **推荐理由：** 收录千余插件的完整清单，按star排序便于发现优质工具
...
- **标签：** `marketplace`, `skills`, `plugin-store`
- **推荐理由：** 类CodeX风格的插件市场，一站式发现和安装插件
...
- **标签：** `recommendation`, `ai-curated`, `awesome-list`
- **推荐理由：** AI精选推荐，12分类190+插件，每小时自动更新
...
- **标签：** `radar`, `awesome-list`, `evidence-backed`
- **推荐理由：** 基于证据的插件雷达图，附插件实验室
...
- **语言：** Unknown
- **描述：** DSHA精选插件合集
- **标签：** `curated`, `collection`, `official`
- **推荐理由：** DSH官方精选插件合集，适合新用户快速上手
...
- **推荐理由：** GitHub Actions每日自动更新的中英双语插件目录
...
- **推荐理由：** Agent内插件搜索引擎，支持npm和精选目录交叉查询
...
- **标签：** `dsh-plugins`, `repository`, `dsh-ecosystem`
- **推荐理由：** DSH插件仓库与验证中心。
...
- **标签：** `migrated`, `awesome-dsh-plugin`
- **推荐理由：** 已迁移至新仓库，请跳转访问。
...
- **推荐理由：** 自动更新的 bilingual 插件目录，基于YAML数据。

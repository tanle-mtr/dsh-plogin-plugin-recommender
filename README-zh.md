...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 187,594 | Core DSH framework enabling everything as a plugin |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 90,693 | Open-source design alternative to Claude Design wi |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,003 | Deploy multi-agent swarms with autonomous collabor |
...
- [Agent 技能与工作流](#agent-技能与工作流) — 39 个插件
- [MCP 服务器与工具](#mcp-服务器与工具) — 5 个插件
- [视觉与设计](#视觉与设计) — 9 个插件
- [浏览器与 Web 自动化](#浏览器与-web-自动化) — 5 个插件
- [通信与社交](#通信与社交) — 1 个插件
- [实用工具与基础设施](#实用工具与基础设施) — 19 个插件
- [主题与皮肤](#主题与皮肤) — 5 个插件
- [研究与分析](#研究与分析) — 24 个插件
- [其他](#其他) — 33 个插件
...
- [实用工具与基础设施](utilities-infrastructure-zh) (19)
...
- **标签：** `dsh`, `harness`, `plugin-framework`
- **推荐理由：** DSH核心框架，万物皆插件的基础设施
...
- **推荐理由：** 终端原生DeepSeek编码Agent，支持提示缓存稳定运行
...
- **标签：** `multi-agent-workspace`, `enterprise`, `agent-skills`
- **推荐理由：** 企业级多引擎Agent工作台，支持视觉编辑器与技能复用
...
- **标签：** `dsh-plugin`, `harness`, `preset`
- **推荐理由：** 双阶段最小到标准DSH预设，Project2覆盖率高
...
- **标签：** `coding-agents`, `architecture`, `dsh-plugin`
- **推荐理由：** 让AI编程代理具备架构感知能力，安全处理长任务
...
- **标签：** `coding-agents`, `macos`, `swift`, `dsh-plugin`
- **推荐理由：** 专为DeepSeek Harness打造的Swift原生macOS编码代理
...
- **标签：** `agent-skill`, `dsh-plugin`, `plugin-development`
- **推荐理由：** 开发DSH插件的Agent Skill，覆盖标准插件/服务/打包
...
- **推荐理由：** 插件开发知识库，含官方中英文档和Cordis入门指南
...
- **标签：** `agent-framework`, `agent-skills`, `mcp`
- **推荐理由：** AI智能体开发与评估驱动的完整技能工具包
...
- **标签：** `plugin-skills`, `scaffolding`, `testing`
- **推荐理由：** DSH插件脚手架搭建与测试技能集合
...
- **标签：** `agent-tools`, `capability-index`, `llm-agents`
- **推荐理由：** 任务前自动预检并注入Top-K适用插件
...
- **标签：** `dsh-publisher`, `plugin-manager`, `automation`
- **推荐理由：** 一键发布插件工具，支持验证与生成
...
- **标签：** `dsh-web-ui`, `dsh-plugin`, `themes`
- **推荐理由：** Web界面任务看板，支持移动端SSH运维与主题皮肤
...
- **标签：** `desktop`, `electron`, `dsh-plugin`
- **推荐理由：** 本地优先桌面伴侣，支持动画宠物和插件SDK
...
- **推荐理由：** 轻量级Tauri桌面应用，仅5MB无需配置即可使用
...
- **标签：** `widget`, `ui`, `dsh-plugin`
- **推荐理由：** 可爱的漂浮鲸鱼小部件，实时监控DSH账户余额
...
- **标签：** `desktop`, `electron`, `dsh-plugin`
- **推荐理由：** 本地优先的DSH桌面工作区，支持会话、文件和插件管理
...
- **推荐理由：** 本地优先的多模型桌面AI助手，隐私至上且技能自进化
...
- **标签：** `desktop-app`, `electron`, `cross-platform`, `dsh-plugin`
- **推荐理由：** 类CodePilot跨平台桌面客户端，附带插件套装
...
- **标签：** `workspace`, `canvas`, `conversation`, `ui`
- **推荐理由：** 画布式非线性对话工作空间，支持分支浏览。
...
- **推荐理由：** Electron桌面GUI客户端，含SSH、技能与远程访问。
...
- **标签：** `notes`, `productivity`, `docker`, `smartisan`
- **推荐理由：** 锤子便签开源版，Docker部署，支持公众号导出。
...
- **标签：** `marketplace`, `plugin-marketplace`
- **推荐理由：** 从Web GUI一键浏览安装所有DSH插件
...
- **标签：** `task-management`, `taskboard`
- **推荐理由：** 原生SQLite任务看板支持agent协作
...
- **标签：** `deepseek-harness`, `desktop-app`, `electron`, `typescript`
- **推荐理由：** Electron桌面控制台，多Tab管理Harness/插件/MCP/Skills
...
- **标签：** `kline`, `chart`, `finance`
- **推荐理由：** 多市场行情K线分析，原生侧栏展示技术指标
...
- **推荐理由：** 浮动HUD面板展示git状态、MCP及Token用量。
...
- **标签：** `desktop`, `tauri`, `docker`, `ssh`
- **推荐理由：** 跨平台桌面应用整合数据库、SSH、Docker与AI。
...
- **标签：** `desktop-app`, `electron`, `deepseek-harness`
- **推荐理由：** Electron桌面版DeepSeek Harness，集成多插件
...
- **标签：** `memory-management`, `rag`, `self-evolving`
- **推荐理由：** 自进化记忆系统，混合检索节省35% Token开销
...
- **标签：** `knowledge-base`, `rag`, `ai-pedia`, `dsh-plugin`
- **推荐理由：** 覆盖Agent、RAG、多模态工具与学习路线的全景AI知识库
...
- **标签：** `agent-memory`, `skill-md`, `semantic-search`
- **推荐理由：** 构建可检索评估的agent技能知识库
...
- **标签：** `context`, `audit`, `memory`
- **推荐理由：** 上下文审计工具，检测token消耗与冲突
...
- **标签：** `memory`, `handoff`, `experience`
- **推荐理由：** 集成PowerContext实现记忆recall与经验持久化。
...
- **标签：** `claude-bridge`, `memory`, `skills`
- **推荐理由：** 桥接Claude Code记忆与技能到DSH生态。
...
- **标签：** `multi-agent`, `swarm`, `workflows`
- **推荐理由：** 部署多智能体蜂群协作的自主工作流框架
...
- **标签：** `agent`, `memory`, `multi-model`
- **推荐理由：** 具备记忆与知识的自进化多模态AI助手
...
- **标签：** `skills`, `knowledge-distillation`, `meta-skill`
- **推荐理由：** 将专业知识提炼为可复用的Agent技能
...
- **标签：** `vision`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 为纯文本模型提供视觉技能，支持多图理解与问答
...
- **标签：** `task-manager`, `mcp`, `dsh-plugin`
- **推荐理由：** 自托管人机协作任务管理器，支持多端访问控制
...
- **标签：** `workflow`, `browser-extension`, `dsh-plugin`
- **推荐理由：** 将AI对话转化为可复用的跨平台工作流
...
- **标签：** `agent-teams`, `multi-agent`, `dsh-plugin`
- **推荐理由：** 在DeepSeek Harness中实现多代理团队协作
...
- **标签：** `vision`, `ocr`, `dsh-plugin`
- **推荐理由：** DSH原生视觉工具包：OCR识别、截图UI还原，免费使用
...
- **标签：** `agent`, `team`, `automation`, `dsh-plugin`
- **推荐理由：** 将多代码Agent整合为协作团队，支持任务分发与派生
...
- **标签：** `skills`, `agent`, `workflow`, `coding`
- **推荐理由：** 将经验转化为可重复执行的AI代理工作流。
...
- **标签：** `vision`, `multimodal`, `agent-skill`, `screenshot`
- **推荐理由：** 为纯文本LLM添加多模态视觉分析能力。
...
- **标签：** `creative-writing`, `fiction`, `drama`, `skill`
- **推荐理由：** 小说创作与短剧制作技能插件。
...
- **标签：** `superpowers`, `skills`
- **推荐理由：** TDD调试规划等Superpowers技能
...
- **标签：** `agent-skills`, `deep-research`, `marketing-automation`, `research-tools`
- **推荐理由：** 88个跨平台Agent技能，覆盖研究、营销和社交情报
...
- **标签：** `agent-skills`, `legal-tech`, `visualization`, `diagram`
- **推荐理由：** 法律诉讼可视化工具，重画诉讼图和案件时间轴
...
- **标签：** `agent-skills`, `spec-programming`, `developer-tools`
- **推荐理由：** 可移植的规格驱动开发Skill，遵循DSH工程模式
...
- **标签：** `dsh-plugin`, `image-reading`, `ocr`, `vision`
- **推荐理由：** 图像OCR与像素转文本工具，34图训练方法
...
- **标签：** `agent-skill`, `plugin-development`, `dsh-plugin`
- **推荐理由：** 管理已安装DSH插件插槽、Typert远程和凭据的Skill
...
- **标签：** `agent-handoff`, `session-memory`
- **推荐理由：** 跨平台会话记忆，实现Agent交接上下文延续
...
- **标签：** `code-simplification`, `codex`
- **推荐理由：** 从DSH适配的代码简化技能，适用于Codex
...
- **标签：** `chinese-traditional-wisdom`, `skill`
- **推荐理由：** 融合八字风水等中华传统智慧的AI技能包
...
- **标签：** `multi-agent`, `collaboration`
- **推荐理由：** 多Agent团队协作，独立模型与共享工作区
...
- **标签：** `media`, `vision`, `image`
- **推荐理由：** 图片读取与生成技能，支持多视觉模型
...
- **⭐ 星标：** 15
- **语言：** TypeScript
- **描述：** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏览���里管理技能（skills）与 MCP 服务器。
- **标签：** `skills`, `mcp`, `gui`
- **推荐理由：** Web GUI技能与MCP管理插件，可视化配置
...
- **标签：** `governance`, `swift-cycle`
- **推荐理由：** Swift Cycle治理技能，版本锁定离线可验
...
- **标签：** `engineering-discipline`, `agent-skills`
- **推荐理由：** 强调事实验证与证据驱动的工程方法论技能
...
- **标签：** `canvas`, `mcp`, `agentic-workflow`
- **推荐理由：** WeShop无限画布原生技能插件，创意工作流
...
- **标签：** `computer-use`, `record-replay`, `agent-skills`
- **推荐理由：** 录制macOS桌面操作并转化为可复用Agent技能。
...
- **标签：** `agent-preset`, `product-management`, `ai-agents`
- **推荐理由：** 虚拟产品团队智能体，覆盖PM到工程师全流程
...
- **标签：** `mcp`, `capability-management`, `tools`
...
- **推荐理由：** 通过OAuth绑定ChatGPT，在DSH内对话GPT模型
...
- **标签：** `design`, `ui`, `figma-alternative`
- **推荐理由：** 开源设计工具，支持本地优先的桌面端设计
...
- **标签：** `diagram`, `architecture`, `mermaid`
- **推荐理由：** 生成精美可验证架构图与流程图的Agent技能
...
- **标签：** `design`, `ppt`, `prototyping`, `dsh-plugin`
- **推荐理由：** AI驱动设计系统，支持模板、PPT生成与可视化原型
...
- **标签：** `image-generation`, `ai-art`, `multimodal`
- **推荐理由：** 直接在DSH聊天中通过Seedream等生成图片。
...
- **标签：** `design`, `visual`, `aesthetics`
- **推荐理由：** 设计美学技能包，避免AI风格化网站外观
...
- **标签：** `browser-extension`, `chrome`, `prompt-manager`
- **推荐理由：** 跨��览器增强套件，支持主流AI聊天平台
...
- **推荐理由：** Chrome侧边栏扩展，无需视觉能力即可直接控制浏览器
...
- **标签：** `web-search`, `free`, `no-signup`, `dsh-plugin`
- **推荐理由：** 免费网页搜索插件，为无原生浏览能力的模型提供桥接
...
- **标签：** `ios`, `mobile-automation`, `mcp`, `dsh-plugin`
- **推荐理由：** 对话内运行iOS模拟器与真机自动化，提供22个Agent工具
...
- **标签：** `resume`, `utility`, `mcp-server`
- **推荐理由：** 隐私优先的开源简历构建工具，支持MCP
...
- **标签：** `image`, `uploader`, `utility`
- **推荐理由：** 全能图床上传工具，支持60+托管服务
...
- **标签：** `no-code`, `crm`, `workflow`
- **推荐理由：** 开源无代码平台，AI辅助快速构建业务系统
...
- **标签：** `vfs`, `agent-tools`, `virtual-filesystem`
- **推荐理由：** 首个跨AI Agent统一虚拟文件系统方案
...
- **标签：** `context`, `utility`, `dsh-plugin`
- **推荐理由：** 最优质的上下文管理插件，含仪表板与统计功能
...
- **标签：** `oauth`, `subscription`, `utilities`, `dsh-plugin`
- **推荐理由：** OAuth桥接，用订阅账户替代API密钥作为LLM提供商
...
- **标签：** `cost-tracking`, `token-usage`, `budget`, `utility`
- **推荐理由：** 实时跟踪会话成本、预算限制和Token用量。
...
- **标签：** `compatibility`, `migration`, `pi`, `bridge`
- **推荐理由：** 兼容层让Pi扩展直接作为DSH插件运行。
...
- **标签：** `context-migration`, `preset-migration`
- **推荐理由：** 跨预设会话迁移保持状态一致
...
- **标签：** `console`, `plugin-management`, `ui`, `dsh-plugin`
- **推荐理由：** 插件生态基建，浏览器面板管理官方仓库插件
...
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`
- **推荐理由：** 本地隔离容器管理多版本DSH，内嵌WebView，一键导入插件
...
- **标签：** `config`, `backup`, `restore`
- **推荐理由：** 配置备份恢复同步，支持WebDAV和迁移
...
- **⭐ 星标：** 3
- **语言：** TypeScript
- **描述：** 致力于解决���插件之间也与版本之间可能存在的冲突问题并提供解决方案
- **标签：** `plugin-doctor`, `conflict-resolution`, `utilities`
- **推荐理由：** 诊断并解决插件间及版本间的冲突问题
...
- **标签：** `dsh-plugin-manager`, `registry`, `discovery`
- **推荐理由：** 多源合并去重的插件发现注册表
...
- **标签：** `dsh-plugin-manager`, `cli`, `deepseek-harness`
- **推荐理由：** CLI插件管理工具，支持安装与审计
...
- **标签：** `pet`, `mascot`, `pixel-art`
- **推荐理由：** 面向多Agent平台的动画宠物主题画廊
...
- **标签：** `theme`, `dsh-plugin`, `deepseek-harness`
- **推荐理由：** 高自由度磨砂玻璃主题，支持自定义模糊度与背景
...
- **推荐理由：** WebGPU海浪主题，Three.js渲染，视觉效果出色。
...
- **标签：** `themes`, `skins`, `color-scheme`, `ui`
...
- **标签：** `background`, `theme`, `webui`
- **推荐理由：** 支持自定义背景与预设氛围的Web主题插件。
...
- **标签：** `ai-guide`, `tutorial`, `resources`
- **推荐理由：** 程序员AI资源大全与Vibe Coding零基础教程
...
- **推荐理由：** DeepSeek Harness插件生态的精选索引清单
...
- **标签：** `awesome-list`, `research`, `dsh-plugin`
- **推荐理由：** 全面的DSH插件、工具和基础设施精选资源
...
- **标签：** `awesome-list`, `bilingual`, `dsh-plugin`
- **推荐理由：** 双语精选插件资源目录，含验证过的参考来源
...
- **标签：** `learning`, `marketplace`, `best-practices`, `dsh-plugin`
- **推荐理由：** 学习DSH原理、浏览插件市场与最佳实践的导航工具
...
- **标签：** `awesome-list`, `guide`, `bilingual`, `dsh-plugin`
- **推荐理由：** 双语DSH终极指南，涵盖入门、精选插件与开发工具
...
- **标签：** `awesome-list`, `plugin-catalog`, `dsh-plugins`
- **推荐理由：** 精选DSH插件/技能/MCP服务器索引目录，便于发现。
...
- **标签：** `ai-agents`, `api-documentation`, `chinese-api`, `dsh-plugin`
- **推荐理由：** 一站式搜索20个中国开放平台6.5万+篇API文档
...
- **标签：** `awesome-list`, `curated-list`, `ecosystem`
- **推荐理由：** 中文精选DSH插件目录，便捷发现优质工具
...
- **标签：** `awesome-list`, `verified`, `dsh-plugins`
- **推荐理由：** 经社区验证、按星标排序的插件目录
...
- **标签：** `awesome-list`, `plugin-radar`, `2origin`
- **推荐理由：** 基于证据的插件雷达与2Origin插件实验室
...
- **标签：** `plugin-portal`, `static-site`, `awesome-dsh-plugin`
- **推荐理由：** 零依赖静态网页，浏览安装227+插件
...
- **标签：** `search`, `discoverability`, `dsh-plugin`
- **推荐理由：** 在智能体内直接搜索发现DSH插件
...
- **标签：** `awesome-list`, `ai-curated`, `plugin-recommender`
- **推荐理由：** AI每小时更新的190+插件分类推荐
...
- **标签：** `plugin-repository`, `dsh-ecosystem`, `plugin-verify`
- **推荐理由：** DSH插件仓库与验证平台
...
- **标签：** `claude-code`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `dsh-plugins`, `kimi-code`, `openclaw`, `opencode`, `zcode`
- **推荐理由：** One-click install + model switch:Claude 
...
- **推荐理由：** J-Space Cognition Suite V3.7 - AI cognit
...
- **标签：** `ai-agent`, `bilibili`, `chrome-extension`, `content-discovery`, `cross-platform`, `deepseek-harness`, `douyin`, `dsh`, `dsh-plugin`, `llm`, `local-first`, `personal-ai`, `privacy-first`, `python`, `recommendation-system`, `self-hosted`, `typescript`, `xiaohongshu`, `youtube`, `zhihu`
- **推荐理由：** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B
...
- **标签：** `agent-framework`, `agent-skills`, `agentic-coding`, `ai-agents`, `ai-scientist`, `ai-skills`, `ai-workflow`, `automation`, `claude-code`, `codex`, `context-engineering`, `developer-tools`, `dsh-plugin`, `llm`, `multi-agent`, `prompt-engineering`, `skills`, `vibe-coding`, `vibecoding`, `workflow-automation`
- **推荐理由：** VibeSkills is a general-purpose Skill th
...
- **标签：** `deepseek-harness`, `dsh`, `dsh-plugin`
- **推荐理由：** 竹知了 —— 一转就哇哇叫的传统玩具，Web 模拟版。零依赖单文件，真实录音采样
...
- **推荐理由：** 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话
...
- **标签：** `claude-code`, `coding-agent`, `deepseek`, `deepseek-harness`, `dsh-plugin`, `ink`, `react`, `terminal`, `tui`
- **推荐理由：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏
...
- **推荐理由：** The plugin market inside DeepSeek Harnes
...
- **标签：** `agent-teams`, `agentic`, `agentic-os`, `agentic-runtime`, `ai-coding`, `ai-ide`, `ai-sdk`, `bitfun`, `computer-use-agent`, `cowork`, `dsh-plugin`, `openclaw`, `vibe-coding`
- **推荐理由：** BitFun combines a high-performance agent
...
- **标签：** `dsh`, `dsh-plugin`
- **推荐理由：** Whale Girl skin series for DeepSeek Harn
...
- **标签：** `claude-code`, `dsh-plugin`, `openclaw`, `openclaw-skills`, `rednotebook`, `research`, `tiktok`, `web-search`
- **推荐理由：** last30days-cn 是一个 AI Agent 技能（Skill），能够自
...
- **标签：** `ai`, `ai-video`, `claude-code`, `claude-skill`, `collage-video`, `dsh-plugin`, `explainer-video`, `ffmpeg`, `generative-ai`, `llm`, `motion-graphics`, `python`, `text-to-video`, `tts`, `video`, `video-generation`, `vox`
- **推荐理由：** Turn one topic into a finished Vox-style
...
- **标签：** `agent-skills`, `ai-code-review`, `architecture-review`, `auto-fix`, `claude-code`, `claude-code-plugin`, `clean-architecture`, `code-health`, `code-quality`, `code-review`, `code-smells`, `codex-cli-plugin`, `deepseek-harness`, `developer-tools`, `dsh-plugin`, `gemini-cli-extension`, `refactoring`, `static-analysis`, `tech-debt`, `test-quality`
- **推荐理由：** AI code reviews grounded in 12 classic e
...
- **推荐理由：** DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器真实安装路径运行级
...
- **推荐理由：** Let AI agents use your real, logged-in b
...
- **标签：** `marketplace`, `plugins`, `aggregator`
- **推荐理由：** DSH插件市场聚合分发中心。
...
- **标签：** `awesome-deepseek-harness`, `plugin-marketplace`, `dsh-plugin`
...
- **推荐理由：** cordis.run官方自动维护的DSH插件精选列表
...
- **标签：** `community`, `photo`
- **推荐理由：** DSH内测社区合影墙，GitHub OAuth登录
...
- **标签：** `registry`, `open-data`, `curated`
- **推荐理由：** 经垃圾过滤的DSH插件开源数据注册表。
...
- **标签：** `stock`, `finance`, `awesome-list`
- **推荐理由：** 精选24个股票/金融/量化DSH插件清单。
...
- **标签：** `awesome-list`, `deepseek-harness`, `curated`
- **推荐理由：** 实用插件精选短名单，注重证据评估
...
- **标签：** `awesome-list`, `deepseek-harness`, `agent-harness`
- **推荐理由：** 覆盖工具、UI和智能体的全面插件清单
...
- **标签：** `awesome-list`, `industry-plugins`, `dsh`
- **推荐理由：** 聚焦金融、法律、医疗等行业的插件精选
...
- **标签：** `awesome-list`, `cordis-plugins`, `dsh`
- **推荐理由：** cordis.run官方自动生成的插件目录

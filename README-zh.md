...
- [编程 Agent 与 Harness 工具](#编程-agent-与-harness-工具) — 17 个插件
...
- [编程 Agent 与 Harness 工具](coding-agents-harness-tools-zh) (17)
...
- **标签：** `multi-agent`, `skills`, `dsh-plugin`
- **推荐理由：** 自进化记忆的多模态AI助手框架。
...
- **标签：** `coding-agents`, `architecture`, `drift-check`
- **推荐理由：** 架构感知编码代理，基线优先防漂移。
...
- **推荐理由：** 在DSH内运行iOS模拟器，22个代理工具实现自动化。
...
- **标签：** `coding-agent`, `orchestration`, `subagent`
- **推荐理由：** 从Claude Code/Codex调度DSH子agent执行任务
...
- **标签：** `agent-skills`, `dsh-plugin`, `plugin-development`
- **推荐理由：** 开发DSH插件的标准Agent技能，涵盖服务/事件/工具/打包全流程
...
- **标签：** `dsh-plugin`, `plugin-development`, `agent-skill`
- **推荐理由：** 帮助构建已安装DSH插件的Agent技能，支持槽位和凭据管理
...
- **标签：** `dsh`, `containers`, `plugin-manager`
- **推荐理由：** 在隔离容器中运行多个DSH版本，内置WebView UI
...
- **标签：** `agent-tools`, `cordis`, `llm-agents`
- **推荐理由：** Agent预检插件库提升可预期性
...
- **标签：** `design-systems`, `desktop-app`, `dsh-plugin`
- **推荐理由：** 本地优先的AI设计桌面应用，Figma替代方案。
...
- **标签：** `dsh-web`, `web-ui`, `plugin-ecosystem`
- **推荐理由：** DSH插件聚合生态包，一切皆插件的创意工坊
...
- **标签：** `desktop`, `tauri`, `installer`
- **推荐理由：** 轻量5MB Tauri桌面应用，零配置开箱即用。
...
- **标签：** `desktop-companion`, `pets`, `sdk`
- **推荐理由：** 本地优先桌面伴侣，动画宠物+插件SDK。
...
- **标签：** `widget`, `floating`, `balance`
- **推荐理由：** 可爱浮动鲸鱼挂件，实时查看账户余额。
...
- **标签：** `desktop-app`, `agent`, `privacy`
- **推荐理由：** 本地优先的桌面AI代理，支持多模型和自演化技能。
...
- **推荐理由：** 跨平台桌面客户端，丰富插件套件，类CodePilot体验。
...
- **推荐理由：** 零配置Windows桌面客户端，支持SSH和移动端
...
- **标签：** `desktop-app`, `electron`, `typescript`, `dsh-plugins`
- **推荐理由：** Electron桌面控制台，多Tab统一管理插件、MCP和Skill
...
- **标签：** `web-ui`, `mcp`, `skills`
- **推荐理由：** 在 DSH Web GUI 中通过浏览器管理技能与 MCP 服务器
...
- **标签：** `ui`, `status-bar`, `pricing`
- **推荐理由：** 底部常驻栏显示模型、余额和实时定价信息
...
- **标签：** `canvas`, `creative`, `deepseek-harness`
- **推荐理由：** WeShop原生画布集成，支持无限创意技能扩展
...
- **标签：** `plugin-manager`, `gui`, `dsh-plugin`
- **推荐理由：** DSH内嵌GUI管理MCP、技能与插件，支持热生效
...
- **标签：** `electron`, `desktop`, `integration`
- **推荐理由：** Electron桌面壳集成DSH网页服务与插件生态
...
- **标签：** `agent-memory`, `rag`, `long-term-memory`, `self-evolving`
- **推荐理由：** 跨平台Markdown原生记忆层，用户自有数据
...
- **标签：** `memory`, `RAG`, `persistent`
- **推荐理由：** 为Agent提供无限持久记忆方案。
...
- **推荐理由：** AI知识库大全，涵盖RAG、MCP、Agent学习资源。
...
- **标签：** `rag`, `embeddings`, `skill-corpus`, `retrieval`
- **推荐理由：** 将SKILL.md转化为可检索的Agent技能语料库
...
- **推荐理由：** 连接PowerContext实现记忆召回与会话交接
...
- **标签：** `skills`, `workflow-automation`, `dsh-plugin`
- **推荐理由：** GPT-Image2工业级提示词引擎，含530+案例。
...
- **标签：** `agent-workspaces`, `no-code`, `multi-platform`
- **推荐理由：** 跨设备统一Agent工作区，支持看板跟踪
...
- **标签：** `agent-os`, `self-evolving`, `loop-engineering`
- **推荐理由：** Agent自我进化OS，持续自动变强
...
- **标签：** `agent-collaboration`, `multi-agent`, `enterprise`
- **推荐理由：** 企业级本地优先多Agent工作台，支持团队协做
...
- **标签：** `workflow`, `productivity`, `browser-extension`
- **推荐理由：** 将AI对话转化为可复用工作流。
...
- **标签：** `agent`, `workflow`, `multi-agent`
- **推荐理由：** 将多个代码代理整合为协作团队，支持会话调度。
...
- **标签：** `creative-writing`, `drama-skills`, `novel-writing`
- **推荐理由：** 小说创作和短剧制作技能工作流
...
- **标签：** `agent-skills`, `execution`, `multi-agent`
- **推荐理由：** 将经验转化为可重复执行的Agent技能
...
- **标签：** `multimodal`, `vision`, `claude-code`
- **推荐理由：** 为纯文本LLM添加多模态视觉能力
...
- **标签：** `plugin-discovery`, `automation`, `skills`
- **推荐理由：** 自动搜索、安装和验证GitHub插件
...
- **标签：** `task-management`, `sqlite`, `ui`
- **推荐理由：** 原生本地任务看板，支持agent认领和审查流程
...
- **标签：** `skills`, `superpowers`, `port`
- **推荐理由：** 将Superpowers技能移植适配到Reasonix
...
- **标签：** `ctf`, `pentest`, `security`, `reverse-engineering`
- **推荐理由：** 完整逆向工程与安全测试技能，适合CTF和渗透测试
...
- **推荐理由：** AI编程导师技能，扫描架构、生成阶梯学习章节并Code Review
...
- **标签：** `agent-skills`, `deep-research`, `fact-checking`, `market-research`
- **推荐理由：** 88个开源技能，覆盖深度研究、社交情报与营销自动化
...
- **标签：** `spec-programming`, `vibe-coding`, `developer-tools`, `ai-coding`
- **推荐理由：** 面向仓库的原生规格驱动开发技能，贴合DSH工程范式
...
- **标签：** `agent-handoff`, `session-memory`, `skills`
- **推荐理由：** 跨平台Agent会话连续性记忆，支持Codex和Claude Code
...
- **标签：** `chinese-wisdom`, `bazi`, `fengshui`, `skill`
- **推荐理由：** 融合八字/风水/易经的本地确定性引擎技能包
...
- **标签：** `skill-picker`, `ux`, `composer`
- **推荐理由：** WorkBuddy风格技能选择器，快速插入技能命令
...
- **标签：** `agent-skills`, `package-manager`, `eval-driven-dev`
- **推荐理由：** 42 项技能包，涵盖 AI 代理工程全链路
...
- **标签：** `docx`, `gongwen`, `office`
- **推荐理由：** 遵循国标的全流程中文公文处理工具
...
- **标签：** `swift-cycle`, `governance`, `offline`
- **推荐理由：** 版本锁定、可离线验证的 Swift Cycle 治理技能
...
- **标签：** `skills`, `gamification`, `mission-system`
- **推荐理由：** 带迷雾地图的游戏化任务系统，任务栏推进
...
- **标签：** `practices`, `engineering`, `discipline`
- **推荐理由：** 从 DSH 提炼的工程纪律与实证工作法
...
- **标签：** `skill-learning`, `agent-skills`, `automation`
- **推荐理由：** 自动将成功会话转化为可复用的智能体技能
...
- **标签：** `agent-preset`, `product-management`, `deepseek-harness`
- **推荐理由：** 虚拟产品团队Agent预设工作流
...
- **推荐理由：** OpenAI Codex与DSH双向同步桥接，���时镜像MCP
...
- **标签：** `mcp`, `zhihu`, `deepseek-harness`
- **推荐理由：** MCP驱动知乎搜索与知道问答，丰富DSH信息源
...
- **标签：** `mcp-server`, `hot-reload`, `skill-management`
- **推荐理由：** 支持热加载MCP配置和技能管理，无需重启
...
- **标签：** `design-as-code`, `vibedesign`, `ui`, `flutter`
...
- **标签：** `ui`, `visual`, `dsh-plugin`
- **推荐理由：** 在回复中直接渲染交互式图表、表单和测验。
...
- **标签：** `design`, `ppt`, `ui-design`, `openpencil`
- **推荐理由：** 在对话中预览、检查和编辑OpenPencil设计文档
...
- **标签：** `legal`, `visualization`, `timeline`, `diagram`
- **推荐理由：** 法律可视化技能，自动生成诉讼时间轴和案件材料图
...
- **标签：** `design`, `ui`, `style`, `vibe-coding`
- **推荐理由：** 6种设计风格预设，避免AI生成的统一外观
...
- **标签：** `video`, `image`, `storyboard`
- **推荐理由：** AI 视频/图像/音频生成，支持可配置模型工具
...
- **标签：** `image`, `electron-app`, `dsh-plugin`
...
- **标签：** `routing`, `harness-engineering`, `injector`
- **推荐理由：** 运行时注入器+任务感知推理模式路由器
...
- **标签：** `preset`, `dsh-plugin`, `standard-tools`
- **推荐理由：** 两阶段预设：从最小启动到标准工具全覆盖
...
- **推荐理由：** 首个视觉插件，图片转结构化JSON供文本Agent使用
...
- **标签：** `vfs`, `virtual-filesystem`, `agent-tools`
- **推荐理由：** 统一虚拟文件系统，跨语言Agent工具访问
...
- **标签：** `claude-code`, `deepseek-harness`, `workflow`
- **推荐理由：** 一键安装切换9大AI编程工具，生态整合利器
...
- **标签：** `oauth`, `infrastructure`, `llm-provider`
- **推荐理由：** 通过OAuth将订阅服务转为DSH的LLM提供者。
...
- **标签：** `search`, `web-fetch`, `utility`
- **推荐理由：** 最强免费网页搜索桥接，无需注册，覆盖所有模型。
...
- **标签：** `cost-tracking`, `token-usage`, `budget`
- **推荐理由：** 追踪会话/每日成本、预算和token用量
...
- **标签：** `compatibility`, `migration`, `integration`
- **推荐理由：** 打通Pi与DSH生态的兼容性桥接层
...
- **标签：** `marketplace`, `plugin`, `ui`
- **推荐理由：** Web端一键浏览安装更新DSH插件的市场工具
...
- **标签：** `backup`, `crash-recovery`, `windows`
- **推荐理由：** 崩溃恢复插件，支持撤销、快照和SAFE MODE
...
- **标签：** `marketplace`, `ui`, `web`
- **推荐理由：** 社区插件市场浏览器，一键安装卸载到profile
...
- **标签：** `plugin-management`, `ui`, `console`, `dsh-repository-plugin`
- **推荐理由：** 插件管理控制台与官方开发引导，无需修改即可使用
...
- **标签：** `ocr`, `image-reading`, `vision`, `pixel-art`
- **推荐理由：** 为无视觉模型提供OCR和像素级图像阅读能力，零依赖
...
- **标签：** `knowledge-base`, `plugin-development`, `scaffold`, `dsh-plugin`
- **推荐理由：** 按需加载的插件开发知识库，含官方文档中英双语存档
...
- **标签：** `config`, `backup`, `migration`, `webdav`
- **推荐理由：** 通过WebDAV备份、恢复和同步DSH完整配置
...
- **标签：** `discoverability`, `search`, `dsh-plugin`
- **推荐理由：** 在DSH内搜索插件发现和浏览
...
- **标签：** `publisher`, `utility`, `workflow`
- **推荐理由：** 一键发布插件，支持验证完整性与自动生成文档
...
- **标签：** `mascot`, `pixel-art`, `sprites`, `themes`
- **推荐理由：** 动画宠物画廊，个性化你的编码Agent
...
- **标签：** `theme`, `threejs`, `webgpu`, `ocean-skin`
- **推荐理由：** 惊艳的WebGPU海洋主题视觉皮肤
...
- **标签：** `themes`, `skins`, `dark-mode`
- **推荐理由：** 34 款 opencode 经典配色一键切换不丢失配置
...
- **标签：** `deepseek-harness`, `webui`, `theme`
- **推荐理由：** 可自定义Web背景与氛围主题
...
- **⭐ 星标：** 19,118
- **语言：** JavaScript
- **描述：** ��序员鱼皮的 AI 资源大全 + Vibe Coding 零基础教程，分享 OpenClaw 保姆级教程、大模型玩法（DeepSeek / GPT / Gemini / Claude / GLM）、最新 AI 资讯、Prompt 提示词大全、AI 知识百科（Agent Skills / RAG / MCP / A2A）、AI 编程教程（Harness Engineering）、AI 工具用法（Cursor / Claude Code / TRAE / Codex / Copilot）、AI 开发框架教程（Spring AI / LangChain）、AI 产品变现指南，帮你快速掌握 AI 技术，走在时代前沿。本项目为开源文档 aiguide，已升级为鱼皮 AI 导航网站
- **标签：** `ai`, `rag`, `vibe-coding`
- **推荐理由：** 全面的AI资源库与Vibe Coding教程大全。
...
- **推荐理由：** 零配置搜索20个中国平台6.5万+ API文档，全平台兼容
...
- **标签：** `kline`, `finance`, `analysis`, `chart`
- **推荐理由：** 支持多市场行情和技术指标的交互式K线分析
...
- **标签：** `evaluation`, `benchmark`, `RAG-evaluation`
- **推荐理由：** 提供提示词、RAG 和智能体的证据驱动评估框架
...
- **标签：** `awesome`, `deepseek-harness`, `finance`, `quant`, `stock`
- **推荐理由：** 精选股票/金融/量化插件合集
...
- **标签：** `ai-agent`, `awesome-list`, `plugin-registry`
- **推荐理由：** 插件雷达与2Origin实验平台
...
- **标签：** `awesome-list`, `dsh-repository`
- **推荐理由：** 插件目录，含生态分析功能
...
- **标签：** `awesome-list`, `typescript`, `curated`
- **推荐理由：** 覆盖模型、工具、沙盒、UI的全方位精选插件
...
- **标签：** `cordis`, `awesome-list`
- **推荐理由：** Cordis官方自动生成的插件目录
...
- **标签：** `awesome-list`, `comprehensive`
- **推荐理由：** 最大规模清单：1000+工具按star排序
...
- **推荐理由：** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 We
...
- **推荐理由：** J-Space Cognition Suite V3.7 - AI cognitive-enhancement Skills based on Anthropi
...
- **推荐理由：** VibeSkills is a general-purpose Skill that automatically routes local Skills and
...
- **推荐理由：** 竹知了 —— 一转就哇哇叫的传统玩具，Web 模拟版。零依赖单文件，真实录音采样，移动端优先。
...
- **推荐理由：** 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Open sidebar foundation, su
...
- **标签：** `agent`, `agent-memory`, `ai-agents`, `claude-code`, `claude-code-plugin`, `codex`, `deepseek`, `deepseek-harness`, `dsh`, `dsh-plugin`, `embeddings`, `hybrid-search`, `long-term-memory`, `memory`, `milvus`, `openclaw`, `opencode`, `rag`, `semantic-search`, `skills`
- **推荐理由：** A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Cod
...
- **推荐理由：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。 
...
- **推荐理由：** The plugin market inside DeepSeek Harness — browse, search, one-click install · 
...
- **推荐理由：** BitFun combines a high-performance agent runtime written in Rust with a polished
...
- **标签：** `dsh`, `dsh-plugin`
- **推荐理由：** Whale Girl skin series for DeepSeek Harness. 适用于 DeepSeek Harness 的，鲸鱼娘系列皮肤。
...
- **推荐理由：** last30days-cn 是一个 AI Agent 技能（Skill），能够自动搜索中国互联网 8 大主流平台最近 30 天的内容，综合分析后生成有据可查的研
...
- **推荐理由：** Turn one topic into a finished Vox-style paper-collage explainer/ad video — auto
...
- **推荐理由：** AI code reviews grounded in 12 classic engineering books — decay risk diagnostic
...
- **标签：** `plugin-registry`, `awesome-list`, `curated`
- **推荐理由：** 精选插件目录，真实安装测试，Top50推荐。
...
- **标签：** `awesome-list`, `ecosystem`, `registry`
- **推荐理由：** 全面覆盖DSH所有类别的插件精选列表。
...
- **⭐ 星标：** 274
- **语言：** JavaScript
- **描述：** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图文导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件��快被发现。
- **标签：** `awesome-list`, `discovery`, `plugin-market`
- **推荐理由：** 每日自动抓取插件，场景化分类和热度排行。
...
- **标签：** `learning`, `documentation`, `marketplace`
- **推荐理由：** DSH原理学习和插件市场最佳实践指南。
...
- **标签：** `plugin-marketplace`, `harness-ai`
- **推荐理由：** DeepSeek Harness插件市场和捆绑包中心
...
- **标签：** `awesome-dsh-plugin`, `plugin-marketplace`, `awesome-list`
...
- **标签：** `awesome-list`, `dsh-plugin`, `plugin-marketplace`
- **推荐理由：** cordis.run官方自动维护的��件精选目录
...
- **标签：** `community`, `photo`, `oauth`, `beta`
- **推荐理由：** DSH内测合影墙，GitHub OAuth即时摄影站
...
- **标签：** `awesome-list`, `curated`, `registry`
- **推荐理由：** 经过验证的DSH插件精选目录与权限指引
...
- **标签：** `ai-agent`, `awesome-list`, `deepseek-harness`
- **推荐理由：** 2026年DSH插件精选目录
...
- **标签：** `plugin-portal`, `web`, `static-site`
- **推荐理由：** 静态插件门户便于发现和安装
...
- **标签：** `dsh-plugin-market`, `plugin-bundle`

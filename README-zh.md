...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 203,370 | Core DSH framework powering the entire plugin ecos |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 92,616 | Local-first design desktop app with AI-powered pro |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,720 | Deploy multi-agent swarms with autonomous workflow |
...
- **标签：** `ai-agent`, `multi-agent`, `skills`, `mcp`
- **推荐理由：** 带记忆和自我进化能力的超级AI助手
...
- **标签：** `coding-agent`, `cli`, `tui`, `prompt-caching`, `r1`
...
- **标签：** `agent-os`, `loop-engineering`, `mcp`, `llm-evaluation`
- **推荐理由：** 自进化Agent操作系统，专注循环工程与LLM评估
...
- **标签：** `agent-workspace`, `enterprise`, `multi-agent`, `visual-editor`
- **推荐理由：** 企业级多引擎Agent工作台，支持可视化编辑器
...
- **标签：** `preset`, `dsh`, `standard`, `bootstrap`
- **推荐理由：** 两阶段启动预设，达成Project2 98/99标准对齐
...
- **推荐理由：** 一键切换 Claude Code、Codex、DeepSeek 等多种 AI 编码工具
...
- **推荐理由：** 高性能 Rust Agent 运行时，结合桌面 IDE 的完整编码体验
...
- **标签：** `security`, `cybersecurity`, `vulnerability`
- **推荐理由：** 审计AI生成代码的安全漏洞
...
- **标签：** `dsh-plugin`, `tool-management`
- **推荐理由：** 统一管���MCP工具和技能暴露级别的菜单
...
- **推荐理由：** 便携 Agent Skill 开发审计 DSH 插件。
...
- **标签：** `agent-tools`, `utility`, `harness`
- **推荐理由：** 任务前自动预检并注入Top-K适用插件的检查工具
...
- **标签：** `agent-skills`, `ai-design`, `desktop-app`, `figma-alternative`
- **推荐理由：** 本地优先的AI设计桌面应用，支持原型生成
...
- **标签：** `agent-skills`, `mcp-server`, `self-hosted`, `resume-builder`
...
- **标签：** `desktop`, `dsh-plugin-desktop`, `deepseek-harness`
...
- **标签：** `browser-extension`, `chat-management`, `prompt-manager`, `chrome-extension`
- **推荐理由：** 增强Gemini/Claude/ChatGPT浏览器的扩展套件
...
- **标签：** `dsh-web`, `ui`, `plugin-aggregation`, `web`
- **推荐理由：** DSH Web插件聚合包，创意工坊分发平台
...
- **推荐理由：** 开放侧边栏底座，支持文件编辑、终端、对话、Git 等扩展
...
- **推荐理由：** 现代化可灵活嵌入任务面板，支持 Codex 和 DeepSeek Harness
...
- **推荐理由：** 鲸鱼主题 TUI 插件，支持实时状态显示和流式思考过程
...
- **标签：** `desktop`, `tauri`, `ui`
- **推荐理由：** 轻量5MB Tauri桌面应用，预装插件零配置开箱即用
...
- **标签：** `desktop-app`, `tauri`, `local-first`
- **推荐理由：** 本地优先的多模型AI代理桌面应用
...
- **标签：** `desktop`, `gui`, `ssh`
- **推荐理由：** 功能完整的Windows桌面GUI，集成SSH、技能与远程访问。
...
- **推荐理由：** DSH底部信息栏，显示提供商、余额、定价和使用统计
...
- **推荐理由：** DSH作曲器中集成的WorkBuddy风格技能选择器
...
- **标签：** `deepseek-harness`, `desktop`, `docker`, `dsh-plugin`, `ssh`, `sftp`
- **推荐理由：** Tauri 一体化桌面，集成数据库/SSH/Docker/AI。
...
- **标签：** `desktop`, `electron`, `ui`, `dsh`
- **推荐理由：** Electron桌面壳，集成DSH Web、侧边栏和ModLens
...
- **标签：** `awesome-dsh-plugin`, `dsh-plugin-market`, `ui`
...
- **标签：** `memory`, `rag`, `long-term-memory`, `mcp`, `agent-memory`
- **推荐理由：** 可移植的本地优先记忆层，Markdown原生跨应用持久化
...
- **标签：** `memory`, `rag`, `self-evolving`, `mcp`, `token-savings`
...
- **推荐理由：** AI 代理记忆管理核心工具，支持 RAG 检索增强
...
- **推荐理由：** 基于 Milvus 的持久化统一记忆层，支持混合搜索与语义检索
...
- **标签：** `memory`, `agentic-ai`, `persistent`
- **推荐理由：** 多AI共享的个人记忆中枢，持久上下文管理
...
- **标签：** `embeddings`, `semantic-search`, `vector-search`
- **推荐理由：** 将SKILL.md转化为RAG就绪技能语料
...
- **标签：** `multi-agent`, `agent-workflow`, `skills`, `mcp-server`
...
- **标签：** `ai-image-generation`, `skills`, `prompt-engineering`, `workflow-automation`
- **推荐理由：** 530+工业级图像提示词及可复用Skills
...
- **标签：** `agent-workspace`, `skills`, `no-code`, `own-your-data`
- **推荐理由：** 跨设备统一Agent工作空间，支持看板跟踪任务
...
- **推荐理由：** 智能技能路由与工作流编排引擎，提升 AI 代理协作效率
...
- **推荐理由：** 基于 Anthropic J-space 全局工作空间研究的认知增强技能集
...
- **标签：** `workflow`, `productivity`, `multi-platform`
...
- **标签：** `creative-writing`, `fiction`
- **推荐理由：** 基于Oh Story的小说与短剧创作技能。
...
- **标签：** `skills`, `automation`
- **推荐理由：** 将经验转化为跨AI Agent的可重复技能。
...
- **标签：** `agent-review`, `self-evolving`, `plan-mode`
- **推荐理由：** 支持Agent可组合、可审查的自进化工作流
...
- **标签：** `session-migration`, `context-migration`
- **推荐理由：** 跨配置会话迁移，保留状态与意图
...
- **推荐理由：** 移植superpowers：TDD、调试、规划协作技能
...
- **标签：** `skills`, `reasonix`
- **推荐理由：** Superpowers技能移植至Reasonix编程工具
...
- **标签：** `agent-skill`, `coding`
- **推荐理由：** 带代码审查和练习的AI编程导师技能
...
- **标签：** `agent-skill`, `plugin-manage`, `credentials`
- **推荐理由：** 管理已安装DSH插件、插槽和凭据的Agent Skill
...
- **标签：** `agent-skill`, `spec-programming`, `vibe-coding`
- **推荐理由：** 可移植的规格驱动开发Skill，支持仓库级编程工作流
...
- **推荐理由：** 带OCR工具的图像转文字Skill，适用于纯文本模型
...
- **标签：** `knowledge-base`, `plugin-dev`, `agent-skill`
- **推荐理由：** 可安装的插件开发知识库Agent Skill，含官方文档
...
- **标签：** `skills`, `task-board`, `agent-skill`
- **推荐理由：** DSH中MattPocock技能的可视化任务面板
...
- **推荐理由：** 八字/风水/易经中华传统智慧AI技能包，带可视化面板
...
- **标签：** `plugin-creator`, `codex`, `agent-skill`
- **推荐理由：** 可复用的Codex Skill，用于构建和验证DSH插件
...
- **推荐理由：** 跨平台Agent接力Skill，支持仓库级上下文记忆
...
- **标签：** `skills-manager`, `plugin`, `agent-skill`
- **推荐理由：** 在DSH中统一加载和管理本地Agent技能的插件
...
- **⭐ 星标：** 24
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面��公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `gongwen`, `docx`, `chinese`
- **推荐理由：** 中文公文全流程处理，格式检查与模板生成。
...
- **标签：** `ai-director`, `ai-image`, `ai-video`, `deepseek-harness`, `dsh-plugin`, `storyboard`, `text-to-video`
- **推荐理由：** AI 视频/图像/音频技能，含分镜工具。
...
- **标签：** `agent-skills`, `ai-testing`, `deepseek-harness`, `dsh-plugin`, `playwright`, `pytest`, `qa`
- **推荐理由：** 资深测试工程师级 Skill 框架，含共享知识库。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `game-development`, `godot`, `gdscript`
- **推荐理由：** Godot 4.x 全栈游戏开发 Agent Skill。
...
- **标签：** `agent-skills`, `agentic-workflow`, `deepseek-harness`, `dsh-plugin`, `canvas`, `mcp`
- **推荐理由：** 无限画布配合创意 Agent 技能与 MCP 工具。
...
- **标签：** `vision`, `ocr`, `mcp`, `multimodal`, `image-to-text`
...
- **推荐理由：** 在DSH中直接搜索65,600+中国平台API文档
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `hot-reload`, `mcp`, `mcp-server`, `skills`
- **推荐理由：** 热加载 MCP 配置免重启，内置技能管理。
...
- **标签：** `architecture-diagram`, `diagrams-as-code`, `mermaid-alternative`, `code-visualization`
- **推荐理由：** AI生成精美可验证的架构图和流程图
...
- **标签：** `design`, `ui`, `vibedesign`, `agent-team`, `flutter`
...
- **推荐理由：** 端到端自动化生成 Vox 风格拼贴解说视频，支持 TTS 和 ffmpeg
...
- **标签：** `ai-design`, `design-studio`, `ppt`, `visual-editor`
- **推荐理由：** AI设计工作室，支持PPT和可视化编辑
...
- **标签：** `design`, `visual`, `styles`
- **推荐理由：** 6种设计美学风格包，避免AI感设计。
...
- **标签：** `content-discovery`, `ai-agent`, `dsh-plugin`
- **推荐理由：** 跨平台 AI 内容发现 Agent，覆盖 B站、YouTube、X 等平台
...
- **推荐理由：** GitHub OAuth 零权限合影墙，内测社区趣味功能。
...
- **标签：** `image-uploader`, `cloudflare-r2`, `s3`, `electron`
...
- **标签：** `routing`, `cordis`, `harness`, `infrastructure`
- **推荐理由：** 运行时注入器+任务感知路由，提升DSH推理效率
...
- **标签：** `vfs`, `virtual-filesystem`, `infrastructure`, `python`
- **推荐理由：** 统一虚拟文件系统，为Agent提供持久化文件上下文
...
- **推荐理由：** DSH 内置可视化插件市场，支持浏览、搜索和一键安装
...
- **标签：** `cost-tracking`, `budget`
- **推荐理由：** 跨提供商追踪会话成本与Token用量。
...
- **标签：** `compatibility`, `migration`
- **推荐理由：** 兼容层，让Pi扩展无缝运行于DSH。
...
- **推荐理由：** 锤子便签风格，支持Docker私有部署和公众号导出
...
- **标签：** `dsh-box`, `container`, `plugin-manage`
- **推荐理由：** 隔离容器运行多版本DSH，一键导入插件和技能
...
- **标签：** `package`, `agents`, `skills`
- **推荐理由：** 42项技能+5个CLI的AI代理资产包管理器。
...
- **标签：** `agent-migration`, `deepseek-harness`, `dsh-plugin`, `mcp`, `skills`
...
- **标签：** `ai-cost`, `data-visualization`, `deepseek-api`, `deepseek-harness`, `dsh-plugin`, `token-usage`
- **推荐理由：** 实时 Token 用量图表和费用估算。
...
- **推荐理由：** 鲸鱼娘系列皮肤，美化 DeepSeek Harness 界面外观
...
- **⭐ 星标：** 129
- **语言：** JavaScript
- **描述：** DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。
- **标签：** `theme`, `skin`, `wallpaper`
- **推荐理由：** 8套Mirage主题，支持自定义强调色与壁纸
...
- **推荐理由：** 自动搜索国内 8 大主流平台近 30 天内容，生成有据可查研究报告
...
- **标签：** `knowledge-base`, `ai-pedia`, `mcp`
- **推荐理由：** 全面的AI资源百科与导航库
...
- **标签：** `guide`, `awesome-list`
- **推荐理由：** DSH终极指南，含入门、资源与精选插件。
...
- **标签：** `marketplace`, `directory`
- **推荐理由：** 1万+插件的市场，支持搜索与免费API。
...
- **推荐理由：** DeepSeek Harness生态插件市场与中心。
...
- **⭐ 星标：** 57
- **语言：** Python
- **描述：** 专利侵权分析���统 —— 输入专利公开号，产出竞品侵权分析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 调用。
- **标签：** `patent`, `rag`, `legal-tech`
- **推荐理由：** 专利侵权分析，支持Skill打包调用
...
- **标签：** `dsh-plugins`, `awesome-list`, `plugin-registry`
...
- **标签：** `ai-agent`, `awesome-list`, `dsh-plugin`
...
- **推荐理由：** GitHub Actions每日自动爬取的双语目录
...
- **标签：** `ai-agents`, `coding-agents`, `awesome-list`, `mcp`
...
- **标签：** `agent-harness`, `coding-agents`, `curated-list`, `dsh-plugin`
- **推荐理由：** 覆盖模型、工具、沙箱、UI的精选插件
...
- **标签：** `industry`, `directory`, `curation`
- **推荐理由：** 精选各行业DSH插件目录，便于研究和发现
...
- **标签：** `low-code`, `crm`, `erp`, `internal-tools`, `workflows`
- **推荐理由：** AI+无代码平台，快速构建业务系统
...
- **推荐理由：** Agent CLI装饰性像素宠物画廊，提升交互趣味
...
- **标签：** `toy`, `web`, `dsh-plugin`
- **推荐理由：** 零依赖单文件网页版传统玩具竹知了，移动端优先
...
- **标签：** `prompt`, `deepseek`, `armor-breaking`
- **推荐理由：** DeepSeek专用破甲提示词插件，提升生成稳定性
...
- **标签：** `anime`, `torrent`, `bangumi`
- **推荐理由：** 多源搜番，展示Bangumi评分与磁力链接
...
- **标签：** `awesome-list`, `curated-list`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 精选 DSH 插件目录，便于生态探索。
...
- **标签：** `awesome-list`, `curated-list`, `deepseek-harness`, `dsh-plugins`, `plugin-registry`
- **推荐理由：** 反垃圾开源插件注册表和技能目录。
...
- **标签：** `awesome-list`, `resource`, `dsh`
- **推荐理由：** 全面的DSH生态资源汇总，覆盖插件、工具和技能
...
- **标签：** `awesome-list`, `verified`, `dsh-plugin`
- **推荐理由：** 按星标排序的已验证社区DSH插件
...
- **标签：** `documentation`, `awesome-list`, `guide`
- **推荐理由：** 按场景选插件的说明书与导航，含权限兼容性说明
...
- **标签：** `portal`, `web`, `plugin-directory`

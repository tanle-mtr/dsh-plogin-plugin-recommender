...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 195,120 | Core DSH framework enabling everything-as-plugin a |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,457 | Local-first desktop design tool, open-source Figma |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,396 | Original meta-harness for multi-agent swarms and a |
...
- **标签：** `ai-agent`, `mcp`, `multi-model`
- **推荐理由：** 开源AI助手框架，支持多模型多通道
...
- **标签：** `agent-orchestration`, `workspace`, `no-code`
- **推荐理由：** 全平台统一Agent工作区，支持多设备同步。
...
- **标签：** `agent-collaboration`, `enterprise`, `workbench`
- **推荐理由：** 企业级多引擎Agent工作���，支持可视化编辑。
...
- **标签：** `preset`, `bootstrap`, `harness-tools`
- **推荐理由：** 两阶段预设，从最小引导到完整工具链。
...
- **标签：** `agent-runtime`, `rust`, `coding-agent`
...
- **标签：** `code-review`, `code-quality`, `clean-architecture`
- **推荐理由：** 基于12本经典工程的AI代码审查工具。
...
- **推荐理由：** 通过OAuth将ChatGPT/Claude/Grok订阅转为LLM后端。
...
- **推荐理由：** AI编程导师，阶梯式教学+自动判题+Code Review
...
- **推荐理由：** 开发DSH插件的标准技能：槽位、工具、适配器、打包
...
- **标签：** `capability-menu`, `mcp`, `tool-management`
...
- **标签：** `codex`, `sync`, `bridge`
- **推荐理由：** OpenAI Codex与DSH双向桥接，实时同步。
...
- **标签：** `image-generation`, `vision`, `media`, `skils`
- **推荐理由：** 免费的图片读取和生成，支持视觉自动转录
...
- **标签：** `package-manager`, `agent`, `cli`, `skills`
- **推荐理由：** 包含42个AI代理技能和5个CLI的包管理器
...
- **标签：** `plugin`, `development`, `audit`, `skill`
- **推荐理由：** 开发审计DSH插件的可移植技能工具
...
- **标签：** `development`, `practices`, `discipline`
- **推荐理由：** DSH项目必备开发纪律和事实核查
...
- **标签：** `plugin-creator`, `codex`, `scaffolding`
- **推荐理由：** 构建和验证DeepSeek Harness插件
...
- **标签：** `plugin-skills`, `testing`, `scaffolding`
- **推荐理由：** 构建和测试DSH插件的技能工具
...
- **标签：** `agent-tools`, `pre-flight`, `capability`
- **推荐理由：** Agent任务预检插件库并注入提示
...
- **标签：** `figma-alternative`, `desktop-app`, `ui-generator`
- **推荐理由：** 本地优先桌面设计工具，开源Figma替代方案
...
- **标签：** `desktop`, `dsh-plugin`, `modern-ui`
...
- **标签：** `web-ui`, `plugin-aggregator`, `dsh-plugin`
- **推荐理由：** Web插件聚合生态包，创意工坊分发。
...
- **标签：** `sidebar`, `deepseek-harness`, `extension`
- **推荐理由：** 可扩展侧边栏，内置文件编辑器/终端/Git等页面。
...
- **标签：** `floating-widget`, `cordis`
- **推荐理由：** 浮动鲸鱼小部件显示账户余额并带动画。
...
- **标签：** `desktop`, `agent`, `local-first`, `privacy`
- **推荐理由：** 本地优先的多模型桌面AI代理，注重隐私保护。
...
- **标签：** `ui`, `interactive`, `charts`
- **推荐理由：** 在对话中直接渲染图表、表单等交互UI组件。
...
- **推荐理由：** 跨平台桌面客户端，类CodePilot体验的插件套件。
...
- **标签：** `canvas`, `visualization`, `workspace`
...
- **推荐理由：** 开源Windows桌面GUI客户端，支持SSH与远程访问
...
- **⭐ 星标：** 57
- **语言：** TypeScript
- **描述：** DSH 插件生态���建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **标签：** `console`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-repository-plugin`, `plugin-management`, `ui`
- **推荐理由：** 浏览器插件管理控制台，零补丁集成官方仓库
...
- **推荐理由：** Electron桌面控制台，多Tab管理Harness/插件/MCP/技能
...
- **标签：** `ui`, `bar`, `info`, `pricing`
- **推荐理由：** 底部状态栏显示提供商、余额和实时定价倒计时
...
- **标签：** `canvas`, `creative`, `agent-skills`
- **推荐理由：** 无限画布创意技能原生插件
...
- **标签：** `memory-management`, `local-first`, `rag`
- **推荐理由：** 本地优先的通用记忆层，Markdown原生格式。
...
- **标签：** `memory-management`, `self-evolving`, `token-savings`
- **推荐理由：** 自演进记忆系统，混合检索节省35%令牌。
...
- **标签：** `memory`, `milvus`, `rag`, `embeddings`
...
- **推荐理由：** AI知识库百科，涵盖RAG、MLOps和Agent技能资源。
...
- **标签：** `agent-memory`, `embeddings`, `skill-md`
...
- **标签：** `knowledge-base`, `agent-skill`, `documentation`
- **推荐理由：** 官方DSH文档知识库，双语支持，按需调用。
...
- **标签：** `context-audit`, `token-analysis`, `ui`
- **推荐理由：** 上下文审计工具，检测重复指令与Token成本。
...
- **标签：** `agent-skills`, `cognitive-enhancement`, `inference-time-control`
- **推荐理由：** 基于Anthropic J-space研究的认知增强Skill集。
...
- **标签：** `ai-workflow`, `browser-extension`
- **推荐理由：** 将AI对话转化为可复用跨平台工作流。
...
- **标签：** `multi-agent`, `workflow`, `coding`
- **推荐理由：** 跨多个AI编码代理的多智能体协作编排。
...
- **标签：** `agent-skills`, `deepseek-harness`, `automation`
- **推荐理由：** 数学建模竞赛全栈自动化Skill，支持GitOps流水线
...
- **标签：** `creative-writing`, `dsh-plugin`, `fiction-writing`
- **推荐理由：** 小说创作与短剧生产DSH插件
...
- **标签：** `ai-infra`, `skills`, `coding-agent`
...
- **推荐理由：** 原生SQLite任务看板，支持Agent认领审核和Web界面。
...
- **推荐理由：** 集成Superpowers实战技能，覆盖TDD、调试、规划全流程
...
- **标签：** `skill-picker`, `ui-ux`, `composer`
- **推荐理由：** 类WorkBuddy的技能选择器，支持斜杠命令插入。
...
- **标签：** `multi-agent`, `team-collaboration`, `workspace`
...
- **标签：** `code-simplification`, `codex`, `refactoring`
- **推荐理由：** 源自DSH的代码简化与重构Codex技能。
...
- **标签：** `skills-manager`, `organization`, `tooling`
- **推荐理由：** DSH技能专属管理器，方便组织管理技能。
...
- **标签：** `swift-cycle`, `governance`, `version-control`
- **推荐理由：** Swift Cycle治理技能适配器，支持版本锁定。
...
- **⭐ 星标：** 16
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。原生支持 DeepSeek Harness (DSH) 技能系统，打包���可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `gongwen`, `document`, `workflow`, `chinese`
- **推荐理由：** 完整的中文公文处理工作流，符合GB/T国家标准
...
- **标签：** `skills`, `mission`, `game`, `workflow`
- **推荐理由：** 游戏化任务系统，引导代理完成复杂工作流
...
- **标签：** `agent`, `preset`, `product-team`
- **推荐理由：** 虚拟产品团队Agent预设，模拟多角色协作
...
- **推荐理由：** 在浏览器Web GUI中管理技能和MCP服务器的插件
...
- **标签：** `mcp`, `zhihu`, `search`, `api`
- **推荐理由：** 知乎搜索的MCP服务器和CLI工具，支持官方API
...
- **标签：** `mcp`, `plugin`, `config`, `hot-reload`
- **推荐理由：** 插件JSON配置转MCP服务器，支持热加载免重启
...
- **标签：** `diagrams-as-code`, `agent-skills`, `architecture-diagram`
- **推荐理由：** 自包含架构图表，支持动效与可验证输出。
...
- **标签：** `ai-design`, `visual-editor`
- **推荐理由：** AI驱动的设计工作室，支持原型和PPT制作。
...
- **标签：** `image-generation`, `dsh-plugin`, `gemini`
...
- **标签：** `kline`, `financial`, `visualization`
- **推荐理由：** 交互式K线分析，支持多市场技术指标。
...
- **标签：** `design`, `ui`, `web-design`, `vibe-coding`
- **推荐理由：** 6种精心设计的样式，防止网站看起来像AI生成
...
- **标签：** `video`, `image`, `audio`, `generation`
- **推荐理由：** AI视频/图像/音频生成，支持可配置的视觉模型
...
- **标签：** `browser-extension`, `prompt-manager`, `chat-management`
- **推荐理由：** 面向主流AI平台的浏览器增强套件
...
- **推荐理由：** 在对话中通过模拟器或USB构建运行Android应用。
...
- **标签：** `toy`, `web`, `mobile-first`
- **推荐理由：** 零依赖单文件趣味Web玩具，移动端优先。
...
- **标签：** `agent-vision-toolkit`, `computer-vision`
- **推荐理由：** 为纯文本LLM添加OCR和图像问答能力。
...
- **标签：** `awesome-list`, `discovery`, `plugin-marketplace`
- **推荐理由：** 每日自动抓取并精选推荐，按场景分类浏览。
...
- **标签：** `documentation`, `best-practices`, `learning`
- **推荐理由：** DSH原理学习、插件市场与最佳实践参考。
...
- **标签：** `cost-tracking`, `dsh-plugin`, `token-usage`
- **推荐理由：** 实时追踪会话成本、预算与token消耗
...
- **标签：** `marketplace`, `plugin-marketplace`, `webgui`
- **推荐理由：** Web界面一键浏览安装更新所有DSH插件。
...
- **标签：** `marketplace`, `webgui`, `plugin-market`
- **推荐理由：** 社区插件市场，Web界面一键安装卸载。
...
- **标签：** `container`, `local-dev`, `multi-version`
- **推荐理由：** 多版本隔离容器运行DSH，内嵌WebView界面。
...
- **标签：** `migration`, `claude-code`, `import`
...
- **标签：** `plugin-doctor`, `troubleshooting`, `utility`
- **推荐理由：** 诊断解决插件冲突和版本问题
...
- **推荐理由：** 34款opencode主题一键切换，重启不丢失配置
...
- **标签：** `ai-tutorial`, `resource`, `vibe-coding`
...
- **标签：** `evaluation`, `rag`, `agent-evaluation`, `observability`
- **推荐理由：** 基于证据的RAG和Agent评估框架，支持可观测性
...
- **标签：** `registry`, `spam-filtered`, `open-data`
- **推荐理由：** 垃圾过滤的DSH插件注册表
...
- **标签：** `verified`, `installation`, `guide`
- **推荐理由：** 经过验证的插件和安装指南
...
- **标签：** `awesome-list`, `radar`, `evidence`
- **推荐理由：** 基于证据的插件雷达和插件实验室
...
- **标签：** `awesome-list`, `catalog`, `automated`
- **推荐理由：** 每日自动爬取的双语插件目录
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh-plugins`
- **推荐理由：** 精选插件、工具、技能与资源合集
...
- **标签：** `awesome`, `curated-list`
- **推荐理由：** 精选插件、工具和基础设施生态索引。
...
- **标签：** `security`, `redteam`, `vulnerability`
- **推荐理由：** AI安全攻防工具，审计幻觉包和漏洞。
...
- **标签：** `armor-breaking`, `prompt`
- **推荐理由：** DeepSeek破甲提示词插件，突破模型限制。
...
- **标签：** `community`, `photo`, `beta`, `event`
- **推荐理由：** DSH内测收官的社区合影墙，记录开发历程
...
- **标签：** `documentation`, `best-practices`, `development`, `archive`
- **推荐理由：** 插件开发的坑点记录和最佳实践档案文档
...
- **标签：** `marketplace`, `dsh-plugin`, `dsh-plugin-bundle`
- **推荐理由：** 类CodeX的插件市场，便于浏览安装

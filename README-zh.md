...
- **标签：** `coding-agent`, `deepseek`, `tui`, `dsh-plugin`
- **推荐理由：** 终端原生DeepSeek编码Agent，前缀缓存优化。
...
- **标签：** `dsh`, `routing`, `agent`, `cordis`
- **推荐理由：** 任务感知路由注入器，优化Agent推理
...
- **标签：** `agent-control`, `loop`, `workflow`
- **推荐理由：** 跨Harness的长期Agent控制面
...
- **标签：** `deepseek-harness`, `preset`, `bootstrap`
- **推荐理由：** 两阶段预设，从最小化引导到完整标准工具集
...
- **标签：** `agent-sandbox`, `virtual-filesystem`, `terminal`
- **推荐理由：** AI代理首个虚拟终端，支持VFS和沙盒环境
...
- **标签：** `code-review`, `architecture`, `clean-code`
- **推荐理由：** 基于经典工程书籍的AI代码审查工具。
...
- **标签：** `agent-teams`, `multi-agent`, `collaboration`
- **推荐理由：** 支持多代理团队协作的DSH插件。
...
- **标签：** `security`, `vulnerability`, `redteam`, `code-review`
- **推荐理由：** 审计AI生成代码中的幻觉包、安全漏洞及AI模式错误
...
- **标签：** `subscriptions`, `oauth`, `multi-provider`, `llm`
- **推荐理由：** ��ChatGPT/Claude/Grok订阅账号作为DSH的LLM提供源，免API密钥
...
- **标签：** `coding-agent`, `sub-agents`, `mcp`, `go`
- **推荐理由：** 支持子Agent、NPC插件和MCP的全功能编程Agent
...
- **标签：** `self-evolving`, `agent-review`, `plan-mode`
- **推荐理由：** 可组合任务控制，实现Agent自我进化与人工审查
...
- **标签：** `tdd`, `debugging`, `planning`
- **推荐理由：** 将成熟的TDD、调试和规划技能适配到代码开发中。
...
- **标签：** `reverse-engineering`, `security`, `pentest`
- **推荐理由：** 全面的逆向工程和授权渗透测试技能集。
...
- **标签：** `agent-skill`, `dsh-plugin`, `plugin-dev`
- **推荐理由：** DSH 插件开发标准技能，支持插件/事件/工具一体化开发。
...
- **标签：** `dsh-plugin`, `agent-skill`, `management`
- **推荐理由：** 管理已安装 DSH 插件插槽、远程连接和凭据的 Agent 技能。
...
- **标签：** `plugin-dev`, `coding-agent`, `validator`
- **推荐理由：** 构建和验证 DSH/Cordis 插件的复用型技能，兼容 Codex。
...
- **标签：** `agent-tools`, `automation`
- **推荐理由：** 任务型请求预检插件库，自动注入适用插件提示。
...
- **推荐理由：** 通过OAuth绑定ChatGPT账号，在DSH中使用其模型。
...
- **标签：** `desktop`, `dsh-plugin`, `cordis`, `dsh`
- **推荐理由：** DSH生态现代化桌面端，插件优先架构。
...
- **标签：** `widget`, `ui`, `dashboard`
- **推荐理由：** 可爱鲸鱼悬浮窗，实时查看账户余额。
...
- **标签：** `ui`, `components`, `charts`, `forms`
- **推荐理由：** 在DSH对话回复中内联渲染图表、表单等交互式UI组件
...
- **标签：** `desktop-app`, `multi-model`, `local-first`, `privacy`
- **推荐理由：** 本地优先的多模型桌面端AI助手，支持自进化技能与隐私保护
...
- **标签：** `desktop-app`, `electron`, `ssh`, `gui`
- **推荐理由：** 开源Windows桌面客户端，集成插件、技能、SSH与移动端远程访问
...
- **推荐理由：** 基于画布的非线性会话工作区，支持对话分支与可视化探索
...
- **标签：** `desktop-app`, `cross-platform`, `electron`
- **推荐理由：** 跨平台桌面客户端，仿CodePilot风格，支持macOS/Windows/Linux
...
- **标签：** `office`, `spreadsheets`, `productivity`
- **推荐理由：** 将完整办公套件嵌入Harness，支持表格文档幻灯片
...
- **推荐理由：** 直接在对话中预览和编辑OpenPencil UI设计文档。
...
- **标签：** `marketplace`, `ui`, `plugin-management`
- **推荐理由：** DSH Web GUI的插件市场，方便浏览和安装社区插件。
...
- **标签：** `dsh-plugin`, `balance`, `usage-tracking`
- **推荐理由：** 底部信息栏显示用量余额和定价详情
...
- **推荐理由：** 一站式DevOps桌面：数据库、SSH、Docker、AI。
...
- **标签：** `electron`, `desktop-app`
- **推荐理由：** Electron桌面版DeepSeek Harness，集成多项工具。
...
- **标签：** `memory`, `rag`, `skills`, `mcp`
- **推荐理由：** 自进化记忆系统，节省35% token成本
...
- **标签：** `memory`, `rag`, `agent-memory`
- **推荐理由：** 专为Agent设计的记忆管理套件，支持RAG
...
- **推荐理由：** 基于Milvus的持久统一Agent记忆层，支持语义搜索
...
- **标签：** `agentic-ai`, `multi-agent`, `swarm`, `dsh-plugin`
- **推荐理由：** 多智能体蜂群协调框架，自主工作流引擎。
...
- **标签：** `agent`, `workspace`, `mcp`, `no-code`
- **推荐理由：** 全平台统一的Agent工作空间与任务看板
...
- **标签：** `video-generation`, `agent-skills`, `ffmpeg`
- **推荐理由：** 一键自动生成科普视频，端到端自动化。
...
- **标签：** `agent-skills`, `skill-md`, `embeddings`, `vector-search`
- **推荐理由：** 将零散技能文件整合为可检索的智能体技能库，支持评���与路由
...
- **推荐理由：** 原生SQLite任务看板��支持项目管理与智能体评审工作流
...
- **推荐理由：** AI驱动的小说与短剧创作技能插件，专注创意写作流程
...
- **推荐理由：** 全栈数学建模竞赛技能，含GitOps流水线与代码自证
...
- **标签：** `agent-skills`, `vision`, `multimodal`
- **推荐理由：** 为代码流程增加多模态视觉能力，适合UI自动化分析。
...
- **标签：** `migration`, `context`, `workflow`
- **推荐理由：** 实现不同预设会话间的状态和上下文无缝迁移。
...
- **标签：** `agent-skills`, `spec-programming`, `ai-coding`
- **推荐理由：** 遵循 DeepSeek 工程模式的仓库原生 Spec 驱动开发技能。
...
- **标签：** `knowledge-base`, `plugin-dev`, `scaffold`
- **推荐理由：** 官方文档知识基底插件开发技能，支持中英双语按需查询。
...
- **标签：** `agent-skill`, `chinese-wisdom`, `dashboard`
- **推荐理由：** 融合八字/风水/中医/易经的本地确定性引擎，带可视化面板。
...
- **标签：** `agent-skill`, `docx`, `gongwen`
- **推荐理由：** 中文公文全流程处理，含格式检查、模板生成和风格增强。
...
- **推荐理由：** 多 Agent 协作方案，支持独立模型、技能和共享工作空间。
...
- **标签：** `agent-handoff`, `agent-skills`, `dsh-plugin`
- **推荐理由：** 跨平台会话记忆，支持Agent任务交接
...
- **标签：** `dsh-plugin`, `code-simplification`
- **推荐理由：** 改编自DSH的代码简化技能，兼容Codex
...
- **标签：** `qa`, `agent-skills`, `testing`, `dsh-plugin`
- **推荐理由：** 资深测试工程师级AI Agent技能框架
...
- **标签：** `agent-framework`, `skills`, `dsh-plugin`
- **推荐理由：** 42个Agent技能与5个CLI的工具包管理器
...
- **标签：** `godot`, `game-development`, `dsh-plugin`
- **推荐理由：** Godot 4.x全栈游戏开发专用技能插件
...
- **推荐理由：** Swift Cycle治理技能，版本固定可离线验证。
...
- **标签：** `skill`, `plugin-development`, `agent-skills`
...
- **标签：** `agent-skills`, `plugin-development`, `cordis`
- **推荐理由：** 便携式开发审计技能，可选bundle适配。
...
- **推荐理由：** 在harness界面内直接管理技能和MCP服务器的Web UI工具。
...
- **标签：** `agent-skills`, `architecture-diagram`, `mermaid-alternative`, `dsh-plugin`
- **推荐理由：** Agent生成的精美架构图与交互可视化技能。
...
- **推荐理由：** 530+工业级图像提示词模板，提炼为Agent技能。
...
- **推荐理由：** 在DSH对话中直接使用Seedream/OpenAI/Gemini生成AI图像
...
- **标签：** `design`, `ui`, `dsh-plugin`
- **推荐理由：** 6套设计风格，告别千篇一律的AI视觉
...
- **标签：** `video`, `image-generation`, `directorx`, `dsh-plugin`
- **推荐理由：** AI视频/图像/音频生成与编辑技能套件
...
- **标签：** `knowledge-cards`, `dsh-plugin`
- **推荐理由：** 将聊天记录转化为精美知识卡片下载分享
...
- **标签：** `browser-extension`, `chat-management`, `prompt-manager`, `dsh-plugin`
- **推荐理由：** 跨浏览器AI工具增强套件，支持多平台。
...
- **标签：** `content-discovery`, `cross-platform`, `web-automation`
- **推荐理由：** 跨平台内容发现Agent，覆盖B站、YouTube、小红书等
...
- **标签：** `web-search`, `free`, `no-signup`, `browser`
- **推荐理由：** 免费网页搜索桥接插件，无需注册或API密钥即可为任意模型联网
...
- **推荐理由：** 在DSH中运行iOS模拟器并提供22个移动端自动化Agent工具
...
- **标签：** `agent-skills`, `mcp-server`, `self-hosted`, `dsh-plugin`
- **推荐理由：** 隐私优先的自托管简历生成器，支持MCP。
...
- **标签：** `image-uploader`, `electron`, `s3`, `dsh-plugin`
- **推荐理由：** 支持60+图床的终极图片上传工具，生态广泛。
...
- **标签：** `low-code`, `crm`, `workflows`, `dsh-plugin`
...
- **标签：** `utility`, `model-switch`, `installer`
- **推荐理由：** 一键安装并切换Claude Code、Codex、DSH等多种AI工具
...
- **标签：** `plugin-registry`, `validation`, `ecosystem`
- **推荐理由：** 自动发现并验证15900+插件的生态雷达。
...
- **推荐理由：** 实时追踪会话成本、预算和Token用量，支持多Provider
...
- **推荐理由：** 打通Pi与DSH生态，通过ABI层运行Pi扩展插件
...
- **推荐理由：** 在Harness内直接搜索、安装和验证GitHub插件
...
- **标签：** `notes`, `utility`, `docker`
- **推荐理由：** 开源锤子便签克隆版，支持Docker部署和微信导出。
...
- **标签：** `remote`, `access`, `p2p`
- **推荐理由：** 安全的P2P远程访问方案，支持多端操作Harness。
...
- **标签：** `plugin-dev`, `utility`, `upgrade`
- **推荐理由：** D SH 版本升级时自动更新插件，减少手动维护负担。
...
- **标签：** `dsh`, `container`, `management`
- **推荐理由：** 容器隔离运行多个 DSH 版本，内置 WebView UI，一键导入插件。
...
- **推荐理由：** 审计上下文指令链与工具 Schema，检测重复冲突，含 Web UI。
...
- **标签：** `config-sync`, `mcp`, `agent-config`
- **推荐理由：** 一键配置 Claude Code、Codex、DSH 等多款 AI Agent 工具。
...
- **标签：** `agent-migration`, `configuration-migration`, `mcp`, `skills`
- **推荐理由：** 从Claude Code迁移技能、命令、MCP配置到DSH。
...
- **标签：** `claude-code`, `migration`, `session-import`, `resume`
- **推荐理由：** 四源迁移向导：Claude/Codex/OpenCode/Hermes。
...
- **标签：** `mascot`, `pixel-art`, `ui`, `cli`
- **推荐理由：** Coding Agent动画宠物表情包画廊
...
- **标签：** `theme`, `skin`, `whale`
- **推荐理由：** DeepSeek Harness鲸鱼娘系列视觉主题
...
- **⭐ 星标：** 397
- **语言：** JavaScript
- **描述：** 是一层高自由度的玻璃质感主题，套在 DeepSeek Harness 网页端。顶栏、侧边栏、输入框、统计行、轨迹视图都成了磨砂玻璃片。玻璃模糊度、磨��度、背景（流体或自定义壁纸，壁纸还能单独调模糊和磨砂）全都能在设置卡片里自由调节。关掉开关就回到原生界面，不改 DSH 任何一行源码。
- **标签：** `theme`, `ui`, `glassmorphism`
- **推荐理由：** 高自由度磨砂玻璃主题，不改动源码即可深度定制DSH界面外观
...
- **推荐理由：** WebGPU海洋主题皮肤，支持Chrome/Edge原生集成
...
- **⭐ 星标：** 5
- **语言：** JavaScript
- **描述：** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸���种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **标签：** `theme`, `customization`, `webui`
- **推荐理由：** 自定义DSH网页背景，支持图片上传与预设氛围。
...
- **标签：** `ai`, `llm`, `rag`, `mcp`
- **推荐理由：** 最全AI资源大全+Vibe Coding零基础教程
...
- **标签：** `research`, `web-search`, `china`, `skill`
- **推荐理由：** 自动搜索中文8大平台近30天内容生成研究报告
...
- **标签：** `awesome-list`, `bilingual`, `resources`
- **推荐理由：** 中英双语DSH插件和扩展精选列表。
...
- **标签：** `ai-knowledge`, `resource-hub`, `awesome-list`
- **推荐理由：** 涵盖大模型、Agent、RAG、MLOps的AI全维度资源百科与学习导航
...
- **推荐理由：** 每日自动更新插件目录，精选真实分类，剔除蹭标签项目
...
- **标签：** `awesome-list`, `mcp`, `visualization`
- **推荐理由：** 精心整理的DSH插件、技能、MCP和编排器目录
...
- **⭐ 星标：** 214
- **语言：** JavaScript
- **描述：** DeepSeek Harness plugin store, marketplace and hub — 11,000+ dsh plugins with search, rankings, install commands and a free public API. DeepSeek Harness 插件市场 / 插件商店：自动收��与格式校验，免费搜索 API。deepseek1024.com
- **标签：** `marketplace`, `catalog`, `api`
- **推荐理由：** 11,000+插件商店，支持搜索和公共API，规模庞大
...
- **标签：** `directory`, `catalog`, `search`
- **推荐理由：** 1958个仓库的插件总目录，支持搜索和STAR排序
...
- **标签：** `academic-search`, `research`, `citation`
- **推荐理由：** 跨数据库学术搜索，支持引文图谱和验证。
...
- **标签：** `research`, `latex`, `gpu-cluster`
- **推荐理由：** 一站式科研工作台：LaTeX写作、arXiv管理和GPU任务编排。
...
- **推荐理由：** 收录 14 类 280+ DSH 社区插件的精选目录，便于探索发现。
...
- **标签：** `dsh-plugin`, `kline`, `analysis`
- **推荐理由：** 交互式K线分析，支持多市场行情与技术指标
...
- **标签：** `awesome-dsh-plugin`, `dsh-repository-plugin`
- **推荐理由：** 经过验证的DSH插件 curated 目录
...
- **标签：** `curated-list`, `coding-agents`, `ui`
- **推荐理由：** 覆盖模型、工具、沙箱、UI的全方位插件策展
...
- **推荐理由：** 有趣的动漫搜索插件，支持Bangumi评分和磁力链。
...
- **推荐理由：** 精心策划的DeepSeek Harness插件优质列表。
...
- **⭐ 星标：** 78
- **语言：** Python
- **描述：** 🐳 DeepSeek Harness 插��聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic
...
- **推荐理由：** 🐳 DeepSeek Harness 插��聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 4 小时自动维护 | Oh-My-DSH
...
- **推荐理由：** ProMentor 是一个 AI Coding Agent Skill。装上它，你的 AI 编程助手立刻化身为导师——扫描项目架构、��成阶梯式 Chapter
...
- **标签：** `agentic-ai`, `claim-chart`, `claude-code`, `claude-code-skill`, `codex`, `dsh-plugin`, `fastapi`, `intellectual-property`, `legal-tech`, `llm-agent`, `multi-agent`, `multimodal`, `patent`, `patent-analysis`, `patent-infringement`, `patent-search`, `patents`, `prior-art`, `python`, `rag`
- **推荐理由：** 专利侵权分析系统 —— 输入专利公开号，产出竞品侵权分析报告；同时打包成 skill，可被任意 agent（dsh, codex, claudecode 等） 
...
- **⭐ 星标：** 50
- **语言：** Python
- **描述：** 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通��。
...
- **推荐理由：** 社区精选好用的DeepSeek Harness插件集合。
...
- **标签：** `awesome-list`, `inventory`
- **推荐理由：** 千余个DSH工具的完整清单，按星标排序。

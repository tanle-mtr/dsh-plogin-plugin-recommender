...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 218,942 | Core DSH framework; foundational plugin ecosystem  |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 95,380 | Open-source design system generator with local-fir |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 71,947 | Multi-agent swarm orchestrator for autonomous work |
...
- **标签：** `multi-agent`, `ai-agent`, `mcp`, `skills`
- **推荐理由：** 多功能多代理框架，具备自我进化记忆和技能管理。
...
- **标签：** `coding-agent`, `tui`, `prompt-caching`, `r1`, `cli`
- **推荐理由：** 终端原生DeepSeek编码代理，前缀缓存稳定适合长时间运行。
...
- **标签：** `routing`, `injector`, `harness-tool`
- **推荐理由：** 任务感知推理模式路由器，提供高级DSH运行时控制能力。
...
- **推荐理由：** 自我进化的Agent OS，带分阶段评估和MCP服务器集成。
...
- **推荐理由：** 长期Agent控制平面，支持跨Harness的持久可控工作流。
...
- **推荐理由：** 企业级多引擎Agent工作台，统一任务和团队协作管理。
...
- **推荐理由：** DSH首个视觉插件，将图片转为结构化JSON，赋能��本编码代理
...
- **推荐理由：** 一键切换多模型编码代理，支持Claude/Codex/Kimi/Qwen等
...
- **标签：** `runtime`, `agent`, `desktop`
- **推荐理由：** 高性能Rust代理运行时，搭配精美桌面应用
...
- **标签：** `coding-agent`, `cli`, `rpc`, `mcp`
- **推荐理由：** 含RPC、子代理和MCP支持的编码Agent CLI。
...
- **标签：** `oauth`, `subscription`, `llm-provider`, `codex`
- **推荐理由：** 通过OAuth将订阅服务接入DSH，无需API密钥。
...
- **推荐理由：** DSH插件中心CLI与解析工具，支持Schema验证。
...
- **标签：** `agent-review`, `dsh-plugin`, `self-evolving`
- **推荐理由：** 可组合自进化Agent模式，支持人类审查控制
...
- **标签：** `coding`, `mentor`, `agent-skills`, `review`
- **推荐理由：** AI编程导师，引导架构分析和代码审查
...
- **推荐理由：** 可复用的插件创建与验证工具，支持DSH和Cordis插件开发。
...
- **标签：** `context-audit`, `token-management`, `ui-tool`
- **推荐理由：** 审计上下文Token成本，检测重复与冲突，配Web UI面板
...
- **⭐ 星标：** 29
- **语言：** JavaScript
- **描述：** DSH 实现 workbuddy 同款选�� skill 功能 | WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the official /skill-name gesture, and DSH loads it with your message.
- **标签：** `skill-picker`, `ux`, `composer-integration`
- **推荐理由：** WorkBuddy风格技能选择器，在编辑器中快速插入Skill指令
...
- **标签：** `container`, `multi-version`, `desktop-utility`
- **推荐理由：** 容器化隔离管理多版本DSH，内嵌WebView快速启动
...
- **标签：** `bioinformatics`, `desktop-app`, `tauri`, `medical`
- **推荐理由：** 面向临床和湿实验科学家的生物信息学桌面Agent，支持离线模式
...
- **标签：** `dsh`, `dsh-plugin`, `skill`
- **推荐理由：** 指导AI从0到1开发构建DSH插件的全流程技能。
...
- **标签：** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `skill`
- **推荐理由：** DSH插件/服务/工具标准与打包规范技能。
...
- **标签：** `agent-tools`, `llm-agents`, `awesome-dsh-plugin`
- **推荐理由：** 任务前自动预检并注入Top-K插件提示。
...
- **标签：** `discoverability`, `search`, `awesome-dsh-plugin`
- **推荐理由：** 在agent内搜索npm与精选列表发现插件。
...
- **推荐理由：** DSH现代化桌面包装，为插件生态提供原生GUI体验。
...
- **标签：** `web-ui`, `plugin-hub`, `dsh-web`
- **推荐理由：** DSH插件Web聚合平台，通过创意工坊分发，扩展生态。
...
- **标签：** `mascot`, `ui`, `pixel-art`
- **推荐理由：** 动画宠物公共画廊，为你的编码Agent体验增添个性化乐趣。
...
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/Git/对话等多功能页面
...
- **标签：** `tui`, `terminal`, `ui`
- **推荐理由：** 鲸鱼顶栏TUI，支持流式思考/回滚/实时TPS显示
...
- **推荐理由：** 可爱小鲸鱼悬浮窗，实时显示DeepSeek账户余额
...
- **标签：** `desktop-app`, `electron`, `react`, `mcp`
- **推荐理由：** 本地AI桌面工作台，集成文件、网页和插件功能。
...
- **推荐理由：** 开箱即用的Windows桌面客户端，支持SSH和插件。
...
- **标签：** `ui-components`, `charts`, `forms`, `react`
- **推荐理由：** 内联渲染图表、表单、测验等交互组件。
...
- **标签：** `canvas`, `workspace`, `branching`, `visual`
...
- **标签：** `desktop-app`, `tauri`, `local-first`, `multi-model`
- **推荐理由：** 本地优先的多模型AI代理桌面应用，支持自进化技能。
...
- **推荐理由：** 类CodePilot桌面客户端，支持多平台跨平台扩展。
...
- **标签：** `ios`, `mobile`, `swift`, `websocket`
- **推荐理由：** 原生iOS客户端，WebSocket实时连接与会话追踪。
...
- **标签：** `notes`, `dsh-plugin`, `docker`
- **推荐理由：** 开源锤子便签，一键Docker部署，支持DSH插件
...
- **标签：** `ui`, `mcp`, `skills`, `management`
- **推荐理由：** 在Web界面统一管理skill和MCP，便捷直观
...
- **标签：** `ui`, `marketplace`, `web`, `plugins`
- **推荐理由：** Web界面一键安装/卸载插件，社区生态丰富
...
- **推荐理由：** Electron桌面控制台，多标签管理插件、MCP和Skill，双击即用。
...
- **标签：** `ui`, `info-bar`, `usage-tracking`, `pricing`
- **推荐理由：** 底部常驻状态栏，实时显示模型、余额和分时定价信息
...
- **标签：** `awesome-dsh`, `desktop`, `docker`, `dsh-plugin`, `ssh`
- **推荐理由：** 数据库·SSH·SFTP·Docker·AI助手一站式桌面。
...
- **标签：** `background`, `ui-customization`, `webui`
- **推荐理由：** 自定义网页背景，含预设主题和实时预览
...
- **标签：** `desktop`, `electron`, `webui`
- **推荐理由：** Electron桌面版DSH，集成ModLens与侧边栏
...
- **标签：** `rag`, `knowledge-base`, `vector-search`, `wiki`, `reranking`
- **推荐理由：** 完整RAG平台，将文档转化为可查询知识库和自维护Wiki。
...
- **推荐理由：** 本地优先的持久化记忆层，支持Markdown原生自进化存储。
...
- **推荐理由：** 自进化记忆OS，混合检索且节省35% token，性能优异。
...
- **推荐理由：** 专为AI代理设计的记忆管理套件，支持持久化记忆与知识精炼
...
- **推荐理由：** 基于Milvus的持久统一记忆层，支持跨代理语义检索
...
- **标签：** `memory`, `context`, `auto-consolidation`
- **推荐理由：** 三层自动巩固的记忆系统，实现主动上下文联想与持久化回忆。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `evaluation-framework`, `rag-evaluation`, `prompt-engineering`
- **推荐理由：** 提示词、RAG、Agent的评测与可观测性框架。
...
- **标签：** `agent-skills`, `knowledge-distillation`, `meta-skill`, `digital-human`
- **推荐理由：** 将专家思维模式蒸馏为可复用的AI代理技能。
...
- **标签：** `agent-workspace`, `orchestration`, `multi-device`
- **推荐理由：** 统一多端Agent工作空间，支持看板管理和跨设备任务追踪。
...
- **推荐理由：** 智能技能路由与工作流编排，提升效率减少token消耗
...
- **标签：** `computer-vision`, `audio-understanding`, `ocr`, `multimodal`
- **推荐理由：** 赋予AI视听能力，视频音频转可搜索证据。
...
- **标签：** `task-management`, `agent`, `native-ui`
- **推荐理由：** 本地任务看板，支持SQLite项目与Agent协作流程。
...
- **标签：** `ios`, `mobile-automation`, `mcp`, `webdriveragent`
- **推荐理由：** 22个Agent工具，支持iOS模拟器与真机自动化控制。
...
- **标签：** `math-modeling`, `competition`, `gitops`, `autopilot`
- **推荐理由：** 全栈自动数学建模竞赛Skill，含GitOps流水线与代码自证。
...
- **标签：** `agent-skills`, `coding`, `multi-model`
- **推荐理由：** 将AI经验转化为可复用的智能体技能
...
- **标签：** `ai-infra`, `agent-skills`, `devops`
- **推荐理由：** AI基础设施专用技能，编写优化调试高性能系统
...
- **标签：** `skill-generation`, `automation`, `agent-skills`
- **推荐理由：** 自动将成功会话转化为可复用skill，高效
...
- **推荐理由：** 将Superpowers技能移植到DSH，功能强大
...
- **标签：** `fintech`, `backtesting`, `investment`, `skills`
- **推荐理由：** AI投研 desk，支持多策略回测和合规分析
...
- **标签：** `skills`, `agent`, `mattpocock`, `github`
- **推荐理由：** 内置25个工程效率技能，侧边栏直接调用，支持GitHub Issue。
...
- **标签：** `gongwen`, `docx`, `office`, `china`
- **推荐理由：** 符合国标GB/T 9704的公文全流程处理工具，含格式检查与优化。
...
- **标签：** `spec-driven`, `vibe-coding`, `agent-skills`
- **推荐理由：** 基于DSH工程规范的便携式规格驱动开发技能。
...
- **标签：** `bazi`, `fengshui`, `iching`, `tcm`, `dashboard`
- **推荐理由：** 融合八字、风水、易学等中华传统智慧的可视化AI Agent技能包
...
- **推荐理由：** 支持多Agent协作，独立模型与共享工作空间的Multi-Agent方案
...
- **标签：** `code-simplification`, `coding-skill`, `refactor`
- **推荐理由：** 将Codex代码简化技能适配到DSH，辅助代码优化重构
...
- **标签：** `testing`, `qa`, `playwright`, `pytest`, `test-automation`
- **推荐理由：** 11个测试技能加共享知识库，让AI像资深测试工程师一样工作
...
- **推荐理由：** 跨平台会话记忆技能，实现Agent交接与目标连续性恢复
...
- **标签：** `roleplay`, `narrative`, `interactive-fiction`, `npc-ai`
- **推荐理由：** 互动叙事角色扮演技能，NPC有记忆立场，支持全维YAML存档
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `quality-gate`, `skill`
- **推荐理由：** 上线前校验需求与实现的工程纪律技能包。
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `godot`, `gdscript`, `game-development`
...
- **标签：** `agent-skills`, `deepseek-harness`, `remotion`, `video`, `motion-design`
...
- **推荐理由：** 免费接入小米MiMo TTS，支持预置/自定义/浏览器语音
...
- **标签：** `dsh-plugin-bundle`, `awesome-dsh-plugin`
- **推荐理由：** 类CodeX插件市场，便于技能发现与安装。
...
- **标签：** `design-systems`, `figma-alternative`, `desktop-app`, `ui-generator`
- **推荐理由：** 开源设计系统生成器，本地优先桌面应用，Figma替代方案。
...
- **标签：** `diagrams-as-code`, `architecture-diagram`, `mermaid-alternative`, `code-visualization`
- **推荐理由：** 从代码生成精美架构图、序列图和数据流图的智能工具。
...
- **标签：** `image-prompts`, `gpt-image-2`, `prompt-engineering`, `skills`
- **推荐理由：** 530+案例和20+工业级模板的GPT图像提示词库。
...
- **标签：** `design`, `vector`, `ai-native`
- **推荐理由：** 首款开源AI原生矢量��计工具，支持并发Agent团队协作。
...
- **标签：** `video-generation`, `image-gen`, `storyboard`, `ai-creative`
- **推荐理由：** 集成DirectorX的AI视频/图像/音频生成技能，支持创意工作流
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `design-skills`, `ui`, `vibe-coding`
- **推荐理由：** 6种设计风格包，让AI生成网站摆脱廉价感。
...
- **标签：** `agent-skills`, `deepseek-harness`, `dsh-plugin`, `image-generation`, `vision`
- **推荐理由：** 免费图片读取与生成技能，自动视觉转录。
...
- **推荐理由：** 面向ChatGPT/Claude/Gemini的跨浏览器增强套件，含提示词管理。
...
- **⭐ 星标：** 3,278
- **语言：** Python
- **描述：** 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找��容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）
- **标签：** `content-discovery`, `browser`, `cross-platform`
- **推荐理由：** 本地优先的跨平台AI内容发现代理，覆盖B站/YouTube/小红书等
...
- **标签：** `resume-builder`, `self-hosted`, `mcp-server`, `typescript`
- **推荐理由：** 隐私优先的自托管简历生成器，支持自定义模板无数据泄露。
...
- **标签：** `electron`, `image-uploader`, `s3`, `github`, `aliyun-oss`
- **推荐理由：** 支持60+图床服务的终极图片上传工具，兼容主流编辑器。
...
- **标签：** `low-code`, `internal-tools`, `crm`, `workflows`, `self-hosted`
- **推荐理由：** AI驱动的开源低代码平台，快速构建内部系统和CRM。
...
- **标签：** `security`, `cybersecurity`, `vulnerability`, `redteam`
- **推荐理由：** AI安全平台，检测幻觉包和代码漏洞。
...
- **⭐ 星标：** 194
- **语言：** HTML
- **描述：** 🐋 DeepSeek Harness 插件总目录 · The catalog of DSH plugins：1958 个仓库 / 1819 个真插件（Skills · MCP · Tools · UI · Orchestration），中���文搜索、分类筛选、STAR 排序 → leenkcool.github.io
- **标签：** `plugin-catalog`, `directory`, `awesome-list`
- **推荐理由：** DSH插件总目录，1958个仓库，双语搜索筛选
...
- **标签：** `llm-provider`, `dsh-plugin`, `command-code`
- **推荐理由：** DeepSeek LLM提供商插件，支持实时模型目录
...
- **标签：** `handbook`, `documentation`, `sandbox`
- **推荐理由：** 173资源DSH完整指南：运行时、插件、排障
...
- **标签：** `backup`, `config`, `sync`, `migration`
- **推荐理由：** 完整备份迁移D SH配置和插件数据，安全可靠
...
- **标签：** `mcp`, `skills`, `menu`, `utility`
- **推荐理由：** 统一管理MCP工具和skill的暴露级别和模式
...
- **标签：** `plugin-management`, `infrastructure`, `ui`, `scaffold`
- **推荐理由：** DSH插件生态基建，浏览器管理官方仓库插件，含开发引导工具。
...
- **标签：** `skills`, `management`, `plugin-management`
- **推荐理由：** 统一管理并安全加载本机Agent Skills的DSH工具。
...
- **标签：** `mcp`, `config-sync`, `multi-agent-tool`, `setup-utility`
- **推荐理由：** 一键同步MCP/Skills配置，支持DSH/Cursor/Codex等多工具
...
- **标签：** `codex`, `sync`, `mcp-mirror`, `interop`, `bridge`
- **推荐理由：** Codex与DSH双向桥接，支持对话同步和MCP自动镜像
...
- **标签：** `deepseek-harness`, `dsh`, `documentation`
- **推荐理由：** 腾讯官方DSH插件文档与示例，入门必备。
...
- **标签：** `token-usage`, `data-visualization`, `cost-tracking`
- **推荐理由：** 实时令牌用量追踪，含成本估算与余额图表
...
- **标签：** `debugging`, `conflict-resolution`, `diagnostics`
- **推荐理由：** 解决插件间及版本冲突，提供诊断方案
...
- **标签：** `theme`, `glass-ui`, `customizable`
- **推荐理由：** 磨砂玻璃主题UI，可自由调节各项参数。
...
- **推荐理由：** WebGPU海洋主题视觉皮肤，Three.js渲染。
...
- **标签：** `ai-guide`, `research`, `tutorials`
- **推荐理由：** 全面AI资源库，含教程、提示词和知识库，适合入门和���习。
...
- **标签：** `awesome-list`, `dsh`, `reference`
- **推荐理由：** 精选DSH插件列表，是生态探索的必备参考指南。
...
- **推荐理由：** 从零开始的Harness工程入门教程，适合新手学习。
...
- **标签：** `knowledge-base`, `awesome-list`, `ai-resources`
- **推荐理由：** 一站式AI资源百科，涵盖Agent、RAG和MLOps。
...
- **标签：** `research`, `latex`, `arxiv`, `experiment-tracking`, `gpu`
- **推荐理由：** 科研全流程工作台：LaTeX、arXiv、实验追踪与GPU编排。
...
- **标签：** `finance`, `multi-agent`, `tushare`
- **推荐理由：** 本地财经数据库，多Agent金融分析与盯盘
...
- **标签：** `api-documentation`, `chinese-api`, `zero-config`
- **推荐理由：** 零配置搜索65,600+中国平台API文档，直接集成在Agent中。
...
- **标签：** `patent`, `legal-tech`, `rag`, `multi-agent`
- **推荐理由：** 输入专利号自动生成竞品侵权分析报告，支持多Agent调用。
...
- **推荐理由：** 法律诉讼可视化工具，将案件材料转化为清晰的时间轴和图���。
...
- **⭐ 星标：** 41
- **语言：** JavaScript
- **描述：** DeepSeek Harness (DSH) 插件精选目录 — 14 ��� 280+ 个社区插件，覆盖 MCP / Skill / TUI / 多 Agent / 上下文记忆 / UI 皮肤，点链接直���仓库。Curated directory of dsh plugins for DeepSeek Harness.
- **标签：** `awesome-list`, `directory`, `community`
- **推荐理由：** 精选280+社区插件目录，覆盖MCP、Skill、UI等全类别。
...
- **标签：** `kline`, `chart`, `finance`, `market-analysis`, `trading`
- **推荐理由：** 原生侧栏交互式K线分析，支持多市场行情与指标计算
...
- **标签：** `plugin-market`, `curated`, `daily-updated`
- **推荐理由：** 每日更新的全面插件市场，含审核流程。
...
- **标签：** `awesome-list`, `plugin-catalog`, `discovery`
- **推荐理由：** 每日精选插件发现工具，场景化分类与过滤。
...
- **推荐理由：** DSH生态精选插件、Skill、MCP服务器与UI合集。
...
- **标签：** `marketplace`, `catalog`, `api`, `plugin-store`
- **推荐理由：** 11000+插件市场，支持搜索、排行与公开API。
...
- **标签：** `list`, `catalog`, `awesome`
- **推荐理由：** cordis.run官方自动维护的插件精选目录
...
- **标签：** `ocr`, `image`, `vision`, `pixel-art`
- **推荐理由：** 专为文本模型设计的图片OCR与像素画读取工具。
...
- **标签：** `awesome`, `awesome-list`, `curated-list`, `deepseek-harness`, `dsh-plugin`
- **推荐理由：** 精选DSH优质插件列表，快速发现好工具。
...
- **标签：** `awesome-list`, `deepseek-harness`, `dsh-plugin`, `plugin-directory`
- **推荐理由：** 公开的DSH插件目录，含安装命令方便一键部署。
...
- **推荐理由：** Neovim插件管理器，与DSH生态无关，仅作记录。
...
- **标签：** `guide`, `plugin-directory`, `manual`
- **推荐理由：** 插件产品说明书，含场景选型与兼容性指南
...
- **标签：** `awesome-list`, `tool-inventory`, `comprehensive`
- **推荐理由：** 完整DSH工具清单，1000+仓库按星排序
...
- **标签：** `awesome`, `awesome-list`, `dsh-plugins`
- **推荐理由：** 80+已验证插件按功能分类整理。

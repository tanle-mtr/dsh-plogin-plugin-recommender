...
- **标签：** `agent`, `dsh`, `harness`
- **推荐理由：** 从零入门DSH工程化的最佳教程，适合新手。
...
- **标签：** `agent-orchestration`, `no-code`, `mcp`
- **推荐理由：** 跨设备统一Agent工作区，支持任务看板管理。
...
- **推荐理由：** 自进化Agent OS，面试门禁评估与预算演化循环。
...
- **推荐理由：** 跨Harness长周期Agent控制平面，适合复杂工作流。
...
- **推荐理由：** DSH首个视觉插件，让纯文本编码Agent具备图像理解能力
...
- **标签：** `security`, `redteam`, `vulnerabilities`
- **推荐理由：** AI安全攻防平台，检测幻觉包和代码漏洞防护
...
- **标签：** `infra`, `coding`, `performance`
- **推荐理由：** AI基础设施开发专用技能，支持代码编写与优化。
...
- **标签：** `coding`, `mentor`, `education`, `skills`
...
- **标签：** `plugin-dev`, `coding`, `skills`, `harness-tools`
- **推荐理由：** 开发DSH插件的元技能，覆盖插槽、服务、事件、打包标准
...
- **标签：** `plugin-creator`, `coding`, `codex`, `template`
- **推荐理由：** 可复用的Codex技能模板，快速构建验证DSH插件
...
- **标签：** `quality-gate`, `engineering-discipline`, `delivery-gate`
- **推荐理由：** 工程纪律守护：严格审视需求并验证交付质量。
...
- **标签：** `marketplace`, `skills`, `dsh-plugin`
- **推荐理由：** DSH插件技能市场，方便发现和管理插件
...
- **标签：** `mcp`, `recommender`, `coding-agents`
- **推荐理由：** AI策展190+插件列表，每小时更新
...
- **标签：** `dsh-web`, `dsh-plugin`, `web-ui`
- **推荐理由：** 基于Web的DSH插件生态，Creative Workshop分发。
...
- **标签：** `sidebar`, `ui`, `desktop`
- **推荐理由：** 开放侧边栏底座，内置文件编辑/终端/Git/子代理等页面
...
- **标签：** `tui`, `terminal`, `ui`
- **推荐理由：** Claude Code风格TUI，鲸鱼顶栏/实时状态/流式思考/回滚
...
- **标签：** `floating-widget`, `deepseek`, `dsh-plugin`
- **推荐理由：** 右下角小鲸鱼浮动组件，实时监��账户余额，支持拖拽吸附
...
- **⭐ 星标：** 855
- **语言：** TypeScript
- **描述：** [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片���接识别、多张图片问答、截图到前端UI 还原等｜DeepSeek Harness-native integration for agent-vision-toolkit: image Q&A, long-screenshot OCR, UI restoration, grounding, pixel diff, Artifacts, and Web UI.
- **标签：** `computer-vision`, `ocr`, `dsh-plugin`
- **推荐理由：** 为纯文本模型提供OCR、截图分析等多图问答视觉能力
...
- **标签：** `desktop`, `gui`, `windows`, `ssh`
- **推荐理由：** 开源Windows桌面客户端，集成SSH和移动端远程访问
...
- **推荐理由：** 本地优先的多模型AI代理桌面应用，隐私优先自进化技能
...
- **推荐理由：** 原生iOS客户端，将工作区与会话延伸至iPhone。
...
- **推荐理由：** P2P端到端加密远程访问，支持多端操控Harness。
...
- **推荐理由：** 开源锤子便签，支持Docker私有部署与公众号导出。
...
- **推荐理由：** Electron桌面控制台，集中管理插件、MCP、技能
...
- **标签：** `skill-picker`, `ui`
- **推荐理由：** 类WorkBuddy技能选择器，快速插入composer
...
- **标签：** `bioinformatics`, `desktop-app`, `tauri`, `single-cell`
- **推荐理由：** 面向临床医生的生物信息学桌面工具，支持离线和技能商店。
...
- **推荐理由：** 一站式DevOps桌面：数据库客户端、SSH、SFTP、Docker和AI助手。
...
- **标签：** `background`, `theme`, `webui`, `personalization`
- **推荐理由：** 支持自定义背景和预设氛围，实时预览所见即所得。
...
- **推荐理由：** Electron桌面壳封装DSH Web，集成sidebar和ModLens等插件。
...
- **标签：** `ui`, `button`, `compact`, `webui`
- **推荐理由：** 一键折叠上下文面板，提升Web UI使用效率。
...
- **标签：** `preset`, `agent-tools`, `workflow`
- **推荐理由：** 两阶段预设：轻量启动后加载完整标准工具，配置高效
...
- **标签：** `cognitive-enhancement`, `skills`, `agent-skills`
...
- **标签：** `agent-skills`, `embeddings`, `skill-routing`
- **推荐理由：** 将SKILL.md文件转为可检索的代理技能库，支持评估��具
...
- **标签：** `multimodal`, `computer-vision`, `ocr`, `verification`
- **推荐理由：** 通过视频音频屏幕监控赋予AI感知能力，生成可搜索证据
...
- **推荐理由：** 原生SQLite任务看板，支持Agent认领审核和独立Web UI
...
- **推荐理由：** 小说和短剧创作技能插件，支持Oh Story和Drama Skills
...
- **标签：** `agent`, `workflow`, `self-evolution`
- **推荐理由：** 可组合、可审查的Agent工作流实现自我进化
...
- **推荐理由：** 可复用技能框架，支持Claude/Codex/GPT等多平台。
...
- **标签：** `skills`, `tdd`, `debugging`, `collaboration`
- **推荐理由：** 集成TDD、调试、规划等Superpowers专业技能
...
- **标签：** `skills`, `productivity`, `github`, `workflow`
- **推荐理由：** 集成25个工程效率技能，开箱即用，原生支持GitHub Issue
...
- **标签：** `document`, `chinese`, `office`, `compliance`
- **推荐理由：** 符合国标的中文公文全流程处理，格式检查/优化/模板生成
...
- **标签：** `spec-driven`, `coding`, `vibe-coding`, `workflow`
- **推荐理由：** 规范驱动开发技能，内置仓库原生模式，支持Vibe Coding
...
- **标签：** `ai-director`, `ai-video`, `directorx`, `storyboard`
- **推荐理由：** 支持视频/图像/音频生成的全流程AI技能，含分镜和知识库。
...
- **推荐理由：** Godot 4.x全栈游戏开发技能，运行时注册，适合快速原型。
...
- **推荐理由：** 官方SkillHub开放API文档和示例，便于DSH集成。
...
- **推荐理由：** 虚拟产品团队代理预设，模拟PM到QA到发布的全流程。
...
- **标签：** `mcp`, `menu`, `control`, `security`
- **推荐理由：** 统一管理MCP工具和skill的暴露级别，安全可控
...
- **标签：** `api`, `documentation`, `mcp`, `chinese-platforms`
- **推荐理由：** 内置65,600+中国开放平台API文档，一键搜索
...
- **标签：** `mcp`, `cloud`, `huawei`, `sdk`, `cli`
- **推荐理由：** 华为云官方MCP工具包，含CLI、SDK、沙箱和安全护栏
...
- **标签：** `diagrams`, `architecture-as-code`, `dsh-plugin`
- **推荐理由：** 生成交互式架构图和序列图
...
- **标签：** `visualization`, `legal-tech`, `timeline`, `svg`
- **推荐理由：** 将杂乱诉讼材料转化为专业时间轴和法律可视化图表
...
- **标签：** `ocr`, `vision`, `image-reading`, `multimodal`
- **推荐理由：** 像素到文本OCR技能，让纯文本模型也能读取和理解图片
...
- **推荐理由：** 增强Gemini、Claude、ChatGPT浏览体验套件
...
- **推荐理由：** 让AI代理无缝操控已登录浏览器，支持多shell环境
...
- **⭐ 星标：** 395
- **语言：** TypeScript
- **描述：** 🥇 The strongest free web search plugin for DeepSeek Harness, and the search bridge for every model without native web access. Free, no signup, no API key. Ask the web or X, get structured JSON evidence. | 🥇 全网最强的 DeepSeek Harness 免费联网搜索插件，免费���注册免 API key。为不能联网的模型补上搜索，问网页或 X，拿回结构化 JSON 证据（搜索、抓取、引用）。
- **标签：** `web-search`, `browser`, `free`
- **推荐理由：** 最强免费网页搜索插件，无需注册API密钥
...
- **标签：** `chatgpt`, `oauth`, `subscription`, `ai-agents`
- **推荐理由：** ChatGPT账号OAuth绑定，在DSH内直接聊天
...
- **标签：** `cli`, `mascot`, `dsh-plugin`
- **推荐理由：** 动画宠物画廊，个性化你的Agent编码体验。
...
- **推荐理由：** 一键切换Claude Code/Codex/Grok/DeepSeek/Kimi等模型
...
- **标签：** `plugin-registry`, `ecosystem`, `dsh-plugin`
- **推荐理由：** 自部署插件雷达，自动发现验证15900+候选插件
...
- **推荐理由：** DeepSeek生态精选插件、工具与MCP资源大全
...
- **标签：** `awesome-list`, `dsh-plugins`, `plugin-ecosystem`
- **推荐理由：** 涵盖CLI到Web UI的DeepSeek插件精选目录
...
- **标签：** `cli`, `plugin-manager`, `tools`
- **推荐理由：** DSH插件集成的CLI和Schema管理工具
...
- **标签：** `infrastructure`, `plugin-management`, `devtools`
- **推荐理由：** DSH基础设施核心：插件注册表控制台与官方开发脚手架
...
- **标签：** `build`, `validation`, `plugin-tools`, `credentials`
- **推荐理由：** 构建验证已安装插件，支持槽位、远程和凭据管理
...
- **推荐理由：** 实时监控Token用量和API成本，支持逐轮图表，适合用量管理。
...
- **标签：** `conflict-resolution`, `debugging`, `plugin-health`
- **推荐理由：** 诊断并解决插件间及版本间冲突，保障稳定运行。
...
- **标签：** `auto-updating`, `vercel`, `bilingual`
- **推荐理由：** 自动更新双语README配合Vercel托管
...
- **推荐理由：** 鲸鱼娘系列皮肤，美化DeepSeek Harness桌面界面
...
- **推荐理由：** 跨PubMed/arXiv/CrossRef学术检索，支持引用图谱与去重。
...
- **推荐理由：** 本地财经数据库，多Agent金融分析，支持IM盯盘。
...
- **标签：** `research`, `industry`, `analysis`, `policy`
- **推荐理由：** 行业研究技能包，方法论+政策新闻追踪一体化
...
- **推荐理由：** 专利侵权分析系统，RAG驱动报告生成，支持多Agent调用
...
- **标签：** `evaluation`, `rag-evaluation`, `prompt-testing`, `agent-evaluation`
- **推荐理由：** 基于证据的评估框架，覆盖提示词、RAG、技能和智能体。
...
- **标签：** `awesome-list`, `plugin-directory`, `verified`
- **推荐理由：** 基于证据的插件目录，提供权限感知安装指导。
...
- **推荐理由：** 1000+仓库全量清单按星级排序，全面探索DSH生态。
...
- **标签：** `documentation`, `guide`, `plugin-directory`
- **推荐理由：** 按场景导航的插件说明书，含安装和兼容性指南。
...
- **标签：** `dsh-bundle`, `dsh-ecosystem`, `research`
- **推荐理由：** DSH插件库分析，了解生态插件分布
...
- **标签：** `awesome-list`, `deepseek`, `evidence-led`
- **推荐理由：** 不可变提交审查的双语插件目录
...
- **标签：** `plugin-registry`, `2origin`, `radar`
- **推荐理由：** 插件雷达结合2Origin实验室协作
...
- **标签：** `awesome`, `verified`, `plugins`
- **推荐理由：** 80+已验证DSH插件按功能分类
...
- **标签：** `encyclopedia`, `mcp`, `rag`, `knowledge-base`
- **推荐理由：** 全维度AI资源百科，覆盖技能、MCP、RAG和学习路线
...
- **标签：** `catalog`, `plugin-marketplace`, `directory`
- **推荐理由：** DSH插件总目录，1958个仓库，支持中英文搜索与分类。
...
- **推荐理由：** 多源搜番，Bangumi评分展示，支持磁力链接复制。
...
- **标签：** `community`, `catalog`, `plugins`, `awesome`
...
- **标签：** `directory`, `awesome-list`, `community`, `resources`
- **推荐理由：** 收录280+社区插件的精选目录，按14类分組直达仓库
...
- **标签：** `awesome-list`, `resources`, `registry`
- **推荐理由：** 全面的插件、工具、技能和资源精选列表。
...
- **推荐理由：** 反垃圾过滤的开放数据插件注册表，含 bundles 和技能目录。

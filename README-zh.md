...
- [Agent 技能与工作流](#agent-技能与工作流) — 50 个插件
...
- [Agent 技能与工作流](agent-skills-workflows-zh) (50)
...
- **标签：** `routing`, `injector`, `harness-tool`, `performance`
- **推荐理由：** 运行时注入器配任务感知路由，优化推理模式
...
- **标签：** `agent-runtime`, `rust`, `coding`
- **推荐理由：** Rust高性能代理运行时配合精美桌面IDE
...
- **推荐理由：** 编码代理，支持RPC、子代理、哈希行编辑和MCP集成
...
- **标签：** `ios`, `mobile-automation`, `coding-agent`, `webdriveragent`
- **推荐理由：** 在DSH内运行实时iOS模拟器，提供22个Agent构建驱动工具
...
- **标签：** `deepseek-harness`, `huaweicloud`, `mcp`, `cloud-sdk`
- **推荐理由：** 华为云官方开发套件，支持MCP工具与云沙箱。
...
- **标签：** `plugin-development`, `knowledge-base`, `scaffold`, `cordis`
- **推荐理由：** 官方插件开发知识库与脚手架，支持中英双语文档
...
- **标签：** `context-audit`, `tool`, `ui`, `optimization`
- **推荐理由：** 上下文审计工具：Token成本分析、重复冲突检测
...
- **推荐理由：** 免费接入小米MiMo TTS，支持预设与自定义语音朗读
...
- **标签：** `chatgpt`, `oauth`, `dsh-plugin`, `ai-agents`
- **推荐理由：** 通过OAuth将ChatGPT接入DSH，扩展模型访问能力。
...
- **标签：** `desktop`, `native`, `ui`
- **推荐理由：** 官方桌面包装，提供原生用户体验
...
- **标签：** `web`, `aggregation`, `ecosystem`, `marketplace`
- **推荐理由：** 基于Web的插件聚合中心，创意工坊分发
...
- **标签：** `marketplace`, `dsh-plugin`, `ui`
- **推荐理由：** 可视化插件市场，一键安装方便高效
...
- **标签：** `taskboard`, `ui`, `skills`
- **推荐理由：** 现代灵活任务面板，无缝嵌入编码Agent
...
- **⭐ 星标：** 3,112
- **语言：** TypeScript
- **描述：** DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实���状态/流式思考/双击 Esc 回滚/上下文进度+TPS。npm 一键装。  DSH official WeChat featured TUI plugin — Claude Code style: whale bar, live status, streaming thoughts, double-Esc rollback, context bar + TPS. npm one-click.
- **标签：** `tui`, `terminal`, `ui`
- **推荐理由：** Claude Code风格TUI，鲸鱼主题流式思考
...
- **⭐ 星标：** 2,778
- **语言：** JavaScript
- **描述：** DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动���用，建议直接喊来你的dsh安装
- **标签：** `widget`, `balance`, `ui`
- **推荐理由：** 可爱鲸鱼浮动组件，实时查看账户余额
...
- **推荐理由：** 零配置Windows桌面客户端，内置SSH和插件系统，开箱即用
...
- **推荐理由：** 本地优先的AI桌面工作区，支持项目、文件和Office协作
...
- **标签：** `desktop-app`, `agent`, `local-first`, `tauri`
- **推荐理由：** 本地优先的Tauri桌面AI代理，支持多模型和自进化技能
...
- **标签：** `office`, `productivity`, `desktop-extension`
- **推荐理由：** 将电子表格、文档、幻灯片和画布原生集成到Harness中
...
- **推荐理由：** SQLite驱动的本地任务看板，支持Agent认领/审核和原生Web UI
...
- **标签：** `mobile`, `ios`, `kmp`, `native-client`
- **推荐理由：** 通过WebSocket连接的原生iOS客户端，将工作区带入手机
...
- **推荐理由：** 跨平台的CodePilot风格桌面客户端及插件套件
...
- **标签：** `cordis`, `dsh-plugin`, `skill-manager`
- **推荐理由：** DSH技能调用审计与内嵌管理器
...
- **标签：** `mcp`, `skills`, `ui`, `plugin`
- **推荐理由：** Web界面技能与MCP可视化管理工具
...
- **标签：** `plugin-market`, `ui`, `web`, `community`
- **推荐理由：** Web GUI社区插件市场，一键安装卸载
...
- **标签：** `deepseek-harness`, `desktop-app`, `electron`, `ui`
- **推荐理由：** 桌面管理控制台，多Tab管理Harness/Plugin/MCP/Skill。
...
- **标签：** `bioinformatics`, `desktop-app`, `tauri`, `llm-agent`
- **推荐理由：** 基于Tauri的生物信息学桌面Agent，支持离线和技能商店
...
- **推荐理由：** 集成数据库、SSH、Docker等工具的DevOps桌面中心
...
- **标签：** `terminal`, `keybindings`, `enhancement`
- **推荐理由：** 含快捷键、内置终端、任务通知和LLM追踪的UI增强插件集
...
- **推荐理由：** Electron桌面版，集成DSH Web、侧边栏和ModLens
...
- **标签：** `memory`, `local-first`, `markdown`, `self-evolving`
- **推荐理由：** 可移植的用户记忆层，Markdown本地优先设计
...
- **标签：** `memory`, `rag`, `token-savings`, `self-evolving`
...
- **标签：** `memory`, `library`, `stateful`, `mcp`
- **推荐理由：** 轻量级记忆库，构建持久化有状态AI智能体
...
- **推荐理由：** 将零散技能文件转为向量检索语料库，支持语义搜索与评估
...
- **标签：** `deepseek-harness`, `memory`, `context`, `dsh-plugin`
- **推荐理由：** 零提示词注入的记忆自动关联，三层自动整合。
...
- **标签：** `workspace`, `task-board`, `cross-platform`, `no-code`
- **推荐理由：** 统一智能体工作空间，全设备任务看板管理
...
- **标签：** `skills`, `marketplace`, `coding`, `finance`, `automation`
- **推荐理由：** 最大技能商店，覆盖编程、金融、自动化工作流
...
- **标签：** `enterprise`, `multi-agent`, `workspace`, `visual-editor`
- **推荐理由：** 企业级多智能体工作台，含可视化编辑器协作
...
- **标签：** `agent-os`, `evaluation`, `loop`, `mcp`, `evolution`
- **推荐理由：** 自进化智能体OS，分阶段评估循环与预算管控
...
- **标签：** `control-plane`, `long-horizon`, `governance`, `workflow`
- **推荐理由：** 长周期智能体控制面，跨工效器持久治理
...
- **标签：** `writing`, `novel`, `rag`
- **推荐理由：** 完整AI小说创作流程，从灵感到完稿
...
- **标签：** `creative-writing`, `novel-writing`, `workflows`
- **推荐理由：** 内置小说、短剧、游戏脚本和视频解说四大创作工作台
...
- **推荐理由：** 赋予代理视频/音频/屏幕观察能力，生成可验证时间戳证据
...
- **标签：** `acceptance-review`, `plan-mode`, `dsh-plugin`
- **推荐理由：** 可组合任务控制，实现Agent自进化
...
- **标签：** `agent-skills`, `cross-platform`, `coding`
- **推荐理由：** 将经验转化为可复用执行流程
...
- **标签：** `agent-skills`, `research-automation`, `deep-research`
- **推荐理由：** 88个跨平台研究与营销Agent Skill
...
- **标签：** `stock`, `mcp`, `financial-analysis`
- **推荐理由：** 本地财经数据库+多Agent盯盘系统
...
- **推荐理由：** 含87个SKILL的安全研究技能包，支持逆向与渗透测试
...
- **标签：** `agent-learning`, `skill-generator`, `agent-skills`
...
- **推荐理由：** Superpowers技能移植到Reasonix编码 harness
...
- **⭐ 星标：** 86
- **语言：** TypeScript
- **描述：** 一个面向 DeepSeek Harness 的统一能力管理插件，为 Tools/Skills 提供常驻、按需、禁用三档暴露策略，以减少上下文占用并支持运行时动态发现���执行。
- **标签：** `deepseek-harness`, `dsh-plugin`, `capability-management`
- **推荐理由：** 动态技能暴露策略，有效减少上下文占用。
...
- **推荐理由：** AI编程导师技能，阶梯式学习+自动判题+Code Review。
...
- **标签：** `agent-skills`, `web-search`, `mcp`, `multi-agent`
- **推荐理由：** 跨平台AI代理的网络搜索、研究与内容提取技能集合。
...
- **标签：** `deepseek-harness`, `skills`, `dsh-plugin`
- **推荐理由：** 25个即用工程技能面板，无需手动配置技能。
...
- **标签：** `deepseek-harness`, `gongwen`, `docx`, `skill`
- **推荐理由：** 公文全流程处理，符合国标GB/T 9704格式规范。
...
- **推荐理由：** 面向仓库的规格驱动开发Skill，适配Dsh工程模式
...
- **标签：** `chinese-traditional-wisdom`, `bazi`, `fengshui`, `iching`
- **推荐理由：** 八字/风水/易经等中华传统智慧技能，带可视化面板
...
- **标签：** `quality-gate`, `engineering-discipline`, `delivery`
- **推荐理由：** 工程纪律技能：交付前审查需求、测试与验证
...
- **标签：** `multi-agent`, `agent-team`, `collaboration`
- **推荐理由：** 多Agent协作框架，支持独立模型、技能与共享工作区
...
- **标签：** `qa`, `testing`, `playwright`, `pytest`, `agent-skills`
- **推荐理由：** 11个测试工程Skill，含共享知识库与决策矩阵
...
- **推荐理由：** DSH 内置技能选择器，一键插入 /skill-name 指令
...
- **推荐理由：** 跨平台技能保持上下文连续，支持多 Agent 交接
...
- **推荐理由：** 将 DSH 代码简化技能适配到 Codex 工作流
...
- **标签：** `config-sync`, `mcp`, `skills`, `multi-agent`
- **推荐理由：** 一键同步 MCP 和技能配置，支持多 AI 工具平台
...
- **标签：** `math-modeling`, `agent`, `competition`, `multi-agent`
- **推荐理由：** 5 角色多 Agent 数学建模，含 33 ��型库和论文模板
...
- **标签：** `math-modeling`, `data-preprocessing`, `paper-writing`
- **推荐理由：** 数学建模全流程工具集，从数据预处理到论文写作
...
- **标签：** `plan-first`, `workflow`, `collaboration`
- **推荐理由：** 议行分离协作机制，提升 AI 任务规划与执行质量
...
- **推荐理由：** Godot 4.x 全栈游戏开发技能，支持 GDScript 编程
...
- **标签：** `video`, `remotion`, `motion-design`, `skill`
- **推荐理由：** 152 张镜头配方卡，电影级产品视频生成技能
...
- **推荐理由：** 专为DSH插件开发设计的Agent Skill，支持Claude Code和Codex
...
- **标签：** `web-search`, `free`, `mcp`
- **推荐理由：** 免费网页搜索工具，无需注册，支持无原生联网能力的模型
...
- **标签：** `ai-design`, `design-systems`, `figma-alternative`
- **推荐理由：** AI代理专用的本地优先开源设计工具
...
- **标签：** `image-generation`, `prompt-engineering`, `gpt-image-2`
- **推荐理由：** 530+图像生成提示词及工业级模板库
...
- **标签：** `ui-components`, `charts`, `visual`
- **推荐理由：** 在回复中内联渲染交互式UI组件：图表、布局、表单
...
- **标签：** `deepseek-harness`, `legal`, `diagram`, `svg`, `litigation`
- **推荐理由：** 法律可视化神器，时间轴+对抗图+关系图生成。
...
- **标签：** `video-generation`, `image-generation`, `ai-director`
- **推荐理由：** AI视频/图像/音频生成技能，支持分镜与知识库
...
- **推荐理由：** 实时Token用量图表、成本估算和API余额可视化面板
...
- **标签：** `knowledge-cards`, `visual`, `shareable`
- **推荐理由：** 将对话历史转为精美知识卡片，支持下载分享
...
- **标签：** `content-discovery`, `cross-platform`, `web`
- **推荐理由：** 跨平台自进化内容发现，覆盖主流网站
...
- **标签：** `browser-automation`, `fingerprint-spoofing`, `playwright`
- **推荐理由：** 持久身份浏览器，支持指纹伪装和无限本地配置文件
...
- **推荐理由：** DSH插件枢纽的CLI和解析器，插件管理必备基础设施
...
- **推荐理由：** 通过OAuth使用ChatGPT/Claude/Grok订阅作为LLM提供商
...
- **标签：** `llm-provider`, `command-code`, `infrastructure`
- **推荐理由：** 添加Command Code模型访问，支持实时目录和推理增强
...
- **标签：** `deepseek-harness`, `plugin-management`, `dsh-plugin`
- **推荐理由：** 插件生态基建，提供注册表控制台和开发引导。
...
- **标签：** `dsh-plugin`, `container`, `multi-version`
- **推荐理由：** 隔离容器运行多版本 DSH，内置 WebView 管理插件
...
- **标签：** `launcher`, `orchestration`, `runtime`, `plugin`
- **推荐理由：** 统一编排 DSH 运行时、插件、技能和 MCP 的启动器
...
- **标签：** `migration`, `session-import`, `claude-code`, `coding`
- **推荐理由：** 从 Claude Code、Codex 迁移会话、记忆和技能到 DSH
...
- **标签：** `marketplace`, `desktop`, `plugin-store`
- **推荐理由：** 类CodeX插件市场，便于浏览和安装插件
...
- **标签：** `directory`, `automated`, `bilingual`
...
- **标签：** `theme`, `skin`, `animated-background`, `threejs`
- **推荐理由：** 动态海洋主题，支持海浪、日落和玻璃拟态效果
...
- **标签：** `webui`, `customization`, `themes`
- **推荐理由：** 支持自定义背景与预设氛围，实时预览所见即所得
...
- **标签：** `ai-guide`, `vibe-coding`, `prompt-engineering`
- **推荐理由：** 全面的AI资源大全及零基础入门教程
...
- **推荐理由：** 社区精选插件目录，自动同步维护，DSH生态发现必备。
...
- **标签：** `deepseek-harness`, `api-documentation`, `chinese-api`, `mcp`
- **推荐理由：** 一键搜索20个中国开放平台65,600+篇API文档。
...
- **标签：** `deepseek-harness`, `patent`, `legal-tech`, `rag`
- **推荐理由：** 专利侵权分析系统，支持多Agent平台调用。
...
- **标签：** `skillhub`, `api-docs`, `examples`, `reference`
- **推荐理由：** SkillHub开放API文档与Dsh插件示例参考资料
...
- **标签：** `kline`, `trading`, `analysis`, `sidebar`
- **推荐理由：** 交互式 K 线分析，支持多市场行情和技术指标
...
- **标签：** `radar`, `evidence-backed`, `analysis`
- **推荐理由：** 基于证据的插件雷达图，辅助理性选型决策
...
- **推荐理由：** 中英双语DSH插件与工具 curated 清单，社区资源导航
...
- **推荐理由：** AI全维度知识库百科，涵盖Agent、RAG、MLOps和学习路线
...
- **⭐ 星标：** 348
- **语言：** JavaScript
- **描述：** 30 秒找到真正适合你的 DeepSeek Harness插件。每天自动抓取 GitHub 上的 `dsh-plugin` 项目并逐个复核：真实插件分类收录，蹭标签项目剔除。通过场景化分类、精选推荐、热度排行和图��导览，帮你快速看懂每个插件能做什么、适合谁，以及如何开始使用。欢迎 Star ，让好用的插件更快被发现。
- **标签：** `awesome-list`, `discovery`, `plugin-marketplace`
- **推荐理由：** 每日扫描GitHub的精选插件发现工具，支持场景分类和热度排行
...
- **推荐理由：** 全面的DSH插件、技能、MCP服务器和编排器精选列表
...
- **标签：** `guide`, `resource`, `documentation`
- **推荐理由：** 包含快速入门、资源推荐和精选插件的Harness终极指南
...
- **标签：** `discovery`, `education`, `marketplace`
- **推荐理由：** 学习DSH原理、浏览插件市场和最佳实践
...
- **标签：** `catalog`, `marketplace`, `dsh-plugins`
- **推荐理由：** 万级插件目录，含搜索与免费API
...
- **推荐理由：** 开源锤子便签复刻，支持Docker私有化部署与DSH集成
...
- **标签：** `deepseek-harness`, `agent-platform`, `web-workbench`, `plugin-system`
- **推荐理由：** 基于DSH的插件化Web工作平台，原生工作区集成。
...
- **推荐理由：** 非官方社区 DSH 插件目录，汇集各类实用插件资源
...
- **推荐理由：** 社区 verified 插件按star排行，品质有保障
...
- **标签：** `dsh-plugins`, `dsh-ecosystem`, `plugin-repository`
- **推荐理由：** 社区维护的DSH插件索引，覆盖多个生态工具。
...
- **推荐理由：** 重定向页面，指向已更新的awesome-dsh-plugin仓库。
...
- **标签：** `awesome-list`, `dsh-plugins`, `curated-list`, `plugin-directory`
- **推荐理由：** 全面 curated 插件注册表，覆盖模型、工具、UI和Agent循环。

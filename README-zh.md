...
| 插件 | 星标 | 简介 |
|--------|-------|-----|
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 197,239 | Core framework for the entire DSH plugin ecosystem |
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | ⭐ 91,671 | Open-source design alternative with local-first de |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | ⭐ 69,448 | Multi-agent swarm orchestrator with skill-based wo |
...
- [Agent 技能与工作流](#agent-技能与工作流) — 34 个插件
- [MCP 服务器与工具](#mcp-服务器与工具) — 3 个插件
- [视觉与设计](#视觉与设计) — 10 个插件
- [浏览器与 Web 自动化](#浏览器与-web-自动化) — 7 个插件
- [通信与社交](#通信与社交) — 2 个插件
- [实用工具与基础设施](#实用工具与基础设施) — 18 个插件
- [主题与皮肤](#主题与皮肤) — 5 个插件
- [研究与分析](#研究与分析) — 23 个插件
- [其他](#其他) — 42 个插件
...
- [Agent 技能与工作流](agent-skills-workflows-zh) (34)
...
- [实用工具与基础设施](utilities-infrastructure-zh) (18)
- [主题与皮肤](themes-skins-zh) (5)
- [研究与分析](research-analysis-zh) (23)
- [其他](other-zh) (42)
---
...
- **标签：** `ai-agent`, `multi-agent`, `skills`
- **推荐理由：** 支持记忆、技能和多模型的超级助手框架
...
- **标签：** `coding-agent`, `tui`, `terminal`
- **推荐理由：** 终端原生AI编程助手，支持提示词缓存
...
- **标签：** `agent-os`, `llm-orchestration`, `loop-engineering`
- **推荐理由：** 自改进智能体OS，含循环工程框架
...
- **标签：** `preset`, `standard-tools`, `harness`
- **推荐理由：** 生产级DSH预设，含Project2标准工具集
...
- **推荐理由：** Rust高性能Agent运行时，搭配精美桌面IDE。
...
- **标签：** `code-review`, `agent-skills`, `clean-architecture`
...
- **标签：** `dsh-plugin`, `plugin-development`
- **推荐理由：** 构建和验证DSH及Cordis插件的复用技能。
...
- **标签：** `dsh-plugin`, `plugin-development`, `cordis`
- **推荐理由：** 便携式DSH插件开发与审计技能，含Bundle适配器。
...
- **标签：** `best-practices`, `documentation`, `skill`
- **推荐理由：** DSH插件开发踩坑与最佳实践档案，含实测记录。
...
- **标签：** `plugin-dev`, `skills`, `best-practices`
- **推荐理由：** DSH插件开发测试全链路Agent技能，内置支持。
...
- **标签：** `agent-orchestration`, `multi-device`, `agent-workspaces`
- **推荐理由：** 统一智能体工作台，跨设备任务看板追踪
...
- **标签：** `dsh-web-ui`, `plugin-ecosystem`, `creative`
- **推荐理由：** DSH创意工坊Web插件聚合生态
...
- **标签：** `desktop`, `plugin-sdk`
- **推荐理由：** 桌面陪伴平台，动画宠物+插件SDK，本地优先
...
- **标签：** `widget`, `desktop`
- **推荐理由：** 右下角小鲸鱼挂件，实时显示DeepSeek账户余额
...
- **推荐理由：** 功能丰富的Windows桌面GUI，支持SSH和远程访问
...
- **标签：** `deepseek-harness`, `desktop-app`, `dsh-plugin`, `electron`, `typescript`
- **推荐理由：** Electron桌面控制台，统一管理插件、MCP和技能
...
- **标签：** `desktop`, `docker`, `ssh`, `sftp`
- **推荐理由：** Tauri跨平台桌面，集成数据库/SSH/Docker/AI。
...
- **标签：** `electron`, `desktop-app`, `integration`
- **推荐理由：** Electron桌面版DSH，集成侧边栏与多工具。
...
- **⭐ 星标：** 5
- **语言：** JavaScript
- **描述：** DSH Web 背景个性化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢��默认即可完全移除；内置中英文双语界面。
- **标签：** `dsh-plugin-market`, `webui`, `personalization`
- **推荐理由：** 可自定义Web背景，支持预设和实时预览效果
...
- **标签：** `agent-memory`, `agentic-rag`, `knowledge-database`
- **推荐理由：** 自演进上下文数据库，统一记忆与知识管理
...
- **标签：** `long-term-memory`, `token-savings`, `memory-management`
- **推荐理由：** 自演化记忆系统，节省35%令牌消耗
...
- **标签：** `knowledge-base`, `rag`, `dsh-plugin`
- **推荐理由：** 含MCP和RAG资源的全方位AI知识百科。
...
- **标签：** `multi-agent`, `swarm-intelligence`, `skills`
- **推荐理由：** 多智能体协作编排与技能工作流系统
...
- **标签：** `agent-skills`, `routing`, `workflow`
- **推荐理由：** 任务感知推理路由，优化智能体工作流
...
- **标签：** `creative-writing`, `fiction`, `screenwriting`
- **推荐理由：** 小说和短剧创作的创意写作技能
...
- **推荐理由：** 对话内多源搜番，展示Bangumi评分，支持复制磁力。
...
- **推荐理由：** SQLite任务看板，支持Agent认领审查，原生Web界面。
...
- **推荐理由：** Superpowers技能移植到Reasonix编码引擎
...
- **标签：** `ctf`, `deepseek-harness`, `dsh-plugin`, `pentest`, `reverse-engineering`
- **推荐理由：** 85个逆向工程和渗透测试技能，安全研究者必备
...
- **推荐理由：** AI导师技能，扫描架构、生成章节、自动Code Review
...
- **标签：** `agent-skills`, `deep-research`, `marketing-automation`, `dsh-plugin`
- **推荐理由：** 88个跨平台研究技能，支持营销和社交智能
...
- **标签：** `agent-skills`, `diagram`, `legal`, `litigation`, `svg`, `visualization`
- **推荐理由：** 诉讼时间轴和案件图可视化工具，法律人必备
...
- **标签：** `agent-skill`, `dsh-plugin`, `llm-agent`, `skill`
- **推荐理由：** 开发DSH插件的元技能，涵盖标准规范
...
- **标签：** `agent-skills`, `dsh-plugin`, `spec-driven-development`, `vibe-coding`
- **推荐理由：** 规格驱动开发技能，适配DSH工程模式
...
- **标签：** `deepseek-harness`, `dsh-plugin`, `image-reading`, `ocr`, `vision`
- **推荐理由：** 图片OCR技能，让文本模型具备图像读取能力
...
- **标签：** `agent`, `skills`, `dsh-better-sidebar`, `wayfinder`
- **推荐理由：** 游戏化任务系统，迷雾地图配合任务栏推进。
...
- **⭐ 星标：** 18
- **语言：** Python
- **描述：** 中文公文全流程处理工具——基于 GB/T 9704《党政机关公文格式》 国家标准，面向公文写作、企事业单位材料编制场景，支持 格式检查与修复、内容优化（Word 原生修订+批注/差异对比版）、模板生成、Markdown 转公文、版头版记页码注入、事实核验、风格增强 等完整能力。���生支持 DeepSeek Harness (DSH) 技能系统，打包为可被 AI Agent 直接调用的 Skill，完全自包含，克隆即用。
- **标签：** `gongwen`, `docx`, `ai-docs`, `dsh-plugin`
- **推荐理由：** 符合国标的全流程中文公文处理技能。
...
- **标签：** `agent-skills`, `engineering`
- **推荐理由：** 可移植的工程纪律技能，提炼高质量决策方法。
...
- **⭐ 星标：** 16
- **语言：** TypeScript
- **描述：** 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏览器里管理技能（skills）与 MCP 服���器。
- **标签：** `deepseek-harness`, `dsh-plugin`, `mcp`
- **推荐理由：** 浏览器内直接管理技能与MCP服务器的Web插件。
...
- **标签：** `mcp`, `zhihu`, `dsh-plugin`, `deepseek-harness`
- **推荐理由：** 知乎搜索、知答问答与开放平台API插件。
...
- **推荐理由：** 热加载免重启，粘贴JSON即连MCP服务器，即点即用。
...
- **标签：** `agent-skills`, `mermaid-alternative`, `code-visualization`
- **推荐理由：** 从文本生成美观的架构图和时序图
...
- **标签：** `ui-design`, `design-as-code`, `agent-team`
- **推荐理由：** AI原生矢量设计工具，支持并发智能体协作
...
- **标签：** `image-generation`, `ai-agent`, `deepseek-harness`
- **推荐理由：** 在DSH聊天中直接生成图片，便捷创意工作流
...
- **标签：** `design-skills`, `vibe-coding`, `ui`
- **推荐理由：** 6种设计样式预设，避免AI生成网站千篇一律。
...
- **标签：** `image-generation`, `vision`, `agent-skills`
- **推荐理由：** 图片自动识别转录与AI图像生成功能。
...
- **标签：** `bilibili`, `content-discovery`, `cross-platform`
- **推荐理由：** 本地优先的跨平台内容发现Agent，覆盖主流中文平台。
...
- **标签：** `web-search`, `dsh-plugin`, `agent-skills`
- **推荐理由：** 无原生搜索模型的免费网络搜索桥接工具。
...
- **标签：** `mobile-automation`, `ios`, `mcp`
- **推荐理由：** 对话内运行iOS模拟器并提供22个自动化工具。
...
- **标签：** `chatgpt`, `codex`, `oauth`, `subscription`
- **推荐理由：** 通过OAuth绑定ChatGPT，在DSH内使用Plus模型
...
- **推荐理由：** DSH内测社区合影墙，GitHub OAuth零权限登录。
...
- **标签：** `electron`, `image-uploader`, `cloud-storage`
- **推荐理由：** 支持60+图床的跨平台图片上传工具
...
- **标签：** `claude-code`, `deepseek-harness`, `multi-tool`
- **推荐理由：** 一键安装多AI工具并切换模型，效率极高。
...
- **标签：** `oauth`, `utilities`, `dsh-plugin`
- **推荐理由：** 通过OAuth利用订阅作为DSH的LLM提供者。
...
- **推荐理由：** 崩溃恢复插件，支持撤销配置变更和SAFE MODE。
...
- **标签：** `console`, `dsh-plugin`, `plugin-management`, `ui`
- **推荐理由：** 插件管理控制台和开发脚手架，基础设施工具
...
- **标签：** `context`, `dsh-plugin`, `tool`, `ui`
- **推荐理由：** 审计DSH上下文Token成本，检测指令冲突与重复。
...
- **标签：** `migration`, `mcp`, `configuration-migration`
- **推荐理由：** 一键迁移Claude Code/Codex/OpenCode配置到DSH。
...
- **推荐理由：** 实时Token用量追踪，成本估算与API余额可视化。
...
- **标签：** `awesome-dsh-plugin`, `deepseek-harness-plugin`
- **推荐理由：** 自动检测并解决插件冲突和版本兼容问题
...
- **标签：** `mascot`, `pixel-art`, `personalization`
- **推荐理由：** 动画宠物画廊，个性化编程智能体界面
...
- **标签：** `ocr`, `vision`, `multimodal`
- **推荐理由：** 视觉OCR桥接器，让文本智能体也能分析图片
...
- **标签：** `research`, `web-search`, `china-content`
...
- **标签：** `education`, `marketplace`, `dsh-plugin`
- **推荐理由：** 学习DSH原理与插件市场最佳实践。
...
- **标签：** `evaluation`, `llm-evaluation`, `rag-evaluation`, `skill-evaluation`
- **推荐理由：** 基于证据的提示词、RAG和技能评估框架。
...
- **标签：** `awesome-list`, `plugin-registry`, `dsh-plugins`
- **推荐理由：** 反垃圾过滤的DSH插件开源注册表，便于发现优质插件
...
- **标签：** `awesome`, `dsh-plugin`, `curated-list`
- **推荐理由：** 基于证据的插件目录，含权限安全的安装指导
...
- **标签：** `awesome-list`, `ai-agents`, `plugins`
...
- **标签：** `awesome`, `deepseek-harness`, `resources`
- **推荐理由：** 全面的DSH插件、工具和资源精选目录
...
- **推荐理由：** 精选实用的DeepSeek Harness插件集合
...
- **标签：** `dsh-plugin-verify`, `dsh-repository-plugin`, `dsh-bundle`
- **推荐理由：** DSH插件验证和仓库索引目录
...
- **标签：** `recommender`, `ai-curated`
- **推荐理由：** AI每小时更新的190+插件分类推荐列表。
...
- **标签：** `industry`, `vertical`
- **推荐理由：** 覆盖金融、法律、医疗等行业的精选DSH插件。
...
- **标签：** `toy`, `web`, `traditional`
- **推荐理由：** 传统竹蜻蜓玩具的网页模拟版，零依赖有趣。
...
- **推荐理由：** 精选Top 50插件，实测+自动更新，插件雷达首选
...
- **推荐理由：** 开源锤子便签，支持Docker部署和便签导出为图片。
...
- **推荐理由：** 一键浏览安装更新GitHub上所有dsh-plugin标记的插件。
...
- **标签：** `marketplace`, `plugin-market`, `webui`
...
- **标签：** `agents`, `awesome-list`, `deepseek`, `dsh-plugin`
- **推荐理由：** 精选DSH插件列表和资源目录
...
- **标签：** `marketplace`, `dsh-plugin-market`
...
- **推荐理由：** 重定向至主awesome-dsh-plugin仓库。
...
- **标签：** `curated`, `full-stack`
- **推荐理由：** 覆盖模型、工具、沙盒、UI的全栈DSH插件集。
...
- **标签：** `curated`, `evidence-based`
- **推荐理由：** 有证据支持的精选DSH插件短清单。

...
- **标签：** `agent-control-plane`, `loopx`, `workflow-automation`
- **推荐理由：** 长周期Agent控制面，跨Harness持久工作
...
- **推荐理由：** AI Agent首个虚拟终端，含虚拟文件系统与安全沙箱
...
- **标签：** `agentic-runtime`, `ai-ide`, `computer-use-agent`
...
- **推荐理由：** 支持RPC插件、子代理、哈希行编辑及MCP的代码智能体。
...
- **标签：** `migration`, `compatibility-layer`, `dsh-plugin`
- **推荐理由：** 打通Pi与DSH生态，Pi插件即插即用。
...
- **标签：** `skills`, `coding`, `superpowers`
- **推荐理由：** Superpowers技能适配Reasonix编码
...
- **标签：** `plugin-development`, `codex`, `harness`
- **推荐理由：** 快速构建和验证DSH插件的Codex技能工具
...
- **标签：** `engineering-discipline`, `quality-gate`, `guard`
- **推荐理由：** 工程质量护栏，需求审查测试交付全流程检查
...
- **标签：** `dsh-plugin`, `container`, `tooling`
- **推荐理由：** 隔离容器管理多版本DeepSeek Harness
...
- **标签：** `cordis`, `plugin`, `orchestrator`
- **推荐理由：** DSH核心编排工具，统一管理运行时与插件
...
- **标签：** `agent-tools`, `plugin-library`
- **推荐理由：** DSH代理任务前自动预检并注入适用插件
...
- **标签：** `self-hosted`, `react`, `typescript`
...
- **标签：** `mascot`, `animated`, `pixel-art`
- **推荐理由：** 为多个编码Agent平台添加动画宠物伴侣
...
- **推荐理由：** 开放侧边栏底座，内置文件/终端/对话/Git等页面
...
- **标签：** `widget`, `balance`, `cute`
- **推荐理由：** 可爱的浮动鲸鱼组件，实时显示DeepSeek账户余额
...
- **推荐理由：** 5MB轻量级Tauri桌面版，零环境配置，跨平台支持
...
- **推荐理由：** 零配置Windows桌面GUI客户端，集成SSH、Codex及移动端远程访问。
...
- **推荐理由：** 本地优先的AI桌面工作区，支持会话、项目及Office文档。
...
- **标签：** `canvas`, `non-linear`, `workspace`
- **推荐理由：** 基于画布的非线性对话工作区，支持分支会话探索。
...
- **标签：** `desktop-app`, `privacy`, `local-first`
- **推荐理由：** 本地优先的隐私桌面应用，支持多模型及自进化技能。
...
- **推荐理由：** 将表格、文档、演示和画布带入DeepSeek Harness
...
- **标签：** `task-management`, `ui`, `native`
- **推荐理由：** 基于SQLite��原地任务看板，支持Agent接管和审查
...
- **推荐理由：** 原生iOS/Android客户端，WebSocket连接DSH工作区
...
- **推荐理由：** 类CodePilot桌面客户端及插件套件，支持多平台
...
- **标签：** `dsh-plugin`, `notes`, `ui`
- **推荐理由：** 开源锤子便签，支持Docker私有部署与IM通知。
...
- **标签：** `dsh-plugin`, `workbench`, `typescript`
- **推荐理由：** 基于DSH的插件化Web工作台，全局Skill管理
...
- **推荐理由：** 集成数据库、SSH、SFTP、Docker和AI助手的DevOps桌面。
...
- **标签：** `desktop`, `electron`
- **推荐理由：** Electron桌面版DSH，集成Web UI、侧边栏和ModLens。
...
- **推荐理由：** 本地优先的可移植记忆层，Markdown原生持久化
...
- **推荐理由：** 带RAG的Agent记忆管理套件，支持记忆检索与优化
...
- **推荐理由：** 基于Milvus的持久化统一记忆层，支持多Agent共享
...
- **标签：** `long-term-memory`, `mcp`, `personal-ai`
- **推荐理由：** 本地优先的共享记忆中枢，让所有AI记住一切
...
- **推荐理由：** 全面AI知识库百科，涵盖Agent、RAG、多模态及学习路线。
...
- **标签：** `multi-agent`, `agent-memory`, `mcp`
- **推荐理由：** 支持多模型、自进化记忆的超级AI助手Harness。
...
- **标签：** `agent-workspaces`, `mcp`, `no-code`
- **推荐理由：** 全平台统一的Agent工作区，跨设备访问
...
- **标签：** `agent-skills`, `skills`
- **推荐理由：** 最全技能商店，自动抓取整理GitHub技能项目
...
- **推荐理由：** DSH首个视觉插件，让纯文本Agent具备图像理解能力
...
- **标签：** `agent-teams`, `agentic`, `orchestration`
- **推荐理由：** 在DSH中实现多Agent团队协作编排
...
- **标签：** `creative-writing`, `novel`, `rag`
- **推荐理由：** 结构化AI小说创作流程，支持世界观设定与审稿
...
- **推荐理由：** 将SKILL.md文件整理为可检索的智能体技能语料库，支持评估。
...
- **标签：** `computer-vision`, `audio-understanding`, `ocr`
- **推荐理由：** 赋予智能体视听能力，将视频音频转为可搜索的时间戳证据。
...
- **标签：** `agent-skills`, `creative-writing`, `workflow`
- **推荐理由：** 内置网文、短剧、游戏和视频解说写作工作流
...
- **推荐理由：** 全栈数学建模自动化Skill，支持GitOps流水线与代码自证。
...
- **标签：** `dsh-plugin`, `agent-review`, `prompt-engineering`
- **推荐理由：** 组合式任务控制与人审自我进化，提升Agent质量。
...
- **推荐理由：** 88个开源Agent技能，覆盖研究、营销与社交智能。
...
- **标签：** `dsh-plugin`, `security`, `ctf`
- **推荐理由：** 87个逆向工程Skill，适用于CTF与授权渗透测试。
...
- **标签：** `skills`, `ai-infra`, `dsh`
- **推荐理由：** 面向AI基础设施开发调试的专业技能集合
...
- **标签：** `dsh-plugin`, `skills`, `engineering`
- **推荐理由：** 自带25个工程技能，侧边栏直接调用
...
- **标签：** `dsh-plugin`, `skills`, `management`
- **推荐理由：** 统一管理加载本机Agent Skills，支持安全管控
...
- **推荐理由：** 仓库级规格驱动开发agent技能，支持AI编程工作流
...
- **标签：** `multi-agent`, `collaboration`, `mcp-tools`
- **推荐理由：** 多agent团队协作，成员独立模型技能和共享工作区
...
- **⭐ 星标：** 33
- **语言：** Python
- **描述：** 让 AI 像资深测���工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
- **标签：** `qa`, `testing`, `skill-framework`
- **推荐理由：** 11个QA测试技能框架，AI自动化测试决策矩阵
...
- **标签：** `multi-agent`, `session-memory`, `orchestration`
- **推荐理由：** 持久化agent团队，跨会话保留记忆和私有技能
...
- **推荐理由：** 编辑器内skill快速选择器，提升agent技能调用效率
...
- **推荐理由：** 跨平台agent交接技能，保持任务连续性和上下文记忆
...
- **标签：** `math-modeling`, `competition`, `educational`
- **推荐理由：** 国产数学建模全流程辅助技能包
...
- **标签：** `agent-skill`, `dsh-plugin-dev`
- **推荐理由：** 开发DSH插件的Agent Skill，含插件/服务/事件/工具标准。
...
- **标签：** `vision`, `ocr`, `mcp`, `gui-automation`
- **推荐理由：** 强大视觉工具箱：图像问答、OCR、截图还原
...
- **推荐理由：** 通过OAuth使用ChatGPT/Claude/Grok订阅作为DSH LLM提供者
...
- **推荐理由：** 添加Command Code LLM模型访问，含实时目录和推理
...
- **标签：** `dsh-plugin`, `mcp`, `api-docs`
- **推荐理由：** 6.5万+中国平台API文档，零配置集成搜索
...
- **标签：** `dsh-plugin`, `mcp`, `cloud`
- **推荐理由：** 华为云官方插件，MCP工具+云沙箱+安全护栏
...
- **标签：** `dsh-plugin`, `legal`, `visualization`
- **推荐理由：** 诉讼可视化，时间轴+对抗图+法律关系图生成
...
- **标签：** `browser-extension`, `chatgpt`, `claude-ai`
- **推荐理由：** 多平台浏览器增强套件，功能全面
...
- **推荐理由：** 免费网页搜索桥接插件，无需注册，支持所有无原生搜索的模型。
...
- **推荐理由：** 对话内嵌实时iOS模拟器，含22个Agent自动化工具
...
- **推荐理由：** 一键安装并切换Claude Code/DSH/Kimi等多平台模型
...
- **标签：** `context`, `dashboard`, `dsh-external`
- **推荐理由：** 全面的上下文管理面板，含仪表盘和侧边栏
...
- **标签：** `security`, `cybersecurity`, `auditing`
- **推荐理由：** 审计AI生成代码中的幻觉包、缺失防护及模式错误，保障安全。
...
- **推荐理由：** 追踪会话/每日费用、预算、Token用量和提供商余额
...
- **⭐ 星标：** 204
- **语言：** TypeScript
- **描述：** 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安��、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness 和 CodeX。 (A multi-device remote access solution built on the DeepSeek Harness plugin system, enabling PC, Android, and Web clients to securely access and operate remote Harness and CodeX over a low-latency, end-to-end encrypted, P2P-first network.)
- **标签：** `dsh-plugin`, `infrastructure`, `remote-access`
- **推荐理由：** 加密P2P多端远程访问，随时随地操作Harness。
...
- **标签：** `dsh-plugin`, `infrastructure`, `plugin-management`
- **推荐理由：** DSH插件生态基建，官方仓库控制台+开发引导
...
- **推荐理由：** 一键配置多平台AI Agent的MCP与Skills
...
- **标签：** `migration`, `session-import`, `tooling`
- **推荐理由：** 多源会话与技能迁移向导工具
...
- **推荐理由：** 实时Token用量、成本估算及API余额可视化图表。
...
- **标签：** `tts`, `xiaomi-mimo`
- **推荐理由：** 免费小米MiMo TTS接入，支持预设/自定义/浏览器语音。
...
- **标签：** `awesome-list`, `plugin-directory`, `dsh-plugins`
- **推荐理由：** 包含80+个已验证插件的 curated 目录
...
- **标签：** `awesome-list`, `moved`, `redirect`
- **推荐理由：** 已迁移至新仓库 awesome-dsh-plugin
...
- **标签：** `awesome-list`, `auto-updating`, `curated`
- **推荐理由：** YAML驱动自动更新的双语插件目录
...
- **标签：** `plugin-directory`, `curated-list`, `dsh-plugins`
- **推荐理由：** 覆盖模型、工具、沙箱和UI的全面插件注册表
...
- **标签：** `theme`, `glass`, `ui-customization`
- **推荐理由：** 磨砂玻璃质感主题UI覆盖层，可自由调节模糊度和背景。
...
- **标签：** `theme`, `skin`, `animation`
- **推荐理由：** 动态海洋主题，可调波浪与玻璃态效果
...
- **⭐ 星标：** 5
- **语言：** JavaScript
- **描述：** DSH Web 背景个���化插件：上传自己的图片（JPG / PNG / WEBP / GIF，浏览器端自动压缩到 1600px 以内）或一键切换极光、余烬、宣纸三种预设氛围；实时预览所见即所得，支持细调图像存在感、暗色遮罩、柔焦、适配方式与焦点位置；上传即自动保存到 DSH 设置，重启后原样恢复，浅色 / 深色主题均正常；侧栏、消息气泡、输入框保持原样不遮挡，浮层菜单不受影响；全程本地处理不上传任何服务器，关闭开关或一键恢复默认即可完全移除；内置中英文双语界面。
- **标签：** `webui`, `background`, `theme`
- **推荐理由：** 支持上传图片或切换预设主题美化DSH界面
...
- **标签：** `documentation`, `wiki`, `code-analysis`
- **推荐理由：** 快速从代码生成技术文档和AI可理解的上下文
...
- **标签：** `curated-list`, `ecosystem`, `awesome-list`
- **推荐理由：** 精选DSH插件与工具目录，快速发现优质资源
...
- **推荐理由：** 一站式科研工作台：LaTeX编辑、arXiv管理、实验追踪、GPU服务器SSH。
...
- **标签：** `dsh-plugin`, `finance`, `mcp`
- **推荐理由：** 本地金融数据库，多Agent分析，自动HTTP/MCP接口。
...
- **⭐ 星标：** 29
- **语言：** HTML
- **描述：** 面向 DeepSeek Harness 的交互式 K 线分析插件，支持多���场行情、技术指标、支撑压力位、新闻与基本面分析，并在原生侧栏中直接展示。
- **标签：** `finance`, `kline`, `analysis`
- **推荐理由：** 侧边栏交互式K线分析与行情工具
...
- **推荐理由：** DeepSeek/GPT等AI资源大全与零基础教程。
...
- **标签：** `awesome-list`, `bilingual`, `plugins`
- **推荐理由：** 双语整理的DSH插件、工具、技能及验证参考精选清单。
...
- **标签：** `awesome-list`, `handbook`, `developer-tools`
- **推荐理由：** 权威的Agent手册，覆盖运行时、插件、MCP及故障排查。
...
- **标签：** `directory`, `catalog`, `awesome-list`
- **推荐理由：** 最全DSH插件目录，支持搜索筛选与排序。
...
- **标签：** `awesome-list`, `curated`, `dsh-plugins`
...
- **推荐理由：** DeepSeek Harness全面资源与插件合集
...
- **标签：** `awesome-list`, `plugin-directory`
- **推荐理由：** DeepSeek Harness插件生态精选合集列表
...
- **标签：** `radar`, `awesome-list`
- **推荐理由：** 有据可查的插件雷达与插件实验室
...
- **推荐理由：** GitHub Actions自动爬取的 bilingual 插件目录

...
- **Why use it:** AI + no-code platform for fast business system building.
...
- **Tags:** `ai-writing`, `chinese-novel`, `long-form`
- **Why use it:** Solves AI amnesia and hallucination for 2M-word serialized Chinese novel writing
...
- **Tags:** `skills-marketplace`, `coding`, `automation`
- **Why use it:** Most comprehensive skills marketplace: docs, coding, ML, automation workflows
...
- **Why use it:** Intelligent skill routing and workflow orchestration boosting agent performance
...
- **Tags:** `agent-skills`, `inference-time-control`, `dsh-plugin`
- **Why use it:** Inference-time control suite for deep reasoning and long-horizon agent tasks.
...
- **Tags:** `novel-writing`, `ai-writing`, `local-first`
- **Why use it:** AI-assisted novel writing with worldbuilding, outlining and revision.
...
- **Why use it:** Vision toolkit for text-only LLMs: image Q&A, OCR and GUI restoration.
...
- **Tags:** `creative-writing`, `novel`, `workflow`, `screenplay`
- **Why use it:** Novel/short-drama/workflow plugin with 4 built-in creative writing workbenches.
...
- **Why use it:** Implements epistemic loop for scientific reasoning in agents.
...
- **Tags:** `task-management`, `native-ui`, `workflow`
...
- **Tags:** `ai-agents`, `skill`, `gitops`
- **Why use it:** Full-stack auto math modeling with GitOps pipeline
...
- **Tags:** `cordis`, `skill-panel`, `audit`
- **Why use it:** In-app skill management and audit tool
...
- **Tags:** `plan-mode`, `self-evolving`, `review`
- **Why use it:** Enable composable self-evolving agent modes
...
- **Why use it:** 88 open-source skills for research and marketing
...
- **Why use it:** Add multimodal vision to text-only LLM agents
...
- **Why use it:** Comprehensive 87-skill pack for CTF, pentesting, and reverse engineering research.
...
- **Why use it:** Auto-upgrades DSH plugins along with framework version updates.
...
- **Tags:** `skills`, `dsh-plugin`, `cordis`
- **Why use it:** Manage skills/tools exposure with 3-tier strategy to reduce context load.
...
- **Tags:** `skills`, `dsh-better-sidebar`, `wayfinder`
- **Why use it:** 25 pre-installed dev & efficiency skills; 10x productivity boost.
...
- **Tags:** `agent-skills`, `mcp`, `web-fetch`
- **Why use it:** Web search, research & finance skills across multiple AI agent platforms.
...
- **⭐ Stars:** 78
- **Language:** TypeScript
- **Description:** ProMentor 是一个 AI Coding Agent Skill。装上它，���的 AI 编程助手立刻化身为导师——扫描项目架构、生成阶梯式 Chapter、带你手写核心逻辑、自动判题、AI Code Review。
- **Tags:** `deepseek-harness`, `dsh-plugin`
- **Why use it:** AI coding mentor skill: scan architecture, generate chapters, auto-review.
...
- **Why use it:** GB/T 9704 compliant official document processing with format check & optimization.
...
- **Tags:** `chinese-traditional-wisdom`, `agent-skill`, `bazi`
...
- **Why use it:** Quality gate skill: grill requirements, test implementation, prove delivery.
...
- **Why use it:** Complete math modeling suite: modeling, data prep, plotting, paper writing skills.
...
- **Tags:** `multi-agent`, `team`, `durable-memory`
- **Why use it:** Durable multi-agent teams with persistent memory, notes, and skill rollover.
...
- **Why use it:** Multi-agent collaboration with independent models, tools, and shared workspace.
...
- **Why use it:** QA engineer agent skill framework: 11 skills, shared KB, type decision matrix.
...
- **Why use it:** Multi-agent math modeling competition tool with 5 roles, 33 models, and templates.
...
- **Why use it:** Separated planning-execution skill for structured AI collaboration workflows.
...
- **Tags:** `skillhub`, `deepseek-harness`, `documentation`
- **Why use it:** Official skill documentation and examples for DSH ecosystem
...
- **Tags:** `agent-skills`, `video`, `remotion`, `motion-design`
- **Why use it:** 152-shot cinematic product video skill with Remotion templates
...
- **Tags:** `code-simplification`, `agent-skills`, `codex`
- **Why use it:** Code simplification skill adapted from official DSH skill library
...
- **Why use it:** Standards-based skill for building DSH plugins
...
- **Tags:** `awesome-dsh-plugin`, `cordis`, `deepseek-harness`, `task-management`, `workflow`
- **Why use it:** Complete engineering workflow tool with task stages, verification, and commit checks

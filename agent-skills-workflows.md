...
- **Why use it:** Distill expertise into reusable AI skills for any agent.
...
- **Why use it:** Industrial-grade prompt templates and skills for GPT image generation.
...
- **Tags:** `workspace`, `orchestration`, `multi-platform`
- **Why use it:** Unified agent workspace and task board across desktop, mobile, browser, and API
...
- **Why use it:** AI cognitive-enhancement skills based on J-space global workspace research — advanced agent orchestration.
...
- **Why use it:** General-purpose skill that intelligently routes and orchestrates harness workflows — versatile and powerful.
...
- **Why use it:** End-to-end Vox-style paper-collage video generation skill — turns one topic into a finished video automatically.
...
- **Tags:** `code-review`, `clean-architecture`, `auto-fix`, `agent-skills`
- **Why use it:** AI code review grounded in 12 classic engineering books with severity labels and auto-fix — great for code quality.
...
- **Tags:** `agentteams`, `dsh-plugin`, `workflow`
...
- **Tags:** `agent-vision-toolkit`, `dsh-plugin`, `computer-vision`
...
- **Why use it:** Creative writing skill for novels & short dramas powered by Oh Story.
...
- **Tags:** `skills`, `automation`, `agent-framework`
- **Why use it:** Turn experiences into repeatable execution skills across AI agents.
...
- **Why use it:** Skill that searches, installs & verifies GitHub DSH plugins automatically.
...
- **Why use it:** Anime search skill with Bangumi ratings & magnet link support in-chat.
...
- **Tags:** `skills`, `ai-infra`, `debugging`
- **Why use it:** Specialized agent skills for AI infrastructure development and debugging workflows.
...
- **Tags:** `skill`, `reasonix`, `coding`
- **Why use it:** Superpowers skill port providing advanced coding harness workflows for Reasonix.
...
- **Why use it:** 85 SKILL.md reverse engineering skill for security research
...
- **Why use it:** AI coding mentor skill with architecture scan and code review
...
- **Why use it:** Legal visualization skill with timeline and diagram generation
...
- **Why use it:** Enables cross-agent session continuity memory recovery
...
- **Why use it:** Unique Chinese wisdom skill: Bazi, Fengshui, IChing all in one
...
- **Why use it:** WorkBuddy-style skill picker, quick skill insertion in composer
...
- **Why use it:** Full pipeline for Chinese official document writing per GB/T 9704.
...
- **Why use it:** Package manager for 42 agent skills, CLIs, and database tools.
...
- **Why use it:** Gamified task system with fog-of-war map for DSH skill workflows.
...
- **Tags:** `plugin`, `skills`, `development`
- **Why use it:** Plugin dev skills for scaffolding and testing DSH plugins
...
- **Tags:** `agent`, `canvas`, `skills`, `mcp`
- **Why use it:** WeShop canvas plugin with infinite creative skills
...
- **Why use it:** Simulates PM/Eng/QA team for product tasks
...
- **Tags:** `agent-tools`, `workflow`, `checklist`

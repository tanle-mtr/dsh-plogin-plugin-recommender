...
- **推荐理由：** Curated DSH plugin ecosystem list
...
- **标签：** `dsh-plugin`, `awesome-list`, `ecosystem`
- **推荐理由：** Curated DSH ecosystem tools list
...
- **推荐理由：** Curated plugin & skill directory for DSH ecosystem
...
- **推荐理由：** 3100+ plugin marketplace with search & API
...
- **推荐理由：** Plugin marketplace hub for DeepSeek Harness
...
- **标签：** `anime`, `search`
- **推荐理由：** Search anime across multiple sources in-chat
...
- **推荐理由：** Smartisan-style notes with Docker deploy & exports
...
- **推荐理由：** One-click DSH plugin marketplace for web GUI
...
- **推荐理由：** Curated awesome list of DSH plugins
...
- **推荐理由：** Community plugin market for DSH web GUI
...
- **推荐理由：** Curated list of DSH plugins and development resources
...
- **推荐理由：** Curated directory of 280+ DSH plugins across 14 categories
...
- **推荐理由：** Unofficial community plugin catalog
...
- **推荐理由：** Curated verified DSH plugin directory
...
- **推荐理由：** Spam-filtered open-data plugin registry
...
- **推荐理由：** Verified stock/finance/quant DSH plugins list

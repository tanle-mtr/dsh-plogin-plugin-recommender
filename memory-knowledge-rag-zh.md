...
- **标签：** `long-term-memory`, `rag`, `dsh-plugin`, `token-savings`
- **推荐理由：** 持久化混合检索记忆，有效节省Token消耗
...
- **推荐理由：** 基于Milvus的统一AI代理持久化记忆层，支持多代理共享
...
- **标签：** `memory`, `agent`, `desktop`
- **推荐理由：** 个人AI代理为所有AI工具提供共享记忆中枢
...
- **标签：** `agent-memory`, `embeddings`, `vector-search`, `skill-reranking`
- **推荐理由：** 将分散技能转为向量化知识库，支持语义检索与评估
...
- **推荐理由：** 官方DSH插件开发文档知识库，中英双语，便于插件开发查阅。

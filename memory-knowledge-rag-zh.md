...
- **标签：** `memory-management`, `long-term-memory`, `self-evolving`, `skills`
- **推荐理由：** 自进化记忆系统，节省token。
...
- **推荐理由：** 基于Markdown和Milvus的统一持久化记忆层
...
- **标签：** `skill-corpus`, `reranking`, `vector-search`
- **推荐理由：** 将分散的SKILL.md文件转化为可检索的Agent技��知识库。
...
- **标签：** `agent-skill`, `knowledge-base`, `dsh-plugin`

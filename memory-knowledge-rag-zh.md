...
- **推荐理由：** 本地优先的可移植记忆层，支持跨应用AI Agent。
...
- **标签：** `agent-memory`, `rag`, `long-term-memory`, `skills`
...
- **标签：** `agent-memory`, `agentic-rag`, `mcp`, `context-engineering`
- **推荐理由：** 具备持续学习能力的状态化Agent记忆库。
...
- **标签：** `memory`, `rag`, `dsh-plugin`, `memoryscope`
- **推荐理由：** 专用代理记忆管理工具包，支持记忆精炼与保留
...
- **推荐理由：** 基于Milvus的持久统一记忆层，支持语义和混合搜索
...
- **标签：** `memory`, `persistent-context`, `multi-agent`
- **推荐理由：** 跨AI智能体的共享持久化记忆中枢
...
- **推荐理由：** 将分散的SKILL.md转化为可检索的agent技能库

...
- **标签：** `rag`, `knowledge-base`, `semantic-search`, `llm`
- **推荐理由：** 开源RAG知识平台，含语义搜索和Wiki功能。
...
- **推荐理由：** 为OpenClaw提供无限记忆存储，支持持久化会话
...
- **标签：** `long-term-memory`, `agent-memory`, `mcp`
- **推荐理由：** 持久化长期记忆插件，支持可检查的回忆工具。
...
- **标签：** `memory`, `skills`, `deepseek-harness`
- **推荐理由：** 通过PowerContext服务器实现记忆、交接和技能管理

...
- **推荐理由：** 腾讯开源LLM知识平台，集成RAG与自维护Wiki
...
- **标签：** `memory`, `local-first`, `markdown`
- **推荐理由：** 可移植的本地优先AI记忆层，用户拥有且自进化。
...
- **标签：** `agent-memory`, `vector-search`
- **推荐理由：** 将分散技能文件转为可检索的Agent技能知识库

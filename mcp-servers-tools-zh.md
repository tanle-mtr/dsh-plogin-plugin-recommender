...
- **标签：** `mcp`, `dsh-plugin`, `huaweicloud`
- **推荐理由：** 华为云官方工具包，含MCP工具、沙箱和安全护栏
...
- **标签：** `dsh-plugin`, `chatgpt`, `codex`, `oauth`, `ai-agents`
- **推荐理由：** 通过OAuth绑定ChatGPT账号，在DSH内直接调用模型。

...
- **Why use it:** Cross-platform AI content discovery from Bilibili, YouTube, Zhihu
...
- **Why use it:** Bind ChatGPT account via OAuth, chat models inside DSH directly
...
- **Why use it:** DingTalk IM channel with stream-mode bot and emotion read-receipts

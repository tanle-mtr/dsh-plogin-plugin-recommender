...
- **Tags:** `social`, `oauth`, `photo`, `event`
- **Why use it:** OAuth zero-permission group photo wall for community events
...
- **Why use it:** DingTalk IM integration with agent chat capabilities

...
- **Why use it:** Modern desktop client for DSH, treating the desktop itself as a plugin.
...
- **Tags:** `pets`, `UI`, `mascot`
- **Why use it:** Gallery of animated pets for multiple coding assistant platforms.
...
- **Tags:** `widget`, `floating-ui`, `balance-tracker`
- **Why use it:** Adorable whale widget tracks DeepSeek balance on DSH
...
- **Why use it:** Zero-setup desktop client with preset plugins
...
- **Tags:** `genui`, `interactive-ui`, `visualization`
- **Why use it:** Renders interactive inline UI components—charts, forms, quizzes—directly in replies.
...
- **Why use it:** Local-first, privacy-focused desktop app alternative to Claude Cowork with self-evolving skills.
...
- **Tags:** `desktop-client`, `electron`, `ssh`
- **Why use it:** Open-source Electron desktop client with Codex, SSH, and mobile remote access built in.
...
- **Tags:** `canvas`, `conversation-workspace`, `non-linear`
...
- **Why use it:** Adds spreadsheets, docs, slides and relational tables into the Harness workspace
...
- **Tags:** `mobile`, `ios`, `ui`
- **Why use it:** Native iOS app with real-time session and agent tracking
...
- **Why use it:** Web UI plugin for managing skills and MCP integrations
...
- **Why use it:** Desktop Electron console for multi-tab Harness/Plugin/MCP management
...
- **Why use it:** Bioinformatics desktop agent with offline mode and skill store
...
- **Tags:** `desktop-app`, `docker`, `ssh`, `devops`
- **Why use it:** All-in-one DevOps desktop: DB, SSH, SFTP, Docker, AI agent
...
- **Why use it:** Custom background images and effects for DSH Web UI.

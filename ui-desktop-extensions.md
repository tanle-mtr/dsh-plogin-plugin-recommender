...
- **Why use it:** Best open-source design plugin with local-first desktop.
...
- **Tags:** `desktop`, `official`, `cross-platform`
- **Why use it:** Official DeepSeek Harness desktop client — native cross-platform experience
...
- **Tags:** `workspace`, `multi-device`, `unified-ui`
- **Why use it:** All agents and workspaces unified across desktop/mobile/browser/API
...
- **Why use it:** Open sidebar foundation with built-in files, terminal, chat, Git pages
...
- **Tags:** `terminal`, `sandbox`, `virtual`
- **Why use it:** World's first virtual terminal providing isolated sandboxed sessions for agents
...
- **Tags:** `task`, `panel`, `ui`
- **Why use it:** Modern flexible task panel embeddable in Codex and DSH environments
...
- **Why use it:** Feature-rich TUI plugin with whale bar, streaming thoughts, and rollback
...
- **Why use it:** Lightweight Tauri desktop app for DSH with zero setup required.
...
- **Tags:** `desktop`, `electron`, `codex`, `ssh`
- **Why use it:** Complete zero-setup DSH desktop client with Codex, SSH, mobile remote access.
...
- **Tags:** `desktop`, `local-first`, `workplace`, `office`
- **Why use it:** Local-first AI desktop workspace with web research, projects, and Office artifacts.
...
- **Tags:** `ui`, `charts`, `forms`, `interactive`
- **Why use it:** Interactive inline UI components — charts, forms, quizzes rendered in replies.
...
- **Why use it:** Visual non-linear canvas workspace for branching AI conversation sessions.
...
- **Why use it:** Brings full office suite (sheets/docs/slides) to DSH desktop.
...
- **Why use it:** Local-first desktop AI agent alternative to Claude Cowork.
...
- **Why use it:** Native iOS/Android client connecting via WebSocket to DSH.
...
- **Tags:** `ios-simulator`, `mobile-automation`, `ui-extension`
- **Why use it:** Embeds live iOS Simulator inside conversation with 22 agent tools.
...
- **Why use it:** Multi-device remote access with P2P encryption
...
- **Why use it:** Web UI plugin for managing skills and MCP servers directly from browser interface.
...
- **Why use it:** Community plugin marketplace integrated into DSH Web GUI for one-click install.
...
- **Tags:** `ui-extension`, `info-bar`, `stats`
- **Why use it:** Replaces composer stats row with model info, balance, and pricing details.
...
- **Why use it:** All-in-one DevOps desktop with SSH, Docker, DB client
...
- **Why use it:** Electron desktop shell integrating DSH web and tools
...
- **Why use it:** Custom web background with presets and live preview

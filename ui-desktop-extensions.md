...
- **Tags:** `figma-alternative`, `desktop-app`, `ui-generator`
- **Why use it:** Local-first desktop design tool, open-source Figma alternative
...
- **Tags:** `desktop`, `dsh-plugin`, `modern-ui`
...
- **Tags:** `web-ui`, `plugin-aggregator`, `dsh-plugin`
- **Why use it:** Web plugin aggregator with creative workshop distribution.
...
- **Tags:** `sidebar`, `deepseek-harness`, `extension`
- **Why use it:** Extensible sidebar with file editor, terminal, Git, and sub-agent pages.
...
- **Why use it:** Claude Code-style TUI with whale theme, real-time status and flow thinking.
...
- **Tags:** `floating-widget`, `cordis`
- **Why use it:** Floating whale widget displays DeepSeek account balance with animations.
...
- **Tags:** `desktop`, `agent`, `local-first`, `privacy`
- **Why use it:** Local-first multi-model desktop agent with privacy focus.
...
- **Why use it:** Render interactive charts, layouts, forms directly in chat replies.
...
- **Why use it:** Open-source Windows desktop GUI client with SSH, mobile remote, and plugin support
...
- **⭐ Stars:** 57
- **Language:** TypeScript
- **Description:** DSH 插件生态���建：薄控制台（浏览器面板管理官方 repository 插件，0 patch）+ make-dsh-plugin skill 官方插件开发引导
- **Tags:** `console`, `deepseek-harness`, `dsh`, `dsh-plugin`, `dsh-repository-plugin`, `plugin-management`, `ui`
- **Why use it:** Browser-based plugin management console with zero-patch integration
...
- **Tags:** `ui`, `bar`, `info`, `pricing`
- **Why use it:** Bottom bar showing provider, balance, and pricing countdown
...
- **Tags:** `canvas`, `creative`, `agent-skills`
...
- **Why use it:** All-in-one desktop for devops

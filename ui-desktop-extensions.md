...
- **Why use it:** Open-source design tool and desktop app for coding agents
...
- **Why use it:** Modern desktop client where even the desktop is a plugin
...
- **Tags:** `mascot`, `ui`, `dsh-plugin`
- **Why use it:** Animated pet gallery providing delightful UI mascots for coding agents.
...
- **Why use it:** Claude Code-style TUI with whale header, streaming thinking display and rollback support.
...
- **Tags:** `desktop`, `tauri`
- **Why use it:** Lightweight 5MB desktop app with preset plugins, zero setup needed.
...
- **Why use it:** Complete local AI desktop workspace integrating DSH sessions, projects, files, and MCP tools.
...
- **Why use it:** Zero-setup Windows desktop client with Codex, SSH, skills, and remote mobile access.
...
- **Why use it:** Renders interactive UI components—charts, forms, quizzes—directly inside chat replies.
...
- **Why use it:** Visual canvas-based non-linear conversation explorer for branching and mapping DSH sessions.
...
- **Why use it:** Local-first multi-model desktop agent with self-evolving skills, privacy-focused, Claude Cowork alternative.
...
- **Why use it:** Native local taskboard with SQLite and clean Web UI
...
- **Why use it:** Brings full office suite into Harness desktop environment
...
- **Why use it:** Native iOS client for DSH with WebSocket sync and agent tracking
...
- **Why use it:** Open-source Smartisan notes with Docker deploy and DSH plugin support
...
- **Why use it:** Provides web UI for managing skills and MCPs directly in DSH interface.
...
- **Why use it:** Community plugin market within DSH web GUI for browsing and installing extensions.
...
- **Why use it:** Multi-tab Electron console for Harness/Plugin/MCP/Skill management
...
- **Tags:** `ui`, `info-bar`
- **Why use it:** Persistent bottom bar showing provider, balance, and pricing with countdown.
...
- **Why use it:** Compact context button improves DSH Web UI usability.
...
- **Why use it:** Converts chat history into shareable, downloadable knowledge cards.

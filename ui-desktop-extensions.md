...
- **Why use it:** Modern desktop solution tailored for DSH plugin ecosystem.
...
- **Tags:** `web-ui`, `plugin-hub`, `distribution`
- **Why use it:** Web-based plugin hub and creative workshop distribution for DSH ecosystem
...
- **Tags:** `sidebar`, `dsh-plugin`, `extension`
- **Why use it:** Open sidebar foundation with file editor, terminal, Git, and sub-agent pages — extensible and feature-rich.
...
- **Why use it:** Claude Code-style TUI plugin with whale header, real-time status, streaming thoughts — polished UX.
...
- **Tags:** `desktop-pet`, `electron`, `dsh-plugin`
- **Why use it:** Desktop companion platform with animated pets and plugin SDK.
...
- **Why use it:** Local-first AI desktop app with multi-model support and self-evolving skills.
...
- **Why use it:** Run iOS Simulator and USB-connected iPhone directly within DSH conversations.
...
- **Why use it:** Visual canvas-based non-linear conversation workspace for branching sessions.
...
- **Why use it:** Full-featured Electron desktop GUI for DSH with SSH & mobile access.
...
- **Why use it:** Native SQLite-backed task management with agent claim/review and no iframe dependency.
...
- **Tags:** `desktop`, `electron`, `docker`, `ssh`, `database`
- **Why use it:** Cross-platform desktop with DB/SSH/Docker panels integrated
...
- **Tags:** `desktop`, `electron`, `integration`, `web`
